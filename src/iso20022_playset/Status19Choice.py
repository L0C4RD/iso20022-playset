...
class Status19Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_AffirmSts", "_RplcmntPrcgSts", "_AllcnSts", "_RspnSts", "_RegnPrcgSts", "_CxlPrcgSts", "_InstrPrcgSts", "_MtchgSts", "_CorpActnEvtPrcgSts", "_RepoCallReqSts", "_CorpActnEvtStag", "_SttlmCondModSts", "_SttlmSts", "_IfrrdMtchgSts"]
	@property
	def AffirmSts(self):
