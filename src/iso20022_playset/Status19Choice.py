...
class Status19Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_RplcmntPrcgSts", "_CorpActnEvtPrcgSts", "_SttlmCondModSts", "_RspnSts", "_RepoCallReqSts", "_CxlPrcgSts", "_IfrrdMtchgSts", "_AllcnSts", "_CorpActnEvtStag", "_SttlmSts", "_MtchgSts", "_RegnPrcgSts", "_AffirmSts", "_InstrPrcgSts"]
	@property
