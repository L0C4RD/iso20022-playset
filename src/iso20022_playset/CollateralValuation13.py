...
class CollateralValuation13(base_types._BaseFieldType):
	...
	__slots__ = ["_CollId", "_CollTp", "_DayCntBsis", "_OthrColl", "_CollDrctn", "_CcyHrcut", "_NbOfDaysAcrd", "_AdjstdRate", "_CshColl", "_SttlmSts", "_XchgRate", "_ApldXcssInd", "_ValtnAmts", "_SctiesColl"]
	@property
	def CollId(self):
		return self._CollId
