...
class CollateralValuation13(base_types._BaseFieldType):
	...
	__slots__ = ["_CcyHrcut", "_OthrColl", "_CollTp", "_CollId", "_ValtnAmts", "_SctiesColl", "_CshColl", "_DayCntBsis", "_NbOfDaysAcrd", "_XchgRate", "_CollDrctn", "_ApldXcssInd", "_SttlmSts", "_AdjstdRate"]
	@property
	def CcyHrcut(self):
