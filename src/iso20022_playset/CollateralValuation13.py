...
class CollateralValuation13(base_types._BaseFieldType):
	...
	__slots__ = ["_XchgRate", "_ValtnAmts", "_CollId", "_AdjstdRate", "_CollTp", "_CshColl", "_SctiesColl", "_ApldXcssInd", "_DayCntBsis", "_OthrColl", "_CcyHrcut", "_NbOfDaysAcrd", "_SttlmSts", "_CollDrctn"]
	@property
	def XchgRate(self):
