...
class CollateralValuation13(base_types._BaseFieldType):
	...
	__slots__ = ["_CollId", "_CollDrctn", "_NbOfDaysAcrd", "_DayCntBsis", "_XchgRate", "_CcyHrcut", "_SctiesColl", "_CollTp", "_ValtnAmts", "_SttlmSts", "_AdjstdRate", "_ApldXcssInd", "_CshColl", "_OthrColl"]
	@property
	def CollId(self):
		return self._CollId
