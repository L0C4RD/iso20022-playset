...
class CardPaymentTransactionResult4(base_types._BaseFieldType):
	...
	def AuthstnCd(self, value):
		self._AuthstnCd = value if value is not None else base_types.UninitialisedField(self, 'AuthstnCd', Min6Max8Text, False)

	@AuthstnCd.deleter
	def AuthstnCd(self):
		del self._AuthstnCd
		self._AuthstnCd = base_types.UninitialisedField(self, 'AuthstnCd', Min6Max8Text, False)
