...
class CollateralAmount17(base_types._BaseFieldType):
	...
	def TermntnTxAmt(self, value):
		self._TermntnTxAmt = value if value is not None else base_types.UninitialisedField(self, 'TermntnTxAmt', ActiveOrHistoricCurrencyAndAmount, False)

	@TermntnTxAmt.deleter
	def TermntnTxAmt(self):
		del self._TermntnTxAmt
		self._TermntnTxAmt = base_types.UninitialisedField(self, 'TermntnTxAmt', ActiveOrHistoricCurrencyAndAmount, False)
