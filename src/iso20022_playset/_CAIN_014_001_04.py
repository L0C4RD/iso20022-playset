...
from . import RetrievalFulfilmentInitiationV04
...
class CAIN_014_001_04():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def RtrvlFlfmtInitn(self, value):
			self._RtrvlFlfmtInitn = value if value is not None else base_types.UninitialisedField(self, 'RtrvlFlfmtInitn', RetrievalFulfilmentInitiationV04, False)

		@RtrvlFlfmtInitn.deleter
		def RtrvlFlfmtInitn(self):
			del self._RtrvlFlfmtInitn
			self._RtrvlFlfmtInitn = base_types.UninitialisedField(self, 'RtrvlFlfmtInitn', RetrievalFulfilmentInitiationV04, False)
