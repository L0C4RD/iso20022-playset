...
class VerificationInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Orgtr", "_AcctTo", "_ConvsDtTm", "_TxAmts", "_Accptr", "_Crdhldr", "_PrcgRslt", "_TxId", "_POICmpnt", "_Prgrmm", "_Cntxt", "_AddtlSvc", "_OrgnlRspnCd", "_Jursdctn", "_Rcvr", "_PrtctdData", "_AcctFr", "_XchgRate", "_SttlmSvc", "_ICCRltdData", "_SctyTrlr", "_Instlmt", "_SpclPrgrmmQlfctn", "_SplmtryData", "_Issr", "_Acqrr", "_Tkn", "_Pyer", "_Hdr", "_TxChrtcs", "_CstmrDvc", "_FndsSvcs", "_Wllt", "_AddtlFee", "_Termnl", "_Rsk", "_Pyee", "_Sndr", "_StrngCstmrAuthntcn", "_Rcncltn", "_Card", "_AddtlData", "_AddtlAmt", "_Dstn", "_Vrfctn"]
	@property
	def Orgtr(self):
		return self._Orgtr
