...
from .Context23 import Context23
from .PartyIdentification286 import PartyIdentification286

class VerificationInitiationV03(base_types._BaseFieldType):

	__slots__ = ["_Tkn", "_XchgRate", "_Cntxt", "_ICCRltdData", "_PrcgRslt", "_SctyTrlr", "_Pyee", "_Hdr", "_CstmrDvc", "_ConvsDtTm", "_Crdhldr", "_Issr", "_AddtlAmt", "_SttlmSvc", "_TxId", "_Rcncltn", "_Orgtr", "_Accptr", "_Wllt", "_AcctFr", "_Instlmt", "_PrtctdData", "_SplmtryData", "_AcctTo", "_Termnl", "_Pyer", "_Prgrmm", "_OrgnlRspnCd", "_Card", "_Acqrr", "_StrngCstmrAuthntcn", "_Vrfctn", "_AddtlData", "_Rcvr", "_Sndr", "_SpclPrgrmmQlfctn", "_FndsSvcs", "_Dstn", "_TxChrtcs", "_POICmpnt", "_AddtlSvc", "_Jursdctn", "_Rsk", "_TxAmts", "_AddtlFee"]
	@property
	def Tkn(self):
		return self._Tkn
