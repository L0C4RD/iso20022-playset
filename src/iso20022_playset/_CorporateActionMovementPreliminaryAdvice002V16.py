...
from . import AccountIdentification76Choice
from . import CorporateAction77
from . import CorporateActionEventReference4
from . import CorporateActionGeneralInformation192
from . import CorporateActionNarrative62
from . import CorporateActionOption245
from . import CorporateActionPreliminaryAdviceType5
from . import CorporateActionReversalReason9
...
class CorporateActionMovementPreliminaryAdvice002V16(base_types._BaseFieldType):
	...
	def AcctDtls(self, value):
		self._AcctDtls = value if value is not None else base_types.UninitialisedField(self, 'AcctDtls', AccountIdentification76Choice, False)

	@AcctDtls.deleter
	def AcctDtls(self):
		del self._AcctDtls
		self._AcctDtls = base_types.UninitialisedField(self, 'AcctDtls', AccountIdentification76Choice, False)
	...
	def AddtlInf(self, value):
		self._AddtlInf = value if value is not None else base_types.UninitialisedField(self, 'AddtlInf', CorporateActionNarrative62, False)

	@AddtlInf.deleter
	def AddtlInf(self):
		del self._AddtlInf
		self._AddtlInf = base_types.UninitialisedField(self, 'AddtlInf', CorporateActionNarrative62, False)
	...
	def CorpActnDtls(self, value):
		self._CorpActnDtls = value if value is not None else base_types.UninitialisedField(self, 'CorpActnDtls', CorporateAction77, False)

	@CorpActnDtls.deleter
	def CorpActnDtls(self):
		del self._CorpActnDtls
		self._CorpActnDtls = base_types.UninitialisedField(self, 'CorpActnDtls', CorporateAction77, False)
	...
	def CorpActnGnlInf(self, value):
		self._CorpActnGnlInf = value if value is not None else base_types.UninitialisedField(self, 'CorpActnGnlInf', CorporateActionGeneralInformation192, False)

	@CorpActnGnlInf.deleter
	def CorpActnGnlInf(self):
		del self._CorpActnGnlInf
		self._CorpActnGnlInf = base_types.UninitialisedField(self, 'CorpActnGnlInf', CorporateActionGeneralInformation192, False)
	...
	def CorpActnMvmntDtls(self, value):
		self._CorpActnMvmntDtls = value if value is not None else base_types.UninitialisedField(self, 'CorpActnMvmntDtls', CorporateActionOption245, True)

	@CorpActnMvmntDtls.deleter
	def CorpActnMvmntDtls(self):
		del self._CorpActnMvmntDtls
		self._CorpActnMvmntDtls = base_types.UninitialisedField(self, 'CorpActnMvmntDtls', CorporateActionOption245, True)
	...
	def MvmntConfId(self, value):
		self._MvmntConfId = value if value is not None else base_types.UninitialisedField(self, 'MvmntConfId', DocumentIdentification37, False)

	@MvmntConfId.deleter
	def MvmntConfId(self):
		del self._MvmntConfId
		self._MvmntConfId = base_types.UninitialisedField(self, 'MvmntConfId', DocumentIdentification37, False)
	...
	def MvmntPrlimryAdvcGnlInf(self, value):
		self._MvmntPrlimryAdvcGnlInf = value if value is not None else base_types.UninitialisedField(self, 'MvmntPrlimryAdvcGnlInf', CorporateActionPreliminaryAdviceType5, False)

	@MvmntPrlimryAdvcGnlInf.deleter
	def MvmntPrlimryAdvcGnlInf(self):
		del self._MvmntPrlimryAdvcGnlInf
		self._MvmntPrlimryAdvcGnlInf = base_types.UninitialisedField(self, 'MvmntPrlimryAdvcGnlInf', CorporateActionPreliminaryAdviceType5, False)
	...
	def NtfctnId(self, value):
		self._NtfctnId = value if value is not None else base_types.UninitialisedField(self, 'NtfctnId', DocumentIdentification37, False)

	@NtfctnId.deleter
	def NtfctnId(self):
		del self._NtfctnId
		self._NtfctnId = base_types.UninitialisedField(self, 'NtfctnId', DocumentIdentification37, False)
	...
	def PrvsMvmntPrlimryAdvcId(self, value):
		self._PrvsMvmntPrlimryAdvcId = value if value is not None else base_types.UninitialisedField(self, 'PrvsMvmntPrlimryAdvcId', DocumentIdentification37, False)

	@PrvsMvmntPrlimryAdvcId.deleter
	def PrvsMvmntPrlimryAdvcId(self):
		del self._PrvsMvmntPrlimryAdvcId
		self._PrvsMvmntPrlimryAdvcId = base_types.UninitialisedField(self, 'PrvsMvmntPrlimryAdvcId', DocumentIdentification37, False)
	...
	def RvslRsn(self, value):
		self._RvslRsn = value if value is not None else base_types.UninitialisedField(self, 'RvslRsn', CorporateActionReversalReason9, False)

	@RvslRsn.deleter
	def RvslRsn(self):
		del self._RvslRsn
		self._RvslRsn = base_types.UninitialisedField(self, 'RvslRsn', CorporateActionReversalReason9, False)
