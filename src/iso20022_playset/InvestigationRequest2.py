...
class InvestigationRequest2(base_types._BaseFieldType):
	...
	__slots__ = ["_InvstgtnTp", "_EIR", "_MsgId", "_Rspndr", "_ReqOrgtr", "_Undrlyg", "_UndrlygInstrm", "_ReqActn", "_RqstrInvstgtnId", "_XpctdRspndr", "_InvstgtnSubTp", "_RspndrInvstgtnId", "_SvcLvl", "_Rqstr"]
	@property
	def InvstgtnTp(self):
