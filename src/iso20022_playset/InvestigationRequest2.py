...
class InvestigationRequest2(base_types._BaseFieldType):
	...
	__slots__ = ["_MsgId", "_EIR", "_Rqstr", "_XpctdRspndr", "_Rspndr", "_SvcLvl", "_InvstgtnSubTp", "_Undrlyg", "_RqstrInvstgtnId", "_InvstgtnTp", "_ReqOrgtr", "_UndrlygInstrm", "_RspndrInvstgtnId", "_ReqActn"]
	@property
	def MsgId(self):
		return self._MsgId
