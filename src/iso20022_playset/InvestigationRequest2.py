...
from .InvestigationType1Choice import InvestigationType1Choice
from .InvestigationServiceLevel1Choice import InvestigationServiceLevel1Choice
from .Party40Choice import Party40Choice
from .InvestigationSubType1Choice import InvestigationSubType1Choice
from .UnderlyingInvestigationInstrument1Choice import UnderlyingInvestigationInstrument1Choice
from .UUIDv4Identifier import UUIDv4Identifier
from .UnderlyingData2Choice import UnderlyingData2Choice
from .InvestigationRequestAction1 import InvestigationRequestAction1

class InvestigationRequest2(base_types._BaseFieldType):

	__slots__ = ["_InvstgtnSubTp", "_MsgId", "_RspndrInvstgtnId", "_XpctdRspndr", "_Rqstr", "_Rspndr", "_EIR", "_Undrlyg", "_SvcLvl", "_ReqOrgtr", "_ReqActn", "_UndrlygInstrm", "_InvstgtnTp", "_RqstrInvstgtnId"]
	@property
	...
	def InvstgtnSubTp(self, value):
		self._InvstgtnSubTp = value if type(value) != auto else self.make_default("InvstgtnSubTp")
	...
	def Rspndr(self, value):
		self._Rspndr = value if type(value) != auto else self.make_default("Rspndr")
	...
	@EIR.setter
	def EIR(self, value):
		self._EIR = value if type(value) != auto else self.make_default("EIR")
	...
	def InvstgtnTp(self, value):
		self._InvstgtnTp = value if type(value) != auto else self.make_default("InvstgtnTp")
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='Undrlyg', type=UnderlyingData2Choice, min=1, max=1, mutex_group=None, array=False),
