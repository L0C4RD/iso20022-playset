...
from . import SecuritiesTradeDetails154
from . import Statement62

class PortfolioTransferNotificationV09(base_types._BaseFieldType):
	...
	def TrfNtfctnDtls(self, value):
		self._TrfNtfctnDtls = value if value is not None else base_types.UninitialisedField(self, 'TrfNtfctnDtls', SecuritiesTradeDetails154, True)

	@TrfNtfctnDtls.deleter
	def TrfNtfctnDtls(self):
		del self._TrfNtfctnDtls
		self._TrfNtfctnDtls = base_types.UninitialisedField(self, 'TrfNtfctnDtls', SecuritiesTradeDetails154, True)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='StmtGnlDtls', type=Statement62, min=1, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='TrfNtfctnDtls', type=SecuritiesTradeDetails154, min=0, max=None, mutex_group=None, array=True),
	))