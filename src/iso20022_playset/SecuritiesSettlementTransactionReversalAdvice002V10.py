...
from .SettlementDetails209 import SettlementDetails209
...
from .AdditionalParameters32 import AdditionalParameters32
from .OtherAmounts44 import OtherAmounts44
from .CashParties40 import CashParties40

class SecuritiesSettlementTransactionReversalAdvice002V10(base_types._BaseFieldType):

	__slots__ = ["_RcvgSttlmPties", "_AddtlPhysOrRegnDtls", "_TradDtls", "_StgSttlmInstrDtls", "_OthrBizPties", "_CshPties", "_OthrAmts", "_QtyAndAcctDtls", "_DlvrgSttlmPties", "_TxIdDtls", "_FinInstrmAttrbts", "_SttldAmt", "_ConfRef", "_SplmtryData", "_SttlmParams", "_AddtlParams", "_FinInstrmId"]
	@property
