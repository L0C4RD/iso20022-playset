...
class SecuritiesSettlementTransactionReversalAdvice002V10(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrAmts", "_DlvrgSttlmPties", "_AddtlParams", "_TxIdDtls", "_QtyAndAcctDtls", "_SttldAmt", "_FinInstrmId", "_StgSttlmInstrDtls", "_RcvgSttlmPties", "_SttlmParams", "_OthrBizPties", "_TradDtls", "_FinInstrmAttrbts", "_SplmtryData", "_ConfRef", "_CshPties", "_AddtlPhysOrRegnDtls"]
	@property
	def OthrAmts(self):
