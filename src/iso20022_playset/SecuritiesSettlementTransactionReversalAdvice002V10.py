...
class SecuritiesSettlementTransactionReversalAdvice002V10(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrAmts", "_AddtlParams", "_CshPties", "_OthrBizPties", "_FinInstrmAttrbts", "_FinInstrmId", "_DlvrgSttlmPties", "_ConfRef", "_SttldAmt", "_TxIdDtls", "_QtyAndAcctDtls", "_StgSttlmInstrDtls", "_TradDtls", "_SttlmParams", "_SplmtryData", "_AddtlPhysOrRegnDtls", "_RcvgSttlmPties"]
	@property
	def OthrAmts(self):
