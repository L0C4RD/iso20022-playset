...
from . import OriginalNotificationReference14
...
class OriginalNotification16(base_types._BaseFieldType):
	...
	def OrgnlNtfctnRef(self, value):
		self._OrgnlNtfctnRef = value if value is not None else base_types.UninitialisedField(self, 'OrgnlNtfctnRef', OriginalNotificationReference14, True)

	@OrgnlNtfctnRef.deleter
	def OrgnlNtfctnRef(self):
		del self._OrgnlNtfctnRef
		self._OrgnlNtfctnRef = base_types.UninitialisedField(self, 'OrgnlNtfctnRef', OriginalNotificationReference14, True)
