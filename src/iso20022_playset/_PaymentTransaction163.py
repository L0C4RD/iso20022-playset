...
class PaymentTransaction163(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlEndToEndId", "_RtrChain", "_IntrBkSttlmDt", "_OrgnlIntrBkSttlmAmt", "_XchgRate", "_CompstnAmt", "_SttlmTmIndctn", "_OrgnlInstrId", "_InstgAgt", "_RtrId", "_PmtTpInf", "_RtrRsnInf", "_ChrgsInf", "_OrgnlGrpInf", "_OrgnlTxRef", "_ClrSysRef", "_AgrdRate", "_RtrdIntrBkSttlmAmt", "_RtrdInstdAmt", "_OrgnlUETR", "_OrgnlIntrBkSttlmDt", "_InstdAgt", "_SttlmTmReq", "_SttlmPrty", "_ChrgBr", "_SplmtryData", "_OrgnlTxId", "_OrgnlClrSysRef"]
	@property
