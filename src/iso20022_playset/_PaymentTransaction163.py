...
class PaymentTransaction163(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlEndToEndId", "_SttlmTmIndctn", "_SplmtryData", "_RtrChain", "_ChrgBr", "_OrgnlInstrId", "_OrgnlClrSysRef", "_SttlmPrty", "_RtrId", "_SttlmTmReq", "_RtrdInstdAmt", "_AgrdRate", "_OrgnlIntrBkSttlmDt", "_InstgAgt", "_PmtTpInf", "_RtrRsnInf", "_RtrdIntrBkSttlmAmt", "_OrgnlUETR", "_OrgnlGrpInf", "_ChrgsInf", "_OrgnlTxId", "_CompstnAmt", "_OrgnlTxRef", "_XchgRate", "_OrgnlIntrBkSttlmAmt", "_ClrSysRef", "_InstdAgt", "_IntrBkSttlmDt"]
	@property
