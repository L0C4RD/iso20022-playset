...
class ReceiveInformation23(base_types._BaseFieldType):

	__slots__ = ["_BnfcryCertfctnCmpltn", "_ClntRef", "_DmtrlsdInd", "_FXDtls", "_FctvSttlmDt", "_Fees", "_IncmPref", "_IndvTax", "_IntrmyInf", "_NetAmt", "_PhysTrf", "_PhysTrfDtls", "_ReqdSttlmDt", "_ReqdTradDt", "_SctiesForm", "_StmpDty", "_SttlmAmt", "_SttlmPtiesDtls", "_Trfee", "_TrfeeRegdAcct"]
	@property
	...
	def TrfeeRegdAcct(self, value):
		self._TrfeeRegdAcct = value if value is not None else base_types.UninitialisedField(self, 'TrfeeRegdAcct', Account38, False)

	@TrfeeRegdAcct.deleter
	def TrfeeRegdAcct(self):
		del self._TrfeeRegdAcct
		self._TrfeeRegdAcct = base_types.UninitialisedField(self, 'TrfeeRegdAcct', Account38, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='TrfeeRegdAcct', type=Account38, min=0, max=1, mutex_group=None, array=False),
	))