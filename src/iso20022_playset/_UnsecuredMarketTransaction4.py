...
class UnsecuredMarketTransaction4(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrPtyPrtryTxId", "_FltgRateNote", "_SplmtryData", "_CtrPtyId", "_SttlmDt", "_MtrtyDt", "_PrtryTxId", "_InstrmTp", "_RptdTxSts", "_TxTp", "_TradDt", "_NvtnSts", "_TxNmnlAmt", "_CallPutOptn", "_RateTp", "_UnqTxIdr", "_DealRate", "_BrnchId", "_RltdPrtryTxId", "_DealPric", "_BrkrdDeal"]
	@property
