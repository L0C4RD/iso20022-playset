...
class UnsecuredMarketTransaction4(base_types._BaseFieldType):
	...
	__slots__ = ["_RltdPrtryTxId", "_FltgRateNote", "_TxTp", "_TxNmnlAmt", "_CtrPtyId", "_RateTp", "_DealPric", "_TradDt", "_UnqTxIdr", "_DealRate", "_SplmtryData", "_PrtryTxId", "_NvtnSts", "_RptdTxSts", "_SttlmDt", "_InstrmTp", "_CtrPtyPrtryTxId", "_CallPutOptn", "_MtrtyDt", "_BrkrdDeal", "_BrnchId"]
	@property
