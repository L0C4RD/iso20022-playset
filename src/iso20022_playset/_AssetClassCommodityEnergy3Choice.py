...
from .EnergyCommodityLightEnd2 import EnergyCommodityLightEnd2
from .EnergyCommodityOil3 import EnergyCommodityOil3
from .EnergyCommodityRenewableEnergy2 import EnergyCommodityRenewableEnergy2
from .EnergyCommodityInterEnergy2 import EnergyCommodityInterEnergy2
from .EnergyCommodityCoal2 import EnergyCommodityCoal2
from .EnergyCommodityDistillates2 import EnergyCommodityDistillates2
from .EnergyCommodityElectricity2 import EnergyCommodityElectricity2
from .EnergyCommodityOther2 import EnergyCommodityOther2
from .EnergyCommodityNaturalGas3 import EnergyCommodityNaturalGas3

class AssetClassCommodityEnergy3Choice(base_types._BaseFieldType):

	__slots__ = ["_Coal", "_RnwblNrgy", "_Othr", "_Oil", "_LghtEnd", "_NtrlGas", "_Dstllts", "_Elctrcty", "_IntrNrgy"]
	@property
	def Coal(self):
		return self._Coal
