...
class TransactionDetails164(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmTxOrCorpActnEvtTp", "_LateDlvryDt", "_TxActvty", "_DlvrgSttlmPties", "_MtchdStsTmStmp", "_TradDt", "_TxAddtlDtls", "_Pmt", "_PlcOfTrad", "_XpctdSttlmDt", "_SttlmParams", "_AckdStsTmStmp", "_SctiesMvmntTp", "_PstngAmt", "_RcvgSttlmPties", "_PlcOfClr", "_SttlmDt", "_SplmtryData", "_PstngQty", "_SfkpgPlc", "_XpctdValDt", "_PrtlyRlsdQty", "_FinInstrmId"]
	@property
