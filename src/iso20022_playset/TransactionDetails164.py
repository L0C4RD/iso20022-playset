...
from .SettlementDetails197 import SettlementDetails197
from .SettlementOrCorporateActionEvent32Choice import SettlementOrCorporateActionEvent32Choice
...
class TransactionDetails164(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmTxOrCorpActnEvtTp", "_MtchdStsTmStmp", "_FinInstrmId", "_SctiesMvmntTp", "_AckdStsTmStmp", "_TxAddtlDtls", "_XpctdValDt", "_LateDlvryDt", "_PstngAmt", "_SttlmParams", "_XpctdSttlmDt", "_RcvgSttlmPties", "_PstngQty", "_TxActvty", "_SttlmDt", "_TradDt", "_PlcOfTrad", "_PlcOfClr", "_PrtlyRlsdQty", "_DlvrgSttlmPties", "_SplmtryData", "_SfkpgPlc", "_Pmt"]
	@property
