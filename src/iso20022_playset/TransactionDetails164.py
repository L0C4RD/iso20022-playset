...
class TransactionDetails164(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmDt", "_FinInstrmId", "_XpctdValDt", "_PlcOfClr", "_TradDt", "_PstngQty", "_LateDlvryDt", "_SfkpgPlc", "_SttlmParams", "_TxActvty", "_SctiesMvmntTp", "_TxAddtlDtls", "_SttlmTxOrCorpActnEvtTp", "_PlcOfTrad", "_AckdStsTmStmp", "_XpctdSttlmDt", "_RcvgSttlmPties", "_Pmt", "_PrtlyRlsdQty", "_DlvrgSttlmPties", "_MtchdStsTmStmp", "_SplmtryData", "_PstngAmt"]
	@property
	def SttlmDt(self):
