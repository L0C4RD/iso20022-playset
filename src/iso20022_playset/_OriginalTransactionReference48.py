...
from . import ISODate
from . import MandateRelatedData4Choice
...
from . import RemittanceInformation21
from . import SettlementInstruction11

class OriginalTransactionReference48(base_types._BaseFieldType):
	...
	def CdtrSchmeId(self, value):
		self._CdtrSchmeId = value if value is not None else base_types.UninitialisedField(self, 'CdtrSchmeId', PartyIdentification135, False)

	@CdtrSchmeId.deleter
	def CdtrSchmeId(self):
		del self._CdtrSchmeId
		self._CdtrSchmeId = base_types.UninitialisedField(self, 'CdtrSchmeId', PartyIdentification135, False)
	...
	def MndtRltdInf(self, value):
		self._MndtRltdInf = value if value is not None else base_types.UninitialisedField(self, 'MndtRltdInf', MandateRelatedData4Choice, False)

	@MndtRltdInf.deleter
	def MndtRltdInf(self):
		del self._MndtRltdInf
		self._MndtRltdInf = base_types.UninitialisedField(self, 'MndtRltdInf', MandateRelatedData4Choice, False)
	...
	def RmtInf(self, value):
		self._RmtInf = value if value is not None else base_types.UninitialisedField(self, 'RmtInf', RemittanceInformation21, False)

	@RmtInf.deleter
	def RmtInf(self):
		del self._RmtInf
		self._RmtInf = base_types.UninitialisedField(self, 'RmtInf', RemittanceInformation21, False)
	...
	def SttlmInf(self, value):
		self._SttlmInf = value if value is not None else base_types.UninitialisedField(self, 'SttlmInf', SettlementInstruction11, False)

	@SttlmInf.deleter
	def SttlmInf(self):
		del self._SttlmInf
		self._SttlmInf = base_types.UninitialisedField(self, 'SttlmInf', SettlementInstruction11, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='CdtrSchmeId', type=PartyIdentification135, min=0, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='MndtRltdInf', type=MandateRelatedData4Choice, min=0, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='RmtInf', type=RemittanceInformation21, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='SttlmInf', type=SettlementInstruction11, min=0, max=1, mutex_group=None, array=False),
