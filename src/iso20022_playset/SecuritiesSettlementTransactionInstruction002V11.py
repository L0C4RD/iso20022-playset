...
class SecuritiesSettlementTransactionInstruction002V11(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmParams", "_OthrBizPties", "_SplmtryData", "_Lnkgs", "_RcvgSttlmPties", "_AddtlPhysOrRegnDtls", "_TradDtls", "_TxId", "_FinInstrmId", "_SttlmAmt", "_NbCounts", "_SttlmTpAndAddtlParams", "_FinInstrmAttrbts", "_DlvrgSttlmPties", "_QtyAndAcctDtls", "_StgSttlmInstrDtls", "_OthrAmts", "_CshPties"]
	@property
