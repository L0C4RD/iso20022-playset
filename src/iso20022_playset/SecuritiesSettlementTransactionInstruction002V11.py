...
class SecuritiesSettlementTransactionInstruction002V11(base_types._BaseFieldType):
	...
	__slots__ = ["_CshPties", "_FinInstrmId", "_OthrBizPties", "_NbCounts", "_AddtlPhysOrRegnDtls", "_OthrAmts", "_RcvgSttlmPties", "_FinInstrmAttrbts", "_DlvrgSttlmPties", "_TradDtls", "_SttlmAmt", "_Lnkgs", "_QtyAndAcctDtls", "_SttlmParams", "_SttlmTpAndAddtlParams", "_TxId", "_StgSttlmInstrDtls", "_SplmtryData"]
	@property
	def CshPties(self):
