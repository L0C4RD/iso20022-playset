...
class SecuritiesSettlementTransactionInstruction002V11(base_types._BaseFieldType):
	...
	__slots__ = ["_Lnkgs", "_AddtlPhysOrRegnDtls", "_OthrAmts", "_FinInstrmAttrbts", "_QtyAndAcctDtls", "_OthrBizPties", "_DlvrgSttlmPties", "_CshPties", "_RcvgSttlmPties", "_SttlmTpAndAddtlParams", "_SttlmAmt", "_TxId", "_FinInstrmId", "_TradDtls", "_StgSttlmInstrDtls", "_SplmtryData", "_SttlmParams", "_NbCounts"]
	@property
	def Lnkgs(self):
		return self._Lnkgs
