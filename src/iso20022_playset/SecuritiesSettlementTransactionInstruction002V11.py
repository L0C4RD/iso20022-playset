...
class SecuritiesSettlementTransactionInstruction002V11(base_types._BaseFieldType):
	...
	__slots__ = ["_RcvgSttlmPties", "_CshPties", "_AddtlPhysOrRegnDtls", "_SttlmParams", "_StgSttlmInstrDtls", "_SttlmAmt", "_Lnkgs", "_OthrBizPties", "_TradDtls", "_NbCounts", "_TxId", "_DlvrgSttlmPties", "_FinInstrmAttrbts", "_SplmtryData", "_QtyAndAcctDtls", "_OthrAmts", "_SttlmTpAndAddtlParams", "_FinInstrmId"]
	@property
