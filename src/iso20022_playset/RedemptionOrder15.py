...
class RedemptionOrder15(base_types._BaseFieldType):
	...
	__slots__ = ["_TxOvrhd", "_ClntRef", "_PhysDlvryDtls", "_TxChanlTp", "_OrdrTp", "_Grp1Or2Units", "_NonStdSttlmInf", "_RltdPtyDtls", "_BnfcryDtls", "_OrdrWvrDtls", "_SttlmAmt", "_IncmPref", "_FinAdvc", "_CshSttlmDt", "_StffClntBrkdwn", "_AmtOrUnitsOrPctg", "_PhysDlvryInd", "_OrdrRef", "_NgtdTrad", "_FXDtls", "_InvstmtAcctDtls", "_SttlmMtd", "_CstmrCndctClssfctn", "_SgntrTp", "_CshSttlmDtls", "_Rndg", "_Equlstn", "_SttlmAndCtdyDtls"]
	@property
	def TxOvrhd(self):
