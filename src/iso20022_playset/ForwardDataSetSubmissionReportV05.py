...
class ForwardDataSetSubmissionReportV05(base_types._BaseFieldType):
	...
	__slots__ = ["_Submitr", "_ComrclDataSet", "_CmonSubmissnRef", "_TrnsprtDataSet", "_OthrCertDataSet", "_RptId", "_InsrncDataSet", "_CertDataSet", "_ReqForActn", "_BuyrBk", "_RltdTxRefs", "_SellrBk"]
	@property
	def Submitr(self):
