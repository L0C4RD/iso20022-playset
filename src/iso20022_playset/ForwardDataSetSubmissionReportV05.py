...
class ForwardDataSetSubmissionReportV05(base_types._BaseFieldType):
	...
	__slots__ = ["_TrnsprtDataSet", "_ReqForActn", "_OthrCertDataSet", "_CertDataSet", "_RltdTxRefs", "_Submitr", "_BuyrBk", "_InsrncDataSet", "_RptId", "_CmonSubmissnRef", "_SellrBk", "_ComrclDataSet"]
	@property
