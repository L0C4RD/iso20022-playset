...
class ForwardDataSetSubmissionReportV05(base_types._BaseFieldType):
	...
	__slots__ = ["_InsrncDataSet", "_ReqForActn", "_SellrBk", "_OthrCertDataSet", "_BuyrBk", "_TrnsprtDataSet", "_CmonSubmissnRef", "_Submitr", "_ComrclDataSet", "_CertDataSet", "_RptId", "_RltdTxRefs"]
	@property
