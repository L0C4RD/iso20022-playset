...
from .SettlementDetails184 import SettlementDetails184
from .SettlementParties125 import SettlementParties125
from .SettlementOrCorporateActionEvent34Choice import SettlementOrCorporateActionEvent34Choice
from .ReceiveDelivery1Code import ReceiveDelivery1Code

class TransactionDetails170(base_types._BaseFieldType):

	__slots__ = ["_AckdStsTmStmp", "_XpctdValDt", "_SplmtryData", "_PlcOfTrad", "_DlvrgSttlmPties", "_PrtlyRlsdQty", "_Pmt", "_PstngAmt", "_RcvgSttlmPties", "_SttlmParams", "_SfkpgPlc", "_TxAddtlDtls", "_SttlmDt", "_TradDt", "_XpctdSttlmDt", "_MtchdStsTmStmp", "_FinInstrmId", "_SttlmTxOrCorpActnEvtTp", "_SctiesMvmntTp", "_PstngQty", "_LateDlvryDt", "_TxActvty", "_PlcOfClr"]
	@property
