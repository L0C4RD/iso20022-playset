...
class TransactionDetails170(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmDt", "_DlvrgSttlmPties", "_LateDlvryDt", "_PlcOfClr", "_XpctdSttlmDt", "_SctiesMvmntTp", "_TradDt", "_Pmt", "_SfkpgPlc", "_PstngQty", "_MtchdStsTmStmp", "_TxAddtlDtls", "_PrtlyRlsdQty", "_AckdStsTmStmp", "_PlcOfTrad", "_TxActvty", "_RcvgSttlmPties", "_PstngAmt", "_SttlmTxOrCorpActnEvtTp", "_SttlmParams", "_SplmtryData", "_FinInstrmId", "_XpctdValDt"]
	@property
	def SttlmDt(self):
