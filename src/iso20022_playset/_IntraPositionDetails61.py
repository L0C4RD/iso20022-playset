...
class IntraPositionDetails61(base_types._BaseFieldType):
	...
	__slots__ = ["_SctiesSubBalId", "_CorpActnEvtTp", "_BalTo", "_AvlblDt", "_PrevslySttldQty", "_SttlmDt", "_BalFr", "_CollMntrAmt", "_RmngToBeSttldQty", "_SttldQty", "_InstrPrcgAddtlDtls"]
	@property
