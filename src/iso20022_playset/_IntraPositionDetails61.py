...
class IntraPositionDetails61(base_types._BaseFieldType):
	...
	__slots__ = ["_CollMntrAmt", "_PrevslySttldQty", "_CorpActnEvtTp", "_SttldQty", "_SctiesSubBalId", "_SttlmDt", "_AvlblDt", "_RmngToBeSttldQty", "_BalFr", "_BalTo", "_InstrPrcgAddtlDtls"]
	@property
