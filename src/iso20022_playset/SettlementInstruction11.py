...
class SettlementInstruction11(base_types._BaseFieldType):
	...
	__slots__ = ["_ClrSys", "_ThrdRmbrsmntAgt", "_InstdRmbrsmntAgt", "_InstgRmbrsmntAgtAcct", "_InstdRmbrsmntAgtAcct", "_ThrdRmbrsmntAgtAcct", "_SttlmMtd", "_InstgRmbrsmntAgt", "_SttlmAcct"]
	@property
	def ClrSys(self):
		return self._ClrSys
