...
class SettlementInstruction11(base_types._BaseFieldType):
	...
	__slots__ = ["_ThrdRmbrsmntAgtAcct", "_SttlmMtd", "_ThrdRmbrsmntAgt", "_SttlmAcct", "_InstgRmbrsmntAgtAcct", "_ClrSys", "_InstgRmbrsmntAgt", "_InstdRmbrsmntAgt", "_InstdRmbrsmntAgtAcct"]
	@property
