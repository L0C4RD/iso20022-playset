...
class Token1(base_types._BaseFieldType):
	...
	def TknXpryDt(self, value):
		self._TknXpryDt = value if value is not None else base_types.UninitialisedField(self, 'TknXpryDt', Exact4NumericText, False)

	@TknXpryDt.deleter
	def TknXpryDt(self):
		del self._TknXpryDt
		self._TknXpryDt = base_types.UninitialisedField(self, 'TknXpryDt', Exact4NumericText, False)
