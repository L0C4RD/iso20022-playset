...
class CashOption113(base_types._BaseFieldType):
	...
	__slots__ = ["_RateAndAmtDtls", "_XmptnTp", "_DtDtls", "_IssrOfferrTaxbltyInd", "_IncmTp", "_PricClctnMtd", "_NonElgblPrcdsInd", "_OthrIncmTp", "_AmtDtls", "_CtryOfIncmSrc", "_CtrctlPmtInd", "_CshAcctId", "_PricDtls", "_CdtDbtInd", "_FXDtls"]
	@property
