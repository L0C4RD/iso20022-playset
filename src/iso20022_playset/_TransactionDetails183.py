...
class TransactionDetails183(base_types._BaseFieldType):

	__slots__ = ["_BlckChainAdrOrWllt", "_DgtlPmtSttlm", "_DlvrgSttlmPties", "_FinInstrmId", "_Invstr", "_Pmt", "_RcvgSttlmPties", "_SctiesMvmntTp", "_SfkpgAcct", "_SttlmAmt", "_SttlmDt", "_SttlmQty", "_TradDt"]
	@property
