...
class CardholderAuthentication17(base_types._BaseFieldType):
	...
	__slots__ = ["_AuthntcnMtd", "_AuthntcnLvl", "_AuthntcnRslt", "_PrtctdAuthntcnVal", "_AuthntcnVal", "_AuthntcnAddtlInf", "_AuthntcnXmptn", "_AuthntcnTp", "_CrdhldrOnLinePIN", "_CrdhldrId", "_AdrVrfctn"]
	@property
