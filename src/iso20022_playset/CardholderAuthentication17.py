...
class CardholderAuthentication17(base_types._BaseFieldType):
	...
	__slots__ = ["_AuthntcnLvl", "_AuthntcnTp", "_AuthntcnVal", "_CrdhldrId", "_AdrVrfctn", "_AuthntcnMtd", "_AuthntcnRslt", "_PrtctdAuthntcnVal", "_CrdhldrOnLinePIN", "_AuthntcnXmptn", "_AuthntcnAddtlInf"]
	@property
