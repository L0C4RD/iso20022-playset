...
class AcquirerProtocolParameters17(base_types._BaseFieldType):
	...
	__slots__ = ["_CmpltnAdvcMndtd", "_RcncltnErr", "_AmtQlfrForRsvatn", "_NtfyOffLineCxl", "_MndtrySctyTrlr", "_BtchDgtlSgntr", "_RcncltnByAcqrr", "_TtlsPerCcy", "_CardDataVrfctn", "_MsgItm", "_SpltTtlCrit", "_ApplId", "_PrtctCardData", "_BtchTrfCntt", "_OnLineTx", "_ActnTp", "_Hst", "_PrvtCardData", "_Vrsn", "_RcncltnXchg", "_SpltTtls", "_OffLineTx", "_AcqrrId", "_FileTrfBtch"]
	@property
