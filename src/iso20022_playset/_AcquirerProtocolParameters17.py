...
class AcquirerProtocolParameters17(base_types._BaseFieldType):
	...
	__slots__ = ["_Vrsn", "_TtlsPerCcy", "_CardDataVrfctn", "_NtfyOffLineCxl", "_RcncltnByAcqrr", "_OffLineTx", "_SpltTtls", "_AcqrrId", "_Hst", "_OnLineTx", "_CmpltnAdvcMndtd", "_ActnTp", "_PrvtCardData", "_ApplId", "_RcncltnXchg", "_BtchTrfCntt", "_PrtctCardData", "_BtchDgtlSgntr", "_AmtQlfrForRsvatn", "_MsgItm", "_FileTrfBtch", "_RcncltnErr", "_SpltTtlCrit", "_MndtrySctyTrlr"]
	@property
	def Vrsn(self):
		return self._Vrsn
