...
class ChargesPerTypeRecord5(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlInf", "_DbtrAgt", "_ChrgsAcct", "_Amt", "_CdtDbtInd", "_ValDt", "_ChrgsAcctOwnr", "_Dbtr", "_DbtrAcct", "_RcrdId", "_DbtrAgtAcct", "_InstrForInstdAgt", "_ChrgsRqstr", "_UndrlygTx"]
	@property
	def AddtlInf(self):
