...
class ChargesPerTypeRecord5(base_types._BaseFieldType):
	...
	__slots__ = ["_ChrgsAcct", "_UndrlygTx", "_ValDt", "_ChrgsAcctOwnr", "_DbtrAgt", "_AddtlInf", "_ChrgsRqstr", "_InstrForInstdAgt", "_DbtrAgtAcct", "_CdtDbtInd", "_Amt", "_Dbtr", "_RcrdId", "_DbtrAcct"]
	@property
	def ChrgsAcct(self):
