...
class TransactionReferences7(base_types._BaseFieldType):
	...
	__slots__ = ["_MsgNmId", "_InstrId", "_TxId", "_ChqNb", "_EndToEndId", "_PmtInfId", "_Prtry", "_AcctSvcrTxId", "_AcctSvcrRef", "_AcctOwnrTxId", "_UETR", "_MndtId", "_ClrSysRef", "_PrcgId", "_MktInfrstrctrTxId", "_MsgId"]
	@property
	def MsgNmId(self):
