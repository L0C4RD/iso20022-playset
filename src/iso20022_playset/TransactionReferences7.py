...
class TransactionReferences7(base_types._BaseFieldType):
	...
	__slots__ = ["_MsgId", "_AcctSvcrTxId", "_MktInfrstrctrTxId", "_ChqNb", "_ClrSysRef", "_PmtInfId", "_MsgNmId", "_PrcgId", "_UETR", "_EndToEndId", "_AcctOwnrTxId", "_InstrId", "_Prtry", "_AcctSvcrRef", "_MndtId", "_TxId"]
	@property
	def MsgId(self):
		return self._MsgId
