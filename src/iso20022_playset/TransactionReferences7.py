...
class TransactionReferences7(base_types._BaseFieldType):
	...
	__slots__ = ["_Prtry", "_AcctOwnrTxId", "_MndtId", "_AcctSvcrTxId", "_EndToEndId", "_InstrId", "_ChqNb", "_MsgNmId", "_PrcgId", "_AcctSvcrRef", "_MsgId", "_ClrSysRef", "_PmtInfId", "_TxId", "_UETR", "_MktInfrstrctrTxId"]
	@property
	def Prtry(self):
		return self._Prtry
