...
class TransactionReferences7(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctSvcrRef", "_PrcgId", "_EndToEndId", "_TxId", "_MndtId", "_ClrSysRef", "_ChqNb", "_AcctSvcrTxId", "_UETR", "_MsgId", "_InstrId", "_MsgNmId", "_MktInfrstrctrTxId", "_AcctOwnrTxId", "_PmtInfId", "_Prtry"]
	@property
