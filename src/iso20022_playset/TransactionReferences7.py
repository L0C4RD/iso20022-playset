...
class TransactionReferences7(base_types._BaseFieldType):
	...
	__slots__ = ["_MndtId", "_UETR", "_MktInfrstrctrTxId", "_MsgId", "_PmtInfId", "_ClrSysRef", "_ChqNb", "_EndToEndId", "_AcctSvcrRef", "_Prtry", "_InstrId", "_TxId", "_AcctSvcrTxId", "_MsgNmId", "_AcctOwnrTxId", "_PrcgId"]
	@property
	def MndtId(self):
		return self._MndtId
