...
class TransactionReferences7(base_types._BaseFieldType):
	...
	__slots__ = ["_ChqNb", "_AcctSvcrRef", "_UETR", "_PrcgId", "_MndtId", "_ClrSysRef", "_AcctOwnrTxId", "_MktInfrstrctrTxId", "_EndToEndId", "_InstrId", "_Prtry", "_TxId", "_PmtInfId", "_AcctSvcrTxId", "_MsgNmId", "_MsgId"]
	@property
	def ChqNb(self):
		return self._ChqNb
