...
class ForwardDataSetSubmissionReportV05(base_types._BaseFieldType):
	...
	__slots__ = ["_BuyrBk", "_RltdTxRefs", "_SellrBk", "_TrnsprtDataSet", "_CertDataSet", "_OthrCertDataSet", "_CmonSubmissnRef", "_Submitr", "_RptId", "_ComrclDataSet", "_ReqForActn", "_InsrncDataSet"]
	@property
	def BuyrBk(self):
		return self._BuyrBk
