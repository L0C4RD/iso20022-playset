...
class ForwardDataSetSubmissionReportV05(base_types._BaseFieldType):
	...
	__slots__ = ["_BuyrBk", "_InsrncDataSet", "_RptId", "_OthrCertDataSet", "_ReqForActn", "_RltdTxRefs", "_CertDataSet", "_Submitr", "_SellrBk", "_CmonSubmissnRef", "_ComrclDataSet", "_TrnsprtDataSet"]
	@property
	def BuyrBk(self):
		return self._BuyrBk
