...
from .RevaluationIndicator3Choice import RevaluationIndicator3Choice

class SecuritiesFinancingTransactionDetails58(base_types._BaseFieldType):

	__slots__ = ["_TermntnDt", "_StockLnMrgn", "_ScndLegNrrtv", "_ComssnClctnDt", "_ClsgLegId", "_EarlstCallBckDt", "_SctiesHrcut", "_SctiesFincgTradId", "_TxCallDely", "_TermntnAmtPerPcOfColl", "_PrmAmt", "_IntrstPmt", "_SctiesFincgUnqTxIdr", "_RpRate", "_LglFrmwk", "_PricgRate", "_ChrgsRate", "_LclBrkrComssn", "_Rvaltn", "_IntrstCmptnMtd", "_AcrdIntrstAmt", "_RateChngDt", "_VarblRateSpprt", "_Sprd", "_MtrtyDtMod", "_FrftAmt", "_TtlNbOfCollInstrs", "_RateTp", "_TermntnTxAmt", "_DealAmt"]
	@property
	def TermntnDt(self):
