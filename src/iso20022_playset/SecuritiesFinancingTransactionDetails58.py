...
class SecuritiesFinancingTransactionDetails58(base_types._BaseFieldType):
	...
	__slots__ = ["_ScndLegNrrtv", "_LclBrkrComssn", "_TermntnTxAmt", "_TermntnAmtPerPcOfColl", "_FrftAmt", "_RateChngDt", "_StockLnMrgn", "_ChrgsRate", "_DealAmt", "_AcrdIntrstAmt", "_VarblRateSpprt", "_Sprd", "_TxCallDely", "_EarlstCallBckDt", "_Rvaltn", "_IntrstCmptnMtd", "_PricgRate", "_ComssnClctnDt", "_SctiesFincgUnqTxIdr", "_SctiesFincgTradId", "_PrmAmt", "_MtrtyDtMod", "_ClsgLegId", "_RateTp", "_LglFrmwk", "_TermntnDt", "_IntrstPmt", "_TtlNbOfCollInstrs", "_RpRate", "_SctiesHrcut"]
	@property
