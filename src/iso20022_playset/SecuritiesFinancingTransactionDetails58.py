...
import RevaluationIndicator3Choice
...
class SecuritiesFinancingTransactionDetails58(base_types._BaseFieldType):
	...
	__slots__ = ["_TermntnTxAmt", "_LglFrmwk", "_ClsgLegId", "_RateTp", "_IntrstCmptnMtd", "_StockLnMrgn", "_PrmAmt", "_ScndLegNrrtv", "_SctiesFincgTradId", "_IntrstPmt", "_DealAmt", "_TermntnAmtPerPcOfColl", "_SctiesHrcut", "_SctiesFincgUnqTxIdr", "_VarblRateSpprt", "_EarlstCallBckDt", "_MtrtyDtMod", "_PricgRate", "_ComssnClctnDt", "_Sprd", "_TtlNbOfCollInstrs", "_LclBrkrComssn", "_TxCallDely", "_AcrdIntrstAmt", "_FrftAmt", "_TermntnDt", "_Rvaltn", "_RateChngDt", "_RpRate", "_ChrgsRate"]
	@property
