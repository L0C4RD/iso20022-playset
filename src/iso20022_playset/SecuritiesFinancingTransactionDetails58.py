...
class SecuritiesFinancingTransactionDetails58(base_types._BaseFieldType):
	...
	__slots__ = ["_LglFrmwk", "_VarblRateSpprt", "_TermntnAmtPerPcOfColl", "_EarlstCallBckDt", "_Sprd", "_PrmAmt", "_StockLnMrgn", "_IntrstCmptnMtd", "_PricgRate", "_FrftAmt", "_TtlNbOfCollInstrs", "_RateTp", "_ScndLegNrrtv", "_LclBrkrComssn", "_SctiesHrcut", "_IntrstPmt", "_AcrdIntrstAmt", "_DealAmt", "_RpRate", "_ComssnClctnDt", "_ChrgsRate", "_TxCallDely", "_ClsgLegId", "_SctiesFincgUnqTxIdr", "_Rvaltn", "_TermntnDt", "_SctiesFincgTradId", "_TermntnTxAmt", "_RateChngDt", "_MtrtyDtMod"]
	@property
	def LglFrmwk(self):
