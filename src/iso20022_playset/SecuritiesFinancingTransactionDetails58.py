...
class SecuritiesFinancingTransactionDetails58(base_types._BaseFieldType):
	...
	__slots__ = ["_IntrstCmptnMtd", "_FrftAmt", "_TermntnTxAmt", "_VarblRateSpprt", "_RateChngDt", "_MtrtyDtMod", "_TermntnAmtPerPcOfColl", "_PricgRate", "_TtlNbOfCollInstrs", "_Sprd", "_LclBrkrComssn", "_LglFrmwk", "_SctiesHrcut", "_SctiesFincgTradId", "_TermntnDt", "_TxCallDely", "_Rvaltn", "_PrmAmt", "_IntrstPmt", "_EarlstCallBckDt", "_StockLnMrgn", "_ScndLegNrrtv", "_SctiesFincgUnqTxIdr", "_RpRate", "_DealAmt", "_ComssnClctnDt", "_ChrgsRate", "_RateTp", "_ClsgLegId", "_AcrdIntrstAmt"]
	@property
