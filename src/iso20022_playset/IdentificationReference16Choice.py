...
class IdentificationReference16Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_IndxId", "_ExctgPtyTxId", "_CollTxId", "_CmonId", "_InstgPtyTxId", "_AllcnId", "_ScndryAllcnId", "_IndvAllcnId", "_CxlReqId", "_UnqTxIdr", "_MktInfrstrctrTxId", "_BlckId", "_PoolId", "_CmplcId", "_ClntOrdrLkId"]
	@property
	def IndxId(self):
		return self._IndxId
