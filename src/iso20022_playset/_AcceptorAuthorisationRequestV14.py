...
from . import AcceptorAuthorisationRequest14
...
class AcceptorAuthorisationRequestV14(base_types._BaseFieldType):
	...
	def AuthstnReq(self, value):
		self._AuthstnReq = value if value is not None else base_types.UninitialisedField(self, 'AuthstnReq', AcceptorAuthorisationRequest14, False)

	@AuthstnReq.deleter
	def AuthstnReq(self):
		del self._AuthstnReq
		self._AuthstnReq = base_types.UninitialisedField(self, 'AuthstnReq', AcceptorAuthorisationRequest14, False)
