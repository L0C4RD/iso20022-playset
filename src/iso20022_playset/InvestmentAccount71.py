...
class InvestmentAccount71(base_types._BaseFieldType):
	...
	__slots__ = ["_IntrmyInf", "_SubAcctDtls", "_OwnrId", "_AcctDsgnt", "_SctiesForm", "_IncmPref", "_BnfcryCertfctnCmpltn", "_AcctId", "_SttlmPtiesDtls", "_AcctNm", "_DmtrlsdInd", "_SfkpgPlc", "_AcctSvcr"]
	@property
	def IntrmyInf(self):
