...
class InvestmentAccount71(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctNm", "_SttlmPtiesDtls", "_SubAcctDtls", "_AcctSvcr", "_SctiesForm", "_BnfcryCertfctnCmpltn", "_AcctDsgnt", "_SfkpgPlc", "_AcctId", "_OwnrId", "_IncmPref", "_DmtrlsdInd", "_IntrmyInf"]
	@property
	def AcctNm(self):
		return self._AcctNm
