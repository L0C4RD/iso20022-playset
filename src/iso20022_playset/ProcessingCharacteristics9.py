...
class ProcessingCharacteristics9(base_types._BaseFieldType):
	...
	__slots__ = ["_DealConfTm", "_DealgFrqcy", "_UnitsInd", "_AddtlInf", "_SttlmCycl", "_AmtInd", "_LtdPrd", "_DealgCutOffTm", "_DealConfTmFrame", "_Rndg", "_DealgFrqcyDesc", "_MainFndOrdrDskLctn", "_SwtchAuthstn", "_DealgCcyAccptd", "_DealgCutOffTmFrame"]
	@property
	def DealConfTm(self):
