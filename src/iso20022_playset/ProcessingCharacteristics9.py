...
class ProcessingCharacteristics9(base_types._BaseFieldType):
	...
	__slots__ = ["_DealgFrqcyDesc", "_SttlmCycl", "_DealgFrqcy", "_LtdPrd", "_DealConfTm", "_DealConfTmFrame", "_UnitsInd", "_DealgCcyAccptd", "_AmtInd", "_DealgCutOffTm", "_SwtchAuthstn", "_DealgCutOffTmFrame", "_AddtlInf", "_Rndg", "_MainFndOrdrDskLctn"]
	@property
