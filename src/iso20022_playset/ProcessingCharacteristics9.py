...
class ProcessingCharacteristics9(base_types._BaseFieldType):
	...
	__slots__ = ["_Rndg", "_MainFndOrdrDskLctn", "_DealgCutOffTmFrame", "_DealConfTmFrame", "_SttlmCycl", "_AddtlInf", "_UnitsInd", "_DealgCcyAccptd", "_DealgCutOffTm", "_DealgFrqcy", "_DealConfTm", "_SwtchAuthstn", "_DealgFrqcyDesc", "_LtdPrd", "_AmtInd"]
	@property
	def Rndg(self):
		return self._Rndg
	...
	def SwtchAuthstn(self, value):
		self._SwtchAuthstn = value if type(value) != auto else self.make_default("SwtchAuthstn")
