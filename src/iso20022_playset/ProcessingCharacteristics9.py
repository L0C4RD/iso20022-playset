...
class ProcessingCharacteristics9(base_types._BaseFieldType):
	...
	__slots__ = ["_DealgFrqcyDesc", "_DealgFrqcy", "_DealConfTm", "_SwtchAuthstn", "_DealgCutOffTmFrame", "_DealgCcyAccptd", "_SttlmCycl", "_AddtlInf", "_LtdPrd", "_DealConfTmFrame", "_AmtInd", "_UnitsInd", "_DealgCutOffTm", "_Rndg", "_MainFndOrdrDskLctn"]
	@property
