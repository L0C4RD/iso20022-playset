...
class AccountNotification24(base_types._BaseFieldType):
	...
	__slots__ = ["_Ntry", "_RptgSeq", "_FrToDt", "_RltdAcct", "_RptgSrc", "_TxsSummry", "_Id", "_NtfctnPgntn", "_LglSeqNb", "_CpyDplctInd", "_Intrst", "_Acct", "_AddtlNtfctnInf", "_ElctrncSeqNb", "_CreDtTm"]
	@property
	def Ntry(self):
		return self._Ntry
