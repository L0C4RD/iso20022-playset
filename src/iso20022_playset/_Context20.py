...
class Context20(base_types._BaseFieldType):
	...
	__slots__ = ["_CardDataNtryMd", "_OthrMrchntCtgy", "_DelydAuthstn", "_QRCdPresntmntMd", "_CrdhldrActvtd", "_Trnst", "_EComrcData", "_TempScrCardDataReusd", "_PmtCrdntlMrchntRltsh", "_MrchntCtgyCd", "_DelydChrgs", "_Attndd", "_TxInitr", "_UattnddLvlCtgy", "_NoShow", "_OthrSctyChrtcs", "_ReSubmissn", "_EComrcIndPropsd", "_Reauthstn", "_EComrc", "_MrchntCtgySpcfcData", "_TrnspndrInittd", "_CardPres", "_SctyChrtcs", "_EComrcIndApld", "_MOTOCd", "_CrdhldrPres", "_PrtlApprvlSpprtd", "_StorgLctn", "_OthrQRCdPresntmntMd", "_OthrCardDataNtryMd", "_PrtlShipmnt"]
	@property
