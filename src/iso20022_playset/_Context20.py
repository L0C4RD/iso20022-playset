...
class Context20(base_types._BaseFieldType):
	...
	__slots__ = ["_EComrc", "_SctyChrtcs", "_TempScrCardDataReusd", "_TxInitr", "_PrtlApprvlSpprtd", "_StorgLctn", "_QRCdPresntmntMd", "_PmtCrdntlMrchntRltsh", "_Attndd", "_CardDataNtryMd", "_EComrcIndPropsd", "_OthrQRCdPresntmntMd", "_UattnddLvlCtgy", "_MOTOCd", "_PrtlShipmnt", "_TrnspndrInittd", "_MrchntCtgyCd", "_OthrMrchntCtgy", "_EComrcData", "_CardPres", "_MrchntCtgySpcfcData", "_ReSubmissn", "_Reauthstn", "_NoShow", "_Trnst", "_CrdhldrActvtd", "_OthrCardDataNtryMd", "_DelydChrgs", "_EComrcIndApld", "_OthrSctyChrtcs", "_DelydAuthstn", "_CrdhldrPres"]
	@property
	def EComrc(self):
		return self._EComrc
