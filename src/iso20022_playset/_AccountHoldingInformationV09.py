...
class AccountHoldingInformationV09(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrCorpInvstr", "_PmryIndvInvstr", "_ScndryCorpInvstr", "_Trfee", "_PoolRef", "_BizFlowDrctnTp", "_RltdRef", "_PrvsRef", "_MktPrctcVrsn", "_NmneeAcct", "_TrfrAcct", "_PdctTrf", "_PmryCorpInvstr", "_MsgRef", "_OthrIndvInvstr", "_Xtnsn", "_ScndryIndvInvstr"]
	@property
