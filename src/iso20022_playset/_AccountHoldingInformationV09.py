...
class AccountHoldingInformationV09(base_types._BaseFieldType):
	...
	__slots__ = ["_RltdRef", "_PdctTrf", "_OthrIndvInvstr", "_PrvsRef", "_PmryCorpInvstr", "_BizFlowDrctnTp", "_MktPrctcVrsn", "_ScndryCorpInvstr", "_Xtnsn", "_OthrCorpInvstr", "_PmryIndvInvstr", "_TrfrAcct", "_ScndryIndvInvstr", "_Trfee", "_NmneeAcct", "_MsgRef", "_PoolRef"]
	@property
	def RltdRef(self):
