...
class MessageStatusResponseData10(base_types._BaseFieldType):
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='RpeatdPmtRspn', type=PaymentResponse8, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='RpeatdRvslRspn', type=ReversalResponse10, min=0, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='RpeatdStordValRspn', type=StoredValueResponse9, min=0, max=1, mutex_group=None, array=False),
