...
class CorporateActionOption245(base_types._BaseFieldType):
	...
	__slots__ = ["_PrdDtls", "_SctiesQty", "_DfltPrcgOrStgInstr", "_CcyOptn", "_FrctnDspstn", "_ChngAllwdInd", "_CertfctnBrkdwnTp", "_RateAndAmtDtls", "_DtDtls", "_ApldOptnInd", "_OptnAvlbtySts", "_CshMvmntDtls", "_NonDmclCtry", "_OptnTp", "_WdrwlAllwdInd", "_ChrgsApldInd", "_OptnFeatrs", "_OfferTp", "_VldDmclCtry", "_PricDtls", "_SctyId", "_OptnNb", "_CertfctnBrkdwnInd", "_AccptncPrtyLvl", "_AddtlInf", "_SctiesMvmntDtls"]
	@property
	def PrdDtls(self):
