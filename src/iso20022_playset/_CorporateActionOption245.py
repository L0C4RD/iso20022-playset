...
class CorporateActionOption245(base_types._BaseFieldType):
	...
	__slots__ = ["_AccptncPrtyLvl", "_OptnFeatrs", "_WdrwlAllwdInd", "_CertfctnBrkdwnInd", "_SctiesMvmntDtls", "_FrctnDspstn", "_DfltPrcgOrStgInstr", "_DtDtls", "_RateAndAmtDtls", "_OptnAvlbtySts", "_CshMvmntDtls", "_ApldOptnInd", "_ChrgsApldInd", "_CertfctnBrkdwnTp", "_OptnTp", "_PrdDtls", "_SctiesQty", "_PricDtls", "_NonDmclCtry", "_OfferTp", "_SctyId", "_AddtlInf", "_CcyOptn", "_VldDmclCtry", "_OptnNb", "_ChngAllwdInd"]
	@property
