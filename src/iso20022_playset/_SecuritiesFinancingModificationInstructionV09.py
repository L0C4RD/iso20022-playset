...
from .SecuritiesFinancingTransactionDetails58 import SecuritiesFinancingTransactionDetails58
from .QuantityAndAccount119 import QuantityAndAccount119
from .AmountAndDirection49 import AmountAndDirection49
from .TransactionTypeAndAdditionalParameters23 import TransactionTypeAndAdditionalParameters23
from .SecurityIdentification19 import SecurityIdentification19
from .SettlementDetails148 import SettlementDetails148
from .SecuritiesTradeDetails100 import SecuritiesTradeDetails100

class SecuritiesFinancingModificationInstructionV09(base_types._BaseFieldType):

	__slots__ = ["_RcvgSttlmPties", "_SplmtryData", "_OpngSttlmAmt", "_TxTpAndModAddtlParams", "_SttlmParams", "_QtyAndAcctDtls", "_DlvrgSttlmPties", "_TradDtls", "_FinInstrmId", "_SctiesFincgAddtlDtls"]
	@property
