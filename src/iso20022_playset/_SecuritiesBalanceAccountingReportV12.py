...
class SecuritiesBalanceAccountingReportV12(base_types._BaseFieldType):
	...
	__slots__ = ["_AltrnRptgCcyTtlAmts", "_BlckChainAdrOrWllt", "_AcctSvcr", "_SubAcctDtls", "_AcctOwnr", "_AcctBaseCcyTtlAmts", "_Pgntn", "_StmtGnlDtls", "_BalForAcct", "_IntrmyInf", "_SfkpgAcct"]
	@property
