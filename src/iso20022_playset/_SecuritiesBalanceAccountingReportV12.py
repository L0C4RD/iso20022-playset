...
from . import AggregateBalanceInformation45
...
from . import Statement74
from . import SubAccountIdentification72
from . import TotalValueInPageAndStatement2

class SecuritiesBalanceAccountingReportV12(base_types._BaseFieldType):
	...
	def AcctBaseCcyTtlAmts(self, value):
		self._AcctBaseCcyTtlAmts = value if value is not None else base_types.UninitialisedField(self, 'AcctBaseCcyTtlAmts', TotalValueInPageAndStatement2, False)

	@AcctBaseCcyTtlAmts.deleter
	def AcctBaseCcyTtlAmts(self):
		del self._AcctBaseCcyTtlAmts
		self._AcctBaseCcyTtlAmts = base_types.UninitialisedField(self, 'AcctBaseCcyTtlAmts', TotalValueInPageAndStatement2, False)
	...
	def AltrnRptgCcyTtlAmts(self, value):
		self._AltrnRptgCcyTtlAmts = value if value is not None else base_types.UninitialisedField(self, 'AltrnRptgCcyTtlAmts', TotalValueInPageAndStatement2, False)

	@AltrnRptgCcyTtlAmts.deleter
	def AltrnRptgCcyTtlAmts(self):
		del self._AltrnRptgCcyTtlAmts
		self._AltrnRptgCcyTtlAmts = base_types.UninitialisedField(self, 'AltrnRptgCcyTtlAmts', TotalValueInPageAndStatement2, False)
	...
	def BalForAcct(self, value):
		self._BalForAcct = value if value is not None else base_types.UninitialisedField(self, 'BalForAcct', AggregateBalanceInformation45, True)

	@BalForAcct.deleter
	def BalForAcct(self):
		del self._BalForAcct
		self._BalForAcct = base_types.UninitialisedField(self, 'BalForAcct', AggregateBalanceInformation45, True)
	...
	def StmtGnlDtls(self, value):
		self._StmtGnlDtls = value if value is not None else base_types.UninitialisedField(self, 'StmtGnlDtls', Statement74, False)

	@StmtGnlDtls.deleter
	def StmtGnlDtls(self):
		del self._StmtGnlDtls
		self._StmtGnlDtls = base_types.UninitialisedField(self, 'StmtGnlDtls', Statement74, False)
	...
	def SubAcctDtls(self, value):
		self._SubAcctDtls = value if value is not None else base_types.UninitialisedField(self, 'SubAcctDtls', SubAccountIdentification72, True)

	@SubAcctDtls.deleter
	def SubAcctDtls(self):
		del self._SubAcctDtls
		self._SubAcctDtls = base_types.UninitialisedField(self, 'SubAcctDtls', SubAccountIdentification72, True)

	_field_defs = frozenset((
		base_types.FieldEntry(name='AcctBaseCcyTtlAmts', type=TotalValueInPageAndStatement2, min=0, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='AltrnRptgCcyTtlAmts', type=TotalValueInPageAndStatement2, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='BalForAcct', type=AggregateBalanceInformation45, min=0, max=None, mutex_group=None, array=True),
		...
		base_types.FieldEntry(name='StmtGnlDtls', type=Statement74, min=1, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='SubAcctDtls', type=SubAccountIdentification72, min=0, max=None, mutex_group=None, array=True),
	))