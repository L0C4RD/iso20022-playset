...
from . import SecuritiesAuditTrailSearchCriteria4
...
class SecuritiesAuditTrailQueryV01(base_types._BaseFieldType):
	...
	def SchCrit(self, value):
		self._SchCrit = value if value is not None else base_types.UninitialisedField(self, 'SchCrit', SecuritiesAuditTrailSearchCriteria4, False)

	@SchCrit.deleter
	def SchCrit(self):
		del self._SchCrit
		self._SchCrit = base_types.UninitialisedField(self, 'SchCrit', SecuritiesAuditTrailSearchCriteria4, False)
