...
class ATMTransaction53(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctData", "_IncdntDtl", "_AddtlChrg", "_Incdnt", "_TxSts", "_AuthstnRslt", "_ReqdRct", "_TxId", "_ATMTtls", "_PresntdAmtSts", "_CstmrCnsnt", "_Lmts", "_TtlPresntdAmt", "_TtlAuthrsdAmt", "_PrtctdAcctData", "_MultiBndl", "_RcncltnId", "_DtldReqdAmt", "_Csstt", "_BndlPresntdAmt", "_TtlReqdAmt", "_RctPrtd", "_CcyConvsRslt", "_ICCRltdData"]
	@property
	def AcctData(self):
