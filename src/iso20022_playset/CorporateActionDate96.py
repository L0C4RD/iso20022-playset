...
class CorporateActionDate96(base_types._BaseFieldType):
	...
	__slots__ = ["_LpsdDt", "_FxgDt", "_EarlyClsgDt", "_RcrdDt", "_ThrdPtyDdln", "_CrtApprvlDt", "_NewMtrtyDt", "_PmtDt", "_LeadPlntffDdln", "_MtgDt", "_LtryDt", "_FctvDt", "_CertfctnDdln", "_EarlyThrdPtyDdln", "_RsltsPblctnDt", "_AnncmntDt", "_WhlyUcondlDt", "_ElctnToCtrPtyMktDdln", "_DdlnForTaxBrkdwnInstr", "_ElctnToCtrPtyRspnDdln", "_ExDvddDt", "_MrgnFxgDt", "_TradgSspdDt", "_FrthrDtldAnncmntDt", "_UcondlDt", "_RegnDdln", "_SpclExDt", "_GrntedPrtcptnDt", "_FilgDt", "_OffclAnncmntPblctnDt", "_HrgDt", "_MktClmTrckgEndDt", "_PrratnDt", "_EqulstnDt", "_DdlnToSplt"]
	@property
	def LpsdDt(self):
		return self._LpsdDt
