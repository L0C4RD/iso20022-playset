...
class CorporateActionDate96(base_types._BaseFieldType):
	...
	__slots__ = ["_OffclAnncmntPblctnDt", "_LeadPlntffDdln", "_EqulstnDt", "_RcrdDt", "_FxgDt", "_DdlnForTaxBrkdwnInstr", "_ExDvddDt", "_MktClmTrckgEndDt", "_MrgnFxgDt", "_EarlyThrdPtyDdln", "_HrgDt", "_AnncmntDt", "_FilgDt", "_FrthrDtldAnncmntDt", "_LtryDt", "_RegnDdln", "_UcondlDt", "_DdlnToSplt", "_PrratnDt", "_ThrdPtyDdln", "_CertfctnDdln", "_NewMtrtyDt", "_FctvDt", "_ElctnToCtrPtyMktDdln", "_TradgSspdDt", "_CrtApprvlDt", "_RsltsPblctnDt", "_PmtDt", "_ElctnToCtrPtyRspnDdln", "_GrntedPrtcptnDt", "_WhlyUcondlDt", "_MtgDt", "_LpsdDt", "_EarlyClsgDt", "_SpclExDt"]
	@property
