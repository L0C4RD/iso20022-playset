...
class CorporateActionDate96(base_types._BaseFieldType):
	...
	__slots__ = ["_MtgDt", "_RegnDdln", "_SpclExDt", "_MrgnFxgDt", "_FctvDt", "_ElctnToCtrPtyRspnDdln", "_LeadPlntffDdln", "_FilgDt", "_EqulstnDt", "_CrtApprvlDt", "_UcondlDt", "_WhlyUcondlDt", "_FrthrDtldAnncmntDt", "_DdlnToSplt", "_ElctnToCtrPtyMktDdln", "_ThrdPtyDdln", "_PrratnDt", "_CertfctnDdln", "_HrgDt", "_ExDvddDt", "_TradgSspdDt", "_RsltsPblctnDt", "_PmtDt", "_AnncmntDt", "_LpsdDt", "_FxgDt", "_NewMtrtyDt", "_RcrdDt", "_MktClmTrckgEndDt", "_EarlyThrdPtyDdln", "_LtryDt", "_DdlnForTaxBrkdwnInstr", "_GrntedPrtcptnDt", "_OffclAnncmntPblctnDt", "_EarlyClsgDt"]
	@property
	def MtgDt(self):
		return self._MtgDt
