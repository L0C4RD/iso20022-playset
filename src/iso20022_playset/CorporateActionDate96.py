...
class CorporateActionDate96(base_types._BaseFieldType):
	...
	__slots__ = ["_ExDvddDt", "_FrthrDtldAnncmntDt", "_MrgnFxgDt", "_DdlnForTaxBrkdwnInstr", "_RegnDdln", "_EarlyThrdPtyDdln", "_FxgDt", "_WhlyUcondlDt", "_OffclAnncmntPblctnDt", "_GrntedPrtcptnDt", "_RcrdDt", "_ElctnToCtrPtyRspnDdln", "_LtryDt", "_DdlnToSplt", "_PmtDt", "_FctvDt", "_MtgDt", "_EqulstnDt", "_TradgSspdDt", "_PrratnDt", "_HrgDt", "_FilgDt", "_UcondlDt", "_ElctnToCtrPtyMktDdln", "_MktClmTrckgEndDt", "_NewMtrtyDt", "_CrtApprvlDt", "_AnncmntDt", "_LeadPlntffDdln", "_LpsdDt", "_ThrdPtyDdln", "_RsltsPblctnDt", "_SpclExDt", "_EarlyClsgDt", "_CertfctnDdln"]
	@property
	def ExDvddDt(self):
