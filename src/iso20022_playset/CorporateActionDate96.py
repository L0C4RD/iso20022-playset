...
class CorporateActionDate96(base_types._BaseFieldType):
	...
	__slots__ = ["_NewMtrtyDt", "_TradgSspdDt", "_EarlyThrdPtyDdln", "_RcrdDt", "_CrtApprvlDt", "_ElctnToCtrPtyRspnDdln", "_UcondlDt", "_MktClmTrckgEndDt", "_HrgDt", "_SpclExDt", "_PrratnDt", "_RegnDdln", "_LeadPlntffDdln", "_AnncmntDt", "_FctvDt", "_FrthrDtldAnncmntDt", "_MrgnFxgDt", "_ElctnToCtrPtyMktDdln", "_LtryDt", "_MtgDt", "_CertfctnDdln", "_EarlyClsgDt", "_DdlnForTaxBrkdwnInstr", "_GrntedPrtcptnDt", "_ThrdPtyDdln", "_FilgDt", "_ExDvddDt", "_WhlyUcondlDt", "_RsltsPblctnDt", "_OffclAnncmntPblctnDt", "_FxgDt", "_PmtDt", "_DdlnToSplt", "_EqulstnDt", "_LpsdDt"]
	@property
	def NewMtrtyDt(self):
