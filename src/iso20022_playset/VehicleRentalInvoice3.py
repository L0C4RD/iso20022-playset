...
class VehicleRentalInvoice3(base_types._BaseFieldType):
	...
	__slots__ = ["_RtrLctn", "_TtlDstnc", "_Tax", "_DstncUnit", "_ChckOutDt", "_MdlPrvdd", "_ChckInTm", "_ChckInDt", "_ChckOutTm", "_Drtn", "_MakePrvdd", "_AddtlAmt", "_Chrg", "_RegnNbInvcd", "_Adjstd", "_SummryCmmdtyId", "_OdmtrStart", "_OdmtrRtr", "_MdlInvcd", "_FreeDstnc", "_MakeInvcd", "_ClssInvcd", "_Insrnc", "_DstncRate", "_NoShow", "_RegnNbPrvdd", "_ClssPrvdd"]
	@property
	def RtrLctn(self):
