...
class PaymentTransaction153(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlTxRef", "_CxlStsRsnInf", "_RslvdCase", "_OrgnlReqdExctnDt", "_OrgnlReqdColltnDt", "_OrgnlEndToEndId", "_TxCxlSts", "_OrgnlInstdAmt", "_CxlStsId", "_UETR", "_OrgnlInstrId"]
	@property
	def OrgnlTxRef(self):
