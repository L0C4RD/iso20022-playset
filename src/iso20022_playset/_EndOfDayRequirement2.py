...
from .InitialMarginRequirement1 import InitialMarginRequirement1
...
class EndOfDayRequirement2(base_types._BaseFieldType):
	...
	def InitlMrgnRqrmnts(self, value):
		self._InitlMrgnRqrmnts = value if type(value) != base_types.auto else self.make_default("InitlMrgnRqrmnts")
	...
	def VartnMrgnRqrmnts(self, value):
		self._VartnMrgnRqrmnts = value if type(value) != base_types.auto else self.make_default("VartnMrgnRqrmnts")
