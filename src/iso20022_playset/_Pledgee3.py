...
from . import PledgeeFormat5Choice
...
class Pledgee3(base_types._BaseFieldType):
	...
	def PldgeeTpAndId(self, value):
		self._PldgeeTpAndId = value if value is not None else base_types.UninitialisedField(self, 'PldgeeTpAndId', PledgeeFormat5Choice, False)

	@PldgeeTpAndId.deleter
	def PldgeeTpAndId(self):
		del self._PldgeeTpAndId
		self._PldgeeTpAndId = base_types.UninitialisedField(self, 'PldgeeTpAndId', PledgeeFormat5Choice, False)
