...
from . import SessionManagementResponse8
...
class SaleToPOISessionManagementResponseV07(base_types._BaseFieldType):
	...
	def SsnMgmtRspn(self, value):
		self._SsnMgmtRspn = value if value is not None else base_types.UninitialisedField(self, 'SsnMgmtRspn', SessionManagementResponse8, False)

	@SsnMgmtRspn.deleter
	def SsnMgmtRspn(self):
		del self._SsnMgmtRspn
		self._SsnMgmtRspn = base_types.UninitialisedField(self, 'SsnMgmtRspn', SessionManagementResponse8, False)
