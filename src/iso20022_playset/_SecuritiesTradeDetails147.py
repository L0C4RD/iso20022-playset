...
class SecuritiesTradeDetails147(base_types._BaseFieldType):
	...
	__slots__ = ["_FxAddtlDtls", "_NbOfDaysAcrd", "_TradId", "_PlcOfTrad", "_TradTxCond", "_SttlmDt", "_CcyToBuyOrSell", "_OpngClsg", "_TradDt", "_SttlmInstrPrcgAddtlDtls", "_MtchgSts", "_TpOfPric", "_UnqTxIdr", "_AffirmSts", "_TradOrgtrRole", "_Rptg", "_LateDlvryDt", "_InvstrCpcty", "_DealPric", "_CollTxId", "_PlcOfClr"]
	@property
