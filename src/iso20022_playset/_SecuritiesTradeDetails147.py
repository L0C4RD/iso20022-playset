...
class SecuritiesTradeDetails147(base_types._BaseFieldType):
	...
	__slots__ = ["_InvstrCpcty", "_TpOfPric", "_Rptg", "_LateDlvryDt", "_UnqTxIdr", "_OpngClsg", "_TradTxCond", "_NbOfDaysAcrd", "_AffirmSts", "_FxAddtlDtls", "_CollTxId", "_PlcOfTrad", "_MtchgSts", "_CcyToBuyOrSell", "_TradOrgtrRole", "_TradId", "_TradDt", "_SttlmInstrPrcgAddtlDtls", "_PlcOfClr", "_DealPric", "_SttlmDt"]
	@property
	def AffirmSts(self):
