...
class SecuritiesTradeDetails125(base_types._BaseFieldType):
	...
	__slots__ = ["_PlcOfTrad", "_NbOfDaysAcrd", "_AffirmSts", "_InvstrCpcty", "_MtchgSts", "_DealPric", "_TradDt", "_FxAddtlDtls", "_TradOrgtrRole", "_CcyToBuyOrSell", "_OpngSttlmDt", "_Rptg", "_SttlmInstrPrcgAddtlDtls", "_TradTxCond", "_PlcOfClr"]
	@property
	def PlcOfTrad(self):
