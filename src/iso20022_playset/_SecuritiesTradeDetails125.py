...
class SecuritiesTradeDetails125(base_types._BaseFieldType):
	...
	__slots__ = ["_MtchgSts", "_NbOfDaysAcrd", "_DealPric", "_SttlmInstrPrcgAddtlDtls", "_OpngSttlmDt", "_TradOrgtrRole", "_TradDt", "_TradTxCond", "_Rptg", "_PlcOfClr", "_CcyToBuyOrSell", "_PlcOfTrad", "_InvstrCpcty", "_AffirmSts", "_FxAddtlDtls"]
	@property
	def MtchgSts(self):
