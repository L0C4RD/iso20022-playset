...
class PaymentTransactionParty4(base_types._BaseFieldType):
	...
	__slots__ = ["_CdtrAgt", "_UltmtCdtr", "_IntrmyAgt2", "_IntrmyAgt1", "_UltmtDbtr", "_InstdRmbrsmntAgt", "_IntrmyAgt3", "_DbtrAgt", "_InstdAgt", "_InstgRmbrsmntAgt", "_InstgAgt", "_Cdtr", "_Dbtr"]
	@property
	def CdtrAgt(self):
