...
class PaymentTransactionParty4(base_types._BaseFieldType):
	...
	__slots__ = ["_IntrmyAgt2", "_CdtrAgt", "_UltmtCdtr", "_UltmtDbtr", "_InstgAgt", "_IntrmyAgt1", "_IntrmyAgt3", "_InstgRmbrsmntAgt", "_InstdAgt", "_InstdRmbrsmntAgt", "_Dbtr", "_DbtrAgt", "_Cdtr"]
	@property
	def IntrmyAgt2(self):
