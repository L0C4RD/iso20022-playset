...
class MessageStatusResponseData9(base_types._BaseFieldType):
	...
	__slots__ = ["_RpeatdRvslRspn", "_XchgId", "_RpeatdLltyRspn", "_TxRspn", "_RpeatdStordValRspn", "_RpeatdCardAcqstnRspn", "_RpeatdPmtRspn", "_RpeatdSndApplPrtcolDataUnitCardRdrRspn", "_InitgPty"]
	@property
