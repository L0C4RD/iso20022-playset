...
class SaleToPOIAbortV07(base_types._BaseFieldType):
	...
	@Abrt.setter
	def Abrt(self, value):
		self._Abrt = value if value is not None else base_types.UninitialisedField(self, 'Abrt', SystemAbort8, False)

	@Abrt.deleter
	def Abrt(self):
		del self._Abrt
		self._Abrt = base_types.UninitialisedField(self, 'Abrt', SystemAbort8, False)
