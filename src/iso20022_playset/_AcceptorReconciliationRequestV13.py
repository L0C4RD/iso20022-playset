...
from . import AcceptorReconciliationRequest13
...
class AcceptorReconciliationRequestV13(base_types._BaseFieldType):
	...
	def RcncltnReq(self, value):
		self._RcncltnReq = value if value is not None else base_types.UninitialisedField(self, 'RcncltnReq', AcceptorReconciliationRequest13, False)

	@RcncltnReq.deleter
	def RcncltnReq(self):
		del self._RcncltnReq
		self._RcncltnReq = base_types.UninitialisedField(self, 'RcncltnReq', AcceptorReconciliationRequest13, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='RcncltnReq', type=AcceptorReconciliationRequest13, min=1, max=1, mutex_group=None, array=False),
