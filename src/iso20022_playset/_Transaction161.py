...
class Transaction161(base_types._BaseFieldType):
	...
	__slots__ = ["_ClntCollInstrId", "_CtrPtyMktInfrstrctrTxId", "_ClntTrptyCollTxId", "_AcctSvcrTxId", "_TradId", "_AcctSvcrLegId", "_SplmtryData", "_TxDtls", "_PrcrTxId", "_MstrRef", "_PoolId", "_UnqTxIdr", "_CmonId", "_TrptyAgtSvcPrvdrCollInstrId", "_AcctOwnrTxId", "_AcctOwnrLegId", "_ClntRef", "_MktInfrstrctrTxId", "_CorpActnEvtId", "_TrptyAgtSvcPrvdrCollTxId"]
	@property
