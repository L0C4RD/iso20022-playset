...
from . import AcceptorCurrencyConversionResponse13
from . import ContentInformationType37
from . import Header70

class AcceptorCurrencyConversionResponseV13(base_types._BaseFieldType):
	...
	def CcyConvsRspn(self, value):
		self._CcyConvsRspn = value if value is not None else base_types.UninitialisedField(self, 'CcyConvsRspn', AcceptorCurrencyConversionResponse13, False)

	@CcyConvsRspn.deleter
	def CcyConvsRspn(self):
		del self._CcyConvsRspn
		self._CcyConvsRspn = base_types.UninitialisedField(self, 'CcyConvsRspn', AcceptorCurrencyConversionResponse13, False)
	...
	_field_defs = frozenset((
		base_types.FieldEntry(name='CcyConvsRspn', type=AcceptorCurrencyConversionResponse13, min=1, max=1, mutex_group=None, array=False),
