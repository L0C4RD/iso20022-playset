...
from . import DocumentLineType1Choice
...
class DocumentLineType1(base_types._BaseFieldType):
	...
	def CdOrPrtry(self, value):
		self._CdOrPrtry = value if value is not None else base_types.UninitialisedField(self, 'CdOrPrtry', DocumentLineType1Choice, False)

	@CdOrPrtry.deleter
	def CdOrPrtry(self):
		del self._CdOrPrtry
		self._CdOrPrtry = base_types.UninitialisedField(self, 'CdOrPrtry', DocumentLineType1Choice, False)
	...
	_field_defs = frozenset((
		base_types.FieldEntry(name='CdOrPrtry', type=DocumentLineType1Choice, min=1, max=1, mutex_group=None, array=False),
