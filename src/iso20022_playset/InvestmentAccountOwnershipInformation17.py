...
from .MailType1Choice import MailType1Choice
from .ISODate import ISODate
from .CommunicationAddress6 import CommunicationAddress6
from .DateAndAmount1 import DateAndAmount1
from .Notification2 import Notification2
from .Max350Text import Max350Text
from .FATCAForm1Choice import FATCAForm1Choice
from .TaxExemptionReason2Choice import TaxExemptionReason2Choice
from .GenericIdentification82 import GenericIdentification82
from .MoneyLaunderingCheck1Choice import MoneyLaunderingCheck1Choice
from .RegulatoryInformation1 import RegulatoryInformation1
from .LanguageCode import LanguageCode
from .Party48Choice import Party48Choice
from .MiFIDClassification1 import MiFIDClassification1
from .AdditiononalInformation13 import AdditiononalInformation13
from .OwnershipBeneficiaryRate1 import OwnershipBeneficiaryRate1
from .CompanyLink1Choice import CompanyLink1Choice
from .FATCAStatus2 import FATCAStatus2
from .CRSStatus4 import CRSStatus4
from .CRSForm1Choice import CRSForm1Choice
from .TaxReporting3 import TaxReporting3
from .AccountingStatus1Choice import AccountingStatus1Choice
from .ModificationScope27 import ModificationScope27
...
class InvestmentAccountOwnershipInformation17(base_types._BaseFieldType):
	...
	__slots__ = ["_FATCASts", "_AcctgSts", "_CpnyLk", "_TaxXmptn", "_OthrId", "_CtryAndResdtlSts", "_CRSFormTp", "_CRSSts", "_FATCAFormTp", "_PmryComAdr", "_OwnrshBnfcryRate", "_Ntfctn", "_FsclXmptn", "_Pty", "_ElctrncMlngSvcRef", "_AddtlRgltryInf", "_ClntId", "_AddtlInf", "_TaxRptg", "_MailTp", "_MiFIDClssfctn", "_EqtyVal", "_WorkgCptl", "_FATCARptgDt", "_CtrlgPty", "_MnyLndrgChck", "_ScndryComAdr", "_SgntryRghtInd", "_MntryWlth", "_CRSRptgDt", "_Lang", "_ModfdInvstrPrflVldtn"]
	@property
	def FATCASts(self):
	...
	def FsclXmptn(self, value):
		self._FsclXmptn = value if type(value) != auto else self.make_default("FsclXmptn")
	...
	def ElctrncMlngSvcRef(self, value):
		self._ElctrncMlngSvcRef = value if type(value) != auto else self.make_default("ElctrncMlngSvcRef")
	...
	def AddtlRgltryInf(self, value):
		self._AddtlRgltryInf = value if type(value) != auto else self.make_default("AddtlRgltryInf")
	...
	def MiFIDClssfctn(self, value):
		self._MiFIDClssfctn = value if type(value) != auto else self.make_default("MiFIDClssfctn")
	...
	def CtrlgPty(self, value):
		self._CtrlgPty = value if type(value) != auto else self.make_default("CtrlgPty")
	...
	def ModfdInvstrPrflVldtn(self, value):
		self._ModfdInvstrPrflVldtn = value if type(value) != auto else self.make_default("ModfdInvstrPrflVldtn")
