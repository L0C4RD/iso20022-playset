...
from . import CorporateActionMovementPreliminaryAdviceCancellationAdviceV13
...
class SEEV_044_001_13():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def CorpActnMvmntPrlimryAdvcCxlAdvc(self, value):
			self._CorpActnMvmntPrlimryAdvcCxlAdvc = value if value is not None else base_types.UninitialisedField(self, 'CorpActnMvmntPrlimryAdvcCxlAdvc', CorporateActionMovementPreliminaryAdviceCancellationAdviceV13, False)

		@CorpActnMvmntPrlimryAdvcCxlAdvc.deleter
		def CorpActnMvmntPrlimryAdvcCxlAdvc(self):
			del self._CorpActnMvmntPrlimryAdvcCxlAdvc
			self._CorpActnMvmntPrlimryAdvcCxlAdvc = base_types.UninitialisedField(self, 'CorpActnMvmntPrlimryAdvcCxlAdvc', CorporateActionMovementPreliminaryAdviceCancellationAdviceV13, False)
