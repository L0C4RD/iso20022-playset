...
class OriginalPaymentInstruction48(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlPmtInfId", "_OrgnlNbOfTxs", "_CxlStsRsnInf", "_NbOfTxsPerCxlSts", "_TxInfAndSts", "_OrgnlGrpInf", "_PmtInfCxlSts", "_OrgnlPmtInfCxlId", "_OrgnlCtrlSum", "_RslvdCase"]
	@property
