...
class IndividualPerson38(base_types._BaseFieldType):
	...
	__slots__ = ["_FmlyInf", "_GDPRData", "_Gndr", "_CityOfBirth", "_NmPrfx", "_PrvcOfBirth", "_PltclyXpsdPrsn", "_CtryOfBirth", "_Nm", "_ModfdPstlAdr", "_NmSfx", "_Prfssn", "_MddlNm", "_BirthDt", "_BizFctn", "_GvnNm", "_DthDt", "_EdctnLvl", "_EmplngCpny", "_CvlSts", "_ModfdCtznsh"]
	@property
	def FmlyInf(self):
