...
class SecuritiesSettlementTransactionConfirmationV12(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrAmts", "_AddtlParams", "_SplmtryData", "_CshPties", "_QtyAndAcctDtls", "_DgtlNtwkFee", "_FinInstrmId", "_SttldAmt", "_RcvgSttlmPties", "_StgSttlmInstrDtls", "_TxIdDtls", "_SttlmParams", "_FinInstrmAttrbts", "_Lnkgs", "_AddtlPhysOrRegnDtls", "_DlvrgSttlmPties", "_OthrBizPties", "_TradDtls"]
	@property
	def OthrAmts(self):
