...
class SecuritiesSettlementTransactionConfirmationV12(base_types._BaseFieldType):
	...
	__slots__ = ["_DgtlNtwkFee", "_RcvgSttlmPties", "_Lnkgs", "_DlvrgSttlmPties", "_FinInstrmId", "_StgSttlmInstrDtls", "_SttldAmt", "_TradDtls", "_AddtlParams", "_AddtlPhysOrRegnDtls", "_QtyAndAcctDtls", "_TxIdDtls", "_OthrBizPties", "_SplmtryData", "_FinInstrmAttrbts", "_OthrAmts", "_SttlmParams", "_CshPties"]
	@property
