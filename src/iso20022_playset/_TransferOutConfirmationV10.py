...
from . import ReceiveInformation23
from . import Transfer38

class TransferOutConfirmationV10(base_types._BaseFieldType):
	...
	def SttlmDtls(self, value):
		self._SttlmDtls = value if value is not None else base_types.UninitialisedField(self, 'SttlmDtls', ReceiveInformation23, False)

	@SttlmDtls.deleter
	def SttlmDtls(self):
		del self._SttlmDtls
		self._SttlmDtls = base_types.UninitialisedField(self, 'SttlmDtls', ReceiveInformation23, False)
	...
	def TrfDtls(self, value):
		self._TrfDtls = value if value is not None else base_types.UninitialisedField(self, 'TrfDtls', Transfer38, True)

	@TrfDtls.deleter
	def TrfDtls(self):
		del self._TrfDtls
		self._TrfDtls = base_types.UninitialisedField(self, 'TrfDtls', Transfer38, True)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='SttlmDtls', type=ReceiveInformation23, min=0, max=1, mutex_group=None, array=False),
