...
class References81Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctSvcrTxId", "_IntraPosMvmntId", "_IntraBalMvmntId", "_SctiesSttlmTxId", "_MktInfrstrctrTxId", "_CtrPtyMktInfrstrctrTxId", "_PoolId", "_TradId", "_CmonId", "_OthrTxId", "_UnqTxIdr"]
	@property
