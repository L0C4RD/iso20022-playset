...
class FinancialItemParameters1(base_types._BaseFieldType):
	...
	__slots__ = ["_TradMkt", "_LglCntxt", "_Ccy", "_DbtAcct", "_IsseDt", "_Buyr", "_RltdItm", "_BuyrFinAgt", "_GovngCtrct", "_Rcpt", "_Sellr", "_Idr", "_Issr", "_DocPurp", "_SellrFinAgt", "_CdtAcct", "_LangCd"]
	@property
	def TradMkt(self):
