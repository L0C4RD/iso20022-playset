...
class FinancialItemParameters1(base_types._BaseFieldType):
	...
	__slots__ = ["_BuyrFinAgt", "_Issr", "_Idr", "_Sellr", "_Ccy", "_CdtAcct", "_IsseDt", "_DocPurp", "_GovngCtrct", "_SellrFinAgt", "_LglCntxt", "_TradMkt", "_LangCd", "_DbtAcct", "_Buyr", "_RltdItm", "_Rcpt"]
	@property
	def BuyrFinAgt(self):
