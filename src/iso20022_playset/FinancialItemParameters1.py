...
class FinancialItemParameters1(base_types._BaseFieldType):
	...
	__slots__ = ["_Buyr", "_Rcpt", "_SellrFinAgt", "_Ccy", "_CdtAcct", "_Sellr", "_RltdItm", "_LangCd", "_LglCntxt", "_BuyrFinAgt", "_IsseDt", "_Issr", "_DbtAcct", "_TradMkt", "_Idr", "_DocPurp", "_GovngCtrct"]
	@property
	def Buyr(self):
		return self._Buyr
