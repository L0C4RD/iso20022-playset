...
class FinancialItemParameters1(base_types._BaseFieldType):
	...
	__slots__ = ["_Sellr", "_Buyr", "_CdtAcct", "_Rcpt", "_Idr", "_BuyrFinAgt", "_TradMkt", "_Ccy", "_IsseDt", "_DocPurp", "_DbtAcct", "_Issr", "_GovngCtrct", "_LangCd", "_LglCntxt", "_SellrFinAgt", "_RltdItm"]
	@property
	def Sellr(self):
		return self._Sellr
