...
from .BatchManagementType2Code import BatchManagementType2Code
...
class BatchManagementResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_RtrvlRefNb", "_SysTracAudtNb", "_BtchId", "_Hdr", "_ColltnIdList", "_Orgtr", "_SctyTrlr", "_BtchMgmtTp", "_ColltnSz", "_Jursdctn", "_RmngMsgsInColltn", "_Rcvr", "_Crrctn", "_ReqAck", "_Prgrmm", "_ColltnId", "_Dstn", "_SttlmSvc", "_Rcncltn", "_MsgSeqNb", "_MsgsBfrAck", "_NbOfBtchsInColltn", "_PostvAck", "_Conttn", "_SplmtryData", "_ChckptId", "_AddtlData", "_Sndr", "_NbOfMsgs", "_OrgnlRspnCd", "_ColltnChcksm", "_BtchChcksm", "_OrgnlColltnId", "_OrgnlBtchId", "_OthrBtchMgmtTp", "_AddtlFee", "_PrcgRslt", "_PrtctdData", "_TrnsmssnDtTm", "_LifeCyclId", "_BtchIdList"]
	@property
	def RtrvlRefNb(self):
	...
	def ColltnIdList(self, value):
		self._ColltnIdList = value if type(value) != auto else self.make_default("ColltnIdList")
	...
	def MsgsBfrAck(self, value):
		self._MsgsBfrAck = value if type(value) != auto else self.make_default("MsgsBfrAck")
	...
	def OrgnlColltnId(self, value):
		self._OrgnlColltnId = value if type(value) != auto else self.make_default("OrgnlColltnId")
