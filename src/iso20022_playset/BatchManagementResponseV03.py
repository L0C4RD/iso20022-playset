...
class BatchManagementResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_ReqAck", "_SplmtryData", "_ColltnSz", "_NbOfBtchsInColltn", "_SttlmSvc", "_MsgSeqNb", "_BtchMgmtTp", "_ColltnIdList", "_PostvAck", "_RtrvlRefNb", "_BtchId", "_ChckptId", "_Rcncltn", "_Rcvr", "_SctyTrlr", "_RmngMsgsInColltn", "_Prgrmm", "_PrtctdData", "_OrgnlColltnId", "_NbOfMsgs", "_LifeCyclId", "_AddtlFee", "_BtchChcksm", "_OrgnlBtchId", "_Jursdctn", "_AddtlData", "_MsgsBfrAck", "_Hdr", "_Orgtr", "_BtchIdList", "_Sndr", "_Conttn", "_OrgnlRspnCd", "_Dstn", "_PrcgRslt", "_SysTracAudtNb", "_OthrBtchMgmtTp", "_Crrctn", "_ColltnId", "_TrnsmssnDtTm", "_ColltnChcksm"]
	@property
	def ReqAck(self):
		return self._ReqAck
