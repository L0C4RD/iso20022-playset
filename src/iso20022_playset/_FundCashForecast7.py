...
class FundCashForecast7(base_types._BaseFieldType):
	...
	__slots__ = ["_FXRate", "_CcySts", "_PrvsTradDtTm", "_PrvsTtlUnitsNb", "_PrvsTtlNAV", "_XcptnlNetCshFlowInd", "_CshInFcstDtls", "_TtlNAV", "_NetCshFcstDtls", "_TradDtTm", "_TtlNAVChngRate", "_InvstmtCcy", "_Pric", "_PctgOfShrClssTtlNAV", "_CshOutFcstDtls", "_Id", "_FinInstrmDtls", "_TtlUnitsNb"]
	@property
	def FXRate(self):
		return self._FXRate
