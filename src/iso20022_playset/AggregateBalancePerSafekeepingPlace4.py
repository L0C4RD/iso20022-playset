...
class AggregateBalancePerSafekeepingPlace4(base_types._BaseFieldType):
	...
	__slots__ = ["_BalBrkdwnDtls", "_SfkpgPlc", "_DaysAcrd", "_FXDtls", "_PricDtls", "_AcrdIntrstAmt", "_BookVal", "_HldgVal", "_AggtBal", "_AddtlBalBrkdwnDtls", "_AcrdIntrstAmtSgn", "_PrvsHldgVal"]
	@property
