...
class AggregateBalancePerSafekeepingPlace4(base_types._BaseFieldType):
	...
	__slots__ = ["_FXDtls", "_BookVal", "_HldgVal", "_PrvsHldgVal", "_DaysAcrd", "_PricDtls", "_AcrdIntrstAmt", "_BalBrkdwnDtls", "_AcrdIntrstAmtSgn", "_SfkpgPlc", "_AddtlBalBrkdwnDtls", "_AggtBal"]
	@property
	def FXDtls(self):
		return self._FXDtls
