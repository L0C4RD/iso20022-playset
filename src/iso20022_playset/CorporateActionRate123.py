...
class CorporateActionRate123(base_types._BaseFieldType):
	...
	__slots__ = ["_TrfrmatnRate", "_AddtlQtyForSbcbdRsltntScties", "_ChrgsFees", "_WhldgTaxRate", "_TaxCdtRate", "_NewToOd", "_ScndLvlTax", "_AddtlQtyForExstgScties", "_FinTxTaxRate", "_FsclStmp", "_AplblRate"]
	@property
