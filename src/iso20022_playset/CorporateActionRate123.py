...
class CorporateActionRate123(base_types._BaseFieldType):
	...
	__slots__ = ["_FsclStmp", "_TrfrmatnRate", "_ScndLvlTax", "_ChrgsFees", "_WhldgTaxRate", "_FinTxTaxRate", "_AddtlQtyForExstgScties", "_AddtlQtyForSbcbdRsltntScties", "_TaxCdtRate", "_NewToOd", "_AplblRate"]
	@property
	def FsclStmp(self):
