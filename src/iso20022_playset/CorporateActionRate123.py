...
class CorporateActionRate123(base_types._BaseFieldType):
	...
	__slots__ = ["_ScndLvlTax", "_FsclStmp", "_TrfrmatnRate", "_AplblRate", "_FinTxTaxRate", "_AddtlQtyForSbcbdRsltntScties", "_TaxCdtRate", "_AddtlQtyForExstgScties", "_NewToOd", "_ChrgsFees", "_WhldgTaxRate"]
	@property
	def ScndLvlTax(self):
