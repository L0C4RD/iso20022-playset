...
class CorporateActionRate123(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlQtyForSbcbdRsltntScties", "_AplblRate", "_TrfrmatnRate", "_AddtlQtyForExstgScties", "_ChrgsFees", "_FinTxTaxRate", "_ScndLvlTax", "_TaxCdtRate", "_NewToOd", "_FsclStmp", "_WhldgTaxRate"]
	@property
