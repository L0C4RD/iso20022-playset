...
class CorporateActionRate123(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlQtyForSbcbdRsltntScties", "_TrfrmatnRate", "_AddtlQtyForExstgScties", "_NewToOd", "_AplblRate", "_FinTxTaxRate", "_FsclStmp", "_WhldgTaxRate", "_ChrgsFees", "_ScndLvlTax", "_TaxCdtRate"]
	@property
