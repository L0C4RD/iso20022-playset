...
from . import MisMatchAcceptanceNotificationV03
...
class TSMT_021_001_03():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def MisMtchAccptncNtfctn(self, value):
			self._MisMtchAccptncNtfctn = value if value is not None else base_types.UninitialisedField(self, 'MisMtchAccptncNtfctn', MisMatchAcceptanceNotificationV03, False)

		@MisMtchAccptncNtfctn.deleter
		def MisMtchAccptncNtfctn(self):
			del self._MisMtchAccptncNtfctn
			self._MisMtchAccptncNtfctn = base_types.UninitialisedField(self, 'MisMtchAccptncNtfctn', MisMatchAcceptanceNotificationV03, False)
