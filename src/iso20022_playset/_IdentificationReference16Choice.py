...
class IdentificationReference16Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_UnqTxIdr", "_IndxId", "_CmplcId", "_ScndryAllcnId", "_MktInfrstrctrTxId", "_PoolId", "_CxlReqId", "_ClntOrdrLkId", "_BlckId", "_IndvAllcnId", "_InstgPtyTxId", "_CmonId", "_ExctgPtyTxId", "_CollTxId", "_AllcnId"]
	@property
	def UnqTxIdr(self):
