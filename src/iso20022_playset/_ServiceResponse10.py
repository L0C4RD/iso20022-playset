...
from . import BalanceInquiryResponse7
from . import BatchResponse8
...
class ServiceResponse10(base_types._BaseFieldType):
	...
	def BalNqryRspn(self, value):
		self._BalNqryRspn = value if value is not None else base_types.UninitialisedField(self, 'BalNqryRspn', BalanceInquiryResponse7, False)

	@BalNqryRspn.deleter
	def BalNqryRspn(self):
		del self._BalNqryRspn
		self._BalNqryRspn = base_types.UninitialisedField(self, 'BalNqryRspn', BalanceInquiryResponse7, False)
	...
	def BtchRspn(self, value):
		self._BtchRspn = value if value is not None else base_types.UninitialisedField(self, 'BtchRspn', BatchResponse8, False)

	@BtchRspn.deleter
	def BtchRspn(self):
		del self._BtchRspn
		self._BtchRspn = base_types.UninitialisedField(self, 'BtchRspn', BatchResponse8, False)
	...
	def PmtRspn(self, value):
		self._PmtRspn = value if value is not None else base_types.UninitialisedField(self, 'PmtRspn', PaymentResponse8, False)

	@PmtRspn.deleter
	def PmtRspn(self):
		del self._PmtRspn
		self._PmtRspn = base_types.UninitialisedField(self, 'PmtRspn', PaymentResponse8, False)
	...
	def RvslRspn(self, value):
		self._RvslRspn = value if value is not None else base_types.UninitialisedField(self, 'RvslRspn', ReversalResponse10, False)

	@RvslRspn.deleter
	def RvslRspn(self):
		del self._RvslRspn
		self._RvslRspn = base_types.UninitialisedField(self, 'RvslRspn', ReversalResponse10, False)
	...
	def StordValRspn(self, value):
		self._StordValRspn = value if value is not None else base_types.UninitialisedField(self, 'StordValRspn', StoredValueResponse9, False)

	@StordValRspn.deleter
	def StordValRspn(self):
		del self._StordValRspn
		self._StordValRspn = base_types.UninitialisedField(self, 'StordValRspn', StoredValueResponse9, False)
	...
	_field_defs = frozenset((
		base_types.FieldEntry(name='BalNqryRspn', type=BalanceInquiryResponse7, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='BtchRspn', type=BatchResponse8, min=0, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='PmtRspn', type=PaymentResponse8, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='Rspn', type=ResponseType11, min=1, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='RvslRspn', type=ReversalResponse10, min=0, max=1, mutex_group=None, array=False),
