...
class TransactionIdentification55(base_types._BaseFieldType):
	...
	__slots__ = ["_LifeCyclSpprt", "_PresntmntSeqCnt", "_PurchsIdr", "_SysTracAudtNb", "_OthrPurchsIdrTp", "_RtrvlRefNb", "_PresntmntSeqNb", "_AssoctdDataRef", "_AssoctdData", "_IssrRefData", "_PurchsIdrTp", "_AuthntcnTkn", "_AcqrrRefData", "_AuthstnSeqNb", "_AcqrrRefNb", "_LifeCyclId", "_LclTm", "_LifeCyclIdMssng", "_TrnsmssnDtTm", "_LclDt", "_AssoctdDataDstn", "_TmZone"]
	@property
