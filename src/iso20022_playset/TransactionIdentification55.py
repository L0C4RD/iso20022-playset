...
class TransactionIdentification55(base_types._BaseFieldType):
	...
	__slots__ = ["_PurchsIdr", "_IssrRefData", "_AssoctdData", "_AssoctdDataRef", "_RtrvlRefNb", "_AuthstnSeqNb", "_AcqrrRefData", "_AcqrrRefNb", "_AssoctdDataDstn", "_PresntmntSeqCnt", "_LifeCyclId", "_SysTracAudtNb", "_TmZone", "_AuthntcnTkn", "_OthrPurchsIdrTp", "_PresntmntSeqNb", "_PurchsIdrTp", "_LclTm", "_LifeCyclIdMssng", "_TrnsmssnDtTm", "_LifeCyclSpprt", "_LclDt"]
	@property
	def PurchsIdr(self):
