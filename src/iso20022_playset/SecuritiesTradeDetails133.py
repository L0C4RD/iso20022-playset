...
from .Reporting9Choice import Reporting9Choice
...
from .TradeOriginator4Choice import TradeOriginator4Choice
from .CurrencyToBuyOrSell1Choice import CurrencyToBuyOrSell1Choice
from .Max3Number import Max3Number

class SecuritiesTradeDetails133(base_types._BaseFieldType):

	__slots__ = ["_CcyToBuyOrSell", "_LateDlvryDt", "_TradDt", "_DealPric", "_InvstrCpcty", "_Rptg", "_TpOfPric", "_PlcOfTrad", "_SttlmInstrPrcgAddtlDtls", "_CollTxId", "_PlcOfClr", "_NbOfDaysAcrd", "_TradId", "_TradOrgtrRole", "_OpngClsg", "_TradTxCond", "_AffirmSts", "_SttlmDt", "_MtchgSts", "_FxAddtlDtls"]
	@property
