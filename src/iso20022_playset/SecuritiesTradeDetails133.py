...
class SecuritiesTradeDetails133(base_types._BaseFieldType):
	...
	__slots__ = ["_TradTxCond", "_AffirmSts", "_FxAddtlDtls", "_TradDt", "_PlcOfClr", "_OpngClsg", "_InvstrCpcty", "_TradOrgtrRole", "_LateDlvryDt", "_CollTxId", "_DealPric", "_SttlmInstrPrcgAddtlDtls", "_SttlmDt", "_MtchgSts", "_TpOfPric", "_PlcOfTrad", "_NbOfDaysAcrd", "_CcyToBuyOrSell", "_TradId", "_Rptg"]
	@property
	def TradTxCond(self):
