...
class Rate46(base_types._BaseFieldType):
	...
	__slots__ = ["_EarlySlctnFeeRate", "_WhldgTaxRate", "_GrssIntrstRateUsdForPmt", "_FsclStmp", "_EqulstnRate", "_GrssDstrbtnRate", "_NetDstrbtnRate", "_AddtlTax", "_AplblRate", "_ThrdPtyIncntivRate", "_DmdRate", "_ScndLvlTax", "_TaxOnPrfts", "_TaxOnIncm", "_ChrgsFees", "_SlctnFeeRate", "_TaxCdtRate", "_TaxRclmRate"]
	@property
