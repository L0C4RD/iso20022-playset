...
class Rate46(base_types._BaseFieldType):
	...
	__slots__ = ["_GrssIntrstRateUsdForPmt", "_ChrgsFees", "_FsclStmp", "_AddtlTax", "_WhldgTaxRate", "_NetDstrbtnRate", "_AplblRate", "_GrssDstrbtnRate", "_EqulstnRate", "_ThrdPtyIncntivRate", "_TaxRclmRate", "_TaxOnIncm", "_DmdRate", "_TaxCdtRate", "_ScndLvlTax", "_SlctnFeeRate", "_EarlySlctnFeeRate", "_TaxOnPrfts"]
	@property
