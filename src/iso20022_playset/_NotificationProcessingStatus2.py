...
from . import ProcessedStatus1Format1Choice
...
class NotificationProcessingStatus2(base_types._BaseFieldType):
	...
	@Sts.setter
	def Sts(self, value):
		self._Sts = value if value is not None else base_types.UninitialisedField(self, 'Sts', ProcessedStatus1Format1Choice, False)

	@Sts.deleter
	def Sts(self):
		del self._Sts
		self._Sts = base_types.UninitialisedField(self, 'Sts', ProcessedStatus1Format1Choice, False)
