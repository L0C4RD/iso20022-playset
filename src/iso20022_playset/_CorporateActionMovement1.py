...
from .DistributionInstructionType1Code import DistributionInstructionType1Code
...
class CorporateActionMovement1(base_types._BaseFieldType):
	...
	__slots__ = ["_OrdrTp", "_ReqdExctnDt", "_OptnTp", "_OptnNb", "_HghPrtyInd", "_ConfdBalSctiesQty", "_AcctId", "_AcctOwnrId"]
	@property
	def OrdrTp(self):
		return self._OrdrTp
