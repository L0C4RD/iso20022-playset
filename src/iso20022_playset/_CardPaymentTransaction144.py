...
class CardPaymentTransaction144(base_types._BaseFieldType):
	...
	def CcyConvsElgblty(self, value):
		self._CcyConvsElgblty = value if value is not None else base_types.UninitialisedField(self, 'CcyConvsElgblty', CurrencyConversion29, False)

	@CcyConvsElgblty.deleter
	def CcyConvsElgblty(self):
		del self._CcyConvsElgblty
		self._CcyConvsElgblty = base_types.UninitialisedField(self, 'CcyConvsElgblty', CurrencyConversion29, False)
