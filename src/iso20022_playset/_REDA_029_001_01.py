...
from ._SecurityMaintenanceStatusAdviceV01 import SecurityMaintenanceStatusAdviceV01
...
class REDA_029_001_01():
	...
	class Document(base_types._BaseFieldType):
		...
		attrib = {
			"xmlns" : base_types._BaseDataType_String(None, data="urn:iso:std:iso:20022:tech:xsd:reda.029.001.01"),
		}
		...
		def SctyMntncStsAdvc(self, value):
			self._SctyMntncStsAdvc = value if type(value) != base_types.auto else self.make_default("SctyMntncStsAdvc")
