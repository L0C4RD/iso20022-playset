...
class QuantityAndAccount104(base_types._BaseFieldType):

	__slots__ = ["_SfkpgAcct", "_CshAcct", "_QtyBrkdwn", "_AcctOwnr", "_DnmtnChc", "_BlckChainAdrOrWllt", "_SttlmQty", "_SfkpgPlc"]
	@property
	def SfkpgAcct(self):
