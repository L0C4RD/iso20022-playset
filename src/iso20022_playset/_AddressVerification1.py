...
class AddressVerification1(base_types._BaseFieldType):
	...
	def AdrDgts(self, value):
		self._AdrDgts = value if type(value) != base_types.auto else self.make_default("AdrDgts")
	...
	def PstlCdDgts(self, value):
		self._PstlCdDgts = value if type(value) != base_types.auto else self.make_default("PstlCdDgts")
