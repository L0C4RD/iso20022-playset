...
class SecuritiesSettlementTransactionInstruction002V11(base_types._BaseFieldType):
	...
	__slots__ = ["_NbCounts", "_DlvrgSttlmPties", "_OthrBizPties", "_TradDtls", "_OthrAmts", "_SttlmAmt", "_CshPties", "_AddtlPhysOrRegnDtls", "_FinInstrmAttrbts", "_StgSttlmInstrDtls", "_FinInstrmId", "_SttlmTpAndAddtlParams", "_RcvgSttlmPties", "_SttlmParams", "_SplmtryData", "_Lnkgs", "_TxId", "_QtyAndAcctDtls"]
	@property
	def NbCounts(self):
