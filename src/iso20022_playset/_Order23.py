...
from ._Commission25 import Commission25
...
class Order23(base_types._BaseFieldType):
	...
	__slots__ = ["_ListId", "_ScndryClntOrdrId", "_TradRgltryCondsTp", "_CcyToBuyOrSell", "_PosFct", "_PreAdvc", "_TradTxTp", "_PrtlFillDtls", "_GvUpNbOfDays", "_DerivCvrd", "_NbOfDaysAcrd", "_AcrdIntrstAmt", "_OrdrId", "_QtyBrkdwn", "_Sd", "_TpOfPric", "_IntrstTp", "_AddtlTradInstrPrcgInf", "_PrcgDt", "_FinInstrmId", "_CallInTp", "_CshMrgn", "_YldTp", "_ConfQty", "_SttlmDt", "_Pmt", "_DealPric", "_OrdrBookgDt", "_Comssn", "_ClntOrdrId", "_ChrgTaxBsisTp", "_BizPrcTp", "_OrdrOrgtrElgblty", "_Rptg", "_PlcOfTrad", "_TradOrgtnDt", "_MtchSts", "_AcrdIntrstPctg", "_TradTxCond", "_AddtlPhysOrRegnDtls", "_GrssTradAmt", "_CptlGnTp", "_TradDt", "_NAVDt"]
	@property
	def ListId(self):
		return self._ListId
