...
from .SafekeepingPlaceFormat48Choice import SafekeepingPlaceFormat48Choice
from .PartyIdentification136Choice import PartyIdentification136Choice
from .CorporateActionBalanceDetails44 import CorporateActionBalanceDetails44
...
class AccountAndBalance62(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctOwnr", "_BlckChainAdrOrWllt", "_Bal", "_SfkpgAcct", "_SfkpgPlc"]
	@property
	def AcctOwnr(self):
