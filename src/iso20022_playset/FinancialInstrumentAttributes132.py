...
class FinancialInstrumentAttributes132(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrctSz", "_XpryDt", "_FltgRateFxgDt", "_DtdDt", "_NxtCllblDt", "_MinNmnlQty", "_DayCntBsis", "_FinInstrmId", "_NxtFctr", "_DnmtnCcy", "_PutblDt", "_IsseDt", "_ConvsDt", "_PlcOfListg", "_PrvsFctr", "_NxtIntrstRate", "_ClssfctnTp", "_MtrtyDt", "_NxtCpnDt", "_IntrstRate"]
	@property
	def CtrctSz(self):
