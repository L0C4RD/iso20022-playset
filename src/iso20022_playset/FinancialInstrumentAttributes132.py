...
class FinancialInstrumentAttributes132(base_types._BaseFieldType):
	...
	__slots__ = ["_NxtIntrstRate", "_IntrstRate", "_IsseDt", "_NxtCllblDt", "_PlcOfListg", "_ConvsDt", "_NxtFctr", "_ClssfctnTp", "_PutblDt", "_DayCntBsis", "_FinInstrmId", "_MtrtyDt", "_NxtCpnDt", "_CtrctSz", "_DtdDt", "_PrvsFctr", "_FltgRateFxgDt", "_DnmtnCcy", "_MinNmnlQty", "_XpryDt"]
	@property
