...
class FinancialInstrumentAttributes132(base_types._BaseFieldType):
	...
	__slots__ = ["_DtdDt", "_DayCntBsis", "_PlcOfListg", "_IntrstRate", "_MtrtyDt", "_IsseDt", "_DnmtnCcy", "_NxtCpnDt", "_NxtFctr", "_NxtIntrstRate", "_MinNmnlQty", "_CtrctSz", "_PutblDt", "_PrvsFctr", "_XpryDt", "_ClssfctnTp", "_FinInstrmId", "_NxtCllblDt", "_ConvsDt", "_FltgRateFxgDt"]
	@property
	def DtdDt(self):
		return self._DtdDt
