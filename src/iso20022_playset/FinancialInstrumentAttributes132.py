...
class FinancialInstrumentAttributes132(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrctSz", "_NxtIntrstRate", "_MtrtyDt", "_DtdDt", "_IntrstRate", "_NxtCllblDt", "_DayCntBsis", "_XpryDt", "_NxtFctr", "_FinInstrmId", "_PlcOfListg", "_NxtCpnDt", "_ConvsDt", "_IsseDt", "_ClssfctnTp", "_MinNmnlQty", "_PutblDt", "_FltgRateFxgDt", "_PrvsFctr", "_DnmtnCcy"]
	@property
	def CtrctSz(self):
