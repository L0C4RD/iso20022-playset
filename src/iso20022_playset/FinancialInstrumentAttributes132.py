...
class FinancialInstrumentAttributes132(base_types._BaseFieldType):
	...
	__slots__ = ["_MtrtyDt", "_NxtFctr", "_XpryDt", "_FinInstrmId", "_NxtIntrstRate", "_DtdDt", "_PrvsFctr", "_IntrstRate", "_PlcOfListg", "_IsseDt", "_FltgRateFxgDt", "_CtrctSz", "_DnmtnCcy", "_ClssfctnTp", "_NxtCpnDt", "_NxtCllblDt", "_MinNmnlQty", "_DayCntBsis", "_ConvsDt", "_PutblDt"]
	@property
	def MtrtyDt(self):
