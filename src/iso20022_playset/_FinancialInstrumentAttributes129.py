...
class FinancialInstrumentAttributes129(base_types._BaseFieldType):
	...
	__slots__ = ["_ClssfctnTp", "_PlcOfListg", "_PrvsFctr", "_ConvsDt", "_MinNmnlQty", "_MinMltplQtyToInst", "_NxtCllblDt", "_IntrstRate", "_FinInstrmId", "_FltgRateFxgDt", "_IssePric", "_DtdDt", "_MtrtyDt", "_OptnStyle", "_NxtIntrstRate", "_IsseDt", "_CtrctSz", "_NxtCpnDt", "_PutblDt", "_DayCntBsis", "_MinQtyToInst", "_NxtFctr", "_DnmtnCcy"]
	@property
	def ClssfctnTp(self):
