...
class InvestmentAccount73(base_types._BaseFieldType):
	...
	__slots__ = ["_FrgnStsCertfctn", "_PwrOfAttnyLvlOfCtrl", "_Dsgnt", "_FndFmlyNm", "_InvstmtAcctCtgy", "_Nm", "_TaxXmptn", "_RndgDtls", "_RinvstmtDtls", "_ClsgDt", "_AcctgSts", "_BlckdSts", "_TaxRptg", "_Id", "_NegInd", "_AcmltnRghtRef", "_PrcgOrdr", "_Lblty", "_IncmPref", "_InvstrPrfl", "_OpngDt", "_AcctSvcr", "_RefCcy", "_FinInstrmDtls", "_Pldgg", "_TxChanlTp", "_Coll", "_Lang", "_ThrdPtyRghts", "_TaxWhldgMtd", "_FsclYr", "_LttrInttDtls", "_AcctUsgTp", "_ReqrdSgntriesNb", "_StmtFrqcy", "_AcctSgntrDtTm", "_OwnrshTp", "_Tp"]
	@property
