...
class InvestmentAccount73(base_types._BaseFieldType):
	...
	__slots__ = ["_Pldgg", "_RndgDtls", "_TaxRptg", "_PrcgOrdr", "_BlckdSts", "_TaxXmptn", "_IncmPref", "_FndFmlyNm", "_AcctgSts", "_LttrInttDtls", "_FinInstrmDtls", "_ThrdPtyRghts", "_PwrOfAttnyLvlOfCtrl", "_AcmltnRghtRef", "_Lang", "_Tp", "_TaxWhldgMtd", "_OpngDt", "_Lblty", "_RinvstmtDtls", "_StmtFrqcy", "_NegInd", "_Id", "_TxChanlTp", "_ReqrdSgntriesNb", "_AcctSgntrDtTm", "_InvstrPrfl", "_AcctSvcr", "_InvstmtAcctCtgy", "_AcctUsgTp", "_OwnrshTp", "_Nm", "_ClsgDt", "_RefCcy", "_Coll", "_Dsgnt", "_FrgnStsCertfctn", "_FsclYr"]
	@property
	def Pldgg(self):
		return self._Pldgg
