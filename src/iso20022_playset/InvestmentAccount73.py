...
class InvestmentAccount73(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctgSts", "_Tp", "_TaxXmptn", "_ClsgDt", "_NegInd", "_TaxWhldgMtd", "_ThrdPtyRghts", "_PwrOfAttnyLvlOfCtrl", "_Dsgnt", "_BlckdSts", "_AcctUsgTp", "_FndFmlyNm", "_InvstmtAcctCtgy", "_FsclYr", "_Lblty", "_AcctSgntrDtTm", "_RefCcy", "_RndgDtls", "_InvstrPrfl", "_Nm", "_RinvstmtDtls", "_TaxRptg", "_LttrInttDtls", "_AcmltnRghtRef", "_FinInstrmDtls", "_IncmPref", "_TxChanlTp", "_Pldgg", "_ReqrdSgntriesNb", "_FrgnStsCertfctn", "_OwnrshTp", "_OpngDt", "_Id", "_AcctSvcr", "_Coll", "_PrcgOrdr", "_StmtFrqcy", "_Lang"]
	@property
	def AcctgSts(self):
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='OwnrshTp', type=OwnershipType2Choice, min=1, max=1, mutex_group=None, array=False),
