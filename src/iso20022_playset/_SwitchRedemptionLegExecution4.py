...
class SwitchRedemptionLegExecution4(base_types._BaseFieldType):
	...
	__slots__ = ["_LegId", "_HldgsRedRate", "_GrssAmt", "_FinInstrmDtls", "_Grp1Or2Units", "_PricDtls", "_NonStdSttlmInf", "_ReqdSttlmCcy", "_InftvPricDtls", "_GtgOrHldBckDtls", "_CumDvddInd", "_PhysDlvryInd", "_SttlmAndCtdyDtls", "_NetAmt", "_PhysDlvryDtls", "_TradDtTm", "_IncmPref", "_IntrmPrftAmt", "_TxOvrhd", "_UnitsNb", "_InvstmtAcctDtls", "_ReqdNAVCcy", "_LegExctnId", "_Equlstn", "_InftvTaxDtls"]
	@property
	def LegId(self):
		return self._LegId
