...
class CollateralParameters10(base_types._BaseFieldType):
	...
	__slots__ = ["_FaildSttlmSlvtn", "_Prty", "_BsktIdAndElgbltySetPrfl", "_AddtlInf", "_XpsrTp", "_CollSd", "_MainTradgAcctCollstn", "_SttlmPrc", "_AutomtcAllcn", "_RspnSts", "_ValSghtMrgnRate", "_CollInstrTp", "_TrfTitl"]
	@property
