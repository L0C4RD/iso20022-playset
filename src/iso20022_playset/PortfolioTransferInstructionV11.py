...
class PortfolioTransferInstructionV11(base_types._BaseFieldType):
	...
	__slots__ = ["_Xtnsn", "_PdctTrf", "_ScndryCorpInvstr", "_PmryIndvInvstr", "_Trfee", "_RltdRef", "_OthrCorpInvstr", "_MsgRef", "_PrvsRef", "_MktPrctcVrsn", "_PmryCorpInvstr", "_ScndryIndvInvstr", "_PoolRef", "_TrfrAcct", "_OthrIndvInvstr", "_NmneeAcct"]
	@property
	def Xtnsn(self):
		return self._Xtnsn
