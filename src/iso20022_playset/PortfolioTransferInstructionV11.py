...
class PortfolioTransferInstructionV11(base_types._BaseFieldType):
	...
	__slots__ = ["_PdctTrf", "_OthrCorpInvstr", "_PmryCorpInvstr", "_MktPrctcVrsn", "_PoolRef", "_RltdRef", "_PmryIndvInvstr", "_TrfrAcct", "_MsgRef", "_Trfee", "_OthrIndvInvstr", "_PrvsRef", "_ScndryIndvInvstr", "_NmneeAcct", "_ScndryCorpInvstr", "_Xtnsn"]
	@property
	def PdctTrf(self):
