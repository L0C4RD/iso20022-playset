...
class PortfolioTransferInstructionV11(base_types._BaseFieldType):
	...
	__slots__ = ["_MktPrctcVrsn", "_ScndryCorpInvstr", "_RltdRef", "_PrvsRef", "_TrfrAcct", "_PmryCorpInvstr", "_NmneeAcct", "_Xtnsn", "_PdctTrf", "_PmryIndvInvstr", "_Trfee", "_PoolRef", "_MsgRef", "_ScndryIndvInvstr", "_OthrIndvInvstr", "_OthrCorpInvstr"]
	@property
