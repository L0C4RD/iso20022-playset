...
from .NotificationCancellationRejectionReason2 import NotificationCancellationRejectionReason2
from .NotificationCancellationProcessingStatus2 import NotificationCancellationProcessingStatus2
