...
from . import TransferInConfirmationV09
...
class SESE_007_001_09():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def TrfInConf(self, value):
			self._TrfInConf = value if value is not None else base_types.UninitialisedField(self, 'TrfInConf', TransferInConfirmationV09, False)

		@TrfInConf.deleter
		def TrfInConf(self):
			del self._TrfInConf
			self._TrfInConf = base_types.UninitialisedField(self, 'TrfInConf', TransferInConfirmationV09, False)
