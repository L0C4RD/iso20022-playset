...
class AddendumResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Card", "_Tkn", "_Prgrmm", "_TxId", "_SctyTrlr", "_PrcgRslt", "_Orgtr", "_AddtlData", "_AddtlFee", "_TxDesc", "_Jursdctn", "_Issr", "_Acqrr", "_Dstn", "_Accptr", "_SplmtryData", "_Hdr", "_OrgnlDataElmts", "_Sndr", "_SttlmSvc", "_PrtctdData", "_Rcvr", "_Rcncltn"]
	@property
	def Card(self):
		return self._Card
