...
class AddendumResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Jursdctn", "_SplmtryData", "_Accptr", "_AddtlData", "_Orgtr", "_Hdr", "_SttlmSvc", "_OrgnlDataElmts", "_Sndr", "_Tkn", "_Card", "_PrcgRslt", "_Dstn", "_TxDesc", "_Rcncltn", "_Rcvr", "_SctyTrlr", "_Issr", "_Prgrmm", "_PrtctdData", "_Acqrr", "_TxId", "_AddtlFee"]
	@property
	def Jursdctn(self):
