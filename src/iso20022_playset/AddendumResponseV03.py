...
class AddendumResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlData", "_SctyTrlr", "_Hdr", "_Sndr", "_Orgtr", "_Acqrr", "_Accptr", "_Jursdctn", "_Rcvr", "_OrgnlDataElmts", "_Prgrmm", "_AddtlFee", "_Dstn", "_SttlmSvc", "_Card", "_Rcncltn", "_PrcgRslt", "_PrtctdData", "_Issr", "_TxDesc", "_SplmtryData", "_Tkn", "_TxId"]
	@property
	def AddtlData(self):
