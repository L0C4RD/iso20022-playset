...
class AddendumResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Sndr", "_Hdr", "_OrgnlDataElmts", "_TxId", "_Card", "_AddtlData", "_Tkn", "_Rcncltn", "_Dstn", "_TxDesc", "_PrtctdData", "_Accptr", "_Issr", "_SttlmSvc", "_Rcvr", "_Jursdctn", "_SplmtryData", "_Orgtr", "_Acqrr", "_PrcgRslt", "_SctyTrlr", "_Prgrmm", "_AddtlFee"]
	@property
	def Sndr(self):
		return self._Sndr
