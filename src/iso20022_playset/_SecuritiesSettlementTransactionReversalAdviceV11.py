...
class SecuritiesSettlementTransactionReversalAdviceV11(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_DgtlNtwkFee", "_ConfRef", "_TxIdDtls", "_FinInstrmAttrbts", "_FinInstrmId", "_AddtlPhysOrRegnDtls", "_TradDtls", "_DlvrgSttlmPties", "_OthrAmts", "_SttlmParams", "_RcvgSttlmPties", "_AddtlParams", "_CshPties", "_OthrBizPties", "_QtyAndAcctDtls", "_SttldAmt", "_StgSttlmInstrDtls"]
	@property
