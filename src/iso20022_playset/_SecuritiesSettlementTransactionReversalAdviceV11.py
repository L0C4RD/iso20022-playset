...
from . import SecuritiesTradeDetails143
from . import SecurityIdentification19
from . import SettlementDetails215
...
class SecuritiesSettlementTransactionReversalAdviceV11(base_types._BaseFieldType):

	__slots__ = ["_AddtlParams", "_AddtlPhysOrRegnDtls", "_ConfRef", "_CshPties", "_DgtlNtwkFee", "_DlvrgSttlmPties", "_FinInstrmAttrbts", "_FinInstrmId", "_OthrAmts", "_OthrBizPties", "_QtyAndAcctDtls", "_RcvgSttlmPties", "_SplmtryData", "_StgSttlmInstrDtls", "_SttldAmt", "_SttlmParams", "_TradDtls", "_TxIdDtls"]
	@property
	...
	def SttlmParams(self, value):
		self._SttlmParams = value if value is not None else base_types.UninitialisedField(self, 'SttlmParams', SettlementDetails215, False)

	@SttlmParams.deleter
	def SttlmParams(self):
		del self._SttlmParams
		self._SttlmParams = base_types.UninitialisedField(self, 'SttlmParams', SettlementDetails215, False)
	...
	def TradDtls(self, value):
		self._TradDtls = value if value is not None else base_types.UninitialisedField(self, 'TradDtls', SecuritiesTradeDetails143, False)

	@TradDtls.deleter
	def TradDtls(self):
		del self._TradDtls
		self._TradDtls = base_types.UninitialisedField(self, 'TradDtls', SecuritiesTradeDetails143, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='SttlmParams', type=SettlementDetails215, min=1, max=1, mutex_group=None, array=False),
