...
from . import IdentificationSource6Choice
from . import Max16Text
from . import Max35Text

class OtherIdentification8(base_types._BaseFieldType):
	...
	@Tp.setter
	def Tp(self, value):
		self._Tp = value if value is not None else base_types.UninitialisedField(self, 'Tp', IdentificationSource6Choice, False)

	@Tp.deleter
	def Tp(self):
		del self._Tp
		self._Tp = base_types.UninitialisedField(self, 'Tp', IdentificationSource6Choice, False)
