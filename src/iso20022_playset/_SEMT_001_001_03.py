...
from . import SecuritiesMessageRejectionV03
...
class SEMT_001_001_03():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def SctiesMsgRjctn(self, value):
			self._SctiesMsgRjctn = value if value is not None else base_types.UninitialisedField(self, 'SctiesMsgRjctn', SecuritiesMessageRejectionV03, False)

		@SctiesMsgRjctn.deleter
		def SctiesMsgRjctn(self):
			del self._SctiesMsgRjctn
			self._SctiesMsgRjctn = base_types.UninitialisedField(self, 'SctiesMsgRjctn', SecuritiesMessageRejectionV03, False)
