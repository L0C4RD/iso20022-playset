...
class CorporateActionRate119(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlTax", "_TaxOnIncm", "_MaxAllwdOvrsbcptRate", "_ScndLvlTax", "_GrssDstrbtnRate", "_GrssIntrstRateUsdForPmt", "_PrratnRate", "_WhldgTaxRate", "_NetDstrbtnRate", "_TaxblIncmPerDvddShr"]
	@property
	def AddtlTax(self):
