...
class CorporateActionRate119(base_types._BaseFieldType):
	...
	__slots__ = ["_GrssIntrstRateUsdForPmt", "_MaxAllwdOvrsbcptRate", "_ScndLvlTax", "_NetDstrbtnRate", "_TaxOnIncm", "_GrssDstrbtnRate", "_AddtlTax", "_PrratnRate", "_TaxblIncmPerDvddShr", "_WhldgTaxRate"]
	@property
