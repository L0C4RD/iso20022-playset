...
class CorporateActionRate119(base_types._BaseFieldType):
	...
	__slots__ = ["_TaxOnIncm", "_AddtlTax", "_PrratnRate", "_TaxblIncmPerDvddShr", "_ScndLvlTax", "_GrssDstrbtnRate", "_NetDstrbtnRate", "_MaxAllwdOvrsbcptRate", "_WhldgTaxRate", "_GrssIntrstRateUsdForPmt"]
	@property
	def TaxOnIncm(self):
