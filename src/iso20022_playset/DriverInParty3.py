...
class DriverInParty3(base_types._BaseFieldType):
	...
	__slots__ = ["_LicTp", "_LicCtry", "_LicXprtnDt", "_DrvrCrdntl", "_LicCtrySubDvsnMjr", "_Adr", "_LicAssgnr", "_Ctct", "_Age", "_LicForm", "_Nm", "_LicOthrAuthrty", "_LicCtrySubDvsnMnr", "_LicIssncDt", "_LicId", "_DtOfBirth"]
	@property
	def LicTp(self):
		return self._LicTp
