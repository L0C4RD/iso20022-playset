...
class DriverInParty3(base_types._BaseFieldType):
	...
	__slots__ = ["_LicCtrySubDvsnMjr", "_LicAssgnr", "_LicXprtnDt", "_LicId", "_Adr", "_LicIssncDt", "_LicTp", "_LicCtrySubDvsnMnr", "_Age", "_Ctct", "_DtOfBirth", "_DrvrCrdntl", "_LicCtry", "_LicOthrAuthrty", "_LicForm", "_Nm"]
	@property
