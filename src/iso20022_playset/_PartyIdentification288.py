...
class PartyIdentification288(base_types._BaseFieldType):
	...
	__slots__ = ["_LglCorpNm", "_LclData", "_AddtlTxRefNb", "_AddtlCtct", "_OwnrTp", "_CorpTaxIdTp", "_SpnsrdMrchnt", "_BizTp", "_CertfctnTpPrvddBy", "_TaxRegnId", "_NmAndLctn", "_Assgnr", "_CertfctnTp", "_CorpTaxId", "_GeogcLctn", "_Phne", "_OwnrEthnctyTp", "_AddtlId", "_ShrtNm", "_OwnrEthnctyTpPrvddBy", "_AddtlAdr", "_Email", "_AddtlData", "_CstmrSvc", "_BizTpPrvddBy", "_Id", "_URL", "_Adr", "_OwnrTpPrvddBy"]
	@property
	def LglCorpNm(self):
