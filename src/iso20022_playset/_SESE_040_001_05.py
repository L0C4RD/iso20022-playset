...
from ._SecuritiesSettlementTransactionCounterpartyResponseV05 import SecuritiesSettlementTransactionCounterpartyResponseV05
...
class SESE_040_001_05():
	...
	class Document(base_types._BaseFieldType):
		...
		attrib = {
			"xmlns" : base_types._BaseDataType_String(None, data="urn:iso:std:iso:20022:tech:xsd:sese.040.001.05"),
		}
