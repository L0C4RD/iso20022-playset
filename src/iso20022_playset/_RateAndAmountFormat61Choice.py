...
from .RateTypeAndAmountAndStatus37 import RateTypeAndAmountAndStatus37
from .RateTypeAndPercentageRate14 import RateTypeAndPercentageRate14
from .Percentage14Rate import Percentage14Rate

class RateAndAmountFormat61Choice(base_types._BaseFieldType):

	__slots__ = ["_NotSpcfdRate", "_Rate", "_RateTpAndAmtAndRateSts", "_Amt", "_RateTpAndRate"]
	@property
