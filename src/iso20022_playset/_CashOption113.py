...
class CashOption113(base_types._BaseFieldType):
	...
	__slots__ = ["_IncmTp", "_CtryOfIncmSrc", "_CshAcctId", "_CdtDbtInd", "_OthrIncmTp", "_CtrctlPmtInd", "_AmtDtls", "_PricDtls", "_NonElgblPrcdsInd", "_FXDtls", "_RateAndAmtDtls", "_XmptnTp", "_DtDtls", "_PricClctnMtd", "_IssrOfferrTaxbltyInd"]
	@property
	def IncmTp(self):
		return self._IncmTp
