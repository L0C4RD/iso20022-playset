...
from . import CashAccountIdentification15Choice
from . import CorporateActionAmounts76
from . import CorporateActionDate97
from . import CountryCode
from . import CreditDebitCode
from . import ForeignExchangeTerms43
from . import GenericIdentification47
from . import IssuerOfferorTaxabilityIndicator1Choice
from . import NonEligibleProceedsIndicator6Choice
from . import Payment2Code
from . import PriceCalculationMethod1Choice
from . import PriceDetails43
from . import Rate47

class CashOption113(base_types._BaseFieldType):

	__slots__ = ["_AmtDtls", "_CdtDbtInd", "_CshAcctId", "_CtrctlPmtInd", "_CtryOfIncmSrc", "_DtDtls", "_FXDtls", "_IncmTp", "_IssrOfferrTaxbltyInd", "_NonElgblPrcdsInd", "_OthrIncmTp", "_PricClctnMtd", "_PricDtls", "_RateAndAmtDtls", "_XmptnTp"]
	@property
	def AmtDtls(self):
	...
	def AmtDtls(self, value):
		self._AmtDtls = value if value is not None else base_types.UninitialisedField(self, 'AmtDtls', CorporateActionAmounts76, False)

	@AmtDtls.deleter
	def AmtDtls(self):
		del self._AmtDtls
		self._AmtDtls = base_types.UninitialisedField(self, 'AmtDtls', CorporateActionAmounts76, False)
	...
	def CshAcctId(self, value):
		self._CshAcctId = value if value is not None else base_types.UninitialisedField(self, 'CshAcctId', CashAccountIdentification15Choice, False)

	@CshAcctId.deleter
	def CshAcctId(self):
		del self._CshAcctId
		self._CshAcctId = base_types.UninitialisedField(self, 'CshAcctId', CashAccountIdentification15Choice, False)
	...
	def CtrctlPmtInd(self, value):
		self._CtrctlPmtInd = value if value is not None else base_types.UninitialisedField(self, 'CtrctlPmtInd', Payment2Code, False)

	@CtrctlPmtInd.deleter
	def CtrctlPmtInd(self):
		del self._CtrctlPmtInd
		self._CtrctlPmtInd = base_types.UninitialisedField(self, 'CtrctlPmtInd', Payment2Code, False)
	...
	def DtDtls(self, value):
		self._DtDtls = value if value is not None else base_types.UninitialisedField(self, 'DtDtls', CorporateActionDate97, False)

	@DtDtls.deleter
	def DtDtls(self):
		del self._DtDtls
		self._DtDtls = base_types.UninitialisedField(self, 'DtDtls', CorporateActionDate97, False)
	...
	def FXDtls(self, value):
		self._FXDtls = value if value is not None else base_types.UninitialisedField(self, 'FXDtls', ForeignExchangeTerms43, False)

	@FXDtls.deleter
	def FXDtls(self):
		del self._FXDtls
		self._FXDtls = base_types.UninitialisedField(self, 'FXDtls', ForeignExchangeTerms43, False)
	...
	def NonElgblPrcdsInd(self, value):
		self._NonElgblPrcdsInd = value if value is not None else base_types.UninitialisedField(self, 'NonElgblPrcdsInd', NonEligibleProceedsIndicator6Choice, False)

	@NonElgblPrcdsInd.deleter
	def NonElgblPrcdsInd(self):
		del self._NonElgblPrcdsInd
		self._NonElgblPrcdsInd = base_types.UninitialisedField(self, 'NonElgblPrcdsInd', NonEligibleProceedsIndicator6Choice, False)
	...
	def PricClctnMtd(self, value):
		self._PricClctnMtd = value if value is not None else base_types.UninitialisedField(self, 'PricClctnMtd', PriceCalculationMethod1Choice, False)

	@PricClctnMtd.deleter
	def PricClctnMtd(self):
		del self._PricClctnMtd
		self._PricClctnMtd = base_types.UninitialisedField(self, 'PricClctnMtd', PriceCalculationMethod1Choice, False)
	...
	def PricDtls(self, value):
		self._PricDtls = value if value is not None else base_types.UninitialisedField(self, 'PricDtls', PriceDetails43, False)

	@PricDtls.deleter
	def PricDtls(self):
		del self._PricDtls
		self._PricDtls = base_types.UninitialisedField(self, 'PricDtls', PriceDetails43, False)
	...
	def RateAndAmtDtls(self, value):
		self._RateAndAmtDtls = value if value is not None else base_types.UninitialisedField(self, 'RateAndAmtDtls', Rate47, False)

	@RateAndAmtDtls.deleter
	def RateAndAmtDtls(self):
		del self._RateAndAmtDtls
		self._RateAndAmtDtls = base_types.UninitialisedField(self, 'RateAndAmtDtls', Rate47, False)
