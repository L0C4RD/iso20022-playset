...
from ._CorporateActionAmounts79 import CorporateActionAmounts79
...
from ._Rate51 import Rate51
from ._TaxVoucher6 import TaxVoucher6
...
class CashOption118(base_types._BaseFieldType):
	...
	def TaxDcmnttnDtls(self, value):
		self._TaxDcmnttnDtls = value if type(value) != base_types.auto else self.make_default("TaxDcmnttnDtls")

	@TaxDcmnttnDtls.deleter
	def TaxDcmnttnDtls(self):
		del self._TaxDcmnttnDtls
		self._TaxDcmnttnDtls = None
