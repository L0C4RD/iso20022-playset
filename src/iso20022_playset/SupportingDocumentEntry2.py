...
class SupportingDocumentEntry2(base_types._BaseFieldType):
	...
	__slots__ = ["_NtryId", "_AddtlInf", "_ShipmntAttrbts", "_TtlAmtAftrShipmnt", "_Attchmnt", "_OrgnlDoc", "_TtlAmtInCtrctCcy", "_MtrtyData", "_TtlAmtAftrShipmntInCtrctCcy", "_DocTp", "_NtryAmdmntId", "_TtlAmt"]
	@property
	def NtryId(self):
		return self._NtryId
