...
class SupportingDocumentEntry2(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlAmt", "_TtlAmtAftrShipmntInCtrctCcy", "_ShipmntAttrbts", "_Attchmnt", "_NtryAmdmntId", "_NtryId", "_TtlAmtAftrShipmnt", "_AddtlInf", "_OrgnlDoc", "_MtrtyData", "_TtlAmtInCtrctCcy", "_DocTp"]
	@property
	def TtlAmt(self):
		return self._TtlAmt
