...
class ExpectedExecutionDetails5(base_types._BaseFieldType):
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='XpctdTradDtTm', type=DateAndDateTime2Choice, min=0, max=1, mutex_group=None, array=False),
	))