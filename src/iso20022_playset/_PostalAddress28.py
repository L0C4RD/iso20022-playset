...
class PostalAddress28(base_types._BaseFieldType):
	...
	__slots__ = ["_Room", "_TwnNm", "_AdrLine", "_AdrTp", "_BldgNm", "_UnitNb", "_CareOf", "_DstrctNm", "_VldFr", "_PstBx", "_CtrySubDvsn", "_Flr", "_TwnLctnNm", "_SubDept", "_Ctry", "_BldgNb", "_PstCd", "_Dept", "_StrtNm"]
	@property
	def Room(self):
		return self._Room
