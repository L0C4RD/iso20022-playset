...
class AuthorisationResponseV04(base_types._BaseFieldType):
	...
	__slots__ = ["_Card", "_Orgtr", "_AcctTo", "_Prgrmm", "_ConvsDtTm", "_Cntxt", "_Tkn", "_Crdhldr", "_Termnl", "_AddtlSvc", "_Jursdctn", "_Rcvr", "_SttlmSvc", "_AcctFr", "_PrtctdData", "_ICCRltdData", "_SctyTrlr", "_TxId", "_AdddmData", "_SpclPrgrmmQlfctn", "_SplmtryData", "_Vrfctn", "_Issr", "_Acqrr", "_Hdr", "_AcctBal", "_TxChrtcs", "_Wllt", "_TxAmts", "_AddtlFee", "_Rsk", "_Accptr", "_PrcgRslt", "_Sndr", "_StrngCstmrAuthntcn", "_Rcncltn", "_AddtlData", "_OrgnlDataElmts", "_AddtlAmt", "_Dstn", "_Instlmt"]
	@property
	def Card(self):
		return self._Card
