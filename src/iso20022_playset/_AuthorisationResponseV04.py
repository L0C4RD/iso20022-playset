...
class AuthorisationResponseV04(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctFr", "_AdddmData", "_TxChrtcs", "_AddtlAmt", "_OrgnlDataElmts", "_Termnl", "_Sndr", "_AcctBal", "_AddtlData", "_Prgrmm", "_AddtlFee", "_Rcncltn", "_ConvsDtTm", "_Crdhldr", "_TxId", "_Card", "_Rsk", "_Orgtr", "_Acqrr", "_ICCRltdData", "_Dstn", "_Instlmt", "_Issr", "_Jursdctn", "_PrcgRslt", "_Cntxt", "_Hdr", "_StrngCstmrAuthntcn", "_AcctTo", "_Tkn", "_SctyTrlr", "_Vrfctn", "_Rcvr", "_Accptr", "_SttlmSvc", "_TxAmts", "_PrtctdData", "_AddtlSvc", "_SpclPrgrmmQlfctn", "_Wllt", "_SplmtryData"]
	@property
	def Accptr(self):
		return self._Accptr
