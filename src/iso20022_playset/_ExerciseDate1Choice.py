...
class ExerciseDate1Choice(base_types._BaseFieldType):
	...
	def FrstExrcDt(self, value):
		self._FrstExrcDt = value if type(value) != base_types.auto else self.make_default("FrstExrcDt")
	...
	def PdgDtAplbl(self, value):
		self._PdgDtAplbl = value if type(value) != base_types.auto else self.make_default("PdgDtAplbl")
