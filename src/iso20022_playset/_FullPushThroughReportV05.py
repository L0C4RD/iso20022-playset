...
class FullPushThroughReportV05(base_types._BaseFieldType):
	...
	__slots__ = ["_TxSts", "_RptPurp", "_RptId", "_BuyrBkCtctPrsn", "_SellrCtctPrsn", "_ReqForActn", "_BuyrCtctPrsn", "_OthrBkCtctPrsn", "_PushdThrghBaseln", "_UsrTxRef", "_SellrBkCtctPrsn", "_TxId", "_EstblishdBaselnId"]
	@property
	def TxSts(self):
		return self._TxSts
