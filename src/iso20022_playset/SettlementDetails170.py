...
class SettlementDetails170(base_types._BaseFieldType):
	...
	__slots__ = ["_CshClrSys", "_CCPElgblty", "_SctiesRTGS", "_SttlgCpcty", "_BlckTrad", "_NetgElgblty", "_TaxCpcty", "_SttlmSysMtd", "_HldInd", "_SttlmTxCond", "_LglRstrctns", "_PrtlSttlmInd", "_StmpDtyTaxBsis", "_ElgblForColl", "_MktClntSd", "_BnfclOwnrsh"]
	@property
	def CshClrSys(self):
