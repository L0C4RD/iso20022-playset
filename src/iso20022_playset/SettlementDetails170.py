...
class SettlementDetails170(base_types._BaseFieldType):
	...
	__slots__ = ["_CshClrSys", "_ElgblForColl", "_StmpDtyTaxBsis", "_MktClntSd", "_BlckTrad", "_CCPElgblty", "_NetgElgblty", "_TaxCpcty", "_HldInd", "_LglRstrctns", "_SttlgCpcty", "_SctiesRTGS", "_BnfclOwnrsh", "_SttlmSysMtd", "_PrtlSttlmInd", "_SttlmTxCond"]
	@property
	def CshClrSys(self):
