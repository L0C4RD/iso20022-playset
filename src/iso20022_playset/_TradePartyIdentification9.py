...
from . import PartyIdentification78
...
class TradePartyIdentification9(base_types._BaseFieldType):
	...
	def TradPtyId(self, value):
		self._TradPtyId = value if value is not None else base_types.UninitialisedField(self, 'TradPtyId', PartyIdentification78, False)

	@TradPtyId.deleter
	def TradPtyId(self):
		del self._TradPtyId
		self._TradPtyId = base_types.UninitialisedField(self, 'TradPtyId', PartyIdentification78, False)
