...
class BenchmarkUpdate1(base_types._BaseFieldType):
	...
	__slots__ = ["_Admstr", "_Id", "_NdrsngPty", "_Othr", "_PrvsId", "_SplmtryData", "_Sts", "_TechRcrdId", "_TechVldtyPrd"]
	@property
	def Admstr(self):
		return self._Admstr
	...
	def PrvsId(self, value):
		self._PrvsId = value if value is not None else base_types.UninitialisedField(self, 'PrvsId', SecurityIdentification19, False)

	@PrvsId.deleter
	def PrvsId(self):
		del self._PrvsId
		self._PrvsId = base_types.UninitialisedField(self, 'PrvsId', SecurityIdentification19, False)
