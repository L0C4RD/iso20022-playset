...
class Terminal9(base_types._BaseFieldType):
	...
	__slots__ = ["_PINLngthCpblty", "_OnBrd", "_MxScrptLngth", "_TempScrStorg", "_Id", "_OthrPINNtrySctyChrtc", "_WrtgCpblty", "_OthrTp", "_MsgCpblty", "_SrlNb", "_GeogcLctn", "_Sftwr", "_RdngCpblty", "_OnLineCpblty", "_ApprvlCdLngth", "_CrdhldrVrfctnCpblty", "_Outdr", "_PINNtrySctyChrtc", "_OffPrmiss", "_IntgtnTp", "_Tp", "_CertfctnId", "_AddtlId", "_CardCaptrCpbl"]
	@property
