...
class Terminal9(base_types._BaseFieldType):
	...
	__slots__ = ["_GeogcLctn", "_WrtgCpblty", "_MxScrptLngth", "_OthrPINNtrySctyChrtc", "_OnLineCpblty", "_MsgCpblty", "_OffPrmiss", "_CrdhldrVrfctnCpblty", "_TempScrStorg", "_PINLngthCpblty", "_Id", "_OnBrd", "_CardCaptrCpbl", "_IntgtnTp", "_PINNtrySctyChrtc", "_ApprvlCdLngth", "_OthrTp", "_Sftwr", "_CertfctnId", "_AddtlId", "_SrlNb", "_RdngCpblty", "_Tp", "_Outdr"]
	@property
	def GeogcLctn(self):
