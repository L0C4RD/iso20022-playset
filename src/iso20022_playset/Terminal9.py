...
class Terminal9(base_types._BaseFieldType):
	...
	__slots__ = ["_OnLineCpblty", "_OthrPINNtrySctyChrtc", "_PINLngthCpblty", "_Outdr", "_AddtlId", "_SrlNb", "_OthrTp", "_GeogcLctn", "_MxScrptLngth", "_IntgtnTp", "_ApprvlCdLngth", "_Id", "_Sftwr", "_OffPrmiss", "_PINNtrySctyChrtc", "_OnBrd", "_WrtgCpblty", "_TempScrStorg", "_CertfctnId", "_Tp", "_CrdhldrVrfctnCpblty", "_RdngCpblty", "_CardCaptrCpbl", "_MsgCpblty"]
	@property
