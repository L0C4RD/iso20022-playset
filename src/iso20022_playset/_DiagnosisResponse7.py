...
from . import StatusReportContent14
...
class DiagnosisResponse7(base_types._BaseFieldType):
	...
	def POISts(self, value):
		self._POISts = value if value is not None else base_types.UninitialisedField(self, 'POISts', StatusReportContent14, False)

	@POISts.deleter
	def POISts(self):
		del self._POISts
		self._POISts = base_types.UninitialisedField(self, 'POISts', StatusReportContent14, False)
