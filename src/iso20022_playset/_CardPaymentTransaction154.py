...
class CardPaymentTransaction154(base_types._BaseFieldType):

	__slots__ = ["_InitrTxId", "_IntrchngData", "_MrchntRefData", "_MsgFrMrchnt", "_RcncltnId", "_RcptTxId", "_SaleRefId", "_TxDtls", "_TxId"]
	@property
	def InitrTxId(self):
