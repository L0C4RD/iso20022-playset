...
class SecuritiesOption116(base_types._BaseFieldType):
	...
	__slots__ = ["_DtDtls", "_IssrOfferrTaxbltyInd", "_EntitldQty", "_NonElgblPrcdsInd", "_CcyOptn", "_IncmTp", "_AmtDtls", "_CtryOfIncmSrc", "_FrctnDspstn", "_PricDtls", "_TradgPrd", "_RateDtls", "_CdtDbtInd", "_SctyDtls", "_XmptnTp", "_SfkpgPlc", "_NewSctiesIssncInd", "_TempFinInstrmInd", "_OthrIncmTp"]
	@property
	def DtDtls(self):
		return self._DtDtls
