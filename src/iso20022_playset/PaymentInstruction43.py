...
class PaymentInstruction43(base_types._BaseFieldType):
	...
	__slots__ = ["_ChrgBr", "_DbtrAgtAcct", "_Dbtr", "_PoolgAdjstmntDt", "_PmtMtd", "_DbtrAgt", "_DbtrAcct", "_NbOfTxs", "_BtchBookg", "_UltmtDbtr", "_CtrlSum", "_PmtTpInf", "_ChrgsAcctAgt", "_PmtInfId", "_CdtTrfTxInf", "_ChrgsAcct", "_ReqdExctnDt", "_InstrForDbtrAgt"]
	@property
	def ChrgBr(self):
		return self._ChrgBr
