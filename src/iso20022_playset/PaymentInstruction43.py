...
from .PaymentMethod3Code import PaymentMethod3Code
from .CreditTransferTransaction59 import CreditTransferTransaction59
from .BranchAndFinancialInstitutionIdentification8 import BranchAndFinancialInstitutionIdentification8

class PaymentInstruction43(base_types._BaseFieldType):

	__slots__ = ["_InstrForDbtrAgt", "_DbtrAgt", "_ChrgBr", "_Dbtr", "_DbtrAcct", "_CdtTrfTxInf", "_NbOfTxs", "_DbtrAgtAcct", "_ChrgsAcctAgt", "_PmtTpInf", "_PmtInfId", "_CtrlSum", "_ChrgsAcct", "_BtchBookg", "_PmtMtd", "_UltmtDbtr", "_PoolgAdjstmntDt", "_ReqdExctnDt"]
	@property
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='CdtTrfTxInf', type=CreditTransferTransaction59, min=1, max=None, mutex_group=None, array=True),
