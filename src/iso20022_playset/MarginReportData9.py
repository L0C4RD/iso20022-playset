...
class MarginReportData9(base_types._BaseFieldType):
	...
	__slots__ = ["_PstdMrgnOrColl", "_Coll", "_RptgTmStmp", "_CtrPtyId", "_TechAttrbts", "_RcvdMrgnOrColl", "_CtrPtyRatgTrggrInd", "_CtrPtyRatgThrshldInd", "_EvtDt", "_SplmtryData", "_TxId"]
	@property
