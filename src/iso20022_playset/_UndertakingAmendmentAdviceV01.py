...
class UndertakingAmendmentAdviceV01(base_types._BaseFieldType):
	...
	def DtOfAdvc(self, value):
		self._DtOfAdvc = value if value is not None else base_types.UninitialisedField(self, 'DtOfAdvc', ISODate, False)

	@DtOfAdvc.deleter
	def DtOfAdvc(self):
		del self._DtOfAdvc
		self._DtOfAdvc = base_types.UninitialisedField(self, 'DtOfAdvc', ISODate, False)
	...
	def UdrtkgAmdmntAdvcDtls(self, value):
		self._UdrtkgAmdmntAdvcDtls = value if value is not None else base_types.UninitialisedField(self, 'UdrtkgAmdmntAdvcDtls', Amendment2, False)

	@UdrtkgAmdmntAdvcDtls.deleter
	def UdrtkgAmdmntAdvcDtls(self):
		del self._UdrtkgAmdmntAdvcDtls
		self._UdrtkgAmdmntAdvcDtls = base_types.UninitialisedField(self, 'UdrtkgAmdmntAdvcDtls', Amendment2, False)
