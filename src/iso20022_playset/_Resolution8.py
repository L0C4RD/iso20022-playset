...
class Resolution8(base_types._BaseFieldType):
	...
	__slots__ = ["_RghtToWdrwInd", "_VoteInstrTp", "_IssrLabl", "_URLAdr", "_Entitlmnt", "_SubmittdBySctyHldr", "_MgmtRcmmndtn", "_Sts", "_VtngRghtsThrshldForApprvl", "_ListgGrpRsltnLabl", "_Tp", "_NtifngPtyRcmmndtn", "_Desc", "_ForInfOnly", "_VoteTp"]
	@property
