...
class CreditTransferTransaction59(base_types._BaseFieldType):
	...
	__slots__ = ["_IntrmyAgt2", "_CdtrAcct", "_TaxRateMrkr", "_RgltryRptg", "_Purp", "_InstrForCdtrAgt", "_RltdRmtInf", "_Amt", "_Tax", "_ChqInstr", "_RmtInf", "_IntrmyAgt3", "_IntrmyAgt1", "_UltmtCdtr", "_UltmtDbtr", "_Frqcy", "_CdtrAgt", "_PmtId", "_Cdtr", "_ChrgBr", "_TrfInstr", "_PmtTpInf"]
	@property
	def IntrmyAgt2(self):
