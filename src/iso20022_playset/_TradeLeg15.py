...
from . import TradingCapacity10Code
from . import UTIIdentifier
from . import YesNoIndicator

class TradeLeg15(base_types._BaseFieldType):

	__slots__ = ["_AcrdIntrstAmt", "_AllcnId", "_Brkr", "_BuySellInd", "_ClrDtls", "_DealPric", "_DerivRltdTrad", "_DlvryAcct", "_FinInstrmId", "_GrssAmt", "_MrgnAcct", "_NonClrMmb", "_OrdrId", "_PlcOfListg", "_PlcOfTrad", "_SfkpgAcct", "_SfkpgPlc", "_SttlmDt", "_SttlmDtls", "_TradDt", "_TradExctnId", "_TradId", "_TradLegId", "_TradPstngCd", "_TradQty", "_TradRegnOrgn", "_TradTp", "_TradTxCond", "_TradgCcy", "_TradgCpcty", "_TradgPty", "_TradgPtyAcct", "_TxDtAndTm", "_UnqTxIdr"]
	@property
	...
	def MrgnAcct(self, value):
		self._MrgnAcct = value if value is not None else base_types.UninitialisedField(self, 'MrgnAcct', SecuritiesAccount19, False)

	@MrgnAcct.deleter
	def MrgnAcct(self):
		del self._MrgnAcct
		self._MrgnAcct = base_types.UninitialisedField(self, 'MrgnAcct', SecuritiesAccount19, False)
	...
	def TradgCpcty(self, value):
		self._TradgCpcty = value if value is not None else base_types.UninitialisedField(self, 'TradgCpcty', TradingCapacity10Code, False)

	@TradgCpcty.deleter
	def TradgCpcty(self):
		del self._TradgCpcty
		self._TradgCpcty = base_types.UninitialisedField(self, 'TradgCpcty', TradingCapacity10Code, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='TradDt', type=DateAndDateTime2Choice, min=1, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='TradgCpcty', type=TradingCapacity10Code, min=1, max=1, mutex_group=None, array=False),
