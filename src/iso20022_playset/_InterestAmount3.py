...
class InterestAmount3(base_types._BaseFieldType):
	...
	__slots__ = ["_ClsgCollBal", "_AcrdIntrstAmt", "_ValDt", "_CollPurp", "_AddtlInf", "_DayCntBsis", "_StdSttlmInstrs", "_IntrstPrd", "_ClctnFrqcy", "_ApldWhldgTax", "_IntrstMtd", "_IntrstRate", "_ClctnMtd", "_OpngCollBal"]
	@property
