...
class IdentificationReference8Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_CollTxId", "_ExctgPtyTxId", "_BlckId", "_ScndryAllcnId", "_AllcnId", "_InstgPtyTxId", "_IndxId", "_IndvAllcnId", "_MktInfrstrctrTxId", "_CmonId", "_CmplcId", "_ClntOrdrLkId", "_PoolId"]
	@property
	def CollTxId(self):
