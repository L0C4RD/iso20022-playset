...
class IdentificationReference8Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_IndxId", "_CmplcId", "_ScndryAllcnId", "_MktInfrstrctrTxId", "_PoolId", "_ClntOrdrLkId", "_BlckId", "_IndvAllcnId", "_InstgPtyTxId", "_CmonId", "_ExctgPtyTxId", "_CollTxId", "_AllcnId"]
	@property
	def IndxId(self):
		return self._IndxId
