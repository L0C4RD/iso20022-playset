...
from . import NetworkManagementResponseV05
...
class CANM_002_001_05():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def NtwkMgmtRspn(self, value):
			self._NtwkMgmtRspn = value if value is not None else base_types.UninitialisedField(self, 'NtwkMgmtRspn', NetworkManagementResponseV05, False)

		@NtwkMgmtRspn.deleter
		def NtwkMgmtRspn(self):
			del self._NtwkMgmtRspn
			self._NtwkMgmtRspn = base_types.UninitialisedField(self, 'NtwkMgmtRspn', NetworkManagementResponseV05, False)
