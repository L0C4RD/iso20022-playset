...
class CardPaymentTransaction143(base_types._BaseFieldType):
	...
	__slots__ = ["_TxId", "_CstmrCnsnt", "_IntrchngData", "_Rvsl", "_AddtlTxData", "_AuthstnRslt", "_CardPrgrmmPropsd", "_FailrRsn", "_InitrTxId", "_MrchntCtgyCd", "_RcptTxId", "_CardPrgrmmApld", "_TxDtls", "_OrgnlTx", "_SaleRefId", "_RcncltnId", "_TxSucss"]
	@property
	def TxId(self):
		return self._TxId
