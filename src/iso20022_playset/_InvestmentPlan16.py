...
class InvestmentPlan16(base_types._BaseFieldType):
	...
	__slots__ = ["_Qty", "_SctyDtls", "_StartDt", "_InitlAmt", "_TtlNbOfInstlmts", "_SLAChrgAndComssnRef", "_IncmPref", "_RndgDrctn", "_Frqcy", "_EndDt", "_RltdCtrctRef", "_InstlmtMgrRole", "_GrssAmtInd", "_CtrctRef", "_ModfdCshSttlm", "_PdctId", "_PlanSts", "_InsrncCover"]
	@property
	def Qty(self):
		return self._Qty
