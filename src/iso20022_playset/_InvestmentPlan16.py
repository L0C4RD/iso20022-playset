...
class InvestmentPlan16(base_types._BaseFieldType):
	...
	__slots__ = ["_SLAChrgAndComssnRef", "_EndDt", "_CtrctRef", "_GrssAmtInd", "_IncmPref", "_InstlmtMgrRole", "_TtlNbOfInstlmts", "_ModfdCshSttlm", "_SctyDtls", "_Frqcy", "_InsrncCover", "_PdctId", "_RltdCtrctRef", "_StartDt", "_RndgDrctn", "_PlanSts", "_Qty", "_InitlAmt"]
	@property
