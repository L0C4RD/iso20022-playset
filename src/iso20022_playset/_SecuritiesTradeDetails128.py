...
class SecuritiesTradeDetails128(base_types._BaseFieldType):
	...
	__slots__ = ["_PlcOfTrad", "_NbOfDaysAcrd", "_DealPric", "_TradDt", "_PlcOfClr", "_Rptg", "_OpngClsg", "_TradTxCond", "_TpOfPric", "_CollTxId", "_TradId", "_InvstrCpcty", "_SttlmDt", "_FctvSttlmDt", "_TradOrgtrRole", "_SttlmInstrPrcgAddtlDtls", "_FxAddtlDtls"]
	@property
	def PlcOfTrad(self):
