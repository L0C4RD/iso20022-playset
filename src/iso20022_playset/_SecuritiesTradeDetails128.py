...
class SecuritiesTradeDetails128(base_types._BaseFieldType):
	...
	__slots__ = ["_DealPric", "_FctvSttlmDt", "_OpngClsg", "_TradOrgtrRole", "_Rptg", "_PlcOfClr", "_CollTxId", "_PlcOfTrad", "_FxAddtlDtls", "_NbOfDaysAcrd", "_SttlmInstrPrcgAddtlDtls", "_SttlmDt", "_TradDt", "_TpOfPric", "_TradTxCond", "_TradId", "_InvstrCpcty"]
	@property
	def DealPric(self):
