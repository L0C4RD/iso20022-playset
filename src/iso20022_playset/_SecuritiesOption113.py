...
from . import CorporateActionPrice89
from . import CorporateActionRate128
from . import CountryCode
from . import CreditDebitCode
from . import FinancialInstrumentAttributes131
...
class SecuritiesOption113(base_types._BaseFieldType):
	...
	def PricDtls(self, value):
		self._PricDtls = value if value is not None else base_types.UninitialisedField(self, 'PricDtls', CorporateActionPrice89, False)

	@PricDtls.deleter
	def PricDtls(self):
		del self._PricDtls
		self._PricDtls = base_types.UninitialisedField(self, 'PricDtls', CorporateActionPrice89, False)
	...
	def SctyDtls(self, value):
		self._SctyDtls = value if value is not None else base_types.UninitialisedField(self, 'SctyDtls', FinancialInstrumentAttributes131, False)

	@SctyDtls.deleter
	def SctyDtls(self):
		del self._SctyDtls
		self._SctyDtls = base_types.UninitialisedField(self, 'SctyDtls', FinancialInstrumentAttributes131, False)
