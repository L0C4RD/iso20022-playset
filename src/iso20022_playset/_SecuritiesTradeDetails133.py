...
class SecuritiesTradeDetails133(base_types._BaseFieldType):
	...
	__slots__ = ["_PlcOfTrad", "_NbOfDaysAcrd", "_AffirmSts", "_MtchgSts", "_DealPric", "_TradDt", "_PlcOfClr", "_CcyToBuyOrSell", "_Rptg", "_OpngClsg", "_TradTxCond", "_TpOfPric", "_CollTxId", "_TradId", "_InvstrCpcty", "_SttlmDt", "_LateDlvryDt", "_TradOrgtrRole", "_SttlmInstrPrcgAddtlDtls", "_FxAddtlDtls"]
	@property
	def PlcOfTrad(self):
