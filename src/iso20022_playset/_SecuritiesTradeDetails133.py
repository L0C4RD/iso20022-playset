...
class SecuritiesTradeDetails133(base_types._BaseFieldType):
	...
	__slots__ = ["_DealPric", "_OpngClsg", "_TradOrgtrRole", "_Rptg", "_LateDlvryDt", "_PlcOfClr", "_CollTxId", "_PlcOfTrad", "_CcyToBuyOrSell", "_AffirmSts", "_FxAddtlDtls", "_MtchgSts", "_NbOfDaysAcrd", "_SttlmInstrPrcgAddtlDtls", "_SttlmDt", "_TradDt", "_TpOfPric", "_TradTxCond", "_TradId", "_InvstrCpcty"]
	@property
	def DealPric(self):
