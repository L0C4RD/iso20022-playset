...
class TransactionDetails166(base_types._BaseFieldType):
	...
	__slots__ = ["_TradDt", "_TrptyAgtSvcPrvdrCollInstrId", "_FinInstrmId", "_LateDlvryDt", "_ClntTrptyCollTxId", "_PrtlyRlsdQty", "_PlcOfTrad", "_AckdStsTmStmp", "_XpctdSttlmDt", "_MtchdStsTmStmp", "_PoolId", "_SttlmAmt", "_BlckChainAdrOrWllt", "_PlcOfClr", "_XpctdValDt", "_UnqTxIdr", "_Invstr", "_TrptyAgtSvcPrvdrCollTxId", "_ClntCollInstrId", "_CorpActnEvtId", "_SfkpgPlc", "_SctiesMvmntTp", "_DlvrgSttlmPties", "_SttlmQty", "_SttlmDt", "_SfkpgAcct", "_RcvgSttlmPties", "_TradId", "_Pmt", "_NonceId", "_SttlmParams", "_AcctOwnr", "_SttlmInstrPrcgAddtlDtls", "_QlfdFrgnIntrmy"]
	@property
	def TradDt(self):
		return self._TradDt
