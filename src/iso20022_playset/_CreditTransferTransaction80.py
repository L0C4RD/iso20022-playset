...
class CreditTransferTransaction80(base_types._BaseFieldType):

	__slots__ = ["_Cdtr", "_CdtrAcct", "_CdtrAgt", "_CdtrAgtAcct", "_Dbtr", "_DbtrAcct", "_DbtrAgt", "_DbtrAgtAcct", "_InstdAgt", "_InstgAgt", "_InstrForCdtrAgt", "_InstrForNxtAgt", "_IntrBkSttlmAmt", "_IntrBkSttlmDt", "_IntrmyAgt1", "_IntrmyAgt1Acct", "_IntrmyAgt2", "_IntrmyAgt2Acct", "_IntrmyAgt3", "_IntrmyAgt3Acct", "_PmtId", "_PmtSgntr", "_PmtTpInf", "_PrvsInstgAgt1", "_PrvsInstgAgt1Acct", "_PrvsInstgAgt2", "_PrvsInstgAgt2Acct", "_PrvsInstgAgt3", "_PrvsInstgAgt3Acct", "_Purp", "_RgltryRptg", "_RmtInf", "_SttlmPrty", "_SttlmTmIndctn", "_SttlmTmReq", "_UltmtCdtr", "_UltmtDbtr", "_UndrlygAllcn", "_XpryDtTm"]
	@property
	def Cdtr(self):
		return self._Cdtr
