...
from .PaymentTransaction154 import PaymentTransaction154

class OriginalPaymentInstruction49(base_types._BaseFieldType):

	__slots__ = ["_TxInf", "_CtrlSum", "_CxlRsnInf", "_OrgnlPmtInfId", "_PmtInfCxl", "_OrgnlGrpInf", "_NbOfTxs", "_PmtCxlId", "_Case"]
	@property
	def TxInf(self):
		return self._TxInf
