...
class Product6(base_types._BaseFieldType):
	...
	__slots__ = ["_PdctCd", "_PdctDesc", "_PdctAmt", "_UnitOfMeasr", "_UnitPric", "_TaxTp", "_DlvryLctn", "_PdctQty", "_ItmId", "_SaleChanl", "_ValAddedTax", "_AddtlPdctDesc", "_PdctAmtSgn", "_UnitPricSgn", "_DlvrySvc", "_AddtlPdctCd"]
	@property
	def PdctCd(self):
		return self._PdctCd
