...
from .SettlementDetails173 import SettlementDetails173
...
class SecuritiesFinancingTransactionDetails53(base_types._BaseFieldType):
	...
	__slots__ = ["_OpngSttlmAmt", "_FinInstrmId", "_CorpActnEvtId", "_BlckChainAdrOrWllt", "_OpngSttlmDt", "_ClsgLegId", "_XpctdSttlmDt", "_Invstr", "_TrptyAgtSvcPrvdrCollTxId", "_RateTp", "_Sprd", "_SttlmQty", "_SctiesFincgTxTp", "_SctiesFincgTradId", "_AcctOwnr", "_StockLnMrgn", "_PricgRate", "_SttlmParams", "_RcvgSttlmPties", "_SctiesHrcut", "_DlvrgSttlmPties", "_SctiesMvmntTp", "_VarblRateSpprt", "_PoolId", "_XpctdValDt", "_LateDlvryDt", "_RpRate", "_SttlmInstrPrcgAddtlDtls", "_RateChngDt", "_TradDt", "_PlcOfTrad", "_Pmt", "_SfkpgPlc", "_SfkpgAcct", "_ClntTrptyCollTxId", "_TermntnTxAmt", "_TermntnDt"]
	@property
