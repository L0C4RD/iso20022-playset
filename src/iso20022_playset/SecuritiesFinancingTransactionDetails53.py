...
class SecuritiesFinancingTransactionDetails53(base_types._BaseFieldType):
	...
	__slots__ = ["_SfkpgPlc", "_PoolId", "_ClntTrptyCollTxId", "_TrptyAgtSvcPrvdrCollTxId", "_SttlmQty", "_Sprd", "_DlvrgSttlmPties", "_SfkpgAcct", "_SctiesHrcut", "_RateTp", "_Pmt", "_SttlmParams", "_StockLnMrgn", "_Invstr", "_XpctdSttlmDt", "_SttlmInstrPrcgAddtlDtls", "_SctiesFincgTradId", "_TermntnTxAmt", "_AcctOwnr", "_RateChngDt", "_PlcOfTrad", "_PricgRate", "_OpngSttlmAmt", "_SctiesFincgTxTp", "_LateDlvryDt", "_FinInstrmId", "_SctiesMvmntTp", "_BlckChainAdrOrWllt", "_TermntnDt", "_OpngSttlmDt", "_ClsgLegId", "_XpctdValDt", "_TradDt", "_RpRate", "_CorpActnEvtId", "_VarblRateSpprt", "_RcvgSttlmPties"]
	@property
	def SfkpgPlc(self):
