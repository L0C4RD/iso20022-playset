...
class OriginalTransactionReference35(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmInf", "_DbtrAgtAcct", "_CdtrSchmeId", "_DbtrAgt", "_PmtTpInf", "_PmtMtd", "_IntrBkSttlmAmt", "_MndtRltdInf", "_ReqdColltnDt", "_Purp", "_CdtrAgtAcct", "_Cdtr", "_UltmtDbtr", "_CdtrAcct", "_ReqdExctnDt", "_IntrBkSttlmDt", "_Dbtr", "_RmtInf", "_Amt", "_CdtrAgt", "_UltmtCdtr", "_DbtrAcct"]
	@property
	def SttlmInf(self):
