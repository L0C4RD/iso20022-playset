...
class OriginalTransactionReference35(base_types._BaseFieldType):
	...
	__slots__ = ["_RmtInf", "_DbtrAgt", "_CdtrAgtAcct", "_DbtrAcct", "_PmtTpInf", "_IntrBkSttlmAmt", "_IntrBkSttlmDt", "_SttlmInf", "_MndtRltdInf", "_Amt", "_ReqdExctnDt", "_Cdtr", "_CdtrSchmeId", "_CdtrAgt", "_UltmtCdtr", "_CdtrAcct", "_UltmtDbtr", "_ReqdColltnDt", "_PmtMtd", "_Purp", "_DbtrAgtAcct", "_Dbtr"]
	@property
	def RmtInf(self):
		return self._RmtInf
