...
class OriginalTransactionReference35(base_types._BaseFieldType):
	...
	__slots__ = ["_MndtRltdInf", "_PmtTpInf", "_UltmtCdtr", "_Purp", "_ReqdExctnDt", "_DbtrAcct", "_CdtrAgt", "_DbtrAgtAcct", "_DbtrAgt", "_SttlmInf", "_PmtMtd", "_ReqdColltnDt", "_CdtrAgtAcct", "_IntrBkSttlmAmt", "_Dbtr", "_CdtrAcct", "_IntrBkSttlmDt", "_Amt", "_CdtrSchmeId", "_UltmtDbtr", "_Cdtr", "_RmtInf"]
	@property
