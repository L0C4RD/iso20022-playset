...
from . import PaymentInstruction46
...
class CreditorPaymentActivationRequestV11(base_types._BaseFieldType):
	...
	def PmtInf(self, value):
		self._PmtInf = value if value is not None else base_types.UninitialisedField(self, 'PmtInf', PaymentInstruction46, True)

	@PmtInf.deleter
	def PmtInf(self):
		del self._PmtInf
		self._PmtInf = base_types.UninitialisedField(self, 'PmtInf', PaymentInstruction46, True)
