...
class Transfer37(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlCost", "_TrfCcy", "_NewAvrgPric", "_HldgsPlanTp", "_TrfRate", "_TradDt", "_FctvSttlmDt", "_BizFlowTp", "_ClntRef", "_UnitsDtls", "_CtrPtyRef", "_FctvTrfDt", "_TrfOrdrDtForm", "_AvrgDt", "_AvrgPric", "_TrfConfRef", "_TtlUnitsNb", "_FinInstrmDtls", "_NewAvrgDt", "_NonStdSttlmInf", "_TrfRsn", "_ReqdSttlmDt", "_TrfExpnssPmtTp", "_Rndg", "_TrfRef", "_OwnAcctTrfInd"]
	@property
	def OrgnlCost(self):
