...
class Transfer37(base_types._BaseFieldType):
	...
	__slots__ = ["_TradDt", "_TrfCcy", "_UnitsDtls", "_FctvTrfDt", "_ClntRef", "_OrgnlCost", "_TrfRef", "_TtlUnitsNb", "_BizFlowTp", "_TrfRsn", "_TrfConfRef", "_NewAvrgDt", "_Rndg", "_NewAvrgPric", "_AvrgDt", "_TrfExpnssPmtTp", "_HldgsPlanTp", "_CtrPtyRef", "_TrfOrdrDtForm", "_OwnAcctTrfInd", "_TrfRate", "_AvrgPric", "_NonStdSttlmInf", "_ReqdSttlmDt", "_FinInstrmDtls", "_FctvSttlmDt"]
	@property
	def TradDt(self):
		return self._TradDt
