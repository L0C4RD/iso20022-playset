...
class Transfer37(base_types._BaseFieldType):
	...
	__slots__ = ["_ClntRef", "_AvrgDt", "_TradDt", "_NonStdSttlmInf", "_TrfExpnssPmtTp", "_FctvSttlmDt", "_TrfRsn", "_CtrPtyRef", "_TrfCcy", "_TrfRef", "_ReqdSttlmDt", "_TrfRate", "_AvrgPric", "_TtlUnitsNb", "_HldgsPlanTp", "_OrgnlCost", "_TrfOrdrDtForm", "_TrfConfRef", "_NewAvrgDt", "_FctvTrfDt", "_FinInstrmDtls", "_UnitsDtls", "_Rndg", "_OwnAcctTrfInd", "_NewAvrgPric", "_BizFlowTp"]
	@property
	def ClntRef(self):
