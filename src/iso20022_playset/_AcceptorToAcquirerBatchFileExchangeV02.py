...
from . import AcceptorToAcquirerFileBody2
...
class AcceptorToAcquirerBatchFileExchangeV02(base_types._BaseFieldType):
	...
	def BodyElmt(self, value):
		self._BodyElmt = value if value is not None else base_types.UninitialisedField(self, 'BodyElmt', AcceptorToAcquirerFileBody2, True)

	@BodyElmt.deleter
	def BodyElmt(self):
		del self._BodyElmt
		self._BodyElmt = base_types.UninitialisedField(self, 'BodyElmt', AcceptorToAcquirerFileBody2, True)
