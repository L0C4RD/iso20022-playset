...
from . import RecurringTransaction7
...
class CardPaymentTransactionDetails54(base_types._BaseFieldType):
	...
	def CcyConvsRslt(self, value):
		self._CcyConvsRslt = value if value is not None else base_types.UninitialisedField(self, 'CcyConvsRslt', CurrencyConversion35, False)

	@CcyConvsRslt.deleter
	def CcyConvsRslt(self):
		del self._CcyConvsRslt
		self._CcyConvsRslt = base_types.UninitialisedField(self, 'CcyConvsRslt', CurrencyConversion35, False)
	...
	def Instlmt(self, value):
		self._Instlmt = value if value is not None else base_types.UninitialisedField(self, 'Instlmt', Instalment7, True)

	@Instlmt.deleter
	def Instlmt(self):
		del self._Instlmt
		self._Instlmt = base_types.UninitialisedField(self, 'Instlmt', Instalment7, True)
	...
	def Rcrng(self, value):
		self._Rcrng = value if value is not None else base_types.UninitialisedField(self, 'Rcrng', RecurringTransaction7, False)

	@Rcrng.deleter
	def Rcrng(self):
		del self._Rcrng
		self._Rcrng = base_types.UninitialisedField(self, 'Rcrng', RecurringTransaction7, False)
