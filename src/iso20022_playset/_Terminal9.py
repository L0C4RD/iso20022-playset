...
from .DisplayCapabilities6 import DisplayCapabilities6
from .Max256Text import Max256Text
from .Software1 import Software1
from .OnLineCapability2Code import OnLineCapability2Code
from .TerminalType1Code import TerminalType1Code
from .PINEntrySecurityCharacteristic1Code import PINEntrySecurityCharacteristic1Code
from .Number import Number
from .GeographicPointInDecimalDegrees import GeographicPointInDecimalDegrees
from .CardholderVerificationCapabilities1 import CardholderVerificationCapabilities1
from .TerminalIntegrationCategory1Code import TerminalIntegrationCategory1Code
from .Max16Text import Max16Text
from .Max35Text import Max35Text
from .TrueFalseIndicator import TrueFalseIndicator
from .CardReadingCapabilities1 import CardReadingCapabilities1
from .CardWritingCapabilities1 import CardWritingCapabilities1
from .AdditionalData1 import AdditionalData1

class Terminal9(base_types._BaseFieldType):

	__slots__ = ["_ApprvlCdLngth", "_Id", "_SrlNb", "_AddtlId", "_PINLngthCpblty", "_Outdr", "_OnLineCpblty", "_TempScrStorg", "_RdngCpblty", "_CardCaptrCpbl", "_GeogcLctn", "_Tp", "_OnBrd", "_WrtgCpblty", "_OthrPINNtrySctyChrtc", "_CertfctnId", "_MsgCpblty", "_OthrTp", "_MxScrptLngth", "_PINNtrySctyChrtc", "_Sftwr", "_IntgtnTp", "_OffPrmiss", "_CrdhldrVrfctnCpblty"]
	@property
