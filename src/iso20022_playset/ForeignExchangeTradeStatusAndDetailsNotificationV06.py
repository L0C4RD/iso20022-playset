...
from .SplitTradeDetails5 import SplitTradeDetails5
from .SettlementParties120 import SettlementParties120
from .GeneralInformation9 import GeneralInformation9
from .NonDeliverableForwardConditions2 import NonDeliverableForwardConditions2
from .TradeData14 import TradeData14
from .AgreedRate3 import AgreedRate3
from .SupplementaryData1 import SupplementaryData1
from .TradeAgreement12 import TradeAgreement12
...
class ForeignExchangeTradeStatusAndDetailsNotificationV06(base_types._BaseFieldType):
	...
	__slots__ = ["_RgltryRptg", "_GnlInf", "_CtrPtySdId", "_TradgSdId", "_TradgSdSttlmInstrs", "_NDFConds", "_CtrPtySdSttlmInstrs", "_SpltTradInf", "_SplmtryData", "_PstTradEvt", "_AgrdRate", "_StsDtls", "_TradAmts", "_TradInf"]
	@property
	def RgltryRptg(self):
