...
class ForeignExchangeTradeStatusAndDetailsNotificationV06(base_types._BaseFieldType):
	...
	__slots__ = ["_AgrdRate", "_TradgSdSttlmInstrs", "_NDFConds", "_PstTradEvt", "_SplmtryData", "_TradInf", "_CtrPtySdId", "_TradAmts", "_StsDtls", "_GnlInf", "_RgltryRptg", "_SpltTradInf", "_CtrPtySdSttlmInstrs", "_TradgSdId"]
	@property
	def AgrdRate(self):
