...
class ForeignExchangeTradeStatusAndDetailsNotificationV06(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrPtySdId", "_PstTradEvt", "_AgrdRate", "_TradgSdId", "_NDFConds", "_TradAmts", "_TradgSdSttlmInstrs", "_GnlInf", "_SplmtryData", "_StsDtls", "_CtrPtySdSttlmInstrs", "_SpltTradInf", "_TradInf", "_RgltryRptg"]
	@property
	def CtrPtySdId(self):
