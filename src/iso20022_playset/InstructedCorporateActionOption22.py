...
class InstructedCorporateActionOption22(base_types._BaseFieldType):
	...
	__slots__ = ["_OptnCancInstrBal", "_OptnNb", "_EvtDdlns", "_OptnTp", "_OptnPdgInstrBal", "_OptnAccptdInstdBal", "_OptnRtrdInstdBal", "_OptnRjctdInstrBal", "_OptnPrtctInstrBal", "_InstdBal", "_DfltActn", "_OptnInstrDtls"]
	@property
