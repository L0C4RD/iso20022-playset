...
class SettlementDetails173(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmSysMtd", "_BlckTrad", "_CCPElgblty", "_NetgElgblty", "_HldInd", "_SttlgCpcty", "_TaxCpcty", "_PrtlSttlmInd", "_CshClrSys", "_SttlmTxCond", "_StmpDtyTaxBsis", "_LglRstrctns", "_SctiesRTGS", "_BnfclOwnrsh", "_ElgblForColl", "_MktClntSd"]
	@property
