...
class SettlementDetails173(base_types._BaseFieldType):
	...
	__slots__ = ["_HldInd", "_NetgElgblty", "_ElgblForColl", "_SctiesRTGS", "_CshClrSys", "_BnfclOwnrsh", "_LglRstrctns", "_MktClntSd", "_SttlmTxCond", "_TaxCpcty", "_SttlmSysMtd", "_PrtlSttlmInd", "_SttlgCpcty", "_BlckTrad", "_CCPElgblty", "_StmpDtyTaxBsis"]
	@property
	def HldInd(self):
		return self._HldInd
