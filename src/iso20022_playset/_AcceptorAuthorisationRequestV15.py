...
from . import AcceptorAuthorisationRequest15
from . import ContentInformationType37
from . import Header70

class AcceptorAuthorisationRequestV15(base_types._BaseFieldType):
	...
	def AuthstnReq(self, value):
		self._AuthstnReq = value if value is not None else base_types.UninitialisedField(self, 'AuthstnReq', AcceptorAuthorisationRequest15, False)

	@AuthstnReq.deleter
	def AuthstnReq(self):
		del self._AuthstnReq
		self._AuthstnReq = base_types.UninitialisedField(self, 'AuthstnReq', AcceptorAuthorisationRequest15, False)
	...
	_field_defs = frozenset((
		base_types.FieldEntry(name='AuthstnReq', type=AcceptorAuthorisationRequest15, min=1, max=1, mutex_group=None, array=False),
