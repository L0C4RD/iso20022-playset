...
class ChargeBackInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Orgtr", "_ConvsDtTm", "_Tkn", "_OrgnlTxAmts", "_Termnl", "_Prgrmm", "_OrgnlTx", "_TxId", "_Jursdctn", "_Rcvr", "_PrtctdData", "_Card", "_SttlmSvc", "_SctyTrlr", "_PrcgRslt", "_SplmtryData", "_Issr", "_Acqrr", "_Pyer", "_DsptData", "_Hdr", "_Wllt", "_TxAmts", "_AddtlFee", "_Accptr", "_TxChrtcs", "_Pyee", "_Sndr", "_Cntxt", "_Rcncltn", "_AddtlData", "_Dcmnttn", "_Dstn"]
	@property
	def Orgtr(self):
		return self._Orgtr
