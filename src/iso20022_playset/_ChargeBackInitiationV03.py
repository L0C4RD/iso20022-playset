...
class ChargeBackInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_SctyTrlr", "_Pyee", "_TxId", "_Hdr", "_TxChrtcs", "_ConvsDtTm", "_Issr", "_SttlmSvc", "_Rcncltn", "_Tkn", "_Termnl", "_Orgtr", "_Wllt", "_DsptData", "_PrtctdData", "_SplmtryData", "_OrgnlTx", "_Pyer", "_OrgnlTxAmts", "_Accptr", "_Card", "_Prgrmm", "_TxAmts", "_Acqrr", "_AddtlData", "_Cntxt", "_Rcvr", "_Sndr", "_Dstn", "_Jursdctn", "_Dcmnttn", "_PrcgRslt", "_AddtlFee"]
	@property
	def SctyTrlr(self):
