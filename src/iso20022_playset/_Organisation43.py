...
class Organisation43(base_types._BaseFieldType):
	...
	__slots__ = ["_RegnCtry", "_FullLglNm", "_CtryOfOpr", "_OrgLglSts", "_RprtvOffcr", "_TrsrMgr", "_EstblishdDt", "_MainMndtHldr", "_RegnNb", "_BizAdr", "_TaxtnCtry", "_TaxtnIdNb", "_TradgNm", "_Sndr", "_BrdRsltnInd", "_RegnDt", "_LglAdr", "_OprlAdr"]
	@property
	def RegnCtry(self):
