...
class Fund2(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlNAV", "_NetCshFcstDtls", "_PrvsTradDtTm", "_PrvsTtlUnitsNb", "_LglNttyIdr", "_CshOutFcstDtls", "_Ccy", "_TradDtTm", "_PrvsTtlNAV", "_CshInFcstDtls", "_Nm", "_PctgOfFndTtlNAV", "_TtlUnitsNb", "_Id"]
	@property
	def TtlNAV(self):
		return self._TtlNAV
