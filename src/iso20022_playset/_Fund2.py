...
class Fund2(base_types._BaseFieldType):
	...
	__slots__ = ["_LglNttyIdr", "_TradDtTm", "_Nm", "_CshOutFcstDtls", "_PrvsTtlNAV", "_Ccy", "_TtlNAV", "_PrvsTradDtTm", "_NetCshFcstDtls", "_PrvsTtlUnitsNb", "_PctgOfFndTtlNAV", "_CshInFcstDtls", "_Id", "_TtlUnitsNb"]
	@property
	def LglNttyIdr(self):
