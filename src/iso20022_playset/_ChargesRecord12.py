...
class ChargesRecord12(base_types._BaseFieldType):
	...
	__slots__ = ["_Tp", "_ChrgsId", "_Amt", "_CdtDbtInd", "_Dbtr", "_SttlmInstr", "_ChrgsAcctAgtAcct", "_UndrlygTx", "_ChrgsAcctAgt", "_RcrdId", "_DbtrAcct", "_InstrForInstdAgt", "_DbtrAgtAcct", "_ChrgsRqstr", "_AddtlInf", "_DbtrAgt", "_ValDt"]
	@property
	def Tp(self):
		return self._Tp
