...
class ChargesRecord12(base_types._BaseFieldType):
	...
	__slots__ = ["_ChrgsRqstr", "_ChrgsAcctAgt", "_SttlmInstr", "_Amt", "_Tp", "_ChrgsAcctAgtAcct", "_ChrgsId", "_UndrlygTx", "_ValDt", "_Dbtr", "_DbtrAgtAcct", "_DbtrAgt", "_InstrForInstdAgt", "_AddtlInf", "_RcrdId", "_CdtDbtInd", "_DbtrAcct"]
	@property
	def ChrgsRqstr(self):
