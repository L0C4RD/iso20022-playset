...
class ChargesRecord12(base_types._BaseFieldType):
	...
	__slots__ = ["_ChrgsAcctAgt", "_ChrgsAcctAgtAcct", "_Dbtr", "_UndrlygTx", "_ChrgsId", "_InstrForInstdAgt", "_Tp", "_DbtrAcct", "_Amt", "_CdtDbtInd", "_RcrdId", "_ChrgsRqstr", "_ValDt", "_DbtrAgt", "_AddtlInf", "_DbtrAgtAcct", "_SttlmInstr"]
	@property
	def AddtlInf(self):
