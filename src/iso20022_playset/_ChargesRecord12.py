...
class ChargesRecord12(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlInf", "_Amt", "_CdtDbtInd", "_ChrgsAcctAgt", "_ChrgsAcctAgtAcct", "_ChrgsId", "_ChrgsRqstr", "_Dbtr", "_DbtrAcct", "_DbtrAgt", "_DbtrAgtAcct", "_InstrForInstdAgt", "_RcrdId", "_SttlmInstr", "_Tp", "_UndrlygTx", "_ValDt"]
	@property
	def AddtlInf(self):
