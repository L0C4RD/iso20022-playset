...
class QuantityAndAccount115(base_types._BaseFieldType):
	...
	__slots__ = ["_SttldQty", "_SfkpgPlc", "_BlckChainAdrOrWllt", "_RmngToBeSttldAmt", "_RmngToBeSttldQty", "_AcctOwnr", "_QtyBrkdwn", "_PrevslySttldAmt", "_DnmtnChc", "_SfkpgAcct", "_PrevslySttldQty", "_CshAcct"]
	@property
	def SttldQty(self):
