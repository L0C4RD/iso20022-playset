...
class QuantityAndAccount115(base_types._BaseFieldType):
	...
	__slots__ = ["_SfkpgPlc", "_BlckChainAdrOrWllt", "_CshAcct", "_SfkpgAcct", "_RmngToBeSttldQty", "_SttldQty", "_PrevslySttldQty", "_PrevslySttldAmt", "_AcctOwnr", "_RmngToBeSttldAmt", "_DnmtnChc", "_QtyBrkdwn"]
	@property
	def SfkpgPlc(self):
