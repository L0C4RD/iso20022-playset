...
from .QuantityBreakdown63 import QuantityBreakdown63
...
class QuantityAndAccount115(base_types._BaseFieldType):
	...
	__slots__ = ["_CshAcct", "_PrevslySttldQty", "_AcctOwnr", "_RmngToBeSttldQty", "_RmngToBeSttldAmt", "_QtyBrkdwn", "_SfkpgAcct", "_SfkpgPlc", "_SttldQty", "_DnmtnChc", "_BlckChainAdrOrWllt", "_PrevslySttldAmt"]
	@property
	def CshAcct(self):
