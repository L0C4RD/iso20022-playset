...
class QuantityAndAccount115(base_types._BaseFieldType):
	...
	__slots__ = ["_BlckChainAdrOrWllt", "_RmngToBeSttldAmt", "_SttldQty", "_SfkpgPlc", "_PrevslySttldAmt", "_RmngToBeSttldQty", "_AcctOwnr", "_QtyBrkdwn", "_DnmtnChc", "_PrevslySttldQty", "_SfkpgAcct", "_CshAcct"]
	@property
