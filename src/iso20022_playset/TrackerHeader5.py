...
class TrackerHeader5(base_types._BaseFieldType):
	...
	__slots__ = ["_TrckrInfrmgPty", "_MsgId", "_NbOfTxs", "_SvcLvl", "_TrckrInfrmdPty", "_OrgnlTrckrUpd", "_CreDtTm"]
	@property
	...
	def OrgnlTrckrUpd(self, value):
		self._OrgnlTrckrUpd = value if type(value) != base_types.auto else self.make_default("OrgnlTrckrUpd")
