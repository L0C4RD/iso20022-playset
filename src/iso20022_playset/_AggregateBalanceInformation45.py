...
class AggregateBalanceInformation45(base_types._BaseFieldType):
	...
	__slots__ = ["_InstrmCcyAmts", "_SplmtryData", "_BalAtSfkpgPlc", "_InvstmtFndsFinInstrmAttrbts", "_AcctBaseCcyAmts", "_QtyBrkdwn", "_AddtlDerivAttrbts", "_FXDtls", "_AggtBal", "_SfkpgPlc", "_BalBrkdwn", "_DaysAcrd", "_FinInstrmAttrbts", "_CorpActnOptnTp", "_FinInstrmId", "_AltrnRptgCcyAmts", "_PricDtls", "_AddtlBalBrkdwn", "_HldgAddtlDtls"]
	@property
