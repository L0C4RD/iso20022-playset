...
class AggregateBalanceInformation45(base_types._BaseFieldType):
	...
	__slots__ = ["_InvstmtFndsFinInstrmAttrbts", "_BalBrkdwn", "_InstrmCcyAmts", "_AddtlDerivAttrbts", "_AltrnRptgCcyAmts", "_AcctBaseCcyAmts", "_BalAtSfkpgPlc", "_CorpActnOptnTp", "_SfkpgPlc", "_AggtBal", "_FinInstrmAttrbts", "_HldgAddtlDtls", "_AddtlBalBrkdwn", "_QtyBrkdwn", "_DaysAcrd", "_FXDtls", "_SplmtryData", "_FinInstrmId", "_PricDtls"]
	@property
