...
class SettlementInternaliserFinancialInstrument1(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrFinInstrms", "_MnyMktInstrm", "_Eqty", "_EmssnAllwnc", "_XchgTradgFnds", "_Bd", "_OthrTrfblScties", "_CllctvInvstmtUdrtkgs", "_SvrgnDebt"]
	@property
	...
	def OthrFinInstrms(self, value):
		self._OthrFinInstrms = value if type(value) != base_types.auto else self.make_default("OthrFinInstrms")
	...
	def XchgTradgFnds(self, value):
		self._XchgTradgFnds = value if type(value) != base_types.auto else self.make_default("XchgTradgFnds")
