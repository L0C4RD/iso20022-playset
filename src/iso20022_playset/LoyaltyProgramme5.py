...
from .LoyaltyValueType1Code import LoyaltyValueType1Code
from .ISODate import ISODate
from .Max35Text import Max35Text

class LoyaltyProgramme5(base_types._BaseFieldType):

	__slots__ = ["_MmbId", "_MmbAdr", "_XprtnDt", "_ValTp", "_Bal", "_OthrValTp", "_ValToCdt", "_Issr", "_MmbNm", "_MmbSts", "_ValToDbt", "_Elgblty", "_Val"]
	@property
	def MmbId(self):
		return self._MmbId
