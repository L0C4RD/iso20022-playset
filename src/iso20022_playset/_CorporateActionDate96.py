...
class CorporateActionDate96(base_types._BaseFieldType):
	...
	__slots__ = ["_MktClmTrckgEndDt", "_ExDvddDt", "_RcrdDt", "_ElctnToCtrPtyMktDdln", "_PrratnDt", "_FilgDt", "_ThrdPtyDdln", "_RegnDdln", "_FrthrDtldAnncmntDt", "_AnncmntDt", "_CrtApprvlDt", "_GrntedPrtcptnDt", "_EqulstnDt", "_CertfctnDdln", "_LeadPlntffDdln", "_EarlyClsgDt", "_LtryDt", "_DdlnToSplt", "_FxgDt", "_EarlyThrdPtyDdln", "_TradgSspdDt", "_MtgDt", "_LpsdDt", "_PmtDt", "_RsltsPblctnDt", "_WhlyUcondlDt", "_DdlnForTaxBrkdwnInstr", "_NewMtrtyDt", "_HrgDt", "_FctvDt", "_UcondlDt", "_SpclExDt", "_OffclAnncmntPblctnDt", "_ElctnToCtrPtyRspnDdln", "_MrgnFxgDt"]
	@property
