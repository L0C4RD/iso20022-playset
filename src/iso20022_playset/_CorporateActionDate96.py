...
class CorporateActionDate96(base_types._BaseFieldType):
	...
	__slots__ = ["_EqulstnDt", "_AnncmntDt", "_ElctnToCtrPtyMktDdln", "_LpsdDt", "_DdlnForTaxBrkdwnInstr", "_DdlnToSplt", "_RsltsPblctnDt", "_SpclExDt", "_UcondlDt", "_ThrdPtyDdln", "_NewMtrtyDt", "_OffclAnncmntPblctnDt", "_RcrdDt", "_FxgDt", "_PmtDt", "_MrgnFxgDt", "_MtgDt", "_ElctnToCtrPtyRspnDdln", "_FilgDt", "_WhlyUcondlDt", "_EarlyThrdPtyDdln", "_FrthrDtldAnncmntDt", "_CrtApprvlDt", "_HrgDt", "_MktClmTrckgEndDt", "_PrratnDt", "_LeadPlntffDdln", "_RegnDdln", "_ExDvddDt", "_EarlyClsgDt", "_GrntedPrtcptnDt", "_CertfctnDdln", "_LtryDt", "_TradgSspdDt", "_FctvDt"]
	@property
	def EqulstnDt(self):
