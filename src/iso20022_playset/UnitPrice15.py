...
class UnitPrice15(base_types._BaseFieldType):
	...
	__slots__ = ["_TaxblIncmPerDvdd", "_ClctnBsis", "_ValInAltrntvCcy", "_EUDvddSts", "_TaxblIncmPerShr", "_ValInInvstmtCcy", "_ChrgDtls", "_TaxLbltyDtls", "_EstmtdPricInd", "_PricMtd", "_XtndedTp", "_Tp", "_ForExctnInd", "_XtndedEUDvddSts", "_NbOfDaysAcrd", "_TaxblIncmPerShrClctd", "_XtndedTaxblIncmPerShrClctd", "_CumDvddInd", "_TaxRfndDtls"]
	@property
