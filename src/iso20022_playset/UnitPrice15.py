...
from .Tax17 import Tax17
from .PriceMethod1Code import PriceMethod1Code
from .TypeOfPrice9Code import TypeOfPrice9Code
...
class UnitPrice15(base_types._BaseFieldType):
	...
	__slots__ = ["_XtndedTaxblIncmPerShrClctd", "_XtndedEUDvddSts", "_TaxLbltyDtls", "_CumDvddInd", "_EstmtdPricInd", "_ForExctnInd", "_NbOfDaysAcrd", "_ValInAltrntvCcy", "_PricMtd", "_Tp", "_EUDvddSts", "_TaxblIncmPerDvdd", "_XtndedTp", "_TaxRfndDtls", "_ValInInvstmtCcy", "_ChrgDtls", "_ClctnBsis", "_TaxblIncmPerShrClctd", "_TaxblIncmPerShr"]
	@property
	...
	def ForExctnInd(self, value):
		self._ForExctnInd = value if type(value) != auto else self.make_default("ForExctnInd")
	...
	def ValInAltrntvCcy(self, value):
		self._ValInAltrntvCcy = value if type(value) != auto else self.make_default("ValInAltrntvCcy")
