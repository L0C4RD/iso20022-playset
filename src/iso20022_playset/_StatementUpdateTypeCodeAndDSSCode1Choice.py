...
class StatementUpdateTypeCodeAndDSSCode1Choice(base_types._BaseFieldType):
	...
	def StmtUpdTpAsCd(self, value):
		self._StmtUpdTpAsCd = value if value is not None else base_types.UninitialisedField(self, 'StmtUpdTpAsCd', StatementUpdateType1Code, False)

	@StmtUpdTpAsCd.deleter
	def StmtUpdTpAsCd(self):
		del self._StmtUpdTpAsCd
		self._StmtUpdTpAsCd = base_types.UninitialisedField(self, 'StmtUpdTpAsCd', StatementUpdateType1Code, False)
