...
class InvestmentAccount73(base_types._BaseFieldType):
	...
	__slots__ = ["_BlckdSts", "_FndFmlyNm", "_ThrdPtyRghts", "_PrcgOrdr", "_NegInd", "_TaxXmptn", "_StmtFrqcy", "_RinvstmtDtls", "_InvstrPrfl", "_FsclYr", "_LttrInttDtls", "_FrgnStsCertfctn", "_OwnrshTp", "_InvstmtAcctCtgy", "_RndgDtls", "_TxChanlTp", "_Tp", "_AcmltnRghtRef", "_AcctUsgTp", "_AcctSgntrDtTm", "_ReqrdSgntriesNb", "_Dsgnt", "_ClsgDt", "_RefCcy", "_Coll", "_Lang", "_IncmPref", "_FinInstrmDtls", "_AcctSvcr", "_PwrOfAttnyLvlOfCtrl", "_Nm", "_Pldgg", "_Lblty", "_AcctgSts", "_OpngDt", "_TaxWhldgMtd", "_Id", "_TaxRptg"]
	@property
	def BlckdSts(self):
