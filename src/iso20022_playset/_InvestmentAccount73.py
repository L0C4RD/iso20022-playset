...
class InvestmentAccount73(base_types._BaseFieldType):
	...
	__slots__ = ["_TaxRptg", "_RndgDtls", "_TaxXmptn", "_AcctUsgTp", "_IncmPref", "_Lang", "_TaxWhldgMtd", "_StmtFrqcy", "_BlckdSts", "_FrgnStsCertfctn", "_Nm", "_RefCcy", "_LttrInttDtls", "_InvstmtAcctCtgy", "_Dsgnt", "_FinInstrmDtls", "_ReqrdSgntriesNb", "_AcmltnRghtRef", "_Coll", "_ClsgDt", "_Tp", "_OwnrshTp", "_TxChanlTp", "_FsclYr", "_NegInd", "_AcctSgntrDtTm", "_AcctgSts", "_AcctSvcr", "_FndFmlyNm", "_Id", "_PwrOfAttnyLvlOfCtrl", "_ThrdPtyRghts", "_InvstrPrfl", "_Lblty", "_RinvstmtDtls", "_Pldgg", "_PrcgOrdr", "_OpngDt"]
	@property
	def TaxRptg(self):
