...
class ChargesPerTypeRecord6(base_types._BaseFieldType):
	...
	__slots__ = ["_UndrlygTx", "_ChrgsRqstr", "_ValDt", "_Dbtr", "_ChrgsAcctAgt", "_SttlmInstr", "_Amt", "_DbtrAgtAcct", "_DbtrAgt", "_InstrForInstdAgt", "_AddtlInf", "_RcrdId", "_ChrgsAcctAgtAcct", "_CdtDbtInd", "_DbtrAcct"]
	@property
	def UndrlygTx(self):
