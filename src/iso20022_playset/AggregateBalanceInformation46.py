...
class AggregateBalanceInformation46(base_types._BaseFieldType):
	...
	__slots__ = ["_HldgAddtlDtls", "_BalBrkdwn", "_DaysAcrd", "_InstrmCcyAmts", "_AggtBal", "_ValtnHrcutDtls", "_FXDtls", "_FinInstrmId", "_InvstmtFndsFinInstrmAttrbts", "_SfkpgPlc", "_AcctBaseCcyAmts", "_QtyBrkdwn", "_NotAvlblBal", "_AvlblBal", "_PricDtls", "_AddtlBalBrkdwn", "_BalAtSfkpgPlc", "_SplmtryData", "_FinInstrmAttrbts", "_CorpActnOptnTp"]
	@property
