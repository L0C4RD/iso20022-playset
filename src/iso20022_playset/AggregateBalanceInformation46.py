...
class AggregateBalanceInformation46(base_types._BaseFieldType):
	...
	__slots__ = ["_AggtBal", "_SfkpgPlc", "_ValtnHrcutDtls", "_AcctBaseCcyAmts", "_PricDtls", "_QtyBrkdwn", "_DaysAcrd", "_FXDtls", "_BalBrkdwn", "_InvstmtFndsFinInstrmAttrbts", "_BalAtSfkpgPlc", "_InstrmCcyAmts", "_AvlblBal", "_AddtlBalBrkdwn", "_FinInstrmId", "_CorpActnOptnTp", "_SplmtryData", "_HldgAddtlDtls", "_NotAvlblBal", "_FinInstrmAttrbts"]
	@property
	def AggtBal(self):
