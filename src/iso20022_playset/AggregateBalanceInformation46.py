...
class AggregateBalanceInformation46(base_types._BaseFieldType):
	...
	__slots__ = ["_InvstmtFndsFinInstrmAttrbts", "_BalBrkdwn", "_ValtnHrcutDtls", "_NotAvlblBal", "_AddtlBalBrkdwn", "_AggtBal", "_QtyBrkdwn", "_AvlblBal", "_FinInstrmAttrbts", "_FXDtls", "_DaysAcrd", "_SplmtryData", "_FinInstrmId", "_HldgAddtlDtls", "_InstrmCcyAmts", "_SfkpgPlc", "_BalAtSfkpgPlc", "_AcctBaseCcyAmts", "_CorpActnOptnTp", "_PricDtls"]
	@property
