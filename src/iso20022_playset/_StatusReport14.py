...
from . import StatusReportDataSetRequest6
...
class StatusReport14(base_types._BaseFieldType):
	...
	def DataSet(self, value):
		self._DataSet = value if value is not None else base_types.UninitialisedField(self, 'DataSet', StatusReportDataSetRequest6, False)

	@DataSet.deleter
	def DataSet(self):
		del self._DataSet
		self._DataSet = base_types.UninitialisedField(self, 'DataSet', StatusReportDataSetRequest6, False)
