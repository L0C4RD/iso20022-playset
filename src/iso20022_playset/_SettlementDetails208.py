...
class SettlementDetails208(base_types._BaseFieldType):
	...
	__slots__ = ["_LttrOfGrnt", "_ModCxlAllwd", "_CCPElgblty", "_Trckg", "_NetgElgblty", "_CshSubBalTp", "_SctiesTxTp", "_DlvryRtrRsn", "_SttlgCpcty", "_TaxCpcty", "_XpsrTp", "_SttlmTxCond", "_CshClrSys", "_SctiesSubBalTp", "_StmpDtyTaxBsis", "_LglRstrctns", "_BnfclOwnrsh", "_Regn", "_ElgblForColl", "_FxStgInstr", "_RtrLeg", "_MktClntSd"]
	@property
	def LttrOfGrnt(self):
