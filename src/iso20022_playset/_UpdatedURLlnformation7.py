...
class UpdatedURLlnformation7(base_types._BaseFieldType):
	...
	def URLAdr(self, value):
		self._URLAdr = value if value is not None else base_types.UninitialisedField(self, 'URLAdr', RestrictedFINZMax2048Text, False)

	@URLAdr.deleter
	def URLAdr(self):
		del self._URLAdr
		self._URLAdr = base_types.UninitialisedField(self, 'URLAdr', RestrictedFINZMax2048Text, False)
