...
from . import RedemptionBulkOrderConfirmationCancellationInstructionV02
...
class SETR_053_001_02():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def RedBlkOrdrConfCxlInstr(self, value):
			self._RedBlkOrdrConfCxlInstr = value if value is not None else base_types.UninitialisedField(self, 'RedBlkOrdrConfCxlInstr', RedemptionBulkOrderConfirmationCancellationInstructionV02, False)

		@RedBlkOrdrConfCxlInstr.deleter
		def RedBlkOrdrConfCxlInstr(self):
			del self._RedBlkOrdrConfCxlInstr
			self._RedBlkOrdrConfCxlInstr = base_types.UninitialisedField(self, 'RedBlkOrdrConfCxlInstr', RedemptionBulkOrderConfirmationCancellationInstructionV02, False)
