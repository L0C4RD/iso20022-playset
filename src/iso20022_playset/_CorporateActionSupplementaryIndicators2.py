...
class CorporateActionSupplementaryIndicators2(base_types._BaseFieldType):

	__slots__ = ["_CncrrntCallInd", "_CondlPmtAplblInd", "_EscrwToMtrtyInd", "_RghtsOvrsbcptInd", "_RghtsRndUpPrvlgInd", "_RghtsTrfblInd", "_SlctnDealrFeeInd", "_SrrndrShrsToAgtInd", "_StepUpPrvlgInd"]
	@property
	def CncrrntCallInd(self):
		return self._CncrrntCallInd

	@CncrrntCallInd.setter
	def CncrrntCallInd(self, value):
		self._CncrrntCallInd = value if value is not None else base_types.UninitialisedField(self, 'CncrrntCallInd', YesNoIndicator, False)

	@CncrrntCallInd.deleter
	def CncrrntCallInd(self):
		del self._CncrrntCallInd
		self._CncrrntCallInd = base_types.UninitialisedField(self, 'CncrrntCallInd', YesNoIndicator, False)
	...
	_field_defs = frozenset((
		base_types.FieldEntry(name='CncrrntCallInd', type=YesNoIndicator, min=0, max=1, mutex_group=None, array=False),
