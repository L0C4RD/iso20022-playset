...
class DebtorActivation5(base_types._BaseFieldType):
	...
	__slots__ = ["_DdctdActvtnCd", "_CtrctFrmtTp", "_Dbtr", "_EndDt", "_CtrctRef", "_UltmtDbtr", "_DbtrActvtnId", "_DbtrSolPrvdr", "_DispNm", "_Cdtr", "_StartDt", "_CstmrId", "_UltmtCdtr", "_ActvtnReqDlvryPty"]
	@property
