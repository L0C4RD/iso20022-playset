...
class DebtorActivation5(base_types._BaseFieldType):
	...
	__slots__ = ["_DbtrActvtnId", "_DdctdActvtnCd", "_CstmrId", "_CtrctRef", "_StartDt", "_DispNm", "_UltmtDbtr", "_EndDt", "_ActvtnReqDlvryPty", "_CtrctFrmtTp", "_UltmtCdtr", "_Cdtr", "_Dbtr", "_DbtrSolPrvdr"]
	@property
