...
class DebtorActivation5(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrctFrmtTp", "_DispNm", "_Dbtr", "_StartDt", "_DdctdActvtnCd", "_UltmtCdtr", "_ActvtnReqDlvryPty", "_Cdtr", "_UltmtDbtr", "_EndDt", "_CtrctRef", "_CstmrId", "_DbtrSolPrvdr", "_DbtrActvtnId"]
	@property
