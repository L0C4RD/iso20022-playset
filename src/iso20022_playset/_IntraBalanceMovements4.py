...
from . import IntraBalanceMovement7
...
class IntraBalanceMovements4(base_types._BaseFieldType):
	...
	def Mvmnt(self, value):
		self._Mvmnt = value if value is not None else base_types.UninitialisedField(self, 'Mvmnt', IntraBalanceMovement7, True)

	@Mvmnt.deleter
	def Mvmnt(self):
		del self._Mvmnt
		self._Mvmnt = base_types.UninitialisedField(self, 'Mvmnt', IntraBalanceMovement7, True)
