...
from . import InstructionStatus14Choice
from . import Max35Text

class DetailedInstructionStatus23(base_types._BaseFieldType):
	...
	def InstrSts(self, value):
		self._InstrSts = value if value is not None else base_types.UninitialisedField(self, 'InstrSts', InstructionStatus14Choice, False)

	@InstrSts.deleter
	def InstrSts(self):
		del self._InstrSts
		self._InstrSts = base_types.UninitialisedField(self, 'InstrSts', InstructionStatus14Choice, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='InstrSts', type=InstructionStatus14Choice, min=1, max=1, mutex_group=None, array=False),
