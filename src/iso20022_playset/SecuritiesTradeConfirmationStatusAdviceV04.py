...
class SecuritiesTradeConfirmationStatusAdviceV04(base_types._BaseFieldType):
	...
	__slots__ = ["_RplcmntPrcgSts", "_DlvrgSttlmPties", "_ConfPties", "_Id", "_AffirmSts", "_Refs", "_PrcgSts", "_CtrPtyTradgDtls", "_MtchgSts", "_PtyTradgDtls", "_SplmtryData", "_RcvgSttlmPties", "_CxlPrcgSts"]
	@property
