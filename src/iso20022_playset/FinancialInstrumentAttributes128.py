...
class FinancialInstrumentAttributes128(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrctSz", "_XpryDt", "_FltgRateFxgDt", "_DtdDt", "_NxtCllblDt", "_NxtFctr", "_MinNmnlQty", "_DayCntBsis", "_DnmtnCcy", "_PutblDt", "_PctgOfDebtClm", "_NxtIntrstRate", "_ConvsDt", "_PlcOfListg", "_WarrtParity", "_OptnStyle", "_PrvsFctr", "_ClssfctnTp", "_FinInstrmId", "_NxtCpnDt", "_MtrtyDt", "_IntrstRate", "_IsseDt"]
	@property
	def CtrctSz(self):
