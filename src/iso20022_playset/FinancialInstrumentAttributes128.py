...
class FinancialInstrumentAttributes128(base_types._BaseFieldType):
	...
	__slots__ = ["_IsseDt", "_ClssfctnTp", "_ConvsDt", "_NxtCllblDt", "_MinNmnlQty", "_FltgRateFxgDt", "_WarrtParity", "_FinInstrmId", "_DayCntBsis", "_MtrtyDt", "_PutblDt", "_DtdDt", "_NxtCpnDt", "_OptnStyle", "_IntrstRate", "_XpryDt", "_CtrctSz", "_PrvsFctr", "_NxtIntrstRate", "_PctgOfDebtClm", "_NxtFctr", "_PlcOfListg", "_DnmtnCcy"]
	@property
	def IsseDt(self):
		return self._IsseDt
	...
	def WarrtParity(self, value):
		self._WarrtParity = value if type(value) != auto else self.make_default("WarrtParity")
