...
class FinancialInstrumentAttributes128(base_types._BaseFieldType):
	...
	__slots__ = ["_DtdDt", "_DayCntBsis", "_PlcOfListg", "_FinInstrmId", "_IntrstRate", "_NxtFctr", "_WarrtParity", "_MtrtyDt", "_IsseDt", "_DnmtnCcy", "_NxtCpnDt", "_PctgOfDebtClm", "_MinNmnlQty", "_CtrctSz", "_PutblDt", "_NxtIntrstRate", "_XpryDt", "_ClssfctnTp", "_PrvsFctr", "_NxtCllblDt", "_ConvsDt", "_FltgRateFxgDt", "_OptnStyle"]
	@property
	def DtdDt(self):
		return self._DtdDt
