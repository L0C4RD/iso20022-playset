...
class FinancialInstrumentAttributes128(base_types._BaseFieldType):
	...
	__slots__ = ["_MtrtyDt", "_WarrtParity", "_XpryDt", "_PrvsFctr", "_NxtIntrstRate", "_DtdDt", "_PlcOfListg", "_IsseDt", "_PctgOfDebtClm", "_FltgRateFxgDt", "_OptnStyle", "_CtrctSz", "_DnmtnCcy", "_ClssfctnTp", "_NxtCpnDt", "_NxtCllblDt", "_FinInstrmId", "_IntrstRate", "_MinNmnlQty", "_DayCntBsis", "_ConvsDt", "_NxtFctr", "_PutblDt"]
	@property
	def MtrtyDt(self):
