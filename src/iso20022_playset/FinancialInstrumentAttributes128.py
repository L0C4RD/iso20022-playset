...
class FinancialInstrumentAttributes128(base_types._BaseFieldType):
	...
	__slots__ = ["_PctgOfDebtClm", "_IsseDt", "_NxtCllblDt", "_PrvsFctr", "_PlcOfListg", "_FinInstrmId", "_ConvsDt", "_WarrtParity", "_MinNmnlQty", "_ClssfctnTp", "_IntrstRate", "_NxtIntrstRate", "_PutblDt", "_DayCntBsis", "_MtrtyDt", "_NxtFctr", "_NxtCpnDt", "_CtrctSz", "_DtdDt", "_OptnStyle", "_DnmtnCcy", "_FltgRateFxgDt", "_XpryDt"]
	@property
