...
class FinancialInstrumentAttributes128(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrctSz", "_MtrtyDt", "_DtdDt", "_OptnStyle", "_NxtCllblDt", "_DayCntBsis", "_WarrtParity", "_XpryDt", "_PctgOfDebtClm", "_PlcOfListg", "_NxtIntrstRate", "_FinInstrmId", "_ConvsDt", "_NxtCpnDt", "_IsseDt", "_ClssfctnTp", "_NxtFctr", "_MinNmnlQty", "_PutblDt", "_FltgRateFxgDt", "_PrvsFctr", "_IntrstRate", "_DnmtnCcy"]
	@property
	def CtrctSz(self):
