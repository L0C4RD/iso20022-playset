...
class RoleAndBaselineAcceptanceNotificationV01(base_types._BaseFieldType):

	__slots__ = ["_TxSts", "_EstblishdBaselnId", "_UsrTxRef", "_Initr", "_TxId", "_NtfctnId", "_ReqForActn"]
	@property
