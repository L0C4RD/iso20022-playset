...
class AggregateBalancePerSafekeepingPlace41(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlBalBrkdwn", "_BalBrkdwn", "_PricDtls", "_PlcOfListg", "_AggtBal", "_XpsrTp", "_AvlblBal", "_HldgAddtlDtls", "_SfkpgPlc", "_QtyBrkdwn", "_InstrmCcyAmts", "_DaysAcrd", "_Pldgee", "_FXDtls", "_NotAvlblBal", "_AcctBaseCcyAmts"]
	@property
