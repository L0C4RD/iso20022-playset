...
class AccountMandateMaintenanceAmendmentRequestV05(base_types._BaseFieldType):
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='OrgId', type=OrganisationIdentification39, min=0, max=1, mutex_group=None, array=False),
