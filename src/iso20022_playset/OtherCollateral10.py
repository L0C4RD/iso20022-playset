...
class OtherCollateral10(base_types._BaseFieldType):
	...
	__slots__ = ["_BlckChainAdrOrWllt", "_AsstNb", "_IsseDt", "_Issr", "_OthrTpOfColl", "_XchgRate", "_Hrcut", "_MktVal", "_LtdCvrgInd", "_LttrOfCdtAmt", "_SfkpgPlc", "_XpryDt", "_ValDt", "_GrntAmt", "_SfkpgAcct", "_BlckdQty", "_CollVal", "_CollOwnrsh", "_LttrOfCdtId"]
	@property
