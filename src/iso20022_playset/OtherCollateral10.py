...
class OtherCollateral10(base_types._BaseFieldType):
	...
	__slots__ = ["_CollOwnrsh", "_OthrTpOfColl", "_IsseDt", "_AsstNb", "_LttrOfCdtId", "_LttrOfCdtAmt", "_MktVal", "_SfkpgAcct", "_XchgRate", "_XpryDt", "_CollVal", "_Issr", "_LtdCvrgInd", "_Hrcut", "_GrntAmt", "_SfkpgPlc", "_BlckChainAdrOrWllt", "_BlckdQty", "_ValDt"]
	@property
	def CollOwnrsh(self):
