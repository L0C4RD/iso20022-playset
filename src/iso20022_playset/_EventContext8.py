...
class EventContext8(base_types._BaseFieldType):
	...
	def CmpntId(self, value):
		self._CmpntId = value if value is not None else base_types.UninitialisedField(self, 'CmpntId', PointOfInteractionComponent18, False)

	@CmpntId.deleter
	def CmpntId(self):
		del self._CmpntId
		self._CmpntId = base_types.UninitialisedField(self, 'CmpntId', PointOfInteractionComponent18, False)
