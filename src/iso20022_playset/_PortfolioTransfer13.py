...
from .FinancialInstrument105 import FinancialInstrument105
...
class PortfolioTransfer13(base_types._BaseFieldType):
	...
	__slots__ = ["_AllOthrCsh", "_RsdlCsh", "_TaxDt", "_Prtfl", "_ActlTrfDt", "_TrfCmpltnId", "_FinInstrmAsstForTrf", "_CshAll", "_AddtlInf", "_TrfInstrRef", "_MstrRef", "_PmtDtls"]
	@property
	def AllOthrCsh(self):
