...
from .ExerciseDate1Choice import ExerciseDate1Choice
from .EmbeddedType1Code import EmbeddedType1Code
from .SecuritiesTransactionPrice17Choice import SecuritiesTransactionPrice17Choice
from .Schedule4 import Schedule4
...
from .OptionBarrierLevel1Choice import OptionBarrierLevel1Choice
from .ISODate import ISODate
from .OptionStyle6Code import OptionStyle6Code

class OptionOrSwaption11(base_types._BaseFieldType):

	__slots__ = ["_CallAmt", "_ExrcStyle", "_Tp", "_MbddTp", "_PrmAmt", "_MtrtyDtOfUndrlyg", "_BrrrLvls", "_PutAmt", "_PrmPmtDt", "_StrkPricSchdl", "_ExrcDt", "_StrkPric"]
	@property
	def CallAmt(self):
