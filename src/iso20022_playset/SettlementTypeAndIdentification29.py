...
class SettlementTypeAndIdentification29(base_types._BaseFieldType):
	...
	__slots__ = ["_CmonId", "_PrcrTxId", "_CtrPtyMktInfrstrctrTxId", "_Pmt", "_CorpActnEvtId", "_NonceId", "_AcctOwnrTxId", "_MktInfrstrctrTxId", "_PoolId", "_AcctSvcrTxId", "_SctiesMvmntTp"]
	@property
	def CmonId(self):
		return self._CmonId
