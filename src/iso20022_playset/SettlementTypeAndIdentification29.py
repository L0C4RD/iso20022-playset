...
class SettlementTypeAndIdentification29(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctSvcrTxId", "_CmonId", "_PoolId", "_MktInfrstrctrTxId", "_CtrPtyMktInfrstrctrTxId", "_NonceId", "_SctiesMvmntTp", "_CorpActnEvtId", "_AcctOwnrTxId", "_Pmt", "_PrcrTxId"]
	@property
