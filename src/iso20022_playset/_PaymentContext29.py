...
class PaymentContext29(base_types._BaseFieldType):
	...
	__slots__ = ["_FllbckInd", "_OnLineCntxt", "_CardPres", "_SpprtdOptn", "_TxChanl", "_CardDataNtryMd", "_AttndncCntxt", "_AttndntLang", "_TxEnvt", "_CrdhldrPres", "_BizArea", "_AttndntMsgCpbl"]
	@property
	def FllbckInd(self):
