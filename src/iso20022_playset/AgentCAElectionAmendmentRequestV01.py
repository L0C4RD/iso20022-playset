...
from .CorporateActionElection2 import CorporateActionElection2
from .CorporateActionElection1 import CorporateActionElection1
from .ContactPerson1 import ContactPerson1

class AgentCAElectionAmendmentRequestV01(base_types._BaseFieldType):

	__slots__ = ["_AmddElctnDtls", "_CorpActnGnlInf", "_OrgnlElctnDtls", "_Id", "_CtctDtls", "_AgtCAElctnAdvcId", "_AcctDtls"]
	@property
