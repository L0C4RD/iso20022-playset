...
class FeeCollectionInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_ConvsDtTm", "_Prgrmm", "_Card", "_TxAmts", "_Tkn", "_PrcgRslt", "_FeeColltnRef", "_SctyTrlr", "_Rcvr", "_Orgtr", "_Cntxt", "_AddtlData", "_AddtlFee", "_Jursdctn", "_Issr", "_TxId", "_Acqrr", "_Dstn", "_Accptr", "_TxChrtcs", "_SplmtryData", "_Hdr", "_OrgnlDataElmts", "_Sndr", "_SttlmSvc", "_PrtctdData", "_SpclPrgrmmQlfctn", "_AddtlAmt", "_Rcncltn"]
	@property
	def ConvsDtTm(self):
