...
class FeeCollectionInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Acqrr", "_Hdr", "_TxChrtcs", "_Dstn", "_PrtctdData", "_Card", "_Rcvr", "_Jursdctn", "_Sndr", "_ConvsDtTm", "_Prgrmm", "_AddtlFee", "_TxId", "_SpclPrgrmmQlfctn", "_Rcncltn", "_SplmtryData", "_AddtlData", "_Accptr", "_SttlmSvc", "_Tkn", "_Issr", "_Orgtr", "_PrcgRslt", "_OrgnlDataElmts", "_Cntxt", "_AddtlAmt", "_FeeColltnRef", "_SctyTrlr", "_TxAmts"]
	@property
	def Acqrr(self):
		return self._Acqrr
