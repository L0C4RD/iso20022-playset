...
class FeeCollectionInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Jursdctn", "_SplmtryData", "_Accptr", "_TxAmts", "_AddtlData", "_ConvsDtTm", "_Orgtr", "_Hdr", "_SttlmSvc", "_OrgnlDataElmts", "_Cntxt", "_Prgrmm", "_Sndr", "_Tkn", "_Card", "_Dstn", "_TxId", "_Rcvr", "_SpclPrgrmmQlfctn", "_Rcncltn", "_PrcgRslt", "_PrtctdData", "_SctyTrlr", "_Issr", "_AddtlAmt", "_Acqrr", "_AddtlFee", "_FeeColltnRef", "_TxChrtcs"]
	@property
	def Jursdctn(self):
