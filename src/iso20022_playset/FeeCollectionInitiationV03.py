...
class FeeCollectionInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlData", "_SctyTrlr", "_Hdr", "_Sndr", "_Orgtr", "_Acqrr", "_Accptr", "_TxId", "_PrcgRslt", "_Jursdctn", "_Rcvr", "_Prgrmm", "_OrgnlDataElmts", "_SpclPrgrmmQlfctn", "_TxAmts", "_AddtlFee", "_Dstn", "_AddtlAmt", "_Card", "_SttlmSvc", "_Rcncltn", "_PrtctdData", "_TxChrtcs", "_Issr", "_SplmtryData", "_ConvsDtTm", "_Tkn", "_Cntxt", "_FeeColltnRef"]
	@property
	def AddtlData(self):
