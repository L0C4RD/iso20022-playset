...
class FeeCollectionInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Sndr", "_TxAmts", "_SpclPrgrmmQlfctn", "_SttlmSvc", "_FeeColltnRef", "_Cntxt", "_TxId", "_Card", "_Rcvr", "_Prgrmm", "_TxChrtcs", "_ConvsDtTm", "_Rcncltn", "_Dstn", "_AddtlData", "_Jursdctn", "_Tkn", "_Acqrr", "_Hdr", "_SctyTrlr", "_AddtlAmt", "_PrcgRslt", "_AddtlFee", "_PrtctdData", "_Issr", "_OrgnlDataElmts", "_SplmtryData", "_Accptr", "_Orgtr"]
	@property
	def Sndr(self):
		return self._Sndr
