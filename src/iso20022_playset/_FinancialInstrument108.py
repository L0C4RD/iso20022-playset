...
class FinancialInstrument108(base_types._BaseFieldType):
	...
	def Convs(self, value):
		self._Convs = value if value is not None else base_types.UninitialisedField(self, 'Convs', Conversion5, False)

	@Convs.deleter
	def Convs(self):
		del self._Convs
		self._Convs = base_types.UninitialisedField(self, 'Convs', Conversion5, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='Convs', type=Conversion5, min=0, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='Instrm', type=FinancialInstrument101Choice, min=1, max=1, mutex_group=None, array=False),
