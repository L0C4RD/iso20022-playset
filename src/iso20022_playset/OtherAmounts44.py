...
class OtherAmounts44(base_types._BaseFieldType):
	...
	__slots__ = ["_NetGnLoss", "_RgltryAmt", "_BookVal", "_LclTaxCtrySpcfc", "_CsmptnTax", "_ExctgBrkrAmt", "_ChrgsFees", "_IsseDscntAllwnc", "_AcrdCptlstnAmt", "_Mrgn", "_RsrchFee", "_CtryNtlFdrlTax", "_TxTax", "_TrfTax", "_LclBrkrComssn", "_PmtLevyTax", "_StockXchgTax", "_Othr", "_TradAmt", "_SpclCncssn", "_LclTax", "_WhldgTax", "_AcrdIntrstAmt", "_ShppgAmt", "_StmpDty", "_ValAddedTax", "_CollMntrAmt"]
	@property
	def NetGnLoss(self):
