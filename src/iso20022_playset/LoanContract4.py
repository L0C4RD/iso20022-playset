...
class LoanContract4(base_types._BaseFieldType):
	...
	__slots__ = ["_DrtnCd", "_Buyr", "_IntrstSchdl", "_Amt", "_PmtSchdl", "_SpclConds", "_PrlngtnFlg", "_MtrtyDt", "_SttlmCcy", "_CtrctDocId", "_Attchmnt", "_Coll", "_SndctdLn", "_IntrstRate", "_LnTpId", "_Trch", "_IntraCpnyLn", "_StartDt", "_Sellr"]
	@property
	def DrtnCd(self):
		return self._DrtnCd
