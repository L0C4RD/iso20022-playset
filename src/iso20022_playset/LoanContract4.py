...
class LoanContract4(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrctDocId", "_SttlmCcy", "_Coll", "_Sellr", "_Attchmnt", "_SndctdLn", "_MtrtyDt", "_Trch", "_LnTpId", "_IntraCpnyLn", "_SpclConds", "_StartDt", "_Amt", "_PrlngtnFlg", "_PmtSchdl", "_IntrstRate", "_IntrstSchdl", "_DrtnCd", "_Buyr"]
	@property
	def CtrctDocId(self):
