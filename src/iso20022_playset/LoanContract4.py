...
class LoanContract4(base_types._BaseFieldType):
	...
	__slots__ = ["_MtrtyDt", "_IntrstRate", "_Trch", "_StartDt", "_SpclConds", "_SndctdLn", "_Buyr", "_Coll", "_DrtnCd", "_LnTpId", "_Sellr", "_SttlmCcy", "_Attchmnt", "_IntraCpnyLn", "_PrlngtnFlg", "_PmtSchdl", "_IntrstSchdl", "_Amt", "_CtrctDocId"]
	@property
	def MtrtyDt(self):
