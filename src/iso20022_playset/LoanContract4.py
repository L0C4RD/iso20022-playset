...
class LoanContract4(base_types._BaseFieldType):
	...
	__slots__ = ["_IntrstSchdl", "_DrtnCd", "_Buyr", "_PmtSchdl", "_CtrctDocId", "_IntrstRate", "_SpclConds", "_SttlmCcy", "_IntraCpnyLn", "_SndctdLn", "_LnTpId", "_Trch", "_Attchmnt", "_Sellr", "_MtrtyDt", "_PrlngtnFlg", "_Amt", "_Coll", "_StartDt"]
	@property
