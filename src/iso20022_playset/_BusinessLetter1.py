...
class BusinessLetter1(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlInf", "_OthrPty", "_Dt", "_VldtnStsInf", "_AssoctdDoc", "_RspnRcpt", "_ApplCntxt", "_AuthstnUsr", "_InstrPrty", "_DgtlSgntr", "_RltdMsg", "_Ntce", "_Orgtr", "_PmryRcpt", "_GovngCtrct", "_LglCntxt", "_RltdLttr", "_CpyRcpt", "_CnttIdr", "_LttrIdr", "_Sndr"]
	@property
	def AddtlInf(self):
