...
class BusinessLetter1(base_types._BaseFieldType):
	...
	__slots__ = ["_ApplCntxt", "_CnttIdr", "_AddtlInf", "_Dt", "_InstrPrty", "_RspnRcpt", "_RltdLttr", "_LttrIdr", "_Ntce", "_Orgtr", "_PmryRcpt", "_GovngCtrct", "_AuthstnUsr", "_OthrPty", "_VldtnStsInf", "_DgtlSgntr", "_AssoctdDoc", "_CpyRcpt", "_RltdMsg", "_LglCntxt", "_Sndr"]
	@property
	def ApplCntxt(self):
