...
class DebtorActivation5(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrctRef", "_UltmtDbtr", "_UltmtCdtr", "_Cdtr", "_CstmrId", "_DispNm", "_Dbtr", "_EndDt", "_DbtrSolPrvdr", "_StartDt", "_CtrctFrmtTp", "_ActvtnReqDlvryPty", "_DdctdActvtnCd", "_DbtrActvtnId"]
	@property
	def CtrctRef(self):
