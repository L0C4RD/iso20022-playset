...
class DebtorActivation5(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrctRef", "_StartDt", "_Cdtr", "_DispNm", "_DdctdActvtnCd", "_DbtrSolPrvdr", "_DbtrActvtnId", "_CstmrId", "_UltmtDbtr", "_ActvtnReqDlvryPty", "_EndDt", "_Dbtr", "_CtrctFrmtTp", "_UltmtCdtr"]
	@property
	def CtrctRef(self):
