...
class SecuritiesOption112(base_types._BaseFieldType):
	...
	__slots__ = ["_DtDtls", "_RcvgSttlmPties", "_CcyOptn", "_CtryOfIncmSrc", "_DlvrgSttlmPties", "_IncmTp", "_AmtDtls", "_RateDtls", "_PstngQty", "_IssrOfferrTaxbltyInd", "_XmptnTp", "_NewSctiesIssncInd", "_FrctnDspstn", "_SfkpgPlc", "_TempFinInstrmInd", "_FinInstrmId", "_PricDtls", "_CdtDbtInd", "_OthrIncmTp"]
	@property
	def DtDtls(self):
		return self._DtDtls
