...
class TransactionDetails157(base_types._BaseFieldType):
	...
	__slots__ = ["_BlckChainAdrOrWllt", "_Pmt", "_SttlmAmt", "_TradDt", "_RcvgSttlmPties", "_SttlmDt", "_Invstr", "_DlvrgSttlmPties", "_SttlmQty", "_FinInstrmId", "_SfkpgAcct", "_SctiesMvmntTp"]
	@property
