...
class TransactionDetails157(base_types._BaseFieldType):
	...
	__slots__ = ["_RcvgSttlmPties", "_Invstr", "_SttlmAmt", "_SttlmDt", "_TradDt", "_SttlmQty", "_SctiesMvmntTp", "_FinInstrmId", "_DlvrgSttlmPties", "_SfkpgAcct", "_Pmt", "_BlckChainAdrOrWllt"]
	@property
