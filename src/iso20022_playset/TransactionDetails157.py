...
class TransactionDetails157(base_types._BaseFieldType):
	...
	__slots__ = ["_RcvgSttlmPties", "_SttlmDt", "_DlvrgSttlmPties", "_SttlmAmt", "_TradDt", "_Pmt", "_BlckChainAdrOrWllt", "_Invstr", "_SttlmQty", "_SfkpgAcct", "_SctiesMvmntTp", "_FinInstrmId"]
	@property
