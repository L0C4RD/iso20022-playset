...
class Rate43(base_types._BaseFieldType):
	...
	__slots__ = ["_GrssIntrstRateUsdForPmt", "_NetDstrbtnRate", "_FsclStmp", "_WhldgTaxRate", "_TaxOnIncm", "_DmdRate", "_SlctnFeeRate", "_TaxOnPrfts", "_EqulstnRate", "_ScndLvlTax", "_TaxCdtRate", "_ChrgsFees", "_TaxRclmRate", "_AplblRate", "_EarlySlctnFeeRate", "_ThrdPtyIncntivRate", "_AddtlTax", "_GrssDstrbtnRate"]
	@property
	def AddtlTax(self):
