...
class StatusTrail13(base_types._BaseFieldType):
	...
	def ModPrcgSts(self, value):
		self._ModPrcgSts = value if value is not None else base_types.UninitialisedField(self, 'ModPrcgSts', ModificationProcessingStatus13Choice, False)

	@ModPrcgSts.deleter
	def ModPrcgSts(self):
		del self._ModPrcgSts
		self._ModPrcgSts = base_types.UninitialisedField(self, 'ModPrcgSts', ModificationProcessingStatus13Choice, False)
	...
	def PrcgSts(self, value):
		self._PrcgSts = value if value is not None else base_types.UninitialisedField(self, 'PrcgSts', ProcessingStatus103Choice, False)

	@PrcgSts.deleter
	def PrcgSts(self):
		del self._PrcgSts
		self._PrcgSts = base_types.UninitialisedField(self, 'PrcgSts', ProcessingStatus103Choice, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='ModPrcgSts', type=ModificationProcessingStatus13Choice, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='MtchgSts', type=MatchingStatus25Choice, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='PrcgSts', type=ProcessingStatus103Choice, min=0, max=1, mutex_group=None, array=False),
