...
class ClearingSystemMemberIdentificationChoice(base_types._BaseFieldType):

	__slots__ = ["_DEBLZ", "_ATBLZ", "_RUCB", "_GBSC", "_PTNCC", "_IENSC", "_CACPA", "_ESNCC", "_AUBSBs", "_USFW", "_NZNCC", "_HKNCC", "_CHSIC", "_ZANCC", "_ITNCC", "_USCH", "_AUBSBx", "_CHBC", "_USCHU"]
	@property
	def DEBLZ(self):
		return self._DEBLZ
