import base_types
import SettlementTransactionCondition20Choice
...
import SecuritiesTransactionType44Choice
...
class SettlementDetails217(base_types._BaseFieldType):
	...
	__slots__ = ["_Prty", "_CshClrSys", "_SttlgCpcty", "_TaxCpcty", "_DlvryRtrRsn", "_FxStgInstr", "_SttlmTxCond", "_ElgblForColl", "_Regn", "_LglRstrctns", "_BnfclOwnrsh", "_ModCxlAllwd", "_SttlmSysMtd", "_RtrLeg", "_CCPElgblty", "_AutomtcBrrwg", "_NetgElgblty", "_HldInd", "_MktClntSd", "_CshSubBalTp", "_RpTp", "_SctiesRTGS", "_StmpDtyTaxBsis", "_XpsrTp", "_BlckTrad", "_PrtlSttlmInd", "_SctiesSubBalTp", "_Trckg", "_LttrOfGrnt", "_SctiesTxTp"]
	@property
	def Prty(self):
		return self._Prty
