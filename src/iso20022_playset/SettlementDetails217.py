...
class SettlementDetails217(base_types._BaseFieldType):
	...
	__slots__ = ["_CshSubBalTp", "_Trckg", "_SctiesRTGS", "_RtrLeg", "_SctiesTxTp", "_NetgElgblty", "_SttlgCpcty", "_SctiesSubBalTp", "_PrtlSttlmInd", "_CshClrSys", "_MktClntSd", "_Regn", "_AutomtcBrrwg", "_BlckTrad", "_CCPElgblty", "_StmpDtyTaxBsis", "_LttrOfGrnt", "_RpTp", "_TaxCpcty", "_XpsrTp", "_BnfclOwnrsh", "_SttlmSysMtd", "_Prty", "_LglRstrctns", "_HldInd", "_FxStgInstr", "_ElgblForColl", "_SttlmTxCond", "_ModCxlAllwd", "_DlvryRtrRsn"]
	@property
