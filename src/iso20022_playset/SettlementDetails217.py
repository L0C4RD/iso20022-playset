...
class SettlementDetails217(base_types._BaseFieldType):
	...
	__slots__ = ["_HldInd", "_ElgblForColl", "_FxStgInstr", "_NetgElgblty", "_TaxCpcty", "_CshClrSys", "_ModCxlAllwd", "_Regn", "_MktClntSd", "_RtrLeg", "_Prty", "_SctiesSubBalTp", "_Trckg", "_CshSubBalTp", "_StmpDtyTaxBsis", "_DlvryRtrRsn", "_LttrOfGrnt", "_SctiesRTGS", "_CCPElgblty", "_LglRstrctns", "_SttlmTxCond", "_PrtlSttlmInd", "_SttlmSysMtd", "_AutomtcBrrwg", "_BnfclOwnrsh", "_RpTp", "_XpsrTp", "_SttlgCpcty", "_SctiesTxTp", "_BlckTrad"]
	@property
	def HldInd(self):
		return self._HldInd
