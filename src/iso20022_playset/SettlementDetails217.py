...
from .SettlementTransactionCondition20Choice import SettlementTransactionCondition20Choice
...
class SettlementDetails217(base_types._BaseFieldType):
	...
	__slots__ = ["_CshClrSys", "_ElgblForColl", "_CCPElgblty", "_StmpDtyTaxBsis", "_BlckTrad", "_MktClntSd", "_ModCxlAllwd", "_Regn", "_NetgElgblty", "_TaxCpcty", "_SctiesSubBalTp", "_SctiesTxTp", "_LglRstrctns", "_RpTp", "_SttlgCpcty", "_HldInd", "_SttlmTxCond", "_Trckg", "_CshSubBalTp", "_RtrLeg", "_FxStgInstr", "_XpsrTp", "_SctiesRTGS", "_Prty", "_BnfclOwnrsh", "_SttlmSysMtd", "_LttrOfGrnt", "_DlvryRtrRsn", "_PrtlSttlmInd", "_AutomtcBrrwg"]
	@property
	def CshClrSys(self):
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='SttlmTxCond', type=SettlementTransactionCondition20Choice, min=0, max=None, mutex_group=None, array=True),
