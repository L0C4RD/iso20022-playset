...
class SettlementDetails217(base_types._BaseFieldType):
	...
	__slots__ = ["_RpTp", "_TaxCpcty", "_NetgElgblty", "_MktClntSd", "_Regn", "_SttlmTxCond", "_AutomtcBrrwg", "_CshClrSys", "_FxStgInstr", "_CCPElgblty", "_BlckTrad", "_SttlgCpcty", "_LttrOfGrnt", "_PrtlSttlmInd", "_BnfclOwnrsh", "_SttlmSysMtd", "_SctiesSubBalTp", "_HldInd", "_XpsrTp", "_RtrLeg", "_StmpDtyTaxBsis", "_Trckg", "_SctiesTxTp", "_Prty", "_SctiesRTGS", "_ElgblForColl", "_ModCxlAllwd", "_CshSubBalTp", "_DlvryRtrRsn", "_LglRstrctns"]
	@property
	def RpTp(self):
		return self._RpTp
