...
class SettlementDetails217(base_types._BaseFieldType):
	...
	__slots__ = ["_RtrLeg", "_CshClrSys", "_CCPElgblty", "_SttlmTxCond", "_SctiesRTGS", "_ModCxlAllwd", "_SttlgCpcty", "_AutomtcBrrwg", "_NetgElgblty", "_BlckTrad", "_BnfclOwnrsh", "_TaxCpcty", "_SttlmSysMtd", "_SctiesSubBalTp", "_RpTp", "_DlvryRtrRsn", "_LglRstrctns", "_LttrOfGrnt", "_PrtlSttlmInd", "_StmpDtyTaxBsis", "_Trckg", "_ElgblForColl", "_XpsrTp", "_SctiesTxTp", "_MktClntSd", "_Regn", "_CshSubBalTp", "_HldInd", "_FxStgInstr", "_Prty"]
	@property
	def RtrLeg(self):
		return self._RtrLeg
