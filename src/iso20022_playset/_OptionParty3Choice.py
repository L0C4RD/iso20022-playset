...
class OptionParty3Choice(base_types._BaseFieldType):
	...
	@Cd.setter
	def Cd(self, value):
		self._Cd = value if value is not None else base_types.UninitialisedField(self, 'Cd', OptionParty1Code, True)

	@Cd.deleter
	def Cd(self):
		del self._Cd
		self._Cd = base_types.UninitialisedField(self, 'Cd', OptionParty1Code, True)
	...
	_field_defs = frozenset((
		base_types.FieldEntry(name='Cd', type=OptionParty1Code, min=1, max=None, mutex_group=1, array=True),
