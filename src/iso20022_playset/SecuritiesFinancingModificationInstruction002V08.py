...
class SecuritiesFinancingModificationInstruction002V08(base_types._BaseFieldType):
	...
	__slots__ = ["_TxTpAndModAddtlParams", "_SttlmParams", "_DlvrgSttlmPties", "_SplmtryData", "_QtyAndAcctDtls", "_TradDtls", "_RcvgSttlmPties", "_SctiesFincgAddtlDtls", "_OpngSttlmAmt", "_FinInstrmId"]
	@property
