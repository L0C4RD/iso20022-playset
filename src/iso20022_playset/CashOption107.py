...
class CashOption107(base_types._BaseFieldType):
	...
	__slots__ = ["_AmtDtls", "_IssrOfferrTaxbltyInd", "_XmptnTp", "_PricDtls", "_CshAcctId", "_CtryOfIncmSrc", "_CtrctlPmtInd", "_IncmTp", "_FXDtls", "_RateAndAmtDtls", "_DtDtls", "_PricClctnMtd", "_CdtDbtInd", "_NonElgblPrcdsInd", "_OthrIncmTp"]
	@property
	def AmtDtls(self):
