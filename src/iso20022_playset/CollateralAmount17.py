...
class CollateralAmount17(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlValOfOwnColl", "_TtlPdgCollOut", "_TtlXpsr", "_TtlOfPrncpls", "_TtlCshFaild", "_Mrgn", "_TtlCollReqrd", "_TermntnTxAmt", "_TtlAcrdIntrst", "_TtlPdgCollIn", "_ValOfCollHeld", "_TxAmt", "_TtlValOfReusdColl", "_TxAmtBrkdwn"]
	@property
