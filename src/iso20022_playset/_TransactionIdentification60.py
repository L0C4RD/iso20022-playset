...
class TransactionIdentification60(base_types._BaseFieldType):

	__slots__ = ["_AcqrrRefData", "_AcqrrRefNb", "_AuthntcnTkn", "_AuthstnSeqNb", "_IssrRefData", "_LclDt", "_LclTm", "_LifeCyclId", "_LifeCyclIdMssng", "_LifeCyclSpprt", "_NtlData", "_PresntmntSeqCnt", "_PresntmntSeqNb", "_PrvtData", "_PurchsIdr", "_PurchsIdrTp", "_RtrvlRefNb", "_SysTracAudtNb", "_TmZone", "_TrnsmssnDtTm"]
	@property
