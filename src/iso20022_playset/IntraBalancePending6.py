...
class IntraBalancePending6(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctSvcrTxId", "_PoolId", "_MktInfrstrctrTxId", "_CreDtTm", "_CorpActnEvtId", "_AcctOwnrTxId", "_Prty", "_BalFr", "_PrcrTxId", "_InstrPrcgAddtlDtls", "_SttlmAmt", "_BalTo", "_StsDt", "_StsAndRsn", "_SplmtryData", "_Lnkgs", "_MsgOrgtr", "_IntnddSttlmDt", "_CshSubBalId"]
	@property
