...
class IntraBalancePending6(base_types._BaseFieldType):
	...
	__slots__ = ["_InstrPrcgAddtlDtls", "_CshSubBalId", "_StsDt", "_Lnkgs", "_AcctOwnrTxId", "_PoolId", "_MsgOrgtr", "_AcctSvcrTxId", "_BalFr", "_PrcrTxId", "_SplmtryData", "_BalTo", "_CorpActnEvtId", "_SttlmAmt", "_StsAndRsn", "_MktInfrstrctrTxId", "_IntnddSttlmDt", "_CreDtTm", "_Prty"]
	@property
