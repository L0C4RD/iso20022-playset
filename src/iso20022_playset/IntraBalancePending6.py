...
class IntraBalancePending6(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_PoolId", "_MktInfrstrctrTxId", "_IntnddSttlmDt", "_PrcrTxId", "_BalTo", "_SttlmAmt", "_CshSubBalId", "_MsgOrgtr", "_AcctOwnrTxId", "_CorpActnEvtId", "_StsDt", "_Lnkgs", "_BalFr", "_CreDtTm", "_Prty", "_AcctSvcrTxId", "_StsAndRsn", "_InstrPrcgAddtlDtls"]
	@property
