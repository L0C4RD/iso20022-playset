...
class IntraBalancePending6(base_types._BaseFieldType):
	...
	__slots__ = ["_BalFr", "_MsgOrgtr", "_CshSubBalId", "_SttlmAmt", "_InstrPrcgAddtlDtls", "_AcctOwnrTxId", "_StsDt", "_CreDtTm", "_Lnkgs", "_StsAndRsn", "_PoolId", "_PrcrTxId", "_AcctSvcrTxId", "_Prty", "_CorpActnEvtId", "_BalTo", "_SplmtryData", "_IntnddSttlmDt", "_MktInfrstrctrTxId"]
	@property
	def BalFr(self):
		return self._BalFr
