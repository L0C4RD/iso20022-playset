...
class FundReferenceDataReport5(base_types._BaseFieldType):
	...
	__slots__ = ["_TrgtMktInd", "_DstrbtnStrtgy", "_RedPrcgChrtcs", "_TrgtMkt", "_AddtlInfUKMkt", "_CshSttlmDtls", "_FndDtls", "_ExAnteInd", "_AuthrsdPrxy", "_FndPties", "_SbcptPrcgChrtcs", "_ValtnDealgChrtcs", "_GnlRefDt", "_PlanChrtcs", "_MainFndOrdrDsk", "_CostsAndChrgs", "_ValForMny", "_InvstmtRstrctns", "_SwtchPrcgChrtcs", "_Vrsn", "_Id", "_SctyId", "_LclMktAnx", "_Xtnsn", "_PmtInstrm", "_ExPstInd", "_FndMgmtCpny"]
	@property
	def TrgtMktInd(self):
