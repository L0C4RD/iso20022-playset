...
class FraudDispositionResponseV04(base_types._BaseFieldType):

	__slots__ = ["_Acqrr", "_AddtlFee", "_Card", "_Crdhldr", "_Dstn", "_FrdTxId", "_Hdr", "_Issr", "_Jursdctn", "_NtlData", "_OrgnlRspnCd", "_Orgtr", "_PrcgRslt", "_Prgrmm", "_PrtctdData", "_PrvtData", "_Rcncltn", "_Rcvr", "_SctyTrlr", "_Sndr", "_SttlmSvc", "_Tkn"]
	@property
	def Acqrr(self):
		return self._Acqrr
