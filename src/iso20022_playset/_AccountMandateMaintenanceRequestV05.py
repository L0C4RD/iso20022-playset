...
class AccountMandateMaintenanceRequestV05(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctId", "_AcctSvcrId", "_AddtlMsgInf", "_CtrctDts", "_DgtlSgntr", "_Fr", "_Grp", "_Mndt", "_OrgId", "_Refs", "_SplmtryData", "_UndrlygMstrAgrmt"]
	@property
	def AcctId(self):
		return self._AcctId
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='OrgId', type=Organisation44, min=0, max=1, mutex_group=None, array=False),
