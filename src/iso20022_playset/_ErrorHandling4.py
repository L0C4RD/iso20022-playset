...
from . import ErrorHandling2Choice
...
class ErrorHandling4(base_types._BaseFieldType):
	...
	@Err.setter
	def Err(self, value):
		self._Err = value if value is not None else base_types.UninitialisedField(self, 'Err', ErrorHandling2Choice, False)

	@Err.deleter
	def Err(self):
		del self._Err
		self._Err = base_types.UninitialisedField(self, 'Err', ErrorHandling2Choice, False)
