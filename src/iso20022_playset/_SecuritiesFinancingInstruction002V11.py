...
class SecuritiesFinancingInstruction002V11(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_DlvrgSttlmPties", "_NbCounts", "_QtyAndAcctDtls", "_OpngSttlmAmt", "_FinInstrmAttrbts", "_OthrBizPties", "_Lnkgs", "_StgSttlmInstrDtls", "_TxId", "_TxTpAndAddtlParams", "_RcvgSttlmPties", "_CshPties", "_OthrAmts", "_TradDtls", "_SctiesFincgDtls", "_SttlmParams", "_FinInstrmId"]
	@property
