...
class SecuritiesFinancingInstruction002V11(base_types._BaseFieldType):
	...
	__slots__ = ["_TxTpAndAddtlParams", "_NbCounts", "_DlvrgSttlmPties", "_OthrBizPties", "_OthrAmts", "_TradDtls", "_CshPties", "_FinInstrmAttrbts", "_StgSttlmInstrDtls", "_SctiesFincgDtls", "_FinInstrmId", "_SttlmParams", "_OpngSttlmAmt", "_RcvgSttlmPties", "_SplmtryData", "_Lnkgs", "_TxId", "_QtyAndAcctDtls"]
	@property
