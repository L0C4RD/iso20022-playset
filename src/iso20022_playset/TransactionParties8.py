...
class TransactionParties8(base_types._BaseFieldType):
	...
	__slots__ = ["_InitgPty", "_PrvsInstgAgt3Acct", "_IntrmyAgt2", "_DbtrAgt", "_PrvsInstgAgt1Acct", "_IntrmyAgt1Acct", "_IntrmyAgt2Acct", "_DbtrAgtAcct", "_PrvsInstgAgt3", "_CdtrAgtAcct", "_PrvsInstgAgt2Acct", "_IntrmyAgt1", "_Dbtr", "_UltmtDbtr", "_IntrmyAgt3Acct", "_CdtrAcct", "_Cdtr", "_PrvsInstgAgt2", "_CdtrAgt", "_DbtrAcct", "_PrvsInstgAgt1", "_IntrmyAgt3", "_UltmtCdtr"]
	@property
	def InitgPty(self):
