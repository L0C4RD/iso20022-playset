...
class TransactionParties8(base_types._BaseFieldType):
	...
	__slots__ = ["_DbtrAcct", "_IntrmyAgt3Acct", "_IntrmyAgt2", "_CdtrAgt", "_CdtrAgtAcct", "_InitgPty", "_Dbtr", "_PrvsInstgAgt1Acct", "_PrvsInstgAgt2Acct", "_PrvsInstgAgt2", "_UltmtCdtr", "_DbtrAgtAcct", "_IntrmyAgt3", "_PrvsInstgAgt3Acct", "_UltmtDbtr", "_IntrmyAgt1Acct", "_PrvsInstgAgt1", "_CdtrAcct", "_IntrmyAgt1", "_IntrmyAgt2Acct", "_Cdtr", "_DbtrAgt", "_PrvsInstgAgt3"]
	@property
	def DbtrAcct(self):
