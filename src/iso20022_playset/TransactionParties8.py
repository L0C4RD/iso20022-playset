...
class TransactionParties8(base_types._BaseFieldType):
	...
	__slots__ = ["_PrvsInstgAgt1", "_PrvsInstgAgt1Acct", "_UltmtCdtr", "_CdtrAgtAcct", "_IntrmyAgt3", "_DbtrAgt", "_CdtrAgt", "_PrvsInstgAgt3", "_PrvsInstgAgt3Acct", "_Dbtr", "_CdtrAcct", "_DbtrAcct", "_PrvsInstgAgt2", "_PrvsInstgAgt2Acct", "_IntrmyAgt1", "_DbtrAgtAcct", "_Cdtr", "_InitgPty", "_IntrmyAgt2Acct", "_UltmtDbtr", "_IntrmyAgt2", "_IntrmyAgt1Acct", "_IntrmyAgt3Acct"]
	@property
