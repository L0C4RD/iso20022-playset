...
class StatusExtensionRejectionNotificationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_EstblishdBaselnId", "_NonXtndedSts", "_NtfctnId", "_ReqForActn", "_RjctnRsn", "_TxId", "_UsrTxRef"]
	@property
	...
	def NonXtndedSts(self, value):
		self._NonXtndedSts = value if value is not None else base_types.UninitialisedField(self, 'NonXtndedSts', TransactionStatus4, False)

	@NonXtndedSts.deleter
	def NonXtndedSts(self):
		del self._NonXtndedSts
		self._NonXtndedSts = base_types.UninitialisedField(self, 'NonXtndedSts', TransactionStatus4, False)
