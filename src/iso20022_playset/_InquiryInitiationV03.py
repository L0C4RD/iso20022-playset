...
class InquiryInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_XchgRate", "_Cntxt", "_ICCRltdData", "_PrcgRslt", "_SctyTrlr", "_Hdr", "_CstmrDvc", "_ConvsDtTm", "_Crdhldr", "_Issr", "_AddtlAmt", "_SttlmSvc", "_TxId", "_Rcncltn", "_Tkn", "_Orgtr", "_Accptr", "_Wllt", "_AcctFr", "_Instlmt", "_PrtctdData", "_SplmtryData", "_Termnl", "_TxChrtcs", "_Prgrmm", "_OrgnlRspnCd", "_Card", "_Acqrr", "_StrngCstmrAuthntcn", "_Vrfctn", "_AddtlData", "_Rcvr", "_Sndr", "_SpclPrgrmmQlfctn", "_Dstn", "_POICmpnt", "_AddtlSvc", "_Jursdctn", "_Rsk", "_TxAmts", "_AddtlFee"]
	@property
	def XchgRate(self):
