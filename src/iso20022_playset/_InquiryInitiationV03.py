...
class InquiryInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Orgtr", "_ConvsDtTm", "_Accptr", "_TxAmts", "_Tkn", "_Crdhldr", "_PrcgRslt", "_TxId", "_TxChrtcs", "_POICmpnt", "_Prgrmm", "_Cntxt", "_AddtlSvc", "_OrgnlRspnCd", "_Jursdctn", "_Rcvr", "_PrtctdData", "_AcctFr", "_XchgRate", "_SttlmSvc", "_ICCRltdData", "_SctyTrlr", "_Instlmt", "_SpclPrgrmmQlfctn", "_SplmtryData", "_Issr", "_Acqrr", "_Hdr", "_CstmrDvc", "_Wllt", "_AddtlFee", "_Termnl", "_Rsk", "_Sndr", "_StrngCstmrAuthntcn", "_Rcncltn", "_Card", "_AddtlData", "_AddtlAmt", "_Dstn", "_Vrfctn"]
	@property
	def Orgtr(self):
		return self._Orgtr
