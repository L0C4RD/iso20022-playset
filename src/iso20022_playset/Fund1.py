...
class Fund1(base_types._BaseFieldType):
	...
	__slots__ = ["_PrvsTradDtTm", "_PrvsTtlNAV", "_EstmtdNetCshFcstDtls", "_TradDtTm", "_Ccy", "_Id", "_EstmtdCshOutFcstDtls", "_EstmtdTtlUnitsNb", "_EstmtdTtlNAV", "_LglNttyIdr", "_EstmtdPctgOfFndTtlNAV", "_Nm", "_PrvsTtlUnitsNb", "_EstmtdCshInFcstDtls"]
	@property
