...
class Transaction127(base_types._BaseFieldType):
	...
	__slots__ = ["_CmonId", "_AcctSvcrTxId", "_TrptyAgtSvcPrvdrCollTxId", "_ClntCollInstrId", "_TrptyAgtSvcPrvdrCollInstrId", "_CorpActnEvtId", "_AcctOwnrTxId", "_PoolId", "_CtrPtyMktInfrstrctrTxId", "_ClntTrptyCollTxId", "_TradId", "_PrcrTxId", "_MktInfrstrctrTxId", "_TxDtls"]
	@property
	def CmonId(self):
		return self._CmonId
