...
class TransactionReportItems3(base_types._BaseFieldType):
	...
	__slots__ = ["_TxSts", "_BuyrBkCtry", "_TtlNetAmt", "_Buyr", "_SubmitgBk", "_EstblishdBaselnId", "_OblgrBk", "_BuyrBk", "_PurchsOrdrRef", "_SellrBkCtry", "_PdgReqForActn", "_Sellr", "_UsrTxRef", "_SellrBk", "_TxId", "_OutsdngAmt"]
	@property
	def TxSts(self):
		return self._TxSts
