...
class SecuritiesFinancingTransactionDetails48(base_types._BaseFieldType):
	...
	__slots__ = ["_Sprd", "_RateTp", "_TtlNbOfCollInstrs", "_FrftAmt", "_PrmAmt", "_TxCallDely", "_ScndLegNrrtv", "_TermntnTxAmt", "_LclBrkrComssn", "_Rvaltn", "_StockLnMrgn", "_MtrtyDtMod", "_PricgRate", "_RateChngDt", "_LglFrmwk", "_TermntnAmtPerPcOfColl", "_AcrdIntrstAmt", "_IntrstPmt", "_SctiesFincgTradId", "_DealAmt", "_ChrgsRate", "_VarblRateSpprt", "_IntrstCmptnMtd", "_EarlstCallBckDt", "_ClsgLegId", "_RpRate", "_ComssnClctnDt", "_TermntnDt", "_SctiesHrcut"]
	@property
