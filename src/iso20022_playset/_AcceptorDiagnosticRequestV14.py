...
from . import AcceptorDiagnosticRequest14
...
class AcceptorDiagnosticRequestV14(base_types._BaseFieldType):
	...
	def DgnstcReq(self, value):
		self._DgnstcReq = value if value is not None else base_types.UninitialisedField(self, 'DgnstcReq', AcceptorDiagnosticRequest14, False)

	@DgnstcReq.deleter
	def DgnstcReq(self):
		del self._DgnstcReq
		self._DgnstcReq = base_types.UninitialisedField(self, 'DgnstcReq', AcceptorDiagnosticRequest14, False)
