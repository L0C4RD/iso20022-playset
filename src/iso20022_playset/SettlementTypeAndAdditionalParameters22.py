...
class SettlementTypeAndAdditionalParameters22(base_types._BaseFieldType):
	...
	__slots__ = ["_CmonId", "_TrptyAgtSvcPrvdrCollTxId", "_RcncltnInd", "_TrptyAgtSvcPrvdrCollInstrId", "_ClntTrptyCollTxId", "_SctiesMvmntTp", "_CorpActnEvtId", "_Pmt", "_ClntCollInstrId"]
	@property
	def CmonId(self):
		return self._CmonId
