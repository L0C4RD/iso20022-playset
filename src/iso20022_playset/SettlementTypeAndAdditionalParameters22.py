...
class SettlementTypeAndAdditionalParameters22(base_types._BaseFieldType):
	...
	__slots__ = ["_ClntTrptyCollTxId", "_Pmt", "_CmonId", "_TrptyAgtSvcPrvdrCollTxId", "_TrptyAgtSvcPrvdrCollInstrId", "_CorpActnEvtId", "_RcncltnInd", "_SctiesMvmntTp", "_ClntCollInstrId"]
	@property
