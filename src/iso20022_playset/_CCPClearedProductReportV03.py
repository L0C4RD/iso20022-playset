...
class CCPClearedProductReportV03(base_types._BaseFieldType):
	...
	def ClrdPdct(self, value):
		self._ClrdPdct = value if value is not None else base_types.UninitialisedField(self, 'ClrdPdct', ClearedProduct3, True)

	@ClrdPdct.deleter
	def ClrdPdct(self):
		del self._ClrdPdct
		self._ClrdPdct = base_types.UninitialisedField(self, 'ClrdPdct', ClearedProduct3, True)
