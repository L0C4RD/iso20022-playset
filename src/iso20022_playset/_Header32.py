...
class Header32(base_types._BaseFieldType):
	...
	def ReTrnsmssnCntr(self, value):
		self._ReTrnsmssnCntr = value if value is not None else base_types.UninitialisedField(self, 'ReTrnsmssnCntr', Number, False)

	@ReTrnsmssnCntr.deleter
	def ReTrnsmssnCntr(self):
		del self._ReTrnsmssnCntr
		self._ReTrnsmssnCntr = base_types.UninitialisedField(self, 'ReTrnsmssnCntr', Number, False)
