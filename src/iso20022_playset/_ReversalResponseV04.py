...
class ReversalResponseV04(base_types._BaseFieldType):
	...
	__slots__ = ["_Orgtr", "_AcctTo", "_ConvsDtTm", "_Tkn", "_Termnl", "_AddtlSvc", "_Jursdctn", "_Rcvr", "_SttlmSvc", "_AcctFr", "_PrtctdData", "_Card", "_ICCRltdData", "_Cntxt", "_SctyTrlr", "_TxId", "_SpclPrgrmmQlfctn", "_SplmtryData", "_Issr", "_Acqrr", "_Hdr", "_TxChrtcs", "_TxAmts", "_AddtlFee", "_Accptr", "_Sndr", "_Prgrmm", "_Rcncltn", "_PrcgRslt", "_AddtlData", "_OrgnlDataElmts", "_AddtlAmt", "_Dstn"]
	@property
	def Orgtr(self):
		return self._Orgtr
