...
class ReversalResponseV04(base_types._BaseFieldType):
	...
	__slots__ = ["_ICCRltdData", "_Cntxt", "_SctyTrlr", "_Hdr", "_ConvsDtTm", "_Issr", "_AddtlAmt", "_Rcncltn", "_AddtlFee", "_Tkn", "_Termnl", "_Orgtr", "_Prgrmm", "_PrtctdData", "_AcctFr", "_SplmtryData", "_AcctTo", "_PrcgRslt", "_Accptr", "_Card", "_TxAmts", "_TxId", "_Acqrr", "_OrgnlDataElmts", "_AddtlData", "_Rcvr", "_Sndr", "_SpclPrgrmmQlfctn", "_Dstn", "_TxChrtcs", "_AddtlSvc", "_Jursdctn", "_SttlmSvc"]
	@property
