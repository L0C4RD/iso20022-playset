...
class NetReportV04(base_types._BaseFieldType):
	...
	def NetOblgtn(self, value):
		self._NetOblgtn = value if value is not None else base_types.UninitialisedField(self, 'NetOblgtn', NetObligation4, True)

	@NetOblgtn.deleter
	def NetOblgtn(self):
		del self._NetOblgtn
		self._NetOblgtn = base_types.UninitialisedField(self, 'NetOblgtn', NetObligation4, True)
	...
	_field_defs = frozenset((
		base_types.FieldEntry(name='NetOblgtn', type=NetObligation4, min=1, max=None, mutex_group=None, array=True),
