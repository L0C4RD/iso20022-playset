...
from .PartyIdentification274 import PartyIdentification274
...
class Organisation42(base_types._BaseFieldType):
	...
	__slots__ = ["_LglRprtv", "_CtryOfOpr", "_RegnDt", "_BizAdr", "_OrgId", "_RprtvOffcr", "_Sndr", "_LglAdr", "_FullLglNm", "_OprlAdr", "_MainMndtHldr", "_TrsrMgr", "_BllgAdr", "_TradgNm"]
	@property
	def LglRprtv(self):
