...
class SecuritiesTradeDetails143(base_types._BaseFieldType):
	...
	__slots__ = ["_UnqTxIdr", "_NbOfDaysAcrd", "_OpngClsg", "_PlcOfClr", "_PlcOfTrad", "_TpOfPric", "_FxAddtlDtls", "_TradOrgtrRole", "_SttlmInstrPrcgAddtlDtls", "_SttlmDt", "_Rptg", "_TradTxCond", "_TradId", "_InvstrCpcty", "_TradDt", "_DealPric", "_CollTxId", "_FctvSttlmDt"]
	@property
	def UnqTxIdr(self):
