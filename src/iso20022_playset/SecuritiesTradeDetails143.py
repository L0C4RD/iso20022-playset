...
class SecuritiesTradeDetails143(base_types._BaseFieldType):
	...
	__slots__ = ["_UnqTxIdr", "_PlcOfTrad", "_SttlmInstrPrcgAddtlDtls", "_SttlmDt", "_TradOrgtrRole", "_TradTxCond", "_OpngClsg", "_FxAddtlDtls", "_InvstrCpcty", "_TradDt", "_TradId", "_NbOfDaysAcrd", "_FctvSttlmDt", "_PlcOfClr", "_CollTxId", "_Rptg", "_TpOfPric", "_DealPric"]
	@property
	def UnqTxIdr(self):
