...
from .SettlementDate18Choice import SettlementDate18Choice
...
class SecuritiesTradeDetails143(base_types._BaseFieldType):
	...
	__slots__ = ["_TpOfPric", "_Rptg", "_DealPric", "_PlcOfTrad", "_SttlmDt", "_OpngClsg", "_PlcOfClr", "_TradTxCond", "_NbOfDaysAcrd", "_UnqTxIdr", "_TradDt", "_FxAddtlDtls", "_TradId", "_CollTxId", "_TradOrgtrRole", "_InvstrCpcty", "_SttlmInstrPrcgAddtlDtls", "_FctvSttlmDt"]
	@property
	def TpOfPric(self):
