...
class SecuritiesTradeDetails143(base_types._BaseFieldType):
	...
	__slots__ = ["_DealPric", "_Rptg", "_SttlmDt", "_TradTxCond", "_PlcOfClr", "_UnqTxIdr", "_OpngClsg", "_TradOrgtrRole", "_CollTxId", "_PlcOfTrad", "_TpOfPric", "_TradId", "_InvstrCpcty", "_FxAddtlDtls", "_NbOfDaysAcrd", "_TradDt", "_SttlmInstrPrcgAddtlDtls", "_FctvSttlmDt"]
	@property
	def DealPric(self):
