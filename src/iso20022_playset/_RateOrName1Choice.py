...
class RateOrName1Choice(base_types._BaseFieldType):
	...
	def RateNm(self, value):
		self._RateNm = value if value is not None else base_types.UninitialisedField(self, 'RateNm', RateName1, False)

	@RateNm.deleter
	def RateNm(self):
		del self._RateNm
		self._RateNm = base_types.UninitialisedField(self, 'RateNm', RateName1, False)
