...
class RetrievalFulfilmentInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Accptr", "_Acqrr", "_AddtlData", "_AddtlFee", "_Card", "_Cntxt", "_ConvsDtTm", "_DsptData", "_Dstn", "_Hdr", "_Issr", "_Jursdctn", "_OrgnlTx", "_Orgtr", "_PrcgRslt", "_Prgrmm", "_PrtctdData", "_Pyee", "_Pyer", "_Rcncltn", "_Rcvr", "_RtrvlFlfmtInstrs", "_SctyTrlr", "_Sndr", "_SpclPrgrmmQlfctn", "_SplmtryData", "_SttlmSvc", "_Termnl", "_Tkn", "_TxChrtcs", "_TxId", "_Wllt"]
	@property
	def Accptr(self):
		return self._Accptr
