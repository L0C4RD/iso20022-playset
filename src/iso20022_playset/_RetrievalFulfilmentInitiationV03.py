...
class RetrievalFulfilmentInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Termnl", "_Sndr", "_AddtlData", "_AddtlFee", "_Pyee", "_Rcncltn", "_ConvsDtTm", "_Pyer", "_DsptData", "_RtrvlFlfmtInstrs", "_Orgtr", "_Acqrr", "_Dstn", "_OrgnlTx", "_TxId", "_Issr", "_Jursdctn", "_Cntxt", "_Hdr", "_Tkn", "_TxChrtcs", "_Prgrmm", "_SctyTrlr", "_Card", "_Rcvr", "_Accptr", "_SttlmSvc", "_PrtctdData", "_SpclPrgrmmQlfctn", "_Wllt", "_SplmtryData", "_PrcgRslt"]
	@property
	def Accptr(self):
		return self._Accptr
