...
class PartyIdentification284(base_types._BaseFieldType):
	...
	__slots__ = ["_Adr", "_AddtlId", "_OwnrEthnctyTpPrvddBy", "_AddtlCtct", "_URLAdr", "_AddtlAdr", "_GeogcLctn", "_ShrtNm", "_Email", "_CstmrSvc", "_OwnrTpPrvddBy", "_Id", "_PhneNb", "_TaxRegnId", "_BizTpPrvddBy", "_CorpTaxIdTp", "_LclData", "_CertfctnTp", "_LglCorpNm", "_Ctry", "_Assgnr", "_CertfctnTpPrvddBy", "_OwnrEthnctyTp", "_BizTp", "_NmAndLctn", "_OwnrTp", "_CorpTaxId", "_AddtlData"]
	@property
	def Adr(self):
		return self._Adr
