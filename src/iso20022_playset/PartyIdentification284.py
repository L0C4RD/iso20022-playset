...
class PartyIdentification284(base_types._BaseFieldType):
	...
	__slots__ = ["_GeogcLctn", "_CorpTaxId", "_Email", "_Assgnr", "_OwnrEthnctyTp", "_Adr", "_AddtlCtct", "_CstmrSvc", "_CorpTaxIdTp", "_LglCorpNm", "_AddtlId", "_ShrtNm", "_NmAndLctn", "_LclData", "_AddtlAdr", "_Ctry", "_OwnrEthnctyTpPrvddBy", "_OwnrTpPrvddBy", "_OwnrTp", "_CertfctnTp", "_TaxRegnId", "_CertfctnTpPrvddBy", "_BizTpPrvddBy", "_PhneNb", "_Id", "_URLAdr", "_BizTp", "_AddtlData"]
	@property
	def GeogcLctn(self):
