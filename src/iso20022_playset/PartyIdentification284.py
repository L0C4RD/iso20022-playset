...
class PartyIdentification284(base_types._BaseFieldType):
	...
	__slots__ = ["_Assgnr", "_AddtlAdr", "_Email", "_OwnrEthnctyTp", "_CertfctnTp", "_BizTp", "_OwnrEthnctyTpPrvddBy", "_GeogcLctn", "_BizTpPrvddBy", "_CorpTaxId", "_Adr", "_Ctry", "_CstmrSvc", "_AddtlCtct", "_NmAndLctn", "_LclData", "_CorpTaxIdTp", "_OwnrTpPrvddBy", "_URLAdr", "_AddtlId", "_OwnrTp", "_ShrtNm", "_PhneNb", "_Id", "_CertfctnTpPrvddBy", "_LglCorpNm", "_TaxRegnId", "_AddtlData"]
	@property
	def Assgnr(self):
		return self._Assgnr
