...
class PartyIdentification284(base_types._BaseFieldType):
	...
	__slots__ = ["_CstmrSvc", "_LglCorpNm", "_Ctry", "_NmAndLctn", "_TaxRegnId", "_OwnrEthnctyTpPrvddBy", "_AddtlAdr", "_CertfctnTp", "_Assgnr", "_Adr", "_ShrtNm", "_CorpTaxId", "_BizTpPrvddBy", "_CertfctnTpPrvddBy", "_PhneNb", "_LclData", "_URLAdr", "_GeogcLctn", "_BizTp", "_Id", "_CorpTaxIdTp", "_OwnrTp", "_OwnrEthnctyTp", "_AddtlData", "_OwnrTpPrvddBy", "_AddtlCtct", "_AddtlId", "_Email"]
	@property
	def CstmrSvc(self):
