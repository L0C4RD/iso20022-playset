...
class PartyIdentification284(base_types._BaseFieldType):
	...
	__slots__ = ["_LclData", "_Ctry", "_URLAdr", "_BizTpPrvddBy", "_CertfctnTp", "_AddtlAdr", "_OwnrTpPrvddBy", "_AddtlId", "_AddtlData", "_LglCorpNm", "_TaxRegnId", "_AddtlCtct", "_BizTp", "_PhneNb", "_OwnrEthnctyTp", "_CorpTaxIdTp", "_CstmrSvc", "_Id", "_CorpTaxId", "_NmAndLctn", "_CertfctnTpPrvddBy", "_ShrtNm", "_OwnrEthnctyTpPrvddBy", "_Adr", "_OwnrTp", "_Email", "_Assgnr", "_GeogcLctn"]
	@property
	def LclData(self):
