...
class OrderData4(base_types._BaseFieldType):
	...
	__slots__ = ["_ClntId", "_TradgCpcty", "_DrctElctrncAccs", "_TxData", "_LqdtyPrvsnActvty", "_ExctgPrsn", "_InvstmtDcsnPrsn", "_InstrData", "_NonExctgBrkr", "_OrdrClssfctn", "_OrdrPrics", "_SubmitgNtty"]
	@property
	def ClntId(self):
		return self._ClntId
