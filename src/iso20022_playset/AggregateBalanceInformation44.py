...
class AggregateBalanceInformation44(base_types._BaseFieldType):
	...
	__slots__ = ["_CorpActnOptnTp", "_SfkpgPlc", "_DaysAcrd", "_AvlblBal", "_AggtBal", "_ValtnHrcutDtls", "_AddtlBalBrkdwn", "_FXDtls", "_BalAtSfkpgPlc", "_NotAvlblBal", "_FinInstrmId", "_FinInstrmAttrbts", "_AcctBaseCcyAmts", "_PricDtls", "_QtyBrkdwn", "_SplmtryData", "_BalBrkdwn", "_HldgAddtlDtls", "_InstrmCcyAmts", "_InvstmtFndsFinInstrmAttrbts"]
	@property
