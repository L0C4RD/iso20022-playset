...
from .AggregateBalancePerSafekeepingPlace41 import AggregateBalancePerSafekeepingPlace41
...
class AggregateBalanceInformation44(base_types._BaseFieldType):
	...
	__slots__ = ["_AvlblBal", "_NotAvlblBal", "_ValtnHrcutDtls", "_AggtBal", "_PricDtls", "_AcctBaseCcyAmts", "_BalBrkdwn", "_QtyBrkdwn", "_InvstmtFndsFinInstrmAttrbts", "_FXDtls", "_DaysAcrd", "_FinInstrmAttrbts", "_SplmtryData", "_BalAtSfkpgPlc", "_SfkpgPlc", "_AddtlBalBrkdwn", "_InstrmCcyAmts", "_HldgAddtlDtls", "_CorpActnOptnTp", "_FinInstrmId"]
	@property
	def AvlblBal(self):
