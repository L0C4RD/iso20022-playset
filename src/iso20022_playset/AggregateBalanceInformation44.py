...
class AggregateBalanceInformation44(base_types._BaseFieldType):
	...
	__slots__ = ["_HldgAddtlDtls", "_FinInstrmId", "_CorpActnOptnTp", "_InstrmCcyAmts", "_InvstmtFndsFinInstrmAttrbts", "_FinInstrmAttrbts", "_NotAvlblBal", "_SfkpgPlc", "_BalBrkdwn", "_AggtBal", "_BalAtSfkpgPlc", "_FXDtls", "_ValtnHrcutDtls", "_AvlblBal", "_AcctBaseCcyAmts", "_QtyBrkdwn", "_DaysAcrd", "_AddtlBalBrkdwn", "_PricDtls", "_SplmtryData"]
	@property
