...
class AggregateBalanceInformation44(base_types._BaseFieldType):
	...
	__slots__ = ["_BalBrkdwn", "_InvstmtFndsFinInstrmAttrbts", "_FinInstrmAttrbts", "_DaysAcrd", "_FXDtls", "_ValtnHrcutDtls", "_CorpActnOptnTp", "_FinInstrmId", "_AvlblBal", "_AcctBaseCcyAmts", "_InstrmCcyAmts", "_BalAtSfkpgPlc", "_QtyBrkdwn", "_SplmtryData", "_PricDtls", "_HldgAddtlDtls", "_SfkpgPlc", "_AggtBal", "_NotAvlblBal", "_AddtlBalBrkdwn"]
	@property
	def BalBrkdwn(self):
