...
class AggregateBalanceInformation44(base_types._BaseFieldType):
	...
	__slots__ = ["_QtyBrkdwn", "_SplmtryData", "_CorpActnOptnTp", "_AvlblBal", "_BalAtSfkpgPlc", "_InvstmtFndsFinInstrmAttrbts", "_HldgAddtlDtls", "_ValtnHrcutDtls", "_SfkpgPlc", "_FinInstrmId", "_NotAvlblBal", "_BalBrkdwn", "_AcctBaseCcyAmts", "_InstrmCcyAmts", "_FinInstrmAttrbts", "_FXDtls", "_AddtlBalBrkdwn", "_AggtBal", "_PricDtls", "_DaysAcrd"]
	@property
	def QtyBrkdwn(self):
