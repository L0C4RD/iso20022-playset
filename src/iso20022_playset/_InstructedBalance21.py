...
from . import InstructedCorporateActionOption22
...
class InstructedBalance21(base_types._BaseFieldType):
	...
	def OptnDtls(self, value):
		self._OptnDtls = value if value is not None else base_types.UninitialisedField(self, 'OptnDtls', InstructedCorporateActionOption22, True)

	@OptnDtls.deleter
	def OptnDtls(self):
		del self._OptnDtls
		self._OptnDtls = base_types.UninitialisedField(self, 'OptnDtls', InstructedCorporateActionOption22, True)
	...
	def TtlAccptdInstrBal(self, value):
		self._TtlAccptdInstrBal = value if value is not None else base_types.UninitialisedField(self, 'TtlAccptdInstrBal', SignedQuantityFormat13, False)

	@TtlAccptdInstrBal.deleter
	def TtlAccptdInstrBal(self):
		del self._TtlAccptdInstrBal
		self._TtlAccptdInstrBal = base_types.UninitialisedField(self, 'TtlAccptdInstrBal', SignedQuantityFormat13, False)
	...
	def TtlCancInstrBal(self, value):
		self._TtlCancInstrBal = value if value is not None else base_types.UninitialisedField(self, 'TtlCancInstrBal', SignedQuantityFormat13, False)

	@TtlCancInstrBal.deleter
	def TtlCancInstrBal(self):
		del self._TtlCancInstrBal
		self._TtlCancInstrBal = base_types.UninitialisedField(self, 'TtlCancInstrBal', SignedQuantityFormat13, False)
	...
	def TtlInstdBal(self, value):
		self._TtlInstdBal = value if value is not None else base_types.UninitialisedField(self, 'TtlInstdBal', BalanceFormat14Choice, False)

	@TtlInstdBal.deleter
	def TtlInstdBal(self):
		del self._TtlInstdBal
		self._TtlInstdBal = base_types.UninitialisedField(self, 'TtlInstdBal', BalanceFormat14Choice, False)
	...
	def TtlPdgInstrBal(self, value):
		self._TtlPdgInstrBal = value if value is not None else base_types.UninitialisedField(self, 'TtlPdgInstrBal', SignedQuantityFormat13, False)

	@TtlPdgInstrBal.deleter
	def TtlPdgInstrBal(self):
		del self._TtlPdgInstrBal
		self._TtlPdgInstrBal = base_types.UninitialisedField(self, 'TtlPdgInstrBal', SignedQuantityFormat13, False)
	...
	def TtlPrtctInstrBal(self, value):
		self._TtlPrtctInstrBal = value if value is not None else base_types.UninitialisedField(self, 'TtlPrtctInstrBal', SignedQuantityFormat13, False)

	@TtlPrtctInstrBal.deleter
	def TtlPrtctInstrBal(self):
		del self._TtlPrtctInstrBal
		self._TtlPrtctInstrBal = base_types.UninitialisedField(self, 'TtlPrtctInstrBal', SignedQuantityFormat13, False)
	...
	def TtlRjctdInstrBal(self, value):
		self._TtlRjctdInstrBal = value if value is not None else base_types.UninitialisedField(self, 'TtlRjctdInstrBal', SignedQuantityFormat13, False)

	@TtlRjctdInstrBal.deleter
	def TtlRjctdInstrBal(self):
		del self._TtlRjctdInstrBal
		self._TtlRjctdInstrBal = base_types.UninitialisedField(self, 'TtlRjctdInstrBal', SignedQuantityFormat13, False)
