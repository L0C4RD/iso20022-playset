...
class OriginalGroupHeader17(base_types._BaseFieldType):

	__slots__ = ["_OrgnlCtrlSum", "_OrgnlNbOfTxs", "_OrgnlCreDtTm", "_GrpSts", "_NbOfTxsPerSts", "_OrgnlMsgId", "_OrgnlMsgNmId", "_StsRsnInf"]
	@property
