...
class ATMTransaction38(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlReqdAmt", "_ICCRltdData", "_PrtctdAcctTo", "_PrtctdAcctFr", "_TxId", "_DtldReqdAmt", "_ReqdExctnDt", "_ReqdRct", "_RcncltnId", "_AcctFr", "_AcctTo", "_CdtrLabl", "_InstntTrfPrgm", "_RcrngTrf", "_DbtrLabl", "_PmtRef"]
	@property
	def TtlReqdAmt(self):
