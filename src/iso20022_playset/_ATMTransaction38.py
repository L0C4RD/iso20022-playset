...
class ATMTransaction38(base_types._BaseFieldType):
	...
	__slots__ = ["_ReqdExctnDt", "_CdtrLabl", "_ReqdRct", "_TxId", "_PrtctdAcctTo", "_DbtrLabl", "_PrtctdAcctFr", "_DtldReqdAmt", "_InstntTrfPrgm", "_RcncltnId", "_TtlReqdAmt", "_PmtRef", "_AcctFr", "_ICCRltdData", "_AcctTo", "_RcrngTrf"]
	@property
