...
class Identification29(base_types._BaseFieldType):
	...
	__slots__ = ["_PrcrTxId", "_ListId", "_CorpActnEvtId", "_AcctOwnrTxId", "_BsktId", "_TradId", "_CtrPtyMktInfrstrctrTxId", "_CmonId", "_PoolId", "_MktInfrstrctrTxId", "_MstrId", "_PrgmId", "_IndxId", "_AcctSvcrTxId"]
	@property
	def PrcrTxId(self):
