...
class Identification29(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctSvcrTxId", "_PrcrTxId", "_CtrPtyMktInfrstrctrTxId", "_TradId", "_PrgmId", "_MktInfrstrctrTxId", "_CmonId", "_MstrId", "_BsktId", "_AcctOwnrTxId", "_CorpActnEvtId", "_PoolId", "_IndxId", "_ListId"]
	@property
