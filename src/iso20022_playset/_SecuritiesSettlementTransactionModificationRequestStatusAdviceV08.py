...
class SecuritiesSettlementTransactionModificationRequestStatusAdviceV08(base_types._BaseFieldType):
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='ModPrcgSts', type=ModificationProcessingStatus12Choice, min=1, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='TxDtls', type=TransactionDetails182, min=0, max=1, mutex_group=None, array=False),
