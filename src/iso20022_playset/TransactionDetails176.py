...
from .TransactionDetails172 import TransactionDetails172
...
class TransactionDetails176(base_types._BaseFieldType):

	__slots__ = ["_PrcrTxId", "_AcctOwnr", "_BlckChainAdrOrWllt", "_MktInfrstrctrTxId", "_SfkpgAcct", "_OthrTxId", "_AcctOwnrTxId", "_AcctSvcrTxId", "_TxDtls"]
	@property
	def PrcrTxId(self):
