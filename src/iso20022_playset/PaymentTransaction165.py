...
class PaymentTransaction165(base_types._BaseFieldType):
	...
	__slots__ = ["_TxCaptr", "_TxDtls", "_PmtInstrm", "_CstmrCnsnt", "_CardPrgrmmPropsd", "_RcncltnId", "_TxId", "_AddtlTxData", "_PmtTpInf", "_AuthstnRslt", "_SaleToPOIData", "_MrchntCtgyCd", "_LastTxFlg", "_CstmrTkn", "_CstmrOrdr", "_TxTp", "_AddtlSvc", "_SaleRefId", "_IssrRefData", "_IssrCITId", "_SaleToIssrData", "_SvcAttr", "_SaleToAcqrrData", "_MrchntCITId", "_CardPrgrmmApld", "_MrchntRefData", "_OrgnlTx"]
	@property
	def TxCaptr(self):
