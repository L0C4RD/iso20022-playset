...
class PaymentTransaction165(base_types._BaseFieldType):
	...
	__slots__ = ["_PmtTpInf", "_SaleToPOIData", "_TxTp", "_MrchntCITId", "_PmtInstrm", "_TxCaptr", "_MrchntCtgyCd", "_OrgnlTx", "_AddtlTxData", "_SaleToAcqrrData", "_MrchntRefData", "_CardPrgrmmPropsd", "_CardPrgrmmApld", "_CstmrOrdr", "_SaleRefId", "_IssrRefData", "_AuthstnRslt", "_CstmrTkn", "_RcncltnId", "_SvcAttr", "_IssrCITId", "_LastTxFlg", "_AddtlSvc", "_SaleToIssrData", "_TxId", "_CstmrCnsnt", "_TxDtls"]
	@property
	def PmtTpInf(self):
