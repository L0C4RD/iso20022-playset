...
from .AccountAndBalance58 import AccountAndBalance58
from .DocumentIdentification31 import DocumentIdentification31
from .CorporateAction85 import CorporateAction85
from .CorporateActionOption233 import CorporateActionOption233
...
class CorporateActionMovementConfirmationV16(base_types._BaseFieldType):
	...
	__slots__ = ["_Pgntn", "_MvmntConfId", "_PngAgt", "_AddtlInf", "_OthrDocId", "_NtfctnId", "_AcctDtls", "_SubPngAgt", "_MvmntPrlimryAdvcId", "_InstrId", "_CorpActnConfDtls", "_IssrAgt", "_TxId", "_EvtsLkg", "_CorpActnDtls", "_SplmtryData", "_CorpActnGnlInf"]
	@property
	def Pgntn(self):
		return self._Pgntn
