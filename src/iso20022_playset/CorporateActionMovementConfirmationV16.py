...
class CorporateActionMovementConfirmationV16(base_types._BaseFieldType):
	...
	__slots__ = ["_InstrId", "_MvmntConfId", "_OthrDocId", "_EvtsLkg", "_NtfctnId", "_AddtlInf", "_SubPngAgt", "_CorpActnGnlInf", "_IssrAgt", "_CorpActnConfDtls", "_CorpActnDtls", "_AcctDtls", "_MvmntPrlimryAdvcId", "_SplmtryData", "_TxId", "_PngAgt", "_Pgntn"]
	@property
	def InstrId(self):
