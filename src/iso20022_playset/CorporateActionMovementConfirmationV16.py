...
class CorporateActionMovementConfirmationV16(base_types._BaseFieldType):
	...
	__slots__ = ["_MvmntPrlimryAdvcId", "_MvmntConfId", "_CorpActnDtls", "_AddtlInf", "_IssrAgt", "_OthrDocId", "_PngAgt", "_EvtsLkg", "_Pgntn", "_SubPngAgt", "_NtfctnId", "_CorpActnGnlInf", "_AcctDtls", "_CorpActnConfDtls", "_SplmtryData", "_InstrId", "_TxId"]
	@property
