...
class IntraBalancePosting6(base_types._BaseFieldType):
	...
	__slots__ = ["_CreDtTm", "_SplmtryData", "_AcctSvcrTxId", "_CshSubBalId", "_BalTo", "_SttldAmt", "_Lnkgs", "_PrcrTxId", "_RmngSttlmAmt", "_PoolId", "_PrevslySttldAmt", "_Prty", "_FctvSttlmDt", "_AcctOwnrTxId", "_MktInfrstrctrTxId", "_CorpActnEvtId", "_InstrPrcgAddtlDtls", "_StsDt", "_MsgOrgtr"]
	@property
	def CreDtTm(self):
