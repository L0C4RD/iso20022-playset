...
from .TradeAgreement14 import TradeAgreement14
...
class ForeignExchangeTradeInstructionV06(base_types._BaseFieldType):
	...
	__slots__ = ["_RgltryRptg", "_CtrPtySdId", "_OptnlGnlInf", "_TradgSdId", "_NDFConds", "_TradgSdSttlmInstrs", "_CtrPtySdSttlmInstrs", "_TradInf", "_SplmtryData", "_PstTradEvt", "_AgrdRate", "_TradAmts"]
	@property
	def RgltryRptg(self):
