...
class DirectDebitTransactionInformation31(base_types._BaseFieldType):
	...
	__slots__ = ["_DrctDbtTx", "_IntrmyAgt2", "_PmtTpInf", "_DbtrAgt", "_IntrmyAgt1Acct", "_Cdtr", "_Purp", "_XchgRate", "_CdtrAgtAcct", "_RmtInf", "_IntrmyAgt1", "_IntrmyAgt3", "_InstdAgt", "_IntrBkSttlmDt", "_DbtrAcct", "_IntrBkSttlmAmt", "_RltdRmtInf", "_InstgAgt", "_UltmtCdtr", "_DbtrAgtAcct", "_IntrmyAgt3Acct", "_InstdAmt", "_RgltryRptg", "_ChrgsInf", "_ReqdColltnDt", "_IntrmyAgt2Acct", "_SttlmTmIndctn", "_UltmtDbtr", "_InitgPty", "_SttlmPrty", "_ChrgBr", "_CdtrAcct", "_PmtId", "_CdtrAgt", "_Dbtr", "_SplmtryData"]
	@property
	def DrctDbtTx(self):
