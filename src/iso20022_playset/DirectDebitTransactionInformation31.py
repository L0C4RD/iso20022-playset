...
from .DirectDebitTransaction12 import DirectDebitTransaction12
...
class DirectDebitTransactionInformation31(base_types._BaseFieldType):
	...
	__slots__ = ["_DbtrAgt", "_CdtrAgt", "_PmtTpInf", "_DbtrAcct", "_Purp", "_DbtrAgtAcct", "_ChrgsInf", "_IntrmyAgt1", "_SttlmTmIndctn", "_CdtrAcct", "_InstdAgt", "_SplmtryData", "_IntrmyAgt3", "_RmtInf", "_IntrmyAgt3Acct", "_XchgRate", "_UltmtDbtr", "_PmtId", "_ChrgBr", "_InitgPty", "_IntrmyAgt1Acct", "_RgltryRptg", "_Dbtr", "_UltmtCdtr", "_RltdRmtInf", "_ReqdColltnDt", "_CdtrAgtAcct", "_InstdAmt", "_IntrBkSttlmAmt", "_SttlmPrty", "_DrctDbtTx", "_IntrBkSttlmDt", "_IntrmyAgt2", "_InstgAgt", "_IntrmyAgt2Acct", "_Cdtr"]
	@property
	def DbtrAgt(self):
