...
from . import CorporateActionNarrative002V09
...
class SEEV_038_002_09():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def CorpActnNrrtv(self, value):
			self._CorpActnNrrtv = value if value is not None else base_types.UninitialisedField(self, 'CorpActnNrrtv', CorporateActionNarrative002V09, False)

		@CorpActnNrrtv.deleter
		def CorpActnNrrtv(self):
			del self._CorpActnNrrtv
			self._CorpActnNrrtv = base_types.UninitialisedField(self, 'CorpActnNrrtv', CorporateActionNarrative002V09, False)
