...
class PaymentSearch10(base_types._BaseFieldType):
	...
	__slots__ = ["_Instr", "_MsgId", "_IntrBkSttlmAmt", "_PrcgVldtyTm", "_EndToEndId", "_UETR", "_Sts", "_ReqdExctnDt", "_IntrBkSttlmAmtCcy", "_PmtMtd", "_IntrBkSttlmDt", "_PmtTp", "_InstdAmt", "_Prty", "_PmtId", "_InstdAmtCcy", "_TxId", "_Pties", "_CdtDbtInd"]
	@property
	def Instr(self):
		return self._Instr
