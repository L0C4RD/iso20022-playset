...
class SecuritiesSettlementTransactionDetails55(base_types._BaseFieldType):
	...
	__slots__ = ["_DlvrgSttlmPties", "_QtyAndAcctDtls", "_Lnkgs", "_TradDtls", "_SttlmAmt", "_StgSttlmInstrDtls", "_RcvgSttlmPties", "_SttlmParams", "_OthrBizPties", "_FinInstrmAttrbts", "_SplmtryData", "_FinInstrmId", "_OthrAmts", "_CshPties", "_SttlmTpAndAddtlParams", "_AddtlPhysOrRegnDtls"]
	@property
