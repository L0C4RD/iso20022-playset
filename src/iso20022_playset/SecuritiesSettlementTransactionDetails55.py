...
class SecuritiesSettlementTransactionDetails55(base_types._BaseFieldType):
	...
	__slots__ = ["_Lnkgs", "_TradDtls", "_SttlmAmt", "_FinInstrmAttrbts", "_OthrBizPties", "_QtyAndAcctDtls", "_CshPties", "_OthrAmts", "_DlvrgSttlmPties", "_FinInstrmId", "_StgSttlmInstrDtls", "_SttlmTpAndAddtlParams", "_SplmtryData", "_SttlmParams", "_AddtlPhysOrRegnDtls", "_RcvgSttlmPties"]
	@property
	def Lnkgs(self):
		return self._Lnkgs
