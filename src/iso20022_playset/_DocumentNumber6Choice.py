...
class DocumentNumber6Choice(base_types._BaseFieldType):
	...
	def PrtryNb(self, value):
		self._PrtryNb = value if value is not None else base_types.UninitialisedField(self, 'PrtryNb', GenericIdentification86, False)

	@PrtryNb.deleter
	def PrtryNb(self):
		del self._PrtryNb
		self._PrtryNb = base_types.UninitialisedField(self, 'PrtryNb', GenericIdentification86, False)
