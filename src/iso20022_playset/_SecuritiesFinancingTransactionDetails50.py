...
class SecuritiesFinancingTransactionDetails50(base_types._BaseFieldType):
	...
	__slots__ = ["_MtrtyDtMod", "_VarblRateSpprt", "_LglFrmwk", "_RpRate", "_TxCallDely", "_RateTp", "_SctiesFincgTradId", "_TermntnTxAmt", "_ScndLegNrrtv", "_TermntnDt", "_IntrstPmt", "_ClsgLegId", "_AcrdIntrstAmt"]
	@property
	def MtrtyDtMod(self):
