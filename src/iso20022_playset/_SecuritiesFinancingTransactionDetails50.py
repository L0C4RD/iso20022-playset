...
class SecuritiesFinancingTransactionDetails50(base_types._BaseFieldType):
	...
	__slots__ = ["_ScndLegNrrtv", "_RateTp", "_RpRate", "_TxCallDely", "_TermntnTxAmt", "_IntrstPmt", "_MtrtyDtMod", "_TermntnDt", "_LglFrmwk", "_VarblRateSpprt", "_ClsgLegId", "_AcrdIntrstAmt", "_SctiesFincgTradId"]
	@property
