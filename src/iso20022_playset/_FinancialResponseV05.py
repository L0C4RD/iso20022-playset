...
from . import TransactionSpecificData2
...
class FinancialResponseV05(base_types._BaseFieldType):
	...
	def AdddmData(self, value):
		self._AdddmData = value if value is not None else base_types.UninitialisedField(self, 'AdddmData', TransactionSpecificData2, False)

	@AdddmData.deleter
	def AdddmData(self):
		del self._AdddmData
		self._AdddmData = base_types.UninitialisedField(self, 'AdddmData', TransactionSpecificData2, False)
