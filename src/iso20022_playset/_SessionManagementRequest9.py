...
class SessionManagementRequest9(base_types._BaseFieldType):
	...
	def LgnReq(self, value):
		self._LgnReq = value if value is not None else base_types.UninitialisedField(self, 'LgnReq', LoginRequest8, False)

	@LgnReq.deleter
	def LgnReq(self):
		del self._LgnReq
		self._LgnReq = base_types.UninitialisedField(self, 'LgnReq', LoginRequest8, False)
