...
class DocumentIdentification6(base_types._BaseFieldType):
	...
	def AmdmntSeqNb(self, value):
		self._AmdmntSeqNb = value if value is not None else base_types.UninitialisedField(self, 'AmdmntSeqNb', Max3NumericText, False)

	@AmdmntSeqNb.deleter
	def AmdmntSeqNb(self):
		del self._AmdmntSeqNb
		self._AmdmntSeqNb = base_types.UninitialisedField(self, 'AmdmntSeqNb', Max3NumericText, False)
