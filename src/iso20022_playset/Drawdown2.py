...
class Drawdown2(base_types._BaseFieldType):
	...
	__slots__ = ["_CapdLmts", "_PctgOfTtlTrfVal", "_MltplPnsnCmcmntLumpSums", "_BnfcryDtls", "_Id", "_PnsnCmcmntLumpSumDt", "_TtlAmtNetDrwdwn", "_PnsnCmcmntLumpSumRmng", "_AddtlFndsDsgntd", "_TrchTp", "_AddtlInf", "_RcptOfDrwdwnInd", "_InvstrTaxRef", "_FlxblDrwdwnTrggrdDt", "_AplblRules", "_LftmAllwnc"]
	@property
	def CapdLmts(self):
