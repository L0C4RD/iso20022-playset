...
class ErrorV04(base_types._BaseFieldType):
	...
	__slots__ = ["_Orgtr", "_Hdr", "_SysTracAudtNb", "_RtrvlRefNb", "_Jursdctn", "_AddtlFee", "_Rcvr", "_PrtctdData", "_SttlmSvc", "_LifeCyclId", "_SctyTrlr", "_Sndr", "_OrgnlMsg", "_Rcncltn", "_TrnsmssnDtTm", "_AddtlData", "_Dstn", "_ErrDtl", "_SplmtryData"]
	@property
	def Orgtr(self):
		return self._Orgtr
