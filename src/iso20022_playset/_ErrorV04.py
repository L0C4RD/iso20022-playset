...
class ErrorV04(base_types._BaseFieldType):
	...
	__slots__ = ["_TrnsmssnDtTm", "_SplmtryData", "_SctyTrlr", "_RtrvlRefNb", "_ErrDtl", "_LifeCyclId", "_OrgnlMsg", "_Hdr", "_AddtlData", "_Rcvr", "_Sndr", "_Dstn", "_SysTracAudtNb", "_Rcncltn", "_AddtlFee", "_Jursdctn", "_Orgtr", "_SttlmSvc", "_PrtctdData"]
	@property
