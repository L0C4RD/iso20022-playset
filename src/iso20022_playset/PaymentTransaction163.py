...
class PaymentTransaction163(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlIntrBkSttlmAmt", "_ChrgBr", "_OrgnlIntrBkSttlmDt", "_RtrRsnInf", "_AgrdRate", "_SttlmTmReq", "_RtrdInstdAmt", "_ChrgsInf", "_ClrSysRef", "_SttlmTmIndctn", "_SttlmPrty", "_RtrdIntrBkSttlmAmt", "_IntrBkSttlmDt", "_InstdAgt", "_CompstnAmt", "_SplmtryData", "_PmtTpInf", "_RtrId", "_OrgnlUETR", "_InstgAgt", "_RtrChain", "_XchgRate", "_OrgnlEndToEndId", "_OrgnlTxId", "_OrgnlClrSysRef", "_OrgnlGrpInf", "_OrgnlInstrId", "_OrgnlTxRef"]
	@property
