...
class PaymentTransaction163(base_types._BaseFieldType):
	...
	__slots__ = ["_ChrgBr", "_CompstnAmt", "_SplmtryData", "_OrgnlInstrId", "_OrgnlIntrBkSttlmAmt", "_OrgnlUETR", "_IntrBkSttlmDt", "_RtrdInstdAmt", "_SttlmTmReq", "_InstdAgt", "_ChrgsInf", "_SttlmPrty", "_OrgnlIntrBkSttlmDt", "_OrgnlGrpInf", "_ClrSysRef", "_OrgnlClrSysRef", "_RtrRsnInf", "_PmtTpInf", "_RtrId", "_RtrChain", "_RtrdIntrBkSttlmAmt", "_OrgnlTxId", "_InstgAgt", "_OrgnlEndToEndId", "_AgrdRate", "_XchgRate", "_OrgnlTxRef", "_SttlmTmIndctn"]
	@property
	def ChrgBr(self):
		return self._ChrgBr
