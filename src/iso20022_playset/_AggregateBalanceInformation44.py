...
class AggregateBalanceInformation44(base_types._BaseFieldType):
	...
	__slots__ = ["_NotAvlblBal", "_AddtlBalBrkdwn", "_BalBrkdwn", "_PricDtls", "_AggtBal", "_BalAtSfkpgPlc", "_AvlblBal", "_CorpActnOptnTp", "_HldgAddtlDtls", "_FinInstrmAttrbts", "_SplmtryData", "_ValtnHrcutDtls", "_InvstmtFndsFinInstrmAttrbts", "_QtyBrkdwn", "_FinInstrmId", "_InstrmCcyAmts", "_DaysAcrd", "_FXDtls", "_SfkpgPlc", "_AcctBaseCcyAmts"]
	@property
