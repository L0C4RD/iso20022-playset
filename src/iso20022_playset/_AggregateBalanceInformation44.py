...
class AggregateBalanceInformation44(base_types._BaseFieldType):
	...
	__slots__ = ["_QtyBrkdwn", "_SplmtryData", "_AggtBal", "_NotAvlblBal", "_FinInstrmAttrbts", "_FXDtls", "_DaysAcrd", "_AvlblBal", "_CorpActnOptnTp", "_SfkpgPlc", "_InstrmCcyAmts", "_BalAtSfkpgPlc", "_HldgAddtlDtls", "_AcctBaseCcyAmts", "_PricDtls", "_BalBrkdwn", "_InvstmtFndsFinInstrmAttrbts", "_AddtlBalBrkdwn", "_ValtnHrcutDtls", "_FinInstrmId"]
	@property
	def QtyBrkdwn(self):
