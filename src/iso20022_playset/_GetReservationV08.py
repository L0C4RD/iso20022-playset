...
from . import ReservationQuery6
from . import SupplementaryData1

class GetReservationV08(base_types._BaseFieldType):

	__slots__ = ["_MsgHdr", "_RsvatnQryDef", "_SplmtryData"]
	@property
	def MsgHdr(self):
		return self._MsgHdr
	...
	def RsvatnQryDef(self):
		return self._RsvatnQryDef

	@RsvatnQryDef.setter
	def RsvatnQryDef(self, value):
		self._RsvatnQryDef = value if value is not None else base_types.UninitialisedField(self, 'RsvatnQryDef', ReservationQuery6, False)

	@RsvatnQryDef.deleter
	def RsvatnQryDef(self):
		del self._RsvatnQryDef
		self._RsvatnQryDef = base_types.UninitialisedField(self, 'RsvatnQryDef', ReservationQuery6, False)
