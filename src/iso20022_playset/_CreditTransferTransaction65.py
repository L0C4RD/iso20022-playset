...
class CreditTransferTransaction65(base_types._BaseFieldType):
	...
	__slots__ = ["_IntrmyAgt2", "_CdtrAgtAcct", "_RgltryRptg", "_Purp", "_InstrForCdtrAgt", "_ReqdExctnDt", "_Tax", "_ChqInstr", "_Amt", "_PmtTpInf", "_RmtInf", "_IntrmyAgt3", "_IntrmyAgt1", "_UltmtCdtr", "_UltmtDbtr", "_CdtrAgt", "_PmtId", "_Cdtr", "_MndtRltdInf", "_NclsdFile", "_RltdRmtInf", "_PmtCond", "_ChrgBr", "_SplmtryData", "_CdtrAcct"]
	@property
	def IntrmyAgt2(self):
