...
from .PaymentCondition2 import PaymentCondition2
...
from .PaymentTypeInformation29 import PaymentTypeInformation29

class CreditTransferTransaction65(base_types._BaseFieldType):

	__slots__ = ["_Amt", "_SplmtryData", "_RltdRmtInf", "_ChrgBr", "_PmtCond", "_Cdtr", "_CdtrAgtAcct", "_UltmtDbtr", "_UltmtCdtr", "_RgltryRptg", "_IntrmyAgt3", "_ChqInstr", "_PmtId", "_Purp", "_Tax", "_CdtrAgt", "_NclsdFile", "_CdtrAcct", "_PmtTpInf", "_RmtInf", "_IntrmyAgt2", "_MndtRltdInf", "_ReqdExctnDt", "_InstrForCdtrAgt", "_IntrmyAgt1"]
	@property
	def Amt(self):
		return self._Amt
