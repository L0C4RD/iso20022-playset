...
from .InvestigationResult1Choice import InvestigationResult1Choice
...
class ReturnIndicator2(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlInf", "_AuthrtyReqTp", "_RspnPrd", "_InvstgtnRslt"]
	@property
	def AddtlInf(self):
	...
	def RspnPrd(self, value):
		self._RspnPrd = value if type(value) != auto else self.make_default("RspnPrd")
