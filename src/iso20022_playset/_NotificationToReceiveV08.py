...
from . import AccountNotification23
...
class NotificationToReceiveV08(base_types._BaseFieldType):
	...
	def Ntfctn(self, value):
		self._Ntfctn = value if value is not None else base_types.UninitialisedField(self, 'Ntfctn', AccountNotification23, False)

	@Ntfctn.deleter
	def Ntfctn(self):
		del self._Ntfctn
		self._Ntfctn = base_types.UninitialisedField(self, 'Ntfctn', AccountNotification23, False)
