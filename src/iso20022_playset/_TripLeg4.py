...
class TripLeg4(base_types._BaseFieldType):
	...
	__slots__ = ["_Amt", "_Arrvl", "_CdtRsnCd", "_CmmdtyCd", "_CnjnctnTcktNb", "_CrrierCd", "_CrrierNm", "_Doc", "_Dprture", "_Drtn", "_FairBsisCd", "_IATACd", "_Insrnc", "_LltyPrgrmm", "_NonDrctRouteCd", "_NtlData", "_OpnTckt", "_OrgnlRsvatnNb", "_OrgnlRsvatnSys", "_PrcdrId", "_PrvtData", "_RcrdLctrNb", "_RouteNb", "_RstrctdTckt", "_RsvatnNb", "_RsvatnSys", "_SeqNb", "_StopOver", "_SvcClss", "_TcktIsseDt", "_TcktIsseLctn", "_TcktIssr", "_TcktNb", "_TcktRstrctns", "_TrnsprtTp", "_XchgdTckt", "_XchgdTcktNb"]
	@property
	def Amt(self):
		return self._Amt
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='Doc', type=ATICALaxProcessing, min=0, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='TrnsprtTp', type=TransportType2Code, min=0, max=1, mutex_group=None, array=False),
