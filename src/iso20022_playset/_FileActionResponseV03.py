...
class FileActionResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Orgtr", "_Prgrmm", "_Tkn", "_Crdhldr", "_Card", "_POICmpnt", "_Jursdctn", "_Rcvr", "_SttlmSvc", "_PrtctdData", "_Accptr", "_Frmt", "_SctyTrlr", "_DataRcrd", "_FileSctyCd", "_SplmtryData", "_Issr", "_Pyer", "_Hdr", "_SysTracAudtNb", "_CstmrDvc", "_RtrvlRefNb", "_FileNm", "_Wllt", "_Acqrr", "_AddtlFee", "_Termnl", "_LifeCyclId", "_Pyee", "_Sndr", "_Crrctn", "_Rcncltn", "_TrnsmssnDtTm", "_AddtlData", "_RspnCd", "_ActnDt", "_Dstn"]
	@property
	def Orgtr(self):
		return self._Orgtr
