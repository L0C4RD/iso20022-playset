...
class FileActionResponseV03(base_types._BaseFieldType):

	__slots__ = ["_Acqrr", "_SctyTrlr", "_LifeCyclId", "_Pyee", "_Hdr", "_Card", "_CstmrDvc", "_Frmt", "_FileNm", "_Crdhldr", "_Issr", "_SysTracAudtNb", "_Crrctn", "_Rcncltn", "_AddtlFee", "_Tkn", "_RspnCd", "_Orgtr", "_Prgrmm", "_Wllt", "_PrtctdData", "_TrnsmssnDtTm", "_DataRcrd", "_SplmtryData", "_Accptr", "_Termnl", "_Pyer", "_RtrvlRefNb", "_AddtlData", "_Rcvr", "_Sndr", "_Dstn", "_ActnDt", "_FileSctyCd", "_POICmpnt", "_Jursdctn", "_SttlmSvc"]
	@property
	def Acqrr(self):
		return self._Acqrr
