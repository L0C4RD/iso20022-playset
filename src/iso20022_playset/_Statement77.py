...
class Statement77(base_types._BaseFieldType):
	...
	def Frqcy(self, value):
		self._Frqcy = value if value is not None else base_types.UninitialisedField(self, 'Frqcy', Frequency34Choice, False)

	@Frqcy.deleter
	def Frqcy(self):
		del self._Frqcy
		self._Frqcy = base_types.UninitialisedField(self, 'Frqcy', Frequency34Choice, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='Frqcy', type=Frequency34Choice, min=1, max=1, mutex_group=None, array=False),
