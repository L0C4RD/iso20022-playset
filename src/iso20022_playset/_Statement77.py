...
from .Frequency34Choice import Frequency34Choice
...
class Statement77(base_types._BaseFieldType):
	...
	__slots__ = ["_SubAcctInd", "_StmtDtTm", "_StmtBsis", "_Frqcy", "_StmtId", "_ActvtyInd", "_RptNb", "_SctyIntrstOrSetOff", "_UpdTp", "_QryRef"]
	@property
	def SubAcctInd(self):
