...
class FinancingAgreementItem1(base_types._BaseFieldType):
	...
	__slots__ = ["_Ratg", "_AddtlInf", "_Grnt", "_VldtnStsInf", "_GrntSts", "_PmtInstrm", "_ItmCntxt", "_ReopIndctn", "_ItmActn", "_RltdGrntLttr", "_AssoctdDoc"]
	@property
	def Ratg(self):
		return self._Ratg
	...
	def GrntSts(self, value):
		self._GrntSts = value if type(value) != base_types.auto else self.make_default("GrntSts")
