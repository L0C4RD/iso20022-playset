...
from . import TransparencyDataReport13
...
class FinancialInstrumentReportingEquityTradingActivityReportV01(base_types._BaseFieldType):
	...
	def EqtyTrnsprncyData(self, value):
		self._EqtyTrnsprncyData = value if value is not None else base_types.UninitialisedField(self, 'EqtyTrnsprncyData', TransparencyDataReport13, True)

	@EqtyTrnsprncyData.deleter
	def EqtyTrnsprncyData(self):
		del self._EqtyTrnsprncyData
		self._EqtyTrnsprncyData = base_types.UninitialisedField(self, 'EqtyTrnsprncyData', TransparencyDataReport13, True)
