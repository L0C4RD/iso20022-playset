...
class SubscriptionMultipleExecution6(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlSttlmAmt", "_BlkCshSttlmDtls", "_OrdrDtTm", "_RcvdDtTm", "_InvstmtAcctDtls", "_IndvExctnDtls", "_PlcOfTrad", "_ReqdFutrTradDt", "_AmdmntInd", "_MstrRef", "_BnfcryDtls", "_CxlRght"]
	@property
