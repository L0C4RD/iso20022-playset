...
import SubscriptionExecution14
...
class SubscriptionMultipleExecution6(base_types._BaseFieldType):
	...
	__slots__ = ["_CxlRght", "_IndvExctnDtls", "_BlkCshSttlmDtls", "_MstrRef", "_AmdmntInd", "_BnfcryDtls", "_RcvdDtTm", "_PlcOfTrad", "_OrdrDtTm", "_ReqdFutrTradDt", "_InvstmtAcctDtls", "_TtlSttlmAmt"]
	@property
	def CxlRght(self):
