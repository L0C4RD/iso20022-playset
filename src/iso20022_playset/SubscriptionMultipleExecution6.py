...
class SubscriptionMultipleExecution6(base_types._BaseFieldType):
	...
	__slots__ = ["_BnfcryDtls", "_BlkCshSttlmDtls", "_OrdrDtTm", "_TtlSttlmAmt", "_ReqdFutrTradDt", "_AmdmntInd", "_CxlRght", "_RcvdDtTm", "_PlcOfTrad", "_IndvExctnDtls", "_MstrRef", "_InvstmtAcctDtls"]
	@property
	def BnfcryDtls(self):
