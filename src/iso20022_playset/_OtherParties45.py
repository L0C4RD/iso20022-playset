...
from . import PartyIdentificationAndAccount221
...
class OtherParties45(base_types._BaseFieldType):
	...
	def QlfdFrgnIntrmy(self, value):
		self._QlfdFrgnIntrmy = value if value is not None else base_types.UninitialisedField(self, 'QlfdFrgnIntrmy', PartyIdentificationAndAccount221, False)

	@QlfdFrgnIntrmy.deleter
	def QlfdFrgnIntrmy(self):
		del self._QlfdFrgnIntrmy
		self._QlfdFrgnIntrmy = base_types.UninitialisedField(self, 'QlfdFrgnIntrmy', PartyIdentificationAndAccount221, False)
