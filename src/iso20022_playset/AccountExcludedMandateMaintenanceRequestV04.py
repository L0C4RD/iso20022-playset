import base_types
import CustomerAccountModification1
...
import References4
import OrganisationModification3

class AccountExcludedMandateMaintenanceRequestV04(base_types._BaseFieldType):

	__slots__ = ["_Org", "_CtrctDts", "_UndrlygMstrAgrmt", "_AddtlMsgInf", "_SplmtryData", "_Acct", "_AcctSvcrId", "_DgtlSgntr", "_Refs", "_Fr"]
	@property
	def Org(self):
		return self._Org
