...
from .TransactionAllocation1 import TransactionAllocation1
from .TransactionQuantities4Choice import TransactionQuantities4Choice
from .Charges15 import Charges15
from .TaxData1 import TaxData1
from .PaymentTypeInformation27 import PaymentTypeInformation27
from .CorporateAction82 import CorporateAction82
from .CreditDebitCode import CreditDebitCode
from .ActiveOrHistoricCurrencyAndAmount import ActiveOrHistoricCurrencyAndAmount
from .TransactionPrice4Choice import TransactionPrice4Choice
from .Max20000Text import Max20000Text
from .RemittanceLocation8 import RemittanceLocation8
from .SupplementaryData1 import SupplementaryData1
from .CashDeposit1 import CashDeposit1
from .TransactionDates3 import TransactionDates3
from .AmountAndCurrencyExchange4 import AmountAndCurrencyExchange4
from .PaymentReturnReason8 import PaymentReturnReason8
from .TransactionParties12 import TransactionParties12
from .CardTransaction18 import CardTransaction18
...
class EntryTransaction15(base_types._BaseFieldType):
	...
	__slots__ = ["_RtrInf", "_AddtlTxInf", "_PmtTpInf", "_CdtDbtInd", "_RltdRmtInf", "_Purp", "_LclInstrm", "_FinInstrmId", "_InstrCpy", "_RltdAgts", "_Avlbty", "_RltdPties", "_CshDpst", "_RltdCorpActn", "_Refs", "_Tax", "_RltdDts", "_BkTxCd", "_RltdPric", "_UndrlygAllcn", "_SplmtryData", "_Chrgs", "_RltdQties", "_RmtInf", "_CardTx", "_AmtDtls", "_Intrst", "_SfkpgAcct", "_Amt"]
	@property
	def RtrInf(self):
		return self._RtrInf
	...
	def RtrInf(self, value):
		self._RtrInf = value if type(value) != base_types.auto else self.make_default("RtrInf")
	...
	def RltdAgts(self, value):
		self._RltdAgts = value if type(value) != base_types.auto else self.make_default("RltdAgts")
	...
	def RltdPties(self, value):
		self._RltdPties = value if type(value) != base_types.auto else self.make_default("RltdPties")
	...
	def CshDpst(self, value):
		self._CshDpst = value if type(value) != base_types.auto else self.make_default("CshDpst")
	...
	def RltdCorpActn(self, value):
		self._RltdCorpActn = value if type(value) != base_types.auto else self.make_default("RltdCorpActn")
	...
	def RltdDts(self, value):
		self._RltdDts = value if type(value) != base_types.auto else self.make_default("RltdDts")
	...
	def RltdPric(self, value):
		self._RltdPric = value if type(value) != base_types.auto else self.make_default("RltdPric")
	...
	def RltdQties(self, value):
		self._RltdQties = value if type(value) != base_types.auto else self.make_default("RltdQties")
