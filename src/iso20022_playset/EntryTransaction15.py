...
class EntryTransaction15(base_types._BaseFieldType):
	...
	__slots__ = ["_CardTx", "_RltdCorpActn", "_UndrlygAllcn", "_CdtDbtInd", "_Chrgs", "_AmtDtls", "_LclInstrm", "_BkTxCd", "_RltdDts", "_Tax", "_RltdAgts", "_Purp", "_AddtlTxInf", "_CshDpst", "_SfkpgAcct", "_Intrst", "_RtrInf", "_RltdRmtInf", "_FinInstrmId", "_Refs", "_InstrCpy", "_Avlbty", "_RltdPric", "_RltdPties", "_RmtInf", "_Amt", "_RltdQties", "_PmtTpInf", "_SplmtryData"]
	@property
	def CardTx(self):
		return self._CardTx
