...
class EntryTransaction15(base_types._BaseFieldType):
	...
	__slots__ = ["_Purp", "_CshDpst", "_Tax", "_PmtTpInf", "_Avlbty", "_SfkpgAcct", "_RltdRmtInf", "_RltdDts", "_RltdAgts", "_RltdCorpActn", "_Refs", "_UndrlygAllcn", "_AddtlTxInf", "_BkTxCd", "_RmtInf", "_CardTx", "_AmtDtls", "_RltdPties", "_RtrInf", "_Amt", "_FinInstrmId", "_Intrst", "_LclInstrm", "_SplmtryData", "_RltdPric", "_RltdQties", "_Chrgs", "_InstrCpy", "_CdtDbtInd"]
	@property
	def Purp(self):
		return self._Purp
