...
class EntryTransaction15(base_types._BaseFieldType):
	...
	__slots__ = ["_RltdAgts", "_Purp", "_Refs", "_RtrInf", "_UndrlygAllcn", "_Intrst", "_Amt", "_CshDpst", "_Tax", "_RltdCorpActn", "_RltdRmtInf", "_RltdQties", "_RmtInf", "_Chrgs", "_CardTx", "_SfkpgAcct", "_FinInstrmId", "_RltdPric", "_InstrCpy", "_RltdDts", "_AddtlTxInf", "_AmtDtls", "_PmtTpInf", "_RltdPties", "_LclInstrm", "_CdtDbtInd", "_BkTxCd", "_SplmtryData", "_Avlbty"]
	@property
	def RltdAgts(self):
