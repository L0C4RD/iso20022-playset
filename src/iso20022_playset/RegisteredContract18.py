...
class RegisteredContract18(base_types._BaseFieldType):
	...
	__slots__ = ["_Ctrct", "_PmtSchdlTp", "_EstmtdDtInd", "_IntrCpnyLn", "_IssrFI", "_AddtlInf", "_LnPrncplAmt", "_Amdmnt", "_CtrctBal", "_OrgnlCtrctRegnReq", "_RegdCtrctId", "_RegdCtrctJrnl", "_Dlvry", "_Submissn", "_PrvsRegdCtrctId"]
	@property
	def Ctrct(self):
		return self._Ctrct
