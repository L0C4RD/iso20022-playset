...
class RegisteredContract18(base_types._BaseFieldType):
	...
	__slots__ = ["_Submissn", "_Amdmnt", "_OrgnlCtrctRegnReq", "_RegdCtrctJrnl", "_IntrCpnyLn", "_Dlvry", "_EstmtdDtInd", "_Ctrct", "_PrvsRegdCtrctId", "_LnPrncplAmt", "_PmtSchdlTp", "_CtrctBal", "_AddtlInf", "_RegdCtrctId", "_IssrFI"]
	@property
	def Submissn(self):
