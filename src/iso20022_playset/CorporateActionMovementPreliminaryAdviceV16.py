...
class CorporateActionMovementPreliminaryAdviceV16(base_types._BaseFieldType):
	...
	__slots__ = ["_Offerr", "_Issr", "_PhysSctiesAgt", "_RvslRsn", "_RsellngAgt", "_CorpActnGnlInf", "_CorpActnMvmntDtls", "_AcctDtls", "_OthrDocId", "_PrvsMvmntPrlimryAdvcId", "_PngAgt", "_MvmntConfId", "_MvmntPrlimryAdvcGnlInf", "_EvtsLkg", "_Pgntn", "_SubPngAgt", "_Regar", "_NtfctnId", "_InfAgt", "_SplmtryData", "_DrpAgt", "_AddtlInf", "_IssrAgt", "_SlctnAgt", "_InstrId", "_TrfAgt", "_CorpActnDtls"]
	@property
	def Offerr(self):
		return self._Offerr
