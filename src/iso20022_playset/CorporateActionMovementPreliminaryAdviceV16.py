...
class CorporateActionMovementPreliminaryAdviceV16(base_types._BaseFieldType):
	...
	__slots__ = ["_PngAgt", "_SplmtryData", "_IssrAgt", "_SlctnAgt", "_AcctDtls", "_Regar", "_PrvsMvmntPrlimryAdvcId", "_InfAgt", "_MvmntConfId", "_RsellngAgt", "_CorpActnMvmntDtls", "_TrfAgt", "_CorpActnDtls", "_Issr", "_Pgntn", "_AddtlInf", "_RvslRsn", "_EvtsLkg", "_NtfctnId", "_MvmntPrlimryAdvcGnlInf", "_CorpActnGnlInf", "_OthrDocId", "_Offerr", "_DrpAgt", "_PhysSctiesAgt", "_InstrId", "_SubPngAgt"]
	@property
	def PngAgt(self):
		return self._PngAgt
