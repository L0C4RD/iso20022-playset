...
class CorporateActionMovementPreliminaryAdviceV16(base_types._BaseFieldType):
	...
	__slots__ = ["_InstrId", "_Issr", "_TrfAgt", "_OthrDocId", "_SlctnAgt", "_PrvsMvmntPrlimryAdvcId", "_Regar", "_RsellngAgt", "_EvtsLkg", "_DrpAgt", "_CorpActnDtls", "_NtfctnId", "_Offerr", "_RvslRsn", "_SubPngAgt", "_AddtlInf", "_CorpActnGnlInf", "_CorpActnMvmntDtls", "_MvmntPrlimryAdvcGnlInf", "_IssrAgt", "_SplmtryData", "_InfAgt", "_PhysSctiesAgt", "_PngAgt", "_AcctDtls", "_Pgntn", "_MvmntConfId"]
	@property
	def InstrId(self):
