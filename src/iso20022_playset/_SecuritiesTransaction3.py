...
from .SecuritiesTransactionPrice22Choice import SecuritiesTransactionPrice22Choice
...
class SecuritiesTransaction3(base_types._BaseFieldType):
	...
	__slots__ = ["_TradPlcMtchgId", "_NetAmt", "_UpFrntPmt", "_TradDt", "_DerivNtnlChng", "_CmplxTradCmpntId", "_Pric", "_DgtlTknQty", "_CtryOfBrnch", "_TradVn", "_TradgCpcty", "_Qty"]
	@property
