...
class Context20(base_types._BaseFieldType):
	...
	__slots__ = ["_Attndd", "_CrdhldrPres", "_MrchntCtgySpcfcData", "_Reauthstn", "_MrchntCtgyCd", "_MOTOCd", "_CrdhldrActvtd", "_DelydChrgs", "_PmtCrdntlMrchntRltsh", "_Trnst", "_OthrQRCdPresntmntMd", "_EComrcIndPropsd", "_QRCdPresntmntMd", "_OthrCardDataNtryMd", "_PrtlShipmnt", "_StorgLctn", "_UattnddLvlCtgy", "_OthrSctyChrtcs", "_TrnspndrInittd", "_OthrMrchntCtgy", "_EComrcData", "_EComrcIndApld", "_PrtlApprvlSpprtd", "_TxInitr", "_CardDataNtryMd", "_CardPres", "_DelydAuthstn", "_ReSubmissn", "_SctyChrtcs", "_TempScrCardDataReusd", "_NoShow", "_EComrc"]
	@property
	def Attndd(self):
		return self._Attndd
