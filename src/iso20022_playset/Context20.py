...
class Context20(base_types._BaseFieldType):
	...
	__slots__ = ["_CardPres", "_CrdhldrActvtd", "_Attndd", "_DelydChrgs", "_PmtCrdntlMrchntRltsh", "_EComrc", "_TrnspndrInittd", "_StorgLctn", "_OthrMrchntCtgy", "_EComrcIndPropsd", "_PrtlShipmnt", "_EComrcData", "_Reauthstn", "_Trnst", "_QRCdPresntmntMd", "_TempScrCardDataReusd", "_PrtlApprvlSpprtd", "_OthrQRCdPresntmntMd", "_UattnddLvlCtgy", "_OthrSctyChrtcs", "_MOTOCd", "_OthrCardDataNtryMd", "_MrchntCtgyCd", "_CardDataNtryMd", "_DelydAuthstn", "_NoShow", "_ReSubmissn", "_EComrcIndApld", "_SctyChrtcs", "_MrchntCtgySpcfcData", "_CrdhldrPres", "_TxInitr"]
	@property
	def CardPres(self):
