...
class SecuritiesReturnCriteria1(base_types._BaseFieldType):
	...
	__slots__ = ["_ISOSctyShrtNm", "_MtrtyDt", "_CSD", "_IssrCSD", "_MinDnmtn", "_FinInstrmId", "_SctiesQtyTp", "_IsseDt", "_CtryOfIsse", "_InvstrCSD", "_MinMltplQty", "_SctySts", "_DevtgSttlmUnit", "_ISOSctyLngNm", "_TechIssrCSD", "_ClssfctnFinInstrm", "_IsseCcy"]
	@property
