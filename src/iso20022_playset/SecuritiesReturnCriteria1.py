...
class SecuritiesReturnCriteria1(base_types._BaseFieldType):
	...
	__slots__ = ["_ISOSctyLngNm", "_SctiesQtyTp", "_MtrtyDt", "_CtryOfIsse", "_IssrCSD", "_InvstrCSD", "_SctySts", "_IsseDt", "_ClssfctnFinInstrm", "_MinDnmtn", "_DevtgSttlmUnit", "_ISOSctyShrtNm", "_TechIssrCSD", "_CSD", "_MinMltplQty", "_IsseCcy", "_FinInstrmId"]
	@property
