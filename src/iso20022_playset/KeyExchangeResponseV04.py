...
class KeyExchangeResponseV04(base_types._BaseFieldType):
	...
	__slots__ = ["_Hdr", "_AddtlData", "_AltrnMsgRsn", "_Rcncltn", "_PrtctdData", "_RtrvlRefNb", "_Prgrmm", "_OthrKeyXchgFctn", "_LifeCyclId", "_KeyXchgFctn", "_TrnsmssnDtTm", "_KeyXchgData", "_OthrKeyXchgTp", "_OrgnlRspnCd", "_MsgRsn", "_Jursdctn", "_SplmtryData", "_KeyXchgTp", "_PrcgRslt", "_SctyTrlr", "_SttlmSvc", "_AddtlFee", "_SysTracAudtNb"]
	@property
	def Hdr(self):
		return self._Hdr
