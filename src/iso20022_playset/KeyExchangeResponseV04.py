...
class KeyExchangeResponseV04(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmSvc", "_SysTracAudtNb", "_OthrKeyXchgTp", "_KeyXchgFctn", "_AltrnMsgRsn", "_OrgnlRspnCd", "_KeyXchgData", "_Prgrmm", "_PrcgRslt", "_Rcncltn", "_AddtlData", "_OthrKeyXchgFctn", "_Jursdctn", "_LifeCyclId", "_RtrvlRefNb", "_SctyTrlr", "_Hdr", "_TrnsmssnDtTm", "_MsgRsn", "_KeyXchgTp", "_AddtlFee", "_PrtctdData", "_SplmtryData"]
	@property
	def SttlmSvc(self):
