...
from .KeyExchangeData1 import KeyExchangeData1
...
from .KeyType1Code import KeyType1Code
...
from .CardServiceType5Code import CardServiceType5Code
from .Header71 import Header71

class KeyExchangeResponseV04(base_types._BaseFieldType):

	__slots__ = ["_KeyXchgTp", "_RtrvlRefNb", "_AddtlData", "_SctyTrlr", "_Hdr", "_OthrKeyXchgFctn", "_OrgnlRspnCd", "_KeyXchgFctn", "_Jursdctn", "_Prgrmm", "_OthrKeyXchgTp", "_SysTracAudtNb", "_TrnsmssnDtTm", "_KeyXchgData", "_AddtlFee", "_SttlmSvc", "_PrcgRslt", "_Rcncltn", "_PrtctdData", "_SplmtryData", "_AltrnMsgRsn", "_LifeCyclId", "_MsgRsn"]
	@property
	def KeyXchgTp(self):
