...
class KeyExchangeResponseV04(base_types._BaseFieldType):
	...
	__slots__ = ["_Hdr", "_KeyXchgTp", "_PrtctdData", "_SysTracAudtNb", "_Jursdctn", "_KeyXchgFctn", "_RtrvlRefNb", "_Prgrmm", "_TrnsmssnDtTm", "_AddtlFee", "_OrgnlRspnCd", "_Rcncltn", "_SplmtryData", "_AddtlData", "_SttlmSvc", "_LifeCyclId", "_AltrnMsgRsn", "_MsgRsn", "_KeyXchgData", "_SctyTrlr", "_PrcgRslt", "_OthrKeyXchgFctn", "_OthrKeyXchgTp"]
	@property
	def Hdr(self):
		return self._Hdr
