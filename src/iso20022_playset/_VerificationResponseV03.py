...
class VerificationResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctFr", "_TxChrtcs", "_AddtlAmt", "_Termnl", "_Sndr", "_AcctBal", "_AddtlData", "_AddtlFee", "_Tkn", "_Rcncltn", "_ConvsDtTm", "_Crdhldr", "_TxId", "_TxAmts", "_Card", "_Rsk", "_Orgtr", "_Acqrr", "_ICCRltdData", "_Dstn", "_Instlmt", "_Issr", "_Jursdctn", "_PrcgRslt", "_Cntxt", "_Hdr", "_StrngCstmrAuthntcn", "_AcctTo", "_Prgrmm", "_SctyTrlr", "_Vrfctn", "_Rcvr", "_Accptr", "_SttlmSvc", "_PrtctdData", "_AddtlSvc", "_OrgnlRspnCd", "_SpclPrgrmmQlfctn", "_Wllt", "_SplmtryData"]
	@property
	def Accptr(self):
		return self._Accptr
