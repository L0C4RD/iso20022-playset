...
class VerificationResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Tkn", "_ICCRltdData", "_SctyTrlr", "_Hdr", "_ConvsDtTm", "_PrcgRslt", "_Crdhldr", "_Issr", "_AddtlAmt", "_TxId", "_Rcncltn", "_AddtlFee", "_Termnl", "_Orgtr", "_Prgrmm", "_Vrfctn", "_Wllt", "_Cntxt", "_AcctFr", "_Instlmt", "_PrtctdData", "_SplmtryData", "_AcctTo", "_Accptr", "_OrgnlRspnCd", "_AcctBal", "_Acqrr", "_StrngCstmrAuthntcn", "_AddtlData", "_Rcvr", "_Sndr", "_SpclPrgrmmQlfctn", "_Dstn", "_TxChrtcs", "_AddtlSvc", "_Jursdctn", "_Rsk", "_TxAmts", "_Card", "_SttlmSvc"]
	@property
	def Tkn(self):
		return self._Tkn
