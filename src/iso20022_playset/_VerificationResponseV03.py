...
class VerificationResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Card", "_Orgtr", "_AcctTo", "_ConvsDtTm", "_TxAmts", "_Cntxt", "_Crdhldr", "_TxId", "_Termnl", "_OrgnlRspnCd", "_AddtlSvc", "_Jursdctn", "_Rcvr", "_SttlmSvc", "_AcctFr", "_PrtctdData", "_ICCRltdData", "_SctyTrlr", "_SpclPrgrmmQlfctn", "_SplmtryData", "_Vrfctn", "_Issr", "_Acqrr", "_Tkn", "_Hdr", "_AcctBal", "_TxChrtcs", "_Wllt", "_AddtlFee", "_Rsk", "_Accptr", "_PrcgRslt", "_Sndr", "_Prgrmm", "_StrngCstmrAuthntcn", "_Rcncltn", "_AddtlData", "_AddtlAmt", "_Dstn", "_Instlmt"]
	@property
	def Card(self):
		return self._Card
