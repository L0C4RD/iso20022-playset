...
class CorporateActionDate107(base_types._BaseFieldType):
	...
	__slots__ = ["_DpstryCoverXprtnDt", "_StockLndgDdln", "_PrtctDdln", "_DcmnttnDdln", "_EarlyRspnDdln", "_XpryDt", "_CoverXprtnDdln", "_RspnDdln", "_BrrwrStockLndgDdln", "_MktDdln", "_SbcptCostDbtDt"]
	@property
