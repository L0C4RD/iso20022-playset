...
class CorporateActionDate107(base_types._BaseFieldType):
	...
	__slots__ = ["_StockLndgDdln", "_CoverXprtnDdln", "_MktDdln", "_DpstryCoverXprtnDt", "_DcmnttnDdln", "_RspnDdln", "_PrtctDdln", "_XpryDt", "_EarlyRspnDdln", "_BrrwrStockLndgDdln", "_SbcptCostDbtDt"]
	@property
