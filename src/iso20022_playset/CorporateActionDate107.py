...
class CorporateActionDate107(base_types._BaseFieldType):
	...
	__slots__ = ["_CoverXprtnDdln", "_BrrwrStockLndgDdln", "_DcmnttnDdln", "_MktDdln", "_EarlyRspnDdln", "_XpryDt", "_SbcptCostDbtDt", "_PrtctDdln", "_DpstryCoverXprtnDt", "_RspnDdln", "_StockLndgDdln"]
	@property
