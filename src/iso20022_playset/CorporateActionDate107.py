...
class CorporateActionDate107(base_types._BaseFieldType):
	...
	__slots__ = ["_EarlyRspnDdln", "_SbcptCostDbtDt", "_CoverXprtnDdln", "_StockLndgDdln", "_DpstryCoverXprtnDt", "_RspnDdln", "_BrrwrStockLndgDdln", "_DcmnttnDdln", "_MktDdln", "_XpryDt", "_PrtctDdln"]
	@property
