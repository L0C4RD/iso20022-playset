...
class DeviceResponse9(base_types._BaseFieldType):
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='DispRspn', type=DeviceDisplayResponse3, min=0, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='InptRspn', type=DeviceInputResponse7, min=0, max=1, mutex_group=None, array=False),
