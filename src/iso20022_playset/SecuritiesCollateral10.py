...
from .SettlementDetails205 import SettlementDetails205
...
class SecuritiesCollateral10(base_types._BaseFieldType):
	...
	__slots__ = ["_SfkpgAcct", "_BlckChainAdrOrWllt", "_Hrcut", "_Pric", "_CollVal", "_SctyId", "_MtrtyDt", "_Qty", "_SfkpgPlc", "_LtdCvrgInd", "_MktVal", "_SttlmParams", "_CollId", "_ValDt"]
	@property
	def SfkpgAcct(self):
