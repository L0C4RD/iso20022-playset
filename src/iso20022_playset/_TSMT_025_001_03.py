...
from ._StatusChangeNotificationV03 import StatusChangeNotificationV03
...
class TSMT_025_001_03():
	...
	class Document(base_types._BaseFieldType):
		...
		attrib = {
			"xmlns" : base_types._BaseDataType_String(None, data="urn:iso:std:iso:20022:tech:xsd:tsmt.025.001.03"),
		}
		...
		def StsChngNtfctn(self, value):
			self._StsChngNtfctn = value if type(value) != base_types.auto else self.make_default("StsChngNtfctn")
