...
class CorporateActionOption237(base_types._BaseFieldType):
	...
	__slots__ = ["_SctyId", "_CcyOptn", "_OptnFeatrs", "_SlctnDealrFeeInd", "_CcyToSell", "_AddtlInf", "_ChngTp", "_FrctnDspstn", "_ExctnReqdDtTm", "_OptnNb", "_OptnTp", "_PricDtls", "_ShrhldrNb", "_ElgblForCollInd", "_RateAndAmtDtls", "_CcyToBuy", "_SctiesQtyOrInstdAmt"]
	@property
	def SctyId(self):
		return self._SctyId
