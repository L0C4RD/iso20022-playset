...
class CorporateActionOption237(base_types._BaseFieldType):
	...
	__slots__ = ["_ChngTp", "_ElgblForCollInd", "_CcyOptn", "_SctyId", "_AddtlInf", "_ExctnReqdDtTm", "_SlctnDealrFeeInd", "_OptnFeatrs", "_RateAndAmtDtls", "_PricDtls", "_CcyToBuy", "_FrctnDspstn", "_OptnNb", "_SctiesQtyOrInstdAmt", "_ShrhldrNb", "_CcyToSell", "_OptnTp"]
	@property
	def ChngTp(self):
		return self._ChngTp
