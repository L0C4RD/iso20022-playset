...
class CorporateActionOption237(base_types._BaseFieldType):
	...
	__slots__ = ["_OptnTp", "_SctyId", "_CcyToBuy", "_PricDtls", "_ElgblForCollInd", "_ChngTp", "_SlctnDealrFeeInd", "_ExctnReqdDtTm", "_FrctnDspstn", "_CcyOptn", "_AddtlInf", "_OptnFeatrs", "_CcyToSell", "_ShrhldrNb", "_SctiesQtyOrInstdAmt", "_RateAndAmtDtls", "_OptnNb"]
	@property
	def OptnTp(self):
		return self._OptnTp
