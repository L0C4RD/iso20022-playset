...
class CorporateActionOption237(base_types._BaseFieldType):
	...
	__slots__ = ["_SctiesQtyOrInstdAmt", "_PricDtls", "_AddtlInf", "_OptnTp", "_CcyOptn", "_OptnFeatrs", "_RateAndAmtDtls", "_SctyId", "_CcyToSell", "_ExctnReqdDtTm", "_SlctnDealrFeeInd", "_ShrhldrNb", "_CcyToBuy", "_FrctnDspstn", "_ChngTp", "_ElgblForCollInd", "_OptnNb"]
	@property
