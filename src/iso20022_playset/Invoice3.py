...
class Invoice3(base_types._BaseFieldType):
	...
	__slots__ = ["_SellrNm", "_SellrAdr", "_BuyrId", "_BuyrTaxRegnId", "_FrghtAmt", "_SellrCtct", "_TaxRclmMtd", "_BuyrNm", "_SellrId", "_BuyrCtct", "_Nb", "_Dt", "_SummryCmmdtyId", "_LineItm", "_SellrAddtlInf", "_CreDtTm", "_BuyrAddtlInf", "_TaxTtl", "_AddtlData", "_BuyrAdr", "_SellrTaxRegnId"]
	@property
	def SellrNm(self):
