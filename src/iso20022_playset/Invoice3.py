...
class Invoice3(base_types._BaseFieldType):
	...
	__slots__ = ["_SellrId", "_CreDtTm", "_BuyrAdr", "_SellrNm", "_Nb", "_BuyrId", "_BuyrCtct", "_SellrAdr", "_TaxRclmMtd", "_LineItm", "_BuyrTaxRegnId", "_BuyrNm", "_TaxTtl", "_FrghtAmt", "_BuyrAddtlInf", "_SellrAddtlInf", "_SummryCmmdtyId", "_SellrCtct", "_SellrTaxRegnId", "_Dt", "_AddtlData"]
	@property
	def SellrId(self):
