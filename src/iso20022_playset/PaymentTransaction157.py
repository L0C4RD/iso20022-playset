...
from .ModificationStatusReason3 import ModificationStatusReason3
...
class PaymentTransaction157(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlInstrId", "_OrgnlEndToEndId", "_OrgnlIntrBkSttlmAmt", "_OrgnlClrSysRef", "_OrgnlIntrBkSttlmDt", "_OrgnlTxRef", "_RslvdCase", "_ModStsId", "_OrgnlPmtInfId", "_OrgnlTxId", "_Assgnr", "_OrgnlUETR", "_ModStsRsnInf", "_RsltnRltdInf", "_OrgnlGrpInf", "_Assgne"]
	@property
	...
	def ModStsId(self, value):
		self._ModStsId = value if type(value) != auto else self.make_default("ModStsId")
	...
	def ModStsRsnInf(self, value):
		self._ModStsRsnInf = value if type(value) != auto else self.make_default("ModStsRsnInf")
