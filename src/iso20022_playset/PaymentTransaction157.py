...
class PaymentTransaction157(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlIntrBkSttlmAmt", "_OrgnlTxRef", "_OrgnlIntrBkSttlmDt", "_RsltnRltdInf", "_Assgnr", "_ModStsId", "_OrgnlGrpInf", "_RslvdCase", "_OrgnlUETR", "_OrgnlPmtInfId", "_OrgnlEndToEndId", "_OrgnlTxId", "_OrgnlClrSysRef", "_ModStsRsnInf", "_OrgnlInstrId", "_Assgne"]
	@property
