...
class PaymentTransaction157(base_types._BaseFieldType):
	...
	__slots__ = ["_Assgne", "_Assgnr", "_OrgnlUETR", "_RslvdCase", "_ModStsId", "_RsltnRltdInf", "_OrgnlPmtInfId", "_OrgnlIntrBkSttlmDt", "_OrgnlGrpInf", "_OrgnlTxId", "_ModStsRsnInf", "_OrgnlIntrBkSttlmAmt", "_OrgnlEndToEndId", "_OrgnlClrSysRef", "_OrgnlTxRef", "_OrgnlInstrId"]
	@property
	def Assgne(self):
		return self._Assgne
