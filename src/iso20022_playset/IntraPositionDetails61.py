...
class IntraPositionDetails61(base_types._BaseFieldType):
	...
	__slots__ = ["_BalFr", "_InstrPrcgAddtlDtls", "_AvlblDt", "_SctiesSubBalId", "_SttlmDt", "_CollMntrAmt", "_SttldQty", "_RmngToBeSttldQty", "_CorpActnEvtTp", "_BalTo", "_PrevslySttldQty"]
	@property
	def BalFr(self):
		return self._BalFr
