...
class IntraPositionDetails61(base_types._BaseFieldType):
	...
	__slots__ = ["_CorpActnEvtTp", "_BalTo", "_CollMntrAmt", "_BalFr", "_SttldQty", "_PrevslySttldQty", "_SctiesSubBalId", "_SttlmDt", "_RmngToBeSttldQty", "_AvlblDt", "_InstrPrcgAddtlDtls"]
	@property
