...
class ReceiveInformation21(base_types._BaseFieldType):
	...
	__slots__ = ["_DmtrlsdInd", "_PhysTrfDtls", "_SctiesForm", "_SttlmPtiesDtls", "_BnfcryCertfctnCmpltn", "_IndvTax", "_Trfee", "_StmpDty", "_TrfeeRegdAcct", "_Fees", "_ClntRef", "_IntrmyInf", "_IncmPref", "_FXDtls", "_PhysTrf", "_ReqdSttlmDt", "_NetAmt", "_SttlmAmt", "_ReqdTradDt"]
	@property
	def DmtrlsdInd(self):
