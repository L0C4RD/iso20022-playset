...
class CollateralAmount15(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlPdgCollIn", "_TtlOfPrncpls", "_TtlCollReqrd", "_TtlAcrdIntrst", "_TtlValOfOwnColl", "_Mrgn", "_TtlPdgCollOut", "_TtlValOfReusdColl", "_ValOfCollHeld", "_TtlXpsr", "_TtlCshFaild", "_TtlFeesComssns"]
	@property
