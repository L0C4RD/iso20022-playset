...
class CollateralAmount15(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlFeesComssns", "_TtlOfPrncpls", "_TtlPdgCollOut", "_TtlCshFaild", "_TtlXpsr", "_TtlCollReqrd", "_Mrgn", "_TtlAcrdIntrst", "_TtlPdgCollIn", "_TtlValOfOwnColl", "_ValOfCollHeld", "_TtlValOfReusdColl"]
	@property
	...
	def TtlFeesComssns(self, value):
		self._TtlFeesComssns = value if type(value) != base_types.auto else self.make_default("TtlFeesComssns")
