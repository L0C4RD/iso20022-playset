...
class Trade10(base_types._BaseFieldType):
	...
	__slots__ = ["_LastQty", "_SttlmDt", "_ValDt", "_ClctdCtrPtyCcyLastQty", "_SctyId", "_DltaInd", "_FxgCcy", "_ValtnRate", "_FwdPts", "_RskAmt", "_AssoctdTradRef", "_ExctnPric", "_SttlmTp", "_OptnInd", "_FxgDt"]
	@property
	def LastQty(self):
