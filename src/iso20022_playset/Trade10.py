...
class Trade10(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmDt", "_FwdPts", "_FxgDt", "_LastQty", "_ExctnPric", "_SttlmTp", "_FxgCcy", "_OptnInd", "_DltaInd", "_RskAmt", "_ValtnRate", "_AssoctdTradRef", "_ClctdCtrPtyCcyLastQty", "_ValDt", "_SctyId"]
	@property
	def SttlmDt(self):
