...
class OriginalTransaction3(base_types._BaseFieldType):
	...
	__slots__ = ["_Pyer", "_Cntxt", "_SttlmSvc", "_CstmrDvc", "_Vrfctn", "_Prgrmm", "_FndsSvcs", "_PrcgRslt", "_Accptr", "_DsptData", "_SpclPrgrmmQlfctn", "_Rcvr", "_Rcncltn", "_Dcmnttn", "_Crdhldr", "_AddtlFee", "_Jursdctn", "_ConvsDtTm", "_Orgtr", "_AcctTo", "_Rsk", "_TxChrtcs", "_Acqrr", "_Wllt", "_Sndr", "_Tkn", "_POICmpnt", "_TxId", "_Dstn", "_Pyee", "_TxAmts", "_Issr", "_AddtlAmt", "_AddtlSvc", "_XchgRate", "_Card", "_Termnl", "_DpstDtls", "_AcctFr"]
	@property
	def Pyer(self):
		return self._Pyer
