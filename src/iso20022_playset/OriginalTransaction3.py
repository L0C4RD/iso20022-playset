...
class OriginalTransaction3(base_types._BaseFieldType):
	...
	__slots__ = ["_Orgtr", "_Card", "_Vrfctn", "_Jursdctn", "_Rcvr", "_Pyee", "_CstmrDvc", "_Dstn", "_AddtlAmt", "_SttlmSvc", "_Rcncltn", "_Issr", "_DpstDtls", "_TxId", "_FndsSvcs", "_Pyer", "_XchgRate", "_Sndr", "_Dcmnttn", "_TxAmts", "_PrcgRslt", "_AddtlSvc", "_AcctFr", "_Wllt", "_AcctTo", "_TxChrtcs", "_DsptData", "_POICmpnt", "_Accptr", "_SpclPrgrmmQlfctn", "_Prgrmm", "_Acqrr", "_AddtlFee", "_Cntxt", "_Termnl", "_Rsk", "_ConvsDtTm", "_Tkn", "_Crdhldr"]
	@property
	def Orgtr(self):
		return self._Orgtr
