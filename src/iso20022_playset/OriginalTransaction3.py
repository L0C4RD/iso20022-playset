...
class OriginalTransaction3(base_types._BaseFieldType):
	...
	__slots__ = ["_FndsSvcs", "_PrcgRslt", "_CstmrDvc", "_Card", "_TxChrtcs", "_AddtlSvc", "_Acqrr", "_Crdhldr", "_Prgrmm", "_Vrfctn", "_ConvsDtTm", "_SpclPrgrmmQlfctn", "_Rcncltn", "_Termnl", "_SttlmSvc", "_Issr", "_TxId", "_XchgRate", "_Wllt", "_DsptData", "_Dstn", "_Accptr", "_Rcvr", "_Cntxt", "_Jursdctn", "_Pyee", "_Dcmnttn", "_Sndr", "_Pyer", "_Rsk", "_DpstDtls", "_POICmpnt", "_AddtlFee", "_AcctFr", "_Tkn", "_TxAmts", "_Orgtr", "_AddtlAmt", "_AcctTo"]
	@property
	def FndsSvcs(self):
