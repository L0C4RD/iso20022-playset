...
class OriginalTransaction3(base_types._BaseFieldType):
	...
	__slots__ = ["_DpstDtls", "_Acqrr", "_Accptr", "_SpclPrgrmmQlfctn", "_Termnl", "_Issr", "_XchgRate", "_PrcgRslt", "_Dstn", "_TxChrtcs", "_TxId", "_Card", "_Pyer", "_Prgrmm", "_AcctFr", "_AddtlSvc", "_SttlmSvc", "_Dcmnttn", "_Rcvr", "_AddtlAmt", "_Rcncltn", "_ConvsDtTm", "_Tkn", "_Wllt", "_Orgtr", "_AddtlFee", "_Cntxt", "_Pyee", "_Jursdctn", "_AcctTo", "_TxAmts", "_CstmrDvc", "_DsptData", "_Vrfctn", "_FndsSvcs", "_Crdhldr", "_POICmpnt", "_Sndr", "_Rsk"]
	@property
	def DpstDtls(self):
