...
class OriginalTransaction3(base_types._BaseFieldType):
	...
	__slots__ = ["_POICmpnt", "_AcctTo", "_Prgrmm", "_Tkn", "_Dstn", "_DsptData", "_Crdhldr", "_DpstDtls", "_Acqrr", "_PrcgRslt", "_Accptr", "_TxId", "_Vrfctn", "_Termnl", "_Rcvr", "_FndsSvcs", "_Jursdctn", "_Wllt", "_Orgtr", "_CstmrDvc", "_Pyee", "_Rsk", "_SttlmSvc", "_AddtlFee", "_Dcmnttn", "_Sndr", "_Rcncltn", "_SpclPrgrmmQlfctn", "_Cntxt", "_TxChrtcs", "_TxAmts", "_AcctFr", "_Issr", "_Card", "_Pyer", "_AddtlAmt", "_XchgRate", "_ConvsDtTm", "_AddtlSvc"]
	@property
	def POICmpnt(self):
