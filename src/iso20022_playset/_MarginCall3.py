...
class MarginCall3(base_types._BaseFieldType):
	...
	__slots__ = ["_CollAcctId", "_RqrmntDtlsDueToB", "_XpctdCollDueToA", "_RqrmntDtlsDueToA", "_XpctdCollDueToB", "_MrgnDtlDueToB", "_MrgnDtlDueToA", "_MrgnCallRslt", "_BlckChainAdrOrWllt"]
	@property
	def CollAcctId(self):
