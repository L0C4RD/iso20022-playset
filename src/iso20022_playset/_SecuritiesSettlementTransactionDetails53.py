...
class SecuritiesSettlementTransactionDetails53(base_types._BaseFieldType):
	...
	__slots__ = ["_TradDtls", "_StgSttlmInstrDtls", "_SplmtryData", "_AddtlPhysOrRegnDtls", "_OthrAmts", "_CshPties", "_QtyAndAcctDtls", "_SttlmTpAndAddtlParams", "_SttlmParams", "_DlvrgSttlmPties", "_FinInstrmAttrbts", "_Lnkgs", "_OthrBizPties", "_SttlmAmt", "_RcvgSttlmPties"]
	@property
	def TradDtls(self):
