...
from . import FinancialInstrument62Choice
from . import FundSettlementParameters17
from . import Intermediary43
from . import Max35Text
from . import Quantity47
from . import Tax36
from . import Unit11
...
class FinancialInstrument99(base_types._BaseFieldType):
	...
	def Instrm(self, value):
		self._Instrm = value if value is not None else base_types.UninitialisedField(self, 'Instrm', FinancialInstrument62Choice, False)

	@Instrm.deleter
	def Instrm(self):
		del self._Instrm
		self._Instrm = base_types.UninitialisedField(self, 'Instrm', FinancialInstrument62Choice, False)
	...
	@Qty.setter
	def Qty(self, value):
		self._Qty = value if value is not None else base_types.UninitialisedField(self, 'Qty', Quantity47, False)

	@Qty.deleter
	def Qty(self):
		del self._Qty
		self._Qty = base_types.UninitialisedField(self, 'Qty', Quantity47, False)
	...
	def SttlmPtiesDtls(self, value):
		self._SttlmPtiesDtls = value if value is not None else base_types.UninitialisedField(self, 'SttlmPtiesDtls', FundSettlementParameters17, True)

	@SttlmPtiesDtls.deleter
	def SttlmPtiesDtls(self):
		del self._SttlmPtiesDtls
		self._SttlmPtiesDtls = base_types.UninitialisedField(self, 'SttlmPtiesDtls', FundSettlementParameters17, True)
	...
	@Trfr.setter
	def Trfr(self, value):
		self._Trfr = value if value is not None else base_types.UninitialisedField(self, 'Trfr', Account28, True)

	@Trfr.deleter
	def Trfr(self):
		del self._Trfr
		self._Trfr = base_types.UninitialisedField(self, 'Trfr', Account28, True)
	...
	def UnitsDtls(self, value):
		self._UnitsDtls = value if value is not None else base_types.UninitialisedField(self, 'UnitsDtls', Unit11, True)

	@UnitsDtls.deleter
	def UnitsDtls(self):
		del self._UnitsDtls
		self._UnitsDtls = base_types.UninitialisedField(self, 'UnitsDtls', Unit11, True)
