...
from . import RedemptionMultipleOrder07

class RedemptionOrderV05(base_types._BaseFieldType):
	...
	def MltplOrdrDtls(self, value):
		self._MltplOrdrDtls = value if value is not None else base_types.UninitialisedField(self, 'MltplOrdrDtls', RedemptionMultipleOrder07, False)

	@MltplOrdrDtls.deleter
	def MltplOrdrDtls(self):
		del self._MltplOrdrDtls
		self._MltplOrdrDtls = base_types.UninitialisedField(self, 'MltplOrdrDtls', RedemptionMultipleOrder07, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='MltplOrdrDtls', type=RedemptionMultipleOrder07, min=1, max=1, mutex_group=None, array=False),
