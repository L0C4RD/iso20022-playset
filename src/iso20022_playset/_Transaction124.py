...
class Transaction124(base_types._BaseFieldType):
	...
	__slots__ = ["_ClsgDt", "_ClntTrptyCollTxId", "_ValtnAmts", "_TermntnOptn", "_OptnTp", "_MrgnRate", "_XpsrTp", "_SctiesBal", "_PricgRate", "_TxSts", "_CtrPtyCollTxRef", "_CshBal", "_CollPties", "_BsktIdAndElgbltySetPrfl", "_SprdRate", "_CmonTxId", "_ExctnReqdDt", "_AutomtcAllcn", "_DayCntBsis", "_TrptyAgtSvcPrvdrCollTxId"]
	@property
	def ClsgDt(self):
		return self._ClsgDt
