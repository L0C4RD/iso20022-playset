...
class TransactionReportItems3(base_types._BaseFieldType):
	...
	__slots__ = ["_BuyrBkCtry", "_PurchsOrdrRef", "_OblgrBk", "_SubmitgBk", "_SellrBk", "_SellrBkCtry", "_UsrTxRef", "_Sellr", "_EstblishdBaselnId", "_TxId", "_OutsdngAmt", "_Buyr", "_PdgReqForActn", "_TxSts", "_TtlNetAmt", "_BuyrBk"]
	@property
	def BuyrBkCtry(self):
