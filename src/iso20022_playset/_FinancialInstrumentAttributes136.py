...
class FinancialInstrumentAttributes136(base_types._BaseFieldType):
	...
	def WarrtParity(self, value):
		self._WarrtParity = value if value is not None else base_types.UninitialisedField(self, 'WarrtParity', QuantityToQuantityRatio2, False)

	@WarrtParity.deleter
	def WarrtParity(self):
		del self._WarrtParity
		self._WarrtParity = base_types.UninitialisedField(self, 'WarrtParity', QuantityToQuantityRatio2, False)
