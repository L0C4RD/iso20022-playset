...
class FinancialInstrumentAttributes136(base_types._BaseFieldType):
	...
	__slots__ = ["_DayCntBsis", "_WarrtParity", "_IsseDt", "_OptnStyle", "_MtrtyDt", "_IntrstRate", "_FltgRateFxgDt", "_XpryDt", "_NxtFctr", "_DnmtnCcy", "_NxtCpnDt", "_ClssfctnTp", "_DtdDt", "_PrvsFctr", "_PutblDt", "_CtrctSz", "_NxtIntrstRate", "_MinNmnlQty", "_FinInstrmId", "_PctgOfDebtClm", "_NxtCllblDt", "_PlcOfListg", "_ConvsDt"]
	@property
	def DayCntBsis(self):
