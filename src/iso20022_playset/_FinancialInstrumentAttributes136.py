...
class FinancialInstrumentAttributes136(base_types._BaseFieldType):

	__slots__ = ["_OptnStyle", "_PrvsFctr", "_PlcOfListg", "_ConvsDt", "_DnmtnCcy", "_NxtCllblDt", "_CtrctSz", "_IntrstRate", "_FltgRateFxgDt", "_WarrtParity", "_DtdDt", "_MtrtyDt", "_IsseDt", "_NxtIntrstRate", "_DayCntBsis", "_PctgOfDebtClm", "_NxtCpnDt", "_NxtFctr", "_PutblDt", "_ClssfctnTp", "_MinNmnlQty", "_XpryDt", "_FinInstrmId"]
	@property
	def OptnStyle(self):
