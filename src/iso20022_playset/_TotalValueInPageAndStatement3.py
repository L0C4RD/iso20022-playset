...
class TotalValueInPageAndStatement3(base_types._BaseFieldType):
	...
	def TtlBookValOfStmt(self, value):
		self._TtlBookValOfStmt = value if value is not None else base_types.UninitialisedField(self, 'TtlBookValOfStmt', AmountAndDirection14, False)

	@TtlBookValOfStmt.deleter
	def TtlBookValOfStmt(self):
		del self._TtlBookValOfStmt
		self._TtlBookValOfStmt = base_types.UninitialisedField(self, 'TtlBookValOfStmt', AmountAndDirection14, False)
	...
	def TtlElgblCollVal(self, value):
		self._TtlElgblCollVal = value if value is not None else base_types.UninitialisedField(self, 'TtlElgblCollVal', AmountAndDirection14, False)

	@TtlElgblCollVal.deleter
	def TtlElgblCollVal(self):
		del self._TtlElgblCollVal
		self._TtlElgblCollVal = base_types.UninitialisedField(self, 'TtlElgblCollVal', AmountAndDirection14, False)
	...
	def TtlHldgsValOfPg(self, value):
		self._TtlHldgsValOfPg = value if value is not None else base_types.UninitialisedField(self, 'TtlHldgsValOfPg', AmountAndDirection14, False)

	@TtlHldgsValOfPg.deleter
	def TtlHldgsValOfPg(self):
		del self._TtlHldgsValOfPg
		self._TtlHldgsValOfPg = base_types.UninitialisedField(self, 'TtlHldgsValOfPg', AmountAndDirection14, False)
	...
	def TtlHldgsValOfStmt(self, value):
		self._TtlHldgsValOfStmt = value if value is not None else base_types.UninitialisedField(self, 'TtlHldgsValOfStmt', AmountAndDirection14, False)

	@TtlHldgsValOfStmt.deleter
	def TtlHldgsValOfStmt(self):
		del self._TtlHldgsValOfStmt
		self._TtlHldgsValOfStmt = base_types.UninitialisedField(self, 'TtlHldgsValOfStmt', AmountAndDirection14, False)
