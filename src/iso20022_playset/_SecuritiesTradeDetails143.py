...
class SecuritiesTradeDetails143(base_types._BaseFieldType):
	...
	__slots__ = ["_NbOfDaysAcrd", "_FxAddtlDtls", "_TradId", "_PlcOfTrad", "_FctvSttlmDt", "_TradTxCond", "_SttlmDt", "_OpngClsg", "_TradDt", "_SttlmInstrPrcgAddtlDtls", "_TpOfPric", "_UnqTxIdr", "_TradOrgtrRole", "_Rptg", "_InvstrCpcty", "_DealPric", "_CollTxId", "_PlcOfClr"]
	@property
