...
class CorporateActionMovementPreliminaryAdviceCancellationAdvice002V13(base_types._BaseFieldType):
	...
	__slots__ = ["_CorpActnDtls", "_SlctnAgt", "_Regar", "_InfAgt", "_MvmntPrlimryAdvcId", "_SplmtryData", "_AcctDtls", "_DrpAgt", "_SubPngAgt", "_RsellngAgt", "_IssrAgt", "_CorpActnGnlInf", "_PngAgt", "_PhysSctiesAgt"]
	@property
