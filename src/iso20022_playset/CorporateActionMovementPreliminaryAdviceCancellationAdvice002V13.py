...
class CorporateActionMovementPreliminaryAdviceCancellationAdvice002V13(base_types._BaseFieldType):
	...
	__slots__ = ["_CorpActnGnlInf", "_SubPngAgt", "_DrpAgt", "_MvmntPrlimryAdvcId", "_PngAgt", "_CorpActnDtls", "_AcctDtls", "_InfAgt", "_PhysSctiesAgt", "_IssrAgt", "_SplmtryData", "_Regar", "_RsellngAgt", "_SlctnAgt"]
	@property
