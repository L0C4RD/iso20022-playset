...
class CorporateActionMovementPreliminaryAdviceCancellationAdvice002V13(base_types._BaseFieldType):
	...
	__slots__ = ["_PhysSctiesAgt", "_RsellngAgt", "_MvmntPrlimryAdvcId", "_DrpAgt", "_SubPngAgt", "_Regar", "_IssrAgt", "_SplmtryData", "_SlctnAgt", "_CorpActnDtls", "_PngAgt", "_InfAgt", "_CorpActnGnlInf", "_AcctDtls"]
	@property
