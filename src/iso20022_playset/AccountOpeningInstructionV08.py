...
class AccountOpeningInstructionV08(base_types._BaseFieldType):
	...
	__slots__ = ["_WdrwlInvstmtPlan", "_CshSttlm", "_Plcmnt", "_AddtlInf", "_Xtnsn", "_MsgId", "_OrdrRef", "_NewIsseAllcn", "_InvstmtAcct", "_SvgsInvstmtPlan", "_PrvsRef", "_InstrDtls", "_SvcLvlAgrmt", "_MktPrctcVrsn", "_AcctPties", "_Intrmies"]
	@property
