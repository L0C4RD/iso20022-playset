...
class SecuritiesSettlementTransactionAllegementNotification002V10(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrPtyMktInfrstrctrTxId", "_DlvrgSttlmPties", "_SplmtryData", "_FinInstrmAttrbts", "_SctiesFincgDtls", "_OthrAmts", "_OthrBizPties", "_SttlmTpAndAddtlParams", "_TxId", "_RcvgSttlmPties", "_CshPties", "_QtyAndAcctDtls", "_SttlmParams", "_MktInfrstrctrTxId", "_TradDtls", "_SttlmAmt", "_FinInstrmId"]
	@property
