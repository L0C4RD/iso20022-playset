...
class CardData12(base_types._BaseFieldType):
	...
	__slots__ = ["_PANFourLastDgts", "_Ccy", "_PmtAcctRef", "_FctvDt", "_PAN", "_PrtctdPAN", "_AddtlData", "_Ctry", "_CardSeqNb", "_PrtflIdr", "_PANAcctRg", "_PdctSubTp", "_PdctTp", "_Trck3", "_XpryDt"]
	@property
