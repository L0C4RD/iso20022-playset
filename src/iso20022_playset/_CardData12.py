...
class CardData12(base_types._BaseFieldType):
	...
	__slots__ = ["_CardSeqNb", "_FctvDt", "_PmtAcctRef", "_PdctSubTp", "_PAN", "_AddtlData", "_PrtctdPAN", "_XpryDt", "_PdctTp", "_Ccy", "_PrtflIdr", "_Ctry", "_PANAcctRg", "_Trck3", "_PANFourLastDgts"]
	@property
	def CardSeqNb(self):
