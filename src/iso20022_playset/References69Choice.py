...
class References69Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_TrptyCollStsAdvcId", "_SctiesSttlmTxGnrtnNtfctnId", "_SctiesBalCtdyRptId", "_IntraPosMvmntPstngRptId", "_TrptyCollTxInstrPrcgStsAdvcId", "_OthrMsgId", "_TtlPrtflValtnRptId", "_SctiesBalAcctgRptId", "_SctiesSttlmTxConfId", "_PrtflTrfNtfctnId", "_TrptyCollAndXpsrRptId", "_SctiesSttlmTxAllgmtRptId", "_SctiesSttlmTxAllgmtNtfctnTxId", "_IntraPosMvmntConfId", "_SctiesTxPdgRptId", "_SctiesFincgConfId", "_SctiesTxPstngRptId"]
	@property
