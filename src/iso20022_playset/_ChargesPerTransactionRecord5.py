...
class ChargesPerTransactionRecord5(base_types._BaseFieldType):
	...
	__slots__ = ["_UndrlygTx", "_ChrgsAcct", "_InstrForInstdAgt", "_ChrgsBrkdwn", "_DbtrAcct", "_RcrdId", "_ChrgsRqstr", "_ValDt", "_DbtrAgt", "_AddtlInf", "_ChrgsAcctOwnr", "_DbtrAgtAcct", "_TtlChrgsPerRcrd", "_Dbtr"]
	@property
	def AddtlInf(self):
