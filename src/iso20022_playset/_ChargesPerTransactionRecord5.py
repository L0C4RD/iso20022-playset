...
class ChargesPerTransactionRecord5(base_types._BaseFieldType):
	...
	__slots__ = ["_ChrgsBrkdwn", "_ChrgsAcct", "_UndrlygTx", "_RcrdId", "_TtlChrgsPerRcrd", "_DbtrAcct", "_ChrgsAcctOwnr", "_DbtrAgtAcct", "_ChrgsRqstr", "_InstrForInstdAgt", "_Dbtr", "_AddtlInf", "_DbtrAgt", "_ValDt"]
	@property
