...
class ChargesPerTransactionRecord5(base_types._BaseFieldType):
	...
	__slots__ = ["_UndrlygTx", "_ChrgsRqstr", "_ValDt", "_Dbtr", "_ChrgsAcct", "_AddtlInf", "_DbtrAcct", "_DbtrAgtAcct", "_DbtrAgt", "_ChrgsAcctOwnr", "_InstrForInstdAgt", "_RcrdId", "_ChrgsBrkdwn", "_TtlChrgsPerRcrd"]
	@property
	def UndrlygTx(self):
