...
class SecuritiesTradeDetails115(base_types._BaseFieldType):
	...
	__slots__ = ["_PlcOfTrad", "_SttlmInstrPrcgAddtlDtls", "_SttlmDt", "_TradOrgtrRole", "_NbOfDaysAcrd", "_TradTxCond", "_FctvSttlmDt", "_PlcOfClr", "_InvstrCpcty", "_Rptg", "_FxAddtlDtls", "_TradDt", "_DealPric"]
	@property
	def PlcOfTrad(self):
