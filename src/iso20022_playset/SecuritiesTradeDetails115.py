...
class SecuritiesTradeDetails115(base_types._BaseFieldType):
	...
	__slots__ = ["_PlcOfClr", "_Rptg", "_TradTxCond", "_NbOfDaysAcrd", "_TradDt", "_DealPric", "_FxAddtlDtls", "_PlcOfTrad", "_TradOrgtrRole", "_InvstrCpcty", "_SttlmInstrPrcgAddtlDtls", "_SttlmDt", "_FctvSttlmDt"]
	@property
	def PlcOfClr(self):
