...
from . import CorporateActionOption252
...
class CorporateActionMovementPreliminaryAdviceV17(base_types._BaseFieldType):
	...
	def CorpActnDtls(self, value):
		self._CorpActnDtls = value if value is not None else base_types.UninitialisedField(self, 'CorpActnDtls', CorporateAction91, False)

	@CorpActnDtls.deleter
	def CorpActnDtls(self):
		del self._CorpActnDtls
		self._CorpActnDtls = base_types.UninitialisedField(self, 'CorpActnDtls', CorporateAction91, False)
	...
	def CorpActnMvmntDtls(self, value):
		self._CorpActnMvmntDtls = value if value is not None else base_types.UninitialisedField(self, 'CorpActnMvmntDtls', CorporateActionOption252, True)

	@CorpActnMvmntDtls.deleter
	def CorpActnMvmntDtls(self):
		del self._CorpActnMvmntDtls
		self._CorpActnMvmntDtls = base_types.UninitialisedField(self, 'CorpActnMvmntDtls', CorporateActionOption252, True)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='CorpActnDtls', type=CorporateAction91, min=0, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='CorpActnMvmntDtls', type=CorporateActionOption252, min=0, max=None, mutex_group=None, array=True),
