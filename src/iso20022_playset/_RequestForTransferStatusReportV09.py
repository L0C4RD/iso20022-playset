...
from . import MessageAndBusinessReference14
from . import MessageIdentification1

class RequestForTransferStatusReportV09(base_types._BaseFieldType):
	...
	def ReqDtls(self, value):
		self._ReqDtls = value if value is not None else base_types.UninitialisedField(self, 'ReqDtls', MessageAndBusinessReference14, True)

	@ReqDtls.deleter
	def ReqDtls(self):
		del self._ReqDtls
		self._ReqDtls = base_types.UninitialisedField(self, 'ReqDtls', MessageAndBusinessReference14, True)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='ReqDtls', type=MessageAndBusinessReference14, min=1, max=None, mutex_group=None, array=True),
