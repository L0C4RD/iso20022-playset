...
class FeeCollectionResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlAmt", "_OrgnlDataElmts", "_Sndr", "_AddtlData", "_Issr", "_Jursdctn", "_Prgrmm", "_SplmtryData", "_Card", "_AddtlFee", "_Hdr", "_Tkn", "_Rcncltn", "_ConvsDtTm", "_SctyTrlr", "_TxId", "_PrcgRslt", "_Rcvr", "_Accptr", "_SttlmSvc", "_SpclPrgrmmQlfctn", "_TxChrtcs", "_Cntxt", "_TxAmts", "_FeeColltnRef", "_PrtctdData", "_Orgtr", "_Acqrr", "_Dstn"]
	@property
	def Accptr(self):
		return self._Accptr
