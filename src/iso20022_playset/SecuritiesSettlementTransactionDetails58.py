...
class SecuritiesSettlementTransactionDetails58(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlPhysOrRegnDtls", "_CshPties", "_Lnkgs", "_QtyAndAcctDtls", "_RcvgSttlmPties", "_OthrBizPties", "_SttlmParams", "_TradDtls", "_StgSttlmInstrDtls", "_SplmtryData", "_DlvrgSttlmPties", "_SttlmAmt", "_OthrAmts", "_SttlmTpAndAddtlParams", "_FinInstrmAttrbts"]
	@property
