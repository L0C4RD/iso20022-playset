...
class SecuritiesSettlementTransactionDetails58(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmTpAndAddtlParams", "_SttlmParams", "_CshPties", "_SttlmAmt", "_RcvgSttlmPties", "_OthrAmts", "_AddtlPhysOrRegnDtls", "_SplmtryData", "_OthrBizPties", "_FinInstrmAttrbts", "_StgSttlmInstrDtls", "_DlvrgSttlmPties", "_QtyAndAcctDtls", "_Lnkgs", "_TradDtls"]
	@property
