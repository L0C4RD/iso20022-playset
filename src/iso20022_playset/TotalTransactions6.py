...
from .TotalsPerBankTransactionCode5 import TotalsPerBankTransactionCode5
from .NumberAndSumOfTransactions4 import NumberAndSumOfTransactions4
from .NumberAndSumOfTransactions1 import NumberAndSumOfTransactions1

class TotalTransactions6(base_types._BaseFieldType):

	__slots__ = ["_TtlDbtNtries", "_TtlCdtNtries", "_TtlNtriesPerBkTxCd", "_TtlNtries"]
	@property
