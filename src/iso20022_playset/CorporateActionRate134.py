...
class CorporateActionRate134(base_types._BaseFieldType):
	...
	__slots__ = ["_TrfrmatnRate", "_NewToOd", "_WhldgTaxRate", "_ChrgsFees", "_AddtlQtyForSbcbdRsltntScties", "_AplblRate", "_FsclStmp", "_ScndLvlTax", "_AddtlQtyForExstgScties", "_TaxCdtRate", "_FinTxTaxRate"]
	@property
