...
class TransferStatusAndReason8(base_types._BaseFieldType):
	...
	__slots__ = ["_StsRcpt", "_QryRspn", "_TrfSts", "_OthrDrwdwnInf", "_ClntRef", "_StsInitr", "_AddtlInf", "_TtlTrfVal", "_TrfRef", "_CxlRef", "_Convs", "_BnftCrstllstnEvt", "_Instrm", "_InvstmtAcctDtls", "_UnitsDtls", "_SndOutDt", "_TrfEvtTp", "_CshSttlmDt", "_SttlmDt", "_PmtDtls", "_DrwdwnTrch", "_TradDt", "_StsIssr", "_TtlUnitsNb", "_AvrgPric", "_IntrmyInf", "_MstrRef"]
	@property
	def StsRcpt(self):
