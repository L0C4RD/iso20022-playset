...
class TransferStatusAndReason8(base_types._BaseFieldType):
	...
	__slots__ = ["_ClntRef", "_UnitsDtls", "_Instrm", "_OthrDrwdwnInf", "_TradDt", "_CxlRef", "_AddtlInf", "_SttlmDt", "_TrfSts", "_InvstmtAcctDtls", "_QryRspn", "_MstrRef", "_CshSttlmDt", "_PmtDtls", "_IntrmyInf", "_BnftCrstllstnEvt", "_TrfRef", "_StsIssr", "_TtlTrfVal", "_AvrgPric", "_SndOutDt", "_Convs", "_TrfEvtTp", "_StsInitr", "_TtlUnitsNb", "_StsRcpt", "_DrwdwnTrch"]
	@property
	def ClntRef(self):
