...
class TransferStatusAndReason8(base_types._BaseFieldType):
	...
	__slots__ = ["_TrfSts", "_StsInitr", "_CshSttlmDt", "_ClntRef", "_SttlmDt", "_MstrRef", "_InvstmtAcctDtls", "_PmtDtls", "_TtlTrfVal", "_TtlUnitsNb", "_StsIssr", "_TradDt", "_DrwdwnTrch", "_AvrgPric", "_AddtlInf", "_BnftCrstllstnEvt", "_StsRcpt", "_Convs", "_TrfRef", "_SndOutDt", "_Instrm", "_TrfEvtTp", "_IntrmyInf", "_CxlRef", "_QryRspn", "_UnitsDtls", "_OthrDrwdwnInf"]
	@property
	def TrfSts(self):
		return self._TrfSts
