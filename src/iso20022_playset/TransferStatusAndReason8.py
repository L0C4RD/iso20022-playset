...
from .Drawdown2 import Drawdown2
from .ActiveCurrencyAnd13DecimalAmount import ActiveCurrencyAnd13DecimalAmount
from .Conversion2 import Conversion2
from .TransferStatusType3Choice import TransferStatusType3Choice
from .Drawdown3 import Drawdown3
...
from .BenefitCrystallisationEvent2 import BenefitCrystallisationEvent2
from .Max350Text import Max350Text
from .TransferStatus5Choice import TransferStatus5Choice
...
from .PaymentInstrument18 import PaymentInstrument18
...
class TransferStatusAndReason8(base_types._BaseFieldType):
	...
	__slots__ = ["_Convs", "_TrfEvtTp", "_StsIssr", "_StsInitr", "_TtlUnitsNb", "_AddtlInf", "_MstrRef", "_IntrmyInf", "_TtlTrfVal", "_ClntRef", "_AvrgPric", "_SndOutDt", "_UnitsDtls", "_OthrDrwdwnInf", "_CshSttlmDt", "_TradDt", "_BnftCrstllstnEvt", "_QryRspn", "_PmtDtls", "_CxlRef", "_Instrm", "_SttlmDt", "_TrfSts", "_InvstmtAcctDtls", "_StsRcpt", "_DrwdwnTrch", "_TrfRef"]
	@property
	def Convs(self):
		return self._Convs
