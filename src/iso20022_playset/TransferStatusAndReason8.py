...
class TransferStatusAndReason8(base_types._BaseFieldType):
	...
	__slots__ = ["_TrfSts", "_TtlUnitsNb", "_UnitsDtls", "_AddtlInf", "_StsIssr", "_OthrDrwdwnInf", "_CxlRef", "_QryRspn", "_InvstmtAcctDtls", "_CshSttlmDt", "_TradDt", "_Instrm", "_MstrRef", "_TrfRef", "_BnftCrstllstnEvt", "_SndOutDt", "_PmtDtls", "_TtlTrfVal", "_SttlmDt", "_ClntRef", "_StsInitr", "_IntrmyInf", "_Convs", "_DrwdwnTrch", "_TrfEvtTp", "_StsRcpt", "_AvrgPric"]
	@property
	def TrfSts(self):
		return self._TrfSts
