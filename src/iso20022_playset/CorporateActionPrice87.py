...
class CorporateActionPrice87(base_types._BaseFieldType):
	...
	__slots__ = ["_MinCshToInst", "_MinMltplCshToInst", "_MaxCshToInst", "_CshInLieuOfShrPric", "_OverSbcptDpstPric", "_MaxPric", "_FrstBidIncrmtPric", "_MinPric", "_LastBidIncrmtPric"]
	@property
