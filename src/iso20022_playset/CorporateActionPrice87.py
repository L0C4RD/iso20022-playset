...
class CorporateActionPrice87(base_types._BaseFieldType):
	...
	__slots__ = ["_MaxCshToInst", "_MaxPric", "_MinCshToInst", "_LastBidIncrmtPric", "_FrstBidIncrmtPric", "_CshInLieuOfShrPric", "_MinMltplCshToInst", "_OverSbcptDpstPric", "_MinPric"]
	@property
