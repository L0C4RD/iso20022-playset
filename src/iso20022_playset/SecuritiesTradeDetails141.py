...
class SecuritiesTradeDetails141(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmDt", "_OthrBizPties", "_PrcrTxId", "_CmonId", "_TradTxCond", "_TradId", "_AcctOwnrTxId", "_TradDt", "_DealPric", "_CollTxId", "_DlvrgSttlmPties", "_FinInstrmAttrbts", "_AcctSvcrTxId", "_UnqTxIdr", "_NbOfDaysAcrd", "_PoolId", "_MktInfrstrctrTxId", "_PlcOfClr", "_RcvgSttlmPties", "_SctiesMvmntTp", "_QtyAndAcctDtls", "_SttlmParams", "_Pmt", "_PlcOfTrad", "_TpOfPric", "_SttlmAmt", "_CtrPtyMktInfrstrctrTxId", "_OthrAmts", "_FinInstrmId", "_SplmtryData", "_Sts", "_SctiesFincgDtls"]
	@property
	def SttlmDt(self):
