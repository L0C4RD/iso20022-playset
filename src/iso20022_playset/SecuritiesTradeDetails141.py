...
class SecuritiesTradeDetails141(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmAmt", "_TradId", "_RcvgSttlmPties", "_CollTxId", "_DlvrgSttlmPties", "_NbOfDaysAcrd", "_CmonId", "_Sts", "_OthrAmts", "_SctiesFincgDtls", "_QtyAndAcctDtls", "_PoolId", "_AcctOwnrTxId", "_PlcOfClr", "_TradDt", "_SplmtryData", "_TpOfPric", "_FinInstrmAttrbts", "_MktInfrstrctrTxId", "_PlcOfTrad", "_UnqTxIdr", "_DealPric", "_SctiesMvmntTp", "_SttlmDt", "_FinInstrmId", "_OthrBizPties", "_SttlmParams", "_TradTxCond", "_PrcrTxId", "_AcctSvcrTxId", "_CtrPtyMktInfrstrctrTxId", "_Pmt"]
	@property
	def SttlmAmt(self):
