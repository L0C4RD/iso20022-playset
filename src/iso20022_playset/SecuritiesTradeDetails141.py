...
class SecuritiesTradeDetails141(base_types._BaseFieldType):
	...
	__slots__ = ["_DealPric", "_TradTxCond", "_FinInstrmId", "_QtyAndAcctDtls", "_Sts", "_CollTxId", "_AcctOwnrTxId", "_PlcOfTrad", "_FinInstrmAttrbts", "_SttlmAmt", "_SttlmDt", "_PoolId", "_PlcOfClr", "_DlvrgSttlmPties", "_CmonId", "_UnqTxIdr", "_SttlmParams", "_RcvgSttlmPties", "_CtrPtyMktInfrstrctrTxId", "_SctiesMvmntTp", "_OthrAmts", "_PrcrTxId", "_MktInfrstrctrTxId", "_TradId", "_TpOfPric", "_SctiesFincgDtls", "_Pmt", "_NbOfDaysAcrd", "_AcctSvcrTxId", "_OthrBizPties", "_TradDt", "_SplmtryData"]
	@property
	def DealPric(self):
