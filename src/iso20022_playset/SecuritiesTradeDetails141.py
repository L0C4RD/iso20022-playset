...
import AllegementStatus3Choice
import Max3Number
...
import QuantityAndAccount114
import SettlementDetails168
import OtherAmounts32
import TradeDate8Choice
import PlaceOfClearingIdentification2
import Max35Text
import SettlementDate17Choice
import SecuritiesFinancingTransactionDetails54

class SecuritiesTradeDetails141(base_types._BaseFieldType):

	__slots__ = ["_PlcOfTrad", "_SplmtryData", "_Pmt", "_SctiesMvmntTp", "_SctiesFincgDtls", "_CmonId", "_Sts", "_TradDt", "_OthrBizPties", "_QtyAndAcctDtls", "_OthrAmts", "_DlvrgSttlmPties", "_CtrPtyMktInfrstrctrTxId", "_AcctSvcrTxId", "_CollTxId", "_SttlmParams", "_AcctOwnrTxId", "_SttlmAmt", "_DealPric", "_UnqTxIdr", "_MktInfrstrctrTxId", "_TradTxCond", "_SttlmDt", "_PrcrTxId", "_FinInstrmId", "_RcvgSttlmPties", "_TradId", "_FinInstrmAttrbts", "_NbOfDaysAcrd", "_PlcOfClr", "_TpOfPric", "_PoolId"]
	@property
	def PlcOfTrad(self):
