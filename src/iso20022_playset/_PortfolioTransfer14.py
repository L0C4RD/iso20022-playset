...
from . import FinancialInstrument108
...
class PortfolioTransfer14(base_types._BaseFieldType):
	...
	def FinInstrmAsstForTrf(self, value):
		self._FinInstrmAsstForTrf = value if value is not None else base_types.UninitialisedField(self, 'FinInstrmAsstForTrf', FinancialInstrument108, True)

	@FinInstrmAsstForTrf.deleter
	def FinInstrmAsstForTrf(self):
		del self._FinInstrmAsstForTrf
		self._FinInstrmAsstForTrf = base_types.UninitialisedField(self, 'FinInstrmAsstForTrf', FinancialInstrument108, True)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='FinInstrmAsstForTrf', type=FinancialInstrument108, min=0, max=None, mutex_group=None, array=True),
