...
class References79Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_TrptyCollTxInstrPrcgStsAdvcId", "_SctiesTxPstngRptId", "_SctiesSttlmTxGnrtnNtfctnId", "_IntraPosMvmntPstngRptId", "_PrtflTrfNtfctnId", "_TtlPrtflValtnRptId", "_IntraPosMvmntConfId", "_TrptyCollStsAdvcId", "_SctiesBalAcctgRptId", "_SctiesBalCtdyRptId", "_OthrMsgId", "_SctiesSttlmTxAllgmtRptId", "_SctiesSttlmTxAllgmtNtfctnTxId", "_SctiesFincgConfId", "_SctiesTxPdgRptId", "_SctiesSttlmTxConfId", "_TrptyCollAndXpsrRptId"]
	@property
