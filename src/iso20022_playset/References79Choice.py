...
class References79Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_SctiesSttlmTxGnrtnNtfctnId", "_TrptyCollTxInstrPrcgStsAdvcId", "_SctiesSttlmTxAllgmtRptId", "_PrtflTrfNtfctnId", "_SctiesBalCtdyRptId", "_SctiesTxPstngRptId", "_SctiesFincgConfId", "_SctiesSttlmTxConfId", "_TtlPrtflValtnRptId", "_IntraPosMvmntPstngRptId", "_IntraPosMvmntConfId", "_SctiesBalAcctgRptId", "_SctiesSttlmTxAllgmtNtfctnTxId", "_SctiesTxPdgRptId", "_TrptyCollAndXpsrRptId", "_TrptyCollStsAdvcId", "_OthrMsgId"]
	@property
