...
class References79Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrMsgId", "_SctiesSttlmTxConfId", "_SctiesFincgConfId", "_IntraPosMvmntPstngRptId", "_TrptyCollTxInstrPrcgStsAdvcId", "_TrptyCollAndXpsrRptId", "_SctiesTxPstngRptId", "_SctiesSttlmTxGnrtnNtfctnId", "_PrtflTrfNtfctnId", "_SctiesBalAcctgRptId", "_SctiesSttlmTxAllgmtRptId", "_SctiesSttlmTxAllgmtNtfctnTxId", "_SctiesTxPdgRptId", "_IntraPosMvmntConfId", "_TrptyCollStsAdvcId", "_SctiesBalCtdyRptId", "_TtlPrtflValtnRptId"]
	@property
	def OthrMsgId(self):
