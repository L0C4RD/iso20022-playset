...
class SecuritiesFinancingModificationInstruction002V08(base_types._BaseFieldType):
	...
	__slots__ = ["_TxTpAndModAddtlParams", "_SctiesFincgAddtlDtls", "_RcvgSttlmPties", "_OpngSttlmAmt", "_FinInstrmId", "_DlvrgSttlmPties", "_TradDtls", "_SttlmParams", "_QtyAndAcctDtls", "_SplmtryData"]
	@property
