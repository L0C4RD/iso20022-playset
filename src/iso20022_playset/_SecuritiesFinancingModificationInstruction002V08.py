...
class SecuritiesFinancingModificationInstruction002V08(base_types._BaseFieldType):
	...
	__slots__ = ["_OpngSttlmAmt", "_RcvgSttlmPties", "_TxTpAndModAddtlParams", "_TradDtls", "_SplmtryData", "_SctiesFincgAddtlDtls", "_DlvrgSttlmPties", "_SttlmParams", "_QtyAndAcctDtls", "_FinInstrmId"]
	@property
