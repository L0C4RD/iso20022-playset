...
from . import PendingStatus74Choice
...
class EventProcessingStatus7Choice(base_types._BaseFieldType):
	...
	@Pdg.setter
	def Pdg(self, value):
		self._Pdg = value if value is not None else base_types.UninitialisedField(self, 'Pdg', PendingStatus74Choice, False)

	@Pdg.deleter
	def Pdg(self):
		del self._Pdg
		self._Pdg = base_types.UninitialisedField(self, 'Pdg', PendingStatus74Choice, False)
