...
class Context23(base_types._BaseFieldType):
	...
	__slots__ = ["_EComrc", "_SctyChrtcs", "_PINNtryBpss", "_TempScrCardDataReusd", "_AuthntcnOutg", "_AddtlData", "_FnlAuthstn", "_CstmrCnsnt", "_DfrrdDlvry", "_PmtCrdntlMrchntRltsh", "_ICCFllbck", "_CrdhldrPres", "_CardDataNtryMd", "_QRCdPresntmntMd", "_EComrcData", "_OthrMrchntCtgy", "_NoShow", "_MOTOCd", "_EComrcIndApld", "_ReSubmissn", "_TxInitr", "_ICCFllbckRsnCd", "_TrnspndrInittd", "_SpltPmt", "_OthrQRCdPresntmntMd", "_DelydAuthstn", "_StorgLctn", "_PrtlShipmnt", "_Trnst", "_OthrCardDataNtryMd", "_CaptrDt", "_UattnddLvlCtgy", "_Attndd", "_MrchntCtgyCd", "_CrdhldrActvtd", "_DtAntcptd", "_MrchntCtgySpcfcData", "_OthrSctyChrtcs", "_PrtlApprvlSpprtd", "_MgntcStrpFllbck", "_Reauthstn", "_EComrcIndPropsd", "_PINPadInprtv", "_LatePresntmnt", "_DelydChrgs", "_OthrICCFllbckRsnCd", "_CardPres"]
	@property
	def EComrc(self):
		return self._EComrc
