...
class Context23(base_types._BaseFieldType):
	...
	__slots__ = ["_CardPres", "_CrdhldrActvtd", "_Attndd", "_ICCFllbckRsnCd", "_DelydChrgs", "_DtAntcptd", "_PmtCrdntlMrchntRltsh", "_EComrc", "_TrnspndrInittd", "_StorgLctn", "_OthrMrchntCtgy", "_PINPadInprtv", "_SpltPmt", "_EComrcIndPropsd", "_PrtlShipmnt", "_OthrICCFllbckRsnCd", "_EComrcData", "_FnlAuthstn", "_Reauthstn", "_ICCFllbck", "_Trnst", "_QRCdPresntmntMd", "_TempScrCardDataReusd", "_CardDataNtryMd", "_PrtlApprvlSpprtd", "_OthrQRCdPresntmntMd", "_CstmrCnsnt", "_UattnddLvlCtgy", "_CaptrDt", "_MrchntCtgyCd", "_MOTOCd", "_OthrSctyChrtcs", "_LatePresntmnt", "_AuthntcnOutg", "_DfrrdDlvry", "_OthrCardDataNtryMd", "_MgntcStrpFllbck", "_DelydAuthstn", "_NoShow", "_ReSubmissn", "_EComrcIndApld", "_PINNtryBpss", "_SctyChrtcs", "_MrchntCtgySpcfcData", "_CrdhldrPres", "_TxInitr", "_AddtlData"]
	@property
	def CardPres(self):
