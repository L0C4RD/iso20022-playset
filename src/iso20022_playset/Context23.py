...
class Context23(base_types._BaseFieldType):
	...
	__slots__ = ["_DelydChrgs", "_MgntcStrpFllbck", "_StorgLctn", "_QRCdPresntmntMd", "_DelydAuthstn", "_DtAntcptd", "_EComrcIndApld", "_CardPres", "_MrchntCtgyCd", "_ICCFllbckRsnCd", "_OthrICCFllbckRsnCd", "_Reauthstn", "_NoShow", "_LatePresntmnt", "_AuthntcnOutg", "_EComrcData", "_OthrCardDataNtryMd", "_DfrrdDlvry", "_EComrcIndPropsd", "_OthrMrchntCtgy", "_PrtlShipmnt", "_SpltPmt", "_AddtlData", "_FnlAuthstn", "_TempScrCardDataReusd", "_ICCFllbck", "_PrtlApprvlSpprtd", "_CaptrDt", "_TrnspndrInittd", "_CardDataNtryMd", "_Trnst", "_CrdhldrPres", "_PINPadInprtv", "_Attndd", "_EComrc", "_CrdhldrActvtd", "_MOTOCd", "_SctyChrtcs", "_MrchntCtgySpcfcData", "_OthrSctyChrtcs", "_PINNtryBpss", "_OthrQRCdPresntmntMd", "_UattnddLvlCtgy", "_TxInitr", "_CstmrCnsnt", "_ReSubmissn", "_PmtCrdntlMrchntRltsh"]
	@property
	def DelydChrgs(self):
