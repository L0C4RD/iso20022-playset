...
class AccountClosingAdditionalInformationRequestV04(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctId", "_AcctSvcrId", "_BalTrfAcct", "_DgtlSgntr", "_Fr", "_OrgId", "_Refs", "_SplmtryData", "_TrfAcctSvcrId"]
	@property
	def AcctId(self):
		return self._AcctId
	...
	def AcctId(self, value):
		self._AcctId = value if value is not None else base_types.UninitialisedField(self, 'AcctId', AccountForAction1, False)

	@AcctId.deleter
	def AcctId(self):
		del self._AcctId
		self._AcctId = base_types.UninitialisedField(self, 'AcctId', AccountForAction1, False)
