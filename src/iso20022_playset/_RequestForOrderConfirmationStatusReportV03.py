...
from . import MessageAndBusinessReference15
from . import MessageIdentification1

class RequestForOrderConfirmationStatusReportV03(base_types._BaseFieldType):
	...
	def ReqDtls(self, value):
		self._ReqDtls = value if value is not None else base_types.UninitialisedField(self, 'ReqDtls', MessageAndBusinessReference15, True)

	@ReqDtls.deleter
	def ReqDtls(self):
		del self._ReqDtls
		self._ReqDtls = base_types.UninitialisedField(self, 'ReqDtls', MessageAndBusinessReference15, True)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='ReqDtls', type=MessageAndBusinessReference15, min=1, max=None, mutex_group=None, array=True),
