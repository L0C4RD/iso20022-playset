...
class OriginalTransactionReference44(base_types._BaseFieldType):
	...
	__slots__ = ["_PmtMtd", "_Purp", "_DbtrAcct", "_UndrlygCstmrCdtTrf", "_ReqdExctnDt", "_DbtrAgtAcct", "_UltmtCdtr", "_UltmtDbtr", "_Cdtr", "_SttlmInf", "_RmtInf", "_UndrlygFICdtTrf", "_DbtrAgt", "_CdtrSchmeId", "_IntrBkSttlmAmt", "_IntrBkSttlmDt", "_ReqdColltnDt", "_PmtTpInf", "_CdtrAcct", "_Amt", "_CdtrAgt", "_CdtrAgtAcct", "_MndtRltdInf", "_Dbtr"]
	@property
	def PmtMtd(self):
		return self._PmtMtd
