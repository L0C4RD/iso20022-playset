...
class Cheque10(base_types._BaseFieldType):
	...
	def DrweeId(self, value):
		self._DrweeId = value if value is not None else base_types.UninitialisedField(self, 'DrweeId', FinancialInstitutionIdentification17, False)

	@DrweeId.deleter
	def DrweeId(self):
		del self._DrweeId
		self._DrweeId = base_types.UninitialisedField(self, 'DrweeId', FinancialInstitutionIdentification17, False)
