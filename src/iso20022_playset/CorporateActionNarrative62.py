...
class CorporateActionNarrative62(base_types._BaseFieldType):
	...
	__slots__ = ["_PrcgTxtForNxtIntrmy", "_InfConds", "_NrrtvVrsn", "_TaxtnConds", "_CertfctnBrkdwn", "_PtyCtctNrrtv", "_InfToCmplyWth", "_AddtlTxt", "_Dsclmr", "_RegnDtls", "_BsktOrIndxInf"]
	@property
