...
class SecuritiesCollateral13(base_types._BaseFieldType):
	...
	__slots__ = ["_AsstNb", "_MktVal", "_ValDt", "_SctyId", "_SfkpgAcct", "_LtdCvrgInd", "_CollOwnrsh", "_Qty", "_MtrtyDt", "_Hrcut", "_BlckChainAdrOrWllt", "_BlckdQty", "_SfkpgPlc", "_CollVal", "_Pric"]
	@property
	def AsstNb(self):
		return self._AsstNb
