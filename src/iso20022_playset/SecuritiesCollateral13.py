...
class SecuritiesCollateral13(base_types._BaseFieldType):
	...
	__slots__ = ["_CollOwnrsh", "_SfkpgPlc", "_SctyId", "_MtrtyDt", "_LtdCvrgInd", "_Pric", "_Hrcut", "_AsstNb", "_Qty", "_ValDt", "_CollVal", "_BlckChainAdrOrWllt", "_BlckdQty", "_MktVal", "_SfkpgAcct"]
	@property
	def CollOwnrsh(self):
