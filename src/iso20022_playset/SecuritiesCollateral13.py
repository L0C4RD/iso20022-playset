...
class SecuritiesCollateral13(base_types._BaseFieldType):
	...
	__slots__ = ["_AsstNb", "_SfkpgAcct", "_BlckChainAdrOrWllt", "_Hrcut", "_Pric", "_CollOwnrsh", "_CollVal", "_SctyId", "_MtrtyDt", "_Qty", "_SfkpgPlc", "_LtdCvrgInd", "_MktVal", "_BlckdQty", "_ValDt"]
	@property
	def AsstNb(self):
		return self._AsstNb
