...
class SecuritiesCollateral13(base_types._BaseFieldType):
	...
	__slots__ = ["_SctyId", "_MtrtyDt", "_Qty", "_ValDt", "_BlckChainAdrOrWllt", "_SfkpgPlc", "_AsstNb", "_Pric", "_SfkpgAcct", "_MktVal", "_BlckdQty", "_CollVal", "_Hrcut", "_CollOwnrsh", "_LtdCvrgInd"]
	@property
	def SctyId(self):
		return self._SctyId
