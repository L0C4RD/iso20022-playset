...
class SecuritiesCollateral13(base_types._BaseFieldType):
	...
	__slots__ = ["_MktVal", "_SfkpgPlc", "_LtdCvrgInd", "_CollOwnrsh", "_BlckdQty", "_SctyId", "_Qty", "_Pric", "_AsstNb", "_BlckChainAdrOrWllt", "_CollVal", "_SfkpgAcct", "_Hrcut", "_MtrtyDt", "_ValDt"]
	@property
	def MktVal(self):
		return self._MktVal
