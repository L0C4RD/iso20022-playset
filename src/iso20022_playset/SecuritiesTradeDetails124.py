...
class SecuritiesTradeDetails124(base_types._BaseFieldType):
	...
	__slots__ = ["_PlcOfClr", "_TradDt", "_FctvSttlmDt", "_DealPric", "_NbOfDaysAcrd", "_TradTxCond", "_InvstrCpcty", "_TradOrgtrRole", "_PlcOfTrad", "_SttlmDt", "_FxAddtlDtls", "_SttlmInstrPrcgAddtlDtls", "_Rptg"]
	@property
	def PlcOfClr(self):
