...
from . import DateOrDateTimePeriod4Choice
from . import PercentageRate
from . import PriceValue5
from . import PriceValueChange1

class StatisticsByUserDefinedTimePeriod3(base_types._BaseFieldType):
	...
	@Prd.setter
	def Prd(self, value):
		self._Prd = value if value is not None else base_types.UninitialisedField(self, 'Prd', DateOrDateTimePeriod4Choice, False)

	@Prd.deleter
	def Prd(self):
		del self._Prd
		self._Prd = base_types.UninitialisedField(self, 'Prd', DateOrDateTimePeriod4Choice, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='Prd', type=DateOrDateTimePeriod4Choice, min=1, max=1, mutex_group=None, array=False),
