...
class TradeTransaction50(base_types._BaseFieldType):
	...
	__slots__ = ["_NtnlQty", "_TxPric", "_IntrstRate", "_TradClr", "_Cdt", "_TradConf", "_Optn", "_XprtnDt", "_ScndryTxId", "_DerivEvt", "_NrgySpcfcAttrbts", "_EarlyTermntnDt", "_Cmmdty", "_MrrrOrTrggrTx", "_BlckTradElctn", "_DlvryTp", "_Ccy", "_FctvDt", "_LrgNtnlOffFcltyElctn", "_Packg", "_Qty", "_RptTrckgNb", "_PrrTxId", "_TxId", "_TradAllcnSts", "_CollPrtflCd", "_ExctnTmStmp", "_PstTradRskRdctnFlg", "_PltfmIdr", "_OthrPmt", "_MstrAgrmt", "_PstTradRskRdctnEvt", "_Cmprssn", "_NtnlAmt", "_SttlmDt", "_SbsqntTxId", "_NonStdsdTerm"]
	@property
	def NtnlQty(self):
