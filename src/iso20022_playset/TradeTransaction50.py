...
class TradeTransaction50(base_types._BaseFieldType):
	...
	__slots__ = ["_PrrTxId", "_MrrrOrTrggrTx", "_Qty", "_SbsqntTxId", "_ScndryTxId", "_BlckTradElctn", "_Cdt", "_SttlmDt", "_CollPrtflCd", "_PstTradRskRdctnEvt", "_LrgNtnlOffFcltyElctn", "_NtnlAmt", "_TradConf", "_TradAllcnSts", "_EarlyTermntnDt", "_ExctnTmStmp", "_FctvDt", "_DerivEvt", "_XprtnDt", "_PltfmIdr", "_NonStdsdTerm", "_Cmprssn", "_Ccy", "_NtnlQty", "_PstTradRskRdctnFlg", "_DlvryTp", "_Cmmdty", "_OthrPmt", "_MstrAgrmt", "_Optn", "_TradClr", "_IntrstRate", "_Packg", "_TxId", "_TxPric", "_RptTrckgNb", "_NrgySpcfcAttrbts"]
	@property
	def PrrTxId(self):
