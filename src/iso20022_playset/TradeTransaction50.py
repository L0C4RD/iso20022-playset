...
class TradeTransaction50(base_types._BaseFieldType):
	...
	__slots__ = ["_ExctnTmStmp", "_MstrAgrmt", "_SbsqntTxId", "_NrgySpcfcAttrbts", "_Packg", "_IntrstRate", "_Ccy", "_OthrPmt", "_Cdt", "_TxId", "_TxPric", "_NtnlAmt", "_MrrrOrTrggrTx", "_Qty", "_PltfmIdr", "_NonStdsdTerm", "_DerivEvt", "_NtnlQty", "_TradAllcnSts", "_Cmprssn", "_DlvryTp", "_EarlyTermntnDt", "_PstTradRskRdctnEvt", "_BlckTradElctn", "_PstTradRskRdctnFlg", "_TradClr", "_LrgNtnlOffFcltyElctn", "_Cmmdty", "_SttlmDt", "_PrrTxId", "_XprtnDt", "_Optn", "_ScndryTxId", "_TradConf", "_CollPrtflCd", "_RptTrckgNb", "_FctvDt"]
	@property
