...
class MarginCall3(base_types._BaseFieldType):
	...
	__slots__ = ["_RqrmntDtlsDueToA", "_RqrmntDtlsDueToB", "_XpctdCollDueToA", "_BlckChainAdrOrWllt", "_MrgnDtlDueToA", "_MrgnCallRslt", "_XpctdCollDueToB", "_CollAcctId", "_MrgnDtlDueToB"]
	@property
