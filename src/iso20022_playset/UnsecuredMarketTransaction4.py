...
class UnsecuredMarketTransaction4(base_types._BaseFieldType):
	...
	__slots__ = ["_TxNmnlAmt", "_BrnchId", "_FltgRateNote", "_TxTp", "_CtrPtyPrtryTxId", "_NvtnSts", "_MtrtyDt", "_DealRate", "_SttlmDt", "_InstrmTp", "_DealPric", "_RltdPrtryTxId", "_PrtryTxId", "_SplmtryData", "_UnqTxIdr", "_TradDt", "_CtrPtyId", "_CallPutOptn", "_RptdTxSts", "_BrkrdDeal", "_RateTp"]
	@property
	def TxNmnlAmt(self):
