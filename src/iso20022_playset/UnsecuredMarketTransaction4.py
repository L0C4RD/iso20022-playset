...
class UnsecuredMarketTransaction4(base_types._BaseFieldType):
	...
	__slots__ = ["_TradDt", "_UnqTxIdr", "_RltdPrtryTxId", "_TxTp", "_InstrmTp", "_NvtnSts", "_BrkrdDeal", "_BrnchId", "_RptdTxSts", "_DealPric", "_PrtryTxId", "_RateTp", "_SttlmDt", "_CallPutOptn", "_DealRate", "_FltgRateNote", "_CtrPtyId", "_SplmtryData", "_CtrPtyPrtryTxId", "_TxNmnlAmt", "_MtrtyDt"]
	@property
	def TradDt(self):
		return self._TradDt
