...
class InstrumentLeg7(base_types._BaseFieldType):
	...
	__slots__ = ["_LegValtnRate", "_LegSttlmCcy", "_LegValDt", "_LegClctdCtrPtyCcyLastQty", "_LegSctyId", "_LegFwdPts", "_LegLastPric", "_LegSymb", "_LegRskAmt", "_LegSttlmTp", "_LegSttlmDt", "_LegCcy", "_LegSd", "_LegOrdrQty"]
	@property
