...
class InstrumentLeg7(base_types._BaseFieldType):
	...
	__slots__ = ["_LegSttlmCcy", "_LegCcy", "_LegFwdPts", "_LegRskAmt", "_LegValtnRate", "_LegSymb", "_LegOrdrQty", "_LegSctyId", "_LegSd", "_LegSttlmTp", "_LegValDt", "_LegSttlmDt", "_LegClctdCtrPtyCcyLastQty", "_LegLastPric"]
	@property
