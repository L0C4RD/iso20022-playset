...
class InstrumentLeg7(base_types._BaseFieldType):
	...
	__slots__ = ["_LegSctyId", "_LegClctdCtrPtyCcyLastQty", "_LegSd", "_LegValtnRate", "_LegSttlmCcy", "_LegCcy", "_LegFwdPts", "_LegValDt", "_LegSttlmDt", "_LegRskAmt", "_LegOrdrQty", "_LegLastPric", "_LegSymb", "_LegSttlmTp"]
	@property
	def LegSctyId(self):
