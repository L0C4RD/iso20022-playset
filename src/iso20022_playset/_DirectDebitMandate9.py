...
class DirectDebitMandate9(base_types._BaseFieldType):
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='CdtrAgt', type=FinancialInstitutionIdentification17, min=0, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='DbtrAcct', type=AccountIdentificationAndName8, min=1, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='DbtrAgt', type=FinancialInstitutionIdentification17, min=1, max=1, mutex_group=None, array=False),
