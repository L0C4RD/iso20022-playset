...
from . import SubscriptionExecution16
from . import YesNoIndicator

class SubscriptionMultipleExecution7(base_types._BaseFieldType):
	...
	def IndvExctnDtls(self, value):
		self._IndvExctnDtls = value if value is not None else base_types.UninitialisedField(self, 'IndvExctnDtls', SubscriptionExecution16, True)

	@IndvExctnDtls.deleter
	def IndvExctnDtls(self):
		del self._IndvExctnDtls
		self._IndvExctnDtls = base_types.UninitialisedField(self, 'IndvExctnDtls', SubscriptionExecution16, True)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='IndvExctnDtls', type=SubscriptionExecution16, min=1, max=None, mutex_group=None, array=True),
