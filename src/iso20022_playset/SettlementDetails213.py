...
class SettlementDetails213(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmInstrGnrtn", "_ElgblForColl", "_FxStgInstr", "_RpTp", "_NetgElgblty", "_TaxCpcty", "_CcyToBuyOrSell", "_CshClrSys", "_HldInd", "_ModCxlAllwd", "_Regn", "_MktClntSd", "_RtrLeg", "_Prty", "_Trckg", "_XpsrTp", "_StmpDtyTaxBsis", "_LttrOfGrnt", "_SctiesRTGS", "_CCPElgblty", "_StmpDtyInd", "_LglRstrctns", "_SttlmTxTp", "_PrtlSttlmInd", "_SttlmSysMtd", "_SttlmTxCond", "_AutomtcBrrwg", "_BnfclOwnrsh", "_SttlgCpcty", "_BlckTrad"]
	@property
