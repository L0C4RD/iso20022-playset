...
class SettlementDetails213(base_types._BaseFieldType):
	...
	__slots__ = ["_RtrLeg", "_CcyToBuyOrSell", "_CshClrSys", "_CCPElgblty", "_SttlmInstrGnrtn", "_SttlmTxTp", "_SctiesRTGS", "_ModCxlAllwd", "_StmpDtyInd", "_SttlmTxCond", "_XpsrTp", "_NetgElgblty", "_AutomtcBrrwg", "_TaxCpcty", "_BlckTrad", "_SttlmSysMtd", "_SttlgCpcty", "_HldInd", "_PrtlSttlmInd", "_LglRstrctns", "_LttrOfGrnt", "_StmpDtyTaxBsis", "_Trckg", "_ElgblForColl", "_MktClntSd", "_Regn", "_RpTp", "_BnfclOwnrsh", "_FxStgInstr", "_Prty"]
	@property
	def RtrLeg(self):
		return self._RtrLeg
	...
	def SttlmInstrGnrtn(self, value):
		self._SttlmInstrGnrtn = value if type(value) != base_types.auto else self.make_default("SttlmInstrGnrtn")
	...
	def SttlmTxTp(self, value):
		self._SttlmTxTp = value if type(value) != base_types.auto else self.make_default("SttlmTxTp")
