...
class SettlementDetails213(base_types._BaseFieldType):
	...
	__slots__ = ["_XpsrTp", "_SttlgCpcty", "_Trckg", "_SctiesRTGS", "_SttlmInstrGnrtn", "_SttlmTxCond", "_NetgElgblty", "_RpTp", "_MktClntSd", "_Regn", "_AutomtcBrrwg", "_CcyToBuyOrSell", "_PrtlSttlmInd", "_CCPElgblty", "_BlckTrad", "_SttlmTxTp", "_StmpDtyTaxBsis", "_StmpDtyInd", "_LttrOfGrnt", "_TaxCpcty", "_BnfclOwnrsh", "_HldInd", "_SttlmSysMtd", "_Prty", "_LglRstrctns", "_FxStgInstr", "_ElgblForColl", "_CshClrSys", "_ModCxlAllwd", "_RtrLeg"]
	@property
	def XpsrTp(self):
		return self._XpsrTp
