...
class ProcessingCharacteristics9(base_types._BaseFieldType):
	...
	__slots__ = ["_DealConfTm", "_DealConfTmFrame", "_LtdPrd", "_UnitsInd", "_DealgCcyAccptd", "_MainFndOrdrDskLctn", "_AmtInd", "_DealgFrqcyDesc", "_DealgCutOffTm", "_AddtlInf", "_DealgFrqcy", "_SwtchAuthstn", "_SttlmCycl", "_Rndg", "_DealgCutOffTmFrame"]
	@property
	def DealConfTm(self):
