...
class ProcessingCharacteristics9(base_types._BaseFieldType):
	...
	__slots__ = ["_MainFndOrdrDskLctn", "_UnitsInd", "_DealgFrqcy", "_DealConfTmFrame", "_LtdPrd", "_Rndg", "_DealgCcyAccptd", "_SwtchAuthstn", "_DealgCutOffTmFrame", "_DealConfTm", "_AddtlInf", "_SttlmCycl", "_AmtInd", "_DealgFrqcyDesc", "_DealgCutOffTm"]
	@property
