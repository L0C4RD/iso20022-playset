...
from . import PriceValueType12Code
...
class YieldedOrValueType2Choice(base_types._BaseFieldType):
	...
	def ValTp(self, value):
		self._ValTp = value if value is not None else base_types.UninitialisedField(self, 'ValTp', PriceValueType12Code, False)

	@ValTp.deleter
	def ValTp(self):
		del self._ValTp
		self._ValTp = base_types.UninitialisedField(self, 'ValTp', PriceValueType12Code, False)
