...
class PaymentTransaction177(base_types._BaseFieldType):
	...
	def CdtSttlmKey(self, value):
		self._CdtSttlmKey = value if value is not None else base_types.UninitialisedField(self, 'CdtSttlmKey', SHA256SignatureText, False)

	@CdtSttlmKey.deleter
	def CdtSttlmKey(self):
		del self._CdtSttlmKey
		self._CdtSttlmKey = base_types.UninitialisedField(self, 'CdtSttlmKey', SHA256SignatureText, False)
