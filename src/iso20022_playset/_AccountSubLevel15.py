...
class AccountSubLevel15(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctId", "_AcctOwnr", "_AcctSubLvl6", "_AcctSubLvl6Diff", "_AcctSvcr", "_BalDtls", "_BnfclOwnr", "_SplmtryData"]
	@property
	def AcctId(self):
		return self._AcctId
	...
	def AcctSubLvl6(self, value):
		self._AcctSubLvl6 = value if value is not None else base_types.UninitialisedField(self, 'AcctSubLvl6', AccountSubLevel16, True)

	@AcctSubLvl6.deleter
	def AcctSubLvl6(self):
		del self._AcctSubLvl6
		self._AcctSubLvl6 = base_types.UninitialisedField(self, 'AcctSubLvl6', AccountSubLevel16, True)
	...
	def AcctSubLvl6Diff(self, value):
		self._AcctSubLvl6Diff = value if value is not None else base_types.UninitialisedField(self, 'AcctSubLvl6Diff', AggregateHoldingBalance2, True)

	@AcctSubLvl6Diff.deleter
	def AcctSubLvl6Diff(self):
		del self._AcctSubLvl6Diff
		self._AcctSubLvl6Diff = base_types.UninitialisedField(self, 'AcctSubLvl6Diff', AggregateHoldingBalance2, True)
