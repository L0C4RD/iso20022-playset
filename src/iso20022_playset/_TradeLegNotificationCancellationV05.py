...
class TradeLegNotificationCancellationV05(base_types._BaseFieldType):
	...
	__slots__ = ["_ClrAcct", "_ClrDtls", "_ClrMmb", "_CxlRsn", "_DlvryAcct", "_NonClrMmb", "_SplmtryData", "_SttlmDtls", "_TradLegDtls"]
	@property
	def ClrAcct(self):
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='CxlRsn', type=CancellationReason36Choice, min=0, max=1, mutex_group=None, array=False),
