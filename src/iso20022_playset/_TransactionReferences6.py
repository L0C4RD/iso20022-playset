...
class TransactionReferences6(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctSvcrTxId", "_AcctOwnrTxId", "_Prtry", "_EndToEndId", "_PmtInfId", "_AcctSvcrRef", "_MktInfrstrctrTxId", "_TxId", "_UETR", "_ChqNb", "_PrcgId", "_MsgId", "_InstrId", "_MndtId", "_ClrSysRef"]
	@property
