...
class TransactionReferences6(base_types._BaseFieldType):
	...
	__slots__ = ["_InstrId", "_AcctSvcrTxId", "_AcctSvcrRef", "_MndtId", "_ClrSysRef", "_UETR", "_AcctOwnrTxId", "_ChqNb", "_MktInfrstrctrTxId", "_PmtInfId", "_Prtry", "_TxId", "_EndToEndId", "_PrcgId", "_MsgId"]
	@property
	def InstrId(self):
