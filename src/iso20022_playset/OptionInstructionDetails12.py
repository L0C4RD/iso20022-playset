...
from .RestrictedFINMax50Text import RestrictedFINMax50Text
from .Max3NumericText import Max3NumericText
from .InstructionProcessingStatus57Choice import InstructionProcessingStatus57Choice
from .ProtectTransactionType2Code import ProtectTransactionType2Code
from .PriceFormat82Choice import PriceFormat82Choice
...
class OptionInstructionDetails12(base_types._BaseFieldType):
	...
	__slots__ = ["_InstrDt", "_InstrSts", "_InstrId", "_InstrQty", "_BidPric", "_InstrNrrtv", "_CstmrRef", "_CondlQty", "_InstrSeqNb", "_PrtctInd", "_CoverPrtctDt", "_PrtctDt"]
	@property
	def InstrDt(self):
