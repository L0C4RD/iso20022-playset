...
class SecuritiesMovement8(base_types._BaseFieldType):
	...
	__slots__ = ["_MvmntSts", "_SctiesQty", "_ClntSctiesMvmntId", "_CollMvmnt", "_FinInstrmId", "_TrptyAgtSvcPrvdrSctiesMvmntId", "_SctiesMvmntTp", "_MrgndVal", "_SctiesMvmntsApprvd", "_BlckChainAdrOrWllt", "_PosTp", "_SfkpgAcct"]
	@property
	def MvmntSts(self):
