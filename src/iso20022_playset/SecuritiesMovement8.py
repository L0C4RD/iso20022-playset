...
class SecuritiesMovement8(base_types._BaseFieldType):
	...
	__slots__ = ["_MvmntSts", "_ClntSctiesMvmntId", "_PosTp", "_TrptyAgtSvcPrvdrSctiesMvmntId", "_FinInstrmId", "_SctiesQty", "_SfkpgAcct", "_MrgndVal", "_BlckChainAdrOrWllt", "_SctiesMvmntsApprvd", "_SctiesMvmntTp", "_CollMvmnt"]
	@property
	def MvmntSts(self):
