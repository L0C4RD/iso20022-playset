...
from .SecuritiesMovementStatus1Choice import SecuritiesMovementStatus1Choice
...
class SecuritiesMovement8(base_types._BaseFieldType):
	...
	__slots__ = ["_SctiesMvmntsApprvd", "_SfkpgAcct", "_BlckChainAdrOrWllt", "_PosTp", "_SctiesQty", "_SctiesMvmntTp", "_MrgndVal", "_FinInstrmId", "_ClntSctiesMvmntId", "_MvmntSts", "_TrptyAgtSvcPrvdrSctiesMvmntId", "_CollMvmnt"]
	@property
	...
	def MrgndVal(self, value):
		self._MrgndVal = value if type(value) != auto else self.make_default("MrgndVal")
