...
from . import PaymentInstruction44
...
class CustomerCreditTransferInitiationV12(base_types._BaseFieldType):
	...
	def PmtInf(self, value):
		self._PmtInf = value if value is not None else base_types.UninitialisedField(self, 'PmtInf', PaymentInstruction44, True)

	@PmtInf.deleter
	def PmtInf(self):
		del self._PmtInf
		self._PmtInf = base_types.UninitialisedField(self, 'PmtInf', PaymentInstruction44, True)
