...
class EstimatedFundCashForecast5(base_types._BaseFieldType):
	...
	__slots__ = ["_InvstmtCcy", "_EstmtdTtlUnitsNb", "_EstmtdPctgOfShrClssTtlNAV", "_PrvsTtlUnitsNb", "_FinInstrmDtls", "_BrkdwnByPty", "_BrkdwnByCcy", "_Id", "_Pric", "_EstmtdNetCshFcstDtls", "_EstmtdTtlNAVChngRate", "_PrvsTtlNAV", "_PrvsTradDtTm", "_CcySts", "_EstmtdTtlNAV", "_BrkdwnByCtry", "_FXRate", "_BrkdwnByUsrDfndParam", "_XcptnlNetCshFlowInd", "_TradDtTm"]
	@property
	def InvstmtCcy(self):
