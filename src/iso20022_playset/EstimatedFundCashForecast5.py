...
class EstimatedFundCashForecast5(base_types._BaseFieldType):
	...
	__slots__ = ["_Id", "_PrvsTtlUnitsNb", "_BrkdwnByPty", "_PrvsTradDtTm", "_TradDtTm", "_FXRate", "_FinInstrmDtls", "_EstmtdTtlNAVChngRate", "_EstmtdTtlNAV", "_BrkdwnByUsrDfndParam", "_BrkdwnByCcy", "_EstmtdTtlUnitsNb", "_XcptnlNetCshFlowInd", "_Pric", "_EstmtdNetCshFcstDtls", "_EstmtdPctgOfShrClssTtlNAV", "_CcySts", "_InvstmtCcy", "_PrvsTtlNAV", "_BrkdwnByCtry"]
	@property
	def Id(self):
		return self._Id
