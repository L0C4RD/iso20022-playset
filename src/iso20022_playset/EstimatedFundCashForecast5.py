...
class EstimatedFundCashForecast5(base_types._BaseFieldType):
	...
	__slots__ = ["_EstmtdTtlNAVChngRate", "_EstmtdPctgOfShrClssTtlNAV", "_FXRate", "_InvstmtCcy", "_BrkdwnByCtry", "_BrkdwnByUsrDfndParam", "_FinInstrmDtls", "_PrvsTradDtTm", "_BrkdwnByCcy", "_BrkdwnByPty", "_Pric", "_PrvsTtlNAV", "_Id", "_EstmtdNetCshFcstDtls", "_EstmtdTtlNAV", "_TradDtTm", "_XcptnlNetCshFlowInd", "_CcySts", "_PrvsTtlUnitsNb", "_EstmtdTtlUnitsNb"]
	@property
