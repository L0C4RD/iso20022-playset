...
class QuantityAndAccount106(base_types._BaseFieldType):

	__slots__ = ["_SttlmQty", "_DnmtnChc", "_AcctOwnr", "_CshAcct", "_SfkpgAcct", "_QtyBrkdwn", "_BlckChainAdrOrWllt", "_SfkpgPlc"]
	@property
	def SttlmQty(self):
