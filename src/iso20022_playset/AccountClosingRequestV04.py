...
class AccountClosingRequestV04(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrctDts", "_AcctId", "_DgtlSgntr", "_SplmtryData", "_Fr", "_BalTrfAcct", "_Refs", "_AcctSvcrId", "_OrgId", "_TrfAcctSvcrId"]
	@property
	def CtrctDts(self):
