...
class LoanData145(base_types._BaseFieldType):
	...
	__slots__ = ["_EvtDt", "_RbtRate", "_DlvryByVal", "_TradgVn", "_TermntnDt", "_GnlColl", "_AsstTp", "_ValDt", "_ClrSts", "_ExctnDtTm", "_CollDlvryMtd", "_UnqTradIdr", "_LndgFee", "_Term", "_LnVal", "_MstrAgrmt"]
	@property
	def EvtDt(self):
		return self._EvtDt
