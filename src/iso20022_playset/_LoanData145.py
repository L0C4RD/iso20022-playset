...
class LoanData145(base_types._BaseFieldType):
	...
	__slots__ = ["_ValDt", "_EvtDt", "_ExctnDtTm", "_ClrSts", "_TermntnDt", "_TradgVn", "_LndgFee", "_Term", "_RbtRate", "_DlvryByVal", "_MstrAgrmt", "_CollDlvryMtd", "_AsstTp", "_GnlColl", "_LnVal", "_UnqTradIdr"]
	@property
	def ValDt(self):
		return self._ValDt
