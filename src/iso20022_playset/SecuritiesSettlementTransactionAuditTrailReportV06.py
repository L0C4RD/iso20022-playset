...
from .TransactionIdentifications54 import TransactionIdentifications54
from .PartyIdentification144 import PartyIdentification144
from .StatusTrail12 import StatusTrail12
...
class SecuritiesSettlementTransactionAuditTrailReportV06(base_types._BaseFieldType):
	...
	__slots__ = ["_SfkpgAcct", "_TxId", "_QryRef", "_Pgntn", "_StsTrl", "_BlckChainAdrOrWllt", "_AcctOwnr"]
	@property
	def SfkpgAcct(self):
