...
class ManagementPlanReplacementV13(base_types._BaseFieldType):
	...
	def MgmtPlan(self, value):
		self._MgmtPlan = value if value is not None else base_types.UninitialisedField(self, 'MgmtPlan', ManagementPlan13, False)

	@MgmtPlan.deleter
	def MgmtPlan(self):
		del self._MgmtPlan
		self._MgmtPlan = base_types.UninitialisedField(self, 'MgmtPlan', ManagementPlan13, False)
