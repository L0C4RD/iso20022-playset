...
from . import SafekeepingPlaceTypeAndAnyBICIdentifier3
...
class SafekeepingPlaceFormat40Choice(base_types._BaseFieldType):
	...
	def TpAndId(self, value):
		self._TpAndId = value if value is not None else base_types.UninitialisedField(self, 'TpAndId', SafekeepingPlaceTypeAndAnyBICIdentifier3, False)

	@TpAndId.deleter
	def TpAndId(self):
		del self._TpAndId
		self._TpAndId = base_types.UninitialisedField(self, 'TpAndId', SafekeepingPlaceTypeAndAnyBICIdentifier3, False)
