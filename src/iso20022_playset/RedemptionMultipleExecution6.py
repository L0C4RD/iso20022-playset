...
class RedemptionMultipleExecution6(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlSttlmAmt", "_OrdrDtTm", "_RcvdDtTm", "_InvstmtAcctDtls", "_PlcOfTrad", "_IndvExctnDtls", "_BlkCshSttlmDtls", "_ReqdFutrTradDt", "_AmdmntInd", "_MstrRef", "_BnfcryDtls", "_CxlRght"]
	@property
