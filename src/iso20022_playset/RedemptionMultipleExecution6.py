...
class RedemptionMultipleExecution6(base_types._BaseFieldType):
	...
	__slots__ = ["_CxlRght", "_IndvExctnDtls", "_InvstmtAcctDtls", "_TtlSttlmAmt", "_AmdmntInd", "_BlkCshSttlmDtls", "_BnfcryDtls", "_ReqdFutrTradDt", "_OrdrDtTm", "_MstrRef", "_RcvdDtTm", "_PlcOfTrad"]
	@property
	def CxlRght(self):
