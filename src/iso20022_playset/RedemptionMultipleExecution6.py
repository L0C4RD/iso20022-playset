...
class RedemptionMultipleExecution6(base_types._BaseFieldType):
	...
	__slots__ = ["_BnfcryDtls", "_OrdrDtTm", "_TtlSttlmAmt", "_ReqdFutrTradDt", "_AmdmntInd", "_CxlRght", "_RcvdDtTm", "_PlcOfTrad", "_BlkCshSttlmDtls", "_MstrRef", "_InvstmtAcctDtls", "_IndvExctnDtls"]
	@property
	def BnfcryDtls(self):
