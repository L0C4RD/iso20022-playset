...
from . import OriginalPaymentInstruction49
...
class UnderlyingTransaction33(base_types._BaseFieldType):
	...
	def OrgnlPmtInfAndCxl(self, value):
		self._OrgnlPmtInfAndCxl = value if value is not None else base_types.UninitialisedField(self, 'OrgnlPmtInfAndCxl', OriginalPaymentInstruction49, True)

	@OrgnlPmtInfAndCxl.deleter
	def OrgnlPmtInfAndCxl(self):
		del self._OrgnlPmtInfAndCxl
		self._OrgnlPmtInfAndCxl = base_types.UninitialisedField(self, 'OrgnlPmtInfAndCxl', OriginalPaymentInstruction49, True)
