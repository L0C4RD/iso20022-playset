...
class TransactionDetails157(base_types._BaseFieldType):
	...
	__slots__ = ["_Invstr", "_SttlmAmt", "_Pmt", "_TradDt", "_SctiesMvmntTp", "_DlvrgSttlmPties", "_SfkpgAcct", "_BlckChainAdrOrWllt", "_SttlmQty", "_RcvgSttlmPties", "_SttlmDt", "_FinInstrmId"]
	@property
	def Invstr(self):
		return self._Invstr
