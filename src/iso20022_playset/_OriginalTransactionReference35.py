...
from . import ISODate
from . import MandateRelatedData2Choice
...
class OriginalTransactionReference35(base_types._BaseFieldType):
	...
	def MndtRltdInf(self, value):
		self._MndtRltdInf = value if value is not None else base_types.UninitialisedField(self, 'MndtRltdInf', MandateRelatedData2Choice, False)

	@MndtRltdInf.deleter
	def MndtRltdInf(self):
		del self._MndtRltdInf
		self._MndtRltdInf = base_types.UninitialisedField(self, 'MndtRltdInf', MandateRelatedData2Choice, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='MndtRltdInf', type=MandateRelatedData2Choice, min=0, max=1, mutex_group=None, array=False),
