...
class AccountSubLevel13(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctSvcr", "_BnfclOwnr", "_AcctSubLvl4", "_SplmtryData", "_AcctOwnr", "_BalDtls", "_AcctId", "_AcctSubLvl4Diff"]
	@property
	def AcctSvcr(self):
	...
	def AcctSubLvl4(self, value):
		self._AcctSubLvl4 = value if type(value) != base_types.auto else self.make_default("AcctSubLvl4")
