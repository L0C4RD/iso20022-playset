...
from .PaymentInstrument20 import PaymentInstrument20
...
from .Quantity50 import Quantity50
from .Conversion3 import Conversion3
...
class FinancialInstrument105(base_types._BaseFieldType):
	...
	__slots__ = ["_TrfCcy", "_FctvTrfDt", "_ClntRef", "_PmtDtls", "_SttlmPtiesDtls", "_TtlBookVal", "_Instrm", "_Qty", "_LatstValtn", "_IntrmyInf", "_Convs", "_UnitsDtls", "_Trfr", "_ReqdTradDt", "_TaxValtnPt", "_TrfTp", "_FctvSttlmDt", "_OrgnlCost", "_AddtlInf", "_NotAvlbl", "_BizFlowTp", "_AddtlAsst", "_TrfRsltsInChngOfBnfclOwnr", "_TrfeeAcct", "_LineId", "_AvrgAcqstnPric", "_AsstsHeldInOwnNm", "_CtrPtyRef", "_CrstllstnDtls", "_OrgnlPctgInstd", "_PrtlInstdQty", "_ReqdSttlmDt"]
	@property
	def TrfCcy(self):
		return self._TrfCcy
