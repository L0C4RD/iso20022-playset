...
class FinancialInstrument105(base_types._BaseFieldType):
	...
	__slots__ = ["_LineId", "_FctvTrfDt", "_LatstValtn", "_PrtlInstdQty", "_UnitsDtls", "_SttlmPtiesDtls", "_BizFlowTp", "_Trfr", "_Convs", "_OrgnlPctgInstd", "_AddtlAsst", "_Qty", "_TrfCcy", "_AvrgAcqstnPric", "_TaxValtnPt", "_ClntRef", "_CrstllstnDtls", "_AsstsHeldInOwnNm", "_OrgnlCost", "_PmtDtls", "_AddtlInf", "_FctvSttlmDt", "_Instrm", "_ReqdSttlmDt", "_TrfeeAcct", "_TtlBookVal", "_NotAvlbl", "_IntrmyInf", "_ReqdTradDt", "_TrfTp", "_TrfRsltsInChngOfBnfclOwnr", "_CtrPtyRef"]
	@property
	def LineId(self):
		return self._LineId
