...
class FinancialInstrument105(base_types._BaseFieldType):
	...
	__slots__ = ["_FctvTrfDt", "_SttlmPtiesDtls", "_TrfRsltsInChngOfBnfclOwnr", "_AddtlInf", "_TaxValtnPt", "_Qty", "_CrstllstnDtls", "_ReqdTradDt", "_TrfeeAcct", "_TrfTp", "_OrgnlCost", "_AsstsHeldInOwnNm", "_TrfCcy", "_PmtDtls", "_Trfr", "_AddtlAsst", "_OrgnlPctgInstd", "_FctvSttlmDt", "_LineId", "_PrtlInstdQty", "_ClntRef", "_CtrPtyRef", "_BizFlowTp", "_LatstValtn", "_Instrm", "_IntrmyInf", "_UnitsDtls", "_AvrgAcqstnPric", "_NotAvlbl", "_ReqdSttlmDt", "_TtlBookVal", "_Convs"]
	@property
	def FctvTrfDt(self):
