...
class CorporateActionPeriod18(base_types._BaseFieldType):
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='DpstrySspnsnPrdForWdrwl', type=Period12Choice, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='ParllTradgPrd', type=Period12Choice, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='PricClctnPrd', type=Period12Choice, min=0, max=1, mutex_group=None, array=False),
