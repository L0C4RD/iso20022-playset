...
class CorporateActionBalanceDetails46(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlElgblBal", "_OnLnBal", "_SttlmPosBal", "_RegdBal", "_AfctdBal", "_TradDtPosBal", "_UinstdBal", "_BrrwdBal", "_OutForRegnBal", "_PdgDlvryBal", "_OblgtdBal", "_BlckdBal", "_CollInBal", "_UafctdBal", "_PdgRctBal", "_InstdBal", "_CollOutBal", "_StrtPosBal", "_InTrnsShipmntBal"]
	@property
