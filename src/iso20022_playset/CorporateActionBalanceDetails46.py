...
class CorporateActionBalanceDetails46(base_types._BaseFieldType):
	...
	__slots__ = ["_AfctdBal", "_StrtPosBal", "_OnLnBal", "_TtlElgblBal", "_BlckdBal", "_OblgtdBal", "_InTrnsShipmntBal", "_PdgDlvryBal", "_CollOutBal", "_TradDtPosBal", "_BrrwdBal", "_OutForRegnBal", "_CollInBal", "_RegdBal", "_PdgRctBal", "_UinstdBal", "_InstdBal", "_UafctdBal", "_SttlmPosBal"]
	@property
	def AfctdBal(self):
