...
class CorporateActionBalanceDetails46(base_types._BaseFieldType):
	...
	__slots__ = ["_PdgDlvryBal", "_InTrnsShipmntBal", "_OutForRegnBal", "_CollOutBal", "_OblgtdBal", "_UafctdBal", "_InstdBal", "_AfctdBal", "_PdgRctBal", "_TtlElgblBal", "_RegdBal", "_SttlmPosBal", "_BrrwdBal", "_BlckdBal", "_OnLnBal", "_CollInBal", "_UinstdBal", "_StrtPosBal", "_TradDtPosBal"]
	@property
