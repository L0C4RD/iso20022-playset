...
class CorporateActionBalanceDetails46(base_types._BaseFieldType):
	...
	__slots__ = ["_UinstdBal", "_TtlElgblBal", "_OnLnBal", "_CollOutBal", "_BlckdBal", "_PdgDlvryBal", "_InTrnsShipmntBal", "_SttlmPosBal", "_AfctdBal", "_StrtPosBal", "_OutForRegnBal", "_PdgRctBal", "_CollInBal", "_InstdBal", "_RegdBal", "_UafctdBal", "_OblgtdBal", "_TradDtPosBal", "_BrrwdBal"]
	@property
	def UinstdBal(self):
