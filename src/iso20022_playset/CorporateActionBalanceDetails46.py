...
class CorporateActionBalanceDetails46(base_types._BaseFieldType):
	...
	__slots__ = ["_OblgtdBal", "_InTrnsShipmntBal", "_RegdBal", "_UinstdBal", "_CollOutBal", "_BlckdBal", "_CollInBal", "_StrtPosBal", "_AfctdBal", "_BrrwdBal", "_TtlElgblBal", "_OutForRegnBal", "_UafctdBal", "_InstdBal", "_TradDtPosBal", "_OnLnBal", "_PdgDlvryBal", "_PdgRctBal", "_SttlmPosBal"]
	@property
	def OblgtdBal(self):
