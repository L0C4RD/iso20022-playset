...
class CreditTransferTransaction61(base_types._BaseFieldType):
	...
	__slots__ = ["_Purp", "_Tax", "_CdtrAcct", "_RltdRmtInf", "_UltmtCdtr", "_MndtRltdInf", "_IntrmyAgt3Acct", "_RmtInf", "_IntrmyAgt1Acct", "_InstrForCdtrAgt", "_PmtTpInf", "_Cdtr", "_CdtrAgt", "_PmtId", "_RgltryRptg", "_IntrmyAgt1", "_UltmtDbtr", "_IntrmyAgt2Acct", "_IntrmyAgt2", "_ChrgBr", "_ChqInstr", "_IntrmyAgt3", "_InstrForDbtrAgt", "_CdtrAgtAcct", "_SplmtryData", "_Amt", "_XchgRateInf"]
	@property
	def Purp(self):
		return self._Purp
