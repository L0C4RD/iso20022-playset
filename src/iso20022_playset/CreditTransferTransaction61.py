...
class CreditTransferTransaction61(base_types._BaseFieldType):
	...
	__slots__ = ["_PmtTpInf", "_XchgRateInf", "_ChqInstr", "_RltdRmtInf", "_UltmtCdtr", "_ChrgBr", "_IntrmyAgt2", "_MndtRltdInf", "_IntrmyAgt3Acct", "_RgltryRptg", "_CdtrAgt", "_IntrmyAgt1Acct", "_Cdtr", "_IntrmyAgt2Acct", "_Purp", "_UltmtDbtr", "_CdtrAgtAcct", "_InstrForCdtrAgt", "_IntrmyAgt1", "_Tax", "_RmtInf", "_IntrmyAgt3", "_Amt", "_CdtrAcct", "_InstrForDbtrAgt", "_SplmtryData", "_PmtId"]
	@property
	def PmtTpInf(self):
