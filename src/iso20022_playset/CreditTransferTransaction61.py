...
class CreditTransferTransaction61(base_types._BaseFieldType):
	...
	__slots__ = ["_IntrmyAgt1Acct", "_ChrgBr", "_IntrmyAgt2", "_Purp", "_XchgRateInf", "_Cdtr", "_PmtId", "_InstrForCdtrAgt", "_MndtRltdInf", "_ChqInstr", "_Tax", "_InstrForDbtrAgt", "_RltdRmtInf", "_IntrmyAgt1", "_RmtInf", "_UltmtCdtr", "_Amt", "_UltmtDbtr", "_IntrmyAgt3Acct", "_CdtrAcct", "_IntrmyAgt2Acct", "_PmtTpInf", "_CdtrAgt", "_SplmtryData", "_CdtrAgtAcct", "_RgltryRptg", "_IntrmyAgt3"]
	@property
