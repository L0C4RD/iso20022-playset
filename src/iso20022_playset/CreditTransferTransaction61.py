...
class CreditTransferTransaction61(base_types._BaseFieldType):
	...
	__slots__ = ["_Amt", "_ChrgBr", "_SplmtryData", "_CdtrAgtAcct", "_IntrmyAgt2Acct", "_RltdRmtInf", "_IntrmyAgt2", "_ChqInstr", "_PmtId", "_RgltryRptg", "_PmtTpInf", "_InstrForCdtrAgt", "_Cdtr", "_IntrmyAgt1Acct", "_XchgRateInf", "_InstrForDbtrAgt", "_IntrmyAgt3Acct", "_MndtRltdInf", "_UltmtDbtr", "_CdtrAcct", "_RmtInf", "_CdtrAgt", "_IntrmyAgt3", "_Tax", "_Purp", "_IntrmyAgt1", "_UltmtCdtr"]
	@property
	def Amt(self):
		return self._Amt
