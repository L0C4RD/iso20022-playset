...
class CreditTransferTransaction61(base_types._BaseFieldType):
	...
	__slots__ = ["_PmtId", "_RgltryRptg", "_ChrgBr", "_Amt", "_UltmtCdtr", "_Cdtr", "_RltdRmtInf", "_Purp", "_ChqInstr", "_MndtRltdInf", "_CdtrAgt", "_PmtTpInf", "_IntrmyAgt1", "_CdtrAgtAcct", "_CdtrAcct", "_Tax", "_IntrmyAgt2", "_SplmtryData", "_IntrmyAgt3", "_RmtInf", "_InstrForCdtrAgt", "_IntrmyAgt3Acct", "_InstrForDbtrAgt", "_UltmtDbtr", "_IntrmyAgt2Acct", "_XchgRateInf", "_IntrmyAgt1Acct"]
	@property
	def PmtId(self):
		return self._PmtId
