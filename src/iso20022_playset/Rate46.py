...
class Rate46(base_types._BaseFieldType):
	...
	__slots__ = ["_AplblRate", "_WhldgTaxRate", "_GrssIntrstRateUsdForPmt", "_SlctnFeeRate", "_EqulstnRate", "_FsclStmp", "_DmdRate", "_TaxOnIncm", "_TaxCdtRate", "_ScndLvlTax", "_AddtlTax", "_TaxRclmRate", "_TaxOnPrfts", "_ChrgsFees", "_EarlySlctnFeeRate", "_NetDstrbtnRate", "_GrssDstrbtnRate", "_ThrdPtyIncntivRate"]
	@property
	def AplblRate(self):
