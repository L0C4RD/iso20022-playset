...
from .GrossDividendRateFormat41Choice import GrossDividendRateFormat41Choice
from .RateFormat29Choice import RateFormat29Choice
from .RateAndAmountFormat69Choice import RateAndAmountFormat69Choice
from .RateAndAmountFormat70Choice import RateAndAmountFormat70Choice
from .RateAndAmountFormat71Choice import RateAndAmountFormat71Choice
from .SolicitationFeeRateFormat14Choice import SolicitationFeeRateFormat14Choice
from .InterestRateUsedForPaymentFormat18Choice import InterestRateUsedForPaymentFormat18Choice
from .RateAndAmountFormat48Choice import RateAndAmountFormat48Choice
from .NetDividendRateFormat43Choice import NetDividendRateFormat43Choice
from .RateFormat24Choice import RateFormat24Choice

class Rate46(base_types._BaseFieldType):

	__slots__ = ["_DmdRate", "_GrssDstrbtnRate", "_ThrdPtyIncntivRate", "_ChrgsFees", "_FsclStmp", "_AddtlTax", "_GrssIntrstRateUsdForPmt", "_TaxOnIncm", "_ScndLvlTax", "_NetDstrbtnRate", "_TaxOnPrfts", "_TaxRclmRate", "_EqulstnRate", "_SlctnFeeRate", "_WhldgTaxRate", "_EarlySlctnFeeRate", "_TaxCdtRate", "_AplblRate"]
	@property
	def DmdRate(self):
