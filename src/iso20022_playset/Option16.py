...
class Option16(base_types._BaseFieldType):
	...
	__slots__ = ["_DerivOptnId", "_XpryLctn", "_SttlmTp", "_Data", "_AddtlOptnInf", "_VoltlyMrgn", "_SttlmAmtTp", "_OptnTp", "_Prm", "_OptnAmts", "_ExrcStyle", "_OptnPyoutTp", "_ValtnRate", "_XpryDtAndTm", "_StrkPric", "_RskAmt", "_ExrcSts"]
	@property
