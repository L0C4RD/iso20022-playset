...
class Option16(base_types._BaseFieldType):
	...
	__slots__ = ["_VoltlyMrgn", "_Data", "_SttlmTp", "_AddtlOptnInf", "_RskAmt", "_OptnTp", "_StrkPric", "_Prm", "_OptnAmts", "_DerivOptnId", "_ExrcStyle", "_XpryLctn", "_ExrcSts", "_OptnPyoutTp", "_ValtnRate", "_XpryDtAndTm", "_SttlmAmtTp"]
	@property
	def VoltlyMrgn(self):
