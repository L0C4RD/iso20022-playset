...
class CorporateActionMovementConfirmationV16(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_CorpActnConfDtls", "_InstrId", "_MvmntConfId", "_CorpActnDtls", "_IssrAgt", "_Pgntn", "_NtfctnId", "_SubPngAgt", "_OthrDocId", "_MvmntPrlimryAdvcId", "_EvtsLkg", "_PngAgt", "_CorpActnGnlInf", "_AddtlInf", "_AcctDtls", "_TxId"]
	@property
