...
class CorporateActionMovementConfirmationV16(base_types._BaseFieldType):
	...
	__slots__ = ["_EvtsLkg", "_OthrDocId", "_Pgntn", "_NtfctnId", "_InstrId", "_SubPngAgt", "_AcctDtls", "_CorpActnDtls", "_MvmntConfId", "_TxId", "_CorpActnGnlInf", "_MvmntPrlimryAdvcId", "_CorpActnConfDtls", "_AddtlInf", "_IssrAgt", "_SplmtryData", "_PngAgt"]
	@property
	def EvtsLkg(self):
