...
class SettlementObligation9(base_types._BaseFieldType):
	...
	__slots__ = ["_TradDt", "_Qty", "_SttlmPties", "_Pmt", "_SfkpgAcct", "_FinInstrmId", "_SfkpgPlc", "_PlcOfTrad", "_SctiesMvmntTp", "_SttlmAmt", "_TradgCpcty", "_AddtlSttlmOblgtnDtls", "_IntnddSttlmDt", "_ClrAcctTp", "_SttlmOblgtnId"]
	@property
	def TradDt(self):
		return self._TradDt
