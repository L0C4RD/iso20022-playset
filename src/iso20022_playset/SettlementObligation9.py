...
class SettlementObligation9(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmAmt", "_SfkpgAcct", "_SctiesMvmntTp", "_Qty", "_FinInstrmId", "_PlcOfTrad", "_TradgCpcty", "_ClrAcctTp", "_SttlmPties", "_SttlmOblgtnId", "_AddtlSttlmOblgtnDtls", "_Pmt", "_IntnddSttlmDt", "_TradDt", "_SfkpgPlc"]
	@property
	def SttlmAmt(self):
