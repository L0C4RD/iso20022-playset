...
class SettlementObligation9(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmPties", "_ClrAcctTp", "_Qty", "_TradgCpcty", "_PlcOfTrad", "_SfkpgPlc", "_TradDt", "_SttlmOblgtnId", "_Pmt", "_AddtlSttlmOblgtnDtls", "_FinInstrmId", "_IntnddSttlmDt", "_SctiesMvmntTp", "_SttlmAmt", "_SfkpgAcct"]
	@property
	def SttlmPties(self):
