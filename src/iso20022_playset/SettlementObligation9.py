...
from .SettlementParties38Choice import SettlementParties38Choice
from .SettlementObligation10 import SettlementObligation10
from .DeliveryReceiptType2Code import DeliveryReceiptType2Code
from .TradeDate3Choice import TradeDate3Choice
...
from .DateFormat65Choice import DateFormat65Choice
from .ClearingAccountType1Code import ClearingAccountType1Code

class SettlementObligation9(base_types._BaseFieldType):

	__slots__ = ["_IntnddSttlmDt", "_SfkpgPlc", "_SttlmAmt", "_SttlmPties", "_TradgCpcty", "_SctiesMvmntTp", "_PlcOfTrad", "_ClrAcctTp", "_Pmt", "_Qty", "_TradDt", "_AddtlSttlmOblgtnDtls", "_SfkpgAcct", "_SttlmOblgtnId", "_FinInstrmId"]
	@property
