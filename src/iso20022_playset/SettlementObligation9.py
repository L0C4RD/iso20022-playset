...
class SettlementObligation9(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmOblgtnId", "_SfkpgPlc", "_IntnddSttlmDt", "_ClrAcctTp", "_SttlmAmt", "_Qty", "_TradgCpcty", "_SfkpgAcct", "_SctiesMvmntTp", "_SttlmPties", "_Pmt", "_PlcOfTrad", "_FinInstrmId", "_AddtlSttlmOblgtnDtls", "_TradDt"]
	@property
