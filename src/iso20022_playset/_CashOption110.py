...
class CashOption110(base_types._BaseFieldType):
	...
	__slots__ = ["_Acct", "_CtrctlPmtInd", "_IncmTp", "_FXDtls", "_CtryOfIncmSrc", "_PricDtls", "_IssrOfferrTaxbltyInd", "_RateAndAmtDtls", "_OthrIncmTp", "_AmtDtls", "_DtDtls", "_XmptnTp", "_CshPties", "_CdtDbtInd", "_TaxVchrDtls"]
	@property
	def Acct(self):
		return self._Acct
