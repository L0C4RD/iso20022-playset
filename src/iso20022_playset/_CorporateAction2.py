...
class CorporateAction2(base_types._BaseFieldType):
	...
	__slots__ = ["_DtDtls", "_CorpActnAddtlInf", "_LtryTp", "_ClctnMtd", "_CptlGn", "_CertfctnTp", "_IntrstAcrdNbOfDays", "_BaseDnmtn", "_IncrmtlDnmtn", "_DstrbtnTp", "_RstrctnInd", "_OfferTp", "_ConvsTp", "_CertfctnReqrdInd", "_EvtStag", "_NewDnmtnCcy", "_PrdDtls", "_NewBrdLotSctiesQty", "_NewPlcOfIncorprtn", "_PrtlElctnInd", "_PricDtls", "_MinExrcblSctiesQty", "_ElctnTp", "_RedChrgsApldInd", "_ChngTp", "_NewDnmtnSctiesQty", "_MinExrcblMltplSctiesQty", "_FrntEndOddLotSctiesQty", "_SctiesQtySght", "_RnncblEntitlmntStsTp", "_DfltOptnTp", "_DvddTp", "_IntrmdtSctiesDstrbtnTp", "_CpnNb", "_RateAndAmtDtls", "_TaxblIncmPerShrClctd", "_IncmTp", "_DfltOptnNb", "_BckEndOddLotSctiesQty"]
	@property
	def DtDtls(self):
		return self._DtDtls
