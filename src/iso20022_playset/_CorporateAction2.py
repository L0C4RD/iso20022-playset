...
class CorporateAction2(base_types._BaseFieldType):
	...
	__slots__ = ["_NewDnmtnSctiesQty", "_DfltOptnTp", "_NewPlcOfIncorprtn", "_DvddTp", "_CertfctnTp", "_CptlGn", "_RateAndAmtDtls", "_MinExrcblMltplSctiesQty", "_ClctnMtd", "_MinExrcblSctiesQty", "_IntrmdtSctiesDstrbtnTp", "_OfferTp", "_CorpActnAddtlInf", "_CertfctnReqrdInd", "_IntrstAcrdNbOfDays", "_ChngTp", "_DtDtls", "_FrntEndOddLotSctiesQty", "_CpnNb", "_ElctnTp", "_EvtStag", "_BckEndOddLotSctiesQty", "_TaxblIncmPerShrClctd", "_RedChrgsApldInd", "_IncrmtlDnmtn", "_NewBrdLotSctiesQty", "_LtryTp", "_DstrbtnTp", "_DfltOptnNb", "_PricDtls", "_IncmTp", "_ConvsTp", "_RstrctnInd", "_NewDnmtnCcy", "_BaseDnmtn", "_PrdDtls", "_PrtlElctnInd", "_RnncblEntitlmntStsTp", "_SctiesQtySght"]
	@property
