...
class SettlementDetails197(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmSysMtd", "_StmpDtyTaxBsis", "_NetgElgblty", "_LttrOfGrnt", "_BnfclOwnrsh", "_CshClrSys", "_SctiesRTGS", "_Regn", "_TaxCpcty", "_PrtlSttlmInd", "_BlckTrad", "_LglRstrctns", "_RpTp", "_HldInd", "_MktClntSd", "_SttlgCpcty", "_CCPElgblty", "_SttlmTxCond"]
	@property
