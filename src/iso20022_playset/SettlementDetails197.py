...
class SettlementDetails197(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlgCpcty", "_RpTp", "_LglRstrctns", "_SttlmSysMtd", "_Regn", "_NetgElgblty", "_CCPElgblty", "_LttrOfGrnt", "_BlckTrad", "_SctiesRTGS", "_TaxCpcty", "_BnfclOwnrsh", "_MktClntSd", "_SttlmTxCond", "_HldInd", "_StmpDtyTaxBsis", "_PrtlSttlmInd", "_CshClrSys"]
	@property
	def SttlgCpcty(self):
