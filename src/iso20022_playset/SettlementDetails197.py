...
class SettlementDetails197(base_types._BaseFieldType):
	...
	__slots__ = ["_TaxCpcty", "_StmpDtyTaxBsis", "_SttlmTxCond", "_SttlmSysMtd", "_MktClntSd", "_BlckTrad", "_RpTp", "_BnfclOwnrsh", "_LttrOfGrnt", "_SctiesRTGS", "_Regn", "_NetgElgblty", "_PrtlSttlmInd", "_CshClrSys", "_LglRstrctns", "_CCPElgblty", "_SttlgCpcty", "_HldInd"]
	@property
	def TaxCpcty(self):
