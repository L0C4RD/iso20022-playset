...
class AmendmentV04(base_types._BaseFieldType):
	...
	__slots__ = ["_AmddData", "_Dstn", "_Hdr", "_Jursdctn", "_MsgAmdd", "_NtlData", "_OrgnlMsg", "_Orgtr", "_Prgrmm", "_PrtctdData", "_PrvtData", "_Rcncltn", "_Rcvr", "_SctyTrlr", "_Sndr", "_SttlmSvc", "_TxId"]
	@property
	def AmddData(self):
