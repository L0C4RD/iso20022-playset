...
class CorporateActionNotification002V15(base_types._BaseFieldType):
	...
	__slots__ = ["_Pgntn", "_CorpActnDtls", "_AddtlInf", "_SubPngAgt", "_Regar", "_EvtsLkg", "_SlctnAgt", "_RsellngAgt", "_InfAgt", "_PrvsNtfctnId", "_TrfAgt", "_DrpAgt", "_Issr", "_OthrDocId", "_InstrId", "_PhysSctiesAgt", "_CorpActnOptnDtls", "_IssrAgt", "_PngAgt", "_CorpActnGnlInf", "_AcctDtls", "_NtfctnGnlInf", "_Offerr", "_SplmtryData", "_IntrmdtScty"]
	@property
	def Pgntn(self):
		return self._Pgntn
