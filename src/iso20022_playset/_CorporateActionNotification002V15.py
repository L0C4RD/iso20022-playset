...
class CorporateActionNotification002V15(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_EvtsLkg", "_AcctDtls", "_TrfAgt", "_DrpAgt", "_IntrmdtScty", "_PngAgt", "_InfAgt", "_NtfctnGnlInf", "_Issr", "_CorpActnOptnDtls", "_OthrDocId", "_InstrId", "_Offerr", "_PhysSctiesAgt", "_Pgntn", "_RsellngAgt", "_PrvsNtfctnId", "_CorpActnGnlInf", "_CorpActnDtls", "_SlctnAgt", "_IssrAgt", "_AddtlInf", "_SubPngAgt", "_Regar"]
	@property
