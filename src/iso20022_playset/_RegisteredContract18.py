...
class RegisteredContract18(base_types._BaseFieldType):
	...
	__slots__ = ["_LnPrncplAmt", "_OrgnlCtrctRegnReq", "_PmtSchdlTp", "_CtrctBal", "_RegdCtrctId", "_RegdCtrctJrnl", "_IssrFI", "_Ctrct", "_Dlvry", "_IntrCpnyLn", "_Amdmnt", "_Submissn", "_EstmtdDtInd", "_PrvsRegdCtrctId", "_AddtlInf"]
	@property
