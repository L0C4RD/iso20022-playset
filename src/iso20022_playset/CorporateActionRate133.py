...
class CorporateActionRate133(base_types._BaseFieldType):
	...
	__slots__ = ["_TaxblIncmPerDvddShr", "_ScndLvlTax", "_MaxAllwdOvrsbcptRate", "_GrssDstrbtnRate", "_NetDstrbtnRate", "_AddtlTax", "_WhldgTaxRate", "_GrssIntrstRateUsdForPmt", "_PrratnRate", "_TaxOnIncm"]
	@property
