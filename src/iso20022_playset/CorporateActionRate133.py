...
class CorporateActionRate133(base_types._BaseFieldType):
	...
	__slots__ = ["_NetDstrbtnRate", "_GrssIntrstRateUsdForPmt", "_AddtlTax", "_WhldgTaxRate", "_MaxAllwdOvrsbcptRate", "_TaxOnIncm", "_GrssDstrbtnRate", "_ScndLvlTax", "_PrratnRate", "_TaxblIncmPerDvddShr"]
	@property
