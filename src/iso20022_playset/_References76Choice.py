...
class References76Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_IntraBalMvmntId", "_CmonId", "_SctiesSttlmTxId", "_AcctSvcrTxId", "_MktInfrstrctrTxId", "_IntraPosMvmntId", "_OthrTxId", "_TradId", "_CtrPtyMktInfrstrctrTxId", "_PoolId"]
	@property
