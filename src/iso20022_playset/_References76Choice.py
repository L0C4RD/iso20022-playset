...
class References76Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_SctiesSttlmTxId", "_OthrTxId", "_AcctSvcrTxId", "_IntraBalMvmntId", "_CmonId", "_PoolId", "_CtrPtyMktInfrstrctrTxId", "_MktInfrstrctrTxId", "_TradId", "_IntraPosMvmntId"]
	@property
