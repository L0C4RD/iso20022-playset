...
from .DetailedError1 import DetailedError1
from .AdditionalData2 import AdditionalData2

class AmendmentV03(base_types._BaseFieldType):

	__slots__ = ["_MsgAmdd", "_SctyTrlr", "_Rcvr", "_Orgtr", "_AddtlData", "_Jursdctn", "_Dstn", "_TxId", "_SplmtryData", "_OrgnlMsg", "_Hdr", "_Sndr", "_SttlmSvc", "_AmddData", "_PrtctdData", "_Prgrmm", "_Rcncltn"]
	@property
	def MsgAmdd(self):
