...
class AmendmentV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Sndr", "_TxId", "_Hdr", "_AmddData", "_AddtlData", "_Rcncltn", "_Dstn", "_PrtctdData", "_OrgnlMsg", "_MsgAmdd", "_SttlmSvc", "_Rcvr", "_Jursdctn", "_SplmtryData", "_Orgtr", "_SctyTrlr", "_Prgrmm"]
	@property
	def Sndr(self):
		return self._Sndr
