...
class AmendmentV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Jursdctn", "_AddtlData", "_SplmtryData", "_Orgtr", "_Hdr", "_SttlmSvc", "_MsgAmdd", "_Sndr", "_Dstn", "_TxId", "_Rcncltn", "_Rcvr", "_SctyTrlr", "_Prgrmm", "_PrtctdData", "_AmddData", "_OrgnlMsg"]
	@property
	def Jursdctn(self):
