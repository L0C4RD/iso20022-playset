...
class SettlementInstruction11(base_types._BaseFieldType):
	...
	__slots__ = ["_InstdRmbrsmntAgt", "_InstgRmbrsmntAgt", "_ClrSys", "_InstgRmbrsmntAgtAcct", "_SttlmAcct", "_ThrdRmbrsmntAgtAcct", "_InstdRmbrsmntAgtAcct", "_ThrdRmbrsmntAgt", "_SttlmMtd"]
	@property
