...
class TemporaryServices3(base_types._BaseFieldType):
	...
	__slots__ = ["_FlatRateInd", "_TmSheet", "_JobStartDt", "_JobEndDt", "_Chrg", "_MplyeeId", "_MplyeePrfssnlLvl", "_DscntAmt", "_CpnyId", "_CpnySprvsr", "_Tax", "_SbttlAmt", "_SummryCmmdtyId", "_JobDrtn", "_CpnyDept", "_CpnyNm", "_JobDesc", "_MplyeePrsnlId", "_JobCd", "_MiscExpnss", "_AddtlData", "_MplyeeNm", "_WkEndg"]
	@property
