...
class TemporaryServices3(base_types._BaseFieldType):
	...
	__slots__ = ["_CpnyId", "_JobDesc", "_CpnySprvsr", "_CpnyNm", "_MplyeePrsnlId", "_Tax", "_FlatRateInd", "_JobDrtn", "_Chrg", "_CpnyDept", "_MplyeePrfssnlLvl", "_DscntAmt", "_TmSheet", "_JobEndDt", "_MplyeeNm", "_SbttlAmt", "_JobCd", "_SummryCmmdtyId", "_JobStartDt", "_MiscExpnss", "_MplyeeId", "_AddtlData", "_WkEndg"]
	@property
	def CpnyId(self):
		return self._CpnyId
