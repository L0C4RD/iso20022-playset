...
class TemporaryServices3(base_types._BaseFieldType):
	...
	__slots__ = ["_CpnyDept", "_JobDesc", "_MplyeeId", "_FlatRateInd", "_MplyeeNm", "_MiscExpnss", "_JobEndDt", "_CpnyNm", "_DscntAmt", "_Tax", "_CpnyId", "_WkEndg", "_Chrg", "_MplyeePrsnlId", "_SbttlAmt", "_JobStartDt", "_TmSheet", "_JobCd", "_JobDrtn", "_SummryCmmdtyId", "_CpnySprvsr", "_AddtlData", "_MplyeePrfssnlLvl"]
	@property
	def CpnyDept(self):
