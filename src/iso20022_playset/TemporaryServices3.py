...
class TemporaryServices3(base_types._BaseFieldType):
	...
	__slots__ = ["_CpnyNm", "_MiscExpnss", "_MplyeeId", "_WkEndg", "_AddtlData", "_FlatRateInd", "_Tax", "_CpnyId", "_SummryCmmdtyId", "_JobStartDt", "_CpnyDept", "_SbttlAmt", "_JobCd", "_CpnySprvsr", "_DscntAmt", "_MplyeePrsnlId", "_MplyeePrfssnlLvl", "_MplyeeNm", "_JobDrtn", "_JobDesc", "_JobEndDt", "_Chrg", "_TmSheet"]
	@property
	def CpnyNm(self):
		return self._CpnyNm
