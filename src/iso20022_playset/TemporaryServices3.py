...
class TemporaryServices3(base_types._BaseFieldType):
	...
	__slots__ = ["_Tax", "_CpnyDept", "_JobDrtn", "_TmSheet", "_SbttlAmt", "_CpnyNm", "_JobEndDt", "_CpnyId", "_CpnySprvsr", "_MplyeeNm", "_MplyeeId", "_MiscExpnss", "_FlatRateInd", "_DscntAmt", "_WkEndg", "_SummryCmmdtyId", "_Chrg", "_MplyeePrfssnlLvl", "_JobCd", "_AddtlData", "_JobDesc", "_JobStartDt", "_MplyeePrsnlId"]
	@property
	def Tax(self):
		return self._Tax
