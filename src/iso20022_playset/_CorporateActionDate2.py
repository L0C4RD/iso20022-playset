...
class CorporateActionDate2(base_types._BaseFieldType):
	...
	__slots__ = ["_RedDt", "_PrratnDt", "_RsltsPblctnDt", "_GrntedPrtcptnDt", "_RcrdDt", "_RegnDdln", "_CertfctnDdln", "_PrtctDt", "_DdlnForTaxBrkdwnInstr", "_EarlyClsgDt", "_ElctnToCtrPtyDdln", "_SpclExDt", "_MrgnFxgDt", "_EqulstnDt", "_UcondlDt", "_CrtApprvlDt", "_IndxFxgDt", "_CoverXprtnDt", "_ExDvddDt", "_FctvDt", "_MtrtyDt", "_TradgSspdDt", "_LpsdDt", "_LtryDt", "_WhlyUcondlDt"]
	@property
	def RedDt(self):
		return self._RedDt
