...
class TransactionDetails179(base_types._BaseFieldType):

	__slots__ = ["_DgtlPmtSttlm", "_DlvrgSttlmPties", "_FinInstrmId", "_Invstr", "_RcvgSttlmPties", "_SttlmAmt", "_SttlmDt", "_SttlmQty", "_TradDt"]
	@property
