...
import AdditionalParameters34
import BlockChainAddressWallet7

class IntraPositionMovementConfirmation002V09(base_types._BaseFieldType):

	__slots__ = ["_SplmtryData", "_IntraPosDtls", "_SfkpgPlc", "_AddtlParams", "_FinInstrmId", "_BlckChainAdrOrWllt", "_AcctOwnr", "_SfkpgAcct", "_FinInstrmAttrbts"]
	@property
