...
from . import AccountHoldingInformationRequestV08
...
class SESE_019_001_08():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def AcctHldgInfReq(self, value):
			self._AcctHldgInfReq = value if value is not None else base_types.UninitialisedField(self, 'AcctHldgInfReq', AccountHoldingInformationRequestV08, False)

		@AcctHldgInfReq.deleter
		def AcctHldgInfReq(self):
			del self._AcctHldgInfReq
			self._AcctHldgInfReq = base_types.UninitialisedField(self, 'AcctHldgInfReq', AccountHoldingInformationRequestV08, False)
