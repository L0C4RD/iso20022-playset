...
from . import BusinessApplicationHeader8
...
class HEAD_001_001_04():
	...
	class BusinessApplicationHeaderV04(base_types._BaseFieldType_Document):
		...
		@Rltd.setter
		def Rltd(self, value):
			self._Rltd = value if value is not None else base_types.UninitialisedField(self, 'Rltd', BusinessApplicationHeader8, True)

		@Rltd.deleter
		def Rltd(self):
			del self._Rltd
			self._Rltd = base_types.UninitialisedField(self, 'Rltd', BusinessApplicationHeader8, True)
