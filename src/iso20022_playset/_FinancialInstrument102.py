...
class FinancialInstrument102(base_types._BaseFieldType):
	...
	__slots__ = ["_BizFlowTp", "_ReqdTradDt", "_TrfRsltsInChngOfBnfclOwnr", "_NotAvlbl", "_TrfTp", "_ReqdSttlmDt", "_PrtlInstdQty", "_Qty", "_Trfr", "_ClntRef", "_SttlmPtiesDtls", "_TrfeeAcct", "_TtlBookVal", "_AsstsHeldInOwnNm", "_AvrgAcqstnPric", "_TaxValtnPt", "_IntrmyInf", "_CrstllstnDtls", "_Convs", "_AddtlAsst", "_CtrPtyRef", "_UnitsDtls", "_PmtDtls", "_Instrm", "_LineId", "_AddtlInf", "_ReqdTrfDt", "_TrfCcy"]
	@property
	def BizFlowTp(self):
