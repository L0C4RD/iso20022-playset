...
class CurrencyConversion29(base_types._BaseFieldType):
	...
	__slots__ = ["_TrgtCcy", "_OrgnlAmt", "_VldFr", "_RsltgAmt", "_AplblBinRg", "_VldUntil", "_CcyConvsId", "_SrcCcy", "_XchgRate", "_QtnDt", "_MrkUpDtls", "_NvrtdXchgRate", "_ComssnDtls", "_DclrtnDtls"]
	@property
	def TrgtCcy(self):
