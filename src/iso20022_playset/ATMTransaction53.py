...
class ATMTransaction53(base_types._BaseFieldType):
	...
	__slots__ = ["_RctPrtd", "_ICCRltdData", "_TtlPresntdAmt", "_DtldReqdAmt", "_BndlPresntdAmt", "_IncdntDtl", "_TtlAuthrsdAmt", "_TtlReqdAmt", "_TxSts", "_PrtctdAcctData", "_AddtlChrg", "_ATMTtls", "_PresntdAmtSts", "_Csstt", "_RcncltnId", "_TxId", "_MultiBndl", "_Incdnt", "_AcctData", "_AuthstnRslt", "_Lmts", "_CcyConvsRslt", "_ReqdRct", "_CstmrCnsnt"]
	@property
	def RctPrtd(self):
