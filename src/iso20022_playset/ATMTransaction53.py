...
class ATMTransaction53(base_types._BaseFieldType):
	...
	__slots__ = ["_RctPrtd", "_Incdnt", "_CcyConvsRslt", "_ATMTtls", "_MultiBndl", "_AddtlChrg", "_TxId", "_Csstt", "_ReqdRct", "_TtlReqdAmt", "_BndlPresntdAmt", "_TtlPresntdAmt", "_CstmrCnsnt", "_PrtctdAcctData", "_AcctData", "_TtlAuthrsdAmt", "_DtldReqdAmt", "_PresntdAmtSts", "_ICCRltdData", "_AuthstnRslt", "_TxSts", "_Lmts", "_IncdntDtl", "_RcncltnId"]
	@property
	def RctPrtd(self):
