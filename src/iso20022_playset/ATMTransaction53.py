...
class ATMTransaction53(base_types._BaseFieldType):
	...
	__slots__ = ["_Lmts", "_MultiBndl", "_TxId", "_AcctData", "_CstmrCnsnt", "_Incdnt", "_ReqdRct", "_AuthstnRslt", "_DtldReqdAmt", "_AddtlChrg", "_IncdntDtl", "_TtlAuthrsdAmt", "_ATMTtls", "_PresntdAmtSts", "_ICCRltdData", "_TtlReqdAmt", "_TxSts", "_CcyConvsRslt", "_Csstt", "_RctPrtd", "_PrtctdAcctData", "_RcncltnId", "_BndlPresntdAmt", "_TtlPresntdAmt"]
	@property
	def Lmts(self):
		return self._Lmts
