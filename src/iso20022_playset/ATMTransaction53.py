...
class ATMTransaction53(base_types._BaseFieldType):
	...
	__slots__ = ["_IncdntDtl", "_PrtctdAcctData", "_ATMTtls", "_ReqdRct", "_PresntdAmtSts", "_TxSts", "_AuthstnRslt", "_BndlPresntdAmt", "_TxId", "_DtldReqdAmt", "_AddtlChrg", "_MultiBndl", "_RcncltnId", "_AcctData", "_TtlAuthrsdAmt", "_CcyConvsRslt", "_TtlReqdAmt", "_Lmts", "_TtlPresntdAmt", "_ICCRltdData", "_Csstt", "_RctPrtd", "_CstmrCnsnt", "_Incdnt"]
	@property
	def IncdntDtl(self):
