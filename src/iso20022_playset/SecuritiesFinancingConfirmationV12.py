...
class SecuritiesFinancingConfirmationV12(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmParams", "_TradDtls", "_FinInstrmId", "_TxIdDtls", "_SctiesFincgDtls", "_DlvrgSttlmPties", "_QtyAndAcctDtls", "_CshPties", "_RcvgSttlmPties", "_OthrAmts", "_AddtlParams", "_OthrBizPties", "_SttldAmt", "_FinInstrmAttrbts", "_StgSttlmInstrDtls", "_SplmtryData", "_DgtlNtwkFee"]
	@property
