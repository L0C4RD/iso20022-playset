...
class SecuritiesFinancingConfirmationV12(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrAmts", "_RcvgSttlmPties", "_SttlmParams", "_TxIdDtls", "_StgSttlmInstrDtls", "_SttldAmt", "_OthrBizPties", "_AddtlParams", "_DgtlNtwkFee", "_TradDtls", "_SctiesFincgDtls", "_CshPties", "_FinInstrmId", "_SplmtryData", "_QtyAndAcctDtls", "_DlvrgSttlmPties", "_FinInstrmAttrbts"]
	@property
	def OthrAmts(self):
