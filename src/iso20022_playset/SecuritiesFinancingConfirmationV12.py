...
class SecuritiesFinancingConfirmationV12(base_types._BaseFieldType):
	...
	__slots__ = ["_DgtlNtwkFee", "_RcvgSttlmPties", "_OthrAmts", "_DlvrgSttlmPties", "_FinInstrmId", "_StgSttlmInstrDtls", "_SttldAmt", "_SttlmParams", "_SctiesFincgDtls", "_AddtlParams", "_TxIdDtls", "_OthrBizPties", "_TradDtls", "_SplmtryData", "_FinInstrmAttrbts", "_QtyAndAcctDtls", "_CshPties"]
	@property
