...
class SecuritiesFinancingConfirmationV12(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_SctiesFincgDtls", "_CshPties", "_DgtlNtwkFee", "_SttlmParams", "_FinInstrmId", "_TradDtls", "_SttldAmt", "_RcvgSttlmPties", "_StgSttlmInstrDtls", "_OthrAmts", "_FinInstrmAttrbts", "_DlvrgSttlmPties", "_TxIdDtls", "_AddtlParams", "_QtyAndAcctDtls", "_OthrBizPties"]
	@property
