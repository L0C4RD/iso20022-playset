...
class SecuritiesFinancingConfirmationV12(base_types._BaseFieldType):
	...
	__slots__ = ["_QtyAndAcctDtls", "_AddtlParams", "_SttlmParams", "_RcvgSttlmPties", "_DgtlNtwkFee", "_DlvrgSttlmPties", "_TradDtls", "_OthrAmts", "_TxIdDtls", "_SplmtryData", "_OthrBizPties", "_SttldAmt", "_FinInstrmId", "_CshPties", "_FinInstrmAttrbts", "_StgSttlmInstrDtls", "_SctiesFincgDtls"]
	@property
