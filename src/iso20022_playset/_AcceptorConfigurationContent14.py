...
class AcceptorConfigurationContent14(base_types._BaseFieldType):
	...
	__slots__ = ["_SvcPrvdrParams", "_AcqrrPrtcolParams", "_TMSPrtcolParams", "_MrchntParams", "_TermnlPackg", "_SaleToPOIParams", "_HstComParams", "_TermnlParams", "_RplcCfgtn", "_ApplParams", "_SctyParams"]
	@property
