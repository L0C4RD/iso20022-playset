...
class Rate42(base_types._BaseFieldType):

	__slots__ = ["_GrssDstrbtnRate", "_ThrdPtyIncntivRate", "_EarlySlctnFeeRate", "_FsclStmp", "_ScndLvlTax", "_WhldgTaxRate", "_AddtlTax", "_AplblRate", "_ChrgsFees", "_TaxRclmRate", "_SlctnFeeRate", "_TaxCdtRate", "_TaxOnIncm", "_DmdRate", "_GrssIntrstRateUsdForPmt", "_EqulstnRate", "_TaxOnPrfts", "_NetDstrbtnRate"]
	@property
