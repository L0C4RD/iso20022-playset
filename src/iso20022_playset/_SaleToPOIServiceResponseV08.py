...
class SaleToPOIServiceResponseV08(base_types._BaseFieldType):
	...
	def SvcRspn(self, value):
		self._SvcRspn = value if value is not None else base_types.UninitialisedField(self, 'SvcRspn', ServiceResponse10, False)

	@SvcRspn.deleter
	def SvcRspn(self):
		del self._SvcRspn
		self._SvcRspn = base_types.UninitialisedField(self, 'SvcRspn', ServiceResponse10, False)
