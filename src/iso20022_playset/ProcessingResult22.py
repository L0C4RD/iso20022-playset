...
class ProcessingResult22(base_types._BaseFieldType):
	...
	__slots__ = ["_ActnReqrd", "_ErrDtl", "_RspnSrcAssgnr", "_RspnCd", "_AddtlInf", "_ApprvlCd", "_TempScrCardDataReusePrtd", "_RspnSrcId", "_Actn", "_RspnSrcOthrTp", "_RspnSrcCtry", "_RspnSrcTp", "_RspnSrcShrtNm"]
	@property
	def ActnReqrd(self):
