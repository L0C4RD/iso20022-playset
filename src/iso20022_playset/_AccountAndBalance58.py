...
from . import CorporateActionBalanceDetails41
from . import Max140Text
from . import Max35Text
from . import PartyIdentification127Choice
from . import SafekeepingPlaceFormat42Choice

class AccountAndBalance58(base_types._BaseFieldType):
	...
	@Bal.setter
	def Bal(self, value):
		self._Bal = value if value is not None else base_types.UninitialisedField(self, 'Bal', CorporateActionBalanceDetails41, False)

	@Bal.deleter
	def Bal(self):
		del self._Bal
		self._Bal = base_types.UninitialisedField(self, 'Bal', CorporateActionBalanceDetails41, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='Bal', type=CorporateActionBalanceDetails41, min=1, max=1, mutex_group=None, array=False),
