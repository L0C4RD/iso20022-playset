...
from . import ATMTransactionAmounts11
...
class CardAccount21(base_types._BaseFieldType):
	...
	@Lmts.setter
	def Lmts(self, value):
		self._Lmts = value if value is not None else base_types.UninitialisedField(self, 'Lmts', ATMTransactionAmounts11, False)

	@Lmts.deleter
	def Lmts(self):
		del self._Lmts
		self._Lmts = base_types.UninitialisedField(self, 'Lmts', ATMTransactionAmounts11, False)
