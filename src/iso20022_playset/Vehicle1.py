...
from .PlainCardData17 import PlainCardData17
...
class Vehicle1(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlVhclData", "_UnitNb", "_Hbmtr", "_VhclTagNtryMd", "_DrvrOrVhclCard", "_VhclTag", "_TrlrHrs", "_MntncId", "_TrlrNb", "_VhclNb", "_RefrHrs", "_RplcmntCar", "_Odmtr"]
	@property
