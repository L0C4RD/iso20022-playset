...
from . import AcceptorReconciliationResponse12
from . import ContentInformationType37
from . import Header70

class AcceptorReconciliationResponseV13(base_types._BaseFieldType):
	...
	def RcncltnRspn(self, value):
		self._RcncltnRspn = value if value is not None else base_types.UninitialisedField(self, 'RcncltnRspn', AcceptorReconciliationResponse12, False)

	@RcncltnRspn.deleter
	def RcncltnRspn(self):
		del self._RcncltnRspn
		self._RcncltnRspn = base_types.UninitialisedField(self, 'RcncltnRspn', AcceptorReconciliationResponse12, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='RcncltnRspn', type=AcceptorReconciliationResponse12, min=1, max=1, mutex_group=None, array=False),
