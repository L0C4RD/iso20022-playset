...
from . import IntraBalancePending5
...
class IntraBalanceMovementPendingReportV02(base_types._BaseFieldType):
	...
	def Mvmnts(self, value):
		self._Mvmnts = value if value is not None else base_types.UninitialisedField(self, 'Mvmnts', IntraBalancePending5, True)

	@Mvmnts.deleter
	def Mvmnts(self):
		del self._Mvmnts
		self._Mvmnts = base_types.UninitialisedField(self, 'Mvmnts', IntraBalancePending5, True)
