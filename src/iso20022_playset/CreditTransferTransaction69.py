...
class CreditTransferTransaction69(base_types._BaseFieldType):
	...
	__slots__ = ["_Cdtr", "_CdtrAgtAcct", "_XpryDtTm", "_IntrmyAgt2", "_IntrBkSttlmDt", "_PrvsInstgAgt1", "_PrvsInstgAgt3", "_SttlmTmReq", "_InstrForCdtrAgt", "_IntrBkSttlmAmt", "_UltmtCdtr", "_SttlmPrty", "_RmtInf", "_DbtrAgt", "_IntrmyAgt1Acct", "_IntrmyAgt3Acct", "_CdtrAcct", "_InstgAgt", "_PrvsInstgAgt2Acct", "_DbtrAgtAcct", "_InstrForNxtAgt", "_SttlmTmIndctn", "_IntrmyAgt2Acct", "_DbtrAcct", "_UndrlygAllcn", "_PrvsInstgAgt1Acct", "_InstdAgt", "_PmtId", "_PrvsInstgAgt3Acct", "_PmtSgntr", "_PmtTpInf", "_CdtrAgt", "_IntrmyAgt3", "_UltmtDbtr", "_Purp", "_PrvsInstgAgt2", "_IntrmyAgt1", "_Dbtr"]
	@property
	def Cdtr(self):
		return self._Cdtr
