...
class PriceValuation4(base_types._BaseFieldType):
	...
	__slots__ = ["_SspdInd", "_FinInstrmDtls", "_ValtnFrqcy", "_TtlUnitsNb", "_ValtnSttstcs", "_ValtnTp", "_PrfrmncDtls", "_NxtValtnDtTm", "_Id", "_OffclValtnInd", "_FndMgmtCpny", "_NAVDtTm", "_PricDtls", "_ValtnDtTm", "_TtlNAV", "_PrvsValtnDtTm"]
	@property
	def SspdInd(self):
