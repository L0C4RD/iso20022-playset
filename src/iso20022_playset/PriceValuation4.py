...
class PriceValuation4(base_types._BaseFieldType):
	...
	__slots__ = ["_PrvsValtnDtTm", "_ValtnSttstcs", "_TtlNAV", "_PrfrmncDtls", "_FndMgmtCpny", "_FinInstrmDtls", "_OffclValtnInd", "_ValtnFrqcy", "_ValtnDtTm", "_NAVDtTm", "_ValtnTp", "_Id", "_TtlUnitsNb", "_PricDtls", "_NxtValtnDtTm", "_SspdInd"]
	@property
