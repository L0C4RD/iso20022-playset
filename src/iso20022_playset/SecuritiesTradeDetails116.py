...
class SecuritiesTradeDetails116(base_types._BaseFieldType):
	...
	__slots__ = ["_CcyToBuyOrSell", "_PlcOfClr", "_Rptg", "_TradTxCond", "_NbOfDaysAcrd", "_TradDt", "_DealPric", "_FxAddtlDtls", "_OpngSttlmDt", "_MtchgSts", "_PlcOfTrad", "_AffirmSts", "_TradOrgtrRole", "_InvstrCpcty", "_SttlmInstrPrcgAddtlDtls"]
	@property
