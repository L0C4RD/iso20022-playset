...
class SecuritiesTradeDetails116(base_types._BaseFieldType):
	...
	__slots__ = ["_PlcOfTrad", "_TradTxCond", "_FxAddtlDtls", "_AffirmSts", "_DealPric", "_PlcOfClr", "_TradOrgtrRole", "_MtchgSts", "_TradDt", "_Rptg", "_InvstrCpcty", "_CcyToBuyOrSell", "_NbOfDaysAcrd", "_OpngSttlmDt", "_SttlmInstrPrcgAddtlDtls"]
	@property
	def PlcOfTrad(self):
