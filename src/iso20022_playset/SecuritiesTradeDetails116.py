...
class SecuritiesTradeDetails116(base_types._BaseFieldType):
	...
	__slots__ = ["_MtchgSts", "_PlcOfTrad", "_FxAddtlDtls", "_CcyToBuyOrSell", "_SttlmInstrPrcgAddtlDtls", "_TradOrgtrRole", "_AffirmSts", "_NbOfDaysAcrd", "_TradTxCond", "_PlcOfClr", "_InvstrCpcty", "_Rptg", "_OpngSttlmDt", "_TradDt", "_DealPric"]
	@property
	def MtchgSts(self):
