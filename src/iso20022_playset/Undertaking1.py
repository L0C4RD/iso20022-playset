...
class Undertaking1(base_types._BaseFieldType):
	...
	__slots__ = ["_PresntnDtls", "_TrfChrgsPyblBy", "_MltplDmndInd", "_ConfChrgsPyblBy", "_UndrlygTx", "_UdrtkgAmt", "_XpryDtls", "_AutomtcAmtVartn", "_Issr", "_AdvsgPty", "_AddtlApplInf", "_DlvryChanl", "_OblgrChrgAcct", "_Bnfcry", "_ScndAdvsgPty", "_Nm", "_Tp", "_CntrUdrtkg", "_OblgrLbltyAcct", "_GovncRulesAndLaw", "_PrtlDmndInd", "_NclsdFile", "_UdrtkgWrdg", "_Oblgr", "_ApplcntRefNb", "_OblgrSttlmAcct", "_Purp", "_ConfInd", "_TrfInd", "_Applcnt", "_AddtlPty", "_Cnfrmr", "_CntrUdrtkgInd"]
	@property
