...
class Undertaking1(base_types._BaseFieldType):
	...
	__slots__ = ["_ConfInd", "_OblgrLbltyAcct", "_Cnfrmr", "_ApplcntRefNb", "_ScndAdvsgPty", "_UdrtkgAmt", "_Issr", "_NclsdFile", "_AdvsgPty", "_AddtlPty", "_PresntnDtls", "_GovncRulesAndLaw", "_UndrlygTx", "_TrfInd", "_Bnfcry", "_Oblgr", "_AddtlApplInf", "_AutomtcAmtVartn", "_CntrUdrtkgInd", "_DlvryChanl", "_UdrtkgWrdg", "_CntrUdrtkg", "_TrfChrgsPyblBy", "_MltplDmndInd", "_Applcnt", "_XpryDtls", "_Tp", "_OblgrSttlmAcct", "_Nm", "_ConfChrgsPyblBy", "_PrtlDmndInd", "_Purp", "_OblgrChrgAcct"]
	@property
	def ConfInd(self):
