...
class Undertaking1(base_types._BaseFieldType):
	...
	__slots__ = ["_UdrtkgWrdg", "_Oblgr", "_AddtlPty", "_Tp", "_UndrlygTx", "_Applcnt", "_TrfInd", "_TrfChrgsPyblBy", "_AutomtcAmtVartn", "_PrtlDmndInd", "_ApplcntRefNb", "_OblgrChrgAcct", "_Issr", "_OblgrSttlmAcct", "_XpryDtls", "_MltplDmndInd", "_ConfInd", "_GovncRulesAndLaw", "_DlvryChanl", "_AddtlApplInf", "_ConfChrgsPyblBy", "_ScndAdvsgPty", "_CntrUdrtkg", "_CntrUdrtkgInd", "_NclsdFile", "_OblgrLbltyAcct", "_AdvsgPty", "_UdrtkgAmt", "_Purp", "_PresntnDtls", "_Nm", "_Cnfrmr", "_Bnfcry"]
	@property
	def UdrtkgWrdg(self):
