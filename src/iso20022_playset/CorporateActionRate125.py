...
class CorporateActionRate125(base_types._BaseFieldType):
	...
	__slots__ = ["_TaxCdtRate", "_FinTxTaxRate", "_NewToOd", "_AplblRate", "_ScndLvlTax", "_FsclStmp", "_ChrgsFees", "_AddtlQtyForSbcbdRsltntScties", "_AddtlQtyForExstgScties", "_WhldgTaxRate"]
	@property
	def TaxCdtRate(self):
