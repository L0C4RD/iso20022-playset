...
from .RatioFormat20Choice import RatioFormat20Choice
from .RatioFormat19Choice import RatioFormat19Choice
...
class CorporateActionRate125(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlQtyForExstgScties", "_ChrgsFees", "_FinTxTaxRate", "_AddtlQtyForSbcbdRsltntScties", "_ScndLvlTax", "_NewToOd", "_TaxCdtRate", "_WhldgTaxRate", "_FsclStmp", "_AplblRate"]
	@property
