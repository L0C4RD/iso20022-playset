...
class CorporateActionRate125(base_types._BaseFieldType):
	...
	__slots__ = ["_FsclStmp", "_ChrgsFees", "_ScndLvlTax", "_NewToOd", "_AddtlQtyForSbcbdRsltntScties", "_AddtlQtyForExstgScties", "_TaxCdtRate", "_AplblRate", "_WhldgTaxRate", "_FinTxTaxRate"]
	@property
	def FsclStmp(self):
