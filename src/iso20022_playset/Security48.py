...
from .CompareCollateralQualityType3 import CompareCollateralQualityType3
from .ComparePercentageRate3 import ComparePercentageRate3
from .CompareSecuritiesLendingType3 import CompareSecuritiesLendingType3
...
from .CompareCountryCode3 import CompareCountryCode3
from .CompareUnitPrice6 import CompareUnitPrice6

class Security48(base_types._BaseFieldType):

	__slots__ = ["_HrcutOrMrgn", "_Qlty", "_ClssfctnTp", "_UnitPric", "_Qty", "_Mtrty", "_IssrId", "_MktVal", "_IssrCtry", "_AvlblForCollReuse", "_Tp", "_NmnlVal", "_ExclsvArrgmnt", "_Id"]
	@property
