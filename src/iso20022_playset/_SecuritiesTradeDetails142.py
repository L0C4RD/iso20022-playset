...
class SecuritiesTradeDetails142(base_types._BaseFieldType):

	__slots__ = ["_CollTxId", "_InvstrCpcty", "_TradOrgtrRole", "_SttlmInstrPrcgAddtlDtls", "_MtchgSts", "_LateDlvryDt", "_PlcOfClr", "_CcyToBuyOrSell", "_TpOfPric", "_SttlmDt", "_TradDt", "_Rptg", "_NbOfDaysAcrd", "_OpngClsg", "_TradTxCond", "_DealPric", "_FxAddtlDtls", "_UnqTxIdr", "_AffirmSts", "_TradId", "_PlcOfTrad"]
	@property
	def CollTxId(self):
