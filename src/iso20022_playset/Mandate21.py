...
class Mandate21(base_types._BaseFieldType):
	...
	__slots__ = ["_MndtReqId", "_Authntcn", "_Tp", "_UltmtCdtr", "_Ocrncs", "_Cdtr", "_Adjstmnt", "_Dbtr", "_DbtrAcct", "_CdtrAgt", "_MndtRef", "_Rsn", "_CdtrAcct", "_CdtrSchmeId", "_DbtrAgt", "_TrckgInd", "_FrstColltnAmt", "_ColltnAmt", "_MaxAmt", "_MndtId", "_UltmtDbtr", "_RfrdDoc"]
	@property
	def MndtReqId(self):
