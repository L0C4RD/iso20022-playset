...
class InquiryResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Rsk", "_OrgnlRspnCd", "_AddtlSvc", "_ICCRltdData", "_PrcgRslt", "_StrngCstmrAuthntcn", "_TxId", "_Dstn", "_AddtlData", "_Termnl", "_Acqrr", "_Hdr", "_SctyTrlr", "_AddtlAmt", "_AddtlFee", "_Issr", "_Accptr", "_Orgtr", "_Sndr", "_TxChrtcs", "_SpclPrgrmmQlfctn", "_AcctFr", "_SttlmSvc", "_AcctBal", "_Instlmt", "_Wllt", "_AcctStmtData", "_Rcvr", "_Vrfctn", "_ConvsDtTm", "_Rcncltn", "_Jursdctn", "_Tkn", "_Cntxt", "_Crdhldr", "_PrtctdData", "_TxAmts", "_Card", "_CardPrgrmm", "_SplmtryData"]
	@property
	def Rsk(self):
		return self._Rsk
