...
from .AccountStatementData3 import AccountStatementData3
...
class InquiryResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_ICCRltdData", "_SctyTrlr", "_Hdr", "_Orgtr", "_Acqrr", "_Accptr", "_Vrfctn", "_Jursdctn", "_Rcvr", "_Dstn", "_AddtlAmt", "_TxAmts", "_SttlmSvc", "_Rcncltn", "_Issr", "_SplmtryData", "_StrngCstmrAuthntcn", "_Card", "_Instlmt", "_TxChrtcs", "_Sndr", "_Termnl", "_AddtlData", "_OrgnlRspnCd", "_PrcgRslt", "_AcctStmtData", "_AddtlSvc", "_AcctFr", "_Wllt", "_Cntxt", "_SpclPrgrmmQlfctn", "_AddtlFee", "_PrtctdData", "_CardPrgrmm", "_TxId", "_Rsk", "_ConvsDtTm", "_Tkn", "_AcctBal", "_Crdhldr"]
	@property
	...
	def CardPrgrmm(self, value):
		self._CardPrgrmm = value if type(value) != auto else self.make_default("CardPrgrmm")
