...
class InquiryResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Instlmt", "_PrcgRslt", "_PrtctdData", "_TxAmts", "_TxChrtcs", "_CardPrgrmm", "_AddtlSvc", "_Crdhldr", "_Vrfctn", "_ConvsDtTm", "_Termnl", "_AcctStmtData", "_ICCRltdData", "_OrgnlRspnCd", "_SpclPrgrmmQlfctn", "_Rcncltn", "_AddtlData", "_Accptr", "_SttlmSvc", "_Issr", "_AcctBal", "_Wllt", "_Acqrr", "_Hdr", "_Dstn", "_Rcvr", "_Cntxt", "_Card", "_Jursdctn", "_Sndr", "_Rsk", "_AddtlFee", "_SplmtryData", "_AcctFr", "_Tkn", "_Orgtr", "_AddtlAmt", "_TxId", "_SctyTrlr", "_StrngCstmrAuthntcn"]
	@property
	def Instlmt(self):
