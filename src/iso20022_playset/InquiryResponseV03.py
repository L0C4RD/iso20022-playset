...
class InquiryResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlRspnCd", "_TxId", "_StrngCstmrAuthntcn", "_SpclPrgrmmQlfctn", "_AddtlData", "_Card", "_Issr", "_PrcgRslt", "_Acqrr", "_Dstn", "_Accptr", "_Termnl", "_SplmtryData", "_Hdr", "_TxAmts", "_AcctFr", "_AddtlSvc", "_SttlmSvc", "_Rcvr", "_AddtlAmt", "_CardPrgrmm", "_ConvsDtTm", "_Rcncltn", "_Tkn", "_Wllt", "_SctyTrlr", "_Orgtr", "_AddtlFee", "_Jursdctn", "_PrtctdData", "_Instlmt", "_Vrfctn", "_AcctStmtData", "_ICCRltdData", "_Crdhldr", "_Cntxt", "_AcctBal", "_Sndr", "_Rsk", "_TxChrtcs"]
	@property
