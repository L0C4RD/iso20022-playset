...
class ChargesPerTransactionRecord6(base_types._BaseFieldType):
	...
	__slots__ = ["_UndrlygTx", "_ValDt", "_DbtrAgt", "_AddtlInf", "_ChrgsRqstr", "_ChrgsBrkdwn", "_DbtrAgtAcct", "_ChrgsAcctAgt", "_ChrgsAcctAgtAcct", "_InstrForInstdAgt", "_SttlmInstr", "_TtlChrgsPerRcrd", "_Dbtr", "_RcrdId", "_DbtrAcct"]
	@property
	def UndrlygTx(self):
