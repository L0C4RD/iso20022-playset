...
class SecuritiesOption115(base_types._BaseFieldType):
	...
	__slots__ = ["_XmptnTp", "_IncmTp", "_CcyOptn", "_OthrIncmTp", "_RateDtls", "_CtryOfIncmSrc", "_RcvgSttlmPties", "_IssrOfferrTaxbltyInd", "_NewSctiesIssncInd", "_DlvrgSttlmPties", "_PstngQty", "_TempFinInstrmInd", "_PricDtls", "_SfkpgPlc", "_FrctnDspstn", "_AmtDtls", "_DtDtls", "_CdtDbtInd", "_FinInstrmId"]
	@property
	def XmptnTp(self):
