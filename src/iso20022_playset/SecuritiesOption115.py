...
class SecuritiesOption115(base_types._BaseFieldType):
	...
	__slots__ = ["_IssrOfferrTaxbltyInd", "_RcvgSttlmPties", "_NewSctiesIssncInd", "_CcyOptn", "_IncmTp", "_DtDtls", "_RateDtls", "_PricDtls", "_AmtDtls", "_FinInstrmId", "_DlvrgSttlmPties", "_CtryOfIncmSrc", "_PstngQty", "_CdtDbtInd", "_SfkpgPlc", "_FrctnDspstn", "_XmptnTp", "_TempFinInstrmInd", "_OthrIncmTp"]
	@property
