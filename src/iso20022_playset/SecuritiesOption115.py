...
class SecuritiesOption115(base_types._BaseFieldType):
	...
	__slots__ = ["_IssrOfferrTaxbltyInd", "_RcvgSttlmPties", "_CcyOptn", "_DtDtls", "_TempFinInstrmInd", "_CtryOfIncmSrc", "_PstngQty", "_PricDtls", "_IncmTp", "_RateDtls", "_FrctnDspstn", "_CdtDbtInd", "_FinInstrmId", "_XmptnTp", "_DlvrgSttlmPties", "_SfkpgPlc", "_AmtDtls", "_NewSctiesIssncInd", "_OthrIncmTp"]
	@property
