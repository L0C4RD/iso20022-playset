...
class SecuritiesOption115(base_types._BaseFieldType):
	...
	__slots__ = ["_SfkpgPlc", "_CdtDbtInd", "_XmptnTp", "_RateDtls", "_FinInstrmId", "_IncmTp", "_FrctnDspstn", "_NewSctiesIssncInd", "_CcyOptn", "_TempFinInstrmInd", "_PstngQty", "_DtDtls", "_PricDtls", "_CtryOfIncmSrc", "_DlvrgSttlmPties", "_IssrOfferrTaxbltyInd", "_RcvgSttlmPties", "_AmtDtls", "_OthrIncmTp"]
	@property
	def SfkpgPlc(self):
