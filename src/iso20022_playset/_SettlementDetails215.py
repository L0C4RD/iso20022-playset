...
from .SecuritiesTransactionType46Choice import SecuritiesTransactionType46Choice
...
class SettlementDetails215(base_types._BaseFieldType):
	...
	__slots__ = ["_ElgblForColl", "_NetgElgblty", "_SttlmTxCond", "_AutomtcBrrwg", "_SctiesTxTp", "_StmpDtyTaxBsis", "_BnfclOwnrsh", "_LglRstrctns", "_RpTp", "_Regn", "_Prty", "_SttlgCpcty", "_CshSubBalTp", "_TaxCpcty", "_CshClrSys", "_SttlmSysMtd", "_PrtlSttlmInd", "_BlckTrad", "_MktClntSd", "_SctiesSubBalTp", "_CCPElgblty", "_SctiesRTGS", "_XpsrTp", "_LttrOfGrnt"]
	@property
