...
class SettlementDetails215(base_types._BaseFieldType):
	...
	__slots__ = ["_LglRstrctns", "_SctiesRTGS", "_SctiesTxTp", "_AutomtcBrrwg", "_LttrOfGrnt", "_BnfclOwnrsh", "_CshSubBalTp", "_XpsrTp", "_SttlmTxCond", "_TaxCpcty", "_RpTp", "_Regn", "_CshClrSys", "_PrtlSttlmInd", "_SttlgCpcty", "_Prty", "_BlckTrad", "_SctiesSubBalTp", "_StmpDtyTaxBsis", "_SttlmSysMtd", "_MktClntSd", "_ElgblForColl", "_CCPElgblty", "_NetgElgblty"]
	@property
