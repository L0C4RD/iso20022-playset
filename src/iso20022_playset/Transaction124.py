...
class Transaction124(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrPtyCollTxRef", "_MrgnRate", "_DayCntBsis", "_BsktIdAndElgbltySetPrfl", "_CmonTxId", "_ValtnAmts", "_PricgRate", "_CollPties", "_ClntTrptyCollTxId", "_XpsrTp", "_TrptyAgtSvcPrvdrCollTxId", "_CshBal", "_ExctnReqdDt", "_ClsgDt", "_AutomtcAllcn", "_OptnTp", "_SctiesBal", "_TermntnOptn", "_SprdRate", "_TxSts"]
	@property
