...
class Transaction124(base_types._BaseFieldType):
	...
	__slots__ = ["_ClntTrptyCollTxId", "_CtrPtyCollTxRef", "_MrgnRate", "_DayCntBsis", "_BsktIdAndElgbltySetPrfl", "_CollPties", "_PricgRate", "_AutomtcAllcn", "_TxSts", "_XpsrTp", "_TermntnOptn", "_ValtnAmts", "_ExctnReqdDt", "_SctiesBal", "_CshBal", "_CmonTxId", "_ClsgDt", "_TrptyAgtSvcPrvdrCollTxId", "_SprdRate", "_OptnTp"]
	@property
