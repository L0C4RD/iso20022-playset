...
from .ProprietaryVote1 import ProprietaryVote1

class Vote14(base_types._BaseFieldType):

	__slots__ = ["_ThreeYrs", "_TwoYrs", "_IssrLabl", "_Blnk", "_Abstn", "_Wthhld", "_WthMgmt", "_AgnstMgmt", "_Dscrtnry", "_Prtry", "_ListgGrpRsltnLabl", "_NoActn", "_Agnst", "_OneYr", "_For"]
	@property
	def ThreeYrs(self):
