...
class ErrorV05(base_types._BaseFieldType):

	__slots__ = ["_AddtlFee", "_Dstn", "_ErrDtl", "_Hdr", "_Jursdctn", "_LifeCyclId", "_NtlData", "_OrgnlMsg", "_Orgtr", "_Prgrmm", "_PrtctdData", "_PrvtData", "_Rcncltn", "_Rcvr", "_RtrvlRefNb", "_SctyTrlr", "_Sndr", "_SttlmSvc", "_SysTracAudtNb", "_TrnsmssnDtTm"]
	@property
	def AddtlFee(self):
