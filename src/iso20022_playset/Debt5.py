...
class Debt5(base_types._BaseFieldType):
	...
	__slots__ = ["_CstPrePmtYld", "_LookBck", "_Purp", "_YldRg", "_DtdDt", "_WghtdAvrgCpn", "_XtndblInd", "_VarblRateInd", "_FrstPmtDt", "_CllblInd", "_CPPrgm", "_XprtnDt", "_AmtsblInd", "_FaceAmt", "_PmtFrqcy", "_PmtDrctnInd", "_IntrstRate", "_WhlPoolInd", "_CstPrePmtPnltyInd", "_Pdctn", "_MaxSbstitn", "_Hrcut", "_LotId", "_AutoRinvstmt", "_WghtdAvrgMtrty", "_PricFrqcy", "_PlsPerMln", "_YldClctn", "_Geogcs", "_InstrmStrTp", "_PerptlInd", "_EscrwdInd", "_PlsPerTrad", "_TxConds", "_MtrtyDt", "_Pcs", "_SbstitnLft", "_PricRg", "_RstrctdInd", "_NxtFctr", "_BkQlfdInd", "_IntrstClctnMtd", "_WghtdAvrgLife", "_OverAlltmtAmt", "_NxtIntrstRate", "_PreFnddInd", "_PmtCcy", "_CpnRg", "_WghtdAvrgLn", "_InsrdInd", "_CurFctr", "_PutblDt", "_GblTp", "_OverAlltmtRate", "_IntrstAcrlDt", "_IntrstTp", "_PotntlEuroSysElgblty", "_NxtCpnDt", "_CPRegnTp", "_MinIncrmt", "_SbstitnFrqcy", "_PutblInd", "_Sctr", "_PricSrc", "_PrvsFctr", "_PlsMax", "_NxtCllblDt", "_IntrstFxgDt", "_OddCpnInd", "_NxtFctrDt", "_AltrntvMinTaxInd", "_CptlsdIntrst", "_XtndblPrd", "_SubrdntdInd", "_PlsPerLot", "_MinQty", "_ActlDnmtnAmt"]
	@property
