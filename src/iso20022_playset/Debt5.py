...
class Debt5(base_types._BaseFieldType):
	...
	__slots__ = ["_ActlDnmtnAmt", "_PmtFrqcy", "_PlsPerMln", "_PmtDrctnInd", "_YldRg", "_EscrwdInd", "_XtndblInd", "_GblTp", "_FrstPmtDt", "_AltrntvMinTaxInd", "_IntrstFxgDt", "_NxtCllblDt", "_VarblRateInd", "_PutblInd", "_RstrctdInd", "_IntrstClctnMtd", "_WghtdAvrgMtrty", "_Pcs", "_YldClctn", "_PlsPerTrad", "_FaceAmt", "_BkQlfdInd", "_SbstitnLft", "_LotId", "_PlsPerLot", "_CstPrePmtYld", "_PricFrqcy", "_WghtdAvrgCpn", "_LookBck", "_MinQty", "_NxtFctr", "_Geogcs", "_CPRegnTp", "_OddCpnInd", "_PreFnddInd", "_IntrstTp", "_PlsMax", "_Sctr", "_CptlsdIntrst", "_PricSrc", "_XprtnDt", "_PutblDt", "_SubrdntdInd", "_TxConds", "_CstPrePmtPnltyInd", "_WhlPoolInd", "_NxtIntrstRate", "_Purp", "_CllblInd", "_Hrcut", "_InstrmStrTp", "_CPPrgm", "_PrvsFctr", "_CpnRg", "_SbstitnFrqcy", "_PmtCcy", "_AmtsblInd", "_DtdDt", "_MinIncrmt", "_Pdctn", "_XtndblPrd", "_PerptlInd", "_CurFctr", "_OverAlltmtRate", "_NxtFctrDt", "_WghtdAvrgLife", "_IntrstAcrlDt", "_IntrstRate", "_NxtCpnDt", "_WghtdAvrgLn", "_OverAlltmtAmt", "_PotntlEuroSysElgblty", "_AutoRinvstmt", "_InsrdInd", "_PricRg", "_MaxSbstitn", "_MtrtyDt"]
	@property
