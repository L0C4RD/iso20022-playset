import base_types
import Frequency35Choice
import YesNoIndicator
import PercentageRate
import DistributionPolicy2Choice
import PaymentDirectionIndicator
import Max350Text
import InterestType3Code
import ActiveCurrencyAndAmount
import DateTimePeriod1Choice
import InstrumentSubStructureType2Choice
import FinancialInstrumentQuantity1Choice
import GlobalNote2Choice
import Max70Text
import DecimalNumber
import ISODateTime
import ActiveCurrencyCode
import TradeTransactionCondition7Choice
import YieldCalculation6
import Max35Text
import Max256Text
import Number
import AmountOrPercentageRange1

class Debt5(base_types._BaseFieldType):

	__slots__ = ["_CstPrePmtYld", "_PrvsFctr", "_CPRegnTp", "_VarblRateInd", "_GblTp", "_RstrctdInd", "_MinQty", "_Pcs", "_PmtDrctnInd", "_DtdDt", "_IntrstTp", "_OverAlltmtRate", "_PutblInd", "_CurFctr", "_CstPrePmtPnltyInd", "_XprtnDt", "_NxtIntrstRate", "_IntrstFxgDt", "_WghtdAvrgLn", "_CllblInd", "_PerptlInd", "_AmtsblInd", "_WghtdAvrgMtrty", "_SbstitnFrqcy", "_WhlPoolInd", "_EscrwdInd", "_IntrstAcrlDt", "_ActlDnmtnAmt", "_PlsPerMln", "_FaceAmt", "_YldClctn", "_MinIncrmt", "_NxtFctr", "_OverAlltmtAmt", "_LotId", "_Pdctn", "_YldRg", "_PlsMax", "_TxConds", "_PricRg", "_XtndblInd", "_MtrtyDt", "_InstrmStrTp", "_NxtCllblDt", "_Purp", "_PlsPerLot", "_CpnRg", "_IntrstRate", "_WghtdAvrgCpn", "_PmtFrqcy", "_PricFrqcy", "_Geogcs", "_LookBck", "_PotntlEuroSysElgblty", "_Sctr", "_PutblDt", "_MaxSbstitn", "_SbstitnLft", "_OddCpnInd", "_AutoRinvstmt", "_InsrdInd", "_WghtdAvrgLife", "_BkQlfdInd", "_XtndblPrd", "_NxtCpnDt", "_PricSrc", "_CPPrgm", "_NxtFctrDt", "_CptlsdIntrst", "_FrstPmtDt", "_PreFnddInd", "_Hrcut", "_PlsPerTrad", "_SubrdntdInd", "_PmtCcy", "_AltrntvMinTaxInd", "_IntrstClctnMtd"]
	@property
