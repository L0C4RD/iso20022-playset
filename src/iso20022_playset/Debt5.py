...
class Debt5(base_types._BaseFieldType):
	...
	__slots__ = ["_PricFrqcy", "_PricRg", "_PmtCcy", "_CstPrePmtYld", "_AmtsblInd", "_NxtCllblDt", "_ActlDnmtnAmt", "_VarblRateInd", "_WhlPoolInd", "_Geogcs", "_MinQty", "_NxtFctr", "_IntrstFxgDt", "_EscrwdInd", "_WghtdAvrgMtrty", "_YldRg", "_XprtnDt", "_PrvsFctr", "_BkQlfdInd", "_WghtdAvrgLn", "_PlsPerMln", "_NxtIntrstRate", "_CPPrgm", "_SbstitnFrqcy", "_PreFnddInd", "_PlsPerLot", "_PutblInd", "_SubrdntdInd", "_DtdDt", "_IntrstRate", "_MinIncrmt", "_CllblInd", "_LotId", "_OverAlltmtRate", "_PlsMax", "_SbstitnLft", "_OddCpnInd", "_PerptlInd", "_RstrctdInd", "_WghtdAvrgCpn", "_CpnRg", "_PutblDt", "_CPRegnTp", "_AltrntvMinTaxInd", "_CptlsdIntrst", "_AutoRinvstmt", "_FrstPmtDt", "_WghtdAvrgLife", "_TxConds", "_LookBck", "_IntrstClctnMtd", "_PmtDrctnInd", "_IntrstTp", "_Pdctn", "_Pcs", "_MtrtyDt", "_CurFctr", "_InsrdInd", "_XtndblPrd", "_GblTp", "_XtndblInd", "_Sctr", "_FaceAmt", "_Hrcut", "_Purp", "_PricSrc", "_PlsPerTrad", "_NxtFctrDt", "_InstrmStrTp", "_MaxSbstitn", "_PmtFrqcy", "_CstPrePmtPnltyInd", "_PotntlEuroSysElgblty", "_OverAlltmtAmt", "_IntrstAcrlDt", "_NxtCpnDt", "_YldClctn"]
	@property
	def PricFrqcy(self):
