...
from ._ReceiveInformation21 import ReceiveInformation21
...
class TransferOutInstructionV09(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmDtls", "_MsgId", "_TrfDtls", "_RltdRef", "_PoolRef", "_AcctDtls", "_PrvsRef", "_MstrRef", "_Xtnsn", "_MktPrctcVrsn", "_CpyDtls"]
	@property
	def AcctDtls(self):
