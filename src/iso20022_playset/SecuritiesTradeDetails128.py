...
class SecuritiesTradeDetails128(base_types._BaseFieldType):
	...
	__slots__ = ["_TradTxCond", "_FxAddtlDtls", "_TradDt", "_PlcOfClr", "_FctvSttlmDt", "_OpngClsg", "_InvstrCpcty", "_TradOrgtrRole", "_CollTxId", "_DealPric", "_SttlmInstrPrcgAddtlDtls", "_SttlmDt", "_TpOfPric", "_PlcOfTrad", "_NbOfDaysAcrd", "_TradId", "_Rptg"]
	@property
	def TradTxCond(self):
