...
from .SettlementDate22Choice import SettlementDate22Choice

class SecuritiesTradeDetails128(base_types._BaseFieldType):

	__slots__ = ["_TradDt", "_FctvSttlmDt", "_DealPric", "_InvstrCpcty", "_Rptg", "_TpOfPric", "_PlcOfTrad", "_CollTxId", "_PlcOfClr", "_NbOfDaysAcrd", "_TradId", "_TradOrgtrRole", "_OpngClsg", "_TradTxCond", "_SttlmDt", "_SttlmInstrPrcgAddtlDtls", "_FxAddtlDtls"]
	@property
	def TradDt(self):
		return self._TradDt
