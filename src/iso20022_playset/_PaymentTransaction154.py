...
class PaymentTransaction154(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlUETR", "_Case", "_OrgnlEndToEndId", "_OrgnlReqdExctnDt", "_SplmtryData", "_CxlRsnInf", "_OrgnlInstdAmt", "_OrgnlTxRef", "_CxlId", "_OrgnlReqdColltnDt", "_OrgnlInstrId"]
	@property
	def OrgnlUETR(self):
