...
class AncillaryPurchase3(base_types._BaseFieldType):
	...
	__slots__ = ["_CdtDbt", "_SvcSubCtgyCd", "_Amt", "_CdtRsnCd", "_Fee", "_Tax", "_SvcCtgyCd", "_DocNb", "_AddtlData", "_SvcPrvdrSvcTp", "_RltdDocNb", "_SummryCmmdtyId"]
	@property
	def CdtDbt(self):
		return self._CdtDbt
	...
	def SvcCtgyCd(self, value):
		self._SvcCtgyCd = value if type(value) != auto else self.make_default("SvcCtgyCd")
