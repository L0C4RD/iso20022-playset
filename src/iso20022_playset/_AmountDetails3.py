...
from . import Tax41
from . import TypeTypeOfAmount23Code
...
class AmountDetails3(base_types._BaseFieldType):
	...
	@Tp.setter
	def Tp(self, value):
		self._Tp = value if value is not None else base_types.UninitialisedField(self, 'Tp', TypeTypeOfAmount23Code, False)

	@Tp.deleter
	def Tp(self):
		del self._Tp
		self._Tp = base_types.UninitialisedField(self, 'Tp', TypeTypeOfAmount23Code, False)
