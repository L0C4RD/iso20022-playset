...
class TradeRecurrentQuery7(base_types._BaseFieldType):
	...
	def Frqcy(self, value):
		self._Frqcy = value if value is not None else base_types.UninitialisedField(self, 'Frqcy', TradeQueryExecutionFrequency3, True)

	@Frqcy.deleter
	def Frqcy(self):
		del self._Frqcy
		self._Frqcy = base_types.UninitialisedField(self, 'Frqcy', TradeQueryExecutionFrequency3, True)
