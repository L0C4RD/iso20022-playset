...
from . import TradeLegNotificationCancellationV04
...
class SECL_002_001_04():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def TradLegNtfctnCxl(self, value):
			self._TradLegNtfctnCxl = value if value is not None else base_types.UninitialisedField(self, 'TradLegNtfctnCxl', TradeLegNotificationCancellationV04, False)

		@TradLegNtfctnCxl.deleter
		def TradLegNtfctnCxl(self):
			del self._TradLegNtfctnCxl
			self._TradLegNtfctnCxl = base_types.UninitialisedField(self, 'TradLegNtfctnCxl', TradeLegNotificationCancellationV04, False)
