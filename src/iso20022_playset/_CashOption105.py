...
class CashOption105(base_types._BaseFieldType):
	...
	__slots__ = ["_CtryOfIncmSrc", "_OthrIncmTp", "_TaxVchrDtls", "_PricDtls", "_CdtDbtInd", "_DtDtls", "_FXDtls", "_CtrctlPmtInd", "_IncmTp", "_XmptnTp", "_CshPties", "_IssrOfferrTaxbltyInd", "_RateAndAmtDtls", "_AmtDtls", "_Acct"]
	@property
