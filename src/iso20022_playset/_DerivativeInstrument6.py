...
from .AssetClassAttributes1Choice import AssetClassAttributes1Choice
from .PhysicalTransferType4Code import PhysicalTransferType4Code
from .OptionType2Code import OptionType2Code
from .UnderlyingIdentification2Choice import UnderlyingIdentification2Choice
from .OptionStyle7Code import OptionStyle7Code
from .SecuritiesTransactionPrice4Choice import SecuritiesTransactionPrice4Choice
from .NonNegativeDecimalNumber import NonNegativeDecimalNumber

class DerivativeInstrument6(base_types._BaseFieldType):

	__slots__ = ["_UndrlygInstrm", "_OptnExrcStyle", "_OptnTp", "_StrkPric", "_DlvryTp", "_AsstClssSpcfcAttrbts", "_XpryDt", "_PricMltplr"]
	@property
