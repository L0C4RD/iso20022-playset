...
class CorporateAction84(base_types._BaseFieldType):
	...
	__slots__ = ["_PricDtls", "_CnsntTp", "_DtchAuctnTp", "_AddtlInf", "_FrftrOfIntrstInd", "_CertfctnBrkdwnInd", "_NewPlcOfIncorprtn", "_AcrdIntrstInd", "_ChrgsApldInd", "_IntrstAcrdNbOfDays", "_ShrhldrRghtsDrctvInd", "_CptlGnInOutInd", "_ElctnTp", "_OcrncTp", "_CertfctnTp", "_SctiesQty", "_AddtlBizPrcInd", "_AccptncPrtyLvl", "_IntrmdtSctiesDstrbtnTp", "_PrdDtls", "_LttrOfGrntedDlvryInd", "_EvtSeqTp", "_OfferTp", "_RnncblEntitlmntStsTp", "_LtryTp", "_TaxblIncmPerShrClctd", "_RstrctnInd", "_DvddTp", "_TaxOnNonDstrbtdPrcdsInd", "_RateAndAmtDtls", "_ChngTp", "_InfTp", "_EvtStag", "_DtDtls", "_CpnNb"]
	@property
	def PricDtls(self):
