...
class CashCollateral2(base_types._BaseFieldType):
	...
	def RtrXcss(self, value):
		self._RtrXcss = value if value is not None else base_types.UninitialisedField(self, 'RtrXcss', YesNoIndicator, False)

	@RtrXcss.deleter
	def RtrXcss(self):
		del self._RtrXcss
		self._RtrXcss = base_types.UninitialisedField(self, 'RtrXcss', YesNoIndicator, False)
