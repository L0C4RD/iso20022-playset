...
class CorporateActionBalanceDetails43(base_types._BaseFieldType):
	...
	__slots__ = ["_RegdBal", "_TtlElgblBal", "_SttlmPosBal", "_InTrnsShipmntBal", "_InstdBal", "_PdgRctBal", "_StrtPosBal", "_OnLnBal", "_CollOutBal", "_UafctdBal", "_TradDtPosBal", "_AfctdBal", "_BrrwdBal", "_CollInBal", "_UinstdBal", "_PdgDlvryBal", "_OblgtdBal", "_BlckdBal", "_OutForRegnBal"]
	@property
	def RegdBal(self):
