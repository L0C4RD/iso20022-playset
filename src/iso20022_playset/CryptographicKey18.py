...
class CryptographicKey18(base_types._BaseFieldType):
	...
	__slots__ = ["_CmpntWthAuthrsdAccs", "_ItmNb", "_PrtctdCmpntWthAuthrsdAccs", "_ActvtnDt", "_Tp", "_SctyPrfl", "_Id", "_KeyVal", "_Fctn", "_Vrsn", "_AddtlId", "_KeyChckVal", "_AddtlMgmtInf", "_Nm", "_DeactvtnDt"]
	@property
