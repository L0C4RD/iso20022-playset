...
class CryptographicKey18(base_types._BaseFieldType):
	...
	__slots__ = ["_ItmNb", "_Fctn", "_DeactvtnDt", "_Id", "_Vrsn", "_CmpntWthAuthrsdAccs", "_KeyChckVal", "_AddtlMgmtInf", "_Nm", "_KeyVal", "_PrtctdCmpntWthAuthrsdAccs", "_ActvtnDt", "_AddtlId", "_SctyPrfl", "_Tp"]
	@property
	def ItmNb(self):
		return self._ItmNb
