...
class CryptographicKey18(base_types._BaseFieldType):
	...
	__slots__ = ["_Nm", "_CmpntWthAuthrsdAccs", "_Vrsn", "_ItmNb", "_PrtctdCmpntWthAuthrsdAccs", "_KeyVal", "_ActvtnDt", "_SctyPrfl", "_Fctn", "_DeactvtnDt", "_Tp", "_KeyChckVal", "_Id", "_AddtlMgmtInf", "_AddtlId"]
	@property
	def Nm(self):
		return self._Nm
