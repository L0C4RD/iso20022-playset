...
class CryptographicKey18(base_types._BaseFieldType):
	...
	__slots__ = ["_ItmNb", "_AddtlId", "_SctyPrfl", "_ActvtnDt", "_AddtlMgmtInf", "_Id", "_Tp", "_DeactvtnDt", "_Fctn", "_CmpntWthAuthrsdAccs", "_KeyChckVal", "_PrtctdCmpntWthAuthrsdAccs", "_Vrsn", "_Nm", "_KeyVal"]
	@property
	def ItmNb(self):
		return self._ItmNb
