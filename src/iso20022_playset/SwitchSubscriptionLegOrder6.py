...
class SwitchSubscriptionLegOrder6(base_types._BaseFieldType):
	...
	__slots__ = ["_TxOvrhd", "_SttlmAndCtdyDtls", "_ReqdNAVCcy", "_FinInstrmQtyChc", "_InvstmtAcctDtls", "_PhysDlvryDtls", "_IncmPref", "_ReqdSttlmCcy", "_NonStdSttlmInf", "_Equlstn", "_LegId", "_PhysDlvryInd", "_FinInstrmDtls"]
	@property
	def TxOvrhd(self):
