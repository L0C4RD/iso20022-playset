...
class SwitchSubscriptionLegOrder6(base_types._BaseFieldType):
	...
	__slots__ = ["_TxOvrhd", "_FinInstrmQtyChc", "_ReqdSttlmCcy", "_SttlmAndCtdyDtls", "_FinInstrmDtls", "_PhysDlvryInd", "_NonStdSttlmInf", "_InvstmtAcctDtls", "_Equlstn", "_ReqdNAVCcy", "_LegId", "_PhysDlvryDtls", "_IncmPref"]
	@property
	def TxOvrhd(self):
