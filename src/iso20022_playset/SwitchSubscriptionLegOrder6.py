...
import FinancialInstrumentQuantity26Choice
...
class SwitchSubscriptionLegOrder6(base_types._BaseFieldType):
	...
	__slots__ = ["_TxOvrhd", "_PhysDlvryInd", "_FinInstrmQtyChc", "_ReqdSttlmCcy", "_SttlmAndCtdyDtls", "_NonStdSttlmInf", "_FinInstrmDtls", "_InvstmtAcctDtls", "_ReqdNAVCcy", "_LegId", "_PhysDlvryDtls", "_Equlstn", "_IncmPref"]
	@property
	def TxOvrhd(self):
