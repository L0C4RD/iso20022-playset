...
from .RecordMessage1Choice import RecordMessage1Choice
from .Max35Text import Max35Text
from .ISO3NumericCurrencyCode import ISO3NumericCurrencyCode
from .OtherAmount5 import OtherAmount5
from .CreditDebit3Code import CreditDebit3Code
from .ISODate import ISODate
from .ClearingMethod2Code import ClearingMethod2Code
...
class Record3(base_types._BaseFieldType):
	...
	__slots__ = ["_IntrchngFeeAmt", "_RcrdMsg", "_AgtFeeAmt", "_DstnShrtNm", "_ClrCdtDbt", "_OthrAmt", "_OrgtrId", "_IntrchngFeeCdtDbt", "_AgtFeeCcy", "_ClrDt", "_DstnAssgnr", "_ClrMtd", "_AgtFeeCdtDbt", "_OrgtrShrtNm", "_RcrdChcksmInptVal", "_IntrchngFeeCcy", "_ClrAmt", "_DstnId", "_DstnCtry", "_ClrPrty", "_ClrCcy", "_OrgtrAssgnr", "_OthrClrMtd", "_SeqCntr", "_OrgtrCtry"]
	@property
