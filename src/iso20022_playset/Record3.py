...
class Record3(base_types._BaseFieldType):
	...
	__slots__ = ["_RcrdMsg", "_ClrCcy", "_ClrCdtDbt", "_OrgtrShrtNm", "_OrgtrCtry", "_SeqCntr", "_DstnId", "_IntrchngFeeAmt", "_ClrPrty", "_DstnShrtNm", "_DstnCtry", "_AgtFeeCcy", "_IntrchngFeeCdtDbt", "_OthrAmt", "_RcrdChcksmInptVal", "_AgtFeeAmt", "_OrgtrId", "_IntrchngFeeCcy", "_ClrMtd", "_ClrDt", "_OthrClrMtd", "_AgtFeeCdtDbt", "_OrgtrAssgnr", "_ClrAmt", "_DstnAssgnr"]
	@property
	def RcrdMsg(self):
