...
class Record3(base_types._BaseFieldType):
	...
	__slots__ = ["_ClrPrty", "_AgtFeeCcy", "_AgtFeeCdtDbt", "_OrgtrAssgnr", "_IntrchngFeeAmt", "_DstnCtry", "_ClrCdtDbt", "_SeqCntr", "_DstnId", "_OthrClrMtd", "_OrgtrShrtNm", "_ClrMtd", "_IntrchngFeeCdtDbt", "_DstnAssgnr", "_RcrdChcksmInptVal", "_DstnShrtNm", "_IntrchngFeeCcy", "_AgtFeeAmt", "_OrgtrId", "_ClrCcy", "_ClrAmt", "_OthrAmt", "_OrgtrCtry", "_RcrdMsg", "_ClrDt"]
	@property
	def ClrPrty(self):
