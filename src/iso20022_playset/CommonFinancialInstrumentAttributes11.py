...
class CommonFinancialInstrumentAttributes11(base_types._BaseFieldType):
	...
	__slots__ = ["_Cnfdtl", "_TEFRARule", "_Rstrctn", "_PmryPlcOfDpst", "_LeadMgr", "_UndrlygRsk", "_PutTp", "_ConvsRatioDnmtr", "_RedPmtCcy", "_DnmtnCcy", "_PmtSts", "_WhldgTaxRgm", "_SctySts", "_FinInstrmIdVldty", "_LglRstrctns", "_FngbInd", "_CertNb", "_ClssfctnTp", "_ConvsPrd", "_FinInstrmForm", "_RcrdDt", "_ConvtblInd", "_AftrXchgPhysForm", "_Clss", "_FinInstrmNm", "_NearTermPosLmt", "_TradgMkt", "_InitlPhysForm", "_SctyCSDLk", "_PoolNb", "_CallTp", "_ListgDt", "_SrNb", "_CvrdInd", "_RedTp", "_TaxLotNb", "_PrncplPngAgt", "_PngAgt", "_PrvtPlcmnt", "_CmonSfkpr", "_Purp", "_PosLmt", "_CpnAttchdNb", "_ConvsRatioNmrtr", "_XpryDt", "_SprdAndBchmkCrv", "_SttlmInf", "_TradgMtd", "_CtrctVrsnNb", "_CtctNm", "_Issnc", "_Dpstry"]
	@property
	def Cnfdtl(self):
		return self._Cnfdtl
