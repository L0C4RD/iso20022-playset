...
from . import OriginalPaymentInstruction52
from . import SupplementaryData1

class CreditorPaymentActivationRequestStatusReportV12(base_types._BaseFieldType):
	...
	def OrgnlPmtInfAndSts(self, value):
		self._OrgnlPmtInfAndSts = value if value is not None else base_types.UninitialisedField(self, 'OrgnlPmtInfAndSts', OriginalPaymentInstruction52, True)

	@OrgnlPmtInfAndSts.deleter
	def OrgnlPmtInfAndSts(self):
		del self._OrgnlPmtInfAndSts
		self._OrgnlPmtInfAndSts = base_types.UninitialisedField(self, 'OrgnlPmtInfAndSts', OriginalPaymentInstruction52, True)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='OrgnlPmtInfAndSts', type=OriginalPaymentInstruction52, min=0, max=None, mutex_group=None, array=True),
