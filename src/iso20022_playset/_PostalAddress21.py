...
from ._AddressType2Choice import AddressType2Choice
...
class PostalAddress21(base_types._BaseFieldType):
	...
	__slots__ = ["_Ctry", "_CareOf", "_Flr", "_Stat", "_MlngInd", "_SdInBldg", "_BldgNb", "_PstBx", "_AdrTp", "_Vllg", "_AdrLine", "_DstrctNm", "_SuiteId", "_RegnAdrInd", "_PstCd", "_StrtNm", "_TwnNm", "_BldgNm"]
	@property
	def AdrLine(self):
	...
	def SdInBldg(self, value):
		self._SdInBldg = value if type(value) != base_types.auto else self.make_default("SdInBldg")
	...
	def SuiteId(self, value):
		self._SuiteId = value if type(value) != base_types.auto else self.make_default("SuiteId")
	...
	@Vllg.setter
	def Vllg(self, value):
		self._Vllg = value if type(value) != base_types.auto else self.make_default("Vllg")
