...
class PostalAddress21(base_types._BaseFieldType):
	...
	__slots__ = ["_Vllg", "_MlngInd", "_SuiteId", "_Ctry", "_BldgNm", "_PstBx", "_Flr", "_SdInBldg", "_RegnAdrInd", "_DstrctNm", "_StrtNm", "_CareOf", "_Stat", "_BldgNb", "_PstCd", "_AdrLine", "_TwnNm", "_AdrTp"]
	@property
	def Vllg(self):
		return self._Vllg
