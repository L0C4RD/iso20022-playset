...
class PostalAddress21(base_types._BaseFieldType):
	...
	__slots__ = ["_DstrctNm", "_CareOf", "_SdInBldg", "_BldgNm", "_MlngInd", "_AdrTp", "_RegnAdrInd", "_AdrLine", "_Vllg", "_Flr", "_StrtNm", "_PstCd", "_Stat", "_TwnNm", "_BldgNb", "_SuiteId", "_PstBx", "_Ctry"]
	@property
	def DstrctNm(self):
