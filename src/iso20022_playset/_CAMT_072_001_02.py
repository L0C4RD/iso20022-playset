...
from . import IntraBalanceMovementModificationRequestV02
...
class CAMT_072_001_02():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def IntraBalMvmntModReq(self, value):
			self._IntraBalMvmntModReq = value if value is not None else base_types.UninitialisedField(self, 'IntraBalMvmntModReq', IntraBalanceMovementModificationRequestV02, False)

		@IntraBalMvmntModReq.deleter
		def IntraBalMvmntModReq(self):
			del self._IntraBalMvmntModReq
			self._IntraBalMvmntModReq = base_types.UninitialisedField(self, 'IntraBalMvmntModReq', IntraBalanceMovementModificationRequestV02, False)
