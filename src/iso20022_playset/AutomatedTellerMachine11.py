...
from .ATMDevice2Code import ATMDevice2Code
from .ATMEquipment1 import ATMEquipment1
from .PostalAddress17 import PostalAddress17
from .PointOfInteractionCapabilities10 import PointOfInteractionCapabilities10
from .ActiveCurrencyCode import ActiveCurrencyCode
from .TransactionEnvironment2Code import TransactionEnvironment2Code
from .Max35Text import Max35Text

class AutomatedTellerMachine11(base_types._BaseFieldType):

	__slots__ = ["_AvlblDvc", "_Id", "_LctnCtgy", "_BaseCcy", "_Cpblties", "_SeqNb", "_Eqpmnt", "_Lctn", "_AddtlId"]
	@property
	def AvlblDvc(self):
		return self._AvlblDvc

	@AvlblDvc.setter
	def AvlblDvc(self, value):
		self._AvlblDvc = value if type(value) != base_types.auto else self.make_default("AvlblDvc")
	...
	_field_defs = frozenset((
		base_types.FieldEntry(name='AvlblDvc', type=ATMDevice2Code, min=0, max=None, mutex_group=None, array=True),
