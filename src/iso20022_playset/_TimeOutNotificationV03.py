...
from .TimeOutResult2 import TimeOutResult2
...
class TimeOutNotificationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_TxSts", "_UsrTxRef", "_TxId", "_TmOutDesc", "_NtfctnId", "_EstblishdBaselnId", "_ReqForActn"]
	@property
	def TxSts(self):
		return self._TxSts
	...
	def TmOutDesc(self, value):
		self._TmOutDesc = value if type(value) != base_types.auto else self.make_default("TmOutDesc")
