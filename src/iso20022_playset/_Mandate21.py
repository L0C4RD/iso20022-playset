...
class Mandate21(base_types._BaseFieldType):
	...
	__slots__ = ["_Tp", "_CdtrAgt", "_Authntcn", "_Adjstmnt", "_MndtReqId", "_MndtRef", "_MaxAmt", "_UltmtDbtr", "_UltmtCdtr", "_RfrdDoc", "_Rsn", "_ColltnAmt", "_FrstColltnAmt", "_MndtId", "_CdtrAcct", "_Cdtr", "_Dbtr", "_Ocrncs", "_DbtrAgt", "_TrckgInd", "_DbtrAcct", "_CdtrSchmeId"]
	@property
	def Tp(self):
		return self._Tp
