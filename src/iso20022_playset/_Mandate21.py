...
class Mandate21(base_types._BaseFieldType):
	...
	__slots__ = ["_CdtrAgt", "_MndtReqId", "_RfrdDoc", "_MaxAmt", "_TrckgInd", "_UltmtCdtr", "_Authntcn", "_Rsn", "_UltmtDbtr", "_Dbtr", "_ColltnAmt", "_MndtId", "_MndtRef", "_Tp", "_Adjstmnt", "_DbtrAcct", "_FrstColltnAmt", "_Ocrncs", "_Cdtr", "_DbtrAgt", "_CdtrAcct", "_CdtrSchmeId"]
	@property
	def CdtrAgt(self):
