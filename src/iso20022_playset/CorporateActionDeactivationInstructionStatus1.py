...
from .CorporateActionDeactivationInstructionRejectionStatus1 import CorporateActionDeactivationInstructionRejectionStatus1
...
from .CorporateActionDeactivationInstructionProcessingStatus1 import CorporateActionDeactivationInstructionProcessingStatus1

class CorporateActionDeactivationInstructionStatus1(base_types._BaseFieldType):

	__slots__ = ["_RjctdSts", "_PrcdSts", "_OptnNb", "_OptnTp"]
	@property
	def RjctdSts(self):
