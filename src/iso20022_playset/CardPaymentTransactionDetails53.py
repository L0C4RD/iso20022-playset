...
class CardPaymentTransactionDetails53(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlInf", "_DlvryLctn", "_InvcAmt", "_ReSubmissnCntr", "_UattnddLvlCtgy", "_VldtyDt", "_TtlAmt", "_CcyConvsRslt", "_ReqdAmt", "_AggtnTx", "_AuthrsdAmt", "_PdctCdSetId", "_OnLineRsn", "_AmtQlfr", "_Instlmt", "_DtldAmt", "_CmpltnSeqCntr", "_AcctTp", "_TtlAuthrsdAmt", "_CmltvAmt", "_ICCRltdData", "_Rcrng", "_Ccy", "_CmpltnSeqNb", "_SaleItm"]
	@property
	def AddtlInf(self):
