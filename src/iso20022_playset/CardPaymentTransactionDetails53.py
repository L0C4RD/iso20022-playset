...
class CardPaymentTransactionDetails53(base_types._BaseFieldType):
	...
	__slots__ = ["_VldtyDt", "_InvcAmt", "_CmpltnSeqNb", "_AcctTp", "_CmpltnSeqCntr", "_CcyConvsRslt", "_OnLineRsn", "_AddtlInf", "_SaleItm", "_AggtnTx", "_ReSubmissnCntr", "_Ccy", "_AuthrsdAmt", "_TtlAuthrsdAmt", "_Instlmt", "_DtldAmt", "_CmltvAmt", "_PdctCdSetId", "_ICCRltdData", "_ReqdAmt", "_Rcrng", "_TtlAmt", "_DlvryLctn", "_UattnddLvlCtgy", "_AmtQlfr"]
	@property
	def VldtyDt(self):
