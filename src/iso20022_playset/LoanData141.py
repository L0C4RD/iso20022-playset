...
from .SecurityCommodity9 import SecurityCommodity9
...
class LoanData141(base_types._BaseFieldType):

	__slots__ = ["_UnqTradIdr", "_ExctnDtTm", "_DlvryByVal", "_LnVal", "_EvtDt", "_TradgVn", "_ValDt", "_LndgFee", "_CollDlvryMtd", "_Term", "_RbtRate", "_ClrSts", "_MstrAgrmt", "_GnlColl", "_AsstTp", "_TermntnDt"]
	@property
	def UnqTradIdr(self):
	...
	def RbtRate(self, value):
		self._RbtRate = value if type(value) != auto else self.make_default("RbtRate")
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='AsstTp', type=SecurityCommodity9, min=0, max=1, mutex_group=None, array=False),
