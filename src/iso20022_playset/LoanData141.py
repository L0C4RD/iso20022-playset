...
class LoanData141(base_types._BaseFieldType):
	...
	__slots__ = ["_TradgVn", "_LnVal", "_MstrAgrmt", "_ExctnDtTm", "_LndgFee", "_DlvryByVal", "_CollDlvryMtd", "_ClrSts", "_EvtDt", "_Term", "_TermntnDt", "_AsstTp", "_RbtRate", "_UnqTradIdr", "_ValDt", "_GnlColl"]
	@property
	def TradgVn(self):
