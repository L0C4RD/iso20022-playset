...
class InvestmentAccountOwnershipInformation16(base_types._BaseFieldType):
	...
	__slots__ = ["_FsclXmptn", "_MnyLndrgChck", "_MailTp", "_CtrlgPty", "_EqtyVal", "_TaxRptg", "_Lang", "_TaxXmptn", "_Pty", "_InvstrPrflVldtn", "_OthrId", "_AddtlRgltryInf", "_AcctgSts", "_CpnyLk", "_CtryAndResdtlSts", "_FATCASts", "_MntryWlth", "_MiFIDClssfctn", "_Ntfctn", "_OwnrshBnfcryRate", "_CRSRptgDt", "_PmryComAdr", "_FATCARptgDt", "_ScndryComAdr", "_AddtlInf", "_ElctrncMlngSvcRef", "_SgntryRghtInd", "_ClntId", "_FATCAFormTp", "_CRSFormTp", "_CRSSts", "_WorkgCptl"]
	@property
	def FsclXmptn(self):
