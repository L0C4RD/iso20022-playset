...
class InvestmentAccountOwnershipInformation16(base_types._BaseFieldType):
	...
	__slots__ = ["_WorkgCptl", "_MailTp", "_CtrlgPty", "_ClntId", "_AddtlInf", "_OthrId", "_SgntryRghtInd", "_OwnrshBnfcryRate", "_Lang", "_Pty", "_MnyLndrgChck", "_Ntfctn", "_CpnyLk", "_CRSRptgDt", "_FsclXmptn", "_CRSSts", "_InvstrPrflVldtn", "_CtryAndResdtlSts", "_AddtlRgltryInf", "_FATCASts", "_TaxXmptn", "_TaxRptg", "_PmryComAdr", "_CRSFormTp", "_AcctgSts", "_MntryWlth", "_FATCARptgDt", "_ElctrncMlngSvcRef", "_MiFIDClssfctn", "_EqtyVal", "_FATCAFormTp", "_ScndryComAdr"]
	@property
	def WorkgCptl(self):
