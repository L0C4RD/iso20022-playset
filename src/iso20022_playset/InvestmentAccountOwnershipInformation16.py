...
from .Party47Choice import Party47Choice
...
class InvestmentAccountOwnershipInformation16(base_types._BaseFieldType):
	...
	__slots__ = ["_FATCASts", "_AcctgSts", "_CpnyLk", "_TaxXmptn", "_OthrId", "_CtryAndResdtlSts", "_CRSFormTp", "_CRSSts", "_FATCAFormTp", "_PmryComAdr", "_OwnrshBnfcryRate", "_Pty", "_Ntfctn", "_FsclXmptn", "_ElctrncMlngSvcRef", "_AddtlRgltryInf", "_ClntId", "_AddtlInf", "_InvstrPrflVldtn", "_TaxRptg", "_MailTp", "_MiFIDClssfctn", "_EqtyVal", "_WorkgCptl", "_FATCARptgDt", "_CtrlgPty", "_MnyLndrgChck", "_ScndryComAdr", "_SgntryRghtInd", "_MntryWlth", "_CRSRptgDt", "_Lang"]
	@property
	def FATCASts(self):
