...
class InvestmentAccountOwnershipInformation16(base_types._BaseFieldType):
	...
	__slots__ = ["_FATCASts", "_FATCAFormTp", "_ElctrncMlngSvcRef", "_SgntryRghtInd", "_TaxXmptn", "_MailTp", "_AcctgSts", "_Pty", "_TaxRptg", "_InvstrPrflVldtn", "_FATCARptgDt", "_MiFIDClssfctn", "_PmryComAdr", "_ScndryComAdr", "_WorkgCptl", "_OthrId", "_CpnyLk", "_CtrlgPty", "_AddtlRgltryInf", "_AddtlInf", "_MntryWlth", "_CRSRptgDt", "_Lang", "_EqtyVal", "_Ntfctn", "_CRSFormTp", "_CRSSts", "_ClntId", "_MnyLndrgChck", "_CtryAndResdtlSts", "_FsclXmptn", "_OwnrshBnfcryRate"]
	@property
	def FATCASts(self):
