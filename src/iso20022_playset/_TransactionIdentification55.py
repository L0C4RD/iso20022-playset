...
class TransactionIdentification55(base_types._BaseFieldType):
	...
	__slots__ = ["_PurchsIdr", "_AuthstnSeqNb", "_PurchsIdrTp", "_LclTm", "_AuthntcnTkn", "_OthrPurchsIdrTp", "_LclDt", "_IssrRefData", "_LifeCyclId", "_AssoctdDataRef", "_SysTracAudtNb", "_PresntmntSeqNb", "_LifeCyclSpprt", "_TmZone", "_AcqrrRefData", "_AcqrrRefNb", "_RtrvlRefNb", "_AssoctdDataDstn", "_PresntmntSeqCnt", "_TrnsmssnDtTm", "_LifeCyclIdMssng", "_AssoctdData"]
	@property
