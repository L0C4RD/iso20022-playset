...
class FinancialInstrumentAttributes133(base_types._BaseFieldType):
	...
	__slots__ = ["_IsseDt", "_NxtIntrstRate", "_MinNmnlQty", "_CtrctSz", "_ConvsDt", "_NxtCllblDt", "_FltgRateFxgDt", "_PlcOfListg", "_NxtFctr", "_IntrstRate", "_MtrtyDt", "_PutblDt", "_DtdDt", "_FinInstrmId", "_DayCntBsis", "_NxtCpnDt", "_ClssfctnTp", "_XpryDt", "_PrvsFctr", "_DnmtnCcy"]
	@property
	def IsseDt(self):
		return self._IsseDt
