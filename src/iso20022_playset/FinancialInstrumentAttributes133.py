...
class FinancialInstrumentAttributes133(base_types._BaseFieldType):
	...
	__slots__ = ["_XpryDt", "_FltgRateFxgDt", "_PlcOfListg", "_DtdDt", "_NxtCllblDt", "_FinInstrmId", "_NxtFctr", "_DnmtnCcy", "_PutblDt", "_IsseDt", "_ConvsDt", "_DayCntBsis", "_PrvsFctr", "_MinNmnlQty", "_NxtIntrstRate", "_MtrtyDt", "_NxtCpnDt", "_CtrctSz", "_IntrstRate", "_ClssfctnTp"]
	@property
	def XpryDt(self):
		return self._XpryDt
