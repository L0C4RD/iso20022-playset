...
from . import PartyAndAuthorisation6
...
class OperationMandate6(base_types._BaseFieldType):
	...
	def MndtHldr(self, value):
		self._MndtHldr = value if value is not None else base_types.UninitialisedField(self, 'MndtHldr', PartyAndAuthorisation6, True)

	@MndtHldr.deleter
	def MndtHldr(self):
		del self._MndtHldr
		self._MndtHldr = base_types.UninitialisedField(self, 'MndtHldr', PartyAndAuthorisation6, True)
