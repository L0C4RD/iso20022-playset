...
from .ExposureType25Choice import ExposureType25Choice
from .LetterOfGuarantee4Choice import LetterOfGuarantee4Choice
from .SettlementTransactionCondition33Choice import SettlementTransactionCondition33Choice
from .PriorityNumeric4Choice import PriorityNumeric4Choice
from .SettlingCapacity7Choice import SettlingCapacity7Choice
from .AutomaticBorrowing6Choice import AutomaticBorrowing6Choice
from .DeliveryReturn3Choice import DeliveryReturn3Choice
...
from .RepurchaseType23Choice import RepurchaseType23Choice
from .SecuritiesTransactionType47Choice import SecuritiesTransactionType47Choice
...
class SettlementDetails219(base_types._BaseFieldType):
	...
	__slots__ = ["_CshClrSys", "_DlvrgSctiesSubBalTp", "_ElgblForColl", "_CCPElgblty", "_StmpDtyTaxBsis", "_BlckTrad", "_MktClntSd", "_ModCxlAllwd", "_Regn", "_NetgElgblty", "_TaxCpcty", "_SttlmTxCond", "_LglRstrctns", "_SctiesTxTp", "_RpTp", "_SttlgCpcty", "_HldInd", "_Trckg", "_CshSubBalTp", "_RtrLeg", "_FxStgInstr", "_XpsrTp", "_SctiesRTGS", "_Prty", "_BnfclOwnrsh", "_RcvgSctiesSubBalTp", "_SttlmSysMtd", "_LttrOfGrnt", "_DlvryRtrRsn", "_PrtlSttlmInd", "_AutomtcBrrwg"]
	@property
	def CshClrSys(self):
	...
	def DlvrgSctiesSubBalTp(self, value):
		self._DlvrgSctiesSubBalTp = value if type(value) != auto else self.make_default("DlvrgSctiesSubBalTp")
	...
	def RcvgSctiesSubBalTp(self, value):
		self._RcvgSctiesSubBalTp = value if type(value) != auto else self.make_default("RcvgSctiesSubBalTp")
	...
	def DlvryRtrRsn(self, value):
		self._DlvryRtrRsn = value if type(value) != auto else self.make_default("DlvryRtrRsn")
