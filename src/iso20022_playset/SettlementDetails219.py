...
class SettlementDetails219(base_types._BaseFieldType):
	...
	__slots__ = ["_RpTp", "_TaxCpcty", "_NetgElgblty", "_MktClntSd", "_Regn", "_AutomtcBrrwg", "_CshClrSys", "_FxStgInstr", "_CCPElgblty", "_BlckTrad", "_SttlgCpcty", "_LttrOfGrnt", "_PrtlSttlmInd", "_BnfclOwnrsh", "_SttlmSysMtd", "_SctiesTxTp", "_HldInd", "_XpsrTp", "_RtrLeg", "_SttlmTxCond", "_StmpDtyTaxBsis", "_Trckg", "_DlvrgSctiesSubBalTp", "_RcvgSctiesSubBalTp", "_Prty", "_SctiesRTGS", "_ElgblForColl", "_ModCxlAllwd", "_CshSubBalTp", "_DlvryRtrRsn", "_LglRstrctns"]
	@property
	def RpTp(self):
		return self._RpTp
