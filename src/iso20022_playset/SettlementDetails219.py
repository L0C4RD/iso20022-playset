...
class SettlementDetails219(base_types._BaseFieldType):
	...
	__slots__ = ["_HldInd", "_ElgblForColl", "_FxStgInstr", "_NetgElgblty", "_TaxCpcty", "_SctiesTxTp", "_DlvrgSctiesSubBalTp", "_CshClrSys", "_ModCxlAllwd", "_Regn", "_MktClntSd", "_RtrLeg", "_Prty", "_Trckg", "_CshSubBalTp", "_RcvgSctiesSubBalTp", "_StmpDtyTaxBsis", "_DlvryRtrRsn", "_LttrOfGrnt", "_SctiesRTGS", "_CCPElgblty", "_LglRstrctns", "_PrtlSttlmInd", "_SttlmSysMtd", "_SttlmTxCond", "_AutomtcBrrwg", "_BnfclOwnrsh", "_RpTp", "_XpsrTp", "_SttlgCpcty", "_BlckTrad"]
	@property
	def HldInd(self):
		return self._HldInd
