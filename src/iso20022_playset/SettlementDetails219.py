...
class SettlementDetails219(base_types._BaseFieldType):
	...
	__slots__ = ["_RtrLeg", "_CshClrSys", "_CCPElgblty", "_SctiesTxTp", "_RcvgSctiesSubBalTp", "_SctiesRTGS", "_ModCxlAllwd", "_SttlgCpcty", "_AutomtcBrrwg", "_NetgElgblty", "_BlckTrad", "_BnfclOwnrsh", "_TaxCpcty", "_SttlmSysMtd", "_RpTp", "_DlvryRtrRsn", "_LglRstrctns", "_LttrOfGrnt", "_PrtlSttlmInd", "_StmpDtyTaxBsis", "_Trckg", "_ElgblForColl", "_XpsrTp", "_SttlmTxCond", "_MktClntSd", "_Regn", "_DlvrgSctiesSubBalTp", "_CshSubBalTp", "_HldInd", "_FxStgInstr", "_Prty"]
	@property
	def RtrLeg(self):
		return self._RtrLeg
