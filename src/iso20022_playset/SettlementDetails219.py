...
import SettlementTransactionCondition33Choice
import Registration9Choice
import DeliveryReturn3Choice
...
import RepurchaseType23Choice
import SettlementTransactionCondition5Code
import SecuritiesTransactionType47Choice

class SettlementDetails219(base_types._BaseFieldType):

	__slots__ = ["_Prty", "_CshClrSys", "_SttlgCpcty", "_TaxCpcty", "_RcvgSctiesSubBalTp", "_DlvryRtrRsn", "_FxStgInstr", "_ElgblForColl", "_Regn", "_LglRstrctns", "_BnfclOwnrsh", "_ModCxlAllwd", "_SttlmTxCond", "_SttlmSysMtd", "_RtrLeg", "_CCPElgblty", "_AutomtcBrrwg", "_NetgElgblty", "_DlvrgSctiesSubBalTp", "_MktClntSd", "_CshSubBalTp", "_HldInd", "_RpTp", "_SctiesRTGS", "_StmpDtyTaxBsis", "_XpsrTp", "_BlckTrad", "_PrtlSttlmInd", "_Trckg", "_LttrOfGrnt", "_SctiesTxTp"]
	@property
	def Prty(self):
		return self._Prty
