...
from . import CorporateActionMovementPreliminaryAdviceV17
...
class SEEV_035_001_17():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def CorpActnMvmntPrlimryAdvc(self, value):
			self._CorpActnMvmntPrlimryAdvc = value if value is not None else base_types.UninitialisedField(self, 'CorpActnMvmntPrlimryAdvc', CorporateActionMovementPreliminaryAdviceV17, False)

		@CorpActnMvmntPrlimryAdvc.deleter
		def CorpActnMvmntPrlimryAdvc(self):
			del self._CorpActnMvmntPrlimryAdvc
			self._CorpActnMvmntPrlimryAdvc = base_types.UninitialisedField(self, 'CorpActnMvmntPrlimryAdvc', CorporateActionMovementPreliminaryAdviceV17, False)
