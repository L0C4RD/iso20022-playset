...
from .NotificationStatus3Code import NotificationStatus3Code
from .Max140Text import Max140Text
from .OriginalNotificationReference13 import OriginalNotificationReference13
from .Max35Text import Max35Text

class OriginalNotification15(base_types._BaseFieldType):

	__slots__ = ["_OrgnlMsgId", "_OrgnlNtfctnRef", "_OrgnlCreDtTm", "_AddtlStsInf", "_OrgnlNtfctnId", "_NtfctnSts"]
	@property
	def OrgnlMsgId(self):
