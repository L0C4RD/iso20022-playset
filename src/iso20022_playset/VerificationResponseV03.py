...
class VerificationResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlRspnCd", "_TxId", "_StrngCstmrAuthntcn", "_SpclPrgrmmQlfctn", "_AddtlData", "_Card", "_Issr", "_Acqrr", "_Dstn", "_Accptr", "_Termnl", "_SplmtryData", "_Hdr", "_TxAmts", "_AcctFr", "_AddtlSvc", "_SttlmSvc", "_Tkn", "_Rcvr", "_AddtlAmt", "_Rcncltn", "_ConvsDtTm", "_Rsk", "_Wllt", "_SctyTrlr", "_Orgtr", "_AddtlFee", "_PrcgRslt", "_Jursdctn", "_TxChrtcs", "_AcctTo", "_PrtctdData", "_Instlmt", "_Vrfctn", "_ICCRltdData", "_Crdhldr", "_Cntxt", "_AcctBal", "_Sndr", "_Prgrmm"]
	@property
