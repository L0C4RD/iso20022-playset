...
class VerificationResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Instlmt", "_PrtctdData", "_TxAmts", "_AddtlSvc", "_Crdhldr", "_Vrfctn", "_ConvsDtTm", "_Termnl", "_ICCRltdData", "_OrgnlRspnCd", "_SpclPrgrmmQlfctn", "_Rcncltn", "_AddtlData", "_Accptr", "_SttlmSvc", "_Prgrmm", "_Issr", "_AcctBal", "_Wllt", "_Acqrr", "_Hdr", "_Dstn", "_Rcvr", "_Cntxt", "_Card", "_Tkn", "_Jursdctn", "_Sndr", "_Rsk", "_AddtlFee", "_SplmtryData", "_AcctFr", "_PrcgRslt", "_TxChrtcs", "_Orgtr", "_AddtlAmt", "_AcctTo", "_TxId", "_SctyTrlr", "_StrngCstmrAuthntcn"]
	@property
	def Instlmt(self):
