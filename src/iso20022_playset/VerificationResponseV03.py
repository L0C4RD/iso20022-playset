...
class VerificationResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_Rsk", "_AcctTo", "_OrgnlRspnCd", "_AddtlSvc", "_ICCRltdData", "_StrngCstmrAuthntcn", "_TxId", "_Dstn", "_AddtlData", "_Termnl", "_Acqrr", "_Hdr", "_SctyTrlr", "_AddtlAmt", "_AddtlFee", "_Issr", "_Accptr", "_Orgtr", "_Sndr", "_Prgrmm", "_SpclPrgrmmQlfctn", "_AcctFr", "_SttlmSvc", "_AcctBal", "_Instlmt", "_PrcgRslt", "_Wllt", "_Rcvr", "_Vrfctn", "_ConvsDtTm", "_Rcncltn", "_Jursdctn", "_Cntxt", "_Crdhldr", "_Tkn", "_PrtctdData", "_TxAmts", "_Card", "_TxChrtcs"]
	@property
