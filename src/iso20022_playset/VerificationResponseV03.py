...
class VerificationResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctTo", "_Dstn", "_PrtctdData", "_Crdhldr", "_TxAmts", "_Card", "_Vrfctn", "_AcctBal", "_Rcvr", "_Jursdctn", "_Wllt", "_Orgtr", "_SctyTrlr", "_Prgrmm", "_Termnl", "_Hdr", "_Rsk", "_SttlmSvc", "_Sndr", "_AddtlFee", "_ICCRltdData", "_AddtlData", "_Rcncltn", "_SpclPrgrmmQlfctn", "_Tkn", "_Accptr", "_StrngCstmrAuthntcn", "_Instlmt", "_AcctFr", "_Issr", "_OrgnlRspnCd", "_PrcgRslt", "_AddtlAmt", "_SplmtryData", "_TxChrtcs", "_Acqrr", "_Cntxt", "_ConvsDtTm", "_AddtlSvc", "_TxId"]
	@property
	def AcctTo(self):
		return self._AcctTo
