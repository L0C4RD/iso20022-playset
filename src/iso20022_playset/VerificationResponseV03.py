...
class VerificationResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_ICCRltdData", "_SctyTrlr", "_Hdr", "_Orgtr", "_Acqrr", "_Accptr", "_Vrfctn", "_Jursdctn", "_Rcvr", "_Prgrmm", "_PrcgRslt", "_Dstn", "_AddtlAmt", "_TxAmts", "_SttlmSvc", "_Rcncltn", "_TxChrtcs", "_Issr", "_SplmtryData", "_Tkn", "_StrngCstmrAuthntcn", "_Card", "_Instlmt", "_AddtlData", "_Sndr", "_Termnl", "_OrgnlRspnCd", "_AddtlSvc", "_AcctFr", "_Wllt", "_AcctTo", "_Cntxt", "_SpclPrgrmmQlfctn", "_AddtlFee", "_PrtctdData", "_TxId", "_Rsk", "_ConvsDtTm", "_AcctBal", "_Crdhldr"]
	@property
