...
from . import RequestType3Choice
...
class MessageHeader4(base_types._BaseFieldType):
	...
	def ReqTp(self, value):
		self._ReqTp = value if value is not None else base_types.UninitialisedField(self, 'ReqTp', RequestType3Choice, False)

	@ReqTp.deleter
	def ReqTp(self):
		del self._ReqTp
		self._ReqTp = base_types.UninitialisedField(self, 'ReqTp', RequestType3Choice, False)
