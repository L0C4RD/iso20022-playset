...
class ChargesRecord11(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlInf", "_ChrgsAcctOwnr", "_DbtrAgtAcct", "_ChrgsRqstr", "_ValDt", "_Dbtr", "_RcrdId", "_CdtDbtInd", "_ChrgsAcct", "_UndrlygTx", "_Amt", "_ChrgsId", "_DbtrAgt", "_InstrForInstdAgt", "_Tp", "_DbtrAcct"]
	@property
	def AddtlInf(self):
