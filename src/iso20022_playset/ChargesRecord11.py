...
class ChargesRecord11(base_types._BaseFieldType):
	...
	__slots__ = ["_Tp", "_AddtlInf", "_CdtDbtInd", "_ValDt", "_ChrgsId", "_Dbtr", "_DbtrAcct", "_RcrdId", "_DbtrAgtAcct", "_InstrForInstdAgt", "_DbtrAgt", "_ChrgsAcct", "_Amt", "_ChrgsAcctOwnr", "_ChrgsRqstr", "_UndrlygTx"]
	@property
	def Tp(self):
		return self._Tp
