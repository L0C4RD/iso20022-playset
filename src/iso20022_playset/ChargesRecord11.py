...
class ChargesRecord11(base_types._BaseFieldType):
	...
	__slots__ = ["_UndrlygTx", "_DbtrAgtAcct", "_ChrgsId", "_Amt", "_Tp", "_Dbtr", "_RcrdId", "_ChrgsAcctOwnr", "_ValDt", "_DbtrAgt", "_AddtlInf", "_ChrgsRqstr", "_InstrForInstdAgt", "_CdtDbtInd", "_ChrgsAcct", "_DbtrAcct"]
	@property
	def UndrlygTx(self):
