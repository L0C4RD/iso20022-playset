...
class CorporateActionOption238(base_types._BaseFieldType):
	...
	__slots__ = ["_OptnFeatrs", "_TtlElgblBal", "_OptnTp", "_CshAcct", "_InstdBal", "_SfkpgAcct", "_StsQty", "_SfkpgPlc", "_BlckChainAdrOrWllt", "_FinInstrmId", "_OptnNb", "_StsCshAmt", "_SlctnDealrFeeInd", "_UinstdBal", "_PrtctBal", "_AcctOwnr"]
	@property
	def OptnFeatrs(self):
