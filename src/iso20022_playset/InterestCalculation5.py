...
class InterestCalculation5(base_types._BaseFieldType):
	...
	__slots__ = ["_AggtdIntrstAmt", "_NbOfDays", "_AcrdIntrstAmt", "_IntrstRate", "_BlckChainAdrOrWllt", "_PrncplAmt", "_FctvPrncplAmt", "_CollAcctId", "_Sprd", "_FctvRate", "_MvmntAmt", "_ClctnDt"]
	@property
