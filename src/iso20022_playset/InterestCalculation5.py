...
class InterestCalculation5(base_types._BaseFieldType):
	...
	__slots__ = ["_NbOfDays", "_MvmntAmt", "_CollAcctId", "_FctvPrncplAmt", "_FctvRate", "_IntrstRate", "_Sprd", "_ClctnDt", "_AcrdIntrstAmt", "_PrncplAmt", "_AggtdIntrstAmt", "_BlckChainAdrOrWllt"]
	@property
	def NbOfDays(self):
