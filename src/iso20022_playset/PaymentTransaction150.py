...
class PaymentTransaction150(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlEndToEndId", "_StsRsnInf", "_AcctSvcrRef", "_PmtCondSts", "_OrgnlInstrId", "_ChrgsInf", "_OrgnlUETR", "_AccptncDtTm", "_NclsdFile", "_OrgnlTxRef", "_TxSts", "_DbtrDcsnDtTm", "_SplmtryData", "_StsId", "_ClrSysRef"]
	@property
