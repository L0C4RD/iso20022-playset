...
class PaymentTransaction150(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlEndToEndId", "_ChrgsInf", "_ClrSysRef", "_DbtrDcsnDtTm", "_PmtCondSts", "_SplmtryData", "_AccptncDtTm", "_TxSts", "_AcctSvcrRef", "_OrgnlInstrId", "_OrgnlTxRef", "_NclsdFile", "_StsId", "_OrgnlUETR", "_StsRsnInf"]
	@property
