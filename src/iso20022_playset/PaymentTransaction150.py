...
class PaymentTransaction150(base_types._BaseFieldType):
	...
	__slots__ = ["_PmtCondSts", "_TxSts", "_SplmtryData", "_StsRsnInf", "_OrgnlTxRef", "_OrgnlUETR", "_DbtrDcsnDtTm", "_ClrSysRef", "_OrgnlEndToEndId", "_ChrgsInf", "_AcctSvcrRef", "_AccptncDtTm", "_OrgnlInstrId", "_StsId", "_NclsdFile"]
	@property
	def PmtCondSts(self):
