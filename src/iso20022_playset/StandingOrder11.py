...
from .StandingOrderType1Choice import StandingOrderType1Choice
from .Max35Text import Max35Text
from .StandingOrderTotalAmount1 import StandingOrderTotalAmount1
...
class StandingOrder11(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlsPerStgOrdr", "_VldtyPrd", "_CdtDbtInd", "_Frqcy", "_ExctnTp", "_RspnsblPty", "_Dbtr", "_Ref", "_LkSetOrdrSeq", "_SysMmb", "_AssoctdPoolAcct", "_LkSetId", "_Ccy", "_ZeroSweepInd", "_CdtrAcct", "_LkSetOrdrId", "_Amt", "_Cdtr", "_Tp", "_DbtrAcct"]
	@property
	...
	def TtlsPerStgOrdr(self, value):
		self._TtlsPerStgOrdr = value if type(value) != auto else self.make_default("TtlsPerStgOrdr")
