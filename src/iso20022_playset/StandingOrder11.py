...
class StandingOrder11(base_types._BaseFieldType):
	...
	__slots__ = ["_DbtrAcct", "_CdtrAcct", "_Cdtr", "_ExctnTp", "_Dbtr", "_Ccy", "_RspnsblPty", "_LkSetId", "_AssoctdPoolAcct", "_VldtyPrd", "_LkSetOrdrId", "_Frqcy", "_Amt", "_Tp", "_ZeroSweepInd", "_Ref", "_CdtDbtInd", "_LkSetOrdrSeq", "_SysMmb", "_TtlsPerStgOrdr"]
	@property
	def DbtrAcct(self):
