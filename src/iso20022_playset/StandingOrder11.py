...
class StandingOrder11(base_types._BaseFieldType):
	...
	__slots__ = ["_AssoctdPoolAcct", "_Tp", "_SysMmb", "_RspnsblPty", "_DbtrAcct", "_ExctnTp", "_Dbtr", "_TtlsPerStgOrdr", "_CdtrAcct", "_LkSetId", "_VldtyPrd", "_LkSetOrdrSeq", "_LkSetOrdrId", "_Amt", "_Ref", "_Cdtr", "_Ccy", "_Frqcy", "_ZeroSweepInd", "_CdtDbtInd"]
	@property
