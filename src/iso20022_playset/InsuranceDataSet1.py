...
class InsuranceDataSet1(base_types._BaseFieldType):
	...
	__slots__ = ["_ClmsPyblAt", "_InsrncConds", "_IsseDt", "_Assrd", "_Trnsprt", "_ClmsPyblIn", "_InsrdAmt", "_Issr", "_InsrncDocId", "_InsrncClauses", "_PlcOfIsse", "_DataSetId", "_FctvDt", "_InsrdGoodsDesc"]
	@property
	def ClmsPyblAt(self):
