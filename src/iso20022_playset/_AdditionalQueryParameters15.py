...
from . import Reason21Choice
from . import SecurityIdentification19
from . import Status19Choice

class AdditionalQueryParameters15(base_types._BaseFieldType):
	...
	@Rsn.setter
	def Rsn(self, value):
		self._Rsn = value if value is not None else base_types.UninitialisedField(self, 'Rsn', Reason21Choice, True)

	@Rsn.deleter
	def Rsn(self):
		del self._Rsn
		self._Rsn = base_types.UninitialisedField(self, 'Rsn', Reason21Choice, True)
