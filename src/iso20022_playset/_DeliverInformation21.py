...
class DeliverInformation21(base_types._BaseFieldType):
	...
	__slots__ = ["_PhysTrfDtls", "_IncmPref", "_FXDtls", "_SctiesForm", "_Trfr", "_SttlmPtiesDtls", "_NetAmt", "_TrfrRegdAcct", "_IndvTax", "_BnfcryCertfctnCmpltn", "_PhysTrf", "_ReqdTradDt", "_ClntRef", "_Fees", "_ReqdSttlmDt", "_StmpDty", "_DmtrlsdInd", "_SttlmAmt", "_IntrmyInf"]
	@property
