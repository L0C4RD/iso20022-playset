...
class RedemptionExecution16(base_types._BaseFieldType):
	...
	__slots__ = ["_BnfcryDtls", "_BestExctn", "_SttlmMtd", "_PrtlRedWhldgAmt", "_OrdrRef", "_SttlmAndCtdyDtls", "_PhysDlvryInd", "_CstmrCndctClssfctn", "_IntrmPrftAmt", "_UnitsNb", "_GrssAmt", "_ClntRef", "_OrdrWvrDtls", "_LateRpt", "_GtgOrHldBckDtls", "_InvstmtAcctDtls", "_RltdPtyDtls", "_TxChanlTp", "_SgntrTp", "_PrtlyExctdInd", "_NetAmt", "_CumDvddInd", "_Rndg", "_DealRef", "_DealgPricDtls", "_InftvTaxDtls", "_StffClntBrkdwn", "_PhysDlvryDtls", "_Grp1Or2Units", "_NgtdTrad", "_PrtlSttlmOfUnits", "_OrdrTp", "_PrtlSttlmOfCsh", "_TxOvrhd", "_InftvPricDtls", "_FinAdvc", "_FXDtls", "_SttlmAmt", "_CshSttlmDtls", "_HldgsRedRate", "_NonStdSttlmInf", "_CshSttlmDt", "_Equlstn", "_IncmPref", "_TradDtTm"]
	@property
	def BnfcryDtls(self):
