...
class Drawdown2(base_types._BaseFieldType):
	...
	__slots__ = ["_InvstrTaxRef", "_PnsnCmcmntLumpSumRmng", "_Id", "_PctgOfTtlTrfVal", "_TtlAmtNetDrwdwn", "_MltplPnsnCmcmntLumpSums", "_AddtlFndsDsgntd", "_LftmAllwnc", "_BnfcryDtls", "_FlxblDrwdwnTrggrdDt", "_CapdLmts", "_TrchTp", "_AplblRules", "_AddtlInf", "_RcptOfDrwdwnInd", "_PnsnCmcmntLumpSumDt"]
	@property
