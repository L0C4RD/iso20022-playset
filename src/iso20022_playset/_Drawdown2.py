...
from . import BeneficiaryDrawdown1
from . import Capped1
...
class Drawdown2(base_types._BaseFieldType):
	...
	def BnfcryDtls(self, value):
		self._BnfcryDtls = value if value is not None else base_types.UninitialisedField(self, 'BnfcryDtls', BeneficiaryDrawdown1, False)

	@BnfcryDtls.deleter
	def BnfcryDtls(self):
		del self._BnfcryDtls
		self._BnfcryDtls = base_types.UninitialisedField(self, 'BnfcryDtls', BeneficiaryDrawdown1, False)
