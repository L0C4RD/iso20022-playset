...
class Drawdown2(base_types._BaseFieldType):
	...
	__slots__ = ["_PnsnCmcmntLumpSumDt", "_AplblRules", "_MltplPnsnCmcmntLumpSums", "_FlxblDrwdwnTrggrdDt", "_InvstrTaxRef", "_TrchTp", "_AddtlFndsDsgntd", "_RcptOfDrwdwnInd", "_PnsnCmcmntLumpSumRmng", "_BnfcryDtls", "_TtlAmtNetDrwdwn", "_CapdLmts", "_LftmAllwnc", "_AddtlInf", "_Id", "_PctgOfTtlTrfVal"]
	@property
