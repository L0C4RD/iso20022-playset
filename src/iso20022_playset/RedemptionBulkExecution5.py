...
class RedemptionBulkExecution5(base_types._BaseFieldType):
	...
	__slots__ = ["_RcvdDtTm", "_IndvExctnDtls", "_FinInstrmDtls", "_ReqdFutrTradDt", "_CxlRght", "_AmdmntInd", "_MstrRef", "_TtlSttlmAmt", "_ReqdNAVCcy", "_ReqdSttlmCcy", "_PlcOfTrad", "_BlkCshSttlmDtls", "_OrdrDtTm"]
	@property
	def RcvdDtTm(self):
