...
class RedemptionBulkExecution5(base_types._BaseFieldType):
	...
	__slots__ = ["_OrdrDtTm", "_TtlSttlmAmt", "_PlcOfTrad", "_ReqdFutrTradDt", "_AmdmntInd", "_ReqdSttlmCcy", "_BlkCshSttlmDtls", "_FinInstrmDtls", "_CxlRght", "_RcvdDtTm", "_MstrRef", "_ReqdNAVCcy", "_IndvExctnDtls"]
	@property
	def OrdrDtTm(self):
