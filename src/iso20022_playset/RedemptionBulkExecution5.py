...
class RedemptionBulkExecution5(base_types._BaseFieldType):
	...
	__slots__ = ["_CxlRght", "_IndvExctnDtls", "_BlkCshSttlmDtls", "_MstrRef", "_AmdmntInd", "_ReqdSttlmCcy", "_RcvdDtTm", "_ReqdNAVCcy", "_PlcOfTrad", "_OrdrDtTm", "_ReqdFutrTradDt", "_TtlSttlmAmt", "_FinInstrmDtls"]
	@property
	def CxlRght(self):
