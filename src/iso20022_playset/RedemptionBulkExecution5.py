...
class RedemptionBulkExecution5(base_types._BaseFieldType):
	...
	__slots__ = ["_IndvExctnDtls", "_ReqdFutrTradDt", "_TtlSttlmAmt", "_ReqdNAVCcy", "_OrdrDtTm", "_RcvdDtTm", "_BlkCshSttlmDtls", "_ReqdSttlmCcy", "_PlcOfTrad", "_AmdmntInd", "_MstrRef", "_FinInstrmDtls", "_CxlRght"]
	@property
