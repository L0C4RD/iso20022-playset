...
class SecuritiesSettlementTransactionInstructionV12(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_DgtlNtwkFee", "_NbCounts", "_CshPties", "_SttlmAmt", "_SttlmParams", "_FinInstrmAttrbts", "_Lnkgs", "_FinInstrmId", "_TradDtls", "_AddtlPhysOrRegnDtls", "_DlvrgSttlmPties", "_RcvgSttlmPties", "_SttlmTpAndAddtlParams", "_OthrAmts", "_OthrBizPties", "_QtyAndAcctDtls", "_TxId", "_StgSttlmInstrDtls"]
	@property
