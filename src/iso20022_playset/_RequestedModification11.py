...
class RequestedModification11(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmInf", "_IntrBkSttlmAmt", "_SttlmTmIndctn", "_RltdRmtInf", "_ChrgBr", "_CdtrAgtAcct", "_UltmtDbtr", "_UltmtCdtr", "_EndToEndId", "_Purp", "_Amt", "_InstrForDbtrAgt", "_ReqdColltnDt", "_InstrId", "_CdtrAcct", "_Cdtr", "_Dbtr", "_RmtInf", "_InstrForNxtAgt", "_ReqdExctnDt", "_InstrForCdtrAgt", "_DbtrAgtAcct", "_TxId", "_PmtTpInf", "_DbtrAcct", "_IntrBkSttlmDt"]
	@property
	def SttlmInf(self):
