...
class OvernightIndexSwapTransaction4(base_types._BaseFieldType):
	...
	__slots__ = ["_TradDt", "_TxTp", "_RptdTxSts", "_PrtryTxId", "_CtrPtyId", "_FxdIntrstRate", "_MtrtyDt", "_TxNmnlAmt", "_CtrPtyPrtryTxId", "_SplmtryData", "_NvtnSts", "_BrnchId", "_RltdPrtryTxId", "_UnqTxIdr", "_StartDt"]
	@property
	def TradDt(self):
		return self._TradDt
