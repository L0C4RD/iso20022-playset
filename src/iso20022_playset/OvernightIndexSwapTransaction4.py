...
from .OvernightIndexSwapType1Code import OvernightIndexSwapType1Code
...
class OvernightIndexSwapTransaction4(base_types._BaseFieldType):
	...
	__slots__ = ["_TxNmnlAmt", "_RltdPrtryTxId", "_TxTp", "_UnqTxIdr", "_BrnchId", "_StartDt", "_TradDt", "_CtrPtyId", "_SplmtryData", "_RptdTxSts", "_NvtnSts", "_CtrPtyPrtryTxId", "_MtrtyDt", "_FxdIntrstRate", "_PrtryTxId"]
	@property
	def TxNmnlAmt(self):
