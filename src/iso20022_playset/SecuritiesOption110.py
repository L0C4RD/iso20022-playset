...
import CorporateActionRate123
import FinancialInstrumentAttributes129
...
class SecuritiesOption110(base_types._BaseFieldType):
	...
	__slots__ = ["_PricDtls", "_CtryOfIncmSrc", "_OthrIncmTp", "_IncmTp", "_FrctnDspstn", "_XmptnTp", "_CdtDbtInd", "_EntitldQty", "_SfkpgPlc", "_CcyOptn", "_IssrOfferrTaxbltyInd", "_TempFinInstrmInd", "_NewSctiesIssncInd", "_NonElgblPrcdsInd", "_TradgPrd", "_SctyDtls", "_RateDtls", "_AmtDtls", "_DtDtls"]
	@property
	def PricDtls(self):
