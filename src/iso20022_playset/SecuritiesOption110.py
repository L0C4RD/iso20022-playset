...
class SecuritiesOption110(base_types._BaseFieldType):
	...
	__slots__ = ["_PricDtls", "_CcyOptn", "_EntitldQty", "_OthrIncmTp", "_CtryOfIncmSrc", "_IncmTp", "_DtDtls", "_TradgPrd", "_FrctnDspstn", "_AmtDtls", "_RateDtls", "_IssrOfferrTaxbltyInd", "_XmptnTp", "_SctyDtls", "_SfkpgPlc", "_TempFinInstrmInd", "_NonElgblPrcdsInd", "_CdtDbtInd", "_NewSctiesIssncInd"]
	@property
	def PricDtls(self):
