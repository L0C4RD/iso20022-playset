...
class AcceptorData4(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlTxRefNb", "_ApldAdr", "_BizNm", "_BizRegnId", "_BizRegnIdTp", "_Id", "_LclData", "_LglCorpNm", "_NmAndLctn", "_NtlData", "_PrtnrId", "_PrvtData", "_SchmeAssgndId", "_SubmittdAdr", "_URLAdr"]
	@property
