...
class PostalAddress27(base_types._BaseFieldType):
	...
	__slots__ = ["_Room", "_TwnNm", "_AdrTp", "_AdrLine", "_BldgNm", "_UnitNb", "_CareOf", "_DstrctNm", "_PstBx", "_CtrySubDvsn", "_Flr", "_TwnLctnNm", "_SubDept", "_Ctry", "_BldgNb", "_PstCd", "_Dept", "_StrtNm"]
	@property
	def Room(self):
		return self._Room
