...
class PostalAddress27(base_types._BaseFieldType):
	...
	__slots__ = ["_Room", "_BldgNm", "_CtrySubDvsn", "_DstrctNm", "_SubDept", "_PstBx", "_TwnNm", "_UnitNb", "_Ctry", "_AdrTp", "_Dept", "_Flr", "_PstCd", "_AdrLine", "_StrtNm", "_CareOf", "_BldgNb", "_TwnLctnNm"]
	@property
	def Room(self):
		return self._Room
