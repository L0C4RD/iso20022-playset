...
class ForeignExchangeTradeStatusAndDetailsNotificationV06(base_types._BaseFieldType):
	...
	__slots__ = ["_AgrdRate", "_CtrPtySdSttlmInstrs", "_SplmtryData", "_TradAmts", "_RgltryRptg", "_SpltTradInf", "_CtrPtySdId", "_TradgSdSttlmInstrs", "_TradgSdId", "_NDFConds", "_PstTradEvt", "_TradInf", "_StsDtls", "_GnlInf"]
	@property
	def AgrdRate(self):
