...
from ._LiquidResourceInformation1 import LiquidResourceInformation1

class LiquidResources1(base_types._BaseFieldType):

	__slots__ = ["_FcltiesOthrCmmtd", "_FcltiesUcmmtd", "_FinInstrmsTrsrInvstmts", "_FinInstrmsDfltrsNonCshColl", "_CshDue", "_FinInstrmsDfltrsSttlmColl", "_FcltiesCmmtdFxSwps", "_FcltiesCmmtdLinesOfCdt", "_FinInstrmsCCP", "_FcltiesCmmtdRpAgrmts"]
	@property
