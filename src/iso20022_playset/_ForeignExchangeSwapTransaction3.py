...
class ForeignExchangeSwapTransaction3(base_types._BaseFieldType):
	...
	__slots__ = ["_MtrtyDt", "_RltdPrtryTxId", "_UnqTxIdr", "_TradDt", "_TxTp", "_PrtryTxId", "_NvtnSts", "_TxNmnlAmt", "_RptdTxSts", "_SpotValDt", "_FX", "_CtrPtyPrtryTxId", "_CtrPtyId", "_SplmtryData", "_BrnchId"]
	@property
	def MtrtyDt(self):
