...
class TransactionDetails169(base_types._BaseFieldType):
	...
	__slots__ = ["_RvslInd", "_SttlmTxOrCorpActnEvtTp", "_AckdStsTmStmp", "_PstngQty", "_MtchdStsTmStmp", "_TxAddtlDtls", "_SttlmDt", "_SfkpgPlc", "_PlcOfClr", "_RcvgSttlmPties", "_SctiesMvmntTp", "_SttlmParams", "_Pmt", "_NbOfDaysAcrd", "_PlcOfTrad", "_TxActvty", "_FctvSttlmDt", "_ValDt", "_TradDt", "_PstngAmt", "_DlvrgSttlmPties", "_AcrdIntrstAmt"]
	@property
	def RvslInd(self):
