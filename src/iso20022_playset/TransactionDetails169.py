...
class TransactionDetails169(base_types._BaseFieldType):
	...
	__slots__ = ["_RcvgSttlmPties", "_MtchdStsTmStmp", "_TxAddtlDtls", "_FctvSttlmDt", "_ValDt", "_Pmt", "_TxActvty", "_PlcOfTrad", "_SttlmDt", "_AckdStsTmStmp", "_SctiesMvmntTp", "_SttlmTxOrCorpActnEvtTp", "_PstngQty", "_PlcOfClr", "_DlvrgSttlmPties", "_NbOfDaysAcrd", "_TradDt", "_RvslInd", "_SfkpgPlc", "_SttlmParams", "_AcrdIntrstAmt", "_PstngAmt"]
	@property
