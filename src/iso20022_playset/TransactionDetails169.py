...
class TransactionDetails169(base_types._BaseFieldType):
	...
	__slots__ = ["_TxAddtlDtls", "_NbOfDaysAcrd", "_SttlmParams", "_PlcOfClr", "_SfkpgPlc", "_DlvrgSttlmPties", "_SctiesMvmntTp", "_ValDt", "_SttlmTxOrCorpActnEvtTp", "_Pmt", "_PlcOfTrad", "_RvslInd", "_PstngAmt", "_MtchdStsTmStmp", "_AcrdIntrstAmt", "_SttlmDt", "_PstngQty", "_FctvSttlmDt", "_TradDt", "_TxActvty", "_AckdStsTmStmp", "_RcvgSttlmPties"]
	@property
