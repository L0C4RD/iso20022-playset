...
from . import PendingProcessingStatus12Choice
...
class ProcessingStatus83Choice(base_types._BaseFieldType):
	...
	def PdgPrcg(self, value):
		self._PdgPrcg = value if value is not None else base_types.UninitialisedField(self, 'PdgPrcg', PendingProcessingStatus12Choice, False)

	@PdgPrcg.deleter
	def PdgPrcg(self):
		del self._PdgPrcg
		self._PdgPrcg = base_types.UninitialisedField(self, 'PdgPrcg', PendingProcessingStatus12Choice, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='PdgPrcg', type=PendingProcessingStatus12Choice, min=0, max=1, mutex_group=1, array=False),
