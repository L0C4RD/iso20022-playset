...
class FinancialInstrumentAttributes119(base_types._BaseFieldType):
	...
	__slots__ = ["_XpryDt", "_FltgRateFxgDt", "_PlcOfListg", "_DtdDt", "_FrstPmtDt", "_NxtIntrstRate", "_OptnTp", "_DnmtnCcy", "_PmtSts", "_VarblRateInd", "_CllblInd", "_VarblRateChngFrqcy", "_NxtFctr", "_IntrstRate", "_CpnAttchdNb", "_PrvsFctr", "_PmtFrqcy", "_IsseDt", "_ClssfctnTp", "_PoolNb", "_CtrctSz", "_NxtCllblDt", "_UndrlygFinInstrmId", "_PutblInd", "_ExrcPric", "_SbcptPric", "_PutblDt", "_StrkPric", "_MktOrIndctvPric", "_FinInstrmAttrAddtlDtls", "_QtyBrkdwn", "_ConvsPric", "_OptnStyle", "_CurFctr", "_DayCntBsis", "_CpnDt", "_YldToMtrtyRate", "_IndxRateBsis", "_MinNmnlQty", "_MtrtyDt", "_RegnForm"]
	@property
	def XpryDt(self):
		return self._XpryDt
