...
from .SecurityIdentification32 import SecurityIdentification32
...
from .QuantityBreakdown64 import QuantityBreakdown64

class FinancialInstrumentAttributes119(base_types._BaseFieldType):

	__slots__ = ["_CpnAttchdNb", "_MktOrIndctvPric", "_VarblRateInd", "_VarblRateChngFrqcy", "_NxtCllblDt", "_CllblInd", "_PmtFrqcy", "_FltgRateFxgDt", "_NxtFctr", "_PlcOfListg", "_PmtSts", "_CurFctr", "_OptnStyle", "_QtyBrkdwn", "_ExrcPric", "_ClssfctnTp", "_NxtIntrstRate", "_FinInstrmAttrAddtlDtls", "_IndxRateBsis", "_DnmtnCcy", "_IsseDt", "_PrvsFctr", "_MinNmnlQty", "_CtrctSz", "_StrkPric", "_IntrstRate", "_ConvsPric", "_YldToMtrtyRate", "_PoolNb", "_PutblInd", "_MtrtyDt", "_PutblDt", "_OptnTp", "_DtdDt", "_DayCntBsis", "_RegnForm", "_UndrlygFinInstrmId", "_FrstPmtDt", "_XpryDt", "_SbcptPric", "_CpnDt"]
	@property
