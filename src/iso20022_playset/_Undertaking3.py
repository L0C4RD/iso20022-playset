...
class Undertaking3(base_types._BaseFieldType):
	...
	__slots__ = ["_NclsdFile", "_Nm", "_PlcOfIsse", "_AddtlPty", "_Tp", "_Id", "_AutomtcAmtVartn", "_UdrtkgAmt", "_PresntnDtls", "_AddtlInf", "_ConfInd", "_UdrtkgTermsAndConds", "_ScndAdvsgPty", "_DlvryChanl", "_DtOfIssnc", "_XpryDtls", "_MltplDmndInd", "_Applcnt", "_TrfChrgsPyblBy", "_Issr", "_ConfPtyTp", "_ConfChrgsPyblBy", "_GovncRulesAndLaw", "_UndrlygTx", "_Bnfcry", "_IssncTp", "_TrfInd", "_PrtlDmndInd", "_AdvsgPty", "_ReqdLclUdrtkg"]
	@property
	def NclsdFile(self):
