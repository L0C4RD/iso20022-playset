...
class OtherAmounts43(base_types._BaseFieldType):
	...
	__slots__ = ["_ShppgAmt", "_TradAmt", "_SpclCncssn", "_ExctgBrkrAmt", "_AcrdCptlstnAmt", "_TrfTax", "_CsmptnTax", "_IsseDscntAllwnc", "_CtryNtlFdrlTax", "_ValAddedTax", "_AcrdIntrstAmt", "_RgltryAmt", "_PmtLevyTax", "_Mrgn", "_RsrchFee", "_StmpDty", "_WhldgTax", "_NetGnLoss", "_LclTaxCtrySpcfc", "_Othr", "_LclBrkrComssn", "_StockXchgTax", "_ChrgsFees", "_LclTax", "_TxTax"]
	@property
	def ShppgAmt(self):
