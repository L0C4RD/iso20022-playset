...
class OtherAmounts43(base_types._BaseFieldType):
	...
	__slots__ = ["_TxTax", "_AcrdIntrstAmt", "_AcrdCptlstnAmt", "_WhldgTax", "_RgltryAmt", "_ShppgAmt", "_ChrgsFees", "_ExctgBrkrAmt", "_NetGnLoss", "_LclTaxCtrySpcfc", "_StockXchgTax", "_Mrgn", "_IsseDscntAllwnc", "_TrfTax", "_LclTax", "_RsrchFee", "_CtryNtlFdrlTax", "_PmtLevyTax", "_SpclCncssn", "_LclBrkrComssn", "_StmpDty", "_TradAmt", "_Othr", "_CsmptnTax", "_ValAddedTax"]
	@property
	def TxTax(self):
		return self._TxTax
