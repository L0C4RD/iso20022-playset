...
class LoanMatchingCriteria9(base_types._BaseFieldType):
	...
	__slots__ = ["_LnVal", "_FltgRbtRateRstFrqcyUnit", "_ExctnDtTm", "_FltgIntrstRefRate", "_FltgIntrstRatePmtFrqcyUnit", "_FltgIntrstRatePmtFrqcyVal", "_CCP", "_ShrtMktValAmt", "_TermntnDt", "_FltgIntrstRateRstFrqcyVal", "_OutsdngMrgnLnAmt", "_DlvryByVal", "_TermntnOptn", "_FxdIntrstRate", "_BsisPtSprd", "_ClrDtTm", "_FltgRateAdjstmntDt", "_GnlColl", "_FltgRbtRefRate", "_UnqTradIdr", "_PrncplAmtMtrtyDtAmt", "_FltgIntrstRateTermUnit", "_ClrSts", "_DayCntBsis", "_PrncplAmtValDtAmt", "_LndgFee", "_OpnTerm", "_FltgRbtRateRstFrqcyVal", "_MtrtyDt", "_CtrctTp", "_EarlstCallBckDt", "_FltgRbtRateTermUnit", "_FltgRbtRatePmtFrqcyVal", "_FltgRbtRatePmtFrqcyUnit", "_UnitOfMeasr", "_LvlTp", "_AsstTp", "_MinNtcePrd", "_TradgVn", "_ValDt", "_FltgIntrstRateTermVal", "_FltgIntrstRateRstFrqcyUnit", "_FltgRbtRateTermVal", "_MstrAgrmtTp", "_CollDlvryMtd", "_FltgRateAdjstmnt", "_RbtRateBsisPtSprd", "_FxdRbtRefRate", "_MrgnLnAttr"]
	@property
	def LnVal(self):
		return self._LnVal
