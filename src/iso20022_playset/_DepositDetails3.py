...
from . import CardDepositType1Code
...
class DepositDetails3(base_types._BaseFieldType):
	...
	__slots__ = ["_Amt", "_CdtDbt", "_OthrTp", "_Tp"]
	@property
	def Amt(self):
		return self._Amt
	...
	@Tp.setter
	def Tp(self, value):
		self._Tp = value if value is not None else base_types.UninitialisedField(self, 'Tp', CardDepositType1Code, False)

	@Tp.deleter
	def Tp(self):
		del self._Tp
		self._Tp = base_types.UninitialisedField(self, 'Tp', CardDepositType1Code, False)
