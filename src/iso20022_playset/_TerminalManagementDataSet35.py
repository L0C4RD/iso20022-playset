...
from . import ManagementPlanContent14
from . import Max9NumericText
from . import TrueFalseIndicator

class TerminalManagementDataSet35(base_types._BaseFieldType):
	...
	@Cntt.setter
	def Cntt(self, value):
		self._Cntt = value if value is not None else base_types.UninitialisedField(self, 'Cntt', ManagementPlanContent14, False)

	@Cntt.deleter
	def Cntt(self):
		del self._Cntt
		self._Cntt = base_types.UninitialisedField(self, 'Cntt', ManagementPlanContent14, False)
	...
	_field_defs = frozenset((
		base_types.FieldEntry(name='Cntt', type=ManagementPlanContent14, min=0, max=1, mutex_group=None, array=False),
