...
class TradeLeg13(base_types._BaseFieldType):
	...
	__slots__ = ["_TradgCcy", "_SfkpgPlc", "_TradgCpcty", "_TradPstngCd", "_TradExctnId", "_TradLegId", "_PlcOfListg", "_TradRegnOrgn", "_PlcOfTrad", "_TradgPtyAcct", "_TradgPty", "_DealPric", "_GrssAmt", "_TradDt", "_TradTp", "_Brkr", "_AllcnId", "_SttlmDt", "_UnqTxIdr", "_TxDtAndTm", "_TradId", "_SfkpgAcct", "_BuySellInd", "_TradQty", "_DerivRltdTrad", "_OrdrId"]
	@property
	def TradgCcy(self):
