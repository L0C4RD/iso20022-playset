...
class TradeLeg13(base_types._BaseFieldType):
	...
	__slots__ = ["_TradgCcy", "_TradRegnOrgn", "_TradExctnId", "_AllcnId", "_TradId", "_TxDtAndTm", "_UnqTxIdr", "_DerivRltdTrad", "_TradLegId", "_BuySellInd", "_GrssAmt", "_TradQty", "_TradgPtyAcct", "_TradgPty", "_TradTp", "_TradgCpcty", "_TradDt", "_SfkpgAcct", "_Brkr", "_TradPstngCd", "_PlcOfTrad", "_SttlmDt", "_OrdrId", "_DealPric", "_PlcOfListg", "_SfkpgPlc"]
	@property
	def TradgCcy(self):
