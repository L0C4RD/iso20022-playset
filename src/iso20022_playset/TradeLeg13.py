...
class TradeLeg13(base_types._BaseFieldType):
	...
	__slots__ = ["_TradTp", "_UnqTxIdr", "_DealPric", "_TradLegId", "_TradPstngCd", "_TradQty", "_TradRegnOrgn", "_TxDtAndTm", "_GrssAmt", "_TradExctnId", "_TradgPtyAcct", "_SfkpgAcct", "_AllcnId", "_BuySellInd", "_SttlmDt", "_SfkpgPlc", "_PlcOfTrad", "_TradId", "_TradgPty", "_TradDt", "_TradgCpcty", "_Brkr", "_DerivRltdTrad", "_TradgCcy", "_PlcOfListg", "_OrdrId"]
	@property
	def TradTp(self):
		return self._TradTp
