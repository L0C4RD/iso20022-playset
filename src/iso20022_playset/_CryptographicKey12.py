...
class CryptographicKey12(base_types._BaseFieldType):
	...
	def KeyChcVal(self, value):
		self._KeyChcVal = value if value is not None else base_types.UninitialisedField(self, 'KeyChcVal', KeyChoiceValue2, False)

	@KeyChcVal.deleter
	def KeyChcVal(self):
		del self._KeyChcVal
		self._KeyChcVal = base_types.UninitialisedField(self, 'KeyChcVal', KeyChoiceValue2, False)
