...
from . import SettlementDetails197
from . import SettlementOrCorporateActionEvent32Choice
...
class TransactionDetails164(base_types._BaseFieldType):
	...
	def PstngAmt(self, value):
		self._PstngAmt = value if value is not None else base_types.UninitialisedField(self, 'PstngAmt', AmountAndDirection67, False)

	@PstngAmt.deleter
	def PstngAmt(self):
		del self._PstngAmt
		self._PstngAmt = base_types.UninitialisedField(self, 'PstngAmt', AmountAndDirection67, False)
	...
	def SttlmParams(self, value):
		self._SttlmParams = value if value is not None else base_types.UninitialisedField(self, 'SttlmParams', SettlementDetails197, False)

	@SttlmParams.deleter
	def SttlmParams(self):
		del self._SttlmParams
		self._SttlmParams = base_types.UninitialisedField(self, 'SttlmParams', SettlementDetails197, False)
	...
	def SttlmTxOrCorpActnEvtTp(self, value):
		self._SttlmTxOrCorpActnEvtTp = value if value is not None else base_types.UninitialisedField(self, 'SttlmTxOrCorpActnEvtTp', SettlementOrCorporateActionEvent32Choice, False)

	@SttlmTxOrCorpActnEvtTp.deleter
	def SttlmTxOrCorpActnEvtTp(self):
		del self._SttlmTxOrCorpActnEvtTp
		self._SttlmTxOrCorpActnEvtTp = base_types.UninitialisedField(self, 'SttlmTxOrCorpActnEvtTp', SettlementOrCorporateActionEvent32Choice, False)
