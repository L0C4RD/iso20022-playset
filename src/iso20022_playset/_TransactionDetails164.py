...
class TransactionDetails164(base_types._BaseFieldType):
	...
	__slots__ = ["_PstngAmt", "_SttlmParams", "_LateDlvryDt", "_PlcOfClr", "_SttlmDt", "_PlcOfTrad", "_XpctdSttlmDt", "_SctiesMvmntTp", "_TxAddtlDtls", "_TxActvty", "_DlvrgSttlmPties", "_PstngQty", "_Pmt", "_PrtlyRlsdQty", "_RcvgSttlmPties", "_MtchdStsTmStmp", "_AckdStsTmStmp", "_SplmtryData", "_TradDt", "_FinInstrmId", "_SttlmTxOrCorpActnEvtTp", "_SfkpgPlc", "_XpctdValDt"]
	@property
	def PstngAmt(self):
