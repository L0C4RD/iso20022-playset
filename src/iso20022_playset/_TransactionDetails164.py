...
class TransactionDetails164(base_types._BaseFieldType):
	...
	__slots__ = ["_PlcOfTrad", "_TxAddtlDtls", "_AckdStsTmStmp", "_XpctdValDt", "_TxActvty", "_SplmtryData", "_PstngAmt", "_SttlmParams", "_Pmt", "_TradDt", "_PrtlyRlsdQty", "_PlcOfClr", "_MtchdStsTmStmp", "_XpctdSttlmDt", "_SfkpgPlc", "_SttlmDt", "_PstngQty", "_SctiesMvmntTp", "_LateDlvryDt", "_DlvrgSttlmPties", "_SttlmTxOrCorpActnEvtTp", "_RcvgSttlmPties", "_FinInstrmId"]
	@property
	def PlcOfTrad(self):
