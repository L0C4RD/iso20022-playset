...
class CorporateActionRate129(base_types._BaseFieldType):
	...
	__slots__ = ["_ChrgsFees", "_ScndLvlTax", "_EstmtdRateInd", "_NewToOd", "_FinTxTaxRate", "_FsclStmp", "_TaxCdtRate", "_AddtlQtyForExstgScties", "_WhldgTaxRate", "_AddtlQtyForSbcbdRsltntScties", "_AplblRate", "_TrfrmatnRate"]
	@property
	def ChrgsFees(self):
