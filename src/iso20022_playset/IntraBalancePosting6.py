...
class IntraBalancePosting6(base_types._BaseFieldType):
	...
	__slots__ = ["_InstrPrcgAddtlDtls", "_CshSubBalId", "_FctvSttlmDt", "_StsDt", "_Lnkgs", "_AcctOwnrTxId", "_PoolId", "_MsgOrgtr", "_AcctSvcrTxId", "_PrcrTxId", "_SplmtryData", "_BalTo", "_CorpActnEvtId", "_RmngSttlmAmt", "_PrevslySttldAmt", "_MktInfrstrctrTxId", "_SttldAmt", "_CreDtTm", "_Prty"]
	@property
