...
class IntraBalancePosting6(base_types._BaseFieldType):
	...
	__slots__ = ["_Lnkgs", "_Prty", "_InstrPrcgAddtlDtls", "_PoolId", "_CshSubBalId", "_SttldAmt", "_PrevslySttldAmt", "_FctvSttlmDt", "_BalTo", "_RmngSttlmAmt", "_MsgOrgtr", "_CreDtTm", "_CorpActnEvtId", "_PrcrTxId", "_MktInfrstrctrTxId", "_AcctOwnrTxId", "_AcctSvcrTxId", "_StsDt", "_SplmtryData"]
	@property
	def Lnkgs(self):
		return self._Lnkgs
