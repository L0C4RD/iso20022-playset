...
class ChargesPerTypeRecord6(base_types._BaseFieldType):
	...
	__slots__ = ["_Dbtr", "_DbtrAgtAcct", "_UndrlygTx", "_AddtlInf", "_InstrForInstdAgt", "_RcrdId", "_ChrgsRqstr", "_ValDt", "_ChrgsAcctAgt", "_DbtrAcct", "_SttlmInstr", "_ChrgsAcctAgtAcct", "_CdtDbtInd", "_Amt", "_DbtrAgt"]
	@property
	def Dbtr(self):
		return self._Dbtr
