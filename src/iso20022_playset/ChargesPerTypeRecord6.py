...
class ChargesPerTypeRecord6(base_types._BaseFieldType):
	...
	__slots__ = ["_UndrlygTx", "_ValDt", "_DbtrAgt", "_AddtlInf", "_ChrgsRqstr", "_ChrgsAcctAgtAcct", "_DbtrAgtAcct", "_ChrgsAcctAgt", "_InstrForInstdAgt", "_CdtDbtInd", "_Amt", "_SttlmInstr", "_Dbtr", "_RcrdId", "_DbtrAcct"]
	@property
	def UndrlygTx(self):
