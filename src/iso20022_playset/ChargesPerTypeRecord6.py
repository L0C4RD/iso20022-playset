...
class ChargesPerTypeRecord6(base_types._BaseFieldType):
	...
	__slots__ = ["_DbtrAcct", "_Amt", "_DbtrAgtAcct", "_Dbtr", "_ChrgsAcctAgtAcct", "_AddtlInf", "_DbtrAgt", "_ChrgsAcctAgt", "_ValDt", "_UndrlygTx", "_InstrForInstdAgt", "_RcrdId", "_CdtDbtInd", "_SttlmInstr", "_ChrgsRqstr"]
	@property
	def DbtrAcct(self):
