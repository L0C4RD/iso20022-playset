...
class ChargesPerTypeRecord6(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlInf", "_DbtrAgt", "_Amt", "_SttlmInstr", "_CdtDbtInd", "_ValDt", "_Dbtr", "_DbtrAcct", "_RcrdId", "_DbtrAgtAcct", "_InstrForInstdAgt", "_ChrgsAcctAgt", "_ChrgsRqstr", "_UndrlygTx", "_ChrgsAcctAgtAcct"]
	@property
	def AddtlInf(self):
