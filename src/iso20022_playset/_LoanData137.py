...
class LoanData137(base_types._BaseFieldType):
	...
	__slots__ = ["_EvtDt", "_TradgVn", "_ExctnDtTm", "_ValDt", "_AsstTp", "_ClrSts", "_TermntnDt", "_DlvryByVal", "_LndgFee", "_Term", "_RbtRate", "_MstrAgrmt", "_CollDlvryMtd", "_GnlColl", "_UnqTradIdr", "_LnVal"]
	@property
	def EvtDt(self):
		return self._EvtDt
