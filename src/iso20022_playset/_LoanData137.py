...
class LoanData137(base_types._BaseFieldType):
	...
	__slots__ = ["_EvtDt", "_RbtRate", "_TermntnDt", "_GnlColl", "_DlvryByVal", "_ExctnDtTm", "_LnVal", "_CollDlvryMtd", "_ValDt", "_TradgVn", "_UnqTradIdr", "_LndgFee", "_ClrSts", "_Term", "_MstrAgrmt", "_AsstTp"]
	@property
	def EvtDt(self):
		return self._EvtDt
