...
from . import AssetClassCommodityAgricultural5Choice
from . import AssetClassCommodityEnergy2Choice
from . import AssetClassCommodityEnvironmental2Choice
from . import AssetClassCommodityFertilizer3Choice
from . import AssetClassCommodityFreight3Choice
...
from . import AssetClassCommodityPaper3Choice
from . import AssetClassCommodityPolypropylene3Choice
...
class AssetClassCommodity5Choice(base_types._BaseFieldType):
	...
	def Agrcltrl(self, value):
		self._Agrcltrl = value if value is not None else base_types.UninitialisedField(self, 'Agrcltrl', AssetClassCommodityAgricultural5Choice, False)

	@Agrcltrl.deleter
	def Agrcltrl(self):
		del self._Agrcltrl
		self._Agrcltrl = base_types.UninitialisedField(self, 'Agrcltrl', AssetClassCommodityAgricultural5Choice, False)
	...
	def Envttl(self, value):
		self._Envttl = value if value is not None else base_types.UninitialisedField(self, 'Envttl', AssetClassCommodityEnvironmental2Choice, False)

	@Envttl.deleter
	def Envttl(self):
		del self._Envttl
		self._Envttl = base_types.UninitialisedField(self, 'Envttl', AssetClassCommodityEnvironmental2Choice, False)
	...
	def Frght(self, value):
		self._Frght = value if value is not None else base_types.UninitialisedField(self, 'Frght', AssetClassCommodityFreight3Choice, False)

	@Frght.deleter
	def Frght(self):
		del self._Frght
		self._Frght = base_types.UninitialisedField(self, 'Frght', AssetClassCommodityFreight3Choice, False)
	...
	def Frtlzr(self, value):
		self._Frtlzr = value if value is not None else base_types.UninitialisedField(self, 'Frtlzr', AssetClassCommodityFertilizer3Choice, False)

	@Frtlzr.deleter
	def Frtlzr(self):
		del self._Frtlzr
		self._Frtlzr = base_types.UninitialisedField(self, 'Frtlzr', AssetClassCommodityFertilizer3Choice, False)
	...
	@Nrgy.setter
	def Nrgy(self, value):
		self._Nrgy = value if value is not None else base_types.UninitialisedField(self, 'Nrgy', AssetClassCommodityEnergy2Choice, False)

	@Nrgy.deleter
	def Nrgy(self):
		del self._Nrgy
		self._Nrgy = base_types.UninitialisedField(self, 'Nrgy', AssetClassCommodityEnergy2Choice, False)
	...
	def Plprpln(self, value):
		self._Plprpln = value if value is not None else base_types.UninitialisedField(self, 'Plprpln', AssetClassCommodityPolypropylene3Choice, False)

	@Plprpln.deleter
	def Plprpln(self):
		del self._Plprpln
		self._Plprpln = base_types.UninitialisedField(self, 'Plprpln', AssetClassCommodityPolypropylene3Choice, False)
	...
	@Ppr.setter
	def Ppr(self, value):
		self._Ppr = value if value is not None else base_types.UninitialisedField(self, 'Ppr', AssetClassCommodityPaper3Choice, False)

	@Ppr.deleter
	def Ppr(self):
		del self._Ppr
		self._Ppr = base_types.UninitialisedField(self, 'Ppr', AssetClassCommodityPaper3Choice, False)
