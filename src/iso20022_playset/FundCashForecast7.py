...
class FundCashForecast7(base_types._BaseFieldType):
	...
	__slots__ = ["_FXRate", "_PctgOfShrClssTtlNAV", "_Id", "_XcptnlNetCshFlowInd", "_TtlUnitsNb", "_PrvsTtlUnitsNb", "_FinInstrmDtls", "_CcySts", "_NetCshFcstDtls", "_Pric", "_TradDtTm", "_PrvsTradDtTm", "_InvstmtCcy", "_CshOutFcstDtls", "_TtlNAVChngRate", "_PrvsTtlNAV", "_CshInFcstDtls", "_TtlNAV"]
	@property
	def FXRate(self):
		return self._FXRate
