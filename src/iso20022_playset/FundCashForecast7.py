...
class FundCashForecast7(base_types._BaseFieldType):
	...
	__slots__ = ["_InvstmtCcy", "_TtlNAV", "_TtlNAVChngRate", "_PrvsTtlUnitsNb", "_PctgOfShrClssTtlNAV", "_FinInstrmDtls", "_NetCshFcstDtls", "_Id", "_Pric", "_PrvsTtlNAV", "_PrvsTradDtTm", "_CshInFcstDtls", "_CshOutFcstDtls", "_TtlUnitsNb", "_CcySts", "_FXRate", "_XcptnlNetCshFlowInd", "_TradDtTm"]
	@property
	def InvstmtCcy(self):
