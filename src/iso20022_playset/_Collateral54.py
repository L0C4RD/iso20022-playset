...
class Collateral54(base_types._BaseFieldType):
	...
	def CshColl(self, value):
		self._CshColl = value if value is not None else base_types.UninitialisedField(self, 'CshColl', CashCollateral2, True)

	@CshColl.deleter
	def CshColl(self):
		del self._CshColl
		self._CshColl = base_types.UninitialisedField(self, 'CshColl', CashCollateral2, True)
