...
class ReportEntry15(base_types._BaseFieldType):
	...
	__slots__ = ["_BkTxCd", "_RvslInd", "_ValDt", "_Sts", "_ComssnWvrInd", "_Avlbty", "_TechInptChanl", "_NtryDtls", "_AddtlInfInd", "_Chrgs", "_AddtlNtryInf", "_BookgDt", "_AmtDtls", "_NtryRef", "_Amt", "_Intrst", "_AcctSvcrRef", "_CdtDbtInd", "_CardTx"]
	@property
	def BkTxCd(self):
		return self._BkTxCd
