...
class ReportEntry15(base_types._BaseFieldType):
	...
	__slots__ = ["_BookgDt", "_RvslInd", "_ComssnWvrInd", "_AddtlNtryInf", "_Avlbty", "_CardTx", "_BkTxCd", "_AcctSvcrRef", "_AmtDtls", "_NtryDtls", "_Intrst", "_CdtDbtInd", "_Chrgs", "_NtryRef", "_ValDt", "_AddtlInfInd", "_TechInptChanl", "_Amt", "_Sts"]
	@property
	def BookgDt(self):
