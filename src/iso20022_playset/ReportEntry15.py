...
class ReportEntry15(base_types._BaseFieldType):
	...
	__slots__ = ["_ComssnWvrInd", "_AcctSvcrRef", "_Chrgs", "_BkTxCd", "_BookgDt", "_Amt", "_NtryRef", "_AmtDtls", "_NtryDtls", "_CdtDbtInd", "_TechInptChanl", "_RvslInd", "_CardTx", "_AddtlInfInd", "_Intrst", "_AddtlNtryInf", "_ValDt", "_Avlbty", "_Sts"]
	@property
