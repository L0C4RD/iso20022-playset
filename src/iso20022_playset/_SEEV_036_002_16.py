...
from . import CorporateActionMovementConfirmation002V16
...
class SEEV_036_002_16():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def CorpActnMvmntConf(self, value):
			self._CorpActnMvmntConf = value if value is not None else base_types.UninitialisedField(self, 'CorpActnMvmntConf', CorporateActionMovementConfirmation002V16, False)

		@CorpActnMvmntConf.deleter
		def CorpActnMvmntConf(self):
			del self._CorpActnMvmntConf
			self._CorpActnMvmntConf = base_types.UninitialisedField(self, 'CorpActnMvmntConf', CorporateActionMovementConfirmation002V16, False)
