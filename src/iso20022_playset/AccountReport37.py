...
class AccountReport37(base_types._BaseFieldType):
	...
	__slots__ = ["_Bal", "_Ntry", "_LglSeqNb", "_Acct", "_CreDtTm", "_RltdAcct", "_ElctrncSeqNb", "_RptPgntn", "_Id", "_FrToDt", "_RptgSeq", "_AddtlRptInf", "_CpyDplctInd", "_RptgSrc", "_Intrst", "_TxsSummry"]
	@property
	def Bal(self):
		return self._Bal
	...
	def AddtlRptInf(self, value):
		self._AddtlRptInf = value if type(value) != base_types.auto else self.make_default("AddtlRptInf")
