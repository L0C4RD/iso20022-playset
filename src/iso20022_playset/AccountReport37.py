...
class AccountReport37(base_types._BaseFieldType):
	...
	__slots__ = ["_Id", "_Intrst", "_TxsSummry", "_CreDtTm", "_Ntry", "_AddtlRptInf", "_Acct", "_RptgSeq", "_RptPgntn", "_ElctrncSeqNb", "_Bal", "_LglSeqNb", "_RltdAcct", "_CpyDplctInd", "_RptgSrc", "_FrToDt"]
	@property
	def Id(self):
		return self._Id
