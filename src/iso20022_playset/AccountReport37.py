...
class AccountReport37(base_types._BaseFieldType):
	...
	__slots__ = ["_Acct", "_TxsSummry", "_RptgSrc", "_RltdAcct", "_Bal", "_FrToDt", "_CpyDplctInd", "_RptPgntn", "_Id", "_CreDtTm", "_LglSeqNb", "_ElctrncSeqNb", "_AddtlRptInf", "_Intrst", "_Ntry", "_RptgSeq"]
	@property
	def Acct(self):
		return self._Acct
