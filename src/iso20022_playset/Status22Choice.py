...
class Status22Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_RspnSts", "_AllcnSts", "_SttlmSts", "_CorpActnEvtPrcgSts", "_RepoCallReqSts", "_AffirmSts", "_IfrrdMtchgSts", "_MtchgSts", "_CorpActnEvtStag", "_RegnPrcgSts", "_CxlPrcgSts", "_RplcmntPrcgSts", "_InstrPrcgSts", "_SttlmCondModSts"]
	@property
	def RspnSts(self):
