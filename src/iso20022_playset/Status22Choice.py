...
class Status22Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmSts", "_AllcnSts", "_RepoCallReqSts", "_InstrPrcgSts", "_CorpActnEvtPrcgSts", "_SttlmCondModSts", "_AffirmSts", "_IfrrdMtchgSts", "_MtchgSts", "_CxlPrcgSts", "_RegnPrcgSts", "_CorpActnEvtStag", "_RspnSts", "_RplcmntPrcgSts"]
	@property
	def SttlmSts(self):
