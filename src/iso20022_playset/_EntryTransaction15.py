...
class EntryTransaction15(base_types._BaseFieldType):
	...
	__slots__ = ["_RltdCorpActn", "_CshDpst", "_SfkpgAcct", "_InstrCpy", "_Purp", "_Chrgs", "_BkTxCd", "_RltdPric", "_Tax", "_RltdDts", "_LclInstrm", "_RmtInf", "_FinInstrmId", "_AmtDtls", "_CdtDbtInd", "_Avlbty", "_Intrst", "_RtrInf", "_Refs", "_RltdAgts", "_UndrlygAllcn", "_RltdPties", "_PmtTpInf", "_RltdQties", "_AddtlTxInf", "_RltdRmtInf", "_Amt", "_CardTx", "_SplmtryData"]
	@property
