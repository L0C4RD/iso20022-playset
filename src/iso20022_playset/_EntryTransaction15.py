...
class EntryTransaction15(base_types._BaseFieldType):
	...
	__slots__ = ["_BkTxCd", "_SplmtryData", "_RltdRmtInf", "_SfkpgAcct", "_Chrgs", "_Refs", "_CdtDbtInd", "_LclInstrm", "_Purp", "_Tax", "_RltdPties", "_AmtDtls", "_InstrCpy", "_RtrInf", "_CardTx", "_Intrst", "_CshDpst", "_FinInstrmId", "_Amt", "_RltdAgts", "_RmtInf", "_AddtlTxInf", "_RltdPric", "_Avlbty", "_RltdQties", "_RltdCorpActn", "_RltdDts", "_UndrlygAllcn", "_PmtTpInf"]
	@property
	def BkTxCd(self):
		return self._BkTxCd
