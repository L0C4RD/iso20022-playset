...
from . import TransactionDetails171
...
class SecuritiesSettlementTransactionModificationRequestStatusAdviceV07(base_types._BaseFieldType):
	...
	def TxDtls(self, value):
		self._TxDtls = value if value is not None else base_types.UninitialisedField(self, 'TxDtls', TransactionDetails171, False)

	@TxDtls.deleter
	def TxDtls(self):
		del self._TxDtls
		self._TxDtls = base_types.UninitialisedField(self, 'TxDtls', TransactionDetails171, False)
