...
class SummaryAmounts2(base_types._BaseFieldType):
	...
	__slots__ = ["_RtrXcssCshAndCollCcy", "_TtlFees", "_ThrshldAmt", "_MinTrfAmt", "_ThrshldTp", "_TtlPdgOutgngColl", "_PrvsXpsrVal", "_RndgAmt", "_TtlPdgIncmgColl", "_TtlAcrdIntrstAmt", "_PreHrcutCollVal", "_CollReqrd", "_PrvsCollVal", "_AdjstdXpsr"]
	@property
