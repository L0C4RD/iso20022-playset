...
class Undertaking4(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlPty", "_LclUdrtkgAmt", "_DlvryChanl", "_Tp", "_ConfChrgsPyblBy", "_TrfInd", "_MltplDmndInd", "_ScndAdvsgPty", "_AddtlInf", "_TrfChrgsPyblBy", "_UdrtkgWrdg", "_GovncRulesAndLaw", "_AutomtcAmtVartn", "_AdvsgPty", "_ConfInd", "_PrtlDmndInd", "_UndrlygTx", "_Bnfcry", "_Applcnt", "_DtOfIssnc", "_XpryDtls", "_PresntnDtls", "_Nm"]
	@property
	def AddtlPty(self):
	...
	def LclUdrtkgAmt(self, value):
		self._LclUdrtkgAmt = value if type(value) != auto else self.make_default("LclUdrtkgAmt")
