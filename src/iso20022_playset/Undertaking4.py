...
class Undertaking4(base_types._BaseFieldType):
	...
	__slots__ = ["_ScndAdvsgPty", "_TrfChrgsPyblBy", "_MltplDmndInd", "_Nm", "_ConfChrgsPyblBy", "_UndrlygTx", "_GovncRulesAndLaw", "_PresntnDtls", "_PrtlDmndInd", "_DlvryChanl", "_DtOfIssnc", "_AutomtcAmtVartn", "_LclUdrtkgAmt", "_UdrtkgWrdg", "_AdvsgPty", "_XpryDtls", "_Applcnt", "_ConfInd", "_AddtlInf", "_TrfInd", "_AddtlPty", "_Tp", "_Bnfcry"]
	@property
