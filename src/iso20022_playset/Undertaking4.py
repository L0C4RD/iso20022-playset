...
class Undertaking4(base_types._BaseFieldType):
	...
	__slots__ = ["_ConfInd", "_PresntnDtls", "_Bnfcry", "_ScndAdvsgPty", "_Applcnt", "_ConfChrgsPyblBy", "_AutomtcAmtVartn", "_Nm", "_XpryDtls", "_AddtlInf", "_UdrtkgWrdg", "_AdvsgPty", "_TrfChrgsPyblBy", "_MltplDmndInd", "_Tp", "_AddtlPty", "_DtOfIssnc", "_UndrlygTx", "_LclUdrtkgAmt", "_GovncRulesAndLaw", "_PrtlDmndInd", "_DlvryChanl", "_TrfInd"]
	@property
	def ConfInd(self):
