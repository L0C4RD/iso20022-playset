...
class Undertaking4(base_types._BaseFieldType):
	...
	__slots__ = ["_TrfChrgsPyblBy", "_AdvsgPty", "_Tp", "_ScndAdvsgPty", "_UndrlygTx", "_XpryDtls", "_Bnfcry", "_DtOfIssnc", "_Nm", "_MltplDmndInd", "_ConfInd", "_PresntnDtls", "_AddtlInf", "_AutomtcAmtVartn", "_UdrtkgWrdg", "_Applcnt", "_GovncRulesAndLaw", "_DlvryChanl", "_TrfInd", "_AddtlPty", "_PrtlDmndInd", "_ConfChrgsPyblBy", "_LclUdrtkgAmt"]
	@property
