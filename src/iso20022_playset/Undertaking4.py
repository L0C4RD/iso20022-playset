...
class Undertaking4(base_types._BaseFieldType):
	...
	__slots__ = ["_PresntnDtls", "_Nm", "_UdrtkgWrdg", "_LclUdrtkgAmt", "_XpryDtls", "_UndrlygTx", "_TrfChrgsPyblBy", "_ConfInd", "_PrtlDmndInd", "_GovncRulesAndLaw", "_Applcnt", "_ScndAdvsgPty", "_ConfChrgsPyblBy", "_MltplDmndInd", "_AutomtcAmtVartn", "_Tp", "_Bnfcry", "_AddtlInf", "_DlvryChanl", "_DtOfIssnc", "_AdvsgPty", "_AddtlPty", "_TrfInd"]
	@property
