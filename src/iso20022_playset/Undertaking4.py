...
class Undertaking4(base_types._BaseFieldType):
	...
	__slots__ = ["_UdrtkgWrdg", "_AddtlPty", "_DlvryChanl", "_UndrlygTx", "_DtOfIssnc", "_PresntnDtls", "_TrfChrgsPyblBy", "_TrfInd", "_LclUdrtkgAmt", "_PrtlDmndInd", "_AutomtcAmtVartn", "_Tp", "_XpryDtls", "_AdvsgPty", "_Applcnt", "_MltplDmndInd", "_ConfInd", "_AddtlInf", "_Nm", "_GovncRulesAndLaw", "_Bnfcry", "_ConfChrgsPyblBy", "_ScndAdvsgPty"]
	@property
	def UdrtkgWrdg(self):
