...
class CorporateActionDate104(base_types._BaseFieldType):
	...
	__slots__ = ["_CoverXprtnDdln", "_DcmnttnDdln", "_XpryDt", "_RspnDdln", "_BrrwrStockLndgDdln", "_EarlyRspnDdln", "_MktDdln", "_PrtctDdln", "_DpstryCoverXprtnDt", "_StockLndgDdln", "_EndOfSctiesBlckgPrd", "_SbcptCostDbtDt"]
	@property
