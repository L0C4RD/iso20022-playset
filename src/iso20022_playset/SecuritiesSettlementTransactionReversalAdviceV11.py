...
class SecuritiesSettlementTransactionReversalAdviceV11(base_types._BaseFieldType):
	...
	__slots__ = ["_DgtlNtwkFee", "_SttlmParams", "_AddtlParams", "_RcvgSttlmPties", "_CshPties", "_DlvrgSttlmPties", "_FinInstrmId", "_StgSttlmInstrDtls", "_SttldAmt", "_ConfRef", "_TradDtls", "_AddtlPhysOrRegnDtls", "_QtyAndAcctDtls", "_TxIdDtls", "_OthrBizPties", "_SplmtryData", "_FinInstrmAttrbts", "_OthrAmts"]
	@property
