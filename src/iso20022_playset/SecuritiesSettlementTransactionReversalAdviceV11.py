...
class SecuritiesSettlementTransactionReversalAdviceV11(base_types._BaseFieldType):
	...
	__slots__ = ["_CshPties", "_DgtlNtwkFee", "_FinInstrmAttrbts", "_TxIdDtls", "_StgSttlmInstrDtls", "_RcvgSttlmPties", "_TradDtls", "_ConfRef", "_SplmtryData", "_AddtlParams", "_SttlmParams", "_SttldAmt", "_FinInstrmId", "_OthrAmts", "_OthrBizPties", "_AddtlPhysOrRegnDtls", "_QtyAndAcctDtls", "_DlvrgSttlmPties"]
	@property
	def CshPties(self):
