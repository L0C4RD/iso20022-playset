...
from .AdditionalParameters30 import AdditionalParameters30
...
from .SettlementDetails215 import SettlementDetails215
...
from .CashParties42 import CashParties42
...
class SecuritiesSettlementTransactionReversalAdviceV11(base_types._BaseFieldType):
	...
	__slots__ = ["_TxIdDtls", "_QtyAndAcctDtls", "_SttlmParams", "_AddtlPhysOrRegnDtls", "_OthrAmts", "_RcvgSttlmPties", "_AddtlParams", "_DgtlNtwkFee", "_DlvrgSttlmPties", "_SplmtryData", "_OthrBizPties", "_CshPties", "_FinInstrmId", "_SttldAmt", "_FinInstrmAttrbts", "_ConfRef", "_StgSttlmInstrDtls", "_TradDtls"]
	@property
	def TxIdDtls(self):
