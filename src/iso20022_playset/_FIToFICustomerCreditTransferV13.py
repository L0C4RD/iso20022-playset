...
from . import CreditTransferTransaction70
...
class FIToFICustomerCreditTransferV13(base_types._BaseFieldType):
	...
	def CdtTrfTxInf(self, value):
		self._CdtTrfTxInf = value if value is not None else base_types.UninitialisedField(self, 'CdtTrfTxInf', CreditTransferTransaction70, True)

	@CdtTrfTxInf.deleter
	def CdtTrfTxInf(self):
		del self._CdtTrfTxInf
		self._CdtTrfTxInf = base_types.UninitialisedField(self, 'CdtTrfTxInf', CreditTransferTransaction70, True)
