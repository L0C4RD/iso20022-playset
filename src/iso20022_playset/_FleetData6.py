...
class FleetData6(base_types._BaseFieldType):
	...
	__slots__ = ["_TripJobNb", "_DrvrOrVhclCard", "_LclAmnty", "_CardFuelPrmptCd", "_LineItm", "_TripWorkOrdr", "_TripBllgId", "_TxRltdData", "_Drvr", "_AgtFuelPrmptCd", "_TripNb", "_TripInvcNb", "_Vhcl", "_TripDlvryTcktNb", "_TripCtrlNb", "_AddtlNtrdData"]
	@property
	def TripJobNb(self):
