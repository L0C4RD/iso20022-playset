...
class FleetData6(base_types._BaseFieldType):
	...
	__slots__ = ["_TripInvcNb", "_TripDlvryTcktNb", "_Drvr", "_TripJobNb", "_Vhcl", "_TripWorkOrdr", "_TxRltdData", "_DrvrOrVhclCard", "_TripNb", "_LclAmnty", "_LineItm", "_AddtlNtrdData", "_TripBllgId", "_TripCtrlNb", "_CardFuelPrmptCd", "_AgtFuelPrmptCd"]
	@property
	def TripInvcNb(self):
