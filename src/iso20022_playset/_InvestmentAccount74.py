...
class InvestmentAccount74(base_types._BaseFieldType):
	...
	__slots__ = ["_BlckdSts", "_FndFmlyNm", "_AcctSts", "_ThrdPtyRghts", "_PrcgOrdr", "_NegInd", "_TaxXmptn", "_StmtFrqcy", "_Id", "_RinvstmtDtls", "_InvstrPrfl", "_FsclYr", "_LttrInttDtls", "_FrgnStsCertfctn", "_InvstmtAcctCtgy", "_RndgDtls", "_TxChanlTp", "_Tp", "_AcmltnRghtRef", "_AcctUsgTp", "_AcctSgntrDtTm", "_ReqrdSgntriesNb", "_Dsgnt", "_ClsgDt", "_OwnrshTp", "_RefCcy", "_Coll", "_Lang", "_IncmPref", "_FinInstrmDtls", "_AcctSvcr", "_PwrOfAttnyLvlOfCtrl", "_Nm", "_Pldgg", "_Lblty", "_AcctgSts", "_OpngDt", "_TaxWhldgMtd", "_StsDt", "_TaxRptg"]
	@property
	def BlckdSts(self):
