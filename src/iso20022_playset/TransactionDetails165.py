...
class TransactionDetails165(base_types._BaseFieldType):
	...
	__slots__ = ["_TxActvty", "_DlvrgSttlmPties", "_MtchdStsTmStmp", "_SttlmParams", "_SttlmTxOrCorpActnEvtTp", "_FctvSttlmDt", "_TradDt", "_Pmt", "_TxAddtlDtls", "_ValDt", "_AcrdIntrstAmt", "_PlcOfTrad", "_AckdStsTmStmp", "_SctiesMvmntTp", "_RcvgSttlmPties", "_PlcOfClr", "_NbOfDaysAcrd", "_PstngQty", "_RvslInd", "_SfkpgPlc", "_SttlmDt", "_PstngAmt"]
	@property
	def TxActvty(self):
