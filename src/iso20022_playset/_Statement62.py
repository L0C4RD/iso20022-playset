...
class Statement62(base_types._BaseFieldType):
	...
	def CtrPtyPrtflTrfNtfctnRef(self, value):
		self._CtrPtyPrtflTrfNtfctnRef = value if value is not None else base_types.UninitialisedField(self, 'CtrPtyPrtflTrfNtfctnRef', Max35Text, False)

	@CtrPtyPrtflTrfNtfctnRef.deleter
	def CtrPtyPrtflTrfNtfctnRef(self):
		del self._CtrPtyPrtflTrfNtfctnRef
		self._CtrPtyPrtflTrfNtfctnRef = base_types.UninitialisedField(self, 'CtrPtyPrtflTrfNtfctnRef', Max35Text, False)
