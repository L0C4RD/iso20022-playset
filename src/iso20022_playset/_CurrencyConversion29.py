...
class CurrencyConversion29(base_types._BaseFieldType):
	...
	__slots__ = ["_DclrtnDtls", "_TrgtCcy", "_AplblBinRg", "_RsltgAmt", "_QtnDt", "_MrkUpDtls", "_NvrtdXchgRate", "_VldFr", "_XchgRate", "_OrgnlAmt", "_VldUntil", "_CcyConvsId", "_SrcCcy", "_ComssnDtls"]
	@property
	def DclrtnDtls(self):
