...
class ValueForMoney1(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrRvwRltdToValAndOrChrgsUK", "_RvwNxtDueUK", "_EMTDataRptgVFMUK", "_OutcmOfPRINValAssmntOrRvwUK", "_FrthrInfUK", "_RvwDtUK", "_AssmntOfValReqrdUdrCOLLUK", "_OutcmOfCOLLAssmntOfValUK"]
	@property
