...
class ATMTransaction51(base_types._BaseFieldType):
	...
	__slots__ = ["_SubDpst", "_RctPrtd", "_ICCRltdData", "_ToBeRcncldMdiaCntrs", "_TtlAuthrsdAmt", "_TxSts", "_ATMTtls", "_AddtlChrg", "_TtlDpstdAmt", "_RcncltnId", "_Csstt", "_TxId", "_Incdnt", "_AuthstnRslt", "_ReqdRct", "_IncdntDtl", "_TtlReqdAmt", "_DtldReqdAmt"]
	@property
	def SubDpst(self):
