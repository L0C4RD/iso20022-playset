...
class ATMTransaction51(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlReqdAmt", "_TxId", "_DtldReqdAmt", "_SubDpst", "_ReqdRct", "_ToBeRcncldMdiaCntrs", "_AuthstnRslt", "_TtlAuthrsdAmt", "_AddtlChrg", "_IncdntDtl", "_ATMTtls", "_ICCRltdData", "_TxSts", "_Csstt", "_RctPrtd", "_TtlDpstdAmt", "_RcncltnId", "_Incdnt"]
	@property
	def TtlReqdAmt(self):
