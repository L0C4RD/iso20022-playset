...
class ATMTransaction51(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlDpstdAmt", "_IncdntDtl", "_ATMTtls", "_ReqdRct", "_DtldReqdAmt", "_TxSts", "_AuthstnRslt", "_TxId", "_ToBeRcncldMdiaCntrs", "_TtlReqdAmt", "_AddtlChrg", "_RcncltnId", "_SubDpst", "_ICCRltdData", "_Csstt", "_RctPrtd", "_Incdnt", "_TtlAuthrsdAmt"]
	@property
