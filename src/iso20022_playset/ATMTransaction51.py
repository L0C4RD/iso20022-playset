...
class ATMTransaction51(base_types._BaseFieldType):
	...
	__slots__ = ["_ICCRltdData", "_DtldReqdAmt", "_ToBeRcncldMdiaCntrs", "_RcncltnId", "_AddtlChrg", "_TxId", "_RctPrtd", "_AuthstnRslt", "_Incdnt", "_TtlAuthrsdAmt", "_Csstt", "_IncdntDtl", "_ATMTtls", "_TxSts", "_ReqdRct", "_TtlReqdAmt", "_SubDpst", "_TtlDpstdAmt"]
	@property
