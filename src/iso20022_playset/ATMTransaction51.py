...
class ATMTransaction51(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlDpstdAmt", "_RctPrtd", "_TtlAuthrsdAmt", "_ATMTtls", "_AddtlChrg", "_TxId", "_Csstt", "_ReqdRct", "_SubDpst", "_DtldReqdAmt", "_RcncltnId", "_TtlReqdAmt", "_ToBeRcncldMdiaCntrs", "_ICCRltdData", "_AuthstnRslt", "_TxSts", "_IncdntDtl", "_Incdnt"]
	@property
