...
class CorporateActionOption232(base_types._BaseFieldType):
	...
	__slots__ = ["_PrdDtls", "_PricDtls", "_CertfctnBrkdwnTp", "_OptnAvlbtySts", "_SctiesQty", "_DfltPrcgOrStgInstr", "_CcyOptn", "_ChngAllwdInd", "_ApldOptnInd", "_OptnFeatrs", "_RateAndAmtDtls", "_NonDmclCtry", "_DtDtls", "_WdrwlAllwdInd", "_ChrgsApldInd", "_VldDmclCtry", "_OfferTp", "_SctiesMvmntDtls", "_OptnNb", "_OptnTp", "_CertfctnBrkdwnInd", "_SctyId", "_FrctnDspstn", "_AccptncPrtyLvl", "_AddtlInf", "_CshMvmntDtls"]
	@property
	def PrdDtls(self):
