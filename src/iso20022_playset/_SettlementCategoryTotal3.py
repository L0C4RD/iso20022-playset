...
class SettlementCategoryTotal3(base_types._BaseFieldType):
	...
	__slots__ = ["_IntrchngFeeCdtDbt", "_Amt", "_Ccy", "_PrcgFeeAmt", "_PrcgFeeCcy", "_Cnt", "_CdtDbt", "_IntrchngFeeAmt", "_IntrchngFeeCcy", "_PrcgFeeCdtDbt"]
	@property
	...
	def PrcgFeeAmt(self, value):
		self._PrcgFeeAmt = value if type(value) != base_types.auto else self.make_default("PrcgFeeAmt")
	...
	def PrcgFeeCcy(self, value):
		self._PrcgFeeCcy = value if type(value) != base_types.auto else self.make_default("PrcgFeeCcy")
	...
	def PrcgFeeCdtDbt(self, value):
		self._PrcgFeeCdtDbt = value if type(value) != base_types.auto else self.make_default("PrcgFeeCdtDbt")
