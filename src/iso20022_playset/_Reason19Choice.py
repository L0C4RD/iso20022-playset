...
from . import PendingCancellationReasons4Choice
from . import PendingProcessingReason11Choice
from . import PendingReason28Choice
from . import PendingReason29Choice
...
class Reason19Choice(base_types._BaseFieldType):
	...
	def PdgCxlRsn(self, value):
		self._PdgCxlRsn = value if value is not None else base_types.UninitialisedField(self, 'PdgCxlRsn', PendingCancellationReasons4Choice, False)

	@PdgCxlRsn.deleter
	def PdgCxlRsn(self):
		del self._PdgCxlRsn
		self._PdgCxlRsn = base_types.UninitialisedField(self, 'PdgCxlRsn', PendingCancellationReasons4Choice, False)
	...
	def PdgPrcgRsn(self, value):
		self._PdgPrcgRsn = value if value is not None else base_types.UninitialisedField(self, 'PdgPrcgRsn', PendingProcessingReason11Choice, False)

	@PdgPrcgRsn.deleter
	def PdgPrcgRsn(self):
		del self._PdgPrcgRsn
		self._PdgPrcgRsn = base_types.UninitialisedField(self, 'PdgPrcgRsn', PendingProcessingReason11Choice, False)
	...
	def PdgRsn(self, value):
		self._PdgRsn = value if value is not None else base_types.UninitialisedField(self, 'PdgRsn', PendingReason29Choice, False)

	@PdgRsn.deleter
	def PdgRsn(self):
		del self._PdgRsn
		self._PdgRsn = base_types.UninitialisedField(self, 'PdgRsn', PendingReason29Choice, False)
