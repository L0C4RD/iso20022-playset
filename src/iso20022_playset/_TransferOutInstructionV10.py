...
from . import InvestmentAccount82
from . import MarketPracticeVersion1
from . import Max35Text
from . import MessageIdentification1
from . import ReceiveInformation22
from . import Transfer39

class TransferOutInstructionV10(base_types._BaseFieldType):
	...
	def AcctDtls(self, value):
		self._AcctDtls = value if value is not None else base_types.UninitialisedField(self, 'AcctDtls', InvestmentAccount82, False)

	@AcctDtls.deleter
	def AcctDtls(self):
		del self._AcctDtls
		self._AcctDtls = base_types.UninitialisedField(self, 'AcctDtls', InvestmentAccount82, False)
	...
	def SttlmDtls(self, value):
		self._SttlmDtls = value if value is not None else base_types.UninitialisedField(self, 'SttlmDtls', ReceiveInformation22, False)

	@SttlmDtls.deleter
	def SttlmDtls(self):
		del self._SttlmDtls
		self._SttlmDtls = base_types.UninitialisedField(self, 'SttlmDtls', ReceiveInformation22, False)
	...
	_field_defs = frozenset((
		base_types.FieldEntry(name='AcctDtls', type=InvestmentAccount82, min=1, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='SttlmDtls', type=ReceiveInformation22, min=0, max=1, mutex_group=None, array=False),
