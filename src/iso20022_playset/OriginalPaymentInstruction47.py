...
from .PaymentTransaction150 import PaymentTransaction150
...
class OriginalPaymentInstruction47(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlCtrlSum", "_PmtInfSts", "_OrgnlPmtInfId", "_TxInfAndSts", "_OrgnlNbOfTxs", "_StsRsnInf", "_NbOfTxsPerSts"]
	@property
