...
class ProtectInstruction5(base_types._BaseFieldType):
	...
	def PrtctSfkpgAcct(self, value):
		self._PrtctSfkpgAcct = value if value is not None else base_types.UninitialisedField(self, 'PrtctSfkpgAcct', RestrictedFINMax35Text, False)

	@PrtctSfkpgAcct.deleter
	def PrtctSfkpgAcct(self):
		del self._PrtctSfkpgAcct
		self._PrtctSfkpgAcct = base_types.UninitialisedField(self, 'PrtctSfkpgAcct', RestrictedFINMax35Text, False)
