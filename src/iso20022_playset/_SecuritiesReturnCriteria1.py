...
class SecuritiesReturnCriteria1(base_types._BaseFieldType):
	...
	__slots__ = ["_SctiesQtyTp", "_InvstrCSD", "_IssrCSD", "_DevtgSttlmUnit", "_IsseCcy", "_FinInstrmId", "_MinMltplQty", "_IsseDt", "_MtrtyDt", "_CSD", "_CtryOfIsse", "_TechIssrCSD", "_MinDnmtn", "_ISOSctyShrtNm", "_SctySts", "_ISOSctyLngNm", "_ClssfctnFinInstrm"]
	@property
