...
class OtherAmounts33(base_types._BaseFieldType):
	...
	__slots__ = ["_ValAddedTax", "_Othr", "_CsmptnTax", "_AcrdCptlstnAmt", "_StockXchgTax", "_WhldgTax", "_RgltryAmt", "_ShppgAmt", "_TrfTax", "_ChrgsFees", "_AcrdIntrstAmt", "_TxTax", "_LclTax", "_CtryNtlFdrlTax", "_StmpDty", "_PmtLevyTax"]
	@property
