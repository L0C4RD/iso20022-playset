...
class OtherAmounts33(base_types._BaseFieldType):
	...
	__slots__ = ["_StmpDty", "_TxTax", "_CsmptnTax", "_CtryNtlFdrlTax", "_Othr", "_AcrdCptlstnAmt", "_LclTax", "_ChrgsFees", "_ShppgAmt", "_PmtLevyTax", "_ValAddedTax", "_WhldgTax", "_StockXchgTax", "_TrfTax", "_AcrdIntrstAmt", "_RgltryAmt"]
	@property
	def StmpDty(self):
