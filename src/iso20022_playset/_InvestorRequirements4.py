...
class InvestorRequirements4(base_types._BaseFieldType):
	...
	__slots__ = ["_RtrPrflGrwth", "_OptnOrLvrgdRtrPrfl", "_Othr", "_RtrPrflIncm", "_RtrPrflHdgg", "_RtrPrflPrsrvtn", "_MinHldgPrd", "_OthrSpcfcInvstmtNeed", "_RtrPrflPnsnSchmeDE", "_SstnbltyPrefs"]
	@property
