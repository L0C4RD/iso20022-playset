...
class InvestorRequirements4(base_types._BaseFieldType):
	...
	__slots__ = ["_RtrPrflGrwth", "_OthrSpcfcInvstmtNeed", "_OptnOrLvrgdRtrPrfl", "_SstnbltyPrefs", "_MinHldgPrd", "_RtrPrflPrsrvtn", "_RtrPrflPnsnSchmeDE", "_RtrPrflHdgg", "_RtrPrflIncm", "_Othr"]
	@property
