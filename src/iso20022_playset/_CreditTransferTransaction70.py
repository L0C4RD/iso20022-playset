...
class CreditTransferTransaction70(base_types._BaseFieldType):
	...
	__slots__ = ["_IntrmyAgt2", "_CdtrAgtAcct", "_IntrBkSttlmDt", "_Dbtr", "_XchgRate", "_InstrForNxtAgt", "_Purp", "_InstrForCdtrAgt", "_RgltryRptg", "_InstgAgt", "_PrvsInstgAgt1", "_PmtTpInf", "_Tax", "_RmtInf", "_PrvsInstgAgt1Acct", "_IntrmyAgt3", "_IntrmyAgt2Acct", "_UltmtDbtr", "_PrvsInstgAgt2Acct", "_ChrgBr", "_PmtSgntr", "_DbtrAgt", "_MndtRltdInf", "_DbtrAcct", "_IntrmyAgt3Acct", "_SttlmPrty", "_PmtId", "_SplmtryData", "_PrvsInstgAgt3Acct", "_IntrmyAgt1Acct", "_AddtlDtTm", "_SttlmTmIndctn", "_ChrgsInf", "_IntrmyAgt1", "_PrvsInstgAgt2", "_UltmtCdtr", "_InitgPty", "_AgrdRate", "_IntrBkSttlmAmt", "_InstdAmt", "_CdtrAgt", "_Cdtr", "_RltdRmtInf", "_DbtrAgtAcct", "_InstdAgt", "_SttlmTmReq", "_PrvsInstgAgt3", "_CdtrAcct"]
	@property
	def IntrmyAgt2(self):
