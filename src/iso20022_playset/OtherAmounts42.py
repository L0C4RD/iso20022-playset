...
class OtherAmounts42(base_types._BaseFieldType):
	...
	__slots__ = ["_LclBrkrComssn", "_NetGnLoss", "_ShppgAmt", "_WhldgTax", "_ChrgsFees", "_SpclCncssn", "_ValAddedTax", "_AcrdIntrstAmt", "_AcrdCptlstnAmt", "_BookVal", "_PmtLevyTax", "_CtryNtlFdrlTax", "_TradAmt", "_StmpDty", "_IsseDscntAllwnc", "_ExctgBrkrAmt", "_Mrgn", "_RgltryAmt", "_TrfTax", "_Othr", "_StockXchgTax", "_CsmptnTax", "_LclTax", "_TxTax", "_RsrchFee"]
	@property
