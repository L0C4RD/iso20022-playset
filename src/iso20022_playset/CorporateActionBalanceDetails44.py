...
class CorporateActionBalanceDetails44(base_types._BaseFieldType):
	...
	__slots__ = ["_InTrnsShipmntBal", "_RegdBal", "_CollOutBal", "_OutForRegnBal", "_SttlmPosBal", "_BlckdBal", "_CollInBal", "_StrtPosBal", "_PdgRctBal", "_TtlElgblBal", "_TradDtPosBal", "_OnLnBal", "_BrrwdBal", "_PdgDlvryBal"]
	@property
