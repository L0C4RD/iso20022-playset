...
class CorporateActionBalanceDetails44(base_types._BaseFieldType):
	...
	__slots__ = ["_OnLnBal", "_TtlElgblBal", "_CollInBal", "_CollOutBal", "_BlckdBal", "_RegdBal", "_PdgDlvryBal", "_SttlmPosBal", "_InTrnsShipmntBal", "_TradDtPosBal", "_StrtPosBal", "_BrrwdBal", "_OutForRegnBal", "_PdgRctBal"]
	@property
	def OnLnBal(self):
