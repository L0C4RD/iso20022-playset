...
import Max35Text
import ActionMessage5
import ATMExchangeRateComponent1

class CurrencyConversion32(base_types._BaseFieldType):

	__slots__ = ["_RsltgAmt", "_OrgnlAmt", "_DclrtnDtls", "_VldUntil", "_CcyConvsId", "_SrcCcy", "_XchgRate", "_QtnDt", "_TrgtCcy", "_NvrtdXchgRate", "_ComssnDtls", "_MrkUpDtls", "_RefRate"]
	@property
	def RsltgAmt(self):
