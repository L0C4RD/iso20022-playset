...
class References76Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_TradId", "_IntraPosMvmntId", "_MktInfrstrctrTxId", "_OthrTxId", "_PoolId", "_AcctSvcrTxId", "_CmonId", "_IntraBalMvmntId", "_CtrPtyMktInfrstrctrTxId", "_SctiesSttlmTxId"]
	@property
	def TradId(self):
		return self._TradId
