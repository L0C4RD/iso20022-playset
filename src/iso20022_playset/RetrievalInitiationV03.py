...
class RetrievalInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_PrcgRslt", "_Pyer", "_SttlmSvc", "_Card", "_Cntxt", "_TxChrtcs", "_SpclPrgrmmQlfctn", "_Rcvr", "_Rcncltn", "_SctyTrlr", "_Prgrmm", "_PrtctdData", "_RtrvlFlfmtDstn", "_Acqrr", "_OrgnlTx", "_AddtlFee", "_Jursdctn", "_Accptr", "_AddtlData", "_ConvsDtTm", "_Orgtr", "_Wllt", "_Sndr", "_Tkn", "_TxId", "_Dstn", "_Termnl", "_Pyee", "_RtrvlFlfmtInstrs", "_Issr", "_Hdr", "_DsptData"]
	@property
