...
class FinancialInstrumentAttributes122(base_types._BaseFieldType):
	...
	__slots__ = ["_MtrtyDt", "_XpryDt", "_OptnTp", "_ExrcPric", "_VarblRateInd", "_CtrctSz", "_IsseDt", "_FltgRateFxgDt", "_DayCntBsis", "_IntrstRate", "_CpnDt", "_RegnForm", "_NxtCllblDt", "_PmtFrqcy", "_PmtSts", "_CpnAttchdNb", "_IndxRateBsis", "_YldToMtrtyRate", "_PoolNb", "_MktOrIndctvPric", "_FrstPmtDt", "_PutblDt", "_PutblInd", "_ClssfctnTp", "_DtdDt", "_NxtIntrstRate", "_CllblInd", "_OptnStyle", "_PlcOfListg", "_UndrlygFinInstrmId", "_NxtFctr", "_DnmtnCcy", "_FinInstrmAttrAddtlDtls", "_PrvsFctr", "_SbcptPric", "_StrkPric", "_ConvsPric", "_CurFctr", "_VarblRateChngFrqcy", "_MinNmnlQty"]
	@property
	def MtrtyDt(self):
