...
class Amendment1(base_types._BaseFieldType):
	...
	__slots__ = ["_UdrtkgId", "_AddtlInf", "_NewBnfcry", "_BnfcryCnsntReqInd", "_AdvsgPty", "_NewUdrtkgTermsAndConds", "_ScndAdvsgPty", "_DtOfIssnc", "_SeqNb", "_UdrtkgAmtAdjstmnt", "_NewXpryDtls", "_LclUdrtkg", "_DlvryChanl", "_TermntnDtls", "_NclsdFile"]
	@property
	def UdrtkgId(self):
