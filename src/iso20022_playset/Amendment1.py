...
class Amendment1(base_types._BaseFieldType):
	...
	__slots__ = ["_NewUdrtkgTermsAndConds", "_DtOfIssnc", "_AdvsgPty", "_AddtlInf", "_ScndAdvsgPty", "_TermntnDtls", "_NewBnfcry", "_BnfcryCnsntReqInd", "_LclUdrtkg", "_UdrtkgId", "_UdrtkgAmtAdjstmnt", "_DlvryChanl", "_NewXpryDtls", "_NclsdFile", "_SeqNb"]
	@property
