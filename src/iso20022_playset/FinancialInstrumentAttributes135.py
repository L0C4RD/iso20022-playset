...
class FinancialInstrumentAttributes135(base_types._BaseFieldType):
	...
	__slots__ = ["_IsseDt", "_MinNmnlQty", "_MinQtyToInst", "_CtrctSz", "_ConvsDt", "_NxtCllblDt", "_IssePric", "_FinInstrmId", "_FltgRateFxgDt", "_PlcOfListg", "_MtrtyDt", "_PutblDt", "_DtdDt", "_DayCntBsis", "_OptnStyle", "_NxtCpnDt", "_ClssfctnTp", "_IntrstRate", "_MinMltplQtyToInst", "_NxtIntrstRate", "_PrvsFctr", "_NxtFctr", "_DnmtnCcy"]
	@property
	def IsseDt(self):
		return self._IsseDt
