...
class FinancialInstrumentAttributes135(base_types._BaseFieldType):
	...
	__slots__ = ["_DayCntBsis", "_DtdDt", "_FinInstrmId", "_PlcOfListg", "_IntrstRate", "_NxtFctr", "_MtrtyDt", "_IsseDt", "_DnmtnCcy", "_NxtCpnDt", "_OptnStyle", "_MinMltplQtyToInst", "_PutblDt", "_NxtIntrstRate", "_IssePric", "_MinNmnlQty", "_PrvsFctr", "_NxtCllblDt", "_ConvsDt", "_ClssfctnTp", "_FltgRateFxgDt", "_CtrctSz", "_MinQtyToInst"]
	@property
	def DayCntBsis(self):
