...
class LineItem13(base_types._BaseFieldType):
	...
	__slots__ = ["_BuyrDfndInf", "_PrtlShipmnt", "_SellrDfndInf", "_RtgSummry", "_LineItmDtls", "_LineItmsTtlAmt", "_Incotrms", "_FrghtChrgs", "_Tax", "_TtlNetAmt", "_ShipmntDtRg", "_Adjstmnt", "_GoodsAndOrSvcsDesc", "_TrnsShipmnt"]
	@property
	...
	def TrnsShipmnt(self, value):
		self._TrnsShipmnt = value if type(value) != base_types.auto else self.make_default("TrnsShipmnt")
