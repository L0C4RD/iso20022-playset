...
class OtherAmounts39(base_types._BaseFieldType):
	...
	__slots__ = ["_RgltryAmt", "_ShppgAmt", "_ExctgBrkrAmt", "_PmtLevyTax", "_ValAddedTax", "_WhldgTax", "_IsseDscntAllwnc", "_NetGnLoss", "_RsrchFee", "_CtryNtlFdrlTax", "_TxTax", "_CsmptnTax", "_TrfTax", "_ChrgsFees", "_LclTaxCtrySpcfc", "_Othr", "_Mrgn", "_StockXchgTax", "_AcrdCptlstnAmt", "_TradAmt", "_LclTax", "_AcrdIntrstAmt", "_LclBrkrComssn", "_StmpDty", "_SpclCncssn"]
	@property
	def RgltryAmt(self):
