...
class OtherAmounts39(base_types._BaseFieldType):

	__slots__ = ["_TradAmt", "_StmpDty", "_LclTax", "_SpclCncssn", "_TrfTax", "_StockXchgTax", "_IsseDscntAllwnc", "_ChrgsFees", "_ExctgBrkrAmt", "_ShppgAmt", "_NetGnLoss", "_AcrdIntrstAmt", "_ValAddedTax", "_LclBrkrComssn", "_CtryNtlFdrlTax", "_RsrchFee", "_WhldgTax", "_PmtLevyTax", "_AcrdCptlstnAmt", "_Mrgn", "_TxTax", "_RgltryAmt", "_Othr", "_LclTaxCtrySpcfc", "_CsmptnTax"]
	@property
	def TradAmt(self):
