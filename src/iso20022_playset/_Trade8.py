...
from .DeliveryType4Code import DeliveryType4Code
...
class Trade8(base_types._BaseFieldType):
	...
	__slots__ = ["_TradgMd", "_SttlmCcy", "_ClrMtd", "_FXTradPdct", "_DlvryTp", "_PdctId", "_SwpLeg", "_TradgMtd", "_TradId", "_Symb", "_FXDtls", "_AssoctdTradRef", "_TradDt", "_TradgCcy", "_PlcOfConf"]
	@property
	def TradgMd(self):
