...
class Trade8(base_types._BaseFieldType):

	__slots__ = ["_AssoctdTradRef", "_ClrMtd", "_DlvryTp", "_FXDtls", "_FXTradPdct", "_PdctId", "_PlcOfConf", "_SttlmCcy", "_SwpLeg", "_Symb", "_TradDt", "_TradId", "_TradgCcy", "_TradgMd", "_TradgMtd"]
	@property
	...
	def DlvryTp(self, value):
		self._DlvryTp = value if value is not None else base_types.UninitialisedField(self, 'DlvryTp', DeliveryType4Code, False)

	@DlvryTp.deleter
	def DlvryTp(self):
		del self._DlvryTp
		self._DlvryTp = base_types.UninitialisedField(self, 'DlvryTp', DeliveryType4Code, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='DlvryTp', type=DeliveryType4Code, min=0, max=1, mutex_group=None, array=False),
