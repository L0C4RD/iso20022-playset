...
class Trade8(base_types._BaseFieldType):
	...
	__slots__ = ["_Symb", "_FXTradPdct", "_SttlmCcy", "_TradId", "_TradgMd", "_TradgCcy", "_TradDt", "_ClrMtd", "_AssoctdTradRef", "_PdctId", "_FXDtls", "_DlvryTp", "_PlcOfConf", "_TradgMtd", "_SwpLeg"]
	@property
	def Symb(self):
		return self._Symb
