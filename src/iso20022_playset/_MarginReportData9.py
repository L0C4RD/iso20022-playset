...
class MarginReportData9(base_types._BaseFieldType):
	...
	__slots__ = ["_RcvdMrgnOrColl", "_CtrPtyRatgThrshldInd", "_SplmtryData", "_CtrPtyId", "_EvtDt", "_RptgTmStmp", "_CtrPtyRatgTrggrInd", "_TxId", "_Coll", "_PstdMrgnOrColl", "_TechAttrbts"]
	@property
