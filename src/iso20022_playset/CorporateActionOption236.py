...
class CorporateActionOption236(base_types._BaseFieldType):
	...
	__slots__ = ["_WdrwlAllwdInd", "_DtDtls", "_SctiesQty", "_CshMvmntDtls", "_AccptncPrtyLvl", "_CcyOptn", "_DfltPrcgOrStgInstr", "_ChrgsApldInd", "_OptnTp", "_OptnFeatrs", "_SctiesMvmntDtls", "_OfferTp", "_VldDmclCtry", "_OptnNb", "_CertfctnBrkdwnTp", "_FinInstrmId", "_PrratnBlwMinQty", "_BidRgTp", "_OptnAvlbtySts", "_PrdDtls", "_NonDmclCtry", "_RateAndAmtDtls", "_FrctnDspstn", "_PricDtls", "_AddtlInf", "_ApldOptnInd", "_CertfctnBrkdwnInd", "_ChngAllwdInd"]
	@property
