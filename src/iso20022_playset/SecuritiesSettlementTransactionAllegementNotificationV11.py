...
class SecuritiesSettlementTransactionAllegementNotificationV11(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_MktInfrstrctrTxId", "_SttlmParams", "_TxId", "_CshPties", "_FinInstrmId", "_RcvgSttlmPties", "_SttlmTpAndAddtlParams", "_TradDtls", "_FinInstrmAttrbts", "_OthrBizPties", "_QtyAndAcctDtls", "_OthrAmts", "_DlvrgSttlmPties", "_CtrPtyMktInfrstrctrTxId", "_SctiesFincgDtls", "_SttlmAmt"]
	@property
