...
class SecuritiesSettlementTransactionAllegementNotificationV11(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrPtyMktInfrstrctrTxId", "_OthrAmts", "_SttlmTpAndAddtlParams", "_SctiesFincgDtls", "_SttlmParams", "_OthrBizPties", "_RcvgSttlmPties", "_DlvrgSttlmPties", "_SttlmAmt", "_SplmtryData", "_QtyAndAcctDtls", "_TxId", "_CshPties", "_MktInfrstrctrTxId", "_TradDtls", "_FinInstrmId", "_FinInstrmAttrbts"]
	@property
