...
class SecuritiesSettlementTransactionAllegementNotificationV11(base_types._BaseFieldType):
	...
	__slots__ = ["_TradDtls", "_FinInstrmId", "_DlvrgSttlmPties", "_CshPties", "_RcvgSttlmPties", "_SttlmParams", "_CtrPtyMktInfrstrctrTxId", "_OthrAmts", "_QtyAndAcctDtls", "_MktInfrstrctrTxId", "_TxId", "_FinInstrmAttrbts", "_SttlmAmt", "_SctiesFincgDtls", "_OthrBizPties", "_SplmtryData", "_SttlmTpAndAddtlParams"]
	@property
	def TradDtls(self):
