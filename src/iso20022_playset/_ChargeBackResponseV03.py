...
class ChargeBackResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_Acqrr", "_Cntxt", "_OrgnlTxAmts", "_SctyTrlr", "_Accptr", "_SttlmSvc", "_Card", "_TxAmts", "_TxId", "_Hdr", "_PrcgRslt", "_AddtlData", "_Rcvr", "_TxChrtcs", "_Sndr", "_Dstn", "_ConvsDtTm", "_Issr", "_Rcncltn", "_Tkn", "_Jursdctn", "_Dcmnttn", "_Termnl", "_Orgtr", "_Prgrmm", "_AddtlFee", "_DsptData", "_PrtctdData"]
	@property
