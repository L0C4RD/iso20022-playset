...
class FinancialInstrumentAttributes134(base_types._BaseFieldType):

	__slots__ = ["_XpryDt", "_FltgRateFxgDt", "_PlcOfListg", "_DtdDt", "_NxtCllblDt", "_NxtFctr", "_WarrtParity", "_DnmtnCcy", "_PutblDt", "_PctgOfDebtClm", "_NxtIntrstRate", "_ConvsDt", "_OptnStyle", "_DayCntBsis", "_MinNmnlQty", "_PrvsFctr", "_MtrtyDt", "_NxtCpnDt", "_IntrstRate", "_CtrctSz", "_IsseDt", "_ClssfctnTp", "_FinInstrmId"]
	@property
	def XpryDt(self):
		return self._XpryDt
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='WarrtParity', type=QuantityToQuantityRatio2, min=0, max=1, mutex_group=None, array=False),
