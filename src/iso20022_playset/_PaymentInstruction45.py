...
from . import DirectDebitTransactionInformation32
from . import ISODate
...
class PaymentInstruction45(base_types._BaseFieldType):
	...
	def DrctDbtTxInf(self, value):
		self._DrctDbtTxInf = value if value is not None else base_types.UninitialisedField(self, 'DrctDbtTxInf', DirectDebitTransactionInformation32, True)

	@DrctDbtTxInf.deleter
	def DrctDbtTxInf(self):
		del self._DrctDbtTxInf
		self._DrctDbtTxInf = base_types.UninitialisedField(self, 'DrctDbtTxInf', DirectDebitTransactionInformation32, True)
