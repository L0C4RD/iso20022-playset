...
class PaymentInstruction45(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrlSum", "_NbOfTxs", "_ChrgBr", "_PmtInfId", "_Cdtr", "_CdtrAgtAcct", "_ChrgsAcct", "_UltmtCdtr", "_ReqdColltnDt", "_ChrgsAcctAgt", "_ReqdAdvcTp", "_BtchBookg", "_DrctDbtTxInf", "_CdtrAgt", "_PmtMtd", "_PmtTpInf", "_CdtrAcct", "_CdtrSchmeId"]
	@property
	def CtrlSum(self):
