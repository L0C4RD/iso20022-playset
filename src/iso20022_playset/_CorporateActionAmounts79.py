...
class CorporateActionAmounts79(base_types._BaseFieldType):
	...
	def AdjstdSbcptAmt(self, value):
		self._AdjstdSbcptAmt = value if value is not None else base_types.UninitialisedField(self, 'AdjstdSbcptAmt', ActiveCurrencyAndAmount, False)

	@AdjstdSbcptAmt.deleter
	def AdjstdSbcptAmt(self):
		del self._AdjstdSbcptAmt
		self._AdjstdSbcptAmt = base_types.UninitialisedField(self, 'AdjstdSbcptAmt', ActiveCurrencyAndAmount, False)
	...
	def EUTaxRtntnAmt(self, value):
		self._EUTaxRtntnAmt = value if value is not None else base_types.UninitialisedField(self, 'EUTaxRtntnAmt', ActiveCurrencyAndAmount, False)

	@EUTaxRtntnAmt.deleter
	def EUTaxRtntnAmt(self):
		del self._EUTaxRtntnAmt
		self._EUTaxRtntnAmt = base_types.UninitialisedField(self, 'EUTaxRtntnAmt', ActiveCurrencyAndAmount, False)
	...
	def NtnlDvddPyblAmt(self, value):
		self._NtnlDvddPyblAmt = value if value is not None else base_types.UninitialisedField(self, 'NtnlDvddPyblAmt', ActiveCurrencyAndAmount, False)

	@NtnlDvddPyblAmt.deleter
	def NtnlDvddPyblAmt(self):
		del self._NtnlDvddPyblAmt
		self._NtnlDvddPyblAmt = base_types.UninitialisedField(self, 'NtnlDvddPyblAmt', ActiveCurrencyAndAmount, False)
	...
	def NtnlTaxAmt(self, value):
		self._NtnlTaxAmt = value if value is not None else base_types.UninitialisedField(self, 'NtnlTaxAmt', ActiveCurrencyAndAmount, False)

	@NtnlTaxAmt.deleter
	def NtnlTaxAmt(self):
		del self._NtnlTaxAmt
		self._NtnlTaxAmt = base_types.UninitialisedField(self, 'NtnlTaxAmt', ActiveCurrencyAndAmount, False)
	...
	def RfnddSbcptAmt(self, value):
		self._RfnddSbcptAmt = value if value is not None else base_types.UninitialisedField(self, 'RfnddSbcptAmt', ActiveCurrencyAndAmount, False)

	@RfnddSbcptAmt.deleter
	def RfnddSbcptAmt(self):
		del self._RfnddSbcptAmt
		self._RfnddSbcptAmt = base_types.UninitialisedField(self, 'RfnddSbcptAmt', ActiveCurrencyAndAmount, False)
	...
	def StockXchgTax(self, value):
		self._StockXchgTax = value if value is not None else base_types.UninitialisedField(self, 'StockXchgTax', ActiveCurrencyAndAmount, False)

	@StockXchgTax.deleter
	def StockXchgTax(self):
		del self._StockXchgTax
		self._StockXchgTax = base_types.UninitialisedField(self, 'StockXchgTax', ActiveCurrencyAndAmount, False)
	...
	def TaxArrearsAmt(self, value):
		self._TaxArrearsAmt = value if value is not None else base_types.UninitialisedField(self, 'TaxArrearsAmt', ActiveCurrencyAndAmount, False)

	@TaxArrearsAmt.deleter
	def TaxArrearsAmt(self):
		del self._TaxArrearsAmt
		self._TaxArrearsAmt = base_types.UninitialisedField(self, 'TaxArrearsAmt', ActiveCurrencyAndAmount, False)
