...
class Debt5(base_types._BaseFieldType):
	...
	__slots__ = ["_Geogcs", "_PlsMax", "_SbstitnFrqcy", "_PerptlInd", "_XtndblPrd", "_VarblRateInd", "_PotntlEuroSysElgblty", "_MinQty", "_WhlPoolInd", "_CstPrePmtPnltyInd", "_PlsPerLot", "_PreFnddInd", "_IntrstRate", "_PricSrc", "_Sctr", "_AutoRinvstmt", "_Pdctn", "_FrstPmtDt", "_AmtsblInd", "_WghtdAvrgLn", "_CpnRg", "_IntrstClctnMtd", "_PlsPerMln", "_EscrwdInd", "_XprtnDt", "_DtdDt", "_CstPrePmtYld", "_SubrdntdInd", "_PrvsFctr", "_WghtdAvrgCpn", "_YldClctn", "_PricRg", "_CPRegnTp", "_YldRg", "_PmtCcy", "_MtrtyDt", "_NxtIntrstRate", "_LookBck", "_Hrcut", "_BkQlfdInd", "_PmtDrctnInd", "_InsrdInd", "_CPPrgm", "_PricFrqcy", "_OverAlltmtRate", "_InstrmStrTp", "_PutblInd", "_NxtCpnDt", "_Purp", "_WghtdAvrgMtrty", "_FaceAmt", "_SbstitnLft", "_OddCpnInd", "_XtndblInd", "_NxtFctrDt", "_CllblInd", "_CptlsdIntrst", "_CurFctr", "_AltrntvMinTaxInd", "_ActlDnmtnAmt", "_WghtdAvrgLife", "_MaxSbstitn", "_MinIncrmt", "_IntrstFxgDt", "_NxtCllblDt", "_TxConds", "_PmtFrqcy", "_OverAlltmtAmt", "_IntrstAcrlDt", "_LotId", "_PutblDt", "_NxtFctr", "_IntrstTp", "_GblTp", "_PlsPerTrad", "_Pcs", "_RstrctdInd"]
	@property
	def Geogcs(self):
		return self._Geogcs
