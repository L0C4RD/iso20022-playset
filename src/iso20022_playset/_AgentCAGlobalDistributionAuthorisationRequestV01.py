...
from . import GlobalDistributionRequest1
...
class AgentCAGlobalDistributionAuthorisationRequestV01(base_types._BaseFieldType):
	...
	def GblDstrbtnDtls(self, value):
		self._GblDstrbtnDtls = value if value is not None else base_types.UninitialisedField(self, 'GblDstrbtnDtls', GlobalDistributionRequest1, False)

	@GblDstrbtnDtls.deleter
	def GblDstrbtnDtls(self):
		del self._GblDstrbtnDtls
		self._GblDstrbtnDtls = base_types.UninitialisedField(self, 'GblDstrbtnDtls', GlobalDistributionRequest1, False)
