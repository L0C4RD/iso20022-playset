...
class SecuritiesTradeDetails141(base_types._BaseFieldType):
	...
	__slots__ = ["_CollTxId", "_CmonId", "_PlcOfClr", "_RcvgSttlmPties", "_SttlmAmt", "_OthrAmts", "_TradDt", "_NbOfDaysAcrd", "_DlvrgSttlmPties", "_Sts", "_FinInstrmAttrbts", "_OthrBizPties", "_SplmtryData", "_PlcOfTrad", "_FinInstrmId", "_PoolId", "_SttlmParams", "_SctiesFincgDtls", "_PrcrTxId", "_TpOfPric", "_MktInfrstrctrTxId", "_SttlmDt", "_SctiesMvmntTp", "_CtrPtyMktInfrstrctrTxId", "_Pmt", "_AcctSvcrTxId", "_AcctOwnrTxId", "_TradTxCond", "_QtyAndAcctDtls", "_DealPric", "_UnqTxIdr", "_TradId"]
	@property
	def CollTxId(self):
