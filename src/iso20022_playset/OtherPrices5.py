...
class OtherPrices5(base_types._BaseFieldType):
	...
	__slots__ = ["_NtnlGrss", "_MrkdUp", "_MrkdDwn", "_RefPric", "_AllMktsWghtdAvrg", "_NetDscld", "_Max", "_NetUdscld", "_BchmkWghtdAvrg", "_OthrPric", "_Bchmk", "_Tx", "_MktBrkrComssn", "_IndxPric", "_RptdPric"]
	@property
	def NtnlGrss(self):
