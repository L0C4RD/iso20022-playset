...
from .PriceInformation28 import PriceInformation28
from .Price14 import Price14

class OtherPrices5(base_types._BaseFieldType):

	__slots__ = ["_NetUdscld", "_NtnlGrss", "_OthrPric", "_MrkdDwn", "_RptdPric", "_MktBrkrComssn", "_IndxPric", "_Max", "_NetDscld", "_AllMktsWghtdAvrg", "_MrkdUp", "_RefPric", "_Bchmk", "_BchmkWghtdAvrg", "_Tx"]
	@property
	def NetUdscld(self):
