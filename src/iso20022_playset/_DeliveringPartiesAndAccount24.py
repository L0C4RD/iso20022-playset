...
class DeliveringPartiesAndAccount24(base_types._BaseFieldType):
	...
	def DlvrgAgtDtls(self, value):
		self._DlvrgAgtDtls = value if value is not None else base_types.UninitialisedField(self, 'DlvrgAgtDtls', PartyIdentificationAndAccount235, False)

	@DlvrgAgtDtls.deleter
	def DlvrgAgtDtls(self):
		del self._DlvrgAgtDtls
		self._DlvrgAgtDtls = base_types.UninitialisedField(self, 'DlvrgAgtDtls', PartyIdentificationAndAccount235, False)
	...
	def DlvrrsCtdnDtls(self, value):
		self._DlvrrsCtdnDtls = value if value is not None else base_types.UninitialisedField(self, 'DlvrrsCtdnDtls', PartyIdentificationAndAccount235, False)

	@DlvrrsCtdnDtls.deleter
	def DlvrrsCtdnDtls(self):
		del self._DlvrrsCtdnDtls
		self._DlvrrsCtdnDtls = base_types.UninitialisedField(self, 'DlvrrsCtdnDtls', PartyIdentificationAndAccount235, False)
	...
	def DlvrrsIntrmy1Dtls(self, value):
		self._DlvrrsIntrmy1Dtls = value if value is not None else base_types.UninitialisedField(self, 'DlvrrsIntrmy1Dtls', PartyIdentificationAndAccount235, False)

	@DlvrrsIntrmy1Dtls.deleter
	def DlvrrsIntrmy1Dtls(self):
		del self._DlvrrsIntrmy1Dtls
		self._DlvrrsIntrmy1Dtls = base_types.UninitialisedField(self, 'DlvrrsIntrmy1Dtls', PartyIdentificationAndAccount235, False)
	...
	def DlvrrsIntrmy2Dtls(self, value):
		self._DlvrrsIntrmy2Dtls = value if value is not None else base_types.UninitialisedField(self, 'DlvrrsIntrmy2Dtls', PartyIdentificationAndAccount235, False)

	@DlvrrsIntrmy2Dtls.deleter
	def DlvrrsIntrmy2Dtls(self):
		del self._DlvrrsIntrmy2Dtls
		self._DlvrrsIntrmy2Dtls = base_types.UninitialisedField(self, 'DlvrrsIntrmy2Dtls', PartyIdentificationAndAccount235, False)
