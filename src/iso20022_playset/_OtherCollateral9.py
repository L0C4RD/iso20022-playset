...
class OtherCollateral9(base_types._BaseFieldType):
	...
	__slots__ = ["_LttrOfCdtAmt", "_Hrcut", "_SfkpgAcct", "_ValDt", "_LttrOfCdtId", "_BlckChainAdrOrWllt", "_IsseDt", "_CollId", "_CollVal", "_MktVal", "_OthrTpOfColl", "_GrntAmt", "_XpryDt", "_LtdCvrgInd", "_SfkpgPlc", "_Issr", "_XchgRate"]
	@property
