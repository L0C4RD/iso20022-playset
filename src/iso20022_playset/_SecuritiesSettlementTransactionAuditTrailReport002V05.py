...
from . import SecuritiesAccount37
from . import StatusTrail11
...
class SecuritiesSettlementTransactionAuditTrailReport002V05(base_types._BaseFieldType):
	...
	def SfkpgAcct(self, value):
		self._SfkpgAcct = value if value is not None else base_types.UninitialisedField(self, 'SfkpgAcct', SecuritiesAccount37, False)

	@SfkpgAcct.deleter
	def SfkpgAcct(self):
		del self._SfkpgAcct
		self._SfkpgAcct = base_types.UninitialisedField(self, 'SfkpgAcct', SecuritiesAccount37, False)
	...
	def StsTrl(self, value):
		self._StsTrl = value if value is not None else base_types.UninitialisedField(self, 'StsTrl', StatusTrail11, True)

	@StsTrl.deleter
	def StsTrl(self):
		del self._StsTrl
		self._StsTrl = base_types.UninitialisedField(self, 'StsTrl', StatusTrail11, True)
