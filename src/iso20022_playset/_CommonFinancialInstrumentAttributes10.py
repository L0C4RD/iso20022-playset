...
class CommonFinancialInstrumentAttributes10(base_types._BaseFieldType):
	...
	__slots__ = ["_Issnc", "_TradgMtd", "_FinInstrmForm", "_XpryDt", "_InitlPhysForm", "_SttlmInf", "_NmVldFr", "_Cnfdtl", "_CtctNm", "_PrncplPngAgt", "_Purp", "_ConvsRatioNmrtr", "_PrvtPlcmnt", "_LeadMgr", "_Clss", "_SprdAndBchmkCrv", "_SrNb", "_PngAgt", "_ISOSctyShrtNm", "_TEFRARule", "_PmtSts", "_ConvtblInd", "_RedPmtCcy", "_WhldgTaxRgm", "_CmonSfkpr", "_CpnAttchdNb", "_RcrdDt", "_DnmtnCcy", "_LglRstrctns", "_CallTp", "_PmryPlcOfDpst", "_CertNb", "_AftrXchgPhysForm", "_SctySts", "_Dpstry", "_TradgMkt", "_Rstrctn", "_FngbInd", "_CtrctVrsnNb", "_ISOSctyLngNm", "_TaxLotNb", "_NearTermPosLmt", "_ListgDt", "_ConvsRatioDnmtr", "_UndrlygRsk", "_PosLmt", "_RedTp", "_PoolNb", "_ConvsPrd", "_PutTp", "_CvrdInd", "_ClssfctnTp"]
	@property
	def Issnc(self):
		return self._Issnc
