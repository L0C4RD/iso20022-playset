...
class CommonFinancialInstrumentAttributes10(base_types._BaseFieldType):
	...
	__slots__ = ["_AftrXchgPhysForm", "_CallTp", "_CertNb", "_Clss", "_ClssfctnTp", "_CmonSfkpr", "_Cnfdtl", "_ConvsPrd", "_ConvsRatioDnmtr", "_ConvsRatioNmrtr", "_ConvtblInd", "_CpnAttchdNb", "_CtctNm", "_CtrctVrsnNb", "_CvrdInd", "_DnmtnCcy", "_Dpstry", "_FinInstrmForm", "_FngbInd", "_ISOSctyLngNm", "_ISOSctyShrtNm", "_InitlPhysForm", "_Issnc", "_LeadMgr", "_LglRstrctns", "_ListgDt", "_NearTermPosLmt", "_NmVldFr", "_PmryPlcOfDpst", "_PmtSts", "_PngAgt", "_PoolNb", "_PosLmt", "_PrncplPngAgt", "_PrvtPlcmnt", "_Purp", "_PutTp", "_RcrdDt", "_RedPmtCcy", "_RedTp", "_Rstrctn", "_SctySts", "_SprdAndBchmkCrv", "_SrNb", "_SttlmInf", "_TEFRARule", "_TaxLotNb", "_TradgMkt", "_TradgMtd", "_UndrlygRsk", "_WhldgTaxRgm", "_XpryDt"]
	@property
	...
	def CmonSfkpr(self, value):
		self._CmonSfkpr = value if value is not None else base_types.UninitialisedField(self, 'CmonSfkpr', AnyBICDec2014Identifier, False)

	@CmonSfkpr.deleter
	def CmonSfkpr(self):
		del self._CmonSfkpr
		self._CmonSfkpr = base_types.UninitialisedField(self, 'CmonSfkpr', AnyBICDec2014Identifier, False)
	...
	def ISOSctyLngNm(self, value):
		self._ISOSctyLngNm = value if value is not None else base_types.UninitialisedField(self, 'ISOSctyLngNm', Max350Text, False)

	@ISOSctyLngNm.deleter
	def ISOSctyLngNm(self):
		del self._ISOSctyLngNm
		self._ISOSctyLngNm = base_types.UninitialisedField(self, 'ISOSctyLngNm', Max350Text, False)
	...
	def ISOSctyShrtNm(self, value):
		self._ISOSctyShrtNm = value if value is not None else base_types.UninitialisedField(self, 'ISOSctyShrtNm', Max35Text, False)

	@ISOSctyShrtNm.deleter
	def ISOSctyShrtNm(self):
		del self._ISOSctyShrtNm
		self._ISOSctyShrtNm = base_types.UninitialisedField(self, 'ISOSctyShrtNm', Max35Text, False)
	...
	def Issnc(self, value):
		self._Issnc = value if value is not None else base_types.UninitialisedField(self, 'Issnc', Issuance5, False)

	@Issnc.deleter
	def Issnc(self):
		del self._Issnc
		self._Issnc = base_types.UninitialisedField(self, 'Issnc', Issuance5, False)
	...
	def NmVldFr(self, value):
		self._NmVldFr = value if value is not None else base_types.UninitialisedField(self, 'NmVldFr', DateAndDateTime2Choice, False)

	@NmVldFr.deleter
	def NmVldFr(self):
		del self._NmVldFr
		self._NmVldFr = base_types.UninitialisedField(self, 'NmVldFr', DateAndDateTime2Choice, False)
