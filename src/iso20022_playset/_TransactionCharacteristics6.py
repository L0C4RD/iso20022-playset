...
class TransactionCharacteristics6(base_types._BaseFieldType):

	__slots__ = ["_AltrnMsgRsn", "_Cxl", "_LclData", "_MsgRsn", "_NtlData", "_PrvtData", "_SbsqntTxTp", "_TxAttr", "_TxDesc", "_TxSubTp", "_TxTp"]
	@property
	...
	def SbsqntTxTp(self, value):
		self._SbsqntTxTp = value if type(value) != base_types.auto else self.make_default("SbsqntTxTp")

	@SbsqntTxTp.deleter
	def SbsqntTxTp(self):
		del self._SbsqntTxTp
		self._SbsqntTxTp = None
