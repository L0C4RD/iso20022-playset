...
class CorporateActionRate128(base_types._BaseFieldType):
	...
	__slots__ = ["_WhldgTaxRate", "_ChrgsFees", "_NewToOd", "_FinTxTaxRate", "_FsclStmp", "_TaxCdtRate", "_AddtlQtyForExstgScties", "_AddtlQtyForSbcbdRsltntScties", "_ScndLvlTax", "_AplblRate", "_TrfrmatnRate"]
	@property
