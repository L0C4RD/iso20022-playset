...
class CorporateActionRate128(base_types._BaseFieldType):

	__slots__ = ["_AddtlQtyForSbcbdRsltntScties", "_AplblRate", "_TrfrmatnRate", "_AddtlQtyForExstgScties", "_ChrgsFees", "_FinTxTaxRate", "_TaxCdtRate", "_WhldgTaxRate", "_ScndLvlTax", "_NewToOd", "_FsclStmp"]
	@property
