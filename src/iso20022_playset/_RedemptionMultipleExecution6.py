...
from . import RedemptionExecution17
...
class RedemptionMultipleExecution6(base_types._BaseFieldType):
	...
	def BlkCshSttlmDtls(self, value):
		self._BlkCshSttlmDtls = value if value is not None else base_types.UninitialisedField(self, 'BlkCshSttlmDtls', PaymentTransaction151, False)

	@BlkCshSttlmDtls.deleter
	def BlkCshSttlmDtls(self):
		del self._BlkCshSttlmDtls
		self._BlkCshSttlmDtls = base_types.UninitialisedField(self, 'BlkCshSttlmDtls', PaymentTransaction151, False)
	...
	def IndvExctnDtls(self, value):
		self._IndvExctnDtls = value if value is not None else base_types.UninitialisedField(self, 'IndvExctnDtls', RedemptionExecution17, True)

	@IndvExctnDtls.deleter
	def IndvExctnDtls(self):
		del self._IndvExctnDtls
		self._IndvExctnDtls = base_types.UninitialisedField(self, 'IndvExctnDtls', RedemptionExecution17, True)
