...
from .FundSettlementParameters18 import FundSettlementParameters18
from .FinancialInstrument61Choice import FinancialInstrument61Choice
...
class FinancialInstrument101(base_types._BaseFieldType):
	...
	__slots__ = ["_LineId", "_ClntRef", "_CtrPtyRef", "_AsstsHeldInOwnNm", "_SttlmPtiesDtls", "_TrfRsltsInChngOfBnfclOwnr", "_AddtlInf", "_Instrm", "_Trfr", "_TrfeeAcct"]
	@property
	def LineId(self):
		return self._LineId
