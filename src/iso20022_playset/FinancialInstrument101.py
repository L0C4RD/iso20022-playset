...
import FinancialInstrument61Choice
import FundSettlementParameters18
...
class FinancialInstrument101(base_types._BaseFieldType):
	...
	__slots__ = ["_LineId", "_AsstsHeldInOwnNm", "_TrfRsltsInChngOfBnfclOwnr", "_SttlmPtiesDtls", "_AddtlInf", "_ClntRef", "_Trfr", "_Instrm", "_CtrPtyRef", "_TrfeeAcct"]
	@property
	def LineId(self):
		return self._LineId
