...
class FundCashForecast6(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlNAV", "_TradDtTm", "_Pric", "_CcySts", "_BrkdwnByUsrDfndParam", "_PctgOfShrClssTtlNAV", "_FXRate", "_PrvsTradDtTm", "_TtlNAVChngRate", "_InvstmtCcy", "_BrkdwnByCcy", "_BrkdwnByCtry", "_TtlUnitsNb", "_Id", "_FinInstrmDtls", "_PrvsTtlNAV", "_XcptnlNetCshFlowInd", "_BrkdwnByPty", "_NetCshFcstDtls", "_PrvsTtlUnitsNb"]
	@property
