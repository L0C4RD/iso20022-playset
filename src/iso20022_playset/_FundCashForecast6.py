...
class FundCashForecast6(base_types._BaseFieldType):
	...
	__slots__ = ["_BrkdwnByPty", "_FXRate", "_CcySts", "_PrvsTradDtTm", "_XcptnlNetCshFlowInd", "_PrvsTtlUnitsNb", "_PrvsTtlNAV", "_TtlNAV", "_NetCshFcstDtls", "_BrkdwnByCtry", "_TradDtTm", "_TtlNAVChngRate", "_InvstmtCcy", "_Pric", "_PctgOfShrClssTtlNAV", "_BrkdwnByCcy", "_Id", "_FinInstrmDtls", "_BrkdwnByUsrDfndParam", "_TtlUnitsNb"]
	@property
