...
class DirectDebitTransactionInformation32(base_types._BaseFieldType):
	...
	__slots__ = ["_DrctDbtTx", "_ChrgBr", "_Purp", "_InstdAmt", "_PmtId", "_DbtrAgtAcct", "_Dbtr", "_Tax", "_DbtrAgt", "_InstrForCdtrAgt", "_RltdRmtInf", "_DbtrAcct", "_RmtInf", "_UltmtCdtr", "_UltmtDbtr", "_SplmtryData", "_RgltryRptg", "_PmtTpInf"]
	@property
	def DrctDbtTx(self):
