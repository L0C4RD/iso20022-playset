...
class DirectDebitTransactionInformation32(base_types._BaseFieldType):
	...
	__slots__ = ["_Purp", "_Tax", "_DbtrAgt", "_RltdRmtInf", "_UltmtCdtr", "_RmtInf", "_InstrForCdtrAgt", "_DrctDbtTx", "_Dbtr", "_PmtId", "_InstdAmt", "_RgltryRptg", "_UltmtDbtr", "_ChrgBr", "_SplmtryData", "_PmtTpInf", "_DbtrAcct", "_DbtrAgtAcct"]
	@property
	def Purp(self):
		return self._Purp
