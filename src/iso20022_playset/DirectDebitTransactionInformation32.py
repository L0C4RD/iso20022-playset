...
class DirectDebitTransactionInformation32(base_types._BaseFieldType):
	...
	__slots__ = ["_PmtId", "_RgltryRptg", "_ChrgBr", "_PmtTpInf", "_DbtrAgt", "_Dbtr", "_DbtrAcct", "_UltmtCdtr", "_RltdRmtInf", "_Purp", "_InstdAmt", "_DbtrAgtAcct", "_DrctDbtTx", "_Tax", "_SplmtryData", "_RmtInf", "_UltmtDbtr", "_InstrForCdtrAgt"]
	@property
	def PmtId(self):
		return self._PmtId
