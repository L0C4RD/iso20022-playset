...
class DirectDebitTransactionInformation32(base_types._BaseFieldType):
	...
	__slots__ = ["_DbtrAgtAcct", "_DrctDbtTx", "_UltmtCdtr", "_Tax", "_RgltryRptg", "_Purp", "_Dbtr", "_InstrForCdtrAgt", "_PmtTpInf", "_ChrgBr", "_PmtId", "_UltmtDbtr", "_RltdRmtInf", "_DbtrAcct", "_InstdAmt", "_RmtInf", "_DbtrAgt", "_SplmtryData"]
	@property
