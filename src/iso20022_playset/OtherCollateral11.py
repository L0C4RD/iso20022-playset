...
class OtherCollateral11(base_types._BaseFieldType):
	...
	__slots__ = ["_MktVal", "_LttrOfCdtId", "_LtdCvrgInd", "_CollId", "_Hrcut", "_IsseDt", "_LttrOfCdtAmt", "_Issr", "_ValDt", "_AsstNb", "_XchgRate", "_GrntAmt", "_SfkpgPlc", "_SfkpgAcct", "_BlckChainAdrOrWllt", "_XpryDt", "_CollVal", "_OthrTpOfColl"]
	@property
	def MktVal(self):
		return self._MktVal
