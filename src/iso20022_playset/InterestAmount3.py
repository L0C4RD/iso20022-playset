...
class InterestAmount3(base_types._BaseFieldType):
	...
	__slots__ = ["_IntrstPrd", "_ClsgCollBal", "_AcrdIntrstAmt", "_IntrstMtd", "_AddtlInf", "_StdSttlmInstrs", "_CollPurp", "_DayCntBsis", "_OpngCollBal", "_ValDt", "_ClctnMtd", "_IntrstRate", "_ApldWhldgTax", "_ClctnFrqcy"]
	@property
	def IntrstPrd(self):
