...
class InterestAmount3(base_types._BaseFieldType):
	...
	__slots__ = ["_ValDt", "_CollPurp", "_StdSttlmInstrs", "_IntrstPrd", "_ApldWhldgTax", "_AcrdIntrstAmt", "_ClctnFrqcy", "_DayCntBsis", "_IntrstRate", "_ClctnMtd", "_AddtlInf", "_ClsgCollBal", "_OpngCollBal", "_IntrstMtd"]
	@property
	def ValDt(self):
		return self._ValDt
