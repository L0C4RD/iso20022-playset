...
class InterestAmount3(base_types._BaseFieldType):
	...
	__slots__ = ["_OpngCollBal", "_DayCntBsis", "_ValDt", "_IntrstPrd", "_IntrstMtd", "_ClctnFrqcy", "_CollPurp", "_StdSttlmInstrs", "_ClctnMtd", "_ClsgCollBal", "_ApldWhldgTax", "_AcrdIntrstAmt", "_IntrstRate", "_AddtlInf"]
	@property
