...
class CardManagementInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_OrgnlDataElmts", "_CstmrDvc", "_Prgrmm", "_ICCRltdData", "_Termnl", "_TxAmts", "_TxId", "_Rcvr", "_NewPINData", "_Rcncltn", "_SctyTrlr", "_PrtctdData", "_Crdhldr", "_Vrfctn", "_Acqrr", "_Card", "_AddtlFee", "_Jursdctn", "_AddtlData", "_ConvsDtTm", "_Orgtr", "_Hdr", "_AcctTo", "_Rsk", "_TxChrtcs", "_Wllt", "_Sndr", "_PrcgRslt", "_Tkn", "_POICmpnt", "_Dstn", "_SttlmSvc", "_Accptr", "_Issr", "_AddtlAmt", "_AddtlSvc", "_XchgRate", "_StrngCstmrAuthntcn", "_AcctFr", "_Cntxt"]
	@property
