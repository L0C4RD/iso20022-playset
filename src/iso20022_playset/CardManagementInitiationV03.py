...
class CardManagementInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_PrcgRslt", "_Accptr", "_StrngCstmrAuthntcn", "_AddtlData", "_Issr", "_Vrfctn", "_XchgRate", "_TxId", "_Acqrr", "_Dstn", "_SplmtryData", "_Hdr", "_TxAmts", "_Card", "_Prgrmm", "_AcctFr", "_AddtlSvc", "_Rcvr", "_AddtlAmt", "_Rcncltn", "_ConvsDtTm", "_OrgnlDataElmts", "_Tkn", "_SttlmSvc", "_Wllt", "_SctyTrlr", "_Orgtr", "_AddtlFee", "_Jursdctn", "_AcctTo", "_CstmrDvc", "_PrtctdData", "_Cntxt", "_ICCRltdData", "_Crdhldr", "_POICmpnt", "_Sndr", "_Rsk", "_TxChrtcs", "_NewPINData", "_Termnl"]
	@property
	def PrcgRslt(self):
