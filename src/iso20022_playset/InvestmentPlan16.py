...
class InvestmentPlan16(base_types._BaseFieldType):
	...
	__slots__ = ["_PdctId", "_InsrncCover", "_InstlmtMgrRole", "_CtrctRef", "_TtlNbOfInstlmts", "_InitlAmt", "_RndgDrctn", "_Frqcy", "_SLAChrgAndComssnRef", "_EndDt", "_ModfdCshSttlm", "_IncmPref", "_PlanSts", "_Qty", "_GrssAmtInd", "_RltdCtrctRef", "_SctyDtls", "_StartDt"]
	@property
	def PdctId(self):
		return self._PdctId
