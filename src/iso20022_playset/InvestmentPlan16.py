...
class InvestmentPlan16(base_types._BaseFieldType):
	...
	__slots__ = ["_SctyDtls", "_PlanSts", "_Frqcy", "_InsrncCover", "_RndgDrctn", "_PdctId", "_IncmPref", "_SLAChrgAndComssnRef", "_StartDt", "_EndDt", "_TtlNbOfInstlmts", "_ModfdCshSttlm", "_InitlAmt", "_Qty", "_CtrctRef", "_InstlmtMgrRole", "_RltdCtrctRef", "_GrssAmtInd"]
	@property
	def SctyDtls(self):
