...
import DocumentIdentification10

class DataSetMatchReportV03(base_types._BaseFieldType):

	__slots__ = ["_ReqForActn", "_TxId", "_RptId", "_CmpardDocRef", "_EstblishdBaselnId", "_SellrBk", "_Buyr", "_Rpt", "_SubmissnTp", "_UsrTxRef", "_TxSts", "_BuyrBk", "_Sellr"]
	@property
	def ReqForActn(self):
