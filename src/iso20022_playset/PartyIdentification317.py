...
import BeneficiaryCertificationType11Choice
import LEIIdentifier
import PartyIdentification259Choice
import RateAndAmountFormat63Choice

class PartyIdentification317(base_types._BaseFieldType):

	__slots__ = ["_DmclCtry", "_AltrnId", "_OwndSctiesQty", "_WhldgTaxRate", "_LEIId", "_NonDmclCtry", "_CertfctnTp", "_OwnrId", "_CertfctnBrkdwn"]
	@property
	def DmclCtry(self):
