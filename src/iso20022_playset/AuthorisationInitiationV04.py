...
class AuthorisationInitiationV04(base_types._BaseFieldType):
	...
	__slots__ = ["_ICCRltdData", "_SctyTrlr", "_Hdr", "_Orgtr", "_Acqrr", "_PrcgRslt", "_Jursdctn", "_Rcvr", "_Pyee", "_Termnl", "_Accptr", "_Cntxt", "_CstmrDvc", "_Dstn", "_AddtlAmt", "_Rcncltn", "_TxChrtcs", "_Issr", "_DpstDtls", "_SplmtryData", "_FndsSvcs", "_Pyer", "_StrngCstmrAuthntcn", "_XchgRate", "_Instlmt", "_AddtlData", "_Sndr", "_TxId", "_AddtlSvc", "_AcctFr", "_Wllt", "_AcctTo", "_OrgnlDataElmts", "_POICmpnt", "_SpclPrgrmmQlfctn", "_TxAmts", "_Cstmr", "_Prgrmm", "_AddtlFee", "_AdddmData", "_SttlmSvc", "_Vrfctn", "_PrtctdData", "_Rsk", "_ConvsDtTm", "_Card", "_Tkn", "_AcctBal", "_Crdhldr"]
	@property
