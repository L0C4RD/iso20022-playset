...
class AuthorisationInitiationV04(base_types._BaseFieldType):
	...
	__slots__ = ["_FndsSvcs", "_Instlmt", "_CstmrDvc", "_PrtctdData", "_AddtlSvc", "_AdddmData", "_Crdhldr", "_Prgrmm", "_ConvsDtTm", "_ICCRltdData", "_SpclPrgrmmQlfctn", "_Rcncltn", "_Accptr", "_AddtlData", "_Cntxt", "_Issr", "_OrgnlDataElmts", "_XchgRate", "_AcctBal", "_Wllt", "_TxAmts", "_Acqrr", "_Hdr", "_Dstn", "_PrcgRslt", "_Termnl", "_Rcvr", "_Jursdctn", "_Pyee", "_SttlmSvc", "_Cstmr", "_Sndr", "_Pyer", "_Rsk", "_DpstDtls", "_Card", "_POICmpnt", "_AddtlFee", "_TxId", "_SplmtryData", "_AcctFr", "_Tkn", "_TxChrtcs", "_Orgtr", "_AddtlAmt", "_AcctTo", "_Vrfctn", "_SctyTrlr", "_StrngCstmrAuthntcn"]
	@property
	def FndsSvcs(self):
