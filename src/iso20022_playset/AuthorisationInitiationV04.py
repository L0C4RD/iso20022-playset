...
class AuthorisationInitiationV04(base_types._BaseFieldType):
	...
	__slots__ = ["_POICmpnt", "_TxAmts", "_AcctTo", "_Prgrmm", "_Tkn", "_Dstn", "_AdddmData", "_PrtctdData", "_Crdhldr", "_DpstDtls", "_PrcgRslt", "_AcctBal", "_Cstmr", "_Rcvr", "_FndsSvcs", "_Card", "_Jursdctn", "_Wllt", "_Orgtr", "_SctyTrlr", "_CstmrDvc", "_Hdr", "_Pyee", "_Rsk", "_Accptr", "_AddtlFee", "_Sndr", "_ICCRltdData", "_OrgnlDataElmts", "_Termnl", "_AddtlData", "_Cntxt", "_Rcncltn", "_SpclPrgrmmQlfctn", "_SttlmSvc", "_StrngCstmrAuthntcn", "_Instlmt", "_AcctFr", "_Issr", "_TxId", "_Pyer", "_Vrfctn", "_AddtlAmt", "_SplmtryData", "_TxChrtcs", "_Acqrr", "_XchgRate", "_ConvsDtTm", "_AddtlSvc"]
	@property
	def POICmpnt(self):
