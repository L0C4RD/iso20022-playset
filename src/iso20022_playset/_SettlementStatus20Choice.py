...
from . import FailingStatus11Choice
from . import PendingStatus45Choice
...
class SettlementStatus20Choice(base_types._BaseFieldType):
	...
	@Flng.setter
	def Flng(self, value):
		self._Flng = value if value is not None else base_types.UninitialisedField(self, 'Flng', FailingStatus11Choice, False)

	@Flng.deleter
	def Flng(self):
		del self._Flng
		self._Flng = base_types.UninitialisedField(self, 'Flng', FailingStatus11Choice, False)
	...
	@Pdg.setter
	def Pdg(self, value):
		self._Pdg = value if value is not None else base_types.UninitialisedField(self, 'Pdg', PendingStatus45Choice, False)

	@Pdg.deleter
	def Pdg(self):
		del self._Pdg
		self._Pdg = base_types.UninitialisedField(self, 'Pdg', PendingStatus45Choice, False)
