...
class SettlementReportingResponseV04(base_types._BaseFieldType):

	__slots__ = ["_AddtlFee", "_Dstn", "_FI", "_Hdr", "_Jursdctn", "_LifeCyclId", "_NtlData", "_OrgnlRspnCd", "_Orgtr", "_OthrInstn", "_PrcgRslt", "_Prgrmm", "_PrtctdData", "_PrvtData", "_Rcncltn", "_Rcvr", "_RtrvlRefNb", "_SctyTrlr", "_Sndr", "_SttlmInstn", "_SttlmSvc", "_SysTracAudtNb", "_TrnsmssnDtTm", "_TxDesc"]
	@property
	def AddtlFee(self):
