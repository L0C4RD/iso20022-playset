...
from .RegulatoryReporting3 import RegulatoryReporting3
from .InstructionForCreditorAgent3 import InstructionForCreditorAgent3
from .SettlementDateTimeIndication1 import SettlementDateTimeIndication1
from .Purpose2Choice import Purpose2Choice
from .TransactionParties8 import TransactionParties8
from .ISODate import ISODate
from .EquivalentAmount2 import EquivalentAmount2
from .RemittanceInformation16 import RemittanceInformation16
from .PaymentRejectReturnReason1 import PaymentRejectReturnReason1
from .PaymentScenario1Choice import PaymentScenario1Choice
from .Priority3Code import Priority3Code
from .Max35Text import Max35Text
from .PaymentTypeInformation28 import PaymentTypeInformation28
from .Party40Choice import Party40Choice
from .CurrencyExchange15 import CurrencyExchange15
from .CreditTransferTransaction46 import CreditTransferTransaction46
...
from .PaymentIdentification10 import PaymentIdentification10
from .RemittanceLocation7 import RemittanceLocation7
from .SettlementInstruction9 import SettlementInstruction9
from .CashAccount38 import CashAccount38
from .ChargeBearerType1Code import ChargeBearerType1Code
from .InstructionForNextAgent1 import InstructionForNextAgent1
from .RelatedTransactionData1 import RelatedTransactionData1
...
from .TaxInformation8 import TaxInformation8
from .ActiveOrHistoricCurrencyAndAmount import ActiveOrHistoricCurrencyAndAmount
from .TrackerRecord8 import TrackerRecord8
from .ISODateTime import ISODateTime
from .TrackerPartyIdentification2 import TrackerPartyIdentification2
from .TrackerData8 import TrackerData8
from .OriginalBusinessInstruction4 import OriginalBusinessInstruction4
from .PartyIdentification135 import PartyIdentification135

class TrackerPaymentTransaction14(base_types._BaseFieldType):

	__slots__ = ["_ChrgBr", "_PrvsInstgAgt1", "_PrvsInstgAgt1Acct", "_Purp", "_UltmtCdtr", "_CdtrAgt", "_RtrdInstdAmt", "_PrvsInstgAgt3Acct", "_PmtId", "_TrckrInfrmgPty", "_CdtrAcct", "_PrvsInstgAgt2Acct", "_TrckdMsgId", "_IntrmyAgt1Acct", "_Cdtr", "_TechRcvr", "_RgltryRptg", "_DbtConfURLAdr", "_IntrmyAgt3", "_DbtrAgt", "_InstgAgt", "_RltdRmtInf", "_IntrBkSttlmDt", "_DbtrAcct", "_PmtScnro", "_DbtrAgtAcct", "_OrgnlEndToEndId", "_TrckrInfrmdPty", "_RjctRtrRsn", "_ChrgsInf", "_SttlmInf", "_UndrlygCstmrCdtTrf", "_SttlmTmReq", "_UltmtDbtr", "_PrvsInstgAgt3", "_TechSndr", "_Dbtr", "_SttlmTmIndctn", "_RltdPmtId", "_EqvtAmt", "_IntrBkSttlmAmt", "_InstrForCdtrAgt", "_PoolgAdjstmntDt", "_IntrmyAgt3Acct", "_TrckrData", "_TrckrRcrd", "_RtrdIntrBkSttlmAmt", "_CdtrAgtAcct", "_ReqdExctnDt", "_InstdAmt", "_RmtInf", "_SttlmPrty", "_XchgRateData", "_Tax", "_PrvsInstgAgt2", "_PmtTpInf", "_IntrmyAgt2Acct", "_InitgPty", "_InstdAgt", "_InstrForNxtAgt", "_IntrmyAgt1", "_IntrmyAgt2", "_AccptncDtTm", "_OrgnlInstrId", "_RtrChain"]
	@property
	def ChrgBr(self):
		return self._ChrgBr
	...
	def TrckdMsgId(self, value):
		self._TrckdMsgId = value if type(value) != base_types.auto else self.make_default("TrckdMsgId")
	...
	def TechRcvr(self, value):
		self._TechRcvr = value if type(value) != base_types.auto else self.make_default("TechRcvr")
	...
	def DbtConfURLAdr(self, value):
		self._DbtConfURLAdr = value if type(value) != base_types.auto else self.make_default("DbtConfURLAdr")
	...
	def PmtScnro(self, value):
		self._PmtScnro = value if type(value) != base_types.auto else self.make_default("PmtScnro")
	...
	def TechSndr(self, value):
		self._TechSndr = value if type(value) != base_types.auto else self.make_default("TechSndr")
	...
	def RltdPmtId(self, value):
		self._RltdPmtId = value if type(value) != base_types.auto else self.make_default("RltdPmtId")
	...
	def TrckrData(self, value):
		self._TrckrData = value if type(value) != base_types.auto else self.make_default("TrckrData")
