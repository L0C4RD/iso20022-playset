...
class SecuritiesTransactionReport7(base_types._BaseFieldType):
	...
	__slots__ = ["_SubmitgPty", "_InvstmtDcsnPrsn", "_ExctgPrsn", "_SplmtryData", "_TxId", "_InvstmtPtyInd", "_Sellr", "_Tx", "_AddtlAttrbts", "_FinInstrm", "_Buyr", "_TechAttrbts", "_OrdrTrnsmssn", "_ExctgPty"]
	@property
	def SubmitgPty(self):
