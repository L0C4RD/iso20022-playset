...
from .InstructedBalance21 import InstructedBalance21
from .PendingBalance8 import PendingBalance8
...
class CorporateActionBalance51(base_types._BaseFieldType):
	...
	__slots__ = ["_RegdBal", "_InTrnsShipmntBal", "_CollOutBal", "_TradDtPosBal", "_UinstdBal", "_SttlmPosBal", "_PdgRctBal", "_OnLnBal", "_BlckdBal", "_BrrwdBal", "_OutForRegnBal", "_TtlInstdBalDtls", "_PdgDlvryBal", "_StrtPosBal", "_CollInBal", "_TtlElgblBal", "_OblgtdBal"]
	@property
	def RegdBal(self):
