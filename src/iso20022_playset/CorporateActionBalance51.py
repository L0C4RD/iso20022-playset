...
class CorporateActionBalance51(base_types._BaseFieldType):
	...
	__slots__ = ["_TradDtPosBal", "_PdgDlvryBal", "_OutForRegnBal", "_OnLnBal", "_RegdBal", "_StrtPosBal", "_UinstdBal", "_TtlInstdBalDtls", "_CollOutBal", "_SttlmPosBal", "_InTrnsShipmntBal", "_TtlElgblBal", "_PdgRctBal", "_OblgtdBal", "_BrrwdBal", "_CollInBal", "_BlckdBal"]
	@property
