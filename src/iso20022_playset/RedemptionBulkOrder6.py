...
class RedemptionBulkOrder6(base_types._BaseFieldType):
	...
	__slots__ = ["_OrdrDtTm", "_XpryDtTm", "_PlcOfTrad", "_ReqdFutrTradDt", "_ReqdSttlmCcy", "_TtlSttlmAmt", "_BlkCshSttlmDtls", "_FinInstrmDtls", "_CxlRght", "_MstrRef", "_ReqdNAVCcy", "_IndvOrdrDtls"]
	@property
	def OrdrDtTm(self):
