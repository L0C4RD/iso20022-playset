...
class CorporateActionRate137(base_types._BaseFieldType):
	...
	__slots__ = ["_NewToOd", "_AddtlQtyForExstgScties", "_FinTxTaxRate", "_WhldgTaxRate", "_AddtlQtyForSbcbdRsltntScties", "_FsclStmp", "_TaxCdtRate", "_ScndLvlTax", "_ChrgsFees", "_AplblRate", "_TrfrmatnRate"]
	@property
	def NewToOd(self):
