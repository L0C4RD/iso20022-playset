...
class CorporateActionRate137(base_types._BaseFieldType):
	...
	__slots__ = ["_ChrgsFees", "_FinTxTaxRate", "_NewToOd", "_TrfrmatnRate", "_AplblRate", "_AddtlQtyForExstgScties", "_ScndLvlTax", "_AddtlQtyForSbcbdRsltntScties", "_FsclStmp", "_WhldgTaxRate", "_TaxCdtRate"]
	@property
	def ChrgsFees(self):
