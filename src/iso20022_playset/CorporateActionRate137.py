...
class CorporateActionRate137(base_types._BaseFieldType):
	...
	__slots__ = ["_TrfrmatnRate", "_NewToOd", "_ChrgsFees", "_TaxCdtRate", "_AddtlQtyForSbcbdRsltntScties", "_ScndLvlTax", "_AplblRate", "_WhldgTaxRate", "_FsclStmp", "_AddtlQtyForExstgScties", "_FinTxTaxRate"]
	@property
