...
class CustomerAccount5(base_types._BaseFieldType):
	...
	__slots__ = ["_MnthlyTxNb", "_Nm", "_Sts", "_Id", "_MnthlyRcvdVal", "_Ccy", "_Rstrctn", "_ClngNtfctnAmt", "_FlrNtfctnAmt", "_MnthlyPmtVal", "_AcctPurp", "_Tp", "_StmtFrqcyAndFrmt", "_AvrgBal", "_ClsgDt"]
	@property
	def MnthlyTxNb(self):
