...
class CorporateActionBalanceDetails46(base_types._BaseFieldType):
	...
	__slots__ = ["_BlckdBal", "_SttlmPosBal", "_UafctdBal", "_OutForRegnBal", "_InstdBal", "_BrrwdBal", "_CollInBal", "_OblgtdBal", "_TradDtPosBal", "_AfctdBal", "_PdgDlvryBal", "_OnLnBal", "_PdgRctBal", "_TtlElgblBal", "_CollOutBal", "_UinstdBal", "_RegdBal", "_InTrnsShipmntBal", "_StrtPosBal"]
	@property
	def BlckdBal(self):
