...
class CorporateActionBalanceDetails46(base_types._BaseFieldType):
	...
	def OblgtdBal(self, value):
		self._OblgtdBal = value if value is not None else base_types.UninitialisedField(self, 'OblgtdBal', BalanceFormat14Choice, False)

	@OblgtdBal.deleter
	def OblgtdBal(self):
		del self._OblgtdBal
		self._OblgtdBal = base_types.UninitialisedField(self, 'OblgtdBal', BalanceFormat14Choice, False)
