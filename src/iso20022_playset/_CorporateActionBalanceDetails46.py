...
from .TotalEligibleBalanceFormat11 import TotalEligibleBalanceFormat11
from .BalanceFormat14Choice import BalanceFormat14Choice
from .BalanceFormat16Choice import BalanceFormat16Choice

class CorporateActionBalanceDetails46(base_types._BaseFieldType):

	__slots__ = ["_CollInBal", "_TtlElgblBal", "_PdgDlvryBal", "_BlckdBal", "_OutForRegnBal", "_InTrnsShipmntBal", "_RegdBal", "_StrtPosBal", "_InstdBal", "_PdgRctBal", "_BrrwdBal", "_OblgtdBal", "_CollOutBal", "_UinstdBal", "_OnLnBal", "_AfctdBal", "_UafctdBal", "_TradDtPosBal", "_SttlmPosBal"]
	@property
	def CollInBal(self):
