...
class SecuritiesFinancingTransactionDetails46(base_types._BaseFieldType):
	...
	__slots__ = ["_LglFrmwk", "_RateChngDt", "_StockLnMrgn", "_ChrgsRate", "_ScndLegNrrtv", "_RateTp", "_TxCallDely", "_EarlstCallBckDt", "_Rvaltn", "_PricgRate", "_Sprd", "_TermntnDt", "_VarblRateSpprt", "_ComssnClctnDt", "_ClsgLegId", "_TermntnTxAmt", "_MtrtyDtMod", "_DealAmt", "_PrmAmt", "_IntrstCmptnMtd", "_FrftAmt", "_SctiesFincgTradId", "_IntrstPmt", "_AcrdIntrstAmt", "_TermntnAmtPerPcOfColl", "_TtlNbOfCollInstrs", "_RpRate", "_SctiesHrcut"]
	@property
	def LglFrmwk(self):
