...
class SecuritiesFinancingTransactionDetails46(base_types._BaseFieldType):
	...
	__slots__ = ["_LglFrmwk", "_RateTp", "_VarblRateSpprt", "_StockLnMrgn", "_PricgRate", "_Rvaltn", "_IntrstPmt", "_FrftAmt", "_DealAmt", "_SctiesHrcut", "_EarlstCallBckDt", "_MtrtyDtMod", "_ComssnClctnDt", "_Sprd", "_TtlNbOfCollInstrs", "_ClsgLegId", "_TxCallDely", "_AcrdIntrstAmt", "_SctiesFincgTradId", "_TermntnDt", "_ScndLegNrrtv", "_RateChngDt", "_PrmAmt", "_IntrstCmptnMtd", "_RpRate", "_TermntnTxAmt", "_TermntnAmtPerPcOfColl", "_ChrgsRate"]
	@property
	def LglFrmwk(self):
