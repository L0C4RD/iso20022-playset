...
class SecuritiesFinancingTransactionDetails46(base_types._BaseFieldType):
	...
	__slots__ = ["_StockLnMrgn", "_PricgRate", "_ComssnClctnDt", "_EarlstCallBckDt", "_SctiesHrcut", "_VarblRateSpprt", "_TxCallDely", "_DealAmt", "_PrmAmt", "_IntrstPmt", "_TermntnDt", "_RpRate", "_ClsgLegId", "_ChrgsRate", "_RateTp", "_RateChngDt", "_AcrdIntrstAmt", "_Rvaltn", "_LglFrmwk", "_IntrstCmptnMtd", "_ScndLegNrrtv", "_Sprd", "_MtrtyDtMod", "_FrftAmt", "_TtlNbOfCollInstrs", "_SctiesFincgTradId", "_TermntnTxAmt", "_TermntnAmtPerPcOfColl"]
	@property
