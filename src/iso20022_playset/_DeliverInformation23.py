...
from ._FundSettlementParameters26 import FundSettlementParameters26
...
class DeliverInformation23(base_types._BaseFieldType):
	...
	def TrfrRegdAcct(self, value):
		self._TrfrRegdAcct = value if type(value) != base_types.auto else self.make_default("TrfrRegdAcct")
