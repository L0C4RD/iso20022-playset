...
from ._ATMDiagnosticRequest3 import ATMDiagnosticRequest3

class ATMDiagnosticRequestV03(base_types._BaseFieldType):

	__slots__ = ["_ATMDgnstcReq", "_PrtctdATMDgnstcReq", "_Hdr", "_SctyTrlr"]
	@property
	...
	def PrtctdATMDgnstcReq(self, value):
		self._PrtctdATMDgnstcReq = value if type(value) != base_types.auto else self.make_default("PrtctdATMDgnstcReq")
