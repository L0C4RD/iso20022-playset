...
class Rate44(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlTax", "_TaxOnPrfts", "_TaxRclmRate", "_PrncpleRate", "_EqulstnRate", "_GrssDstrbtnRate", "_EarlySlctnFeeRate", "_GrssIntrstRateUsdForPmt", "_WhldgTaxRate", "_SlctnFeeRate", "_ThrdPtyIncntivRate", "_ScndLvlTax", "_DmdRate", "_TaxOnIncm", "_NetDstrbtnRate", "_AplblRate", "_FsclStmp", "_ChrgsFees", "_TaxCdtRate"]
	@property
	def AddtlTax(self):
