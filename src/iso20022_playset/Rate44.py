...
class Rate44(base_types._BaseFieldType):
	...
	__slots__ = ["_ChrgsFees", "_FsclStmp", "_EarlySlctnFeeRate", "_WhldgTaxRate", "_NetDstrbtnRate", "_ScndLvlTax", "_GrssIntrstRateUsdForPmt", "_DmdRate", "_TaxOnIncm", "_TaxOnPrfts", "_TaxRclmRate", "_AddtlTax", "_ThrdPtyIncntivRate", "_TaxCdtRate", "_PrncpleRate", "_GrssDstrbtnRate", "_EqulstnRate", "_AplblRate", "_SlctnFeeRate"]
	@property
	def ChrgsFees(self):
