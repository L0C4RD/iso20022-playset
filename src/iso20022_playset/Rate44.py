...
class Rate44(base_types._BaseFieldType):
	...
	__slots__ = ["_TaxRclmRate", "_GrssIntrstRateUsdForPmt", "_PrncpleRate", "_GrssDstrbtnRate", "_TaxOnIncm", "_SlctnFeeRate", "_EqulstnRate", "_ChrgsFees", "_WhldgTaxRate", "_ScndLvlTax", "_AplblRate", "_AddtlTax", "_TaxOnPrfts", "_TaxCdtRate", "_EarlySlctnFeeRate", "_FsclStmp", "_DmdRate", "_NetDstrbtnRate", "_ThrdPtyIncntivRate"]
	@property
