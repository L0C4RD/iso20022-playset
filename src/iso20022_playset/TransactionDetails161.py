...
class TransactionDetails161(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmAmt", "_QlfdFrgnIntrmy", "_TrptyAgtSvcPrvdrCollInstrId", "_FinInstrmId", "_CorpActnEvtId", "_AckdStsTmStmp", "_ClntCollInstrId", "_BlckChainAdrOrWllt", "_XpctdSttlmDt", "_RcvgSttlmPties", "_Invstr", "_TrptyAgtSvcPrvdrCollTxId", "_SttlmDt", "_PlcOfClr", "_SttlmQty", "_DlvrgSttlmPties", "_AcctOwnr", "_MtchdStsTmStmp", "_SctiesMvmntTp", "_PoolId", "_XpctdValDt", "_LateDlvryDt", "_SttlmInstrPrcgAddtlDtls", "_TradDt", "_PlcOfTrad", "_Pmt", "_PrtlyRlsdQty", "_SfkpgPlc", "_SfkpgAcct", "_TradId", "_ClntTrptyCollTxId", "_SttlmParams"]
	@property
	def SttlmAmt(self):
