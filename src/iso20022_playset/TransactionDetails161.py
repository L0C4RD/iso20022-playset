...
class TransactionDetails161(base_types._BaseFieldType):
	...
	__slots__ = ["_PlcOfTrad", "_XpctdSttlmDt", "_DlvrgSttlmPties", "_QlfdFrgnIntrmy", "_SttlmQty", "_TradDt", "_ClntTrptyCollTxId", "_TrptyAgtSvcPrvdrCollTxId", "_SfkpgPlc", "_CorpActnEvtId", "_ClntCollInstrId", "_FinInstrmId", "_RcvgSttlmPties", "_PoolId", "_Invstr", "_XpctdValDt", "_PrtlyRlsdQty", "_SfkpgAcct", "_PlcOfClr", "_SttlmAmt", "_SctiesMvmntTp", "_Pmt", "_SttlmInstrPrcgAddtlDtls", "_LateDlvryDt", "_TrptyAgtSvcPrvdrCollInstrId", "_SttlmParams", "_MtchdStsTmStmp", "_TradId", "_BlckChainAdrOrWllt", "_AckdStsTmStmp", "_SttlmDt", "_AcctOwnr"]
	@property
	def PlcOfTrad(self):
