...
from .SettlementDetails210 import SettlementDetails210
...
class TransactionDetails161(base_types._BaseFieldType):
	...
	__slots__ = ["_MtchdStsTmStmp", "_Pmt", "_PlcOfTrad", "_XpctdSttlmDt", "_RcvgSttlmPties", "_PlcOfClr", "_SttlmAmt", "_AcctOwnr", "_PoolId", "_TradId", "_ClntCollInstrId", "_BlckChainAdrOrWllt", "_SfkpgPlc", "_CorpActnEvtId", "_SttlmInstrPrcgAddtlDtls", "_TrptyAgtSvcPrvdrCollTxId", "_ClntTrptyCollTxId", "_LateDlvryDt", "_DlvrgSttlmPties", "_TradDt", "_Invstr", "_SttlmQty", "_SfkpgAcct", "_QlfdFrgnIntrmy", "_AckdStsTmStmp", "_SctiesMvmntTp", "_SttlmDt", "_TrptyAgtSvcPrvdrCollInstrId", "_XpctdValDt", "_PrtlyRlsdQty", "_SttlmParams", "_FinInstrmId"]
	@property
