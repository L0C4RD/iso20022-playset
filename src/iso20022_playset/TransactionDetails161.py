...
class TransactionDetails161(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmDt", "_BlckChainAdrOrWllt", "_SttlmQty", "_LateDlvryDt", "_AcctOwnr", "_SttlmInstrPrcgAddtlDtls", "_SfkpgAcct", "_QlfdFrgnIntrmy", "_PlcOfTrad", "_AckdStsTmStmp", "_XpctdSttlmDt", "_RcvgSttlmPties", "_TrptyAgtSvcPrvdrCollInstrId", "_MtchdStsTmStmp", "_FinInstrmId", "_PlcOfClr", "_TrptyAgtSvcPrvdrCollTxId", "_XpctdValDt", "_SttlmAmt", "_TradDt", "_SfkpgPlc", "_SctiesMvmntTp", "_ClntTrptyCollTxId", "_Invstr", "_Pmt", "_ClntCollInstrId", "_CorpActnEvtId", "_PrtlyRlsdQty", "_DlvrgSttlmPties", "_TradId", "_SttlmParams", "_PoolId"]
	@property
	def SttlmDt(self):
