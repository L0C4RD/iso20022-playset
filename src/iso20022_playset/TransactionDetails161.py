...
class TransactionDetails161(base_types._BaseFieldType):
	...
	__slots__ = ["_Pmt", "_ClntCollInstrId", "_DlvrgSttlmPties", "_SctiesMvmntTp", "_AcctOwnr", "_TradId", "_FinInstrmId", "_SfkpgPlc", "_SttlmParams", "_SfkpgAcct", "_PoolId", "_LateDlvryDt", "_Invstr", "_SttlmInstrPrcgAddtlDtls", "_TradDt", "_PrtlyRlsdQty", "_MtchdStsTmStmp", "_TrptyAgtSvcPrvdrCollTxId", "_ClntTrptyCollTxId", "_RcvgSttlmPties", "_XpctdValDt", "_XpctdSttlmDt", "_BlckChainAdrOrWllt", "_SttlmQty", "_TrptyAgtSvcPrvdrCollInstrId", "_CorpActnEvtId", "_PlcOfTrad", "_PlcOfClr", "_SttlmDt", "_AckdStsTmStmp", "_QlfdFrgnIntrmy", "_SttlmAmt"]
	@property
	def Pmt(self):
		return self._Pmt
