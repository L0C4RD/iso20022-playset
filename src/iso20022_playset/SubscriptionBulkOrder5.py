...
class SubscriptionBulkOrder5(base_types._BaseFieldType):
	...
	__slots__ = ["_ReqdFutrTradDt", "_TtlSttlmAmt", "_BlkCshSttlmDtls", "_ReqdNAVCcy", "_FinInstrmDtls", "_OrdrDtTm", "_ReqdSttlmCcy", "_PlcOfTrad", "_MstrRef", "_XpryDtTm", "_IndvOrdrDtls", "_CxlRght"]
	@property
