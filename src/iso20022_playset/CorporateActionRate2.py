...
class CorporateActionRate2(base_types._BaseFieldType):
	...
	__slots__ = ["_GrssDvdd", "_RltdTax", "_IndxFctr", "_CshIncntiv", "_AddtlQtyForExstgScties", "_Chrgs", "_TaxRclm", "_FsclStmp", "_NewSctiesToUndrlygScties", "_GrmnLclTax4", "_TaxOnIncm", "_PrvsnlDvdd", "_FnlDvdd", "_TaxOnPrft", "_FullyFrnkd", "_WhldgOfLclTax", "_OrgnlAmt", "_GrmnLclTax2", "_WhldgOfFrgnTax", "_NonResdtRate", "_NetDvdd", "_XchgRate", "_NewToOd", "_WhldgTax", "_GrmnLclTax3", "_SlctnFee", "_MaxAllwdOvrsbcpt", "_AddtlTax", "_AplblRate", "_AddtlQtyForSbcbdRsltntScties", "_IntrstForUsdPmt", "_GrmnLclTax1", "_Prratn"]
	@property
	def GrssDvdd(self):
