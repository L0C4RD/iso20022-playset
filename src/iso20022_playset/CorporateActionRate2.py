...
class CorporateActionRate2(base_types._BaseFieldType):
	...
	__slots__ = ["_RltdTax", "_OrgnlAmt", "_AplblRate", "_FsclStmp", "_Prratn", "_CshIncntiv", "_Chrgs", "_WhldgOfFrgnTax", "_WhldgOfLclTax", "_GrssDvdd", "_GrmnLclTax4", "_NewSctiesToUndrlygScties", "_IndxFctr", "_NetDvdd", "_FullyFrnkd", "_WhldgTax", "_MaxAllwdOvrsbcpt", "_NonResdtRate", "_SlctnFee", "_IntrstForUsdPmt", "_GrmnLclTax3", "_NewToOd", "_GrmnLclTax1", "_TaxRclm", "_FnlDvdd", "_TaxOnPrft", "_XchgRate", "_GrmnLclTax2", "_TaxOnIncm", "_AddtlTax", "_PrvsnlDvdd", "_AddtlQtyForExstgScties", "_AddtlQtyForSbcbdRsltntScties"]
	@property
	def RltdTax(self):
