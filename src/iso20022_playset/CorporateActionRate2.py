...
class CorporateActionRate2(base_types._BaseFieldType):
	...
	__slots__ = ["_CshIncntiv", "_MaxAllwdOvrsbcpt", "_FnlDvdd", "_AplblRate", "_SlctnFee", "_NetDvdd", "_AddtlQtyForExstgScties", "_AddtlQtyForSbcbdRsltntScties", "_NonResdtRate", "_GrmnLclTax3", "_Prratn", "_XchgRate", "_GrmnLclTax2", "_WhldgTax", "_TaxOnPrft", "_OrgnlAmt", "_IntrstForUsdPmt", "_WhldgOfFrgnTax", "_GrmnLclTax1", "_TaxOnIncm", "_RltdTax", "_GrmnLclTax4", "_TaxRclm", "_Chrgs", "_IndxFctr", "_WhldgOfLclTax", "_GrssDvdd", "_AddtlTax", "_FsclStmp", "_PrvsnlDvdd", "_NewSctiesToUndrlygScties", "_NewToOd", "_FullyFrnkd"]
	@property
	def CshIncntiv(self):
