...
class AggregateBalancePerSafekeepingPlace4(base_types._BaseFieldType):

	__slots__ = ["_AcrdIntrstAmt", "_AcrdIntrstAmtSgn", "_AddtlBalBrkdwnDtls", "_AggtBal", "_BalBrkdwnDtls", "_BookVal", "_DaysAcrd", "_FXDtls", "_HldgVal", "_PricDtls", "_PrvsHldgVal", "_SfkpgPlc"]
	@property
	...
	def AggtBal(self, value):
		self._AggtBal = value if value is not None else base_types.UninitialisedField(self, 'AggtBal', BalanceQuantity1Choice, False)

	@AggtBal.deleter
	def AggtBal(self):
		del self._AggtBal
		self._AggtBal = base_types.UninitialisedField(self, 'AggtBal', BalanceQuantity1Choice, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='AggtBal', type=BalanceQuantity1Choice, min=1, max=1, mutex_group=None, array=False),
