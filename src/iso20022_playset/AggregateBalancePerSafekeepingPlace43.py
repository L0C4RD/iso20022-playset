...
class AggregateBalancePerSafekeepingPlace43(base_types._BaseFieldType):
	...
	__slots__ = ["_AggtBal", "_PricDtls", "_AcctBaseCcyAmts", "_QtyBrkdwn", "_DaysAcrd", "_PlcOfListg", "_FXDtls", "_BalBrkdwn", "_SfkpgPlc", "_InstrmCcyAmts", "_AvlblBal", "_AddtlBalBrkdwn", "_Pldgee", "_HldgAddtlDtls", "_XpsrTp", "_NotAvlblBal"]
	@property
	def AggtBal(self):
