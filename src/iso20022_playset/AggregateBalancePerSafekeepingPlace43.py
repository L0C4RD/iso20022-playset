...
class AggregateBalancePerSafekeepingPlace43(base_types._BaseFieldType):
	...
	__slots__ = ["_SfkpgPlc", "_BalBrkdwn", "_NotAvlblBal", "_AddtlBalBrkdwn", "_AggtBal", "_QtyBrkdwn", "_AvlblBal", "_FXDtls", "_DaysAcrd", "_PlcOfListg", "_XpsrTp", "_InstrmCcyAmts", "_HldgAddtlDtls", "_AcctBaseCcyAmts", "_PricDtls", "_Pldgee"]
	@property
	def SfkpgPlc(self):
