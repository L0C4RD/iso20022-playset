...
class ForeignExchangeTradeInstructionV06(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrPtySdSttlmInstrs", "_PstTradEvt", "_TradgSdSttlmInstrs", "_TradAmts", "_AgrdRate", "_SplmtryData", "_OptnlGnlInf", "_NDFConds", "_TradgSdId", "_CtrPtySdId", "_RgltryRptg", "_TradInf"]
	@property
