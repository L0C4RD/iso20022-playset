...
class ForeignExchangeTradeInstructionV06(base_types._BaseFieldType):
	...
	__slots__ = ["_TradgSdId", "_TradgSdSttlmInstrs", "_OptnlGnlInf", "_TradAmts", "_CtrPtySdId", "_RgltryRptg", "_AgrdRate", "_TradInf", "_NDFConds", "_PstTradEvt", "_SplmtryData", "_CtrPtySdSttlmInstrs"]
	@property
	def AgrdRate(self):
