...
class ForeignExchangeTradeInstructionV06(base_types._BaseFieldType):
	...
	__slots__ = ["_AgrdRate", "_NDFConds", "_SplmtryData", "_TradAmts", "_TradInf", "_RgltryRptg", "_CtrPtySdId", "_TradgSdSttlmInstrs", "_TradgSdId", "_OptnlGnlInf", "_CtrPtySdSttlmInstrs", "_PstTradEvt"]
	@property
	def AgrdRate(self):
