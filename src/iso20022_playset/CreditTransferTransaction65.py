...
class CreditTransferTransaction65(base_types._BaseFieldType):
	...
	__slots__ = ["_IntrmyAgt1", "_UltmtCdtr", "_PmtCond", "_IntrmyAgt2", "_CdtrAgtAcct", "_CdtrAcct", "_Tax", "_RgltryRptg", "_Purp", "_PmtTpInf", "_ChrgBr", "_IntrmyAgt3", "_PmtId", "_Cdtr", "_UltmtDbtr", "_RltdRmtInf", "_NclsdFile", "_ChqInstr", "_ReqdExctnDt", "_Amt", "_RmtInf", "_InstrForCdtrAgt", "_CdtrAgt", "_MndtRltdInf", "_SplmtryData"]
	@property
	def IntrmyAgt1(self):
