...
class CreditTransferTransaction65(base_types._BaseFieldType):
	...
	__slots__ = ["_PmtId", "_RgltryRptg", "_ChrgBr", "_PmtTpInf", "_CdtrAgt", "_Amt", "_PmtCond", "_UltmtCdtr", "_RltdRmtInf", "_Purp", "_ChqInstr", "_ReqdExctnDt", "_MndtRltdInf", "_IntrmyAgt1", "_CdtrAgtAcct", "_CdtrAcct", "_Tax", "_IntrmyAgt2", "_SplmtryData", "_IntrmyAgt3", "_RmtInf", "_InstrForCdtrAgt", "_UltmtDbtr", "_NclsdFile", "_Cdtr"]
	@property
	def PmtId(self):
		return self._PmtId
