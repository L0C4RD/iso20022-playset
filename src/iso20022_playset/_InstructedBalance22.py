...
from . import InstructedCorporateActionOption23
from . import SignedQuantityFormat10

class InstructedBalance22(base_types._BaseFieldType):
	...
	def OptnDtls(self, value):
		self._OptnDtls = value if value is not None else base_types.UninitialisedField(self, 'OptnDtls', InstructedCorporateActionOption23, True)

	@OptnDtls.deleter
	def OptnDtls(self):
		del self._OptnDtls
		self._OptnDtls = base_types.UninitialisedField(self, 'OptnDtls', InstructedCorporateActionOption23, True)
	...
	_field_defs = frozenset((
		base_types.FieldEntry(name='OptnDtls', type=InstructedCorporateActionOption23, min=0, max=None, mutex_group=None, array=True),
