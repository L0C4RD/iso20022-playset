...
class CreditTransferTransaction67(base_types._BaseFieldType):
	...
	__slots__ = ["_IntrmyAgt2", "_RmtInf", "_SttlmTmReq", "_Dbtr", "_Cdtr", "_IntrmyAgt1Acct", "_Purp", "_CdtrAgtAcct", "_InstrForCdtrAgt", "_IntrmyAgt1", "_UltmtDbtr", "_IntrmyAgt3", "_PrvsInstgAgt1Acct", "_InstdAgt", "_IntrBkSttlmDt", "_PmtTpInf", "_IntrBkSttlmAmt", "_PrvsInstgAgt1", "_DbtrAcct", "_InstgAgt", "_UndrlygAllcn", "_PrvsInstgAgt2", "_DbtrAgtAcct", "_IntrmyAgt3Acct", "_XpryDtTm", "_CdtrAgt", "_UltmtCdtr", "_IntrmyAgt2Acct", "_SttlmTmIndctn", "_SttlmPrty", "_PrvsInstgAgt3Acct", "_InstrForNxtAgt", "_CdtrAcct", "_PmtId", "_UndrlygCstmrCdtTrf", "_PrvsInstgAgt3", "_UndrlygFICdtTrf", "_SplmtryData", "_PmtSgntr", "_DbtrAgt", "_PrvsInstgAgt2Acct"]
	@property
	def IntrmyAgt2(self):
