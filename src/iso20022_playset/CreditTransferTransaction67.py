...
class CreditTransferTransaction67(base_types._BaseFieldType):
	...
	__slots__ = ["_PmtSgntr", "_Purp", "_CdtrAcct", "_PrvsInstgAgt2", "_UndrlygFICdtTrf", "_PmtTpInf", "_InstgAgt", "_IntrmyAgt3Acct", "_IntrmyAgt1Acct", "_InstrForCdtrAgt", "_PrvsInstgAgt1", "_CdtrAgt", "_UndrlygCstmrCdtTrf", "_PrvsInstgAgt3", "_SttlmTmIndctn", "_IntrmyAgt1", "_IntrmyAgt2Acct", "_IntrmyAgt2", "_IntrBkSttlmDt", "_SttlmTmReq", "_XpryDtTm", "_UltmtCdtr", "_PrvsInstgAgt3Acct", "_CdtrAgtAcct", "_InstrForNxtAgt", "_IntrBkSttlmAmt", "_DbtrAgt", "_PmtId", "_PrvsInstgAgt1Acct", "_Dbtr", "_DbtrAgtAcct", "_Cdtr", "_DbtrAcct", "_UndrlygAllcn", "_UltmtDbtr", "_IntrmyAgt3", "_PrvsInstgAgt2Acct", "_SplmtryData", "_InstdAgt", "_SttlmPrty", "_RmtInf"]
	@property
	def PmtSgntr(self):
