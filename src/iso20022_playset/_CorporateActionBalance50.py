...
class CorporateActionBalance50(base_types._BaseFieldType):
	...
	__slots__ = ["_TradDtPosBal", "_SttlmPosBal", "_PdgDlvryBal", "_TtlElgblBal", "_PdgRctBal", "_CollInBal", "_BlckdBal", "_InTrnsShipmntBal", "_StrtPosBal", "_BrrwdBal", "_UinstdBal", "_OnLnBal", "_TtlInstdBalDtls", "_OblgtdBal", "_RegdBal", "_CollOutBal", "_OutForRegnBal"]
	@property
