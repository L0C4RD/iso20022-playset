...
class SecuritiesSettlementTransactionConfirmation002V11(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrAmts", "_OthrBizPties", "_FinInstrmAttrbts", "_CshPties", "_AddtlParams", "_Lnkgs", "_FinInstrmId", "_DlvrgSttlmPties", "_SttldAmt", "_TxIdDtls", "_QtyAndAcctDtls", "_StgSttlmInstrDtls", "_TradDtls", "_SttlmParams", "_SplmtryData", "_AddtlPhysOrRegnDtls", "_RcvgSttlmPties"]
	@property
	def OthrAmts(self):
