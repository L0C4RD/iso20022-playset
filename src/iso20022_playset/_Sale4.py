...
from ._SaleItem5 import SaleItem5

class Sale4(base_types._BaseFieldType):
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='LineItm', type=SaleItem5, min=0, max=None, mutex_group=None, array=True),
