...
class OtherAmounts16(base_types._BaseFieldType):
	...
	__slots__ = ["_BrrwgIntrstAmt", "_IsseDscntAllwnc", "_SpclCncssn", "_StmpDty", "_LclTaxCtrySpcfc4", "_OddLotFee", "_LclBrkrComssn", "_MtchgConfFee", "_PmtLevyTax", "_CtryNtlFdrlTax", "_TxTax", "_BrrwgFee", "_WhldgTax", "_OrgnlCcyAmt", "_Mrgn", "_RgltryAmt", "_ChrgsFees", "_ExctgBrkrAmt", "_RmngBookVal", "_ValAddedTax", "_NetGnLoss", "_BookVal", "_RmnrtnAmtReq", "_ConvtdAmt", "_TrfTax", "_AcrdCptlstnAmt", "_RmnrtnAmt", "_RmngFaceVal", "_ClrBrkrComssn", "_DiffInPric", "_CsmptnTax", "_Othr", "_LclTax", "_StockXchgTax", "_LclTaxCtrySpcfc1", "_NetMktVal", "_LclTaxCtrySpcfc3", "_ShrdBrkrgAmt", "_LclTaxCtrySpcfc2", "_MktMmbFeeAmt"]
	@property
