...
class FinancialItemParameters1(base_types._BaseFieldType):
	...
	__slots__ = ["_TradMkt", "_DbtAcct", "_RltdItm", "_GovngCtrct", "_Issr", "_Buyr", "_LglCntxt", "_LangCd", "_IsseDt", "_Rcpt", "_Sellr", "_DocPurp", "_Idr", "_Ccy", "_SellrFinAgt", "_BuyrFinAgt", "_CdtAcct"]
	@property
	def TradMkt(self):
