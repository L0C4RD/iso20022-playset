...
class PaymentTransactionParty4(base_types._BaseFieldType):
	...
	__slots__ = ["_InstdRmbrsmntAgt", "_InstdAgt", "_IntrmyAgt2", "_DbtrAgt", "_IntrmyAgt3", "_InstgAgt", "_UltmtDbtr", "_CdtrAgt", "_Cdtr", "_UltmtCdtr", "_Dbtr", "_IntrmyAgt1", "_InstgRmbrsmntAgt"]
	@property
