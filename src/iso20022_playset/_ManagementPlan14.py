...
from . import TerminalManagementDataSet35
...
class ManagementPlan14(base_types._BaseFieldType):
	...
	def DataSet(self, value):
		self._DataSet = value if value is not None else base_types.UninitialisedField(self, 'DataSet', TerminalManagementDataSet35, False)

	@DataSet.deleter
	def DataSet(self):
		del self._DataSet
		self._DataSet = base_types.UninitialisedField(self, 'DataSet', TerminalManagementDataSet35, False)
