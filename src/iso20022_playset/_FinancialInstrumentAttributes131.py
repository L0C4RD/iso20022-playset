...
class FinancialInstrumentAttributes131(base_types._BaseFieldType):
	...
	__slots__ = ["_MinNmnlQty", "_IsseDt", "_MtrtyDt", "_IssePric", "_IntrstRate", "_FltgRateFxgDt", "_OptnStyle", "_MinQtyToInst", "_NxtFctr", "_PlcOfListg", "_DnmtnCcy", "_NxtCpnDt", "_DtdDt", "_PrvsFctr", "_PutblDt", "_ConvsDt", "_NxtIntrstRate", "_CtrctSz", "_DayCntBsis", "_NxtCllblDt", "_FinInstrmId", "_ClssfctnTp", "_MinMltplQtyToInst"]
	@property
	def MinNmnlQty(self):
