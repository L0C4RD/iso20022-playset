...
class FinancialInstrumentAttributes131(base_types._BaseFieldType):
	...
	def IssePric(self, value):
		self._IssePric = value if value is not None else base_types.UninitialisedField(self, 'IssePric', PriceFormat81Choice, False)

	@IssePric.deleter
	def IssePric(self):
		del self._IssePric
		self._IssePric = base_types.UninitialisedField(self, 'IssePric', PriceFormat81Choice, False)
