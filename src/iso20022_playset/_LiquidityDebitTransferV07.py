...
from . import LiquidityDebitTransfer4
...
class LiquidityDebitTransferV07(base_types._BaseFieldType):
	...
	def LqdtyDbtTrf(self, value):
		self._LqdtyDbtTrf = value if value is not None else base_types.UninitialisedField(self, 'LqdtyDbtTrf', LiquidityDebitTransfer4, False)

	@LqdtyDbtTrf.deleter
	def LqdtyDbtTrf(self):
		del self._LqdtyDbtTrf
		self._LqdtyDbtTrf = base_types.UninitialisedField(self, 'LqdtyDbtTrf', LiquidityDebitTransfer4, False)
