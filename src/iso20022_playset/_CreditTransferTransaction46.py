...
class CreditTransferTransaction46(base_types._BaseFieldType):
	...
	@Cdtr.setter
	def Cdtr(self, value):
		self._Cdtr = value if value is not None else base_types.UninitialisedField(self, 'Cdtr', PartyIdentification135, False)

	@Cdtr.deleter
	def Cdtr(self):
		del self._Cdtr
		self._Cdtr = base_types.UninitialisedField(self, 'Cdtr', PartyIdentification135, False)
	...
	@Dbtr.setter
	def Dbtr(self, value):
		self._Dbtr = value if value is not None else base_types.UninitialisedField(self, 'Dbtr', PartyIdentification135, False)

	@Dbtr.deleter
	def Dbtr(self):
		del self._Dbtr
		self._Dbtr = base_types.UninitialisedField(self, 'Dbtr', PartyIdentification135, False)
	...
	_field_defs = frozenset((
		base_types.FieldEntry(name='Cdtr', type=PartyIdentification135, min=0, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='Dbtr', type=PartyIdentification135, min=0, max=1, mutex_group=None, array=False),
