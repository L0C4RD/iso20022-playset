...
class SecuritiesTradeDetails125(base_types._BaseFieldType):
	...
	__slots__ = ["_DealPric", "_TradTxCond", "_Rptg", "_SttlmInstrPrcgAddtlDtls", "_TradDt", "_PlcOfTrad", "_AffirmSts", "_PlcOfClr", "_TradOrgtrRole", "_FxAddtlDtls", "_CcyToBuyOrSell", "_MtchgSts", "_NbOfDaysAcrd", "_OpngSttlmDt", "_InvstrCpcty"]
	@property
	def DealPric(self):
