...
class SecuritiesTradeDetails125(base_types._BaseFieldType):
	...
	__slots__ = ["_TradTxCond", "_MtchgSts", "_AffirmSts", "_SttlmInstrPrcgAddtlDtls", "_FxAddtlDtls", "_PlcOfClr", "_TradDt", "_PlcOfTrad", "_NbOfDaysAcrd", "_InvstrCpcty", "_TradOrgtrRole", "_CcyToBuyOrSell", "_DealPric", "_OpngSttlmDt", "_Rptg"]
	@property
	def TradTxCond(self):
