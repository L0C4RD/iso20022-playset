...
class TradeLeg11(base_types._BaseFieldType):
	...
	__slots__ = ["_UnqTxIdr", "_TradgCpcty", "_BuySellInd", "_SfkpgAcct", "_GrssAmt", "_TradRegnOrgn", "_Sts", "_TradgPty", "_SfkpgPlc", "_AcrdIntrstAmt", "_DealPric", "_OrdrId", "_TradLegId", "_SttlmDt", "_TradDt", "_FinInstrmId", "_AllcnId", "_TxDtTm", "_PlcOfListg", "_Brkr", "_TradPstngCd", "_TradId", "_TradTp", "_PlcOfTrad", "_TradgPtyAcct", "_DerivRltdTrad", "_TradgCcy", "_TradExctnId", "_TradQty"]
	@property
	def UnqTxIdr(self):
