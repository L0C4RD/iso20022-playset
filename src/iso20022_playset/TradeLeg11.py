...
class TradeLeg11(base_types._BaseFieldType):
	...
	__slots__ = ["_PlcOfListg", "_SfkpgPlc", "_BuySellInd", "_Brkr", "_TradgPty", "_SttlmDt", "_TradQty", "_GrssAmt", "_TradLegId", "_TradTp", "_UnqTxIdr", "_PlcOfTrad", "_TradgPtyAcct", "_DealPric", "_AcrdIntrstAmt", "_TxDtTm", "_AllcnId", "_DerivRltdTrad", "_OrdrId", "_TradPstngCd", "_TradExctnId", "_SfkpgAcct", "_TradgCcy", "_TradId", "_Sts", "_TradDt", "_TradRegnOrgn", "_FinInstrmId", "_TradgCpcty"]
	@property
	def PlcOfListg(self):
