...
class TradeLeg11(base_types._BaseFieldType):
	...
	__slots__ = ["_TradQty", "_GrssAmt", "_SttlmDt", "_TradTp", "_Brkr", "_SfkpgAcct", "_OrdrId", "_DerivRltdTrad", "_BuySellInd", "_UnqTxIdr", "_TradRegnOrgn", "_TradId", "_TradgCcy", "_TradgPty", "_TradgCpcty", "_TxDtTm", "_TradPstngCd", "_DealPric", "_TradLegId", "_TradgPtyAcct", "_FinInstrmId", "_SfkpgPlc", "_PlcOfTrad", "_TradExctnId", "_PlcOfListg", "_Sts", "_AllcnId", "_TradDt", "_AcrdIntrstAmt"]
	@property
	def TradQty(self):
