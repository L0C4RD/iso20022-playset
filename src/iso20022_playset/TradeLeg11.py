...
class TradeLeg11(base_types._BaseFieldType):
	...
	__slots__ = ["_Sts", "_TradTp", "_UnqTxIdr", "_TxDtTm", "_DealPric", "_TradLegId", "_TradPstngCd", "_TradQty", "_SttlmDt", "_TradRegnOrgn", "_FinInstrmId", "_GrssAmt", "_TradDt", "_TradExctnId", "_TradgPtyAcct", "_SfkpgAcct", "_AllcnId", "_BuySellInd", "_AcrdIntrstAmt", "_SfkpgPlc", "_PlcOfTrad", "_TradId", "_TradgPty", "_TradgCpcty", "_Brkr", "_DerivRltdTrad", "_TradgCcy", "_PlcOfListg", "_OrdrId"]
	@property
	def Sts(self):
		return self._Sts
	...
	_field_defs = frozenset((
		base_types.FieldEntry(name='Sts', type=Status5Code, min=0, max=1, mutex_group=None, array=False),
