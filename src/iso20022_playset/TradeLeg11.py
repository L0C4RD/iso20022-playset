...
class TradeLeg11(base_types._BaseFieldType):
	...
	__slots__ = ["_TradgCcy", "_TradRegnOrgn", "_TradExctnId", "_AllcnId", "_TradId", "_FinInstrmId", "_UnqTxIdr", "_DerivRltdTrad", "_TradLegId", "_TxDtTm", "_BuySellInd", "_GrssAmt", "_TradQty", "_TradgPtyAcct", "_TradgPty", "_TradTp", "_TradgCpcty", "_PlcOfListg", "_Sts", "_SfkpgAcct", "_AcrdIntrstAmt", "_Brkr", "_TradDt", "_TradPstngCd", "_PlcOfTrad", "_OrdrId", "_DealPric", "_SttlmDt", "_SfkpgPlc"]
	@property
	def TradgCcy(self):
