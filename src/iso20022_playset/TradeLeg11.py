...
class TradeLeg11(base_types._BaseFieldType):
	...
	__slots__ = ["_TradgCcy", "_SfkpgPlc", "_TradDt", "_TradgCpcty", "_TradPstngCd", "_TradExctnId", "_SttlmDt", "_TradLegId", "_PlcOfListg", "_TradRegnOrgn", "_PlcOfTrad", "_TradgPtyAcct", "_TradgPty", "_DealPric", "_FinInstrmId", "_GrssAmt", "_Brkr", "_TradTp", "_AllcnId", "_Sts", "_UnqTxIdr", "_TradId", "_TxDtTm", "_SfkpgAcct", "_BuySellInd", "_TradQty", "_DerivRltdTrad", "_AcrdIntrstAmt", "_OrdrId"]
	@property
	def TradgCcy(self):
