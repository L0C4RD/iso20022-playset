...
class PartyIdentification284(base_types._BaseFieldType):
	...
	__slots__ = ["_LglCorpNm", "_AddtlCtct", "_OwnrTp", "_CorpTaxIdTp", "_LclData", "_BizTp", "_Ctry", "_CertfctnTpPrvddBy", "_TaxRegnId", "_Assgnr", "_CertfctnTp", "_CorpTaxId", "_GeogcLctn", "_OwnrEthnctyTp", "_ShrtNm", "_OwnrEthnctyTpPrvddBy", "_Id", "_AddtlAdr", "_Email", "_AddtlData", "_NmAndLctn", "_AddtlId", "_CstmrSvc", "_PhneNb", "_BizTpPrvddBy", "_URLAdr", "_Adr", "_OwnrTpPrvddBy"]
	@property
	def LglCorpNm(self):
