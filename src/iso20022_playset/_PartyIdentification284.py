...
class PartyIdentification284(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlAdr", "_AddtlCtct", "_AddtlData", "_AddtlId", "_Adr", "_Assgnr", "_BizTp", "_BizTpPrvddBy", "_CertfctnTp", "_CertfctnTpPrvddBy", "_CorpTaxId", "_CorpTaxIdTp", "_CstmrSvc", "_Ctry", "_Email", "_GeogcLctn", "_Id", "_LclData", "_LglCorpNm", "_NmAndLctn", "_OwnrEthnctyTp", "_OwnrEthnctyTpPrvddBy", "_OwnrTp", "_OwnrTpPrvddBy", "_PhneNb", "_ShrtNm", "_TaxRegnId", "_URLAdr"]
	@property
	def AddtlAdr(self):
	...
	def AddtlId(self, value):
		self._AddtlId = value if value is not None else base_types.UninitialisedField(self, 'AddtlId', AdditionalData1, False)

	@AddtlId.deleter
	def AddtlId(self):
		del self._AddtlId
		self._AddtlId = base_types.UninitialisedField(self, 'AddtlId', AdditionalData1, False)
	...
	def LclData(self, value):
		self._LclData = value if value is not None else base_types.UninitialisedField(self, 'LclData', LocalData11, False)

	@LclData.deleter
	def LclData(self):
		del self._LclData
		self._LclData = base_types.UninitialisedField(self, 'LclData', LocalData11, False)
