...
class PartyIdentification284(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlAdr", "_LclData", "_TaxRegnId", "_NmAndLctn", "_LglCorpNm", "_OwnrEthnctyTp", "_Assgnr", "_GeogcLctn", "_BizTpPrvddBy", "_CertfctnTp", "_OwnrTp", "_ShrtNm", "_AddtlData", "_CstmrSvc", "_Adr", "_OwnrTpPrvddBy", "_OwnrEthnctyTpPrvddBy", "_AddtlId", "_CertfctnTpPrvddBy", "_CorpTaxId", "_AddtlCtct", "_Ctry", "_BizTp", "_Id", "_Email", "_CorpTaxIdTp", "_PhneNb", "_URLAdr"]
	@property
	def AddtlAdr(self):
