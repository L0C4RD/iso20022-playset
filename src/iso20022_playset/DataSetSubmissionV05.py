...
class DataSetSubmissionV05(base_types._BaseFieldType):
	...
	__slots__ = ["_ComrclDataSet", "_SubmissnId", "_CmonSubmissnRef", "_TrnsprtDataSet", "_OthrCertDataSet", "_InsrncDataSet", "_CertDataSet", "_RltdTxRefs", "_Instr", "_BuyrBk", "_SellrBk"]
	@property
