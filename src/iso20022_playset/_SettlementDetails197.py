...
class SettlementDetails197(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmTxCond", "_NetgElgblty", "_HldInd", "_LttrOfGrnt", "_SctiesRTGS", "_CshClrSys", "_BnfclOwnrsh", "_LglRstrctns", "_MktClntSd", "_TaxCpcty", "_RpTp", "_SttlmSysMtd", "_PrtlSttlmInd", "_SttlgCpcty", "_BlckTrad", "_CCPElgblty", "_StmpDtyTaxBsis", "_Regn"]
	@property
