...
class SettlementDetails197(base_types._BaseFieldType):
	...
	__slots__ = ["_LttrOfGrnt", "_HldInd", "_SttlmSysMtd", "_BlckTrad", "_CCPElgblty", "_NetgElgblty", "_SttlgCpcty", "_TaxCpcty", "_PrtlSttlmInd", "_CshClrSys", "_StmpDtyTaxBsis", "_LglRstrctns", "_SctiesRTGS", "_BnfclOwnrsh", "_RpTp", "_Regn", "_SttlmTxCond", "_MktClntSd"]
	@property
	def LttrOfGrnt(self):
