...
class IndividualPerson37(base_types._BaseFieldType):
	...
	__slots__ = ["_Prfssn", "_PrvcOfBirth", "_PltclyXpsdPrsn", "_CvlSts", "_MddlNm", "_CityOfBirth", "_GvnNm", "_PstlAdr", "_EmplngCpny", "_BirthDt", "_CtryOfBirth", "_FmlyInf", "_DthDt", "_BizFctn", "_EdctnLvl", "_Nm", "_GDPRData", "_NmSfx", "_Gndr", "_NmPrfx", "_Ctznsh"]
	@property
	def Prfssn(self):
		return self._Prfssn
