...
class IndividualPerson37(base_types._BaseFieldType):
	...
	__slots__ = ["_BizFctn", "_EdctnLvl", "_Prfssn", "_Gndr", "_GDPRData", "_Ctznsh", "_PstlAdr", "_GvnNm", "_PrvcOfBirth", "_NmSfx", "_CtryOfBirth", "_EmplngCpny", "_BirthDt", "_Nm", "_FmlyInf", "_PltclyXpsdPrsn", "_NmPrfx", "_MddlNm", "_CityOfBirth", "_CvlSts", "_DthDt"]
	@property
	def BizFctn(self):
