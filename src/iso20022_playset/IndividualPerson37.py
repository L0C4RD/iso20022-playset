...
class IndividualPerson37(base_types._BaseFieldType):
	...
	__slots__ = ["_PstlAdr", "_Nm", "_GvnNm", "_EdctnLvl", "_EmplngCpny", "_Prfssn", "_PltclyXpsdPrsn", "_GDPRData", "_MddlNm", "_CityOfBirth", "_Gndr", "_BirthDt", "_Ctznsh", "_NmPrfx", "_BizFctn", "_FmlyInf", "_CtryOfBirth", "_NmSfx", "_CvlSts", "_PrvcOfBirth", "_DthDt"]
	@property
	def PstlAdr(self):
