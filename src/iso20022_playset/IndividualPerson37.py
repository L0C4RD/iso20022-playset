...
class IndividualPerson37(base_types._BaseFieldType):
	...
	__slots__ = ["_EmplngCpny", "_DthDt", "_NmPrfx", "_CvlSts", "_Nm", "_FmlyInf", "_PstlAdr", "_PrvcOfBirth", "_MddlNm", "_Ctznsh", "_CityOfBirth", "_CtryOfBirth", "_Prfssn", "_NmSfx", "_Gndr", "_BirthDt", "_EdctnLvl", "_GvnNm", "_BizFctn", "_PltclyXpsdPrsn", "_GDPRData"]
	@property
	def EmplngCpny(self):
