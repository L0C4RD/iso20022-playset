...
from .ExternalSecuritiesPurpose1Code import ExternalSecuritiesPurpose1Code
...
class Purpose3Choice(base_types._BaseFieldType):
	...
	def SctiesPurpCd(self, value):
		self._SctiesPurpCd = value if type(value) != base_types.auto else self.make_default("SctiesPurpCd")
