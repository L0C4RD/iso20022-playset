...
from . import MaintenanceDelegationRequest12
from . import TMSHeader1

class MaintenanceDelegationRequestV12(base_types._BaseFieldType):
	...
	def MntncDlgtnReq(self, value):
		self._MntncDlgtnReq = value if value is not None else base_types.UninitialisedField(self, 'MntncDlgtnReq', MaintenanceDelegationRequest12, False)

	@MntncDlgtnReq.deleter
	def MntncDlgtnReq(self):
		del self._MntncDlgtnReq
		self._MntncDlgtnReq = base_types.UninitialisedField(self, 'MntncDlgtnReq', MaintenanceDelegationRequest12, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='MntncDlgtnReq', type=MaintenanceDelegationRequest12, min=1, max=1, mutex_group=None, array=False),
