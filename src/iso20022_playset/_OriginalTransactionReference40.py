...
class OriginalTransactionReference40(base_types._BaseFieldType):
	...
	__slots__ = ["_CdtrAgtAcct", "_XpryDt", "_ReqdExctnDt", "_PmtTpInf", "_RmtInf", "_UltmtCdtr", "_Dbtr", "_UltmtDbtr", "_Amt", "_CdtrAgt", "_Cdtr", "_MndtRltdInf", "_NclsdFile", "_PmtMtd", "_DbtrAcct", "_DbtrAgtAcct", "_PmtCond", "_DbtrAgt", "_CdtrAcct"]
	@property
