...
class OriginalTransactionReference40(base_types._BaseFieldType):
	...
	__slots__ = ["_XpryDt", "_PmtCond", "_Cdtr", "_CdtrAgtAcct", "_UltmtDbtr", "_UltmtCdtr", "_Amt", "_CdtrAgt", "_NclsdFile", "_PmtMtd", "_CdtrAcct", "_Dbtr", "_PmtTpInf", "_RmtInf", "_MndtRltdInf", "_ReqdExctnDt", "_DbtrAgtAcct", "_DbtrAgt", "_DbtrAcct"]
	@property
	def XpryDt(self):
		return self._XpryDt
