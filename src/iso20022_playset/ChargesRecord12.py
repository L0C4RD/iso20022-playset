...
class ChargesRecord12(base_types._BaseFieldType):
	...
	__slots__ = ["_DbtrAcct", "_ChrgsAcctAgtAcct", "_AddtlInf", "_ChrgsAcctAgt", "_InstrForInstdAgt", "_RcrdId", "_ChrgsId", "_SttlmInstr", "_CdtDbtInd", "_Tp", "_Amt", "_Dbtr", "_DbtrAgt", "_ValDt", "_UndrlygTx", "_DbtrAgtAcct", "_ChrgsRqstr"]
	@property
	def DbtrAcct(self):
