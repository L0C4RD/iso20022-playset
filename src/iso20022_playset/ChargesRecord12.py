...
class ChargesRecord12(base_types._BaseFieldType):
	...
	__slots__ = ["_Dbtr", "_DbtrAgtAcct", "_AddtlInf", "_ChrgsRqstr", "_ChrgsId", "_ChrgsAcctAgt", "_DbtrAcct", "_ChrgsAcctAgtAcct", "_Amt", "_DbtrAgt", "_Tp", "_UndrlygTx", "_InstrForInstdAgt", "_RcrdId", "_ValDt", "_SttlmInstr", "_CdtDbtInd"]
	@property
	def Dbtr(self):
		return self._Dbtr
