...
class ChargesRecord12(base_types._BaseFieldType):
	...
	__slots__ = ["_Tp", "_AddtlInf", "_CdtDbtInd", "_ValDt", "_ChrgsId", "_Dbtr", "_DbtrAcct", "_RcrdId", "_DbtrAgtAcct", "_InstrForInstdAgt", "_ChrgsAcctAgt", "_DbtrAgt", "_Amt", "_SttlmInstr", "_ChrgsRqstr", "_UndrlygTx", "_ChrgsAcctAgtAcct"]
	@property
	def Tp(self):
		return self._Tp
