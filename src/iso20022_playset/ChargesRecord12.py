...
class ChargesRecord12(base_types._BaseFieldType):
	...
	__slots__ = ["_UndrlygTx", "_DbtrAgtAcct", "_ChrgsId", "_Amt", "_SttlmInstr", "_Tp", "_Dbtr", "_RcrdId", "_ValDt", "_DbtrAgt", "_AddtlInf", "_ChrgsRqstr", "_ChrgsAcctAgtAcct", "_InstrForInstdAgt", "_ChrgsAcctAgt", "_CdtDbtInd", "_DbtrAcct"]
	@property
	def UndrlygTx(self):
