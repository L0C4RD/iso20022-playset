...
class ChargesRecord12(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlInf", "_DbtrAgtAcct", "_ChrgsRqstr", "_ValDt", "_Dbtr", "_ChrgsAcctAgt", "_RcrdId", "_SttlmInstr", "_CdtDbtInd", "_UndrlygTx", "_Amt", "_ChrgsId", "_DbtrAgt", "_ChrgsAcctAgtAcct", "_InstrForInstdAgt", "_Tp", "_DbtrAcct"]
	@property
	def AddtlInf(self):
