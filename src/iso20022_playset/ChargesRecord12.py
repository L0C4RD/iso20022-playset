...
class ChargesRecord12(base_types._BaseFieldType):
	...
	__slots__ = ["_ChrgsRqstr", "_DbtrAcct", "_RcrdId", "_ValDt", "_Tp", "_ChrgsAcctAgt", "_ChrgsAcctAgtAcct", "_ChrgsId", "_DbtrAgt", "_CdtDbtInd", "_AddtlInf", "_Amt", "_SttlmInstr", "_UndrlygTx", "_InstrForInstdAgt", "_DbtrAgtAcct", "_Dbtr"]
	@property
	def ChrgsRqstr(self):
