...
from . import RedemptionBulkOrder6
...
class RedemptionBulkOrderV04(base_types._BaseFieldType):
	...
	def BlkOrdrDtls(self, value):
		self._BlkOrdrDtls = value if value is not None else base_types.UninitialisedField(self, 'BlkOrdrDtls', RedemptionBulkOrder6, False)

	@BlkOrdrDtls.deleter
	def BlkOrdrDtls(self):
		del self._BlkOrdrDtls
		self._BlkOrdrDtls = base_types.UninitialisedField(self, 'BlkOrdrDtls', RedemptionBulkOrder6, False)
