...
from .InterestAmount4 import InterestAmount4
from .InterestResult1 import InterestResult1
...
class InterestPaymentRequestV05(base_types._BaseFieldType):
	...
	__slots__ = ["_NetAmtDtls", "_Agrmt", "_SplmtryData", "_Oblgtn", "_IntrstDueToA", "_IntrstDueToB", "_TxId"]
	@property
	def NetAmtDtls(self):
