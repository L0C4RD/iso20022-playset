...
class OriginalTransactionIdentification1(base_types._BaseFieldType):
	...
	__slots__ = ["_TmZone", "_AuthstnSeqNb", "_LifeCyclIdMssng", "_RtrvlRefNb", "_LifeCyclId", "_LclTm", "_AcqrrRefNb", "_OthrPurchsIdrTp", "_PresntmntSeqCnt", "_LifeCyclSpprt", "_PresntmntSeqNb", "_PurchsIdr", "_TrnsmssnDtTm", "_AcqrrRefData", "_LclDt", "_IssrRefData", "_AuthntcnTkn", "_PurchsIdrTp", "_SysTracAudtNb"]
	@property
	def TmZone(self):
		return self._TmZone
