...
class OriginalTransactionIdentification1(base_types._BaseFieldType):
	...
	__slots__ = ["_PurchsIdr", "_AuthstnSeqNb", "_PurchsIdrTp", "_LclDt", "_LclTm", "_AuthntcnTkn", "_OthrPurchsIdrTp", "_IssrRefData", "_LifeCyclId", "_PresntmntSeqNb", "_RtrvlRefNb", "_LifeCyclSpprt", "_TmZone", "_SysTracAudtNb", "_AcqrrRefData", "_AcqrrRefNb", "_PresntmntSeqCnt", "_TrnsmssnDtTm", "_LifeCyclIdMssng"]
	@property
