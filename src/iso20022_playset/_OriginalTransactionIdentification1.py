...
class OriginalTransactionIdentification1(base_types._BaseFieldType):
	...
	__slots__ = ["_AcqrrRefNb", "_LifeCyclSpprt", "_AuthstnSeqNb", "_AcqrrRefData", "_IssrRefData", "_PresntmntSeqNb", "_LifeCyclIdMssng", "_RtrvlRefNb", "_TmZone", "_LifeCyclId", "_SysTracAudtNb", "_PurchsIdr", "_LclTm", "_PresntmntSeqCnt", "_TrnsmssnDtTm", "_LclDt", "_OthrPurchsIdrTp", "_PurchsIdrTp", "_AuthntcnTkn"]
	@property
	def AcqrrRefNb(self):
