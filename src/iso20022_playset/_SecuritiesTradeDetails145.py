...
class SecuritiesTradeDetails145(base_types._BaseFieldType):
	...
	__slots__ = ["_FxAddtlDtls", "_AckdStsTmStmp", "_NbOfDaysAcrd", "_TradId", "_PlcOfTrad", "_TradTxCond", "_CcyToBuyOrSell", "_OpngClsg", "_TradDt", "_MtchdStsTmStmp", "_SttlmInstrPrcgAddtlDtls", "_MtchgSts", "_TpOfPric", "_UnqTxIdr", "_AffirmSts", "_TradOrgtrRole", "_Rptg", "_LateDlvryDt", "_InvstrCpcty", "_DealPric", "_CollTxId", "_SttlmDt", "_PlcOfClr"]
	@property
