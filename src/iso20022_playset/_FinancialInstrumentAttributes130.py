...
class FinancialInstrumentAttributes130(base_types._BaseFieldType):

	__slots__ = ["_BabyBdDnmtn", "_ClssfctnTp", "_ConvsDt", "_CtrctSz", "_DayCntBsis", "_DnmtnCcy", "_DtdDt", "_FinInstrmId", "_FltgRateFxgDt", "_IntrstRate", "_IsseDt", "_IssePric", "_MinMltplQtyToInst", "_MinNmnlQty", "_MinQtyToInst", "_MtrtyDt", "_NxtCllblDt", "_NxtCpnDt", "_NxtFctr", "_NxtIntrstRate", "_OptnStyle", "_PlcOfListg", "_PrvsFctr", "_PutblDt"]
	@property
	def BabyBdDnmtn(self):
		return self._BabyBdDnmtn

	@BabyBdDnmtn.setter
	def BabyBdDnmtn(self, value):
		self._BabyBdDnmtn = value if value is not None else base_types.UninitialisedField(self, 'BabyBdDnmtn', DecimalNumber, False)

	@BabyBdDnmtn.deleter
	def BabyBdDnmtn(self):
		del self._BabyBdDnmtn
		self._BabyBdDnmtn = base_types.UninitialisedField(self, 'BabyBdDnmtn', DecimalNumber, False)
	...
	def IssePric(self, value):
		self._IssePric = value if value is not None else base_types.UninitialisedField(self, 'IssePric', PriceFormat74Choice, False)

	@IssePric.deleter
	def IssePric(self):
		del self._IssePric
		self._IssePric = base_types.UninitialisedField(self, 'IssePric', PriceFormat74Choice, False)
	...
	def MinMltplQtyToInst(self, value):
		self._MinMltplQtyToInst = value if value is not None else base_types.UninitialisedField(self, 'MinMltplQtyToInst', FinancialInstrumentQuantity33Choice, False)

	@MinMltplQtyToInst.deleter
	def MinMltplQtyToInst(self):
		del self._MinMltplQtyToInst
		self._MinMltplQtyToInst = base_types.UninitialisedField(self, 'MinMltplQtyToInst', FinancialInstrumentQuantity33Choice, False)
	...
	def MinQtyToInst(self, value):
		self._MinQtyToInst = value if value is not None else base_types.UninitialisedField(self, 'MinQtyToInst', FinancialInstrumentQuantity33Choice, False)

	@MinQtyToInst.deleter
	def MinQtyToInst(self):
		del self._MinQtyToInst
		self._MinQtyToInst = base_types.UninitialisedField(self, 'MinQtyToInst', FinancialInstrumentQuantity33Choice, False)
	...
	_field_defs = frozenset((
		base_types.FieldEntry(name='BabyBdDnmtn', type=DecimalNumber, min=0, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='IssePric', type=PriceFormat74Choice, min=0, max=1, mutex_group=None, array=False),
