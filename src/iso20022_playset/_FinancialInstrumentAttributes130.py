...
class FinancialInstrumentAttributes130(base_types._BaseFieldType):
	...
	__slots__ = ["_MinNmnlQty", "_IsseDt", "_MtrtyDt", "_IntrstRate", "_FltgRateFxgDt", "_OptnStyle", "_MinQtyToInst", "_NxtFctr", "_PlcOfListg", "_DnmtnCcy", "_NxtCpnDt", "_BabyBdDnmtn", "_DtdDt", "_PrvsFctr", "_PutblDt", "_ConvsDt", "_NxtIntrstRate", "_CtrctSz", "_DayCntBsis", "_NxtCllblDt", "_IssePric", "_FinInstrmId", "_ClssfctnTp", "_MinMltplQtyToInst"]
	@property
	def MinNmnlQty(self):
