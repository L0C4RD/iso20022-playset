...
class CorporateActionDate108(base_types._BaseFieldType):
	...
	__slots__ = ["_BrrwrStockLndgDdln", "_XpryDt", "_RspnDdln", "_SbcptCostDbtDt", "_StockLndgDdln", "_DcmnttnDdln", "_EndOfSctiesBlckgPrd", "_CoverXprtnDdln", "_MktDdln", "_PrtctDdln", "_EarlyRspnDdln", "_DpstryCoverXprtnDt"]
	@property
