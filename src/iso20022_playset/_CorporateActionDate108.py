...
class CorporateActionDate108(base_types._BaseFieldType):
	...
	__slots__ = ["_XpryDt", "_CoverXprtnDdln", "_EarlyRspnDdln", "_PrtctDdln", "_DpstryCoverXprtnDt", "_StockLndgDdln", "_BrrwrStockLndgDdln", "_MktDdln", "_SbcptCostDbtDt", "_EndOfSctiesBlckgPrd", "_DcmnttnDdln", "_RspnDdln"]
	@property
	def XpryDt(self):
		return self._XpryDt
