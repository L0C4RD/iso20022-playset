...
class DeviceResponse8(base_types._BaseFieldType):
	...
	__slots__ = ["_Rspn", "_InitlstnCardRdrRspn", "_ScrInptRspn", "_SplmtryData", "_CardRdrApplPrtcolDataUnitRspn", "_Cntxt", "_InptRspn", "_Envt", "_SvcCntt", "_TrnsmssnRspn", "_DispRspn", "_PrtRspn"]
	@property
	def Rspn(self):
		return self._Rspn
