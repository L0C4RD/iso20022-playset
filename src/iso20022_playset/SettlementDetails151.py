...
class SettlementDetails151(base_types._BaseFieldType):
	...
	__slots__ = ["_TaxCpcty", "_StmpDtyTaxBsis", "_SttlmSysMtd", "_ElgblForColl", "_MktClntSd", "_BlckTrad", "_BnfclOwnrsh", "_SttlmTxCond", "_SctiesRTGS", "_NetgElgblty", "_PrtlSttlmInd", "_CshClrSys", "_Prty", "_LglRstrctns", "_CCPElgblty", "_SttlgCpcty", "_AutomtcBrrwg"]
	@property
	def TaxCpcty(self):
