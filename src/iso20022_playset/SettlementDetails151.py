...
class SettlementDetails151(base_types._BaseFieldType):
	...
	__slots__ = ["_ElgblForColl", "_AutomtcBrrwg", "_SttlgCpcty", "_LglRstrctns", "_SttlmSysMtd", "_NetgElgblty", "_CCPElgblty", "_BlckTrad", "_SctiesRTGS", "_TaxCpcty", "_SttlmTxCond", "_BnfclOwnrsh", "_MktClntSd", "_StmpDtyTaxBsis", "_Prty", "_PrtlSttlmInd", "_CshClrSys"]
	@property
