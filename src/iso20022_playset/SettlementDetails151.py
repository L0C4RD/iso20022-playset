...
class SettlementDetails151(base_types._BaseFieldType):
	...
	__slots__ = ["_AutomtcBrrwg", "_CshClrSys", "_SctiesRTGS", "_NetgElgblty", "_BlckTrad", "_SttlmSysMtd", "_Prty", "_CCPElgblty", "_MktClntSd", "_StmpDtyTaxBsis", "_LglRstrctns", "_PrtlSttlmInd", "_ElgblForColl", "_SttlmTxCond", "_BnfclOwnrsh", "_SttlgCpcty", "_TaxCpcty"]
	@property
