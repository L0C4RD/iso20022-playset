...
class Baseline5(base_types._BaseFieldType):
	...
	__slots__ = ["_SubmitrBaselnId", "_ComrclDataSetReqrd", "_PmtTerms", "_SellrSdSubmitgBk", "_Buyr", "_PmtOblgtn", "_BuyrSdSubmitgBk", "_InsrncDataSetReqrd", "_OthrCertDataSetReqrd", "_SttlmTerms", "_BllTo", "_SvcCd", "_ShipTo", "_InttToPayXpctd", "_Consgn", "_LatstMtchDt", "_PurchsOrdrRef", "_Sellr", "_CertDataSetReqrd", "_TrnsprtDataSetReqrd", "_Goods", "_BuyrBk", "_SellrBk"]
	@property
