...
class OriginalTransactionReference40(base_types._BaseFieldType):
	...
	__slots__ = ["_Amt", "_Dbtr", "_DbtrAgtAcct", "_UltmtCdtr", "_PmtCond", "_DbtrAcct", "_CdtrAgtAcct", "_CdtrAcct", "_DbtrAgt", "_PmtTpInf", "_Cdtr", "_NclsdFile", "_UltmtDbtr", "_ReqdExctnDt", "_XpryDt", "_RmtInf", "_CdtrAgt", "_MndtRltdInf", "_PmtMtd"]
	@property
	def Amt(self):
		return self._Amt
