...
class OriginalTransactionReference40(base_types._BaseFieldType):
	...
	__slots__ = ["_PmtCond", "_PmtTpInf", "_CdtrAgt", "_UltmtCdtr", "_Dbtr", "_ReqdExctnDt", "_MndtRltdInf", "_DbtrAgtAcct", "_DbtrAcct", "_PmtMtd", "_CdtrAgtAcct", "_CdtrAcct", "_Amt", "_DbtrAgt", "_RmtInf", "_XpryDt", "_UltmtDbtr", "_NclsdFile", "_Cdtr"]
	@property
	def PmtCond(self):
