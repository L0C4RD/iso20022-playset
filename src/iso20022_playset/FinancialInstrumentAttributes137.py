...
class FinancialInstrumentAttributes137(base_types._BaseFieldType):
	...
	__slots__ = ["_FltgRateFxgDt", "_NxtCllblDt", "_PlcOfListg", "_DtdDt", "_IssePric", "_NxtFctr", "_MinQtyToInst", "_DnmtnCcy", "_PutblDt", "_NxtIntrstRate", "_ConvsDt", "_OptnStyle", "_DayCntBsis", "_MinNmnlQty", "_PrvsFctr", "_MtrtyDt", "_NxtCpnDt", "_MinMltplQtyToInst", "_IntrstRate", "_CtrctSz", "_IsseDt", "_ClssfctnTp", "_FinInstrmId"]
	@property
