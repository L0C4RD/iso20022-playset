...
class ChargesPerTransactionRecord5(base_types._BaseFieldType):
	...
	__slots__ = ["_ChrgsBrkdwn", "_DbtrAcct", "_ChrgsAcctOwnr", "_Dbtr", "_TtlChrgsPerRcrd", "_AddtlInf", "_DbtrAgt", "_ValDt", "_ChrgsAcct", "_UndrlygTx", "_InstrForInstdAgt", "_RcrdId", "_DbtrAgtAcct", "_ChrgsRqstr"]
	@property
