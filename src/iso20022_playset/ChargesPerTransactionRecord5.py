...
class ChargesPerTransactionRecord5(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlInf", "_ChrgsBrkdwn", "_DbtrAgt", "_ChrgsAcct", "_ValDt", "_ChrgsAcctOwnr", "_Dbtr", "_DbtrAcct", "_RcrdId", "_TtlChrgsPerRcrd", "_DbtrAgtAcct", "_InstrForInstdAgt", "_ChrgsRqstr", "_UndrlygTx"]
	@property
	def AddtlInf(self):
