...
class ChargesPerTransactionRecord5(base_types._BaseFieldType):
	...
	__slots__ = ["_ChrgsRqstr", "_AddtlInf", "_DbtrAcct", "_RcrdId", "_ValDt", "_ChrgsBrkdwn", "_TtlChrgsPerRcrd", "_UndrlygTx", "_ChrgsAcct", "_InstrForInstdAgt", "_DbtrAgtAcct", "_Dbtr", "_DbtrAgt", "_ChrgsAcctOwnr"]
	@property
	def ChrgsRqstr(self):
