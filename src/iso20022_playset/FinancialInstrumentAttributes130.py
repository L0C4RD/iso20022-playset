...
class FinancialInstrumentAttributes130(base_types._BaseFieldType):
	...
	__slots__ = ["_MinQtyToInst", "_CtrctSz", "_IssePric", "_MtrtyDt", "_DtdDt", "_OptnStyle", "_NxtCllblDt", "_DayCntBsis", "_PlcOfListg", "_PrvsFctr", "_MinMltplQtyToInst", "_FinInstrmId", "_ConvsDt", "_NxtCpnDt", "_IsseDt", "_BabyBdDnmtn", "_ClssfctnTp", "_NxtFctr", "_MinNmnlQty", "_PutblDt", "_FltgRateFxgDt", "_NxtIntrstRate", "_IntrstRate", "_DnmtnCcy"]
	@property
