...
class FinancialInstrumentAttributes130(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrctSz", "_FltgRateFxgDt", "_NxtCllblDt", "_DtdDt", "_NxtFctr", "_MinNmnlQty", "_DayCntBsis", "_MinMltplQtyToInst", "_MinQtyToInst", "_BabyBdDnmtn", "_DnmtnCcy", "_PutblDt", "_NxtIntrstRate", "_ConvsDt", "_PlcOfListg", "_IssePric", "_OptnStyle", "_PrvsFctr", "_ClssfctnTp", "_FinInstrmId", "_NxtCpnDt", "_MtrtyDt", "_IntrstRate", "_IsseDt"]
	@property
	def CtrctSz(self):
