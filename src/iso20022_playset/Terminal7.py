...
class Terminal7(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrTp", "_Id", "_WrtgCpblty", "_CardCaptrCpbl", "_OnBrd", "_AddtlId", "_MsgCpblty", "_RdngCpblty", "_PINLngthCpblty", "_OnLineCpblty", "_SrlNb", "_OffPrmiss", "_Tp", "_MxScrptLngth", "_GeogcLctn", "_Outdr", "_IntgtnTp", "_PINNtrySctyChrtc", "_ApprvlCdLngth", "_CrdhldrVrfctnCpblty", "_OthrPINNtrySctyChrtc", "_CertfctnId", "_TempScrStorg", "_Sftwr"]
	@property
	def OthrTp(self):
		return self._OthrTp
