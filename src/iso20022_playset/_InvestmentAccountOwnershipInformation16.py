...
class InvestmentAccountOwnershipInformation16(base_types._BaseFieldType):
	...
	__slots__ = ["_PmryComAdr", "_SgntryRghtInd", "_TaxXmptn", "_WorkgCptl", "_Pty", "_FsclXmptn", "_CRSSts", "_AddtlRgltryInf", "_Ntfctn", "_FATCAFormTp", "_MnyLndrgChck", "_InvstrPrflVldtn", "_MntryWlth", "_OwnrshBnfcryRate", "_CRSFormTp", "_ScndryComAdr", "_Lang", "_AddtlInf", "_CtrlgPty", "_EqtyVal", "_ElctrncMlngSvcRef", "_FATCASts", "_CtryAndResdtlSts", "_AcctgSts", "_MiFIDClssfctn", "_CRSRptgDt", "_FATCARptgDt", "_CpnyLk", "_MailTp", "_OthrId", "_ClntId", "_TaxRptg"]
	@property
	def PmryComAdr(self):
