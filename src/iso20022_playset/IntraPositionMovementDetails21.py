...
class IntraPositionMovementDetails21(base_types._BaseFieldType):
	...
	__slots__ = ["_SctiesSubBalId", "_Id", "_PrevslySttldQty", "_AvlblDt", "_SplmtryData", "_AckdStsTmStmp", "_CollMntrAmt", "_RmngToBeSttldQty", "_BalTo", "_SttlmDt", "_InstrPrcgAddtlDtls", "_CorpActnEvtTp", "_SttldQty"]
	@property
