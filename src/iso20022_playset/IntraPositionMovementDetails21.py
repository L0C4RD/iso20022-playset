...
class IntraPositionMovementDetails21(base_types._BaseFieldType):
	...
	__slots__ = ["_CollMntrAmt", "_InstrPrcgAddtlDtls", "_AckdStsTmStmp", "_PrevslySttldQty", "_CorpActnEvtTp", "_SttldQty", "_SplmtryData", "_BalTo", "_Id", "_RmngToBeSttldQty", "_SctiesSubBalId", "_SttlmDt", "_AvlblDt"]
	@property
