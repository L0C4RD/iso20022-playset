...
class IntraPositionMovementDetails21(base_types._BaseFieldType):
	...
	__slots__ = ["_PrevslySttldQty", "_CorpActnEvtTp", "_AvlblDt", "_SttlmDt", "_Id", "_InstrPrcgAddtlDtls", "_AckdStsTmStmp", "_BalTo", "_CollMntrAmt", "_SttldQty", "_SplmtryData", "_SctiesSubBalId", "_RmngToBeSttldQty"]
	@property
