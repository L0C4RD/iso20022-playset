...
class AddendumInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Issr", "_Orgtr", "_Acqrr", "_Tkn", "_TxDesc", "_Hdr", "_TxId", "_DataSrc", "_Jursdctn", "_AddtlFee", "_Rcvr", "_SttlmSvc", "_PrtctdData", "_AdddmData", "_SctyTrlr", "_Cstmr", "_Sndr", "_Prgrmm", "_Accptr", "_Rcncltn", "_AddtlData", "_OrgnlDataElmts", "_Card", "_Dstn", "_SplmtryData"]
	@property
	def Issr(self):
		return self._Issr
