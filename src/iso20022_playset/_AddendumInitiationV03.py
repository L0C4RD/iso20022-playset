...
class AddendumInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_Cstmr", "_SttlmSvc", "_TxId", "_TxDesc", "_SctyTrlr", "_DataSrc", "_Acqrr", "_OrgnlDataElmts", "_Hdr", "_AddtlData", "_Rcvr", "_Card", "_Sndr", "_Dstn", "_Accptr", "_Issr", "_AdddmData", "_Rcncltn", "_Tkn", "_Jursdctn", "_Orgtr", "_Prgrmm", "_AddtlFee", "_PrtctdData"]
	@property
