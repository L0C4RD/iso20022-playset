...
import AdditionalBusinessProcessFormat18Choice
import CorporateActionQuantity12
import IntermediateSecuritiesDistributionTypeFormat15Choice
import CorporateActionDate85
...
class CorporateAction69(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlBizPrcInd", "_EvtStag", "_DtDtls", "_SctiesQty", "_IntrmdtSctiesDstrbtnTp", "_LtryTp"]
	@property
