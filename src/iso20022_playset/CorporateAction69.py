...
from .AdditionalBusinessProcessFormat18Choice import AdditionalBusinessProcessFormat18Choice
from .LotteryTypeFormat4Choice import LotteryTypeFormat4Choice
from .CorporateActionQuantity12 import CorporateActionQuantity12
from .CorporateActionEventStageFormat14Choice import CorporateActionEventStageFormat14Choice
from .CorporateActionDate85 import CorporateActionDate85

class CorporateAction69(base_types._BaseFieldType):

	__slots__ = ["_DtDtls", "_EvtStag", "_AddtlBizPrcInd", "_SctiesQty", "_LtryTp", "_IntrmdtSctiesDstrbtnTp"]
	@property
	def DtDtls(self):
		return self._DtDtls
