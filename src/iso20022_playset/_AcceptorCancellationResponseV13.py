...
from . import AcceptorCancellationResponse13
...
class AcceptorCancellationResponseV13(base_types._BaseFieldType):
	...
	def CxlRspn(self, value):
		self._CxlRspn = value if value is not None else base_types.UninitialisedField(self, 'CxlRspn', AcceptorCancellationResponse13, False)

	@CxlRspn.deleter
	def CxlRspn(self):
		del self._CxlRspn
		self._CxlRspn = base_types.UninitialisedField(self, 'CxlRspn', AcceptorCancellationResponse13, False)
