...
class TransactionIdentification58(base_types._BaseFieldType):

	__slots__ = ["_AcqrrRefData", "_AcqrrRefNb", "_AssoctdData", "_AssoctdDataDstn", "_AssoctdDataRef", "_AssoctdTxLifeCyclId", "_AuthntcnTkn", "_AuthstnSeqNb", "_IssrRefData", "_LclDt", "_LclTm", "_LifeCyclId", "_LifeCyclIdMssng", "_LifeCyclIdVldtn", "_LifeCyclSpprt", "_NtlData", "_PresntmntSeqCnt", "_PresntmntSeqNb", "_PrvtData", "_PurchsIdr", "_PurchsIdrTp", "_RtrvlRefNb", "_SysTracAudtNb", "_TmZone", "_TrnsmssnDtTm"]
	@property
	...
	@property
	def AssoctdTxLifeCyclId(self):
		return self._AssoctdTxLifeCyclId

	@AssoctdTxLifeCyclId.setter
	def AssoctdTxLifeCyclId(self, value):
		self._AssoctdTxLifeCyclId = value if value is not None else base_types.UninitialisedField(self, 'AssoctdTxLifeCyclId', Max36Text, False)

	@AssoctdTxLifeCyclId.deleter
	def AssoctdTxLifeCyclId(self):
		del self._AssoctdTxLifeCyclId
		self._AssoctdTxLifeCyclId = base_types.UninitialisedField(self, 'AssoctdTxLifeCyclId', Max36Text, False)
	...
	def AuthntcnTkn(self, value):
		self._AuthntcnTkn = value if value is not None else base_types.UninitialisedField(self, 'AuthntcnTkn', Max36Text, False)

	@AuthntcnTkn.deleter
	def AuthntcnTkn(self):
		del self._AuthntcnTkn
		self._AuthntcnTkn = base_types.UninitialisedField(self, 'AuthntcnTkn', Max36Text, False)
	...
	def LifeCyclId(self, value):
		self._LifeCyclId = value if value is not None else base_types.UninitialisedField(self, 'LifeCyclId', Max36Text, False)

	@LifeCyclId.deleter
	def LifeCyclId(self):
		del self._LifeCyclId
		self._LifeCyclId = base_types.UninitialisedField(self, 'LifeCyclId', Max36Text, False)
	...
	@property
	def LifeCyclIdVldtn(self):
		return self._LifeCyclIdVldtn

	@LifeCyclIdVldtn.setter
	def LifeCyclIdVldtn(self, value):
		self._LifeCyclIdVldtn = value if value is not None else base_types.UninitialisedField(self, 'LifeCyclIdVldtn', Max37Text, False)

	@LifeCyclIdVldtn.deleter
	def LifeCyclIdVldtn(self):
		del self._LifeCyclIdVldtn
		self._LifeCyclIdVldtn = base_types.UninitialisedField(self, 'LifeCyclIdVldtn', Max37Text, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='AssoctdTxLifeCyclId', type=Max36Text, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='AuthntcnTkn', type=Max36Text, min=0, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='LifeCyclId', type=Max36Text, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='LifeCyclIdMssng', type=Max70Text, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='LifeCyclIdVldtn', type=Max37Text, min=0, max=1, mutex_group=None, array=False),
