...
from . import InstructionTypeStatus7Choice
...
class MeetingInstructionStatusV11(base_types._BaseFieldType):
	...
	def InstrTpSts(self, value):
		self._InstrTpSts = value if value is not None else base_types.UninitialisedField(self, 'InstrTpSts', InstructionTypeStatus7Choice, False)

	@InstrTpSts.deleter
	def InstrTpSts(self):
		del self._InstrTpSts
		self._InstrTpSts = base_types.UninitialisedField(self, 'InstrTpSts', InstructionTypeStatus7Choice, False)
