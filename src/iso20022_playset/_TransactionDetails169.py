...
class TransactionDetails169(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmDt", "_SttlmTxOrCorpActnEvtTp", "_DlvrgSttlmPties", "_PlcOfClr", "_RvslInd", "_SttlmParams", "_FctvSttlmDt", "_SctiesMvmntTp", "_TradDt", "_AcrdIntrstAmt", "_NbOfDaysAcrd", "_Pmt", "_PstngQty", "_SfkpgPlc", "_MtchdStsTmStmp", "_TxAddtlDtls", "_AckdStsTmStmp", "_TxActvty", "_RcvgSttlmPties", "_PstngAmt", "_PlcOfTrad", "_ValDt"]
	@property
	def SttlmDt(self):
