...
class CashOption105(base_types._BaseFieldType):
	...
	__slots__ = ["_IssrOfferrTaxbltyInd", "_AmtDtls", "_XmptnTp", "_FXDtls", "_PricDtls", "_CtrctlPmtInd", "_CtryOfIncmSrc", "_IncmTp", "_DtDtls", "_TaxVchrDtls", "_RateAndAmtDtls", "_CshPties", "_CdtDbtInd", "_Acct", "_OthrIncmTp"]
	@property
