...
class CashOption105(base_types._BaseFieldType):
	...
	__slots__ = ["_TaxVchrDtls", "_CtrctlPmtInd", "_CtryOfIncmSrc", "_OthrIncmTp", "_IssrOfferrTaxbltyInd", "_AmtDtls", "_IncmTp", "_FXDtls", "_XmptnTp", "_DtDtls", "_CdtDbtInd", "_PricDtls", "_Acct", "_CshPties", "_RateAndAmtDtls"]
	@property
