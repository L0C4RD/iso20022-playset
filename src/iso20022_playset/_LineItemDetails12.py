...
class LineItemDetails12(base_types._BaseFieldType):
	...
	__slots__ = ["_PdctChrtcs", "_OutsdngQty", "_OrdrdQty", "_AccptdAmt", "_PricTlrnce", "_QtyTlrnce", "_PdctIdr", "_AccptdQty", "_OrdrdAmt", "_PdgQty", "_PdctCtgy", "_PdctNm", "_PdgAmt", "_OutsdngAmt", "_LineItmId"]
	@property
	def PdctChrtcs(self):
