...
from . import SettlementFailsDailyInstructionType3
...
class SettlementFailsDailyInstructionType1Choice(base_types._BaseFieldType):
	...
	@Data.setter
	def Data(self, value):
		self._Data = value if value is not None else base_types.UninitialisedField(self, 'Data', SettlementFailsDailyInstructionType3, False)

	@Data.deleter
	def Data(self):
		del self._Data
		self._Data = base_types.UninitialisedField(self, 'Data', SettlementFailsDailyInstructionType3, False)
	...
	_field_defs = frozenset((
		base_types.FieldEntry(name='Data', type=SettlementFailsDailyInstructionType3, min=0, max=1, mutex_group=1, array=False),
