...
class FinancialInstrumentAttributes111(base_types._BaseFieldType):
	...
	__slots__ = ["_MinNmnlQty", "_IsseDt", "_FltgRateFxgDt", "_NxtIntrstRate", "_XpryDt", "_VarblRateInd", "_DnmtnCcy", "_YldToMtrtyRate", "_PrvsFctr", "_PutblInd", "_SbcptPric", "_RegnForm", "_DtdDt", "_FinInstrmAttrAddtlDtls", "_IntrstRate", "_CtrctSz", "_DayCntBsis", "_ConvsPric", "_PmtSts", "_CllblInd", "_NxtCllblDt", "_PoolNb", "_CpnAttchdNb", "_ClssfctnTp", "_VarblRateChngFrqcy", "_NxtFctr", "_MtrtyDt", "_OptnStyle", "_StrkPric", "_OptnTp", "_PlcOfListg", "_MktOrIndctvPric", "_FrstPmtDt", "_PutblDt", "_IndxRateBsis", "_PmtFrqcy", "_CurFctr", "_UndrlygFinInstrmId", "_CpnDt", "_ExrcPric"]
	@property
	def MinNmnlQty(self):
