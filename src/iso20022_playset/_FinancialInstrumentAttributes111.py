...
class FinancialInstrumentAttributes111(base_types._BaseFieldType):
	...
	__slots__ = ["_ClssfctnTp", "_ConvsPric", "_PlcOfListg", "_OptnTp", "_IntrstRate", "_VarblRateInd", "_MinNmnlQty", "_PoolNb", "_YldToMtrtyRate", "_PutblInd", "_PrvsFctr", "_CpnDt", "_VarblRateChngFrqcy", "_PutblDt", "_DayCntBsis", "_RegnForm", "_MktOrIndctvPric", "_XpryDt", "_FrstPmtDt", "_NxtFctr", "_StrkPric", "_UndrlygFinInstrmId", "_CpnAttchdNb", "_PmtSts", "_NxtCllblDt", "_PmtFrqcy", "_FltgRateFxgDt", "_FinInstrmAttrAddtlDtls", "_CurFctr", "_NxtIntrstRate", "_IndxRateBsis", "_CllblInd", "_DtdDt", "_MtrtyDt", "_OptnStyle", "_IsseDt", "_CtrctSz", "_SbcptPric", "_ExrcPric", "_DnmtnCcy"]
	@property
	def ClssfctnTp(self):
