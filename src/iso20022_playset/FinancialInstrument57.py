...
from .Series1 import Series1
from .FormOfSecurity1Code import FormOfSecurity1Code

class FinancialInstrument57(base_types._BaseFieldType):

	__slots__ = ["_ClssTp", "_SplmtryId", "_Nm", "_SctiesForm", "_DstrbtnPlcy", "_SrsId", "_PdctGrp", "_Id", "_ShrtNm"]
	@property
	def ClssTp(self):
		return self._ClssTp
	...
	def SrsId(self, value):
		self._SrsId = value if type(value) != auto else self.make_default("SrsId")
