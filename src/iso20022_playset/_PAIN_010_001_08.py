...
from . import MandateAmendmentRequestV08
...
class PAIN_010_001_08():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def MndtAmdmntReq(self, value):
			self._MndtAmdmntReq = value if value is not None else base_types.UninitialisedField(self, 'MndtAmdmntReq', MandateAmendmentRequestV08, False)

		@MndtAmdmntReq.deleter
		def MndtAmdmntReq(self):
			del self._MndtAmdmntReq
			self._MndtAmdmntReq = base_types.UninitialisedField(self, 'MndtAmdmntReq', MandateAmendmentRequestV08, False)
