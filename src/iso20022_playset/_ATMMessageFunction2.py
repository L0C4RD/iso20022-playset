...
class ATMMessageFunction2(base_types._BaseFieldType):
	...
	@Fctn.setter
	def Fctn(self, value):
		self._Fctn = value if value is not None else base_types.UninitialisedField(self, 'Fctn', MessageFunction11Code, False)

	@Fctn.deleter
	def Fctn(self):
		del self._Fctn
		self._Fctn = base_types.UninitialisedField(self, 'Fctn', MessageFunction11Code, False)
