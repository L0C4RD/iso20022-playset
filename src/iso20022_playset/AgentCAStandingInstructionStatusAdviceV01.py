...
from .StandingInstructionStatus1Choice import StandingInstructionStatus1Choice
from .DocumentIdentification8 import DocumentIdentification8
from .StandingInstructionCancellationStatus1Choice import StandingInstructionCancellationStatus1Choice

class AgentCAStandingInstructionStatusAdviceV01(base_types._BaseFieldType):

	__slots__ = ["_StgInstrReqSts", "_AgtCAStgInstrReqId", "_StgInstrGnlInf", "_Id", "_StgInstrCxlReqSts", "_AgtCAStgInstrCxlReqId"]
	@property
	...
	def StgInstrCxlReqSts(self, value):
		self._StgInstrCxlReqSts = value if type(value) != auto else self.make_default("StgInstrCxlReqSts")
