...
from ._CorporateActionInstructionStatusAdviceV16 import CorporateActionInstructionStatusAdviceV16
...
class SEEV_034_001_16():
	...
	class Document(base_types._BaseFieldType):
		...
		attrib = {
			"xmlns" : base_types._BaseDataType_String(None, data="urn:iso:std:iso:20022:tech:xsd:seev.034.001.16"),
		}
