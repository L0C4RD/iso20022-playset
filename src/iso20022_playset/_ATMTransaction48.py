...
from .ATMCustomerProfile7 import ATMCustomerProfile7
from .Max10000Binary import Max10000Binary
from .ResponseType12 import ResponseType12
from .CurrencyConversion33 import CurrencyConversion33
from .CurrencyConversion5 import CurrencyConversion5
from .CardAccount18 import CardAccount18
from .ATMAccountStatement3 import ATMAccountStatement3
...
class ATMTransaction48(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctInf", "_AcctStmtData", "_AuthstnRslt", "_CcyXchg", "_TxRspn", "_ICCRltdData", "_Cmd", "_TxId", "_CcyConvs", "_Actn", "_CstmrSvcPrfl"]
	@property
	def AcctInf(self):
