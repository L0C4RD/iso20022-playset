...
from .Commission24 import Commission24
...
class Order24(base_types._BaseFieldType):
	...
	__slots__ = ["_ListId", "_AddtlPhysOrRegnDtls", "_QtyBrkdwn", "_Rptg", "_TradOrgtnDt", "_AcrdIntrstAmt", "_MtchSts", "_ClntOrdrId", "_Pmt", "_PreAdvc", "_OrdrOrgtrElgblty", "_PrcgDt", "_Sd", "_NAVDt", "_BizPrcTp", "_TradTxTp", "_CallInTp", "_ChrgTaxBsisTp", "_ScndryClntOrdrId", "_GvUpNbOfDays", "_IntrstTp", "_OrdrId", "_DerivCvrd", "_CptlGnTp", "_TradTxCond", "_AcrdIntrstPctg", "_CcyToBuyOrSell", "_TradDt", "_GrssTradAmt", "_TradRgltryCondsTp", "_Comssn", "_YldTp", "_TpOfPric", "_PlcOfTrad", "_DealPric", "_PosFct", "_AddtlTradInstrPrcgInf", "_OrdrBookgDt", "_NbOfDaysAcrd", "_PrtlFillDtls", "_CshMrgn", "_SttlmDt", "_ConfQty"]
	@property
	def ListId(self):
		return self._ListId
