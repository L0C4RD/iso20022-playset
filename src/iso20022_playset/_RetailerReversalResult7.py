...
class RetailerReversalResult7(base_types._BaseFieldType):
	...
	def OrgnlPmtTx(self, value):
		self._OrgnlPmtTx = value if value is not None else base_types.UninitialisedField(self, 'OrgnlPmtTx', PaymentTransaction165, False)

	@OrgnlPmtTx.deleter
	def OrgnlPmtTx(self):
		del self._OrgnlPmtTx
		self._OrgnlPmtTx = base_types.UninitialisedField(self, 'OrgnlPmtTx', PaymentTransaction165, False)
