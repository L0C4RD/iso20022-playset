...
from .SecuritiesTradeDetails140 import SecuritiesTradeDetails140
from .Statement69 import Statement69
from .Pagination1 import Pagination1

class SecuritiesSettlementTransactionAllegementReport002V10(base_types._BaseFieldType):

	__slots__ = ["_BlckChainAdrOrWllt", "_AcctOwnr", "_SfkpgAcct", "_Pgntn", "_AllgmtDtls", "_StmtGnlDtls"]
	@property
