...
class PaymentTransaction130(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlInstrId", "_TxSts", "_OrgnlEndToEndId", "_StsRsnInf", "_OrgnlGrpInf", "_AccptncDtTm", "_OrgnlTxRef", "_ChrgsInf", "_FctvIntrBkSttlmDt", "_StsId", "_OrgnlTxId", "_AcctSvcrRef", "_OrgnlUETR", "_InstgAgt", "_InstdAgt", "_SplmtryData", "_ClrSysRef"]
	@property
