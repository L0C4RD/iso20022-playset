...
class PaymentTransaction130(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlInstrId", "_SplmtryData", "_AccptncDtTm", "_OrgnlUETR", "_OrgnlTxRef", "_InstgAgt", "_InstdAgt", "_OrgnlGrpInf", "_StsRsnInf", "_ClrSysRef", "_FctvIntrBkSttlmDt", "_AcctSvcrRef", "_OrgnlTxId", "_ChrgsInf", "_OrgnlEndToEndId", "_StsId", "_TxSts"]
	@property
