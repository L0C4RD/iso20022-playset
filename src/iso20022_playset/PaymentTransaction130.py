...
class PaymentTransaction130(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctSvcrRef", "_ChrgsInf", "_FctvIntrBkSttlmDt", "_AccptncDtTm", "_InstgAgt", "_OrgnlUETR", "_OrgnlGrpInf", "_StsRsnInf", "_TxSts", "_StsId", "_ClrSysRef", "_OrgnlEndToEndId", "_InstdAgt", "_OrgnlInstrId", "_OrgnlTxRef", "_OrgnlTxId", "_SplmtryData"]
	@property
