...
class PaymentTransaction130(base_types._BaseFieldType):
	...
	__slots__ = ["_FctvIntrBkSttlmDt", "_ChrgsInf", "_OrgnlGrpInf", "_ClrSysRef", "_StsRsnInf", "_OrgnlUETR", "_StsId", "_AccptncDtTm", "_TxSts", "_OrgnlTxRef", "_OrgnlTxId", "_SplmtryData", "_OrgnlEndToEndId", "_InstdAgt", "_AcctSvcrRef", "_InstgAgt", "_OrgnlInstrId"]
	@property
