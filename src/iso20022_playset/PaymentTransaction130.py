...
class PaymentTransaction130(base_types._BaseFieldType):
	...
	__slots__ = ["_ChrgsInf", "_FctvIntrBkSttlmDt", "_InstgAgt", "_ClrSysRef", "_StsId", "_OrgnlTxRef", "_StsRsnInf", "_TxSts", "_SplmtryData", "_OrgnlUETR", "_OrgnlEndToEndId", "_OrgnlTxId", "_OrgnlGrpInf", "_InstdAgt", "_AcctSvcrRef", "_AccptncDtTm", "_OrgnlInstrId"]
	@property
	def ChrgsInf(self):
