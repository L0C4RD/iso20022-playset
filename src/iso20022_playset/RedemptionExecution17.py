...
from .TotalFeesAndTaxes42 import TotalFeesAndTaxes42
...
from .Equalisation3 import Equalisation3
...
from .InformativeTax2 import InformativeTax2
...
from .Intermediary49 import Intermediary49
from .UKTaxGroupUnit1Code import UKTaxGroupUnit1Code
from .FundSettlementParameters19 import FundSettlementParameters19
...
class RedemptionExecution17(base_types._BaseFieldType):
	...
	__slots__ = ["_PhysDlvryInd", "_ReqdSttlmCcy", "_FinAdvc", "_DealRef", "_PrtlSttlmOfUnits", "_CshSttlmDtls", "_FXDtls", "_ClntRef", "_Rndg", "_IntrmPrftAmt", "_SgntrTp", "_Equlstn", "_RltdPtyDtls", "_InftvTaxDtls", "_StffClntBrkdwn", "_TxOvrhd", "_OrdrWvrDtls", "_OrdrRef", "_ReqdNAVCcy", "_UnitsNb", "_PhysDlvryDtls", "_SubAcctForHldg", "_GrssAmt", "_NonStdSttlmInf", "_BestExctn", "_NetAmt", "_DealgPricDtls", "_PrtlyExctdInd", "_CumDvddInd", "_SttlmAmt", "_LateRpt", "_PrtlRedWhldgAmt", "_CstmrCndctClssfctn", "_TxChanlTp", "_HldgsRedRate", "_InftvPricDtls", "_OrdrTp", "_CshSttlmDt", "_SttlmAndCtdyDtls", "_GtgOrHldBckDtls", "_NgtdTrad", "_SttlmMtd", "_FinInstrmDtls", "_TradDtTm", "_Grp1Or2Units", "_PrtlSttlmOfCsh", "_IncmPref"]
	@property
	...
	def PrtlRedWhldgAmt(self, value):
		self._PrtlRedWhldgAmt = value if type(value) != auto else self.make_default("PrtlRedWhldgAmt")
	...
	def GtgOrHldBckDtls(self, value):
		self._GtgOrHldBckDtls = value if type(value) != auto else self.make_default("GtgOrHldBckDtls")
