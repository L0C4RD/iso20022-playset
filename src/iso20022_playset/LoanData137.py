...
class LoanData137(base_types._BaseFieldType):
	...
	__slots__ = ["_TradgVn", "_ClrSts", "_MstrAgrmt", "_DlvryByVal", "_EvtDt", "_GnlColl", "_UnqTradIdr", "_LndgFee", "_ValDt", "_LnVal", "_ExctnDtTm", "_Term", "_RbtRate", "_AsstTp", "_TermntnDt", "_CollDlvryMtd"]
	@property
	def TradgVn(self):
