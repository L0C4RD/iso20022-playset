...
class LoanData137(base_types._BaseFieldType):
	...
	__slots__ = ["_TradgVn", "_LnVal", "_MstrAgrmt", "_LndgFee", "_DlvryByVal", "_CollDlvryMtd", "_UnqTradIdr", "_ClrSts", "_EvtDt", "_Term", "_TermntnDt", "_AsstTp", "_ExctnDtTm", "_RbtRate", "_ValDt", "_GnlColl"]
	@property
	def TradgVn(self):
