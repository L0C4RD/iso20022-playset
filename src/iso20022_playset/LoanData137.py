...
class LoanData137(base_types._BaseFieldType):
	...
	__slots__ = ["_MstrAgrmt", "_EvtDt", "_Term", "_ClrSts", "_CollDlvryMtd", "_AsstTp", "_ExctnDtTm", "_UnqTradIdr", "_RbtRate", "_TradgVn", "_TermntnDt", "_DlvryByVal", "_LnVal", "_GnlColl", "_ValDt", "_LndgFee"]
	@property
	def MstrAgrmt(self):
