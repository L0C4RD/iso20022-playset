...
class LoanData137(base_types._BaseFieldType):
	...
	__slots__ = ["_ExctnDtTm", "_TradgVn", "_AsstTp", "_ClrSts", "_RbtRate", "_GnlColl", "_DlvryByVal", "_Term", "_ValDt", "_UnqTradIdr", "_LnVal", "_LndgFee", "_TermntnDt", "_CollDlvryMtd", "_MstrAgrmt", "_EvtDt"]
	@property
	def ExctnDtTm(self):
