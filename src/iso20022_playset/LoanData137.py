...
class LoanData137(base_types._BaseFieldType):

	__slots__ = ["_DlvryByVal", "_LnVal", "_EvtDt", "_TradgVn", "_ValDt", "_LndgFee", "_CollDlvryMtd", "_UnqTradIdr", "_Term", "_RbtRate", "_ClrSts", "_MstrAgrmt", "_ExctnDtTm", "_GnlColl", "_AsstTp", "_TermntnDt"]
	@property
	def DlvryByVal(self):
