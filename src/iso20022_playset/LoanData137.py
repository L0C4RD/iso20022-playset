...
class LoanData137(base_types._BaseFieldType):
	...
	__slots__ = ["_UnqTradIdr", "_RbtRate", "_TermntnDt", "_MstrAgrmt", "_LndgFee", "_Term", "_DlvryByVal", "_ValDt", "_CollDlvryMtd", "_ClrSts", "_ExctnDtTm", "_TradgVn", "_AsstTp", "_EvtDt", "_GnlColl", "_LnVal"]
	@property
	def UnqTradIdr(self):
