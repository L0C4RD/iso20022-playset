...
class Mandate23(base_types._BaseFieldType):
	...
	__slots__ = ["_RfrdDoc", "_DbtrAcct", "_Authntcn", "_CdtrAcct", "_DbtrAgt", "_Cdtr", "_UltmtCdtr", "_MndtReqId", "_ColltnAmt", "_MndtId", "_Rsn", "_Tp", "_FrstColltnAmt", "_CdtrSchmeId", "_CdtrAgt", "_MaxAmt", "_Dbtr", "_UltmtDbtr", "_TrckgInd", "_SplmtryData", "_MndtRef", "_Ocrncs", "_Adjstmnt"]
	@property
	def RfrdDoc(self):
