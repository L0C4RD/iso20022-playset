...
class Mandate23(base_types._BaseFieldType):
	...
	__slots__ = ["_Ocrncs", "_FrstColltnAmt", "_Adjstmnt", "_TrckgInd", "_MndtRef", "_UltmtCdtr", "_Rsn", "_DbtrAcct", "_Tp", "_RfrdDoc", "_MndtId", "_CdtrAgt", "_CdtrAcct", "_MaxAmt", "_Authntcn", "_Dbtr", "_CdtrSchmeId", "_Cdtr", "_UltmtDbtr", "_MndtReqId", "_ColltnAmt", "_DbtrAgt", "_SplmtryData"]
	@property
	def Ocrncs(self):
		return self._Ocrncs
