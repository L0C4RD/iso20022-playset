...
class SwitchExecution7(base_types._BaseFieldType):
	...
	__slots__ = ["_FinAdvc", "_PlcOfTrad", "_SgntrTp", "_RedLegDtls", "_SttlmMtd", "_RcvdDtTm", "_AmdmntInd", "_NgtdTrad", "_InvstmtAcctDtls", "_MstrRef", "_CshSttlmDtls", "_ReqdFutrTradDt", "_OrdrDtTm", "_FXDtls", "_CshSttlmDt", "_TxChanlTp", "_DealRef", "_LateRpt", "_CstmrCndctClssfctn", "_BestExctn", "_RltdPtyDtls", "_CxlRght", "_SttlmAmt", "_OrdrWvrDtls", "_AddtlAmt", "_SbcptLegDtls", "_OrdrRef", "_ClntRef"]
	@property
	def FinAdvc(self):
