...
class SwitchExecution7(base_types._BaseFieldType):
	...
	__slots__ = ["_CstmrCndctClssfctn", "_SttlmMtd", "_MstrRef", "_OrdrDtTm", "_TxChanlTp", "_CxlRght", "_NgtdTrad", "_AddtlAmt", "_RltdPtyDtls", "_SbcptLegDtls", "_DealRef", "_FXDtls", "_CshSttlmDt", "_LateRpt", "_BestExctn", "_PlcOfTrad", "_RedLegDtls", "_RcvdDtTm", "_AmdmntInd", "_InvstmtAcctDtls", "_ClntRef", "_CshSttlmDtls", "_OrdrRef", "_FinAdvc", "_SgntrTp", "_OrdrWvrDtls", "_SttlmAmt", "_ReqdFutrTradDt"]
	@property
