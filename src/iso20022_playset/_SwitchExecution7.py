...
class SwitchExecution7(base_types._BaseFieldType):
	...
	def CshSttlmDtls(self, value):
		self._CshSttlmDtls = value if value is not None else base_types.UninitialisedField(self, 'CshSttlmDtls', PaymentTransaction71, False)

	@CshSttlmDtls.deleter
	def CshSttlmDtls(self):
		del self._CshSttlmDtls
		self._CshSttlmDtls = base_types.UninitialisedField(self, 'CshSttlmDtls', PaymentTransaction71, False)
	...
	def FXDtls(self, value):
		self._FXDtls = value if value is not None else base_types.UninitialisedField(self, 'FXDtls', ForeignExchangeTerms33, True)

	@FXDtls.deleter
	def FXDtls(self):
		del self._FXDtls
		self._FXDtls = base_types.UninitialisedField(self, 'FXDtls', ForeignExchangeTerms33, True)
	...
	def RedLegDtls(self, value):
		self._RedLegDtls = value if value is not None else base_types.UninitialisedField(self, 'RedLegDtls', SwitchRedemptionLegExecution4, True)

	@RedLegDtls.deleter
	def RedLegDtls(self):
		del self._RedLegDtls
		self._RedLegDtls = base_types.UninitialisedField(self, 'RedLegDtls', SwitchRedemptionLegExecution4, True)
	...
	def RltdPtyDtls(self, value):
		self._RltdPtyDtls = value if value is not None else base_types.UninitialisedField(self, 'RltdPtyDtls', Intermediary39, True)

	@RltdPtyDtls.deleter
	def RltdPtyDtls(self):
		del self._RltdPtyDtls
		self._RltdPtyDtls = base_types.UninitialisedField(self, 'RltdPtyDtls', Intermediary39, True)
	...
	def SbcptLegDtls(self, value):
		self._SbcptLegDtls = value if value is not None else base_types.UninitialisedField(self, 'SbcptLegDtls', SwitchSubscriptionLegExecution4, True)

	@SbcptLegDtls.deleter
	def SbcptLegDtls(self):
		del self._SbcptLegDtls
		self._SbcptLegDtls = base_types.UninitialisedField(self, 'SbcptLegDtls', SwitchSubscriptionLegExecution4, True)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='RedLegDtls', type=SwitchRedemptionLegExecution4, min=1, max=None, mutex_group=None, array=True),
		...
		base_types.FieldEntry(name='SbcptLegDtls', type=SwitchSubscriptionLegExecution4, min=1, max=None, mutex_group=None, array=True),
