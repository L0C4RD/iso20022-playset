...
from . import TransparencyDataReport21
...
class FinancialInstrumentReportingNonEquityTransparencyDataReportV03(base_types._BaseFieldType):
	...
	def NonEqtyTrnsprncyData(self, value):
		self._NonEqtyTrnsprncyData = value if value is not None else base_types.UninitialisedField(self, 'NonEqtyTrnsprncyData', TransparencyDataReport21, True)

	@NonEqtyTrnsprncyData.deleter
	def NonEqtyTrnsprncyData(self):
		del self._NonEqtyTrnsprncyData
		self._NonEqtyTrnsprncyData = base_types.UninitialisedField(self, 'NonEqtyTrnsprncyData', TransparencyDataReport21, True)
