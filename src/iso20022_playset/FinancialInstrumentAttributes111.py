...
class FinancialInstrumentAttributes111(base_types._BaseFieldType):
	...
	__slots__ = ["_ConvsPric", "_CtrctSz", "_MtrtyDt", "_DtdDt", "_RegnForm", "_VarblRateInd", "_PmtFrqcy", "_FrstPmtDt", "_IndxRateBsis", "_VarblRateChngFrqcy", "_NxtIntrstRate", "_PlcOfListg", "_CllblInd", "_ClssfctnTp", "_NxtFctr", "_PutblDt", "_FltgRateFxgDt", "_YldToMtrtyRate", "_DnmtnCcy", "_CpnDt", "_MktOrIndctvPric", "_PutblInd", "_UndrlygFinInstrmId", "_OptnStyle", "_NxtCllblDt", "_DayCntBsis", "_PmtSts", "_XpryDt", "_PoolNb", "_StrkPric", "_SbcptPric", "_PrvsFctr", "_IsseDt", "_CpnAttchdNb", "_IntrstRate", "_ExrcPric", "_OptnTp", "_MinNmnlQty", "_CurFctr", "_FinInstrmAttrAddtlDtls"]
	@property
	def ConvsPric(self):
