...
class InvestmentAccount74(base_types._BaseFieldType):
	...
	__slots__ = ["_Nm", "_RinvstmtDtls", "_Id", "_Tp", "_InvstrPrfl", "_OwnrshTp", "_FinInstrmDtls", "_TxChanlTp", "_Lblty", "_BlckdSts", "_AcctUsgTp", "_Lang", "_IncmPref", "_ClsgDt", "_RefCcy", "_LttrInttDtls", "_Coll", "_FndFmlyNm", "_Pldgg", "_AcctSgntrDtTm", "_FsclYr", "_InvstmtAcctCtgy", "_NegInd", "_PwrOfAttnyLvlOfCtrl", "_PrcgOrdr", "_AcctSts", "_AcctSvcr", "_StmtFrqcy", "_TaxWhldgMtd", "_OpngDt", "_TaxXmptn", "_TaxRptg", "_AcmltnRghtRef", "_ThrdPtyRghts", "_AcctgSts", "_ReqrdSgntriesNb", "_Dsgnt", "_RndgDtls", "_FrgnStsCertfctn", "_StsDt"]
	@property
	def Nm(self):
		return self._Nm
