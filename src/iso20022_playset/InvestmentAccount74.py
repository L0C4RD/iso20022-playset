...
class InvestmentAccount74(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctgSts", "_Tp", "_Id", "_TaxXmptn", "_ClsgDt", "_NegInd", "_TaxWhldgMtd", "_ThrdPtyRghts", "_StsDt", "_PwrOfAttnyLvlOfCtrl", "_BlckdSts", "_Dsgnt", "_AcctUsgTp", "_FndFmlyNm", "_InvstmtAcctCtgy", "_FsclYr", "_Lblty", "_AcctSgntrDtTm", "_RefCcy", "_RndgDtls", "_InvstrPrfl", "_Nm", "_RinvstmtDtls", "_OwnrshTp", "_TaxRptg", "_LttrInttDtls", "_AcmltnRghtRef", "_FinInstrmDtls", "_AcctSts", "_IncmPref", "_TxChanlTp", "_Pldgg", "_ReqrdSgntriesNb", "_FrgnStsCertfctn", "_OpngDt", "_AcctSvcr", "_Coll", "_PrcgOrdr", "_StmtFrqcy", "_Lang"]
	@property
	def AcctgSts(self):
