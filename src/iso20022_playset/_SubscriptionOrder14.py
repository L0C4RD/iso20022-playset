...
class SubscriptionOrder14(base_types._BaseFieldType):
	...
	__slots__ = ["_FXDtls", "_NonStdSttlmInf", "_Rndg", "_CshSttlmDtls", "_NgtdTrad", "_TxOvrhd", "_CshSttlmDt", "_StffClntBrkdwn", "_SttlmAndCtdyDtls", "_LttrInttRef", "_AcmltnRghtRef", "_FinAdvc", "_Equlstn", "_SrcOfCsh", "_CstmrCndctClssfctn", "_FinInstrmDtls", "_SttlmMtd", "_OrdrTp", "_AmtOrUnits", "_ReqdSttlmCcy", "_TxChanlTp", "_SubAcctForHldg", "_PhysDlvryInd", "_RltdPtyDtls", "_IncmPref", "_ClntRef", "_PhysDlvryDtls", "_OrdrRef", "_ReqdNAVCcy", "_SgntrTp", "_OrdrWvrDtls", "_SttlmAmt"]
	@property
	def FXDtls(self):
		return self._FXDtls
