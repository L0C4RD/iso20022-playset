...
from . import TradeConfirmation5
...
class TradeConfirmation4Choice(base_types._BaseFieldType):
	...
	def Confd(self, value):
		self._Confd = value if value is not None else base_types.UninitialisedField(self, 'Confd', TradeConfirmation5, False)

	@Confd.deleter
	def Confd(self):
		del self._Confd
		self._Confd = base_types.UninitialisedField(self, 'Confd', TradeConfirmation5, False)
