...
class LiquidResources1(base_types._BaseFieldType):
	...
	__slots__ = ["_FcltiesUcmmtd", "_FinInstrmsTrsrInvstmts", "_FcltiesOthrCmmtd", "_FcltiesCmmtdRpAgrmts", "_CshDue", "_FinInstrmsDfltrsSttlmColl", "_FinInstrmsDfltrsNonCshColl", "_FcltiesCmmtdFxSwps", "_FinInstrmsCCP", "_FcltiesCmmtdLinesOfCdt"]
	@property
