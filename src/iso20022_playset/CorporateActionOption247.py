...
from .CorporateActionRate136 import CorporateActionRate136
from .YesNoIndicator import YesNoIndicator
from .DefaultProcessingOrStandingInstruction2Choice import DefaultProcessingOrStandingInstruction2Choice
from .ActiveCurrencyCode import ActiveCurrencyCode
from .BeneficiaryCertificationType15Choice import BeneficiaryCertificationType15Choice
from .CashOption113 import CashOption113
from .ProrationBelowMinimumQuantity1Choice import ProrationBelowMinimumQuantity1Choice
from .CorporateActionDate108 import CorporateActionDate108
...
from .OptionFeaturesFormat31Choice import OptionFeaturesFormat31Choice
from .CountryCode import CountryCode
from .CorporateActionPrice97 import CorporateActionPrice97
from .SecuritiesOption84 import SecuritiesOption84
from .FractionDispositionType31Choice import FractionDispositionType31Choice
from .CorporateActionOption46Choice import CorporateActionOption46Choice
from .BidRangeType2Choice import BidRangeType2Choice
from .CorporateActionNarrative64 import CorporateActionNarrative64
from .Exact3UpperCaseAlphaNumericText import Exact3UpperCaseAlphaNumericText
from .SecuritiesOption117 import SecuritiesOption117

class CorporateActionOption247(base_types._BaseFieldType):

	__slots__ = ["_OptnAvlbtySts", "_ChngAllwdInd", "_BidRgTp", "_PrdDtls", "_PricDtls", "_SctiesMvmntDtls", "_OfferTp", "_AccptncPrtyLvl", "_VldDmclCtry", "_OptnNb", "_AddtlInf", "_CcyOptn", "_NonDmclCtry", "_ApldOptnInd", "_PrratnBlwMinQty", "_DtDtls", "_CertfctnBrkdwnTp", "_FrctnDspstn", "_FinInstrmId", "_CshMvmntDtls", "_OptnTp", "_DfltPrcgOrStgInstr", "_RateAndAmtDtls", "_CertfctnBrkdwnInd", "_WdrwlAllwdInd", "_SctiesQty", "_OptnFeatrs", "_ChrgsApldInd"]
	@property
