...
class AuthorisationInitiationV04(base_types._BaseFieldType):
	...
	__slots__ = ["_Orgtr", "_AcctTo", "_ConvsDtTm", "_PrcgRslt", "_Tkn", "_Crdhldr", "_POICmpnt", "_Prgrmm", "_AddtlSvc", "_Jursdctn", "_Rcvr", "_PrtctdData", "_AcctFr", "_XchgRate", "_AdddmData", "_SttlmSvc", "_ICCRltdData", "_SctyTrlr", "_Cstmr", "_Cntxt", "_TxId", "_Accptr", "_Instlmt", "_SpclPrgrmmQlfctn", "_SplmtryData", "_Issr", "_Acqrr", "_Pyer", "_Hdr", "_AcctBal", "_TxChrtcs", "_CstmrDvc", "_FndsSvcs", "_Wllt", "_TxAmts", "_AddtlFee", "_Termnl", "_Rsk", "_Pyee", "_Sndr", "_StrngCstmrAuthntcn", "_Rcncltn", "_Card", "_AddtlData", "_DpstDtls", "_OrgnlDataElmts", "_AddtlAmt", "_Dstn", "_Vrfctn"]
	@property
	def Orgtr(self):
		return self._Orgtr
