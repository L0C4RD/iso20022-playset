...
class CorporateActionInstruction002V13(base_types._BaseFieldType):
	...
	__slots__ = ["_BnfclOwnrDtls", "_InstrCxlReqId", "_CancInstrId", "_EvtsLkg", "_SplmtryData", "_AddtlInf", "_ChngInstrInd", "_CorpActnGnlInf", "_CorpActnInstr", "_OthrDocId", "_PrtctInstr", "_AcctDtls"]
	@property
