...
from . import ISODate
from . import SecuritiesAccountReferenceDataChange2
...
class SecuritiesAccountStatement2(base_types._BaseFieldType):
	...
	@Chng.setter
	def Chng(self, value):
		self._Chng = value if value is not None else base_types.UninitialisedField(self, 'Chng', SecuritiesAccountReferenceDataChange2, True)

	@Chng.deleter
	def Chng(self):
		del self._Chng
		self._Chng = base_types.UninitialisedField(self, 'Chng', SecuritiesAccountReferenceDataChange2, True)
