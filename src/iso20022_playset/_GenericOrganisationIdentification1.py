...
from . import OrganisationIdentificationSchemeName1Choice

class GenericOrganisationIdentification1(base_types._BaseFieldType):
	...
	def SchmeNm(self, value):
		self._SchmeNm = value if value is not None else base_types.UninitialisedField(self, 'SchmeNm', OrganisationIdentificationSchemeName1Choice, False)

	@SchmeNm.deleter
	def SchmeNm(self):
		del self._SchmeNm
		self._SchmeNm = base_types.UninitialisedField(self, 'SchmeNm', OrganisationIdentificationSchemeName1Choice, False)
