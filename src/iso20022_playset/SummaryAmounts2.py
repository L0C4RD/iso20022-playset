...
class SummaryAmounts2(base_types._BaseFieldType):
	...
	__slots__ = ["_AdjstdXpsr", "_TtlPdgIncmgColl", "_TtlPdgOutgngColl", "_ThrshldTp", "_RtrXcssCshAndCollCcy", "_PrvsCollVal", "_TtlAcrdIntrstAmt", "_MinTrfAmt", "_PreHrcutCollVal", "_RndgAmt", "_ThrshldAmt", "_CollReqrd", "_PrvsXpsrVal", "_TtlFees"]
	@property
	def AdjstdXpsr(self):
