...
from .CardPaymentTransactionDetails50 import CardPaymentTransactionDetails50
from .Max140Text import Max140Text
from .Max70Text import Max70Text
from .AuthorisationResult19 import AuthorisationResult19
...
class CardPaymentTransaction143(base_types._BaseFieldType):
	...
	__slots__ = ["_FailrRsn", "_TxId", "_SaleRefId", "_CardPrgrmmPropsd", "_Rvsl", "_InitrTxId", "_CstmrCnsnt", "_AuthstnRslt", "_TxSucss", "_IntrchngData", "_RcptTxId", "_TxDtls", "_OrgnlTx", "_CardPrgrmmApld", "_MrchntCtgyCd", "_RcncltnId", "_AddtlTxData"]
	@property
	def FailrRsn(self):
