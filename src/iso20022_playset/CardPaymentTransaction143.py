...
class CardPaymentTransaction143(base_types._BaseFieldType):
	...
	__slots__ = ["_CardPrgrmmPropsd", "_IntrchngData", "_CardPrgrmmApld", "_MrchntCtgyCd", "_AuthstnRslt", "_TxId", "_SaleRefId", "_TxDtls", "_InitrTxId", "_FailrRsn", "_Rvsl", "_RcptTxId", "_RcncltnId", "_AddtlTxData", "_TxSucss", "_OrgnlTx", "_CstmrCnsnt"]
	@property
