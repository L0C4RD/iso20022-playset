...
class CardPaymentTransaction143(base_types._BaseFieldType):
	...
	__slots__ = ["_MrchntCtgyCd", "_CstmrCnsnt", "_OrgnlTx", "_CardPrgrmmPropsd", "_TxSucss", "_TxId", "_AddtlTxData", "_InitrTxId", "_TxDtls", "_FailrRsn", "_AuthstnRslt", "_IntrchngData", "_Rvsl", "_SaleRefId", "_RcptTxId", "_RcncltnId", "_CardPrgrmmApld"]
	@property
