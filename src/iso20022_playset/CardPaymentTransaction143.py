...
class CardPaymentTransaction143(base_types._BaseFieldType):
	...
	__slots__ = ["_MrchntCtgyCd", "_InitrTxId", "_OrgnlTx", "_TxDtls", "_IntrchngData", "_AddtlTxData", "_CardPrgrmmPropsd", "_Rvsl", "_CardPrgrmmApld", "_SaleRefId", "_RcncltnId", "_RcptTxId", "_FailrRsn", "_AuthstnRslt", "_TxId", "_TxSucss", "_CstmrCnsnt"]
	@property
