...
class CardPaymentTransaction143(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlTxData", "_Rvsl", "_RcptTxId", "_AuthstnRslt", "_CardPrgrmmApld", "_CardPrgrmmPropsd", "_InitrTxId", "_RcncltnId", "_CstmrCnsnt", "_OrgnlTx", "_SaleRefId", "_TxId", "_IntrchngData", "_FailrRsn", "_MrchntCtgyCd", "_TxDtls", "_TxSucss"]
	@property
