...
class CardPaymentTransaction143(base_types._BaseFieldType):
	...
	__slots__ = ["_TxDtls", "_MrchntCtgyCd", "_IntrchngData", "_RcncltnId", "_CardPrgrmmApld", "_InitrTxId", "_Rvsl", "_AuthstnRslt", "_TxSucss", "_FailrRsn", "_CardPrgrmmPropsd", "_RcptTxId", "_TxId", "_CstmrCnsnt", "_SaleRefId", "_OrgnlTx", "_AddtlTxData"]
	@property
	def TxDtls(self):
		return self._TxDtls
