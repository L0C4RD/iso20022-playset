...
from . import FIToFICustomerDirectDebitV11
...
class PACS_003_001_11():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def FIToFICstmrDrctDbt(self, value):
			self._FIToFICstmrDrctDbt = value if value is not None else base_types.UninitialisedField(self, 'FIToFICstmrDrctDbt', FIToFICustomerDirectDebitV11, False)

		@FIToFICstmrDrctDbt.deleter
		def FIToFICstmrDrctDbt(self):
			del self._FIToFICstmrDrctDbt
			self._FIToFICstmrDrctDbt = base_types.UninitialisedField(self, 'FIToFICstmrDrctDbt', FIToFICustomerDirectDebitV11, False)
