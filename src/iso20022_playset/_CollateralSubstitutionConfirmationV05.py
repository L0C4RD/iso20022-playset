...
from . import CollateralConfirmation1
...
class CollateralSubstitutionConfirmationV05(base_types._BaseFieldType):
	...
	def SbstitnConf(self, value):
		self._SbstitnConf = value if value is not None else base_types.UninitialisedField(self, 'SbstitnConf', CollateralConfirmation1, False)

	@SbstitnConf.deleter
	def SbstitnConf(self):
		del self._SbstitnConf
		self._SbstitnConf = base_types.UninitialisedField(self, 'SbstitnConf', CollateralConfirmation1, False)
