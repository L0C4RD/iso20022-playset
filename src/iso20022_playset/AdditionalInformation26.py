...
class AdditionalInformation26(base_types._BaseFieldType):
	...
	__slots__ = ["_BlckChainAdrOrWllt", "_FinInstrmId", "_Invstr", "_CutOffDt", "_XpryDt", "_FctvDt", "_SfkpgAcct", "_Qty", "_DlvrgPty1", "_ClssfctnTp", "_AcctOwnrTxId", "_TxSbjtToBuyIn", "_RcvgPty1"]
	@property
