...
from . import FundSettlementParameters15
from . import ISODate
...
class DeliverInformation20(base_types._BaseFieldType):
	...
	__slots__ = ["_BnfcryCertfctnCmpltn", "_ClntRef", "_DmtrlsdInd", "_FXDtls", "_FctvSttlmDt", "_Fees", "_IncmPref", "_IndvTax", "_IntrmyInf", "_NetAmt", "_PhysTrf", "_PhysTrfDtls", "_ReqdSttlmDt", "_ReqdTradDt", "_SctiesForm", "_StmpDty", "_SttlmAmt", "_SttlmPtiesDtls", "_Trfr", "_TrfrRegdAcct"]
	@property
	...
	def SttlmPtiesDtls(self, value):
		self._SttlmPtiesDtls = value if value is not None else base_types.UninitialisedField(self, 'SttlmPtiesDtls', FundSettlementParameters15, False)

	@SttlmPtiesDtls.deleter
	def SttlmPtiesDtls(self):
		del self._SttlmPtiesDtls
		self._SttlmPtiesDtls = base_types.UninitialisedField(self, 'SttlmPtiesDtls', FundSettlementParameters15, False)
	...
	def TrfrRegdAcct(self, value):
		self._TrfrRegdAcct = value if value is not None else base_types.UninitialisedField(self, 'TrfrRegdAcct', Account31, False)

	@TrfrRegdAcct.deleter
	def TrfrRegdAcct(self):
		del self._TrfrRegdAcct
		self._TrfrRegdAcct = base_types.UninitialisedField(self, 'TrfrRegdAcct', Account31, False)
