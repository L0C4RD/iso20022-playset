...
from . import CollateralManagementCancellationStatusV05
...
class COLR_006_001_05():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def CollMgmtCxlSts(self, value):
			self._CollMgmtCxlSts = value if value is not None else base_types.UninitialisedField(self, 'CollMgmtCxlSts', CollateralManagementCancellationStatusV05, False)

		@CollMgmtCxlSts.deleter
		def CollMgmtCxlSts(self):
			del self._CollMgmtCxlSts
			self._CollMgmtCxlSts = base_types.UninitialisedField(self, 'CollMgmtCxlSts', CollateralManagementCancellationStatusV05, False)
