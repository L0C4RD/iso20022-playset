...
class CorporateActionMovementPreliminaryAdviceCancellationAdviceV13(base_types._BaseFieldType):
	...
	__slots__ = ["_RsellngAgt", "_PngAgt", "_InfAgt", "_CorpActnGnlInf", "_DrpAgt", "_MvmntPrlimryAdvcId", "_PhysSctiesAgt", "_SlctnAgt", "_Regar", "_SplmtryData", "_CorpActnDtls", "_SubPngAgt", "_AcctDtls", "_IssrAgt"]
	@property
	def RsellngAgt(self):
