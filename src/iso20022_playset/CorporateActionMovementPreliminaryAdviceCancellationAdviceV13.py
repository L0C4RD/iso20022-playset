...
class CorporateActionMovementPreliminaryAdviceCancellationAdviceV13(base_types._BaseFieldType):
	...
	__slots__ = ["_PngAgt", "_AcctDtls", "_CorpActnDtls", "_SubPngAgt", "_Regar", "_PhysSctiesAgt", "_MvmntPrlimryAdvcId", "_IssrAgt", "_InfAgt", "_SplmtryData", "_DrpAgt", "_RsellngAgt", "_SlctnAgt", "_CorpActnGnlInf"]
	@property
	def PngAgt(self):
		return self._PngAgt
