...
class DeviceRequest8(base_types._BaseFieldType):
	...
	__slots__ = ["_InptReq", "_Envt", "_SplmtryData", "_TrnsmssnReq", "_InitlstnCardRdrReq", "_Cntxt", "_PwrOffCardRdrReq", "_DispReq", "_ScrInptReq", "_CardRdrAPDUReq", "_PrtReq", "_PlayRsrcReq", "_InptNtfctn", "_SvcCntt"]
	@property
	def InptReq(self):
