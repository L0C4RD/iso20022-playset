...
class DeviceRequest8(base_types._BaseFieldType):
	...
	__slots__ = ["_InptReq", "_DispReq", "_SplmtryData", "_PrtReq", "_InitlstnCardRdrReq", "_PlayRsrcReq", "_SvcCntt", "_Envt", "_ScrInptReq", "_Cntxt", "_CardRdrAPDUReq", "_PwrOffCardRdrReq", "_TrnsmssnReq", "_InptNtfctn"]
	@property
	def InptReq(self):
