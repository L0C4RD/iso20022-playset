...
from .PendingSettlement2Code import PendingSettlement2Code
from .SuspendedStatusReason1Code import SuspendedStatusReason1Code
from .UnmatchedStatusReason1Code import UnmatchedStatusReason1Code
from .PendingFailingSettlement1Code import PendingFailingSettlement1Code
from .CancelledStatusReason1Code import CancelledStatusReason1Code
from .ProprietaryStatusJustification2 import ProprietaryStatusJustification2

class PaymentStatusReason1Choice(base_types._BaseFieldType):

	__slots__ = ["_Prtry", "_PdgFlngSttlm", "_Sspd", "_PrtryRjctn", "_Umtchd", "_PdgSttlm", "_Canc"]
	@property
	def Prtry(self):
		return self._Prtry
