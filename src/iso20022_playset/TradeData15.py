...
class TradeData15(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmSsnIdr", "_SpltTradInd", "_CurSts", "_MtchgSysUnqRef", "_OrgtrRef", "_MtchgSysMtchgRef", "_StsOrgtr", "_CurStsDtTm", "_PrvsStsDtTm", "_MsgId", "_PrvsStsSubTp", "_PrvsSts", "_CurStsSubTp", "_MtchgSysMtchdSdRef", "_PdctTp"]
	@property
