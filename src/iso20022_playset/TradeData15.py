...
class TradeData15(base_types._BaseFieldType):
	...
	__slots__ = ["_PrvsSts", "_MtchgSysUnqRef", "_MsgId", "_CurStsDtTm", "_PrvsStsSubTp", "_SttlmSsnIdr", "_StsOrgtr", "_PrvsStsDtTm", "_PdctTp", "_SpltTradInd", "_CurStsSubTp", "_CurSts", "_OrgtrRef", "_MtchgSysMtchdSdRef", "_MtchgSysMtchgRef"]
	@property
	def PrvsSts(self):
