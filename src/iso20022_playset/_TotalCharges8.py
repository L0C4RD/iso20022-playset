...
class TotalCharges8(base_types._BaseFieldType):
	...
	def NbOfChrgsBrkdwnItms(self, value):
		self._NbOfChrgsBrkdwnItms = value if value is not None else base_types.UninitialisedField(self, 'NbOfChrgsBrkdwnItms', Max15NumericText, False)

	@NbOfChrgsBrkdwnItms.deleter
	def NbOfChrgsBrkdwnItms(self):
		del self._NbOfChrgsBrkdwnItms
		self._NbOfChrgsBrkdwnItms = base_types.UninitialisedField(self, 'NbOfChrgsBrkdwnItms', Max15NumericText, False)
