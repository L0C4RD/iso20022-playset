...
class CardManagementResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlDataElmts", "_Rsk", "_AddtlSvc", "_ICCRltdData", "_PrcgRslt", "_StrngCstmrAuthntcn", "_Dstn", "_AddtlData", "_Termnl", "_Acqrr", "_Hdr", "_SctyTrlr", "_AddtlAmt", "_AddtlFee", "_Issr", "_Accptr", "_Orgtr", "_Sndr", "_TxChrtcs", "_Prgrmm", "_SttlmSvc", "_Wllt", "_TxId", "_Rcvr", "_Vrfctn", "_ConvsDtTm", "_Rcncltn", "_Jursdctn", "_Tkn", "_CstmrDvc", "_Cntxt", "_Crdhldr", "_PrtctdData", "_TxAmts", "_Card", "_SplmtryData"]
	@property
