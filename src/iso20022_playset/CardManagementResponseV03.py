...
class CardManagementResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_PrcgRslt", "_CstmrDvc", "_TxAmts", "_PrtctdData", "_TxChrtcs", "_AddtlSvc", "_Crdhldr", "_Vrfctn", "_ConvsDtTm", "_Termnl", "_ICCRltdData", "_Rcncltn", "_AddtlData", "_Accptr", "_SttlmSvc", "_Prgrmm", "_Issr", "_OrgnlDataElmts", "_Wllt", "_Acqrr", "_Hdr", "_Dstn", "_Rcvr", "_Cntxt", "_Card", "_Jursdctn", "_Sndr", "_Rsk", "_AddtlFee", "_TxId", "_SplmtryData", "_Tkn", "_Orgtr", "_AddtlAmt", "_SctyTrlr", "_StrngCstmrAuthntcn"]
	@property
	def PrcgRslt(self):
