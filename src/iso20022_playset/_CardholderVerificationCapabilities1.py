...
from . import CardholderVerificationCapability5Code
...
class CardholderVerificationCapabilities1(base_types._BaseFieldType):
	...
	def Cpblty(self, value):
		self._Cpblty = value if value is not None else base_types.UninitialisedField(self, 'Cpblty', CardholderVerificationCapability5Code, False)

	@Cpblty.deleter
	def Cpblty(self):
		del self._Cpblty
		self._Cpblty = base_types.UninitialisedField(self, 'Cpblty', CardholderVerificationCapability5Code, False)
