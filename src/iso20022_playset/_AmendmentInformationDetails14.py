...
class AmendmentInformationDetails14(base_types._BaseFieldType):
	...
	def OrgnlCdtrAgt(self, value):
		self._OrgnlCdtrAgt = value if value is not None else base_types.UninitialisedField(self, 'OrgnlCdtrAgt', BranchAndFinancialInstitutionIdentification6, False)

	@OrgnlCdtrAgt.deleter
	def OrgnlCdtrAgt(self):
		del self._OrgnlCdtrAgt
		self._OrgnlCdtrAgt = base_types.UninitialisedField(self, 'OrgnlCdtrAgt', BranchAndFinancialInstitutionIdentification6, False)
	...
	def OrgnlCdtrSchmeId(self, value):
		self._OrgnlCdtrSchmeId = value if value is not None else base_types.UninitialisedField(self, 'OrgnlCdtrSchmeId', PartyIdentification135, False)

	@OrgnlCdtrSchmeId.deleter
	def OrgnlCdtrSchmeId(self):
		del self._OrgnlCdtrSchmeId
		self._OrgnlCdtrSchmeId = base_types.UninitialisedField(self, 'OrgnlCdtrSchmeId', PartyIdentification135, False)
	...
	def OrgnlDbtr(self, value):
		self._OrgnlDbtr = value if value is not None else base_types.UninitialisedField(self, 'OrgnlDbtr', PartyIdentification135, False)

	@OrgnlDbtr.deleter
	def OrgnlDbtr(self):
		del self._OrgnlDbtr
		self._OrgnlDbtr = base_types.UninitialisedField(self, 'OrgnlDbtr', PartyIdentification135, False)
	...
	def OrgnlDbtrAgt(self, value):
		self._OrgnlDbtrAgt = value if value is not None else base_types.UninitialisedField(self, 'OrgnlDbtrAgt', BranchAndFinancialInstitutionIdentification6, False)

	@OrgnlDbtrAgt.deleter
	def OrgnlDbtrAgt(self):
		del self._OrgnlDbtrAgt
		self._OrgnlDbtrAgt = base_types.UninitialisedField(self, 'OrgnlDbtrAgt', BranchAndFinancialInstitutionIdentification6, False)
