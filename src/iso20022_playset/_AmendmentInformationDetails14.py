...
class AmendmentInformationDetails14(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlFrqcy", "_OrgnlCdtrSchmeId", "_OrgnlDbtrAcct", "_OrgnlRsn", "_OrgnlDbtrAgt", "_OrgnlMndtId", "_OrgnlCdtrAgtAcct", "_OrgnlTrckgDays", "_OrgnlCdtrAgt", "_OrgnlFnlColltnDt", "_OrgnlDbtrAgtAcct", "_OrgnlDbtr"]
	@property
	def OrgnlFrqcy(self):
