...
class StatusReportContent15(base_types._BaseFieldType):
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='DataSetReqrd', type=DataSetRequest7, min=0, max=None, mutex_group=None, array=True),
		base_types.FieldEntry(name='Errs', type=Max140Text, min=0, max=None, mutex_group=None, array=True),
		base_types.FieldEntry(name='Evt', type=TMSEvent13, min=0, max=None, mutex_group=None, array=True),
		base_types.FieldEntry(name='POICmpnt', type=PointOfInteractionComponent18, min=0, max=None, mutex_group=None, array=True),
		base_types.FieldEntry(name='POICpblties', type=PointOfInteractionCapabilities11, min=0, max=1, mutex_group=None, array=False),
