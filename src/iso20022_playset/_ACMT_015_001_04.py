...
from . import AccountExcludedMandateMaintenanceRequestV04
...
class ACMT_015_001_04():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def AcctExcldMndtMntncReq(self, value):
			self._AcctExcldMndtMntncReq = value if value is not None else base_types.UninitialisedField(self, 'AcctExcldMndtMntncReq', AccountExcludedMandateMaintenanceRequestV04, False)

		@AcctExcldMndtMntncReq.deleter
		def AcctExcldMndtMntncReq(self):
			del self._AcctExcldMndtMntncReq
			self._AcctExcldMndtMntncReq = base_types.UninitialisedField(self, 'AcctExcldMndtMntncReq', AccountExcludedMandateMaintenanceRequestV04, False)
