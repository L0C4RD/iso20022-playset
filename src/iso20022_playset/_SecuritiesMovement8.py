...
class SecuritiesMovement8(base_types._BaseFieldType):
	...
	__slots__ = ["_BlckChainAdrOrWllt", "_SctiesQty", "_SctiesMvmntsApprvd", "_SfkpgAcct", "_ClntSctiesMvmntId", "_MrgndVal", "_MvmntSts", "_TrptyAgtSvcPrvdrSctiesMvmntId", "_CollMvmnt", "_SctiesMvmntTp", "_FinInstrmId", "_PosTp"]
	@property
