...
class SecuritiesMovement8(base_types._BaseFieldType):
	...
	__slots__ = ["_MvmntSts", "_SctiesQty", "_ClntSctiesMvmntId", "_SfkpgAcct", "_CollMvmnt", "_SctiesMvmntTp", "_SctiesMvmntsApprvd", "_MrgndVal", "_PosTp", "_BlckChainAdrOrWllt", "_FinInstrmId", "_TrptyAgtSvcPrvdrSctiesMvmntId"]
	@property
	def MvmntSts(self):
