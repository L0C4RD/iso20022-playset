...
from . import CustodyStatementOfHoldings2
...
class CustodyStatementOfHoldingsCancellationV02(base_types._BaseFieldType):
	...
	def StmtToBeCanc(self, value):
		self._StmtToBeCanc = value if value is not None else base_types.UninitialisedField(self, 'StmtToBeCanc', CustodyStatementOfHoldings2, False)

	@StmtToBeCanc.deleter
	def StmtToBeCanc(self):
		del self._StmtToBeCanc
		self._StmtToBeCanc = base_types.UninitialisedField(self, 'StmtToBeCanc', CustodyStatementOfHoldings2, False)
