...
from . import SubscriptionMultipleExecution7

class SubscriptionOrderConfirmationV06(base_types._BaseFieldType):
	...
	def MltplExctnDtls(self, value):
		self._MltplExctnDtls = value if value is not None else base_types.UninitialisedField(self, 'MltplExctnDtls', SubscriptionMultipleExecution7, False)

	@MltplExctnDtls.deleter
	def MltplExctnDtls(self):
		del self._MltplExctnDtls
		self._MltplExctnDtls = base_types.UninitialisedField(self, 'MltplExctnDtls', SubscriptionMultipleExecution7, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='MltplExctnDtls', type=SubscriptionMultipleExecution7, min=1, max=1, mutex_group=None, array=False),
