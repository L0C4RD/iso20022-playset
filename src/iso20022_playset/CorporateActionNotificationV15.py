...
class CorporateActionNotificationV15(base_types._BaseFieldType):
	...
	__slots__ = ["_TrfAgt", "_NtfctnGnlInf", "_EvtsLkg", "_SubPngAgt", "_Pgntn", "_Regar", "_AddtlInf", "_CorpActnOptnDtls", "_RsellngAgt", "_CorpActnGnlInf", "_InstrId", "_IntrmdtScty", "_Offerr", "_InfAgt", "_PngAgt", "_SplmtryData", "_OthrDocId", "_PrvsNtfctnId", "_CorpActnDtls", "_PhysSctiesAgt", "_IssrAgt", "_DrpAgt", "_SlctnAgt", "_Issr", "_AcctDtls"]
	@property
	def TrfAgt(self):
		return self._TrfAgt
