...
class CorporateActionNotificationV15(base_types._BaseFieldType):
	...
	__slots__ = ["_InstrId", "_Issr", "_TrfAgt", "_Pgntn", "_IntrmdtScty", "_OthrDocId", "_PrvsNtfctnId", "_SlctnAgt", "_Regar", "_RsellngAgt", "_NtfctnGnlInf", "_EvtsLkg", "_DrpAgt", "_Offerr", "_CorpActnGnlInf", "_SubPngAgt", "_AcctDtls", "_CorpActnOptnDtls", "_IssrAgt", "_SplmtryData", "_InfAgt", "_PhysSctiesAgt", "_PngAgt", "_CorpActnDtls", "_AddtlInf"]
	@property
	def InstrId(self):
