...
class FinancialInstrument96(base_types._BaseFieldType):
	...
	__slots__ = ["_DvddFrqcy", "_Authrsd", "_PhysRegdScties", "_SspnsnStartDt", "_DmtrlsdBrScties", "_SwtchFee", "_MtrtyDt", "_TermntnDt", "_SspnsnEndDt", "_TaxEffcntPdctElgbl", "_MgmtFeeSrc", "_PrfrmncFee", "_PhysBrScties", "_InitlOfferEndDt", "_AddtlInf", "_MayBeTermntdEarly", "_DstrbtnPlcy", "_EUSvgsDrctv", "_FrntEndLd", "_DvddPlcy", "_DmtrlsdRegdScties", "_RinvstmtFrqcy", "_FndEndDt", "_RDRCmplnt", "_LnchDt", "_Equlstn", "_ClsdEndFnd", "_BckEndLd"]
	@property
	def DvddFrqcy(self):
