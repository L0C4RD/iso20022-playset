...
class FinancialInstrument96(base_types._BaseFieldType):
	...
	__slots__ = ["_Equlstn", "_DmtrlsdBrScties", "_DvddPlcy", "_ClsdEndFnd", "_MayBeTermntdEarly", "_DmtrlsdRegdScties", "_Authrsd", "_MgmtFeeSrc", "_FndEndDt", "_DstrbtnPlcy", "_TaxEffcntPdctElgbl", "_PhysRegdScties", "_FrntEndLd", "_RDRCmplnt", "_DvddFrqcy", "_SwtchFee", "_MtrtyDt", "_SspnsnStartDt", "_BckEndLd", "_RinvstmtFrqcy", "_SspnsnEndDt", "_InitlOfferEndDt", "_AddtlInf", "_TermntnDt", "_EUSvgsDrctv", "_PrfrmncFee", "_PhysBrScties", "_LnchDt"]
	@property
	def Equlstn(self):
