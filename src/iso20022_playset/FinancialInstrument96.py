...
class FinancialInstrument96(base_types._BaseFieldType):
	...
	__slots__ = ["_MtrtyDt", "_DmtrlsdRegdScties", "_PrfrmncFee", "_FndEndDt", "_FrntEndLd", "_DstrbtnPlcy", "_AddtlInf", "_PhysBrScties", "_MayBeTermntdEarly", "_MgmtFeeSrc", "_EUSvgsDrctv", "_ClsdEndFnd", "_Authrsd", "_SwtchFee", "_LnchDt", "_InitlOfferEndDt", "_DvddFrqcy", "_SspnsnEndDt", "_DvddPlcy", "_SspnsnStartDt", "_TaxEffcntPdctElgbl", "_RinvstmtFrqcy", "_BckEndLd", "_TermntnDt", "_DmtrlsdBrScties", "_Equlstn", "_RDRCmplnt", "_PhysRegdScties"]
	@property
	def MtrtyDt(self):
