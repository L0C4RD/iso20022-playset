...
class FinancialInstrument96(base_types._BaseFieldType):
	...
	__slots__ = ["_BckEndLd", "_TaxEffcntPdctElgbl", "_InitlOfferEndDt", "_EUSvgsDrctv", "_SspnsnEndDt", "_FndEndDt", "_TermntnDt", "_DmtrlsdBrScties", "_AddtlInf", "_SspnsnStartDt", "_DstrbtnPlcy", "_LnchDt", "_MayBeTermntdEarly", "_MgmtFeeSrc", "_DmtrlsdRegdScties", "_DvddFrqcy", "_MtrtyDt", "_ClsdEndFnd", "_DvddPlcy", "_RDRCmplnt", "_Equlstn", "_SwtchFee", "_FrntEndLd", "_Authrsd", "_PhysBrScties", "_RinvstmtFrqcy", "_PrfrmncFee", "_PhysRegdScties"]
	@property
	def BckEndLd(self):
