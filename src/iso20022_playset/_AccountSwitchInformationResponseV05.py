...
from . import PaymentInstruction43
from . import SupplementaryData1

class AccountSwitchInformationResponseV05(base_types._BaseFieldType):

	__slots__ = ["_AcctSwtchDtls", "_DrctDbtInstr", "_MsgId", "_NewAcct", "_OdAcct", "_PmtInstr", "_SplmtryData"]
	@property
	...
	def PmtInstr(self, value):
		self._PmtInstr = value if value is not None else base_types.UninitialisedField(self, 'PmtInstr', PaymentInstruction43, True)

	@PmtInstr.deleter
	def PmtInstr(self):
		del self._PmtInstr
		self._PmtInstr = base_types.UninitialisedField(self, 'PmtInstr', PaymentInstruction43, True)
