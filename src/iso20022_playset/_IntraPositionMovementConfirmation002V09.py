...
class IntraPositionMovementConfirmation002V09(base_types._BaseFieldType):
	...
	def AddtlParams(self, value):
		self._AddtlParams = value if value is not None else base_types.UninitialisedField(self, 'AddtlParams', AdditionalParameters34, False)

	@AddtlParams.deleter
	def AddtlParams(self):
		del self._AddtlParams
		self._AddtlParams = base_types.UninitialisedField(self, 'AddtlParams', AdditionalParameters34, False)
	...
	def IntraPosDtls(self, value):
		self._IntraPosDtls = value if value is not None else base_types.UninitialisedField(self, 'IntraPosDtls', IntraPositionDetails61, False)

	@IntraPosDtls.deleter
	def IntraPosDtls(self):
		del self._IntraPosDtls
		self._IntraPosDtls = base_types.UninitialisedField(self, 'IntraPosDtls', IntraPositionDetails61, False)
