...
class CorporateActionDate108(base_types._BaseFieldType):
	...
	__slots__ = ["_PrtctDdln", "_EndOfSctiesBlckgPrd", "_BrrwrStockLndgDdln", "_XpryDt", "_StockLndgDdln", "_SbcptCostDbtDt", "_CoverXprtnDdln", "_RspnDdln", "_DcmnttnDdln", "_EarlyRspnDdln", "_MktDdln", "_DpstryCoverXprtnDt"]
	@property
	def PrtctDdln(self):
