...
class CorporateActionDate108(base_types._BaseFieldType):
	...
	__slots__ = ["_EndOfSctiesBlckgPrd", "_SbcptCostDbtDt", "_XpryDt", "_MktDdln", "_StockLndgDdln", "_BrrwrStockLndgDdln", "_PrtctDdln", "_RspnDdln", "_CoverXprtnDdln", "_DcmnttnDdln", "_DpstryCoverXprtnDt", "_EarlyRspnDdln"]
	@property
