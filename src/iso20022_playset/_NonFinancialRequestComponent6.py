...
from . import NonFinancialRequestContentComponent6
from . import PaymentContext30
from . import SupplementaryData1

class NonFinancialRequestComponent6(base_types._BaseFieldType):
	...
	def NonFinReqCntt(self, value):
		self._NonFinReqCntt = value if value is not None else base_types.UninitialisedField(self, 'NonFinReqCntt', NonFinancialRequestContentComponent6, False)

	@NonFinReqCntt.deleter
	def NonFinReqCntt(self):
		del self._NonFinReqCntt
		self._NonFinReqCntt = base_types.UninitialisedField(self, 'NonFinReqCntt', NonFinancialRequestContentComponent6, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='NonFinReqCntt', type=NonFinancialRequestContentComponent6, min=1, max=1, mutex_group=None, array=False),
