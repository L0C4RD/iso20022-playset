...
from . import AcceptorAuthorisationResponse15
...
class AcceptorAuthorisationResponseV15(base_types._BaseFieldType):
	...
	def AuthstnRspn(self, value):
		self._AuthstnRspn = value if value is not None else base_types.UninitialisedField(self, 'AuthstnRspn', AcceptorAuthorisationResponse15, False)

	@AuthstnRspn.deleter
	def AuthstnRspn(self):
		del self._AuthstnRspn
		self._AuthstnRspn = base_types.UninitialisedField(self, 'AuthstnRspn', AcceptorAuthorisationResponse15, False)
