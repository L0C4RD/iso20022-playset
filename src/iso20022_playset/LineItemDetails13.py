...
class LineItemDetails13(base_types._BaseFieldType):
	...
	__slots__ = ["_QtyTlrnce", "_ShipmntSchdl", "_PdctNm", "_PdctCtgy", "_Adjstmnt", "_PdctChrtcs", "_LineItmId", "_Qty", "_RtgSummry", "_Incotrms", "_PricTlrnce", "_PdctOrgn", "_UnitPric", "_FrghtChrgs", "_PdctIdr", "_TtlAmt", "_Tax"]
	@property
	def QtyTlrnce(self):
