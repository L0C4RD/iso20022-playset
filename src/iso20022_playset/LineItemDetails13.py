...
class LineItemDetails13(base_types._BaseFieldType):
	...
	__slots__ = ["_FrghtChrgs", "_Tax", "_UnitPric", "_Adjstmnt", "_QtyTlrnce", "_PdctNm", "_LineItmId", "_PricTlrnce", "_PdctCtgy", "_Incotrms", "_PdctChrtcs", "_TtlAmt", "_RtgSummry", "_PdctIdr", "_Qty", "_ShipmntSchdl", "_PdctOrgn"]
	@property
	def FrghtChrgs(self):
