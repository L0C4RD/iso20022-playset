...
class LineItemDetails13(base_types._BaseFieldType):
	...
	__slots__ = ["_Qty", "_PdctChrtcs", "_PdctOrgn", "_PdctNm", "_ShipmntSchdl", "_UnitPric", "_Incotrms", "_FrghtChrgs", "_PdctIdr", "_QtyTlrnce", "_LineItmId", "_PdctCtgy", "_PricTlrnce", "_RtgSummry", "_Tax", "_TtlAmt", "_Adjstmnt"]
	@property
	def Qty(self):
		return self._Qty
