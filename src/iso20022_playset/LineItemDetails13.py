...
class LineItemDetails13(base_types._BaseFieldType):
	...
	__slots__ = ["_QtyTlrnce", "_PdctNm", "_Adjstmnt", "_Incotrms", "_RtgSummry", "_PdctChrtcs", "_PricTlrnce", "_PdctIdr", "_PdctOrgn", "_Qty", "_TtlAmt", "_LineItmId", "_ShipmntSchdl", "_FrghtChrgs", "_Tax", "_UnitPric", "_PdctCtgy"]
	@property
	def QtyTlrnce(self):
