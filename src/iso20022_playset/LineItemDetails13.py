...
class LineItemDetails13(base_types._BaseFieldType):
	...
	__slots__ = ["_RtgSummry", "_PricTlrnce", "_Adjstmnt", "_PdctOrgn", "_QtyTlrnce", "_TtlAmt", "_PdctNm", "_PdctChrtcs", "_Qty", "_ShipmntSchdl", "_PdctCtgy", "_Tax", "_PdctIdr", "_FrghtChrgs", "_LineItmId", "_UnitPric", "_Incotrms"]
	@property
	def RtgSummry(self):
