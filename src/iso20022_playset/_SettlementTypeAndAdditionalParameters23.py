...
class SettlementTypeAndAdditionalParameters23(base_types._BaseFieldType):
	...
	__slots__ = ["_ClntCollInstrId", "_ClntTrptyCollTxId", "_NonceId", "_CmonId", "_TrptyAgtSvcPrvdrCollInstrId", "_Pmt", "_SctiesMvmntTp", "_CorpActnEvtId", "_RcncltnInd", "_TrptyAgtSvcPrvdrCollTxId"]
	@property
