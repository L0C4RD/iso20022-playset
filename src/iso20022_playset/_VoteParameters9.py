...
class VoteParameters9(base_types._BaseFieldType):
	...
	__slots__ = ["_EarlyIncntivPrm", "_VoteMthds", "_VoteWthPrmDdln", "_EarlyVoteWthPrmDdln", "_VtngBlltElctrncAdr", "_RvcbltyDdln", "_BnfclOwnrDsclsr", "_PrtlVoteAllwd", "_VoteWthPrmMktDdln", "_VoteDdln", "_RvcbltyMktDdln", "_VoteMktDdln", "_VtngBlltReqAdr", "_SpltVoteAllwd", "_AddtlVtngRqrmnts", "_SctiesQtyReqrdToVote", "_IncntivPrm", "_PrvsInstrInvldtyInd"]
	@property
