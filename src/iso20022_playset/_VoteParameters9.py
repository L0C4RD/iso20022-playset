...
class VoteParameters9(base_types._BaseFieldType):
	...
	__slots__ = ["_VtngBlltReqAdr", "_PrtlVoteAllwd", "_VoteMktDdln", "_EarlyIncntivPrm", "_RvcbltyDdln", "_VtngBlltElctrncAdr", "_PrvsInstrInvldtyInd", "_AddtlVtngRqrmnts", "_VoteMthds", "_EarlyVoteWthPrmDdln", "_RvcbltyMktDdln", "_SpltVoteAllwd", "_BnfclOwnrDsclsr", "_IncntivPrm", "_VoteWthPrmDdln", "_VoteDdln", "_VoteWthPrmMktDdln", "_SctiesQtyReqrdToVote"]
	@property
