...
class InsuranceDataSet1(base_types._BaseFieldType):
	...
	__slots__ = ["_InsrncDocId", "_PlcOfIsse", "_InsrdGoodsDesc", "_DataSetId", "_ClmsPyblIn", "_FctvDt", "_ClmsPyblAt", "_InsrncClauses", "_Issr", "_InsrdAmt", "_Assrd", "_IsseDt", "_Trnsprt", "_InsrncConds"]
	@property
