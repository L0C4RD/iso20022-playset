...
class InsuranceDataSet1(base_types._BaseFieldType):
	...
	__slots__ = ["_IsseDt", "_InsrncClauses", "_Issr", "_Assrd", "_PlcOfIsse", "_ClmsPyblIn", "_DataSetId", "_FctvDt", "_Trnsprt", "_InsrncConds", "_ClmsPyblAt", "_InsrdAmt", "_InsrdGoodsDesc", "_InsrncDocId"]
	@property
	def IsseDt(self):
		return self._IsseDt
