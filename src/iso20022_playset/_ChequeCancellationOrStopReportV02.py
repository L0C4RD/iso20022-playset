...
from . import Cheque18
from . import GroupHeader103
from . import SupplementaryData1

class ChequeCancellationOrStopReportV02(base_types._BaseFieldType):
	...
	@Chq.setter
	def Chq(self, value):
		self._Chq = value if value is not None else base_types.UninitialisedField(self, 'Chq', Cheque18, True)

	@Chq.deleter
	def Chq(self):
		del self._Chq
		self._Chq = base_types.UninitialisedField(self, 'Chq', Cheque18, True)
	...
	_field_defs = frozenset((
		base_types.FieldEntry(name='Chq', type=Cheque18, min=1, max=None, mutex_group=None, array=True),
