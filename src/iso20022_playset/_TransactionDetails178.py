...
class TransactionDetails178(base_types._BaseFieldType):

	__slots__ = ["_AcctOwnr", "_BlckChainAdrOrWllt", "_DgtlPmtSttlm", "_DlvrgSttlmPties", "_FinInstrmId", "_Invstr", "_RcvgSttlmPties", "_SfkpgAcct", "_SttlmAmt", "_SttlmDt", "_SttlmQty", "_TradDt"]
	@property
	def AcctOwnr(self):
