...
class Record3(base_types._BaseFieldType):
	...
	__slots__ = ["_ClrDt", "_ClrCdtDbt", "_ClrMtd", "_OrgtrId", "_OthrAmt", "_DstnCtry", "_DstnShrtNm", "_IntrchngFeeAmt", "_AgtFeeAmt", "_IntrchngFeeCcy", "_OrgtrCtry", "_IntrchngFeeCdtDbt", "_OrgtrShrtNm", "_RcrdChcksmInptVal", "_AgtFeeCcy", "_DstnId", "_DstnAssgnr", "_ClrPrty", "_OrgtrAssgnr", "_OthrClrMtd", "_ClrAmt", "_ClrCcy", "_AgtFeeCdtDbt", "_SeqCntr", "_RcrdMsg"]
	@property
	def ClrDt(self):
		return self._ClrDt
