...
class CorporateActionMovementReversalAdviceV16(base_types._BaseFieldType):
	...
	__slots__ = ["_RvslRsn", "_CorpActnGnlInf", "_CorpActnConfDtls", "_PngAgt", "_SplmtryData", "_OthrDocId", "_TxId", "_AcctDtls", "_EvtsLkg", "_SubPngAgt", "_CorpActnDtls", "_IssrAgt", "_MvmntConfId", "_AddtlInf"]
	@property
	def RvslRsn(self):
