...
class CorporateActionMovementReversalAdviceV16(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrDocId", "_SplmtryData", "_CorpActnDtls", "_EvtsLkg", "_TxId", "_PngAgt", "_AcctDtls", "_AddtlInf", "_MvmntConfId", "_RvslRsn", "_SubPngAgt", "_CorpActnConfDtls", "_CorpActnGnlInf", "_IssrAgt"]
	@property
	def OthrDocId(self):
