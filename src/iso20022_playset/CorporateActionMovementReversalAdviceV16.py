...
class CorporateActionMovementReversalAdviceV16(base_types._BaseFieldType):
	...
	__slots__ = ["_CorpActnDtls", "_IssrAgt", "_SplmtryData", "_PngAgt", "_EvtsLkg", "_RvslRsn", "_TxId", "_OthrDocId", "_AddtlInf", "_SubPngAgt", "_CorpActnGnlInf", "_CorpActnConfDtls", "_AcctDtls", "_MvmntConfId"]
	@property
