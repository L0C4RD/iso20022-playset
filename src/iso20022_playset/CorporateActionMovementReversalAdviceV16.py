...
class CorporateActionMovementReversalAdviceV16(base_types._BaseFieldType):
	...
	__slots__ = ["_PngAgt", "_EvtsLkg", "_SubPngAgt", "_CorpActnGnlInf", "_AcctDtls", "_AddtlInf", "_IssrAgt", "_SplmtryData", "_RvslRsn", "_CorpActnConfDtls", "_MvmntConfId", "_CorpActnDtls", "_OthrDocId", "_TxId"]
	@property
	def PngAgt(self):
		return self._PngAgt
