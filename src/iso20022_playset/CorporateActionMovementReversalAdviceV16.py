...
class CorporateActionMovementReversalAdviceV16(base_types._BaseFieldType):
	...
	__slots__ = ["_PngAgt", "_AddtlInf", "_IssrAgt", "_RvslRsn", "_EvtsLkg", "_AcctDtls", "_CorpActnConfDtls", "_CorpActnGnlInf", "_OthrDocId", "_MvmntConfId", "_CorpActnDtls", "_SplmtryData", "_TxId", "_SubPngAgt"]
	@property
	def PngAgt(self):
		return self._PngAgt
