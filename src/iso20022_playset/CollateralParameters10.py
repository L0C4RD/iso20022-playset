...
class CollateralParameters10(base_types._BaseFieldType):
	...
	__slots__ = ["_CollSd", "_TrfTitl", "_ValSghtMrgnRate", "_MainTradgAcctCollstn", "_BsktIdAndElgbltySetPrfl", "_Prty", "_CollInstrTp", "_AddtlInf", "_SttlmPrc", "_FaildSttlmSlvtn", "_AutomtcAllcn", "_RspnSts", "_XpsrTp"]
	@property
	def CollSd(self):
		return self._CollSd
