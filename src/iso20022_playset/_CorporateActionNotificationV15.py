...
class CorporateActionNotificationV15(base_types._BaseFieldType):
	...
	__slots__ = ["_EvtsLkg", "_OthrDocId", "_TrfAgt", "_Pgntn", "_DrpAgt", "_SlctnAgt", "_AcctDtls", "_IntrmdtScty", "_InstrId", "_PrvsNtfctnId", "_PhysSctiesAgt", "_IssrAgt", "_NtfctnGnlInf", "_SubPngAgt", "_Issr", "_CorpActnDtls", "_InfAgt", "_AddtlInf", "_RsellngAgt", "_CorpActnOptnDtls", "_Offerr", "_PngAgt", "_CorpActnGnlInf", "_SplmtryData", "_Regar"]
	@property
	def EvtsLkg(self):
