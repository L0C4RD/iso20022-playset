...
class CorporateActionNotificationV15(base_types._BaseFieldType):
	...
	def CorpActnDtls(self, value):
		self._CorpActnDtls = value if value is not None else base_types.UninitialisedField(self, 'CorpActnDtls', CorporateAction84, False)

	@CorpActnDtls.deleter
	def CorpActnDtls(self):
		del self._CorpActnDtls
		self._CorpActnDtls = base_types.UninitialisedField(self, 'CorpActnDtls', CorporateAction84, False)
	...
	def CorpActnOptnDtls(self, value):
		self._CorpActnOptnDtls = value if value is not None else base_types.UninitialisedField(self, 'CorpActnOptnDtls', CorporateActionOption236, True)

	@CorpActnOptnDtls.deleter
	def CorpActnOptnDtls(self):
		del self._CorpActnOptnDtls
		self._CorpActnOptnDtls = base_types.UninitialisedField(self, 'CorpActnOptnDtls', CorporateActionOption236, True)
	...
	def IntrmdtScty(self, value):
		self._IntrmdtScty = value if value is not None else base_types.UninitialisedField(self, 'IntrmdtScty', FinancialInstrumentAttributes110, False)

	@IntrmdtScty.deleter
	def IntrmdtScty(self):
		del self._IntrmdtScty
		self._IntrmdtScty = base_types.UninitialisedField(self, 'IntrmdtScty', FinancialInstrumentAttributes110, False)
