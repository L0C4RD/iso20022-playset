...
class SecuritiesFinancingTransactionDetails50(base_types._BaseFieldType):
	...
	__slots__ = ["_RpRate", "_IntrstPmt", "_TxCallDely", "_RateTp", "_SctiesFincgTradId", "_ScndLegNrrtv", "_TermntnTxAmt", "_ClsgLegId", "_TermntnDt", "_VarblRateSpprt", "_AcrdIntrstAmt", "_MtrtyDtMod", "_LglFrmwk"]
	@property
	def RpRate(self):
		return self._RpRate
