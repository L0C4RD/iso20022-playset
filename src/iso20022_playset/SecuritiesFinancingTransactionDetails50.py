...
class SecuritiesFinancingTransactionDetails50(base_types._BaseFieldType):
	...
	__slots__ = ["_LglFrmwk", "_TxCallDely", "_ScndLegNrrtv", "_VarblRateSpprt", "_RateTp", "_ClsgLegId", "_TermntnTxAmt", "_IntrstPmt", "_TermntnDt", "_AcrdIntrstAmt", "_RpRate", "_MtrtyDtMod", "_SctiesFincgTradId"]
	@property
	def LglFrmwk(self):
