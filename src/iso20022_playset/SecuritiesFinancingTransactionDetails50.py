...
class SecuritiesFinancingTransactionDetails50(base_types._BaseFieldType):
	...
	__slots__ = ["_TxCallDely", "_VarblRateSpprt", "_LglFrmwk", "_TermntnTxAmt", "_MtrtyDtMod", "_ScndLegNrrtv", "_RateTp", "_SctiesFincgTradId", "_IntrstPmt", "_AcrdIntrstAmt", "_ClsgLegId", "_RpRate", "_TermntnDt"]
	@property
	def TxCallDely(self):
