...
class SecuritiesFinancingTransactionDetails50(base_types._BaseFieldType):
	...
	__slots__ = ["_LglFrmwk", "_MtrtyDtMod", "_ClsgLegId", "_TxCallDely", "_AcrdIntrstAmt", "_TermntnDt", "_SctiesFincgTradId", "_RateTp", "_VarblRateSpprt", "_ScndLegNrrtv", "_IntrstPmt", "_RpRate", "_TermntnTxAmt"]
	@property
	def LglFrmwk(self):
