...
class ReversalResponseV04(base_types._BaseFieldType):
	...
	__slots__ = ["_TxAmts", "_AcctTo", "_Tkn", "_Dstn", "_PrtctdData", "_PrcgRslt", "_Rcvr", "_Jursdctn", "_Orgtr", "_SctyTrlr", "_AddtlSvc", "_Prgrmm", "_Termnl", "_Hdr", "_SttlmSvc", "_AddtlFee", "_Sndr", "_ICCRltdData", "_OrgnlDataElmts", "_AddtlData", "_Rcncltn", "_SpclPrgrmmQlfctn", "_Accptr", "_AcctFr", "_Issr", "_TxId", "_AddtlAmt", "_SplmtryData", "_TxChrtcs", "_Acqrr", "_Card", "_ConvsDtTm", "_Cntxt"]
	@property
	def TxAmts(self):
		return self._TxAmts
