...
class ReversalResponseV04(base_types._BaseFieldType):
	...
	__slots__ = ["_Card", "_SpclPrgrmmQlfctn", "_Cntxt", "_AddtlData", "_Issr", "_TxId", "_Acqrr", "_Dstn", "_Accptr", "_Termnl", "_PrcgRslt", "_SplmtryData", "_Hdr", "_AcctFr", "_AddtlSvc", "_SttlmSvc", "_Rcvr", "_AddtlAmt", "_Rcncltn", "_ConvsDtTm", "_TxAmts", "_Tkn", "_SctyTrlr", "_Orgtr", "_AddtlFee", "_Jursdctn", "_TxChrtcs", "_AcctTo", "_OrgnlDataElmts", "_PrtctdData", "_ICCRltdData", "_Sndr", "_Prgrmm"]
	@property
	def Card(self):
		return self._Card
