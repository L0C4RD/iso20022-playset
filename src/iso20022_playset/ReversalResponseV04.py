...
class ReversalResponseV04(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_TxAmts", "_AcctTo", "_Cntxt", "_AddtlSvc", "_ICCRltdData", "_PrcgRslt", "_Dstn", "_AddtlData", "_Termnl", "_Acqrr", "_Hdr", "_SctyTrlr", "_AddtlAmt", "_AddtlFee", "_Card", "_Issr", "_OrgnlDataElmts", "_Accptr", "_Orgtr", "_Sndr", "_Prgrmm", "_SpclPrgrmmQlfctn", "_AcctFr", "_SttlmSvc", "_TxId", "_Rcvr", "_ConvsDtTm", "_Rcncltn", "_Jursdctn", "_Tkn", "_PrtctdData", "_TxChrtcs"]
	@property
