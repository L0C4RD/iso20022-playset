...
from . import SecuritiesIndexReport1
...
class FinancialInstrumentReportingReferenceDataIndexReportV01(base_types._BaseFieldType):
	...
	__slots__ = ["_IndxData", "_RptHdr", "_SplmtryData"]
	@property
	def IndxData(self):
	...
	def IndxData(self, value):
		self._IndxData = value if value is not None else base_types.UninitialisedField(self, 'IndxData', SecuritiesIndexReport1, True)

	@IndxData.deleter
	def IndxData(self):
		del self._IndxData
		self._IndxData = base_types.UninitialisedField(self, 'IndxData', SecuritiesIndexReport1, True)
