...
class Transaction125(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctSvcrTxId", "_ClntTrptyCollTxId", "_PrcrTxId", "_TxDtls", "_CtrPtyMktInfrstrctrTxId", "_TradId", "_MktInfrstrctrTxId", "_CmonId", "_TrptyAgtSvcPrvdrCollInstrId", "_AcctOwnrTxId", "_CorpActnEvtId", "_StsAndRsn", "_PoolId", "_TrptyAgtSvcPrvdrCollTxId", "_ClntCollInstrId"]
	@property
