...
class Transaction125(base_types._BaseFieldType):
	...
	__slots__ = ["_MktInfrstrctrTxId", "_CtrPtyMktInfrstrctrTxId", "_CmonId", "_CorpActnEvtId", "_TrptyAgtSvcPrvdrCollTxId", "_TrptyAgtSvcPrvdrCollInstrId", "_PoolId", "_ClntCollInstrId", "_ClntTrptyCollTxId", "_TxDtls", "_TradId", "_StsAndRsn", "_AcctOwnrTxId", "_PrcrTxId", "_AcctSvcrTxId"]
	@property
