...
class Transaction125(base_types._BaseFieldType):
	...
	__slots__ = ["_ClntTrptyCollTxId", "_StsAndRsn", "_AcctOwnrTxId", "_AcctSvcrTxId", "_PrcrTxId", "_TrptyAgtSvcPrvdrCollTxId", "_TxDtls", "_PoolId", "_CtrPtyMktInfrstrctrTxId", "_CorpActnEvtId", "_ClntCollInstrId", "_TrptyAgtSvcPrvdrCollInstrId", "_TradId", "_CmonId", "_MktInfrstrctrTxId"]
	@property
