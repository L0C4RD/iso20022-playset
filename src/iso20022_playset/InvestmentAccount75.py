...
from .FiscalYear1Choice import FiscalYear1Choice
from .PartyIdentification125Choice import PartyIdentification125Choice
from .StatementFrequencyReason2Choice import StatementFrequencyReason2Choice
from .LanguageCode import LanguageCode
from .Number import Number
from .TransactionChannelType1Choice import TransactionChannelType1Choice
from .Provided1Code import Provided1Code
from .DateAndDateTime1Choice import DateAndDateTime1Choice
from .AccountingStatus1Choice import AccountingStatus1Choice
from .LetterIntent1 import LetterIntent1
from .LevelOfControl1Choice import LevelOfControl1Choice
from .InvestmentAccountCategory1Choice import InvestmentAccountCategory1Choice
from .TaxWithholdingMethod3Code import TaxWithholdingMethod3Code
from .AccountType2Choice import AccountType2Choice
from .Max35Text import Max35Text
from .PositionEffect3Code import PositionEffect3Code
from .YesNoIndicator import YesNoIndicator
from .AccountStatusUpdateInstruction1 import AccountStatusUpdateInstruction1
from .ActiveCurrencyCode import ActiveCurrencyCode
from .Max350Text import Max350Text
from .TaxExemptionReason2Choice import TaxExemptionReason2Choice
from .Eligible1Code import Eligible1Code
from .ModificationScope46 import ModificationScope46
from .Reinvestment4 import Reinvestment4
from .IncomePreference2Code import IncomePreference2Code
from .OwnershipType2Choice import OwnershipType2Choice
from .BlockedStatusReason2Choice import BlockedStatusReason2Choice
from .TaxReporting3 import TaxReporting3
from .ModificationScope42 import ModificationScope42
from .AccountUsageType2Choice import AccountUsageType2Choice
from .RoundingParameters1 import RoundingParameters1
from .ThirdPartyRights2 import ThirdPartyRights2
from .Collateral1Code import Collateral1Code
from .Liability1Choice import Liability1Choice

class InvestmentAccount75(base_types._BaseFieldType):

	__slots__ = ["_AcctgSts", "_Tp", "_TaxXmptn", "_ClsgDt", "_NegInd", "_TaxWhldgMtd", "_ThrdPtyRghts", "_PwrOfAttnyLvlOfCtrl", "_Dsgnt", "_BlckdSts", "_AcctUsgTp", "_FndFmlyNm", "_InvstmtAcctCtgy", "_ModfdInvstrPrfl", "_FsclYr", "_Lblty", "_AcctSgntrDtTm", "_RefCcy", "_RndgDtls", "_Nm", "_RinvstmtDtls", "_OwnrshTp", "_TaxRptg", "_LttrInttDtls", "_AcmltnRghtRef", "_IncmPref", "_TxChanlTp", "_Pldgg", "_ReqrdSgntriesNb", "_FrgnStsCertfctn", "_OpngDt", "_AcctStsUpdInstr", "_ModfdFinInstrmDtls", "_AcctSvcr", "_Coll", "_PrcgOrdr", "_StmtFrqcy", "_Lang"]
	@property
	def AcctgSts(self):
	...
	def ModfdInvstrPrfl(self, value):
		self._ModfdInvstrPrfl = value if type(value) != auto else self.make_default("ModfdInvstrPrfl")
	...
	def AcctStsUpdInstr(self, value):
		self._AcctStsUpdInstr = value if type(value) != auto else self.make_default("AcctStsUpdInstr")
	...
	def ModfdFinInstrmDtls(self, value):
		self._ModfdFinInstrmDtls = value if type(value) != auto else self.make_default("ModfdFinInstrmDtls")
