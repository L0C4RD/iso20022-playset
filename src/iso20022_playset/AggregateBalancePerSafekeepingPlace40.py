...
class AggregateBalancePerSafekeepingPlace40(base_types._BaseFieldType):
	...
	__slots__ = ["_PricDtls", "_Pldgee", "_FXDtls", "_QtyBrkdwn", "_DaysAcrd", "_AltrnRptgCcyAmts", "_AddtlBalBrkdwn", "_PlcOfListg", "_XpsrTp", "_BalBrkdwn", "_AggtBal", "_InstrmCcyAmts", "_HldgAddtlDtls", "_SfkpgPlc", "_AcctBaseCcyAmts"]
	@property
	def PricDtls(self):
