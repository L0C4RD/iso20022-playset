...
class AggregateBalancePerSafekeepingPlace40(base_types._BaseFieldType):
	...
	__slots__ = ["_AggtBal", "_XpsrTp", "_AddtlBalBrkdwn", "_AcctBaseCcyAmts", "_PricDtls", "_HldgAddtlDtls", "_Pldgee", "_FXDtls", "_InstrmCcyAmts", "_QtyBrkdwn", "_SfkpgPlc", "_PlcOfListg", "_DaysAcrd", "_BalBrkdwn", "_AltrnRptgCcyAmts"]
	@property
	def AggtBal(self):
