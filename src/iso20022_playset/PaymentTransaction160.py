...
class PaymentTransaction160(base_types._BaseFieldType):
	...
	__slots__ = ["_ClrSysRef", "_StsRsnInf", "_ChrgsInf", "_SplmtryData", "_OrgnlUETR", "_StsId", "_TrckrData", "_AccptncDtTm", "_OrgnlTxRef", "_TxSts", "_AcctSvcrRef", "_OrgnlEndToEndId", "_OrgnlInstrId"]
	@property
	def ClrSysRef(self):
