...
class PaymentTransaction160(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlInstrId", "_TxSts", "_StsId", "_OrgnlEndToEndId", "_AcctSvcrRef", "_AccptncDtTm", "_OrgnlUETR", "_SplmtryData", "_ClrSysRef", "_ChrgsInf", "_OrgnlTxRef", "_TrckrData", "_StsRsnInf"]
	@property
