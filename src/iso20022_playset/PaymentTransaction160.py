...
from .TrackerData7 import TrackerData7

class PaymentTransaction160(base_types._BaseFieldType):

	__slots__ = ["_OrgnlTxRef", "_TrckrData", "_TxSts", "_SplmtryData", "_StsRsnInf", "_OrgnlUETR", "_ClrSysRef", "_OrgnlEndToEndId", "_ChrgsInf", "_AcctSvcrRef", "_AccptncDtTm", "_OrgnlInstrId", "_StsId"]
	@property
	def OrgnlTxRef(self):
