...
class PaymentTransaction160(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlEndToEndId", "_StsRsnInf", "_AcctSvcrRef", "_OrgnlInstrId", "_ChrgsInf", "_OrgnlUETR", "_AccptncDtTm", "_TrckrData", "_OrgnlTxRef", "_TxSts", "_SplmtryData", "_StsId", "_ClrSysRef"]
	@property
