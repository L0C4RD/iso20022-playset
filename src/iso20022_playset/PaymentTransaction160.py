...
class PaymentTransaction160(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlEndToEndId", "_ChrgsInf", "_ClrSysRef", "_SplmtryData", "_AccptncDtTm", "_TxSts", "_AcctSvcrRef", "_OrgnlInstrId", "_TrckrData", "_StsId", "_OrgnlUETR", "_StsRsnInf", "_OrgnlTxRef"]
	@property
