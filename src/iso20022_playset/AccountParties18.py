...
class AccountParties18(base_types._BaseFieldType):
	...
	__slots__ = ["_Admstr", "_Grntr", "_SnrMggOffcl", "_OthrPty", "_LglGuardn", "_RegdShrhldrNm", "_PrncplAcctPty", "_Sttlr", "_ScndryOwnr", "_ModScpIndctn", "_SucssrOnDth", "_Bnfcry", "_CtdnForMnr", "_Prtctr", "_PwrOfAttny"]
	@property
	def Admstr(self):
		return self._Admstr
