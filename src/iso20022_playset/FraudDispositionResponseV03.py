...
class FraudDispositionResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Prgrmm", "_OrgnlRspnCd", "_Tkn", "_Acqrr", "_SctyTrlr", "_PrcgRslt", "_Orgtr", "_AddtlData", "_AddtlFee", "_Jursdctn", "_Issr", "_Dstn", "_Card", "_SplmtryData", "_Hdr", "_Sndr", "_FrdTxId", "_SttlmSvc", "_Crdhldr", "_PrtctdData", "_Rcvr", "_Rcncltn"]
	@property
	def Prgrmm(self):
		return self._Prgrmm
