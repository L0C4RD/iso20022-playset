...
class FraudDispositionResponseV03(base_types._BaseFieldType):

	__slots__ = ["_AddtlData", "_SctyTrlr", "_Hdr", "_Sndr", "_Orgtr", "_FrdTxId", "_OrgnlRspnCd", "_Jursdctn", "_Rcvr", "_Prgrmm", "_AddtlFee", "_Acqrr", "_Dstn", "_SttlmSvc", "_PrcgRslt", "_Rcncltn", "_PrtctdData", "_Issr", "_SplmtryData", "_Tkn", "_Card", "_Crdhldr"]
	@property
	def AddtlData(self):
