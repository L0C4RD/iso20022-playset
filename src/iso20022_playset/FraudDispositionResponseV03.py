...
class FraudDispositionResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Sndr", "_Hdr", "_AddtlData", "_Tkn", "_Rcncltn", "_Dstn", "_PrtctdData", "_Prgrmm", "_Crdhldr", "_Acqrr", "_OrgnlRspnCd", "_Issr", "_Card", "_Rcvr", "_Jursdctn", "_SplmtryData", "_Orgtr", "_PrcgRslt", "_SctyTrlr", "_SttlmSvc", "_AddtlFee", "_FrdTxId"]
	@property
	def Sndr(self):
		return self._Sndr
