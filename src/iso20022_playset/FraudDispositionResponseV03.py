...
class FraudDispositionResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Jursdctn", "_SplmtryData", "_AddtlData", "_Orgtr", "_Hdr", "_SttlmSvc", "_Card", "_Acqrr", "_Sndr", "_OrgnlRspnCd", "_Prgrmm", "_Tkn", "_Dstn", "_PrcgRslt", "_Rcncltn", "_Rcvr", "_SctyTrlr", "_Issr", "_PrtctdData", "_Crdhldr", "_AddtlFee", "_FrdTxId"]
	@property
	def Jursdctn(self):
