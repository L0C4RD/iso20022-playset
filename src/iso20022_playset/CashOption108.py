...
class CashOption108(base_types._BaseFieldType):
	...
	__slots__ = ["_AmtDtls", "_RateAndAmtDtls", "_PricDtls", "_XmptnTp", "_EstmtdRateInd", "_CtryOfIncmSrc", "_NRATaxRptblInd", "_IncmTp", "_FXDtls", "_DtDtls", "_PricClctnMtd", "_CdtDbtInd", "_NonElgblPrcdsInd", "_OthrIncmTp"]
	@property
	def AmtDtls(self):
