...
from .PriceDetails39 import PriceDetails39
from .Rate44 import Rate44

class CashOption108(base_types._BaseFieldType):

	__slots__ = ["_PricDtls", "_XmptnTp", "_EstmtdRateInd", "_CdtDbtInd", "_OthrIncmTp", "_PricClctnMtd", "_RateAndAmtDtls", "_CtryOfIncmSrc", "_FXDtls", "_NonElgblPrcdsInd", "_NRATaxRptblInd", "_DtDtls", "_AmtDtls", "_IncmTp"]
	@property
	def PricDtls(self):
