...
class CashOption108(base_types._BaseFieldType):
	...
	__slots__ = ["_NRATaxRptblInd", "_NonElgblPrcdsInd", "_AmtDtls", "_OthrIncmTp", "_CdtDbtInd", "_RateAndAmtDtls", "_CtryOfIncmSrc", "_IncmTp", "_PricDtls", "_EstmtdRateInd", "_FXDtls", "_PricClctnMtd", "_DtDtls", "_XmptnTp"]
	@property
