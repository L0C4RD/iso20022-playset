...
import PriceDetails39
import NonEligibleProceedsIndicator5Choice
import ForeignExchangeTerms39
import CorporateActionAmounts71
import YesNoIndicator
import Rate44
import CorporateActionDate84
import CountryCode
import PriceCalculationMethod2Choice

class CashOption108(base_types._BaseFieldType):

	__slots__ = ["_PricDtls", "_NRATaxRptblInd", "_OthrIncmTp", "_NonElgblPrcdsInd", "_PricClctnMtd", "_CtryOfIncmSrc", "_AmtDtls", "_XmptnTp", "_DtDtls", "_EstmtdRateInd", "_RateAndAmtDtls", "_FXDtls", "_CdtDbtInd", "_IncmTp"]
	@property
	def PricDtls(self):
	...
	def NRATaxRptblInd(self, value):
		self._NRATaxRptblInd = value if type(value) != auto else self.make_default("NRATaxRptblInd")
