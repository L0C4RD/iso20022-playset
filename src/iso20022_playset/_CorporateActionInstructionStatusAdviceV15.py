...
from .InstructionProcessingStatus55Choice import InstructionProcessingStatus55Choice
from .DocumentIdentification9 import DocumentIdentification9
from .CorporateActionOption238 import CorporateActionOption238
from .ProtectInstruction2 import ProtectInstruction2
...
class CorporateActionInstructionStatusAdviceV15(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_PrtctInstr", "_CorpActnGnlInf", "_InstrPrcgSts", "_InstrId", "_AddtlInf", "_CorpActnInstr", "_OthrDocId"]
	@property
