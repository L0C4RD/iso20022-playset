...
class TaxVoucher1(base_types._BaseFieldType):
	...
	__slots__ = ["_CshAmtBrghtFwd", "_NtnlDvddPybl", "_AlltdShrsCost", "_WhldgTaxRate", "_TaxVchrRate", "_ChrgAmt", "_FXDtls", "_TaxCdt", "_NtnlTax", "_GrssAmt", "_StmpDtyAmt", "_WhldgTaxAmt", "_RcrdDtHldg", "_ComssnAmt", "_BrgnDt", "_CshAmtCrrdFwd", "_ScripDvddRinvstmtPricPerShr", "_BrgnSttlmDt", "_TaxCdtRate", "_TaxDdctn", "_NetAmt"]
	@property
