...
class TaxVoucher1(base_types._BaseFieldType):
	...
	__slots__ = ["_WhldgTaxRate", "_NetAmt", "_ScripDvddRinvstmtPricPerShr", "_TaxDdctn", "_ChrgAmt", "_ComssnAmt", "_RcrdDtHldg", "_GrssAmt", "_BrgnDt", "_NtnlDvddPybl", "_NtnlTax", "_TaxCdt", "_TaxCdtRate", "_StmpDtyAmt", "_CshAmtCrrdFwd", "_AlltdShrsCost", "_TaxVchrRate", "_CshAmtBrghtFwd", "_BrgnSttlmDt", "_FXDtls", "_WhldgTaxAmt"]
	@property
