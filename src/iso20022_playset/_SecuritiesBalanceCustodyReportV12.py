...
from .Statement73 import Statement73
from .TotalValueInPageAndStatement1 import TotalValueInPageAndStatement1
...
from .SubAccountIdentification71 import SubAccountIdentification71
from .AggregateBalanceInformation46 import AggregateBalanceInformation46

class SecuritiesBalanceCustodyReportV12(base_types._BaseFieldType):

	__slots__ = ["_BlckChainAdrOrWllt", "_AcctSvcr", "_AcctOwnr", "_Pgntn", "_StmtGnlDtls", "_IntrmyInf", "_BalForAcct", "_SubAcctDtls", "_SfkpgAcct", "_AcctBaseCcyTtlAmts"]
	@property
