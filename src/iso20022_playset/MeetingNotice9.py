...
class MeetingNotice9(base_types._BaseFieldType):
	...
	__slots__ = ["_CtctPrsnDtls", "_Attndnc", "_IssrMtgId", "_Clssfctn", "_OneManOneVoteInd", "_PrxyAppntmntNtfctnAdr", "_RegnSctiesDdln", "_MtgId", "_EvtPrcgWebSiteAdr", "_EnrlmntDdln", "_EntitlmntFxgDt", "_Prtcptn", "_TtlNbOfVtngRghts", "_SctiesBlckgPrdEndDt", "_TtlNbOfSctiesOutsdng", "_AddtlPrcdrDtls", "_PrxyChc", "_Tp", "_AnncmntDt", "_RsltPblctnDt", "_RegnSctiesMktDdln", "_EnrlmntMktDdln", "_AddtlDcmnttnURLAdr"]
	@property
