...
class CardPaymentTransaction140(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctTo", "_MrchntRefData", "_IntrchngData", "_MrchntOvrrd", "_MrchntCITId", "_AcctFr", "_MrchntCtgyCd", "_RcncltnId", "_CardPrgrmmApld", "_Rvsl", "_LastTxFlg", "_InitrTxId", "_AddtlSvc", "_SvcAttr", "_SaleRefId", "_IssrCITId", "_TxDtls", "_TxSucss", "_FailrRsn", "_TxTp", "_CstmrCnsnt", "_TxCaptr", "_CardPrgrmmPropsd", "_RcptTxId", "_TxId", "_OrgnlTx", "_AuthstnRslt", "_AddtlTxData"]
	@property
	def AcctTo(self):
		return self._AcctTo
