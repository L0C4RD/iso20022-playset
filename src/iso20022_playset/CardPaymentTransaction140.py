...
class CardPaymentTransaction140(base_types._BaseFieldType):
	...
	__slots__ = ["_TxCaptr", "_TxDtls", "_CstmrCnsnt", "_OrgnlTx", "_CardPrgrmmPropsd", "_RcncltnId", "_TxSucss", "_TxId", "_AddtlTxData", "_MrchntOvrrd", "_InitrTxId", "_AuthstnRslt", "_AcctTo", "_FailrRsn", "_MrchntCtgyCd", "_IntrchngData", "_LastTxFlg", "_Rvsl", "_TxTp", "_AddtlSvc", "_SaleRefId", "_RcptTxId", "_AcctFr", "_IssrCITId", "_SvcAttr", "_MrchntCITId", "_CardPrgrmmApld", "_MrchntRefData"]
	@property
	def TxCaptr(self):
