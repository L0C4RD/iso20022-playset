...
class CardPaymentTransaction140(base_types._BaseFieldType):
	...
	__slots__ = ["_FailrRsn", "_MrchntCtgyCd", "_TxId", "_LastTxFlg", "_AddtlTxData", "_SaleRefId", "_InitrTxId", "_IssrCITId", "_AcctFr", "_Rvsl", "_TxDtls", "_AcctTo", "_MrchntRefData", "_AuthstnRslt", "_CstmrCnsnt", "_TxSucss", "_TxTp", "_MrchntOvrrd", "_IntrchngData", "_RcptTxId", "_SvcAttr", "_TxCaptr", "_OrgnlTx", "_MrchntCITId", "_CardPrgrmmApld", "_RcncltnId", "_CardPrgrmmPropsd", "_AddtlSvc"]
	@property
	def FailrRsn(self):
