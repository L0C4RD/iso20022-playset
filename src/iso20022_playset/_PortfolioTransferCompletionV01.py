...
class PortfolioTransferCompletionV01(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrCorpInvstr", "_PmryIndvInvstr", "_ScndryCorpInvstr", "_PoolRef", "_RltdRef", "_PrvsRef", "_MktPrctcVrsn", "_NmneeAcct", "_TrfrAcct", "_PdctTrf", "_PmryCorpInvstr", "_MsgRef", "_RegdHldr", "_Trfee", "_OthrIndvInvstr", "_Xtnsn", "_ScndryIndvInvstr"]
	@property
