...
class PortfolioTransferCompletionV01(base_types._BaseFieldType):
	...
	__slots__ = ["_RltdRef", "_OthrIndvInvstr", "_RegdHldr", "_PdctTrf", "_PrvsRef", "_PmryCorpInvstr", "_MktPrctcVrsn", "_ScndryCorpInvstr", "_Xtnsn", "_OthrCorpInvstr", "_Trfee", "_PmryIndvInvstr", "_TrfrAcct", "_ScndryIndvInvstr", "_NmneeAcct", "_MsgRef", "_PoolRef"]
	@property
	def RltdRef(self):
