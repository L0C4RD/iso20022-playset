...
class SecuritiesSettlementTransactionDetails58(base_types._BaseFieldType):
	...
	__slots__ = ["_CshPties", "_FinInstrmAttrbts", "_AddtlPhysOrRegnDtls", "_SplmtryData", "_OthrAmts", "_DlvrgSttlmPties", "_QtyAndAcctDtls", "_StgSttlmInstrDtls", "_RcvgSttlmPties", "_SttlmAmt", "_Lnkgs", "_SttlmParams", "_OthrBizPties", "_SttlmTpAndAddtlParams", "_TradDtls"]
	@property
	def CshPties(self):
