...
from .Linkages40 import Linkages40
...
class SecuritiesSettlementTransactionDetails58(base_types._BaseFieldType):
	...
	__slots__ = ["_TradDtls", "_SplmtryData", "_SttlmParams", "_OthrAmts", "_QtyAndAcctDtls", "_OthrBizPties", "_CshPties", "_RcvgSttlmPties", "_Lnkgs", "_SttlmAmt", "_SttlmTpAndAddtlParams", "_AddtlPhysOrRegnDtls", "_DlvrgSttlmPties", "_FinInstrmAttrbts", "_StgSttlmInstrDtls"]
	@property
	def TradDtls(self):
