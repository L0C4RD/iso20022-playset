...
class PositionSetDimensions16(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrctTp", "_XchgRateBsis", "_IRSTp", "_ValCcy", "_MstrAgrmt", "_Coll", "_UndrlygInstrm", "_CtrPtyId", "_OptnTp", "_NtnlCcy", "_Cdt", "_NtnlCcyScndLeg", "_IntraGrp", "_OthrPmt", "_AsstClss", "_SttlmCcy", "_SttlmCcyScndLeg", "_Cmmdty", "_Clrd", "_TmToMtrty"]
	@property
	def CtrctTp(self):
