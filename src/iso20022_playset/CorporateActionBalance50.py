...
class CorporateActionBalance50(base_types._BaseFieldType):
	...
	__slots__ = ["_PdgRctBal", "_BlckdBal", "_CollInBal", "_SttlmPosBal", "_TtlInstdBalDtls", "_TtlElgblBal", "_UinstdBal", "_PdgDlvryBal", "_BrrwdBal", "_CollOutBal", "_TradDtPosBal", "_InTrnsShipmntBal", "_OnLnBal", "_OutForRegnBal", "_OblgtdBal", "_StrtPosBal", "_RegdBal"]
	@property
	def PdgRctBal(self):
