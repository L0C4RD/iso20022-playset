...
class CorporateActionEventReference3Choice(base_types._BaseFieldType):
	...
	def LkdCorpActnId(self, value):
		self._LkdCorpActnId = value if value is not None else base_types.UninitialisedField(self, 'LkdCorpActnId', Max35Text, False)

	@LkdCorpActnId.deleter
	def LkdCorpActnId(self):
		del self._LkdCorpActnId
		self._LkdCorpActnId = base_types.UninitialisedField(self, 'LkdCorpActnId', Max35Text, False)
	...
	def LkdOffclCorpActnEvtId(self, value):
		self._LkdOffclCorpActnEvtId = value if value is not None else base_types.UninitialisedField(self, 'LkdOffclCorpActnEvtId', Max35Text, False)

	@LkdOffclCorpActnEvtId.deleter
	def LkdOffclCorpActnEvtId(self):
		del self._LkdOffclCorpActnEvtId
		self._LkdOffclCorpActnEvtId = base_types.UninitialisedField(self, 'LkdOffclCorpActnEvtId', Max35Text, False)
