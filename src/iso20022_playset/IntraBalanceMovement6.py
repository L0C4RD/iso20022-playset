...
class IntraBalanceMovement6(base_types._BaseFieldType):
	...
	__slots__ = ["_InstrPrcgAddtlDtls", "_CshSubBalId", "_StsDt", "_Lnkgs", "_MsgOrgtr", "_FctvSttlmDt", "_BalFr", "_SttldAmt", "_SplmtryData", "_BalTo", "_SttlmAmt", "_PrevslySttldAmt", "_RmngSttlmAmt", "_IntnddSttlmDt", "_CreDtTm", "_Prty"]
	@property
