...
class IntraBalanceMovement6(base_types._BaseFieldType):
	...
	__slots__ = ["_Lnkgs", "_Prty", "_InstrPrcgAddtlDtls", "_CshSubBalId", "_PrevslySttldAmt", "_BalTo", "_RmngSttlmAmt", "_MsgOrgtr", "_FctvSttlmDt", "_CreDtTm", "_SttlmAmt", "_BalFr", "_SttldAmt", "_StsDt", "_SplmtryData", "_IntnddSttlmDt"]
	@property
	def Lnkgs(self):
		return self._Lnkgs
