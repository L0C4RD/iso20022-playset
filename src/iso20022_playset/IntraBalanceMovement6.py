...
class IntraBalanceMovement6(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_PrevslySttldAmt", "_FctvSttlmDt", "_IntnddSttlmDt", "_RmngSttlmAmt", "_BalTo", "_SttldAmt", "_SttlmAmt", "_CshSubBalId", "_MsgOrgtr", "_StsDt", "_Lnkgs", "_BalFr", "_CreDtTm", "_Prty", "_InstrPrcgAddtlDtls"]
	@property
