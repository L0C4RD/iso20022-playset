...
class IntraBalanceMovement6(base_types._BaseFieldType):
	...
	__slots__ = ["_SttldAmt", "_CreDtTm", "_RmngSttlmAmt", "_Prty", "_BalFr", "_FctvSttlmDt", "_InstrPrcgAddtlDtls", "_SttlmAmt", "_BalTo", "_StsDt", "_SplmtryData", "_Lnkgs", "_MsgOrgtr", "_IntnddSttlmDt", "_PrevslySttldAmt", "_CshSubBalId"]
	@property
	def SttldAmt(self):
