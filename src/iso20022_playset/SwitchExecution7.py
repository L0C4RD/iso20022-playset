...
class SwitchExecution7(base_types._BaseFieldType):
	...
	__slots__ = ["_CstmrCndctClssfctn", "_LateRpt", "_RltdPtyDtls", "_RcvdDtTm", "_SttlmAmt", "_TxChanlTp", "_MstrRef", "_CshSttlmDt", "_DealRef", "_CxlRght", "_ClntRef", "_OrdrRef", "_SbcptLegDtls", "_FinAdvc", "_OrdrDtTm", "_InvstmtAcctDtls", "_NgtdTrad", "_FXDtls", "_SgntrTp", "_RedLegDtls", "_CshSttlmDtls", "_OrdrWvrDtls", "_ReqdFutrTradDt", "_AmdmntInd", "_PlcOfTrad", "_AddtlAmt", "_BestExctn", "_SttlmMtd"]
	@property
