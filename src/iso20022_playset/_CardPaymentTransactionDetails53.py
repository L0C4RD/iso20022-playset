...
from .Instalment5 import Instalment5
from .OnLineReason2Code import OnLineReason2Code
...
from .AggregationTransaction3 import AggregationTransaction3
from .Max10Text import Max10Text
from .ISODate import ISODate
from .PositiveNumber import PositiveNumber
from .Max10000Binary import Max10000Binary
from .CurrencyConversion30 import CurrencyConversion30
from .Max35Text import Max35Text
from .ImpliedCurrencyAndAmount import ImpliedCurrencyAndAmount

class CardPaymentTransactionDetails53(base_types._BaseFieldType):

	__slots__ = ["_ReSubmissnCntr", "_CmpltnSeqCntr", "_TtlAmt", "_ICCRltdData", "_AmtQlfr", "_CcyConvsRslt", "_ReqdAmt", "_TtlAuthrsdAmt", "_AddtlInf", "_PdctCdSetId", "_Ccy", "_CmpltnSeqNb", "_InvcAmt", "_OnLineRsn", "_AcctTp", "_CmltvAmt", "_AuthrsdAmt", "_DlvryLctn", "_Instlmt", "_VldtyDt", "_DtldAmt", "_AggtnTx", "_UattnddLvlCtgy", "_SaleItm", "_Rcrng"]
	@property
