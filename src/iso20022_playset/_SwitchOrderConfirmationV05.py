...
from . import SwitchExecution8

class SwitchOrderConfirmationV05(base_types._BaseFieldType):
	...
	def SwtchExctnDtls(self, value):
		self._SwtchExctnDtls = value if value is not None else base_types.UninitialisedField(self, 'SwtchExctnDtls', SwitchExecution8, True)

	@SwtchExctnDtls.deleter
	def SwtchExctnDtls(self):
		del self._SwtchExctnDtls
		self._SwtchExctnDtls = base_types.UninitialisedField(self, 'SwtchExctnDtls', SwitchExecution8, True)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='SwtchExctnDtls', type=SwitchExecution8, min=1, max=None, mutex_group=None, array=True),
