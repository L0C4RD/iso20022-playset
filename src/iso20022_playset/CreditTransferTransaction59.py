...
from .TransferInstruction1 import TransferInstruction1
...
from .TaxRateMarker1Code import TaxRateMarker1Code
from .ActiveCurrencyAndAmount import ActiveCurrencyAndAmount
from .PaymentIdentification6 import PaymentIdentification6
...
from .Cheque19 import Cheque19
from .RemittanceLocation9 import RemittanceLocation9
from .BranchAndFinancialInstitutionIdentification8 import BranchAndFinancialInstitutionIdentification8

class CreditTransferTransaction59(base_types._BaseFieldType):

	__slots__ = ["_PmtId", "_RgltryRptg", "_ChrgBr", "_CdtrAgt", "_TrfInstr", "_UltmtCdtr", "_Cdtr", "_Purp", "_ChqInstr", "_TaxRateMrkr", "_PmtTpInf", "_IntrmyAgt1", "_RltdRmtInf", "_CdtrAcct", "_Tax", "_IntrmyAgt2", "_Amt", "_IntrmyAgt3", "_RmtInf", "_InstrForCdtrAgt", "_Frqcy", "_UltmtDbtr"]
	@property
	def PmtId(self):
		return self._PmtId
	...
	def TrfInstr(self, value):
		self._TrfInstr = value if type(value) != base_types.auto else self.make_default("TrfInstr")
	...
	def ChqInstr(self, value):
		self._ChqInstr = value if type(value) != base_types.auto else self.make_default("ChqInstr")
	...
	def TaxRateMrkr(self, value):
		self._TaxRateMrkr = value if type(value) != base_types.auto else self.make_default("TaxRateMrkr")

	@TaxRateMrkr.deleter
	def TaxRateMrkr(self):
		del self._TaxRateMrkr
		self._TaxRateMrkr = None
