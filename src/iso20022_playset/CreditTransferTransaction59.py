...
class CreditTransferTransaction59(base_types._BaseFieldType):
	...
	__slots__ = ["_IntrmyAgt1", "_UltmtCdtr", "_IntrmyAgt2", "_CdtrAcct", "_Amt", "_Tax", "_RgltryRptg", "_Purp", "_TrfInstr", "_IntrmyAgt3", "_ChrgBr", "_RltdRmtInf", "_PmtId", "_UltmtDbtr", "_Frqcy", "_ChqInstr", "_Cdtr", "_InstrForCdtrAgt", "_RmtInf", "_CdtrAgt", "_PmtTpInf", "_TaxRateMrkr"]
	@property
	def IntrmyAgt1(self):
