...
class CreditTransferTransaction59(base_types._BaseFieldType):
	...
	__slots__ = ["_TrfInstr", "_ChrgBr", "_ChqInstr", "_IntrmyAgt2", "_PmtId", "_RgltryRptg", "_RltdRmtInf", "_PmtTpInf", "_InstrForCdtrAgt", "_Cdtr", "_Frqcy", "_CdtrAgt", "_UltmtDbtr", "_CdtrAcct", "_TaxRateMrkr", "_Amt", "_RmtInf", "_IntrmyAgt3", "_Tax", "_Purp", "_IntrmyAgt1", "_UltmtCdtr"]
	@property
	def TrfInstr(self):
