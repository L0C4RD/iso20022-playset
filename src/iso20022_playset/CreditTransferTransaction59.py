...
class CreditTransferTransaction59(base_types._BaseFieldType):
	...
	__slots__ = ["_PmtTpInf", "_ChqInstr", "_UltmtCdtr", "_ChrgBr", "_IntrmyAgt2", "_RgltryRptg", "_TaxRateMrkr", "_Cdtr", "_Purp", "_UltmtDbtr", "_TrfInstr", "_IntrmyAgt1", "_InstrForCdtrAgt", "_Tax", "_RmtInf", "_IntrmyAgt3", "_CdtrAgt", "_Frqcy", "_Amt", "_CdtrAcct", "_RltdRmtInf", "_PmtId"]
	@property
	def PmtTpInf(self):
