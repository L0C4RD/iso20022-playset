...
from . import CardPaymentTransaction140
from . import Max9NumericText
from . import PaymentContext30
from . import Traceability8

class CardPaymentDataSetTransaction51(base_types._BaseFieldType):
	...
	@Tx.setter
	def Tx(self, value):
		self._Tx = value if value is not None else base_types.UninitialisedField(self, 'Tx', CardPaymentTransaction140, False)

	@Tx.deleter
	def Tx(self):
		del self._Tx
		self._Tx = base_types.UninitialisedField(self, 'Tx', CardPaymentTransaction140, False)
