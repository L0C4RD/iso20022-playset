...
class SaleItem4(base_types._BaseFieldType):
	...
	__slots__ = ["_UnitOfMeasr", "_AddtlPdctCd", "_PdctCdModfr", "_PdctCdTp", "_PdctQty", "_InsrncAmt", "_Adjstmnt", "_PdctDesc", "_NonAdjstdTtlAmt", "_PdctTp", "_AddtlPdctCdTp", "_NonAdjstdUnitPric", "_Tax", "_OthrUnitOfMeasr", "_TtlAmt", "_PdctCd", "_AdjstdAmt", "_InsrncInd"]
	@property
