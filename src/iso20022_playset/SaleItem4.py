...
class SaleItem4(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlPdctCd", "_AddtlPdctCdTp", "_PdctDesc", "_PdctCdTp", "_PdctCdModfr", "_PdctCd", "_InsrncInd", "_OthrUnitOfMeasr", "_NonAdjstdUnitPric", "_TtlAmt", "_PdctQty", "_Tax", "_AdjstdAmt", "_Adjstmnt", "_InsrncAmt", "_NonAdjstdTtlAmt", "_UnitOfMeasr", "_PdctTp"]
	@property
