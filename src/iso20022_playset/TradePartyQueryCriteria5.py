...
from .TradePartyIdentificationQuery9 import TradePartyIdentificationQuery9
from .Operation3Code import Operation3Code
from .TradePartyIdentificationQuery8 import TradePartyIdentificationQuery8

class TradePartyQueryCriteria5(base_types._BaseFieldType):

	__slots__ = ["_Bnfcry", "_AgtLndr", "_OthrCtrPty", "_RptgCtrPtyBrnch", "_SubmitgAgt", "_OthrCtrPtyBrnch", "_Brkr", "_Oprtr", "_RptgCtrPty", "_CCP", "_TrptyAgt"]
	@property
	def Bnfcry(self):
		return self._Bnfcry
	...
	def RptgCtrPtyBrnch(self, value):
		self._RptgCtrPtyBrnch = value if type(value) != auto else self.make_default("RptgCtrPtyBrnch")
	...
	def OthrCtrPtyBrnch(self, value):
		self._OthrCtrPtyBrnch = value if type(value) != auto else self.make_default("OthrCtrPtyBrnch")
