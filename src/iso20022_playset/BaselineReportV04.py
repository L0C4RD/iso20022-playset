...
from .ReportType2 import ReportType2
...
from .DocumentIdentification6 import DocumentIdentification6
from .LineItem14 import LineItem14

class BaselineReportV04(base_types._BaseFieldType):

	__slots__ = ["_RptdLineItm", "_Sellr", "_RptTp", "_TxSts", "_RptId", "_Buyr", "_TxId", "_ReqForActn", "_EstblishdBaselnId", "_BuyrBk", "_UsrTxRef", "_RltdMsgRef", "_SellrBk"]
	@property
