...
class InterestRate8Choice(base_types._BaseFieldType):
	...
	@Fltg.setter
	def Fltg(self, value):
		self._Fltg = value if value is not None else base_types.UninitialisedField(self, 'Fltg', FloatingInterestRate8, False)

	@Fltg.deleter
	def Fltg(self):
		del self._Fltg
		self._Fltg = base_types.UninitialisedField(self, 'Fltg', FloatingInterestRate8, False)
