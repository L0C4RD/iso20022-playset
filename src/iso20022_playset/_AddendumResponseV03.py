...
class AddendumResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_SttlmSvc", "_TxId", "_TxDesc", "_SctyTrlr", "_Accptr", "_Acqrr", "_OrgnlDataElmts", "_Hdr", "_AddtlData", "_Rcvr", "_Card", "_Sndr", "_Dstn", "_Issr", "_Rcncltn", "_Tkn", "_Jursdctn", "_PrcgRslt", "_Orgtr", "_Prgrmm", "_AddtlFee", "_PrtctdData"]
	@property
