...
class AddendumResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Issr", "_Orgtr", "_Acqrr", "_Tkn", "_TxDesc", "_Hdr", "_TxId", "_PrcgRslt", "_Jursdctn", "_AddtlFee", "_Rcvr", "_SttlmSvc", "_PrtctdData", "_Accptr", "_SctyTrlr", "_Sndr", "_Prgrmm", "_Rcncltn", "_AddtlData", "_OrgnlDataElmts", "_Card", "_Dstn", "_SplmtryData"]
	@property
	def Issr(self):
		return self._Issr
