...
class CorporateActionPrice97(base_types._BaseFieldType):
	...
	__slots__ = ["_MinPric", "_MaxPric", "_MaxCshToInst", "_LastBidIncrmtPric", "_CshInLieuOfShrPric", "_MinMltplCshToInst", "_FrstBidIncrmtPric", "_MinCshToInst", "_OverSbcptDpstPric"]
	@property
	def MinPric(self):
