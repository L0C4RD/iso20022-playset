...
class CorporateActionPrice97(base_types._BaseFieldType):
	...
	__slots__ = ["_LastBidIncrmtPric", "_MaxPric", "_MinPric", "_FrstBidIncrmtPric", "_MinMltplCshToInst", "_OverSbcptDpstPric", "_CshInLieuOfShrPric", "_MaxCshToInst", "_MinCshToInst"]
	@property
