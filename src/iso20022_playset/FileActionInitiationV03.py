...
class FileActionInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Prgrmm", "_Conttn", "_DataRcrd", "_Acqrr", "_Accptr", "_TrnsmssnDtTm", "_AddtlData", "_Issr", "_AltrnMsgRsn", "_Crrctn", "_Dstn", "_SplmtryData", "_Hdr", "_Pyer", "_SysTracAudtNb", "_ActnDt", "_OthrFileActnTp", "_SttlmSvc", "_Rcvr", "_Rcncltn", "_MsgRsn", "_Frmt", "_Card", "_Tkn", "_FileNm", "_Wllt", "_SctyTrlr", "_Orgtr", "_FileActnScp", "_LifeCyclId", "_AddtlFee", "_TxDesc", "_Pyee", "_Jursdctn", "_RspnCd", "_FileActnTp", "_CstmrDvc", "_PrtctdData", "_RtrvlRefNb", "_FileSctyCd", "_Crdhldr", "_POICmpnt", "_Sndr", "_Termnl"]
	@property
	def Prgrmm(self):
		return self._Prgrmm
