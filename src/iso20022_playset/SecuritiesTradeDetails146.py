...
class SecuritiesTradeDetails146(base_types._BaseFieldType):
	...
	__slots__ = ["_DealPric", "_Rptg", "_MtchgSts", "_TradTxCond", "_PlcOfClr", "_UnqTxIdr", "_LateDlvryDt", "_OpngClsg", "_AffirmSts", "_TradOrgtrRole", "_CollTxId", "_PlcOfTrad", "_FxAddtlDtls", "_TpOfPric", "_TradId", "_InvstrCpcty", "_NbOfDaysAcrd", "_CcyToBuyOrSell", "_TradDt", "_SttlmInstrPrcgAddtlDtls"]
	@property
	def DealPric(self):
