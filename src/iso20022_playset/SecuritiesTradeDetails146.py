...
class SecuritiesTradeDetails146(base_types._BaseFieldType):
	...
	__slots__ = ["_CcyToBuyOrSell", "_TpOfPric", "_LateDlvryDt", "_Rptg", "_DealPric", "_PlcOfTrad", "_AffirmSts", "_MtchgSts", "_OpngClsg", "_PlcOfClr", "_TradTxCond", "_NbOfDaysAcrd", "_TradDt", "_UnqTxIdr", "_FxAddtlDtls", "_TradId", "_CollTxId", "_TradOrgtrRole", "_InvstrCpcty", "_SttlmInstrPrcgAddtlDtls"]
	@property
