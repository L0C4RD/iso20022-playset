...
class FinancialResponseV04(base_types._BaseFieldType):
	...
	__slots__ = ["_ICCRltdData", "_SctyTrlr", "_Hdr", "_ConvsDtTm", "_Crdhldr", "_Issr", "_AddtlAmt", "_Rcncltn", "_AddtlFee", "_Tkn", "_Termnl", "_Orgtr", "_Prgrmm", "_Vrfctn", "_Wllt", "_Cntxt", "_AcctFr", "_Instlmt", "_PrtctdData", "_SplmtryData", "_AcctTo", "_PrcgRslt", "_Accptr", "_AdddmData", "_TxAmts", "_AcctBal", "_TxId", "_Acqrr", "_OrgnlDataElmts", "_StrngCstmrAuthntcn", "_AddtlData", "_Rcvr", "_Sndr", "_DsptData", "_SpclPrgrmmQlfctn", "_Dstn", "_TxChrtcs", "_AddtlSvc", "_Jursdctn", "_Rsk", "_Dcmnttn", "_Card", "_SttlmSvc"]
	@property
