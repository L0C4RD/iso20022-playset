...
class RetrievalInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Orgtr", "_ConvsDtTm", "_Tkn", "_Termnl", "_OrgnlTx", "_Jursdctn", "_Rcvr", "_SttlmSvc", "_PrtctdData", "_Card", "_SctyTrlr", "_PrcgRslt", "_SpclPrgrmmQlfctn", "_SplmtryData", "_Issr", "_Acqrr", "_Pyer", "_DsptData", "_RtrvlFlfmtDstn", "_Cntxt", "_Wllt", "_TxId", "_AddtlFee", "_Accptr", "_TxChrtcs", "_Pyee", "_Sndr", "_Prgrmm", "_Hdr", "_Rcncltn", "_AddtlData", "_RtrvlFlfmtInstrs", "_Dstn"]
	@property
	def Orgtr(self):
		return self._Orgtr
