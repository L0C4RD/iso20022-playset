...
class RetrievalInitiationV03(base_types._BaseFieldType):

	__slots__ = ["_Accptr", "_Acqrr", "_AddtlData", "_AddtlFee", "_Card", "_Cntxt", "_ConvsDtTm", "_DsptData", "_Dstn", "_Hdr", "_Issr", "_Jursdctn", "_OrgnlTx", "_Orgtr", "_PrcgRslt", "_Prgrmm", "_PrtctdData", "_Pyee", "_Pyer", "_Rcncltn", "_Rcvr", "_RtrvlFlfmtDstn", "_RtrvlFlfmtInstrs", "_SctyTrlr", "_Sndr", "_SpclPrgrmmQlfctn", "_SplmtryData", "_SttlmSvc", "_Termnl", "_Tkn", "_TxChrtcs", "_TxId", "_Wllt"]
	@property
	def Accptr(self):
		return self._Accptr
	...
	def Cntxt(self, value):
		self._Cntxt = value if value is not None else base_types.UninitialisedField(self, 'Cntxt', Context24, False)

	@Cntxt.deleter
	def Cntxt(self):
		del self._Cntxt
		self._Cntxt = base_types.UninitialisedField(self, 'Cntxt', Context24, False)
	...
	def OrgnlTx(self, value):
		self._OrgnlTx = value if value is not None else base_types.UninitialisedField(self, 'OrgnlTx', OriginalTransaction3, False)

	@OrgnlTx.deleter
	def OrgnlTx(self):
		del self._OrgnlTx
		self._OrgnlTx = base_types.UninitialisedField(self, 'OrgnlTx', OriginalTransaction3, False)
	...
	def PrcgRslt(self, value):
		self._PrcgRslt = value if value is not None else base_types.UninitialisedField(self, 'PrcgRslt', ProcessingResult25, False)

	@PrcgRslt.deleter
	def PrcgRslt(self):
		del self._PrcgRslt
		self._PrcgRslt = base_types.UninitialisedField(self, 'PrcgRslt', ProcessingResult25, False)
	...
	@property
	def RtrvlFlfmtDstn(self):
		return self._RtrvlFlfmtDstn

	@RtrvlFlfmtDstn.setter
	def RtrvlFlfmtDstn(self, value):
		self._RtrvlFlfmtDstn = value if value is not None else base_types.UninitialisedField(self, 'RtrvlFlfmtDstn', PartyIdentification285, False)

	@RtrvlFlfmtDstn.deleter
	def RtrvlFlfmtDstn(self):
		del self._RtrvlFlfmtDstn
		self._RtrvlFlfmtDstn = base_types.UninitialisedField(self, 'RtrvlFlfmtDstn', PartyIdentification285, False)

	@property
	def RtrvlFlfmtInstrs(self):
		return self._RtrvlFlfmtInstrs

	@RtrvlFlfmtInstrs.setter
	def RtrvlFlfmtInstrs(self, value):
		self._RtrvlFlfmtInstrs = value if value is not None else base_types.UninitialisedField(self, 'RtrvlFlfmtInstrs', RetrievalFulfilmentInstructions3, True)

	@RtrvlFlfmtInstrs.deleter
	def RtrvlFlfmtInstrs(self):
		del self._RtrvlFlfmtInstrs
		self._RtrvlFlfmtInstrs = base_types.UninitialisedField(self, 'RtrvlFlfmtInstrs', RetrievalFulfilmentInstructions3, True)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='Cntxt', type=Context24, min=0, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='Hdr', type=Header71, min=0, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='RtrvlFlfmtDstn', type=PartyIdentification285, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='RtrvlFlfmtInstrs', type=RetrievalFulfilmentInstructions3, min=0, max=None, mutex_group=None, array=True),
