...
from .AggregateBalanceInformation44 import AggregateBalanceInformation44
from .Intermediary45 import Intermediary45
from .Statement77 import Statement77
...
from .SubAccountIdentification69 import SubAccountIdentification69
from .TotalValueInPageAndStatement3 import TotalValueInPageAndStatement3

class SecuritiesBalanceCustodyReport002V11(base_types._BaseFieldType):

	__slots__ = ["_AcctBaseCcyTtlAmts", "_SfkpgAcct", "_AcctOwnr", "_Pgntn", "_AcctSvcr", "_StmtGnlDtls", "_IntrmyInf", "_BlckChainAdrOrWllt", "_BalForAcct", "_SubAcctDtls"]
	@property
