...
from . import InvestmentFundOrder14
from . import Max35Text
from . import MessageIdentification1
from . import YesNoIndicator

class RedemptionBulkOrderConfirmationCancellationInstructionV03(base_types._BaseFieldType):
	...
	def OrdrRefs(self, value):
		self._OrdrRefs = value if value is not None else base_types.UninitialisedField(self, 'OrdrRefs', InvestmentFundOrder14, True)

	@OrdrRefs.deleter
	def OrdrRefs(self):
		del self._OrdrRefs
		self._OrdrRefs = base_types.UninitialisedField(self, 'OrdrRefs', InvestmentFundOrder14, True)
