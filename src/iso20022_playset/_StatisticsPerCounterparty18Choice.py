...
from . import DetailedStatisticsPerCounterparty19
...
class StatisticsPerCounterparty18Choice(base_types._BaseFieldType):
	...
	@Rpt.setter
	def Rpt(self, value):
		self._Rpt = value if value is not None else base_types.UninitialisedField(self, 'Rpt', DetailedStatisticsPerCounterparty19, False)

	@Rpt.deleter
	def Rpt(self):
		del self._Rpt
		self._Rpt = base_types.UninitialisedField(self, 'Rpt', DetailedStatisticsPerCounterparty19, False)
