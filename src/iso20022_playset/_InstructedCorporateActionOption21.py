...
from . import OptionInstructionDetails11
...
class InstructedCorporateActionOption21(base_types._BaseFieldType):
	...
	def OptnInstrDtls(self, value):
		self._OptnInstrDtls = value if value is not None else base_types.UninitialisedField(self, 'OptnInstrDtls', OptionInstructionDetails11, True)

	@OptnInstrDtls.deleter
	def OptnInstrDtls(self):
		del self._OptnInstrDtls
		self._OptnInstrDtls = base_types.UninitialisedField(self, 'OptnInstrDtls', OptionInstructionDetails11, True)
