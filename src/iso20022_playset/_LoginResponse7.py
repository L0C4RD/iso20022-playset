...
class LoginResponse7(base_types._BaseFieldType):
	...
	def POISftwr(self, value):
		self._POISftwr = value if value is not None else base_types.UninitialisedField(self, 'POISftwr', PointOfInteractionComponent17, True)

	@POISftwr.deleter
	def POISftwr(self):
		del self._POISftwr
		self._POISftwr = base_types.UninitialisedField(self, 'POISftwr', PointOfInteractionComponent17, True)
