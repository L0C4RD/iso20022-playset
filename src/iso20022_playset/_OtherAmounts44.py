...
class OtherAmounts44(base_types._BaseFieldType):
	...
	__slots__ = ["_AcrdCptlstnAmt", "_AcrdIntrstAmt", "_BookVal", "_ChrgsFees", "_CollMntrAmt", "_CsmptnTax", "_CtryNtlFdrlTax", "_ExctgBrkrAmt", "_IsseDscntAllwnc", "_LclBrkrComssn", "_LclTax", "_LclTaxCtrySpcfc", "_Mrgn", "_NetGnLoss", "_Othr", "_PmtLevyTax", "_RgltryAmt", "_RsrchFee", "_ShppgAmt", "_SpclCncssn", "_StmpDty", "_StockXchgTax", "_TradAmt", "_TrfTax", "_TxTax", "_ValAddedTax", "_WhldgTax"]
	@property
	...
	def CollMntrAmt(self, value):
		self._CollMntrAmt = value if value is not None else base_types.UninitialisedField(self, 'CollMntrAmt', AmountAndDirection58, False)

	@CollMntrAmt.deleter
	def CollMntrAmt(self):
		del self._CollMntrAmt
		self._CollMntrAmt = base_types.UninitialisedField(self, 'CollMntrAmt', AmountAndDirection58, False)
	...
	def LclTaxCtrySpcfc(self, value):
		self._LclTaxCtrySpcfc = value if value is not None else base_types.UninitialisedField(self, 'LclTaxCtrySpcfc', AmountAndDirection58, False)

	@LclTaxCtrySpcfc.deleter
	def LclTaxCtrySpcfc(self):
		del self._LclTaxCtrySpcfc
		self._LclTaxCtrySpcfc = base_types.UninitialisedField(self, 'LclTaxCtrySpcfc', AmountAndDirection58, False)
