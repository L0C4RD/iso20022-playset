...
class SecuritiesTransactionReport7(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlAttrbts", "_OrdrTrnsmssn", "_SplmtryData", "_Tx", "_TxId", "_ExctgPrsn", "_InvstmtPtyInd", "_InvstmtDcsnPrsn", "_Sellr", "_SubmitgPty", "_Buyr", "_ExctgPty", "_TechAttrbts", "_FinInstrm"]
	@property
