...
class VehicleRentalInvoice3(base_types._BaseFieldType):
	...
	__slots__ = ["_ClssPrvdd", "_ChckOutDt", "_NoShow", "_RtrLctn", "_ClssInvcd", "_MakeInvcd", "_DstncRate", "_Insrnc", "_ChckOutTm", "_OdmtrRtr", "_MdlPrvdd", "_Drtn", "_FreeDstnc", "_RegnNbInvcd", "_MdlInvcd", "_AddtlAmt", "_Adjstd", "_MakePrvdd", "_SummryCmmdtyId", "_RegnNbPrvdd", "_Chrg", "_Tax", "_OdmtrStart", "_DstncUnit", "_TtlDstnc", "_ChckInTm", "_ChckInDt"]
	@property
	def ClssPrvdd(self):
