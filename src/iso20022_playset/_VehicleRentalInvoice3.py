...
class VehicleRentalInvoice3(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlDstnc", "_Tax", "_RtrLctn", "_ChckOutDt", "_DstncRate", "_ClssInvcd", "_RegnNbPrvdd", "_OdmtrStart", "_NoShow", "_OdmtrRtr", "_ChckInDt", "_RegnNbInvcd", "_AddtlAmt", "_ChckInTm", "_ChckOutTm", "_MakePrvdd", "_FreeDstnc", "_Insrnc", "_MdlInvcd", "_MakeInvcd", "_Adjstd", "_MdlPrvdd", "_DstncUnit", "_SummryCmmdtyId", "_ClssPrvdd", "_Drtn", "_Chrg"]
	@property
	def TtlDstnc(self):
