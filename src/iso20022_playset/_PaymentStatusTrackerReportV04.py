...
from . import TrackerStatusAndTransaction21

class PaymentStatusTrackerReportV04(base_types._BaseFieldType):
	...
	def TrckrStsAndTx(self, value):
		self._TrckrStsAndTx = value if value is not None else base_types.UninitialisedField(self, 'TrckrStsAndTx', TrackerStatusAndTransaction21, True)

	@TrckrStsAndTx.deleter
	def TrckrStsAndTx(self):
		del self._TrckrStsAndTx
		self._TrckrStsAndTx = base_types.UninitialisedField(self, 'TrckrStsAndTx', TrackerStatusAndTransaction21, True)
