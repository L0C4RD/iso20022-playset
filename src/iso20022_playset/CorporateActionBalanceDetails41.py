...
class CorporateActionBalanceDetails41(base_types._BaseFieldType):
	...
	__slots__ = ["_RegdBal", "_CollInBal", "_PdgRctBal", "_ConfdBal", "_TtlElgblBal", "_BlckdBal", "_SttlmPosBal", "_StrtPosBal", "_BrrwdBal", "_OutForRegnBal", "_OnLnBal", "_CollOutBal", "_UafctdBal", "_TradDtPosBal", "_InTrnsShipmntBal", "_PdgDlvryBal", "_AfctdBal"]
	@property
	def RegdBal(self):
