...
class CorporateActionBalanceDetails41(base_types._BaseFieldType):
	...
	__slots__ = ["_CollOutBal", "_OutForRegnBal", "_ConfdBal", "_AfctdBal", "_StrtPosBal", "_CollInBal", "_PdgRctBal", "_SttlmPosBal", "_RegdBal", "_OnLnBal", "_BlckdBal", "_TtlElgblBal", "_UafctdBal", "_BrrwdBal", "_PdgDlvryBal", "_InTrnsShipmntBal", "_TradDtPosBal"]
	@property
	def CollOutBal(self):
