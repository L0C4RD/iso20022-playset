...
class CorporateActionBalanceDetails41(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmPosBal", "_PdgDlvryBal", "_CollInBal", "_PdgRctBal", "_RegdBal", "_TtlElgblBal", "_StrtPosBal", "_TradDtPosBal", "_OutForRegnBal", "_BlckdBal", "_UafctdBal", "_AfctdBal", "_ConfdBal", "_OnLnBal", "_BrrwdBal", "_InTrnsShipmntBal", "_CollOutBal"]
	@property
