...
class CorporateActionBalanceDetails41(base_types._BaseFieldType):
	...
	__slots__ = ["_ConfdBal", "_TradDtPosBal", "_RegdBal", "_OnLnBal", "_SttlmPosBal", "_OutForRegnBal", "_UafctdBal", "_TtlElgblBal", "_StrtPosBal", "_BrrwdBal", "_CollOutBal", "_PdgRctBal", "_InTrnsShipmntBal", "_BlckdBal", "_CollInBal", "_AfctdBal", "_PdgDlvryBal"]
	@property
	def ConfdBal(self):
