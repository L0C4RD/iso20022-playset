...
class CorporateActionBalanceDetails41(base_types._BaseFieldType):
	...
	__slots__ = ["_BrrwdBal", "_StrtPosBal", "_ConfdBal", "_PdgRctBal", "_OutForRegnBal", "_AfctdBal", "_PdgDlvryBal", "_InTrnsShipmntBal", "_CollInBal", "_BlckdBal", "_SttlmPosBal", "_TradDtPosBal", "_CollOutBal", "_RegdBal", "_UafctdBal", "_OnLnBal", "_TtlElgblBal"]
	@property
	def BrrwdBal(self):
