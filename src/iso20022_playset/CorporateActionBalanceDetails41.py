...
class CorporateActionBalanceDetails41(base_types._BaseFieldType):
	...
	__slots__ = ["_AfctdBal", "_OnLnBal", "_RegdBal", "_BlckdBal", "_InTrnsShipmntBal", "_TradDtPosBal", "_PdgDlvryBal", "_CollInBal", "_SttlmPosBal", "_BrrwdBal", "_StrtPosBal", "_PdgRctBal", "_UafctdBal", "_TtlElgblBal", "_CollOutBal", "_OutForRegnBal", "_ConfdBal"]
	@property
	def AfctdBal(self):
