...
class SecurityOption1(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlQtyForExstgScties", "_AddtlQtyForSbcbdRsltntScties", "_NewBrdLotSctiesQty", "_CdtDbtInd", "_MinExrcblMltplSctiesQty", "_DtDtls", "_SctiesQty", "_SctyId", "_ShrRnkg", "_FrctnDspstn", "_NewDnmtnSctiesQty", "_PricDtls", "_TempFinInstrmInd", "_MinExrcblSctiesQty", "_TradgPrd"]
	@property
