...
class SecurityOption1(base_types._BaseFieldType):
	...
	__slots__ = ["_FrctnDspstn", "_MinExrcblSctiesQty", "_SctiesQty", "_CdtDbtInd", "_NewDnmtnSctiesQty", "_AddtlQtyForSbcbdRsltntScties", "_TradgPrd", "_DtDtls", "_PricDtls", "_TempFinInstrmInd", "_SctyId", "_ShrRnkg", "_AddtlQtyForExstgScties", "_MinExrcblMltplSctiesQty", "_NewBrdLotSctiesQty"]
	@property
