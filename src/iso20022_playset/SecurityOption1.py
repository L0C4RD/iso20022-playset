...
class SecurityOption1(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlQtyForSbcbdRsltntScties", "_TradgPrd", "_SctyId", "_MinExrcblSctiesQty", "_AddtlQtyForExstgScties", "_FrctnDspstn", "_DtDtls", "_PricDtls", "_NewBrdLotSctiesQty", "_SctiesQty", "_ShrRnkg", "_MinExrcblMltplSctiesQty", "_NewDnmtnSctiesQty", "_CdtDbtInd", "_TempFinInstrmInd"]
	@property
