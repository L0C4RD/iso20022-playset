...
from .CorporateActionDate3 import CorporateActionDate3
from .UnitOrFaceAmount1Choice import UnitOrFaceAmount1Choice
from .ShareRanking1FormatChoice import ShareRanking1FormatChoice
...
from .CorporateActionPrice4 import CorporateActionPrice4

class SecurityOption1(base_types._BaseFieldType):

	__slots__ = ["_MinExrcblMltplSctiesQty", "_AddtlQtyForExstgScties", "_TradgPrd", "_AddtlQtyForSbcbdRsltntScties", "_CdtDbtInd", "_FrctnDspstn", "_NewBrdLotSctiesQty", "_ShrRnkg", "_SctyId", "_NewDnmtnSctiesQty", "_TempFinInstrmInd", "_PricDtls", "_SctiesQty", "_MinExrcblSctiesQty", "_DtDtls"]
	@property
	...
	def ShrRnkg(self, value):
		self._ShrRnkg = value if type(value) != auto else self.make_default("ShrRnkg")
