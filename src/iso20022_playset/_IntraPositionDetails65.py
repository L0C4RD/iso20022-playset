...
class IntraPositionDetails65(base_types._BaseFieldType):
	...
	__slots__ = ["_CollMntrAmt", "_PrevslySttldQty", "_SctiesSubBalId", "_BalFr", "_SttldQty", "_RmngToBeSttldQty", "_CorpActnEvtTp", "_SttlmDt", "_BalTo", "_InstrPrcgAddtlDtls", "_AvlblDt"]
	@property
