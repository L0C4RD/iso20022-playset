...
class IntraPositionDetails65(base_types._BaseFieldType):
	...
	__slots__ = ["_PrevslySttldQty", "_AvlblDt", "_SttlmDt", "_SttldQty", "_InstrPrcgAddtlDtls", "_CorpActnEvtTp", "_SctiesSubBalId", "_BalTo", "_BalFr", "_RmngToBeSttldQty", "_CollMntrAmt"]
	@property
