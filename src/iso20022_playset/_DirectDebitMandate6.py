...
from ._BranchData import BranchData
...
class DirectDebitMandate6(base_types._BaseFieldType):
	...
	__slots__ = ["_Dbtr", "_DbtrTaxIdNb", "_DbtrNtlRegnNb", "_CdtrAgtBrnch", "_Cdtr", "_RegnId", "_DbtrAgtBrnch", "_DbtrAcct", "_CdtrAgt", "_MndtId", "_DbtrAgt"]
	@property
	def Dbtr(self):
		return self._Dbtr
