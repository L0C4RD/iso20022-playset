...
class FullPushThroughReportV05(base_types._BaseFieldType):
	...
	__slots__ = ["_SellrCtctPrsn", "_TxSts", "_EstblishdBaselnId", "_RptId", "_RptPurp", "_BuyrCtctPrsn", "_BuyrBkCtctPrsn", "_SellrBkCtctPrsn", "_TxId", "_OthrBkCtctPrsn", "_ReqForActn", "_PushdThrghBaseln", "_UsrTxRef"]
	@property
