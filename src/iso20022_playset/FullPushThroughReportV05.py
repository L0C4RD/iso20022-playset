...
class FullPushThroughReportV05(base_types._BaseFieldType):
	...
	__slots__ = ["_UsrTxRef", "_BuyrCtctPrsn", "_PushdThrghBaseln", "_ReqForActn", "_TxId", "_EstblishdBaselnId", "_RptPurp", "_SellrBkCtctPrsn", "_RptId", "_OthrBkCtctPrsn", "_BuyrBkCtctPrsn", "_TxSts", "_SellrCtctPrsn"]
	@property
	def UsrTxRef(self):
