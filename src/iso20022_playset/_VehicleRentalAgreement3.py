...
class VehicleRentalAgreement3(base_types._BaseFieldType):
	...
	__slots__ = ["_Clss", "_RntlDtls", "_RtrLctn", "_LltyPrgrmm", "_PckpLctn", "_ChckOutDt", "_RntlLctn", "_Nb", "_RntlRate", "_AddtlAmt", "_ChckInTm", "_ChckInDt", "_ChckOutTm", "_RegnNb", "_TrvlDstnc", "_EstmtdTax", "_Insrnc", "_DscntPrgrmm", "_Adjstd", "_Drtn", "_Mdl", "_Make"]
	@property
	def Clss(self):
		return self._Clss
