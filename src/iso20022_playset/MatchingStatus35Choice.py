...
class MatchingStatus35Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_MtchdWthTlrnce", "_Mtchd", "_Umtchd", "_MtchgAllgd", "_PrtrySts"]
	@property
	...
	def MtchdWthTlrnce(self, value):
		self._MtchdWthTlrnce = value if type(value) != base_types.auto else self.make_default("MtchdWthTlrnce")
