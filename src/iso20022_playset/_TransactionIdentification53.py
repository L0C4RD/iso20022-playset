...
class TransactionIdentification53(base_types._BaseFieldType):
	...
	__slots__ = ["_AuthstnSeqNb", "_RtrvlRefNb", "_LifeCyclId", "_AcqrrRefNb", "_OthrPurchsIdrTp", "_PresntmntSeqCnt", "_LifeCyclSpprt", "_PresntmntSeqNb", "_PurchsIdr", "_TrnsmssnDtTm", "_AcqrrRefData", "_IssrRefData", "_AssoctdDataRef", "_SysTracAudtNb", "_AuthntcnTkn", "_PurchsIdrTp"]
	@property
