...
class TransactionIdentification53(base_types._BaseFieldType):
	...
	__slots__ = ["_PurchsIdr", "_AuthstnSeqNb", "_PurchsIdrTp", "_AuthntcnTkn", "_OthrPurchsIdrTp", "_IssrRefData", "_LifeCyclId", "_AssoctdDataRef", "_SysTracAudtNb", "_PresntmntSeqNb", "_RtrvlRefNb", "_LifeCyclSpprt", "_AcqrrRefData", "_AcqrrRefNb", "_PresntmntSeqCnt", "_TrnsmssnDtTm"]
	@property
