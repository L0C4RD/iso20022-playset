...
class TransactionDetails173(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmDt", "_Pmt", "_SfkpgAcct", "_SttlmQty", "_Invstr", "_FinInstrmId", "_SttlmAmt", "_BlckChainAdrOrWllt", "_TradDt", "_DlvrgSttlmPties", "_RcvgSttlmPties", "_SctiesMvmntTp"]
	@property
	def SttlmDt(self):
