...
class TransactionDetails173(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmDt", "_SttlmQty", "_DlvrgSttlmPties", "_FinInstrmId", "_SctiesMvmntTp", "_TradDt", "_Pmt", "_RcvgSttlmPties", "_BlckChainAdrOrWllt", "_Invstr", "_SttlmAmt", "_SfkpgAcct"]
	@property
	def SttlmDt(self):
