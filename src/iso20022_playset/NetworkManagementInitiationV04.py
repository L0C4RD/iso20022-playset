...
class NetworkManagementInitiationV04(base_types._BaseFieldType):
	...
	__slots__ = ["_Jursdctn", "_SplmtryData", "_AddtlData", "_MaxNbOfMsgs", "_Hdr", "_SttlmSvc", "_SysTracAudtNb", "_NtwkMgmtTp", "_OrgnlRspnCd", "_RtrvlRefNb", "_Prgrmm", "_TrnsmssnDtTm", "_AltrnMsgRsn", "_TxDesc", "_Rcncltn", "_PrcgRslt", "_SctyTrlr", "_MsgRsn", "_NbOfMsgs", "_LifeCyclId", "_AddtlFee", "_OthrNtwkMgmtTp"]
	@property
	def Jursdctn(self):
