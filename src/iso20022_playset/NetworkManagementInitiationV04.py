...
class NetworkManagementInitiationV04(base_types._BaseFieldType):
	...
	__slots__ = ["_RtrvlRefNb", "_AddtlData", "_SctyTrlr", "_Hdr", "_NbOfMsgs", "_OrgnlRspnCd", "_PrcgRslt", "_Jursdctn", "_MaxNbOfMsgs", "_Prgrmm", "_SysTracAudtNb", "_TrnsmssnDtTm", "_AddtlFee", "_SttlmSvc", "_Rcncltn", "_OthrNtwkMgmtTp", "_TxDesc", "_SplmtryData", "_AltrnMsgRsn", "_NtwkMgmtTp", "_LifeCyclId", "_MsgRsn"]
	@property
	def RtrvlRefNb(self):
