...
class PointOfInteractionCapabilities10(base_types._BaseFieldType):
	...
	__slots__ = ["_IntractvTxs", "_CardRdData", "_ApprvlCdLngth", "_MxScrptLngth", "_MsgCpblties", "_RctPrtg", "_Authntcn", "_CardCaptrCpbl", "_WdrwlMdia", "_CardWrtData", "_PINLngthCpblties", "_DpstdMdia"]
	@property
