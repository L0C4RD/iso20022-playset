...
class PointOfInteractionCapabilities10(base_types._BaseFieldType):
	...
	__slots__ = ["_IntractvTxs", "_CardCaptrCpbl", "_CardRdData", "_Authntcn", "_PINLngthCpblties", "_CardWrtData", "_MsgCpblties", "_RctPrtg", "_WdrwlMdia", "_MxScrptLngth", "_ApprvlCdLngth", "_DpstdMdia"]
	@property
