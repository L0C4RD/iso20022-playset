...
from . import StandingSettlementInstructionV01
...
class REDA_056_001_01():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def StgSttlmInstr(self, value):
			self._StgSttlmInstr = value if value is not None else base_types.UninitialisedField(self, 'StgSttlmInstr', StandingSettlementInstructionV01, False)

		@StgSttlmInstr.deleter
		def StgSttlmInstr(self):
			del self._StgSttlmInstr
			self._StgSttlmInstr = base_types.UninitialisedField(self, 'StgSttlmInstr', StandingSettlementInstructionV01, False)
