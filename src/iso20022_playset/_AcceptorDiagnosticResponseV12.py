...
from . import AcceptorDiagnosticResponse11
...
class AcceptorDiagnosticResponseV12(base_types._BaseFieldType):
	...
	def DgnstcRspn(self, value):
		self._DgnstcRspn = value if value is not None else base_types.UninitialisedField(self, 'DgnstcRspn', AcceptorDiagnosticResponse11, False)

	@DgnstcRspn.deleter
	def DgnstcRspn(self):
		del self._DgnstcRspn
		self._DgnstcRspn = base_types.UninitialisedField(self, 'DgnstcRspn', AcceptorDiagnosticResponse11, False)
