...
class Standardisation3Choice(base_types._BaseFieldType):
	...
	@Cd.setter
	def Cd(self, value):
		self._Cd = value if value is not None else base_types.UninitialisedField(self, 'Cd', Standardisation1Code, True)

	@Cd.deleter
	def Cd(self):
		del self._Cd
		self._Cd = base_types.UninitialisedField(self, 'Cd', Standardisation1Code, True)
	...
	_field_defs = frozenset((
		base_types.FieldEntry(name='Cd', type=Standardisation1Code, min=1, max=None, mutex_group=1, array=True),
