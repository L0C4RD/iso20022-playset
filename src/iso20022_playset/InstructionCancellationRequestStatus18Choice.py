...
from .RejectedStatus54Choice import RejectedStatus54Choice
from .CancelledStatus14Choice import CancelledStatus14Choice
from .PendingCancellationStatus15Choice import PendingCancellationStatus15Choice

class InstructionCancellationRequestStatus18Choice(base_types._BaseFieldType):

	__slots__ = ["_PrtrySts", "_CxlCmpltd", "_Rjctd", "_PdgCxl", "_Accptd"]
	@property
	def PrtrySts(self):
