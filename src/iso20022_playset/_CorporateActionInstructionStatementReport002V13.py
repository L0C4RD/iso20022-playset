...
from . import AccountIdentification74
from . import Pagination1
from . import Statement75
...
class CorporateActionInstructionStatementReport002V13(base_types._BaseFieldType):
	...
	def AcctAndStmtDtls(self, value):
		self._AcctAndStmtDtls = value if value is not None else base_types.UninitialisedField(self, 'AcctAndStmtDtls', AccountIdentification74, True)

	@AcctAndStmtDtls.deleter
	def AcctAndStmtDtls(self):
		del self._AcctAndStmtDtls
		self._AcctAndStmtDtls = base_types.UninitialisedField(self, 'AcctAndStmtDtls', AccountIdentification74, True)
	...
	def StmtGnlDtls(self, value):
		self._StmtGnlDtls = value if value is not None else base_types.UninitialisedField(self, 'StmtGnlDtls', Statement75, False)

	@StmtGnlDtls.deleter
	def StmtGnlDtls(self):
		del self._StmtGnlDtls
		self._StmtGnlDtls = base_types.UninitialisedField(self, 'StmtGnlDtls', Statement75, False)
