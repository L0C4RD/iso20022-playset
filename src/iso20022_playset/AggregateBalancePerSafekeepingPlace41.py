...
class AggregateBalancePerSafekeepingPlace41(base_types._BaseFieldType):
	...
	__slots__ = ["_Pldgee", "_AvlblBal", "_NotAvlblBal", "_PlcOfListg", "_XpsrTp", "_AggtBal", "_PricDtls", "_AcctBaseCcyAmts", "_BalBrkdwn", "_QtyBrkdwn", "_SfkpgPlc", "_FXDtls", "_DaysAcrd", "_AddtlBalBrkdwn", "_InstrmCcyAmts", "_HldgAddtlDtls"]
	@property
	def Pldgee(self):
		return self._Pldgee
