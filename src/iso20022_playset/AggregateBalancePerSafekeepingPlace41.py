...
class AggregateBalancePerSafekeepingPlace41(base_types._BaseFieldType):
	...
	__slots__ = ["_AggtBal", "_NotAvlblBal", "_XpsrTp", "_HldgAddtlDtls", "_AcctBaseCcyAmts", "_PricDtls", "_AddtlBalBrkdwn", "_QtyBrkdwn", "_SfkpgPlc", "_PlcOfListg", "_DaysAcrd", "_Pldgee", "_FXDtls", "_BalBrkdwn", "_AvlblBal", "_InstrmCcyAmts"]
	@property
	def AggtBal(self):
