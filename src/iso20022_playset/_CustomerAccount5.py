...
class CustomerAccount5(base_types._BaseFieldType):
	...
	__slots__ = ["_FlrNtfctnAmt", "_MnthlyRcvdVal", "_Tp", "_Ccy", "_StmtFrqcyAndFrmt", "_Nm", "_AvrgBal", "_ClngNtfctnAmt", "_MnthlyTxNb", "_Id", "_MnthlyPmtVal", "_ClsgDt", "_AcctPurp", "_Rstrctn", "_Sts"]
	@property
