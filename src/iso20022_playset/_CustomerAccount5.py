...
class CustomerAccount5(base_types._BaseFieldType):
	...
	__slots__ = ["_FlrNtfctnAmt", "_AvrgBal", "_Sts", "_Tp", "_MnthlyRcvdVal", "_Ccy", "_MnthlyPmtVal", "_MnthlyTxNb", "_Rstrctn", "_StmtFrqcyAndFrmt", "_ClsgDt", "_ClngNtfctnAmt", "_AcctPurp", "_Nm", "_Id"]
	@property
