...
class SubscriptionBulkExecution4(base_types._BaseFieldType):
	...
	__slots__ = ["_OrdrDtTm", "_TtlSttlmAmt", "_PlcOfTrad", "_ReqdFutrTradDt", "_AmdmntInd", "_ReqdSttlmCcy", "_FinInstrmDtls", "_CxlRght", "_RcvdDtTm", "_MstrRef", "_ReqdNAVCcy", "_IndvExctnDtls", "_BlkCshSttlmDtls"]
	@property
	def OrdrDtTm(self):
