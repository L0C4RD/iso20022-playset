...
class SubscriptionBulkExecution4(base_types._BaseFieldType):
	...
	__slots__ = ["_ReqdFutrTradDt", "_TtlSttlmAmt", "_BlkCshSttlmDtls", "_ReqdNAVCcy", "_OrdrDtTm", "_RcvdDtTm", "_ReqdSttlmCcy", "_PlcOfTrad", "_AmdmntInd", "_MstrRef", "_FinInstrmDtls", "_IndvExctnDtls", "_CxlRght"]
	@property
