...
from .FinancialInstrumentAttributes131 import FinancialInstrumentAttributes131
from .CorporateActionRate128 import CorporateActionRate128
...
from .CorporateActionPrice89 import CorporateActionPrice89
...
class SecuritiesOption113(base_types._BaseFieldType):
	...
	__slots__ = ["_NewSctiesIssncInd", "_FrctnDspstn", "_XmptnTp", "_RateDtls", "_CdtDbtInd", "_TempFinInstrmInd", "_DtDtls", "_NonElgblPrcdsInd", "_TradgPrd", "_IssrOfferrTaxbltyInd", "_CcyOptn", "_SfkpgPlc", "_SctyDtls", "_OthrIncmTp", "_AmtDtls", "_CtryOfIncmSrc", "_PricDtls", "_IncmTp", "_EntitldQty"]
	@property
