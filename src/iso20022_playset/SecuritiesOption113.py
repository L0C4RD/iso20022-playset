...
class SecuritiesOption113(base_types._BaseFieldType):
	...
	__slots__ = ["_IssrOfferrTaxbltyInd", "_SctyDtls", "_AmtDtls", "_RateDtls", "_CcyOptn", "_IncmTp", "_XmptnTp", "_DtDtls", "_CtryOfIncmSrc", "_TradgPrd", "_CdtDbtInd", "_NonElgblPrcdsInd", "_EntitldQty", "_SfkpgPlc", "_FrctnDspstn", "_TempFinInstrmInd", "_NewSctiesIssncInd", "_OthrIncmTp", "_PricDtls"]
	@property
