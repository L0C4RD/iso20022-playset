...
class Rate45(base_types._BaseFieldType):
	...
	__slots__ = ["_SlctnFeeRate", "_GrssIntrstRateUsdForPmt", "_WhldgTaxRate", "_TaxOnPrfts", "_EarlySlctnFeeRate", "_TaxCdtRate", "_NetDstrbtnRate", "_AplblRate", "_FsclStmp", "_AddtlTax", "_ThrdPtyIncntivRate", "_ScndLvlTax", "_EqulstnRate", "_ChrgsFees", "_DmdRate", "_GrssDstrbtnRate", "_TaxRclmRate", "_TaxOnIncm"]
	@property
