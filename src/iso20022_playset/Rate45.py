...
class Rate45(base_types._BaseFieldType):
	...
	__slots__ = ["_TaxOnPrfts", "_ChrgsFees", "_TaxRclmRate", "_DmdRate", "_SlctnFeeRate", "_TaxOnIncm", "_GrssDstrbtnRate", "_ThrdPtyIncntivRate", "_EarlySlctnFeeRate", "_ScndLvlTax", "_FsclStmp", "_TaxCdtRate", "_AddtlTax", "_NetDstrbtnRate", "_GrssIntrstRateUsdForPmt", "_WhldgTaxRate", "_AplblRate", "_EqulstnRate"]
	@property
	def TaxOnPrfts(self):
