...
class Rate45(base_types._BaseFieldType):
	...
	__slots__ = ["_GrssDstrbtnRate", "_AplblRate", "_WhldgTaxRate", "_ScndLvlTax", "_SlctnFeeRate", "_EqulstnRate", "_EarlySlctnFeeRate", "_NetDstrbtnRate", "_TaxOnIncm", "_FsclStmp", "_ThrdPtyIncntivRate", "_TaxRclmRate", "_AddtlTax", "_ChrgsFees", "_TaxOnPrfts", "_DmdRate", "_TaxCdtRate", "_GrssIntrstRateUsdForPmt"]
	@property
