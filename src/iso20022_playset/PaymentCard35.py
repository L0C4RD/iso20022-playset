...
class PaymentCard35(base_types._BaseFieldType):
	...
	__slots__ = ["_SvcOptn", "_CardPdctTp", "_AddtlCardData", "_AllwdPdct", "_CardPdctPrfl", "_CardCcyCd", "_CardCtryCd", "_CardPdctSubTp", "_MskdPAN", "_PrvtCardData", "_PmtAcctRef", "_PlainCardData", "_IssrBIN", "_CardBrnd", "_PrtctdCardData", "_IntrnlCard"]
	@property
	def SvcOptn(self):
