...
from .Exact3AlphaNumericText import Exact3AlphaNumericText
...
from .PlainCardData22 import PlainCardData22
from .TrueFalseIndicator import TrueFalseIndicator
from .CardProductType1Code import CardProductType1Code
from .Max3Text import Max3Text

class PaymentCard35(base_types._BaseFieldType):

	__slots__ = ["_CardPdctTp", "_CardBrnd", "_CardCtryCd", "_CardPdctPrfl", "_IntrnlCard", "_PlainCardData", "_CardPdctSubTp", "_PrvtCardData", "_PmtAcctRef", "_SvcOptn", "_CardCcyCd", "_MskdPAN", "_AddtlCardData", "_AllwdPdct", "_IssrBIN", "_PrtctdCardData"]
	@property
	def CardPdctTp(self):
