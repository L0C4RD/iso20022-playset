...
class PaymentCard35(base_types._BaseFieldType):
	...
	__slots__ = ["_PlainCardData", "_AllwdPdct", "_CardPdctTp", "_AddtlCardData", "_PmtAcctRef", "_CardPdctPrfl", "_CardBrnd", "_PrvtCardData", "_PrtctdCardData", "_IntrnlCard", "_CardCcyCd", "_MskdPAN", "_CardCtryCd", "_IssrBIN", "_SvcOptn", "_CardPdctSubTp"]
	@property
