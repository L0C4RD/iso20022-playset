...
class CorporateActionOption247(base_types._BaseFieldType):
	...
	__slots__ = ["_ChngAllwdInd", "_SctiesMvmntDtls", "_RateAndAmtDtls", "_AccptncPrtyLvl", "_AddtlInf", "_OptnFeatrs", "_WdrwlAllwdInd", "_CertfctnBrkdwnInd", "_DtDtls", "_PricDtls", "_FrctnDspstn", "_DfltPrcgOrStgInstr", "_BidRgTp", "_FinInstrmId", "_OptnAvlbtySts", "_ApldOptnInd", "_ChrgsApldInd", "_SctiesQty", "_OptnTp", "_PrdDtls", "_PrratnBlwMinQty", "_NonDmclCtry", "_CshMvmntDtls", "_CertfctnBrkdwnTp", "_CcyOptn", "_VldDmclCtry", "_OptnNb", "_OfferTp"]
	@property
