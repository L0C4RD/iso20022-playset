...
class CorporateActionOption247(base_types._BaseFieldType):
	...
	__slots__ = ["_PrdDtls", "_SctiesQty", "_OfferTp", "_DfltPrcgOrStgInstr", "_CcyOptn", "_FrctnDspstn", "_ChngAllwdInd", "_FinInstrmId", "_ApldOptnInd", "_OptnAvlbtySts", "_SctiesMvmntDtls", "_CshMvmntDtls", "_NonDmclCtry", "_OptnTp", "_WdrwlAllwdInd", "_ChrgsApldInd", "_OptnFeatrs", "_PricDtls", "_VldDmclCtry", "_RateAndAmtDtls", "_AddtlInf", "_DtDtls", "_OptnNb", "_CertfctnBrkdwnTp", "_PrratnBlwMinQty", "_CertfctnBrkdwnInd", "_AccptncPrtyLvl", "_BidRgTp"]
	@property
	def PrdDtls(self):
