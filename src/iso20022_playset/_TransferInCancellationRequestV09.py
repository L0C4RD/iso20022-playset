...
from . import TransferReference15
...
class TransferInCancellationRequestV09(base_types._BaseFieldType):
	...
	def TrfRefs(self, value):
		self._TrfRefs = value if value is not None else base_types.UninitialisedField(self, 'TrfRefs', TransferReference15, True)

	@TrfRefs.deleter
	def TrfRefs(self):
		del self._TrfRefs
		self._TrfRefs = base_types.UninitialisedField(self, 'TrfRefs', TransferReference15, True)
