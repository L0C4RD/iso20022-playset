...
class InstrumentLeg7(base_types._BaseFieldType):
	...
	__slots__ = ["_LegClctdCtrPtyCcyLastQty", "_LegSttlmDt", "_LegValtnRate", "_LegCcy", "_LegSymb", "_LegSttlmTp", "_LegValDt", "_LegOrdrQty", "_LegLastPric", "_LegFwdPts", "_LegSctyId", "_LegSd", "_LegSttlmCcy", "_LegRskAmt"]
	@property
