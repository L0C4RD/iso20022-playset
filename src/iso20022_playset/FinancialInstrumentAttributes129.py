...
class FinancialInstrumentAttributes129(base_types._BaseFieldType):
	...
	__slots__ = ["_IsseDt", "_IssePric", "_NxtCllblDt", "_PrvsFctr", "_PlcOfListg", "_FinInstrmId", "_ConvsDt", "_ClssfctnTp", "_IntrstRate", "_NxtIntrstRate", "_MinMltplQtyToInst", "_PutblDt", "_DayCntBsis", "_MtrtyDt", "_NxtFctr", "_NxtCpnDt", "_MinQtyToInst", "_CtrctSz", "_DtdDt", "_OptnStyle", "_FltgRateFxgDt", "_DnmtnCcy", "_MinNmnlQty"]
	@property
	def IsseDt(self):
		return self._IsseDt
