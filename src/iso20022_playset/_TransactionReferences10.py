...
class TransactionReferences10(base_types._BaseFieldType):

	__slots__ = ["_AcctOwnrTxId", "_AcctSvcrRef", "_AcctSvcrTxId", "_ChqNb", "_ClrSysRef", "_EndToEndId", "_InstrId", "_MktInfrstrctrTxId", "_MndtId", "_MsgId", "_PmtInfId", "_PrcgId", "_Prtry", "_RtrId", "_TxId", "_UETR"]
	@property
