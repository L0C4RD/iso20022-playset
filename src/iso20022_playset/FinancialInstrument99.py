...
class FinancialInstrument99(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlCost", "_AsstsHeldInOwnNm", "_TrfCcy", "_Instrm", "_TrfRsltsInChngOfBnfclOwnr", "_AddtlInf", "_SttlmPtiesDtls", "_LineId", "_ClntRef", "_CtrPtyRef", "_BizFlowTp", "_LatstValtn", "_Trfr", "_IntrmyInf", "_UnitsDtls", "_TaxValtnPt", "_AvrgAcqstnPric", "_TtlBookVal", "_CrstllstnDtls", "_Qty", "_TrfeeAcct"]
	@property
	def OrgnlCost(self):
