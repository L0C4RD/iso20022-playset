...
import FinancialInstrument62Choice
...
class FinancialInstrument99(base_types._BaseFieldType):
	...
	__slots__ = ["_ClntRef", "_UnitsDtls", "_Instrm", "_CrstllstnDtls", "_LatstValtn", "_AddtlInf", "_LineId", "_AsstsHeldInOwnNm", "_TrfeeAcct", "_CtrPtyRef", "_TrfRsltsInChngOfBnfclOwnr", "_TrfCcy", "_AvrgAcqstnPric", "_TaxValtnPt", "_SttlmPtiesDtls", "_TtlBookVal", "_OrgnlCost", "_Qty", "_IntrmyInf", "_Trfr", "_BizFlowTp"]
	@property
	def ClntRef(self):
