...
class SwitchSubscriptionLegExecution4(base_types._BaseFieldType):
	...
	__slots__ = ["_UnitsNb", "_IncmPref", "_InftvPricDtls", "_InvstmtAcctDtls", "_IntrmPrftAmt", "_PhysDlvryDtls", "_SttlmAndCtdyDtls", "_PricDtls", "_NonStdSttlmInf", "_LegId", "_PhysDlvryInd", "_NetAmt", "_LegExctnId", "_FinInstrmDtls", "_Equlstn", "_TradDtTm", "_InftvTaxDtls", "_ReqdNAVCcy", "_ReqdSttlmCcy", "_TxOvrhd", "_GrssAmt", "_CumDvddInd"]
	@property
	def UnitsNb(self):
