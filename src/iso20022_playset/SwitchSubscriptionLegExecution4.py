...
class SwitchSubscriptionLegExecution4(base_types._BaseFieldType):
	...
	__slots__ = ["_TradDtTm", "_SttlmAndCtdyDtls", "_PricDtls", "_IntrmPrftAmt", "_ReqdNAVCcy", "_PhysDlvryDtls", "_GrssAmt", "_CumDvddInd", "_NonStdSttlmInf", "_Equlstn", "_FinInstrmDtls", "_TxOvrhd", "_PhysDlvryInd", "_UnitsNb", "_NetAmt", "_InvstmtAcctDtls", "_LegExctnId", "_ReqdSttlmCcy", "_IncmPref", "_InftvPricDtls", "_LegId", "_InftvTaxDtls"]
	@property
	def TradDtTm(self):
