...
class SettlementDetails207(base_types._BaseFieldType):
	...
	__slots__ = ["_RtrLeg", "_ModCxlAllwd", "_AutomtcBrrwg", "_CshClrSys", "_SctiesRTGS", "_NetgElgblty", "_BlckTrad", "_XpsrTp", "_SttlmSysMtd", "_FxStgInstr", "_RcvgSctiesSubBalTp", "_Prty", "_Regn", "_CCPElgblty", "_LttrOfGrnt", "_Trckg", "_RpTp", "_MktClntSd", "_StmpDtyTaxBsis", "_DlvryRtrRsn", "_LglRstrctns", "_HldInd", "_CshSubBalTp", "_PrtlSttlmInd", "_ElgblForColl", "_BnfclOwnrsh", "_DlvrgSctiesSubBalTp", "_SttlgCpcty", "_SttlmTxCond", "_TaxCpcty", "_SctiesTxTp"]
	@property
	def RtrLeg(self):
		return self._RtrLeg
