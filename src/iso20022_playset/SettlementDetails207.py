...
from .PriorityNumeric5Choice import PriorityNumeric5Choice
from .SettlementSystemMethod5Choice import SettlementSystemMethod5Choice
from .SettlementTransactionCondition39Choice import SettlementTransactionCondition39Choice
from .HoldIndicator7 import HoldIndicator7
...
from .SecuritiesTransactionType53Choice import SecuritiesTransactionType53Choice
from .AutomaticBorrowing8Choice import AutomaticBorrowing8Choice
from .RepurchaseType26Choice import RepurchaseType26Choice
...
class SettlementDetails207(base_types._BaseFieldType):
	...
	__slots__ = ["_DlvrgSctiesSubBalTp", "_ElgblForColl", "_AutomtcBrrwg", "_SttlgCpcty", "_CshSubBalTp", "_LglRstrctns", "_SttlmTxCond", "_SctiesTxTp", "_XpsrTp", "_NetgElgblty", "_Regn", "_RpTp", "_SttlmSysMtd", "_CCPElgblty", "_LttrOfGrnt", "_FxStgInstr", "_BlckTrad", "_RtrLeg", "_SctiesRTGS", "_Trckg", "_TaxCpcty", "_BnfclOwnrsh", "_MktClntSd", "_ModCxlAllwd", "_HldInd", "_RcvgSctiesSubBalTp", "_StmpDtyTaxBsis", "_Prty", "_PrtlSttlmInd", "_DlvryRtrRsn", "_CshClrSys"]
	@property
