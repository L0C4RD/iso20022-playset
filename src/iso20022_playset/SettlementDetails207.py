...
class SettlementDetails207(base_types._BaseFieldType):
	...
	__slots__ = ["_HldInd", "_LglRstrctns", "_BnfclOwnrsh", "_RcvgSctiesSubBalTp", "_AutomtcBrrwg", "_MktClntSd", "_SttlgCpcty", "_PrtlSttlmInd", "_CshSubBalTp", "_SttlmTxCond", "_Regn", "_CshClrSys", "_Prty", "_DlvrgSctiesSubBalTp", "_ModCxlAllwd", "_SctiesRTGS", "_NetgElgblty", "_DlvryRtrRsn", "_RpTp", "_CCPElgblty", "_BlckTrad", "_SttlmSysMtd", "_XpsrTp", "_FxStgInstr", "_Trckg", "_SctiesTxTp", "_StmpDtyTaxBsis", "_LttrOfGrnt", "_ElgblForColl", "_TaxCpcty", "_RtrLeg"]
	@property
	def HldInd(self):
		return self._HldInd
