...
import RepurchaseType26Choice
import ModificationCancellationAllowed5Choice
...
import SecuritiesTransactionType53Choice
import AutomaticBorrowing8Choice

class SettlementDetails207(base_types._BaseFieldType):

	__slots__ = ["_XpsrTp", "_TaxCpcty", "_StmpDtyTaxBsis", "_SctiesTxTp", "_SttlmSysMtd", "_ElgblForColl", "_SttlmTxCond", "_CshSubBalTp", "_BlckTrad", "_DlvrgSctiesSubBalTp", "_MktClntSd", "_DlvryRtrRsn", "_RtrLeg", "_BnfclOwnrsh", "_ModCxlAllwd", "_LttrOfGrnt", "_RcvgSctiesSubBalTp", "_SctiesRTGS", "_Regn", "_NetgElgblty", "_PrtlSttlmInd", "_CshClrSys", "_LglRstrctns", "_Prty", "_CCPElgblty", "_Trckg", "_SttlgCpcty", "_AutomtcBrrwg", "_FxStgInstr", "_RpTp", "_HldInd"]
	@property
	def XpsrTp(self):
		return self._XpsrTp
