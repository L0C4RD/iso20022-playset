...
from . import FinancialInstrumentDetails49
from . import PartyIdentification144
from . import SecuritiesAccount25
from . import YesNoIndicator

class SubAccountIdentification74(base_types._BaseFieldType):

	__slots__ = ["_AcctOwnr", "_ActvtyInd", "_BlckChainAdrOrWllt", "_FinInstrmDtls", "_SfkpgAcct"]
	@property
	def AcctOwnr(self):
	...
	def FinInstrmDtls(self, value):
		self._FinInstrmDtls = value if value is not None else base_types.UninitialisedField(self, 'FinInstrmDtls', FinancialInstrumentDetails49, True)

	@FinInstrmDtls.deleter
	def FinInstrmDtls(self):
		del self._FinInstrmDtls
		self._FinInstrmDtls = base_types.UninitialisedField(self, 'FinInstrmDtls', FinancialInstrumentDetails49, True)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='FinInstrmDtls', type=FinancialInstrumentDetails49, min=0, max=None, mutex_group=None, array=True),
