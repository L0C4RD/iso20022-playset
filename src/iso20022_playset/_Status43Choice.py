...
class Status43Choice(base_types._BaseFieldType):
	...
	def InstrPrcgSts(self, value):
		self._InstrPrcgSts = value if value is not None else base_types.UninitialisedField(self, 'InstrPrcgSts', InstructionProcessingStatus61Choice, False)

	@InstrPrcgSts.deleter
	def InstrPrcgSts(self):
		del self._InstrPrcgSts
		self._InstrPrcgSts = base_types.UninitialisedField(self, 'InstrPrcgSts', InstructionProcessingStatus61Choice, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='InstrPrcgSts', type=InstructionProcessingStatus61Choice, min=0, max=1, mutex_group=1, array=False),
