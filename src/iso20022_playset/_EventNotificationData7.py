...
class EventNotificationData7(base_types._BaseFieldType):
	...
	def RtlrEvt(self, value):
		self._RtlrEvt = value if value is not None else base_types.UninitialisedField(self, 'RtlrEvt', RetailerEvent7, False)

	@RtlrEvt.deleter
	def RtlrEvt(self):
		del self._RtlrEvt
		self._RtlrEvt = base_types.UninitialisedField(self, 'RtlrEvt', RetailerEvent7, False)
