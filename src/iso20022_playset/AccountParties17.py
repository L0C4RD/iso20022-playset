...
class AccountParties17(base_types._BaseFieldType):
	...
	__slots__ = ["_Bnfcry", "_PwrOfAttny", "_Sttlr", "_OthrPty", "_CtdnForMnr", "_ScndryOwnr", "_Grntr", "_RegdShrhldrNm", "_LglGuardn", "_SnrMggOffcl", "_Prtctr", "_SucssrOnDth", "_Admstr", "_PrncplAcctPty"]
	@property
	def Bnfcry(self):
		return self._Bnfcry
