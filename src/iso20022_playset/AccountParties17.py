...
import AccountParties12Choice
import ExtendedParty14
...
class AccountParties17(base_types._BaseFieldType):
	...
	__slots__ = ["_Prtctr", "_Bnfcry", "_OthrPty", "_CtdnForMnr", "_Grntr", "_SucssrOnDth", "_ScndryOwnr", "_PrncplAcctPty", "_Sttlr", "_PwrOfAttny", "_RegdShrhldrNm", "_LglGuardn", "_SnrMggOffcl", "_Admstr"]
	@property
	def Prtctr(self):
		return self._Prtctr
