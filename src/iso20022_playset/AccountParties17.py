...
class AccountParties17(base_types._BaseFieldType):
	...
	__slots__ = ["_SucssrOnDth", "_OthrPty", "_Grntr", "_PrncplAcctPty", "_Bnfcry", "_Sttlr", "_RegdShrhldrNm", "_PwrOfAttny", "_Admstr", "_LglGuardn", "_ScndryOwnr", "_Prtctr", "_CtdnForMnr", "_SnrMggOffcl"]
	@property
