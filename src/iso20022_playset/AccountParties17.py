...
class AccountParties17(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrPty", "_SucssrOnDth", "_PrncplAcctPty", "_Bnfcry", "_Prtctr", "_ScndryOwnr", "_SnrMggOffcl", "_RegdShrhldrNm", "_Admstr", "_PwrOfAttny", "_CtdnForMnr", "_Sttlr", "_Grntr", "_LglGuardn"]
	@property
	def OthrPty(self):
