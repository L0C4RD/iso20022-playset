...
class AccountParties17(base_types._BaseFieldType):
	...
	__slots__ = ["_PrncplAcctPty", "_Sttlr", "_Prtctr", "_Bnfcry", "_SucssrOnDth", "_ScndryOwnr", "_CtdnForMnr", "_PwrOfAttny", "_LglGuardn", "_SnrMggOffcl", "_OthrPty", "_Grntr", "_Admstr", "_RegdShrhldrNm"]
	@property
