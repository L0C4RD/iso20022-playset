...
from .AccountParties12Choice import AccountParties12Choice
from .InvestmentAccountOwnershipInformation16 import InvestmentAccountOwnershipInformation16
from .ExtendedParty14 import ExtendedParty14
...
class AccountParties17(base_types._BaseFieldType):
	...
	__slots__ = ["_PwrOfAttny", "_PrncplAcctPty", "_LglGuardn", "_SucssrOnDth", "_SnrMggOffcl", "_Bnfcry", "_Prtctr", "_RegdShrhldrNm", "_Admstr", "_Sttlr", "_CtdnForMnr", "_OthrPty", "_ScndryOwnr", "_Grntr"]
	@property
	def PwrOfAttny(self):
	...
	def LglGuardn(self, value):
		self._LglGuardn = value if type(value) != auto else self.make_default("LglGuardn")
	...
	def Prtctr(self, value):
		self._Prtctr = value if type(value) != auto else self.make_default("Prtctr")
	...
	def Sttlr(self, value):
		self._Sttlr = value if type(value) != auto else self.make_default("Sttlr")
