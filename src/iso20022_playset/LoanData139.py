...
class LoanData139(base_types._BaseFieldType):
	...
	__slots__ = ["_TermntnDt", "_MstrAgrmt", "_EvtDt", "_MinNtcePrd", "_EarlstCallBckDt", "_Term", "_DlvryByVal", "_ValDt", "_CollDlvryMtd", "_ClrSts", "_TradgVn", "_IntrstRate", "_UnqTradIdr", "_GnlColl", "_PrncplAmt", "_ExctnDtTm"]
	@property
	def TermntnDt(self):
