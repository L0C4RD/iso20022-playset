...
class LoanData139(base_types._BaseFieldType):
	...
	__slots__ = ["_TradgVn", "_UnqTradIdr", "_EvtDt", "_ClrSts", "_PrncplAmt", "_GnlColl", "_DlvryByVal", "_IntrstRate", "_Term", "_ValDt", "_EarlstCallBckDt", "_ExctnDtTm", "_MinNtcePrd", "_TermntnDt", "_CollDlvryMtd", "_MstrAgrmt"]
	@property
	def TradgVn(self):
