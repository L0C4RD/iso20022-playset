...
class LoanData139(base_types._BaseFieldType):
	...
	__slots__ = ["_MstrAgrmt", "_Term", "_PrncplAmt", "_ClrSts", "_CollDlvryMtd", "_EarlstCallBckDt", "_IntrstRate", "_UnqTradIdr", "_EvtDt", "_ExctnDtTm", "_TradgVn", "_TermntnDt", "_DlvryByVal", "_MinNtcePrd", "_GnlColl", "_ValDt"]
	@property
	def MstrAgrmt(self):
