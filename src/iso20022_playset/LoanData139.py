...
class LoanData139(base_types._BaseFieldType):
	...
	__slots__ = ["_UnqTradIdr", "_ExctnDtTm", "_DlvryByVal", "_MinNtcePrd", "_TradgVn", "_ValDt", "_CollDlvryMtd", "_PrncplAmt", "_IntrstRate", "_EarlstCallBckDt", "_Term", "_ClrSts", "_MstrAgrmt", "_GnlColl", "_TermntnDt", "_EvtDt"]
	@property
	def UnqTradIdr(self):
