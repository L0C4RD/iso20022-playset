...
from ._CurrencyQueryDefinition3 import CurrencyQueryDefinition3

class GetCurrencyExchangeRateV04(base_types._BaseFieldType):

	__slots__ = ["_MsgHdr", "_SplmtryData", "_CcyQryDef"]
	@property
	def MsgHdr(self):
		return self._MsgHdr
	...
	def CcyQryDef(self, value):
		self._CcyQryDef = value if type(value) != base_types.auto else self.make_default("CcyQryDef")
