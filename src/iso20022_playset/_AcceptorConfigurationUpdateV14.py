...
from . import AcceptorConfiguration14
...
class AcceptorConfigurationUpdateV14(base_types._BaseFieldType):
	...
	def AccptrCfgtn(self, value):
		self._AccptrCfgtn = value if value is not None else base_types.UninitialisedField(self, 'AccptrCfgtn', AcceptorConfiguration14, False)

	@AccptrCfgtn.deleter
	def AccptrCfgtn(self):
		del self._AccptrCfgtn
		self._AccptrCfgtn = base_types.UninitialisedField(self, 'AccptrCfgtn', AcceptorConfiguration14, False)
