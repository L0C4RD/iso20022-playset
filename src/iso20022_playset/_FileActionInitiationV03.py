...
class FileActionInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Conttn", "_Orgtr", "_Prgrmm", "_Tkn", "_Crdhldr", "_Card", "_POICmpnt", "_OthrFileActnTp", "_Jursdctn", "_FileActnScp", "_Rcvr", "_SttlmSvc", "_PrtctdData", "_MsgRsn", "_Accptr", "_Frmt", "_SctyTrlr", "_DataRcrd", "_FileSctyCd", "_SplmtryData", "_Issr", "_RspnCd", "_TxDesc", "_Pyer", "_Hdr", "_SysTracAudtNb", "_CstmrDvc", "_RtrvlRefNb", "_FileNm", "_AltrnMsgRsn", "_FileActnTp", "_Acqrr", "_Wllt", "_AddtlFee", "_Termnl", "_LifeCyclId", "_Pyee", "_Sndr", "_Crrctn", "_Rcncltn", "_TrnsmssnDtTm", "_AddtlData", "_ActnDt", "_Dstn"]
	@property
	def Conttn(self):
		return self._Conttn
