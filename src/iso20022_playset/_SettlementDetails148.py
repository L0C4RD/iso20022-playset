...
class SettlementDetails148(base_types._BaseFieldType):
	...
	__slots__ = ["_SctiesRTGS", "_HldInd", "_ElgblForColl", "_NetgElgblty", "_AutomtcBrrwg", "_SttlmTxCond", "_StmpDtyTaxBsis", "_BnfclOwnrsh", "_LglRstrctns", "_Trckg", "_Prty", "_SttlgCpcty", "_TaxCpcty", "_CshClrSys", "_SttlmSysMtd", "_PrtlSttlmInd", "_BlckTrad", "_MktClntSd", "_CCPElgblty", "_FxStgInstr"]
	@property
	def SctiesRTGS(self):
