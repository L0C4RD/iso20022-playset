...
class SettlementDetails148(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmTxCond", "_LglRstrctns", "_SctiesRTGS", "_AutomtcBrrwg", "_BnfclOwnrsh", "_HldInd", "_TaxCpcty", "_FxStgInstr", "_CshClrSys", "_PrtlSttlmInd", "_SttlgCpcty", "_Prty", "_BlckTrad", "_StmpDtyTaxBsis", "_SttlmSysMtd", "_MktClntSd", "_ElgblForColl", "_CCPElgblty", "_NetgElgblty", "_Trckg"]
	@property
