...
class AcquirerProtocolParameters17(base_types._BaseFieldType):
	...
	__slots__ = ["_PrtctCardData", "_ActnTp", "_TtlsPerCcy", "_Vrsn", "_CmpltnAdvcMndtd", "_MsgItm", "_NtfyOffLineCxl", "_RcncltnErr", "_AmtQlfrForRsvatn", "_SpltTtlCrit", "_CardDataVrfctn", "_OnLineTx", "_PrvtCardData", "_SpltTtls", "_ApplId", "_MndtrySctyTrlr", "_BtchTrfCntt", "_BtchDgtlSgntr", "_AcqrrId", "_OffLineTx", "_RcncltnXchg", "_Hst", "_RcncltnByAcqrr", "_FileTrfBtch"]
	@property
