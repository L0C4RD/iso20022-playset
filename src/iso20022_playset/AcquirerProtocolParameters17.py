...
class AcquirerProtocolParameters17(base_types._BaseFieldType):
	...
	__slots__ = ["_PrvtCardData", "_OnLineTx", "_OffLineTx", "_PrtctCardData", "_MndtrySctyTrlr", "_FileTrfBtch", "_TtlsPerCcy", "_AcqrrId", "_AmtQlfrForRsvatn", "_Hst", "_BtchDgtlSgntr", "_BtchTrfCntt", "_CardDataVrfctn", "_RcncltnXchg", "_ActnTp", "_MsgItm", "_SpltTtlCrit", "_RcncltnErr", "_RcncltnByAcqrr", "_NtfyOffLineCxl", "_SpltTtls", "_Vrsn", "_ApplId", "_CmpltnAdvcMndtd"]
	@property
