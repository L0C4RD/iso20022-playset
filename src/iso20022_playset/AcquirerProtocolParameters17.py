...
from .TypeOfAmount8Code import TypeOfAmount8Code
from .AcquirerHostConfiguration10 import AcquirerHostConfiguration10
from .ReconciliationCriteria1Code import ReconciliationCriteria1Code
from .AcquirerProtocolExchangeBehavior2 import AcquirerProtocolExchangeBehavior2
...
from .BatchTransactionType1Code import BatchTransactionType1Code

class AcquirerProtocolParameters17(base_types._BaseFieldType):

	__slots__ = ["_SpltTtls", "_OnLineTx", "_CardDataVrfctn", "_ActnTp", "_Hst", "_TtlsPerCcy", "_NtfyOffLineCxl", "_RcncltnByAcqrr", "_ApplId", "_PrvtCardData", "_AmtQlfrForRsvatn", "_FileTrfBtch", "_SpltTtlCrit", "_AcqrrId", "_RcncltnXchg", "_BtchDgtlSgntr", "_PrtctCardData", "_MndtrySctyTrlr", "_RcncltnErr", "_BtchTrfCntt", "_OffLineTx", "_MsgItm", "_CmpltnAdvcMndtd", "_Vrsn"]
	@property
	def SpltTtls(self):
