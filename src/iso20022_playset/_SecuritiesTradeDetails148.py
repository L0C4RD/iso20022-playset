...
class SecuritiesTradeDetails148(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrAmts", "_SttlmParams", "_CmonId", "_NtfctnRcvrTxId", "_SttlmAmt", "_RcvgSttlmPties", "_SttlmDt", "_SctiesMvmntTp", "_TradDt", "_Pmt", "_NbOfDaysAcrd", "_FinInstrmAttrbts", "_Rptg", "_NtfctnSndrTxId", "_OthrBizPties", "_DlvrgSttlmPties", "_QtyDtls", "_Sts", "_SplmtryData", "_FinInstrmId"]
	@property
	def OthrAmts(self):
