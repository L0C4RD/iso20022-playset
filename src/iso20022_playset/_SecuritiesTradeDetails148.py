...
class SecuritiesTradeDetails148(base_types._BaseFieldType):
	...
	__slots__ = ["_NbOfDaysAcrd", "_Rptg", "_SplmtryData", "_SttlmParams", "_OthrBizPties", "_Pmt", "_QtyDtls", "_SttlmAmt", "_TradDt", "_OthrAmts", "_FinInstrmAttrbts", "_FinInstrmId", "_Sts", "_CmonId", "_DlvrgSttlmPties", "_NtfctnRcvrTxId", "_SctiesMvmntTp", "_RcvgSttlmPties", "_SttlmDt", "_NtfctnSndrTxId"]
	@property
