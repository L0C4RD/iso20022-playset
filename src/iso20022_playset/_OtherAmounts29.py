...
class OtherAmounts29(base_types._BaseFieldType):
	...
	__slots__ = ["_ShppgAmt", "_LclTax", "_RgltryAmt", "_WhldgTax", "_TxTax", "_ChrgsFees", "_AcrdCptlstnAmt", "_Othr", "_ValAddedTax", "_AcrdIntrstAmt", "_StmpDty", "_StockXchgTax", "_TrfTax", "_CtryNtlFdrlTax", "_CsmptnTax", "_PmtLevyTax"]
	@property
	def ShppgAmt(self):
