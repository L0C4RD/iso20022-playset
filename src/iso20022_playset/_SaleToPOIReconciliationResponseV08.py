...
from . import ReconciliationResponse11

class SaleToPOIReconciliationResponseV08(base_types._BaseFieldType):
	...
	def RcncltnRspn(self, value):
		self._RcncltnRspn = value if value is not None else base_types.UninitialisedField(self, 'RcncltnRspn', ReconciliationResponse11, False)

	@RcncltnRspn.deleter
	def RcncltnRspn(self):
		del self._RcncltnRspn
		self._RcncltnRspn = base_types.UninitialisedField(self, 'RcncltnRspn', ReconciliationResponse11, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='RcncltnRspn', type=ReconciliationResponse11, min=1, max=1, mutex_group=None, array=False),
