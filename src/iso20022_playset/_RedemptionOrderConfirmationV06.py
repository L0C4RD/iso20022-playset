...
from . import RedemptionMultipleExecution07

class RedemptionOrderConfirmationV06(base_types._BaseFieldType):
	...
	def MltplExctnDtls(self, value):
		self._MltplExctnDtls = value if value is not None else base_types.UninitialisedField(self, 'MltplExctnDtls', RedemptionMultipleExecution07, False)

	@MltplExctnDtls.deleter
	def MltplExctnDtls(self):
		del self._MltplExctnDtls
		self._MltplExctnDtls = base_types.UninitialisedField(self, 'MltplExctnDtls', RedemptionMultipleExecution07, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='MltplExctnDtls', type=RedemptionMultipleExecution07, min=1, max=1, mutex_group=None, array=False),
