...
class OrderData4(base_types._BaseFieldType):
	...
	__slots__ = ["_TradgCpcty", "_NonExctgBrkr", "_OrdrClssfctn", "_DrctElctrncAccs", "_InvstmtDcsnPrsn", "_ClntId", "_SubmitgNtty", "_LqdtyPrvsnActvty", "_ExctgPrsn", "_OrdrPrics", "_InstrData", "_TxData"]
	@property
	def TradgCpcty(self):
