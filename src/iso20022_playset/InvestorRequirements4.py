...
class InvestorRequirements4(base_types._BaseFieldType):
	...
	__slots__ = ["_RtrPrflHdgg", "_MinHldgPrd", "_SstnbltyPrefs", "_RtrPrflGrwth", "_Othr", "_OthrSpcfcInvstmtNeed", "_OptnOrLvrgdRtrPrfl", "_RtrPrflPnsnSchmeDE", "_RtrPrflIncm", "_RtrPrflPrsrvtn"]
	@property
