...
class InvestorRequirements4(base_types._BaseFieldType):
	...
	__slots__ = ["_RtrPrflGrwth", "_Othr", "_RtrPrflPnsnSchmeDE", "_RtrPrflHdgg", "_OthrSpcfcInvstmtNeed", "_RtrPrflIncm", "_RtrPrflPrsrvtn", "_OptnOrLvrgdRtrPrfl", "_SstnbltyPrefs", "_MinHldgPrd"]
	@property
