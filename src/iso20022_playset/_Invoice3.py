...
class Invoice3(base_types._BaseFieldType):
	...
	__slots__ = ["_TaxTtl", "_SellrId", "_SellrCtct", "_BuyrAdr", "_FrghtAmt", "_Dt", "_SellrAddtlInf", "_CreDtTm", "_AddtlData", "_BuyrCtct", "_BuyrTaxRegnId", "_SellrAdr", "_TaxRclmMtd", "_SellrNm", "_SummryCmmdtyId", "_SellrTaxRegnId", "_BuyrId", "_BuyrAddtlInf", "_BuyrNm", "_Nb", "_LineItm"]
	@property
	def TaxTtl(self):
		return self._TaxTtl
