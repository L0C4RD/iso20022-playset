...
class AmountPricePerFinancialInstrumentQuantity10(base_types._BaseFieldType):
	...
	def FinInstrmQty(self, value):
		self._FinInstrmQty = value if value is not None else base_types.UninitialisedField(self, 'FinInstrmQty', FinancialInstrumentQuantity33Choice, False)

	@FinInstrmQty.deleter
	def FinInstrmQty(self):
		del self._FinInstrmQty
		self._FinInstrmQty = base_types.UninitialisedField(self, 'FinInstrmQty', FinancialInstrumentQuantity33Choice, False)
