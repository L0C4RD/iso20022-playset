...
class RetailerPaymentResult7(base_types._BaseFieldType):
	...
	__slots__ = ["_PrtctdCaptrdSgntr", "_TxRspn", "_CstmrOrdr", "_AddtlSvc", "_PmtInstrm", "_OnlnFlg", "_MrchntOvrrdFlg", "_SvcAttr", "_TxTp", "_PmtTpInf", "_ReqdTx", "_ImgCaptrdSgntr", "_CstmrLang"]
	@property
