...
from . import Number
from . import ParticipationMethod2
...
class MeetingNotice9(base_types._BaseFieldType):
	...
	def Prtcptn(self, value):
		self._Prtcptn = value if value is not None else base_types.UninitialisedField(self, 'Prtcptn', ParticipationMethod2, True)

	@Prtcptn.deleter
	def Prtcptn(self):
		del self._Prtcptn
		self._Prtcptn = base_types.UninitialisedField(self, 'Prtcptn', ParticipationMethod2, True)
