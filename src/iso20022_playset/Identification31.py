...
class Identification31(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctSvcrTxId", "_UnqTxIdr", "_CmonId", "_PoolId", "_MktInfrstrctrTxId", "_MstrId", "_CtrPtyMktInfrstrctrTxId", "_IndxId", "_PrgmId", "_TradId", "_ListId", "_CorpActnEvtId", "_AcctOwnrTxId", "_PrcrTxId", "_BsktId"]
	@property
