...
class InvestmentAccount70(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctNm", "_SubAcctDtls", "_AcctSvcr", "_SctiesForm", "_BnfcryCertfctnCmpltn", "_AcctDsgnt", "_SfkpgPlc", "_AcctId", "_SttlmPtiesDtls", "_OwnrId", "_IncmPref", "_DmtrlsdInd", "_IntrmyInf"]
	@property
	def AcctNm(self):
		return self._AcctNm
