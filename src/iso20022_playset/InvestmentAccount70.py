...
import SafekeepingPlaceFormat28Choice

class InvestmentAccount70(base_types._BaseFieldType):

	__slots__ = ["_SctiesForm", "_SfkpgPlc", "_SubAcctDtls", "_BnfcryCertfctnCmpltn", "_AcctId", "_AcctNm", "_IntrmyInf", "_AcctSvcr", "_AcctDsgnt", "_SttlmPtiesDtls", "_DmtrlsdInd", "_IncmPref", "_OwnrId"]
	@property
	def SctiesForm(self):
