...
class InquiryResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_ICCRltdData", "_SctyTrlr", "_Hdr", "_ConvsDtTm", "_CardPrgrmm", "_Crdhldr", "_Issr", "_AddtlAmt", "_TxId", "_Rcncltn", "_AddtlFee", "_Tkn", "_Termnl", "_Orgtr", "_Vrfctn", "_Wllt", "_Cntxt", "_AcctFr", "_Instlmt", "_PrtctdData", "_SplmtryData", "_PrcgRslt", "_TxChrtcs", "_Accptr", "_OrgnlRspnCd", "_AcctBal", "_Acqrr", "_StrngCstmrAuthntcn", "_AddtlData", "_Rcvr", "_Sndr", "_SpclPrgrmmQlfctn", "_Dstn", "_AddtlSvc", "_Jursdctn", "_Rsk", "_TxAmts", "_AcctStmtData", "_Card", "_SttlmSvc"]
	@property
