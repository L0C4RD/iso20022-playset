...
class InquiryResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Card", "_Orgtr", "_ConvsDtTm", "_Cntxt", "_TxAmts", "_Tkn", "_Crdhldr", "_TxId", "_TxChrtcs", "_Termnl", "_OrgnlRspnCd", "_AddtlSvc", "_Jursdctn", "_Rcvr", "_SttlmSvc", "_AcctFr", "_PrtctdData", "_ICCRltdData", "_SctyTrlr", "_SpclPrgrmmQlfctn", "_SplmtryData", "_Vrfctn", "_Issr", "_Acqrr", "_Hdr", "_AcctStmtData", "_AcctBal", "_Wllt", "_CardPrgrmm", "_AddtlFee", "_Rsk", "_Accptr", "_Sndr", "_StrngCstmrAuthntcn", "_Rcncltn", "_PrcgRslt", "_AddtlData", "_AddtlAmt", "_Dstn", "_Instlmt"]
	@property
	def Card(self):
		return self._Card
