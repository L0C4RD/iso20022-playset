...
class SettlementReportingInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Orgtr", "_TxDesc", "_Hdr", "_SttlmRptTp", "_SysTracAudtNb", "_RtrvlRefNb", "_TtlSttlmAmt", "_OthrSttlmRptTp", "_AltrnMsgRsn", "_Jursdctn", "_AddtlFee", "_Rcvr", "_SttlmSvc", "_PrtctdData", "_FndsTrfAmt", "_MsgRsn", "_FI", "_LifeCyclId", "_IssrSttlmTtls", "_OthrSttlmTtls", "_SctyTrlr", "_Sndr", "_SttlmInstn", "_Prgrmm", "_OthrInstn", "_AcqrrSttlmTtls", "_Rcncltn", "_TrnsmssnDtTm", "_AddtlData", "_Dstn", "_SplmtryData"]
	@property
	def Orgtr(self):
		return self._Orgtr
