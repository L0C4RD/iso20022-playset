...
class CorporateActionNotification002V15(base_types._BaseFieldType):
	...
	__slots__ = ["_Issr", "_SlctnAgt", "_AddtlInf", "_IntrmdtScty", "_RsellngAgt", "_TrfAgt", "_NtfctnGnlInf", "_CorpActnGnlInf", "_IssrAgt", "_Offerr", "_Pgntn", "_Regar", "_OthrDocId", "_EvtsLkg", "_SplmtryData", "_PngAgt", "_CorpActnDtls", "_DrpAgt", "_CorpActnOptnDtls", "_PhysSctiesAgt", "_InstrId", "_SubPngAgt", "_InfAgt", "_AcctDtls", "_PrvsNtfctnId"]
	@property
	def Issr(self):
		return self._Issr
