...
class CorporateActionNotification002V15(base_types._BaseFieldType):
	...
	__slots__ = ["_SlctnAgt", "_AcctDtls", "_PngAgt", "_OthrDocId", "_Issr", "_TrfAgt", "_IssrAgt", "_EvtsLkg", "_CorpActnDtls", "_SubPngAgt", "_IntrmdtScty", "_AddtlInf", "_Pgntn", "_CorpActnGnlInf", "_CorpActnOptnDtls", "_Regar", "_InfAgt", "_PrvsNtfctnId", "_NtfctnGnlInf", "_DrpAgt", "_Offerr", "_PhysSctiesAgt", "_RsellngAgt", "_SplmtryData", "_InstrId"]
	@property
	def SlctnAgt(self):
