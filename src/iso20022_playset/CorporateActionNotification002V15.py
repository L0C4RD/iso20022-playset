import base_types
import CorporateActionNotification11
...
import CorporateActionGeneralInformation194
import Pagination1
import CorporateAction87
import DocumentIdentification37
import AccountIdentification78Choice
import FinancialInstrumentAttributes117
import CorporateActionOption247
import CorporateActionNarrative65

class CorporateActionNotification002V15(base_types._BaseFieldType):

	__slots__ = ["_PhysSctiesAgt", "_AddtlInf", "_IssrAgt", "_DrpAgt", "_Regar", "_CorpActnGnlInf", "_OthrDocId", "_Offerr", "_NtfctnGnlInf", "_Issr", "_PrvsNtfctnId", "_InfAgt", "_EvtsLkg", "_Pgntn", "_RsellngAgt", "_SubPngAgt", "_SplmtryData", "_IntrmdtScty", "_InstrId", "_SlctnAgt", "_CorpActnDtls", "_PngAgt", "_CorpActnOptnDtls", "_TrfAgt", "_AcctDtls"]
	@property
