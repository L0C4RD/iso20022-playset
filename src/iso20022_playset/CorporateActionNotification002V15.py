...
class CorporateActionNotification002V15(base_types._BaseFieldType):
	...
	__slots__ = ["_PrvsNtfctnId", "_SplmtryData", "_CorpActnDtls", "_Pgntn", "_DrpAgt", "_PngAgt", "_Offerr", "_RsellngAgt", "_Issr", "_InstrId", "_IntrmdtScty", "_IssrAgt", "_Regar", "_AcctDtls", "_InfAgt", "_TrfAgt", "_CorpActnOptnDtls", "_CorpActnGnlInf", "_SubPngAgt", "_NtfctnGnlInf", "_OthrDocId", "_SlctnAgt", "_EvtsLkg", "_AddtlInf", "_PhysSctiesAgt"]
	@property
