...
from .CorporateActionNarrative65 import CorporateActionNarrative65
from .CorporateActionOption247 import CorporateActionOption247
from .CorporateAction87 import CorporateAction87
...
from .CorporateActionGeneralInformation194 import CorporateActionGeneralInformation194
from .CorporateActionEventReference4 import CorporateActionEventReference4
from .SupplementaryData1 import SupplementaryData1
from .AccountIdentification78Choice import AccountIdentification78Choice
from .CorporateActionNotification11 import CorporateActionNotification11
from .FinancialInstrumentAttributes117 import FinancialInstrumentAttributes117

class CorporateActionNotification002V15(base_types._BaseFieldType):

	__slots__ = ["_IntrmdtScty", "_Pgntn", "_SubPngAgt", "_EvtsLkg", "_InstrId", "_Issr", "_PhysSctiesAgt", "_Offerr", "_AcctDtls", "_Regar", "_TrfAgt", "_CorpActnOptnDtls", "_OthrDocId", "_SlctnAgt", "_DrpAgt", "_NtfctnGnlInf", "_PngAgt", "_InfAgt", "_AddtlInf", "_CorpActnGnlInf", "_SplmtryData", "_CorpActnDtls", "_PrvsNtfctnId", "_IssrAgt", "_RsellngAgt"]
	@property
