...
class CorporateActionNotification002V15(base_types._BaseFieldType):
	...
	__slots__ = ["_Issr", "_SlctnAgt", "_Regar", "_DrpAgt", "_AcctDtls", "_InstrId", "_IssrAgt", "_Offerr", "_EvtsLkg", "_NtfctnGnlInf", "_OthrDocId", "_PrvsNtfctnId", "_InfAgt", "_SplmtryData", "_CorpActnDtls", "_AddtlInf", "_SubPngAgt", "_CorpActnGnlInf", "_RsellngAgt", "_TrfAgt", "_IntrmdtScty", "_CorpActnOptnDtls", "_Pgntn", "_PngAgt", "_PhysSctiesAgt"]
	@property
	def Issr(self):
		return self._Issr
