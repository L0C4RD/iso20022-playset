...
class SecuritiesOption117(base_types._BaseFieldType):
	...
	__slots__ = ["_IncmTp", "_CtryOfIncmSrc", "_SfkpgPlc", "_SctyDtls", "_PricDtls", "_EntitldQty", "_XmptnTp", "_FrctnDspstn", "_RateDtls", "_TradgPrd", "_NewSctiesIssncInd", "_AmtDtls", "_CdtDbtInd", "_OthrIncmTp", "_TempFinInstrmInd", "_NonElgblPrcdsInd", "_CcyOptn", "_DtDtls", "_IssrOfferrTaxbltyInd"]
	@property
	def IncmTp(self):
		return self._IncmTp
