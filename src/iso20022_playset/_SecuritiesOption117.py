...
from . import CorporateActionPrice98
from . import CorporateActionRate137
from . import CountryCode
from . import CreditDebitCode
from . import FinancialInstrumentAttributes137
...
from . import SafekeepingPlaceFormat56Choice
from . import SecurityDate24
...
class SecuritiesOption117(base_types._BaseFieldType):
	...
	def DtDtls(self, value):
		self._DtDtls = value if value is not None else base_types.UninitialisedField(self, 'DtDtls', SecurityDate24, False)

	@DtDtls.deleter
	def DtDtls(self):
		del self._DtDtls
		self._DtDtls = base_types.UninitialisedField(self, 'DtDtls', SecurityDate24, False)
	...
	def EntitldQty(self, value):
		self._EntitldQty = value if value is not None else base_types.UninitialisedField(self, 'EntitldQty', Quantity54Choice, False)

	@EntitldQty.deleter
	def EntitldQty(self):
		del self._EntitldQty
		self._EntitldQty = base_types.UninitialisedField(self, 'EntitldQty', Quantity54Choice, False)
	...
	def PricDtls(self, value):
		self._PricDtls = value if value is not None else base_types.UninitialisedField(self, 'PricDtls', CorporateActionPrice98, False)

	@PricDtls.deleter
	def PricDtls(self):
		del self._PricDtls
		self._PricDtls = base_types.UninitialisedField(self, 'PricDtls', CorporateActionPrice98, False)
	...
	def RateDtls(self, value):
		self._RateDtls = value if value is not None else base_types.UninitialisedField(self, 'RateDtls', CorporateActionRate137, False)

	@RateDtls.deleter
	def RateDtls(self):
		del self._RateDtls
		self._RateDtls = base_types.UninitialisedField(self, 'RateDtls', CorporateActionRate137, False)
	...
	def SctyDtls(self, value):
		self._SctyDtls = value if value is not None else base_types.UninitialisedField(self, 'SctyDtls', FinancialInstrumentAttributes137, False)

	@SctyDtls.deleter
	def SctyDtls(self):
		del self._SctyDtls
		self._SctyDtls = base_types.UninitialisedField(self, 'SctyDtls', FinancialInstrumentAttributes137, False)
	...
	def SfkpgPlc(self, value):
		self._SfkpgPlc = value if value is not None else base_types.UninitialisedField(self, 'SfkpgPlc', SafekeepingPlaceFormat56Choice, False)

	@SfkpgPlc.deleter
	def SfkpgPlc(self):
		del self._SfkpgPlc
		self._SfkpgPlc = base_types.UninitialisedField(self, 'SfkpgPlc', SafekeepingPlaceFormat56Choice, False)
