...
from ._SettlementFailsJustification1 import SettlementFailsJustification1
from ._TrueFalseIndicator import TrueFalseIndicator

class SettlementFailsDerogation1(base_types._BaseFieldType):

	__slots__ = ["_Justfn", "_ElgbltyInd"]
	@property
	def Justfn(self):
		return self._Justfn
	...
	def ElgbltyInd(self, value):
		self._ElgbltyInd = value if type(value) != base_types.auto else self.make_default("ElgbltyInd")
