...
from . import FundConfirmedCashForecastReport3
...
class FundConfirmedCashForecastReportCancellationV03(base_types._BaseFieldType):
	...
	def CshFcstRptToBeCanc(self, value):
		self._CshFcstRptToBeCanc = value if value is not None else base_types.UninitialisedField(self, 'CshFcstRptToBeCanc', FundConfirmedCashForecastReport3, False)

	@CshFcstRptToBeCanc.deleter
	def CshFcstRptToBeCanc(self):
		del self._CshFcstRptToBeCanc
		self._CshFcstRptToBeCanc = base_types.UninitialisedField(self, 'CshFcstRptToBeCanc', FundConfirmedCashForecastReport3, False)
