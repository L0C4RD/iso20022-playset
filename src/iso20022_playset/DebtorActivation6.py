...
class DebtorActivation6(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrctRef", "_StartDt", "_Cdtr", "_DispNm", "_DdctdActvtnCd", "_DbtrActvtnId", "_CstmrId", "_UltmtDbtr", "_ActvtnReqDlvryPty", "_DbtrSolPrvdr", "_EndDt", "_Dbtr", "_CtrctFrmtTp", "_UltmtCdtr"]
	@property
	def CtrctRef(self):
