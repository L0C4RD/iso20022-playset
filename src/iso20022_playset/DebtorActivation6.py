...
class DebtorActivation6(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrctFrmtTp", "_EndDt", "_DispNm", "_StartDt", "_DbtrActvtnId", "_Dbtr", "_CtrctRef", "_DbtrSolPrvdr", "_DdctdActvtnCd", "_CstmrId", "_ActvtnReqDlvryPty", "_Cdtr", "_UltmtCdtr", "_UltmtDbtr"]
	@property
