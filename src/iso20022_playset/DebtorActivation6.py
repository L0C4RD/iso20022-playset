...
class DebtorActivation6(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrctRef", "_UltmtDbtr", "_UltmtCdtr", "_Dbtr", "_DispNm", "_CstmrId", "_Cdtr", "_EndDt", "_StartDt", "_CtrctFrmtTp", "_ActvtnReqDlvryPty", "_DdctdActvtnCd", "_DbtrActvtnId", "_DbtrSolPrvdr"]
	@property
	def CtrctRef(self):
