...
class DebtorActivation6(base_types._BaseFieldType):
	...
	__slots__ = ["_DispNm", "_DbtrSolPrvdr", "_CtrctFrmtTp", "_StartDt", "_Dbtr", "_DbtrActvtnId", "_EndDt", "_CtrctRef", "_ActvtnReqDlvryPty", "_Cdtr", "_UltmtDbtr", "_DdctdActvtnCd", "_CstmrId", "_UltmtCdtr"]
	@property
	def DispNm(self):
		return self._DispNm
