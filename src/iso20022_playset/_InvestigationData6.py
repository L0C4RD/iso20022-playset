...
from . import InvestigationDataRecord7Choice
...
class InvestigationData6(base_types._BaseFieldType):
	...
	def RspnData(self, value):
		self._RspnData = value if value is not None else base_types.UninitialisedField(self, 'RspnData', InvestigationDataRecord7Choice, False)

	@RspnData.deleter
	def RspnData(self):
		del self._RspnData
		self._RspnData = base_types.UninitialisedField(self, 'RspnData', InvestigationDataRecord7Choice, False)
