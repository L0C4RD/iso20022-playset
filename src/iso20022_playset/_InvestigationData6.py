...
from .InvestigationDataRecord7Choice import InvestigationDataRecord7Choice
...
class InvestigationData6(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlInvstgtnSeq", "_OrgnlInvstgtnRsnSubTp", "_RltdFileData", "_NclsdFile", "_RspnData", "_RltdInvstgtnData", "_RspnOrgtr", "_OrgnlInvstgtnRsn"]
	@property
