...
class TradeData44(base_types._BaseFieldType):
	...
	__slots__ = ["_MtchgSysUnqRef", "_CurStsDtTm", "_SttlmSsnIdr", "_PdctTp", "_RgltryRptg", "_CurSttlmDt", "_NewSttlmDt", "_OrgtrRef", "_MtchgSysMtchdSdRef", "_MtchgSysMtchgRef"]
	@property
	...
	def CurSttlmDt(self, value):
		self._CurSttlmDt = value if type(value) != base_types.auto else self.make_default("CurSttlmDt")
	...
	def NewSttlmDt(self, value):
		self._NewSttlmDt = value if type(value) != base_types.auto else self.make_default("NewSttlmDt")
