...
from . import FormOfSecurity7Choice
from . import Frequency27Choice
...
from . import Number23Choice
from . import OptionStyle9Choice
from . import OptionType7Choice
from . import PercentageRate
from . import Price3
from . import PriceType5Choice
from . import QuantityBreakdown64
from . import RestrictedFINXMax350Text
from . import SecuritiesPaymentStatus6Choice
from . import SecurityIdentification32
from . import YesNoIndicator

class FinancialInstrumentAttributes119(base_types._BaseFieldType):
	...
	def ConvsPric(self, value):
		self._ConvsPric = value if value is not None else base_types.UninitialisedField(self, 'ConvsPric', Price3, False)

	@ConvsPric.deleter
	def ConvsPric(self):
		del self._ConvsPric
		self._ConvsPric = base_types.UninitialisedField(self, 'ConvsPric', Price3, False)
	...
	def CpnAttchdNb(self, value):
		self._CpnAttchdNb = value if value is not None else base_types.UninitialisedField(self, 'CpnAttchdNb', Number23Choice, False)

	@CpnAttchdNb.deleter
	def CpnAttchdNb(self):
		del self._CpnAttchdNb
		self._CpnAttchdNb = base_types.UninitialisedField(self, 'CpnAttchdNb', Number23Choice, False)
	...
	def ExrcPric(self, value):
		self._ExrcPric = value if value is not None else base_types.UninitialisedField(self, 'ExrcPric', Price3, False)

	@ExrcPric.deleter
	def ExrcPric(self):
		del self._ExrcPric
		self._ExrcPric = base_types.UninitialisedField(self, 'ExrcPric', Price3, False)
	...
	def FinInstrmAttrAddtlDtls(self, value):
		self._FinInstrmAttrAddtlDtls = value if value is not None else base_types.UninitialisedField(self, 'FinInstrmAttrAddtlDtls', RestrictedFINXMax350Text, False)

	@FinInstrmAttrAddtlDtls.deleter
	def FinInstrmAttrAddtlDtls(self):
		del self._FinInstrmAttrAddtlDtls
		self._FinInstrmAttrAddtlDtls = base_types.UninitialisedField(self, 'FinInstrmAttrAddtlDtls', RestrictedFINXMax350Text, False)
	...
	def MktOrIndctvPric(self, value):
		self._MktOrIndctvPric = value if value is not None else base_types.UninitialisedField(self, 'MktOrIndctvPric', PriceType5Choice, False)

	@MktOrIndctvPric.deleter
	def MktOrIndctvPric(self):
		del self._MktOrIndctvPric
		self._MktOrIndctvPric = base_types.UninitialisedField(self, 'MktOrIndctvPric', PriceType5Choice, False)
	...
	def OptnTp(self, value):
		self._OptnTp = value if value is not None else base_types.UninitialisedField(self, 'OptnTp', OptionType7Choice, False)

	@OptnTp.deleter
	def OptnTp(self):
		del self._OptnTp
		self._OptnTp = base_types.UninitialisedField(self, 'OptnTp', OptionType7Choice, False)
	...
	def PmtFrqcy(self, value):
		self._PmtFrqcy = value if value is not None else base_types.UninitialisedField(self, 'PmtFrqcy', Frequency27Choice, False)

	@PmtFrqcy.deleter
	def PmtFrqcy(self):
		del self._PmtFrqcy
		self._PmtFrqcy = base_types.UninitialisedField(self, 'PmtFrqcy', Frequency27Choice, False)
	...
	def PmtSts(self, value):
		self._PmtSts = value if value is not None else base_types.UninitialisedField(self, 'PmtSts', SecuritiesPaymentStatus6Choice, False)

	@PmtSts.deleter
	def PmtSts(self):
		del self._PmtSts
		self._PmtSts = base_types.UninitialisedField(self, 'PmtSts', SecuritiesPaymentStatus6Choice, False)
	...
	def PoolNb(self, value):
		self._PoolNb = value if value is not None else base_types.UninitialisedField(self, 'PoolNb', GenericIdentification39, False)

	@PoolNb.deleter
	def PoolNb(self):
		del self._PoolNb
		self._PoolNb = base_types.UninitialisedField(self, 'PoolNb', GenericIdentification39, False)
	...
	def QtyBrkdwn(self, value):
		self._QtyBrkdwn = value if value is not None else base_types.UninitialisedField(self, 'QtyBrkdwn', QuantityBreakdown64, True)

	@QtyBrkdwn.deleter
	def QtyBrkdwn(self):
		del self._QtyBrkdwn
		self._QtyBrkdwn = base_types.UninitialisedField(self, 'QtyBrkdwn', QuantityBreakdown64, True)
	...
	def RegnForm(self, value):
		self._RegnForm = value if value is not None else base_types.UninitialisedField(self, 'RegnForm', FormOfSecurity7Choice, False)

	@RegnForm.deleter
	def RegnForm(self):
		del self._RegnForm
		self._RegnForm = base_types.UninitialisedField(self, 'RegnForm', FormOfSecurity7Choice, False)
	...
	def SbcptPric(self, value):
		self._SbcptPric = value if value is not None else base_types.UninitialisedField(self, 'SbcptPric', Price3, False)

	@SbcptPric.deleter
	def SbcptPric(self):
		del self._SbcptPric
		self._SbcptPric = base_types.UninitialisedField(self, 'SbcptPric', Price3, False)
	...
	def StrkPric(self, value):
		self._StrkPric = value if value is not None else base_types.UninitialisedField(self, 'StrkPric', Price3, False)

	@StrkPric.deleter
	def StrkPric(self):
		del self._StrkPric
		self._StrkPric = base_types.UninitialisedField(self, 'StrkPric', Price3, False)
	...
	def UndrlygFinInstrmId(self, value):
		self._UndrlygFinInstrmId = value if value is not None else base_types.UninitialisedField(self, 'UndrlygFinInstrmId', SecurityIdentification32, True)

	@UndrlygFinInstrmId.deleter
	def UndrlygFinInstrmId(self):
		del self._UndrlygFinInstrmId
		self._UndrlygFinInstrmId = base_types.UninitialisedField(self, 'UndrlygFinInstrmId', SecurityIdentification32, True)
	...
	def VarblRateChngFrqcy(self, value):
		self._VarblRateChngFrqcy = value if value is not None else base_types.UninitialisedField(self, 'VarblRateChngFrqcy', Frequency27Choice, False)

	@VarblRateChngFrqcy.deleter
	def VarblRateChngFrqcy(self):
		del self._VarblRateChngFrqcy
		self._VarblRateChngFrqcy = base_types.UninitialisedField(self, 'VarblRateChngFrqcy', Frequency27Choice, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='QtyBrkdwn', type=QuantityBreakdown64, min=0, max=None, mutex_group=None, array=True),
		...
		base_types.FieldEntry(name='UndrlygFinInstrmId', type=SecurityIdentification32, min=0, max=None, mutex_group=None, array=True),
