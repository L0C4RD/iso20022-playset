...
from . import DetailedInstructionStatus22
...
class MeetingVoteExecutionConfirmationV12(base_types._BaseFieldType):
	...
	def VoteInstrs(self, value):
		self._VoteInstrs = value if value is not None else base_types.UninitialisedField(self, 'VoteInstrs', DetailedInstructionStatus22, True)

	@VoteInstrs.deleter
	def VoteInstrs(self):
		del self._VoteInstrs
		self._VoteInstrs = base_types.UninitialisedField(self, 'VoteInstrs', DetailedInstructionStatus22, True)
