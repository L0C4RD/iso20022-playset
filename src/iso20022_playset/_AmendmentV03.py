...
class AmendmentV03(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_AmddData", "_SctyTrlr", "_TxId", "_OrgnlMsg", "_Hdr", "_AddtlData", "_MsgAmdd", "_Rcvr", "_Sndr", "_Dstn", "_Rcncltn", "_Jursdctn", "_Orgtr", "_Prgrmm", "_SttlmSvc", "_PrtctdData"]
	@property
