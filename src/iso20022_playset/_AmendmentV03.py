...
class AmendmentV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Orgtr", "_AmddData", "_Hdr", "_TxId", "_MsgAmdd", "_Jursdctn", "_Rcvr", "_PrtctdData", "_SttlmSvc", "_SctyTrlr", "_Sndr", "_OrgnlMsg", "_Prgrmm", "_Rcncltn", "_AddtlData", "_Dstn", "_SplmtryData"]
	@property
	def Orgtr(self):
		return self._Orgtr
