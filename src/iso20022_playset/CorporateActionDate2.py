...
class CorporateActionDate2(base_types._BaseFieldType):
	...
	__slots__ = ["_MtrtyDt", "_DdlnForTaxBrkdwnInstr", "_SpclExDt", "_ExDvddDt", "_UcondlDt", "_IndxFxgDt", "_RcrdDt", "_LpsdDt", "_RsltsPblctnDt", "_EarlyClsgDt", "_FctvDt", "_RedDt", "_MrgnFxgDt", "_WhlyUcondlDt", "_PrratnDt", "_GrntedPrtcptnDt", "_CertfctnDdln", "_EqulstnDt", "_TradgSspdDt", "_PrtctDt", "_RegnDdln", "_LtryDt", "_CrtApprvlDt", "_ElctnToCtrPtyDdln", "_CoverXprtnDt"]
	@property
	def MtrtyDt(self):
