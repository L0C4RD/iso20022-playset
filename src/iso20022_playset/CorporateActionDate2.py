...
class CorporateActionDate2(base_types._BaseFieldType):
	...
	__slots__ = ["_RegnDdln", "_CertfctnDdln", "_PrtctDt", "_WhlyUcondlDt", "_TradgSspdDt", "_RedDt", "_GrntedPrtcptnDt", "_ElctnToCtrPtyDdln", "_MtrtyDt", "_PrratnDt", "_EarlyClsgDt", "_SpclExDt", "_EqulstnDt", "_IndxFxgDt", "_UcondlDt", "_ExDvddDt", "_DdlnForTaxBrkdwnInstr", "_LpsdDt", "_RsltsPblctnDt", "_CrtApprvlDt", "_RcrdDt", "_CoverXprtnDt", "_FctvDt", "_LtryDt", "_MrgnFxgDt"]
	@property
	def RegnDdln(self):
