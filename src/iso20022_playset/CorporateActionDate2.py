...
class CorporateActionDate2(base_types._BaseFieldType):
	...
	__slots__ = ["_UcondlDt", "_IndxFxgDt", "_RsltsPblctnDt", "_SpclExDt", "_LpsdDt", "_FctvDt", "_PrratnDt", "_GrntedPrtcptnDt", "_CrtApprvlDt", "_LtryDt", "_ExDvddDt", "_DdlnForTaxBrkdwnInstr", "_EqulstnDt", "_PrtctDt", "_WhlyUcondlDt", "_RcrdDt", "_ElctnToCtrPtyDdln", "_EarlyClsgDt", "_RedDt", "_CertfctnDdln", "_TradgSspdDt", "_CoverXprtnDt", "_MtrtyDt", "_MrgnFxgDt", "_RegnDdln"]
	@property
	def UcondlDt(self):
