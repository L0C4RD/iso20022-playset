...
class CorporateActionDate2(base_types._BaseFieldType):
	...
	__slots__ = ["_LtryDt", "_ElctnToCtrPtyDdln", "_EqulstnDt", "_MrgnFxgDt", "_LpsdDt", "_ExDvddDt", "_SpclExDt", "_IndxFxgDt", "_PrratnDt", "_DdlnForTaxBrkdwnInstr", "_RegnDdln", "_CertfctnDdln", "_MtrtyDt", "_CoverXprtnDt", "_RedDt", "_RsltsPblctnDt", "_PrtctDt", "_TradgSspdDt", "_WhlyUcondlDt", "_RcrdDt", "_GrntedPrtcptnDt", "_EarlyClsgDt", "_FctvDt", "_CrtApprvlDt", "_UcondlDt"]
	@property
	def LtryDt(self):
		return self._LtryDt
