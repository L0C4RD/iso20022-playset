...
from .AmountAndDirection72 import AmountAndDirection72

class OtherAmounts36(base_types._BaseFieldType):

	__slots__ = ["_TxTax", "_StmpDty", "_CsmptnTax", "_AcrdIntrstAmt", "_ChrgsFees", "_LclBrkrComssn", "_ExctgBrkrAmt", "_LclTax", "_Othr", "_WhldgTax", "_TradAmt"]
	@property
	def TxTax(self):
		return self._TxTax
