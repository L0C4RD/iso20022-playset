import base_types
import AmountAndDirection72

class OtherAmounts36(base_types._BaseFieldType):

	__slots__ = ["_TxTax", "_ExctgBrkrAmt", "_LclBrkrComssn", "_Othr", "_TradAmt", "_LclTax", "_WhldgTax", "_AcrdIntrstAmt", "_StmpDty", "_ChrgsFees", "_CsmptnTax"]
	@property
	def TxTax(self):
		return self._TxTax
