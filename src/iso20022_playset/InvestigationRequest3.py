...
class InvestigationRequest3(base_types._BaseFieldType):
	...
	__slots__ = ["_MsgId", "_Undrlyg", "_EIR", "_Rqstr", "_XpctdRspndr", "_Rspndr", "_SvcLvl", "_InvstgtnSubTp", "_RqstrInvstgtnId", "_InvstgtnTp", "_ReqOrgtr", "_UndrlygInstrm", "_RspndrInvstgtnId", "_ReqActn"]
	@property
	def MsgId(self):
		return self._MsgId
