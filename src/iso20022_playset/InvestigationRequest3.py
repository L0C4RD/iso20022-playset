...
class InvestigationRequest3(base_types._BaseFieldType):
	...
	__slots__ = ["_InvstgtnSubTp", "_MsgId", "_RspndrInvstgtnId", "_XpctdRspndr", "_Undrlyg", "_Rqstr", "_Rspndr", "_EIR", "_SvcLvl", "_ReqOrgtr", "_ReqActn", "_UndrlygInstrm", "_InvstgtnTp", "_RqstrInvstgtnId"]
	@property
