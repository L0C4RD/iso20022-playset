...
from .TerminalManagementActionResult2Code import TerminalManagementActionResult2Code
from .Max140Text import Max140Text
from .ISODateTime import ISODateTime
from .ATMCommand5Code import ATMCommand5Code

class ATMCommand8(base_types._BaseFieldType):

	__slots__ = ["_PrcdDtTm", "_Rslt", "_Tp", "_CmdId", "_ReqrdDtTm", "_AddtlErrInf"]
	@property
	def PrcdDtTm(self):
	...
	def PrcdDtTm(self, value):
		self._PrcdDtTm = value if type(value) != base_types.auto else self.make_default("PrcdDtTm")
	...
	def ReqrdDtTm(self, value):
		self._ReqrdDtTm = value if type(value) != base_types.auto else self.make_default("ReqrdDtTm")
