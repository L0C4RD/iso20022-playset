...
from .Instruction1Code import Instruction1Code
...
from .DateAndDateTimeSearch3Choice import DateAndDateTimeSearch3Choice
from .ActiveOrHistoricCurrencyCode import ActiveOrHistoricCurrencyCode
from .ActiveOrHistoricAmountRange2Choice import ActiveOrHistoricAmountRange2Choice
...
from .InstructionStatusSearch5 import InstructionStatusSearch5

class PaymentSearch10(base_types._BaseFieldType):

	__slots__ = ["_Prty", "_PmtTp", "_Pties", "_UETR", "_IntrBkSttlmAmt", "_InstdAmtCcy", "_ReqdExctnDt", "_IntrBkSttlmAmtCcy", "_IntrBkSttlmDt", "_Sts", "_MsgId", "_PmtId", "_TxId", "_InstdAmt", "_CdtDbtInd", "_PmtMtd", "_PrcgVldtyTm", "_EndToEndId", "_Instr"]
	@property
	def Prty(self):
		return self._Prty
	...
	def InstdAmtCcy(self, value):
		self._InstdAmtCcy = value if type(value) != auto else self.make_default("InstdAmtCcy")
	...
	def IntrBkSttlmAmtCcy(self, value):
		self._IntrBkSttlmAmtCcy = value if type(value) != auto else self.make_default("IntrBkSttlmAmtCcy")
