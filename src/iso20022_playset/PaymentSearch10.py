...
class PaymentSearch10(base_types._BaseFieldType):
	...
	__slots__ = ["_UETR", "_PmtMtd", "_CdtDbtInd", "_Prty", "_PrcgVldtyTm", "_Sts", "_ReqdExctnDt", "_IntrBkSttlmDt", "_InstdAmt", "_Instr", "_Pties", "_InstdAmtCcy", "_TxId", "_IntrBkSttlmAmtCcy", "_EndToEndId", "_PmtTp", "_PmtId", "_MsgId", "_IntrBkSttlmAmt"]
	@property
	def UETR(self):
		return self._UETR
