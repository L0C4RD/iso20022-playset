...
class CertificateDataSet2(base_types._BaseFieldType):
	...
	__slots__ = ["_AuthrsdInspctrInd", "_CertTp", "_GoodsDesc", "_InspctnDt", "_Trnsprt", "_Manfctr", "_CertId", "_AddtlInf", "_Consgnr", "_LineItm", "_IsseDt", "_Consgn", "_CertfdChrtcs", "_Issr", "_PlcOfIsse", "_DataSetId"]
	@property
