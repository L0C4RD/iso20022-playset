...
class CertificateDataSet2(base_types._BaseFieldType):
	...
	__slots__ = ["_InspctnDt", "_DataSetId", "_Consgn", "_Issr", "_IsseDt", "_Manfctr", "_CertTp", "_CertfdChrtcs", "_LineItm", "_Consgnr", "_GoodsDesc", "_CertId", "_PlcOfIsse", "_AddtlInf", "_Trnsprt", "_AuthrsdInspctrInd"]
	@property
	def InspctnDt(self):
