...
class InputData6(base_types._BaseFieldType):
	...
	__slots__ = ["_DsblCclFlg", "_InptCmd", "_DsblCrrctFlg", "_DvcTp", "_InfQlfr", "_NtfyCardInptFlg", "_BeepKeyFlg", "_MaxInptTm", "_InptTxt", "_DsblVldFlg", "_ImdtRspnFlg", "_GblCrrctnFlg", "_MenuBckFlg", "_WaitUsrVldtnFlg"]
	@property
	def DsblCclFlg(self):
