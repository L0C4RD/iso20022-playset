...
class InputData6(base_types._BaseFieldType):
	...
	__slots__ = ["_DsblCclFlg", "_InptCmd", "_InptTxt", "_MenuBckFlg", "_DsblVldFlg", "_BeepKeyFlg", "_DvcTp", "_WaitUsrVldtnFlg", "_GblCrrctnFlg", "_MaxInptTm", "_InfQlfr", "_DsblCrrctFlg", "_ImdtRspnFlg", "_NtfyCardInptFlg"]
	@property
	def DsblCclFlg(self):
