...
from . import FraudReportingInitiationV03
...
class CAFR_001_001_03():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def FrdRptgInitn(self, value):
			self._FrdRptgInitn = value if value is not None else base_types.UninitialisedField(self, 'FrdRptgInitn', FraudReportingInitiationV03, False)

		@FrdRptgInitn.deleter
		def FrdRptgInitn(self):
			del self._FrdRptgInitn
			self._FrdRptgInitn = base_types.UninitialisedField(self, 'FrdRptgInitn', FraudReportingInitiationV03, False)
