...
class OtherAmounts42(base_types._BaseFieldType):
	...
	__slots__ = ["_StmpDty", "_TxTax", "_CsmptnTax", "_CtryNtlFdrlTax", "_Othr", "_AcrdCptlstnAmt", "_BookVal", "_LclTax", "_TradAmt", "_ChrgsFees", "_Mrgn", "_ExctgBrkrAmt", "_NetGnLoss", "_ShppgAmt", "_PmtLevyTax", "_WhldgTax", "_ValAddedTax", "_RsrchFee", "_IsseDscntAllwnc", "_SpclCncssn", "_StockXchgTax", "_TrfTax", "_AcrdIntrstAmt", "_RgltryAmt", "_LclBrkrComssn"]
	@property
	def StmpDty(self):
