...
from . import AdministrativeRequest9
...
class SaleToPOIAdministrativeRequestV08(base_types._BaseFieldType):
	...
	def AdmstvReq(self, value):
		self._AdmstvReq = value if value is not None else base_types.UninitialisedField(self, 'AdmstvReq', AdministrativeRequest9, False)

	@AdmstvReq.deleter
	def AdmstvReq(self):
		del self._AdmstvReq
		self._AdmstvReq = base_types.UninitialisedField(self, 'AdmstvReq', AdministrativeRequest9, False)
