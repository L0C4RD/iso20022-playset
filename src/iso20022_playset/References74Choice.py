...
class References74Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_TradId", "_AcctSvcrTxId", "_PoolId", "_OthrTxId", "_SctiesSttlmTxId", "_CmonId", "_IntraBalMvmntId", "_IntraPosMvmntId", "_MktInfrstrctrTxId", "_CtrPtyMktInfrstrctrTxId"]
	@property
	def TradId(self):
		return self._TradId
