...
class SubscriptionExecution14(base_types._BaseFieldType):
	...
	__slots__ = ["_PrtlyExctdInd", "_NonStdSttlmInf", "_Rndg", "_NgtdTrad", "_DealgPricDtls", "_CumDvddInd", "_PrtlSttlmOfUnits", "_DealRef", "_CshSttlmDt", "_BestExctn", "_CshSttlmDtls", "_StffClntBrkdwn", "_PhysDlvryDtls", "_FXDtls", "_IntrmPrftAmt", "_Equlstn", "_LttrInttRef", "_UnitsNb", "_AcmltnRghtRef", "_FinAdvc", "_SrcOfCsh", "_CstmrCndctClssfctn", "_GrssAmt", "_TradDtTm", "_FinInstrmDtls", "_SttlmMtd", "_OrdrTp", "_ReqdSttlmCcy", "_PrtlSttlmOfCsh", "_TxChanlTp", "_Rfnd", "_InftvPricDtls", "_InftvTaxDtls", "_LateRpt", "_SubAcctForHldg", "_PhysDlvryInd", "_NetAmt", "_RltdPtyDtls", "_SttlmAndCtdyDtls", "_IncmPref", "_SttlmAmt", "_ClntRef", "_SbcptIntrst", "_OrdrRef", "_ReqdNAVCcy", "_TxOvrhd", "_SgntrTp", "_OrdrWvrDtls"]
	@property
