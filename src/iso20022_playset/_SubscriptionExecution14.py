...
from . import FundSettlementParameters20
from . import ISODate
...
class SubscriptionExecution14(base_types._BaseFieldType):
	...
	def CshSttlmDtls(self, value):
		self._CshSttlmDtls = value if value is not None else base_types.UninitialisedField(self, 'CshSttlmDtls', PaymentTransaction162, False)

	@CshSttlmDtls.deleter
	def CshSttlmDtls(self):
		del self._CshSttlmDtls
		self._CshSttlmDtls = base_types.UninitialisedField(self, 'CshSttlmDtls', PaymentTransaction162, False)
	...
	def Equlstn(self, value):
		self._Equlstn = value if value is not None else base_types.UninitialisedField(self, 'Equlstn', Equalisation4, False)

	@Equlstn.deleter
	def Equlstn(self):
		del self._Equlstn
		self._Equlstn = base_types.UninitialisedField(self, 'Equlstn', Equalisation4, False)
	...
	@Rfnd.setter
	def Rfnd(self, value):
		self._Rfnd = value if value is not None else base_types.UninitialisedField(self, 'Rfnd', ActiveCurrencyAndAmount, False)

	@Rfnd.deleter
	def Rfnd(self):
		del self._Rfnd
		self._Rfnd = base_types.UninitialisedField(self, 'Rfnd', ActiveCurrencyAndAmount, False)
	...
	def SbcptIntrst(self, value):
		self._SbcptIntrst = value if value is not None else base_types.UninitialisedField(self, 'SbcptIntrst', ActiveCurrencyAndAmount, False)

	@SbcptIntrst.deleter
	def SbcptIntrst(self):
		del self._SbcptIntrst
		self._SbcptIntrst = base_types.UninitialisedField(self, 'SbcptIntrst', ActiveCurrencyAndAmount, False)
	...
	def SttlmAndCtdyDtls(self, value):
		self._SttlmAndCtdyDtls = value if value is not None else base_types.UninitialisedField(self, 'SttlmAndCtdyDtls', FundSettlementParameters20, False)

	@SttlmAndCtdyDtls.deleter
	def SttlmAndCtdyDtls(self):
		del self._SttlmAndCtdyDtls
		self._SttlmAndCtdyDtls = base_types.UninitialisedField(self, 'SttlmAndCtdyDtls', FundSettlementParameters20, False)
