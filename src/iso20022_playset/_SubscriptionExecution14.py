...
class SubscriptionExecution14(base_types._BaseFieldType):
	...
	__slots__ = ["_SgntrTp", "_TxOvrhd", "_DealgPricDtls", "_OrdrTp", "_SttlmMtd", "_NgtdTrad", "_IncmPref", "_Rndg", "_FinInstrmDtls", "_UnitsNb", "_SttlmAndCtdyDtls", "_PhysDlvryInd", "_CumDvddInd", "_StffClntBrkdwn", "_TxChanlTp", "_DealRef", "_RltdPtyDtls", "_AcmltnRghtRef", "_LateRpt", "_CstmrCndctClssfctn", "_BestExctn", "_CshSttlmDtls", "_ReqdSttlmCcy", "_SbcptIntrst", "_NonStdSttlmInf", "_IntrmPrftAmt", "_OrdrWvrDtls", "_FinAdvc", "_LttrInttRef", "_InftvTaxDtls", "_SttlmAmt", "_Equlstn", "_Rfnd", "_TradDtTm", "_SubAcctForHldg", "_FXDtls", "_PrtlSttlmOfCsh", "_ReqdNAVCcy", "_PrtlSttlmOfUnits", "_NetAmt", "_PrtlyExctdInd", "_GrssAmt", "_SrcOfCsh", "_CshSttlmDt", "_InftvPricDtls", "_PhysDlvryDtls", "_OrdrRef", "_ClntRef"]
	@property
	def SgntrTp(self):
