...
class CommonFinancialInstrumentAttributes10(base_types._BaseFieldType):
	...
	__slots__ = ["_Cnfdtl", "_SprdAndBchmkCrv", "_XpryDt", "_PrvtPlcmnt", "_RcrdDt", "_CmonSfkpr", "_FinInstrmForm", "_RedTp", "_TaxLotNb", "_NearTermPosLmt", "_PrncplPngAgt", "_Purp", "_ConvsRatioDnmtr", "_Dpstry", "_TradgMtd", "_PutTp", "_AftrXchgPhysForm", "_WhldgTaxRgm", "_ConvsRatioNmrtr", "_Clss", "_PmtSts", "_PosLmt", "_FngbInd", "_ListgDt", "_ConvtblInd", "_LglRstrctns", "_Issnc", "_UndrlygRsk", "_ISOSctyLngNm", "_CpnAttchdNb", "_TradgMkt", "_ConvsPrd", "_NmVldFr", "_DnmtnCcy", "_CvrdInd", "_InitlPhysForm", "_Rstrctn", "_CallTp", "_CtrctVrsnNb", "_ISOSctyShrtNm", "_PmryPlcOfDpst", "_SctySts", "_CtctNm", "_ClssfctnTp", "_CertNb", "_LeadMgr", "_PoolNb", "_SttlmInf", "_TEFRARule", "_PngAgt", "_SrNb", "_RedPmtCcy"]
	@property
	def Cnfdtl(self):
		return self._Cnfdtl
