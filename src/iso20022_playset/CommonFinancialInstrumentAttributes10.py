...
class CommonFinancialInstrumentAttributes10(base_types._BaseFieldType):
	...
	__slots__ = ["_RedPmtCcy", "_ClssfctnTp", "_Cnfdtl", "_LeadMgr", "_PutTp", "_PmryPlcOfDpst", "_CertNb", "_Rstrctn", "_PngAgt", "_TEFRARule", "_ISOSctyShrtNm", "_SttlmInf", "_Clss", "_Dpstry", "_InitlPhysForm", "_TaxLotNb", "_ISOSctyLngNm", "_SprdAndBchmkCrv", "_SrNb", "_FinInstrmForm", "_RcrdDt", "_CpnAttchdNb", "_CvrdInd", "_ConvsPrd", "_NearTermPosLmt", "_Purp", "_AftrXchgPhysForm", "_PmtSts", "_RedTp", "_SctySts", "_NmVldFr", "_ListgDt", "_CmonSfkpr", "_CtctNm", "_CtrctVrsnNb", "_ConvtblInd", "_CallTp", "_DnmtnCcy", "_PrvtPlcmnt", "_WhldgTaxRgm", "_ConvsRatioDnmtr", "_FngbInd", "_TradgMtd", "_PrncplPngAgt", "_PoolNb", "_ConvsRatioNmrtr", "_XpryDt", "_TradgMkt", "_PosLmt", "_LglRstrctns", "_UndrlygRsk", "_Issnc"]
	@property
	def RedPmtCcy(self):
