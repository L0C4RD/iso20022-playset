...
class ATMTransaction49(base_types._BaseFieldType):
	...
	__slots__ = ["_Lmts", "_TxId", "_AuthstnRslt", "_CcyConvsElgblty", "_DtldReqdAmt", "_AddtlChrg", "_CmpltnReqrd", "_MixTp", "_ICCRltdData", "_TtlReqdAmt", "_Cmd", "_AcctInf", "_AcctData", "_TtlAuthrsdAmt", "_Mix", "_PrtctdAcctData", "_RcncltnId"]
	@property
	def Lmts(self):
		return self._Lmts
