...
class ATMTransaction49(base_types._BaseFieldType):
	...
	__slots__ = ["_MixTp", "_ICCRltdData", "_CcyConvsElgblty", "_Cmd", "_DtldReqdAmt", "_TtlAuthrsdAmt", "_CmpltnReqrd", "_TtlReqdAmt", "_PrtctdAcctData", "_AddtlChrg", "_Mix", "_AuthstnRslt", "_RcncltnId", "_TxId", "_AcctData", "_Lmts", "_AcctInf"]
	@property
	def MixTp(self):
		return self._MixTp
