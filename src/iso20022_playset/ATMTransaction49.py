...
class ATMTransaction49(base_types._BaseFieldType):
	...
	__slots__ = ["_ICCRltdData", "_PrtctdAcctData", "_DtldReqdAmt", "_AcctInf", "_CmpltnReqrd", "_AcctData", "_RcncltnId", "_AddtlChrg", "_TxId", "_TtlAuthrsdAmt", "_MixTp", "_Lmts", "_Cmd", "_TtlReqdAmt", "_CcyConvsElgblty", "_Mix", "_AuthstnRslt"]
	@property
