...
class ATMTransaction49(base_types._BaseFieldType):
	...
	__slots__ = ["_Mix", "_DtldReqdAmt", "_AddtlChrg", "_AcctData", "_CcyConvsElgblty", "_Lmts", "_AcctInf", "_TxId", "_TtlReqdAmt", "_MixTp", "_TtlAuthrsdAmt", "_CmpltnReqrd", "_Cmd", "_ICCRltdData", "_PrtctdAcctData", "_AuthstnRslt", "_RcncltnId"]
	@property
	def Mix(self):
		return self._Mix
