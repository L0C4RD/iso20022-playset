...
class BusinessLetter1(base_types._BaseFieldType):
	...
	__slots__ = ["_Dt", "_VldtnStsInf", "_PmryRcpt", "_RspnRcpt", "_GovngCtrct", "_LttrIdr", "_RltdLttr", "_CnttIdr", "_CpyRcpt", "_ApplCntxt", "_RltdMsg", "_AddtlInf", "_DgtlSgntr", "_OthrPty", "_Orgtr", "_Sndr", "_LglCntxt", "_AuthstnUsr", "_AssoctdDoc", "_Ntce", "_InstrPrty"]
	@property
	def Dt(self):
		return self._Dt
