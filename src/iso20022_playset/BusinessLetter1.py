...
class BusinessLetter1(base_types._BaseFieldType):
	...
	__slots__ = ["_InstrPrty", "_OthrPty", "_PmryRcpt", "_LttrIdr", "_VldtnStsInf", "_AddtlInf", "_RltdLttr", "_Sndr", "_GovngCtrct", "_AuthstnUsr", "_DgtlSgntr", "_AssoctdDoc", "_LglCntxt", "_CpyRcpt", "_RspnRcpt", "_ApplCntxt", "_Ntce", "_Dt", "_Orgtr", "_CnttIdr", "_RltdMsg"]
	@property
	def InstrPrty(self):
