...
from ._SaleToPOIAdministrativeRequestV08 import SaleToPOIAdministrativeRequestV08
...
class CASP_007_001_08():
	...
	class Document(base_types._BaseFieldType):
		...
		attrib = {
			"xmlns" : base_types._BaseDataType_String(None, data="urn:iso:std:iso:20022:tech:xsd:casp.007.001.08"),
		}
