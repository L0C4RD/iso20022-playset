...
from .IssuerCSDIdentification1 import IssuerCSDIdentification1
...
class IssuerCSDReport1(base_types._BaseFieldType):
	...
	__slots__ = ["_OvrllTtl", "_TxTp", "_TtlCshTrf", "_FinInstrm", "_Id", "_ClntTp"]
	@property
	def OvrllTtl(self):
	...
	def TtlCshTrf(self, value):
		self._TtlCshTrf = value if type(value) != base_types.auto else self.make_default("TtlCshTrf")
	...
	def ClntTp(self, value):
		self._ClntTp = value if type(value) != base_types.auto else self.make_default("ClntTp")
