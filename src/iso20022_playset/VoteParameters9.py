...
class VoteParameters9(base_types._BaseFieldType):
	...
	__slots__ = ["_BnfclOwnrDsclsr", "_EarlyVoteWthPrmDdln", "_PrtlVoteAllwd", "_VoteMktDdln", "_PrvsInstrInvldtyInd", "_SpltVoteAllwd", "_VoteWthPrmDdln", "_VoteWthPrmMktDdln", "_IncntivPrm", "_AddtlVtngRqrmnts", "_VoteMthds", "_RvcbltyMktDdln", "_RvcbltyDdln", "_EarlyIncntivPrm", "_VtngBlltReqAdr", "_SctiesQtyReqrdToVote", "_VoteDdln", "_VtngBlltElctrncAdr"]
	@property
