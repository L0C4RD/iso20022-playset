...
from .OriginalItemAndStatus8 import OriginalItemAndStatus8

class OriginalNotificationReference13(base_types._BaseFieldType):

	__slots__ = ["_TtlAmt", "_XpctdValDt", "_IntrmyAgt", "_Acct", "_RltdAcct", "_OrgnlItmAndSts", "_DbtrAgt", "_AcctOwnr", "_AcctSvcr", "_Dbtr"]
	@property
	def TtlAmt(self):
		return self._TtlAmt
