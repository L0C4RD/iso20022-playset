...
from . import ISODate
from . import OriginalItemAndStatus8
...
class OriginalNotificationReference13(base_types._BaseFieldType):
	...
	def OrgnlItmAndSts(self, value):
		self._OrgnlItmAndSts = value if value is not None else base_types.UninitialisedField(self, 'OrgnlItmAndSts', OriginalItemAndStatus8, True)

	@OrgnlItmAndSts.deleter
	def OrgnlItmAndSts(self):
		del self._OrgnlItmAndSts
		self._OrgnlItmAndSts = base_types.UninitialisedField(self, 'OrgnlItmAndSts', OriginalItemAndStatus8, True)
