...
class CurrencyExchange22(base_types._BaseFieldType):
	...
	def DlvrblCrossCcy(self, value):
		self._DlvrblCrossCcy = value if value is not None else base_types.UninitialisedField(self, 'DlvrblCrossCcy', ActiveOrHistoricCurrencyCode, False)

	@DlvrblCrossCcy.deleter
	def DlvrblCrossCcy(self):
		del self._DlvrblCrossCcy
		self._DlvrblCrossCcy = base_types.UninitialisedField(self, 'DlvrblCrossCcy', ActiveOrHistoricCurrencyCode, False)
