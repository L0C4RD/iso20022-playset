...
from .SecuritiesTransactionType51Choice import SecuritiesTransactionType51Choice
...
class SettlementDetails211(base_types._BaseFieldType):
	...
	__slots__ = ["_ElgblForColl", "_AutomtcBrrwg", "_SttlgCpcty", "_SctiesTxTp", "_RpTp", "_CshSubBalTp", "_LglRstrctns", "_XpsrTp", "_NetgElgblty", "_Regn", "_SttlmSysMtd", "_CCPElgblty", "_LttrOfGrnt", "_BlckTrad", "_SctiesRTGS", "_TaxCpcty", "_BnfclOwnrsh", "_MktClntSd", "_SttlmTxCond", "_StmpDtyTaxBsis", "_SctiesSubBalTp", "_Prty", "_PrtlSttlmInd", "_CshClrSys"]
	@property
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='SctiesTxTp', type=SecuritiesTransactionType51Choice, min=1, max=1, mutex_group=None, array=False),
