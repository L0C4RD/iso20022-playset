...
class SettlementDetails211(base_types._BaseFieldType):
	...
	__slots__ = ["_XpsrTp", "_TaxCpcty", "_StmpDtyTaxBsis", "_SttlmTxCond", "_SttlmSysMtd", "_ElgblForColl", "_CshSubBalTp", "_BlckTrad", "_SctiesTxTp", "_MktClntSd", "_RpTp", "_BnfclOwnrsh", "_LttrOfGrnt", "_SctiesRTGS", "_Regn", "_NetgElgblty", "_PrtlSttlmInd", "_CshClrSys", "_LglRstrctns", "_Prty", "_CCPElgblty", "_SctiesSubBalTp", "_SttlgCpcty", "_AutomtcBrrwg"]
	@property
	def XpsrTp(self):
		return self._XpsrTp
