...
import SecuritiesTransactionType51Choice
...
class SettlementDetails211(base_types._BaseFieldType):
	...
	__slots__ = ["_Prty", "_SttlmSysMtd", "_StmpDtyTaxBsis", "_NetgElgblty", "_SctiesTxTp", "_LttrOfGrnt", "_BnfclOwnrsh", "_CshClrSys", "_SctiesRTGS", "_Regn", "_PrtlSttlmInd", "_TaxCpcty", "_SctiesSubBalTp", "_BlckTrad", "_AutomtcBrrwg", "_MktClntSd", "_LglRstrctns", "_CshSubBalTp", "_XpsrTp", "_RpTp", "_ElgblForColl", "_SttlgCpcty", "_CCPElgblty", "_SttlmTxCond"]
	@property
	def Prty(self):
		return self._Prty
