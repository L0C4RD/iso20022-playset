...
from . import DistributionProcessingStatus1
...
class GlobalDistributionStatus1(base_types._BaseFieldType):
	...
	def PrcdSts(self, value):
		self._PrcdSts = value if value is not None else base_types.UninitialisedField(self, 'PrcdSts', DistributionProcessingStatus1, False)

	@PrcdSts.deleter
	def PrcdSts(self):
		del self._PrcdSts
		self._PrcdSts = base_types.UninitialisedField(self, 'PrcdSts', DistributionProcessingStatus1, False)
