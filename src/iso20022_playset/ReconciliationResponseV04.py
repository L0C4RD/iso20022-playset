...
from .CardServiceType4Code import CardServiceType4Code
...
from .TransactionTotals14 import TransactionTotals14
from .Header71 import Header71
from .ReconciliationFunction1Code import ReconciliationFunction1Code
...
from .ReconciliationActivityType1Code import ReconciliationActivityType1Code
...
class ReconciliationResponseV04(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlRspnCd", "_RcncltnFctn", "_Prgrmm", "_SctyTrlr", "_ReqdCcy", "_PrcgRslt", "_Orgtr", "_RcncltnActvtyTp", "_AddtlData", "_LifeCyclId", "_AddtlFee", "_OthrRcncltnTp", "_Jursdctn", "_Dstn", "_SplmtryData", "_RcncltnTtls", "_Hdr", "_PrtctdData", "_Sndr", "_RcncltnTp", "_RtrvlRefNb", "_SttlmSvc", "_TrnsmssnDtTm", "_SysTracAudtNb", "_Rcvr", "_OthrRcncltnActvtyTp", "_Rcncltn"]
	@property
