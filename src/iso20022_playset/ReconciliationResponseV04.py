...
class ReconciliationResponseV04(base_types._BaseFieldType):
	...
	__slots__ = ["_Jursdctn", "_SplmtryData", "_AddtlData", "_RcncltnTp", "_Orgtr", "_Hdr", "_SttlmSvc", "_ReqdCcy", "_RcncltnActvtyTp", "_OthrRcncltnActvtyTp", "_OrgnlRspnCd", "_RtrvlRefNb", "_Sndr", "_Dstn", "_PrcgRslt", "_SysTracAudtNb", "_Rcncltn", "_Rcvr", "_SctyTrlr", "_Prgrmm", "_PrtctdData", "_TrnsmssnDtTm", "_RcncltnTtls", "_RcncltnFctn", "_OthrRcncltnTp", "_LifeCyclId", "_AddtlFee"]
	@property
	def Jursdctn(self):
