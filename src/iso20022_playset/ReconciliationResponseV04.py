...
class ReconciliationResponseV04(base_types._BaseFieldType):
	...
	__slots__ = ["_Hdr", "_Dstn", "_PrtctdData", "_OthrRcncltnActvtyTp", "_RcncltnFctn", "_Rcvr", "_Jursdctn", "_SctyTrlr", "_Sndr", "_RtrvlRefNb", "_RcncltnTtls", "_RcncltnTp", "_AddtlFee", "_OrgnlRspnCd", "_Rcncltn", "_SplmtryData", "_AddtlData", "_SttlmSvc", "_LifeCyclId", "_ReqdCcy", "_TrnsmssnDtTm", "_OthrRcncltnTp", "_Prgrmm", "_SysTracAudtNb", "_Orgtr", "_RcncltnActvtyTp", "_PrcgRslt"]
	@property
	def Hdr(self):
		return self._Hdr
