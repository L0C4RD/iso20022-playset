...
class ReconciliationResponseV04(base_types._BaseFieldType):
	...
	__slots__ = ["_RcncltnTp", "_RtrvlRefNb", "_AddtlData", "_SysTracAudtNb", "_SctyTrlr", "_Hdr", "_Sndr", "_Orgtr", "_OrgnlRspnCd", "_RcncltnTtls", "_Jursdctn", "_Rcvr", "_OthrRcncltnActvtyTp", "_ReqdCcy", "_RcncltnFctn", "_RcncltnActvtyTp", "_OthrRcncltnTp", "_Prgrmm", "_AddtlFee", "_Dstn", "_SttlmSvc", "_PrcgRslt", "_Rcncltn", "_PrtctdData", "_SplmtryData", "_TrnsmssnDtTm", "_LifeCyclId"]
	@property
	def RcncltnTp(self):
