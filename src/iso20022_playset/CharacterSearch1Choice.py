...
class CharacterSearch1Choice(base_types._BaseFieldType):
	...
	@NCT.setter
	def NCT(self, value):
		self._NCT = value if type(value) != base_types.auto else self.make_default("NCT")
	...
	@CT.setter
	def CT(self, value):
		self._CT = value if type(value) != base_types.auto else self.make_default("CT")
