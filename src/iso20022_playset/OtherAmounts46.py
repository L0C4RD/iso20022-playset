...
class OtherAmounts46(base_types._BaseFieldType):
	...
	__slots__ = ["_Othr", "_TrfTax", "_ValAddedTax", "_BookVal", "_LclTax", "_StockXchgTax", "_TradAmt", "_CsmptnTax", "_SpclCncssn", "_TxTax", "_LclTaxCtrySpcfc", "_ShppgAmt", "_RgltryAmt", "_CollMntrAmt", "_ExctgBrkrAmt", "_StmpDty", "_WhldgTax", "_AcrdIntrstAmt", "_ChrgsFees", "_AcrdCptlstnAmt", "_LclBrkrComssn", "_NetGnLoss", "_Mrgn", "_IsseDscntAllwnc", "_CtryNtlFdrlTax", "_NtwkFee", "_PmtLevyTax", "_RsrchFee"]
	@property
	def Othr(self):
		return self._Othr
