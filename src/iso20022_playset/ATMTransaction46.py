...
class ATMTransaction46(base_types._BaseFieldType):
	...
	__slots__ = ["_PrtctdAcctData", "_SelctdMix", "_AcctData", "_TtlReqdAmt", "_CcyConvsRslt", "_CshDspnsd", "_DtldReqdAmt", "_ICCRltdData", "_TxId", "_ReqdRct", "_SelctdMixTp", "_RcncltnId"]
	@property
	...
	def SelctdMix(self, value):
		self._SelctdMix = value if type(value) != auto else self.make_default("SelctdMix")
