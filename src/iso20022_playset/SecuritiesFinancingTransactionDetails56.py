...
class SecuritiesFinancingTransactionDetails56(base_types._BaseFieldType):
	...
	__slots__ = ["_TermntnTxAmt", "_IntrstPmt", "_TxCallDely", "_LglFrmwk", "_PricgRate", "_TermntnAmtPerPcOfColl", "_ScndLegNrrtv", "_Sprd", "_DealAmt", "_SctiesFincgTradId", "_VarblRateSpprt", "_RateChngDt", "_IntrstCmptnMtd", "_EarlstCallBckDt", "_SctiesFincgUnqTxIdr", "_ComssnClctnDt", "_RateTp", "_TtlNbOfCollInstrs", "_ChrgsRate", "_Rvaltn", "_TermntnDt", "_FrftAmt", "_StockLnMrgn", "_SctiesHrcut", "_MtrtyDtMod", "_PrmAmt", "_RpRate", "_AcrdIntrstAmt", "_ClsgLegId"]
	@property
