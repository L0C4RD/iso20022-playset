...
class TradeTransaction50(base_types._BaseFieldType):
	...
	__slots__ = ["_TradClr", "_Optn", "_NrgySpcfcAttrbts", "_ExctnTmStmp", "_Cmprssn", "_TxPric", "_TxId", "_DlvryTp", "_MrrrOrTrggrTx", "_SttlmDt", "_ScndryTxId", "_FctvDt", "_XprtnDt", "_TradConf", "_BlckTradElctn", "_NtnlAmt", "_DerivEvt", "_NonStdsdTerm", "_IntrstRate", "_LrgNtnlOffFcltyElctn", "_Cdt", "_Ccy", "_CollPrtflCd", "_PltfmIdr", "_EarlyTermntnDt", "_PrrTxId", "_NtnlQty", "_RptTrckgNb", "_TradAllcnSts", "_OthrPmt", "_PstTradRskRdctnEvt", "_MstrAgrmt", "_Cmmdty", "_SbsqntTxId", "_Packg", "_PstTradRskRdctnFlg", "_Qty"]
	@property
	def TradClr(self):
