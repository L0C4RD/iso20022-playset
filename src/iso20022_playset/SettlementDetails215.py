...
class SettlementDetails215(base_types._BaseFieldType):
	...
	__slots__ = ["_SctiesTxTp", "_CshSubBalTp", "_SctiesRTGS", "_NetgElgblty", "_SttlgCpcty", "_RpTp", "_SctiesSubBalTp", "_PrtlSttlmInd", "_MktClntSd", "_Regn", "_AutomtcBrrwg", "_BlckTrad", "_CCPElgblty", "_StmpDtyTaxBsis", "_SttlmTxCond", "_LttrOfGrnt", "_XpsrTp", "_TaxCpcty", "_BnfclOwnrsh", "_SttlmSysMtd", "_Prty", "_LglRstrctns", "_ElgblForColl", "_CshClrSys"]
	@property
	def SctiesTxTp(self):
