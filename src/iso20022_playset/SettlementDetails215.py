...
import SecuritiesTransactionType46Choice
import Restriction5Choice

class SettlementDetails215(base_types._BaseFieldType):

	__slots__ = ["_ElgblForColl", "_RpTp", "_NetgElgblty", "_TaxCpcty", "_SttlmTxCond", "_CshClrSys", "_Regn", "_MktClntSd", "_Prty", "_SctiesSubBalTp", "_CshSubBalTp", "_StmpDtyTaxBsis", "_LttrOfGrnt", "_SctiesRTGS", "_CCPElgblty", "_LglRstrctns", "_PrtlSttlmInd", "_SttlmSysMtd", "_SctiesTxTp", "_AutomtcBrrwg", "_BnfclOwnrsh", "_XpsrTp", "_SttlgCpcty", "_BlckTrad"]
	@property
