...
class SettlementDetails215(base_types._BaseFieldType):
	...
	__slots__ = ["_CshClrSys", "_CCPElgblty", "_SctiesRTGS", "_SttlgCpcty", "_AutomtcBrrwg", "_NetgElgblty", "_BlckTrad", "_BnfclOwnrsh", "_TaxCpcty", "_SttlmSysMtd", "_SctiesTxTp", "_SctiesSubBalTp", "_LglRstrctns", "_LttrOfGrnt", "_PrtlSttlmInd", "_StmpDtyTaxBsis", "_SttlmTxCond", "_XpsrTp", "_ElgblForColl", "_MktClntSd", "_Regn", "_RpTp", "_CshSubBalTp", "_Prty"]
	@property
	def CshClrSys(self):
