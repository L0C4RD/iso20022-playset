...
class SettlementDetails215(base_types._BaseFieldType):
	...
	__slots__ = ["_CshClrSys", "_SctiesTxTp", "_ElgblForColl", "_CCPElgblty", "_StmpDtyTaxBsis", "_BlckTrad", "_MktClntSd", "_Regn", "_NetgElgblty", "_TaxCpcty", "_SctiesSubBalTp", "_SttlmTxCond", "_LglRstrctns", "_SttlgCpcty", "_CshSubBalTp", "_XpsrTp", "_SctiesRTGS", "_Prty", "_BnfclOwnrsh", "_SttlmSysMtd", "_LttrOfGrnt", "_PrtlSttlmInd", "_RpTp", "_AutomtcBrrwg"]
	@property
	def CshClrSys(self):
