...
class SettlementDetails215(base_types._BaseFieldType):
	...
	__slots__ = ["_TaxCpcty", "_NetgElgblty", "_MktClntSd", "_SttlmTxCond", "_Regn", "_AutomtcBrrwg", "_CshClrSys", "_CCPElgblty", "_BlckTrad", "_SttlgCpcty", "_LttrOfGrnt", "_PrtlSttlmInd", "_BnfclOwnrsh", "_SttlmSysMtd", "_SctiesSubBalTp", "_XpsrTp", "_StmpDtyTaxBsis", "_RpTp", "_SctiesTxTp", "_Prty", "_SctiesRTGS", "_ElgblForColl", "_CshSubBalTp", "_LglRstrctns"]
	@property
	def TaxCpcty(self):
