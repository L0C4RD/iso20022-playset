...
from . import ISIN2021Identifier
...
class SecurityIdentification39(base_types._BaseFieldType):
	...
	@ISIN.setter
	def ISIN(self, value):
		self._ISIN = value if value is not None else base_types.UninitialisedField(self, 'ISIN', ISIN2021Identifier, False)

	@ISIN.deleter
	def ISIN(self):
		del self._ISIN
		self._ISIN = base_types.UninitialisedField(self, 'ISIN', ISIN2021Identifier, False)
