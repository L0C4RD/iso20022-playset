...
class PaymentTransaction149(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlEndToEndId", "_SttlmTmIndctn", "_SplmtryData", "_ChrgBr", "_OrgnlInstrId", "_OrgnlClrSysRef", "_SttlmPrty", "_OrgnlTxRef", "_RvsdInstdAmt", "_InstgAgt", "_OrgnlUETR", "_OrgnlGrpInf", "_ChrgsInf", "_OrgnlTxId", "_CompstnAmt", "_XchgRate", "_RvslRsnInf", "_OrgnlIntrBkSttlmAmt", "_InstdAgt", "_RvslId", "_RvsdIntrBkSttlmAmt", "_IntrBkSttlmDt"]
	@property
	...
	def RvsdIntrBkSttlmAmt(self, value):
		self._RvsdIntrBkSttlmAmt = value if type(value) != base_types.auto else self.make_default("RvsdIntrBkSttlmAmt")
