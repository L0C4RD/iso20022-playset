...
class PaymentTransaction149(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlEndToEndId", "_RvslId", "_CompstnAmt", "_IntrBkSttlmDt", "_OrgnlIntrBkSttlmAmt", "_XchgRate", "_SttlmTmIndctn", "_OrgnlInstrId", "_RvsdInstdAmt", "_InstgAgt", "_ChrgsInf", "_OrgnlGrpInf", "_RvslRsnInf", "_OrgnlUETR", "_RvsdIntrBkSttlmAmt", "_OrgnlTxRef", "_InstdAgt", "_SttlmPrty", "_ChrgBr", "_SplmtryData", "_OrgnlTxId", "_OrgnlClrSysRef"]
	@property
