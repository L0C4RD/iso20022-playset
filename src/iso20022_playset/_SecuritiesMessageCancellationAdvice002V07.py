...
from . import References79Choice
...
class SecuritiesMessageCancellationAdvice002V07(base_types._BaseFieldType):
	...
	@Ref.setter
	def Ref(self, value):
		self._Ref = value if value is not None else base_types.UninitialisedField(self, 'Ref', References79Choice, False)

	@Ref.deleter
	def Ref(self):
		del self._Ref
		self._Ref = base_types.UninitialisedField(self, 'Ref', References79Choice, False)
