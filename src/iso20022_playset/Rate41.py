...
class Rate41(base_types._BaseFieldType):
	...
	__slots__ = ["_AplblRate", "_SlctnFeeRate", "_EqulstnRate", "_GrssIntrstRateUsdForPmt", "_DmdRate", "_WhldgTaxRate", "_TaxCdtRate", "_ChrgsFees", "_FsclStmp", "_GrssDstrbtnRate", "_ThrdPtyIncntivRate", "_TaxRclmRate", "_ScndLvlTax", "_TaxOnPrfts", "_AddtlTax", "_NetDstrbtnRate", "_EarlySlctnFeeRate", "_TaxOnIncm"]
	@property
	def AplblRate(self):
