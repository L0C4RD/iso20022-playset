...
class Rate41(base_types._BaseFieldType):
	...
	__slots__ = ["_ScndLvlTax", "_EqulstnRate", "_TaxOnPrfts", "_NetDstrbtnRate", "_GrssIntrstRateUsdForPmt", "_TaxCdtRate", "_AplblRate", "_ThrdPtyIncntivRate", "_EarlySlctnFeeRate", "_FsclStmp", "_ChrgsFees", "_DmdRate", "_TaxOnIncm", "_AddtlTax", "_GrssDstrbtnRate", "_TaxRclmRate", "_SlctnFeeRate", "_WhldgTaxRate"]
	@property
	def ScndLvlTax(self):
