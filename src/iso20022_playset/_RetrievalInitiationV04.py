...
from . import ProcessingResult31
...
class RetrievalInitiationV04(base_types._BaseFieldType):

	__slots__ = ["_Accptr", "_Acqrr", "_AddtlFee", "_Card", "_Cntxt", "_ConvsDtTm", "_DsptData", "_Dstn", "_Hdr", "_Issr", "_Jursdctn", "_NtlData", "_OrgnlTx", "_Orgtr", "_PrcgRslt", "_Prgrmm", "_PrtctdData", "_PrvtData", "_Pyee", "_Pyer", "_Rcncltn", "_Rcvr", "_RtrvlFlfmtDstn", "_RtrvlFlfmtInstrs", "_SctyTrlr", "_Sndr", "_SpclPrgrmmQlfctn", "_SttlmSvc", "_Termnl", "_Tkn", "_TxChrtcs", "_TxId", "_Txtr", "_Wllt"]
	@property
	def Accptr(self):
		return self._Accptr
	...
	def Cntxt(self, value):
		self._Cntxt = value if value is not None else base_types.UninitialisedField(self, 'Cntxt', Context30, False)

	@Cntxt.deleter
	def Cntxt(self):
		del self._Cntxt
		self._Cntxt = base_types.UninitialisedField(self, 'Cntxt', Context30, False)
	...
	def PrcgRslt(self, value):
		self._PrcgRslt = value if value is not None else base_types.UninitialisedField(self, 'PrcgRslt', ProcessingResult31, False)

	@PrcgRslt.deleter
	def PrcgRslt(self):
		del self._PrcgRslt
		self._PrcgRslt = base_types.UninitialisedField(self, 'PrcgRslt', ProcessingResult31, False)
	...
	def RtrvlFlfmtDstn(self, value):
		self._RtrvlFlfmtDstn = value if value is not None else base_types.UninitialisedField(self, 'RtrvlFlfmtDstn', DestinationData1, False)

	@RtrvlFlfmtDstn.deleter
	def RtrvlFlfmtDstn(self):
		del self._RtrvlFlfmtDstn
		self._RtrvlFlfmtDstn = base_types.UninitialisedField(self, 'RtrvlFlfmtDstn', DestinationData1, False)
	...
	def RtrvlFlfmtInstrs(self, value):
		self._RtrvlFlfmtInstrs = value if value is not None else base_types.UninitialisedField(self, 'RtrvlFlfmtInstrs', ATICALaxProcessing, True)

	@RtrvlFlfmtInstrs.deleter
	def RtrvlFlfmtInstrs(self):
		del self._RtrvlFlfmtInstrs
		self._RtrvlFlfmtInstrs = base_types.UninitialisedField(self, 'RtrvlFlfmtInstrs', ATICALaxProcessing, True)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='Cntxt', type=Context30, min=0, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='Hdr', type=Header72, min=0, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='PrcgRslt', type=ProcessingResult31, min=0, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='RtrvlFlfmtDstn', type=DestinationData1, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='RtrvlFlfmtInstrs', type=ATICALaxProcessing, min=0, max=None, mutex_group=None, array=True),
