...
class AggregateBalanceInformation4(base_types._BaseFieldType):
	...
	__slots__ = ["_BookVal", "_SfkpgPlc", "_PrvsHldgVal", "_AggtQty", "_AcrdIntrstAmt", "_AcrdIntrstAmtSgn", "_NotAvlblQty", "_FXDtls", "_HldgVal", "_DaysAcrd", "_FinInstrmDtls", "_PricDtls", "_BalBrkdwnDtls", "_BalAtSfkpgPlc", "_AddtlBalBrkdwnDtls", "_AvlblQty"]
	@property
	def BookVal(self):
