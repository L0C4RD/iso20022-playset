...
class AggregateBalanceInformation4(base_types._BaseFieldType):
	...
	__slots__ = ["_PrvsHldgVal", "_FinInstrmDtls", "_FXDtls", "_SfkpgPlc", "_AddtlBalBrkdwnDtls", "_BookVal", "_AcrdIntrstAmt", "_AggtQty", "_AcrdIntrstAmtSgn", "_HldgVal", "_AvlblQty", "_PricDtls", "_DaysAcrd", "_BalBrkdwnDtls", "_NotAvlblQty", "_BalAtSfkpgPlc"]
	@property
