...
class TransactionIdentification62(base_types._BaseFieldType):

	__slots__ = ["_AcqrrRefData", "_AcqrrRefNb", "_AssoctdDataRef", "_AuthntcnTkn", "_AuthstnSeqNb", "_IssrRefData", "_LifeCyclId", "_LifeCyclSpprt", "_NtlData", "_PresntmntSeqCnt", "_PresntmntSeqNb", "_PrvtData", "_PurchsIdr", "_PurchsIdrTp", "_RtrvlRefNb", "_SysTracAudtNb", "_TrnsmssnDtTm"]
	@property
