...
from .NumberOfTransactionsPerStatus1 import NumberOfTransactionsPerStatus1

class OriginalGroupHeader23(base_types._BaseFieldType):

	__slots__ = ["_OrgnlCtrlSum", "_OrgnlNbOfTxs", "_OrgnlCreDtTm", "_CxlStsRsnInf", "_OrgnlGrpCxlId", "_OrgnlMsgNmId", "_NbOfTxsPerCxlSts", "_GrpCxlSts", "_RslvdCase", "_OrgnlMsgId"]
	@property
