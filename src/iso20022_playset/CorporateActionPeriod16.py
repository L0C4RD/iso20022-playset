...
class CorporateActionPeriod16(base_types._BaseFieldType):
	...
	__slots__ = ["_IntrstPrd", "_DpstrySspnsnPrdForPldg", "_DpstrySspnsnPrdForWdrwlAtAgt", "_DpstrySspnsnPrdForWdrwlInNmneeNm", "_DpstrySspnsnPrdForDpstAtAgt", "_DpstrySspnsnPrdForWdrwlInStrtNm", "_DpstrySspnsnPrdForDpst", "_CmplsryPurchsPrd", "_FsclYrPrd", "_DpstrySspnsnPrdForSgrtn", "_DpstrySspnsnPrdForBookNtryTrf", "_PricClctnPrd", "_ClmPrd", "_BookClsrPrd", "_SpltPrd", "_CoDpstriesSspnsnPrd"]
	@property
	def IntrstPrd(self):
