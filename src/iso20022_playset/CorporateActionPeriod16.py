...
class CorporateActionPeriod16(base_types._BaseFieldType):
	...
	__slots__ = ["_DpstrySspnsnPrdForBookNtryTrf", "_FsclYrPrd", "_CmplsryPurchsPrd", "_DpstrySspnsnPrdForDpstAtAgt", "_DpstrySspnsnPrdForWdrwlAtAgt", "_DpstrySspnsnPrdForSgrtn", "_CoDpstriesSspnsnPrd", "_SpltPrd", "_DpstrySspnsnPrdForDpst", "_DpstrySspnsnPrdForWdrwlInNmneeNm", "_DpstrySspnsnPrdForPldg", "_BookClsrPrd", "_ClmPrd", "_DpstrySspnsnPrdForWdrwlInStrtNm", "_PricClctnPrd", "_IntrstPrd"]
	@property
