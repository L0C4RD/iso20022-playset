...
class CorporateActionPeriod16(base_types._BaseFieldType):
	...
	__slots__ = ["_CoDpstriesSspnsnPrd", "_CmplsryPurchsPrd", "_DpstrySspnsnPrdForDpstAtAgt", "_IntrstPrd", "_DpstrySspnsnPrdForSgrtn", "_DpstrySspnsnPrdForWdrwlInStrtNm", "_SpltPrd", "_PricClctnPrd", "_ClmPrd", "_DpstrySspnsnPrdForDpst", "_DpstrySspnsnPrdForWdrwlAtAgt", "_FsclYrPrd", "_BookClsrPrd", "_DpstrySspnsnPrdForWdrwlInNmneeNm", "_DpstrySspnsnPrdForBookNtryTrf", "_DpstrySspnsnPrdForPldg"]
	@property
