...
class FinancialInstrument102(base_types._BaseFieldType):
	...
	__slots__ = ["_TrfTp", "_AsstsHeldInOwnNm", "_TrfCcy", "_SttlmPtiesDtls", "_ReqdTrfDt", "_TrfRsltsInChngOfBnfclOwnr", "_AddtlInf", "_PmtDtls", "_Trfr", "_AddtlAsst", "_LineId", "_PrtlInstdQty", "_ClntRef", "_CtrPtyRef", "_BizFlowTp", "_IntrmyInf", "_Instrm", "_UnitsDtls", "_TaxValtnPt", "_AvrgAcqstnPric", "_NotAvlbl", "_ReqdSttlmDt", "_TtlBookVal", "_Convs", "_CrstllstnDtls", "_ReqdTradDt", "_Qty", "_TrfeeAcct"]
	@property
	def TrfTp(self):
		return self._TrfTp
