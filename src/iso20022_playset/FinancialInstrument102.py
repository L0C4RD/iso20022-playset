...
class FinancialInstrument102(base_types._BaseFieldType):
	...
	__slots__ = ["_UnitsDtls", "_PrtlInstdQty", "_Trfr", "_ClntRef", "_LineId", "_TtlBookVal", "_CrstllstnDtls", "_SttlmPtiesDtls", "_ReqdTrfDt", "_ReqdSttlmDt", "_TaxValtnPt", "_ReqdTradDt", "_AvrgAcqstnPric", "_TrfeeAcct", "_PmtDtls", "_AddtlInf", "_TrfRsltsInChngOfBnfclOwnr", "_Qty", "_Instrm", "_CtrPtyRef", "_TrfTp", "_NotAvlbl", "_Convs", "_BizFlowTp", "_AddtlAsst", "_IntrmyInf", "_TrfCcy", "_AsstsHeldInOwnNm"]
	@property
	def UnitsDtls(self):
