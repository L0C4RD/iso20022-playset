...
class FinancialInstrument102(base_types._BaseFieldType):
	...
	__slots__ = ["_PmtDtls", "_LineId", "_Qty", "_AsstsHeldInOwnNm", "_PrtlInstdQty", "_UnitsDtls", "_AddtlInf", "_SttlmPtiesDtls", "_BizFlowTp", "_Trfr", "_Instrm", "_AvrgAcqstnPric", "_ReqdSttlmDt", "_TrfeeAcct", "_AddtlAsst", "_TtlBookVal", "_NotAvlbl", "_TrfCcy", "_ReqdTrfDt", "_IntrmyInf", "_TaxValtnPt", "_Convs", "_ClntRef", "_CrstllstnDtls", "_ReqdTradDt", "_TrfTp", "_TrfRsltsInChngOfBnfclOwnr", "_CtrPtyRef"]
	@property
	def PmtDtls(self):
