...
class FinancialInstrument102(base_types._BaseFieldType):
	...
	__slots__ = ["_TrfCcy", "_ReqdTrfDt", "_ClntRef", "_SttlmPtiesDtls", "_AddtlInf", "_NotAvlbl", "_BizFlowTp", "_TtlBookVal", "_Instrm", "_Convs", "_IntrmyInf", "_AddtlAsst", "_TrfRsltsInChngOfBnfclOwnr", "_UnitsDtls", "_TrfeeAcct", "_LineId", "_AsstsHeldInOwnNm", "_PmtDtls", "_AvrgAcqstnPric", "_CtrPtyRef", "_CrstllstnDtls", "_Trfr", "_ReqdTradDt", "_TaxValtnPt", "_TrfTp", "_PrtlInstdQty", "_ReqdSttlmDt", "_Qty"]
	@property
	def TrfCcy(self):
		return self._TrfCcy
