...
class FleetLineItem5(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlAmtExclgTax", "_FuelBrndCd", "_Fuel", "_UnitPric", "_Tax", "_PdctQlfr", "_PdctQty", "_UnitOfMeasr", "_SvcTp", "_OthrUnitOfMeasr", "_DscntAmt", "_PdctCtgy", "_UnitPricTax", "_NonTaxbl", "_PdctCd", "_PdctCdAssgnr", "_TtlAmtInclgTax"]
	@property
