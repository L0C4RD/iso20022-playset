...
class FleetLineItem5(base_types._BaseFieldType):
	...
	__slots__ = ["_PdctCd", "_PdctQty", "_OthrUnitOfMeasr", "_UnitPric", "_SvcTp", "_PdctCtgy", "_DscntAmt", "_Tax", "_UnitPricTax", "_UnitOfMeasr", "_TtlAmtExclgTax", "_NonTaxbl", "_Fuel", "_TtlAmtInclgTax", "_PdctQlfr", "_PdctCdAssgnr", "_FuelBrndCd"]
	@property
	def PdctCd(self):
		return self._PdctCd
