...
class Terminal7(base_types._BaseFieldType):
	...
	__slots__ = ["_ApprvlCdLngth", "_SrlNb", "_AddtlId", "_PINLngthCpblty", "_Outdr", "_OnLineCpblty", "_TempScrStorg", "_RdngCpblty", "_CardCaptrCpbl", "_GeogcLctn", "_Tp", "_OnBrd", "_WrtgCpblty", "_OthrPINNtrySctyChrtc", "_CertfctnId", "_MsgCpblty", "_OthrTp", "_MxScrptLngth", "_PINNtrySctyChrtc", "_Sftwr", "_IntgtnTp", "_OffPrmiss", "_Id", "_CrdhldrVrfctnCpblty"]
	@property
