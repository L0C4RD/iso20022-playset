...
class Terminal7(base_types._BaseFieldType):
	...
	__slots__ = ["_IntgtnTp", "_Tp", "_Id", "_MxScrptLngth", "_RdngCpblty", "_TempScrStorg", "_ApprvlCdLngth", "_SrlNb", "_OnBrd", "_PINLngthCpblty", "_OthrPINNtrySctyChrtc", "_MsgCpblty", "_CrdhldrVrfctnCpblty", "_WrtgCpblty", "_Outdr", "_OthrTp", "_CardCaptrCpbl", "_OffPrmiss", "_OnLineCpblty", "_CertfctnId", "_PINNtrySctyChrtc", "_Sftwr", "_AddtlId", "_GeogcLctn"]
	@property
	def AddtlId(self):
