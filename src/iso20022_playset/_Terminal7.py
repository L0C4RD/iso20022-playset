...
class Terminal7(base_types._BaseFieldType):
	...
	__slots__ = ["_WrtgCpblty", "_Sftwr", "_Id", "_TempScrStorg", "_RdngCpblty", "_OnBrd", "_CrdhldrVrfctnCpblty", "_PINNtrySctyChrtc", "_CertfctnId", "_CardCaptrCpbl", "_SrlNb", "_PINLngthCpblty", "_Tp", "_MxScrptLngth", "_GeogcLctn", "_ApprvlCdLngth", "_AddtlId", "_OnLineCpblty", "_Outdr", "_OffPrmiss", "_OthrPINNtrySctyChrtc", "_OthrTp", "_MsgCpblty", "_IntgtnTp"]
	@property
	def WrtgCpblty(self):
