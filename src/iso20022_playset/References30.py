...
class References30(base_types._BaseFieldType):

	__slots__ = ["_AcctOwnrTxId", "_AcctSvcrTxId", "_CmonId", "_UnqTxIdr", "_PoolId", "_CtrPtyMktInfrstrctrTxId", "_TradId", "_PrcrTxId", "_MktInfrstrctrTxId"]
	@property
