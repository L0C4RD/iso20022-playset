...
class SecuritiesCollateral11(base_types._BaseFieldType):
	...
	__slots__ = ["_SfkpgPlc", "_SctyId", "_CollId", "_MtrtyDt", "_LtdCvrgInd", "_Pric", "_Hrcut", "_AsstNb", "_SttlmParams", "_Qty", "_ValDt", "_CollVal", "_BlckChainAdrOrWllt", "_MktVal", "_SfkpgAcct"]
	@property
	def SfkpgPlc(self):
