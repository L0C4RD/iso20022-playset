...
class SecuritiesCollateral11(base_types._BaseFieldType):
	...
	__slots__ = ["_CollId", "_MtrtyDt", "_SctyId", "_Qty", "_ValDt", "_BlckChainAdrOrWllt", "_SfkpgPlc", "_AsstNb", "_Pric", "_SfkpgAcct", "_SttlmParams", "_MktVal", "_CollVal", "_Hrcut", "_LtdCvrgInd"]
	@property
	def CollId(self):
		return self._CollId
