...
class SecuritiesCollateral11(base_types._BaseFieldType):
	...
	__slots__ = ["_BlckChainAdrOrWllt", "_CollVal", "_SfkpgAcct", "_SctyId", "_SttlmParams", "_Hrcut", "_ValDt", "_Qty", "_Pric", "_AsstNb", "_LtdCvrgInd", "_MtrtyDt", "_SfkpgPlc", "_CollId", "_MktVal"]
	@property
