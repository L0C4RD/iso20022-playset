...
from .SettlementDetails206 import SettlementDetails206
...
class SecuritiesCollateral11(base_types._BaseFieldType):
	...
	__slots__ = ["_MktVal", "_SfkpgPlc", "_LtdCvrgInd", "_CollId", "_SctyId", "_Qty", "_Pric", "_AsstNb", "_BlckChainAdrOrWllt", "_CollVal", "_SfkpgAcct", "_Hrcut", "_MtrtyDt", "_SttlmParams", "_ValDt"]
	@property
	def MktVal(self):
		return self._MktVal
