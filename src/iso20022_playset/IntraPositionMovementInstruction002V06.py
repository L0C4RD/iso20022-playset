...
class IntraPositionMovementInstruction002V06(base_types._BaseFieldType):
	...
	__slots__ = ["_IntraPosDtls", "_CorpActnEvtId", "_TxId", "_AcctOwnr", "_FinInstrmId", "_Lnkgs", "_BlckChainAdrOrWllt", "_SplmtryData", "_SfkpgPlc", "_SfkpgAcct", "_FinInstrmAttrbts", "_NbCounts"]
	@property
