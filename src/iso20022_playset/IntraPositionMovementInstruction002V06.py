...
class IntraPositionMovementInstruction002V06(base_types._BaseFieldType):
	...
	__slots__ = ["_SfkpgAcct", "_AcctOwnr", "_BlckChainAdrOrWllt", "_FinInstrmAttrbts", "_SplmtryData", "_Lnkgs", "_SfkpgPlc", "_IntraPosDtls", "_CorpActnEvtId", "_FinInstrmId", "_NbCounts", "_TxId"]
	@property
	def SfkpgAcct(self):
