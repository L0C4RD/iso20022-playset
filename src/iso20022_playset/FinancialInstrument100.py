...
class FinancialInstrument100(base_types._BaseFieldType):
	...
	__slots__ = ["_ClntRef", "_LatstValtn", "_LineId", "_TtlBookVal", "_FctvSttlmDt", "_ReqdSttlmDt", "_TaxValtnPt", "_FctvTrfDt", "_OrgnlPctgInstd", "_TrfeeAcct", "_PmtDtls", "_AddtlInf", "_TrfRsltsInChngOfBnfclOwnr", "_Instrm", "_CtrPtyRef", "_NotAvlbl", "_OrgnlCost", "_AddtlAsst", "_UnitsDtls", "_IntrmyInf", "_AsstsHeldInOwnNm", "_PrtlInstdQty", "_Trfr", "_CrstllstnDtls", "_SttlmPtiesDtls", "_AvrgAcqstnPric", "_Qty", "_TrfTp", "_Convs", "_BizFlowTp", "_ReqdTradDt", "_TrfCcy"]
	@property
	def ClntRef(self):
