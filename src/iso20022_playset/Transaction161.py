...
class Transaction161(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctSvcrTxId", "_ClntRef", "_UnqTxIdr", "_AcctSvcrLegId", "_PoolId", "_MktInfrstrctrTxId", "_CorpActnEvtId", "_AcctOwnrTxId", "_ClntCollInstrId", "_PrcrTxId", "_CtrPtyMktInfrstrctrTxId", "_MstrRef", "_AcctOwnrLegId", "_CmonId", "_TrptyAgtSvcPrvdrCollTxId", "_TradId", "_SplmtryData", "_TxDtls", "_TrptyAgtSvcPrvdrCollInstrId", "_ClntTrptyCollTxId"]
	@property
