...
from .TransactionDetails169 import TransactionDetails169
from .AdditionalReference10 import AdditionalReference10

class Transaction161(base_types._BaseFieldType):

	__slots__ = ["_ClntTrptyCollTxId", "_CtrPtyMktInfrstrctrTxId", "_AcctOwnrTxId", "_TxDtls", "_MstrRef", "_PoolId", "_AcctSvcrTxId", "_AcctSvcrLegId", "_CmonId", "_ClntRef", "_AcctOwnrLegId", "_PrcrTxId", "_SplmtryData", "_UnqTxIdr", "_CorpActnEvtId", "_TradId", "_TrptyAgtSvcPrvdrCollInstrId", "_MktInfrstrctrTxId", "_TrptyAgtSvcPrvdrCollTxId", "_ClntCollInstrId"]
	@property
