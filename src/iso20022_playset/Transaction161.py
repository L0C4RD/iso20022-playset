...
class Transaction161(base_types._BaseFieldType):
	...
	__slots__ = ["_ClntTrptyCollTxId", "_TrptyAgtSvcPrvdrCollTxId", "_TradId", "_UnqTxIdr", "_ClntRef", "_TrptyAgtSvcPrvdrCollInstrId", "_CmonId", "_AcctOwnrTxId", "_TxDtls", "_PoolId", "_PrcrTxId", "_AcctSvcrTxId", "_CorpActnEvtId", "_ClntCollInstrId", "_AcctSvcrLegId", "_SplmtryData", "_CtrPtyMktInfrstrctrTxId", "_MstrRef", "_AcctOwnrLegId", "_MktInfrstrctrTxId"]
	@property
