...
class SecuritiesOption114(base_types._BaseFieldType):
	...
	__slots__ = ["_RndgFctr", "_PricDtls", "_ChrgInd", "_CcyOptn", "_EntitldQty", "_SctyDtls", "_OthrIncmTp", "_CtryOfIncmSrc", "_IncmTp", "_DtDtls", "_TradgPrd", "_FrctnDspstn", "_RateDtls", "_EstmtdPricInd", "_RinvstmtIncmClssfctn", "_XmptnTp", "_SfkpgPlc", "_TempFinInstrmInd", "_PricBsis", "_NonElgblPrcdsInd", "_CdtDbtInd", "_NewSctiesIssncInd"]
	@property
	def RndgFctr(self):
