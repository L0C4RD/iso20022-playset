...
class SecuritiesSettlementTransactionConfirmation002V11(base_types._BaseFieldType):
	...
	__slots__ = ["_SttldAmt", "_SplmtryData", "_DlvrgSttlmPties", "_QtyAndAcctDtls", "_TxIdDtls", "_OthrAmts", "_FinInstrmAttrbts", "_AddtlParams", "_TradDtls", "_OthrBizPties", "_StgSttlmInstrDtls", "_SttlmParams", "_AddtlPhysOrRegnDtls", "_RcvgSttlmPties", "_CshPties", "_Lnkgs", "_FinInstrmId"]
	@property
	def SttldAmt(self):
