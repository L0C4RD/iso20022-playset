...
class MarginReportData10(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrctMod", "_Coll", "_SplmtryData", "_EvtDt", "_CtrPtyRatgThrshldInd", "_CtrPtyRatgTrggrInd", "_RcvdMrgnOrColl", "_PstdMrgnOrColl", "_RptgTmStmp", "_CtrPtyId", "_TechAttrbts", "_TxId"]
	@property
	def CtrctMod(self):
