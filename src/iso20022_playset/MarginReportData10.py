...
class MarginReportData10(base_types._BaseFieldType):
	...
	__slots__ = ["_RptgTmStmp", "_CtrPtyRatgTrggrInd", "_CtrctMod", "_SplmtryData", "_EvtDt", "_CtrPtyRatgThrshldInd", "_Coll", "_TxId", "_PstdMrgnOrColl", "_CtrPtyId", "_TechAttrbts", "_RcvdMrgnOrColl"]
	@property
	def RptgTmStmp(self):
