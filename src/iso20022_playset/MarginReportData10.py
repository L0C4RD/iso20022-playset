...
class MarginReportData10(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrctMod", "_CtrPtyId", "_EvtDt", "_CtrPtyRatgThrshldInd", "_CtrPtyRatgTrggrInd", "_TxId", "_RcvdMrgnOrColl", "_RptgTmStmp", "_TechAttrbts", "_Coll", "_SplmtryData", "_PstdMrgnOrColl"]
	@property
	def CtrctMod(self):
