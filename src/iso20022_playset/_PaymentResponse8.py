...
class PaymentResponse8(base_types._BaseFieldType):
	...
	def PmtRct(self, value):
		self._PmtRct = value if value is not None else base_types.UninitialisedField(self, 'PmtRct', PaymentReceipt7, True)

	@PmtRct.deleter
	def PmtRct(self):
		del self._PmtRct
		self._PmtRct = base_types.UninitialisedField(self, 'PmtRct', PaymentReceipt7, True)
	...
	def RtlrPmtRslt(self, value):
		self._RtlrPmtRslt = value if value is not None else base_types.UninitialisedField(self, 'RtlrPmtRslt', RetailerPaymentResult8, False)

	@RtlrPmtRslt.deleter
	def RtlrPmtRslt(self):
		del self._RtlrPmtRslt
		self._RtlrPmtRslt = base_types.UninitialisedField(self, 'RtlrPmtRslt', RetailerPaymentResult8, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='PmtRct', type=PaymentReceipt7, min=0, max=None, mutex_group=None, array=True),
		base_types.FieldEntry(name='RtlrPmtRslt', type=RetailerPaymentResult8, min=1, max=1, mutex_group=None, array=False),
