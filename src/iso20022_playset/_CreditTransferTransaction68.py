...
class CreditTransferTransaction68(base_types._BaseFieldType):
	...
	__slots__ = ["_Cdtr", "_PrvsInstgAgt1", "_CdtrAgtAcct", "_UltmtDbtr", "_UltmtCdtr", "_IntrmyAgt3", "_IntrmyAgt3Acct", "_PrvsInstgAgt3", "_InitgPty", "_PrvsInstgAgt1Acct", "_Purp", "_Tax", "_IntrmyAgt1Acct", "_PmtTpInf", "_Dbtr", "_CdtrAgt", "_PmtId", "_DbtrAgt", "_CdtrAcct", "_PrvsInstgAgt3Acct", "_RmtInf", "_InstrForNxtAgt", "_IntrmyAgt2", "_IntrmyAgt2Acct", "_InstrForCdtrAgt", "_InstdAmt", "_DbtrAgtAcct", "_IntrmyAgt1", "_PrvsInstgAgt2Acct", "_PrvsInstgAgt2", "_DbtrAcct"]
	@property
	def Cdtr(self):
		return self._Cdtr
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='PmtId', type=PaymentIdentification13, min=0, max=1, mutex_group=None, array=False),
