...
class CreditTransferTransaction68(base_types._BaseFieldType):
	...
	__slots__ = ["_IntrmyAgt2", "_CdtrAgtAcct", "_IntrmyAgt1Acct", "_CdtrAcct", "_Dbtr", "_InstrForNxtAgt", "_Purp", "_InstrForCdtrAgt", "_PrvsInstgAgt1", "_PmtTpInf", "_Tax", "_RmtInf", "_PrvsInstgAgt1Acct", "_IntrmyAgt3", "_IntrmyAgt1", "_IntrmyAgt2Acct", "_PrvsInstgAgt2", "_UltmtCdtr", "_InitgPty", "_UltmtDbtr", "_PrvsInstgAgt2Acct", "_InstdAmt", "_PmtId", "_CdtrAgt", "_Cdtr", "_DbtrAgt", "_DbtrAcct", "_IntrmyAgt3Acct", "_DbtrAgtAcct", "_PrvsInstgAgt3", "_PrvsInstgAgt3Acct"]
	@property
	def IntrmyAgt2(self):
