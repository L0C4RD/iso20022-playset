...
from . import AdditionalQueryParameters13
...
class SecuritiesStatementQueryV08(base_types._BaseFieldType):
	...
	def AddtlQryParams(self, value):
		self._AddtlQryParams = value if value is not None else base_types.UninitialisedField(self, 'AddtlQryParams', AdditionalQueryParameters13, True)

	@AddtlQryParams.deleter
	def AddtlQryParams(self):
		del self._AddtlQryParams
		self._AddtlQryParams = base_types.UninitialisedField(self, 'AddtlQryParams', AdditionalQueryParameters13, True)
