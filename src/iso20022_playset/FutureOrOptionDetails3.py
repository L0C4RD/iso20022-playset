...
class FutureOrOptionDetails3(base_types._BaseFieldType):
	...
	__slots__ = ["_FutrAndOptnCtrctTp", "_MinTradgPricgIncrmt", "_Apprnc", "_FrstDealgDt", "_UnitOfMeasr", "_NearTermPosLmt", "_IssePric", "_Purp", "_Ratio", "_StrpblInd", "_LastDlvryDt", "_FutrDt", "_Ratg", "_AnncmntDt", "_LastTx", "_SprdTx", "_MinSz", "_CtrctSttlmMnth", "_PosLmt", "_OptnRghts"]
	@property
