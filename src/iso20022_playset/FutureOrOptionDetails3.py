...
from .UnderlyingRatio2 import UnderlyingRatio2
from .YesNoIndicator import YesNoIndicator
from .UnitOfMeasure1Code import UnitOfMeasure1Code
from .Appearance1Code import Appearance1Code
from .DateAndDateTime1Choice import DateAndDateTime1Choice
from .ActiveCurrencyAndAmount import ActiveCurrencyAndAmount
from .ISOYearMonth import ISOYearMonth
from .Max256Text import Max256Text
from .OptionRight2Choice import OptionRight2Choice
from .Number import Number
from .FutureAndOptionContractType1Code import FutureAndOptionContractType1Code
from .ISODateTime import ISODateTime
from .Rating1 import Rating1

class FutureOrOptionDetails3(base_types._BaseFieldType):

	__slots__ = ["_SprdTx", "_LastTx", "_UnitOfMeasr", "_Purp", "_FrstDealgDt", "_PosLmt", "_MinTradgPricgIncrmt", "_MinSz", "_NearTermPosLmt", "_IssePric", "_Ratg", "_Apprnc", "_FutrDt", "_OptnRghts", "_FutrAndOptnCtrctTp", "_Ratio", "_StrpblInd", "_AnncmntDt", "_CtrctSttlmMnth", "_LastDlvryDt"]
	@property
	def SprdTx(self):
		return self._SprdTx
	...
	def FrstDealgDt(self, value):
		self._FrstDealgDt = value if type(value) != auto else self.make_default("FrstDealgDt")
	...
	def LastDlvryDt(self, value):
		self._LastDlvryDt = value if type(value) != auto else self.make_default("LastDlvryDt")
