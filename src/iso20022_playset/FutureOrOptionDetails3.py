...
class FutureOrOptionDetails3(base_types._BaseFieldType):
	...
	__slots__ = ["_Purp", "_Apprnc", "_SprdTx", "_StrpblInd", "_IssePric", "_FrstDealgDt", "_FutrAndOptnCtrctTp", "_PosLmt", "_Ratio", "_NearTermPosLmt", "_LastTx", "_MinSz", "_UnitOfMeasr", "_FutrDt", "_LastDlvryDt", "_CtrctSttlmMnth", "_OptnRghts", "_AnncmntDt", "_MinTradgPricgIncrmt", "_Ratg"]
	@property
	def Purp(self):
		return self._Purp
