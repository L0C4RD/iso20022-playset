...
from .FXCancellation3Choice import FXCancellation3Choice
from .References45Choice import References45Choice
from .CancellationReason23 import CancellationReason23

class SecuritiesTransactionCancellationRequestV08(base_types._BaseFieldType):

	__slots__ = ["_SfkpgAcct", "_BlckChainAdrOrWllt", "_TxDtls", "_PrcrTxId", "_AcctSvcrTxId", "_AcctOwnrTxId", "_CxlRsn", "_NonceId", "_AcctOwnr", "_SplmtryData", "_FxCxl", "_MktInfrstrctrTxId"]
	@property
	def SfkpgAcct(self):
