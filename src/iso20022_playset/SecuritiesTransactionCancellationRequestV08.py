...
class SecuritiesTransactionCancellationRequestV08(base_types._BaseFieldType):
	...
	__slots__ = ["_PrcrTxId", "_CxlRsn", "_SplmtryData", "_FxCxl", "_AcctOwnr", "_NonceId", "_AcctOwnrTxId", "_MktInfrstrctrTxId", "_SfkpgAcct", "_BlckChainAdrOrWllt", "_AcctSvcrTxId", "_TxDtls"]
	@property
	def PrcrTxId(self):
