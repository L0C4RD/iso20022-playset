...
from . import FinancialInstrument8
from . import FinancialInstrumentQuantity1
from . import Max35Text
from . import PartyIdentification2Choice
from . import PerformanceFactors1
from . import UnitPrice15
from . import ValuationStatistics3
...
class PriceValuation4(base_types._BaseFieldType):
	...
	def FinInstrmDtls(self, value):
		self._FinInstrmDtls = value if value is not None else base_types.UninitialisedField(self, 'FinInstrmDtls', FinancialInstrument8, False)

	@FinInstrmDtls.deleter
	def FinInstrmDtls(self):
		del self._FinInstrmDtls
		self._FinInstrmDtls = base_types.UninitialisedField(self, 'FinInstrmDtls', FinancialInstrument8, False)
	...
	def FndMgmtCpny(self, value):
		self._FndMgmtCpny = value if value is not None else base_types.UninitialisedField(self, 'FndMgmtCpny', PartyIdentification2Choice, False)

	@FndMgmtCpny.deleter
	def FndMgmtCpny(self):
		del self._FndMgmtCpny
		self._FndMgmtCpny = base_types.UninitialisedField(self, 'FndMgmtCpny', PartyIdentification2Choice, False)
	...
	def NAVDtTm(self, value):
		self._NAVDtTm = value if value is not None else base_types.UninitialisedField(self, 'NAVDtTm', DateAndDateTimeChoice, False)

	@NAVDtTm.deleter
	def NAVDtTm(self):
		del self._NAVDtTm
		self._NAVDtTm = base_types.UninitialisedField(self, 'NAVDtTm', DateAndDateTimeChoice, False)
	...
	def NxtValtnDtTm(self, value):
		self._NxtValtnDtTm = value if value is not None else base_types.UninitialisedField(self, 'NxtValtnDtTm', DateAndDateTimeChoice, False)

	@NxtValtnDtTm.deleter
	def NxtValtnDtTm(self):
		del self._NxtValtnDtTm
		self._NxtValtnDtTm = base_types.UninitialisedField(self, 'NxtValtnDtTm', DateAndDateTimeChoice, False)
	...
	def PrfrmncDtls(self, value):
		self._PrfrmncDtls = value if value is not None else base_types.UninitialisedField(self, 'PrfrmncDtls', PerformanceFactors1, False)

	@PrfrmncDtls.deleter
	def PrfrmncDtls(self):
		del self._PrfrmncDtls
		self._PrfrmncDtls = base_types.UninitialisedField(self, 'PrfrmncDtls', PerformanceFactors1, False)
	...
	def PricDtls(self, value):
		self._PricDtls = value if value is not None else base_types.UninitialisedField(self, 'PricDtls', UnitPrice15, True)

	@PricDtls.deleter
	def PricDtls(self):
		del self._PricDtls
		self._PricDtls = base_types.UninitialisedField(self, 'PricDtls', UnitPrice15, True)
	...
	def PrvsValtnDtTm(self, value):
		self._PrvsValtnDtTm = value if value is not None else base_types.UninitialisedField(self, 'PrvsValtnDtTm', DateAndDateTimeChoice, False)

	@PrvsValtnDtTm.deleter
	def PrvsValtnDtTm(self):
		del self._PrvsValtnDtTm
		self._PrvsValtnDtTm = base_types.UninitialisedField(self, 'PrvsValtnDtTm', DateAndDateTimeChoice, False)
	...
	def ValtnDtTm(self, value):
		self._ValtnDtTm = value if value is not None else base_types.UninitialisedField(self, 'ValtnDtTm', DateAndDateTimeChoice, False)

	@ValtnDtTm.deleter
	def ValtnDtTm(self):
		del self._ValtnDtTm
		self._ValtnDtTm = base_types.UninitialisedField(self, 'ValtnDtTm', DateAndDateTimeChoice, False)
	...
	def ValtnSttstcs(self, value):
		self._ValtnSttstcs = value if value is not None else base_types.UninitialisedField(self, 'ValtnSttstcs', ValuationStatistics3, True)

	@ValtnSttstcs.deleter
	def ValtnSttstcs(self):
		del self._ValtnSttstcs
		self._ValtnSttstcs = base_types.UninitialisedField(self, 'ValtnSttstcs', ValuationStatistics3, True)
