...
class SettlementDetails152(base_types._BaseFieldType):
	...
	__slots__ = ["_NetgElgblty", "_HldInd", "_ElgblForColl", "_CCPElgblty", "_CshClrSys", "_BnfclOwnrsh", "_FxStgInstr", "_LglRstrctns", "_MktClntSd", "_SttlmTxCond", "_TaxCpcty", "_SttlmSysMtd", "_Trckg", "_PrtlSttlmInd", "_SttlgCpcty", "_BlckTrad", "_SctiesRTGS", "_StmpDtyTaxBsis", "_AutomtcBrrwg", "_Prty"]
	@property
