...
class SettlementDetails152(base_types._BaseFieldType):
	...
	__slots__ = ["_SctiesRTGS", "_ElgblForColl", "_MktClntSd", "_SttlgCpcty", "_AutomtcBrrwg", "_Prty", "_FxStgInstr", "_LglRstrctns", "_PrtlSttlmInd", "_StmpDtyTaxBsis", "_HldInd", "_SttlmTxCond", "_CCPElgblty", "_NetgElgblty", "_TaxCpcty", "_BlckTrad", "_BnfclOwnrsh", "_CshClrSys", "_Trckg", "_SttlmSysMtd"]
	@property
