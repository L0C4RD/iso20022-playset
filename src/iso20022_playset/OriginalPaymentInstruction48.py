...
class OriginalPaymentInstruction48(base_types._BaseFieldType):
	...
	__slots__ = ["_PmtInfCxlSts", "_OrgnlCtrlSum", "_OrgnlPmtInfId", "_OrgnlGrpInf", "_OrgnlNbOfTxs", "_CxlStsRsnInf", "_OrgnlPmtInfCxlId", "_NbOfTxsPerCxlSts", "_RslvdCase", "_TxInfAndSts"]
	@property
