...
class OriginalPaymentInstruction48(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlPmtInfCxlId", "_OrgnlNbOfTxs", "_TxInfAndSts", "_CxlStsRsnInf", "_PmtInfCxlSts", "_OrgnlCtrlSum", "_OrgnlPmtInfId", "_NbOfTxsPerCxlSts", "_OrgnlGrpInf", "_RslvdCase"]
	@property
