...
class ValueForMoney1(base_types._BaseFieldType):
	...
	__slots__ = ["_FrthrInfUK", "_AssmntOfValReqrdUdrCOLLUK", "_OutcmOfPRINValAssmntOrRvwUK", "_OutcmOfCOLLAssmntOfValUK", "_RvwDtUK", "_OthrRvwRltdToValAndOrChrgsUK", "_EMTDataRptgVFMUK", "_RvwNxtDueUK"]
	@property
	def FrthrInfUK(self):
