...
class ValueForMoney1(base_types._BaseFieldType):
	...
	__slots__ = ["_OutcmOfPRINValAssmntOrRvwUK", "_RvwDtUK", "_RvwNxtDueUK", "_AssmntOfValReqrdUdrCOLLUK", "_OutcmOfCOLLAssmntOfValUK", "_EMTDataRptgVFMUK", "_FrthrInfUK", "_OthrRvwRltdToValAndOrChrgsUK"]
	@property
