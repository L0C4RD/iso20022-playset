...
class TripLeg3(base_types._BaseFieldType):
	...
	__slots__ = ["_RsvatnSys", "_OrgnlRsvatnSys", "_FairBsisCd", "_RouteNb", "_CrrierCd", "_RsvatnNb", "_SvcClss", "_Doc", "_RcrdLctrNb", "_Insrnc", "_CdtRsnCd", "_AddtlData", "_Dprture", "_PrcdrId", "_TcktIsseDt", "_TcktIsseLctn", "_OrgnlRsvatnNb", "_SeqNb", "_XchgdTckt", "_Amt", "_XchgdTcktNb", "_TrnsprtTp", "_CnjnctnTcktNb", "_TcktRstrctns", "_CmmdtyCd", "_LltyPrgrmm", "_OthrTrnsprtTp", "_IATACd", "_TcktNb", "_OpnTckt", "_NonDrctRouteCd", "_RstrctdTckt", "_CrrierNm", "_StopOver", "_Arrvl", "_TcktIssr", "_Drtn"]
	@property
	def RsvatnSys(self):
