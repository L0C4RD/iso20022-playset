...
class TripLeg3(base_types._BaseFieldType):
	...
	__slots__ = ["_SeqNb", "_CrrierCd", "_IATACd", "_LltyPrgrmm", "_CmmdtyCd", "_CdtRsnCd", "_Drtn", "_RsvatnNb", "_Doc", "_PrcdrId", "_RsvatnSys", "_FairBsisCd", "_TcktNb", "_TcktIsseDt", "_RouteNb", "_RcrdLctrNb", "_OpnTckt", "_OrgnlRsvatnSys", "_CrrierNm", "_OthrTrnsprtTp", "_Insrnc", "_XchgdTckt", "_TrnsprtTp", "_Dprture", "_SvcClss", "_Amt", "_TcktIsseLctn", "_AddtlData", "_StopOver", "_TcktRstrctns", "_XchgdTcktNb", "_OrgnlRsvatnNb", "_Arrvl", "_TcktIssr", "_NonDrctRouteCd", "_CnjnctnTcktNb", "_RstrctdTckt"]
	@property
	def SeqNb(self):
		return self._SeqNb
