...
from . import OriginalPaymentInstruction51
...
class CustomerPaymentStatusReportV14(base_types._BaseFieldType):
	...
	def OrgnlPmtInfAndSts(self, value):
		self._OrgnlPmtInfAndSts = value if value is not None else base_types.UninitialisedField(self, 'OrgnlPmtInfAndSts', OriginalPaymentInstruction51, True)

	@OrgnlPmtInfAndSts.deleter
	def OrgnlPmtInfAndSts(self):
		del self._OrgnlPmtInfAndSts
		self._OrgnlPmtInfAndSts = base_types.UninitialisedField(self, 'OrgnlPmtInfAndSts', OriginalPaymentInstruction51, True)
