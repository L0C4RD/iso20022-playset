...
class OtherAmounts39(base_types._BaseFieldType):
	...
	__slots__ = ["_ShppgAmt", "_TradAmt", "_IsseDscntAllwnc", "_LclTax", "_Mrgn", "_RgltryAmt", "_WhldgTax", "_TxTax", "_ChrgsFees", "_LclBrkrComssn", "_NetGnLoss", "_AcrdCptlstnAmt", "_Othr", "_ValAddedTax", "_RsrchFee", "_AcrdIntrstAmt", "_StmpDty", "_StockXchgTax", "_TrfTax", "_ExctgBrkrAmt", "_CtryNtlFdrlTax", "_LclTaxCtrySpcfc", "_CsmptnTax", "_SpclCncssn", "_PmtLevyTax"]
	@property
	def ShppgAmt(self):
