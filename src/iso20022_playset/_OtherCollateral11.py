...
class OtherCollateral11(base_types._BaseFieldType):
	...
	__slots__ = ["_LtdCvrgInd", "_Hrcut", "_SfkpgAcct", "_XchgRate", "_XpryDt", "_AsstNb", "_CollId", "_ValDt", "_IsseDt", "_SfkpgPlc", "_MktVal", "_LttrOfCdtAmt", "_OthrTpOfColl", "_CollVal", "_LttrOfCdtId", "_Issr", "_BlckChainAdrOrWllt", "_GrntAmt"]
	@property
	def LtdCvrgInd(self):
