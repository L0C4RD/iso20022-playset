...
class Transaction126(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrPtyMktInfrstrctrTxId", "_MktInfrstrctrTxId", "_TrptyAgtSvcPrvdrCollInstrId", "_PoolId", "_MstrRef", "_ClntTrptyCollTxId", "_TrptyAgtSvcPrvdrCollTxId", "_AcctOwnrTxId", "_AcctSvcrTxId", "_PrcrTxId", "_AcctSvcrLegId", "_TxDtls", "_AcctOwnrLegId", "_ClntRef", "_CorpActnEvtId", "_TradId", "_CmonId", "_ClntCollInstrId", "_SplmtryData"]
	@property
