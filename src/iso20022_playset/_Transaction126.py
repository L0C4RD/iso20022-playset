...
from .TransactionDetails165 import TransactionDetails165
from .RestrictedFINXMax16Text import RestrictedFINXMax16Text
from .RestrictedFINXMax35Text import RestrictedFINXMax35Text
from .AdditionalReference12 import AdditionalReference12
from .RestrictedFINXMax52Text import RestrictedFINXMax52Text

class Transaction126(base_types._BaseFieldType):

	__slots__ = ["_AcctOwnrLegId", "_SplmtryData", "_CorpActnEvtId", "_AcctSvcrLegId", "_PoolId", "_CmonId", "_TxDtls", "_AcctSvcrTxId", "_TrptyAgtSvcPrvdrCollTxId", "_ClntRef", "_TrptyAgtSvcPrvdrCollInstrId", "_ClntCollInstrId", "_AcctOwnrTxId", "_CtrPtyMktInfrstrctrTxId", "_ClntTrptyCollTxId", "_TradId", "_PrcrTxId", "_MktInfrstrctrTxId", "_MstrRef"]
	@property
	...
	def AcctOwnrLegId(self, value):
		self._AcctOwnrLegId = value if type(value) != base_types.auto else self.make_default("AcctOwnrLegId")
	...
	def AcctSvcrLegId(self, value):
		self._AcctSvcrLegId = value if type(value) != base_types.auto else self.make_default("AcctSvcrLegId")
