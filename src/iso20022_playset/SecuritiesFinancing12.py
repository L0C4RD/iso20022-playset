...
class SecuritiesFinancing12(base_types._BaseFieldType):
	...
	__slots__ = ["_BrrwgRsn", "_StdCollAmt", "_RollOver", "_ExCpn", "_AcrdIntrstAmt", "_CollTp", "_NbOfDaysLndgBrrwg", "_StdCollRatio", "_AcrdIntrstPctg", "_CllblTradInd", "_TxCallDely", "_SprdRate", "_RateChngDt", "_VarblRateSpprt", "_SctiesHrcut", "_FincgAgrmt", "_AcrdIntrstTax", "_LglFrmwk", "_Rvaltn", "_RpRate", "_TtlNbOfCollInstrs", "_IntrstCmptnMtd", "_RateTp", "_StockLnMrgn", "_FrftAmt", "_EndFctr", "_ClsgAmtPerPcsOfColl", "_SctiesLndgTp", "_MinDtForCallBck", "_PrmAmt", "_PrdcPmt", "_CtrctTermsModChngd", "_PricgRate", "_EndNbOfDaysAcrd", "_LndgTxMtd", "_Rvsbl", "_BrrwgRate", "_DvddRatio", "_LndgWthColl", "_IntrstRate"]
	@property
	def BrrwgRsn(self):
