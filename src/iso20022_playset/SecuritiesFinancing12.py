...
class SecuritiesFinancing12(base_types._BaseFieldType):
	...
	__slots__ = ["_StdCollRatio", "_CollTp", "_MinDtForCallBck", "_AcrdIntrstPctg", "_FrftAmt", "_RollOver", "_EndFctr", "_ExCpn", "_ClsgAmtPerPcsOfColl", "_AcrdIntrstAmt", "_Rvsbl", "_VarblRateSpprt", "_CllblTradInd", "_CtrctTermsModChngd", "_TtlNbOfCollInstrs", "_FincgAgrmt", "_StockLnMrgn", "_DvddRatio", "_EndNbOfDaysAcrd", "_SctiesHrcut", "_IntrstCmptnMtd", "_RateChngDt", "_AcrdIntrstTax", "_NbOfDaysLndgBrrwg", "_SctiesLndgTp", "_RpRate", "_PricgRate", "_LndgWthColl", "_LglFrmwk", "_Rvaltn", "_TxCallDely", "_BrrwgRate", "_RateTp", "_IntrstRate", "_StdCollAmt", "_PrdcPmt", "_SprdRate", "_BrrwgRsn", "_LndgTxMtd", "_PrmAmt"]
	@property
