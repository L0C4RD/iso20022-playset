...
class SecuritiesFinancing12(base_types._BaseFieldType):
	...
	__slots__ = ["_DvddRatio", "_VarblRateSpprt", "_TtlNbOfCollInstrs", "_BrrwgRate", "_ExCpn", "_AcrdIntrstPctg", "_AcrdIntrstAmt", "_AcrdIntrstTax", "_Rvsbl", "_CtrctTermsModChngd", "_IntrstRate", "_SctiesHrcut", "_IntrstCmptnMtd", "_Rvaltn", "_StockLnMrgn", "_StdCollAmt", "_RollOver", "_RateTp", "_StdCollRatio", "_FincgAgrmt", "_LglFrmwk", "_BrrwgRsn", "_PricgRate", "_LndgWthColl", "_ClsgAmtPerPcsOfColl", "_RateChngDt", "_FrftAmt", "_CollTp", "_MinDtForCallBck", "_TxCallDely", "_EndNbOfDaysAcrd", "_CllblTradInd", "_NbOfDaysLndgBrrwg", "_SctiesLndgTp", "_RpRate", "_PrmAmt", "_EndFctr", "_LndgTxMtd", "_SprdRate", "_PrdcPmt"]
	@property
	def DvddRatio(self):
