...
class SettlementReportingResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Orgtr", "_TxDesc", "_Hdr", "_SysTracAudtNb", "_OrgnlRspnCd", "_RtrvlRefNb", "_PrcgRslt", "_Jursdctn", "_AddtlFee", "_Rcvr", "_SttlmSvc", "_PrtctdData", "_LifeCyclId", "_FI", "_SctyTrlr", "_Sndr", "_SttlmInstn", "_Prgrmm", "_OthrInstn", "_Rcncltn", "_TrnsmssnDtTm", "_AddtlData", "_Dstn", "_SplmtryData"]
	@property
	def Orgtr(self):
		return self._Orgtr
