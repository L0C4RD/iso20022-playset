...
class SettlementReportingResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_TrnsmssnDtTm", "_SplmtryData", "_TxDesc", "_SctyTrlr", "_RtrvlRefNb", "_LifeCyclId", "_SttlmInstn", "_FI", "_OrgnlRspnCd", "_OthrInstn", "_Hdr", "_AddtlData", "_Rcvr", "_Sndr", "_Dstn", "_SysTracAudtNb", "_Rcncltn", "_AddtlFee", "_Jursdctn", "_PrcgRslt", "_Orgtr", "_Prgrmm", "_SttlmSvc", "_PrtctdData"]
	@property
