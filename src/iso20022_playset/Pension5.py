...
class Pension5(base_types._BaseFieldType):
	...
	__slots__ = ["_BlckTrf", "_DrwdwnTrchId", "_TaxFreeCshPrtcn", "_DrwdwnTp", "_NonWrpprTrf", "_LumpSumTp", "_BnftCrstllstnEvtOcrd", "_AddtlInf", "_TaxRef", "_Shrg", "_NonSfgrddGrntedBnfts", "_DrwdwnSts", "_Id", "_BlckTrfRef", "_TrfScp", "_EstmtdVal", "_PnsnOrdr", "_MnyPurchsAnlAllwnc", "_ClntLftmAllwncPrtcn", "_NbOfDrwdwnTrnchs", "_RtrmntAgePrtcn", "_Tp", "_SfgrdBnft", "_LftmAllwncPrtcn", "_RtrmntAge", "_RingFncdDrwdwnAssts", "_TaxFreeCshAmt", "_ValOfPnsnPlcyOrPlanOrSchme"]
	@property
	def BlckTrf(self):
