...
from . import TradeLegStatement5
...
class TradeLegStatementV05(base_types._BaseFieldType):
	...
	def StmtDtls(self, value):
		self._StmtDtls = value if value is not None else base_types.UninitialisedField(self, 'StmtDtls', TradeLegStatement5, True)

	@StmtDtls.deleter
	def StmtDtls(self):
		del self._StmtDtls
		self._StmtDtls = base_types.UninitialisedField(self, 'StmtDtls', TradeLegStatement5, True)
