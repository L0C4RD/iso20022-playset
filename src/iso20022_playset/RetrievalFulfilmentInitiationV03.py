...
class RetrievalFulfilmentInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlTx", "_SctyTrlr", "_Hdr", "_Orgtr", "_Acqrr", "_Accptr", "_Jursdctn", "_Rcvr", "_Pyee", "_Prgrmm", "_Dstn", "_SttlmSvc", "_Rcncltn", "_Issr", "_SplmtryData", "_TxId", "_Pyer", "_Cntxt", "_AddtlData", "_Sndr", "_Termnl", "_DsptData", "_Wllt", "_RtrvlFlfmtInstrs", "_Card", "_TxChrtcs", "_SpclPrgrmmQlfctn", "_AddtlFee", "_PrtctdData", "_PrcgRslt", "_ConvsDtTm", "_Tkn"]
	@property
	def OrgnlTx(self):
