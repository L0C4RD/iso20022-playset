...
class RetrievalFulfilmentInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlTx", "_Tkn", "_Dstn", "_PrtctdData", "_TxId", "_Rcvr", "_Jursdctn", "_Wllt", "_Orgtr", "_SctyTrlr", "_Pyee", "_Prgrmm", "_Termnl", "_Hdr", "_SttlmSvc", "_Sndr", "_AddtlFee", "_DsptData", "_PrcgRslt", "_AddtlData", "_RtrvlFlfmtInstrs", "_Rcncltn", "_SpclPrgrmmQlfctn", "_Accptr", "_Issr", "_Cntxt", "_Pyer", "_TxChrtcs", "_SplmtryData", "_Card", "_Acqrr", "_ConvsDtTm"]
	@property
	def OrgnlTx(self):
