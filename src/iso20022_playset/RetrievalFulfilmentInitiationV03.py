...
class RetrievalFulfilmentInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Pyee", "_Dstn", "_AddtlData", "_Termnl", "_Acqrr", "_Hdr", "_SctyTrlr", "_TxId", "_AddtlFee", "_Card", "_RtrvlFlfmtInstrs", "_Issr", "_Accptr", "_Orgtr", "_Sndr", "_Prgrmm", "_SpclPrgrmmQlfctn", "_SttlmSvc", "_PrcgRslt", "_Pyer", "_Cntxt", "_Wllt", "_Rcvr", "_DsptData", "_ConvsDtTm", "_Rcncltn", "_Jursdctn", "_Tkn", "_OrgnlTx", "_PrtctdData", "_TxChrtcs", "_SplmtryData"]
	@property
	def Pyee(self):
		return self._Pyee
