...
class RetrievalFulfilmentInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Card", "_TxChrtcs", "_OrgnlTx", "_SpclPrgrmmQlfctn", "_AddtlData", "_Issr", "_DsptData", "_Acqrr", "_Dstn", "_Accptr", "_Termnl", "_Cntxt", "_TxId", "_Hdr", "_PrcgRslt", "_SplmtryData", "_Pyer", "_SttlmSvc", "_Rcvr", "_Rcncltn", "_ConvsDtTm", "_RtrvlFlfmtInstrs", "_Tkn", "_Wllt", "_SctyTrlr", "_Orgtr", "_AddtlFee", "_Pyee", "_Jursdctn", "_PrtctdData", "_Sndr", "_Prgrmm"]
	@property
	def Card(self):
		return self._Card
