...
class PaymentInstruction43(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrlSum", "_NbOfTxs", "_ChrgBr", "_PmtInfId", "_UltmtDbtr", "_PmtTpInf", "_ChrgsAcct", "_ChrgsAcctAgt", "_PoolgAdjstmntDt", "_BtchBookg", "_Dbtr", "_DbtrAcct", "_InstrForDbtrAgt", "_ReqdExctnDt", "_DbtrAgt", "_CdtTrfTxInf", "_PmtMtd", "_DbtrAgtAcct"]
	@property
	def CtrlSum(self):
