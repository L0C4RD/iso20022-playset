...
class PaymentInstruction43(base_types._BaseFieldType):
	...
	__slots__ = ["_PmtMtd", "_Dbtr", "_CdtTrfTxInf", "_ChrgsAcct", "_InstrForDbtrAgt", "_UltmtDbtr", "_PmtInfId", "_BtchBookg", "_PoolgAdjstmntDt", "_DbtrAcct", "_DbtrAgt", "_ChrgsAcctAgt", "_NbOfTxs", "_DbtrAgtAcct", "_ChrgBr", "_ReqdExctnDt", "_PmtTpInf", "_CtrlSum"]
	@property
	def PmtMtd(self):
		return self._PmtMtd
