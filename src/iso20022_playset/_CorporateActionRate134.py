...
class CorporateActionRate134(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlQtyForSbcbdRsltntScties", "_NewToOd", "_TrfrmatnRate", "_FsclStmp", "_ScndLvlTax", "_AddtlQtyForExstgScties", "_AplblRate", "_WhldgTaxRate", "_ChrgsFees", "_FinTxTaxRate", "_TaxCdtRate"]
	@property
