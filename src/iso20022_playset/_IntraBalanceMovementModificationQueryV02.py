...
from . import IntraBalanceQueryDefinition12
...
class IntraBalanceMovementModificationQueryV02(base_types._BaseFieldType):
	...
	def QryDef(self, value):
		self._QryDef = value if value is not None else base_types.UninitialisedField(self, 'QryDef', IntraBalanceQueryDefinition12, False)

	@QryDef.deleter
	def QryDef(self):
		del self._QryDef
		self._QryDef = base_types.UninitialisedField(self, 'QryDef', IntraBalanceQueryDefinition12, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='QryDef', type=IntraBalanceQueryDefinition12, min=1, max=1, mutex_group=None, array=False),
