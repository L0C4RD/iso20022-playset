...
class BatchTransferResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Prgrmm", "_SttlmSvc", "_AgtData", "_ReqAck", "_TrnsmssnDtTm", "_OrgnlBtchId", "_OrgnlRspnCd", "_BtchId", "_NbOfMsgs", "_PrcgRslt", "_ClrBtchData", "_SysTracAudtNb", "_Rcncltn", "_Dstn", "_AddtlData", "_ClrCtrlTtls", "_Jursdctn", "_LifeCyclId", "_RtrvlRefNb", "_SctyTrlr", "_Hdr", "_BtchChcksm", "_Rcrd", "_PrtctdData", "_SplmtryData", "_Orgtr"]
	@property
	def Prgrmm(self):
		return self._Prgrmm
