...
class BatchTransferResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlRspnCd", "_ClrCtrlTtls", "_SctyTrlr", "_OrgnlBtchId", "_PrcgRslt", "_Rcrd", "_NbOfMsgs", "_Orgtr", "_AddtlData", "_BtchId", "_LifeCyclId", "_Jursdctn", "_BtchChcksm", "_Dstn", "_SplmtryData", "_Hdr", "_PrtctdData", "_RtrvlRefNb", "_ReqAck", "_AgtData", "_SttlmSvc", "_TrnsmssnDtTm", "_ClrBtchData", "_SysTracAudtNb", "_Prgrmm", "_Rcncltn"]
	@property
