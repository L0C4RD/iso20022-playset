...
class BatchTransferResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Jursdctn", "_ReqAck", "_SplmtryData", "_AddtlData", "_Orgtr", "_Hdr", "_SttlmSvc", "_OrgnlRspnCd", "_RtrvlRefNb", "_AgtData", "_BtchId", "_Dstn", "_PrcgRslt", "_SysTracAudtNb", "_Rcncltn", "_SctyTrlr", "_Prgrmm", "_PrtctdData", "_TrnsmssnDtTm", "_NbOfMsgs", "_LifeCyclId", "_ClrCtrlTtls", "_ClrBtchData", "_Rcrd", "_BtchChcksm", "_OrgnlBtchId"]
	@property
	def Jursdctn(self):
