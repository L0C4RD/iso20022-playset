...
from .ClearingPartyAndTime21Choice import ClearingPartyAndTime21Choice
from .ClearingExceptionOrExemption3Choice import ClearingExceptionOrExemption3Choice
from .ClearingPartyAndTime22Choice import ClearingPartyAndTime22Choice

class Cleared23Choice(base_types._BaseFieldType):

	__slots__ = ["_IntndToClear", "_NonClrd", "_Clrd"]
	@property
