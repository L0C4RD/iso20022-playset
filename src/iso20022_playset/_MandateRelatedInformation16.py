...
from . import AmendmentInformationDetails15
...
class MandateRelatedInformation16(base_types._BaseFieldType):
	...
	def AmdmntInfDtls(self, value):
		self._AmdmntInfDtls = value if value is not None else base_types.UninitialisedField(self, 'AmdmntInfDtls', AmendmentInformationDetails15, False)

	@AmdmntInfDtls.deleter
	def AmdmntInfDtls(self):
		del self._AmdmntInfDtls
		self._AmdmntInfDtls = base_types.UninitialisedField(self, 'AmdmntInfDtls', AmendmentInformationDetails15, False)
