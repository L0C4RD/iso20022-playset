...
class OriginalTransactionReference42(base_types._BaseFieldType):
	...
	__slots__ = ["_CdtrAgt", "_CdtrAgtAcct", "_CdtrAcct", "_IntrBkSttlmDt", "_IntrBkSttlmAmt", "_Purp", "_UltmtCdtr", "_ReqdExctnDt", "_RmtInf", "_Dbtr", "_SttlmInf", "_MndtRltdInf", "_Amt", "_ReqdColltnDt", "_UltmtDbtr", "_PmtTpInf", "_PmtMtd", "_DbtrAcct", "_DbtrAgtAcct", "_DbtrAgt", "_Cdtr", "_CdtrSchmeId"]
	@property
	def CdtrAgt(self):
