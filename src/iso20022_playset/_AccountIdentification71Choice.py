...
from . import AccountAndBalance60
...
class AccountIdentification71Choice(base_types._BaseFieldType):
	...
	def AcctsListAndBalDtls(self, value):
		self._AcctsListAndBalDtls = value if value is not None else base_types.UninitialisedField(self, 'AcctsListAndBalDtls', AccountAndBalance60, True)

	@AcctsListAndBalDtls.deleter
	def AcctsListAndBalDtls(self):
		del self._AcctsListAndBalDtls
		self._AcctsListAndBalDtls = base_types.UninitialisedField(self, 'AcctsListAndBalDtls', AccountAndBalance60, True)
