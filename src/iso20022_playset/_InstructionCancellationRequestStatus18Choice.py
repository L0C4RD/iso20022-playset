...
from . import CancelledStatus14Choice
from . import NoSpecifiedReason1
from . import PendingCancellationStatus15Choice
from . import ProprietaryStatusAndReason7
from . import RejectedStatus54Choice
...
class InstructionCancellationRequestStatus18Choice(base_types._BaseFieldType):
	...
	def CxlCmpltd(self, value):
		self._CxlCmpltd = value if value is not None else base_types.UninitialisedField(self, 'CxlCmpltd', CancelledStatus14Choice, False)

	@CxlCmpltd.deleter
	def CxlCmpltd(self):
		del self._CxlCmpltd
		self._CxlCmpltd = base_types.UninitialisedField(self, 'CxlCmpltd', CancelledStatus14Choice, False)
	...
	def PdgCxl(self, value):
		self._PdgCxl = value if value is not None else base_types.UninitialisedField(self, 'PdgCxl', PendingCancellationStatus15Choice, False)

	@PdgCxl.deleter
	def PdgCxl(self):
		del self._PdgCxl
		self._PdgCxl = base_types.UninitialisedField(self, 'PdgCxl', PendingCancellationStatus15Choice, False)
	...
	def Rjctd(self, value):
		self._Rjctd = value if value is not None else base_types.UninitialisedField(self, 'Rjctd', RejectedStatus54Choice, False)

	@Rjctd.deleter
	def Rjctd(self):
		del self._Rjctd
		self._Rjctd = base_types.UninitialisedField(self, 'Rjctd', RejectedStatus54Choice, False)
