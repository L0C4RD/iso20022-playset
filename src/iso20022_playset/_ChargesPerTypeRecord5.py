...
class ChargesPerTypeRecord5(base_types._BaseFieldType):
	...
	__slots__ = ["_UndrlygTx", "_ChrgsRqstr", "_ValDt", "_Dbtr", "_ChrgsAcct", "_AddtlInf", "_Amt", "_DbtrAgtAcct", "_DbtrAgt", "_ChrgsAcctOwnr", "_InstrForInstdAgt", "_RcrdId", "_CdtDbtInd", "_DbtrAcct"]
	@property
	def UndrlygTx(self):
