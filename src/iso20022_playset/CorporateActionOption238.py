...
class CorporateActionOption238(base_types._BaseFieldType):
	...
	__slots__ = ["_CshAcct", "_SfkpgPlc", "_SfkpgAcct", "_FinInstrmId", "_StsCshAmt", "_SlctnDealrFeeInd", "_AcctOwnr", "_OptnFeatrs", "_TtlElgblBal", "_BlckChainAdrOrWllt", "_OptnTp", "_OptnNb", "_UinstdBal", "_PrtctBal", "_InstdBal", "_StsQty"]
	@property
	def CshAcct(self):
