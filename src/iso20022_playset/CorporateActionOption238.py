...
class CorporateActionOption238(base_types._BaseFieldType):
	...
	__slots__ = ["_StsCshAmt", "_SfkpgPlc", "_AcctOwnr", "_BlckChainAdrOrWllt", "_OptnFeatrs", "_SlctnDealrFeeInd", "_OptnTp", "_TtlElgblBal", "_PrtctBal", "_StsQty", "_SfkpgAcct", "_InstdBal", "_OptnNb", "_UinstdBal", "_FinInstrmId", "_CshAcct"]
	@property
	def StsCshAmt(self):
