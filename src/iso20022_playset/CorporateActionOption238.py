...
class CorporateActionOption238(base_types._BaseFieldType):
	...
	__slots__ = ["_OptnTp", "_UinstdBal", "_SfkpgAcct", "_OptnNb", "_SlctnDealrFeeInd", "_SfkpgPlc", "_StsQty", "_FinInstrmId", "_AcctOwnr", "_BlckChainAdrOrWllt", "_OptnFeatrs", "_InstdBal", "_CshAcct", "_StsCshAmt", "_TtlElgblBal", "_PrtctBal"]
	@property
	def OptnTp(self):
		return self._OptnTp
