...
from .AssetClassCommodityPaper5Choice import AssetClassCommodityPaper5Choice
...
class AssetClassCommodity7Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_Plprpln", "_Metl", "_Agrcltrl", "_Indx", "_Infltn", "_Envttl", "_OthrC10", "_OffclEcnmcSttstcs", "_Frght", "_Othr", "_MultiCmmdtyExtc", "_Frtlzr", "_Nrgy", "_Ppr", "_IndstrlPdct"]
	@property
	def Plprpln(self):
