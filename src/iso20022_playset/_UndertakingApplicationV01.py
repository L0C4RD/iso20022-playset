...
from ._Undertaking1 import Undertaking1

class UndertakingApplicationV01(base_types._BaseFieldType):

	__slots__ = ["_InstrsToBk", "_UdrtkgApplDtls", "_DgtlSgntr"]
	@property
	def InstrsToBk(self):
	...
	def UdrtkgApplDtls(self, value):
		self._UdrtkgApplDtls = value if type(value) != base_types.auto else self.make_default("UdrtkgApplDtls")
