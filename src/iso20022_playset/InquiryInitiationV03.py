...
class InquiryInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_CstmrDvc", "_Prgrmm", "_ICCRltdData", "_Termnl", "_TxAmts", "_SpclPrgrmmQlfctn", "_Rcvr", "_Rcncltn", "_SctyTrlr", "_PrtctdData", "_Crdhldr", "_Vrfctn", "_Acqrr", "_Card", "_AddtlFee", "_TxId", "_Jursdctn", "_AddtlData", "_Instlmt", "_ConvsDtTm", "_Orgtr", "_Hdr", "_Rsk", "_TxChrtcs", "_Wllt", "_Sndr", "_OrgnlRspnCd", "_Tkn", "_POICmpnt", "_PrcgRslt", "_Dstn", "_SttlmSvc", "_Accptr", "_Issr", "_AddtlAmt", "_AddtlSvc", "_XchgRate", "_StrngCstmrAuthntcn", "_AcctFr", "_Cntxt"]
	@property
