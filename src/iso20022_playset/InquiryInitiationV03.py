...
class InquiryInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_PrcgRslt", "_OrgnlRspnCd", "_Accptr", "_TxId", "_StrngCstmrAuthntcn", "_SpclPrgrmmQlfctn", "_AddtlData", "_Issr", "_Vrfctn", "_XchgRate", "_Acqrr", "_Dstn", "_SplmtryData", "_Hdr", "_TxAmts", "_Card", "_Prgrmm", "_AcctFr", "_AddtlSvc", "_Rcvr", "_AddtlAmt", "_Rcncltn", "_ConvsDtTm", "_Tkn", "_SttlmSvc", "_Wllt", "_SctyTrlr", "_Orgtr", "_AddtlFee", "_Jursdctn", "_CstmrDvc", "_PrtctdData", "_Instlmt", "_Cntxt", "_ICCRltdData", "_Crdhldr", "_POICmpnt", "_Sndr", "_Rsk", "_TxChrtcs", "_Termnl"]
	@property
	def PrcgRslt(self):
