...
class InquiryInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_POICmpnt", "_Prgrmm", "_Tkn", "_Dstn", "_PrtctdData", "_Crdhldr", "_TxAmts", "_PrcgRslt", "_Rcvr", "_Card", "_Jursdctn", "_Wllt", "_TxChrtcs", "_Orgtr", "_SctyTrlr", "_CstmrDvc", "_Hdr", "_Rsk", "_AddtlFee", "_Sndr", "_ICCRltdData", "_Termnl", "_Cntxt", "_AddtlData", "_Rcncltn", "_SpclPrgrmmQlfctn", "_SttlmSvc", "_Accptr", "_StrngCstmrAuthntcn", "_Instlmt", "_AcctFr", "_Issr", "_OrgnlRspnCd", "_Vrfctn", "_AddtlAmt", "_SplmtryData", "_Acqrr", "_XchgRate", "_ConvsDtTm", "_AddtlSvc", "_TxId"]
	@property
	def POICmpnt(self):
