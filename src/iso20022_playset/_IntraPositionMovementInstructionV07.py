...
class IntraPositionMovementInstructionV07(base_types._BaseFieldType):
	...
	__slots__ = ["_TxId", "_FinInstrmId", "_Lnkgs", "_SfkpgAcct", "_IntraPosDtls", "_SfkpgPlc", "_CorpActnEvtId", "_NbCounts", "_AcctOwnr", "_SplmtryData", "_BlckChainAdrOrWllt", "_FinInstrmAttrbts"]
	@property
	def TxId(self):
		return self._TxId
