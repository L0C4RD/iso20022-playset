...
class IntraPositionMovementInstructionV07(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_SfkpgAcct", "_SfkpgPlc", "_FinInstrmId", "_FinInstrmAttrbts", "_BlckChainAdrOrWllt", "_Lnkgs", "_CorpActnEvtId", "_IntraPosDtls", "_AcctOwnr", "_TxId", "_NbCounts"]
	@property
