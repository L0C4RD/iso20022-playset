...
from ._FundConfirmedCashForecastReportV04 import FundConfirmedCashForecastReportV04
...
class CAMT_041_001_04():
	...
	class Document(base_types._BaseFieldType):
		...
		attrib = {
			"xmlns" : base_types._BaseDataType_String(None, data="urn:iso:std:iso:20022:tech:xsd:camt.041.001.04"),
		}
		...
		def FndConfdCshFcstRpt(self, value):
			self._FndConfdCshFcstRpt = value if type(value) != base_types.auto else self.make_default("FndConfdCshFcstRpt")
