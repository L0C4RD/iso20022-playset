...
class BatchTransferInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlRspnCd", "_Rcrd", "_PrcgRslt", "_NbOfMsgs", "_AddtlData", "_Jursdctn", "_BtchChcksm", "_LifeCyclId", "_ClrCtrlTtls", "_Hdr", "_RtrvlRefNb", "_Rcncltn", "_Prgrmm", "_SctyTrlr", "_OrgnlBtchId", "_TrnsmssnDtTm", "_Dstn", "_SysTracAudtNb", "_SttlmSvc", "_ReqAck", "_PrtctdData", "_BtchId", "_Orgtr", "_SplmtryData", "_ClrBtchData", "_AgtData"]
	@property
	def AddtlData(self):
