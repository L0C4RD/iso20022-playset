...
class BatchTransferInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_BtchId", "_SttlmSvc", "_SctyTrlr", "_RtrvlRefNb", "_PrcgRslt", "_Rcrd", "_LifeCyclId", "_OrgnlRspnCd", "_ReqAck", "_Hdr", "_AddtlData", "_TrnsmssnDtTm", "_Dstn", "_Rcncltn", "_AgtData", "_NbOfMsgs", "_BtchChcksm", "_Jursdctn", "_ClrCtrlTtls", "_OrgnlBtchId", "_Orgtr", "_Prgrmm", "_SysTracAudtNb", "_ClrBtchData", "_PrtctdData"]
	@property
