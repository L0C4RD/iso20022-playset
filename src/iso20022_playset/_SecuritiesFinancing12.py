...
class SecuritiesFinancing12(base_types._BaseFieldType):
	...
	__slots__ = ["_RateTp", "_RpRate", "_CtrctTermsModChngd", "_Rvsbl", "_CollTp", "_MinDtForCallBck", "_StdCollAmt", "_AcrdIntrstPctg", "_PricgRate", "_SctiesLndgTp", "_EndNbOfDaysAcrd", "_IntrstCmptnMtd", "_RateChngDt", "_AcrdIntrstTax", "_EndFctr", "_RollOver", "_StdCollRatio", "_PrmAmt", "_LndgTxMtd", "_SprdRate", "_FincgAgrmt", "_VarblRateSpprt", "_ClsgAmtPerPcsOfColl", "_LndgWthColl", "_CllblTradInd", "_NbOfDaysLndgBrrwg", "_BrrwgRsn", "_PrdcPmt", "_BrrwgRate", "_AcrdIntrstAmt", "_FrftAmt", "_TtlNbOfCollInstrs", "_DvddRatio", "_Rvaltn", "_TxCallDely", "_ExCpn", "_StockLnMrgn", "_IntrstRate", "_LglFrmwk", "_SctiesHrcut"]
	@property
	def RateTp(self):
		return self._RateTp
