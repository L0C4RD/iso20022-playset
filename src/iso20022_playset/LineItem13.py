...
class LineItem13(base_types._BaseFieldType):
	...
	__slots__ = ["_RtgSummry", "_LineItmDtls", "_SellrDfndInf", "_BuyrDfndInf", "_LineItmsTtlAmt", "_Adjstmnt", "_TrnsShipmnt", "_ShipmntDtRg", "_Tax", "_FrghtChrgs", "_GoodsAndOrSvcsDesc", "_PrtlShipmnt", "_TtlNetAmt", "_Incotrms"]
	@property
	def RtgSummry(self):
