...
from .ExternalEffectiveDateParameter1Code import ExternalEffectiveDateParameter1Code
...
class EffectiveDate1(base_types._BaseFieldType):
	...
	def FctvDtParam(self, value):
		self._FctvDtParam = value if type(value) != base_types.auto else self.make_default("FctvDtParam")
