...
class VerificationInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_PrcgRslt", "_OrgnlRspnCd", "_Accptr", "_TxId", "_StrngCstmrAuthntcn", "_SpclPrgrmmQlfctn", "_AddtlData", "_Issr", "_Vrfctn", "_XchgRate", "_Acqrr", "_Dstn", "_SplmtryData", "_Hdr", "_TxAmts", "_Pyer", "_Card", "_Prgrmm", "_AcctFr", "_AddtlSvc", "_Tkn", "_Rcvr", "_AddtlAmt", "_Rcncltn", "_ConvsDtTm", "_SttlmSvc", "_Wllt", "_SctyTrlr", "_Orgtr", "_AddtlFee", "_Pyee", "_Jursdctn", "_TxChrtcs", "_AcctTo", "_CstmrDvc", "_PrtctdData", "_Instlmt", "_Cntxt", "_FndsSvcs", "_ICCRltdData", "_Crdhldr", "_POICmpnt", "_Sndr", "_Rsk", "_Termnl"]
	@property
	def PrcgRslt(self):
