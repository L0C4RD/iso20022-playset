...
class VerificationInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_Rsk", "_AcctTo", "_Pyee", "_OrgnlRspnCd", "_Card", "_AddtlSvc", "_ICCRltdData", "_Termnl", "_StrngCstmrAuthntcn", "_TxId", "_Dstn", "_AddtlData", "_PrcgRslt", "_Acqrr", "_Hdr", "_SctyTrlr", "_AddtlAmt", "_AddtlFee", "_Issr", "_Accptr", "_Orgtr", "_Sndr", "_SpclPrgrmmQlfctn", "_AcctFr", "_Instlmt", "_Pyer", "_Wllt", "_Rcvr", "_Vrfctn", "_XchgRate", "_ConvsDtTm", "_Cntxt", "_FndsSvcs", "_Rcncltn", "_Jursdctn", "_CstmrDvc", "_POICmpnt", "_Crdhldr", "_Tkn", "_PrtctdData", "_TxAmts", "_SttlmSvc", "_Prgrmm", "_TxChrtcs"]
	@property
