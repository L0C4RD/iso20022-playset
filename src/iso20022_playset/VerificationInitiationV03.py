...
class VerificationInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Accptr", "_ICCRltdData", "_SctyTrlr", "_Hdr", "_Orgtr", "_Acqrr", "_PrcgRslt", "_Jursdctn", "_Rcvr", "_Pyee", "_Termnl", "_CstmrDvc", "_Dstn", "_AddtlAmt", "_TxAmts", "_Rcncltn", "_TxChrtcs", "_Issr", "_SplmtryData", "_FndsSvcs", "_Tkn", "_Pyer", "_StrngCstmrAuthntcn", "_XchgRate", "_Instlmt", "_AddtlData", "_Sndr", "_Cntxt", "_OrgnlRspnCd", "_AddtlSvc", "_AcctFr", "_Wllt", "_AcctTo", "_POICmpnt", "_SpclPrgrmmQlfctn", "_Prgrmm", "_AddtlFee", "_SttlmSvc", "_Vrfctn", "_PrtctdData", "_TxId", "_Rsk", "_ConvsDtTm", "_Card", "_Crdhldr"]
	@property
	def Accptr(self):
		return self._Accptr
