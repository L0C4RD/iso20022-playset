...
class VehicleRentalService3(base_types._BaseFieldType):
	...
	__slots__ = ["_CpnyCtct", "_CpnyAdr", "_RntlInvc", "_CpnyId", "_CpnyNm", "_RntrCorpIdrAssgnr", "_CpnyTp", "_LltyPrgrmm", "_PmryDrvr", "_CpnyOthrTp", "_RntrCorpNm", "_RntlAgrmt", "_AddtlDrvr", "_SummryCmmdtyId", "_AddtlData", "_RntrNm", "_RntrCorpIdr"]
	@property
	def CpnyCtct(self):
