...
from . import UnderlyingTransaction34
...
class FIToFIPaymentCancellationRequestV11(base_types._BaseFieldType):
	...
	def Undrlyg(self, value):
		self._Undrlyg = value if value is not None else base_types.UninitialisedField(self, 'Undrlyg', UnderlyingTransaction34, True)

	@Undrlyg.deleter
	def Undrlyg(self):
		del self._Undrlyg
		self._Undrlyg = base_types.UninitialisedField(self, 'Undrlyg', UnderlyingTransaction34, True)
