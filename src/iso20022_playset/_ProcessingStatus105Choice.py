...
from . import PendingStatus82Choice
from . import ProprietaryStatusAndReason6
from . import RejectionOrRepairStatus42Choice
from . import RejectionOrRepairStatus43Choice

class ProcessingStatus105Choice(base_types._BaseFieldType):
	...
	def PdgCxl(self, value):
		self._PdgCxl = value if value is not None else base_types.UninitialisedField(self, 'PdgCxl', PendingStatus82Choice, False)

	@PdgCxl.deleter
	def PdgCxl(self):
		del self._PdgCxl
		self._PdgCxl = base_types.UninitialisedField(self, 'PdgCxl', PendingStatus82Choice, False)
	...
	def Rjctd(self, value):
		self._Rjctd = value if value is not None else base_types.UninitialisedField(self, 'Rjctd', RejectionOrRepairStatus43Choice, False)

	@Rjctd.deleter
	def Rjctd(self):
		del self._Rjctd
		self._Rjctd = base_types.UninitialisedField(self, 'Rjctd', RejectionOrRepairStatus43Choice, False)
	...
	@Rpr.setter
	def Rpr(self, value):
		self._Rpr = value if value is not None else base_types.UninitialisedField(self, 'Rpr', RejectionOrRepairStatus42Choice, False)

	@Rpr.deleter
	def Rpr(self):
		del self._Rpr
		self._Rpr = base_types.UninitialisedField(self, 'Rpr', RejectionOrRepairStatus42Choice, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='PdgCxl', type=PendingStatus82Choice, min=0, max=1, mutex_group=1, array=False),
