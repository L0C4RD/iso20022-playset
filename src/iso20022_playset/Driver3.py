...
class Driver3(base_types._BaseFieldType):
	...
	__slots__ = ["_LicTp", "_AddtlId", "_LicCtry", "_LicXprtnDt", "_LicCtrySubDvsnMjr", "_MplyeeId", "_LicAssgnr", "_AddtlData", "_LicForm", "_Nm", "_LicOthrAuthrty", "_LicCtrySubDvsnMnr", "_Mplyr", "_LicIssncDt", "_Id", "_DeptNb", "_LicId", "_DtOfBirth"]
	@property
	def LicTp(self):
		return self._LicTp
