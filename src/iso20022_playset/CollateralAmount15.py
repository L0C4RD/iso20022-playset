...
class CollateralAmount15(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlCshFaild", "_ValOfCollHeld", "_TtlOfPrncpls", "_TtlFeesComssns", "_TtlValOfOwnColl", "_TtlValOfReusdColl", "_TtlAcrdIntrst", "_Mrgn", "_TtlPdgCollOut", "_TtlPdgCollIn", "_TtlXpsr", "_TtlCollReqrd"]
	@property
