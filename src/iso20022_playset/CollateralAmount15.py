...
class CollateralAmount15(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlPdgCollOut", "_TtlOfPrncpls", "_TtlXpsr", "_TtlValOfOwnColl", "_TtlCshFaild", "_Mrgn", "_TtlCollReqrd", "_TtlAcrdIntrst", "_TtlPdgCollIn", "_TtlFeesComssns", "_ValOfCollHeld", "_TtlValOfReusdColl"]
	@property
