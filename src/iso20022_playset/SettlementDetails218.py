...
class SettlementDetails218(base_types._BaseFieldType):
	...
	__slots__ = ["_RtrLeg", "_CshClrSys", "_CCPElgblty", "_ModCxlAllwd", "_SttlgCpcty", "_NetgElgblty", "_BnfclOwnrsh", "_TaxCpcty", "_SctiesTxTp", "_SctiesSubBalTp", "_DlvryRtrRsn", "_LglRstrctns", "_LttrOfGrnt", "_StmpDtyTaxBsis", "_Trckg", "_SttlmTxCond", "_XpsrTp", "_ElgblForColl", "_MktClntSd", "_Regn", "_CshSubBalTp", "_FxStgInstr"]
	@property
	def RtrLeg(self):
		return self._RtrLeg
