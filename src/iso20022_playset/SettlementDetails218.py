import base_types
import SecuritiesTransactionType59Choice
...
import SettlementTransactionCondition16Choice
import Restriction5Choice

class SettlementDetails218(base_types._BaseFieldType):

	__slots__ = ["_SctiesTxTp", "_ElgblForColl", "_FxStgInstr", "_NetgElgblty", "_TaxCpcty", "_SttlmTxCond", "_CshClrSys", "_ModCxlAllwd", "_Regn", "_MktClntSd", "_RtrLeg", "_SctiesSubBalTp", "_Trckg", "_CshSubBalTp", "_StmpDtyTaxBsis", "_LttrOfGrnt", "_DlvryRtrRsn", "_CCPElgblty", "_LglRstrctns", "_BnfclOwnrsh", "_XpsrTp", "_SttlgCpcty"]
	@property
	def SctiesTxTp(self):
