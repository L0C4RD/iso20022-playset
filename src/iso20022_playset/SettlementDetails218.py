...
from .SettlementTransactionCondition16Choice import SettlementTransactionCondition16Choice
from .ModificationCancellationAllowed4Choice import ModificationCancellationAllowed4Choice
from .SecuritiesTransactionType59Choice import SecuritiesTransactionType59Choice

class SettlementDetails218(base_types._BaseFieldType):

	__slots__ = ["_CshClrSys", "_ElgblForColl", "_CCPElgblty", "_StmpDtyTaxBsis", "_MktClntSd", "_ModCxlAllwd", "_Regn", "_NetgElgblty", "_TaxCpcty", "_SctiesSubBalTp", "_SttlmTxCond", "_LglRstrctns", "_SttlgCpcty", "_Trckg", "_CshSubBalTp", "_RtrLeg", "_FxStgInstr", "_XpsrTp", "_SctiesTxTp", "_BnfclOwnrsh", "_LttrOfGrnt", "_DlvryRtrRsn"]
	@property
	def CshClrSys(self):
