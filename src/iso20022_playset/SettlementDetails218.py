...
class SettlementDetails218(base_types._BaseFieldType):
	...
	__slots__ = ["_TaxCpcty", "_NetgElgblty", "_MktClntSd", "_SttlmTxCond", "_Regn", "_CshClrSys", "_FxStgInstr", "_SctiesTxTp", "_CCPElgblty", "_LttrOfGrnt", "_SttlgCpcty", "_SctiesSubBalTp", "_BnfclOwnrsh", "_XpsrTp", "_RtrLeg", "_StmpDtyTaxBsis", "_Trckg", "_ElgblForColl", "_ModCxlAllwd", "_CshSubBalTp", "_DlvryRtrRsn", "_LglRstrctns"]
	@property
	def TaxCpcty(self):
