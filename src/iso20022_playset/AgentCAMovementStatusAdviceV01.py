...
from .CorporateActionMovementStatus1Choice import CorporateActionMovementStatus1Choice
...
from .CorporateMovementStatus2 import CorporateMovementStatus2

class AgentCAMovementStatusAdviceV01(base_types._BaseFieldType):

	__slots__ = ["_AgtCAGblDstrbtnStsAdvcId", "_MvmntCxlStsDtls", "_MvmntStsDtls", "_CorpActnGnlInf", "_AgtCAMvmntInstrId", "_Id", "_AgtCAMvmntCxlReqId", "_AgtCAElctnStsAdvcId"]
	@property
	...
	def MvmntCxlStsDtls(self, value):
		self._MvmntCxlStsDtls = value if type(value) != auto else self.make_default("MvmntCxlStsDtls")
	...
	def MvmntStsDtls(self, value):
		self._MvmntStsDtls = value if type(value) != auto else self.make_default("MvmntStsDtls")
