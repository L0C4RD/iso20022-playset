...
class ProcessingCharacteristics11(base_types._BaseFieldType):
	...
	__slots__ = ["_DealConfTm", "_DealgFrqcy", "_SbsqntInvstmtAppl", "_AddtlInf", "_DealgCcyAccptd", "_DealgCutOffTmFrame", "_UnitsInd", "_SttlmCycl", "_AmtInd", "_LtdPrd", "_DealgCutOffTm", "_Rndg", "_InitlInvstmtAppl", "_DealConfTmFrame", "_MainFndOrdrDskLctn", "_DealgFrqcyDesc"]
	@property
	def DealConfTm(self):
