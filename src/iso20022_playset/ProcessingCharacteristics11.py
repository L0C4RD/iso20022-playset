...
class ProcessingCharacteristics11(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlInf", "_DealgFrqcy", "_MainFndOrdrDskLctn", "_AmtInd", "_SttlmCycl", "_Rndg", "_DealgCutOffTmFrame", "_DealConfTmFrame", "_UnitsInd", "_DealgCcyAccptd", "_DealgCutOffTm", "_SbsqntInvstmtAppl", "_DealConfTm", "_DealgFrqcyDesc", "_LtdPrd", "_InitlInvstmtAppl"]
	@property
	def AddtlInf(self):
