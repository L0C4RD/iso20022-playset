...
class ProcessingCharacteristics11(base_types._BaseFieldType):
	...
	__slots__ = ["_DealgFrqcy", "_DealConfTmFrame", "_DealConfTm", "_InitlInvstmtAppl", "_UnitsInd", "_AmtInd", "_DealgCutOffTmFrame", "_AddtlInf", "_DealgFrqcyDesc", "_Rndg", "_LtdPrd", "_DealgCcyAccptd", "_DealgCutOffTm", "_SbsqntInvstmtAppl", "_SttlmCycl", "_MainFndOrdrDskLctn"]
	@property
	def DealgFrqcy(self):
