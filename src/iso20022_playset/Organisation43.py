...
class Organisation43(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgLglSts", "_RprtvOffcr", "_RegnDt", "_TaxtnIdNb", "_Sndr", "_TaxtnCtry", "_BizAdr", "_FullLglNm", "_OprlAdr", "_LglAdr", "_MainMndtHldr", "_RegnNb", "_RegnCtry", "_TrsrMgr", "_TradgNm", "_CtryOfOpr", "_EstblishdDt", "_BrdRsltnInd"]
	@property
	def OrgLglSts(self):
