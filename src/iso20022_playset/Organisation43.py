...
class Organisation43(base_types._BaseFieldType):
	...
	__slots__ = ["_RegnNb", "_EstblishdDt", "_MainMndtHldr", "_BizAdr", "_LglAdr", "_OrgLglSts", "_BrdRsltnInd", "_OprlAdr", "_RegnCtry", "_RprtvOffcr", "_TaxtnIdNb", "_RegnDt", "_Sndr", "_CtryOfOpr", "_FullLglNm", "_TrsrMgr", "_TaxtnCtry", "_TradgNm"]
	@property
	def RegnNb(self):
		return self._RegnNb
