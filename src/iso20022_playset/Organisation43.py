...
class Organisation43(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgLglSts", "_RegnDt", "_BizAdr", "_BrdRsltnInd", "_RegnNb", "_TradgNm", "_TrsrMgr", "_LglAdr", "_TaxtnIdNb", "_OprlAdr", "_FullLglNm", "_CtryOfOpr", "_TaxtnCtry", "_EstblishdDt", "_RegnCtry", "_Sndr", "_MainMndtHldr", "_RprtvOffcr"]
	@property
	def OrgLglSts(self):
