...
class Organisation43(base_types._BaseFieldType):
	...
	__slots__ = ["_TradgNm", "_LglAdr", "_OrgLglSts", "_Sndr", "_CtryOfOpr", "_RprtvOffcr", "_TaxtnIdNb", "_BizAdr", "_MainMndtHldr", "_OprlAdr", "_BrdRsltnInd", "_FullLglNm", "_EstblishdDt", "_RegnDt", "_TaxtnCtry", "_RegnNb", "_TrsrMgr", "_RegnCtry"]
	@property
	def TradgNm(self):
