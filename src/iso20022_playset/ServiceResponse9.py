...
from .BatchResponse7 import BatchResponse7
from .SupplementaryData1 import SupplementaryData1
from .ReversalResponse9 import ReversalResponse9
from .RetailerService3Code import RetailerService3Code
...
from .BalanceInquiryResponse6 import BalanceInquiryResponse6

class ServiceResponse9(base_types._BaseFieldType):

	__slots__ = ["_SvcCntt", "_Rspn", "_BtchRspn", "_Envt", "_BalNqryRspn", "_Cntxt", "_PmtRspn", "_LltyRspn", "_SplmtryData", "_StordValRspn", "_CardAcqstnRspn", "_RvslRspn"]
	@property
	def SvcCntt(self):
	...
	def BtchRspn(self, value):
		self._BtchRspn = value if type(value) != auto else self.make_default("BtchRspn")
	...
	def PmtRspn(self, value):
		self._PmtRspn = value if type(value) != auto else self.make_default("PmtRspn")
	...
	def CardAcqstnRspn(self, value):
		self._CardAcqstnRspn = value if type(value) != auto else self.make_default("CardAcqstnRspn")
