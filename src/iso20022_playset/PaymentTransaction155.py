...
class PaymentTransaction155(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlIntrBkSttlmAmt", "_OrgnlTxRef", "_CxlRsnInf", "_SplmtryData", "_OrgnlIntrBkSttlmDt", "_Assgne", "_OrgnlUETR", "_OrgnlEndToEndId", "_OrgnlGrpInf", "_OrgnlTxId", "_OrgnlClrSysRef", "_Assgnr", "_Case", "_OrgnlInstrId", "_CxlId"]
	@property
