...
class PaymentTransaction155(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlEndToEndId", "_OrgnlIntrBkSttlmAmt", "_OrgnlIntrBkSttlmDt", "_CxlId", "_OrgnlInstrId", "_OrgnlUETR", "_Assgnr", "_OrgnlGrpInf", "_OrgnlTxRef", "_Assgne", "_OrgnlTxId", "_OrgnlClrSysRef", "_Case", "_SplmtryData", "_CxlRsnInf"]
	@property
