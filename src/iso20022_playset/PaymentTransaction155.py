...
class PaymentTransaction155(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlEndToEndId", "_CxlId", "_OrgnlTxId", "_SplmtryData", "_OrgnlClrSysRef", "_Assgne", "_OrgnlGrpInf", "_OrgnlIntrBkSttlmAmt", "_OrgnlInstrId", "_CxlRsnInf", "_Case", "_Assgnr", "_OrgnlUETR", "_OrgnlIntrBkSttlmDt", "_OrgnlTxRef"]
	@property
