...
class CorporateActionCancellationAdviceV13(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctsDtls", "_CorpActnDtls", "_CxlAdvcGnlInf", "_SlctnAgt", "_SplmtryData", "_InfAgt", "_Regar", "_RsellngAgt", "_DrpAgt", "_AddtlTxt", "_PhysSctiesAgt", "_CorpActnGnlInf", "_PngAgt", "_SubPngAgt", "_IssrAgt"]
	@property
	def AcctsDtls(self):
