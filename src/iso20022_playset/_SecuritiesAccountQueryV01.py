...
from . import SecuritiesAccountReturnCriteria1
from . import SecuritiesAccountSearchCriteria2
...
class SecuritiesAccountQueryV01(base_types._BaseFieldType):
	...
	def RtrCrit(self, value):
		self._RtrCrit = value if value is not None else base_types.UninitialisedField(self, 'RtrCrit', SecuritiesAccountReturnCriteria1, False)

	@RtrCrit.deleter
	def RtrCrit(self):
		del self._RtrCrit
		self._RtrCrit = base_types.UninitialisedField(self, 'RtrCrit', SecuritiesAccountReturnCriteria1, False)
	...
	def SchCrit(self, value):
		self._SchCrit = value if value is not None else base_types.UninitialisedField(self, 'SchCrit', SecuritiesAccountSearchCriteria2, False)

	@SchCrit.deleter
	def SchCrit(self):
		del self._SchCrit
		self._SchCrit = base_types.UninitialisedField(self, 'SchCrit', SecuritiesAccountSearchCriteria2, False)
