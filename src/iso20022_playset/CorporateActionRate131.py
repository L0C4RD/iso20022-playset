...
class CorporateActionRate131(base_types._BaseFieldType):
	...
	__slots__ = ["_TaxblIncmPerDvddShr", "_AddtlTax", "_ScndLvlTax", "_GrssIntrstRateUsdForPmt", "_WhldgTaxRate", "_NetDstrbtnRate", "_PrratnRate", "_MaxAllwdOvrsbcptRate", "_GrssDstrbtnRate"]
	@property
