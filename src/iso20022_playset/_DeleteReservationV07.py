...
class DeleteReservationV07(base_types._BaseFieldType):
	...
	def CurRsvatn(self, value):
		self._CurRsvatn = value if value is not None else base_types.UninitialisedField(self, 'CurRsvatn', ReservationIdentification4, False)

	@CurRsvatn.deleter
	def CurRsvatn(self):
		del self._CurRsvatn
		self._CurRsvatn = base_types.UninitialisedField(self, 'CurRsvatn', ReservationIdentification4, False)
