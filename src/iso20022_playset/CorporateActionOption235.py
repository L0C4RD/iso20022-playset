...
class CorporateActionOption235(base_types._BaseFieldType):
	...
	__slots__ = ["_PrratnFrctn", "_DtDtls", "_RateAndAmtDtls", "_OptnNb", "_SplmtryOptnFeatrs", "_PricDtls", "_FrctnDspstn", "_SbcptChrgInd", "_PrtctChrgInd", "_OvrsbcptChrgInd", "_SctiesMvmntDtls", "_CertfctnBrkdwnTp", "_CertfctnBrkdwnInd", "_PrratnRndgInd", "_PrratnBlwMinQty", "_StepUpChrgInd", "_AddtlInf", "_SctiesQty", "_CcyOptn", "_OptnFeatrs", "_WdrwlAllwdInd", "_OfferTp", "_FinInstrmId", "_AccptncPrtyLvl", "_PrratnRtrMinQtyTrtmnt", "_PrdDtls", "_OptnAvlbtySts", "_DfltOptnInd", "_CshMvmntDtls", "_TaxCtgy", "_OptnTp"]
	@property
