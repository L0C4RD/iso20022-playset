...
class CorporateActionOption235(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlInf", "_WdrwlAllwdInd", "_CcyOptn", "_FrctnDspstn", "_StepUpChrgInd", "_OptnFeatrs", "_DtDtls", "_OptnAvlbtySts", "_SplmtryOptnFeatrs", "_OptnNb", "_CertfctnBrkdwnInd", "_PrratnRndgInd", "_SbcptChrgInd", "_OfferTp", "_PrdDtls", "_OptnTp", "_PrratnBlwMinQty", "_OvrsbcptChrgInd", "_DfltOptnInd", "_TaxCtgy", "_PrratnFrctn", "_CertfctnBrkdwnTp", "_SctiesMvmntDtls", "_PrtctChrgInd", "_RateAndAmtDtls", "_PrratnRtrMinQtyTrtmnt", "_PricDtls", "_CshMvmntDtls", "_FinInstrmId", "_SctiesQty", "_AccptncPrtyLvl"]
	@property
	def AddtlInf(self):
