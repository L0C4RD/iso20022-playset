...
from .InterestRequestSequence1Code import InterestRequestSequence1Code
from .InterestRate1Choice import InterestRate1Choice
from .Reference20 import Reference20
...
class InterestAmount4(base_types._BaseFieldType):
	...
	__slots__ = ["_ValDt", "_ClsgCollBal", "_RefDtls", "_CollPurp", "_DayCntBsis", "_IntrstReqSeq", "_IntrstRate", "_AcrdIntrstAmt", "_AddtlInf", "_StdSttlmInstrs", "_IntrstPrd", "_ClctnFrqcy", "_ApldWhldgTax", "_IntrstMtd", "_ClctnMtd", "_OpngCollBal"]
	@property
	def ValDt(self):
		return self._ValDt
	...
	def RefDtls(self, value):
		self._RefDtls = value if type(value) != base_types.auto else self.make_default("RefDtls")
