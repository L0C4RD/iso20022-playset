...
class PaymentTransaction165(base_types._BaseFieldType):
	...
	__slots__ = ["_TxDtls", "_TxId", "_CstmrCnsnt", "_CstmrOrdr", "_SaleToIssrData", "_OrgnlTx", "_TxCaptr", "_AuthstnRslt", "_AddtlTxData", "_CardPrgrmmPropsd", "_SaleToPOIData", "_LastTxFlg", "_PmtTpInf", "_SvcAttr", "_IssrRefData", "_MrchntCITId", "_CardPrgrmmApld", "_AddtlSvc", "_CstmrTkn", "_SaleRefId", "_RcncltnId", "_TxTp", "_MrchntRefData", "_SaleToAcqrrData", "_PmtInstrm", "_IssrCITId", "_MrchntCtgyCd"]
	@property
	def TxDtls(self):
		return self._TxDtls
