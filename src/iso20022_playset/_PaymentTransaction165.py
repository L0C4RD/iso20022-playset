...
class PaymentTransaction165(base_types._BaseFieldType):
	...
	__slots__ = ["_TxId", "_SvcAttr", "_OrgnlTx", "_TxTp", "_MrchntRefData", "_SaleToPOIData", "_TxCaptr", "_CstmrOrdr", "_CardPrgrmmApld", "_SaleToIssrData", "_TxDtls", "_AuthstnRslt", "_AddtlTxData", "_CstmrCnsnt", "_CstmrTkn", "_SaleToAcqrrData", "_MrchntCtgyCd", "_RcncltnId", "_MrchntCITId", "_IssrCITId", "_SaleRefId", "_AddtlSvc", "_LastTxFlg", "_PmtInstrm", "_IssrRefData", "_CardPrgrmmPropsd", "_PmtTpInf"]
	@property
	def TxId(self):
		return self._TxId
