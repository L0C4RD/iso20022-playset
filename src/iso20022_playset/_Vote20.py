...
from . import ResolutionStatus2Code
from . import ResolutionSubStatus1Code

class Vote20(base_types._BaseFieldType):

	__slots__ = ["_Abstn", "_Agnst", "_AgnstMgmt", "_Blnk", "_Desc", "_Dscrtnry", "_For", "_IssrLabl", "_NoActn", "_OneYr", "_Prtry", "_RsltnSts", "_SubSts", "_ThreeYrs", "_TwoYrs", "_WthMgmt", "_Wthhld"]
	@property
	def Abstn(self):
		return self._Abstn
	...
	def RsltnSts(self, value):
		self._RsltnSts = value if value is not None else base_types.UninitialisedField(self, 'RsltnSts', ResolutionStatus2Code, False)

	@RsltnSts.deleter
	def RsltnSts(self):
		del self._RsltnSts
		self._RsltnSts = base_types.UninitialisedField(self, 'RsltnSts', ResolutionStatus2Code, False)
