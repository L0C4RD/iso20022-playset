...
class TransportBySea5(base_types._BaseFieldType):
	...
	__slots__ = ["_ChrtrrNm", "_VygNb", "_SeaCrrierCtry", "_IMONb", "_PortOfLoadng", "_OwnrNm", "_VsslNm", "_CrrierAgtNm", "_CrrierAgtCtry", "_PortOfDschrge", "_MstrNm", "_SeaCrrierNm"]
	@property
	def ChrtrrNm(self):
	...
	def ChrtrrNm(self, value):
		self._ChrtrrNm = value if type(value) != base_types.auto else self.make_default("ChrtrrNm")
	...
	def VygNb(self, value):
		self._VygNb = value if type(value) != base_types.auto else self.make_default("VygNb")
	...
	def IMONb(self, value):
		self._IMONb = value if type(value) != base_types.auto else self.make_default("IMONb")
	...
	def MstrNm(self, value):
		self._MstrNm = value if type(value) != base_types.auto else self.make_default("MstrNm")
