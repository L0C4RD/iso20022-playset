...
class AggregateBalanceInformation45(base_types._BaseFieldType):
	...
	__slots__ = ["_InstrmCcyAmts", "_FinInstrmId", "_CorpActnOptnTp", "_AcctBaseCcyAmts", "_FXDtls", "_BalBrkdwn", "_AddtlDerivAttrbts", "_BalAtSfkpgPlc", "_QtyBrkdwn", "_SfkpgPlc", "_InvstmtFndsFinInstrmAttrbts", "_HldgAddtlDtls", "_FinInstrmAttrbts", "_AddtlBalBrkdwn", "_DaysAcrd", "_AggtBal", "_AltrnRptgCcyAmts", "_SplmtryData", "_PricDtls"]
	@property
