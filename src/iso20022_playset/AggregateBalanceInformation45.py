...
class AggregateBalanceInformation45(base_types._BaseFieldType):
	...
	__slots__ = ["_BalBrkdwn", "_InvstmtFndsFinInstrmAttrbts", "_InstrmCcyAmts", "_BalAtSfkpgPlc", "_QtyBrkdwn", "_AcctBaseCcyAmts", "_AggtBal", "_FXDtls", "_PricDtls", "_DaysAcrd", "_AddtlBalBrkdwn", "_SplmtryData", "_AddtlDerivAttrbts", "_AltrnRptgCcyAmts", "_FinInstrmId", "_HldgAddtlDtls", "_SfkpgPlc", "_FinInstrmAttrbts", "_CorpActnOptnTp"]
	@property
	def BalBrkdwn(self):
