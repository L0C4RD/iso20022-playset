...
from .TaxType1Choice import TaxType1Choice
from .ExemptionReason1Choice import ExemptionReason1Choice
from .TaxCalculationInformation11 import TaxCalculationInformation11

class Tax38(base_types._BaseFieldType):

	__slots__ = ["_XmptnInd", "_RcptId", "_TaxClctnDtls", "_Amt", "_Bsis", "_XmptnRsn", "_Ctry", "_Tp"]
	@property
	def XmptnInd(self):
