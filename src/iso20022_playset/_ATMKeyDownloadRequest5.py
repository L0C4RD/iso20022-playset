...
from . import SecurityParameters9
...
class ATMKeyDownloadRequest5(base_types._BaseFieldType):
	...
	def ATMSctyParams(self, value):
		self._ATMSctyParams = value if value is not None else base_types.UninitialisedField(self, 'ATMSctyParams', SecurityParameters9, False)

	@ATMSctyParams.deleter
	def ATMSctyParams(self):
		del self._ATMSctyParams
		self._ATMSctyParams = base_types.UninitialisedField(self, 'ATMSctyParams', SecurityParameters9, False)
