...
from . import InvestigationData18
from . import InvestigationStatus2
from . import Max35Text
from . import Party40Choice

class InvestigationResponse23(base_types._BaseFieldType):
	...
	def InvstgtnData(self, value):
		self._InvstgtnData = value if value is not None else base_types.UninitialisedField(self, 'InvstgtnData', InvestigationData18, True)

	@InvstgtnData.deleter
	def InvstgtnData(self):
		del self._InvstgtnData
		self._InvstgtnData = base_types.UninitialisedField(self, 'InvstgtnData', InvestigationData18, True)
	...
	_field_defs = frozenset((
		base_types.FieldEntry(name='InvstgtnData', type=InvestigationData18, min=0, max=None, mutex_group=None, array=True),
