...
from .TransactionIdentifications37 import TransactionIdentifications37
from .PartyIdentification156 import PartyIdentification156
from .SupplementaryData1 import SupplementaryData1
from .TransactionDetails158 import TransactionDetails158
...
class SecuritiesSettlementTransactionModificationRequestStatusAdvice002V06(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctOwnr", "_ModReqRef", "_TxDtls", "_ModPrcgSts", "_TxId", "_SplmtryData", "_SfkpgAcct", "_BlckChainAdrOrWllt"]
	@property
	def AcctOwnr(self):
