...
class SettlementReportingResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Sndr", "_SttlmInstn", "_Hdr", "_AddtlData", "_Rcncltn", "_Dstn", "_TxDesc", "_PrtctdData", "_RtrvlRefNb", "_LifeCyclId", "_TrnsmssnDtTm", "_FI", "_OrgnlRspnCd", "_SttlmSvc", "_Rcvr", "_Jursdctn", "_SplmtryData", "_OthrInstn", "_Orgtr", "_PrcgRslt", "_SctyTrlr", "_Prgrmm", "_AddtlFee", "_SysTracAudtNb"]
	@property
	def Sndr(self):
		return self._Sndr
