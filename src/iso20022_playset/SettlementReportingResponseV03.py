...
class SettlementReportingResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlRspnCd", "_Prgrmm", "_SctyTrlr", "_TrnsmssnDtTm", "_PrcgRslt", "_OthrInstn", "_Orgtr", "_AddtlData", "_LifeCyclId", "_SttlmInstn", "_TxDesc", "_Jursdctn", "_AddtlFee", "_FI", "_Dstn", "_SplmtryData", "_Hdr", "_Sndr", "_SysTracAudtNb", "_RtrvlRefNb", "_SttlmSvc", "_PrtctdData", "_Rcvr", "_Rcncltn"]
	@property
