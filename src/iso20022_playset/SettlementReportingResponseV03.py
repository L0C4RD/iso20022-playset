...
class SettlementReportingResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Sndr", "_Prgrmm", "_SttlmSvc", "_SysTracAudtNb", "_SttlmInstn", "_OthrInstn", "_OrgnlRspnCd", "_Rcvr", "_FI", "_PrcgRslt", "_Rcncltn", "_Dstn", "_AddtlData", "_Jursdctn", "_LifeCyclId", "_RtrvlRefNb", "_SctyTrlr", "_Hdr", "_TrnsmssnDtTm", "_TxDesc", "_AddtlFee", "_PrtctdData", "_SplmtryData", "_Orgtr"]
	@property
	def Sndr(self):
		return self._Sndr
