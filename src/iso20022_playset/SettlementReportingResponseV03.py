...
class SettlementReportingResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Jursdctn", "_SplmtryData", "_AddtlData", "_Orgtr", "_Hdr", "_SttlmSvc", "_OthrInstn", "_FI", "_SysTracAudtNb", "_OrgnlRspnCd", "_RtrvlRefNb", "_Sndr", "_TrnsmssnDtTm", "_Dstn", "_PrcgRslt", "_SttlmInstn", "_TxDesc", "_Rcncltn", "_Rcvr", "_SctyTrlr", "_Prgrmm", "_PrtctdData", "_LifeCyclId", "_AddtlFee"]
	@property
	def Jursdctn(self):
