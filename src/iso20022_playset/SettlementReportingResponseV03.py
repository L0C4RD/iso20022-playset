...
class SettlementReportingResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Hdr", "_Dstn", "_PrtctdData", "_SysTracAudtNb", "_TxDesc", "_Rcvr", "_Jursdctn", "_Sndr", "_RtrvlRefNb", "_SttlmInstn", "_OthrInstn", "_TrnsmssnDtTm", "_AddtlFee", "_OrgnlRspnCd", "_Rcncltn", "_SplmtryData", "_AddtlData", "_SttlmSvc", "_LifeCyclId", "_Prgrmm", "_Orgtr", "_FI", "_SctyTrlr", "_PrcgRslt"]
	@property
	def Hdr(self):
		return self._Hdr
