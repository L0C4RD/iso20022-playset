...
class Identification30(base_types._BaseFieldType):
	...
	__slots__ = ["_MstrId", "_AcctSvcrTxId", "_BsktId", "_IndxId", "_AcctOwnrTxId", "_CmonId", "_UnqTxIdr", "_PoolId", "_CtrPtyMktInfrstrctrTxId", "_TradId", "_PrgmId", "_PrcrTxId", "_CorpActnEvtId", "_MktInfrstrctrTxId", "_ListId"]
	@property
	def MstrId(self):
		return self._MstrId
