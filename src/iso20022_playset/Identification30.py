...
class Identification30(base_types._BaseFieldType):
	...
	__slots__ = ["_CmonId", "_MstrId", "_PrcrTxId", "_ListId", "_BsktId", "_CtrPtyMktInfrstrctrTxId", "_UnqTxIdr", "_CorpActnEvtId", "_TradId", "_IndxId", "_PrgmId", "_AcctOwnrTxId", "_MktInfrstrctrTxId", "_PoolId", "_AcctSvcrTxId"]
	@property
	def CmonId(self):
		return self._CmonId
