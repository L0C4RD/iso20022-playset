...
class Identification30(base_types._BaseFieldType):
	...
	__slots__ = ["_UnqTxIdr", "_TradId", "_AcctOwnrTxId", "_MktInfrstrctrTxId", "_IndxId", "_CorpActnEvtId", "_PrcrTxId", "_PrgmId", "_ListId", "_MstrId", "_CmonId", "_AcctSvcrTxId", "_CtrPtyMktInfrstrctrTxId", "_BsktId", "_PoolId"]
	@property
	def UnqTxIdr(self):
