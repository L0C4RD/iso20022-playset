...
class Identification30(base_types._BaseFieldType):
	...
	__slots__ = ["_PoolId", "_IndxId", "_PrgmId", "_MstrId", "_PrcrTxId", "_MktInfrstrctrTxId", "_TradId", "_CmonId", "_AcctOwnrTxId", "_UnqTxIdr", "_ListId", "_AcctSvcrTxId", "_BsktId", "_CorpActnEvtId", "_CtrPtyMktInfrstrctrTxId"]
	@property
	def PoolId(self):
		return self._PoolId
