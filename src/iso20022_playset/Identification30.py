...
class Identification30(base_types._BaseFieldType):
	...
	__slots__ = ["_IndxId", "_TradId", "_PrcrTxId", "_AcctSvcrTxId", "_UnqTxIdr", "_PoolId", "_MstrId", "_ListId", "_CorpActnEvtId", "_PrgmId", "_BsktId", "_CtrPtyMktInfrstrctrTxId", "_CmonId", "_AcctOwnrTxId", "_MktInfrstrctrTxId"]
	@property
	def IndxId(self):
		return self._IndxId
