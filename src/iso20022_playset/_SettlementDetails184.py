...
class SettlementDetails184(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmTxCond", "_HldInd", "_MktClntSd", "_SttlmSysMtd", "_RpTp", "_StmpDtyTaxBsis", "_NetgElgblty", "_BnfclOwnrsh", "_PrtlSttlmInd", "_SctiesRTGS", "_CCPElgblty", "_CshClrSys", "_Regn", "_LttrOfGrnt", "_TaxCpcty", "_SttlgCpcty", "_LglRstrctns", "_BlckTrad"]
	@property
	def BlckTrad(self):
