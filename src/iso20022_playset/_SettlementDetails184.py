...
class SettlementDetails184(base_types._BaseFieldType):
	...
	__slots__ = ["_LglRstrctns", "_SctiesRTGS", "_SttlmTxCond", "_LttrOfGrnt", "_BnfclOwnrsh", "_TaxCpcty", "_RpTp", "_Regn", "_PrtlSttlmInd", "_CshClrSys", "_SttlgCpcty", "_BlckTrad", "_StmpDtyTaxBsis", "_SttlmSysMtd", "_MktClntSd", "_CCPElgblty", "_NetgElgblty", "_HldInd"]
	@property
