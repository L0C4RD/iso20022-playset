...
from . import CorporateActionEventReference4Choice
...
class CorporateActionEventReference4(base_types._BaseFieldType):
	...
	def EvtId(self, value):
		self._EvtId = value if value is not None else base_types.UninitialisedField(self, 'EvtId', CorporateActionEventReference4Choice, False)

	@EvtId.deleter
	def EvtId(self):
		del self._EvtId
		self._EvtId = base_types.UninitialisedField(self, 'EvtId', CorporateActionEventReference4Choice, False)
