...
class EstimatedFundCashForecast6(base_types._BaseFieldType):
	...
	__slots__ = ["_InvstmtCcy", "_EstmtdTtlUnitsNb", "_EstmtdPctgOfShrClssTtlNAV", "_PrvsTtlUnitsNb", "_EstmtdCshOutFcstDtls", "_FinInstrmDtls", "_Id", "_Pric", "_EstmtdNetCshFcstDtls", "_EstmtdTtlNAVChngRate", "_PrvsTtlNAV", "_PrvsTradDtTm", "_EstmtdCshInFcstDtls", "_CcySts", "_EstmtdTtlNAV", "_FXRate", "_XcptnlNetCshFlowInd", "_TradDtTm"]
	@property
	def InvstmtCcy(self):
