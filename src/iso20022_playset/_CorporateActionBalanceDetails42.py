...
class CorporateActionBalanceDetails42(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlElgblBal", "_TradDtPosBal", "_RegdBal", "_BrrwdBal", "_PdgDlvryBal", "_CollInBal", "_InTrnsShipmntBal", "_SttlmPosBal", "_StrtPosBal", "_PdgRctBal", "_OutForRegnBal", "_BlckdBal", "_OnLnBal", "_CollOutBal"]
	@property
