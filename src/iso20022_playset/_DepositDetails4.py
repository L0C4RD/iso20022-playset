...
from ._CardDepositType2Code import CardDepositType2Code
from ._CreditDebit3Code import CreditDebit3Code
from ._ImpliedCurrencyAndAmount import ImpliedCurrencyAndAmount

class DepositDetails4(base_types._BaseFieldType):
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='Tp', type=CardDepositType2Code, min=1, max=1, mutex_group=None, array=False),
	))