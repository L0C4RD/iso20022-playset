...
class Transfer36(base_types._BaseFieldType):
	...
	__slots__ = ["_FinInstrmDtls", "_TrfOrdrDtForm", "_TrfRsn", "_TrfRef", "_CtrPtyRef", "_BizFlowTp", "_AvrgPric", "_Rndg", "_TrfExpnssPmtTp", "_OwnAcctTrfInd", "_OrgnlCost", "_TrfCcy", "_UnitsDtls", "_Qty", "_ReqdTrfDt", "_ClntRef", "_ReqdSttlmDt", "_NonStdSttlmInf", "_HldgsPlanTp"]
	@property
