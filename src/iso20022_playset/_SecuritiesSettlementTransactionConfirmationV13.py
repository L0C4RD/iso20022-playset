...
from . import AdditionalParameters29
...
from . import SettlementDetails221
...
class SecuritiesSettlementTransactionConfirmationV13(base_types._BaseFieldType):

	__slots__ = ["_AddtlParams", "_AddtlPhysOrRegnDtls", "_CshPties", "_DgtlPmtSttlm", "_DlvrgSttlmPties", "_FinInstrmAttrbts", "_FinInstrmId", "_Lnkgs", "_OthrAmts", "_OthrBizPties", "_QtyAndAcctDtls", "_RcvgSttlmPties", "_SplmtryData", "_StgSttlmInstrDtls", "_SttldAmt", "_SttlmParams", "_TradDtls", "_TxIdDtls"]
	@property
	...
	def AddtlParams(self, value):
		self._AddtlParams = value if value is not None else base_types.UninitialisedField(self, 'AddtlParams', AdditionalParameters29, False)

	@AddtlParams.deleter
	def AddtlParams(self):
		del self._AddtlParams
		self._AddtlParams = base_types.UninitialisedField(self, 'AddtlParams', AdditionalParameters29, False)
	...
	def Lnkgs(self, value):
		self._Lnkgs = value if value is not None else base_types.UninitialisedField(self, 'Lnkgs', Linkages41, False)

	@Lnkgs.deleter
	def Lnkgs(self):
		del self._Lnkgs
		self._Lnkgs = base_types.UninitialisedField(self, 'Lnkgs', Linkages41, False)
	...
	def SttlmParams(self, value):
		self._SttlmParams = value if value is not None else base_types.UninitialisedField(self, 'SttlmParams', SettlementDetails221, False)

	@SttlmParams.deleter
	def SttlmParams(self):
		del self._SttlmParams
		self._SttlmParams = base_types.UninitialisedField(self, 'SttlmParams', SettlementDetails221, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='SttlmParams', type=SettlementDetails221, min=1, max=1, mutex_group=None, array=False),
