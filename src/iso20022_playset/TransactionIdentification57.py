...
class TransactionIdentification57(base_types._BaseFieldType):
	...
	__slots__ = ["_LifeCyclSpprt", "_AssoctdDataDstn", "_PresntmntSeqCnt", "_AssoctdDataRef", "_OthrPurchsIdrTp", "_TmZone", "_PresntmntSeqNb", "_AuthntcnTkn", "_RtrvlRefNb", "_SysTracAudtNb", "_AssoctdData", "_AcqrrRefNb", "_IssrRefData", "_LifeCyclIdMssng", "_LclDt", "_PurchsIdrTp", "_TrnsmssnDtTm", "_AcqrrRefData", "_LifeCyclId", "_AuthstnSeqNb", "_PurchsIdr", "_LclTm"]
	@property
