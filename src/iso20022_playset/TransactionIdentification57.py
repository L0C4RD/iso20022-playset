...
class TransactionIdentification57(base_types._BaseFieldType):
	...
	__slots__ = ["_PresntmntSeqCnt", "_LclDt", "_RtrvlRefNb", "_AssoctdDataDstn", "_AssoctdData", "_AuthstnSeqNb", "_PurchsIdrTp", "_LclTm", "_IssrRefData", "_AuthntcnTkn", "_LifeCyclId", "_TmZone", "_PurchsIdr", "_AcqrrRefNb", "_AcqrrRefData", "_LifeCyclSpprt", "_OthrPurchsIdrTp", "_LifeCyclIdMssng", "_PresntmntSeqNb", "_AssoctdDataRef", "_TrnsmssnDtTm", "_SysTracAudtNb"]
	@property
