...
from . import CardPaymentTransaction148
from . import CardPaymentTransactionDetails54
...
class PaymentTransaction183(base_types._BaseFieldType):

	__slots__ = ["_AddtlSvc", "_AddtlTxData", "_AuthstnRslt", "_CardPrgrmmApld", "_CardPrgrmmPropsd", "_CstmrCnsnt", "_CstmrOrdr", "_CstmrTkn", "_IssrCITId", "_IssrRefData", "_LastTxFlg", "_MrchntCITId", "_MrchntCtgyCd", "_MrchntRefData", "_MsgFrMrchnt", "_OrgnlTx", "_PmtInstrm", "_PmtTpInf", "_RcncltnId", "_SaleRefId", "_SaleToAcqrrData", "_SaleToIssrData", "_SaleToPOIData", "_SvcAttr", "_TxCaptr", "_TxDtls", "_TxId", "_TxTp"]
	@property
	def AddtlSvc(self):
	...
	def OrgnlTx(self, value):
		self._OrgnlTx = value if value is not None else base_types.UninitialisedField(self, 'OrgnlTx', CardPaymentTransaction148, False)

	@OrgnlTx.deleter
	def OrgnlTx(self):
		del self._OrgnlTx
		self._OrgnlTx = base_types.UninitialisedField(self, 'OrgnlTx', CardPaymentTransaction148, False)
	...
	def TxDtls(self, value):
		self._TxDtls = value if value is not None else base_types.UninitialisedField(self, 'TxDtls', CardPaymentTransactionDetails54, False)

	@TxDtls.deleter
	def TxDtls(self):
		del self._TxDtls
		self._TxDtls = base_types.UninitialisedField(self, 'TxDtls', CardPaymentTransactionDetails54, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='OrgnlTx', type=CardPaymentTransaction148, min=0, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='TxDtls', type=CardPaymentTransactionDetails54, min=1, max=1, mutex_group=None, array=False),
