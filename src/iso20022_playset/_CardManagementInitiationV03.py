...
class CardManagementInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_XchgRate", "_Cntxt", "_ICCRltdData", "_PrcgRslt", "_SctyTrlr", "_Hdr", "_CstmrDvc", "_ConvsDtTm", "_Crdhldr", "_Issr", "_AddtlAmt", "_SttlmSvc", "_Rcncltn", "_Tkn", "_Orgtr", "_Accptr", "_Wllt", "_AcctFr", "_PrtctdData", "_SplmtryData", "_AcctTo", "_Termnl", "_TxChrtcs", "_Prgrmm", "_Card", "_Acqrr", "_TxId", "_StrngCstmrAuthntcn", "_Vrfctn", "_AddtlData", "_Rcvr", "_Sndr", "_Dstn", "_OrgnlDataElmts", "_POICmpnt", "_AddtlSvc", "_Jursdctn", "_Rsk", "_TxAmts", "_NewPINData", "_AddtlFee"]
	@property
	def XchgRate(self):
	...
	def NewPINData(self, value):
		self._NewPINData = value if type(value) != base_types.auto else self.make_default("NewPINData")
