...
class CardManagementInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlDataElmts", "_Orgtr", "_AcctTo", "_ConvsDtTm", "_TxAmts", "_Accptr", "_Tkn", "_Crdhldr", "_PrcgRslt", "_TxChrtcs", "_POICmpnt", "_Prgrmm", "_Cntxt", "_AddtlSvc", "_Jursdctn", "_Rcvr", "_PrtctdData", "_AcctFr", "_XchgRate", "_SttlmSvc", "_ICCRltdData", "_SctyTrlr", "_TxId", "_SplmtryData", "_Issr", "_Acqrr", "_Hdr", "_CstmrDvc", "_Wllt", "_AddtlFee", "_Termnl", "_Rsk", "_Sndr", "_StrngCstmrAuthntcn", "_Rcncltn", "_Card", "_AddtlData", "_AddtlAmt", "_Dstn", "_NewPINData", "_Vrfctn"]
	@property
