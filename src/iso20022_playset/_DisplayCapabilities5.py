...
from . import UserInterface5Code
...
class DisplayCapabilities5(base_types._BaseFieldType):
	...
	@Dstn.setter
	def Dstn(self, value):
		self._Dstn = value if value is not None else base_types.UninitialisedField(self, 'Dstn', UserInterface5Code, True)

	@Dstn.deleter
	def Dstn(self):
		del self._Dstn
		self._Dstn = base_types.UninitialisedField(self, 'Dstn', UserInterface5Code, True)
