...
class InvestmentAccountOwnershipInformation17(base_types._BaseFieldType):
	...
	__slots__ = ["_TaxRptg", "_AddtlRgltryInf", "_TaxXmptn", "_CtrlgPty", "_AddtlInf", "_Lang", "_Pty", "_MailTp", "_ScndryComAdr", "_Ntfctn", "_MntryWlth", "_ClntId", "_FATCAFormTp", "_MiFIDClssfctn", "_OwnrshBnfcryRate", "_MnyLndrgChck", "_FATCASts", "_CRSFormTp", "_OthrId", "_SgntryRghtInd", "_ElctrncMlngSvcRef", "_CRSRptgDt", "_CpnyLk", "_AcctgSts", "_EqtyVal", "_CRSSts", "_CtryAndResdtlSts", "_PmryComAdr", "_ModfdInvstrPrflVldtn", "_FATCARptgDt", "_WorkgCptl", "_FsclXmptn"]
	@property
	def TaxRptg(self):
