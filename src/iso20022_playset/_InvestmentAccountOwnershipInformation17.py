...
class InvestmentAccountOwnershipInformation17(base_types._BaseFieldType):
	...
	__slots__ = ["_PmryComAdr", "_SgntryRghtInd", "_Pty", "_TaxXmptn", "_WorkgCptl", "_ModfdInvstrPrflVldtn", "_FsclXmptn", "_CRSSts", "_AddtlRgltryInf", "_Ntfctn", "_FATCAFormTp", "_MnyLndrgChck", "_MntryWlth", "_OwnrshBnfcryRate", "_CRSFormTp", "_ScndryComAdr", "_Lang", "_AddtlInf", "_CtrlgPty", "_EqtyVal", "_ElctrncMlngSvcRef", "_FATCASts", "_CtryAndResdtlSts", "_AcctgSts", "_MiFIDClssfctn", "_CRSRptgDt", "_FATCARptgDt", "_CpnyLk", "_MailTp", "_OthrId", "_ClntId", "_TaxRptg"]
	@property
	def PmryComAdr(self):
