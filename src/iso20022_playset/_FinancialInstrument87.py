...
class FinancialInstrument87(base_types._BaseFieldType):
	...
	__slots__ = ["_ClssTp", "_Pldgg", "_DstrbtnPlcy", "_FndOwnrsh", "_ThrdPtyRghts", "_OprlSts", "_BlckdHldgDtls", "_FndIntntn", "_PdctGrp", "_SctiesForm", "_Nm", "_SplmtryId", "_Coll", "_Id", "_ShrtNm"]
	@property
	def ClssTp(self):
		return self._ClssTp
