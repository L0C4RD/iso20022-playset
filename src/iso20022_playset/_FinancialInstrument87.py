...
class FinancialInstrument87(base_types._BaseFieldType):
	...
	__slots__ = ["_SctiesForm", "_Nm", "_BlckdHldgDtls", "_OprlSts", "_ShrtNm", "_SplmtryId", "_Id", "_ThrdPtyRghts", "_ClssTp", "_Pldgg", "_Coll", "_FndOwnrsh", "_PdctGrp", "_FndIntntn", "_DstrbtnPlcy"]
	@property
	def SctiesForm(self):
