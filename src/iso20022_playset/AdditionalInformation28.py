...
class AdditionalInformation28(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctOwnrTxId", "_FctvDt", "_CutOffDt", "_FinInstrmId", "_XpryDt", "_RcvgPty1", "_BlckChainAdrOrWllt", "_DlvrgPty1", "_Qty", "_TxSbjtToBuyIn", "_Invstr", "_SfkpgAcct", "_ClssfctnTp"]
	@property
