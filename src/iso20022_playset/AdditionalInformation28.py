...
class AdditionalInformation28(base_types._BaseFieldType):
	...
	__slots__ = ["_CutOffDt", "_Qty", "_AcctOwnrTxId", "_FctvDt", "_BlckChainAdrOrWllt", "_Invstr", "_XpryDt", "_TxSbjtToBuyIn", "_ClssfctnTp", "_DlvrgPty1", "_RcvgPty1", "_SfkpgAcct", "_FinInstrmId"]
	@property
	def CutOffDt(self):
