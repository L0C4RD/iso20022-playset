...
class AdditionalInformation28(base_types._BaseFieldType):
	...
	__slots__ = ["_RcvgPty1", "_Invstr", "_ClssfctnTp", "_SfkpgAcct", "_CutOffDt", "_DlvrgPty1", "_XpryDt", "_AcctOwnrTxId", "_FctvDt", "_BlckChainAdrOrWllt", "_FinInstrmId", "_TxSbjtToBuyIn", "_Qty"]
	@property
	def RcvgPty1(self):
