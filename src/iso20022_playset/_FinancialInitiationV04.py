...
class FinancialInitiationV04(base_types._BaseFieldType):
	...
	__slots__ = ["_XchgRate", "_ICCRltdData", "_PrcgRslt", "_SctyTrlr", "_Pyee", "_TxId", "_Hdr", "_CstmrDvc", "_ConvsDtTm", "_Crdhldr", "_Issr", "_AddtlAmt", "_SttlmSvc", "_Rcncltn", "_Tkn", "_Orgtr", "_Wllt", "_PrtctdData", "_AcctFr", "_Instlmt", "_DpstDtls", "_SplmtryData", "_Cstmr", "_OrgnlTx", "_AcctTo", "_Termnl", "_Pyer", "_Prgrmm", "_TxAmts", "_AcctBal", "_Card", "_Acqrr", "_OrgnlDataElmts", "_StrngCstmrAuthntcn", "_Vrfctn", "_AddtlData", "_Rcvr", "_Sndr", "_DsptData", "_SpclPrgrmmQlfctn", "_FndsSvcs", "_Dstn", "_Accptr", "_TxChrtcs", "_POICmpnt", "_AddtlSvc", "_AdddmData", "_Jursdctn", "_Rsk", "_Dcmnttn", "_Cntxt", "_AddtlFee"]
	@property
	def XchgRate(self):
