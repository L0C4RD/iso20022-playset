...
class FinancialInitiationV04(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctFr", "_TxChrtcs", "_AddtlAmt", "_OrgnlDataElmts", "_Accptr", "_Termnl", "_Sndr", "_AcctBal", "_AdddmData", "_AddtlData", "_DsptData", "_AddtlFee", "_Pyee", "_FndsSvcs", "_Vrfctn", "_Rcncltn", "_ConvsDtTm", "_Crdhldr", "_POICmpnt", "_Cstmr", "_Pyer", "_CstmrDvc", "_Rsk", "_PrcgRslt", "_Orgtr", "_XchgRate", "_Card", "_Acqrr", "_ICCRltdData", "_Dstn", "_DpstDtls", "_Instlmt", "_Prgrmm", "_OrgnlTx", "_Issr", "_Jursdctn", "_Hdr", "_StrngCstmrAuthntcn", "_AcctTo", "_Tkn", "_SctyTrlr", "_Rcvr", "_TxId", "_Cntxt", "_SttlmSvc", "_Dcmnttn", "_TxAmts", "_PrtctdData", "_AddtlSvc", "_SpclPrgrmmQlfctn", "_Wllt", "_SplmtryData"]
	@property
	def Accptr(self):
		return self._Accptr
