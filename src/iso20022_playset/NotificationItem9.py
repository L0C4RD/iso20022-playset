...
class NotificationItem9(base_types._BaseFieldType):
	...
	__slots__ = ["_UETR", "_UndrlygAllcn", "_Dbtr", "_RltdAcct", "_Amt", "_RltdRmtInf", "_DbtrAgt", "_Purp", "_AcctOwnr", "_Acct", "_IntrmyAgt", "_Id", "_EndToEndId", "_XpctdValDt", "_RmtInf", "_AcctSvcr"]
	@property
	def UETR(self):
		return self._UETR
