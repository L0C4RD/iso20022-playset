...
class NotificationItem9(base_types._BaseFieldType):
	...
	__slots__ = ["_EndToEndId", "_AcctSvcr", "_IntrmyAgt", "_XpctdValDt", "_Purp", "_Dbtr", "_RltdAcct", "_Acct", "_UETR", "_RltdRmtInf", "_Id", "_UndrlygAllcn", "_DbtrAgt", "_RmtInf", "_Amt", "_AcctOwnr"]
	@property
	def EndToEndId(self):
