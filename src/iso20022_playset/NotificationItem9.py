...
class NotificationItem9(base_types._BaseFieldType):
	...
	__slots__ = ["_UndrlygAllcn", "_RltdRmtInf", "_AcctOwnr", "_Amt", "_XpctdValDt", "_Id", "_RltdAcct", "_IntrmyAgt", "_Purp", "_RmtInf", "_UETR", "_EndToEndId", "_AcctSvcr", "_DbtrAgt", "_Acct", "_Dbtr"]
	@property
