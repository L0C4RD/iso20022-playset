...
class NotificationItem9(base_types._BaseFieldType):
	...
	__slots__ = ["_RltdAcct", "_AcctOwnr", "_Id", "_UETR", "_XpctdValDt", "_UndrlygAllcn", "_Amt", "_RltdRmtInf", "_DbtrAgt", "_Acct", "_EndToEndId", "_IntrmyAgt", "_RmtInf", "_AcctSvcr", "_Purp", "_Dbtr"]
	@property
	def RltdAcct(self):
