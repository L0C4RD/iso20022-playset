...
class ChargeBackResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlData", "_SctyTrlr", "_Hdr", "_OrgnlTxAmts", "_Orgtr", "_Accptr", "_Sndr", "_Termnl", "_DsptData", "_Dcmnttn", "_Jursdctn", "_Rcvr", "_Card", "_TxChrtcs", "_PrcgRslt", "_Prgrmm", "_TxAmts", "_AddtlFee", "_Acqrr", "_Dstn", "_SttlmSvc", "_PrtctdData", "_Rcncltn", "_Issr", "_SplmtryData", "_ConvsDtTm", "_Tkn", "_Cntxt", "_TxId"]
	@property
	def AddtlData(self):
