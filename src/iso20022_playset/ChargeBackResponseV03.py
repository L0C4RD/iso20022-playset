...
class ChargeBackResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Sndr", "_DsptData", "_TxId", "_TxAmts", "_Hdr", "_AddtlData", "_Tkn", "_Rcncltn", "_Dstn", "_PrtctdData", "_Accptr", "_Acqrr", "_Dcmnttn", "_Issr", "_OrgnlTxAmts", "_SttlmSvc", "_TxChrtcs", "_Rcvr", "_Jursdctn", "_Termnl", "_SplmtryData", "_Orgtr", "_Card", "_SctyTrlr", "_ConvsDtTm", "_Prgrmm", "_AddtlFee", "_Cntxt", "_PrcgRslt"]
	@property
	def Sndr(self):
		return self._Sndr
