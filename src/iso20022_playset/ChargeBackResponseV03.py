...
class ChargeBackResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Card", "_ConvsDtTm", "_TxAmts", "_TxChrtcs", "_Tkn", "_Prgrmm", "_Acqrr", "_SctyTrlr", "_Orgtr", "_Cntxt", "_AddtlData", "_AddtlFee", "_Jursdctn", "_Issr", "_DsptData", "_PrcgRslt", "_Dstn", "_Termnl", "_Accptr", "_OrgnlTxAmts", "_SplmtryData", "_TxId", "_Hdr", "_Sndr", "_SttlmSvc", "_Dcmnttn", "_PrtctdData", "_Rcvr", "_Rcncltn"]
	@property
	def Card(self):
		return self._Card
