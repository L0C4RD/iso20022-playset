...
class ChargeBackResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Jursdctn", "_SplmtryData", "_TxAmts", "_Accptr", "_AddtlData", "_ConvsDtTm", "_Orgtr", "_OrgnlTxAmts", "_Hdr", "_SttlmSvc", "_Card", "_Acqrr", "_Sndr", "_Cntxt", "_Tkn", "_Dstn", "_TxId", "_Termnl", "_TxChrtcs", "_Rcncltn", "_Rcvr", "_SctyTrlr", "_Dcmnttn", "_Issr", "_Prgrmm", "_PrtctdData", "_PrcgRslt", "_AddtlFee", "_DsptData"]
	@property
	def Jursdctn(self):
