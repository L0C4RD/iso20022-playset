...
from . import FinancialInstitutionIdentification7
...
class BranchAndFinancialInstitutionIdentification4(base_types._BaseFieldType):
	...
	def FinInstnId(self, value):
		self._FinInstnId = value if value is not None else base_types.UninitialisedField(self, 'FinInstnId', FinancialInstitutionIdentification7, False)

	@FinInstnId.deleter
	def FinInstnId(self):
		del self._FinInstnId
		self._FinInstnId = base_types.UninitialisedField(self, 'FinInstnId', FinancialInstitutionIdentification7, False)
