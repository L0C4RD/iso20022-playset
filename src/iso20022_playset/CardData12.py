...
class CardData12(base_types._BaseFieldType):
	...
	__slots__ = ["_FctvDt", "_PdctSubTp", "_CardSeqNb", "_PrtflIdr", "_Trck3", "_PANAcctRg", "_PAN", "_PdctTp", "_XpryDt", "_Ctry", "_PmtAcctRef", "_PANFourLastDgts", "_AddtlData", "_Ccy", "_PrtctdPAN"]
	@property
	def FctvDt(self):
		return self._FctvDt
