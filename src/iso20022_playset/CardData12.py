...
class CardData12(base_types._BaseFieldType):
	...
	__slots__ = ["_PmtAcctRef", "_XpryDt", "_Ctry", "_PrtctdPAN", "_Trck3", "_PAN", "_PANAcctRg", "_PANFourLastDgts", "_CardSeqNb", "_PrtflIdr", "_AddtlData", "_FctvDt", "_PdctSubTp", "_PdctTp", "_Ccy"]
	@property
	def PmtAcctRef(self):
