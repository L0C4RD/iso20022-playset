...
class CardData12(base_types._BaseFieldType):
	...
	__slots__ = ["_FctvDt", "_PAN", "_PrtctdPAN", "_Trck3", "_XpryDt", "_PmtAcctRef", "_PANAcctRg", "_Ctry", "_PdctSubTp", "_PrtflIdr", "_CardSeqNb", "_Ccy", "_AddtlData", "_PANFourLastDgts", "_PdctTp"]
	@property
	def FctvDt(self):
		return self._FctvDt
