...
class CardData12(base_types._BaseFieldType):
	...
	__slots__ = ["_Ctry", "_FctvDt", "_Ccy", "_CardSeqNb", "_PrtflIdr", "_PdctSubTp", "_PrtctdPAN", "_XpryDt", "_PmtAcctRef", "_PdctTp", "_PANFourLastDgts", "_AddtlData", "_Trck3", "_PANAcctRg", "_PAN"]
	@property
	def Ctry(self):
		return self._Ctry
