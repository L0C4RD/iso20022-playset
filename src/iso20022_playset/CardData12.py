...
class CardData12(base_types._BaseFieldType):
	...
	__slots__ = ["_Trck3", "_PrtctdPAN", "_PANAcctRg", "_XpryDt", "_FctvDt", "_Ccy", "_PANFourLastDgts", "_PmtAcctRef", "_PrtflIdr", "_PdctSubTp", "_PAN", "_Ctry", "_CardSeqNb", "_PdctTp", "_AddtlData"]
	@property
	def Trck3(self):
		return self._Trck3
