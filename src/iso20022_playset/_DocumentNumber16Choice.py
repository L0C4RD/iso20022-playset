...
from . import GenericIdentification163
...
class DocumentNumber16Choice(base_types._BaseFieldType):
	...
	def PrtryNb(self, value):
		self._PrtryNb = value if value is not None else base_types.UninitialisedField(self, 'PrtryNb', GenericIdentification163, False)

	@PrtryNb.deleter
	def PrtryNb(self):
		del self._PrtryNb
		self._PrtryNb = base_types.UninitialisedField(self, 'PrtryNb', GenericIdentification163, False)
