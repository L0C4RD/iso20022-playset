...
class FinancialInstrument96(base_types._BaseFieldType):
	...
	__slots__ = ["_TermntnDt", "_SspnsnEndDt", "_MtrtyDt", "_ClsdEndFnd", "_FndEndDt", "_DmtrlsdRegdScties", "_TaxEffcntPdctElgbl", "_PhysBrScties", "_LnchDt", "_RinvstmtFrqcy", "_DvddFrqcy", "_PrfrmncFee", "_Authrsd", "_Equlstn", "_MgmtFeeSrc", "_InitlOfferEndDt", "_SspnsnStartDt", "_PhysRegdScties", "_RDRCmplnt", "_DmtrlsdBrScties", "_DvddPlcy", "_EUSvgsDrctv", "_MayBeTermntdEarly", "_AddtlInf", "_DstrbtnPlcy", "_BckEndLd", "_SwtchFee", "_FrntEndLd"]
	@property
	def TermntnDt(self):
