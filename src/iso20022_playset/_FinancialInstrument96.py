...
class FinancialInstrument96(base_types._BaseFieldType):
	...
	__slots__ = ["_EUSvgsDrctv", "_LnchDt", "_Equlstn", "_RinvstmtFrqcy", "_Authrsd", "_TaxEffcntPdctElgbl", "_DvddFrqcy", "_ClsdEndFnd", "_DmtrlsdBrScties", "_SspnsnStartDt", "_InitlOfferEndDt", "_MayBeTermntdEarly", "_TermntnDt", "_FrntEndLd", "_PhysRegdScties", "_SwtchFee", "_MgmtFeeSrc", "_DmtrlsdRegdScties", "_DstrbtnPlcy", "_BckEndLd", "_PhysBrScties", "_FndEndDt", "_MtrtyDt", "_PrfrmncFee", "_AddtlInf", "_SspnsnEndDt", "_DvddPlcy", "_RDRCmplnt"]
	@property
