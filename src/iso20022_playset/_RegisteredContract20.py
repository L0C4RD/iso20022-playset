...
class RegisteredContract20(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlCtrctRegnReq", "_Amdmnt", "_Dlvry", "_Submissn", "_RptgPty", "_PmtSchdlTp", "_CtrctBal", "_RegdCtrctJrnl", "_PrvsRegdCtrctId", "_IntrCpnyLn", "_RegnAgt", "_EstmtdDtInd", "_Ctrct", "_AddtlInf", "_IssrFI", "_RegdCtrctId", "_LnPrncplAmt", "_SplmtryData"]
	@property
	def AddtlInf(self):
