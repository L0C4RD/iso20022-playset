...
class ClearingSystemMemberIdentification2Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_USCH", "_USFW", "_ATBLZ", "_HKNCC", "_ZANCC", "_INIFSC", "_USCHU", "_IENSC", "_PTNCC", "_NZNCC", "_ESNCC", "_DEBLZ", "_PLKNR", "_AUBSBs", "_AUBSBx", "_CACPA", "_ITNCC", "_OthrClrCdId", "_GBSC", "_CHBC", "_GRHEBIC", "_CHSIC", "_RUCB"]
	@property
	def USCH(self):
		return self._USCH
