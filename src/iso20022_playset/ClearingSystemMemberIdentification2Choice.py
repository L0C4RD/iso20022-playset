...
class ClearingSystemMemberIdentification2Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_GRHEBIC", "_USCHU", "_DEBLZ", "_CHSIC", "_CACPA", "_PLKNR", "_INIFSC", "_IENSC", "_HKNCC", "_AUBSBs", "_USCH", "_USFW", "_GBSC", "_NZNCC", "_ESNCC", "_OthrClrCdId", "_RUCB", "_CHBC", "_ZANCC", "_ATBLZ", "_PTNCC", "_AUBSBx", "_ITNCC"]
	@property
	def GRHEBIC(self):
