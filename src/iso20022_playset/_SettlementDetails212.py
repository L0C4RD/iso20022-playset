...
class SettlementDetails212(base_types._BaseFieldType):
	...
	__slots__ = ["_NetgElgblty", "_ElgblForColl", "_HldInd", "_LttrOfGrnt", "_RpTp", "_SctiesRTGS", "_CshClrSys", "_BnfclOwnrsh", "_DlvryRtrRsn", "_RtrLeg", "_ModCxlAllwd", "_LglRstrctns", "_FxStgInstr", "_SctiesSubBalTp", "_MktClntSd", "_TaxCpcty", "_SttlmSysMtd", "_SttlmTxCond", "_Trckg", "_SctiesTxTp", "_Regn", "_XpsrTp", "_PrtlSttlmInd", "_CshSubBalTp", "_SttlgCpcty", "_BlckTrad", "_CCPElgblty", "_StmpDtyTaxBsis", "_AutomtcBrrwg", "_Prty"]
	@property
