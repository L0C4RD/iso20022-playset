...
from ._SettlementTransactionCondition29Choice import SettlementTransactionCondition29Choice

class SettlementDetails212(base_types._BaseFieldType):

	__slots__ = ["_DlvryRtrRsn", "_HldInd", "_RpTp", "_SctiesRTGS", "_SttlmTxCond", "_ElgblForColl", "_MktClntSd", "_SttlgCpcty", "_AutomtcBrrwg", "_ModCxlAllwd", "_Prty", "_FxStgInstr", "_LglRstrctns", "_Regn", "_SctiesSubBalTp", "_PrtlSttlmInd", "_StmpDtyTaxBsis", "_CCPElgblty", "_SctiesTxTp", "_NetgElgblty", "_XpsrTp", "_LttrOfGrnt", "_TaxCpcty", "_CshSubBalTp", "_BlckTrad", "_BnfclOwnrsh", "_CshClrSys", "_RtrLeg", "_Trckg", "_SttlmSysMtd"]
	@property
