...
class SettlementDetails212(base_types._BaseFieldType):
	...
	__slots__ = ["_LttrOfGrnt", "_HldInd", "_SttlmSysMtd", "_SttlmTxCond", "_BlckTrad", "_ModCxlAllwd", "_Prty", "_CCPElgblty", "_NetgElgblty", "_Trckg", "_CshSubBalTp", "_AutomtcBrrwg", "_DlvryRtrRsn", "_SttlgCpcty", "_TaxCpcty", "_SctiesTxTp", "_XpsrTp", "_PrtlSttlmInd", "_CshClrSys", "_SctiesSubBalTp", "_StmpDtyTaxBsis", "_LglRstrctns", "_BnfclOwnrsh", "_SctiesRTGS", "_RpTp", "_Regn", "_ElgblForColl", "_FxStgInstr", "_RtrLeg", "_MktClntSd"]
	@property
	def LttrOfGrnt(self):
