...
class StatusReportDataSetRequest6(base_types._BaseFieldType):
	...
	@Cntt.setter
	def Cntt(self, value):
		self._Cntt = value if value is not None else base_types.UninitialisedField(self, 'Cntt', StatusReportContent14, False)

	@Cntt.deleter
	def Cntt(self):
		del self._Cntt
		self._Cntt = base_types.UninitialisedField(self, 'Cntt', StatusReportContent14, False)
