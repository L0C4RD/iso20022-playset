...
class Trade8(base_types._BaseFieldType):
	...
	__slots__ = ["_ClrMtd", "_SttlmCcy", "_FXTradPdct", "_Symb", "_PdctId", "_TradgMtd", "_SwpLeg", "_DlvryTp", "_PlcOfConf", "_FXDtls", "_TradId", "_TradDt", "_TradgCcy", "_AssoctdTradRef", "_TradgMd"]
	@property
	def ClrMtd(self):
		return self._ClrMtd
