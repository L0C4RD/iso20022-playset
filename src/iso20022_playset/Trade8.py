...
class Trade8(base_types._BaseFieldType):
	...
	__slots__ = ["_DlvryTp", "_TradDt", "_TradgCcy", "_ClrMtd", "_FXDtls", "_PdctId", "_SttlmCcy", "_TradgMd", "_SwpLeg", "_TradId", "_Symb", "_TradgMtd", "_PlcOfConf", "_AssoctdTradRef", "_FXTradPdct"]
	@property
	def DlvryTp(self):
