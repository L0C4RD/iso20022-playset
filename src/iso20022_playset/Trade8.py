...
class Trade8(base_types._BaseFieldType):
	...
	__slots__ = ["_ClrMtd", "_SttlmCcy", "_Symb", "_TradDt", "_DlvryTp", "_TradId", "_TradgMtd", "_PdctId", "_TradgCcy", "_TradgMd", "_FXDtls", "_SwpLeg", "_AssoctdTradRef", "_FXTradPdct", "_PlcOfConf"]
	@property
	def ClrMtd(self):
		return self._ClrMtd
