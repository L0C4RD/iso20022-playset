...
class Trade8(base_types._BaseFieldType):
	...
	__slots__ = ["_DlvryTp", "_PdctId", "_FXTradPdct", "_TradId", "_Symb", "_TradgCcy", "_TradgMtd", "_TradgMd", "_PlcOfConf", "_SwpLeg", "_FXDtls", "_AssoctdTradRef", "_TradDt", "_ClrMtd", "_SttlmCcy"]
	@property
	def DlvryTp(self):
