...
class Trade8(base_types._BaseFieldType):
	...
	__slots__ = ["_SwpLeg", "_DlvryTp", "_SttlmCcy", "_ClrMtd", "_Symb", "_PdctId", "_TradgMtd", "_TradDt", "_FXDtls", "_AssoctdTradRef", "_TradgCcy", "_TradgMd", "_FXTradPdct", "_PlcOfConf", "_TradId"]
	@property
	def SwpLeg(self):
		return self._SwpLeg
