...
class Trade8(base_types._BaseFieldType):
	...
	__slots__ = ["_Symb", "_AssoctdTradRef", "_TradgMtd", "_FXTradPdct", "_DlvryTp", "_ClrMtd", "_PdctId", "_TradId", "_TradDt", "_FXDtls", "_TradgMd", "_SwpLeg", "_TradgCcy", "_SttlmCcy", "_PlcOfConf"]
	@property
	def Symb(self):
		return self._Symb
