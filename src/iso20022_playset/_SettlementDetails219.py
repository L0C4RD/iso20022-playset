...
from . import DeliveryReturn3Choice
...
from . import RepurchaseType23Choice
from . import Restriction5Choice
from . import SecuritiesRTGS4Choice
from . import SecuritiesTransactionType47Choice
from . import SettlementSystemMethod4Choice
from . import SettlementTransactionCondition33Choice
...
class SettlementDetails219(base_types._BaseFieldType):
	...
	def DlvrgSctiesSubBalTp(self, value):
		self._DlvrgSctiesSubBalTp = value if value is not None else base_types.UninitialisedField(self, 'DlvrgSctiesSubBalTp', GenericIdentification30, False)

	@DlvrgSctiesSubBalTp.deleter
	def DlvrgSctiesSubBalTp(self):
		del self._DlvrgSctiesSubBalTp
		self._DlvrgSctiesSubBalTp = base_types.UninitialisedField(self, 'DlvrgSctiesSubBalTp', GenericIdentification30, False)
	...
	def DlvryRtrRsn(self, value):
		self._DlvryRtrRsn = value if value is not None else base_types.UninitialisedField(self, 'DlvryRtrRsn', DeliveryReturn3Choice, False)

	@DlvryRtrRsn.deleter
	def DlvryRtrRsn(self):
		del self._DlvryRtrRsn
		self._DlvryRtrRsn = base_types.UninitialisedField(self, 'DlvryRtrRsn', DeliveryReturn3Choice, False)
	...
	def RcvgSctiesSubBalTp(self, value):
		self._RcvgSctiesSubBalTp = value if value is not None else base_types.UninitialisedField(self, 'RcvgSctiesSubBalTp', GenericIdentification30, False)

	@RcvgSctiesSubBalTp.deleter
	def RcvgSctiesSubBalTp(self):
		del self._RcvgSctiesSubBalTp
		self._RcvgSctiesSubBalTp = base_types.UninitialisedField(self, 'RcvgSctiesSubBalTp', GenericIdentification30, False)
	...
	@RpTp.setter
	def RpTp(self, value):
		self._RpTp = value if value is not None else base_types.UninitialisedField(self, 'RpTp', RepurchaseType23Choice, False)

	@RpTp.deleter
	def RpTp(self):
		del self._RpTp
		self._RpTp = base_types.UninitialisedField(self, 'RpTp', RepurchaseType23Choice, False)
	...
	def SctiesTxTp(self, value):
		self._SctiesTxTp = value if value is not None else base_types.UninitialisedField(self, 'SctiesTxTp', SecuritiesTransactionType47Choice, False)

	@SctiesTxTp.deleter
	def SctiesTxTp(self):
		del self._SctiesTxTp
		self._SctiesTxTp = base_types.UninitialisedField(self, 'SctiesTxTp', SecuritiesTransactionType47Choice, False)
	...
	def SttlmTxCond(self, value):
		self._SttlmTxCond = value if value is not None else base_types.UninitialisedField(self, 'SttlmTxCond', SettlementTransactionCondition33Choice, True)

	@SttlmTxCond.deleter
	def SttlmTxCond(self):
		del self._SttlmTxCond
		self._SttlmTxCond = base_types.UninitialisedField(self, 'SttlmTxCond', SettlementTransactionCondition33Choice, True)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='RpTp', type=RepurchaseType23Choice, min=0, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='SctiesTxTp', type=SecuritiesTransactionType47Choice, min=1, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='SttlmTxCond', type=SettlementTransactionCondition33Choice, min=0, max=None, mutex_group=None, array=True),
