...
class CorporateAction87(base_types._BaseFieldType):
	...
	__slots__ = ["_DtDtls", "_LtryTp", "_FrftrOfIntrstInd", "_RateAndAmtDtls", "_ShrhldrRghtsDrctvInd", "_PricDtls", "_AddtlInf", "_AccptncPrtyLvl", "_OfferTp", "_SctiesQty", "_IntrmdtSctiesDstrbtnTp", "_LttrOfGrntedDlvryInd", "_IntrstAcrdNbOfDays", "_CertfctnTp", "_ElctnTp", "_InfTp", "_EvtStag", "_CertfctnBrkdwnInd", "_EvtSeqTp", "_RnncblEntitlmntStsTp", "_TaxOnNonDstrbtdPrcdsInd", "_CptlGnInOutInd", "_AddtlBizPrcInd", "_ChngTp", "_DvddTp", "_CpnNb", "_CnsntTp", "_NewPlcOfIncorprtn", "_DtchAuctnTp", "_RstrctnInd", "_AcrdIntrstInd", "_PrdDtls", "_TaxblIncmPerShrClctd", "_ChrgsApldInd", "_OcrncTp"]
	@property
	def DtDtls(self):
		return self._DtDtls
