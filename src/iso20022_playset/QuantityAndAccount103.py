...
from .AmountAndDirection19 import AmountAndDirection19
...
class QuantityAndAccount103(base_types._BaseFieldType):
	...
	__slots__ = ["_SttldQty", "_AcctOwnr", "_CshAcct", "_PrevslySttldQty", "_BlckChainAdrOrWllt", "_PrevslySttldAmt", "_SfkpgPlc", "_RmngToBeSttldAmt", "_SfkpgAcct", "_RmngToBeSttldQty"]
	@property
	def SttldQty(self):
