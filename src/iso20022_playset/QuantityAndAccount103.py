...
import AmountAndDirection19
import Quantity54Choice

class QuantityAndAccount103(base_types._BaseFieldType):

	__slots__ = ["_RmngToBeSttldQty", "_PrevslySttldQty", "_SttldQty", "_RmngToBeSttldAmt", "_CshAcct", "_BlckChainAdrOrWllt", "_PrevslySttldAmt", "_AcctOwnr", "_SfkpgPlc", "_SfkpgAcct"]
	@property
