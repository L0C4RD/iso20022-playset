...
from . import ProcessingStatus101Choice
from . import SettlementStatus30Choice
from . import SupplementaryData1
from . import TransactionDetails177
from . import TransactionIdentifications47

class SecuritiesSettlementTransactionStatusAdviceV14(base_types._BaseFieldType):
	...
	def PrcgSts(self, value):
		self._PrcgSts = value if value is not None else base_types.UninitialisedField(self, 'PrcgSts', ProcessingStatus101Choice, False)

	@PrcgSts.deleter
	def PrcgSts(self):
		del self._PrcgSts
		self._PrcgSts = base_types.UninitialisedField(self, 'PrcgSts', ProcessingStatus101Choice, False)
	...
	def TxDtls(self, value):
		self._TxDtls = value if value is not None else base_types.UninitialisedField(self, 'TxDtls', TransactionDetails177, False)

	@TxDtls.deleter
	def TxDtls(self):
		del self._TxDtls
		self._TxDtls = base_types.UninitialisedField(self, 'TxDtls', TransactionDetails177, False)
	...
	@TxId.setter
	def TxId(self, value):
		self._TxId = value if value is not None else base_types.UninitialisedField(self, 'TxId', TransactionIdentifications47, False)

	@TxId.deleter
	def TxId(self):
		del self._TxId
		self._TxId = base_types.UninitialisedField(self, 'TxId', TransactionIdentifications47, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='PrcgSts', type=ProcessingStatus101Choice, min=0, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='TxDtls', type=TransactionDetails177, min=0, max=1, mutex_group=None, array=False),
