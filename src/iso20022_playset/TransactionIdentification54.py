...
class TransactionIdentification54(base_types._BaseFieldType):
	...
	__slots__ = ["_LifeCyclSpprt", "_PresntmntSeqCnt", "_OthrPurchsIdrTp", "_TmZone", "_PresntmntSeqNb", "_AuthntcnTkn", "_RtrvlRefNb", "_SysTracAudtNb", "_AcqrrRefNb", "_IssrRefData", "_LifeCyclIdMssng", "_LclDt", "_PurchsIdrTp", "_TrnsmssnDtTm", "_AcqrrRefData", "_LifeCyclId", "_AuthstnSeqNb", "_PurchsIdr", "_LclTm"]
	@property
