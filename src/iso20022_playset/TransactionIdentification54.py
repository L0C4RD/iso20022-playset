...
class TransactionIdentification54(base_types._BaseFieldType):
	...
	__slots__ = ["_SysTracAudtNb", "_AcqrrRefData", "_TrnsmssnDtTm", "_LifeCyclSpprt", "_RtrvlRefNb", "_LclTm", "_TmZone", "_LclDt", "_LifeCyclIdMssng", "_PurchsIdrTp", "_OthrPurchsIdrTp", "_PresntmntSeqCnt", "_PurchsIdr", "_LifeCyclId", "_IssrRefData", "_PresntmntSeqNb", "_AcqrrRefNb", "_AuthntcnTkn", "_AuthstnSeqNb"]
	@property
