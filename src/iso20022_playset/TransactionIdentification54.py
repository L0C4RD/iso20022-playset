...
class TransactionIdentification54(base_types._BaseFieldType):
	...
	__slots__ = ["_PurchsIdrTp", "_TmZone", "_OthrPurchsIdrTp", "_RtrvlRefNb", "_LifeCyclId", "_AcqrrRefNb", "_PresntmntSeqCnt", "_LifeCyclIdMssng", "_AuthstnSeqNb", "_AcqrrRefData", "_AuthntcnTkn", "_PresntmntSeqNb", "_SysTracAudtNb", "_IssrRefData", "_LifeCyclSpprt", "_LclDt", "_TrnsmssnDtTm", "_LclTm", "_PurchsIdr"]
	@property
