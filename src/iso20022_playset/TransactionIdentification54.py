...
class TransactionIdentification54(base_types._BaseFieldType):
	...
	__slots__ = ["_PresntmntSeqCnt", "_LclDt", "_RtrvlRefNb", "_PurchsIdrTp", "_AuthstnSeqNb", "_LclTm", "_IssrRefData", "_AuthntcnTkn", "_LifeCyclId", "_TmZone", "_PurchsIdr", "_AcqrrRefNb", "_AcqrrRefData", "_LifeCyclSpprt", "_OthrPurchsIdrTp", "_LifeCyclIdMssng", "_PresntmntSeqNb", "_TrnsmssnDtTm", "_SysTracAudtNb"]
	@property
