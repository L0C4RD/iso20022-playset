...
class RegisteredContract20(base_types._BaseFieldType):
	...
	__slots__ = ["_Ctrct", "_LnPrncplAmt", "_OrgnlCtrctRegnReq", "_CtrctBal", "_RegdCtrctId", "_Dlvry", "_PrvsRegdCtrctId", "_RptgPty", "_EstmtdDtInd", "_PmtSchdlTp", "_IntrCpnyLn", "_IssrFI", "_AddtlInf", "_Amdmnt", "_RegdCtrctJrnl", "_SplmtryData", "_Submissn", "_RegnAgt"]
	@property
	def Ctrct(self):
		return self._Ctrct
