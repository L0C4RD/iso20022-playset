...
class TransactionReferences6(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctOwnrTxId", "_MsgId", "_InstrId", "_PrcgId", "_EndToEndId", "_AcctSvcrTxId", "_Prtry", "_ClrSysRef", "_MktInfrstrctrTxId", "_AcctSvcrRef", "_MndtId", "_PmtInfId", "_ChqNb", "_UETR", "_TxId"]
	@property
