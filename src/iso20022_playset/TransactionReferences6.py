...
class TransactionReferences6(base_types._BaseFieldType):
	...
	__slots__ = ["_MndtId", "_PmtInfId", "_ClrSysRef", "_ChqNb", "_UETR", "_EndToEndId", "_MktInfrstrctrTxId", "_AcctSvcrRef", "_Prtry", "_InstrId", "_TxId", "_MsgId", "_AcctSvcrTxId", "_AcctOwnrTxId", "_PrcgId"]
	@property
	def MndtId(self):
		return self._MndtId
