...
class TransactionReferences6(base_types._BaseFieldType):
	...
	__slots__ = ["_MsgId", "_AcctSvcrTxId", "_PrcgId", "_UETR", "_EndToEndId", "_ChqNb", "_ClrSysRef", "_MktInfrstrctrTxId", "_AcctOwnrTxId", "_InstrId", "_PmtInfId", "_Prtry", "_AcctSvcrRef", "_MndtId", "_TxId"]
	@property
	def MsgId(self):
		return self._MsgId
