...
class TaxVoucher1(base_types._BaseFieldType):
	...
	__slots__ = ["_CshAmtCrrdFwd", "_NetAmt", "_NtnlDvddPybl", "_TaxCdt", "_BrgnSttlmDt", "_FXDtls", "_RcrdDtHldg", "_ScripDvddRinvstmtPricPerShr", "_ComssnAmt", "_BrgnDt", "_TaxDdctn", "_StmpDtyAmt", "_WhldgTaxAmt", "_NtnlTax", "_AlltdShrsCost", "_TaxVchrRate", "_GrssAmt", "_TaxCdtRate", "_WhldgTaxRate", "_ChrgAmt", "_CshAmtBrghtFwd"]
	@property
