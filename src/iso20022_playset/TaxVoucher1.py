...
class TaxVoucher1(base_types._BaseFieldType):
	...
	__slots__ = ["_NtnlDvddPybl", "_TaxVchrRate", "_TaxCdt", "_CshAmtCrrdFwd", "_NtnlTax", "_BrgnDt", "_WhldgTaxRate", "_FXDtls", "_AlltdShrsCost", "_CshAmtBrghtFwd", "_BrgnSttlmDt", "_NetAmt", "_ScripDvddRinvstmtPricPerShr", "_TaxDdctn", "_TaxCdtRate", "_WhldgTaxAmt", "_StmpDtyAmt", "_ChrgAmt", "_ComssnAmt", "_RcrdDtHldg", "_GrssAmt"]
	@property
