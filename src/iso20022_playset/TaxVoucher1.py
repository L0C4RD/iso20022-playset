...
class TaxVoucher1(base_types._BaseFieldType):
	...
	__slots__ = ["_TaxCdt", "_BrgnDt", "_TaxVchrRate", "_WhldgTaxAmt", "_TaxCdtRate", "_BrgnSttlmDt", "_ChrgAmt", "_StmpDtyAmt", "_NetAmt", "_NtnlTax", "_ScripDvddRinvstmtPricPerShr", "_FXDtls", "_WhldgTaxRate", "_AlltdShrsCost", "_CshAmtBrghtFwd", "_GrssAmt", "_NtnlDvddPybl", "_TaxDdctn", "_CshAmtCrrdFwd", "_RcrdDtHldg", "_ComssnAmt"]
	@property
	def TaxCdt(self):
		return self._TaxCdt
