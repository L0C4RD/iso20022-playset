...
class TaxVoucher1(base_types._BaseFieldType):
	...
	__slots__ = ["_NetAmt", "_NtnlDvddPybl", "_FXDtls", "_CshAmtCrrdFwd", "_AlltdShrsCost", "_TaxVchrRate", "_NtnlTax", "_RcrdDtHldg", "_BrgnSttlmDt", "_BrgnDt", "_TaxCdtRate", "_TaxCdt", "_ScripDvddRinvstmtPricPerShr", "_GrssAmt", "_WhldgTaxRate", "_TaxDdctn", "_ComssnAmt", "_StmpDtyAmt", "_WhldgTaxAmt", "_ChrgAmt", "_CshAmtBrghtFwd"]
	@property
	def NetAmt(self):
		return self._NetAmt
