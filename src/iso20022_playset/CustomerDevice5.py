...
class CustomerDevice5(base_types._BaseFieldType):
	...
	__slots__ = ["_GeogcLctn", "_Email", "_Prvdr", "_Tp", "_Lang", "_DvcNmNrmlzd", "_OprgSysTp", "_OprgSysId", "_IPAdr", "_LctnCtryCd", "_OprgSysBld", "_Manfctr", "_OthrTp", "_Phne", "_OprgSysVrsn", "_OthrOprgSysTp", "_ManfctrMdlId", "_DvcNm", "_AddtlData", "_DvcId"]
	@property
	def GeogcLctn(self):
