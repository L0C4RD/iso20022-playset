...
class CustomerDevice5(base_types._BaseFieldType):
	...
	__slots__ = ["_Lang", "_LctnCtryCd", "_IPAdr", "_DvcNm", "_DvcId", "_AddtlData", "_OprgSysVrsn", "_DvcNmNrmlzd", "_Manfctr", "_Phne", "_OprgSysTp", "_OthrOprgSysTp", "_Prvdr", "_ManfctrMdlId", "_OthrTp", "_OprgSysId", "_OprgSysBld", "_Email", "_GeogcLctn", "_Tp"]
	@property
	def Lang(self):
		return self._Lang
