...
from . import ATMMessageFunction1
...
class Header20(base_types._BaseFieldType):
	...
	def MsgFctn(self, value):
		self._MsgFctn = value if value is not None else base_types.UninitialisedField(self, 'MsgFctn', ATMMessageFunction1, False)

	@MsgFctn.deleter
	def MsgFctn(self):
		del self._MsgFctn
		self._MsgFctn = base_types.UninitialisedField(self, 'MsgFctn', ATMMessageFunction1, False)
