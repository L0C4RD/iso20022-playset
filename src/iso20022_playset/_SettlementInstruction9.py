...
class SettlementInstruction9(base_types._BaseFieldType):
	...
	def InstdRmbrsmntAgtAcct(self, value):
		self._InstdRmbrsmntAgtAcct = value if value is not None else base_types.UninitialisedField(self, 'InstdRmbrsmntAgtAcct', CashAccount38, False)

	@InstdRmbrsmntAgtAcct.deleter
	def InstdRmbrsmntAgtAcct(self):
		del self._InstdRmbrsmntAgtAcct
		self._InstdRmbrsmntAgtAcct = base_types.UninitialisedField(self, 'InstdRmbrsmntAgtAcct', CashAccount38, False)
	...
	def InstgRmbrsmntAgtAcct(self, value):
		self._InstgRmbrsmntAgtAcct = value if value is not None else base_types.UninitialisedField(self, 'InstgRmbrsmntAgtAcct', CashAccount38, False)

	@InstgRmbrsmntAgtAcct.deleter
	def InstgRmbrsmntAgtAcct(self):
		del self._InstgRmbrsmntAgtAcct
		self._InstgRmbrsmntAgtAcct = base_types.UninitialisedField(self, 'InstgRmbrsmntAgtAcct', CashAccount38, False)
	...
	def SttlmAcct(self, value):
		self._SttlmAcct = value if value is not None else base_types.UninitialisedField(self, 'SttlmAcct', CashAccount38, False)

	@SttlmAcct.deleter
	def SttlmAcct(self):
		del self._SttlmAcct
		self._SttlmAcct = base_types.UninitialisedField(self, 'SttlmAcct', CashAccount38, False)
	...
	def ThrdRmbrsmntAgtAcct(self, value):
		self._ThrdRmbrsmntAgtAcct = value if value is not None else base_types.UninitialisedField(self, 'ThrdRmbrsmntAgtAcct', CashAccount38, False)

	@ThrdRmbrsmntAgtAcct.deleter
	def ThrdRmbrsmntAgtAcct(self):
		del self._ThrdRmbrsmntAgtAcct
		self._ThrdRmbrsmntAgtAcct = base_types.UninitialisedField(self, 'ThrdRmbrsmntAgtAcct', CashAccount38, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='InstdRmbrsmntAgtAcct', type=CashAccount38, min=0, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='InstgRmbrsmntAgtAcct', type=CashAccount38, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='SttlmAcct', type=CashAccount38, min=0, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='ThrdRmbrsmntAgtAcct', type=CashAccount38, min=0, max=1, mutex_group=None, array=False),
	))