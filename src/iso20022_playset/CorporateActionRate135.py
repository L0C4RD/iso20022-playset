...
from .RateAndAmountFormat74Choice import RateAndAmountFormat74Choice
from .RateFormat25Choice import RateFormat25Choice
from .RateAndAmountFormat57Choice import RateAndAmountFormat57Choice
from .RateFormat12Choice import RateFormat12Choice
from .RateAndAmountFormat73Choice import RateAndAmountFormat73Choice
from .RateAndAmountFormat72Choice import RateAndAmountFormat72Choice
from .RateFormat24Choice import RateFormat24Choice

class CorporateActionRate135(base_types._BaseFieldType):

	__slots__ = ["_IntrstShrtfll", "_NxtFctr", "_RltdIndx", "_RinvstmtDscntRateToMkt", "_RealsdLoss", "_DclrdRate", "_IntrstRate", "_PctgSght", "_BidIntrvl", "_PrvsFctr", "_IndxFctr", "_Sprd"]
	@property
	...
	_field_defs = frozenset((
		base_types.FieldEntry(name='IntrstShrtfll', type=RateAndAmountFormat74Choice, min=0, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='RealsdLoss', type=RateAndAmountFormat74Choice, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='DclrdRate', type=RateAndAmountFormat74Choice, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='IntrstRate', type=RateAndAmountFormat72Choice, min=0, max=1, mutex_group=None, array=False),
