...
class AccountStatement14(base_types._BaseFieldType):
	...
	__slots__ = ["_Acct", "_StmtPgntn", "_TxsSummry", "_RptgSrc", "_RltdAcct", "_Bal", "_AddtlStmtInf", "_FrToDt", "_CpyDplctInd", "_Id", "_CreDtTm", "_LglSeqNb", "_ElctrncSeqNb", "_Intrst", "_Ntry", "_RptgSeq"]
	@property
	def Acct(self):
		return self._Acct
