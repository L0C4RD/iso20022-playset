...
class AccountStatement14(base_types._BaseFieldType):
	...
	__slots__ = ["_RltdAcct", "_Intrst", "_Id", "_Ntry", "_Acct", "_CpyDplctInd", "_StmtPgntn", "_LglSeqNb", "_CreDtTm", "_TxsSummry", "_RptgSeq", "_ElctrncSeqNb", "_FrToDt", "_RptgSrc", "_Bal", "_AddtlStmtInf"]
	@property
	def RltdAcct(self):
