...
class AccountStatement14(base_types._BaseFieldType):
	...
	__slots__ = ["_Ntry", "_LglSeqNb", "_Acct", "_CreDtTm", "_StmtPgntn", "_RltdAcct", "_ElctrncSeqNb", "_Bal", "_Id", "_FrToDt", "_TxsSummry", "_RptgSeq", "_CpyDplctInd", "_RptgSrc", "_Intrst", "_AddtlStmtInf"]
	@property
	def Ntry(self):
		return self._Ntry
