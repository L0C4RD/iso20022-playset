...
class AccountStatement14(base_types._BaseFieldType):
	...
	__slots__ = ["_Intrst", "_Acct", "_CpyDplctInd", "_TxsSummry", "_RptgSrc", "_CreDtTm", "_StmtPgntn", "_RptgSeq", "_RltdAcct", "_Bal", "_ElctrncSeqNb", "_AddtlStmtInf", "_Id", "_LglSeqNb", "_Ntry", "_FrToDt"]
	@property
	def Intrst(self):
		return self._Intrst
