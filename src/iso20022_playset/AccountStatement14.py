...
class AccountStatement14(base_types._BaseFieldType):
	...
	__slots__ = ["_CpyDplctInd", "_TxsSummry", "_RptgSrc", "_RptgSeq", "_AddtlStmtInf", "_LglSeqNb", "_Id", "_RltdAcct", "_Intrst", "_Bal", "_FrToDt", "_StmtPgntn", "_Acct", "_CreDtTm", "_ElctrncSeqNb", "_Ntry"]
	@property
