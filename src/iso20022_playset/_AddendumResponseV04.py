...
class AddendumResponseV04(base_types._BaseFieldType):

	__slots__ = ["_Accptr", "_Acqrr", "_AddtlFee", "_Card", "_Dstn", "_Hdr", "_Issr", "_Jursdctn", "_NtlData", "_OrgnlDataElmts", "_Orgtr", "_PrcgRslt", "_Prgrmm", "_PrtctdData", "_PrvtData", "_Rcncltn", "_Rcvr", "_SctyTrlr", "_Sndr", "_SttlmSvc", "_Tkn", "_TxDesc", "_TxId"]
	@property
	def Accptr(self):
		return self._Accptr
