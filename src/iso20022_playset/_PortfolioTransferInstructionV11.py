...
from .PortfolioTransfer11 import PortfolioTransfer11
...
class PortfolioTransferInstructionV11(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrCorpInvstr", "_PmryIndvInvstr", "_ScndryCorpInvstr", "_Trfee", "_PoolRef", "_PdctTrf", "_RltdRef", "_PrvsRef", "_MktPrctcVrsn", "_NmneeAcct", "_TrfrAcct", "_PmryCorpInvstr", "_MsgRef", "_OthrIndvInvstr", "_Xtnsn", "_ScndryIndvInvstr"]
	@property
