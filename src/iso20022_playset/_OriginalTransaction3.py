...
from .Terminal9 import Terminal9
from .ProgrammeMode4 import ProgrammeMode4
from .Reconciliation4 import Reconciliation4
from .OriginalTransactionCharacteristics1 import OriginalTransactionCharacteristics1
from .PartyIdentification286 import PartyIdentification286

class OriginalTransaction3(base_types._BaseFieldType):

	__slots__ = ["_XchgRate", "_Acqrr", "_Pyee", "_TxAmts", "_CstmrDvc", "_ConvsDtTm", "_Crdhldr", "_Issr", "_AddtlAmt", "_Card", "_Rcncltn", "_AddtlFee", "_Tkn", "_Orgtr", "_Vrfctn", "_Termnl", "_TxId", "_Wllt", "_AcctFr", "_DpstDtls", "_AcctTo", "_Accptr", "_Pyer", "_PrcgRslt", "_Cntxt", "_Prgrmm", "_Rcvr", "_Sndr", "_DsptData", "_SpclPrgrmmQlfctn", "_TxChrtcs", "_Dstn", "_FndsSvcs", "_POICmpnt", "_AddtlSvc", "_Jursdctn", "_Rsk", "_Dcmnttn", "_SttlmSvc"]
	@property
	def XchgRate(self):
