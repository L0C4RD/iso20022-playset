...
class OriginalTransaction3(base_types._BaseFieldType):
	...
	__slots__ = ["_Orgtr", "_AcctTo", "_ConvsDtTm", "_DsptData", "_Tkn", "_Crdhldr", "_POICmpnt", "_Card", "_Prgrmm", "_AddtlSvc", "_Jursdctn", "_Rcvr", "_SttlmSvc", "_AcctFr", "_XchgRate", "_Accptr", "_TxChrtcs", "_SpclPrgrmmQlfctn", "_Cntxt", "_Vrfctn", "_Issr", "_Pyer", "_CstmrDvc", "_FndsSvcs", "_Wllt", "_Termnl", "_Acqrr", "_TxId", "_AddtlFee", "_Rsk", "_Pyee", "_Sndr", "_Rcncltn", "_PrcgRslt", "_DpstDtls", "_Dcmnttn", "_AddtlAmt", "_TxAmts", "_Dstn"]
	@property
	def Orgtr(self):
		return self._Orgtr
