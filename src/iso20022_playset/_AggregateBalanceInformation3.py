...
class AggregateBalanceInformation3(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlBalBrkdwnDtls", "_BalAtSfkpgPlc", "_PricDtls", "_FXDtls", "_AcrdIntrstAmtSgn", "_SfkpgPlc", "_AcrdIntrstAmt", "_PrvsHldgVal", "_AggtQty", "_FinInstrmDtls", "_BalBrkdwnDtls", "_HldgVal", "_BookVal", "_DaysAcrd"]
	@property
