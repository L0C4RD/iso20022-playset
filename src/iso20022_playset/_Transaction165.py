...
from ._TransactionDetails186 import TransactionDetails186
from ._UTIIdentifier import UTIIdentifier

class Transaction165(base_types._BaseFieldType):
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='TxDtls', type=TransactionDetails186, min=0, max=1, mutex_group=None, array=False),
