...
class SettlementDetails174(base_types._BaseFieldType):
	...
	__slots__ = ["_RpTp", "_Regn", "_SctiesRTGS", "_BnfclOwnrsh", "_HldInd", "_SttlmTxCond", "_SctiesTxTp", "_MktClntSd", "_PrtlSttlmInd", "_StmpDtyTaxBsis", "_CshClrSys"]
	@property
	def RpTp(self):
		return self._RpTp
