...
from . import AlgorithmIdentification14
...
class EncryptedContent3(base_types._BaseFieldType):
	...
	def CnttNcrptnAlgo(self, value):
		self._CnttNcrptnAlgo = value if value is not None else base_types.UninitialisedField(self, 'CnttNcrptnAlgo', AlgorithmIdentification14, False)

	@CnttNcrptnAlgo.deleter
	def CnttNcrptnAlgo(self):
		del self._CnttNcrptnAlgo
		self._CnttNcrptnAlgo = base_types.UninitialisedField(self, 'CnttNcrptnAlgo', AlgorithmIdentification14, False)
