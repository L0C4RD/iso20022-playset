...
from . import CorporateActionEventAndBalance26
...
class AccountIdentification68(base_types._BaseFieldType):
	...
	def CorpActnEvtAndBal(self, value):
		self._CorpActnEvtAndBal = value if value is not None else base_types.UninitialisedField(self, 'CorpActnEvtAndBal', CorporateActionEventAndBalance26, True)

	@CorpActnEvtAndBal.deleter
	def CorpActnEvtAndBal(self):
		del self._CorpActnEvtAndBal
		self._CorpActnEvtAndBal = base_types.UninitialisedField(self, 'CorpActnEvtAndBal', CorporateActionEventAndBalance26, True)
