...
class LoanData143(base_types._BaseFieldType):
	...
	__slots__ = ["_TradgVn", "_IntrstRate", "_DlvryByVal", "_CollDlvryMtd", "_Term", "_ExctnDtTm", "_ClrSts", "_UnqTradIdr", "_UnitPric", "_TermntnDt", "_MstrAgrmt", "_EvtDt", "_PrncplAmt", "_ValDt", "_GnlColl"]
	@property
	def TradgVn(self):
