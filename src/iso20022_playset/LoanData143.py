...
class LoanData143(base_types._BaseFieldType):
	...
	__slots__ = ["_TradgVn", "_DlvryByVal", "_Term", "_ClrSts", "_ExctnDtTm", "_IntrstRate", "_UnqTradIdr", "_EvtDt", "_ValDt", "_GnlColl", "_CollDlvryMtd", "_PrncplAmt", "_MstrAgrmt", "_TermntnDt", "_UnitPric"]
	@property
	def TradgVn(self):
