...
class LoanData143(base_types._BaseFieldType):
	...
	__slots__ = ["_CollDlvryMtd", "_MstrAgrmt", "_IntrstRate", "_EvtDt", "_TradgVn", "_TermntnDt", "_Term", "_PrncplAmt", "_ExctnDtTm", "_UnqTradIdr", "_UnitPric", "_ValDt", "_GnlColl", "_DlvryByVal", "_ClrSts"]
	@property
