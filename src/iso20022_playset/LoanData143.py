...
class LoanData143(base_types._BaseFieldType):
	...
	__slots__ = ["_PrncplAmt", "_UnqTradIdr", "_IntrstRate", "_Term", "_ValDt", "_MstrAgrmt", "_ExctnDtTm", "_CollDlvryMtd", "_GnlColl", "_EvtDt", "_UnitPric", "_TradgVn", "_TermntnDt", "_ClrSts", "_DlvryByVal"]
	@property
	def PrncplAmt(self):
