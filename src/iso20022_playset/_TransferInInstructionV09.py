...
class TransferInInstructionV09(base_types._BaseFieldType):
	...
	def SttlmDtls(self, value):
		self._SttlmDtls = value if value is not None else base_types.UninitialisedField(self, 'SttlmDtls', DeliverInformation21, False)

	@SttlmDtls.deleter
	def SttlmDtls(self):
		del self._SttlmDtls
		self._SttlmDtls = base_types.UninitialisedField(self, 'SttlmDtls', DeliverInformation21, False)
	...
	def TrfDtls(self, value):
		self._TrfDtls = value if value is not None else base_types.UninitialisedField(self, 'TrfDtls', Transfer36, True)

	@TrfDtls.deleter
	def TrfDtls(self):
		del self._TrfDtls
		self._TrfDtls = base_types.UninitialisedField(self, 'TrfDtls', Transfer36, True)
