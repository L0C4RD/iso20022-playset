...
class CorporateActionOption243(base_types._BaseFieldType):
	...
	__slots__ = ["_PricDtls", "_RateAndAmtDtls", "_ShrhldrNb", "_CcyToBuy", "_ElgblForCollInd", "_ChngTp", "_SlctnDealrFeeInd", "_SctyId", "_ExctnReqdDtTm", "_CcyOptn", "_CcyToSell", "_OptnFeatrs", "_AddtlInf", "_SctiesQtyOrInstdAmt", "_FrctnDspstn", "_OptnTp", "_OptnNb"]
	@property
	def PricDtls(self):
