...
class CorporateActionOption243(base_types._BaseFieldType):
	...
	__slots__ = ["_SctyId", "_ElgblForCollInd", "_CcyOptn", "_ChngTp", "_AddtlInf", "_ExctnReqdDtTm", "_SlctnDealrFeeInd", "_RateAndAmtDtls", "_SctiesQtyOrInstdAmt", "_CcyToBuy", "_OptnNb", "_ShrhldrNb", "_FrctnDspstn", "_OptnFeatrs", "_CcyToSell", "_OptnTp", "_PricDtls"]
	@property
	def SctyId(self):
		return self._SctyId
