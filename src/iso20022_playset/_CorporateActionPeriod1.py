...
class CorporateActionPeriod1(base_types._BaseFieldType):
	...
	__slots__ = ["_ActnPrd", "_BlckgPrd", "_IntrstPrd", "_CmplsryPurchsPrd", "_PricClctnPrd"]
	@property
	def ActnPrd(self):
	...
	def BlckgPrd(self, value):
		self._BlckgPrd = value if type(value) != base_types.auto else self.make_default("BlckgPrd")
