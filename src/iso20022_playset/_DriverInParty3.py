...
class DriverInParty3(base_types._BaseFieldType):
	...
	__slots__ = ["_LicForm", "_LicCtry", "_Ctct", "_Nm", "_LicXprtnDt", "_DrvrCrdntl", "_LicCtrySubDvsnMnr", "_LicId", "_Age", "_LicTp", "_DtOfBirth", "_LicAssgnr", "_LicCtrySubDvsnMjr", "_LicOthrAuthrty", "_Adr", "_LicIssncDt"]
	@property
	def LicForm(self):
