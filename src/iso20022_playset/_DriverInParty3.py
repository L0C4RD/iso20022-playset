...
class DriverInParty3(base_types._BaseFieldType):
	...
	__slots__ = ["_LicIssncDt", "_LicForm", "_LicCtrySubDvsnMjr", "_LicAssgnr", "_DtOfBirth", "_LicCtry", "_LicId", "_LicOthrAuthrty", "_LicCtrySubDvsnMnr", "_Adr", "_DrvrCrdntl", "_Age", "_LicXprtnDt", "_LicTp", "_Ctct", "_Nm"]
	@property
	def LicIssncDt(self):
