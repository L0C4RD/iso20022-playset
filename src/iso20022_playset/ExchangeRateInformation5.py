...
class ExchangeRateInformation5(base_types._BaseFieldType):
	...
	__slots__ = ["_RateLckElgbl", "_BaseCcyCd", "_RateLckReqd", "_AgrmtTp", "_OthrRateTp", "_OthrEndPt", "_Tm", "_CntrCcyCd", "_Rate", "_RateTp", "_Id", "_Dt", "_RateLckApld", "_OthrAgrmtTp", "_EndPt", "_Prvdr"]
	@property
