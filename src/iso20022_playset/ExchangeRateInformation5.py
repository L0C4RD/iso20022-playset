...
class ExchangeRateInformation5(base_types._BaseFieldType):
	...
	__slots__ = ["_RateTp", "_Id", "_Prvdr", "_CntrCcyCd", "_RateLckElgbl", "_Tm", "_RateLckApld", "_OthrEndPt", "_Rate", "_OthrRateTp", "_EndPt", "_Dt", "_BaseCcyCd", "_OthrAgrmtTp", "_AgrmtTp", "_RateLckReqd"]
	@property
	def RateTp(self):
		return self._RateTp
