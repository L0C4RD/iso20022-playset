...
class ExchangeRateInformation5(base_types._BaseFieldType):
	...
	__slots__ = ["_Dt", "_OthrAgrmtTp", "_RateTp", "_AgrmtTp", "_CntrCcyCd", "_RateLckReqd", "_RateLckElgbl", "_OthrEndPt", "_EndPt", "_RateLckApld", "_Tm", "_OthrRateTp", "_Rate", "_BaseCcyCd", "_Id", "_Prvdr"]
	@property
	def Dt(self):
		return self._Dt
