...
from .StandingSettlementInstruction13 import StandingSettlementInstruction13
from .Order24 import Order24
...
from .FinancialInstrumentStipulations4 import FinancialInstrumentStipulations4
from .ConfirmationParties6 import ConfirmationParties6
from .TwoLegTransactionDetails5 import TwoLegTransactionDetails5
from .Linkages76 import Linkages76
from .Clearing5 import Clearing5
from .OtherPrices5 import OtherPrices5
from .AmountAndDirection28 import AmountAndDirection28
from .SettlementDetails213 import SettlementDetails213
from .TransactiontIdentification4 import TransactiontIdentification4
from .CashParties33 import CashParties33
from .SettlementParties59 import SettlementParties59
from .UnderlyingFinancialInstrument7 import UnderlyingFinancialInstrument7
from .RegulatoryStipulations1 import RegulatoryStipulations1
from .OtherParties32 import OtherParties32

class SecuritiesTradeConfirmationV05(base_types._BaseFieldType):

	__slots__ = ["_SplmtryData", "_ConfPties", "_Id", "_UndrlygFinInstrm", "_OthrBizPties", "_FinInstrmAttrbts", "_Refs", "_FinInstrmId", "_TwoLegTxDtls", "_ClrDtls", "_TradDtls", "_SttlmAmt", "_NbCnt", "_OthrPrics", "_CshPties", "_StgSttlmInstr", "_RgltryStiptns", "_Stiptns", "_OthrAmts", "_RcvgSttlmPties", "_DlvrgSttlmPties", "_SttlmParams"]
	@property
