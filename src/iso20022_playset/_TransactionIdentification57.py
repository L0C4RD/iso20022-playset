...
class TransactionIdentification57(base_types._BaseFieldType):
	...
	__slots__ = ["_AcqrrRefNb", "_LifeCyclSpprt", "_AuthstnSeqNb", "_RtrvlRefNb", "_AcqrrRefData", "_IssrRefData", "_AssoctdDataRef", "_AssoctdData", "_SysTracAudtNb", "_PresntmntSeqNb", "_LifeCyclIdMssng", "_AssoctdDataDstn", "_TmZone", "_LifeCyclId", "_PurchsIdr", "_LclTm", "_PresntmntSeqCnt", "_TrnsmssnDtTm", "_LclDt", "_OthrPurchsIdrTp", "_PurchsIdrTp", "_AuthntcnTkn"]
	@property
	def AcqrrRefNb(self):
