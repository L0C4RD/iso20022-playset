...
class InvoiceLineItem4(base_types._BaseFieldType):

	__slots__ = ["_AdjstmntAmt", "_AdjstmntCdtDbt", "_AdjstmntRsn", "_CdtDbt", "_CtrctNb", "_Desc", "_Dt", "_Insrnc", "_InsrncAmt", "_MdclSvcs", "_NtlData", "_OrdrDt", "_OthrUnitOfMeasr", "_PdctCd", "_PdctQlfr", "_PdctQty", "_PrvtData", "_Rbllg", "_ShipToIndstryCd", "_ShppgDt", "_Tax", "_TpOfSpply", "_TtlAmt", "_UnitOfMeasr", "_UnitPric", "_VATInvcRef", "_ZeroCostToCstmr"]
	@property
