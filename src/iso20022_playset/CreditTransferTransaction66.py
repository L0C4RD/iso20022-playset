...
import DirectDebitTransactionInformation33

class CreditTransferTransaction66(base_types._BaseFieldType):

	__slots__ = ["_CdtId", "_Cdtr", "_SplmtryData", "_CdtrAgtAcct", "_IntrmyAgt2Acct", "_IntrmyAgt2", "_IntrBkSttlmDt", "_InstdAgt", "_BtchBookg", "_InstrForCdtrAgt", "_UltmtCdtr", "_IntrmyAgt1Acct", "_TtlIntrBkSttlmAmt", "_IntrmyAgt3Acct", "_CdtrAcct", "_PmtTpInf", "_CdtrAgt", "_InstgAgt", "_IntrmyAgt3", "_IntrmyAgt1", "_DrctDbtTxInf", "_SttlmTmIndctn"]
	@property
	def CdtId(self):
		return self._CdtId
