...
class CreditTransferTransaction66(base_types._BaseFieldType):
	...
	__slots__ = ["_CdtrAcct", "_PmtTpInf", "_InstgAgt", "_IntrmyAgt3Acct", "_BtchBookg", "_IntrmyAgt1Acct", "_InstrForCdtrAgt", "_CdtrAgt", "_SttlmTmIndctn", "_IntrmyAgt1", "_IntrmyAgt2Acct", "_IntrmyAgt2", "_IntrBkSttlmDt", "_UltmtCdtr", "_DrctDbtTxInf", "_IntrmyAgt3", "_SplmtryData", "_CdtrAgtAcct", "_InstdAgt", "_CdtId", "_Cdtr", "_TtlIntrBkSttlmAmt"]
	@property
	def CdtrAcct(self):
