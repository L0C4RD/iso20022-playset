...
class CreditTransferTransaction66(base_types._BaseFieldType):
	...
	__slots__ = ["_IntrmyAgt2", "_IntrmyAgt3Acct", "_CdtrAgt", "_TtlIntrBkSttlmAmt", "_Cdtr", "_UltmtCdtr", "_IntrmyAgt1Acct", "_IntrmyAgt2Acct", "_SttlmTmIndctn", "_CdtrAgtAcct", "_InstrForCdtrAgt", "_IntrmyAgt1", "_DrctDbtTxInf", "_IntrmyAgt3", "_BtchBookg", "_CdtrAcct", "_InstdAgt", "_IntrBkSttlmDt", "_SplmtryData", "_CdtId", "_PmtTpInf", "_InstgAgt"]
	@property
	def IntrmyAgt2(self):
