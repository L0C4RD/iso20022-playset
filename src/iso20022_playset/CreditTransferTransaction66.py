...
from .DirectDebitTransactionInformation33 import DirectDebitTransactionInformation33
...
class CreditTransferTransaction66(base_types._BaseFieldType):
	...
	__slots__ = ["_DrctDbtTxInf", "_IntrmyAgt1Acct", "_IntrmyAgt2", "_UltmtCdtr", "_InstgAgt", "_TtlIntrBkSttlmAmt", "_SttlmTmIndctn", "_InstrForCdtrAgt", "_Cdtr", "_IntrmyAgt1", "_BtchBookg", "_IntrmyAgt3Acct", "_IntrBkSttlmDt", "_CdtrAcct", "_IntrmyAgt2Acct", "_CdtId", "_InstdAgt", "_CdtrAgt", "_SplmtryData", "_PmtTpInf", "_CdtrAgtAcct", "_IntrmyAgt3"]
	@property
	...
	def TtlIntrBkSttlmAmt(self, value):
		self._TtlIntrBkSttlmAmt = value if type(value) != auto else self.make_default("TtlIntrBkSttlmAmt")
	...
	def CdtId(self, value):
		self._CdtId = value if type(value) != auto else self.make_default("CdtId")
