...
class CreditTransferTransaction66(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlIntrBkSttlmAmt", "_UltmtCdtr", "_CdtrAgt", "_IntrmyAgt1", "_CdtrAgtAcct", "_SttlmTmIndctn", "_CdtrAcct", "_DrctDbtTxInf", "_IntrBkSttlmDt", "_InstdAgt", "_IntrmyAgt2", "_SplmtryData", "_PmtTpInf", "_IntrmyAgt3", "_Cdtr", "_InstrForCdtrAgt", "_IntrmyAgt3Acct", "_BtchBookg", "_InstgAgt", "_CdtId", "_IntrmyAgt2Acct", "_IntrmyAgt1Acct"]
	@property
	...
	def CdtId(self, value):
		self._CdtId = value if type(value) != base_types.auto else self.make_default("CdtId")
