...
class RetrievalFulfilmentResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Termnl", "_Sndr", "_AddtlData", "_AddtlFee", "_Pyee", "_Rcncltn", "_ConvsDtTm", "_PrcgRslt", "_Pyer", "_DsptData", "_RtrvlFlfmtInstrs", "_Orgtr", "_Acqrr", "_Dstn", "_TxId", "_Issr", "_Jursdctn", "_Cntxt", "_Hdr", "_Tkn", "_TxChrtcs", "_Prgrmm", "_SctyTrlr", "_Card", "_Rcvr", "_Accptr", "_SttlmSvc", "_PrtctdData", "_OrgnlRspnCd", "_SpclPrgrmmQlfctn", "_Wllt", "_SplmtryData"]
	@property
	def Accptr(self):
		return self._Accptr
