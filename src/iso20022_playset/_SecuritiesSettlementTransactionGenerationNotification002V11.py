...
from .Linkages68 import Linkages68
...
class SecuritiesSettlementTransactionGenerationNotification002V11(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_DlvrgSttlmPties", "_TxIdDtls", "_NbCounts", "_Lnkgs", "_GnrtdRsn", "_FinInstrmAttrbts", "_OthrBizPties", "_SttlmParams", "_AddtlPhysOrRegnDtls", "_RcvgSttlmPties", "_CshPties", "_OthrAmts", "_SttlmAmt", "_StsAndRsn", "_TradDtls", "_QtyAndAcctDtls", "_FinInstrmId"]
	@property
