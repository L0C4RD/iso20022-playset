...
from . import TransferCancellationStatusReportV07
...
class SESE_010_001_07():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def TrfCxlStsRpt(self, value):
			self._TrfCxlStsRpt = value if value is not None else base_types.UninitialisedField(self, 'TrfCxlStsRpt', TransferCancellationStatusReportV07, False)

		@TrfCxlStsRpt.deleter
		def TrfCxlStsRpt(self):
			del self._TrfCxlStsRpt
			self._TrfCxlStsRpt = base_types.UninitialisedField(self, 'TrfCxlStsRpt', TransferCancellationStatusReportV07, False)
