...
class OtherAmounts47(base_types._BaseFieldType):
	...
	__slots__ = ["_TradAmt", "_NtwkFee", "_TrfTax", "_LclTax", "_TxTax", "_RsrchFee", "_CtryNtlFdrlTax", "_RgltryAmt", "_ChrgsFees", "_Othr", "_StmpDty", "_Mrgn", "_BookVal", "_ExctgBrkrAmt", "_CsmptnTax", "_ValAddedTax", "_StockXchgTax", "_ShppgAmt", "_SpclCncssn", "_AcrdCptlstnAmt", "_WhldgTax", "_LclBrkrComssn", "_NetGnLoss", "_AcrdIntrstAmt", "_PmtLevyTax", "_IsseDscntAllwnc"]
	@property
	def TradAmt(self):
