...
class TransactionIdentifications49(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctOwnrTxId", "_AcctSvcrTxId", "_CmonId", "_CtrPtyMktInfrstrctrTxId", "_MktInfrstrctrTxId", "_NetgSvcPrvdrId", "_PrcrTxId"]
	@property
	...
	def NetgSvcPrvdrId(self, value):
		self._NetgSvcPrvdrId = value if value is not None else base_types.UninitialisedField(self, 'NetgSvcPrvdrId', RestrictedFINXMax16Text, False)

	@NetgSvcPrvdrId.deleter
	def NetgSvcPrvdrId(self):
		del self._NetgSvcPrvdrId
		self._NetgSvcPrvdrId = base_types.UninitialisedField(self, 'NetgSvcPrvdrId', RestrictedFINXMax16Text, False)
