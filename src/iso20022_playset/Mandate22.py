...
class Mandate22(base_types._BaseFieldType):
	...
	__slots__ = ["_Ocrncs", "_Adjstmnt", "_TrckgInd", "_FrstColltnAmt", "_MndtRef", "_UltmtCdtr", "_Rsn", "_DbtrAcct", "_Tp", "_MndtReqId", "_RfrdDoc", "_CdtrAgt", "_CdtrAcct", "_MndtId", "_Authntcn", "_Dbtr", "_CdtrSchmeId", "_Cdtr", "_UltmtDbtr", "_ColltnAmt", "_MaxAmt", "_DbtrAgt"]
	@property
	def Ocrncs(self):
		return self._Ocrncs
