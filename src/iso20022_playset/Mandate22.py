...
class Mandate22(base_types._BaseFieldType):
	...
	__slots__ = ["_MndtId", "_Dbtr", "_CdtrSchmeId", "_Tp", "_DbtrAcct", "_Authntcn", "_Rsn", "_ColltnAmt", "_MaxAmt", "_MndtReqId", "_Ocrncs", "_UltmtCdtr", "_UltmtDbtr", "_TrckgInd", "_CdtrAcct", "_MndtRef", "_CdtrAgt", "_Adjstmnt", "_DbtrAgt", "_Cdtr", "_FrstColltnAmt", "_RfrdDoc"]
	@property
	def MndtId(self):
		return self._MndtId
