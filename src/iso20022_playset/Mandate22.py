...
class Mandate22(base_types._BaseFieldType):
	...
	__slots__ = ["_MndtRef", "_CdtrSchmeId", "_ColltnAmt", "_UltmtCdtr", "_MndtReqId", "_Tp", "_CdtrAgt", "_DbtrAgt", "_Cdtr", "_UltmtDbtr", "_Adjstmnt", "_MaxAmt", "_RfrdDoc", "_CdtrAcct", "_Dbtr", "_TrckgInd", "_Authntcn", "_Ocrncs", "_Rsn", "_MndtId", "_DbtrAcct", "_FrstColltnAmt"]
	@property
	def MndtRef(self):
