...
class TradeLeg14(base_types._BaseFieldType):

	__slots__ = ["_AcrdIntrstAmt", "_AllcnId", "_Brkr", "_BuySellInd", "_DealPric", "_DerivRltdTrad", "_FinInstrmId", "_GrssAmt", "_OrdrId", "_PlcOfListg", "_PlcOfTrad", "_SfkpgAcct", "_SfkpgPlc", "_Sts", "_SttlmDt", "_TradDt", "_TradExctnId", "_TradId", "_TradLegId", "_TradPstngCd", "_TradQty", "_TradRegnOrgn", "_TradTp", "_TradTxCond", "_TradgCcy", "_TradgCpcty", "_TradgPty", "_TradgPtyAcct", "_TxDtTm", "_UnqTxIdr"]
	@property
