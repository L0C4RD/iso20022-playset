...
class FinancialInstrumentAttributes112(base_types._BaseFieldType):
	...
	__slots__ = ["_MtrtyDt", "_XpryDt", "_PmtFrqcy", "_VarblRateInd", "_PoolNb", "_PlcOfListg", "_IsseDt", "_OptnTp", "_FltgRateFxgDt", "_OptnStyle", "_FinInstrmAttrAddtlDtls", "_IntrstRate", "_PmtSts", "_CpnDt", "_ClssfctnTp", "_QtyBrkdwn", "_NxtCllblDt", "_IndxRateBsis", "_ExrcPric", "_YldToMtrtyRate", "_SbcptPric", "_CpnAttchdNb", "_DayCntBsis", "_FrstPmtDt", "_PutblDt", "_PutblInd", "_DtdDt", "_NxtIntrstRate", "_CllblInd", "_CtrctSz", "_NxtFctr", "_DnmtnCcy", "_MktOrIndctvPric", "_StrkPric", "_ConvsPric", "_RegnForm", "_PrvsFctr", "_MinNmnlQty", "_UndrlygFinInstrmId", "_CurFctr", "_VarblRateChngFrqcy"]
	@property
	def MtrtyDt(self):
