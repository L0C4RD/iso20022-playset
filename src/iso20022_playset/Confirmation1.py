...
class Confirmation1(base_types._BaseFieldType):
	...
	__slots__ = ["_PgNb", "_QryPgNb", "_TtlNbOfRpts", "_InitgPtyConfTm", "_ReqId", "_LastPgInd", "_LastRptReqd", "_ConfTm", "_MsgNbOfCurPg", "_ListOrdrNb", "_QryStartNb", "_ConfTp", "_TradPtyConfTm", "_ConfSts"]
	@property
	def PgNb(self):
		return self._PgNb
