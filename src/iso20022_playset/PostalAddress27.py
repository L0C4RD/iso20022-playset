...
class PostalAddress27(base_types._BaseFieldType):
	...
	__slots__ = ["_Dept", "_CtrySubDvsn", "_PstCd", "_BldgNb", "_CareOf", "_BldgNm", "_AdrTp", "_StrtNm", "_UnitNb", "_Room", "_Flr", "_TwnLctnNm", "_Ctry", "_PstBx", "_SubDept", "_DstrctNm", "_TwnNm", "_AdrLine"]
	@property
	def Dept(self):
		return self._Dept
