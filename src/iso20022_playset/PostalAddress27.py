...
class PostalAddress27(base_types._BaseFieldType):
	...
	__slots__ = ["_PstCd", "_Dept", "_TwnNm", "_DstrctNm", "_SubDept", "_TwnLctnNm", "_Room", "_UnitNb", "_Flr", "_PstBx", "_CtrySubDvsn", "_AdrLine", "_BldgNm", "_BldgNb", "_AdrTp", "_CareOf", "_StrtNm", "_Ctry"]
	@property
	def PstCd(self):
		return self._PstCd
