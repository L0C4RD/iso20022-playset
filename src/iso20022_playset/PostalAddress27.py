...
class PostalAddress27(base_types._BaseFieldType):
	...
	__slots__ = ["_CareOf", "_Flr", "_BldgNm", "_Room", "_Ctry", "_DstrctNm", "_AdrLine", "_TwnNm", "_CtrySubDvsn", "_PstBx", "_TwnLctnNm", "_UnitNb", "_AdrTp", "_Dept", "_PstCd", "_StrtNm", "_BldgNb", "_SubDept"]
	@property
	def CareOf(self):
		return self._CareOf
