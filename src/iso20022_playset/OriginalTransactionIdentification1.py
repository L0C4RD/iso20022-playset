...
class OriginalTransactionIdentification1(base_types._BaseFieldType):
	...
	__slots__ = ["_PurchsIdrTp", "_TmZone", "_OthrPurchsIdrTp", "_LifeCyclId", "_AcqrrRefNb", "_PresntmntSeqCnt", "_LifeCyclIdMssng", "_AuthstnSeqNb", "_AcqrrRefData", "_AuthntcnTkn", "_PresntmntSeqNb", "_RtrvlRefNb", "_IssrRefData", "_LifeCyclSpprt", "_LclDt", "_TrnsmssnDtTm", "_LclTm", "_SysTracAudtNb", "_PurchsIdr"]
	@property
