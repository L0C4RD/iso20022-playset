...
class OriginalTransactionIdentification1(base_types._BaseFieldType):
	...
	__slots__ = ["_AcqrrRefData", "_TrnsmssnDtTm", "_LifeCyclSpprt", "_LclTm", "_TmZone", "_LclDt", "_LifeCyclIdMssng", "_PurchsIdrTp", "_OthrPurchsIdrTp", "_SysTracAudtNb", "_PresntmntSeqCnt", "_PurchsIdr", "_LifeCyclId", "_RtrvlRefNb", "_IssrRefData", "_PresntmntSeqNb", "_AcqrrRefNb", "_AuthntcnTkn", "_AuthstnSeqNb"]
	@property
