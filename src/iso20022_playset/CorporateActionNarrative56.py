...
class CorporateActionNarrative56(base_types._BaseFieldType):
	...
	__slots__ = ["_PrcgTxtForNxtIntrmy", "_InfToCmplyWth", "_NrrtvVrsn", "_Dsclmr", "_RegnDtls", "_BsktOrIndxInf", "_TaxtnConds", "_CertfctnBrkdwn", "_AddtlTxt", "_InfConds", "_PtyCtctNrrtv"]
	@property
