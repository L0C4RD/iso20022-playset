...
class AggregateBalanceInformation43(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_CorpActnOptnTp", "_AltrnRptgCcyAmts", "_BalAtSfkpgPlc", "_BalBrkdwn", "_AcctBaseCcyAmts", "_InvstmtFndsFinInstrmAttrbts", "_AddtlBalBrkdwn", "_HldgAddtlDtls", "_SfkpgPlc", "_FinInstrmId", "_PricDtls", "_FinInstrmAttrbts", "_FXDtls", "_AggtBal", "_AddtlDerivAttrbts", "_QtyBrkdwn", "_DaysAcrd", "_InstrmCcyAmts"]
	@property
