...
class AggregateBalanceInformation43(base_types._BaseFieldType):
	...
	__slots__ = ["_InvstmtFndsFinInstrmAttrbts", "_AcctBaseCcyAmts", "_FinInstrmAttrbts", "_DaysAcrd", "_BalBrkdwn", "_AltrnRptgCcyAmts", "_FXDtls", "_FinInstrmId", "_InstrmCcyAmts", "_QtyBrkdwn", "_BalAtSfkpgPlc", "_PricDtls", "_AddtlBalBrkdwn", "_SplmtryData", "_HldgAddtlDtls", "_SfkpgPlc", "_AggtBal", "_CorpActnOptnTp", "_AddtlDerivAttrbts"]
	@property
