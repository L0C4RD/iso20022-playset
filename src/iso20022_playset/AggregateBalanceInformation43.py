...
class AggregateBalanceInformation43(base_types._BaseFieldType):
	...
	__slots__ = ["_InvstmtFndsFinInstrmAttrbts", "_AggtBal", "_AddtlBalBrkdwn", "_HldgAddtlDtls", "_AcctBaseCcyAmts", "_InstrmCcyAmts", "_QtyBrkdwn", "_FinInstrmAttrbts", "_BalAtSfkpgPlc", "_DaysAcrd", "_SfkpgPlc", "_PricDtls", "_FXDtls", "_FinInstrmId", "_AddtlDerivAttrbts", "_SplmtryData", "_BalBrkdwn", "_CorpActnOptnTp", "_AltrnRptgCcyAmts"]
	@property
