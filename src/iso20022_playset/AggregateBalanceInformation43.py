...
import AdditionalBalanceInformation23
import Balance22
import SubBalanceInformation23
import ForeignExchangeTerms35
import FinancialInstrumentAttributes122
import SafeKeepingPlace4
import SupplementaryData1
import BalanceAmounts5
import DerivativeBasicAttributes2
import SecurityIdentification20
import Number
import QuantityBreakdown70
import AggregateBalancePerSafekeepingPlace40
...
class AggregateBalanceInformation43(base_types._BaseFieldType):
	...
	__slots__ = ["_InstrmCcyAmts", "_AddtlDerivAttrbts", "_PricDtls", "_AddtlBalBrkdwn", "_CorpActnOptnTp", "_SfkpgPlc", "_AltrnRptgCcyAmts", "_DaysAcrd", "_AcctBaseCcyAmts", "_AggtBal", "_BalBrkdwn", "_FXDtls", "_QtyBrkdwn", "_FinInstrmId", "_FinInstrmAttrbts", "_SplmtryData", "_BalAtSfkpgPlc", "_HldgAddtlDtls", "_InvstmtFndsFinInstrmAttrbts"]
	@property
