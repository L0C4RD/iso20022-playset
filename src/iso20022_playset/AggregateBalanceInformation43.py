...
class AggregateBalanceInformation43(base_types._BaseFieldType):
	...
	__slots__ = ["_HldgAddtlDtls", "_AcctBaseCcyAmts", "_FinInstrmId", "_CorpActnOptnTp", "_InstrmCcyAmts", "_InvstmtFndsFinInstrmAttrbts", "_FinInstrmAttrbts", "_SfkpgPlc", "_BalBrkdwn", "_PricDtls", "_QtyBrkdwn", "_AddtlDerivAttrbts", "_AltrnRptgCcyAmts", "_AggtBal", "_FXDtls", "_DaysAcrd", "_AddtlBalBrkdwn", "_SplmtryData", "_BalAtSfkpgPlc"]
	@property
