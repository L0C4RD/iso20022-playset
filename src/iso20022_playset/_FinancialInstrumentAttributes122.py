...
class FinancialInstrumentAttributes122(base_types._BaseFieldType):
	...
	__slots__ = ["_IsseDt", "_PmtFrqcy", "_FltgRateFxgDt", "_NxtIntrstRate", "_ExrcPric", "_XpryDt", "_VarblRateInd", "_SbcptPric", "_DnmtnCcy", "_YldToMtrtyRate", "_PrvsFctr", "_PutblInd", "_ClssfctnTp", "_DtdDt", "_OptnTp", "_IntrstRate", "_MinNmnlQty", "_CpnAttchdNb", "_CllblInd", "_NxtCllblDt", "_PoolNb", "_ConvsPric", "_UndrlygFinInstrmId", "_MktOrIndctvPric", "_DayCntBsis", "_NxtFctr", "_StrkPric", "_OptnStyle", "_MtrtyDt", "_FinInstrmAttrAddtlDtls", "_VarblRateChngFrqcy", "_FrstPmtDt", "_PutblDt", "_CtrctSz", "_IndxRateBsis", "_CurFctr", "_PlcOfListg", "_PmtSts", "_RegnForm", "_CpnDt"]
	@property
	def IsseDt(self):
		return self._IsseDt
