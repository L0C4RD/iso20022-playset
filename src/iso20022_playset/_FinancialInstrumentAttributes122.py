...
class FinancialInstrumentAttributes122(base_types._BaseFieldType):
	...
	def UndrlygFinInstrmId(self, value):
		self._UndrlygFinInstrmId = value if value is not None else base_types.UninitialisedField(self, 'UndrlygFinInstrmId', SecurityIdentification20, True)

	@UndrlygFinInstrmId.deleter
	def UndrlygFinInstrmId(self):
		del self._UndrlygFinInstrmId
		self._UndrlygFinInstrmId = base_types.UninitialisedField(self, 'UndrlygFinInstrmId', SecurityIdentification20, True)
