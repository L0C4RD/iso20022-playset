...
from .GenericIdentification186 import GenericIdentification186
...
class CryptographicKey18(base_types._BaseFieldType):
	...
	__slots__ = ["_KeyVal", "_ItmNb", "_AddtlId", "_AddtlMgmtInf", "_Nm", "_DeactvtnDt", "_ActvtnDt", "_SctyPrfl", "_Vrsn", "_KeyChckVal", "_PrtctdCmpntWthAuthrsdAccs", "_Fctn", "_Id", "_Tp", "_CmpntWthAuthrsdAccs"]
	@property
	def KeyVal(self):
		return self._KeyVal
