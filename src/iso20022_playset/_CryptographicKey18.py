...
class CryptographicKey18(base_types._BaseFieldType):
	...
	__slots__ = ["_Tp", "_KeyVal", "_ItmNb", "_AddtlId", "_Vrsn", "_PrtctdCmpntWthAuthrsdAccs", "_Id", "_KeyChckVal", "_Nm", "_AddtlMgmtInf", "_CmpntWthAuthrsdAccs", "_Fctn", "_SctyPrfl", "_DeactvtnDt", "_ActvtnDt"]
	@property
	def Tp(self):
		return self._Tp
