...
from .UpdatedAdditionalInformation22 import UpdatedAdditionalInformation22
from .UpdatedAdditionalInformation23 import UpdatedAdditionalInformation23

class CorporateActionNarrative61(base_types._BaseFieldType):

	__slots__ = ["_NrrtvVrsn", "_CertfctnBrkdwn", "_InfToCmplyWth", "_AddtlTxt", "_SctyRstrctn", "_Dsclmr", "_TaxtnConds", "_InfConds"]
	@property
	def NrrtvVrsn(self):
