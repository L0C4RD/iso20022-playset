...
from ._UpdatedAdditionalInformation22 import UpdatedAdditionalInformation22
from ._UpdatedAdditionalInformation23 import UpdatedAdditionalInformation23

class CorporateActionNarrative61(base_types._BaseFieldType):

	__slots__ = ["_TaxtnConds", "_NrrtvVrsn", "_CertfctnBrkdwn", "_SctyRstrctn", "_Dsclmr", "_InfToCmplyWth", "_AddtlTxt", "_InfConds"]
	@property
	def AddtlTxt(self):
