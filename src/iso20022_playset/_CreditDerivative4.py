...
class CreditDerivative4(base_types._BaseFieldType):
	...
	@Trch.setter
	def Trch(self, value):
		self._Trch = value if value is not None else base_types.UninitialisedField(self, 'Trch', TrancheIndicator3Choice, False)

	@Trch.deleter
	def Trch(self):
		del self._Trch
		self._Trch = base_types.UninitialisedField(self, 'Trch', TrancheIndicator3Choice, False)
