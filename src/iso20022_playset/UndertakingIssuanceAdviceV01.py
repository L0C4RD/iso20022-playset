...
from .UndertakingAdvice1 import UndertakingAdvice1
...
class UndertakingIssuanceAdviceV01(base_types._BaseFieldType):
	...
	__slots__ = ["_DtOfAdvc", "_AdvsgPty", "_BkToBkInf", "_UdrtkgIssncAdvcDtls", "_DgtlSgntr", "_ScndAdvsgPty"]
	@property
	def DtOfAdvc(self):
	...
	def UdrtkgIssncAdvcDtls(self, value):
		self._UdrtkgIssncAdvcDtls = value if type(value) != base_types.auto else self.make_default("UdrtkgIssncAdvcDtls")
