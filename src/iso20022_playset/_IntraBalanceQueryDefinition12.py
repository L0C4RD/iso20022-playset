...
from . import IntraBalanceQueryCriteria12
...
class IntraBalanceQueryDefinition12(base_types._BaseFieldType):
	...
	def SchCrit(self, value):
		self._SchCrit = value if value is not None else base_types.UninitialisedField(self, 'SchCrit', IntraBalanceQueryCriteria12, False)

	@SchCrit.deleter
	def SchCrit(self):
		del self._SchCrit
		self._SchCrit = base_types.UninitialisedField(self, 'SchCrit', IntraBalanceQueryCriteria12, False)
