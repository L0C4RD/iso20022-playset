...
from .ContractModification8 import ContractModification8
...
class MarginReportData10(base_types._BaseFieldType):
	...
	__slots__ = ["_RcvdMrgnOrColl", "_CtrPtyRatgThrshldInd", "_SplmtryData", "_CtrPtyId", "_EvtDt", "_CtrctMod", "_RptgTmStmp", "_CtrPtyRatgTrggrInd", "_TxId", "_Coll", "_PstdMrgnOrColl", "_TechAttrbts"]
	@property
