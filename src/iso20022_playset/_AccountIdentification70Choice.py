...
from . import AccountAndBalance59
from . import AccountIdentification10

class AccountIdentification70Choice(base_types._BaseFieldType):
	...
	def AcctsListAndBalDtls(self, value):
		self._AcctsListAndBalDtls = value if value is not None else base_types.UninitialisedField(self, 'AcctsListAndBalDtls', AccountAndBalance59, True)

	@AcctsListAndBalDtls.deleter
	def AcctsListAndBalDtls(self):
		del self._AcctsListAndBalDtls
		self._AcctsListAndBalDtls = base_types.UninitialisedField(self, 'AcctsListAndBalDtls', AccountAndBalance59, True)
	...
	_field_defs = frozenset((
		base_types.FieldEntry(name='AcctsListAndBalDtls', type=AccountAndBalance59, min=1, max=None, mutex_group=1, array=True),
