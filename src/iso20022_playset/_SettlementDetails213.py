...
from . import ExposureType18Choice
...
from . import ModificationCancellationAllowed4Choice
...
from . import SettlementInstructionGeneration2Choice
from . import SettlementSystemMethod4Choice
from . import SettlementTransactionCondition31Choice
from . import SettlementTransactionType3Choice
from . import SettlingCapacity9Choice
from . import TaxCapacityParty4Choice
from . import Tracking4Choice
from . import YesNoIndicator

class SettlementDetails213(base_types._BaseFieldType):

	__slots__ = ["_AutomtcBrrwg", "_BlckTrad", "_BnfclOwnrsh", "_CCPElgblty", "_CcyToBuyOrSell", "_CshClrSys", "_ElgblForColl", "_FxStgInstr", "_HldInd", "_LglRstrctns", "_LttrOfGrnt", "_MktClntSd", "_ModCxlAllwd", "_NetgElgblty", "_PrtlSttlmInd", "_Prty", "_Regn", "_RpTp", "_RtrLeg", "_SctiesRTGS", "_StmpDtyInd", "_StmpDtyTaxBsis", "_SttlgCpcty", "_SttlmInstrGnrtn", "_SttlmSysMtd", "_SttlmTxCond", "_SttlmTxTp", "_TaxCpcty", "_Trckg", "_XpsrTp"]
	@property
	...
	def ModCxlAllwd(self, value):
		self._ModCxlAllwd = value if value is not None else base_types.UninitialisedField(self, 'ModCxlAllwd', ModificationCancellationAllowed4Choice, False)

	@ModCxlAllwd.deleter
	def ModCxlAllwd(self):
		del self._ModCxlAllwd
		self._ModCxlAllwd = base_types.UninitialisedField(self, 'ModCxlAllwd', ModificationCancellationAllowed4Choice, False)
	...
	def SttlgCpcty(self, value):
		self._SttlgCpcty = value if value is not None else base_types.UninitialisedField(self, 'SttlgCpcty', SettlingCapacity9Choice, False)

	@SttlgCpcty.deleter
	def SttlgCpcty(self):
		del self._SttlgCpcty
		self._SttlgCpcty = base_types.UninitialisedField(self, 'SttlgCpcty', SettlingCapacity9Choice, False)

	@property
	def SttlmInstrGnrtn(self):
		return self._SttlmInstrGnrtn

	@SttlmInstrGnrtn.setter
	def SttlmInstrGnrtn(self, value):
		self._SttlmInstrGnrtn = value if value is not None else base_types.UninitialisedField(self, 'SttlmInstrGnrtn', SettlementInstructionGeneration2Choice, False)

	@SttlmInstrGnrtn.deleter
	def SttlmInstrGnrtn(self):
		del self._SttlmInstrGnrtn
		self._SttlmInstrGnrtn = base_types.UninitialisedField(self, 'SttlmInstrGnrtn', SettlementInstructionGeneration2Choice, False)
	...
	def SttlmTxCond(self, value):
		self._SttlmTxCond = value if value is not None else base_types.UninitialisedField(self, 'SttlmTxCond', SettlementTransactionCondition31Choice, True)

	@SttlmTxCond.deleter
	def SttlmTxCond(self):
		del self._SttlmTxCond
		self._SttlmTxCond = base_types.UninitialisedField(self, 'SttlmTxCond', SettlementTransactionCondition31Choice, True)

	@property
	def SttlmTxTp(self):
		return self._SttlmTxTp

	@SttlmTxTp.setter
	def SttlmTxTp(self, value):
		self._SttlmTxTp = value if value is not None else base_types.UninitialisedField(self, 'SttlmTxTp', SettlementTransactionType3Choice, False)

	@SttlmTxTp.deleter
	def SttlmTxTp(self):
		del self._SttlmTxTp
		self._SttlmTxTp = base_types.UninitialisedField(self, 'SttlmTxTp', SettlementTransactionType3Choice, False)
	...
	def XpsrTp(self, value):
		self._XpsrTp = value if value is not None else base_types.UninitialisedField(self, 'XpsrTp', ExposureType18Choice, False)

	@XpsrTp.deleter
	def XpsrTp(self):
		del self._XpsrTp
		self._XpsrTp = base_types.UninitialisedField(self, 'XpsrTp', ExposureType18Choice, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='SttlgCpcty', type=SettlingCapacity9Choice, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='SttlmInstrGnrtn', type=SettlementInstructionGeneration2Choice, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='SttlmSysMtd', type=SettlementSystemMethod4Choice, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='SttlmTxCond', type=SettlementTransactionCondition31Choice, min=0, max=None, mutex_group=None, array=True),
		base_types.FieldEntry(name='SttlmTxTp', type=SettlementTransactionType3Choice, min=1, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='XpsrTp', type=ExposureType18Choice, min=0, max=1, mutex_group=None, array=False),
	))