...
from . import FinancialInstrumentIdentification11
...
class FinancialInstrument104Choice(base_types._BaseFieldType):
	...
	@Scty.setter
	def Scty(self, value):
		self._Scty = value if value is not None else base_types.UninitialisedField(self, 'Scty', FinancialInstrumentIdentification11, False)

	@Scty.deleter
	def Scty(self):
		del self._Scty
		self._Scty = base_types.UninitialisedField(self, 'Scty', FinancialInstrumentIdentification11, False)
