...
class TransactionIdentifications44(base_types._BaseFieldType):
	...
	def CtrPtyCollInstrId(self, value):
		self._CtrPtyCollInstrId = value if value is not None else base_types.UninitialisedField(self, 'CtrPtyCollInstrId', Max35Text, False)

	@CtrPtyCollInstrId.deleter
	def CtrPtyCollInstrId(self):
		del self._CtrPtyCollInstrId
		self._CtrPtyCollInstrId = base_types.UninitialisedField(self, 'CtrPtyCollInstrId', Max35Text, False)
