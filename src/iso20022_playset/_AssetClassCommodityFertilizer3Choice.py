...
from . import FertilizerCommodityOther1
...
class AssetClassCommodityFertilizer3Choice(base_types._BaseFieldType):
	...
	@Othr.setter
	def Othr(self, value):
		self._Othr = value if value is not None else base_types.UninitialisedField(self, 'Othr', FertilizerCommodityOther1, False)

	@Othr.deleter
	def Othr(self):
		del self._Othr
		self._Othr = base_types.UninitialisedField(self, 'Othr', FertilizerCommodityOther1, False)
