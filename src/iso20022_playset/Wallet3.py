...
class Wallet3(base_types._BaseFieldType):
	...
	__slots__ = ["_PANAge", "_OthrCardDataNtryMd", "_PrvdrPhneScore", "_CardDataNtryMd", "_PrvdrAcctScore", "_PrvdrRskAssmntMdlVrsn", "_AddtlData", "_AcctAge", "_PrvdrRskAssmnt", "_SspdCrds", "_LastWlltChng", "_DaysSncLastActvty", "_AcctEmailAge", "_AcctCtry", "_UsrAcctAge", "_Actvty", "_PrvdrDvcScore", "_Prvdr", "_ActvtyIntrvl"]
	@property
	def PANAge(self):
		return self._PANAge
