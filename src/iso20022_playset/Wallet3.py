...
class Wallet3(base_types._BaseFieldType):
	...
	__slots__ = ["_SspdCrds", "_PANAge", "_PrvdrRskAssmnt", "_DaysSncLastActvty", "_CardDataNtryMd", "_Actvty", "_ActvtyIntrvl", "_AcctAge", "_AcctCtry", "_Prvdr", "_PrvdrRskAssmntMdlVrsn", "_PrvdrPhneScore", "_LastWlltChng", "_OthrCardDataNtryMd", "_PrvdrAcctScore", "_AcctEmailAge", "_AddtlData", "_PrvdrDvcScore", "_UsrAcctAge"]
	@property
	def SspdCrds(self):
