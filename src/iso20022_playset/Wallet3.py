...
class Wallet3(base_types._BaseFieldType):
	...
	__slots__ = ["_ActvtyIntrvl", "_LastWlltChng", "_Actvty", "_Prvdr", "_AcctEmailAge", "_PrvdrDvcScore", "_AcctCtry", "_SspdCrds", "_PrvdrRskAssmnt", "_PrvdrAcctScore", "_PrvdrPhneScore", "_OthrCardDataNtryMd", "_CardDataNtryMd", "_PrvdrRskAssmntMdlVrsn", "_AcctAge", "_PANAge", "_AddtlData", "_DaysSncLastActvty", "_UsrAcctAge"]
	@property
