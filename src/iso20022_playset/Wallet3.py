...
class Wallet3(base_types._BaseFieldType):
	...
	__slots__ = ["_CardDataNtryMd", "_DaysSncLastActvty", "_PANAge", "_AcctCtry", "_Prvdr", "_AcctAge", "_PrvdrRskAssmnt", "_PrvdrAcctScore", "_Actvty", "_OthrCardDataNtryMd", "_PrvdrRskAssmntMdlVrsn", "_ActvtyIntrvl", "_LastWlltChng", "_PrvdrPhneScore", "_SspdCrds", "_UsrAcctAge", "_PrvdrDvcScore", "_AddtlData", "_AcctEmailAge"]
	@property
