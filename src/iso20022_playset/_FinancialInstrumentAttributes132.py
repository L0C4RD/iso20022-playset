...
class FinancialInstrumentAttributes132(base_types._BaseFieldType):
	...
	__slots__ = ["_ClssfctnTp", "_PlcOfListg", "_ConvsDt", "_MinNmnlQty", "_PrvsFctr", "_NxtCllblDt", "_NxtFctr", "_FltgRateFxgDt", "_FinInstrmId", "_DtdDt", "_MtrtyDt", "_IsseDt", "_CtrctSz", "_NxtCpnDt", "_PutblDt", "_DayCntBsis", "_IntrstRate", "_XpryDt", "_NxtIntrstRate", "_DnmtnCcy"]
	@property
	def ClssfctnTp(self):
