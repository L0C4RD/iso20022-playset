...
from . import CardPaymentDataSet42
from . import TransactionTotals12

class CardPaymentBatchTransferResponse13(base_types._BaseFieldType):
	...
	def DataSet(self, value):
		self._DataSet = value if value is not None else base_types.UninitialisedField(self, 'DataSet', CardPaymentDataSet42, True)

	@DataSet.deleter
	def DataSet(self):
		del self._DataSet
		self._DataSet = base_types.UninitialisedField(self, 'DataSet', CardPaymentDataSet42, True)
