...
from . import CorporateActionEventType113Choice
from . import CorporateActionMandatoryVoluntary4Choice
from . import RestrictedFINXMax16Text
from . import SecurityIdentification20

class CorporateActionGeneralInformation184(base_types._BaseFieldType):
	...
	def EvtTp(self, value):
		self._EvtTp = value if value is not None else base_types.UninitialisedField(self, 'EvtTp', CorporateActionEventType113Choice, False)

	@EvtTp.deleter
	def EvtTp(self):
		del self._EvtTp
		self._EvtTp = base_types.UninitialisedField(self, 'EvtTp', CorporateActionEventType113Choice, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='EvtTp', type=CorporateActionEventType113Choice, min=1, max=1, mutex_group=None, array=False),
