...
class LineItemDetails12(base_types._BaseFieldType):
	...
	__slots__ = ["_AccptdQty", "_QtyTlrnce", "_PdctNm", "_PricTlrnce", "_OrdrdAmt", "_OutsdngAmt", "_PdctIdr", "_PdgQty", "_PdgAmt", "_AccptdAmt", "_LineItmId", "_PdctChrtcs", "_OutsdngQty", "_OrdrdQty", "_PdctCtgy"]
	@property
	def AccptdQty(self):
