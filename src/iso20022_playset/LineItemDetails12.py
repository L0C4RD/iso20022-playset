...
class LineItemDetails12(base_types._BaseFieldType):
	...
	__slots__ = ["_AccptdAmt", "_PdgQty", "_PdctCtgy", "_PricTlrnce", "_AccptdQty", "_PdctIdr", "_OutsdngAmt", "_OrdrdAmt", "_OrdrdQty", "_QtyTlrnce", "_OutsdngQty", "_LineItmId", "_PdctNm", "_PdctChrtcs", "_PdgAmt"]
	@property
	def AccptdAmt(self):
