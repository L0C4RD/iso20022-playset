...
class LineItemDetails12(base_types._BaseFieldType):
	...
	__slots__ = ["_PdctChrtcs", "_OutsdngAmt", "_OrdrdAmt", "_PdctIdr", "_QtyTlrnce", "_PdgAmt", "_PdctCtgy", "_OrdrdQty", "_PdgQty", "_AccptdAmt", "_AccptdQty", "_PdctNm", "_LineItmId", "_OutsdngQty", "_PricTlrnce"]
	@property
	def PdctChrtcs(self):
