...
class CardPaymentTransaction146(base_types._BaseFieldType):

	__slots__ = ["_AcctFr", "_AcctTo", "_AddtlSvc", "_AddtlTxData", "_CardPrgrmmApld", "_CardPrgrmmPropsd", "_CstmrCnsnt", "_InitrTxId", "_IssrCITId", "_LastTxFlg", "_MrchntCITId", "_MrchntCtgyCd", "_MrchntRefData", "_MsgFrMrchnt", "_OrgnlTx", "_RcncltnId", "_SaleRefId", "_SvcAttr", "_TxCaptr", "_TxDtls", "_TxId", "_TxTp"]
	@property
	def AcctFr(self):
		return self._AcctFr
