...
class CorporateActionMovementReversalAdvice002V16(base_types._BaseFieldType):
	...
	__slots__ = ["_TxId", "_CorpActnGnlInf", "_CorpActnDtls", "_EvtsLkg", "_CorpActnConfDtls", "_AddtlInf", "_SplmtryData", "_AcctDtls", "_PngAgt", "_IssrAgt", "_MvmntConfId", "_OthrDocId", "_RvslRsn", "_SubPngAgt"]
	@property
	def TxId(self):
		return self._TxId
