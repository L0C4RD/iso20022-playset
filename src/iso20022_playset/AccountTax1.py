import base_types
import BillingTaxCalculationMethod1Code
import Max40Text
import ResidenceLocation1Choice

class AccountTax1(base_types._BaseFieldType):

	__slots__ = ["_NonResCtry", "_Rgn", "_ClctnMtd"]
	@property
	def NonResCtry(self):
	...
	def NonResCtry(self, value):
		self._NonResCtry = value if type(value) != auto else self.make_default("NonResCtry")
