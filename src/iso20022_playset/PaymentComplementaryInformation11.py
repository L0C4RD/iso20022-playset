...
class PaymentComplementaryInformation11(base_types._BaseFieldType):
	...
	__slots__ = ["_Purp", "_CdtrAcct", "_PmtTpInf", "_PrvsInstgAgt2", "_InstrForDbtrAgt", "_RltdRmtInf", "_UltmtCdtr", "_IntrmyAgt3Acct", "_IntrmyAgt1Acct", "_InstrForCdtrAgt", "_PrvsInstgAgt1", "_Cdtr", "_CdtrAgt", "_PrvsInstgAgt3", "_IntrmyAgt1", "_UltmtDbtr", "_IntrmyAgt2Acct", "_IntrmyAgt2", "_IntrBkSttlmDt", "_ChrgBr", "_CdtrAgtAcct", "_PrvsInstgAgt3Acct", "_Amt", "_InstrForNxtAgt", "_DbtrAgt", "_ReqdColltnDt", "_DbtrAgtAcct", "_PrvsInstgAgt1Acct", "_SttlmInf", "_DbtrAcct", "_ReqdExctnDt", "_EndToEndId", "_InstrId", "_IntrBkSttlmAmt", "_RmtInf", "_Dbtr", "_IntrmyAgt3", "_PrvsInstgAgt2Acct", "_TxId"]
	@property
	def Purp(self):
		return self._Purp
