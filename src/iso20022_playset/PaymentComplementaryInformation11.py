...
class PaymentComplementaryInformation11(base_types._BaseFieldType):
	...
	__slots__ = ["_ChrgBr", "_IntrmyAgt2", "_Dbtr", "_PmtTpInf", "_IntrBkSttlmAmt", "_IntrmyAgt1Acct", "_Purp", "_CdtrAgtAcct", "_InstrForCdtrAgt", "_IntrmyAgt1", "_SttlmInf", "_RmtInf", "_IntrmyAgt3", "_PrvsInstgAgt1Acct", "_ReqdExctnDt", "_IntrBkSttlmDt", "_Amt", "_PrvsInstgAgt1", "_TxId", "_DbtrAcct", "_RltdRmtInf", "_UltmtCdtr", "_PrvsInstgAgt2", "_DbtrAgtAcct", "_IntrmyAgt3Acct", "_CdtrAgt", "_ReqdColltnDt", "_IntrmyAgt2Acct", "_Cdtr", "_UltmtDbtr", "_InstrForDbtrAgt", "_InstrForNxtAgt", "_PrvsInstgAgt3Acct", "_EndToEndId", "_CdtrAcct", "_PrvsInstgAgt3", "_InstrId", "_DbtrAgt", "_PrvsInstgAgt2Acct"]
	@property
	def ChrgBr(self):
		return self._ChrgBr
