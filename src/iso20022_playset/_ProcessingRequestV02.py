...
class ProcessingRequestV02(base_types._BaseFieldType):
	...
	@Req.setter
	def Req(self, value):
		self._Req = value if value is not None else base_types.UninitialisedField(self, 'Req', RequestDetails30, False)

	@Req.deleter
	def Req(self):
		del self._Req
		self._Req = base_types.UninitialisedField(self, 'Req', RequestDetails30, False)
