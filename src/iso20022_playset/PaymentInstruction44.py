...
class PaymentInstruction44(base_types._BaseFieldType):
	...
	__slots__ = ["_InstrForDbtrAgt", "_DbtrAgt", "_ChrgBr", "_ReqdExctnDt", "_DbtrAcct", "_Dbtr", "_ReqdAdvcTp", "_NbOfTxs", "_DbtrAgtAcct", "_ChrgsAcctAgt", "_PmtTpInf", "_PmtInfId", "_CdtTrfTxInf", "_CtrlSum", "_ChrgsAcct", "_BtchBookg", "_PmtMtd", "_UltmtDbtr", "_PoolgAdjstmntDt"]
	@property
