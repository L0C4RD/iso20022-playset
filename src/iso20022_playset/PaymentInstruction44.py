...
class PaymentInstruction44(base_types._BaseFieldType):
	...
	__slots__ = ["_PmtTpInf", "_PoolgAdjstmntDt", "_ChrgBr", "_DbtrAgtAcct", "_ChrgsAcctAgt", "_DbtrAgt", "_UltmtDbtr", "_InstrForDbtrAgt", "_CtrlSum", "_ReqdAdvcTp", "_ChrgsAcct", "_PmtMtd", "_BtchBookg", "_CdtTrfTxInf", "_Dbtr", "_DbtrAcct", "_PmtInfId", "_ReqdExctnDt", "_NbOfTxs"]
	@property
	def PmtTpInf(self):
