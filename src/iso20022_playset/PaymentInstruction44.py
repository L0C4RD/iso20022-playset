...
from .CreditTransferTransaction61 import CreditTransferTransaction61
...
class PaymentInstruction44(base_types._BaseFieldType):
	...
	__slots__ = ["_ChrgBr", "_ReqdAdvcTp", "_DbtrAgtAcct", "_Dbtr", "_PoolgAdjstmntDt", "_PmtMtd", "_CdtTrfTxInf", "_DbtrAgt", "_DbtrAcct", "_NbOfTxs", "_BtchBookg", "_UltmtDbtr", "_CtrlSum", "_ReqdExctnDt", "_PmtTpInf", "_ChrgsAcctAgt", "_PmtInfId", "_ChrgsAcct", "_InstrForDbtrAgt"]
	@property
	def ChrgBr(self):
		return self._ChrgBr
