...
from .PaymentTokenIdentifiers1 import PaymentTokenIdentifiers1
...
class CardPaymentToken5(base_types._BaseFieldType):
	...
	__slots__ = ["_TknChrtc", "_TknRqstr", "_TknAssrncLvl", "_TknInittdInd", "_TknXpryDt", "_TknAssrncData", "_CardSeqNb", "_Tkn", "_TknAssrncMtd"]
	@property
	def TknChrtc(self):
