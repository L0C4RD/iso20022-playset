...
from . import PositionSetMetrics13
...
class PositionSet17(base_types._BaseFieldType):
	...
	def Mtrcs(self, value):
		self._Mtrcs = value if value is not None else base_types.UninitialisedField(self, 'Mtrcs', PositionSetMetrics13, False)

	@Mtrcs.deleter
	def Mtrcs(self):
		del self._Mtrcs
		self._Mtrcs = base_types.UninitialisedField(self, 'Mtrcs', PositionSetMetrics13, False)
