...
from ._ISO8583NetworkManagementInformationCode import ISO8583NetworkManagementInformationCode
...
class NetworkManagementResponseV05(base_types._BaseFieldType):
