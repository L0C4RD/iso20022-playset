...
class PaymentInstruction47(base_types._BaseFieldType):
	...
	__slots__ = ["_Tp", "_IntrBkSttlmAmt", "_EndToEndId", "_Prty", "_PmtMtd", "_Purp", "_ReqdExctnDt", "_InstrCpy", "_InstdAmt", "_Sts", "_Pties", "_IntrBkSttlmDt", "_MsgId", "_PrcgVldtyTm", "_GnrtdOrdr", "_TxId"]
	@property
	def Tp(self):
		return self._Tp
