...
class CorporateActionOption239(base_types._BaseFieldType):
	...
	__slots__ = ["_BlckChainAdrOrWllt", "_AcctOwnr", "_OptnFeatrs", "_CshAcct", "_SfkpgAcct", "_SfkpgPlc", "_UinstdBal", "_StsCshAmt", "_FinInstrmId", "_TtlElgblBal", "_StsQty", "_InstdBal", "_OptnTp", "_OptnNb", "_PrtctBal"]
	@property
