...
class CorporateActionOption239(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctOwnr", "_FinInstrmId", "_OptnNb", "_InstdBal", "_SfkpgAcct", "_StsQty", "_OptnTp", "_PrtctBal", "_StsCshAmt", "_OptnFeatrs", "_SfkpgPlc", "_CshAcct", "_UinstdBal", "_BlckChainAdrOrWllt", "_TtlElgblBal"]
	@property
	def AcctOwnr(self):
