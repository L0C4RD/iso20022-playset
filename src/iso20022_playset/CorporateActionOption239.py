...
class CorporateActionOption239(base_types._BaseFieldType):
	...
	__slots__ = ["_CshAcct", "_BlckChainAdrOrWllt", "_SfkpgPlc", "_OptnTp", "_OptnNb", "_SfkpgAcct", "_UinstdBal", "_PrtctBal", "_FinInstrmId", "_StsCshAmt", "_InstdBal", "_AcctOwnr", "_OptnFeatrs", "_StsQty", "_TtlElgblBal"]
	@property
	def CshAcct(self):
