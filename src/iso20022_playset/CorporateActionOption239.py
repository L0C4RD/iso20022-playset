...
class CorporateActionOption239(base_types._BaseFieldType):
	...
	__slots__ = ["_StsCshAmt", "_SfkpgPlc", "_AcctOwnr", "_BlckChainAdrOrWllt", "_OptnFeatrs", "_OptnTp", "_TtlElgblBal", "_InstdBal", "_OptnNb", "_PrtctBal", "_StsQty", "_UinstdBal", "_FinInstrmId", "_SfkpgAcct", "_CshAcct"]
	@property
	def StsCshAmt(self):
