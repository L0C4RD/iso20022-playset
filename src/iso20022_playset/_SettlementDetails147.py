...
class SettlementDetails147(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmTxCond", "_LglRstrctns", "_SctiesRTGS", "_AutomtcBrrwg", "_BnfclOwnrsh", "_TaxCpcty", "_PrtlSttlmInd", "_CshClrSys", "_SttlgCpcty", "_Prty", "_BlckTrad", "_StmpDtyTaxBsis", "_SttlmSysMtd", "_MktClntSd", "_CCPElgblty", "_ElgblForColl", "_NetgElgblty"]
	@property
