...
from . import UnmatchedStatus18Choice
...
class MatchingStatus26Choice(base_types._BaseFieldType):
	...
	def Umtchd(self, value):
		self._Umtchd = value if value is not None else base_types.UninitialisedField(self, 'Umtchd', UnmatchedStatus18Choice, False)

	@Umtchd.deleter
	def Umtchd(self):
		del self._Umtchd
		self._Umtchd = base_types.UninitialisedField(self, 'Umtchd', UnmatchedStatus18Choice, False)
