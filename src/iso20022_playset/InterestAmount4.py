...
class InterestAmount4(base_types._BaseFieldType):
	...
	__slots__ = ["_RefDtls", "_CollPurp", "_ValDt", "_StdSttlmInstrs", "_IntrstPrd", "_ApldWhldgTax", "_AcrdIntrstAmt", "_ClctnFrqcy", "_IntrstReqSeq", "_IntrstRate", "_DayCntBsis", "_ClctnMtd", "_AddtlInf", "_OpngCollBal", "_ClsgCollBal", "_IntrstMtd"]
	@property
	def RefDtls(self):
