...
class InterestAmount4(base_types._BaseFieldType):
	...
	__slots__ = ["_ClsgCollBal", "_IntrstRate", "_DayCntBsis", "_AddtlInf", "_OpngCollBal", "_CollPurp", "_AcrdIntrstAmt", "_ClctnMtd", "_IntrstReqSeq", "_StdSttlmInstrs", "_IntrstPrd", "_ApldWhldgTax", "_IntrstMtd", "_ClctnFrqcy", "_RefDtls", "_ValDt"]
	@property
