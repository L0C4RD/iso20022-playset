...
class InterestAmount4(base_types._BaseFieldType):
	...
	__slots__ = ["_CollPurp", "_AddtlInf", "_IntrstReqSeq", "_DayCntBsis", "_IntrstRate", "_AcrdIntrstAmt", "_ClctnFrqcy", "_ValDt", "_ApldWhldgTax", "_StdSttlmInstrs", "_ClctnMtd", "_RefDtls", "_ClsgCollBal", "_IntrstPrd", "_OpngCollBal", "_IntrstMtd"]
	@property
	def CollPurp(self):
