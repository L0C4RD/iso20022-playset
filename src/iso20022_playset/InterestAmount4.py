...
class InterestAmount4(base_types._BaseFieldType):
	...
	__slots__ = ["_AcrdIntrstAmt", "_IntrstMtd", "_OpngCollBal", "_RefDtls", "_ClctnMtd", "_IntrstRate", "_ClctnFrqcy", "_IntrstPrd", "_ClsgCollBal", "_IntrstReqSeq", "_AddtlInf", "_StdSttlmInstrs", "_CollPurp", "_ValDt", "_DayCntBsis", "_ApldWhldgTax"]
	@property
