...
class InterestAmount4(base_types._BaseFieldType):
	...
	__slots__ = ["_OpngCollBal", "_IntrstPrd", "_ClctnFrqcy", "_CollPurp", "_ValDt", "_ClctnMtd", "_ApldWhldgTax", "_DayCntBsis", "_AcrdIntrstAmt", "_AddtlInf", "_IntrstMtd", "_IntrstReqSeq", "_StdSttlmInstrs", "_ClsgCollBal", "_RefDtls", "_IntrstRate"]
	@property
