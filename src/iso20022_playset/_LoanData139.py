...
class LoanData139(base_types._BaseFieldType):
	...
	__slots__ = ["_MstrAgrmt", "_ValDt", "_TermntnDt", "_EvtDt", "_CollDlvryMtd", "_UnqTradIdr", "_GnlColl", "_IntrstRate", "_DlvryByVal", "_ClrSts", "_ExctnDtTm", "_EarlstCallBckDt", "_Term", "_TradgVn", "_MinNtcePrd", "_PrncplAmt"]
	@property
	def ClrSts(self):
		return self._ClrSts
