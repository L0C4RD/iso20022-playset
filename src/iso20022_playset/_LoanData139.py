...
class LoanData139(base_types._BaseFieldType):
	...
	__slots__ = ["_UnqTradIdr", "_EarlstCallBckDt", "_TermntnDt", "_GnlColl", "_DlvryByVal", "_IntrstRate", "_MinNtcePrd", "_CollDlvryMtd", "_ValDt", "_TradgVn", "_EvtDt", "_ExctnDtTm", "_ClrSts", "_Term", "_MstrAgrmt", "_PrncplAmt"]
	@property
	def UnqTradIdr(self):
