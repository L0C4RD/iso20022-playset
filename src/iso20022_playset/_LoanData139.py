...
class LoanData139(base_types._BaseFieldType):
	...
	__slots__ = ["_TradgVn", "_ValDt", "_IntrstRate", "_EvtDt", "_MinNtcePrd", "_ClrSts", "_UnqTradIdr", "_PrncplAmt", "_TermntnDt", "_DlvryByVal", "_Term", "_ExctnDtTm", "_MstrAgrmt", "_CollDlvryMtd", "_EarlstCallBckDt", "_GnlColl"]
	@property
	def TradgVn(self):
