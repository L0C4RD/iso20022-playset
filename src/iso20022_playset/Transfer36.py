...
class Transfer36(base_types._BaseFieldType):
	...
	__slots__ = ["_ClntRef", "_Qty", "_ReqdTrfDt", "_NonStdSttlmInf", "_TrfExpnssPmtTp", "_TrfRsn", "_CtrPtyRef", "_TrfCcy", "_TrfRef", "_ReqdSttlmDt", "_AvrgPric", "_HldgsPlanTp", "_OrgnlCost", "_TrfOrdrDtForm", "_FinInstrmDtls", "_UnitsDtls", "_Rndg", "_OwnAcctTrfInd", "_BizFlowTp"]
	@property
	def ClntRef(self):
