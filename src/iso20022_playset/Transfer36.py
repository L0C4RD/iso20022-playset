...
class Transfer36(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlCost", "_TrfCcy", "_ReqdTrfDt", "_HldgsPlanTp", "_BizFlowTp", "_ClntRef", "_UnitsDtls", "_CtrPtyRef", "_TrfOrdrDtForm", "_Qty", "_AvrgPric", "_FinInstrmDtls", "_NonStdSttlmInf", "_TrfRsn", "_ReqdSttlmDt", "_TrfExpnssPmtTp", "_Rndg", "_TrfRef", "_OwnAcctTrfInd"]
	@property
	def OrgnlCost(self):
