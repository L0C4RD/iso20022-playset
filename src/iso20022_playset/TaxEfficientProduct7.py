...
class TaxEfficientProduct7(base_types._BaseFieldType):
	...
	__slots__ = ["_CshCmpntInd", "_EstmtdVal", "_PrvsYrsSbcptAmt", "_CurYr", "_InvstmtsToFllwVal", "_OthrAmt", "_PrvsYrs", "_InvstrTaxRef", "_TtlSbcptAmt", "_TaxEffcntPdctTp", "_CurYrSbcptDtls", "_TaxClctnBase", "_AddtlInf", "_CurInvstmtAmt", "_DtOfFrstSbcpt", "_TrfrAltrnId", "_BnsOrWdrwl", "_WdrwlForResdtlPurchsPrgrs", "_DtFrstQlfygAddtn", "_InnvtvFinc", "_LwstInvstdAmtCurYr", "_PrvsYrSbcptAmt", "_UusdTaxDdctn"]
	@property
