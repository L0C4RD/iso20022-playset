...
class TaxEfficientProduct7(base_types._BaseFieldType):
	...
	__slots__ = ["_TrfrAltrnId", "_WdrwlForResdtlPurchsPrgrs", "_CurYrSbcptDtls", "_OthrAmt", "_LwstInvstdAmtCurYr", "_TaxEffcntPdctTp", "_PrvsYrs", "_PrvsYrsSbcptAmt", "_CurInvstmtAmt", "_DtOfFrstSbcpt", "_AddtlInf", "_CshCmpntInd", "_InnvtvFinc", "_EstmtdVal", "_CurYr", "_UusdTaxDdctn", "_DtFrstQlfygAddtn", "_BnsOrWdrwl", "_TaxClctnBase", "_TtlSbcptAmt", "_InvstrTaxRef", "_PrvsYrSbcptAmt", "_InvstmtsToFllwVal"]
	@property
