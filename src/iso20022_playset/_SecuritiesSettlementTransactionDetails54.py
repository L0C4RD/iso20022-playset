...
class SecuritiesSettlementTransactionDetails54(base_types._BaseFieldType):
	...
	__slots__ = ["_StgSttlmInstrDtls", "_SplmtryData", "_AddtlPhysOrRegnDtls", "_OthrAmts", "_CshPties", "_QtyAndAcctDtls", "_SttlmTpAndAddtlParams", "_Lnkgs", "_SttlmParams", "_DlvrgSttlmPties", "_FinInstrmAttrbts", "_TradDtls", "_OthrBizPties", "_SttlmAmt", "_RcvgSttlmPties"]
	@property
