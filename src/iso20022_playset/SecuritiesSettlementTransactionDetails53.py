...
class SecuritiesSettlementTransactionDetails53(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmParams", "_RcvgSttlmPties", "_Lnkgs", "_TradDtls", "_FinInstrmAttrbts", "_OthrBizPties", "_SplmtryData", "_SttlmTpAndAddtlParams", "_OthrAmts", "_SttlmAmt", "_CshPties", "_QtyAndAcctDtls", "_DlvrgSttlmPties", "_AddtlPhysOrRegnDtls", "_StgSttlmInstrDtls"]
	@property
