...
class SecuritiesSettlementTransactionDetails53(base_types._BaseFieldType):
	...
	__slots__ = ["_CshPties", "_QtyAndAcctDtls", "_SttlmParams", "_Lnkgs", "_RcvgSttlmPties", "_OthrBizPties", "_TradDtls", "_AddtlPhysOrRegnDtls", "_StgSttlmInstrDtls", "_OthrAmts", "_FinInstrmAttrbts", "_DlvrgSttlmPties", "_SttlmTpAndAddtlParams", "_SttlmAmt", "_SplmtryData"]
	@property
	def CshPties(self):
