...
class SecuritiesSettlementTransactionDetails53(base_types._BaseFieldType):
	...
	__slots__ = ["_CshPties", "_AddtlPhysOrRegnDtls", "_TradDtls", "_FinInstrmAttrbts", "_SplmtryData", "_Lnkgs", "_StgSttlmInstrDtls", "_DlvrgSttlmPties", "_RcvgSttlmPties", "_SttlmTpAndAddtlParams", "_OthrBizPties", "_OthrAmts", "_QtyAndAcctDtls", "_SttlmParams", "_SttlmAmt"]
	@property
	def CshPties(self):
