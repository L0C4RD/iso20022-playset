...
class SecuritiesSettlementTransactionDetails53(base_types._BaseFieldType):
	...
	__slots__ = ["_Lnkgs", "_StgSttlmInstrDtls", "_SttlmAmt", "_FinInstrmAttrbts", "_OthrBizPties", "_CshPties", "_DlvrgSttlmPties", "_OthrAmts", "_SttlmTpAndAddtlParams", "_QtyAndAcctDtls", "_SplmtryData", "_SttlmParams", "_RcvgSttlmPties", "_AddtlPhysOrRegnDtls", "_TradDtls"]
	@property
	def Lnkgs(self):
		return self._Lnkgs
