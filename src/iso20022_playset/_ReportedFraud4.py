...
class ReportedFraud4(base_types._BaseFieldType):
	...
	__slots__ = ["_SubmitrCaseRef", "_Tp", "_CaseRef", "_InvstgtnSts", "_Actn", "_ConfRptgDt", "_CaseLctrNb", "_OthrRptgNtty", "_OthrTp", "_Arrst", "_CrdhldrRptgDt", "_RptgNtty", "_OthrActn", "_MktSgmt", "_CmprmsdCrdntl"]
	@property
