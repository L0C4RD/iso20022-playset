...
class IdentificationReference15Choice(base_types._BaseFieldType):

	__slots__ = ["_CollTxId", "_CmplcId", "_MktInfrstrctrTxId", "_PoolId", "_ExctgPtyTxId", "_InstgPtyTxId", "_IndxId", "_BlckId", "_AllcnId", "_CmonId", "_IndvAllcnId", "_ClntOrdrLkId", "_ScndryAllcnId", "_UnqTxIdr"]
	@property
	def AllcnId(self):
