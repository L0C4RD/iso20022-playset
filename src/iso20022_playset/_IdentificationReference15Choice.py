...
class IdentificationReference15Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_AllcnId", "_BlckId", "_ClntOrdrLkId", "_CmonId", "_CmplcId", "_CollTxId", "_ExctgPtyTxId", "_IndvAllcnId", "_IndxId", "_InstgPtyTxId", "_MktInfrstrctrTxId", "_PoolId", "_ScndryAllcnId", "_UnqTxIdr"]
	@property
	def AllcnId(self):
