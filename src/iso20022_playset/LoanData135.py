...
class LoanData135(base_types._BaseFieldType):
	...
	__slots__ = ["_MstrAgrmt", "_EvtDt", "_Term", "_PrncplAmt", "_ClrSts", "_CollDlvryMtd", "_ExctnDtTm", "_EarlstCallBckDt", "_UnqTradIdr", "_IntrstRate", "_TradgVn", "_TermntnDt", "_DlvryByVal", "_MinNtcePrd", "_GnlColl", "_ValDt"]
	@property
	def MstrAgrmt(self):
