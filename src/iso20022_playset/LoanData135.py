...
class LoanData135(base_types._BaseFieldType):
	...
	__slots__ = ["_TradgVn", "_MstrAgrmt", "_MinNtcePrd", "_DlvryByVal", "_CollDlvryMtd", "_PrncplAmt", "_EarlstCallBckDt", "_IntrstRate", "_UnqTradIdr", "_ClrSts", "_EvtDt", "_Term", "_TermntnDt", "_ExctnDtTm", "_ValDt", "_GnlColl"]
	@property
	def TradgVn(self):
