...
class LoanData135(base_types._BaseFieldType):
	...
	__slots__ = ["_IntrstRate", "_TradgVn", "_ClrSts", "_PrncplAmt", "_MstrAgrmt", "_DlvryByVal", "_EvtDt", "_GnlColl", "_UnqTradIdr", "_EarlstCallBckDt", "_ValDt", "_ExctnDtTm", "_Term", "_TermntnDt", "_MinNtcePrd", "_CollDlvryMtd"]
	@property
	def IntrstRate(self):
