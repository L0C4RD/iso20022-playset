...
class LoanData135(base_types._BaseFieldType):
	...
	__slots__ = ["_DlvryByVal", "_MinNtcePrd", "_EvtDt", "_TradgVn", "_ValDt", "_CollDlvryMtd", "_PrncplAmt", "_UnqTradIdr", "_IntrstRate", "_EarlstCallBckDt", "_Term", "_ClrSts", "_MstrAgrmt", "_ExctnDtTm", "_GnlColl", "_TermntnDt"]
	@property
	def DlvryByVal(self):
