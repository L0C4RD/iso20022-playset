...
class LoanData135(base_types._BaseFieldType):
	...
	__slots__ = ["_ExctnDtTm", "_TradgVn", "_ClrSts", "_PrncplAmt", "_GnlColl", "_DlvryByVal", "_IntrstRate", "_Term", "_ValDt", "_EarlstCallBckDt", "_UnqTradIdr", "_MinNtcePrd", "_TermntnDt", "_CollDlvryMtd", "_MstrAgrmt", "_EvtDt"]
	@property
	def ExctnDtTm(self):
