...
class TransactionAdviceResponseV07(base_types._BaseFieldType):
	...
	def TxAdvcRspn(self, value):
		self._TxAdvcRspn = value if value is not None else base_types.UninitialisedField(self, 'TxAdvcRspn', AcceptorCompletionAdviceResponse14, False)

	@TxAdvcRspn.deleter
	def TxAdvcRspn(self):
		del self._TxAdvcRspn
		self._TxAdvcRspn = base_types.UninitialisedField(self, 'TxAdvcRspn', AcceptorCompletionAdviceResponse14, False)
