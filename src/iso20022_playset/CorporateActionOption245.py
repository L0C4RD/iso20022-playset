...
class CorporateActionOption245(base_types._BaseFieldType):
	...
	__slots__ = ["_SctyId", "_AccptncPrtyLvl", "_AddtlInf", "_VldDmclCtry", "_PricDtls", "_ChrgsApldInd", "_OptnFeatrs", "_CcyOptn", "_NonDmclCtry", "_CshMvmntDtls", "_ChngAllwdInd", "_DtDtls", "_CertfctnBrkdwnTp", "_DfltPrcgOrStgInstr", "_CertfctnBrkdwnInd", "_RateAndAmtDtls", "_WdrwlAllwdInd", "_SctiesQty", "_PrdDtls", "_ApldOptnInd", "_OfferTp", "_OptnNb", "_SctiesMvmntDtls", "_OptnTp", "_FrctnDspstn", "_OptnAvlbtySts"]
	@property
	def SctyId(self):
		return self._SctyId
