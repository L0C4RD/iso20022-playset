...
class CorporateActionOption245(base_types._BaseFieldType):
	...
	__slots__ = ["_CshMvmntDtls", "_SctyId", "_VldDmclCtry", "_NonDmclCtry", "_PricDtls", "_AddtlInf", "_CertfctnBrkdwnInd", "_OptnFeatrs", "_CcyOptn", "_RateAndAmtDtls", "_DfltPrcgOrStgInstr", "_OptnAvlbtySts", "_DtDtls", "_AccptncPrtyLvl", "_ChngAllwdInd", "_OptnTp", "_ChrgsApldInd", "_WdrwlAllwdInd", "_CertfctnBrkdwnTp", "_ApldOptnInd", "_PrdDtls", "_OptnNb", "_SctiesQty", "_SctiesMvmntDtls", "_FrctnDspstn", "_OfferTp"]
	@property
