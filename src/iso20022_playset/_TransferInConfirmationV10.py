...
from . import DeliverInformation23
...
class TransferInConfirmationV10(base_types._BaseFieldType):
	...
	def SttlmDtls(self, value):
		self._SttlmDtls = value if value is not None else base_types.UninitialisedField(self, 'SttlmDtls', DeliverInformation23, False)

	@SttlmDtls.deleter
	def SttlmDtls(self):
		del self._SttlmDtls
		self._SttlmDtls = base_types.UninitialisedField(self, 'SttlmDtls', DeliverInformation23, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='SttlmDtls', type=DeliverInformation23, min=0, max=1, mutex_group=None, array=False),
