...
class IndividualPerson44(base_types._BaseFieldType):
	...
	__slots__ = ["_CtryOfBirth", "_BirthDt", "_Lang", "_CtryAndResdtlSts", "_ScndryComAdr", "_OthrDtls", "_PrvcOfBirth", "_CurNm", "_OthrId", "_SclSctyNb", "_PmryComAdr", "_TaxtnCtry", "_PstlAdr", "_Gndr", "_CtznshInf", "_PrvsNm", "_CityOfBirth"]
	@property
