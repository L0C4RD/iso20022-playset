...
class IndividualPerson44(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrId", "_SclSctyNb", "_Lang", "_Gndr", "_PrvsNm", "_CityOfBirth", "_CtryAndResdtlSts", "_PstlAdr", "_PrvcOfBirth", "_CtryOfBirth", "_TaxtnCtry", "_PmryComAdr", "_BirthDt", "_OthrDtls", "_CtznshInf", "_ScndryComAdr", "_CurNm"]
	@property
	def OthrId(self):
		return self._OthrId
