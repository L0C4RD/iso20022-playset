...
class MessageStatusResponseData9(base_types._BaseFieldType):
	...
	__slots__ = ["_TxRspn", "_RpeatdLltyRspn", "_RpeatdPmtRspn", "_RpeatdStordValRspn", "_XchgId", "_RpeatdCardAcqstnRspn", "_RpeatdSndApplPrtcolDataUnitCardRdrRspn", "_RpeatdRvslRspn", "_InitgPty"]
	@property
	def TxRspn(self):
		return self._TxRspn
