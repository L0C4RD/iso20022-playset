...
class MessageStatusResponseData9(base_types._BaseFieldType):
	...
	__slots__ = ["_RpeatdLltyRspn", "_RpeatdPmtRspn", "_XchgId", "_RpeatdRvslRspn", "_RpeatdStordValRspn", "_RpeatdSndApplPrtcolDataUnitCardRdrRspn", "_RpeatdCardAcqstnRspn", "_TxRspn", "_InitgPty"]
	@property
