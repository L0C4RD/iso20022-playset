...
class PaymentTransaction152(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlEndToEndId", "_Assgnr", "_OrgnlClrSysRef", "_OrgnlTxRef", "_Assgne", "_TxCxlSts", "_OrgnlIntrBkSttlmDt", "_RslvdCase", "_OrgnlUETR", "_CxlStsRsnInf", "_OrgnlGrpInf", "_RsltnRltdInf", "_OrgnlTxId", "_CxlStsId", "_OrgnlIntrBkSttlmAmt", "_OrgnlInstrId"]
	@property
