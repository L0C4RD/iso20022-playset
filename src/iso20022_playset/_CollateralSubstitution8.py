...
from . import SecuritiesCollateral12
...
class CollateralSubstitution8(base_types._BaseFieldType):
	...
	def SctiesColl(self, value):
		self._SctiesColl = value if value is not None else base_types.UninitialisedField(self, 'SctiesColl', SecuritiesCollateral12, True)

	@SctiesColl.deleter
	def SctiesColl(self):
		del self._SctiesColl
		self._SctiesColl = base_types.UninitialisedField(self, 'SctiesColl', SecuritiesCollateral12, True)
