...
class PortfolioTransferConfirmationV11(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrCorpInvstr", "_PmryIndvInvstr", "_ScndryCorpInvstr", "_Trfee", "_PoolRef", "_RltdRef", "_PrvsRef", "_MktPrctcVrsn", "_NmneeAcct", "_TrfrAcct", "_PmryCorpInvstr", "_MsgRef", "_RegdHldr", "_OthrIndvInvstr", "_PdctTrf", "_Xtnsn", "_ScndryIndvInvstr"]
	@property
