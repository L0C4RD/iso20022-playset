...
class SecuritiesFinancingTransactionDetails53(base_types._BaseFieldType):
	...
	__slots__ = ["_PlcOfTrad", "_RcvgSttlmPties", "_VarblRateSpprt", "_RateChngDt", "_RpRate", "_Pmt", "_RateTp", "_DlvrgSttlmPties", "_SttlmQty", "_XpctdSttlmDt", "_SttlmParams", "_TrptyAgtSvcPrvdrCollTxId", "_AcctOwnr", "_ClntTrptyCollTxId", "_LateDlvryDt", "_SctiesMvmntTp", "_BlckChainAdrOrWllt", "_ClsgLegId", "_XpctdValDt", "_CorpActnEvtId", "_TradDt", "_PricgRate", "_TermntnDt", "_SctiesFincgTxTp", "_PoolId", "_TermntnTxAmt", "_SfkpgPlc", "_OpngSttlmDt", "_Invstr", "_Sprd", "_OpngSttlmAmt", "_SctiesFincgTradId", "_StockLnMrgn", "_SfkpgAcct", "_SttlmInstrPrcgAddtlDtls", "_SctiesHrcut", "_FinInstrmId"]
	@property
	def PlcOfTrad(self):
