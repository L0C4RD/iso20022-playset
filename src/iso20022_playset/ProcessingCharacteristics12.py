...
class ProcessingCharacteristics12(base_types._BaseFieldType):
	...
	__slots__ = ["_DealgFrqcy", "_DealConfTm", "_UnitsInd", "_DealConfTmFrame", "_AmtInd", "_DealgCutOffTmFrame", "_AddtlInf", "_PctgInd", "_DealgFrqcyDesc", "_SttlmCycl", "_LtdPrd", "_DealgCcyAccptd", "_DealgCutOffTm", "_RedAuthstn", "_Rndg", "_MainFndOrdrDskLctn"]
	@property
	def DealgFrqcy(self):
