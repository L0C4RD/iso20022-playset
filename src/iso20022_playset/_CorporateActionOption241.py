...
class CorporateActionOption241(base_types._BaseFieldType):
	...
	__slots__ = ["_BlckChainAdrOrWllt", "_FinInstrmId", "_InstdBal", "_UinstdBal", "_StsCshAmt", "_OptnNb", "_PrtctBal", "_StsQty", "_CshAcct", "_OptnTp", "_SfkpgAcct", "_AcctOwnr", "_OptnFeatrs", "_TtlElgblBal", "_SfkpgPlc"]
	@property
