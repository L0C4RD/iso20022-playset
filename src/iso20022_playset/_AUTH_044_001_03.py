...
from . import FinancialInstrumentReportingEquityTradingActivityResultV03
...
class AUTH_044_001_03():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def FinInstrmRptgEqtyTradgActvtyRslt(self, value):
			self._FinInstrmRptgEqtyTradgActvtyRslt = value if value is not None else base_types.UninitialisedField(self, 'FinInstrmRptgEqtyTradgActvtyRslt', FinancialInstrumentReportingEquityTradingActivityResultV03, False)

		@FinInstrmRptgEqtyTradgActvtyRslt.deleter
		def FinInstrmRptgEqtyTradgActvtyRslt(self):
			del self._FinInstrmRptgEqtyTradgActvtyRslt
			self._FinInstrmRptgEqtyTradgActvtyRslt = base_types.UninitialisedField(self, 'FinInstrmRptgEqtyTradgActvtyRslt', FinancialInstrumentReportingEquityTradingActivityResultV03, False)
