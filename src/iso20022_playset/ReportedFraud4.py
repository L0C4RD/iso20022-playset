...
class ReportedFraud4(base_types._BaseFieldType):
	...
	__slots__ = ["_ConfRptgDt", "_MktSgmt", "_Actn", "_OthrRptgNtty", "_CaseRef", "_OthrTp", "_CmprmsdCrdntl", "_CrdhldrRptgDt", "_RptgNtty", "_OthrActn", "_SubmitrCaseRef", "_Arrst", "_InvstgtnSts", "_CaseLctrNb", "_Tp"]
	@property
	def ConfRptgDt(self):
