...
class ReportedFraud4(base_types._BaseFieldType):
	...
	__slots__ = ["_ConfRptgDt", "_CaseLctrNb", "_OthrActn", "_CaseRef", "_Arrst", "_CmprmsdCrdntl", "_OthrTp", "_CrdhldrRptgDt", "_MktSgmt", "_InvstgtnSts", "_OthrRptgNtty", "_Actn", "_Tp", "_RptgNtty", "_SubmitrCaseRef"]
	@property
	def ConfRptgDt(self):
