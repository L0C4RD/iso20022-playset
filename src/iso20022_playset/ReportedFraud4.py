...
class ReportedFraud4(base_types._BaseFieldType):
	...
	__slots__ = ["_MktSgmt", "_InvstgtnSts", "_Tp", "_Arrst", "_CmprmsdCrdntl", "_CaseRef", "_ConfRptgDt", "_OthrTp", "_CaseLctrNb", "_RptgNtty", "_Actn", "_CrdhldrRptgDt", "_SubmitrCaseRef", "_OthrRptgNtty", "_OthrActn"]
	@property
	def MktSgmt(self):
