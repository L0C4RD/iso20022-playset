...
class Plan3(base_types._BaseFieldType):
	...
	__slots__ = ["_PmtTp", "_NbOfPrds", "_NrmlPmtAmt", "_IntrstRate", "_NbOfGracePrdUnits", "_TtlNbOfPmts", "_PrdUnit", "_GrdTtlAmt", "_Ccy", "_FrstPmtDt", "_CstmrSelctdGracePrd", "_DfrrdPrds", "_Id", "_OwnrNm", "_AddtlData", "_OthrOwnr", "_Dfrrd", "_AmtDtls", "_FrstAmt", "_RegnSysId", "_OthrGracePrdUnitTp", "_Ownr", "_GracePrdUnitTp"]
	@property
	def PmtTp(self):
		return self._PmtTp
