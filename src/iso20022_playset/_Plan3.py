...
class Plan3(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrOwnr", "_Ccy", "_NrmlPmtAmt", "_GracePrdUnitTp", "_Id", "_Dfrrd", "_RegnSysId", "_AmtDtls", "_TtlNbOfPmts", "_GrdTtlAmt", "_PrdUnit", "_OthrGracePrdUnitTp", "_AddtlData", "_FrstAmt", "_NbOfGracePrdUnits", "_NbOfPrds", "_PmtTp", "_Ownr", "_CstmrSelctdGracePrd", "_IntrstRate", "_OwnrNm", "_FrstPmtDt", "_DfrrdPrds"]
	@property
	def OthrOwnr(self):
