...
class ProcessingResult30(base_types._BaseFieldType):

	__slots__ = ["_ActnCd", "_ErrDtl", "_NtlData", "_PrvtData", "_RspnCd", "_RspnRsn", "_RspnSrcCtry", "_RspnSrcId", "_RspnSrcNm", "_RspnSrcTp"]
	@property
	def ActnCd(self):
		return self._ActnCd
