...
import Organisation36
import PortfolioTransfer10
import MessageIdentification1
import AdditionalReference11
import IndividualPerson8
import PartyIdentification132
import InvestmentAccount69
import AdditionalReference10

class PortfolioTransferConfirmationV11(base_types._BaseFieldType):

	__slots__ = ["_PdctTrf", "_OthrCorpInvstr", "_PmryCorpInvstr", "_MktPrctcVrsn", "_RegdHldr", "_PoolRef", "_RltdRef", "_PmryIndvInvstr", "_TrfrAcct", "_MsgRef", "_Trfee", "_OthrIndvInvstr", "_PrvsRef", "_ScndryIndvInvstr", "_NmneeAcct", "_ScndryCorpInvstr", "_Xtnsn"]
	@property
	def PdctTrf(self):
	...
	def RegdHldr(self, value):
		self._RegdHldr = value if type(value) != auto else self.make_default("RegdHldr")
	...
	_field_defs = frozenset((
		base_types.FieldEntry(name='PdctTrf', type=PortfolioTransfer10, min=1, max=None, mutex_group=None, array=True),
