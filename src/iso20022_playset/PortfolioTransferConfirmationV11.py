...
class PortfolioTransferConfirmationV11(base_types._BaseFieldType):
	...
	__slots__ = ["_PmryCorpInvstr", "_Xtnsn", "_Trfee", "_OthrCorpInvstr", "_RegdHldr", "_TrfrAcct", "_MsgRef", "_PoolRef", "_ScndryCorpInvstr", "_MktPrctcVrsn", "_PmryIndvInvstr", "_RltdRef", "_PdctTrf", "_OthrIndvInvstr", "_NmneeAcct", "_PrvsRef", "_ScndryIndvInvstr"]
	@property
