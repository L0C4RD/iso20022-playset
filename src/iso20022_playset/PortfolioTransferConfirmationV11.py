...
from .PortfolioTransfer10 import PortfolioTransfer10
...
class PortfolioTransferConfirmationV11(base_types._BaseFieldType):
	...
	__slots__ = ["_Xtnsn", "_ScndryCorpInvstr", "_PmryIndvInvstr", "_Trfee", "_RltdRef", "_OthrCorpInvstr", "_RegdHldr", "_MsgRef", "_PrvsRef", "_MktPrctcVrsn", "_PmryCorpInvstr", "_ScndryIndvInvstr", "_PoolRef", "_TrfrAcct", "_OthrIndvInvstr", "_PdctTrf", "_NmneeAcct"]
	@property
	def Xtnsn(self):
		return self._Xtnsn
