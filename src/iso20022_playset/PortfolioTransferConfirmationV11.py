...
class PortfolioTransferConfirmationV11(base_types._BaseFieldType):
	...
	__slots__ = ["_MsgRef", "_RegdHldr", "_TrfrAcct", "_Xtnsn", "_RltdRef", "_NmneeAcct", "_PoolRef", "_PmryIndvInvstr", "_Trfee", "_PdctTrf", "_PrvsRef", "_OthrCorpInvstr", "_ScndryIndvInvstr", "_MktPrctcVrsn", "_PmryCorpInvstr", "_ScndryCorpInvstr", "_OthrIndvInvstr"]
	@property
	def MsgRef(self):
		return self._MsgRef
