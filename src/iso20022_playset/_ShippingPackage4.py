...
class ShippingPackage4(base_types._BaseFieldType):
	...
	__slots__ = ["_DlvryAdr", "_DlvryCtct", "_DlvryDt", "_DlvryInstrs", "_DlvryNoteNb", "_DlvryTm", "_Insrnc", "_InsrncAmt", "_NbOfUnits", "_OthrWghtUnit", "_PckpDt", "_PckpTm", "_Pdct", "_SpplrAdr", "_SpplrBizNm", "_SpplrCtct", "_SpplrId", "_SpplrInstrs", "_SpplrLclData", "_SpplrLglCorpNm", "_SpplrNm", "_TrckgNb", "_WghtUnit"]
	@property
	def DlvryAdr(self):
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='SpplrAdr', type=Address4, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='SpplrBizNm', type=Max35Text, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='SpplrCtct', type=ContactBusiness2, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='SpplrId', type=Max35Text, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='SpplrInstrs', type=Max350Text, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='SpplrLclData', type=LocalData20, min=0, max=None, mutex_group=None, array=True),
		base_types.FieldEntry(name='SpplrLglCorpNm', type=Max99Text, min=0, max=1, mutex_group=None, array=False),
