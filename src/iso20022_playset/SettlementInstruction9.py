...
class SettlementInstruction9(base_types._BaseFieldType):
	...
	__slots__ = ["_ThrdRmbrsmntAgtAcct", "_SttlmAcct", "_ClrSys", "_ThrdRmbrsmntAgt", "_InstdRmbrsmntAgt", "_SttlmMtd", "_InstgRmbrsmntAgt", "_InstdRmbrsmntAgtAcct", "_InstgRmbrsmntAgtAcct"]
	@property
