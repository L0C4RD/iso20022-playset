...
class SettlementInstruction9(base_types._BaseFieldType):
	...
	__slots__ = ["_ThrdRmbrsmntAgtAcct", "_SttlmAcct", "_SttlmMtd", "_ClrSys", "_ThrdRmbrsmntAgt", "_InstgRmbrsmntAgtAcct", "_InstdRmbrsmntAgt", "_InstgRmbrsmntAgt", "_InstdRmbrsmntAgtAcct"]
	@property
