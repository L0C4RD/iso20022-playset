...
class CustomerAccountModification1(base_types._BaseFieldType):
	...
	__slots__ = ["_MnthlyPmtVal", "_AvrgBal", "_StmtFrqcyAndFrmt", "_Rstrctn", "_MnthlyTxNb", "_FlrNtfctnAmt", "_AcctPurp", "_Id", "_ClsgDt", "_ClngNtfctnAmt", "_Sts", "_MnthlyRcvdVal", "_Nm", "_Tp", "_Ccy"]
	@property
