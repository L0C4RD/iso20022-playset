...
class CustomerAccountModification1(base_types._BaseFieldType):
	...
	__slots__ = ["_Nm", "_ClsgDt", "_AvrgBal", "_Rstrctn", "_Id", "_ClngNtfctnAmt", "_MnthlyPmtVal", "_MnthlyRcvdVal", "_Ccy", "_Tp", "_FlrNtfctnAmt", "_MnthlyTxNb", "_StmtFrqcyAndFrmt", "_Sts", "_AcctPurp"]
	@property
	def Nm(self):
		return self._Nm
