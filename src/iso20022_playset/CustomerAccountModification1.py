...
class CustomerAccountModification1(base_types._BaseFieldType):
	...
	__slots__ = ["_Sts", "_Ccy", "_MnthlyPmtVal", "_MnthlyTxNb", "_FlrNtfctnAmt", "_Nm", "_ClngNtfctnAmt", "_AcctPurp", "_Rstrctn", "_Tp", "_Id", "_AvrgBal", "_StmtFrqcyAndFrmt", "_MnthlyRcvdVal", "_ClsgDt"]
	@property
	def Sts(self):
		return self._Sts
