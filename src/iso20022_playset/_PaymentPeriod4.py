...
class PaymentPeriod4(base_types._BaseFieldType):
	...
	@Cd.setter
	def Cd(self, value):
		self._Cd = value if value is not None else base_types.UninitialisedField(self, 'Cd', PaymentTime4Code, False)

	@Cd.deleter
	def Cd(self):
		del self._Cd
		self._Cd = base_types.UninitialisedField(self, 'Cd', PaymentTime4Code, False)
	...
	_field_defs = frozenset((
		base_types.FieldEntry(name='Cd', type=PaymentTime4Code, min=1, max=1, mutex_group=None, array=False),
