...
from .PortfolioTransfer12 import PortfolioTransfer12
from .InvestmentAccount69 import InvestmentAccount69

class AccountHoldingInformationRequestV08(base_types._BaseFieldType):

	__slots__ = ["_Xtnsn", "_ScndryCorpInvstr", "_PmryIndvInvstr", "_Trfee", "_RltdRef", "_OthrCorpInvstr", "_MsgRef", "_PrvsRef", "_MktPrctcVrsn", "_PmryCorpInvstr", "_ScndryIndvInvstr", "_PoolRef", "_TrfrAcct", "_PdctTrf", "_BizFlowDrctnTp", "_OthrIndvInvstr", "_NmneeAcct"]
	@property
	def Xtnsn(self):
		return self._Xtnsn
