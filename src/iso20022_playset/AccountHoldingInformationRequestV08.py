...
class AccountHoldingInformationRequestV08(base_types._BaseFieldType):
	...
	__slots__ = ["_PmryCorpInvstr", "_Xtnsn", "_Trfee", "_OthrCorpInvstr", "_TrfrAcct", "_MsgRef", "_PdctTrf", "_PoolRef", "_ScndryCorpInvstr", "_BizFlowDrctnTp", "_PmryIndvInvstr", "_MktPrctcVrsn", "_RltdRef", "_OthrIndvInvstr", "_NmneeAcct", "_PrvsRef", "_ScndryIndvInvstr"]
	@property
