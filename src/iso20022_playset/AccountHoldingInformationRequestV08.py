...
import PortfolioTransfer12
import Organisation36
import BusinessFlowDirectionType1Code
...
class AccountHoldingInformationRequestV08(base_types._BaseFieldType):
	...
	__slots__ = ["_BizFlowDrctnTp", "_MsgRef", "_TrfrAcct", "_Xtnsn", "_RltdRef", "_NmneeAcct", "_PoolRef", "_PmryIndvInvstr", "_Trfee", "_PrvsRef", "_OthrCorpInvstr", "_ScndryIndvInvstr", "_MktPrctcVrsn", "_PmryCorpInvstr", "_ScndryCorpInvstr", "_OthrIndvInvstr", "_PdctTrf"]
	@property
