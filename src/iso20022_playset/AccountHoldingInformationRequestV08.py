...
class AccountHoldingInformationRequestV08(base_types._BaseFieldType):
	...
	__slots__ = ["_MktPrctcVrsn", "_ScndryCorpInvstr", "_RltdRef", "_PrvsRef", "_PdctTrf", "_BizFlowDrctnTp", "_TrfrAcct", "_PmryCorpInvstr", "_NmneeAcct", "_Xtnsn", "_PmryIndvInvstr", "_Trfee", "_PoolRef", "_MsgRef", "_ScndryIndvInvstr", "_OthrIndvInvstr", "_OthrCorpInvstr"]
	@property
