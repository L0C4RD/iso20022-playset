...
class AccountHoldingInformationRequestV08(base_types._BaseFieldType):
	...
	__slots__ = ["_PmryCorpInvstr", "_PmryIndvInvstr", "_Trfee", "_Xtnsn", "_PrvsRef", "_TrfrAcct", "_ScndryIndvInvstr", "_RltdRef", "_PoolRef", "_NmneeAcct", "_ScndryCorpInvstr", "_MsgRef", "_BizFlowDrctnTp", "_PdctTrf", "_OthrCorpInvstr", "_MktPrctcVrsn", "_OthrIndvInvstr"]
	@property
