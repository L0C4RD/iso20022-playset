...
class AccountHoldingInformationRequestV08(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrCorpInvstr", "_PmryCorpInvstr", "_MktPrctcVrsn", "_PoolRef", "_RltdRef", "_PmryIndvInvstr", "_TrfrAcct", "_MsgRef", "_Trfee", "_BizFlowDrctnTp", "_OthrIndvInvstr", "_PrvsRef", "_ScndryIndvInvstr", "_PdctTrf", "_NmneeAcct", "_ScndryCorpInvstr", "_Xtnsn"]
	@property
