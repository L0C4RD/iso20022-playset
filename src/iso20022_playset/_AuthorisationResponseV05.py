...
from ._PromotionData1 import PromotionData1
...
from ._TransactionSpecificData2 import TransactionSpecificData2
from ._TransactorData1 import TransactorData1
from ._Verification9 import Verification9
from ._Wallet4 import Wallet4

class AuthorisationResponseV05(base_types._BaseFieldType):

	__slots__ = ["_Accptr", "_AcctBal", "_AcctFr", "_AcctTo", "_Acqrr", "_AddtlAmt", "_AddtlFee", "_AddtlSvc", "_AuthntcnData", "_Bnfts", "_Card", "_Cntxt", "_ConvsDtTm", "_Crdhldr", "_Dstn", "_FndsSvcs", "_Hdr", "_ICCRltdData", "_Instlmt", "_Issr", "_Jursdctn", "_NtlData", "_OrgnlDataElmts", "_Orgtr", "_PrcgRslt", "_Prgrmm", "_Prmtn", "_PrtctdData", "_PrvtData", "_Pyee", "_Pyer", "_Rcncltn", "_RcrngPmt", "_Rcvr", "_Rsk", "_SctyTrlr", "_Sndr", "_SpclPrgrmmQlfctn", "_StrngCstmrAuthntcn", "_SttlmSvc", "_Tax", "_Termnl", "_Tkn", "_TxAmts", "_TxChrtcs", "_TxId", "_TxSpcfcData", "_Txtr", "_Vrfctn", "_Wllt"]
	@property
	def Accptr(self):
		return self._Accptr
	...
	def Prmtn(self, value):
		self._Prmtn = value if type(value) != base_types.auto else self.make_default("Prmtn")
	...
	def TxSpcfcData(self, value):
		self._TxSpcfcData = value if type(value) != base_types.auto else self.make_default("TxSpcfcData")

	@TxSpcfcData.deleter
	def TxSpcfcData(self):
		del self._TxSpcfcData
		self._TxSpcfcData = None
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='PrcgRslt', type=ProcessingResult29, min=1, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='TxSpcfcData', type=TransactionSpecificData2, min=0, max=1, mutex_group=None, array=False),
