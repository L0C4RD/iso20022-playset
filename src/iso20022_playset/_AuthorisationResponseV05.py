...
class AuthorisationResponseV05(base_types._BaseFieldType):
	...
	def TxSpcfcData(self, value):
		self._TxSpcfcData = value if value is not None else base_types.UninitialisedField(self, 'TxSpcfcData', TransactionSpecificData2, False)

	@TxSpcfcData.deleter
	def TxSpcfcData(self):
		del self._TxSpcfcData
		self._TxSpcfcData = base_types.UninitialisedField(self, 'TxSpcfcData', TransactionSpecificData2, False)
