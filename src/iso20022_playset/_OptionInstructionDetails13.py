...
from . import ISODate
from . import InstructionProcessingStatus62Choice
...
class OptionInstructionDetails13(base_types._BaseFieldType):
	...
	def InstrSts(self, value):
		self._InstrSts = value if value is not None else base_types.UninitialisedField(self, 'InstrSts', InstructionProcessingStatus62Choice, False)

	@InstrSts.deleter
	def InstrSts(self):
		del self._InstrSts
		self._InstrSts = base_types.UninitialisedField(self, 'InstrSts', InstructionProcessingStatus62Choice, False)
