...
class CashOption110(base_types._BaseFieldType):
	...
	__slots__ = ["_XmptnTp", "_IssrOfferrTaxbltyInd", "_IncmTp", "_PricDtls", "_Acct", "_CtrctlPmtInd", "_OthrIncmTp", "_FXDtls", "_CtryOfIncmSrc", "_DtDtls", "_RateAndAmtDtls", "_AmtDtls", "_CdtDbtInd", "_CshPties", "_TaxVchrDtls"]
	@property
	def XmptnTp(self):
