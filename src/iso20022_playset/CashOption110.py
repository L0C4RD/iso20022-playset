...
class CashOption110(base_types._BaseFieldType):
	...
	__slots__ = ["_CshPties", "_Acct", "_DtDtls", "_CdtDbtInd", "_XmptnTp", "_AmtDtls", "_CtryOfIncmSrc", "_CtrctlPmtInd", "_IssrOfferrTaxbltyInd", "_IncmTp", "_FXDtls", "_TaxVchrDtls", "_RateAndAmtDtls", "_OthrIncmTp", "_PricDtls"]
	@property
	def CshPties(self):
