...
from . import DeliverInformation22
from . import Extension1
from . import InvestmentAccount83
from . import MarketPracticeVersion1
from . import Max35Text
from . import MessageIdentification1
from . import Transfer39
from . import TransferInFunction1Code

class TransferInInstructionV10(base_types._BaseFieldType):
	...
	def AcctDtls(self, value):
		self._AcctDtls = value if value is not None else base_types.UninitialisedField(self, 'AcctDtls', InvestmentAccount83, False)

	@AcctDtls.deleter
	def AcctDtls(self):
		del self._AcctDtls
		self._AcctDtls = base_types.UninitialisedField(self, 'AcctDtls', InvestmentAccount83, False)
	...
	@Fctn.setter
	def Fctn(self, value):
		self._Fctn = value if value is not None else base_types.UninitialisedField(self, 'Fctn', TransferInFunction1Code, False)

	@Fctn.deleter
	def Fctn(self):
		del self._Fctn
		self._Fctn = base_types.UninitialisedField(self, 'Fctn', TransferInFunction1Code, False)
	...
	def SttlmDtls(self, value):
		self._SttlmDtls = value if value is not None else base_types.UninitialisedField(self, 'SttlmDtls', DeliverInformation22, False)

	@SttlmDtls.deleter
	def SttlmDtls(self):
		del self._SttlmDtls
		self._SttlmDtls = base_types.UninitialisedField(self, 'SttlmDtls', DeliverInformation22, False)
	...
	def TrfDtls(self, value):
		self._TrfDtls = value if value is not None else base_types.UninitialisedField(self, 'TrfDtls', Transfer39, True)

	@TrfDtls.deleter
	def TrfDtls(self):
		del self._TrfDtls
		self._TrfDtls = base_types.UninitialisedField(self, 'TrfDtls', Transfer39, True)
	...
	_field_defs = frozenset((
		base_types.FieldEntry(name='AcctDtls', type=InvestmentAccount83, min=1, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='SttlmDtls', type=DeliverInformation22, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='TrfDtls', type=Transfer39, min=1, max=None, mutex_group=None, array=True),
