...
from . import SecuritiesSettlementTransactionInstructionV12
...
class SESE_023_001_12():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def SctiesSttlmTxInstr(self, value):
			self._SctiesSttlmTxInstr = value if value is not None else base_types.UninitialisedField(self, 'SctiesSttlmTxInstr', SecuritiesSettlementTransactionInstructionV12, False)

		@SctiesSttlmTxInstr.deleter
		def SctiesSttlmTxInstr(self):
			del self._SctiesSttlmTxInstr
			self._SctiesSttlmTxInstr = base_types.UninitialisedField(self, 'SctiesSttlmTxInstr', SecuritiesSettlementTransactionInstructionV12, False)
