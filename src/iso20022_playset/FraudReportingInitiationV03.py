...
class FraudReportingInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlInf", "_Jursdctn", "_SplmtryData", "_CardNotRcvdDtls", "_AddtlData", "_Orgtr", "_Hdr", "_SttlmSvc", "_Acqrr", "_Card", "_Sndr", "_Prgrmm", "_Tkn", "_Dstn", "_RptdFrd", "_Rcncltn", "_Rcvr", "_SctyTrlr", "_Issr", "_PrtctdData", "_TxCrdhldrNm", "_FrdlntTxData", "_Crdhldr", "_LclData", "_AddtlFee", "_FrdTxId"]
	@property
	def AddtlInf(self):
