...
class FraudReportingInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_RptdFrd", "_SctyTrlr", "_AddtlData", "_Hdr", "_Sndr", "_Orgtr", "_FrdTxId", "_CardNotRcvdDtls", "_Jursdctn", "_Rcvr", "_Prgrmm", "_FrdlntTxData", "_AddtlFee", "_Acqrr", "_Dstn", "_SttlmSvc", "_TxCrdhldrNm", "_Rcncltn", "_PrtctdData", "_LclData", "_Issr", "_SplmtryData", "_Tkn", "_Card", "_AddtlInf", "_Crdhldr"]
	@property
	def RptdFrd(self):
