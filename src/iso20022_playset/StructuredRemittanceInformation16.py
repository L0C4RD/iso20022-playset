...
from .ReferredDocumentInformation7 import ReferredDocumentInformation7
from .CreditorReferenceInformation2 import CreditorReferenceInformation2
from .RemittanceAmount2 import RemittanceAmount2
from .TaxInformation7 import TaxInformation7
from .Max140Text import Max140Text
from .Garnishment3 import Garnishment3
...
class StructuredRemittanceInformation16(base_types._BaseFieldType):
	...
	__slots__ = ["_RfrdDocInf", "_Invcr", "_AddtlRmtInf", "_CdtrRefInf", "_TaxRmt", "_GrnshmtRmt", "_RfrdDocAmt", "_Invcee"]
	@property
	def RfrdDocInf(self):
