...
from .SecuritiesAccount25 import SecuritiesAccount25
from .BlockChainAddressWallet2 import BlockChainAddressWallet2
...
class SubAccountIdentification71(base_types._BaseFieldType):
	...
	__slots__ = ["_ActvtyInd", "_BalForSubAcct", "_AcctOwnr", "_BlckChainAdrOrWllt", "_SfkpgAcct"]
	@property
	def ActvtyInd(self):
