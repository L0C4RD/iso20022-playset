...
class FutureOrOptionDetails3(base_types._BaseFieldType):
	...
	__slots__ = ["_FutrAndOptnCtrctTp", "_MinTradgPricgIncrmt", "_NearTermPosLmt", "_AnncmntDt", "_LastDlvryDt", "_Ratio", "_CtrctSttlmMnth", "_FutrDt", "_FrstDealgDt", "_Ratg", "_SprdTx", "_Apprnc", "_StrpblInd", "_PosLmt", "_IssePric", "_OptnRghts", "_UnitOfMeasr", "_MinSz", "_Purp", "_LastTx"]
	@property
