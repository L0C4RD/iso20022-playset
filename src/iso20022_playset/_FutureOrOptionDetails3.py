...
class FutureOrOptionDetails3(base_types._BaseFieldType):
	...
	__slots__ = ["_FutrDt", "_Ratg", "_PosLmt", "_Apprnc", "_FrstDealgDt", "_StrpblInd", "_NearTermPosLmt", "_LastTx", "_OptnRghts", "_UnitOfMeasr", "_FutrAndOptnCtrctTp", "_Purp", "_IssePric", "_CtrctSttlmMnth", "_AnncmntDt", "_Ratio", "_LastDlvryDt", "_SprdTx", "_MinTradgPricgIncrmt", "_MinSz"]
	@property
	def FutrDt(self):
		return self._FutrDt
