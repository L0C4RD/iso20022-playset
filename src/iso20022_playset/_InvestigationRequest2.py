...
class InvestigationRequest2(base_types._BaseFieldType):
	...
	__slots__ = ["_InvstgtnSubTp", "_InvstgtnTp", "_EIR", "_MsgId", "_Undrlyg", "_Rqstr", "_Rspndr", "_ReqOrgtr", "_SvcLvl", "_UndrlygInstrm", "_ReqActn", "_RspndrInvstgtnId", "_RqstrInvstgtnId", "_XpctdRspndr"]
	@property
	def EIR(self):
		return self._EIR
