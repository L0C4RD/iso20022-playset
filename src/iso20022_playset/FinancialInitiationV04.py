...
class FinancialInitiationV04(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_TxAmts", "_Rsk", "_Accptr", "_AcctTo", "_Pyee", "_Card", "_AddtlSvc", "_ICCRltdData", "_TxId", "_Termnl", "_StrngCstmrAuthntcn", "_Dstn", "_AddtlData", "_PrcgRslt", "_DsptData", "_Acqrr", "_Hdr", "_SctyTrlr", "_AddtlAmt", "_AddtlFee", "_Issr", "_OrgnlDataElmts", "_Orgtr", "_Sndr", "_SpclPrgrmmQlfctn", "_AcctFr", "_AcctBal", "_Instlmt", "_Pyer", "_AdddmData", "_Wllt", "_Rcvr", "_Cstmr", "_Vrfctn", "_DpstDtls", "_XchgRate", "_ConvsDtTm", "_FndsSvcs", "_Rcncltn", "_Jursdctn", "_Tkn", "_OrgnlTx", "_CstmrDvc", "_POICmpnt", "_Crdhldr", "_Cntxt", "_Dcmnttn", "_PrtctdData", "_SttlmSvc", "_Prgrmm", "_TxChrtcs"]
	@property
