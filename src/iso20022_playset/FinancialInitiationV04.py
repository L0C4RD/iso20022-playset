...
from .TransactionIdentification55 import TransactionIdentification55
...
from .DisputeDocumentation1 import DisputeDocumentation1
...
class FinancialInitiationV04(base_types._BaseFieldType):

	__slots__ = ["_ICCRltdData", "_OrgnlTx", "_SctyTrlr", "_Hdr", "_Orgtr", "_Acqrr", "_PrcgRslt", "_Jursdctn", "_Rcvr", "_Pyee", "_Termnl", "_Accptr", "_Cntxt", "_CstmrDvc", "_Dstn", "_AddtlAmt", "_Rcncltn", "_TxChrtcs", "_Issr", "_DpstDtls", "_SplmtryData", "_FndsSvcs", "_TxId", "_Pyer", "_StrngCstmrAuthntcn", "_XchgRate", "_Instlmt", "_AddtlData", "_Sndr", "_Dcmnttn", "_AddtlSvc", "_AcctFr", "_Wllt", "_AcctTo", "_DsptData", "_OrgnlDataElmts", "_POICmpnt", "_SpclPrgrmmQlfctn", "_TxAmts", "_Cstmr", "_Prgrmm", "_AddtlFee", "_AdddmData", "_SttlmSvc", "_Vrfctn", "_PrtctdData", "_Rsk", "_ConvsDtTm", "_Card", "_Tkn", "_AcctBal", "_Crdhldr"]
	@property
	...
	def AdddmData(self, value):
		self._AdddmData = value if type(value) != auto else self.make_default("AdddmData")
