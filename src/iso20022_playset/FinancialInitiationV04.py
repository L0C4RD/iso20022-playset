...
class FinancialInitiationV04(base_types._BaseFieldType):
	...
	__slots__ = ["_PrcgRslt", "_DpstDtls", "_OrgnlTx", "_StrngCstmrAuthntcn", "_SpclPrgrmmQlfctn", "_AddtlData", "_Accptr", "_Issr", "_Vrfctn", "_XchgRate", "_Acqrr", "_Dstn", "_Cntxt", "_SplmtryData", "_Hdr", "_Pyer", "_Card", "_Prgrmm", "_AcctFr", "_AddtlSvc", "_Dcmnttn", "_Rcvr", "_AddtlAmt", "_Rcncltn", "_ConvsDtTm", "_AdddmData", "_TxAmts", "_Tkn", "_SttlmSvc", "_Wllt", "_SctyTrlr", "_Orgtr", "_AddtlFee", "_Pyee", "_Jursdctn", "_Cstmr", "_TxChrtcs", "_AcctTo", "_TxId", "_CstmrDvc", "_OrgnlDataElmts", "_Instlmt", "_DsptData", "_PrtctdData", "_FndsSvcs", "_ICCRltdData", "_Crdhldr", "_POICmpnt", "_AcctBal", "_Sndr", "_Rsk", "_Termnl"]
	@property
	def PrcgRslt(self):
