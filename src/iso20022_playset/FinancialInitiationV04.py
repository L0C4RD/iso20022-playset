...
class FinancialInitiationV04(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_Pyer", "_CstmrDvc", "_Prgrmm", "_FndsSvcs", "_ICCRltdData", "_TxId", "_Termnl", "_DsptData", "_AdddmData", "_SpclPrgrmmQlfctn", "_Rcvr", "_Rcncltn", "_Dcmnttn", "_SctyTrlr", "_PrtctdData", "_Crdhldr", "_Vrfctn", "_Acqrr", "_OrgnlTx", "_Card", "_AddtlFee", "_TxChrtcs", "_Jursdctn", "_TxAmts", "_AddtlData", "_Instlmt", "_ConvsDtTm", "_Orgtr", "_Hdr", "_AcctTo", "_Rsk", "_Wllt", "_OrgnlDataElmts", "_Sndr", "_Tkn", "_POICmpnt", "_PrcgRslt", "_Dstn", "_SttlmSvc", "_Pyee", "_Issr", "_AddtlAmt", "_AddtlSvc", "_Cntxt", "_XchgRate", "_Accptr", "_StrngCstmrAuthntcn", "_AcctBal", "_DpstDtls", "_AcctFr", "_Cstmr"]
	@property
