...
class FinancialInitiationV04(base_types._BaseFieldType):
	...
	__slots__ = ["_FndsSvcs", "_Instlmt", "_CstmrDvc", "_PrtctdData", "_AddtlSvc", "_AdddmData", "_Crdhldr", "_Prgrmm", "_ConvsDtTm", "_ICCRltdData", "_SpclPrgrmmQlfctn", "_Rcncltn", "_Accptr", "_AddtlData", "_Cntxt", "_Issr", "_OrgnlTx", "_OrgnlDataElmts", "_XchgRate", "_AcctBal", "_Wllt", "_TxAmts", "_DsptData", "_Acqrr", "_Hdr", "_TxId", "_Dstn", "_PrcgRslt", "_Termnl", "_Rcvr", "_Jursdctn", "_Pyee", "_SttlmSvc", "_Dcmnttn", "_Cstmr", "_Sndr", "_Pyer", "_Rsk", "_DpstDtls", "_Card", "_POICmpnt", "_AddtlFee", "_SplmtryData", "_AcctFr", "_Tkn", "_TxChrtcs", "_Orgtr", "_AddtlAmt", "_AcctTo", "_Vrfctn", "_SctyTrlr", "_StrngCstmrAuthntcn"]
	@property
	def FndsSvcs(self):
