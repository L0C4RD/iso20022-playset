...
class Event1(base_types._BaseFieldType):
	...
	def EvtDesc(self, value):
		self._EvtDesc = value if value is not None else base_types.UninitialisedField(self, 'EvtDesc', Max350Text, False)

	@EvtDesc.deleter
	def EvtDesc(self):
		del self._EvtDesc
		self._EvtDesc = base_types.UninitialisedField(self, 'EvtDesc', Max350Text, False)
