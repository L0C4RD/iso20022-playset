...
class TotalPortfolioValuation1(base_types._BaseFieldType):
	...
	__slots__ = ["_IncmRcvd", "_TtlBookVal", "_ExpnssPd", "_TtlPrtflValChng", "_TtlDsbrsmnts", "_PrvsTtlPrtflVal", "_TtlPrtflVal", "_RealsdGnOrLoss", "_InvstmtFndDtls", "_TtlRcts", "_TtlBookValChng", "_PrvsTtlBookVal", "_AcrdIncm", "_UrlsdGnOrLoss"]
	@property
	def IncmRcvd(self):
