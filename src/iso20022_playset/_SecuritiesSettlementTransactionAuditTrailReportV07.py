...
class SecuritiesSettlementTransactionAuditTrailReportV07(base_types._BaseFieldType):
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='StsTrl', type=StatusTrail13, min=0, max=None, mutex_group=None, array=True),
		base_types.FieldEntry(name='TxId', type=TransactionIdentifications56, min=0, max=1, mutex_group=None, array=False),
	))