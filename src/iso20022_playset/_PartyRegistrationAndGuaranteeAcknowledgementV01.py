...
class PartyRegistrationAndGuaranteeAcknowledgementV01(base_types._BaseFieldType):
	...
	__slots__ = ["_Hdr", "_AttchdMsg", "_CtrlSum", "_AckList", "_AckCnt", "_ItmCnt"]
	@property
	def AckCnt(self):
		return self._AckCnt
	...
	def AckCnt(self, value):
		self._AckCnt = value if type(value) != base_types.auto else self.make_default("AckCnt")
	...
	def AckList(self, value):
		self._AckList = value if type(value) != base_types.auto else self.make_default("AckList")
