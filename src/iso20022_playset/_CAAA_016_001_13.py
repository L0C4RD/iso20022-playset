...
from ._AcceptorCurrencyConversionRequestV13 import AcceptorCurrencyConversionRequestV13
...
class CAAA_016_001_13():
	...
	class Document(base_types._BaseFieldType):
		...
		attrib = {
			"xmlns" : base_types._BaseDataType_String(None, data="urn:iso:std:iso:20022:tech:xsd:caaa.016.001.13"),
		}
