...
class NumberOfTransactionsPerStatus5(base_types._BaseFieldType):
	...
	def DtldSts(self, value):
		self._DtldSts = value if value is not None else base_types.UninitialisedField(self, 'DtldSts', ExternalPaymentTransactionStatus1Code, False)

	@DtldSts.deleter
	def DtldSts(self):
		del self._DtldSts
		self._DtldSts = base_types.UninitialisedField(self, 'DtldSts', ExternalPaymentTransactionStatus1Code, False)
