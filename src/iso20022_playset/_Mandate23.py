...
class Mandate23(base_types._BaseFieldType):
	...
	__slots__ = ["_CdtrAgt", "_RfrdDoc", "_Dbtr", "_MaxAmt", "_TrckgInd", "_UltmtCdtr", "_Authntcn", "_Rsn", "_MndtId", "_UltmtDbtr", "_ColltnAmt", "_MndtReqId", "_Cdtr", "_Tp", "_Adjstmnt", "_DbtrAgt", "_MndtRef", "_DbtrAcct", "_FrstColltnAmt", "_Ocrncs", "_SplmtryData", "_CdtrAcct", "_CdtrSchmeId"]
	@property
	def CdtrAgt(self):
