...
class Mandate23(base_types._BaseFieldType):
	...
	__slots__ = ["_Tp", "_CdtrAgt", "_SplmtryData", "_Authntcn", "_Adjstmnt", "_Cdtr", "_MndtRef", "_RfrdDoc", "_MaxAmt", "_UltmtDbtr", "_UltmtCdtr", "_Rsn", "_ColltnAmt", "_FrstColltnAmt", "_MndtReqId", "_Dbtr", "_MndtId", "_DbtrAgt", "_CdtrAcct", "_Ocrncs", "_TrckgInd", "_DbtrAcct", "_CdtrSchmeId"]
	@property
	def Tp(self):
		return self._Tp
