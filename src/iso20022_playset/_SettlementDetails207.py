...
class SettlementDetails207(base_types._BaseFieldType):
	...
	__slots__ = ["_LttrOfGrnt", "_RcvgSctiesSubBalTp", "_HldInd", "_SttlmSysMtd", "_SctiesTxTp", "_BlckTrad", "_ModCxlAllwd", "_Prty", "_CCPElgblty", "_NetgElgblty", "_Trckg", "_CshSubBalTp", "_AutomtcBrrwg", "_DlvryRtrRsn", "_SttlgCpcty", "_TaxCpcty", "_XpsrTp", "_PrtlSttlmInd", "_CshClrSys", "_StmpDtyTaxBsis", "_DlvrgSctiesSubBalTp", "_LglRstrctns", "_BnfclOwnrsh", "_SctiesRTGS", "_RpTp", "_SttlmTxCond", "_Regn", "_ElgblForColl", "_FxStgInstr", "_RtrLeg", "_MktClntSd"]
	@property
	def LttrOfGrnt(self):
