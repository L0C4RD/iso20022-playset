...
class ATMTransaction39(base_types._BaseFieldType):
	...
	__slots__ = ["_PropsdExctnDt", "_Actn", "_Cmd", "_TrfIdr", "_TxId", "_PrtctdAcctFr", "_AddtlChrg", "_TtlReqdAmt", "_AcctFr", "_PmtRef", "_CdtrLabl", "_AcctTo", "_ReqdExctnDt", "_DbtrLabl", "_RcrngTrf", "_TtlAuthrsdAmt", "_TxRspn", "_ICCRltdData", "_DtldReqdAmt", "_AuthstnRslt", "_InstntTrfPrgm", "_Lmts", "_PrtctdAcctTo", "_AcctInf", "_RcncltnId"]
	@property
