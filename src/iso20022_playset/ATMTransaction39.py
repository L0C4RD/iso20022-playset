...
class ATMTransaction39(base_types._BaseFieldType):
	...
	__slots__ = ["_Lmts", "_TxId", "_DtldReqdAmt", "_Actn", "_ReqdExctnDt", "_TrfIdr", "_PmtRef", "_AuthstnRslt", "_PropsdExctnDt", "_TxRspn", "_RcrngTrf", "_DbtrLabl", "_AcctTo", "_PrtctdAcctTo", "_AddtlChrg", "_InstntTrfPrgm", "_AcctFr", "_CdtrLabl", "_PrtctdAcctFr", "_ICCRltdData", "_Cmd", "_AcctInf", "_TtlReqdAmt", "_TtlAuthrsdAmt", "_RcncltnId"]
	@property
	def Lmts(self):
		return self._Lmts
