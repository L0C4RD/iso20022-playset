...
class ATMTransaction39(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlChrg", "_PrtctdAcctTo", "_AuthstnRslt", "_DbtrLabl", "_TxId", "_AcctFr", "_AcctInf", "_PmtRef", "_RcncltnId", "_Actn", "_CdtrLabl", "_AcctTo", "_Cmd", "_InstntTrfPrgm", "_RcrngTrf", "_TtlReqdAmt", "_ICCRltdData", "_TrfIdr", "_Lmts", "_DtldReqdAmt", "_ReqdExctnDt", "_PropsdExctnDt", "_TxRspn", "_PrtctdAcctFr", "_TtlAuthrsdAmt"]
	@property
	def AddtlChrg(self):
