...
class ATMTransaction39(base_types._BaseFieldType):
	...
	__slots__ = ["_PrtctdAcctFr", "_DbtrLabl", "_AcctInf", "_Lmts", "_InstntTrfPrgm", "_TxId", "_AuthstnRslt", "_ReqdExctnDt", "_TtlReqdAmt", "_TrfIdr", "_AcctTo", "_TtlAuthrsdAmt", "_RcrngTrf", "_Actn", "_PrtctdAcctTo", "_Cmd", "_TxRspn", "_DtldReqdAmt", "_ICCRltdData", "_AddtlChrg", "_RcncltnId", "_PropsdExctnDt", "_AcctFr", "_PmtRef", "_CdtrLabl"]
	@property
