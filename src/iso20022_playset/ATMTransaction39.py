...
class ATMTransaction39(base_types._BaseFieldType):
	...
	__slots__ = ["_ICCRltdData", "_CdtrLabl", "_AcctTo", "_ReqdExctnDt", "_AddtlChrg", "_TxRspn", "_Cmd", "_RcrngTrf", "_PrtctdAcctTo", "_AcctFr", "_TrfIdr", "_DtldReqdAmt", "_TtlAuthrsdAmt", "_PropsdExctnDt", "_TtlReqdAmt", "_PrtctdAcctFr", "_InstntTrfPrgm", "_DbtrLabl", "_PmtRef", "_RcncltnId", "_TxId", "_Actn", "_AuthstnRslt", "_Lmts", "_AcctInf"]
	@property
