...
class SettlementDetails214(base_types._BaseFieldType):
	...
	__slots__ = ["_CshSubBalTp", "_SctiesRTGS", "_NetgElgblty", "_SttlgCpcty", "_RpTp", "_SctiesSubBalTp", "_PrtlSttlmInd", "_MktClntSd", "_Regn", "_AutomtcBrrwg", "_BlckTrad", "_CCPElgblty", "_StmpDtyTaxBsis", "_LttrOfGrnt", "_XpsrTp", "_TaxCpcty", "_SctiesTxTp", "_BnfclOwnrsh", "_SttlmSysMtd", "_Prty", "_LglRstrctns", "_SttlmTxCond", "_ElgblForColl", "_CshClrSys"]
	@property
