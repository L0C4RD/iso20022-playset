...
class SettlementDetails214(base_types._BaseFieldType):
	...
	__slots__ = ["_CshClrSys", "_CCPElgblty", "_SttlmTxCond", "_SctiesRTGS", "_SttlgCpcty", "_AutomtcBrrwg", "_NetgElgblty", "_BlckTrad", "_BnfclOwnrsh", "_TaxCpcty", "_SttlmSysMtd", "_SctiesSubBalTp", "_LglRstrctns", "_LttrOfGrnt", "_PrtlSttlmInd", "_StmpDtyTaxBsis", "_ElgblForColl", "_XpsrTp", "_SctiesTxTp", "_MktClntSd", "_Regn", "_RpTp", "_CshSubBalTp", "_Prty"]
	@property
	def CshClrSys(self):
