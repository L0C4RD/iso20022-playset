...
class SettlementDetails214(base_types._BaseFieldType):
	...
	__slots__ = ["_ElgblForColl", "_RpTp", "_NetgElgblty", "_SttlmTxCond", "_TaxCpcty", "_CshClrSys", "_Regn", "_MktClntSd", "_Prty", "_SctiesSubBalTp", "_CshSubBalTp", "_StmpDtyTaxBsis", "_LttrOfGrnt", "_SctiesRTGS", "_CCPElgblty", "_LglRstrctns", "_PrtlSttlmInd", "_SttlmSysMtd", "_AutomtcBrrwg", "_BnfclOwnrsh", "_SctiesTxTp", "_XpsrTp", "_SttlgCpcty", "_BlckTrad"]
	@property
