...
class SettlementDetails214(base_types._BaseFieldType):
	...
	__slots__ = ["_Prty", "_CshClrSys", "_SttlgCpcty", "_TaxCpcty", "_RpTp", "_ElgblForColl", "_Regn", "_LglRstrctns", "_BnfclOwnrsh", "_SttlmSysMtd", "_CCPElgblty", "_AutomtcBrrwg", "_NetgElgblty", "_MktClntSd", "_CshSubBalTp", "_SctiesRTGS", "_StmpDtyTaxBsis", "_SctiesTxTp", "_XpsrTp", "_BlckTrad", "_PrtlSttlmInd", "_SctiesSubBalTp", "_LttrOfGrnt", "_SttlmTxCond"]
	@property
	def Prty(self):
		return self._Prty
