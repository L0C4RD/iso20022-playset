...
class SettlementDetails214(base_types._BaseFieldType):
	...
	__slots__ = ["_SctiesTxTp", "_TaxCpcty", "_NetgElgblty", "_MktClntSd", "_Regn", "_AutomtcBrrwg", "_CshClrSys", "_CCPElgblty", "_SttlmTxCond", "_BlckTrad", "_SttlgCpcty", "_LttrOfGrnt", "_PrtlSttlmInd", "_BnfclOwnrsh", "_SttlmSysMtd", "_SctiesSubBalTp", "_XpsrTp", "_StmpDtyTaxBsis", "_RpTp", "_Prty", "_SctiesRTGS", "_ElgblForColl", "_CshSubBalTp", "_LglRstrctns"]
	@property
	def SctiesTxTp(self):
