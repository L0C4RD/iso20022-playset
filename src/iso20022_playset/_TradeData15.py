...
class TradeData15(base_types._BaseFieldType):
	...
	__slots__ = ["_StsOrgtr", "_PrvsStsDtTm", "_MsgId", "_MtchgSysMtchdSdRef", "_MtchgSysUnqRef", "_CurStsSubTp", "_SpltTradInd", "_CurStsDtTm", "_CurSts", "_PrvsSts", "_PdctTp", "_MtchgSysMtchgRef", "_SttlmSsnIdr", "_OrgtrRef", "_PrvsStsSubTp"]
	@property
	def StsOrgtr(self):
