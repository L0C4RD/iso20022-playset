...
from . import StatisticsByUserDefinedTimePeriod2
...
class ValuationStatistics3(base_types._BaseFieldType):
	...
	def ByUsrDfndTmPrd(self, value):
		self._ByUsrDfndTmPrd = value if value is not None else base_types.UninitialisedField(self, 'ByUsrDfndTmPrd', StatisticsByUserDefinedTimePeriod2, True)

	@ByUsrDfndTmPrd.deleter
	def ByUsrDfndTmPrd(self):
		del self._ByUsrDfndTmPrd
		self._ByUsrDfndTmPrd = base_types.UninitialisedField(self, 'ByUsrDfndTmPrd', StatisticsByUserDefinedTimePeriod2, True)
