...
from .PreferredContactMethod1Code import PreferredContactMethod1Code
...
class Contact4(base_types._BaseFieldType):
	...
	__slots__ = ["_PrefrdMtd", "_Nm", "_Dept", "_EmailPurp", "_FaxNb", "_MobNb", "_NmPrfx", "_PhneNb", "_Rspnsblty", "_EmailAdr", "_Othr", "_JobTitl"]
	@property
	def PrefrdMtd(self):
