...
class TripartyCollateralTransactionInstructionProcessingStatusAdviceV01(base_types._BaseFieldType):
	...
	__slots__ = ["_MtchgSts", "_CshMvmnt", "_DealTxDt", "_SplmtryData", "_Pgntn", "_CollPties", "_TxInstrId", "_CxlPrcgSts", "_DealTxDtls", "_SctiesMvmnt", "_GnlParams", "_CxlReqRef", "_InstrPrcgSts"]
	@property
	def MtchgSts(self):
