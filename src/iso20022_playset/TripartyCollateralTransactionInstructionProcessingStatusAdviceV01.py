...
class TripartyCollateralTransactionInstructionProcessingStatusAdviceV01(base_types._BaseFieldType):
	...
	__slots__ = ["_CxlReqRef", "_DealTxDt", "_SctiesMvmnt", "_MtchgSts", "_InstrPrcgSts", "_CshMvmnt", "_SplmtryData", "_CxlPrcgSts", "_TxInstrId", "_GnlParams", "_DealTxDtls", "_Pgntn", "_CollPties"]
	@property
	def CxlReqRef(self):
