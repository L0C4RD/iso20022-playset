...
class CorporateActionBalanceDetails45(base_types._BaseFieldType):
	...
	__slots__ = ["_PdgRctBal", "_ConfdBal", "_BrrwdBal", "_RegdBal", "_OnLnBal", "_TradDtPosBal", "_CollOutBal", "_AfctdBal", "_InTrnsShipmntBal", "_BlckdBal", "_OutForRegnBal", "_TtlElgblBal", "_SttlmPosBal", "_StrtPosBal", "_PdgDlvryBal", "_UafctdBal", "_CollInBal"]
	@property
	def PdgRctBal(self):
