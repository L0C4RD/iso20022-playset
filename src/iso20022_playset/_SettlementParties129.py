...
from . import PartyIdentificationAndAccount204
...
class SettlementParties129(base_types._BaseFieldType):
	...
	@Pty1.setter
	def Pty1(self, value):
		self._Pty1 = value if value is not None else base_types.UninitialisedField(self, 'Pty1', PartyIdentificationAndAccount204, False)

	@Pty1.deleter
	def Pty1(self):
		del self._Pty1
		self._Pty1 = base_types.UninitialisedField(self, 'Pty1', PartyIdentificationAndAccount204, False)
	...
	@Pty2.setter
	def Pty2(self, value):
		self._Pty2 = value if value is not None else base_types.UninitialisedField(self, 'Pty2', PartyIdentificationAndAccount204, False)

	@Pty2.deleter
	def Pty2(self):
		del self._Pty2
		self._Pty2 = base_types.UninitialisedField(self, 'Pty2', PartyIdentificationAndAccount204, False)
	...
	@Pty3.setter
	def Pty3(self, value):
		self._Pty3 = value if value is not None else base_types.UninitialisedField(self, 'Pty3', PartyIdentificationAndAccount204, False)

	@Pty3.deleter
	def Pty3(self):
		del self._Pty3
		self._Pty3 = base_types.UninitialisedField(self, 'Pty3', PartyIdentificationAndAccount204, False)
