...
class InquiryVerificationInitiationV04(base_types._BaseFieldType):
	...
	__slots__ = ["_Accptr", "_AcctFr", "_AcctTo", "_Acqrr", "_AddtlAmt", "_AddtlFee", "_AddtlSvc", "_AuthntcnData", "_Bnfts", "_Card", "_Cntxt", "_ConvsDtTm", "_Crdhldr", "_CstmrDvc", "_Dstn", "_FndsSvcs", "_Hdr", "_ICCRltdData", "_Instlmt", "_Issr", "_Jursdctn", "_NtlData", "_OrgnlRspnCd", "_Orgtr", "_POICmpnt", "_PrcgRslt", "_Prgrmm", "_PrtctdData", "_PrvtData", "_Pyee", "_Pyer", "_Rcncltn", "_Rcvr", "_Rsk", "_SctyTrlr", "_Sndr", "_SpclPrgrmmQlfctn", "_StrngCstmrAuthntcn", "_SttlmSvc", "_Termnl", "_Tkn", "_TxAmts", "_TxChrtcs", "_TxId", "_Txtr", "_Vrfctn", "_Wllt", "_XchgRate"]
	@property
	def Accptr(self):
		return self._Accptr
