...
class TMSAction13(base_types._BaseFieldType):
	...
	__slots__ = ["_TmCond", "_AddtlInf", "_ReTry", "_KeyNcphrmntCert", "_MsgItm", "_DlgtnScpId", "_DlgtnProof", "_PrtctdDlgtnProof", "_DvcReq", "_AddtlPrc", "_Key", "_CmpntTp", "_RmotAccs", "_ErrActn", "_DataSetId", "_TMSPrtcolVrsn", "_DlgtnScpDef", "_Tp", "_TMChllng", "_Trggr", "_TermnlMgrId", "_TMSPrtcol"]
	@property
	def TmCond(self):
		return self._TmCond
