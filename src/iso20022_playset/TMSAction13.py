...
class TMSAction13(base_types._BaseFieldType):
	...
	__slots__ = ["_DvcReq", "_CmpntTp", "_RmotAccs", "_ReTry", "_DlgtnProof", "_AddtlInf", "_DlgtnScpDef", "_PrtctdDlgtnProof", "_AddtlPrc", "_TMChllng", "_DlgtnScpId", "_TmCond", "_TMSPrtcolVrsn", "_Tp", "_ErrActn", "_TMSPrtcol", "_Trggr", "_Key", "_TermnlMgrId", "_DataSetId", "_MsgItm", "_KeyNcphrmntCert"]
	@property
	def DvcReq(self):
		return self._DvcReq
