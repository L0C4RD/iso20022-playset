...
class TMSAction13(base_types._BaseFieldType):
	...
	__slots__ = ["_TMSPrtcolVrsn", "_DlgtnProof", "_ReTry", "_MsgItm", "_KeyNcphrmntCert", "_DlgtnScpId", "_ErrActn", "_DlgtnScpDef", "_TermnlMgrId", "_TMChllng", "_DataSetId", "_TMSPrtcol", "_Tp", "_Key", "_CmpntTp", "_TmCond", "_Trggr", "_DvcReq", "_RmotAccs", "_PrtctdDlgtnProof", "_AddtlPrc", "_AddtlInf"]
	@property
