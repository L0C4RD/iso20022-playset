...
class TMSAction13(base_types._BaseFieldType):
	...
	__slots__ = ["_MsgItm", "_DlgtnScpDef", "_TMSPrtcolVrsn", "_TmCond", "_Key", "_CmpntTp", "_ReTry", "_TMChllng", "_Tp", "_ErrActn", "_AddtlPrc", "_DvcReq", "_KeyNcphrmntCert", "_TermnlMgrId", "_Trggr", "_AddtlInf", "_RmotAccs", "_DlgtnScpId", "_PrtctdDlgtnProof", "_TMSPrtcol", "_DataSetId", "_DlgtnProof"]
	@property
	def MsgItm(self):
		return self._MsgItm
