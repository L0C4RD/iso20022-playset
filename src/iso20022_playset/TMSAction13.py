...
class TMSAction13(base_types._BaseFieldType):
	...
	__slots__ = ["_PrtctdDlgtnProof", "_DataSetId", "_ReTry", "_RmotAccs", "_TMSPrtcol", "_DlgtnScpDef", "_TermnlMgrId", "_KeyNcphrmntCert", "_ErrActn", "_Tp", "_DlgtnScpId", "_TMChllng", "_MsgItm", "_DvcReq", "_TMSPrtcolVrsn", "_AddtlInf", "_DlgtnProof", "_Key", "_TmCond", "_AddtlPrc", "_Trggr", "_CmpntTp"]
	@property
