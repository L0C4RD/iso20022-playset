...
from . import PartyIdentification241
from . import PartyIdentification270

class EligiblePosition19(base_types._BaseFieldType):
	...
	def AcctOwnr(self, value):
		self._AcctOwnr = value if value is not None else base_types.UninitialisedField(self, 'AcctOwnr', PartyIdentification241, False)

	@AcctOwnr.deleter
	def AcctOwnr(self):
		del self._AcctOwnr
		self._AcctOwnr = base_types.UninitialisedField(self, 'AcctOwnr', PartyIdentification241, False)
	...
	def RghtsHldr(self, value):
		self._RghtsHldr = value if value is not None else base_types.UninitialisedField(self, 'RghtsHldr', PartyIdentification270, True)

	@RghtsHldr.deleter
	def RghtsHldr(self):
		del self._RghtsHldr
		self._RghtsHldr = base_types.UninitialisedField(self, 'RghtsHldr', PartyIdentification270, True)

	_field_defs = frozenset((
		base_types.FieldEntry(name='AcctId', type=Max35Text, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='AcctOwnr', type=PartyIdentification241, min=0, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='RghtsHldr', type=PartyIdentification270, min=0, max=250, mutex_group=None, array=True),
	))