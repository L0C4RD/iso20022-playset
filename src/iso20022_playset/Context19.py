...
class Context19(base_types._BaseFieldType):
	...
	__slots__ = ["_EComrc", "_SctyChrtcs", "_GoodAndSvcDlvrySchdl", "_PINNtryBpss", "_RctTp", "_RctDstn", "_ECRId", "_TempScrCardDataReusd", "_OthrGoodAndSvcDlvryChanl", "_AuthntcnOutg", "_AddtlData", "_FnlAuthstn", "_CstmrCnsnt", "_DfrrdDlvry", "_RctReq", "_GoodAndSvcsSubTp", "_PmtCrdntlMrchntRltsh", "_ICCFllbck", "_CrdhldrPres", "_CardDataNtryMd", "_QRCdPresntmntMd", "_EComrcData", "_OthrMrchntCtgy", "_NoShow", "_OthrGoodAndSvcDlvrySchdl", "_MOTOCd", "_EComrcIndApld", "_ReSubmissn", "_TxInitr", "_ICCFllbckRsnCd", "_TrnspndrInittd", "_GoodAndSvcDlvryChanl", "_SpltPmt", "_OthrQRCdPresntmntMd", "_GoodsAndSvcsTp", "_DelydAuthstn", "_StorgLctn", "_SaleRefNb", "_PrtlShipmnt", "_Trnst", "_OthrCardDataNtryMd", "_CaptrDt", "_UattnddLvlCtgy", "_GoodAndSvcsOthrSubTp", "_Attndd", "_MrchntCtgyCd", "_CrdhldrActvtd", "_DtAntcptd", "_MrchntCtgySpcfcData", "_OthrSctyChrtcs", "_PrtlApprvlSpprtd", "_MgntcStrpFllbck", "_Reauthstn", "_EComrcIndPropsd", "_PINPadInprtv", "_LatePresntmnt", "_DelydChrgs", "_OthrICCFllbckRsnCd", "_CardPres"]
	@property
	def EComrc(self):
		return self._EComrc
