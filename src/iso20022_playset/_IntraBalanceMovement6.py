...
class IntraBalanceMovement6(base_types._BaseFieldType):
	...
	__slots__ = ["_FctvSttlmDt", "_CreDtTm", "_BalFr", "_SplmtryData", "_IntnddSttlmDt", "_CshSubBalId", "_BalTo", "_Lnkgs", "_SttldAmt", "_RmngSttlmAmt", "_PrevslySttldAmt", "_Prty", "_InstrPrcgAddtlDtls", "_SttlmAmt", "_StsDt", "_MsgOrgtr"]
	@property
