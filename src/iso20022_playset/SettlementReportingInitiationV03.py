...
from .SettlementCategoryTotal3 import SettlementCategoryTotal3
from .SettlementCategoryTotal2 import SettlementCategoryTotal2
...
from .SettlementReportType1Code import SettlementReportType1Code
...
class SettlementReportingInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_RtrvlRefNb", "_AddtlData", "_SctyTrlr", "_Hdr", "_Sndr", "_Orgtr", "_FI", "_Jursdctn", "_Rcvr", "_IssrSttlmTtls", "_OthrInstn", "_TtlSttlmAmt", "_Prgrmm", "_SysTracAudtNb", "_TrnsmssnDtTm", "_AddtlFee", "_Dstn", "_SttlmSvc", "_SttlmRptTp", "_Rcncltn", "_PrtctdData", "_FndsTrfAmt", "_TxDesc", "_SplmtryData", "_AltrnMsgRsn", "_OthrSttlmRptTp", "_LifeCyclId", "_OthrSttlmTtls", "_SttlmInstn", "_AcqrrSttlmTtls", "_MsgRsn"]
	@property
	def RtrvlRefNb(self):
	...
	def SttlmRptTp(self, value):
		self._SttlmRptTp = value if type(value) != auto else self.make_default("SttlmRptTp")
	...
	def AcqrrSttlmTtls(self, value):
		self._AcqrrSttlmTtls = value if type(value) != auto else self.make_default("AcqrrSttlmTtls")
