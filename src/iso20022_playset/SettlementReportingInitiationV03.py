...
class SettlementReportingInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Jursdctn", "_SplmtryData", "_AddtlData", "_AcqrrSttlmTtls", "_Orgtr", "_Hdr", "_SttlmSvc", "_OthrInstn", "_FI", "_SysTracAudtNb", "_SttlmRptTp", "_RtrvlRefNb", "_Sndr", "_IssrSttlmTtls", "_TrnsmssnDtTm", "_TtlSttlmAmt", "_Dstn", "_SttlmInstn", "_AltrnMsgRsn", "_TxDesc", "_Rcncltn", "_Rcvr", "_SctyTrlr", "_MsgRsn", "_Prgrmm", "_PrtctdData", "_OthrSttlmRptTp", "_LifeCyclId", "_AddtlFee", "_FndsTrfAmt", "_OthrSttlmTtls"]
	@property
	def Jursdctn(self):
