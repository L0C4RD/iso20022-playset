...
class SettlementReportingInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Sndr", "_SttlmInstn", "_Hdr", "_AddtlData", "_AltrnMsgRsn", "_Rcncltn", "_Dstn", "_OthrSttlmRptTp", "_TxDesc", "_PrtctdData", "_RtrvlRefNb", "_LifeCyclId", "_AcqrrSttlmTtls", "_TrnsmssnDtTm", "_FI", "_OthrSttlmTtls", "_FndsTrfAmt", "_MsgRsn", "_SttlmSvc", "_IssrSttlmTtls", "_Rcvr", "_Jursdctn", "_TtlSttlmAmt", "_OthrInstn", "_Orgtr", "_SplmtryData", "_SctyTrlr", "_SttlmRptTp", "_Prgrmm", "_AddtlFee", "_SysTracAudtNb"]
	@property
	def Sndr(self):
		return self._Sndr
