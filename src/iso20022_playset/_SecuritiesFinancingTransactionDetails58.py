...
class SecuritiesFinancingTransactionDetails58(base_types._BaseFieldType):
	...
	__slots__ = ["_MtrtyDtMod", "_RateChngDt", "_RateTp", "_RpRate", "_TermntnTxAmt", "_ChrgsRate", "_TermntnAmtPerPcOfColl", "_TxCallDely", "_SctiesFincgTradId", "_ScndLegNrrtv", "_AcrdIntrstAmt", "_PricgRate", "_FrftAmt", "_PrmAmt", "_TermntnDt", "_Sprd", "_IntrstCmptnMtd", "_EarlstCallBckDt", "_TtlNbOfCollInstrs", "_ClsgLegId", "_ComssnClctnDt", "_LglFrmwk", "_StockLnMrgn", "_DealAmt", "_Rvaltn", "_SctiesFincgUnqTxIdr", "_IntrstPmt", "_SctiesHrcut", "_VarblRateSpprt", "_LclBrkrComssn"]
	@property
	def MtrtyDtMod(self):
