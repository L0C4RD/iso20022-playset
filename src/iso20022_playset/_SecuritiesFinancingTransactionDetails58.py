...
class SecuritiesFinancingTransactionDetails58(base_types._BaseFieldType):
	...
	__slots__ = ["_RpRate", "_EarlstCallBckDt", "_MtrtyDtMod", "_PrmAmt", "_TermntnTxAmt", "_LclBrkrComssn", "_VarblRateSpprt", "_ClsgLegId", "_FrftAmt", "_ChrgsRate", "_AcrdIntrstAmt", "_ComssnClctnDt", "_Sprd", "_TermntnAmtPerPcOfColl", "_SctiesFincgTradId", "_TxCallDely", "_TtlNbOfCollInstrs", "_DealAmt", "_StockLnMrgn", "_IntrstCmptnMtd", "_IntrstPmt", "_TermntnDt", "_ScndLegNrrtv", "_PricgRate", "_RateChngDt", "_Rvaltn", "_LglFrmwk", "_RateTp", "_SctiesHrcut", "_SctiesFincgUnqTxIdr"]
	@property
	def RpRate(self):
		return self._RpRate
