...
class Rate42(base_types._BaseFieldType):
	...
	__slots__ = ["_AplblRate", "_TaxOnIncm", "_ThrdPtyIncntivRate", "_ChrgsFees", "_NetDstrbtnRate", "_EqulstnRate", "_FsclStmp", "_EarlySlctnFeeRate", "_SlctnFeeRate", "_AddtlTax", "_TaxRclmRate", "_ScndLvlTax", "_TaxOnPrfts", "_TaxCdtRate", "_GrssDstrbtnRate", "_DmdRate", "_WhldgTaxRate", "_GrssIntrstRateUsdForPmt"]
	@property
	def AplblRate(self):
