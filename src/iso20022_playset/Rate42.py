...
class Rate42(base_types._BaseFieldType):
	...
	__slots__ = ["_ChrgsFees", "_FsclStmp", "_EarlySlctnFeeRate", "_WhldgTaxRate", "_NetDstrbtnRate", "_ScndLvlTax", "_GrssIntrstRateUsdForPmt", "_DmdRate", "_TaxOnIncm", "_TaxOnPrfts", "_TaxRclmRate", "_AddtlTax", "_ThrdPtyIncntivRate", "_TaxCdtRate", "_EqulstnRate", "_GrssDstrbtnRate", "_AplblRate", "_SlctnFeeRate"]
	@property
	def ChrgsFees(self):
