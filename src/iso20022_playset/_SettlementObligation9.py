...
class SettlementObligation9(base_types._BaseFieldType):
	...
	__slots__ = ["_TradgCpcty", "_Pmt", "_SttlmAmt", "_AddtlSttlmOblgtnDtls", "_SfkpgAcct", "_FinInstrmId", "_SttlmPties", "_Qty", "_IntnddSttlmDt", "_ClrAcctTp", "_TradDt", "_SfkpgPlc", "_PlcOfTrad", "_SctiesMvmntTp", "_SttlmOblgtnId"]
	@property
	def TradgCpcty(self):
