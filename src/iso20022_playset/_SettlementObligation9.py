...
class SettlementObligation9(base_types._BaseFieldType):
	...
	__slots__ = ["_PlcOfTrad", "_AddtlSttlmOblgtnDtls", "_TradDt", "_IntnddSttlmDt", "_Qty", "_SfkpgAcct", "_Pmt", "_SttlmPties", "_SttlmAmt", "_SfkpgPlc", "_SctiesMvmntTp", "_FinInstrmId", "_TradgCpcty", "_ClrAcctTp", "_SttlmOblgtnId"]
	@property
	def PlcOfTrad(self):
