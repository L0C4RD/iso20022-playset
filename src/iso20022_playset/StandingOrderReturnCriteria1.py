...
class StandingOrderReturnCriteria1(base_types._BaseFieldType):
	...
	__slots__ = ["_LkSetOrdrIdInd", "_ExctnTpInd", "_ZeroSweepInd", "_VldToInd", "_DbtrAcctInd", "_TpInd", "_VldtyFrInd", "_CdtrAcctInd", "_RspnsblPtyInd", "_CcyInd", "_TtlAmtInd", "_SysMmbInd", "_AssoctdPoolAcct", "_FrqcyInd", "_StgOrdrIdInd", "_LkSetOrdrSeqInd", "_LkSetIdInd"]
	@property
