...
class StandingOrderReturnCriteria1(base_types._BaseFieldType):
	...
	__slots__ = ["_VldtyFrInd", "_LkSetIdInd", "_LkSetOrdrIdInd", "_DbtrAcctInd", "_ExctnTpInd", "_CcyInd", "_AssoctdPoolAcct", "_StgOrdrIdInd", "_CdtrAcctInd", "_TpInd", "_FrqcyInd", "_ZeroSweepInd", "_SysMmbInd", "_TtlAmtInd", "_RspnsblPtyInd", "_VldToInd", "_LkSetOrdrSeqInd"]
	@property
	def VldtyFrInd(self):
