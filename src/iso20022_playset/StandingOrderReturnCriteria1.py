...
class StandingOrderReturnCriteria1(base_types._BaseFieldType):
	...
	__slots__ = ["_LkSetOrdrIdInd", "_StgOrdrIdInd", "_VldToInd", "_CcyInd", "_ExctnTpInd", "_SysMmbInd", "_CdtrAcctInd", "_ZeroSweepInd", "_FrqcyInd", "_RspnsblPtyInd", "_LkSetIdInd", "_TpInd", "_DbtrAcctInd", "_AssoctdPoolAcct", "_LkSetOrdrSeqInd", "_TtlAmtInd", "_VldtyFrInd"]
	@property
