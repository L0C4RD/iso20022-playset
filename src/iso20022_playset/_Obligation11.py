...
from .PartyIdentification242 import PartyIdentification242
...
from .ExposureType11Code import ExposureType11Code
from .BlockChainAddressWallet5 import BlockChainAddressWallet5

class Obligation11(base_types._BaseFieldType):

	__slots__ = ["_PtyA", "_ValtnDt", "_PtyB", "_BlckChainAdrOrWllt", "_XpsrTp", "_SvcgPtyA", "_SvcgPtyB", "_CollAcctId"]
	@property
	def PtyA(self):
		return self._PtyA
