...
class TransactionDetails173(base_types._BaseFieldType):
	...
	__slots__ = ["_SfkpgAcct", "_SttlmAmt", "_DlvrgSttlmPties", "_Pmt", "_TradDt", "_SctiesMvmntTp", "_Invstr", "_SttlmQty", "_RcvgSttlmPties", "_SttlmDt", "_BlckChainAdrOrWllt", "_FinInstrmId"]
	@property
	def SfkpgAcct(self):
