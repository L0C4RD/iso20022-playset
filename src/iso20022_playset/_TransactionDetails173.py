...
class TransactionDetails173(base_types._BaseFieldType):
	...
	__slots__ = ["_Pmt", "_BlckChainAdrOrWllt", "_SttlmDt", "_SfkpgAcct", "_SttlmQty", "_DlvrgSttlmPties", "_RcvgSttlmPties", "_SttlmAmt", "_Invstr", "_SctiesMvmntTp", "_FinInstrmId", "_TradDt"]
	@property
	def Pmt(self):
		return self._Pmt
