...
class SecuritiesTradeDetails147(base_types._BaseFieldType):
	...
	__slots__ = ["_UnqTxIdr", "_PlcOfTrad", "_MtchgSts", "_SttlmInstrPrcgAddtlDtls", "_SttlmDt", "_TradOrgtrRole", "_TradTxCond", "_OpngClsg", "_FxAddtlDtls", "_TradDt", "_InvstrCpcty", "_CcyToBuyOrSell", "_TradId", "_NbOfDaysAcrd", "_LateDlvryDt", "_PlcOfClr", "_CollTxId", "_Rptg", "_TpOfPric", "_AffirmSts", "_DealPric"]
	@property
	def UnqTxIdr(self):
