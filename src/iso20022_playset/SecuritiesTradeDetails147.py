...
class SecuritiesTradeDetails147(base_types._BaseFieldType):
	...
	__slots__ = ["_TpOfPric", "_OpngClsg", "_InvstrCpcty", "_SttlmInstrPrcgAddtlDtls", "_UnqTxIdr", "_SttlmDt", "_TradId", "_CcyToBuyOrSell", "_LateDlvryDt", "_PlcOfClr", "_MtchgSts", "_TradTxCond", "_DealPric", "_NbOfDaysAcrd", "_AffirmSts", "_Rptg", "_PlcOfTrad", "_TradDt", "_CollTxId", "_TradOrgtrRole", "_FxAddtlDtls"]
	@property
	def TpOfPric(self):
