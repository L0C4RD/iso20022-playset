...
class ATMTransaction39(base_types._BaseFieldType):
	...
	__slots__ = ["_TxRspn", "_ReqdExctnDt", "_CdtrLabl", "_AuthstnRslt", "_Cmd", "_PrtctdAcctTo", "_TxId", "_DbtrLabl", "_PrtctdAcctFr", "_DtldReqdAmt", "_Lmts", "_TrfIdr", "_InstntTrfPrgm", "_AcctFr", "_PropsdExctnDt", "_RcncltnId", "_TtlReqdAmt", "_PmtRef", "_AcctTo", "_Actn", "_TtlAuthrsdAmt", "_AcctInf", "_ICCRltdData", "_AddtlChrg", "_RcrngTrf"]
	@property
	def TxRspn(self):
		return self._TxRspn
