...
from .ExternalUndertakingType1Code import ExternalUndertakingType1Code

class Undertaking4(base_types._BaseFieldType):

	__slots__ = ["_Applcnt", "_AddtlPty", "_AutomtcAmtVartn", "_PresntnDtls", "_AddtlInf", "_ConfInd", "_ScndAdvsgPty", "_DlvryChanl", "_LclUdrtkgAmt", "_XpryDtls", "_MltplDmndInd", "_TrfChrgsPyblBy", "_DtOfIssnc", "_ConfChrgsPyblBy", "_Nm", "_GovncRulesAndLaw", "_Tp", "_UndrlygTx", "_TrfInd", "_AdvsgPty", "_PrtlDmndInd", "_UdrtkgWrdg", "_Bnfcry"]
	@property
	def Applcnt(self):
	...
	def LclUdrtkgAmt(self, value):
		self._LclUdrtkgAmt = value if type(value) != base_types.auto else self.make_default("LclUdrtkgAmt")

	@LclUdrtkgAmt.deleter
	def LclUdrtkgAmt(self):
		del self._LclUdrtkgAmt
		self._LclUdrtkgAmt = None
