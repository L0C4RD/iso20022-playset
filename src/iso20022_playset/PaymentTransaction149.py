...
class PaymentTransaction149(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlTxRef", "_OrgnlIntrBkSttlmAmt", "_ChrgBr", "_RvslId", "_RvsdIntrBkSttlmAmt", "_ChrgsInf", "_RvslRsnInf", "_SttlmTmIndctn", "_SttlmPrty", "_IntrBkSttlmDt", "_InstdAgt", "_CompstnAmt", "_SplmtryData", "_OrgnlUETR", "_InstgAgt", "_XchgRate", "_OrgnlEndToEndId", "_OrgnlTxId", "_OrgnlClrSysRef", "_OrgnlGrpInf", "_RvsdInstdAmt", "_OrgnlInstrId"]
	@property
	def OrgnlTxRef(self):
