...
class PaymentTransaction149(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlInstrId", "_ChrgBr", "_OrgnlEndToEndId", "_OrgnlGrpInf", "_InstgAgt", "_OrgnlIntrBkSttlmAmt", "_SttlmTmIndctn", "_CompstnAmt", "_RvslRsnInf", "_OrgnlClrSysRef", "_ChrgsInf", "_SttlmPrty", "_OrgnlTxRef", "_RvslId", "_RvsdIntrBkSttlmAmt", "_OrgnlTxId", "_IntrBkSttlmDt", "_InstdAgt", "_OrgnlUETR", "_SplmtryData", "_XchgRate", "_RvsdInstdAmt"]
	@property
