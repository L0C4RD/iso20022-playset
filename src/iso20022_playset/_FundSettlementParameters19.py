...
from . import DeliveringPartiesAndAccount20
from . import ISODate
from . import Max35Text
from . import PartyIdentification139
from . import ReceivingPartiesAndAccount20
from . import SafekeepingPlaceFormat40Choice
from . import SettlementTransactionCondition30Choice
from . import TradeTransactionCondition8Choice

class FundSettlementParameters19(base_types._BaseFieldType):
	...
	def DlvrgSdDtls(self, value):
		self._DlvrgSdDtls = value if value is not None else base_types.UninitialisedField(self, 'DlvrgSdDtls', DeliveringPartiesAndAccount20, False)

	@DlvrgSdDtls.deleter
	def DlvrgSdDtls(self):
		del self._DlvrgSdDtls
		self._DlvrgSdDtls = base_types.UninitialisedField(self, 'DlvrgSdDtls', DeliveringPartiesAndAccount20, False)
	...
	def RcvgSdDtls(self, value):
		self._RcvgSdDtls = value if value is not None else base_types.UninitialisedField(self, 'RcvgSdDtls', ReceivingPartiesAndAccount20, False)

	@RcvgSdDtls.deleter
	def RcvgSdDtls(self):
		del self._RcvgSdDtls
		self._RcvgSdDtls = base_types.UninitialisedField(self, 'RcvgSdDtls', ReceivingPartiesAndAccount20, False)
	...
	def SfkpgPlc(self, value):
		self._SfkpgPlc = value if value is not None else base_types.UninitialisedField(self, 'SfkpgPlc', SafekeepingPlaceFormat40Choice, False)

	@SfkpgPlc.deleter
	def SfkpgPlc(self):
		del self._SfkpgPlc
		self._SfkpgPlc = base_types.UninitialisedField(self, 'SfkpgPlc', SafekeepingPlaceFormat40Choice, False)
	...
	def SttlmPlc(self, value):
		self._SttlmPlc = value if value is not None else base_types.UninitialisedField(self, 'SttlmPlc', PartyIdentification139, False)

	@SttlmPlc.deleter
	def SttlmPlc(self):
		del self._SttlmPlc
		self._SttlmPlc = base_types.UninitialisedField(self, 'SttlmPlc', PartyIdentification139, False)
	...
	_field_defs = frozenset((
		base_types.FieldEntry(name='DlvrgSdDtls', type=DeliveringPartiesAndAccount20, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='RcvgSdDtls', type=ReceivingPartiesAndAccount20, min=1, max=1, mutex_group=None, array=False),
