...
class SecuritiesFinancingTransactionDetails54(base_types._BaseFieldType):
	...
	__slots__ = ["_VarblRateSpprt", "_MtrtyDtMod", "_AcrdIntrstAmt", "_TxCallDely", "_TermntnTxAmt", "_LglFrmwk", "_TermntnDt", "_RateTp", "_ClsgLegId", "_ScndLegNrrtv", "_SctiesFincgTradId", "_IntrstPmt", "_RpRate", "_SctiesFincgUnqTxIdr"]
	@property
