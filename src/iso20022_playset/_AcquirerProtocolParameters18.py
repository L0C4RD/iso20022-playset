...
from . import AcquirerHostConfiguration11
...
class AcquirerProtocolParameters18(base_types._BaseFieldType):
	...
	@Hst.setter
	def Hst(self, value):
		self._Hst = value if value is not None else base_types.UninitialisedField(self, 'Hst', AcquirerHostConfiguration11, True)

	@Hst.deleter
	def Hst(self):
		del self._Hst
		self._Hst = base_types.UninitialisedField(self, 'Hst', AcquirerHostConfiguration11, True)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='Hst', type=AcquirerHostConfiguration11, min=0, max=None, mutex_group=None, array=True),
