import base_types
import AmountAndDirection47

class OtherAmounts32(base_types._BaseFieldType):

	__slots__ = ["_CsmptnTax", "_AcrdIntrstAmt", "_LclTax", "_TradAmt", "_ExctgBrkrAmt", "_TxTax", "_WhldgTax", "_Othr", "_ChrgsFees", "_StmpDty", "_LclBrkrComssn"]
	@property
	def CsmptnTax(self):
