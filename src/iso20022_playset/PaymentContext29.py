...
class PaymentContext29(base_types._BaseFieldType):
	...
	__slots__ = ["_CardPres", "_AttndntLang", "_AttndncCntxt", "_SpprtdOptn", "_AttndntMsgCpbl", "_BizArea", "_FllbckInd", "_CardDataNtryMd", "_TxEnvt", "_CrdhldrPres", "_TxChanl", "_OnLineCntxt"]
	@property
	def CardPres(self):
