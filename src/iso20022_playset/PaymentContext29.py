...
from .CardFallback1Code import CardFallback1Code
from .BusinessArea2Code import BusinessArea2Code
from .TransactionEnvironment1Code import TransactionEnvironment1Code
from .SupportedPaymentOption2Code import SupportedPaymentOption2Code
from .AttendanceContext1Code import AttendanceContext1Code
from .TransactionChannel5Code import TransactionChannel5Code
...
class PaymentContext29(base_types._BaseFieldType):
	...
	__slots__ = ["_AttndncCntxt", "_AttndntLang", "_CrdhldrPres", "_OnLineCntxt", "_BizArea", "_CardPres", "_AttndntMsgCpbl", "_CardDataNtryMd", "_FllbckInd", "_SpprtdOptn", "_TxEnvt", "_TxChanl"]
	@property
	...
	def BizArea(self, value):
		self._BizArea = value if type(value) != auto else self.make_default("BizArea")
	...
	def SpprtdOptn(self, value):
		self._SpprtdOptn = value if type(value) != auto else self.make_default("SpprtdOptn")
