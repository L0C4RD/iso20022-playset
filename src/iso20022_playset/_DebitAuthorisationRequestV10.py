...
class DebitAuthorisationRequestV10(base_types._BaseFieldType):
	...
	@Dtl.setter
	def Dtl(self, value):
		self._Dtl = value if value is not None else base_types.UninitialisedField(self, 'Dtl', DebitAuthorisation2, False)

	@Dtl.deleter
	def Dtl(self):
		del self._Dtl
		self._Dtl = base_types.UninitialisedField(self, 'Dtl', DebitAuthorisation2, False)
