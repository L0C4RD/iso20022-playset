...
from . import FinancialInstrumentIdentification9
...
class FinancialInstrumentIdentification8(base_types._BaseFieldType):
	...
	def AltrnScty(self, value):
		self._AltrnScty = value if value is not None else base_types.UninitialisedField(self, 'AltrnScty', FinancialInstrumentIdentification9, True)

	@AltrnScty.deleter
	def AltrnScty(self):
		del self._AltrnScty
		self._AltrnScty = base_types.UninitialisedField(self, 'AltrnScty', FinancialInstrumentIdentification9, True)
