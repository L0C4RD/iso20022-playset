...
class PaymentReturnCriteria4(base_types._BaseFieldType):
	...
	__slots__ = ["_TxIdInd", "_PmtMtdInd", "_InstgRmbrsmntAgtInd", "_CdtrAgtInd", "_InstrStsRtrCrit", "_PmtTpInd", "_DbtrAgtInd", "_MsgIdInd", "_InstdAmtInd", "_IntrBkSttlmAmtInd", "_EndToEndIdInd", "_InstrInd", "_CdtrInd", "_PrcgVldtyTmInd", "_InstdRmbrsmntAgtInd", "_InstrCpyInd", "_CdtDbtInd", "_DbtrInd", "_PurpInd", "_PrtyInd", "_PmtMTInd", "_ReqdExctnDtInd", "_IntrBkSttlmDtInd", "_IntrmyInd"]
	@property
	def TxIdInd(self):
