...
class PaymentReturnCriteria4(base_types._BaseFieldType):
	...
	__slots__ = ["_CdtDbtInd", "_InstrCpyInd", "_IntrmyInd", "_DbtrAgtInd", "_CdtrInd", "_MsgIdInd", "_PrtyInd", "_InstdAmtInd", "_PmtMtdInd", "_InstdRmbrsmntAgtInd", "_InstrStsRtrCrit", "_PmtTpInd", "_IntrBkSttlmDtInd", "_DbtrInd", "_ReqdExctnDtInd", "_PmtMTInd", "_PrcgVldtyTmInd", "_InstrInd", "_PurpInd", "_TxIdInd", "_CdtrAgtInd", "_EndToEndIdInd", "_InstgRmbrsmntAgtInd", "_IntrBkSttlmAmtInd"]
	@property
	def CdtDbtInd(self):
