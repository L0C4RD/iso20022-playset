...
class PaymentReturnCriteria4(base_types._BaseFieldType):
	...
	__slots__ = ["_IntrmyInd", "_InstdAmtInd", "_MsgIdInd", "_PmtMtdInd", "_IntrBkSttlmAmtInd", "_PurpInd", "_CdtrAgtInd", "_DbtrAgtInd", "_PmtMTInd", "_IntrBkSttlmDtInd", "_TxIdInd", "_EndToEndIdInd", "_ReqdExctnDtInd", "_InstdRmbrsmntAgtInd", "_DbtrInd", "_PrcgVldtyTmInd", "_CdtDbtInd", "_PmtTpInd", "_InstrCpyInd", "_InstgRmbrsmntAgtInd", "_PrtyInd", "_CdtrInd", "_InstrInd", "_InstrStsRtrCrit"]
	@property
	def IntrmyInd(self):
