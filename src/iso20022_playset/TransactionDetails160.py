...
class TransactionDetails160(base_types._BaseFieldType):

	__slots__ = ["_SttlmQty", "_DlvrgSttlmPties", "_RcvgSttlmPties", "_Invstr", "_FinInstrmId", "_SttlmDt", "_TradDt", "_SttlmAmt"]
	@property
	def SttlmQty(self):
