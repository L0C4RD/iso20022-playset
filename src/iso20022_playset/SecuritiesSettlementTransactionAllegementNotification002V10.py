...
class SecuritiesSettlementTransactionAllegementNotification002V10(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmTpAndAddtlParams", "_SctiesFincgDtls", "_QtyAndAcctDtls", "_FinInstrmId", "_CshPties", "_RcvgSttlmPties", "_FinInstrmAttrbts", "_DlvrgSttlmPties", "_MktInfrstrctrTxId", "_CtrPtyMktInfrstrctrTxId", "_OthrBizPties", "_SttlmParams", "_OthrAmts", "_TxId", "_SplmtryData", "_SttlmAmt", "_TradDtls"]
	@property
