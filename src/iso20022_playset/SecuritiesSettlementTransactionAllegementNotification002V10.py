...
class SecuritiesSettlementTransactionAllegementNotification002V10(base_types._BaseFieldType):
	...
	__slots__ = ["_RcvgSttlmPties", "_SttlmTpAndAddtlParams", "_CtrPtyMktInfrstrctrTxId", "_MktInfrstrctrTxId", "_CshPties", "_OthrBizPties", "_TradDtls", "_OthrAmts", "_TxId", "_DlvrgSttlmPties", "_SctiesFincgDtls", "_FinInstrmAttrbts", "_SttlmParams", "_QtyAndAcctDtls", "_SttlmAmt", "_SplmtryData", "_FinInstrmId"]
	@property
