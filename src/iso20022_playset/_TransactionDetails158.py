...
class TransactionDetails158(base_types._BaseFieldType):

	__slots__ = ["_SctiesMvmntTp", "_TradDt", "_SttlmDt", "_DlvrgSttlmPties", "_Pmt", "_RcvgSttlmPties", "_FinInstrmId", "_Invstr", "_SttlmQty", "_SttlmAmt"]
	@property
