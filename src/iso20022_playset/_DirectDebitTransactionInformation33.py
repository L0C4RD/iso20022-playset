...
class DirectDebitTransactionInformation33(base_types._BaseFieldType):
	...
	__slots__ = ["_IntrBkSttlmAmt", "_UltmtDbtr", "_SttlmTmIndctn", "_RmtInf", "_SttlmPrty", "_PmtId", "_SttlmTmReq", "_DbtrAgt", "_DbtrAgtAcct", "_Purp", "_InstrForDbtrAgt", "_Dbtr", "_PmtTpInf", "_DbtrAcct", "_IntrBkSttlmDt"]
	@property
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='InstrForDbtrAgt', type=Max210Text, min=0, max=1, mutex_group=None, array=False),
