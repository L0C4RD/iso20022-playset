...
class InputData6(base_types._BaseFieldType):
	...
	__slots__ = ["_MenuBckFlg", "_MaxInptTm", "_InptCmd", "_ImdtRspnFlg", "_GblCrrctnFlg", "_BeepKeyFlg", "_DvcTp", "_DsblCclFlg", "_InptTxt", "_DsblVldFlg", "_NtfyCardInptFlg", "_WaitUsrVldtnFlg", "_InfQlfr", "_DsblCrrctFlg"]
	@property
	def MenuBckFlg(self):
