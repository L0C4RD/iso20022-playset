...
class InputData6(base_types._BaseFieldType):
	...
	__slots__ = ["_InptTxt", "_DsblCrrctFlg", "_DsblVldFlg", "_MaxInptTm", "_BeepKeyFlg", "_DsblCclFlg", "_DvcTp", "_ImdtRspnFlg", "_MenuBckFlg", "_NtfyCardInptFlg", "_InfQlfr", "_WaitUsrVldtnFlg", "_InptCmd", "_GblCrrctnFlg"]
	@property
	def InptTxt(self):
