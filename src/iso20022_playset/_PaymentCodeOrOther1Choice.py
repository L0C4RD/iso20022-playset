...
class PaymentCodeOrOther1Choice(base_types._BaseFieldType):
	...
	def PmtCd(self, value):
		self._PmtCd = value if value is not None else base_types.UninitialisedField(self, 'PmtCd', PaymentPeriod3, False)

	@PmtCd.deleter
	def PmtCd(self):
		del self._PmtCd
		self._PmtCd = base_types.UninitialisedField(self, 'PmtCd', PaymentPeriod3, False)
