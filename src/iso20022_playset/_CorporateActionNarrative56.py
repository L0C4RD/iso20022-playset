...
class CorporateActionNarrative56(base_types._BaseFieldType):
	...
	def AddtlTxt(self, value):
		self._AddtlTxt = value if value is not None else base_types.UninitialisedField(self, 'AddtlTxt', UpdatedAdditionalInformation17, False)

	@AddtlTxt.deleter
	def AddtlTxt(self):
		del self._AddtlTxt
		self._AddtlTxt = base_types.UninitialisedField(self, 'AddtlTxt', UpdatedAdditionalInformation17, False)
	...
	def BsktOrIndxInf(self, value):
		self._BsktOrIndxInf = value if value is not None else base_types.UninitialisedField(self, 'BsktOrIndxInf', UpdatedAdditionalInformation17, False)

	@BsktOrIndxInf.deleter
	def BsktOrIndxInf(self):
		del self._BsktOrIndxInf
		self._BsktOrIndxInf = base_types.UninitialisedField(self, 'BsktOrIndxInf', UpdatedAdditionalInformation17, False)
	...
	def NrrtvVrsn(self, value):
		self._NrrtvVrsn = value if value is not None else base_types.UninitialisedField(self, 'NrrtvVrsn', UpdatedAdditionalInformation17, False)

	@NrrtvVrsn.deleter
	def NrrtvVrsn(self):
		del self._NrrtvVrsn
		self._NrrtvVrsn = base_types.UninitialisedField(self, 'NrrtvVrsn', UpdatedAdditionalInformation17, False)
	...
	def PrcgTxtForNxtIntrmy(self, value):
		self._PrcgTxtForNxtIntrmy = value if value is not None else base_types.UninitialisedField(self, 'PrcgTxtForNxtIntrmy', UpdatedAdditionalInformation17, False)

	@PrcgTxtForNxtIntrmy.deleter
	def PrcgTxtForNxtIntrmy(self):
		del self._PrcgTxtForNxtIntrmy
		self._PrcgTxtForNxtIntrmy = base_types.UninitialisedField(self, 'PrcgTxtForNxtIntrmy', UpdatedAdditionalInformation17, False)
	...
	def PtyCtctNrrtv(self, value):
		self._PtyCtctNrrtv = value if value is not None else base_types.UninitialisedField(self, 'PtyCtctNrrtv', UpdatedAdditionalInformation17, False)

	@PtyCtctNrrtv.deleter
	def PtyCtctNrrtv(self):
		del self._PtyCtctNrrtv
		self._PtyCtctNrrtv = base_types.UninitialisedField(self, 'PtyCtctNrrtv', UpdatedAdditionalInformation17, False)
	...
	def RegnDtls(self, value):
		self._RegnDtls = value if value is not None else base_types.UninitialisedField(self, 'RegnDtls', UpdatedAdditionalInformation17, False)

	@RegnDtls.deleter
	def RegnDtls(self):
		del self._RegnDtls
		self._RegnDtls = base_types.UninitialisedField(self, 'RegnDtls', UpdatedAdditionalInformation17, False)
