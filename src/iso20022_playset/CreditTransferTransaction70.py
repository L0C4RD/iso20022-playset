...
import PaymentIdentification13
...
import CryptographicKey1Choice
import ChargeBearerType1Code
import AdditionalDateTime1

class CreditTransferTransaction70(base_types._BaseFieldType):

	__slots__ = ["_IntrmyAgt2", "_AgrdRate", "_SttlmTmReq", "_DbtrAgt", "_IntrmyAgt1Acct", "_Cdtr", "_Purp", "_XchgRate", "_CdtrAgtAcct", "_InstrForCdtrAgt", "_IntrmyAgt1", "_Tax", "_RmtInf", "_IntrmyAgt3", "_PrvsInstgAgt1Acct", "_InstdAgt", "_IntrBkSttlmDt", "_PmtTpInf", "_IntrBkSttlmAmt", "_PrvsInstgAgt1", "_DbtrAcct", "_InstgAgt", "_RltdRmtInf", "_PrvsInstgAgt2", "_UltmtCdtr", "_MndtRltdInf", "_IntrmyAgt3Acct", "_DbtrAgtAcct", "_InstdAmt", "_RgltryRptg", "_ChrgsInf", "_IntrmyAgt2Acct", "_SttlmTmIndctn", "_UltmtDbtr", "_InitgPty", "_AddtlDtTm", "_SttlmPrty", "_PrvsInstgAgt3Acct", "_InstrForNxtAgt", "_ChrgBr", "_Dbtr", "_PmtId", "_CdtrAgt", "_PrvsInstgAgt3", "_CdtrAcct", "_SplmtryData", "_PmtSgntr", "_PrvsInstgAgt2Acct"]
	@property
	def IntrmyAgt2(self):
