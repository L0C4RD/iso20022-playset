...
class CreditTransferTransaction70(base_types._BaseFieldType):
	...
	__slots__ = ["_Dbtr", "_SplmtryData", "_CdtrAgtAcct", "_RltdRmtInf", "_IntrmyAgt2", "_ChrgBr", "_IntrBkSttlmDt", "_PrvsInstgAgt1", "_PrvsInstgAgt3", "_RgltryRptg", "_SttlmTmReq", "_InitgPty", "_InstrForCdtrAgt", "_IntrBkSttlmAmt", "_ChrgsInf", "_SttlmPrty", "_CdtrAgt", "_IntrmyAgt1Acct", "_IntrmyAgt3Acct", "_CdtrAcct", "_InstgAgt", "_PrvsInstgAgt2Acct", "_PrvsInstgAgt2", "_AgrdRate", "_DbtrAgtAcct", "_InstrForNxtAgt", "_UltmtCdtr", "_SttlmTmIndctn", "_InstdAmt", "_AddtlDtTm", "_IntrmyAgt2Acct", "_DbtrAcct", "_PrvsInstgAgt1Acct", "_InstdAgt", "_PmtId", "_PrvsInstgAgt3Acct", "_PmtSgntr", "_MndtRltdInf", "_UltmtDbtr", "_PmtTpInf", "_RmtInf", "_IntrmyAgt3", "_DbtrAgt", "_Tax", "_Purp", "_XchgRate", "_IntrmyAgt1", "_Cdtr"]
	@property
	def Dbtr(self):
		return self._Dbtr
