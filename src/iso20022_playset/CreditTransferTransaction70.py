...
from .PaymentIdentification13 import PaymentIdentification13
...
from .AdditionalDateTime1 import AdditionalDateTime1
from .CurrencyExchange26 import CurrencyExchange26
from .PaymentTypeInformation28 import PaymentTypeInformation28
from .CryptographicKey1Choice import CryptographicKey1Choice
from .BranchAndFinancialInstitutionIdentification8 import BranchAndFinancialInstitutionIdentification8

class CreditTransferTransaction70(base_types._BaseFieldType):

	__slots__ = ["_DbtrAgt", "_CdtrAgt", "_PrvsInstgAgt3", "_Purp", "_SttlmTmReq", "_PrvsInstgAgt2Acct", "_DbtrAgtAcct", "_ChrgsInf", "_IntrmyAgt1", "_SttlmTmIndctn", "_CdtrAcct", "_Tax", "_InstdAgt", "_SplmtryData", "_PrvsInstgAgt1", "_IntrmyAgt3", "_RmtInf", "_InstrForCdtrAgt", "_IntrmyAgt3Acct", "_XchgRate", "_UltmtDbtr", "_PmtId", "_ChrgBr", "_InitgPty", "_IntrmyAgt1Acct", "_PrvsInstgAgt2", "_RgltryRptg", "_Dbtr", "_UltmtCdtr", "_RltdRmtInf", "_AgrdRate", "_MndtRltdInf", "_DbtrAcct", "_CdtrAgtAcct", "_InstdAmt", "_IntrBkSttlmAmt", "_AddtlDtTm", "_SttlmPrty", "_IntrBkSttlmDt", "_IntrmyAgt2", "_PmtTpInf", "_PmtSgntr", "_InstgAgt", "_PrvsInstgAgt3Acct", "_InstrForNxtAgt", "_IntrmyAgt2Acct", "_PrvsInstgAgt1Acct", "_Cdtr"]
	@property
	def DbtrAgt(self):
	...
	@AddtlDtTm.setter
	def AddtlDtTm(self, value):
		self._AddtlDtTm = value if type(value) != base_types.auto else self.make_default("AddtlDtTm")

	@AddtlDtTm.deleter
	def AddtlDtTm(self):
		del self._AddtlDtTm
		self._AddtlDtTm = None
	...
	def PmtSgntr(self, value):
		self._PmtSgntr = value if type(value) != base_types.auto else self.make_default("PmtSgntr")
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='AddtlDtTm', type=AdditionalDateTime1, min=0, max=1, mutex_group=None, array=False),
