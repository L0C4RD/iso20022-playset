...
class ReportEntry15(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlInfInd", "_Sts", "_BookgDt", "_Chrgs", "_BkTxCd", "_AddtlNtryInf", "_CardTx", "_AmtDtls", "_TechInptChanl", "_Intrst", "_AcctSvcrRef", "_ComssnWvrInd", "_ValDt", "_CdtDbtInd", "_NtryDtls", "_Avlbty", "_RvslInd", "_Amt", "_NtryRef"]
	@property
