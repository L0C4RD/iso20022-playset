...
class IdentificationReference15Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_InstgPtyTxId", "_IndvAllcnId", "_PoolId", "_UnqTxIdr", "_ClntOrdrLkId", "_CmonId", "_CmplcId", "_CollTxId", "_AllcnId", "_MktInfrstrctrTxId", "_BlckId", "_IndxId", "_ScndryAllcnId", "_ExctgPtyTxId"]
	@property
