...
class IdentificationReference15Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_ClntOrdrLkId", "_AllcnId", "_MktInfrstrctrTxId", "_IndvAllcnId", "_ExctgPtyTxId", "_IndxId", "_PoolId", "_CollTxId", "_InstgPtyTxId", "_ScndryAllcnId", "_CmonId", "_BlckId", "_CmplcId", "_UnqTxIdr"]
	@property
