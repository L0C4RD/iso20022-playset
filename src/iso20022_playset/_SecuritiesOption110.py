...
class SecuritiesOption110(base_types._BaseFieldType):
	...
	__slots__ = ["_PricDtls", "_CtryOfIncmSrc", "_SfkpgPlc", "_NonElgblPrcdsInd", "_IncmTp", "_EntitldQty", "_XmptnTp", "_TempFinInstrmInd", "_IssrOfferrTaxbltyInd", "_SctyDtls", "_AmtDtls", "_OthrIncmTp", "_TradgPrd", "_NewSctiesIssncInd", "_CdtDbtInd", "_FrctnDspstn", "_RateDtls", "_DtDtls", "_CcyOptn"]
	@property
	def PricDtls(self):
