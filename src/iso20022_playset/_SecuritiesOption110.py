...
class SecuritiesOption110(base_types._BaseFieldType):
	...
	__slots__ = ["_RateDtls", "_EntitldQty", "_NewSctiesIssncInd", "_CcyOptn", "_OthrIncmTp", "_IncmTp", "_XmptnTp", "_SctyDtls", "_CdtDbtInd", "_PricDtls", "_SfkpgPlc", "_TempFinInstrmInd", "_CtryOfIncmSrc", "_AmtDtls", "_DtDtls", "_TradgPrd", "_NonElgblPrcdsInd", "_IssrOfferrTaxbltyInd", "_FrctnDspstn"]
	@property
	def RateDtls(self):
