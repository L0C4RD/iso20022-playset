...
class ProcessingCharacteristics10(base_types._BaseFieldType):
	...
	__slots__ = ["_MainFndOrdrDskLctn", "_RedAuthstn", "_LtdPrd", "_DealgFrqcyDesc", "_DealConfTm", "_SttlmCycl", "_Rndg", "_PctgInd", "_AmtInd", "_DealgCcyAccptd", "_DealgCutOffTmFrame", "_DealgFrqcy", "_AddtlInf", "_UnitsInd", "_DealConfTmFrame", "_DealgCutOffTm"]
	@property
