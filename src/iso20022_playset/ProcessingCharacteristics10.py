...
class ProcessingCharacteristics10(base_types._BaseFieldType):
	...
	__slots__ = ["_DealConfTm", "_DealgFrqcy", "_AddtlInf", "_SttlmCycl", "_DealConfTmFrame", "_DealgCcyAccptd", "_DealgCutOffTmFrame", "_PctgInd", "_RedAuthstn", "_UnitsInd", "_AmtInd", "_LtdPrd", "_DealgCutOffTm", "_Rndg", "_MainFndOrdrDskLctn", "_DealgFrqcyDesc"]
	@property
	def DealConfTm(self):
