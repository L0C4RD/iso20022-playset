...
class ProcessingCharacteristics10(base_types._BaseFieldType):
	...
	__slots__ = ["_PctgInd", "_MainFndOrdrDskLctn", "_Rndg", "_AmtInd", "_DealgFrqcy", "_SttlmCycl", "_RedAuthstn", "_DealgCutOffTmFrame", "_DealConfTm", "_UnitsInd", "_AddtlInf", "_DealgCcyAccptd", "_DealConfTmFrame", "_LtdPrd", "_DealgFrqcyDesc", "_DealgCutOffTm"]
	@property
	def PctgInd(self):
