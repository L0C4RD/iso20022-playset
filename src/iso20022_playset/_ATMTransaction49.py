...
from .ATMMediaMix1 import ATMMediaMix1
from .CurrencyConversion32 import CurrencyConversion32
from .TrueFalseIndicator import TrueFalseIndicator
from .Max35Text import Max35Text
from .CardAccount22 import CardAccount22
...
class ATMTransaction49(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlReqdAmt", "_ICCRltdData", "_CmpltnReqrd", "_Mix", "_CcyConvsElgblty", "_TxId", "_AcctInf", "_RcncltnId", "_PrtctdAcctData", "_Lmts", "_AcctData", "_TtlAuthrsdAmt", "_Cmd", "_AddtlChrg", "_AuthstnRslt", "_DtldReqdAmt", "_MixTp"]
	@property
	def TtlReqdAmt(self):
