...
class ATMTransaction49(base_types._BaseFieldType):
	...
	__slots__ = ["_CcyConvsElgblty", "_AddtlChrg", "_Cmd", "_TxId", "_AcctData", "_Lmts", "_MixTp", "_PrtctdAcctData", "_RcncltnId", "_DtldReqdAmt", "_TtlReqdAmt", "_TtlAuthrsdAmt", "_ICCRltdData", "_AcctInf", "_Mix", "_AuthstnRslt", "_CmpltnReqrd"]
	@property
