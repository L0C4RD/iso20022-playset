...
class ForeignExchangeTradeInstructionAmendmentV06(base_types._BaseFieldType):
	...
	__slots__ = ["_TradgSdId", "_TradgSdSttlmInstrs", "_TradInf", "_OptnlGnlInf", "_TradAmts", "_CtrPtySdId", "_RgltryRptg", "_AgrdRate", "_NDFConds", "_PstTradEvt", "_SplmtryData", "_CtrPtySdSttlmInstrs"]
	@property
	def AgrdRate(self):
