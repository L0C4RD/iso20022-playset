...
class ForeignExchangeTradeInstructionAmendmentV06(base_types._BaseFieldType):
	...
	def TradInf(self, value):
		self._TradInf = value if value is not None else base_types.UninitialisedField(self, 'TradInf', TradeAgreement15, False)

	@TradInf.deleter
	def TradInf(self):
		del self._TradInf
		self._TradInf = base_types.UninitialisedField(self, 'TradInf', TradeAgreement15, False)
