...
from .TimeFrame7Choice import TimeFrame7Choice
from .MainFundOrderDeskLocation1 import MainFundOrderDeskLocation1
from .TimeFrame11 import TimeFrame11
...
class ProcessingCharacteristics11(base_types._BaseFieldType):
	...
	__slots__ = ["_LtdPrd", "_SttlmCycl", "_DealConfTmFrame", "_DealgCcyAccptd", "_SbsqntInvstmtAppl", "_DealgCutOffTm", "_DealgFrqcy", "_Rndg", "_UnitsInd", "_MainFndOrdrDskLctn", "_InitlInvstmtAppl", "_AmtInd", "_DealgFrqcyDesc", "_AddtlInf", "_DealConfTm", "_DealgCutOffTmFrame"]
	@property
	def LtdPrd(self):
		return self._LtdPrd
	...
	def SbsqntInvstmtAppl(self, value):
		self._SbsqntInvstmtAppl = value if type(value) != base_types.auto else self.make_default("SbsqntInvstmtAppl")
	...
	def InitlInvstmtAppl(self, value):
		self._InitlInvstmtAppl = value if type(value) != base_types.auto else self.make_default("InitlInvstmtAppl")
