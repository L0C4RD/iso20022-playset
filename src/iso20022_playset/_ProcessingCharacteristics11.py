...
class ProcessingCharacteristics11(base_types._BaseFieldType):
	...
	__slots__ = ["_MainFndOrdrDskLctn", "_LtdPrd", "_DealConfTmFrame", "_Rndg", "_DealgCutOffTmFrame", "_SttlmCycl", "_DealgFrqcyDesc", "_DealgCutOffTm", "_SbsqntInvstmtAppl", "_DealgFrqcy", "_UnitsInd", "_InitlInvstmtAppl", "_DealgCcyAccptd", "_DealConfTm", "_AddtlInf", "_AmtInd"]
	@property
