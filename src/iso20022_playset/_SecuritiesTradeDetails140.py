...
from .SecuritiesFinancingTransactionDetails50 import SecuritiesFinancingTransactionDetails50
from .PlaceOfTradeIdentification2 import PlaceOfTradeIdentification2
from .TradeTransactionCondition6Choice import TradeTransactionCondition6Choice
from .QuantityAndAccount107 import QuantityAndAccount107
from .FinancialInstrumentAttributes122 import FinancialInstrumentAttributes122
from .AllegementStatus4Choice import AllegementStatus4Choice
from .Max3Number import Max3Number
from .OtherAmounts36 import OtherAmounts36
from .SettlementParties105 import SettlementParties105
from .OtherParties37 import OtherParties37
from .PlaceOfClearingIdentification2 import PlaceOfClearingIdentification2
from .SettlementDetails174 import SettlementDetails174
from .RestrictedFINXMax16Text import RestrictedFINXMax16Text
from .AmountAndDirection92 import AmountAndDirection92
...
from .Price11 import Price11

class SecuritiesTradeDetails140(base_types._BaseFieldType):

	__slots__ = ["_PlcOfTrad", "_NbOfDaysAcrd", "_SplmtryData", "_DlvrgSttlmPties", "_DealPric", "_Pmt", "_TradDt", "_FinInstrmAttrbts", "_SctiesFincgDtls", "_TradTxCond", "_SttlmParams", "_PoolId", "_OthrAmts", "_AcctOwnrTxId", "_OthrBizPties", "_CollTxId", "_CmonId", "_TpOfPric", "_AcctSvcrTxId", "_SttlmDt", "_RcvgSttlmPties", "_CtrPtyMktInfrstrctrTxId", "_SctiesMvmntTp", "_QtyAndAcctDtls", "_TradId", "_PrcrTxId", "_MktInfrstrctrTxId", "_PlcOfClr", "_Sts", "_SttlmAmt", "_FinInstrmId"]
	@property
	def PlcOfTrad(self):
