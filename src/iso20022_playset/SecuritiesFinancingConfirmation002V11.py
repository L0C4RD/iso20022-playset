...
class SecuritiesFinancingConfirmation002V11(base_types._BaseFieldType):
	...
	__slots__ = ["_RcvgSttlmPties", "_CshPties", "_TradDtls", "_StgSttlmInstrDtls", "_AddtlParams", "_OthrBizPties", "_QtyAndAcctDtls", "_SctiesFincgDtls", "_DlvrgSttlmPties", "_FinInstrmAttrbts", "_SttldAmt", "_SplmtryData", "_TxIdDtls", "_SttlmParams", "_OthrAmts", "_FinInstrmId"]
	@property
