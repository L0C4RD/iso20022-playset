...
class SecuritiesFinancingConfirmation002V11(base_types._BaseFieldType):
	...
	__slots__ = ["_CshPties", "_SttlmParams", "_FinInstrmId", "_OthrBizPties", "_OthrAmts", "_RcvgSttlmPties", "_FinInstrmAttrbts", "_DlvrgSttlmPties", "_TxIdDtls", "_QtyAndAcctDtls", "_TradDtls", "_SctiesFincgDtls", "_StgSttlmInstrDtls", "_SttldAmt", "_AddtlParams", "_SplmtryData"]
	@property
	def CshPties(self):
