...
class SecuritiesFinancingConfirmation002V11(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrBizPties", "_SplmtryData", "_SttlmParams", "_QtyAndAcctDtls", "_RcvgSttlmPties", "_AddtlParams", "_FinInstrmId", "_FinInstrmAttrbts", "_DlvrgSttlmPties", "_StgSttlmInstrDtls", "_TradDtls", "_TxIdDtls", "_OthrAmts", "_SttldAmt", "_CshPties", "_SctiesFincgDtls"]
	@property
