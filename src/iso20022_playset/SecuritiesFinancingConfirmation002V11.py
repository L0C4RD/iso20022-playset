...
class SecuritiesFinancingConfirmation002V11(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrAmts", "_SttlmParams", "_AddtlParams", "_SttldAmt", "_FinInstrmId", "_StgSttlmInstrDtls", "_RcvgSttlmPties", "_TradDtls", "_OthrBizPties", "_FinInstrmAttrbts", "_SplmtryData", "_CshPties", "_QtyAndAcctDtls", "_SctiesFincgDtls", "_DlvrgSttlmPties", "_TxIdDtls"]
	@property
	def OthrAmts(self):
