...
class SecuritiesFinancingConfirmation002V11(base_types._BaseFieldType):
	...
	__slots__ = ["_SttldAmt", "_AddtlParams", "_QtyAndAcctDtls", "_TradDtls", "_FinInstrmAttrbts", "_OthrBizPties", "_DlvrgSttlmPties", "_CshPties", "_OthrAmts", "_RcvgSttlmPties", "_SctiesFincgDtls", "_FinInstrmId", "_TxIdDtls", "_StgSttlmInstrDtls", "_SplmtryData", "_SttlmParams"]
	@property
	def SttldAmt(self):
