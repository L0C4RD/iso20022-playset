...
class SecuritiesFinancingConfirmation002V11(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrBizPties", "_FinInstrmAttrbts", "_CshPties", "_TradDtls", "_FinInstrmId", "_SttlmParams", "_DlvrgSttlmPties", "_SttldAmt", "_TxIdDtls", "_OthrAmts", "_StgSttlmInstrDtls", "_AddtlParams", "_SctiesFincgDtls", "_QtyAndAcctDtls", "_SplmtryData", "_RcvgSttlmPties"]
	@property
