...
class SecuritiesCollateral11(base_types._BaseFieldType):
	...
	__slots__ = ["_Hrcut", "_ValDt", "_SfkpgPlc", "_SfkpgAcct", "_CollId", "_MtrtyDt", "_SctyId", "_CollVal", "_Pric", "_BlckChainAdrOrWllt", "_Qty", "_SttlmParams", "_AsstNb", "_MktVal", "_LtdCvrgInd"]
	@property
	def AsstNb(self):
		return self._AsstNb
