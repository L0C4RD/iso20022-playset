...
class SecuritiesCollateral11(base_types._BaseFieldType):
	...
	__slots__ = ["_Hrcut", "_SctyId", "_AsstNb", "_CollId", "_Qty", "_SfkpgAcct", "_ValDt", "_MktVal", "_SttlmParams", "_LtdCvrgInd", "_CollVal", "_BlckChainAdrOrWllt", "_MtrtyDt", "_SfkpgPlc", "_Pric"]
	@property
	def Hrcut(self):
		return self._Hrcut
