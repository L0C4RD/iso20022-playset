...
from ._SettlementDetails206 import SettlementDetails206
...
class SecuritiesCollateral11(base_types._BaseFieldType):
	...
	__slots__ = ["_LtdCvrgInd", "_Hrcut", "_SfkpgAcct", "_AsstNb", "_ValDt", "_SctyId", "_MktVal", "_CollId", "_CollVal", "_SfkpgPlc", "_Pric", "_Qty", "_BlckChainAdrOrWllt", "_SttlmParams", "_MtrtyDt"]
	@property
	def LtdCvrgInd(self):
