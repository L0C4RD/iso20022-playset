...
from . import SettlementDetails206
from . import YesNoIndicator

class SecuritiesCollateral11(base_types._BaseFieldType):

	__slots__ = ["_AsstNb", "_BlckChainAdrOrWllt", "_CollId", "_CollVal", "_Hrcut", "_LtdCvrgInd", "_MktVal", "_MtrtyDt", "_Pric", "_Qty", "_SctyId", "_SfkpgAcct", "_SfkpgPlc", "_SttlmParams", "_ValDt"]
	@property
	def AsstNb(self):
		return self._AsstNb
	...
	def SttlmParams(self, value):
		self._SttlmParams = value if value is not None else base_types.UninitialisedField(self, 'SttlmParams', SettlementDetails206, False)

	@SttlmParams.deleter
	def SttlmParams(self):
		del self._SttlmParams
		self._SttlmParams = base_types.UninitialisedField(self, 'SttlmParams', SettlementDetails206, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='SttlmParams', type=SettlementDetails206, min=0, max=1, mutex_group=None, array=False),
