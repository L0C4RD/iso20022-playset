...
from . import MarketClaimCancellationRequestStatus3Choice
from . import References26
from . import SupplementaryData1

class MarketClaimCancellationRequestStatusAdviceV04(base_types._BaseFieldType):
	...
	def MktClmCxlReqSts(self, value):
		self._MktClmCxlReqSts = value if value is not None else base_types.UninitialisedField(self, 'MktClmCxlReqSts', MarketClaimCancellationRequestStatus3Choice, False)

	@MktClmCxlReqSts.deleter
	def MktClmCxlReqSts(self):
		del self._MktClmCxlReqSts
		self._MktClmCxlReqSts = base_types.UninitialisedField(self, 'MktClmCxlReqSts', MarketClaimCancellationRequestStatus3Choice, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='MktClmCxlReqSts', type=MarketClaimCancellationRequestStatus3Choice, min=1, max=1, mutex_group=None, array=False),
