...
class PaymentTransaction158(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlInstrId", "_OrgnlEndToEndId", "_OrgnlGrpInf", "_OrgnlTxId", "_InstgAgt", "_AccptncDtTm", "_OrgnlUETR", "_InstdAgt", "_SplmtryData", "_ClrSysRef", "_OrgnlTxRef", "_StsReqId"]
	@property
