...
class PaymentTransaction158(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlTxRef", "_InstdAgt", "_StsReqId", "_SplmtryData", "_OrgnlUETR", "_InstgAgt", "_ClrSysRef", "_OrgnlEndToEndId", "_OrgnlGrpInf", "_OrgnlTxId", "_AccptncDtTm", "_OrgnlInstrId"]
	@property
	def OrgnlTxRef(self):
