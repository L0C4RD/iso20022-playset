...
class SettlementDetails190(base_types._BaseFieldType):
	...
	__slots__ = ["_NetgElgblty", "_StmpDtyTaxBsis", "_BnfclOwnrsh", "_LglRstrctns", "_RpTp", "_Regn", "_SttlmTxCond", "_SttlgCpcty", "_TaxCpcty", "_CshClrSys", "_SttlmSysMtd", "_PrtlSttlmInd", "_MktClntSd", "_BlckTrad", "_CCPElgblty", "_SctiesRTGS", "_LttrOfGrnt"]
	@property
