...
from . import TransactionDetails185
from . import UTIIdentifier

class Transaction164(base_types._BaseFieldType):
	...
	def StsAndRsn(self, value):
		self._StsAndRsn = value if value is not None else base_types.UninitialisedField(self, 'StsAndRsn', Status43Choice, True)

	@StsAndRsn.deleter
	def StsAndRsn(self):
		del self._StsAndRsn
		self._StsAndRsn = base_types.UninitialisedField(self, 'StsAndRsn', Status43Choice, True)
	...
	def TxDtls(self, value):
		self._TxDtls = value if value is not None else base_types.UninitialisedField(self, 'TxDtls', TransactionDetails185, False)

	@TxDtls.deleter
	def TxDtls(self):
		del self._TxDtls
		self._TxDtls = base_types.UninitialisedField(self, 'TxDtls', TransactionDetails185, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='StsAndRsn', type=Status43Choice, min=0, max=None, mutex_group=None, array=True),
		...
		base_types.FieldEntry(name='TxDtls', type=TransactionDetails185, min=0, max=1, mutex_group=None, array=False),
