...
class MandateInitiationRequestV08(base_types._BaseFieldType):
	...
	@Mndt.setter
	def Mndt(self, value):
		self._Mndt = value if value is not None else base_types.UninitialisedField(self, 'Mndt', Mandate23, True)

	@Mndt.deleter
	def Mndt(self):
		del self._Mndt
		self._Mndt = base_types.UninitialisedField(self, 'Mndt', Mandate23, True)
