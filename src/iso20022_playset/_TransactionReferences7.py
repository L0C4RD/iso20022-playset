...
class TransactionReferences7(base_types._BaseFieldType):
	...
	__slots__ = ["_MsgNmId", "_AcctSvcrTxId", "_AcctOwnrTxId", "_ChqNb", "_PmtInfId", "_EndToEndId", "_InstrId", "_AcctSvcrRef", "_MndtId", "_UETR", "_MktInfrstrctrTxId", "_Prtry", "_TxId", "_ClrSysRef", "_PrcgId", "_MsgId"]
	@property
	def MsgNmId(self):
