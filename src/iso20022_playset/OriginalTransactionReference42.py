...
class OriginalTransactionReference42(base_types._BaseFieldType):
	...
	__slots__ = ["_Purp", "_DbtrAcct", "_CdtrAcct", "_PmtTpInf", "_Dbtr", "_ReqdExctnDt", "_IntrBkSttlmAmt", "_RmtInf", "_CdtrSchmeId", "_CdtrAgt", "_PmtMtd", "_MndtRltdInf", "_IntrBkSttlmDt", "_CdtrAgtAcct", "_Cdtr", "_Amt", "_UltmtCdtr", "_DbtrAgt", "_ReqdColltnDt", "_DbtrAgtAcct", "_UltmtDbtr", "_SttlmInf"]
	@property
	def Purp(self):
		return self._Purp
