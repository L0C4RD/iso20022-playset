...
class OriginalTransactionReference42(base_types._BaseFieldType):

	__slots__ = ["_CdtrSchmeId", "_DbtrAgtAcct", "_CdtrAgt", "_MndtRltdInf", "_Cdtr", "_PmtTpInf", "_PmtMtd", "_IntrBkSttlmAmt", "_ReqdColltnDt", "_Purp", "_CdtrAgtAcct", "_RmtInf", "_SttlmInf", "_UltmtDbtr", "_CdtrAcct", "_UltmtCdtr", "_ReqdExctnDt", "_IntrBkSttlmDt", "_DbtrAgt", "_Amt", "_Dbtr", "_DbtrAcct"]
	@property
