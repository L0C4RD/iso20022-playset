...
class OriginalTransactionReference42(base_types._BaseFieldType):
	...
	__slots__ = ["_PmtTpInf", "_MndtRltdInf", "_Purp", "_ReqdExctnDt", "_DbtrAcct", "_UltmtDbtr", "_DbtrAgtAcct", "_CdtrAgt", "_Dbtr", "_PmtMtd", "_ReqdColltnDt", "_CdtrAgtAcct", "_IntrBkSttlmAmt", "_CdtrAcct", "_CdtrSchmeId", "_IntrBkSttlmDt", "_Amt", "_DbtrAgt", "_RmtInf", "_SttlmInf", "_UltmtCdtr", "_Cdtr"]
	@property
	def PmtTpInf(self):
