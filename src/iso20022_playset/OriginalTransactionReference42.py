...
class OriginalTransactionReference42(base_types._BaseFieldType):
	...
	__slots__ = ["_Amt", "_DbtrAgtAcct", "_Cdtr", "_Dbtr", "_MndtRltdInf", "_UltmtDbtr", "_DbtrAcct", "_SttlmInf", "_ReqdColltnDt", "_CdtrAgtAcct", "_CdtrAcct", "_CdtrAgt", "_DbtrAgt", "_IntrBkSttlmDt", "_Purp", "_CdtrSchmeId", "_UltmtCdtr", "_ReqdExctnDt", "_RmtInf", "_PmtTpInf", "_IntrBkSttlmAmt", "_PmtMtd"]
	@property
	def Amt(self):
		return self._Amt
