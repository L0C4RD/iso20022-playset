...
class CardPaymentTransaction139(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctTo", "_TxId", "_SvcAttr", "_MrchntRefData", "_CardPrgrmmApld", "_InitrTxId", "_TxDtls", "_TxTp", "_OrgnlTx", "_AddtlTxData", "_AcctFr", "_CstmrCnsnt", "_TxCaptr", "_MrchntCtgyCd", "_RcncltnId", "_MrchntCITId", "_IssrCITId", "_SaleRefId", "_LastTxFlg", "_CardPrgrmmPropsd", "_AddtlSvc"]
	@property
	def AcctTo(self):
		return self._AcctTo
