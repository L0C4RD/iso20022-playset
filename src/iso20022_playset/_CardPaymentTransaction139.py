...
class CardPaymentTransaction139(base_types._BaseFieldType):
	...
	__slots__ = ["_TxDtls", "_AcctFr", "_TxId", "_CstmrCnsnt", "_AddtlTxData", "_CardPrgrmmPropsd", "_AcctTo", "_LastTxFlg", "_SvcAttr", "_MrchntCITId", "_InitrTxId", "_CardPrgrmmApld", "_AddtlSvc", "_OrgnlTx", "_SaleRefId", "_RcncltnId", "_MrchntRefData", "_TxTp", "_IssrCITId", "_TxCaptr", "_MrchntCtgyCd"]
	@property
	def TxDtls(self):
		return self._TxDtls
