...
class FinancialInstrumentStipulations4(base_types._BaseFieldType):
	...
	__slots__ = ["_PreFnddInd", "_Pdctn", "_OverAlltmtRate", "_SbstitnFrqcy", "_CpnRg", "_WhlPoolInd", "_MinQty", "_CllblInd", "_TxConds", "_PerptlInd", "_Ratg", "_MinDnmtn", "_CstmDt", "_YldRg", "_InsrdInd", "_Hrcut", "_PricRg", "_Geogcs", "_PricFrqcy", "_PmtFrqcy", "_MtrtyDt", "_OverAlltmtAmt", "_IsseSz", "_EscrwdInd", "_PricSrc", "_Purp", "_IssrId", "_RstrctdInd", "_IsseDt", "_AltrntvMinTaxInd", "_PutblInd", "_Sctr", "_AutoRinvstmt", "_ConvtblInd", "_AmtsblInd", "_Ccy", "_MinIncrmt", "_LookBck", "_SbstitnLft", "_XprtnDt", "_MaxSbstitn"]
	@property
	def PreFnddInd(self):
