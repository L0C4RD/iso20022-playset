...
class FinancialInstrumentStipulations4(base_types._BaseFieldType):
	...
	__slots__ = ["_Pdctn", "_YldRg", "_PricRg", "_Purp", "_TxConds", "_PmtFrqcy", "_CpnRg", "_RstrctdInd", "_MinQty", "_SbstitnFrqcy", "_CstmDt", "_ConvtblInd", "_Geogcs", "_LookBck", "_Sctr", "_OverAlltmtRate", "_IsseDt", "_MaxSbstitn", "_SbstitnLft", "_PutblInd", "_AutoRinvstmt", "_PricFrqcy", "_InsrdInd", "_IssrId", "_XprtnDt", "_Ratg", "_PricSrc", "_CllblInd", "_PerptlInd", "_AmtsblInd", "_WhlPoolInd", "_EscrwdInd", "_PreFnddInd", "_MinIncrmt", "_Hrcut", "_IsseSz", "_Ccy", "_MtrtyDt", "_MinDnmtn", "_AltrntvMinTaxInd", "_OverAlltmtAmt"]
	@property
	def Pdctn(self):
		return self._Pdctn
