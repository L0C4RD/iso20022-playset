...
class FinancialInstrumentStipulations4(base_types._BaseFieldType):
	...
	__slots__ = ["_IsseSz", "_LookBck", "_CstmDt", "_Purp", "_PricFrqcy", "_OverAlltmtAmt", "_YldRg", "_MtrtyDt", "_MinDnmtn", "_PreFnddInd", "_CpnRg", "_CllblInd", "_XprtnDt", "_AmtsblInd", "_InsrdInd", "_MinQty", "_WhlPoolInd", "_OverAlltmtRate", "_PmtFrqcy", "_Pdctn", "_MaxSbstitn", "_Hrcut", "_AutoRinvstmt", "_MinIncrmt", "_PutblInd", "_IsseDt", "_Sctr", "_SbstitnFrqcy", "_PricSrc", "_Geogcs", "_AltrntvMinTaxInd", "_ConvtblInd", "_PerptlInd", "_EscrwdInd", "_TxConds", "_Ratg", "_IssrId", "_SbstitnLft", "_PricRg", "_Ccy", "_RstrctdInd"]
	@property
	def IsseSz(self):
		return self._IsseSz
