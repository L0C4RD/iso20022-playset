...
from . import ProcessingStatus85Choice
from . import RequestDetails32
...
class SecuritiesSettlementConditionModificationStatusAdviceV10(base_types._BaseFieldType):
	...
	def PrcgSts(self, value):
		self._PrcgSts = value if value is not None else base_types.UninitialisedField(self, 'PrcgSts', ProcessingStatus85Choice, False)

	@PrcgSts.deleter
	def PrcgSts(self):
		del self._PrcgSts
		self._PrcgSts = base_types.UninitialisedField(self, 'PrcgSts', ProcessingStatus85Choice, False)
	...
	def ReqDtls(self, value):
		self._ReqDtls = value if value is not None else base_types.UninitialisedField(self, 'ReqDtls', RequestDetails32, False)

	@ReqDtls.deleter
	def ReqDtls(self):
		del self._ReqDtls
		self._ReqDtls = base_types.UninitialisedField(self, 'ReqDtls', RequestDetails32, False)
