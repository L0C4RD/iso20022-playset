...
class Rate43(base_types._BaseFieldType):
	...
	__slots__ = ["_WhldgTaxRate", "_ChrgsFees", "_FsclStmp", "_EarlySlctnFeeRate", "_NetDstrbtnRate", "_GrssIntrstRateUsdForPmt", "_DmdRate", "_TaxOnIncm", "_TaxOnPrfts", "_TaxRclmRate", "_AddtlTax", "_ThrdPtyIncntivRate", "_TaxCdtRate", "_EqulstnRate", "_GrssDstrbtnRate", "_ScndLvlTax", "_AplblRate", "_SlctnFeeRate"]
	@property
