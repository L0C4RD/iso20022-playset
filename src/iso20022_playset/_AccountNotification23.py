...
class AccountNotification23(base_types._BaseFieldType):
	...
	@Itm.setter
	def Itm(self, value):
		self._Itm = value if value is not None else base_types.UninitialisedField(self, 'Itm', NotificationItem9, True)

	@Itm.deleter
	def Itm(self):
		del self._Itm
		self._Itm = base_types.UninitialisedField(self, 'Itm', NotificationItem9, True)
