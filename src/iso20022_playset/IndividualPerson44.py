...
class IndividualPerson44(base_types._BaseFieldType):
	...
	__slots__ = ["_PrvcOfBirth", "_SclSctyNb", "_CityOfBirth", "_BirthDt", "_CtryOfBirth", "_Lang", "_OthrDtls", "_CtryAndResdtlSts", "_PstlAdr", "_OthrId", "_Gndr", "_PrvsNm", "_CtznshInf", "_CurNm", "_TaxtnCtry", "_PmryComAdr", "_ScndryComAdr"]
	@property
