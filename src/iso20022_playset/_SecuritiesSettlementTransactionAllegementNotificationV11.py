...
class SecuritiesSettlementTransactionAllegementNotificationV11(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrPtyMktInfrstrctrTxId", "_SplmtryData", "_SttlmTpAndAddtlParams", "_TradDtls", "_FinInstrmAttrbts", "_FinInstrmId", "_DlvrgSttlmPties", "_SttlmParams", "_RcvgSttlmPties", "_CshPties", "_MktInfrstrctrTxId", "_SttlmAmt", "_OthrAmts", "_QtyAndAcctDtls", "_OthrBizPties", "_SctiesFincgDtls", "_TxId"]
	@property
