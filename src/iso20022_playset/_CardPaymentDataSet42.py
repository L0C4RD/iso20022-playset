...
class CardPaymentDataSet42(base_types._BaseFieldType):
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='RjctdTx', type=CardPaymentDataSet41, min=0, max=None, mutex_group=None, array=True),
		base_types.FieldEntry(name='RmvDataSet', type=TrueFalseIndicator, min=1, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='RsmdApprvl', type=CardPaymentDataSet41, min=0, max=None, mutex_group=None, array=True),
		base_types.FieldEntry(name='RsmdRjctn', type=CardPaymentDataSet41, min=0, max=None, mutex_group=None, array=True),
		base_types.FieldEntry(name='SspdTx', type=CardPaymentDataSet41, min=0, max=None, mutex_group=None, array=True),
