...
class AggregateBalancePerSafekeepingPlace42(base_types._BaseFieldType):
	...
	__slots__ = ["_SfkpgPlc", "_DaysAcrd", "_PlcOfListg", "_FXDtls", "_InstrmCcyAmts", "_BalBrkdwn", "_AddtlBalBrkdwn", "_AltrnRptgCcyAmts", "_XpsrTp", "_QtyBrkdwn", "_AggtBal", "_AcctBaseCcyAmts", "_HldgAddtlDtls", "_Pldgee", "_PricDtls"]
	@property
	def SfkpgPlc(self):
