...
class AcceptorConfigurationContent14(base_types._BaseFieldType):
	...
	__slots__ = ["_ApplParams", "_TermnlPackg", "_TMSPrtcolParams", "_SctyParams", "_SvcPrvdrParams", "_AcqrrPrtcolParams", "_SaleToPOIParams", "_HstComParams", "_TermnlParams", "_RplcCfgtn", "_MrchntParams"]
	@property
	def ApplParams(self):
