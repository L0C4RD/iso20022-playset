...
class AcceptorConfigurationContent14(base_types._BaseFieldType):
	...
	__slots__ = ["_SaleToPOIParams", "_HstComParams", "_AcqrrPrtcolParams", "_TMSPrtcolParams", "_TermnlPackg", "_SctyParams", "_ApplParams", "_SvcPrvdrParams", "_TermnlParams", "_RplcCfgtn", "_MrchntParams"]
	@property
