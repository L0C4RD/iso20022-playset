...
class SecuritiesBalanceAccountingReport002V11(base_types._BaseFieldType):
	...
	__slots__ = ["_AltrnRptgCcyTtlAmts", "_SfkpgAcct", "_StmtGnlDtls", "_AcctOwnr", "_Pgntn", "_AcctSvcr", "_AcctBaseCcyTtlAmts", "_IntrmyInf", "_SubAcctDtls", "_BlckChainAdrOrWllt", "_BalForAcct"]
	@property
