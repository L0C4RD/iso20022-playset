...
class SecuritiesBalanceAccountingReport002V11(base_types._BaseFieldType):
	...
	__slots__ = ["_IntrmyInf", "_SubAcctDtls", "_StmtGnlDtls", "_AcctBaseCcyTtlAmts", "_BalForAcct", "_BlckChainAdrOrWllt", "_AltrnRptgCcyTtlAmts", "_AcctSvcr", "_SfkpgAcct", "_Pgntn", "_AcctOwnr"]
	@property
	def IntrmyInf(self):
