...
class SecuritiesBalanceAccountingReport002V11(base_types._BaseFieldType):
	...
	__slots__ = ["_StmtGnlDtls", "_BlckChainAdrOrWllt", "_SfkpgAcct", "_AcctOwnr", "_AcctBaseCcyTtlAmts", "_IntrmyInf", "_AltrnRptgCcyTtlAmts", "_BalForAcct", "_SubAcctDtls", "_AcctSvcr", "_Pgntn"]
	@property
