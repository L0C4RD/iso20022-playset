...
class SecuritiesTradeDetails140(base_types._BaseFieldType):
	...
	__slots__ = ["_CmonId", "_TradTxCond", "_DealPric", "_OthrAmts", "_SctiesFincgDtls", "_FinInstrmAttrbts", "_PrcrTxId", "_QtyAndAcctDtls", "_OthrBizPties", "_SttlmDt", "_FinInstrmId", "_SctiesMvmntTp", "_PoolId", "_NbOfDaysAcrd", "_DlvrgSttlmPties", "_CtrPtyMktInfrstrctrTxId", "_AcctOwnrTxId", "_MktInfrstrctrTxId", "_SttlmAmt", "_TradDt", "_PlcOfTrad", "_Pmt", "_PlcOfClr", "_SttlmParams", "_CollTxId", "_Sts", "_AcctSvcrTxId", "_SplmtryData", "_TpOfPric", "_TradId", "_RcvgSttlmPties"]
	@property
	def CmonId(self):
		return self._CmonId
