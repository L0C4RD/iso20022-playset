...
class SecuritiesTradeDetails140(base_types._BaseFieldType):
	...
	__slots__ = ["_MktInfrstrctrTxId", "_SplmtryData", "_CtrPtyMktInfrstrctrTxId", "_SttlmAmt", "_CmonId", "_Pmt", "_QtyAndAcctDtls", "_SctiesMvmntTp", "_TpOfPric", "_TradId", "_RcvgSttlmPties", "_OthrAmts", "_SttlmDt", "_FinInstrmId", "_PrcrTxId", "_SttlmParams", "_OthrBizPties", "_DealPric", "_SctiesFincgDtls", "_Sts", "_FinInstrmAttrbts", "_DlvrgSttlmPties", "_PoolId", "_NbOfDaysAcrd", "_PlcOfTrad", "_AcctOwnrTxId", "_PlcOfClr", "_TradTxCond", "_CollTxId", "_TradDt", "_AcctSvcrTxId"]
	@property
