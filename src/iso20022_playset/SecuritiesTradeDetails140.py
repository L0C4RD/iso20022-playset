...
class SecuritiesTradeDetails140(base_types._BaseFieldType):
	...
	__slots__ = ["_Sts", "_SctiesFincgDtls", "_TradTxCond", "_FinInstrmId", "_SttlmDt", "_PlcOfClr", "_AcctSvcrTxId", "_TradDt", "_PoolId", "_RcvgSttlmPties", "_CollTxId", "_DealPric", "_FinInstrmAttrbts", "_DlvrgSttlmPties", "_CmonId", "_MktInfrstrctrTxId", "_SctiesMvmntTp", "_OthrBizPties", "_AcctOwnrTxId", "_OthrAmts", "_TpOfPric", "_Pmt", "_PlcOfTrad", "_PrcrTxId", "_NbOfDaysAcrd", "_QtyAndAcctDtls", "_CtrPtyMktInfrstrctrTxId", "_TradId", "_SplmtryData", "_SttlmAmt", "_SttlmParams"]
	@property
	def Sts(self):
		return self._Sts
