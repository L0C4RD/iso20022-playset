...
class CorporateActionOption243(base_types._BaseFieldType):
	...
	__slots__ = ["_ChngTp", "_SctiesQtyOrInstdAmt", "_ElgblForCollInd", "_PricDtls", "_FrctnDspstn", "_OptnFeatrs", "_ExctnReqdDtTm", "_ShrhldrNb", "_OptnNb", "_SlctnDealrFeeInd", "_SctyId", "_AddtlInf", "_CcyOptn", "_OptnTp", "_CcyToSell", "_RateAndAmtDtls", "_CcyToBuy"]
	@property
	def ChngTp(self):
		return self._ChngTp
