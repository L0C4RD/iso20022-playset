...
class CorporateActionOption243(base_types._BaseFieldType):
	...
	__slots__ = ["_OptnFeatrs", "_RateAndAmtDtls", "_FrctnDspstn", "_CcyOptn", "_SctiesQtyOrInstdAmt", "_SlctnDealrFeeInd", "_OptnNb", "_AddtlInf", "_ChngTp", "_OptnTp", "_ElgblForCollInd", "_PricDtls", "_CcyToSell", "_SctyId", "_CcyToBuy", "_ExctnReqdDtTm", "_ShrhldrNb"]
	@property
	def OptnFeatrs(self):
