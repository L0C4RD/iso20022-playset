...
class Lodging4(base_types._BaseFieldType):
	...
	__slots__ = ["_Insrnc", "_CstmrId", "_Drtn", "_LltyPrgrmm", "_InsrncAmt", "_PrprtyAssgnr", "_NoShow", "_CstmrNm", "_PrprtyId", "_PrprtyNm", "_CstmrAge", "_CstmrFileRefNb", "_FolioNb", "_Dprture", "_AddtlData", "_PrstgsPrprty", "_NbOfRooms", "_AuthrsdAmt", "_TtlAmt", "_Room", "_TtlTax", "_LineItm", "_Arrvl", "_PrprtyTp", "_PrprtyCtct", "_CstmrCtct", "_SummryCmmdtyId", "_CstmrAdr", "_PrprtyCtry", "_PrprtyLctn", "_PrprtyFireSftyAct", "_PrprtyOthrTp"]
	@property
	def Insrnc(self):
		return self._Insrnc
