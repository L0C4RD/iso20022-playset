...
class Lodging4(base_types._BaseFieldType):
	...
	__slots__ = ["_Arrvl", "_CstmrCtct", "_NbOfRooms", "_Drtn", "_Insrnc", "_PrprtyCtry", "_TtlAmt", "_InsrncAmt", "_PrstgsPrprty", "_CstmrAge", "_AuthrsdAmt", "_CstmrId", "_PrprtyCtct", "_CstmrAdr", "_TtlTax", "_PrprtyId", "_FolioNb", "_CstmrFileRefNb", "_Dprture", "_PrprtyFireSftyAct", "_PrprtyLctn", "_NoShow", "_PrprtyTp", "_Room", "_PrprtyOthrTp", "_LineItm", "_SummryCmmdtyId", "_PrprtyNm", "_CstmrNm", "_AddtlData", "_PrprtyAssgnr", "_LltyPrgrmm"]
	@property
	def Arrvl(self):
		return self._Arrvl
