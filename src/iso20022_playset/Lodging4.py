...
class Lodging4(base_types._BaseFieldType):
	...
	__slots__ = ["_PrprtyNm", "_PrprtyCtct", "_CstmrAdr", "_LltyPrgrmm", "_TtlTax", "_CstmrId", "_FolioNb", "_Room", "_PrprtyId", "_Drtn", "_NbOfRooms", "_PrstgsPrprty", "_CstmrNm", "_Dprture", "_CstmrCtct", "_Insrnc", "_PrprtyCtry", "_Arrvl", "_CstmrFileRefNb", "_TtlAmt", "_PrprtyLctn", "_PrprtyOthrTp", "_PrprtyTp", "_InsrncAmt", "_SummryCmmdtyId", "_PrprtyAssgnr", "_CstmrAge", "_AuthrsdAmt", "_AddtlData", "_NoShow", "_PrprtyFireSftyAct", "_LineItm"]
	@property
	def PrprtyNm(self):
