...
class CorporateActionOption242(base_types._BaseFieldType):
	...
	__slots__ = ["_OptnTp", "_AcctOwnr", "_TtlElgblBal", "_FinInstrmId", "_SfkpgAcct", "_StsQty", "_BlckChainAdrOrWllt", "_SlctnDealrFeeInd", "_UinstdBal", "_OptnNb", "_CshAcct", "_PrtctBal", "_SfkpgPlc", "_StsCshAmt", "_OptnFeatrs", "_InstdBal"]
	@property
	def OptnTp(self):
		return self._OptnTp
