...
class CorporateActionOption242(base_types._BaseFieldType):
	...
	__slots__ = ["_UinstdBal", "_SlctnDealrFeeInd", "_FinInstrmId", "_InstdBal", "_SfkpgPlc", "_OptnFeatrs", "_StsCshAmt", "_StsQty", "_PrtctBal", "_CshAcct", "_AcctOwnr", "_OptnNb", "_BlckChainAdrOrWllt", "_SfkpgAcct", "_TtlElgblBal", "_OptnTp"]
	@property
	def UinstdBal(self):
