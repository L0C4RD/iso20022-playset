...
class CorporateActionOption242(base_types._BaseFieldType):
	...
	__slots__ = ["_StsCshAmt", "_OptnFeatrs", "_SfkpgPlc", "_OptnNb", "_UinstdBal", "_SlctnDealrFeeInd", "_SfkpgAcct", "_BlckChainAdrOrWllt", "_OptnTp", "_CshAcct", "_PrtctBal", "_InstdBal", "_TtlElgblBal", "_AcctOwnr", "_StsQty", "_FinInstrmId"]
	@property
	def StsCshAmt(self):
