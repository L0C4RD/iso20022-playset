...
class SubscriptionOrder14(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmMtd", "_AcmltnRghtRef", "_OrdrRef", "_SttlmAndCtdyDtls", "_FinInstrmDtls", "_PhysDlvryInd", "_CshSttlmDtls", "_CstmrCndctClssfctn", "_ClntRef", "_ReqdNAVCcy", "_OrdrWvrDtls", "_ReqdSttlmCcy", "_TxChanlTp", "_SgntrTp", "_PhysDlvryDtls", "_Rndg", "_StffClntBrkdwn", "_NgtdTrad", "_OrdrTp", "_AmtOrUnits", "_FinAdvc", "_SrcOfCsh", "_FXDtls", "_LttrInttRef", "_TxOvrhd", "_NonStdSttlmInf", "_SubAcctForHldg", "_CshSttlmDt", "_Equlstn", "_RltdPtyDtls", "_SttlmAmt", "_IncmPref"]
	@property
	def SttlmMtd(self):
