...
class SubscriptionOrder14(base_types._BaseFieldType):
	...
	__slots__ = ["_IncmPref", "_AcmltnRghtRef", "_CstmrCndctClssfctn", "_StffClntBrkdwn", "_Rndg", "_NonStdSttlmInf", "_SttlmAmt", "_PhysDlvryInd", "_SttlmAndCtdyDtls", "_OrdrTp", "_OrdrRef", "_ReqdNAVCcy", "_OrdrWvrDtls", "_ReqdSttlmCcy", "_FinAdvc", "_TxOvrhd", "_FXDtls", "_PhysDlvryDtls", "_SrcOfCsh", "_CshSttlmDt", "_NgtdTrad", "_SubAcctForHldg", "_AmtOrUnits", "_LttrInttRef", "_SgntrTp", "_FinInstrmDtls", "_SttlmMtd", "_Equlstn", "_CshSttlmDtls", "_ClntRef", "_RltdPtyDtls", "_TxChanlTp"]
	@property
	def IncmPref(self):
