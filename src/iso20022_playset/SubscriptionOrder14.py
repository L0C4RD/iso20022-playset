...
from .FinancialInstrumentQuantity27Choice import FinancialInstrumentQuantity27Choice
...
class SubscriptionOrder14(base_types._BaseFieldType):
	...
	__slots__ = ["_PhysDlvryInd", "_ReqdSttlmCcy", "_FinAdvc", "_ClntRef", "_Rndg", "_SttlmAmt", "_SgntrTp", "_StffClntBrkdwn", "_OrdrWvrDtls", "_PhysDlvryDtls", "_CshSttlmDtls", "_OrdrRef", "_ReqdNAVCcy", "_RltdPtyDtls", "_SubAcctForHldg", "_FXDtls", "_AcmltnRghtRef", "_Equlstn", "_LttrInttRef", "_CstmrCndctClssfctn", "_TxChanlTp", "_SttlmAndCtdyDtls", "_OrdrTp", "_CshSttlmDt", "_TxOvrhd", "_NgtdTrad", "_SrcOfCsh", "_SttlmMtd", "_FinInstrmDtls", "_NonStdSttlmInf", "_AmtOrUnits", "_IncmPref"]
	@property
	...
	def AmtOrUnits(self, value):
		self._AmtOrUnits = value if type(value) != auto else self.make_default("AmtOrUnits")
