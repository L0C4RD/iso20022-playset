...
class SubscriptionOrder14(base_types._BaseFieldType):
	...
	__slots__ = ["_OrdrTp", "_LttrInttRef", "_IncmPref", "_StffClntBrkdwn", "_FinAdvc", "_TxChanlTp", "_CstmrCndctClssfctn", "_ReqdSttlmCcy", "_FinInstrmDtls", "_OrdrWvrDtls", "_SttlmAmt", "_SttlmAndCtdyDtls", "_ReqdNAVCcy", "_SubAcctForHldg", "_NgtdTrad", "_PhysDlvryInd", "_TxOvrhd", "_Rndg", "_Equlstn", "_SrcOfCsh", "_SttlmMtd", "_AmtOrUnits", "_CshSttlmDt", "_AcmltnRghtRef", "_FXDtls", "_NonStdSttlmInf", "_ClntRef", "_OrdrRef", "_PhysDlvryDtls", "_RltdPtyDtls", "_SgntrTp", "_CshSttlmDtls"]
	@property
	def OrdrTp(self):
		return self._OrdrTp
