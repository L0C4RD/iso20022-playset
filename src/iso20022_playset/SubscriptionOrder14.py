...
class SubscriptionOrder14(base_types._BaseFieldType):
	...
	__slots__ = ["_TxOvrhd", "_SttlmAndCtdyDtls", "_ReqdNAVCcy", "_SttlmAmt", "_CshSttlmDt", "_StffClntBrkdwn", "_OrdrRef", "_AcmltnRghtRef", "_CshSttlmDtls", "_LttrInttRef", "_Rndg", "_PhysDlvryDtls", "_Equlstn", "_ClntRef", "_TxChanlTp", "_OrdrTp", "_ReqdSttlmCcy", "_NonStdSttlmInf", "_RltdPtyDtls", "_OrdrWvrDtls", "_IncmPref", "_FinAdvc", "_AmtOrUnits", "_PhysDlvryInd", "_SubAcctForHldg", "_SrcOfCsh", "_NgtdTrad", "_FXDtls", "_SttlmMtd", "_CstmrCndctClssfctn", "_FinInstrmDtls", "_SgntrTp"]
	@property
	def TxOvrhd(self):
