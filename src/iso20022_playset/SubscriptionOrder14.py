...
import FinancialInstrumentQuantity27Choice
...
class SubscriptionOrder14(base_types._BaseFieldType):
	...
	__slots__ = ["_CshSttlmDtls", "_RltdPtyDtls", "_TxOvrhd", "_CshSttlmDt", "_PhysDlvryInd", "_OrdrRef", "_FinAdvc", "_AcmltnRghtRef", "_NgtdTrad", "_SrcOfCsh", "_StffClntBrkdwn", "_SgntrTp", "_Rndg", "_CstmrCndctClssfctn", "_FXDtls", "_SttlmMtd", "_SubAcctForHldg", "_ReqdNAVCcy", "_LttrInttRef", "_PhysDlvryDtls", "_SttlmAmt", "_TxChanlTp", "_OrdrTp", "_NonStdSttlmInf", "_Equlstn", "_FinInstrmDtls", "_AmtOrUnits", "_ClntRef", "_SttlmAndCtdyDtls", "_ReqdSttlmCcy", "_OrdrWvrDtls", "_IncmPref"]
	@property
