...
class CorporateActionNarrative60(base_types._BaseFieldType):
	...
	__slots__ = ["_CertfctnBrkdwn", "_BsktOrIndxInf", "_PtyCtctNrrtv", "_InfToCmplyWth", "_URLAdr", "_PrcgTxtForNxtIntrmy", "_InfConds", "_Dsclmr", "_AddtlTxt", "_NrrtvVrsn", "_RegnDtls", "_TaxtnConds"]
	@property
