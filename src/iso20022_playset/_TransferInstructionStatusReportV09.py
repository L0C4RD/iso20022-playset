...
from . import TransferStatusAndReason8
...
class TransferInstructionStatusReportV09(base_types._BaseFieldType):
	...
	def StsRpt(self, value):
		self._StsRpt = value if value is not None else base_types.UninitialisedField(self, 'StsRpt', TransferStatusAndReason8, False)

	@StsRpt.deleter
	def StsRpt(self):
		del self._StsRpt
		self._StsRpt = base_types.UninitialisedField(self, 'StsRpt', TransferStatusAndReason8, False)
