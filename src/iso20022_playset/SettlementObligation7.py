...
class SettlementObligation7(base_types._BaseFieldType):
	...
	__slots__ = ["_DlvryAcct", "_TradDt", "_CntrlCtrPtyTxId", "_SfkpgPlc", "_SfkpgAcct", "_Dpstry", "_DealPric", "_CSDTxId", "_PrvsBuyInId", "_NonClrMmb", "_Qty", "_ClrSgmt", "_RmngAmtToBeSttld", "_FinInstrmId", "_IntnddSttlmDt", "_RmngQtyToBeSttld", "_SttlmAmt"]
	@property
	def DlvryAcct(self):
