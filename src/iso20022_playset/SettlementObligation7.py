...
class SettlementObligation7(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmAmt", "_DlvryAcct", "_PrvsBuyInId", "_Dpstry", "_Qty", "_RmngQtyToBeSttld", "_DealPric", "_FinInstrmId", "_CntrlCtrPtyTxId", "_SfkpgPlc", "_IntnddSttlmDt", "_TradDt", "_ClrSgmt", "_NonClrMmb", "_RmngAmtToBeSttld", "_SfkpgAcct", "_CSDTxId"]
	@property
	def SttlmAmt(self):
