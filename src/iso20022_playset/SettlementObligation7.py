...
class SettlementObligation7(base_types._BaseFieldType):
	...
	__slots__ = ["_RmngAmtToBeSttld", "_PrvsBuyInId", "_Qty", "_Dpstry", "_RmngQtyToBeSttld", "_SfkpgPlc", "_DealPric", "_CntrlCtrPtyTxId", "_FinInstrmId", "_NonClrMmb", "_SfkpgAcct", "_SttlmAmt", "_CSDTxId", "_TradDt", "_DlvryAcct", "_ClrSgmt", "_IntnddSttlmDt"]
	@property
