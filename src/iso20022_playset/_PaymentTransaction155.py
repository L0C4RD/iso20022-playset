...
class PaymentTransaction155(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlUETR", "_Case", "_OrgnlEndToEndId", "_SplmtryData", "_CxlRsnInf", "_OrgnlGrpInf", "_OrgnlClrSysRef", "_Assgnr", "_OrgnlTxId", "_OrgnlTxRef", "_CxlId", "_OrgnlIntrBkSttlmDt", "_Assgne", "_OrgnlIntrBkSttlmAmt", "_OrgnlInstrId"]
	@property
	def OrgnlUETR(self):
