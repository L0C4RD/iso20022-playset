...
from . import FinancialIdentificationSchemeName1Choice
...
class GenericFinancialIdentification1(base_types._BaseFieldType):
	...
	def SchmeNm(self, value):
		self._SchmeNm = value if value is not None else base_types.UninitialisedField(self, 'SchmeNm', FinancialIdentificationSchemeName1Choice, False)

	@SchmeNm.deleter
	def SchmeNm(self):
		del self._SchmeNm
		self._SchmeNm = base_types.UninitialisedField(self, 'SchmeNm', FinancialIdentificationSchemeName1Choice, False)
