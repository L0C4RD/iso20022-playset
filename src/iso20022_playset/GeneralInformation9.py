...
class GeneralInformation9(base_types._BaseFieldType):
	...
	__slots__ = ["_RltdTradRef", "_DealgBrnchTradgSd", "_AgrmtDtls", "_BlckInd", "_CtctInf", "_DealgMtd", "_SndrToRcvrInf", "_PmtClrCentr", "_BrkrId", "_DealgBrnchCtrPtySd", "_ClctnAgt", "_BrkrsComssn", "_CtrPtyRef", "_BrkrsRef", "_DefsYr"]
	@property
