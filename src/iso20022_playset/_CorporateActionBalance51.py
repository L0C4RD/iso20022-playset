...
class CorporateActionBalance51(base_types._BaseFieldType):
	...
	__slots__ = ["_CollInBal", "_TradDtPosBal", "_StrtPosBal", "_InTrnsShipmntBal", "_OutForRegnBal", "_TtlElgblBal", "_SttlmPosBal", "_PdgRctBal", "_UinstdBal", "_CollOutBal", "_OnLnBal", "_BlckdBal", "_TtlInstdBalDtls", "_PdgDlvryBal", "_OblgtdBal", "_BrrwdBal", "_RegdBal"]
	@property
	def CollInBal(self):
