...
class CorporateActionBalance51(base_types._BaseFieldType):
	...
	__slots__ = ["_CollInBal", "_OnLnBal", "_BrrwdBal", "_OblgtdBal", "_PdgDlvryBal", "_InTrnsShipmntBal", "_BlckdBal", "_PdgRctBal", "_UinstdBal", "_TtlInstdBalDtls", "_OutForRegnBal", "_StrtPosBal", "_TtlElgblBal", "_CollOutBal", "_SttlmPosBal", "_RegdBal", "_TradDtPosBal"]
	@property
	def CollInBal(self):
