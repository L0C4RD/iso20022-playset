...
class CorporateActionDate104(base_types._BaseFieldType):
	...
	__slots__ = ["_MktDdln", "_StockLndgDdln", "_DcmnttnDdln", "_DpstryCoverXprtnDt", "_EarlyRspnDdln", "_SbcptCostDbtDt", "_PrtctDdln", "_XpryDt", "_EndOfSctiesBlckgPrd", "_CoverXprtnDdln", "_RspnDdln", "_BrrwrStockLndgDdln"]
	@property
	def MktDdln(self):
