...
from .DateFormat59Choice import DateFormat59Choice
from .BorrowerLendingDeadline5 import BorrowerLendingDeadline5

class CorporateActionDate104(base_types._BaseFieldType):

	__slots__ = ["_CoverXprtnDdln", "_DpstryCoverXprtnDt", "_PrtctDdln", "_XpryDt", "_BrrwrStockLndgDdln", "_RspnDdln", "_EarlyRspnDdln", "_SbcptCostDbtDt", "_MktDdln", "_DcmnttnDdln", "_EndOfSctiesBlckgPrd", "_StockLndgDdln"]
	@property
