...
class CorporateActionDate104(base_types._BaseFieldType):
	...
	__slots__ = ["_RspnDdln", "_MktDdln", "_XpryDt", "_DcmnttnDdln", "_DpstryCoverXprtnDt", "_EndOfSctiesBlckgPrd", "_BrrwrStockLndgDdln", "_CoverXprtnDdln", "_EarlyRspnDdln", "_SbcptCostDbtDt", "_StockLndgDdln", "_PrtctDdln"]
	@property
	def RspnDdln(self):
