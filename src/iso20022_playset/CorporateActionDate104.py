...
import DateFormat59Choice
import DateFormat43Choice
import BorrowerLendingDeadline5
import DateFormat44Choice

class CorporateActionDate104(base_types._BaseFieldType):

	__slots__ = ["_MktDdln", "_SbcptCostDbtDt", "_RspnDdln", "_DpstryCoverXprtnDt", "_EndOfSctiesBlckgPrd", "_CoverXprtnDdln", "_BrrwrStockLndgDdln", "_PrtctDdln", "_StockLndgDdln", "_DcmnttnDdln", "_EarlyRspnDdln", "_XpryDt"]
	@property
	def MktDdln(self):
