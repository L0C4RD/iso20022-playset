...
class SettlementDetails170(base_types._BaseFieldType):
	...
	__slots__ = ["_ElgblForColl", "_MktClntSd", "_SttlmSysMtd", "_StmpDtyTaxBsis", "_NetgElgblty", "_BnfclOwnrsh", "_PrtlSttlmInd", "_SctiesRTGS", "_HldInd", "_SttlmTxCond", "_CCPElgblty", "_CshClrSys", "_TaxCpcty", "_SttlgCpcty", "_LglRstrctns", "_BlckTrad"]
	@property
	def BlckTrad(self):
