...
class SettlementDetails170(base_types._BaseFieldType):
	...
	__slots__ = ["_HldInd", "_ElgblForColl", "_NetgElgblty", "_SttlmTxCond", "_StmpDtyTaxBsis", "_BnfclOwnrsh", "_LglRstrctns", "_SttlgCpcty", "_TaxCpcty", "_CshClrSys", "_SttlmSysMtd", "_PrtlSttlmInd", "_MktClntSd", "_BlckTrad", "_CCPElgblty", "_SctiesRTGS"]
	@property
	def HldInd(self):
		return self._HldInd
