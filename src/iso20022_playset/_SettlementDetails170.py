...
from . import SettlementTransactionCondition18Choice
...
class SettlementDetails170(base_types._BaseFieldType):
	...
	__slots__ = ["_BlckTrad", "_BnfclOwnrsh", "_CCPElgblty", "_CshClrSys", "_ElgblForColl", "_HldInd", "_LglRstrctns", "_MktClntSd", "_NetgElgblty", "_PrtlSttlmInd", "_SctiesRTGS", "_StmpDtyTaxBsis", "_SttlgCpcty", "_SttlmSysMtd", "_SttlmTxCond", "_TaxCpcty"]
	@property
	def BlckTrad(self):
	...
	def SttlmTxCond(self, value):
		self._SttlmTxCond = value if value is not None else base_types.UninitialisedField(self, 'SttlmTxCond', SettlementTransactionCondition18Choice, True)

	@SttlmTxCond.deleter
	def SttlmTxCond(self):
		del self._SttlmTxCond
		self._SttlmTxCond = base_types.UninitialisedField(self, 'SttlmTxCond', SettlementTransactionCondition18Choice, True)
