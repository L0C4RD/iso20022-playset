...
class CashOption111(base_types._BaseFieldType):
	...
	__slots__ = ["_FXDtls", "_AmtDtls", "_DtDtls", "_CtrctlPmtInd", "_IncmTp", "_CtryOfIncmSrc", "_IssrOfferrTaxbltyInd", "_RateAndAmtDtls", "_OthrIncmTp", "_NonElgblPrcdsInd", "_CshAcctId", "_PricDtls", "_XmptnTp", "_CdtDbtInd"]
	@property
	def FXDtls(self):
		return self._FXDtls
