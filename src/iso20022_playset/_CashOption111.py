...
class CashOption111(base_types._BaseFieldType):
	...
	__slots__ = ["_IncmTp", "_CtryOfIncmSrc", "_CshAcctId", "_DtDtls", "_AmtDtls", "_RateAndAmtDtls", "_NonElgblPrcdsInd", "_CdtDbtInd", "_OthrIncmTp", "_CtrctlPmtInd", "_PricDtls", "_XmptnTp", "_FXDtls", "_IssrOfferrTaxbltyInd"]
	@property
	def IncmTp(self):
		return self._IncmTp
