...
class Context24(base_types._BaseFieldType):
	...
	__slots__ = ["_CaptrDt", "_MrchntCtgyCd", "_OthrSctyChrtcs", "_Attndd", "_EComrc", "_RctDstn", "_CardPres", "_PrtlShipmnt", "_EComrcIndApld", "_EComrcData", "_NoShow", "_PrtlApprvlSpprtd", "_CardDataNtryMd", "_OthrGoodAndSvcDlvryChanl", "_MOTOCd", "_StorgLctn", "_GoodAndSvcsSubTp", "_AuthntcnOutg", "_Trnst", "_DelydAuthstn", "_DelydChrgs", "_TxInitr", "_Reauthstn", "_GoodAndSvcDlvryChanl", "_RctTp", "_UattnddLvlCtgy", "_MrchntCtgySpcfcData", "_GoodsAndSvcsTp", "_GoodAndSvcsOthrSubTp", "_OthrGoodAndSvcDlvrySchdl", "_AddtlData", "_ReSubmissn", "_QRCdPresntmntMd", "_CrdhldrPres", "_TrnspndrInittd", "_CrdhldrActvtd", "_OthrMrchntCtgy", "_SaleRefNb", "_OthrCardDataNtryMd", "_LatePresntmnt", "_DtAntcptd", "_RctReq", "_SctyChrtcs", "_EComrcIndPropsd", "_PmtCrdntlMrchntRltsh", "_OthrQRCdPresntmntMd", "_GoodAndSvcDlvrySchdl", "_SpltPmt", "_DfrrdDlvry"]
	@property
	def CaptrDt(self):
