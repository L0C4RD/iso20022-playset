...
from . import AcceptorReconciliationRequest14
from . import ContentInformationType37
from . import Header70

class AcceptorReconciliationRequestV14(base_types._BaseFieldType):
	...
	def RcncltnReq(self, value):
		self._RcncltnReq = value if value is not None else base_types.UninitialisedField(self, 'RcncltnReq', AcceptorReconciliationRequest14, False)

	@RcncltnReq.deleter
	def RcncltnReq(self):
		del self._RcncltnReq
		self._RcncltnReq = base_types.UninitialisedField(self, 'RcncltnReq', AcceptorReconciliationRequest14, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='RcncltnReq', type=AcceptorReconciliationRequest14, min=1, max=1, mutex_group=None, array=False),
