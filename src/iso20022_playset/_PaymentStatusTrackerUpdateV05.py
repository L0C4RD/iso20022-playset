...
from . import TrackerStatusAndTransaction22

class PaymentStatusTrackerUpdateV05(base_types._BaseFieldType):
	...
	def TrckrStsAndTx(self, value):
		self._TrckrStsAndTx = value if value is not None else base_types.UninitialisedField(self, 'TrckrStsAndTx', TrackerStatusAndTransaction22, True)

	@TrckrStsAndTx.deleter
	def TrckrStsAndTx(self):
		del self._TrckrStsAndTx
		self._TrckrStsAndTx = base_types.UninitialisedField(self, 'TrckrStsAndTx', TrackerStatusAndTransaction22, True)

	_field_defs = frozenset((
		base_types.FieldEntry(name='GrpHdr', type=TrackerHeader6, min=1, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='SplmtryData', type=SupplementaryData1, min=0, max=None, mutex_group=None, array=True),
		base_types.FieldEntry(name='TrckrStsAndTx', type=TrackerStatusAndTransaction22, min=1, max=None, mutex_group=None, array=True),
	))