...
from . import ReconciliationRequest8
...
class SaleToPOIReconciliationRequestV07(base_types._BaseFieldType):
	...
	def RcncltnReq(self, value):
		self._RcncltnReq = value if value is not None else base_types.UninitialisedField(self, 'RcncltnReq', ReconciliationRequest8, False)

	@RcncltnReq.deleter
	def RcncltnReq(self):
		del self._RcncltnReq
		self._RcncltnReq = base_types.UninitialisedField(self, 'RcncltnReq', ReconciliationRequest8, False)
