...
class SettlementDetails209(base_types._BaseFieldType):
	...
	__slots__ = ["_NetgElgblty", "_ElgblForColl", "_LttrOfGrnt", "_SctiesRTGS", "_CshClrSys", "_BnfclOwnrsh", "_LglRstrctns", "_SctiesSubBalTp", "_MktClntSd", "_SttlmTxCond", "_TaxCpcty", "_SttlmSysMtd", "_RpTp", "_Regn", "_XpsrTp", "_PrtlSttlmInd", "_CshSubBalTp", "_SttlgCpcty", "_BlckTrad", "_CCPElgblty", "_StmpDtyTaxBsis", "_AutomtcBrrwg", "_SctiesTxTp", "_Prty"]
	@property
