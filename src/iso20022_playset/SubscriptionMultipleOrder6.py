...
class SubscriptionMultipleOrder6(base_types._BaseFieldType):
	...
	__slots__ = ["_CxlRght", "_BnfcryDtls", "_IndvOrdrDtls", "_InvstmtAcctDtls", "_XpryDtTm", "_MstrRef", "_PlcOfTrad", "_TtlSttlmAmt", "_ReqdFutrTradDt", "_OrdrDtTm", "_BlkCshSttlmDtls"]
	@property
	def CxlRght(self):
