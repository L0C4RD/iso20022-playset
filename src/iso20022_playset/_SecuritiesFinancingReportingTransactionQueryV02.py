...
from . import TradeReportQuery13Choice
...
class SecuritiesFinancingReportingTransactionQueryV02(base_types._BaseFieldType):
	...
	def TradQryData(self, value):
		self._TradQryData = value if value is not None else base_types.UninitialisedField(self, 'TradQryData', TradeReportQuery13Choice, False)

	@TradQryData.deleter
	def TradQryData(self):
		del self._TradQryData
		self._TradQryData = base_types.UninitialisedField(self, 'TradQryData', TradeReportQuery13Choice, False)
