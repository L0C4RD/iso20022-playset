...
from . import CCPClearedProductReportV03
...
class AUTH_069_001_03():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def CCPClrdPdctRpt(self, value):
			self._CCPClrdPdctRpt = value if value is not None else base_types.UninitialisedField(self, 'CCPClrdPdctRpt', CCPClearedProductReportV03, False)

		@CCPClrdPdctRpt.deleter
		def CCPClrdPdctRpt(self):
			del self._CCPClrdPdctRpt
			self._CCPClrdPdctRpt = base_types.UninitialisedField(self, 'CCPClrdPdctRpt', CCPClearedProductReportV03, False)
