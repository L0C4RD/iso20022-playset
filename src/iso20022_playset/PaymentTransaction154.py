...
class PaymentTransaction154(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlInstrId", "_Case", "_OrgnlReqdExctnDt", "_OrgnlEndToEndId", "_OrgnlInstdAmt", "_OrgnlReqdColltnDt", "_OrgnlUETR", "_CxlId", "_SplmtryData", "_OrgnlTxRef", "_CxlRsnInf"]
	@property
