...
class PaymentTransaction154(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlInstrId", "_SplmtryData", "_OrgnlUETR", "_OrgnlReqdColltnDt", "_CxlId", "_CxlRsnInf", "_OrgnlEndToEndId", "_Case", "_OrgnlInstdAmt", "_OrgnlReqdExctnDt", "_OrgnlTxRef"]
	@property
