...
class PaymentTransaction154(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlTxRef", "_CxlRsnInf", "_OrgnlReqdExctnDt", "_SplmtryData", "_OrgnlUETR", "_OrgnlEndToEndId", "_OrgnlInstdAmt", "_Case", "_OrgnlInstrId", "_CxlId", "_OrgnlReqdColltnDt"]
	@property
	def OrgnlTxRef(self):
