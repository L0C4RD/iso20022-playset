...
class ForeignExchangeTradeInstructionCancellationV06(base_types._BaseFieldType):
	...
	__slots__ = ["_NDFConds", "_SplmtryData", "_TradAmts", "_RgltryRptg", "_CtrPtySdId", "_TradgSdSttlmInstrs", "_TradgSdId", "_AgrdRate", "_OptnlGnlInf", "_CtrPtySdSttlmInstrs", "_TradInf", "_PstTradEvt"]
	@property
	def NDFConds(self):
