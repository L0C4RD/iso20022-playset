...
class CloseLinkCreationRequestV01(base_types._BaseFieldType):
	...
	def ClsLk(self, value):
		self._ClsLk = value if value is not None else base_types.UninitialisedField(self, 'ClsLk', CloseLink5, False)

	@ClsLk.deleter
	def ClsLk(self):
		del self._ClsLk
		self._ClsLk = base_types.UninitialisedField(self, 'ClsLk', CloseLink5, False)
