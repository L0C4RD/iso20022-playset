...
class SafeKeepingPlace4(base_types._BaseFieldType):
	...
	def SfkpgPlcFrmt(self, value):
		self._SfkpgPlcFrmt = value if value is not None else base_types.UninitialisedField(self, 'SfkpgPlcFrmt', SafekeepingPlaceFormat39Choice, False)

	@SfkpgPlcFrmt.deleter
	def SfkpgPlcFrmt(self):
		del self._SfkpgPlcFrmt
		self._SfkpgPlcFrmt = base_types.UninitialisedField(self, 'SfkpgPlcFrmt', SafekeepingPlaceFormat39Choice, False)
