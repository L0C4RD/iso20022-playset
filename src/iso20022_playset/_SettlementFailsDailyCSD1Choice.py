...
from . import SettlementFailsDailyCSD3
...
class SettlementFailsDailyCSD1Choice(base_types._BaseFieldType):
	...
	@Data.setter
	def Data(self, value):
		self._Data = value if value is not None else base_types.UninitialisedField(self, 'Data', SettlementFailsDailyCSD3, False)

	@Data.deleter
	def Data(self):
		del self._Data
		self._Data = base_types.UninitialisedField(self, 'Data', SettlementFailsDailyCSD3, False)
