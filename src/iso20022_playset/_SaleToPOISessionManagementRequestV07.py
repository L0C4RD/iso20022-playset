...
from . import SessionManagementRequest8
...
class SaleToPOISessionManagementRequestV07(base_types._BaseFieldType):
	...
	def SsnMgmtReq(self, value):
		self._SsnMgmtReq = value if value is not None else base_types.UninitialisedField(self, 'SsnMgmtReq', SessionManagementRequest8, False)

	@SsnMgmtReq.deleter
	def SsnMgmtReq(self):
		del self._SsnMgmtReq
		self._SsnMgmtReq = base_types.UninitialisedField(self, 'SsnMgmtReq', SessionManagementRequest8, False)
