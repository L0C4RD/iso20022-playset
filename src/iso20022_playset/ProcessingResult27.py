...
class ProcessingResult27(base_types._BaseFieldType):
	...
	__slots__ = ["_RspnSrcCtry", "_RspnSrcId", "_RspnSrcTp", "_RspnSrcOthrTp", "_ApprvlCd", "_ActnReqrd", "_Actn", "_TempScrCardDataReusePrtd", "_RspnSrcAssgnr", "_AddtlInf", "_RspnCd", "_RspnSrcShrtNm"]
	@property
