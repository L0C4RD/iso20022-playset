...
class ProcessingResult27(base_types._BaseFieldType):
	...
	__slots__ = ["_ActnReqrd", "_RspnSrcAssgnr", "_AddtlInf", "_RspnCd", "_ApprvlCd", "_TempScrCardDataReusePrtd", "_RspnSrcId", "_Actn", "_RspnSrcOthrTp", "_RspnSrcCtry", "_RspnSrcTp", "_RspnSrcShrtNm"]
	@property
	def ActnReqrd(self):
