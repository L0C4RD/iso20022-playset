...
class ProcessingResult27(base_types._BaseFieldType):
	...
	__slots__ = ["_RspnSrcAssgnr", "_RspnSrcOthrTp", "_RspnSrcTp", "_RspnCd", "_RspnSrcCtry", "_RspnSrcShrtNm", "_ApprvlCd", "_TempScrCardDataReusePrtd", "_Actn", "_AddtlInf", "_RspnSrcId", "_ActnReqrd"]
	@property
