...
from ._AdditionalBusinessProcessFormat25Choice import AdditionalBusinessProcessFormat25Choice
...
from ._CorporateActionAmounts80 import CorporateActionAmounts80
from ._CorporateActionBalanceDetails48 import CorporateActionBalanceDetails48
...
from ._CorporateActionLotteryEvent1 import CorporateActionLotteryEvent1
...
from ._CorporateActionSupplementaryIndicators2 import CorporateActionSupplementaryIndicators2
...
class CorporateAction88(base_types._BaseFieldType):
	...
	def CertDtls(self, value):
		self._CertDtls = value if type(value) != base_types.auto else self.make_default("CertDtls")
	...
	def EvtBalDtls(self, value):
		self._EvtBalDtls = value if type(value) != base_types.auto else self.make_default("EvtBalDtls")
	...
	def LtryEvtInf(self, value):
		self._LtryEvtInf = value if type(value) != base_types.auto else self.make_default("LtryEvtInf")

	@LtryEvtInf.deleter
	def LtryEvtInf(self):
		del self._LtryEvtInf
		self._LtryEvtInf = None
	...
	def SplmtryIndctrs(self, value):
		self._SplmtryIndctrs = value if type(value) != base_types.auto else self.make_default("SplmtryIndctrs")
