...
class LoanMatchingCriteria9(base_types._BaseFieldType):
	...
	__slots__ = ["_FltgIntrstRateRstFrqcyUnit", "_FxdRbtRefRate", "_ShrtMktValAmt", "_FxdIntrstRate", "_MrgnLnAttr", "_CtrctTp", "_MtrtyDt", "_CollDlvryMtd", "_PrncplAmtValDtAmt", "_TermntnDt", "_AsstTp", "_ValDt", "_GnlColl", "_FltgIntrstRatePmtFrqcyUnit", "_ClrDtTm", "_MinNtcePrd", "_FltgIntrstRefRate", "_FltgRbtRateTermUnit", "_FltgRateAdjstmntDt", "_FltgRateAdjstmnt", "_FltgRbtRatePmtFrqcyVal", "_TradgVn", "_ExctnDtTm", "_FltgRbtRateRstFrqcyVal", "_UnitOfMeasr", "_EarlstCallBckDt", "_DayCntBsis", "_FltgIntrstRateTermUnit", "_BsisPtSprd", "_MstrAgrmtTp", "_LnVal", "_LndgFee", "_ClrSts", "_DlvryByVal", "_FltgIntrstRateTermVal", "_TermntnOptn", "_FltgIntrstRatePmtFrqcyVal", "_FltgIntrstRateRstFrqcyVal", "_FltgRbtRateTermVal", "_FltgRbtRateRstFrqcyUnit", "_FltgRbtRatePmtFrqcyUnit", "_OutsdngMrgnLnAmt", "_FltgRbtRefRate", "_PrncplAmtMtrtyDtAmt", "_UnqTradIdr", "_LvlTp", "_CCP", "_OpnTerm", "_RbtRateBsisPtSprd"]
	@property
