...
class LoanMatchingCriteria9(base_types._BaseFieldType):
	...
	__slots__ = ["_ExctnDtTm", "_FltgIntrstRatePmtFrqcyVal", "_FltgRbtRateRstFrqcyUnit", "_FxdRbtRefRate", "_FltgRateAdjstmnt", "_TermntnOptn", "_BsisPtSprd", "_CCP", "_CollDlvryMtd", "_OutsdngMrgnLnAmt", "_UnitOfMeasr", "_FltgIntrstRefRate", "_PrncplAmtValDtAmt", "_LndgFee", "_ClrSts", "_GnlColl", "_MinNtcePrd", "_FxdIntrstRate", "_LvlTp", "_MtrtyDt", "_ValDt", "_FltgRbtRatePmtFrqcyVal", "_DayCntBsis", "_CtrctTp", "_FltgIntrstRateRstFrqcyVal", "_OpnTerm", "_UnqTradIdr", "_LnVal", "_ClrDtTm", "_ShrtMktValAmt", "_FltgIntrstRateTermUnit", "_TradgVn", "_MrgnLnAttr", "_MstrAgrmtTp", "_FltgIntrstRatePmtFrqcyUnit", "_FltgRbtRateRstFrqcyVal", "_FltgRbtRefRate", "_DlvryByVal", "_FltgIntrstRateRstFrqcyUnit", "_EarlstCallBckDt", "_PrncplAmtMtrtyDtAmt", "_FltgRbtRateTermUnit", "_FltgIntrstRateTermVal", "_FltgRateAdjstmntDt", "_AsstTp", "_RbtRateBsisPtSprd", "_TermntnDt", "_FltgRbtRatePmtFrqcyUnit", "_FltgRbtRateTermVal"]
	@property
	def ExctnDtTm(self):
