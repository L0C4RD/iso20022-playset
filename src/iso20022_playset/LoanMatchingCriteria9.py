...
class LoanMatchingCriteria9(base_types._BaseFieldType):
	...
	__slots__ = ["_ExctnDtTm", "_FxdRbtRefRate", "_AsstTp", "_FltgIntrstRefRate", "_FltgIntrstRateRstFrqcyVal", "_CollDlvryMtd", "_FltgRbtRateTermUnit", "_MstrAgrmtTp", "_FltgRbtRateTermVal", "_CtrctTp", "_DayCntBsis", "_FltgRateAdjstmntDt", "_TermntnDt", "_MrgnLnAttr", "_FltgIntrstRateTermUnit", "_FltgIntrstRateTermVal", "_MtrtyDt", "_LndgFee", "_FltgRateAdjstmnt", "_ClrDtTm", "_CCP", "_MinNtcePrd", "_LvlTp", "_LnVal", "_PrncplAmtMtrtyDtAmt", "_OpnTerm", "_ValDt", "_FltgRbtRatePmtFrqcyVal", "_ClrSts", "_EarlstCallBckDt", "_FltgIntrstRateRstFrqcyUnit", "_OutsdngMrgnLnAmt", "_FltgRbtRatePmtFrqcyUnit", "_FxdIntrstRate", "_FltgRbtRateRstFrqcyVal", "_UnitOfMeasr", "_ShrtMktValAmt", "_GnlColl", "_FltgIntrstRatePmtFrqcyVal", "_BsisPtSprd", "_UnqTradIdr", "_DlvryByVal", "_FltgRbtRateRstFrqcyUnit", "_TermntnOptn", "_FltgIntrstRatePmtFrqcyUnit", "_RbtRateBsisPtSprd", "_PrncplAmtValDtAmt", "_FltgRbtRefRate", "_TradgVn"]
	@property
	def ExctnDtTm(self):
