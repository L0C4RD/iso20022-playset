...
class LoanMatchingCriteria9(base_types._BaseFieldType):
	...
	__slots__ = ["_FltgRateAdjstmnt", "_GnlColl", "_UnitOfMeasr", "_UnqTradIdr", "_LvlTp", "_TermntnDt", "_MrgnLnAttr", "_OutsdngMrgnLnAmt", "_ClrSts", "_FxdIntrstRate", "_LnVal", "_CCP", "_FltgIntrstRatePmtFrqcyVal", "_MtrtyDt", "_MinNtcePrd", "_CtrctTp", "_FltgIntrstRatePmtFrqcyUnit", "_ShrtMktValAmt", "_FxdRbtRefRate", "_OpnTerm", "_FltgIntrstRefRate", "_FltgRbtRateRstFrqcyVal", "_DlvryByVal", "_MstrAgrmtTp", "_FltgRbtRateTermVal", "_FltgIntrstRateRstFrqcyUnit", "_FltgIntrstRateTermUnit", "_FltgRateAdjstmntDt", "_FltgRbtRatePmtFrqcyUnit", "_ExctnDtTm", "_FltgRbtRateTermUnit", "_LndgFee", "_FltgRbtRateRstFrqcyUnit", "_ValDt", "_EarlstCallBckDt", "_ClrDtTm", "_CollDlvryMtd", "_TermntnOptn", "_DayCntBsis", "_RbtRateBsisPtSprd", "_FltgRbtRefRate", "_TradgVn", "_FltgIntrstRateTermVal", "_BsisPtSprd", "_PrncplAmtValDtAmt", "_PrncplAmtMtrtyDtAmt", "_AsstTp", "_FltgIntrstRateRstFrqcyVal", "_FltgRbtRatePmtFrqcyVal"]
	@property
