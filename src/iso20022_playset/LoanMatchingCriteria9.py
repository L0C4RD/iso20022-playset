...
from .CompareReportingLevelType3 import CompareReportingLevelType3
from .CompareInterestComputationMethod3 import CompareInterestComputationMethod3
from .SecurityCommodity7Choice import SecurityCommodity7Choice
from .CompareNumber5 import CompareNumber5
from .ComparePercentageRate3 import ComparePercentageRate3
from .CompareBenchmarkCurveName3 import CompareBenchmarkCurveName3
from .CompareDeliveryMethod3 import CompareDeliveryMethod3
from .CompareDecimalNumber3 import CompareDecimalNumber3
from .CompareTrueFalseIndicator3 import CompareTrueFalseIndicator3
from .CompareTerminationOption3 import CompareTerminationOption3
from .CompareInterestRate1 import CompareInterestRate1
from .CompareMICIdentifier3 import CompareMICIdentifier3
from .CompareRateBasis3 import CompareRateBasis3
from .CompareAgreementType2 import CompareAgreementType2
from .CompareText2 import CompareText2
from .CompareClearingStatus3 import CompareClearingStatus3
from .CompareActiveOrHistoricCurrencyAndAmount3 import CompareActiveOrHistoricCurrencyAndAmount3
...
from .CompareNumber6 import CompareNumber6
from .CompareExposureType3 import CompareExposureType3
from .CompareSpecialCollateral3 import CompareSpecialCollateral3

class LoanMatchingCriteria9(base_types._BaseFieldType):

	__slots__ = ["_OpnTerm", "_ClrSts", "_FltgIntrstRateRstFrqcyVal", "_FxdIntrstRate", "_FltgIntrstRateTermVal", "_CtrctTp", "_TradgVn", "_DlvryByVal", "_FltgRateAdjstmnt", "_TermntnDt", "_EarlstCallBckDt", "_FltgIntrstRateTermUnit", "_FltgRbtRatePmtFrqcyVal", "_CCP", "_LvlTp", "_UnqTradIdr", "_DayCntBsis", "_FltgRbtRatePmtFrqcyUnit", "_FltgIntrstRateRstFrqcyUnit", "_RbtRateBsisPtSprd", "_FltgRateAdjstmntDt", "_GnlColl", "_LndgFee", "_FltgIntrstRefRate", "_TermntnOptn", "_FltgRbtRateTermUnit", "_ValDt", "_UnitOfMeasr", "_MtrtyDt", "_CollDlvryMtd", "_FltgRbtRateTermVal", "_FltgRbtRateRstFrqcyUnit", "_FltgIntrstRatePmtFrqcyUnit", "_FltgRbtRateRstFrqcyVal", "_ClrDtTm", "_MrgnLnAttr", "_MstrAgrmtTp", "_PrncplAmtMtrtyDtAmt", "_LnVal", "_AsstTp", "_FxdRbtRefRate", "_ShrtMktValAmt", "_MinNtcePrd", "_FltgIntrstRatePmtFrqcyVal", "_PrncplAmtValDtAmt", "_ExctnDtTm", "_OutsdngMrgnLnAmt", "_BsisPtSprd", "_FltgRbtRefRate"]
	@property
	def OpnTerm(self):
