...
class AddendumInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Acqrr", "_Hdr", "_Dstn", "_PrtctdData", "_TxId", "_Card", "_TxDesc", "_Rcvr", "_Jursdctn", "_AdddmData", "_Cstmr", "_DataSrc", "_Sndr", "_AddtlFee", "_Rcncltn", "_SplmtryData", "_Accptr", "_AddtlData", "_SttlmSvc", "_Tkn", "_Prgrmm", "_Issr", "_Orgtr", "_OrgnlDataElmts", "_SctyTrlr"]
	@property
	def Acqrr(self):
		return self._Acqrr
