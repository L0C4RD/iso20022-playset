...
from .TransactionIdentification53 import TransactionIdentification53
...
class AddendumInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlData", "_SctyTrlr", "_Hdr", "_Sndr", "_Orgtr", "_Acqrr", "_Jursdctn", "_Rcvr", "_OrgnlDataElmts", "_DataSrc", "_Accptr", "_Prgrmm", "_Cstmr", "_AddtlFee", "_AdddmData", "_Dstn", "_SttlmSvc", "_Card", "_Rcncltn", "_PrtctdData", "_Issr", "_TxDesc", "_SplmtryData", "_Tkn", "_TxId"]
	@property
	def AddtlData(self):
