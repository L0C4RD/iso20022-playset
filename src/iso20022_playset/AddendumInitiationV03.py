...
class AddendumInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_AdddmData", "_Card", "_Tkn", "_Prgrmm", "_TxId", "_SctyTrlr", "_DataSrc", "_Orgtr", "_AddtlData", "_AddtlFee", "_TxDesc", "_Accptr", "_Jursdctn", "_Cstmr", "_Issr", "_Acqrr", "_Dstn", "_SplmtryData", "_Hdr", "_OrgnlDataElmts", "_Sndr", "_SttlmSvc", "_PrtctdData", "_Rcvr", "_Rcncltn"]
	@property
	def AdddmData(self):
