...
class FraudDispositionInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Issr", "_RptdFrd", "_Orgtr", "_Prgrmm", "_Acqrr", "_Tkn", "_Crdhldr", "_AddtlInf", "_Hdr", "_Jursdctn", "_AddtlFee", "_Rcvr", "_SttlmSvc", "_PrtctdData", "_FrdDspstnSts", "_SctyTrlr", "_Dstn", "_Sndr", "_Card", "_Rcncltn", "_AddtlData", "_FrdTxId", "_SplmtryData"]
	@property
	def Issr(self):
		return self._Issr
