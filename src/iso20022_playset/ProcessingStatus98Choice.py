...
class ProcessingStatus98Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_StgInstr", "_PdgPrcg", "_RcvdAtIntrmy", "_ForcdRjctn", "_AckdAccptd", "_DfltActn", "_FullyExctdConfSnt", "_Done", "_AlrdyMtchdAndAffrmd", "_Rjctd", "_Gnrtd", "_TradgSspdByStockXchg", "_Futr", "_Trtd", "_NoInstr", "_SttlmInstrSnt", "_OpnOrdr", "_InRpr", "_PrtrySts"]
	@property
	def StgInstr(self):
