...
class ProcessingStatus98Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_Gnrtd", "_Rjctd", "_Done", "_AlrdyMtchdAndAffrmd", "_FullyExctdConfSnt", "_ForcdRjctn", "_PrtrySts", "_DfltActn", "_InRpr", "_StgInstr", "_RcvdAtIntrmy", "_Trtd", "_AckdAccptd", "_PdgPrcg", "_Futr", "_OpnOrdr", "_SttlmInstrSnt", "_NoInstr", "_TradgSspdByStockXchg"]
	@property
	def Gnrtd(self):
		return self._Gnrtd
