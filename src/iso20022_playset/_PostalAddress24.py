...
class PostalAddress24(base_types._BaseFieldType):
	...
	__slots__ = ["_AdrLine", "_AdrTp", "_BldgNb", "_BldgNm", "_Ctry", "_CtrySubDvsn", "_Dept", "_DstrctNm", "_Flr", "_PstBx", "_PstCd", "_Room", "_StrtNm", "_SubDept", "_TwnLctnNm", "_TwnNm"]
	@property
	def AdrLine(self):
	...
	def TwnLctnNm(self, value):
		self._TwnLctnNm = value if value is not None else base_types.UninitialisedField(self, 'TwnLctnNm', Max35Text, False)

	@TwnLctnNm.deleter
	def TwnLctnNm(self):
		del self._TwnLctnNm
		self._TwnLctnNm = base_types.UninitialisedField(self, 'TwnLctnNm', Max35Text, False)
