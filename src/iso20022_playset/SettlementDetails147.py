...
class SettlementDetails147(base_types._BaseFieldType):
	...
	__slots__ = ["_CshClrSys", "_CCPElgblty", "_SctiesRTGS", "_SttlgCpcty", "_BlckTrad", "_NetgElgblty", "_AutomtcBrrwg", "_TaxCpcty", "_SttlmSysMtd", "_SttlmTxCond", "_LglRstrctns", "_PrtlSttlmInd", "_StmpDtyTaxBsis", "_ElgblForColl", "_MktClntSd", "_BnfclOwnrsh", "_Prty"]
	@property
	def CshClrSys(self):
