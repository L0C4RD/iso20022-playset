...
class InvestmentAccount81(base_types._BaseFieldType):

	__slots__ = ["_AcctDsgnt", "_AcctId", "_AcctNm", "_AcctSvcr", "_BlckChainAdrOrWllt", "_OrdrOrgtrElgblty", "_OwnrId", "_SubAcctDtls"]
	@property
	def AcctDsgnt(self):
