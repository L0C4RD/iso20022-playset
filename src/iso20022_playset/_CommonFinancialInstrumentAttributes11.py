...
class CommonFinancialInstrumentAttributes11(base_types._BaseFieldType):
	...
	__slots__ = ["_Issnc", "_TradgMtd", "_FinInstrmForm", "_XpryDt", "_InitlPhysForm", "_SttlmInf", "_DnmtnCcy", "_FinInstrmIdVldty", "_Cnfdtl", "_CtctNm", "_PrncplPngAgt", "_Purp", "_ConvsRatioNmrtr", "_PrvtPlcmnt", "_LeadMgr", "_Clss", "_SprdAndBchmkCrv", "_SrNb", "_PngAgt", "_TEFRARule", "_PmtSts", "_ConvtblInd", "_RedPmtCcy", "_WhldgTaxRgm", "_CpnAttchdNb", "_RcrdDt", "_LglRstrctns", "_CallTp", "_PmryPlcOfDpst", "_CertNb", "_AftrXchgPhysForm", "_SctySts", "_Dpstry", "_TradgMkt", "_Rstrctn", "_FngbInd", "_CtrctVrsnNb", "_TaxLotNb", "_NearTermPosLmt", "_ListgDt", "_ConvsRatioDnmtr", "_UndrlygRsk", "_FinInstrmNm", "_PosLmt", "_RedTp", "_PoolNb", "_CmonSfkpr", "_SctyCSDLk", "_ConvsPrd", "_PutTp", "_CvrdInd", "_ClssfctnTp"]
	@property
	def Issnc(self):
		return self._Issnc
