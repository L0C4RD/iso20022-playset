...
class PostalAddress28(base_types._BaseFieldType):
	...
	__slots__ = ["_Dept", "_CtrySubDvsn", "_PstCd", "_BldgNb", "_CareOf", "_BldgNm", "_AdrTp", "_StrtNm", "_SubDept", "_UnitNb", "_VldFr", "_Room", "_Flr", "_TwnLctnNm", "_Ctry", "_PstBx", "_AdrLine", "_DstrctNm", "_TwnNm"]
	@property
	def Dept(self):
		return self._Dept
