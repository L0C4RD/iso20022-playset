...
class PostalAddress28(base_types._BaseFieldType):
	...
	__slots__ = ["_CareOf", "_Ctry", "_BldgNm", "_Flr", "_Room", "_VldFr", "_DstrctNm", "_AdrLine", "_TwnNm", "_CtrySubDvsn", "_PstBx", "_TwnLctnNm", "_UnitNb", "_AdrTp", "_Dept", "_PstCd", "_StrtNm", "_BldgNb", "_SubDept"]
	@property
	def CareOf(self):
		return self._CareOf
