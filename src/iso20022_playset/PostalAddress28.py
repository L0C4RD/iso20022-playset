...
class PostalAddress28(base_types._BaseFieldType):
	...
	__slots__ = ["_UnitNb", "_Flr", "_Room", "_CtrySubDvsn", "_Dept", "_TwnLctnNm", "_DstrctNm", "_Ctry", "_TwnNm", "_PstBx", "_AdrTp", "_AdrLine", "_BldgNb", "_SubDept", "_CareOf", "_StrtNm", "_VldFr", "_PstCd", "_BldgNm"]
	@property
	def UnitNb(self):
		return self._UnitNb
