...
class CollateralAmount16(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlCshFaild", "_TtlValOfOwnColl", "_TtlCollReqrd", "_Mrgn", "_TtlAcrdIntrst", "_TtlOfPrncpls", "_TtlXpsr", "_TtlValOfReusdColl", "_ValOfCollHeld", "_TtlPdgCollIn", "_TtlPdgCollOut"]
	@property
