...
class CollateralAmount16(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlCshFaild", "_ValOfCollHeld", "_TtlValOfOwnColl", "_TtlOfPrncpls", "_TtlValOfReusdColl", "_TtlAcrdIntrst", "_Mrgn", "_TtlPdgCollOut", "_TtlPdgCollIn", "_TtlXpsr", "_TtlCollReqrd"]
	@property
