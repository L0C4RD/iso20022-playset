...
class CustomerAccountModification1(base_types._BaseFieldType):
	...
	__slots__ = ["_MnthlyTxNb", "_Rstrctn", "_StmtFrqcyAndFrmt", "_ClngNtfctnAmt", "_Sts", "_Ccy", "_MnthlyRcvdVal", "_AvrgBal", "_ClsgDt", "_AcctPurp", "_FlrNtfctnAmt", "_MnthlyPmtVal", "_Tp", "_Nm", "_Id"]
	@property
	def MnthlyTxNb(self):
