...
class CustomerAccount4(base_types._BaseFieldType):
	...
	__slots__ = ["_ClngNtfctnAmt", "_MnthlyPmtVal", "_Rstrctn", "_ClsgDt", "_Tp", "_StmtFrqcyAndFrmt", "_Ccy", "_AvrgBal", "_MnthlyRcvdVal", "_FlrNtfctnAmt", "_MnthlyTxNb", "_Nm", "_AcctPurp", "_Id", "_Sts"]
	@property
