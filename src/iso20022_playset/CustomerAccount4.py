...
class CustomerAccount4(base_types._BaseFieldType):
	...
	__slots__ = ["_MnthlyTxNb", "_Nm", "_Sts", "_MnthlyRcvdVal", "_Ccy", "_Rstrctn", "_ClngNtfctnAmt", "_Id", "_FlrNtfctnAmt", "_MnthlyPmtVal", "_AcctPurp", "_Tp", "_StmtFrqcyAndFrmt", "_AvrgBal", "_ClsgDt"]
	@property
	def MnthlyTxNb(self):
