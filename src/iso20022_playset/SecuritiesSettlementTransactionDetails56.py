...
class SecuritiesSettlementTransactionDetails56(base_types._BaseFieldType):
	...
	__slots__ = ["_TradDtls", "_SttlmAmt", "_SplmtryData", "_OthrBizPties", "_QtyAndAcctDtls", "_DlvrgSttlmPties", "_SttlmTpAndAddtlParams", "_Lnkgs", "_AddtlPhysOrRegnDtls", "_SttlmParams", "_FinInstrmAttrbts", "_CshPties", "_StgSttlmInstrDtls", "_RcvgSttlmPties", "_OthrAmts"]
	@property
	def TradDtls(self):
