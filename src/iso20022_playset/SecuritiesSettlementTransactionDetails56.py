...
class SecuritiesSettlementTransactionDetails56(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_FinInstrmAttrbts", "_SttlmParams", "_AddtlPhysOrRegnDtls", "_QtyAndAcctDtls", "_SttlmTpAndAddtlParams", "_Lnkgs", "_CshPties", "_SttlmAmt", "_OthrBizPties", "_RcvgSttlmPties", "_OthrAmts", "_DlvrgSttlmPties", "_TradDtls", "_StgSttlmInstrDtls"]
	@property
