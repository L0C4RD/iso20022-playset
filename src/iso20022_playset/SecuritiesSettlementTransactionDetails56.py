...
class SecuritiesSettlementTransactionDetails56(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmParams", "_SttlmTpAndAddtlParams", "_DlvrgSttlmPties", "_RcvgSttlmPties", "_CshPties", "_AddtlPhysOrRegnDtls", "_TradDtls", "_Lnkgs", "_OthrAmts", "_OthrBizPties", "_SplmtryData", "_FinInstrmAttrbts", "_StgSttlmInstrDtls", "_QtyAndAcctDtls", "_SttlmAmt"]
	@property
