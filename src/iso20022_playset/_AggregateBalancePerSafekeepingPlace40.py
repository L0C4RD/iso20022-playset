...
class AggregateBalancePerSafekeepingPlace40(base_types._BaseFieldType):
	...
	__slots__ = ["_QtyBrkdwn", "_PricDtls", "_AltrnRptgCcyAmts", "_SfkpgPlc", "_FXDtls", "_AddtlBalBrkdwn", "_AcctBaseCcyAmts", "_DaysAcrd", "_Pldgee", "_PlcOfListg", "_InstrmCcyAmts", "_AggtBal", "_BalBrkdwn", "_XpsrTp", "_HldgAddtlDtls"]
	@property
	def QtyBrkdwn(self):
