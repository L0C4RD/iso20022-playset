...
class FinancialInstrumentStipulations4(base_types._BaseFieldType):
	...
	__slots__ = ["_Hrcut", "_MtrtyDt", "_Geogcs", "_InsrdInd", "_PerptlInd", "_OverAlltmtRate", "_PutblInd", "_MinQty", "_WhlPoolInd", "_IsseDt", "_PreFnddInd", "_Purp", "_SbstitnFrqcy", "_SbstitnLft", "_TxConds", "_PricSrc", "_AutoRinvstmt", "_Pdctn", "_Sctr", "_CllblInd", "_ConvtblInd", "_AmtsblInd", "_CpnRg", "_IsseSz", "_Ratg", "_AltrntvMinTaxInd", "_MaxSbstitn", "_MinIncrmt", "_EscrwdInd", "_MinDnmtn", "_XprtnDt", "_PricFrqcy", "_OverAlltmtAmt", "_CstmDt", "_PricRg", "_PmtFrqcy", "_IssrId", "_YldRg", "_Ccy", "_LookBck", "_RstrctdInd"]
	@property
	def Hrcut(self):
		return self._Hrcut
