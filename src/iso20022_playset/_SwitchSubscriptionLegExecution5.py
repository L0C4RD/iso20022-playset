...
class SwitchSubscriptionLegExecution5(base_types._BaseFieldType):

	__slots__ = ["_CumDvddInd", "_DgtlAsstSttlm", "_Equlstn", "_FinInstrmDtls", "_GrssAmt", "_IncmPref", "_InftvPricDtls", "_InftvTaxDtls", "_IntrmPrftAmt", "_InvstmtAcctDtls", "_LegExctnId", "_LegId", "_NetAmt", "_NonStdSttlmInf", "_PhysDlvryDtls", "_PhysDlvryInd", "_PricDtls", "_ReqdNAVCcy", "_ReqdSttlmCcy", "_SttlmAndCtdyDtls", "_TradDtTm", "_TxOvrhd", "_Units"]
	@property
	def CumDvddInd(self):
