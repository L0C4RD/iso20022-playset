...
from . import AdministrativeResponse9
from . import ContentInformationType38
from . import Header41

class SaleToPOIAdministrativeResponseV08(base_types._BaseFieldType):
	...
	def AdmstvRspn(self, value):
		self._AdmstvRspn = value if value is not None else base_types.UninitialisedField(self, 'AdmstvRspn', AdministrativeResponse9, False)

	@AdmstvRspn.deleter
	def AdmstvRspn(self):
		del self._AdmstvRspn
		self._AdmstvRspn = base_types.UninitialisedField(self, 'AdmstvRspn', AdministrativeResponse9, False)
	...
	_field_defs = frozenset((
		base_types.FieldEntry(name='AdmstvRspn', type=AdministrativeResponse9, min=1, max=1, mutex_group=None, array=False),
