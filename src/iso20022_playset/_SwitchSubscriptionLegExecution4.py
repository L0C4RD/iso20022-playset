...
class SwitchSubscriptionLegExecution4(base_types._BaseFieldType):
	...
	__slots__ = ["_LegId", "_GrssAmt", "_FinInstrmDtls", "_PricDtls", "_NonStdSttlmInf", "_ReqdSttlmCcy", "_InftvPricDtls", "_CumDvddInd", "_PhysDlvryInd", "_NetAmt", "_SttlmAndCtdyDtls", "_PhysDlvryDtls", "_TradDtTm", "_IncmPref", "_IntrmPrftAmt", "_TxOvrhd", "_UnitsNb", "_InvstmtAcctDtls", "_ReqdNAVCcy", "_LegExctnId", "_Equlstn", "_InftvTaxDtls"]
	@property
	def LegId(self):
		return self._LegId
