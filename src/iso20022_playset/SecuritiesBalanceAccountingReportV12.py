...
class SecuritiesBalanceAccountingReportV12(base_types._BaseFieldType):
	...
	__slots__ = ["_SfkpgAcct", "_SubAcctDtls", "_AltrnRptgCcyTtlAmts", "_AcctSvcr", "_StmtGnlDtls", "_Pgntn", "_AcctOwnr", "_AcctBaseCcyTtlAmts", "_BlckChainAdrOrWllt", "_BalForAcct", "_IntrmyInf"]
	@property
	def SfkpgAcct(self):
