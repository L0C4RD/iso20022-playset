...
class InvestmentPlan17(base_types._BaseFieldType):
	...
	__slots__ = ["_InitlAmt", "_PlanSts", "_RndgDrctn", "_EndDt", "_Frqcy", "_StartDt", "_IncmPref", "_SLAChrgAndComssnRef", "_SctyDtls", "_InstlmtMgrRole", "_InsrncCover", "_Qty", "_CshSttlm", "_GrssAmtInd", "_RltdCtrctRef", "_TtlNbOfInstlmts", "_PdctId", "_CtrctRef"]
	@property
	def InitlAmt(self):
