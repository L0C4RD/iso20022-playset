...
class InvestmentPlan17(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlNbOfInstlmts", "_EndDt", "_SLAChrgAndComssnRef", "_GrssAmtInd", "_StartDt", "_InitlAmt", "_Frqcy", "_Qty", "_CshSttlm", "_InstlmtMgrRole", "_SctyDtls", "_RltdCtrctRef", "_IncmPref", "_PlanSts", "_InsrncCover", "_RndgDrctn", "_PdctId", "_CtrctRef"]
	@property
