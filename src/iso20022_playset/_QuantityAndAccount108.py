...
class QuantityAndAccount108(base_types._BaseFieldType):
	...
	__slots__ = ["_BlckChainAdrOrWllt", "_DnmtnChc", "_CshAcct", "_PrevslySttldAmt", "_RmngToBeSttldAmt", "_SfkpgAcct", "_SfkpgPlc", "_RmngToBeSttldQty", "_QtyBrkdwn", "_PrevslySttldQty", "_AcctOwnr", "_SttldQty"]
	@property
	def AcctOwnr(self):
