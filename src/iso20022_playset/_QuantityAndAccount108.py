...
class QuantityAndAccount108(base_types._BaseFieldType):
	...
	__slots__ = ["_DnmtnChc", "_CshAcct", "_QtyBrkdwn", "_AcctOwnr", "_PrevslySttldQty", "_PrevslySttldAmt", "_SfkpgAcct", "_RmngToBeSttldQty", "_BlckChainAdrOrWllt", "_RmngToBeSttldAmt", "_SttldQty", "_SfkpgPlc"]
	@property
	def DnmtnChc(self):
