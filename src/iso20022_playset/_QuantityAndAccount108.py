...
from ._QuantityBreakdown75 import QuantityBreakdown75
from ._SafeKeepingPlace4 import SafeKeepingPlace4

class QuantityAndAccount108(base_types._BaseFieldType):

	__slots__ = ["_SttldQty", "_DnmtnChc", "_PrevslySttldQty", "_RmngToBeSttldAmt", "_QtyBrkdwn", "_AcctOwnr", "_CshAcct", "_SfkpgAcct", "_BlckChainAdrOrWllt", "_RmngToBeSttldQty", "_SfkpgPlc", "_PrevslySttldAmt"]
	@property
	def SttldQty(self):
