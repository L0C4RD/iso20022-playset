...
class FinancialInstrument100(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlPctgInstd", "_OrgnlCost", "_Trfr", "_IntrmyInf", "_PrtlInstdQty", "_FctvTrfDt", "_Instrm", "_Qty", "_CrstllstnDtls", "_SttlmPtiesDtls", "_ReqdSttlmDt", "_NotAvlbl", "_AsstsHeldInOwnNm", "_TrfRsltsInChngOfBnfclOwnr", "_ClntRef", "_TrfeeAcct", "_CtrPtyRef", "_AvrgAcqstnPric", "_BizFlowTp", "_TtlBookVal", "_PmtDtls", "_AddtlAsst", "_TrfCcy", "_LineId", "_TaxValtnPt", "_FctvSttlmDt", "_AddtlInf", "_TrfTp", "_ReqdTradDt", "_Convs", "_UnitsDtls", "_LatstValtn"]
	@property
	def AddtlAsst(self):
