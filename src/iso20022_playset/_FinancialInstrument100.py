...
class FinancialInstrument100(base_types._BaseFieldType):
	...
	__slots__ = ["_BizFlowTp", "_ReqdTradDt", "_TrfRsltsInChngOfBnfclOwnr", "_Trfr", "_ClntRef", "_TtlBookVal", "_OrgnlPctgInstd", "_LatstValtn", "_AsstsHeldInOwnNm", "_TaxValtnPt", "_IntrmyInf", "_CrstllstnDtls", "_OrgnlCost", "_UnitsDtls", "_PmtDtls", "_LineId", "_TrfCcy", "_NotAvlbl", "_TrfTp", "_ReqdSttlmDt", "_AvrgAcqstnPric", "_Qty", "_SttlmPtiesDtls", "_TrfeeAcct", "_FctvTrfDt", "_Convs", "_AddtlAsst", "_FctvSttlmDt", "_CtrPtyRef", "_Instrm", "_AddtlInf", "_PrtlInstdQty"]
	@property
	def BizFlowTp(self):
