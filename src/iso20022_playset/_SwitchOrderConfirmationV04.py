...
class SwitchOrderConfirmationV04(base_types._BaseFieldType):
	...
	def SwtchExctnDtls(self, value):
		self._SwtchExctnDtls = value if value is not None else base_types.UninitialisedField(self, 'SwtchExctnDtls', SwitchExecution7, True)

	@SwtchExctnDtls.deleter
	def SwtchExctnDtls(self):
		del self._SwtchExctnDtls
		self._SwtchExctnDtls = base_types.UninitialisedField(self, 'SwtchExctnDtls', SwitchExecution7, True)
