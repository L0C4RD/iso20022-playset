...
class SaleItem4(base_types._BaseFieldType):
	...
	__slots__ = ["_NonAdjstdTtlAmt", "_PdctQty", "_AdjstdAmt", "_PdctTp", "_PdctCdTp", "_PdctCd", "_OthrUnitOfMeasr", "_UnitOfMeasr", "_PdctDesc", "_TtlAmt", "_AddtlPdctCd", "_NonAdjstdUnitPric", "_InsrncInd", "_InsrncAmt", "_PdctCdModfr", "_Tax", "_AddtlPdctCdTp", "_Adjstmnt"]
	@property
