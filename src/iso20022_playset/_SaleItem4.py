...
class SaleItem4(base_types._BaseFieldType):
	...
	__slots__ = ["_Tax", "_Adjstmnt", "_PdctQty", "_NonAdjstdUnitPric", "_PdctDesc", "_InsrncAmt", "_PdctCdTp", "_InsrncInd", "_AddtlPdctCdTp", "_NonAdjstdTtlAmt", "_AddtlPdctCd", "_TtlAmt", "_UnitOfMeasr", "_PdctCdModfr", "_PdctTp", "_AdjstdAmt", "_OthrUnitOfMeasr", "_PdctCd"]
	@property
	def Tax(self):
		return self._Tax
