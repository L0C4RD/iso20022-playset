...
class TransactionIdentification53(base_types._BaseFieldType):
	...
	__slots__ = ["_PurchsIdrTp", "_OthrPurchsIdrTp", "_LifeCyclId", "_AcqrrRefNb", "_PresntmntSeqCnt", "_AuthstnSeqNb", "_AuthntcnTkn", "_AcqrrRefData", "_PresntmntSeqNb", "_SysTracAudtNb", "_RtrvlRefNb", "_LifeCyclSpprt", "_IssrRefData", "_TrnsmssnDtTm", "_AssoctdDataRef", "_PurchsIdr"]
	@property
