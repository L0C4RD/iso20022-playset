...
class Token3(base_types._BaseFieldType):
	...
	__slots__ = ["_PmtTkn", "_TknRefId", "_TknRqstrId", "_TknInittdInd", "_StorgLctn", "_AddtlData", "_PrtcnMtd", "_OthrPrtcnMtd", "_OthrStorgLctn", "_TknXpryDt", "_TknAssrncMtd", "_TknAssrncData", "_OrgnlTkn"]
	@property
	def PmtTkn(self):
		return self._PmtTkn
