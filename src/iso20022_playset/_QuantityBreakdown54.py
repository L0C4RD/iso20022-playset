...
class QuantityBreakdown54(base_types._BaseFieldType):
	...
	def LotQty(self, value):
		self._LotQty = value if value is not None else base_types.UninitialisedField(self, 'LotQty', Balance7, False)

	@LotQty.deleter
	def LotQty(self):
		del self._LotQty
		self._LotQty = base_types.UninitialisedField(self, 'LotQty', Balance7, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='LotQty', type=Balance7, min=0, max=1, mutex_group=None, array=False),
