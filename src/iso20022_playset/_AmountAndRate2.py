...
class AmountAndRate2(base_types._BaseFieldType):
	...
	@Amt.setter
	def Amt(self, value):
		self._Amt = value if value is not None else base_types.UninitialisedField(self, 'Amt', AmountAndDirection30, False)

	@Amt.deleter
	def Amt(self):
		del self._Amt
		self._Amt = base_types.UninitialisedField(self, 'Amt', AmountAndDirection30, False)
	...
	_field_defs = frozenset((
		base_types.FieldEntry(name='Amt', type=AmountAndDirection30, min=0, max=1, mutex_group=None, array=False),
