...
class ShippingPackage3(base_types._BaseFieldType):
	...
	__slots__ = ["_WghtUnit", "_SpplrId", "_SpplrInstrs", "_DlvryDt", "_SpplrAdr", "_DlvryTm", "_DlvryCtct", "_Insrnc", "_PckpTm", "_PckpDt", "_NbOfUnits", "_SpplrNm", "_DlvryInstrs", "_TrckgNb", "_DlvryAdr", "_SpplrCtct", "_Pdct", "_InsrncAmt", "_DlvryNoteNb", "_OthrWghtUnit"]
	@property
	def WghtUnit(self):
