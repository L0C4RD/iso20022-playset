...
class ShippingPackage3(base_types._BaseFieldType):
	...
	__slots__ = ["_DlvryCtct", "_SpplrAdr", "_DlvryDt", "_PckpTm", "_InsrncAmt", "_DlvryInstrs", "_SpplrNm", "_Insrnc", "_DlvryNoteNb", "_NbOfUnits", "_Pdct", "_SpplrId", "_SpplrCtct", "_PckpDt", "_DlvryTm", "_WghtUnit", "_DlvryAdr", "_TrckgNb", "_OthrWghtUnit", "_SpplrInstrs"]
	@property
	def DlvryCtct(self):
