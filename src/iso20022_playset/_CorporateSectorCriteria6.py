...
from . import NonFinancialPartySector1Code
...
class CorporateSectorCriteria6(base_types._BaseFieldType):
	...
	def NFISctr(self, value):
		self._NFISctr = value if value is not None else base_types.UninitialisedField(self, 'NFISctr', NonFinancialPartySector1Code, True)

	@NFISctr.deleter
	def NFISctr(self):
		del self._NFISctr
		self._NFISctr = base_types.UninitialisedField(self, 'NFISctr', NonFinancialPartySector1Code, True)
