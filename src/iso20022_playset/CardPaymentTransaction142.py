...
class CardPaymentTransaction142(base_types._BaseFieldType):
	...
	__slots__ = ["_CardPrgrmmPropsd", "_SaleRefId", "_TxDtls", "_InitrTxId", "_TxCaptr", "_OrgnlTx", "_CardPrgrmmApld", "_MrchntCtgyCd", "_RcptTxId", "_RcncltnId", "_TxId", "_AddtlTxData", "_CstmrCnsnt"]
	@property
