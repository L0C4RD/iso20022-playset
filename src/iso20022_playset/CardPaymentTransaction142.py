...
class CardPaymentTransaction142(base_types._BaseFieldType):
	...
	__slots__ = ["_TxDtls", "_MrchntCtgyCd", "_AddtlTxData", "_TxCaptr", "_CardPrgrmmPropsd", "_OrgnlTx", "_RcptTxId", "_TxId", "_CstmrCnsnt", "_SaleRefId", "_RcncltnId", "_CardPrgrmmApld", "_InitrTxId"]
	@property
	def TxDtls(self):
		return self._TxDtls
