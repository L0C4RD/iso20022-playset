...
class CardPaymentTransaction142(base_types._BaseFieldType):
	...
	__slots__ = ["_MrchntCtgyCd", "_TxCaptr", "_SaleRefId", "_CstmrCnsnt", "_RcptTxId", "_CardPrgrmmPropsd", "_TxId", "_InitrTxId", "_AddtlTxData", "_OrgnlTx", "_RcncltnId", "_CardPrgrmmApld", "_TxDtls"]
	@property
