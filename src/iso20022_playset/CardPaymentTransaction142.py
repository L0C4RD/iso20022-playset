...
class CardPaymentTransaction142(base_types._BaseFieldType):
	...
	__slots__ = ["_CstmrCnsnt", "_OrgnlTx", "_RcptTxId", "_TxId", "_TxDtls", "_AddtlTxData", "_SaleRefId", "_InitrTxId", "_TxCaptr", "_CardPrgrmmApld", "_MrchntCtgyCd", "_RcncltnId", "_CardPrgrmmPropsd"]
	@property
	def CstmrCnsnt(self):
