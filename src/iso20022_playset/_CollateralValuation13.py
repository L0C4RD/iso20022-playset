...
class CollateralValuation13(base_types._BaseFieldType):
	...
	__slots__ = ["_CollDrctn", "_SctiesColl", "_XchgRate", "_CshColl", "_CcyHrcut", "_CollId", "_DayCntBsis", "_ApldXcssInd", "_AdjstdRate", "_SttlmSts", "_OthrColl", "_NbOfDaysAcrd", "_ValtnAmts", "_CollTp"]
	@property
	def CollDrctn(self):
