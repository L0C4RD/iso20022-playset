...
class CollateralValuation13(base_types._BaseFieldType):
	...
	__slots__ = ["_CcyHrcut", "_CollDrctn", "_AdjstdRate", "_CollId", "_ValtnAmts", "_CollTp", "_OthrColl", "_SttlmSts", "_SctiesColl", "_CshColl", "_ApldXcssInd", "_NbOfDaysAcrd", "_DayCntBsis", "_XchgRate"]
	@property
	def CcyHrcut(self):
