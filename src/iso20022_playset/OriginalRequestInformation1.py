...
class OriginalRequestInformation1(base_types._BaseFieldType):
	...
	__slots__ = ["_IntrmyAgt", "_CxlStsInf", "_Id", "_FrstAgt", "_FincgRqstr", "_CreDtTm", "_VldtnStsInf"]
	@property
	def IntrmyAgt(self):
	...
	def CxlStsInf(self, value):
		self._CxlStsInf = value if type(value) != base_types.auto else self.make_default("CxlStsInf")
