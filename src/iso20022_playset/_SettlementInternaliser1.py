...
from . import SettlementInternaliserIdentification1
...
class SettlementInternaliser1(base_types._BaseFieldType):
	...
	@Id.setter
	def Id(self, value):
		self._Id = value if value is not None else base_types.UninitialisedField(self, 'Id', SettlementInternaliserIdentification1, False)

	@Id.deleter
	def Id(self):
		del self._Id
		self._Id = base_types.UninitialisedField(self, 'Id', SettlementInternaliserIdentification1, False)
