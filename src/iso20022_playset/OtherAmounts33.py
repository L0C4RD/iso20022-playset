...
class OtherAmounts33(base_types._BaseFieldType):
	...
	__slots__ = ["_Othr", "_ShppgAmt", "_AcrdIntrstAmt", "_WhldgTax", "_RgltryAmt", "_ValAddedTax", "_ChrgsFees", "_PmtLevyTax", "_StockXchgTax", "_TrfTax", "_AcrdCptlstnAmt", "_TxTax", "_CsmptnTax", "_CtryNtlFdrlTax", "_StmpDty", "_LclTax"]
	@property
	def Othr(self):
		return self._Othr
