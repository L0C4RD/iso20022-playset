...
from . import SwitchOrderCancellationRequestV04
...
class SETR_014_001_04():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def SwtchOrdrCxlReq(self, value):
			self._SwtchOrdrCxlReq = value if value is not None else base_types.UninitialisedField(self, 'SwtchOrdrCxlReq', SwitchOrderCancellationRequestV04, False)

		@SwtchOrdrCxlReq.deleter
		def SwtchOrdrCxlReq(self):
			del self._SwtchOrdrCxlReq
			self._SwtchOrdrCxlReq = base_types.UninitialisedField(self, 'SwtchOrdrCxlReq', SwitchOrderCancellationRequestV04, False)
