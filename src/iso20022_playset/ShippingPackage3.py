...
class ShippingPackage3(base_types._BaseFieldType):
	...
	__slots__ = ["_NbOfUnits", "_PckpTm", "_OthrWghtUnit", "_Pdct", "_WghtUnit", "_SpplrId", "_SpplrCtct", "_DlvryDt", "_DlvryTm", "_SpplrInstrs", "_SpplrNm", "_TrckgNb", "_Insrnc", "_DlvryNoteNb", "_DlvryInstrs", "_DlvryCtct", "_InsrncAmt", "_SpplrAdr", "_PckpDt", "_DlvryAdr"]
	@property
	def NbOfUnits(self):
