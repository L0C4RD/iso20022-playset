...
class SaleContext4(base_types._BaseFieldType):
	...
	__slots__ = ["_CshrId", "_SpltPmt", "_PurchsOrdrNb", "_SaleRcncltnId", "_SaleRefNb", "_RmngAmt", "_ReuseCardDataFlg", "_SpnsrdMrchnt", "_SaleId", "_DlvryNoteNb", "_ForceOnlnFlg", "_CstmrOrdrReqFlg", "_SaleTknScp", "_InvcNb", "_AddtlSaleData", "_ShftNb", "_AllwdNtryMd", "_CshrLang"]
	@property
	def CshrId(self):
		return self._CshrId
