...
class CorporateAction83(base_types._BaseFieldType):
	...
	__slots__ = ["_AmtDtls", "_AccptncPrtyLvl", "_AddtlBizPrcInd", "_CertfctnTp", "_AddtlInf", "_OcrncTp", "_LtryTp", "_CnsntTp", "_EvtBalDtls", "_ChrgsApldInd", "_PrdDtls", "_TaxOnNonDstrbtdPrcdsInd", "_OfferTp", "_ChngTp", "_InfTp", "_SctiesQty", "_CertDtls", "_DvddTp", "_TaxblIncmPerShrClctd", "_CptlGnInOutInd", "_RateAndAmtDtls", "_FrftrOfIntrstInd", "_NtceTp", "_PrratnRtrMinQtyTrtmnt", "_DtDtls", "_IntrmdtSctiesDstrbtnTp", "_NewPlcOfIncorprtn", "_PricDtls", "_RstrctnInd", "_RnncblEntitlmntStsTp", "_DtchAuctnTp", "_SplmtryIndctrs", "_EvtStag", "_AcrdIntrstInd", "_IntrstAcrdNbOfDays"]
	@property
	def AmtDtls(self):
