...
class SecuritiesSettlementTransactionInstructionV12(base_types._BaseFieldType):
	...
	__slots__ = ["_RcvgSttlmPties", "_OthrBizPties", "_StgSttlmInstrDtls", "_OthrAmts", "_SttlmAmt", "_SttlmParams", "_DgtlNtwkFee", "_TxId", "_AddtlPhysOrRegnDtls", "_CshPties", "_TradDtls", "_SttlmTpAndAddtlParams", "_FinInstrmId", "_QtyAndAcctDtls", "_SplmtryData", "_Lnkgs", "_DlvrgSttlmPties", "_FinInstrmAttrbts", "_NbCounts"]
	@property
