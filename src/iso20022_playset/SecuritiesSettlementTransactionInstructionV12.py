...
import SettlementDetails219
import OtherParties43
import SecuritiesTradeDetails142
import SettlementTypeAndAdditionalParameters23
...
class SecuritiesSettlementTransactionInstructionV12(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmAmt", "_SplmtryData", "_CshPties", "_TxId", "_DgtlNtwkFee", "_FinInstrmId", "_RcvgSttlmPties", "_StgSttlmInstrDtls", "_QtyAndAcctDtls", "_NbCounts", "_OthrAmts", "_TradDtls", "_Lnkgs", "_FinInstrmAttrbts", "_AddtlPhysOrRegnDtls", "_DlvrgSttlmPties", "_SttlmTpAndAddtlParams", "_SttlmParams", "_OthrBizPties"]
	@property
	def SttlmAmt(self):
