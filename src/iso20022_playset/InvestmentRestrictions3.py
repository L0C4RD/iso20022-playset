...
class InvestmentRestrictions3(base_types._BaseFieldType):
	...
	__slots__ = ["_MaxSwtchRedAmt", "_MinSbsqntSbcptAmt", "_AddtlInf", "_HldgTrfbl", "_MinInitlSbcptAmt", "_OthrSwtchRstrctns", "_MinSwtchSbcptAmt", "_MinSwtchSbcptUnits", "_MaxSwtchRedUnits", "_MaxRedAmt", "_MinSbsqntSbcptUnits", "_MinRedPctg", "_MinHldgAmt", "_MinHldgPrd", "_MinInitlSbcptUnits", "_MaxRedUnits", "_OthrRedRstrctns", "_MinHldgUnits"]
	@property
