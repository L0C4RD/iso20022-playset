...
class InvestmentRestrictions3(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrRedRstrctns", "_MinHldgPrd", "_HldgTrfbl", "_MinRedPctg", "_MinInitlSbcptAmt", "_MinSwtchSbcptUnits", "_MinHldgAmt", "_MinSbsqntSbcptUnits", "_OthrSwtchRstrctns", "_MinSbsqntSbcptAmt", "_MinHldgUnits", "_MaxSwtchRedUnits", "_MaxRedAmt", "_MaxRedUnits", "_MinSwtchSbcptAmt", "_AddtlInf", "_MinInitlSbcptUnits", "_MaxSwtchRedAmt"]
	@property
