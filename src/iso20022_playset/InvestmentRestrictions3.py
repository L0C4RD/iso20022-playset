...
class InvestmentRestrictions3(base_types._BaseFieldType):
	...
	__slots__ = ["_MinInitlSbcptAmt", "_MinHldgAmt", "_MinHldgUnits", "_OthrRedRstrctns", "_MinSbsqntSbcptUnits", "_MaxRedUnits", "_MinRedPctg", "_HldgTrfbl", "_MinSbsqntSbcptAmt", "_MaxSwtchRedAmt", "_MaxRedAmt", "_AddtlInf", "_MaxSwtchRedUnits", "_OthrSwtchRstrctns", "_MinHldgPrd", "_MinSwtchSbcptAmt", "_MinSwtchSbcptUnits", "_MinInitlSbcptUnits"]
	@property
