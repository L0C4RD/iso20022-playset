...
class SecuritiesFinancingInstructionV12(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_SctiesFincgDtls", "_DgtlNtwkFee", "_NbCounts", "_CshPties", "_FinInstrmAttrbts", "_Lnkgs", "_FinInstrmId", "_OpngSttlmAmt", "_DlvrgSttlmPties", "_RcvgSttlmPties", "_TradDtls", "_OthrAmts", "_OthrBizPties", "_SttlmParams", "_QtyAndAcctDtls", "_TxTpAndAddtlParams", "_TxId", "_StgSttlmInstrDtls"]
	@property
