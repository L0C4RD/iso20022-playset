...
class SettlementDetails211(base_types._BaseFieldType):
	...
	__slots__ = ["_LttrOfGrnt", "_SctiesTxTp", "_SttlmSysMtd", "_BlckTrad", "_Prty", "_CCPElgblty", "_NetgElgblty", "_CshSubBalTp", "_AutomtcBrrwg", "_SttlgCpcty", "_TaxCpcty", "_XpsrTp", "_PrtlSttlmInd", "_CshClrSys", "_SctiesSubBalTp", "_StmpDtyTaxBsis", "_LglRstrctns", "_BnfclOwnrsh", "_RpTp", "_SctiesRTGS", "_Regn", "_ElgblForColl", "_SttlmTxCond", "_MktClntSd"]
	@property
	def LttrOfGrnt(self):
