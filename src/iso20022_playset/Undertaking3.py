...
class Undertaking3(base_types._BaseFieldType):
	...
	__slots__ = ["_Tp", "_ConfInd", "_PresntnDtls", "_Bnfcry", "_IssncTp", "_ScndAdvsgPty", "_UdrtkgAmt", "_AutomtcAmtVartn", "_Issr", "_UdrtkgTermsAndConds", "_ConfPtyTp", "_NclsdFile", "_XpryDtls", "_PlcOfIsse", "_AddtlInf", "_Id", "_AdvsgPty", "_TrfChrgsPyblBy", "_MltplDmndInd", "_Applcnt", "_DtOfIssnc", "_ReqdLclUdrtkg", "_AddtlPty", "_GovncRulesAndLaw", "_UndrlygTx", "_ConfChrgsPyblBy", "_PrtlDmndInd", "_DlvryChanl", "_Nm", "_TrfInd"]
	@property
	def Tp(self):
		return self._Tp
