...
from .Presentation1 import Presentation1
from .UndertakingType1Choice import UndertakingType1Choice
from .Document9 import Document9
from .Undertaking4 import Undertaking4
from .AutomaticVariation1 import AutomaticVariation1

class Undertaking3(base_types._BaseFieldType):

	__slots__ = ["_PlcOfIsse", "_AddtlPty", "_Id", "_DlvryChanl", "_Issr", "_DtOfIssnc", "_ConfChrgsPyblBy", "_TrfInd", "_MltplDmndInd", "_NclsdFile", "_ScndAdvsgPty", "_AddtlInf", "_TrfChrgsPyblBy", "_GovncRulesAndLaw", "_AutomtcAmtVartn", "_AdvsgPty", "_ConfInd", "_PrtlDmndInd", "_ReqdLclUdrtkg", "_Bnfcry", "_Tp", "_Nm", "_Applcnt", "_UdrtkgAmt", "_ConfPtyTp", "_UdrtkgTermsAndConds", "_XpryDtls", "_IssncTp", "_PresntnDtls", "_UndrlygTx"]
	@property
	def PlcOfIsse(self):
	...
	def DtOfIssnc(self, value):
		self._DtOfIssnc = value if type(value) != auto else self.make_default("DtOfIssnc")
