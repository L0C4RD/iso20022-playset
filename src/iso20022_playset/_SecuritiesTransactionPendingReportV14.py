...
from . import StatusAndReason47
from . import Transaction163
...
class SecuritiesTransactionPendingReportV14(base_types._BaseFieldType):
	...
	@Sts.setter
	def Sts(self, value):
		self._Sts = value if value is not None else base_types.UninitialisedField(self, 'Sts', StatusAndReason47, True)

	@Sts.deleter
	def Sts(self):
		del self._Sts
		self._Sts = base_types.UninitialisedField(self, 'Sts', StatusAndReason47, True)
	...
	@Txs.setter
	def Txs(self, value):
		self._Txs = value if value is not None else base_types.UninitialisedField(self, 'Txs', Transaction163, True)

	@Txs.deleter
	def Txs(self):
		del self._Txs
		self._Txs = base_types.UninitialisedField(self, 'Txs', Transaction163, True)
