...
class OtherCollateral9(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrTpOfColl", "_CollId", "_IsseDt", "_LttrOfCdtId", "_LttrOfCdtAmt", "_MktVal", "_SfkpgAcct", "_XchgRate", "_XpryDt", "_CollVal", "_Issr", "_LtdCvrgInd", "_Hrcut", "_GrntAmt", "_SfkpgPlc", "_BlckChainAdrOrWllt", "_ValDt"]
	@property
