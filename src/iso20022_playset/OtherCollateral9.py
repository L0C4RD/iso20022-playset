...
class OtherCollateral9(base_types._BaseFieldType):
	...
	__slots__ = ["_Issr", "_ValDt", "_XchgRate", "_OthrTpOfColl", "_LtdCvrgInd", "_XpryDt", "_Hrcut", "_GrntAmt", "_CollVal", "_MktVal", "_BlckChainAdrOrWllt", "_IsseDt", "_SfkpgPlc", "_LttrOfCdtId", "_LttrOfCdtAmt", "_SfkpgAcct", "_CollId"]
	@property
	def Issr(self):
		return self._Issr
