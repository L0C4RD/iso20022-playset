...
class OtherCollateral9(base_types._BaseFieldType):
	...
	__slots__ = ["_CollId", "_BlckChainAdrOrWllt", "_OthrTpOfColl", "_IsseDt", "_Issr", "_XchgRate", "_Hrcut", "_MktVal", "_LtdCvrgInd", "_LttrOfCdtAmt", "_SfkpgPlc", "_XpryDt", "_ValDt", "_GrntAmt", "_SfkpgAcct", "_CollVal", "_LttrOfCdtId"]
	@property
	def CollId(self):
		return self._CollId
