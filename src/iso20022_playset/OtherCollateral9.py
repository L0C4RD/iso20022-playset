...
class OtherCollateral9(base_types._BaseFieldType):
	...
	__slots__ = ["_MktVal", "_SfkpgAcct", "_OthrTpOfColl", "_SfkpgPlc", "_GrntAmt", "_XchgRate", "_CollId", "_ValDt", "_IsseDt", "_LttrOfCdtId", "_LtdCvrgInd", "_CollVal", "_BlckChainAdrOrWllt", "_XpryDt", "_Hrcut", "_Issr", "_LttrOfCdtAmt"]
	@property
	def MktVal(self):
		return self._MktVal
