...
class RedemptionMultipleOrder6(base_types._BaseFieldType):
	...
	def IndvOrdrDtls(self, value):
		self._IndvOrdrDtls = value if value is not None else base_types.UninitialisedField(self, 'IndvOrdrDtls', RedemptionOrder14, True)

	@IndvOrdrDtls.deleter
	def IndvOrdrDtls(self):
		del self._IndvOrdrDtls
		self._IndvOrdrDtls = base_types.UninitialisedField(self, 'IndvOrdrDtls', RedemptionOrder14, True)
