...
from . import NotificationToReceiveStatusReportV09
...
class CAMT_059_001_09():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def NtfctnToRcvStsRpt(self, value):
			self._NtfctnToRcvStsRpt = value if value is not None else base_types.UninitialisedField(self, 'NtfctnToRcvStsRpt', NotificationToReceiveStatusReportV09, False)

		@NtfctnToRcvStsRpt.deleter
		def NtfctnToRcvStsRpt(self):
			del self._NtfctnToRcvStsRpt
			self._NtfctnToRcvStsRpt = base_types.UninitialisedField(self, 'NtfctnToRcvStsRpt', NotificationToReceiveStatusReportV09, False)
