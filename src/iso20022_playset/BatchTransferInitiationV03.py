...
class BatchTransferInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Rcrd", "_Hdr", "_ReqAck", "_AddtlData", "_Rcncltn", "_Dstn", "_BtchChcksm", "_PrtctdData", "_RtrvlRefNb", "_PrcgRslt", "_LifeCyclId", "_ClrCtrlTtls", "_OrgnlRspnCd", "_SysTracAudtNb", "_SttlmSvc", "_BtchId", "_OrgnlBtchId", "_AgtData", "_Jursdctn", "_SplmtryData", "_Orgtr", "_SctyTrlr", "_NbOfMsgs", "_TrnsmssnDtTm", "_Prgrmm", "_ClrBtchData"]
	@property
	def Rcrd(self):
		return self._Rcrd
