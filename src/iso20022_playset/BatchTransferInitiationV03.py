...
class BatchTransferInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Hdr", "_Dstn", "_PrtctdData", "_BtchChcksm", "_Jursdctn", "_RtrvlRefNb", "_Rcrd", "_NbOfMsgs", "_OrgnlRspnCd", "_Rcncltn", "_SplmtryData", "_AddtlData", "_SttlmSvc", "_LifeCyclId", "_BtchId", "_OrgnlBtchId", "_ClrCtrlTtls", "_TrnsmssnDtTm", "_Prgrmm", "_ReqAck", "_AgtData", "_SysTracAudtNb", "_ClrBtchData", "_PrcgRslt", "_Orgtr", "_SctyTrlr"]
	@property
	def Hdr(self):
		return self._Hdr
