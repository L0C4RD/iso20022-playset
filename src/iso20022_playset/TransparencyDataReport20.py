...
class TransparencyDataReport20(base_types._BaseFieldType):
	...
	__slots__ = ["_TradgVn", "_PreTradLrgInScaleThrshld", "_RptgPrd", "_PstTradInstrmSzSpcfcThrshld", "_Lqdty", "_FullNm", "_Sttstcs", "_Id", "_PstTradLrgInScaleThrshld", "_TechRcrdId", "_PreTradInstrmSzSpcfcThrshld"]
	@property
	def TradgVn(self):
