...
class AdministrativeResponseV02(base_types._BaseFieldType):
	...
	__slots__ = ["_TxId", "_Instlmt", "_CstmrDvc", "_Rcncltn", "_PrtctdData", "_AddtlSvc", "_Crdhldr", "_Prgrmm", "_ConvsDtTm", "_ICCRltdData", "_SpclPrgrmmQlfctn", "_Accptr", "_AddtlData", "_OrgnlTx", "_Cntxt", "_MsgRsn", "_Issr", "_XchgRate", "_OthrAdmstvTp", "_Wllt", "_Acqrr", "_Hdr", "_Dstn", "_AdmstvTp", "_Termnl", "_TxDesc", "_Rcvr", "_Jursdctn", "_Pyee", "_SttlmSvc", "_Cstmr", "_Sndr", "_Pyer", "_Rsk", "_Card", "_POICmpnt", "_AddtlFee", "_LclData", "_SplmtryData", "_PrcgRslt", "_AltrnMsgRsn", "_Tkn", "_Orgtr", "_Vrfctn", "_SctyTrlr", "_TxtMsg"]
	@property
	def TxId(self):
		return self._TxId
