...
class AdministrativeResponseV02(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_Rsk", "_Accptr", "_Pyee", "_Card", "_PrcgRslt", "_AddtlSvc", "_ICCRltdData", "_LclData", "_Termnl", "_Dstn", "_AddtlData", "_Acqrr", "_Hdr", "_SctyTrlr", "_TxId", "_AddtlFee", "_OthrAdmstvTp", "_Issr", "_Orgtr", "_Sndr", "_SpclPrgrmmQlfctn", "_TxtMsg", "_Instlmt", "_Pyer", "_AltrnMsgRsn", "_Rcncltn", "_AdmstvTp", "_Wllt", "_Rcvr", "_Cstmr", "_Vrfctn", "_XchgRate", "_ConvsDtTm", "_Jursdctn", "_Tkn", "_CstmrDvc", "_TxDesc", "_MsgRsn", "_POICmpnt", "_Cntxt", "_Crdhldr", "_PrtctdData", "_SttlmSvc", "_Prgrmm", "_OrgnlTx"]
	@property
