...
class AdministrativeResponseV02(base_types._BaseFieldType):
	...
	__slots__ = ["_SpclPrgrmmQlfctn", "_AddtlData", "_Accptr", "_Issr", "_AltrnMsgRsn", "_Vrfctn", "_TxId", "_XchgRate", "_Acqrr", "_Dstn", "_Cntxt", "_SplmtryData", "_Hdr", "_Pyer", "_OrgnlTx", "_LclData", "_Card", "_Prgrmm", "_AddtlSvc", "_Rcncltn", "_Rcvr", "_ConvsDtTm", "_OthrAdmstvTp", "_MsgRsn", "_TxtMsg", "_Tkn", "_SttlmSvc", "_Wllt", "_SctyTrlr", "_Orgtr", "_AdmstvTp", "_AddtlFee", "_TxDesc", "_Pyee", "_Jursdctn", "_Cstmr", "_CstmrDvc", "_PrtctdData", "_Instlmt", "_ICCRltdData", "_PrcgRslt", "_Crdhldr", "_POICmpnt", "_Sndr", "_Rsk", "_Termnl"]
	@property
