...
from . import UnderlyingTransaction36

class FIToFIPaymentCancellationRequestV12(base_types._BaseFieldType):
	...
	def Undrlyg(self, value):
		self._Undrlyg = value if value is not None else base_types.UninitialisedField(self, 'Undrlyg', UnderlyingTransaction36, True)

	@Undrlyg.deleter
	def Undrlyg(self):
		del self._Undrlyg
		self._Undrlyg = base_types.UninitialisedField(self, 'Undrlyg', UnderlyingTransaction36, True)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='Undrlyg', type=UnderlyingTransaction36, min=1, max=None, mutex_group=None, array=True),
	))