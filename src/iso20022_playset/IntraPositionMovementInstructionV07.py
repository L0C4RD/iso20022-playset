...
class IntraPositionMovementInstructionV07(base_types._BaseFieldType):
	...
	__slots__ = ["_NbCounts", "_SplmtryData", "_FinInstrmAttrbts", "_IntraPosDtls", "_CorpActnEvtId", "_TxId", "_SfkpgPlc", "_Lnkgs", "_FinInstrmId", "_SfkpgAcct", "_AcctOwnr", "_BlckChainAdrOrWllt"]
	@property
	def NbCounts(self):
