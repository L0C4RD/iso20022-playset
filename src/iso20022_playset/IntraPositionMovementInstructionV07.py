...
class IntraPositionMovementInstructionV07(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_Lnkgs", "_AcctOwnr", "_BlckChainAdrOrWllt", "_SfkpgAcct", "_FinInstrmAttrbts", "_FinInstrmId", "_TxId", "_NbCounts", "_IntraPosDtls", "_CorpActnEvtId", "_SfkpgPlc"]
	@property
