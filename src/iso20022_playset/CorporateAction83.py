import base_types
import CorporateActionSD26
import Exact3UpperCaseAlphaNumericText
import CorporateActionSupplementaryIndicators1
...
import RedemptionAnnouncementNoticeType1Code
...
import CorporateActionBalanceDetails47
import DutchAuctionTypeFormat1Choice
import CorporateActionDate83
import YesNoIndicator
import Max350Text
import CorporateActionAmounts70
...
class CorporateAction83(base_types._BaseFieldType):
	...
	__slots__ = ["_TaxOnNonDstrbtdPrcdsInd", "_NtceTp", "_RstrctnInd", "_IntrstAcrdNbOfDays", "_SplmtryIndctrs", "_TaxblIncmPerShrClctd", "_AmtDtls", "_ChrgsApldInd", "_IntrmdtSctiesDstrbtnTp", "_LtryTp", "_AddtlInf", "_PrdDtls", "_ChngTp", "_FrftrOfIntrstInd", "_SctiesQty", "_CertDtls", "_AccptncPrtyLvl", "_PrratnRtrMinQtyTrtmnt", "_PricDtls", "_AddtlBizPrcInd", "_DtchAuctnTp", "_NewPlcOfIncorprtn", "_EvtBalDtls", "_CptlGnInOutInd", "_RnncblEntitlmntStsTp", "_InfTp", "_AcrdIntrstInd", "_CnsntTp", "_OcrncTp", "_OfferTp", "_DvddTp", "_DtDtls", "_RateAndAmtDtls", "_EvtStag", "_CertfctnTp"]
	@property
