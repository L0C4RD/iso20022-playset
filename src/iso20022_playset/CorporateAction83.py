...
class CorporateAction83(base_types._BaseFieldType):
	...
	__slots__ = ["_PricDtls", "_CnsntTp", "_DtchAuctnTp", "_AddtlInf", "_FrftrOfIntrstInd", "_NewPlcOfIncorprtn", "_AcrdIntrstInd", "_ChrgsApldInd", "_NtceTp", "_IntrstAcrdNbOfDays", "_CptlGnInOutInd", "_OcrncTp", "_CertfctnTp", "_SctiesQty", "_AddtlBizPrcInd", "_AccptncPrtyLvl", "_EvtBalDtls", "_IntrmdtSctiesDstrbtnTp", "_PrdDtls", "_OfferTp", "_RnncblEntitlmntStsTp", "_LtryTp", "_CertDtls", "_TaxblIncmPerShrClctd", "_RstrctnInd", "_DvddTp", "_SplmtryIndctrs", "_TaxOnNonDstrbtdPrcdsInd", "_RateAndAmtDtls", "_ChngTp", "_InfTp", "_PrratnRtrMinQtyTrtmnt", "_EvtStag", "_DtDtls", "_AmtDtls"]
	@property
	def PricDtls(self):
