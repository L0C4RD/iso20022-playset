...
class TransparencyDataReport20(base_types._BaseFieldType):
	...
	__slots__ = ["_TradgVn", "_Lqdty", "_Sttstcs", "_PstTradInstrmSzSpcfcThrshld", "_PreTradLrgInScaleThrshld", "_FullNm", "_TechRcrdId", "_PstTradLrgInScaleThrshld", "_PreTradInstrmSzSpcfcThrshld", "_RptgPrd", "_Id"]
	@property
	def TradgVn(self):
