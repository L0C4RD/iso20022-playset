...
from . import AcceptorTransactionLogReportRequestV05
...
class CAAA_024_001_05():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def AccptrTxLgRptReq(self, value):
			self._AccptrTxLgRptReq = value if value is not None else base_types.UninitialisedField(self, 'AccptrTxLgRptReq', AcceptorTransactionLogReportRequestV05, False)

		@AccptrTxLgRptReq.deleter
		def AccptrTxLgRptReq(self):
			del self._AccptrTxLgRptReq
			self._AccptrTxLgRptReq = base_types.UninitialisedField(self, 'AccptrTxLgRptReq', AcceptorTransactionLogReportRequestV05, False)
