...
class Context24(base_types._BaseFieldType):
	...
	__slots__ = ["_CardDataNtryMd", "_OthrMrchntCtgy", "_DfrrdDlvry", "_DelydAuthstn", "_QRCdPresntmntMd", "_AuthntcnOutg", "_CrdhldrActvtd", "_SaleRefNb", "_Trnst", "_EComrcData", "_PmtCrdntlMrchntRltsh", "_OthrGoodAndSvcDlvrySchdl", "_MrchntCtgyCd", "_DelydChrgs", "_Attndd", "_TxInitr", "_UattnddLvlCtgy", "_NoShow", "_OthrSctyChrtcs", "_ReSubmissn", "_RctTp", "_EComrcIndPropsd", "_Reauthstn", "_GoodAndSvcDlvryChanl", "_EComrc", "_RctDstn", "_MrchntCtgySpcfcData", "_TrnspndrInittd", "_CaptrDt", "_OthrGoodAndSvcDlvryChanl", "_CardPres", "_GoodAndSvcsSubTp", "_SctyChrtcs", "_LatePresntmnt", "_EComrcIndApld", "_MOTOCd", "_RctReq", "_CrdhldrPres", "_PrtlApprvlSpprtd", "_StorgLctn", "_AddtlData", "_SpltPmt", "_DtAntcptd", "_GoodAndSvcDlvrySchdl", "_GoodAndSvcsOthrSubTp", "_OthrQRCdPresntmntMd", "_OthrCardDataNtryMd", "_PrtlShipmnt", "_GoodsAndSvcsTp"]
	@property
