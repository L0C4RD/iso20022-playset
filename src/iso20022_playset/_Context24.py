...
class Context24(base_types._BaseFieldType):
	...
	__slots__ = ["_EComrc", "_GoodAndSvcDlvryChanl", "_SctyChrtcs", "_SpltPmt", "_GoodAndSvcDlvrySchdl", "_OthrGoodAndSvcDlvrySchdl", "_TxInitr", "_PrtlApprvlSpprtd", "_StorgLctn", "_QRCdPresntmntMd", "_PmtCrdntlMrchntRltsh", "_Attndd", "_SaleRefNb", "_AddtlData", "_CardDataNtryMd", "_EComrcIndPropsd", "_OthrQRCdPresntmntMd", "_RctDstn", "_DtAntcptd", "_DfrrdDlvry", "_GoodAndSvcsSubTp", "_AuthntcnOutg", "_UattnddLvlCtgy", "_MOTOCd", "_PrtlShipmnt", "_TrnspndrInittd", "_MrchntCtgyCd", "_OthrMrchntCtgy", "_EComrcData", "_CardPres", "_MrchntCtgySpcfcData", "_ReSubmissn", "_Reauthstn", "_RctReq", "_NoShow", "_Trnst", "_CrdhldrActvtd", "_OthrCardDataNtryMd", "_DelydChrgs", "_EComrcIndApld", "_OthrSctyChrtcs", "_CaptrDt", "_LatePresntmnt", "_GoodAndSvcsOthrSubTp", "_DelydAuthstn", "_CrdhldrPres", "_RctTp", "_OthrGoodAndSvcDlvryChanl", "_GoodsAndSvcsTp"]
	@property
	def EComrc(self):
		return self._EComrc
