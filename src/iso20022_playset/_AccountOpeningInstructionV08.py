...
class AccountOpeningInstructionV08(base_types._BaseFieldType):
	...
	__slots__ = ["_PrvsRef", "_WdrwlInvstmtPlan", "_AcctPties", "_AddtlInf", "_OrdrRef", "_Intrmies", "_MktPrctcVrsn", "_InvstmtAcct", "_CshSttlm", "_Plcmnt", "_SvcLvlAgrmt", "_SvgsInvstmtPlan", "_MsgId", "_InstrDtls", "_NewIsseAllcn", "_Xtnsn"]
	@property
	def PrvsRef(self):
