...
class Amendment3(base_types._BaseFieldType):
	...
	__slots__ = ["_NewBnfcry", "_UdrtkgId", "_IncrDcrAmt", "_TermntnDtls", "_ApplcntReqNb", "_NclsdFile", "_AddtlInf", "_NewUdrtkgTermsAndConds", "_DlvryChanl", "_Applcnt", "_NewXpryDtls", "_CntrUdrtkg"]
	@property
	def NewBnfcry(self):
