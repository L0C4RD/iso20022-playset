...
class Amendment3(base_types._BaseFieldType):
	...
	__slots__ = ["_NewUdrtkgTermsAndConds", "_IncrDcrAmt", "_ApplcntReqNb", "_AddtlInf", "_TermntnDtls", "_UdrtkgId", "_NewXpryDtls", "_NewBnfcry", "_Applcnt", "_DlvryChanl", "_CntrUdrtkg", "_NclsdFile"]
	@property
