...
class Amendment3(base_types._BaseFieldType):
	...
	__slots__ = ["_CntrUdrtkg", "_NewBnfcry", "_ApplcntReqNb", "_UdrtkgId", "_DlvryChanl", "_Applcnt", "_AddtlInf", "_IncrDcrAmt", "_TermntnDtls", "_NewXpryDtls", "_NewUdrtkgTermsAndConds", "_NclsdFile"]
	@property
	def CntrUdrtkg(self):
