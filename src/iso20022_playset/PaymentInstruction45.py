...
class PaymentInstruction45(base_types._BaseFieldType):
	...
	__slots__ = ["_CdtrAcct", "_ChrgBr", "_PmtTpInf", "_CdtrAgt", "_UltmtCdtr", "_ReqdAdvcTp", "_NbOfTxs", "_PmtMtd", "_ChrgsAcctAgt", "_PmtInfId", "_CdtrAgtAcct", "_CdtrSchmeId", "_CtrlSum", "_ChrgsAcct", "_BtchBookg", "_DrctDbtTxInf", "_ReqdColltnDt", "_Cdtr"]
	@property
	def CdtrAcct(self):
