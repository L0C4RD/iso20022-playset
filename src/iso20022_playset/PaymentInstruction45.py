...
from .AdviceType1 import AdviceType1
from .ISODate import ISODate
from .DecimalNumber import DecimalNumber
from .PaymentMethod2Code import PaymentMethod2Code
from .DirectDebitTransactionInformation32 import DirectDebitTransactionInformation32
...
class PaymentInstruction45(base_types._BaseFieldType):
	...
	__slots__ = ["_Cdtr", "_ChrgBr", "_ReqdAdvcTp", "_CdtrAcct", "_NbOfTxs", "_UltmtCdtr", "_ReqdColltnDt", "_BtchBookg", "_CdtrAgt", "_CdtrSchmeId", "_CtrlSum", "_ChrgsAcctAgt", "_PmtMtd", "_PmtInfId", "_CdtrAgtAcct", "_ChrgsAcct", "_PmtTpInf", "_DrctDbtTxInf"]
	@property
	def Cdtr(self):
		return self._Cdtr
