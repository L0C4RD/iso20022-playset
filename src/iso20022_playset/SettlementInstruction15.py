...
class SettlementInstruction15(base_types._BaseFieldType):
	...
	__slots__ = ["_InstdRmbrsmntAgt", "_ThrdRmbrsmntAgt", "_ClrSys", "_InstgRmbrsmntAgtAcct", "_InstdRmbrsmntAgtAcct", "_ThrdRmbrsmntAgtAcct", "_SttlmMtd", "_InstgRmbrsmntAgt", "_SttlmAcct"]
	@property
