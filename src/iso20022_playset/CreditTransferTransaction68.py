...
class CreditTransferTransaction68(base_types._BaseFieldType):
	...
	__slots__ = ["_Cdtr", "_PrvsInstgAgt2", "_IntrmyAgt2", "_Purp", "_InitgPty", "_InstdAmt", "_IntrmyAgt1Acct", "_DbtrAcct", "_InstrForCdtrAgt", "_DbtrAgtAcct", "_Dbtr", "_DbtrAgt", "_Tax", "_IntrmyAgt1", "_PrvsInstgAgt1", "_RmtInf", "_UltmtCdtr", "_PrvsInstgAgt3Acct", "_CdtrAgt", "_UltmtDbtr", "_IntrmyAgt3Acct", "_PmtId", "_PrvsInstgAgt1Acct", "_CdtrAcct", "_IntrmyAgt2Acct", "_PmtTpInf", "_InstrForNxtAgt", "_CdtrAgtAcct", "_PrvsInstgAgt2Acct", "_PrvsInstgAgt3", "_IntrmyAgt3"]
	@property
	def Cdtr(self):
		return self._Cdtr
