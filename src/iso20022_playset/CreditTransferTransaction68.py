...
class CreditTransferTransaction68(base_types._BaseFieldType):
	...
	__slots__ = ["_PrvsInstgAgt3", "_DbtrAgtAcct", "_DbtrAgt", "_IntrmyAgt1", "_UltmtCdtr", "_DbtrAcct", "_IntrmyAgt2", "_InstrForNxtAgt", "_PmtTpInf", "_CdtrAcct", "_PrvsInstgAgt1", "_Tax", "_CdtrAgtAcct", "_IntrmyAgt1Acct", "_PrvsInstgAgt2", "_Purp", "_PmtId", "_Dbtr", "_IntrmyAgt3", "_PrvsInstgAgt1Acct", "_PrvsInstgAgt2Acct", "_Cdtr", "_UltmtDbtr", "_PrvsInstgAgt3Acct", "_InitgPty", "_RmtInf", "_InstrForCdtrAgt", "_IntrmyAgt2Acct", "_CdtrAgt", "_IntrmyAgt3Acct", "_InstdAmt"]
	@property
