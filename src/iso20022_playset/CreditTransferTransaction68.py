...
class CreditTransferTransaction68(base_types._BaseFieldType):
	...
	__slots__ = ["_Dbtr", "_InstdAmt", "_CdtrAgtAcct", "_IntrmyAgt2Acct", "_DbtrAcct", "_PmtId", "_IntrmyAgt2", "_PrvsInstgAgt1", "_PrvsInstgAgt1Acct", "_PrvsInstgAgt3", "_InstrForNxtAgt", "_InitgPty", "_InstrForCdtrAgt", "_PrvsInstgAgt3Acct", "_Cdtr", "_CdtrAgt", "_IntrmyAgt1Acct", "_IntrmyAgt3Acct", "_UltmtDbtr", "_Purp", "_CdtrAcct", "_PmtTpInf", "_RmtInf", "_IntrmyAgt3", "_DbtrAgt", "_Tax", "_PrvsInstgAgt2Acct", "_PrvsInstgAgt2", "_IntrmyAgt1", "_DbtrAgtAcct", "_UltmtCdtr"]
	@property
	def Dbtr(self):
		return self._Dbtr
