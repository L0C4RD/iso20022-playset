...
class CreditTransferTransaction68(base_types._BaseFieldType):
	...
	__slots__ = ["_Purp", "_DbtrAcct", "_Tax", "_CdtrAcct", "_DbtrAgtAcct", "_PmtId", "_PrvsInstgAgt2", "_DbtrAgt", "_Cdtr", "_UltmtCdtr", "_PmtTpInf", "_InstdAmt", "_IntrmyAgt3Acct", "_RmtInf", "_IntrmyAgt1Acct", "_InstrForCdtrAgt", "_PrvsInstgAgt1", "_InitgPty", "_Dbtr", "_PrvsInstgAgt3", "_IntrmyAgt1", "_UltmtDbtr", "_IntrmyAgt2Acct", "_IntrmyAgt2", "_IntrmyAgt3", "_PrvsInstgAgt2Acct", "_PrvsInstgAgt3Acct", "_CdtrAgtAcct", "_InstrForNxtAgt", "_PrvsInstgAgt1Acct", "_CdtrAgt"]
	@property
	def Purp(self):
		return self._Purp
