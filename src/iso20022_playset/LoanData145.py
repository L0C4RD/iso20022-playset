...
class LoanData145(base_types._BaseFieldType):
	...
	__slots__ = ["_ValDt", "_EvtDt", "_LndgFee", "_CollDlvryMtd", "_ClrSts", "_DlvryByVal", "_UnqTradIdr", "_Term", "_AsstTp", "_RbtRate", "_MstrAgrmt", "_ExctnDtTm", "_GnlColl", "_TradgVn", "_TermntnDt", "_LnVal"]
	@property
	def ValDt(self):
		return self._ValDt
