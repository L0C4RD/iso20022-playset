...
class LoanData145(base_types._BaseFieldType):
	...
	__slots__ = ["_MstrAgrmt", "_EvtDt", "_TradgVn", "_LnVal", "_Term", "_CollDlvryMtd", "_ExctnDtTm", "_UnqTradIdr", "_ValDt", "_DlvryByVal", "_RbtRate", "_TermntnDt", "_AsstTp", "_GnlColl", "_LndgFee", "_ClrSts"]
	@property
	def MstrAgrmt(self):
