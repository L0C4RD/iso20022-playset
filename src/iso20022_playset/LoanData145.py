...
class LoanData145(base_types._BaseFieldType):
	...
	__slots__ = ["_MstrAgrmt", "_LndgFee", "_AsstTp", "_CollDlvryMtd", "_ClrSts", "_LnVal", "_UnqTradIdr", "_RbtRate", "_EvtDt", "_TradgVn", "_DlvryByVal", "_Term", "_ValDt", "_TermntnDt", "_ExctnDtTm", "_GnlColl"]
	@property
	def MstrAgrmt(self):
