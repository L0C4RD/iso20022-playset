...
class LoanData145(base_types._BaseFieldType):
	...
	__slots__ = ["_DlvryByVal", "_ExctnDtTm", "_GnlColl", "_RbtRate", "_TradgVn", "_Term", "_LnVal", "_ClrSts", "_UnqTradIdr", "_AsstTp", "_LndgFee", "_TermntnDt", "_CollDlvryMtd", "_MstrAgrmt", "_EvtDt", "_ValDt"]
	@property
	def DlvryByVal(self):
