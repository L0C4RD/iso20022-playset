...
class LoanData145(base_types._BaseFieldType):
	...
	__slots__ = ["_DlvryByVal", "_ClrSts", "_AsstTp", "_UnqTradIdr", "_ValDt", "_RbtRate", "_TermntnDt", "_MstrAgrmt", "_LndgFee", "_Term", "_TradgVn", "_CollDlvryMtd", "_LnVal", "_ExctnDtTm", "_EvtDt", "_GnlColl"]
	@property
	def DlvryByVal(self):
