...
class LoanData145(base_types._BaseFieldType):
	...
	__slots__ = ["_ValDt", "_MstrAgrmt", "_EvtDt", "_GnlColl", "_LndgFee", "_UnqTradIdr", "_ExctnDtTm", "_AsstTp", "_Term", "_RbtRate", "_LnVal", "_ClrSts", "_TermntnDt", "_TradgVn", "_DlvryByVal", "_CollDlvryMtd"]
	@property
	def ValDt(self):
		return self._ValDt
