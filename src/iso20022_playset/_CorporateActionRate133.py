...
class CorporateActionRate133(base_types._BaseFieldType):
	...
	__slots__ = ["_NetDstrbtnRate", "_WhldgTaxRate", "_GrssDstrbtnRate", "_TaxblIncmPerDvddShr", "_PrratnRate", "_MaxAllwdOvrsbcptRate", "_GrssIntrstRateUsdForPmt", "_TaxOnIncm", "_AddtlTax", "_ScndLvlTax"]
	@property
