...
class FeeCollectionInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_Cntxt", "_SttlmSvc", "_SctyTrlr", "_Accptr", "_PrcgRslt", "_TxAmts", "_TxId", "_Acqrr", "_OrgnlDataElmts", "_Hdr", "_AddtlData", "_Rcvr", "_Card", "_Sndr", "_SpclPrgrmmQlfctn", "_Dstn", "_ConvsDtTm", "_Issr", "_AddtlAmt", "_TxChrtcs", "_Rcncltn", "_Tkn", "_Jursdctn", "_FeeColltnRef", "_Orgtr", "_Prgrmm", "_AddtlFee", "_PrtctdData"]
	@property
