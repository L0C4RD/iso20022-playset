...
class FeeCollectionInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Issr", "_Orgtr", "_Prgrmm", "_ConvsDtTm", "_TxChrtcs", "_Tkn", "_Acqrr", "_Hdr", "_TxAmts", "_Jursdctn", "_FeeColltnRef", "_AddtlFee", "_Rcvr", "_SttlmSvc", "_PrtctdData", "_Accptr", "_Cntxt", "_SctyTrlr", "_PrcgRslt", "_Sndr", "_Dstn", "_TxId", "_Rcncltn", "_AddtlData", "_OrgnlDataElmts", "_Card", "_SpclPrgrmmQlfctn", "_AddtlAmt", "_SplmtryData"]
	@property
	def Issr(self):
		return self._Issr
