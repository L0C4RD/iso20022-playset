...
from . import CancellationStatus18Choice
from . import PendingProcessingStatus14Choice
from . import PendingStatus46Choice
from . import ProprietaryReason5
from . import ProprietaryStatusAndReason7
from . import RejectionStatus40Choice
from . import RepairStatus15Choice
...
class ProcessingStatus90Choice(base_types._BaseFieldType):
	...
	@Canc.setter
	def Canc(self, value):
		self._Canc = value if value is not None else base_types.UninitialisedField(self, 'Canc', CancellationStatus18Choice, False)

	@Canc.deleter
	def Canc(self):
		del self._Canc
		self._Canc = base_types.UninitialisedField(self, 'Canc', CancellationStatus18Choice, False)
	...
	def ModReqd(self, value):
		self._ModReqd = value if value is not None else base_types.UninitialisedField(self, 'ModReqd', ProprietaryReason5, False)

	@ModReqd.deleter
	def ModReqd(self):
		del self._ModReqd
		self._ModReqd = base_types.UninitialisedField(self, 'ModReqd', ProprietaryReason5, False)
	...
	def PdgPrcg(self, value):
		self._PdgPrcg = value if value is not None else base_types.UninitialisedField(self, 'PdgPrcg', PendingProcessingStatus14Choice, False)

	@PdgPrcg.deleter
	def PdgPrcg(self):
		del self._PdgPrcg
		self._PdgPrcg = base_types.UninitialisedField(self, 'PdgPrcg', PendingProcessingStatus14Choice, False)
	...
	def Rjctd(self, value):
		self._Rjctd = value if value is not None else base_types.UninitialisedField(self, 'Rjctd', RejectionStatus40Choice, False)

	@Rjctd.deleter
	def Rjctd(self):
		del self._Rjctd
		self._Rjctd = base_types.UninitialisedField(self, 'Rjctd', RejectionStatus40Choice, False)
	...
	@Rpr.setter
	def Rpr(self, value):
		self._Rpr = value if value is not None else base_types.UninitialisedField(self, 'Rpr', RepairStatus15Choice, False)

	@Rpr.deleter
	def Rpr(self):
		del self._Rpr
		self._Rpr = base_types.UninitialisedField(self, 'Rpr', RepairStatus15Choice, False)
