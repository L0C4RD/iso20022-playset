...
class TripLeg3(base_types._BaseFieldType):
	...
	__slots__ = ["_OpnTckt", "_NonDrctRouteCd", "_FairBsisCd", "_Amt", "_TcktRstrctns", "_AddtlData", "_IATACd", "_PrcdrId", "_XchgdTckt", "_CnjnctnTcktNb", "_CrrierNm", "_OthrTrnsprtTp", "_XchgdTcktNb", "_Dprture", "_StopOver", "_SvcClss", "_CrrierCd", "_OrgnlRsvatnNb", "_Arrvl", "_TcktNb", "_RsvatnSys", "_Doc", "_RcrdLctrNb", "_CdtRsnCd", "_RouteNb", "_TrnsprtTp", "_TcktIsseLctn", "_RstrctdTckt", "_SeqNb", "_OrgnlRsvatnSys", "_TcktIsseDt", "_RsvatnNb", "_Drtn", "_CmmdtyCd", "_TcktIssr", "_Insrnc", "_LltyPrgrmm"]
	@property
	def OpnTckt(self):
