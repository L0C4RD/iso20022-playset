...
class TripLeg3(base_types._BaseFieldType):
	...
	__slots__ = ["_Insrnc", "_TcktIsseLctn", "_CrrierCd", "_TrnsprtTp", "_RsvatnSys", "_SeqNb", "_FairBsisCd", "_Drtn", "_Amt", "_RsvatnNb", "_CrrierNm", "_RstrctdTckt", "_CmmdtyCd", "_TcktIsseDt", "_OrgnlRsvatnSys", "_Dprture", "_Arrvl", "_AddtlData", "_LltyPrgrmm", "_RouteNb", "_Doc", "_TcktNb", "_OthrTrnsprtTp", "_CdtRsnCd", "_TcktIssr", "_RcrdLctrNb", "_XchgdTcktNb", "_IATACd", "_XchgdTckt", "_NonDrctRouteCd", "_StopOver", "_PrcdrId", "_CnjnctnTcktNb", "_OpnTckt", "_SvcClss", "_OrgnlRsvatnNb", "_TcktRstrctns"]
	@property
	def Insrnc(self):
		return self._Insrnc
