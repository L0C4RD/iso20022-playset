...
class Organisation40(base_types._BaseFieldType):
	...
	__slots__ = ["_RegnDt", "_Id", "_ShrtNm", "_PlcOfListg", "_Nm", "_ModfdPstlAdr", "_RegnCtry", "_TpOfOrg", "_LglNttyIdr", "_Purp"]
	@property
	def RegnDt(self):
		return self._RegnDt
	...
	def TpOfOrg(self, value):
		self._TpOfOrg = value if type(value) != auto else self.make_default("TpOfOrg")
