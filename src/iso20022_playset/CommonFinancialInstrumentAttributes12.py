...
class CommonFinancialInstrumentAttributes12(base_types._BaseFieldType):
	...
	__slots__ = ["_PoolNb", "_Clss", "_FngbInd", "_ISOSctyLngNm", "_WhldgTaxRgm", "_ConvsRatioDnmtr", "_Purp", "_CallTp", "_PmryPlcOfDpst", "_TaxLotNb", "_RedPmtCcy", "_RcrdDt", "_PosLmt", "_ClssfctnTp", "_FinInstrmId", "_Issnc", "_AftrXchgPhysForm", "_LglRstrctns", "_InitlPhysForm", "_ConvtblInd", "_CertNb", "_TradgMkt", "_XpryDt", "_SrNb", "_CpnAttchdNb", "_LeadMgr", "_TEFRARule", "_PmtSts", "_FinInstrmForm", "_RedTp", "_CvrdInd", "_CtctNm", "_SprdAndBchmkCrv", "_SctySts", "_ISOSctyShrtNm", "_NearTermPosLmt", "_Rstrctn", "_Dpstry", "_UndrlygRsk", "_Cnfdtl", "_TradgMtd", "_ConvsPrd", "_PrncplPngAgt", "_PutTp", "_ConvsRatioNmrtr", "_ListgDt", "_CmonSfkpr", "_PrvtPlcmnt", "_CtrctVrsnNb", "_PngAgt", "_NmVldFr", "_DnmtnCcy", "_SttlmInf"]
	@property
	def PoolNb(self):
		return self._PoolNb
