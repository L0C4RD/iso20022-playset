...
class CommonFinancialInstrumentAttributes12(base_types._BaseFieldType):
	...
	__slots__ = ["_Cnfdtl", "_TEFRARule", "_Rstrctn", "_PmryPlcOfDpst", "_LeadMgr", "_UndrlygRsk", "_PutTp", "_ConvsRatioDnmtr", "_RedPmtCcy", "_DnmtnCcy", "_PmtSts", "_WhldgTaxRgm", "_SctySts", "_Issnc", "_LglRstrctns", "_FngbInd", "_CertNb", "_ClssfctnTp", "_ConvsPrd", "_FinInstrmForm", "_RcrdDt", "_ConvtblInd", "_AftrXchgPhysForm", "_Clss", "_NearTermPosLmt", "_TradgMkt", "_InitlPhysForm", "_PoolNb", "_CallTp", "_ListgDt", "_NmVldFr", "_CvrdInd", "_SrNb", "_TaxLotNb", "_RedTp", "_FinInstrmId", "_PrvtPlcmnt", "_PrncplPngAgt", "_PngAgt", "_CmonSfkpr", "_Purp", "_PosLmt", "_CpnAttchdNb", "_ConvsRatioNmrtr", "_XpryDt", "_SprdAndBchmkCrv", "_ISOSctyLngNm", "_SttlmInf", "_TradgMtd", "_ISOSctyShrtNm", "_CtrctVrsnNb", "_CtctNm", "_Dpstry"]
	@property
	def Cnfdtl(self):
		return self._Cnfdtl
