...
from .Issuance5 import Issuance5
...
class CommonFinancialInstrumentAttributes12(base_types._BaseFieldType):

	__slots__ = ["_RedPmtCcy", "_ClssfctnTp", "_Cnfdtl", "_LeadMgr", "_PutTp", "_PmryPlcOfDpst", "_CertNb", "_Rstrctn", "_PngAgt", "_TEFRARule", "_ISOSctyShrtNm", "_SttlmInf", "_FinInstrmId", "_Clss", "_Dpstry", "_InitlPhysForm", "_TaxLotNb", "_ISOSctyLngNm", "_SprdAndBchmkCrv", "_SrNb", "_CmonSfkpr", "_FinInstrmForm", "_DnmtnCcy", "_RcrdDt", "_CpnAttchdNb", "_CvrdInd", "_ConvsPrd", "_NearTermPosLmt", "_Purp", "_AftrXchgPhysForm", "_PmtSts", "_RedTp", "_SctySts", "_NmVldFr", "_ListgDt", "_CtctNm", "_CtrctVrsnNb", "_ConvtblInd", "_CallTp", "_PrvtPlcmnt", "_WhldgTaxRgm", "_ConvsRatioDnmtr", "_FngbInd", "_TradgMtd", "_PrncplPngAgt", "_PoolNb", "_ConvsRatioNmrtr", "_XpryDt", "_TradgMkt", "_PosLmt", "_LglRstrctns", "_UndrlygRsk", "_Issnc"]
	@property
	def RedPmtCcy(self):
	...
	def NmVldFr(self, value):
		self._NmVldFr = value if type(value) != auto else self.make_default("NmVldFr")
