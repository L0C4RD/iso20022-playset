...
class CommonFinancialInstrumentAttributes12(base_types._BaseFieldType):
	...
	__slots__ = ["_Cnfdtl", "_SprdAndBchmkCrv", "_XpryDt", "_PrvtPlcmnt", "_RcrdDt", "_FinInstrmForm", "_CmonSfkpr", "_TaxLotNb", "_NearTermPosLmt", "_RedTp", "_Purp", "_PrncplPngAgt", "_ConvsRatioDnmtr", "_Dpstry", "_TradgMtd", "_PutTp", "_AftrXchgPhysForm", "_WhldgTaxRgm", "_ConvsRatioNmrtr", "_Clss", "_PmtSts", "_PosLmt", "_FngbInd", "_ListgDt", "_ConvtblInd", "_LglRstrctns", "_Issnc", "_UndrlygRsk", "_ISOSctyLngNm", "_CpnAttchdNb", "_TradgMkt", "_ConvsPrd", "_FinInstrmId", "_NmVldFr", "_CvrdInd", "_Rstrctn", "_InitlPhysForm", "_CallTp", "_CtrctVrsnNb", "_ISOSctyShrtNm", "_PmryPlcOfDpst", "_SctySts", "_CtctNm", "_ClssfctnTp", "_CertNb", "_DnmtnCcy", "_LeadMgr", "_PoolNb", "_SttlmInf", "_TEFRARule", "_PngAgt", "_SrNb", "_RedPmtCcy"]
	@property
	def Cnfdtl(self):
		return self._Cnfdtl
