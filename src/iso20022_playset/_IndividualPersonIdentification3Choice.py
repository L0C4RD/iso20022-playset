...
from . import IndividualPerson35
...
class IndividualPersonIdentification3Choice(base_types._BaseFieldType):
	...
	def PrsnNm(self, value):
		self._PrsnNm = value if value is not None else base_types.UninitialisedField(self, 'PrsnNm', IndividualPerson35, False)

	@PrsnNm.deleter
	def PrsnNm(self):
		del self._PrsnNm
		self._PrsnNm = base_types.UninitialisedField(self, 'PrsnNm', IndividualPerson35, False)
