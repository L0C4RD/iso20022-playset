...
from . import IntraBalanceQueryDefinition11
...
class IntraBalanceMovementQueryV02(base_types._BaseFieldType):
	...
	def QryDef(self, value):
		self._QryDef = value if value is not None else base_types.UninitialisedField(self, 'QryDef', IntraBalanceQueryDefinition11, False)

	@QryDef.deleter
	def QryDef(self):
		del self._QryDef
		self._QryDef = base_types.UninitialisedField(self, 'QryDef', IntraBalanceQueryDefinition11, False)
