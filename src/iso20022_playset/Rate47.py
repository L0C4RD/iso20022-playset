...
class Rate47(base_types._BaseFieldType):
	...
	__slots__ = ["_ThrdPtyIncntivRate", "_GrssDstrbtnRate", "_FsclStmp", "_AddtlTax", "_TaxCdtRate", "_ScndLvlTax", "_GrssIntrstRateUsdForPmt", "_ChrgsFees", "_TaxOnIncm", "_EarlySlctnFeeRate", "_SlctnFeeRate", "_WhldgTaxRate", "_NetDstrbtnRate", "_TaxOnPrfts", "_TaxRclmRate", "_EqulstnRate", "_DmdRate", "_AplblRate"]
	@property
