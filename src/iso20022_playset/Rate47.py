...
class Rate47(base_types._BaseFieldType):
	...
	__slots__ = ["_AplblRate", "_GrssIntrstRateUsdForPmt", "_EqulstnRate", "_ScndLvlTax", "_WhldgTaxRate", "_SlctnFeeRate", "_FsclStmp", "_TaxOnIncm", "_ChrgsFees", "_TaxCdtRate", "_TaxRclmRate", "_TaxOnPrfts", "_ThrdPtyIncntivRate", "_EarlySlctnFeeRate", "_NetDstrbtnRate", "_GrssDstrbtnRate", "_DmdRate", "_AddtlTax"]
	@property
	def AplblRate(self):
