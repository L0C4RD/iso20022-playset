...
class RetrievalResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_SctyTrlr", "_Orgtr", "_Acqrr", "_Accptr", "_Jursdctn", "_Rcvr", "_Pyee", "_Prgrmm", "_Dstn", "_SttlmSvc", "_Rcncltn", "_Issr", "_SplmtryData", "_TxId", "_Pyer", "_Cntxt", "_AddtlData", "_Sndr", "_Termnl", "_DsptData", "_OrgnlRspnCd", "_Wllt", "_RtrvlFlfmtInstrs", "_Hdr", "_Card", "_TxChrtcs", "_SpclPrgrmmQlfctn", "_AddtlFee", "_PrcgRslt", "_PrtctdData", "_ConvsDtTm", "_Tkn"]
	@property
	def SctyTrlr(self):
