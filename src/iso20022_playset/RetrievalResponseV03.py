...
class RetrievalResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_PrtctdData", "_Hdr", "_ConvsDtTm", "_Termnl", "_OrgnlRspnCd", "_SpclPrgrmmQlfctn", "_Rcncltn", "_AddtlData", "_Accptr", "_SttlmSvc", "_Card", "_Prgrmm", "_Issr", "_TxId", "_Wllt", "_Acqrr", "_Dstn", "_Rcvr", "_Jursdctn", "_Pyee", "_Sndr", "_Pyer", "_TxChrtcs", "_DsptData", "_AddtlFee", "_SplmtryData", "_Tkn", "_Cntxt", "_RtrvlFlfmtInstrs", "_Orgtr", "_SctyTrlr", "_PrcgRslt"]
	@property
	def PrtctdData(self):
