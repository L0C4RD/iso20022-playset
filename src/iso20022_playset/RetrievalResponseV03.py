...
class RetrievalResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Tkn", "_Dstn", "_PrtctdData", "_TxId", "_Rcvr", "_Jursdctn", "_Wllt", "_Orgtr", "_PrcgRslt", "_SctyTrlr", "_Pyee", "_Termnl", "_Prgrmm", "_SttlmSvc", "_AddtlFee", "_Sndr", "_DsptData", "_AddtlData", "_RtrvlFlfmtInstrs", "_Rcncltn", "_SpclPrgrmmQlfctn", "_Accptr", "_Hdr", "_OrgnlRspnCd", "_Issr", "_Cntxt", "_Pyer", "_TxChrtcs", "_SplmtryData", "_Card", "_Acqrr", "_ConvsDtTm"]
	@property
	def Tkn(self):
		return self._Tkn
