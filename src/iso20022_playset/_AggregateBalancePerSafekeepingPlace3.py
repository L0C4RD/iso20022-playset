...
class AggregateBalancePerSafekeepingPlace3(base_types._BaseFieldType):
	...
	__slots__ = ["_HldgVal", "_AddtlBalBrkdwnDtls", "_AvlblQty", "_SfkpgPlc", "_FXDtls", "_AcrdIntrstAmtSgn", "_AcrdIntrstAmt", "_PrvsHldgVal", "_AggtQty", "_PricDtls", "_BalBrkdwnDtls", "_BookVal", "_DaysAcrd", "_NotAvlblQty"]
	@property
	def HldgVal(self):
