...
from .EligibilityDates1 import EligibilityDates1
...
from .SecurityPosition21 import SecurityPosition21

class MeetingEntitlementNotificationV10(base_types._BaseFieldType):

	__slots__ = ["_SplmtryData", "_Scty", "_MtgAttndee", "_Prxy", "_Issr", "_NtfctnTp", "_Elgblty", "_MtgRef", "_PrvsEntitlmntNtfctnId"]
	@property
