...
class SecuritiesCollateral13(base_types._BaseFieldType):
	...
	__slots__ = ["_Hrcut", "_SctyId", "_AsstNb", "_Qty", "_SfkpgAcct", "_ValDt", "_MktVal", "_BlckdQty", "_LtdCvrgInd", "_CollVal", "_CollOwnrsh", "_BlckChainAdrOrWllt", "_MtrtyDt", "_SfkpgPlc", "_Pric"]
	@property
	def Hrcut(self):
		return self._Hrcut
