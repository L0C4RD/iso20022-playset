...
class SecuritiesCollateral13(base_types._BaseFieldType):
	...
	__slots__ = ["_LtdCvrgInd", "_Hrcut", "_BlckdQty", "_SfkpgAcct", "_CollOwnrsh", "_AsstNb", "_ValDt", "_SctyId", "_MktVal", "_CollVal", "_SfkpgPlc", "_Pric", "_Qty", "_BlckChainAdrOrWllt", "_MtrtyDt"]
	@property
	def LtdCvrgInd(self):
