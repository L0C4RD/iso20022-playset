...
class VehicleRentalService3(base_types._BaseFieldType):
	...
	__slots__ = ["_CpnyCtct", "_RntlAgrmt", "_CpnyTp", "_RntrCorpNm", "_LltyPrgrmm", "_AddtlDrvr", "_RntrNm", "_CpnyId", "_AddtlData", "_CpnyAdr", "_CpnyOthrTp", "_SummryCmmdtyId", "_RntrCorpIdr", "_RntlInvc", "_RntrCorpIdrAssgnr", "_PmryDrvr", "_CpnyNm"]
	@property
	def CpnyCtct(self):
