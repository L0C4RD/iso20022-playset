...
class RegisteredContract19(base_types._BaseFieldType):
	...
	__slots__ = ["_Prty", "_Attchmnt", "_SplmtryData", "_ClsrRsn", "_Cssn", "_RegnAgt", "_OrgnlRegdCtrct", "_RptgPty", "_RegdCtrctClsrId"]
	@property
	def Prty(self):
		return self._Prty
	...
	def OrgnlRegdCtrct(self, value):
		self._OrgnlRegdCtrct = value if type(value) != base_types.auto else self.make_default("OrgnlRegdCtrct")
