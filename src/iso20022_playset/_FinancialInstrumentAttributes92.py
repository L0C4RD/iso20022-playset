...
from . import QuantityBreakdown31
from . import SecuritiesPaymentStatus5Choice
from . import SecurityIdentification19
from . import YesNoIndicator

class FinancialInstrumentAttributes92(base_types._BaseFieldType):
	...
	def CtrctSz(self, value):
		self._CtrctSz = value if value is not None else base_types.UninitialisedField(self, 'CtrctSz', FinancialInstrumentQuantity1Choice, False)

	@CtrctSz.deleter
	def CtrctSz(self):
		del self._CtrctSz
		self._CtrctSz = base_types.UninitialisedField(self, 'CtrctSz', FinancialInstrumentQuantity1Choice, False)
	...
	def QtyBrkdwn(self, value):
		self._QtyBrkdwn = value if value is not None else base_types.UninitialisedField(self, 'QtyBrkdwn', QuantityBreakdown31, True)

	@QtyBrkdwn.deleter
	def QtyBrkdwn(self):
		del self._QtyBrkdwn
		self._QtyBrkdwn = base_types.UninitialisedField(self, 'QtyBrkdwn', QuantityBreakdown31, True)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='CtrctSz', type=FinancialInstrumentQuantity1Choice, min=0, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='QtyBrkdwn', type=QuantityBreakdown31, min=0, max=None, mutex_group=None, array=True),
