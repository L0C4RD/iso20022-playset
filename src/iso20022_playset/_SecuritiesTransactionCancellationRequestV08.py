...
class SecuritiesTransactionCancellationRequestV08(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctOwnrTxId", "_SplmtryData", "_NonceId", "_AcctSvcrTxId", "_AcctOwnr", "_SfkpgAcct", "_CxlRsn", "_TxDtls", "_MktInfrstrctrTxId", "_PrcrTxId", "_FxCxl", "_BlckChainAdrOrWllt"]
	@property
