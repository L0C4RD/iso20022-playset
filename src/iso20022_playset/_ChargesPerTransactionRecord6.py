...
class ChargesPerTransactionRecord6(base_types._BaseFieldType):
	...
	__slots__ = ["_UndrlygTx", "_ChrgsRqstr", "_ValDt", "_Dbtr", "_ChrgsAcctAgt", "_SttlmInstr", "_DbtrAcct", "_DbtrAgtAcct", "_DbtrAgt", "_InstrForInstdAgt", "_AddtlInf", "_RcrdId", "_ChrgsAcctAgtAcct", "_ChrgsBrkdwn", "_TtlChrgsPerRcrd"]
	@property
	def UndrlygTx(self):
