...
class FleetData6(base_types._BaseFieldType):
	...
	__slots__ = ["_TripNb", "_TripInvcNb", "_AddtlNtrdData", "_LineItm", "_Vhcl", "_TripDlvryTcktNb", "_CardFuelPrmptCd", "_Drvr", "_LclAmnty", "_TripJobNb", "_TripCtrlNb", "_AgtFuelPrmptCd", "_TripBllgId", "_DrvrOrVhclCard", "_TripWorkOrdr", "_TxRltdData"]
	@property
	def TripNb(self):
		return self._TripNb
