...
class FleetData6(base_types._BaseFieldType):
	...
	__slots__ = ["_CardFuelPrmptCd", "_Vhcl", "_LclAmnty", "_AddtlNtrdData", "_TripCtrlNb", "_AgtFuelPrmptCd", "_TxRltdData", "_TripWorkOrdr", "_Drvr", "_TripJobNb", "_TripNb", "_LineItm", "_TripBllgId", "_TripInvcNb", "_TripDlvryTcktNb", "_DrvrOrVhclCard"]
	@property
