...
from . import FIToFIPaymentStatusReportV15
...
class PACS_002_001_15():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def FIToFIPmtStsRpt(self, value):
			self._FIToFIPmtStsRpt = value if value is not None else base_types.UninitialisedField(self, 'FIToFIPmtStsRpt', FIToFIPaymentStatusReportV15, False)

		@FIToFIPmtStsRpt.deleter
		def FIToFIPmtStsRpt(self):
			del self._FIToFIPmtStsRpt
			self._FIToFIPmtStsRpt = base_types.UninitialisedField(self, 'FIToFIPmtStsRpt', FIToFIPaymentStatusReportV15, False)
