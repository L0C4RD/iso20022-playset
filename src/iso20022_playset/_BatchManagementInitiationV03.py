...
class BatchManagementInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_PostvAck", "_SctyTrlr", "_PrcgRslt", "_LifeCyclId", "_Hdr", "_TrnsmssnDtTm", "_BtchMgmtTp", "_MsgSeqNb", "_MsgsBfrAck", "_Crrctn", "_Rcncltn", "_ColltnId", "_BtchChcksm", "_OrgnlBtchId", "_Orgtr", "_NbOfBtchsInColltn", "_Prgrmm", "_SysTracAudtNb", "_ChckptId", "_OthrBtchMgmtTp", "_PrtctdData", "_Conttn", "_BtchId", "_SplmtryData", "_BtchIdList", "_RtrvlRefNb", "_ColltnSz", "_OrgnlRspnCd", "_OrgnlColltnId", "_AddtlData", "_Rcvr", "_Sndr", "_Dstn", "_RmngMsgsInColltn", "_NbOfMsgs", "_ColltnChcksm", "_Jursdctn", "_ColltnIdList", "_SttlmSvc", "_ReqAck"]
	@property
	def PostvAck(self):
