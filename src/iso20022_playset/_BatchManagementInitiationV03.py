...
class BatchManagementInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlRspnCd", "_Conttn", "_BtchIdList", "_Sndr", "_NbOfMsgs", "_AddtlData", "_ColltnIdList", "_ColltnSz", "_RtrvlRefNb", "_ColltnId", "_Rcncltn", "_ColltnChcksm", "_ChckptId", "_OthrBtchMgmtTp", "_SysTracAudtNb", "_OrgnlColltnId", "_RmngMsgsInColltn", "_Orgtr", "_BtchMgmtTp", "_Dstn", "_MsgSeqNb", "_PrcgRslt", "_Jursdctn", "_BtchChcksm", "_LifeCyclId", "_Hdr", "_Crrctn", "_NbOfBtchsInColltn", "_PostvAck", "_Prgrmm", "_TrnsmssnDtTm", "_OrgnlBtchId", "_SctyTrlr", "_MsgsBfrAck", "_Rcvr", "_SttlmSvc", "_ReqAck", "_PrtctdData", "_BtchId", "_SplmtryData"]
	@property
	def AddtlData(self):
