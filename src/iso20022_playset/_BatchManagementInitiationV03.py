...
from . import BatchManagementType2Code
...
class BatchManagementInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlData", "_BtchChcksm", "_BtchId", "_BtchIdList", "_BtchMgmtTp", "_ChckptId", "_ColltnChcksm", "_ColltnId", "_ColltnIdList", "_ColltnSz", "_Conttn", "_Crrctn", "_Dstn", "_Hdr", "_Jursdctn", "_LifeCyclId", "_MsgSeqNb", "_MsgsBfrAck", "_NbOfBtchsInColltn", "_NbOfMsgs", "_OrgnlBtchId", "_OrgnlColltnId", "_OrgnlRspnCd", "_Orgtr", "_OthrBtchMgmtTp", "_PostvAck", "_PrcgRslt", "_Prgrmm", "_PrtctdData", "_Rcncltn", "_Rcvr", "_ReqAck", "_RmngMsgsInColltn", "_RtrvlRefNb", "_SctyTrlr", "_Sndr", "_SplmtryData", "_SttlmSvc", "_SysTracAudtNb", "_TrnsmssnDtTm"]
	@property
	def AddtlData(self):
	...
	def BtchMgmtTp(self, value):
		self._BtchMgmtTp = value if value is not None else base_types.UninitialisedField(self, 'BtchMgmtTp', BatchManagementType2Code, False)

	@BtchMgmtTp.deleter
	def BtchMgmtTp(self):
		del self._BtchMgmtTp
		self._BtchMgmtTp = base_types.UninitialisedField(self, 'BtchMgmtTp', BatchManagementType2Code, False)
	...
	def OthrBtchMgmtTp(self, value):
		self._OthrBtchMgmtTp = value if value is not None else base_types.UninitialisedField(self, 'OthrBtchMgmtTp', Max35Text, False)

	@OthrBtchMgmtTp.deleter
	def OthrBtchMgmtTp(self):
		del self._OthrBtchMgmtTp
		self._OthrBtchMgmtTp = base_types.UninitialisedField(self, 'OthrBtchMgmtTp', Max35Text, False)
