...
class SecuritiesSettlementTransactionDetails55(base_types._BaseFieldType):
	...
	__slots__ = ["_QtyAndAcctDtls", "_SplmtryData", "_DlvrgSttlmPties", "_FinInstrmAttrbts", "_Lnkgs", "_OthrBizPties", "_FinInstrmId", "_StgSttlmInstrDtls", "_SttlmTpAndAddtlParams", "_RcvgSttlmPties", "_CshPties", "_OthrAmts", "_AddtlPhysOrRegnDtls", "_TradDtls", "_SttlmParams", "_SttlmAmt"]
	@property
