...
from ._ForeignExchangeTradeBulkStatusNotificationV06 import ForeignExchangeTradeBulkStatusNotificationV06
...
class FXTR_030_001_06():
	...
	class Document(base_types._BaseFieldType):
		...
		attrib = {
			"xmlns" : base_types._BaseDataType_String(None, data="urn:iso:std:iso:20022:tech:xsd:fxtr.030.001.06"),
		}
		...
		def FXTradBlkStsNtfctn(self, value):
			self._FXTradBlkStsNtfctn = value if type(value) != base_types.auto else self.make_default("FXTradBlkStsNtfctn")
