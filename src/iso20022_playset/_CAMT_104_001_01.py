...
class CAMT_104_001_01():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def CretMmb(self, value):
			self._CretMmb = value if value is not None else base_types.UninitialisedField(self, 'CretMmb', CreateMemberV01, False)

		@CretMmb.deleter
		def CretMmb(self):
			del self._CretMmb
			self._CretMmb = base_types.UninitialisedField(self, 'CretMmb', CreateMemberV01, False)
