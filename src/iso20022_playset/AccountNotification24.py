...
class AccountNotification24(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlNtfctnInf", "_CpyDplctInd", "_TxsSummry", "_RptgSrc", "_RptgSeq", "_NtfctnPgntn", "_Acct", "_CreDtTm", "_LglSeqNb", "_Id", "_ElctrncSeqNb", "_Ntry", "_RltdAcct", "_Intrst", "_FrToDt"]
	@property
