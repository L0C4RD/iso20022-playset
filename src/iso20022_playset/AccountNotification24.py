...
class AccountNotification24(base_types._BaseFieldType):
	...
	__slots__ = ["_RltdAcct", "_Intrst", "_Id", "_Ntry", "_NtfctnPgntn", "_ElctrncSeqNb", "_RptgSeq", "_CpyDplctInd", "_Acct", "_LglSeqNb", "_FrToDt", "_AddtlNtfctnInf", "_CreDtTm", "_RptgSrc", "_TxsSummry"]
	@property
	def RltdAcct(self):
