...
from . import AcceptorCurrencyConversionRequest13
from . import ContentInformationType37
from . import Header70

class AcceptorCurrencyConversionRequestV13(base_types._BaseFieldType):
	...
	def CcyConvsReq(self, value):
		self._CcyConvsReq = value if value is not None else base_types.UninitialisedField(self, 'CcyConvsReq', AcceptorCurrencyConversionRequest13, False)

	@CcyConvsReq.deleter
	def CcyConvsReq(self):
		del self._CcyConvsReq
		self._CcyConvsReq = base_types.UninitialisedField(self, 'CcyConvsReq', AcceptorCurrencyConversionRequest13, False)
	...
	_field_defs = frozenset((
		base_types.FieldEntry(name='CcyConvsReq', type=AcceptorCurrencyConversionRequest13, min=1, max=1, mutex_group=None, array=False),
