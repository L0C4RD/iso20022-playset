...
class LoanData135(base_types._BaseFieldType):
	...
	__slots__ = ["_EvtDt", "_TradgVn", "_ExctnDtTm", "_ValDt", "_IntrstRate", "_MinNtcePrd", "_ClrSts", "_TermntnDt", "_PrncplAmt", "_DlvryByVal", "_Term", "_MstrAgrmt", "_CollDlvryMtd", "_EarlstCallBckDt", "_GnlColl", "_UnqTradIdr"]
	@property
	def EvtDt(self):
		return self._EvtDt
