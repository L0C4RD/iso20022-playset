...
from . import RejectedStatus56Choice
...
class RejectedStatus11(base_types._BaseFieldType):
	...
	def RjctdRsn(self, value):
		self._RjctdRsn = value if value is not None else base_types.UninitialisedField(self, 'RjctdRsn', RejectedStatus56Choice, False)

	@RjctdRsn.deleter
	def RjctdRsn(self):
		del self._RjctdRsn
		self._RjctdRsn = base_types.UninitialisedField(self, 'RjctdRsn', RejectedStatus56Choice, False)
