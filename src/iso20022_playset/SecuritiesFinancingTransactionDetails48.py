...
class SecuritiesFinancingTransactionDetails48(base_types._BaseFieldType):
	...
	__slots__ = ["_AcrdIntrstAmt", "_MtrtyDtMod", "_RateChngDt", "_TermntnAmtPerPcOfColl", "_PricgRate", "_IntrstCmptnMtd", "_TtlNbOfCollInstrs", "_Sprd", "_PrmAmt", "_LclBrkrComssn", "_SctiesHrcut", "_TxCallDely", "_TermntnDt", "_LglFrmwk", "_RateTp", "_Rvaltn", "_ClsgLegId", "_IntrstPmt", "_EarlstCallBckDt", "_StockLnMrgn", "_DealAmt", "_RpRate", "_FrftAmt", "_ComssnClctnDt", "_ScndLegNrrtv", "_ChrgsRate", "_VarblRateSpprt", "_SctiesFincgTradId", "_TermntnTxAmt"]
	@property
