...
class SecuritiesFinancingTransactionDetails48(base_types._BaseFieldType):
	...
	__slots__ = ["_EarlstCallBckDt", "_Sprd", "_FrftAmt", "_LclBrkrComssn", "_StockLnMrgn", "_PrmAmt", "_TermntnAmtPerPcOfColl", "_RateTp", "_TtlNbOfCollInstrs", "_IntrstCmptnMtd", "_SctiesHrcut", "_IntrstPmt", "_TermntnDt", "_PricgRate", "_AcrdIntrstAmt", "_RpRate", "_Rvaltn", "_ComssnClctnDt", "_ChrgsRate", "_SctiesFincgTradId", "_DealAmt", "_LglFrmwk", "_TxCallDely", "_ScndLegNrrtv", "_VarblRateSpprt", "_ClsgLegId", "_TermntnTxAmt", "_RateChngDt", "_MtrtyDtMod"]
	@property
