...
class ReversalInitiationV04(base_types._BaseFieldType):
	...
	__slots__ = ["_ICCRltdData", "_PrcgRslt", "_SctyTrlr", "_Pyee", "_Hdr", "_ConvsDtTm", "_Issr", "_AddtlAmt", "_SttlmSvc", "_Rcncltn", "_Tkn", "_Termnl", "_Orgtr", "_Wllt", "_PrtctdData", "_AcctFr", "_DpstDtls", "_SplmtryData", "_AcctTo", "_Pyer", "_Card", "_Prgrmm", "_TxAmts", "_AcctBal", "_TxId", "_Acqrr", "_OrgnlDataElmts", "_AddtlData", "_Rcvr", "_Cntxt", "_Sndr", "_SpclPrgrmmQlfctn", "_FndsSvcs", "_Dstn", "_Accptr", "_TxChrtcs", "_AddtlSvc", "_Jursdctn", "_AddtlFee"]
	@property
