...
class ReversalInitiationV04(base_types._BaseFieldType):
	...
	__slots__ = ["_Orgtr", "_AcctTo", "_ConvsDtTm", "_PrcgRslt", "_Tkn", "_Termnl", "_Prgrmm", "_AddtlSvc", "_Jursdctn", "_Rcvr", "_PrtctdData", "_AcctFr", "_Card", "_SttlmSvc", "_ICCRltdData", "_SctyTrlr", "_TxId", "_Accptr", "_SpclPrgrmmQlfctn", "_SplmtryData", "_Issr", "_Acqrr", "_Pyer", "_Hdr", "_AcctBal", "_TxChrtcs", "_FndsSvcs", "_Wllt", "_TxAmts", "_AddtlFee", "_Pyee", "_Sndr", "_Cntxt", "_Rcncltn", "_AddtlData", "_DpstDtls", "_OrgnlDataElmts", "_AddtlAmt", "_Dstn"]
	@property
	def Orgtr(self):
		return self._Orgtr
