...
class CorporateActionSupplementaryIndicators1(base_types._BaseFieldType):
	...
	__slots__ = ["_RghtsRndUpPrvlgInd", "_EscrwToMtrtyInd", "_SrrndrShrsToAgtInd", "_CondlPmtAplblInd", "_StepUpPrvlgInd", "_SlctnDealrFeeInd", "_RghtsTrfblInd", "_RghtsOvrsbcptInd"]
	@property
