...
from ._PortfolioTransferNotificationV09 import PortfolioTransferNotificationV09
...
class SESE_037_001_09():
	...
	class Document(base_types._BaseFieldType):
		...
		attrib = {
			"xmlns" : base_types._BaseDataType_String(None, data="urn:iso:std:iso:20022:tech:xsd:sese.037.001.09"),
		}
