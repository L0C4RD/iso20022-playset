...
class CorporateActionRate124(base_types._BaseFieldType):
	...
	__slots__ = ["_TaxblIncmPerDvddShr", "_GrssDstrbtnRate", "_PrratnRate", "_ScndLvlTax", "_TaxOnIncm", "_BidIntrvl", "_IssrDclrdXchgRate", "_AddtlTax", "_NetDstrbtnRate", "_MaxAllwdOvrsbcptRate", "_GrssIntrstRateUsdForPmt", "_WhldgTaxRate"]
	@property
