...
class CorporateActionRate124(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlTax", "_TaxOnIncm", "_BidIntrvl", "_MaxAllwdOvrsbcptRate", "_IssrDclrdXchgRate", "_GrssDstrbtnRate", "_ScndLvlTax", "_GrssIntrstRateUsdForPmt", "_PrratnRate", "_WhldgTaxRate", "_NetDstrbtnRate", "_TaxblIncmPerDvddShr"]
	@property
	def AddtlTax(self):
