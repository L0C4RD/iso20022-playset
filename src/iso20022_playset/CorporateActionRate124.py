...
class CorporateActionRate124(base_types._BaseFieldType):
	...
	__slots__ = ["_NetDstrbtnRate", "_IssrDclrdXchgRate", "_TaxblIncmPerDvddShr", "_WhldgTaxRate", "_TaxOnIncm", "_GrssIntrstRateUsdForPmt", "_GrssDstrbtnRate", "_MaxAllwdOvrsbcptRate", "_AddtlTax", "_ScndLvlTax", "_BidIntrvl", "_PrratnRate"]
	@property
