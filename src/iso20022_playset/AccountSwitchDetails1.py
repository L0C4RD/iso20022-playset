...
import ISODate
import ResponseDetails1
import SwitchType1Code
import SwitchStatus1Code
import ISODateTime
import BalanceTransferWindow1Code
import Max35Text

class AccountSwitchDetails1(base_types._BaseFieldType):

	__slots__ = ["_SwtchTp", "_UnqRefNb", "_SwtchRcvdDtTm", "_SwtchSts", "_RtgUnqRefNb", "_SwtchDt", "_Rspn", "_BalTrfWndw"]
	@property
	def SwtchTp(self):
