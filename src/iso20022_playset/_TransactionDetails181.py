...
class TransactionDetails181(base_types._BaseFieldType):
	...
	def AcctOwnrTxId(self, value):
		self._AcctOwnrTxId = value if value is not None else base_types.UninitialisedField(self, 'AcctOwnrTxId', SettlementTypeAndIdentification18, False)

	@AcctOwnrTxId.deleter
	def AcctOwnrTxId(self):
		del self._AcctOwnrTxId
		self._AcctOwnrTxId = base_types.UninitialisedField(self, 'AcctOwnrTxId', SettlementTypeAndIdentification18, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='AcctOwnrTxId', type=SettlementTypeAndIdentification18, min=1, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='OthrTxId', type=Max35Text, min=0, max=1, mutex_group=None, array=False),
