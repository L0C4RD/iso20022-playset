...
from . import BalanceQuantity15Choice
from . import ShortLong1Code

class Balance22(base_types._BaseFieldType):
	...
	@Qty.setter
	def Qty(self, value):
		self._Qty = value if value is not None else base_types.UninitialisedField(self, 'Qty', BalanceQuantity15Choice, False)

	@Qty.deleter
	def Qty(self):
		del self._Qty
		self._Qty = base_types.UninitialisedField(self, 'Qty', BalanceQuantity15Choice, False)
