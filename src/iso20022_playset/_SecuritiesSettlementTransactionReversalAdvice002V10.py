...
class SecuritiesSettlementTransactionReversalAdvice002V10(base_types._BaseFieldType):
	...
	__slots__ = ["_DlvrgSttlmPties", "_TxIdDtls", "_OthrBizPties", "_SttlmParams", "_QtyAndAcctDtls", "_CshPties", "_AddtlParams", "_SttldAmt", "_AddtlPhysOrRegnDtls", "_ConfRef", "_FinInstrmAttrbts", "_TradDtls", "_StgSttlmInstrDtls", "_FinInstrmId", "_OthrAmts", "_RcvgSttlmPties", "_SplmtryData"]
	@property
