...
class SecuritiesSettlementTransactionReversalAdvice002V10(base_types._BaseFieldType):
	...
	__slots__ = ["_SttldAmt", "_SplmtryData", "_DlvrgSttlmPties", "_QtyAndAcctDtls", "_TxIdDtls", "_ConfRef", "_OthrAmts", "_AddtlParams", "_FinInstrmAttrbts", "_TradDtls", "_SttlmParams", "_OthrBizPties", "_StgSttlmInstrDtls", "_AddtlPhysOrRegnDtls", "_RcvgSttlmPties", "_CshPties", "_FinInstrmId"]
	@property
	def SttldAmt(self):
