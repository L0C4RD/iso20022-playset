...
class Context21(base_types._BaseFieldType):
	...
	__slots__ = ["_PmtCrdntlMrchntRltsh", "_DelydAuthstn", "_LatePresntmnt", "_DtAntcptd", "_MrchntCtgyCd", "_MOTOCd", "_AddtlData", "_NoShow", "_EComrcIndApld", "_ReSubmissn", "_OthrQRCdPresntmntMd", "_DfrrdDlvry", "_SctyChrtcs", "_OthrSctyChrtcs", "_CardPres", "_CaptrDt", "_PrtlShipmnt", "_QRCdPresntmntMd", "_Attndd", "_CrdhldrPres", "_OthrCardDataNtryMd", "_PrtlApprvlSpprtd", "_MrchntCtgySpcfcData", "_UattnddLvlCtgy", "_TrnspndrInittd", "_Trnst", "_EComrc", "_EComrcData", "_CrdhldrActvtd", "_TxInitr", "_DelydChrgs", "_SpltPmt", "_StorgLctn", "_AuthntcnOutg", "_Reauthstn", "_OthrMrchntCtgy", "_CardDataNtryMd"]
	@property
