...
class Context21(base_types._BaseFieldType):
	...
	__slots__ = ["_CardPres", "_CrdhldrActvtd", "_Attndd", "_DelydChrgs", "_DtAntcptd", "_PmtCrdntlMrchntRltsh", "_EComrc", "_TrnspndrInittd", "_StorgLctn", "_OthrMrchntCtgy", "_SpltPmt", "_PrtlShipmnt", "_EComrcData", "_Reauthstn", "_Trnst", "_QRCdPresntmntMd", "_PrtlApprvlSpprtd", "_OthrQRCdPresntmntMd", "_UattnddLvlCtgy", "_CaptrDt", "_OthrSctyChrtcs", "_MOTOCd", "_LatePresntmnt", "_AuthntcnOutg", "_DfrrdDlvry", "_OthrCardDataNtryMd", "_MrchntCtgyCd", "_CardDataNtryMd", "_NoShow", "_DelydAuthstn", "_ReSubmissn", "_EComrcIndApld", "_SctyChrtcs", "_MrchntCtgySpcfcData", "_CrdhldrPres", "_TxInitr", "_AddtlData"]
	@property
	def CardPres(self):
