...
class Context21(base_types._BaseFieldType):
	...
	__slots__ = ["_CaptrDt", "_MrchntCtgyCd", "_OthrSctyChrtcs", "_Attndd", "_EComrc", "_CardPres", "_PrtlShipmnt", "_EComrcIndApld", "_EComrcData", "_NoShow", "_PrtlApprvlSpprtd", "_CardDataNtryMd", "_MOTOCd", "_StorgLctn", "_AuthntcnOutg", "_Trnst", "_DelydAuthstn", "_DelydChrgs", "_TxInitr", "_Reauthstn", "_UattnddLvlCtgy", "_MrchntCtgySpcfcData", "_AddtlData", "_ReSubmissn", "_QRCdPresntmntMd", "_CrdhldrPres", "_TrnspndrInittd", "_CrdhldrActvtd", "_OthrMrchntCtgy", "_OthrCardDataNtryMd", "_LatePresntmnt", "_DtAntcptd", "_SctyChrtcs", "_PmtCrdntlMrchntRltsh", "_OthrQRCdPresntmntMd", "_SpltPmt", "_DfrrdDlvry"]
	@property
	def CaptrDt(self):
