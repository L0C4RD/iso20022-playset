...
class Context21(base_types._BaseFieldType):
	...
	__slots__ = ["_Attndd", "_CrdhldrPres", "_MrchntCtgySpcfcData", "_Reauthstn", "_MrchntCtgyCd", "_DfrrdDlvry", "_MOTOCd", "_CrdhldrActvtd", "_DelydChrgs", "_PmtCrdntlMrchntRltsh", "_Trnst", "_AuthntcnOutg", "_OthrQRCdPresntmntMd", "_DtAntcptd", "_QRCdPresntmntMd", "_OthrCardDataNtryMd", "_PrtlShipmnt", "_StorgLctn", "_UattnddLvlCtgy", "_OthrSctyChrtcs", "_TrnspndrInittd", "_OthrMrchntCtgy", "_SpltPmt", "_EComrcData", "_EComrcIndApld", "_CaptrDt", "_PrtlApprvlSpprtd", "_TxInitr", "_LatePresntmnt", "_CardDataNtryMd", "_CardPres", "_ReSubmissn", "_DelydAuthstn", "_SctyChrtcs", "_AddtlData", "_NoShow", "_EComrc"]
	@property
	def Attndd(self):
		return self._Attndd
