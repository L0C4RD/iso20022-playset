...
class Context21(base_types._BaseFieldType):
	...
	__slots__ = ["_DelydChrgs", "_StorgLctn", "_QRCdPresntmntMd", "_DelydAuthstn", "_DtAntcptd", "_EComrcIndApld", "_CardPres", "_Reauthstn", "_NoShow", "_LatePresntmnt", "_AuthntcnOutg", "_EComrcData", "_OthrCardDataNtryMd", "_DfrrdDlvry", "_OthrMrchntCtgy", "_PrtlShipmnt", "_SpltPmt", "_AddtlData", "_PrtlApprvlSpprtd", "_CaptrDt", "_TrnspndrInittd", "_Trnst", "_CrdhldrPres", "_Attndd", "_EComrc", "_CrdhldrActvtd", "_MOTOCd", "_CardDataNtryMd", "_MrchntCtgySpcfcData", "_SctyChrtcs", "_OthrSctyChrtcs", "_OthrQRCdPresntmntMd", "_UattnddLvlCtgy", "_TxInitr", "_MrchntCtgyCd", "_ReSubmissn", "_PmtCrdntlMrchntRltsh"]
	@property
	def DelydChrgs(self):
