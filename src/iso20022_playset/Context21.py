...
class Context21(base_types._BaseFieldType):
	...
	__slots__ = ["_EComrc", "_SctyChrtcs", "_AuthntcnOutg", "_AddtlData", "_DfrrdDlvry", "_PmtCrdntlMrchntRltsh", "_CrdhldrPres", "_QRCdPresntmntMd", "_EComrcData", "_OthrMrchntCtgy", "_NoShow", "_CardDataNtryMd", "_MOTOCd", "_EComrcIndApld", "_ReSubmissn", "_TxInitr", "_TrnspndrInittd", "_SpltPmt", "_OthrQRCdPresntmntMd", "_DelydAuthstn", "_StorgLctn", "_PrtlShipmnt", "_Trnst", "_OthrCardDataNtryMd", "_CaptrDt", "_UattnddLvlCtgy", "_Attndd", "_CrdhldrActvtd", "_DtAntcptd", "_MrchntCtgySpcfcData", "_OthrSctyChrtcs", "_PrtlApprvlSpprtd", "_Reauthstn", "_LatePresntmnt", "_DelydChrgs", "_CardPres", "_MrchntCtgyCd"]
	@property
	def EComrc(self):
		return self._EComrc
