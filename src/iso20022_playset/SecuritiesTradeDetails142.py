...
class SecuritiesTradeDetails142(base_types._BaseFieldType):
	...
	__slots__ = ["_PlcOfTrad", "_TradId", "_UnqTxIdr", "_DealPric", "_AffirmSts", "_CollTxId", "_Rptg", "_SttlmDt", "_InvstrCpcty", "_NbOfDaysAcrd", "_LateDlvryDt", "_TradTxCond", "_FxAddtlDtls", "_OpngClsg", "_PlcOfClr", "_TradOrgtrRole", "_MtchgSts", "_TradDt", "_CcyToBuyOrSell", "_TpOfPric", "_SttlmInstrPrcgAddtlDtls"]
	@property
	def PlcOfTrad(self):
