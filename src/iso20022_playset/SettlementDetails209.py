...
class SettlementDetails209(base_types._BaseFieldType):
	...
	__slots__ = ["_SctiesSubBalTp", "_AutomtcBrrwg", "_CshClrSys", "_SctiesRTGS", "_SttlmTxCond", "_SctiesTxTp", "_XpsrTp", "_SttlmSysMtd", "_BlckTrad", "_NetgElgblty", "_Prty", "_Regn", "_CCPElgblty", "_RpTp", "_LttrOfGrnt", "_StmpDtyTaxBsis", "_MktClntSd", "_LglRstrctns", "_CshSubBalTp", "_PrtlSttlmInd", "_ElgblForColl", "_BnfclOwnrsh", "_SttlgCpcty", "_TaxCpcty"]
	@property
