...
class SettlementDetails209(base_types._BaseFieldType):
	...
	__slots__ = ["_XpsrTp", "_TaxCpcty", "_StmpDtyTaxBsis", "_SttlmSysMtd", "_ElgblForColl", "_CshSubBalTp", "_BlckTrad", "_MktClntSd", "_RpTp", "_BnfclOwnrsh", "_LttrOfGrnt", "_SctiesRTGS", "_SttlmTxCond", "_Regn", "_NetgElgblty", "_PrtlSttlmInd", "_CshClrSys", "_LglRstrctns", "_Prty", "_CCPElgblty", "_SctiesSubBalTp", "_SttlgCpcty", "_AutomtcBrrwg", "_SctiesTxTp"]
	@property
	def XpsrTp(self):
		return self._XpsrTp
