...
from .SecuritiesTransactionType55Choice import SecuritiesTransactionType55Choice
...
class SettlementDetails209(base_types._BaseFieldType):
	...
	__slots__ = ["_ElgblForColl", "_AutomtcBrrwg", "_SttlgCpcty", "_RpTp", "_CshSubBalTp", "_LglRstrctns", "_SttlmTxCond", "_XpsrTp", "_NetgElgblty", "_Regn", "_SttlmSysMtd", "_CCPElgblty", "_LttrOfGrnt", "_BlckTrad", "_SctiesTxTp", "_SctiesRTGS", "_TaxCpcty", "_BnfclOwnrsh", "_MktClntSd", "_StmpDtyTaxBsis", "_SctiesSubBalTp", "_Prty", "_PrtlSttlmInd", "_CshClrSys"]
	@property
