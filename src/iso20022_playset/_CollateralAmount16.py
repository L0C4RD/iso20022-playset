...
class CollateralAmount16(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlPdgCollIn", "_TtlValOfOwnColl", "_TtlCollReqrd", "_TtlAcrdIntrst", "_TtlOfPrncpls", "_Mrgn", "_TtlPdgCollOut", "_TtlValOfReusdColl", "_ValOfCollHeld", "_TtlXpsr", "_TtlCshFaild"]
	@property
