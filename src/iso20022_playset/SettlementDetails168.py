...
import SettlementTransactionCondition17Choice
...
class SettlementDetails168(base_types._BaseFieldType):
	...
	__slots__ = ["_PrtlSttlmInd", "_BnfclOwnrsh", "_MktClntSd", "_StmpDtyTaxBsis", "_HldInd", "_Regn", "_SttlmTxCond", "_SctiesTxTp", "_RpTp", "_CshClrSys", "_SctiesRTGS"]
	@property
