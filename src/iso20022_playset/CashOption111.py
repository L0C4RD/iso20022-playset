...
class CashOption111(base_types._BaseFieldType):
	...
	__slots__ = ["_XmptnTp", "_IssrOfferrTaxbltyInd", "_IncmTp", "_PricDtls", "_CtrctlPmtInd", "_OthrIncmTp", "_CshAcctId", "_CtryOfIncmSrc", "_AmtDtls", "_DtDtls", "_NonElgblPrcdsInd", "_RateAndAmtDtls", "_CdtDbtInd", "_FXDtls"]
	@property
	def XmptnTp(self):
