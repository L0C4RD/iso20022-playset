...
from .NonEligibleProceedsIndicator4Choice import NonEligibleProceedsIndicator4Choice
from .CashAccountIdentification13Choice import CashAccountIdentification13Choice
from .CorporateActionAmounts75 import CorporateActionAmounts75
from .CorporateActionDate94 import CorporateActionDate94
from .Payment1Code import Payment1Code
from .Rate46 import Rate46
from .CreditDebitCode import CreditDebitCode
from .PriceDetails42 import PriceDetails42
from .ForeignExchangeTerms42 import ForeignExchangeTerms42

class CashOption111(base_types._BaseFieldType):

	__slots__ = ["_NonElgblPrcdsInd", "_AmtDtls", "_DtDtls", "_FXDtls", "_CdtDbtInd", "_XmptnTp", "_CtryOfIncmSrc", "_CtrctlPmtInd", "_IssrOfferrTaxbltyInd", "_IncmTp", "_CshAcctId", "_RateAndAmtDtls", "_PricDtls", "_OthrIncmTp"]
	@property
