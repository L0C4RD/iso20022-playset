...
class Security55(base_types._BaseFieldType):

	__slots__ = ["_Id", "_AvlblForCollReuse", "_MktVal", "_ClssfctnTp", "_ExclsvArrgmnt", "_Issr", "_QtyOrNmnlVal", "_Qlty", "_Mtrty", "_HrcutOrMrgn", "_UnitPric", "_Tp"]
	@property
	def Id(self):
		return self._Id
