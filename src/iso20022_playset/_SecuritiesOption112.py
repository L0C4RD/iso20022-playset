...
class SecuritiesOption112(base_types._BaseFieldType):
	...
	__slots__ = ["_CtryOfIncmSrc", "_NewSctiesIssncInd", "_PricDtls", "_SfkpgPlc", "_IncmTp", "_XmptnTp", "_RcvgSttlmPties", "_TempFinInstrmInd", "_IssrOfferrTaxbltyInd", "_RateDtls", "_FinInstrmId", "_AmtDtls", "_OthrIncmTp", "_DtDtls", "_DlvrgSttlmPties", "_CdtDbtInd", "_PstngQty", "_CcyOptn", "_FrctnDspstn"]
	@property
