...
class SecuritiesOption112(base_types._BaseFieldType):
	...
	__slots__ = ["_CcyOptn", "_DtDtls", "_OthrIncmTp", "_IncmTp", "_XmptnTp", "_PricDtls", "_CdtDbtInd", "_PstngQty", "_DlvrgSttlmPties", "_FrctnDspstn", "_SfkpgPlc", "_RcvgSttlmPties", "_TempFinInstrmInd", "_CtryOfIncmSrc", "_NewSctiesIssncInd", "_AmtDtls", "_IssrOfferrTaxbltyInd", "_FinInstrmId", "_RateDtls"]
	@property
	def CcyOptn(self):
