...
class Token3(base_types._BaseFieldType):
	...
	__slots__ = ["_TknRefId", "_TknInittdInd", "_TknXpryDt", "_PrtcnMtd", "_OrgnlTkn", "_StorgLctn", "_TknAssrncMtd", "_PmtTkn", "_TknRqstrId", "_OthrStorgLctn", "_AddtlData", "_TknAssrncData", "_OthrPrtcnMtd"]
	@property
	def TknRefId(self):
