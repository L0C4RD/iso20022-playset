...
class SettlementDetails198(base_types._BaseFieldType):
	...
	__slots__ = ["_CshClrSys", "_SctiesRTGS", "_NetgElgblty", "_BlckTrad", "_SttlmSysMtd", "_Regn", "_CCPElgblty", "_RpTp", "_LttrOfGrnt", "_MktClntSd", "_StmpDtyTaxBsis", "_SttlgCpcty", "_LglRstrctns", "_PrtlSttlmInd", "_BnfclOwnrsh", "_SttlmTxCond", "_TaxCpcty"]
	@property
	def CshClrSys(self):
