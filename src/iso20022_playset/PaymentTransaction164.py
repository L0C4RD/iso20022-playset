...
class PaymentTransaction164(base_types._BaseFieldType):
	...
	__slots__ = ["_FctvIntrBkSttlmDt", "_ClrSysRef", "_ChrgsInf", "_OrgnlUETR", "_StsId", "_AccptncDtTm", "_CdtSttlmKey", "_OrgnlTxRef", "_TxSts", "_PrcgDt", "_OrgnlTxId", "_StsRsnInf", "_InstdAgt", "_AcctSvcrRef", "_OrgnlInstrId", "_SplmtryData", "_OrgnlGrpInf", "_OrgnlEndToEndId", "_InstgAgt"]
	@property
