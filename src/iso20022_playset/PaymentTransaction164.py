...
class PaymentTransaction164(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlTxRef", "_FctvIntrBkSttlmDt", "_PrcgDt", "_CdtSttlmKey", "_ChrgsInf", "_ClrSysRef", "_StsId", "_InstdAgt", "_TxSts", "_SplmtryData", "_StsRsnInf", "_OrgnlUETR", "_InstgAgt", "_OrgnlEndToEndId", "_OrgnlTxId", "_OrgnlGrpInf", "_AcctSvcrRef", "_AccptncDtTm", "_OrgnlInstrId"]
	@property
	def OrgnlTxRef(self):
