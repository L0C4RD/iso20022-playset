...
class PaymentTransaction164(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlInstrId", "_TxSts", "_OrgnlEndToEndId", "_OrgnlGrpInf", "_InstgAgt", "_PrcgDt", "_AccptncDtTm", "_CdtSttlmKey", "_ChrgsInf", "_OrgnlTxRef", "_FctvIntrBkSttlmDt", "_StsId", "_OrgnlTxId", "_AcctSvcrRef", "_InstdAgt", "_OrgnlUETR", "_SplmtryData", "_ClrSysRef", "_StsRsnInf"]
	@property
