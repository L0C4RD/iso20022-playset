...
class AggregateBalanceInformation43(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlBalBrkdwn", "_SplmtryData", "_AggtBal", "_AcctBaseCcyAmts", "_BalAtSfkpgPlc", "_AddtlDerivAttrbts", "_AltrnRptgCcyAmts", "_FinInstrmAttrbts", "_QtyBrkdwn", "_FXDtls", "_DaysAcrd", "_CorpActnOptnTp", "_SfkpgPlc", "_BalBrkdwn", "_HldgAddtlDtls", "_InvstmtFndsFinInstrmAttrbts", "_PricDtls", "_InstrmCcyAmts", "_FinInstrmId"]
	@property
