...
from ._AggregateBalancePerSafekeepingPlace40 import AggregateBalancePerSafekeepingPlace40
...
from ._DerivativeBasicAttributes2 import DerivativeBasicAttributes2
...
class AggregateBalanceInformation43(base_types._BaseFieldType):
	...
	__slots__ = ["_PricDtls", "_SfkpgPlc", "_AcctBaseCcyAmts", "_AltrnRptgCcyAmts", "_BalAtSfkpgPlc", "_BalBrkdwn", "_InstrmCcyAmts", "_AggtBal", "_CorpActnOptnTp", "_HldgAddtlDtls", "_QtyBrkdwn", "_FinInstrmAttrbts", "_InvstmtFndsFinInstrmAttrbts", "_FinInstrmId", "_AddtlBalBrkdwn", "_DaysAcrd", "_AddtlDerivAttrbts", "_FXDtls", "_SplmtryData"]
	@property
	def PricDtls(self):
