...
class CorporateActionMovementReversalAdvice002V16(base_types._BaseFieldType):
	...
	__slots__ = ["_RvslRsn", "_TxId", "_SplmtryData", "_AcctDtls", "_SubPngAgt", "_OthrDocId", "_CorpActnConfDtls", "_MvmntConfId", "_AddtlInf", "_IssrAgt", "_CorpActnGnlInf", "_EvtsLkg", "_PngAgt", "_CorpActnDtls"]
	@property
	def RvslRsn(self):
