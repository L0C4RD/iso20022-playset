...
class CorporateActionMovementReversalAdvice002V16(base_types._BaseFieldType):
	...
	__slots__ = ["_EvtsLkg", "_SubPngAgt", "_SplmtryData", "_PngAgt", "_AcctDtls", "_CorpActnDtls", "_MvmntConfId", "_TxId", "_CorpActnGnlInf", "_CorpActnConfDtls", "_RvslRsn", "_AddtlInf", "_OthrDocId", "_IssrAgt"]
	@property
	def EvtsLkg(self):
