...
class CorporateActionMovementReversalAdvice002V16(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlInf", "_AcctDtls", "_MvmntConfId", "_CorpActnConfDtls", "_RvslRsn", "_SubPngAgt", "_IssrAgt", "_CorpActnDtls", "_TxId", "_OthrDocId", "_SplmtryData", "_CorpActnGnlInf", "_PngAgt", "_EvtsLkg"]
	@property
	def AddtlInf(self):
