...
class CorporateActionMovementReversalAdvice002V16(base_types._BaseFieldType):
	...
	__slots__ = ["_EvtsLkg", "_TxId", "_OthrDocId", "_SplmtryData", "_SubPngAgt", "_CorpActnGnlInf", "_MvmntConfId", "_AddtlInf", "_CorpActnDtls", "_AcctDtls", "_IssrAgt", "_PngAgt", "_CorpActnConfDtls", "_RvslRsn"]
	@property
	def EvtsLkg(self):
