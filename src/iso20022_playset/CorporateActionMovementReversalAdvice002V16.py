...
from .CorporateAction78 import CorporateAction78
from .CorporateActionOption246 import CorporateActionOption246
...
from .AccountAndBalance54 import AccountAndBalance54
from .SupplementaryData1 import SupplementaryData1
from .CorporateActionReversalReason10 import CorporateActionReversalReason10
from .TransactionIdentification1 import TransactionIdentification1
from .CorporateActionGeneralInformation193 import CorporateActionGeneralInformation193

class CorporateActionMovementReversalAdvice002V16(base_types._BaseFieldType):

	__slots__ = ["_SubPngAgt", "_AddtlInf", "_AcctDtls", "_CorpActnGnlInf", "_EvtsLkg", "_TxId", "_CorpActnConfDtls", "_PngAgt", "_IssrAgt", "_SplmtryData", "_CorpActnDtls", "_RvslRsn", "_MvmntConfId", "_OthrDocId"]
	@property
	def SubPngAgt(self):
