...
class AccountSubLevel14(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctId", "_AcctOwnr", "_AcctSubLvl5", "_AcctSubLvl5Diff", "_AcctSvcr", "_BalDtls", "_BnfclOwnr", "_SplmtryData"]
	@property
	def AcctId(self):
		return self._AcctId
	...
	def AcctSubLvl5(self, value):
		self._AcctSubLvl5 = value if value is not None else base_types.UninitialisedField(self, 'AcctSubLvl5', AccountSubLevel15, True)

	@AcctSubLvl5.deleter
	def AcctSubLvl5(self):
		del self._AcctSubLvl5
		self._AcctSubLvl5 = base_types.UninitialisedField(self, 'AcctSubLvl5', AccountSubLevel15, True)
	...
	def AcctSubLvl5Diff(self, value):
		self._AcctSubLvl5Diff = value if value is not None else base_types.UninitialisedField(self, 'AcctSubLvl5Diff', AggregateHoldingBalance2, True)

	@AcctSubLvl5Diff.deleter
	def AcctSubLvl5Diff(self):
		del self._AcctSubLvl5Diff
		self._AcctSubLvl5Diff = base_types.UninitialisedField(self, 'AcctSubLvl5Diff', AggregateHoldingBalance2, True)
