...
from . import OriginalNotification17
...
class NotificationToReceiveStatusReportV09(base_types._BaseFieldType):
	...
	def OrgnlNtfctnAndSts(self, value):
		self._OrgnlNtfctnAndSts = value if value is not None else base_types.UninitialisedField(self, 'OrgnlNtfctnAndSts', OriginalNotification17, False)

	@OrgnlNtfctnAndSts.deleter
	def OrgnlNtfctnAndSts(self):
		del self._OrgnlNtfctnAndSts
		self._OrgnlNtfctnAndSts = base_types.UninitialisedField(self, 'OrgnlNtfctnAndSts', OriginalNotification17, False)
