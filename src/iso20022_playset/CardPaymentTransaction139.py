...
class CardPaymentTransaction139(base_types._BaseFieldType):
	...
	__slots__ = ["_MrchntCtgyCd", "_TxId", "_LastTxFlg", "_AddtlTxData", "_SaleRefId", "_TxCaptr", "_InitrTxId", "_IssrCITId", "_AcctFr", "_TxDtls", "_AcctTo", "_MrchntRefData", "_CstmrCnsnt", "_TxTp", "_SvcAttr", "_OrgnlTx", "_MrchntCITId", "_CardPrgrmmApld", "_RcncltnId", "_CardPrgrmmPropsd", "_AddtlSvc"]
	@property
