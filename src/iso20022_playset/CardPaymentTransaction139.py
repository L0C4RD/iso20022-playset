...
class CardPaymentTransaction139(base_types._BaseFieldType):
	...
	__slots__ = ["_LastTxFlg", "_CardPrgrmmPropsd", "_AcctFr", "_AcctTo", "_CardPrgrmmApld", "_TxId", "_MrchntCITId", "_IssrCITId", "_MrchntRefData", "_TxCaptr", "_SaleRefId", "_MrchntCtgyCd", "_InitrTxId", "_AddtlSvc", "_TxDtls", "_SvcAttr", "_TxTp", "_RcncltnId", "_AddtlTxData", "_OrgnlTx", "_CstmrCnsnt"]
	@property
	def LastTxFlg(self):
