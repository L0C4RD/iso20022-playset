...
class CardPaymentTransaction139(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctTo", "_MrchntRefData", "_TxCaptr", "_MrchntCITId", "_AcctFr", "_MrchntCtgyCd", "_RcncltnId", "_CardPrgrmmApld", "_AddtlSvc", "_LastTxFlg", "_InitrTxId", "_SvcAttr", "_IssrCITId", "_TxDtls", "_CstmrCnsnt", "_TxTp", "_CardPrgrmmPropsd", "_TxId", "_OrgnlTx", "_SaleRefId", "_AddtlTxData"]
	@property
	def AcctTo(self):
		return self._AcctTo
