...
class CardPaymentTransaction139(base_types._BaseFieldType):
	...
	__slots__ = ["_TxDtls", "_CstmrCnsnt", "_OrgnlTx", "_CardPrgrmmPropsd", "_RcncltnId", "_TxId", "_AddtlTxData", "_InitrTxId", "_TxCaptr", "_AcctTo", "_MrchntCtgyCd", "_LastTxFlg", "_TxTp", "_AddtlSvc", "_SaleRefId", "_AcctFr", "_IssrCITId", "_SvcAttr", "_MrchntCITId", "_CardPrgrmmApld", "_MrchntRefData"]
	@property
	def TxDtls(self):
		return self._TxDtls
