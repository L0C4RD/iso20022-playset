...
class CardPaymentTransaction139(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctTo", "_AcctFr", "_InitrTxId", "_OrgnlTx", "_MrchntCITId", "_MrchntCtgyCd", "_TxCaptr", "_AddtlTxData", "_MrchntRefData", "_CardPrgrmmPropsd", "_CardPrgrmmApld", "_SaleRefId", "_RcncltnId", "_SvcAttr", "_TxTp", "_IssrCITId", "_LastTxFlg", "_AddtlSvc", "_TxId", "_CstmrCnsnt", "_TxDtls"]
	@property
	def AcctTo(self):
		return self._AcctTo
