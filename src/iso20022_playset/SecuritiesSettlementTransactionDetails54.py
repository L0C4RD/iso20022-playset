...
class SecuritiesSettlementTransactionDetails54(base_types._BaseFieldType):
	...
	__slots__ = ["_CshPties", "_AddtlPhysOrRegnDtls", "_TradDtls", "_FinInstrmAttrbts", "_SplmtryData", "_RcvgSttlmPties", "_StgSttlmInstrDtls", "_DlvrgSttlmPties", "_SttlmTpAndAddtlParams", "_OthrBizPties", "_OthrAmts", "_QtyAndAcctDtls", "_SttlmParams", "_Lnkgs", "_SttlmAmt"]
	@property
	def CshPties(self):
