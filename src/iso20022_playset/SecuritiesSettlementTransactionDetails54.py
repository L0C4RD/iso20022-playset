...
class SecuritiesSettlementTransactionDetails54(base_types._BaseFieldType):
	...
	__slots__ = ["_CshPties", "_Lnkgs", "_QtyAndAcctDtls", "_SttlmParams", "_RcvgSttlmPties", "_OthrBizPties", "_TradDtls", "_AddtlPhysOrRegnDtls", "_StgSttlmInstrDtls", "_OthrAmts", "_FinInstrmAttrbts", "_DlvrgSttlmPties", "_SttlmTpAndAddtlParams", "_SttlmAmt", "_SplmtryData"]
	@property
	def CshPties(self):
