...
from .ShippingPackage3 import ShippingPackage3
...
class ShippingData3(base_types._BaseFieldType):
	...
	__slots__ = ["_Insrnc", "_SvcDscrptrCd", "_NetAmt", "_Tax", "_SummryCmmdtyId", "_InvcNb", "_MiscExpnss", "_InvcCreDtTm", "_InsrncAmt", "_IncntivAmt", "_NbOfPackgs", "_AddtlData", "_Packg"]
	@property
	def Insrnc(self):
		return self._Insrnc
