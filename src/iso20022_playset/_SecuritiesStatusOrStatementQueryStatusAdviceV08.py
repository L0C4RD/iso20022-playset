...
from . import StatusOrStatement14Choice
from . import SupplementaryData1

class SecuritiesStatusOrStatementQueryStatusAdviceV08(base_types._BaseFieldType):
	...
	def StsOrStmtReqd(self, value):
		self._StsOrStmtReqd = value if value is not None else base_types.UninitialisedField(self, 'StsOrStmtReqd', StatusOrStatement14Choice, False)

	@StsOrStmtReqd.deleter
	def StsOrStmtReqd(self):
		del self._StsOrStmtReqd
		self._StsOrStmtReqd = base_types.UninitialisedField(self, 'StsOrStmtReqd', StatusOrStatement14Choice, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='StsOrStmtReqd', type=StatusOrStatement14Choice, min=0, max=1, mutex_group=None, array=False),
	))