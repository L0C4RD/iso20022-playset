...
class ReceiveInformation21(base_types._BaseFieldType):
	...
	__slots__ = ["_Trfee", "_ReqdTradDt", "_ReqdSttlmDt", "_PhysTrfDtls", "_IncmPref", "_Fees", "_DmtrlsdInd", "_ClntRef", "_IndvTax", "_SctiesForm", "_NetAmt", "_SttlmPtiesDtls", "_IntrmyInf", "_FXDtls", "_StmpDty", "_TrfeeRegdAcct", "_PhysTrf", "_BnfcryCertfctnCmpltn", "_SttlmAmt"]
	@property
	def Trfee(self):
		return self._Trfee
