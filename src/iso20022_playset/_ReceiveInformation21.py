...
class ReceiveInformation21(base_types._BaseFieldType):
	...
	__slots__ = ["_Trfee", "_PhysTrfDtls", "_IncmPref", "_FXDtls", "_SctiesForm", "_NetAmt", "_SttlmPtiesDtls", "_IndvTax", "_BnfcryCertfctnCmpltn", "_TrfeeRegdAcct", "_PhysTrf", "_ReqdTradDt", "_Fees", "_ReqdSttlmDt", "_ClntRef", "_StmpDty", "_DmtrlsdInd", "_SttlmAmt", "_IntrmyInf"]
	@property
	def Trfee(self):
		return self._Trfee
