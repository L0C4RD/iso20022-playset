...
class ReceivingPartiesAndAccount20(base_types._BaseFieldType):
	...
	def RcvgAgtDtls(self, value):
		self._RcvgAgtDtls = value if value is not None else base_types.UninitialisedField(self, 'RcvgAgtDtls', PartyIdentificationAndAccount222, False)

	@RcvgAgtDtls.deleter
	def RcvgAgtDtls(self):
		del self._RcvgAgtDtls
		self._RcvgAgtDtls = base_types.UninitialisedField(self, 'RcvgAgtDtls', PartyIdentificationAndAccount222, False)
	...
	def RcvrsCtdnDtls(self, value):
		self._RcvrsCtdnDtls = value if value is not None else base_types.UninitialisedField(self, 'RcvrsCtdnDtls', PartyIdentificationAndAccount222, False)

	@RcvrsCtdnDtls.deleter
	def RcvrsCtdnDtls(self):
		del self._RcvrsCtdnDtls
		self._RcvrsCtdnDtls = base_types.UninitialisedField(self, 'RcvrsCtdnDtls', PartyIdentificationAndAccount222, False)
	...
	def RcvrsIntrmy1Dtls(self, value):
		self._RcvrsIntrmy1Dtls = value if value is not None else base_types.UninitialisedField(self, 'RcvrsIntrmy1Dtls', PartyIdentificationAndAccount222, False)

	@RcvrsIntrmy1Dtls.deleter
	def RcvrsIntrmy1Dtls(self):
		del self._RcvrsIntrmy1Dtls
		self._RcvrsIntrmy1Dtls = base_types.UninitialisedField(self, 'RcvrsIntrmy1Dtls', PartyIdentificationAndAccount222, False)
	...
	def RcvrsIntrmy2Dtls(self, value):
		self._RcvrsIntrmy2Dtls = value if value is not None else base_types.UninitialisedField(self, 'RcvrsIntrmy2Dtls', PartyIdentificationAndAccount222, False)

	@RcvrsIntrmy2Dtls.deleter
	def RcvrsIntrmy2Dtls(self):
		del self._RcvrsIntrmy2Dtls
		self._RcvrsIntrmy2Dtls = base_types.UninitialisedField(self, 'RcvrsIntrmy2Dtls', PartyIdentificationAndAccount222, False)
