...
from . import DocumentIdentification10
...
class DataSetMatchReportV03(base_types._BaseFieldType):
	...
	def CmpardDocRef(self, value):
		self._CmpardDocRef = value if value is not None else base_types.UninitialisedField(self, 'CmpardDocRef', DocumentIdentification10, True)

	@CmpardDocRef.deleter
	def CmpardDocRef(self):
		del self._CmpardDocRef
		self._CmpardDocRef = base_types.UninitialisedField(self, 'CmpardDocRef', DocumentIdentification10, True)
	...
	def SubmissnTp(self, value):
		self._SubmissnTp = value if value is not None else base_types.UninitialisedField(self, 'SubmissnTp', ReportType3, False)

	@SubmissnTp.deleter
	def SubmissnTp(self):
		del self._SubmissnTp
		self._SubmissnTp = base_types.UninitialisedField(self, 'SubmissnTp', ReportType3, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='CmpardDocRef', type=DocumentIdentification10, min=2, max=None, mutex_group=None, array=True),
		...
		base_types.FieldEntry(name='SubmissnTp', type=ReportType3, min=1, max=1, mutex_group=None, array=False),
