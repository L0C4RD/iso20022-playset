...
class NotificationItem9(base_types._BaseFieldType):
	...
	__slots__ = ["_Id", "_RltdRmtInf", "_Purp", "_EndToEndId", "_IntrmyAgt", "_AcctSvcr", "_XpctdValDt", "_Acct", "_RltdAcct", "_UETR", "_RmtInf", "_DbtrAgt", "_Amt", "_UndrlygAllcn", "_AcctOwnr", "_Dbtr"]
	@property
	def Id(self):
		return self._Id
