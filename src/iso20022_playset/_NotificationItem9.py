...
class NotificationItem9(base_types._BaseFieldType):
	...
	__slots__ = ["_Acct", "_AcctOwnr", "_EndToEndId", "_IntrmyAgt", "_Purp", "_Amt", "_RmtInf", "_RltdAcct", "_UETR", "_Dbtr", "_XpctdValDt", "_UndrlygAllcn", "_AcctSvcr", "_Id", "_RltdRmtInf", "_DbtrAgt"]
	@property
	def Acct(self):
		return self._Acct
