...
class MarginCallRequestV05(base_types._BaseFieldType):
	...
	__slots__ = ["_MrgnCallDtls", "_TxId", "_Agrmt", "_Oblgtn", "_MrgnCallRslt", "_RqrmntDtlsDueToB", "_XpctdCollDueToB", "_RqrmntDtlsDueToA", "_MrgnDtlsDueToA", "_MrgnDtlsDueToB", "_XpctdCollDueToA", "_SplmtryData"]
	@property
