...
class TradeLeg12(base_types._BaseFieldType):
	...
	__slots__ = ["_OrdrId", "_TradDt", "_TradExctnId", "_PlcOfListg", "_TradgPty", "_DealPric", "_DlvryAcct", "_GrssAmt", "_MrgnAcct", "_Brkr", "_SttlmDt", "_BuySellInd", "_TradTp", "_TradQty", "_TradId", "_TradgCpcty", "_SfkpgAcct", "_TradRegnOrgn", "_AllcnId", "_TradgPtyAcct", "_NonClrMmb", "_FinInstrmId", "_AcrdIntrstAmt", "_TradPstngCd", "_UnqTxIdr", "_ClrDtls", "_DerivRltdTrad", "_TradLegId", "_TxDtAndTm", "_SfkpgPlc", "_SttlmDtls", "_PlcOfTrad", "_TradgCcy"]
	@property
	def OrdrId(self):
		return self._OrdrId
