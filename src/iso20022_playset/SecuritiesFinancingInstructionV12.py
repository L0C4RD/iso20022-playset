...
class SecuritiesFinancingInstructionV12(base_types._BaseFieldType):
	...
	__slots__ = ["_RcvgSttlmPties", "_OthrBizPties", "_StgSttlmInstrDtls", "_TradDtls", "_OthrAmts", "_SctiesFincgDtls", "_DgtlNtwkFee", "_SttlmParams", "_OpngSttlmAmt", "_TxId", "_CshPties", "_TxTpAndAddtlParams", "_FinInstrmId", "_QtyAndAcctDtls", "_SplmtryData", "_Lnkgs", "_DlvrgSttlmPties", "_FinInstrmAttrbts", "_NbCounts"]
	@property
