...
from .FundSettlementParameters20 import FundSettlementParameters20
...
from .Equalisation4 import Equalisation4
from .SourceOfCash1Choice import SourceOfCash1Choice
...
from .PaymentTransaction162 import PaymentTransaction162
...
class SubscriptionExecution14(base_types._BaseFieldType):
	...
	__slots__ = ["_PhysDlvryInd", "_ReqdSttlmCcy", "_FinAdvc", "_DealRef", "_PrtlSttlmOfUnits", "_FXDtls", "_Equlstn", "_ClntRef", "_Rndg", "_IntrmPrftAmt", "_SgntrTp", "_SttlmAndCtdyDtls", "_RltdPtyDtls", "_InftvTaxDtls", "_CshSttlmDtls", "_TxOvrhd", "_StffClntBrkdwn", "_OrdrWvrDtls", "_OrdrRef", "_ReqdNAVCcy", "_UnitsNb", "_PhysDlvryDtls", "_SubAcctForHldg", "_GrssAmt", "_NonStdSttlmInf", "_BestExctn", "_NetAmt", "_DealgPricDtls", "_PrtlyExctdInd", "_CumDvddInd", "_SttlmAmt", "_SbcptIntrst", "_LateRpt", "_AcmltnRghtRef", "_LttrInttRef", "_CstmrCndctClssfctn", "_TxChanlTp", "_InftvPricDtls", "_OrdrTp", "_CshSttlmDt", "_NgtdTrad", "_SrcOfCsh", "_SttlmMtd", "_FinInstrmDtls", "_TradDtTm", "_Rfnd", "_PrtlSttlmOfCsh", "_IncmPref"]
	@property
