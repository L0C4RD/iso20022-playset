...
from . import AccountAndBalance63
from . import CorporateAction86
from . import CorporateActionEventReference4
from . import CorporateActionGeneralInformation190
from . import CorporateActionNarrative35
from . import CorporateActionOption244
...
class CorporateActionMovementConfirmation002V16(base_types._BaseFieldType):
	...
	def AcctDtls(self, value):
		self._AcctDtls = value if value is not None else base_types.UninitialisedField(self, 'AcctDtls', AccountAndBalance63, False)

	@AcctDtls.deleter
	def AcctDtls(self):
		del self._AcctDtls
		self._AcctDtls = base_types.UninitialisedField(self, 'AcctDtls', AccountAndBalance63, False)
	...
	def CorpActnConfDtls(self, value):
		self._CorpActnConfDtls = value if value is not None else base_types.UninitialisedField(self, 'CorpActnConfDtls', CorporateActionOption244, False)

	@CorpActnConfDtls.deleter
	def CorpActnConfDtls(self):
		del self._CorpActnConfDtls
		self._CorpActnConfDtls = base_types.UninitialisedField(self, 'CorpActnConfDtls', CorporateActionOption244, False)
	...
	def CorpActnDtls(self, value):
		self._CorpActnDtls = value if value is not None else base_types.UninitialisedField(self, 'CorpActnDtls', CorporateAction86, False)

	@CorpActnDtls.deleter
	def CorpActnDtls(self):
		del self._CorpActnDtls
		self._CorpActnDtls = base_types.UninitialisedField(self, 'CorpActnDtls', CorporateAction86, False)
	...
	def CorpActnGnlInf(self, value):
		self._CorpActnGnlInf = value if value is not None else base_types.UninitialisedField(self, 'CorpActnGnlInf', CorporateActionGeneralInformation190, False)

	@CorpActnGnlInf.deleter
	def CorpActnGnlInf(self):
		del self._CorpActnGnlInf
		self._CorpActnGnlInf = base_types.UninitialisedField(self, 'CorpActnGnlInf', CorporateActionGeneralInformation190, False)
	...
	def MvmntConfId(self, value):
		self._MvmntConfId = value if value is not None else base_types.UninitialisedField(self, 'MvmntConfId', RestrictedFINXMax16Text, False)

	@MvmntConfId.deleter
	def MvmntConfId(self):
		del self._MvmntConfId
		self._MvmntConfId = base_types.UninitialisedField(self, 'MvmntConfId', RestrictedFINXMax16Text, False)
