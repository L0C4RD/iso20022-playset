...
class CorporateActionMovementConfirmation002V16(base_types._BaseFieldType):
	...
	__slots__ = ["_Pgntn", "_MvmntPrlimryAdvcId", "_AcctDtls", "_IssrAgt", "_SubPngAgt", "_EvtsLkg", "_AddtlInf", "_MvmntConfId", "_CorpActnGnlInf", "_CorpActnConfDtls", "_OthrDocId", "_InstrId", "_PngAgt", "_NtfctnId", "_TxId", "_SplmtryData", "_CorpActnDtls"]
	@property
	def Pgntn(self):
		return self._Pgntn
