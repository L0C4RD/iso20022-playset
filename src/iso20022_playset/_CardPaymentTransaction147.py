...
class CardPaymentTransaction147(base_types._BaseFieldType):

	__slots__ = ["_AcctFr", "_AcctTo", "_AddtlSvc", "_AddtlTxData", "_AuthstnRslt", "_CardPrgrmmApld", "_CardPrgrmmPropsd", "_CstmrCnsnt", "_FailrRsn", "_InitrTxId", "_IntrchngData", "_IssrCITId", "_LastTxFlg", "_MrchntCITId", "_MrchntCtgyCd", "_MrchntOvrrd", "_MrchntRefData", "_MsgFrMrchnt", "_OrgnlTx", "_RcncltnId", "_RcptTxId", "_Rvsl", "_SaleRefId", "_SvcAttr", "_TxCaptr", "_TxDtls", "_TxId", "_TxSucss", "_TxTp"]
	@property
	def AcctFr(self):
		return self._AcctFr
