...
class SecuritiesSettlementTransactionGenerationNotification002V11(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrBizPties", "_SplmtryData", "_TxIdDtls", "_QtyAndAcctDtls", "_RcvgSttlmPties", "_AddtlPhysOrRegnDtls", "_FinInstrmId", "_SttlmAmt", "_GnrtdRsn", "_StsAndRsn", "_TradDtls", "_NbCounts", "_FinInstrmAttrbts", "_DlvrgSttlmPties", "_Lnkgs", "_SttlmParams", "_OthrAmts", "_CshPties"]
	@property
