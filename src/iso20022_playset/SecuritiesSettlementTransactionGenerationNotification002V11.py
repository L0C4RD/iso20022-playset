...
class SecuritiesSettlementTransactionGenerationNotification002V11(base_types._BaseFieldType):
	...
	__slots__ = ["_CshPties", "_FinInstrmId", "_TradDtls", "_OthrBizPties", "_NbCounts", "_SttlmParams", "_OthrAmts", "_AddtlPhysOrRegnDtls", "_RcvgSttlmPties", "_FinInstrmAttrbts", "_DlvrgSttlmPties", "_Lnkgs", "_SttlmAmt", "_QtyAndAcctDtls", "_TxIdDtls", "_StsAndRsn", "_GnrtdRsn", "_SplmtryData"]
	@property
	def CshPties(self):
