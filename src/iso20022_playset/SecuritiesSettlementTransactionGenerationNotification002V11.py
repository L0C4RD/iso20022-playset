...
class SecuritiesSettlementTransactionGenerationNotification002V11(base_types._BaseFieldType):
	...
	__slots__ = ["_RcvgSttlmPties", "_CshPties", "_AddtlPhysOrRegnDtls", "_StsAndRsn", "_TradDtls", "_SttlmAmt", "_OthrBizPties", "_QtyAndAcctDtls", "_NbCounts", "_DlvrgSttlmPties", "_TxIdDtls", "_SttlmParams", "_FinInstrmAttrbts", "_SplmtryData", "_GnrtdRsn", "_OthrAmts", "_Lnkgs", "_FinInstrmId"]
	@property
