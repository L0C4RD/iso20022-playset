...
class AccountHoldingInformationV09(base_types._BaseFieldType):
	...
	__slots__ = ["_PmryCorpInvstr", "_Xtnsn", "_Trfee", "_OthrCorpInvstr", "_TrfrAcct", "_MsgRef", "_PoolRef", "_ScndryCorpInvstr", "_BizFlowDrctnTp", "_PmryIndvInvstr", "_MktPrctcVrsn", "_RltdRef", "_PdctTrf", "_OthrIndvInvstr", "_NmneeAcct", "_PrvsRef", "_ScndryIndvInvstr"]
	@property
