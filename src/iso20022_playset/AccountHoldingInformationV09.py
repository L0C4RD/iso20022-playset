...
class AccountHoldingInformationV09(base_types._BaseFieldType):
	...
	__slots__ = ["_BizFlowDrctnTp", "_PdctTrf", "_MsgRef", "_TrfrAcct", "_Xtnsn", "_RltdRef", "_NmneeAcct", "_PoolRef", "_PmryIndvInvstr", "_Trfee", "_PrvsRef", "_OthrCorpInvstr", "_ScndryIndvInvstr", "_MktPrctcVrsn", "_PmryCorpInvstr", "_ScndryCorpInvstr", "_OthrIndvInvstr"]
	@property
