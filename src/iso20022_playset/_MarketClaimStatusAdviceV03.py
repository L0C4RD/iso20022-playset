...
from . import MarketClaimProcessingStatus1Choice
...
class MarketClaimStatusAdviceV03(base_types._BaseFieldType):
	...
	def MktClmPrcgSts(self, value):
		self._MktClmPrcgSts = value if value is not None else base_types.UninitialisedField(self, 'MktClmPrcgSts', MarketClaimProcessingStatus1Choice, False)

	@MktClmPrcgSts.deleter
	def MktClmPrcgSts(self):
		del self._MktClmPrcgSts
		self._MktClmPrcgSts = base_types.UninitialisedField(self, 'MktClmPrcgSts', MarketClaimProcessingStatus1Choice, False)
