...
from .MarketClaimProcessingStatus1Choice import MarketClaimProcessingStatus1Choice
...
class MarketClaimStatusAdviceV03(base_types._BaseFieldType):
	...
	__slots__ = ["_MktClmCreId", "_SplmtryData", "_MktClmPrcgSts", "_MktClmDtls", "_CorpActnGnlInf", "_TxRef", "_AcctDtls"]
	@property
