...
class SecuritiesFinancingReportingTransactionMarginDataReportV02(base_types._BaseFieldType):
	...
	def TradData(self, value):
		self._TradData = value if value is not None else base_types.UninitialisedField(self, 'TradData', TradeData39Choice, False)

	@TradData.deleter
	def TradData(self):
		del self._TradData
		self._TradData = base_types.UninitialisedField(self, 'TradData', TradeData39Choice, False)
