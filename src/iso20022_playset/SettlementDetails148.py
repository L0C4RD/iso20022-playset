...
class SettlementDetails148(base_types._BaseFieldType):
	...
	__slots__ = ["_Trckg", "_SctiesRTGS", "_NetgElgblty", "_SttlgCpcty", "_SttlmTxCond", "_PrtlSttlmInd", "_MktClntSd", "_AutomtcBrrwg", "_BlckTrad", "_CCPElgblty", "_StmpDtyTaxBsis", "_TaxCpcty", "_BnfclOwnrsh", "_HldInd", "_SttlmSysMtd", "_Prty", "_LglRstrctns", "_FxStgInstr", "_ElgblForColl", "_CshClrSys"]
	@property
	def Trckg(self):
		return self._Trckg
