...
class SettlementDetails148(base_types._BaseFieldType):
	...
	__slots__ = ["_ElgblForColl", "_FxStgInstr", "_NetgElgblty", "_TaxCpcty", "_CshClrSys", "_HldInd", "_MktClntSd", "_Prty", "_SttlmTxCond", "_Trckg", "_StmpDtyTaxBsis", "_SctiesRTGS", "_CCPElgblty", "_LglRstrctns", "_SttlmSysMtd", "_PrtlSttlmInd", "_AutomtcBrrwg", "_BnfclOwnrsh", "_SttlgCpcty", "_BlckTrad"]
	@property
