...
class SettlementDetails148(base_types._BaseFieldType):
	...
	__slots__ = ["_CshClrSys", "_CCPElgblty", "_SctiesRTGS", "_SttlgCpcty", "_AutomtcBrrwg", "_NetgElgblty", "_BlckTrad", "_TaxCpcty", "_SttlmSysMtd", "_HldInd", "_SttlmTxCond", "_LglRstrctns", "_PrtlSttlmInd", "_StmpDtyTaxBsis", "_Trckg", "_ElgblForColl", "_MktClntSd", "_BnfclOwnrsh", "_FxStgInstr", "_Prty"]
	@property
	def CshClrSys(self):
