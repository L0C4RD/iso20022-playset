...
class SettlementDetails148(base_types._BaseFieldType):
	...
	__slots__ = ["_Prty", "_CshClrSys", "_SttlgCpcty", "_TaxCpcty", "_FxStgInstr", "_HldInd", "_ElgblForColl", "_SttlmTxCond", "_LglRstrctns", "_BnfclOwnrsh", "_SttlmSysMtd", "_AutomtcBrrwg", "_CCPElgblty", "_NetgElgblty", "_MktClntSd", "_SctiesRTGS", "_StmpDtyTaxBsis", "_BlckTrad", "_PrtlSttlmInd", "_Trckg"]
	@property
	def Prty(self):
		return self._Prty
