...
class AuthorisationInitiationV05(base_types._BaseFieldType):
	...
	@Txtr.setter
	def Txtr(self, value):
		self._Txtr = value if value is not None else base_types.UninitialisedField(self, 'Txtr', TransactorData1, True)

	@Txtr.deleter
	def Txtr(self):
		del self._Txtr
		self._Txtr = base_types.UninitialisedField(self, 'Txtr', TransactorData1, True)
