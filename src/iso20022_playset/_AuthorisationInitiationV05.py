...
from ._TransactionSpecificData1 import TransactionSpecificData1
from ._TransactorData1 import TransactorData1
from ._Verification8 import Verification8
from ._Wallet4 import Wallet4

class AuthorisationInitiationV05(base_types._BaseFieldType):

	__slots__ = ["_Accptr", "_AcctBal", "_AcctFr", "_AcctTo", "_Acqrr", "_AddtlAmt", "_AddtlFee", "_AddtlSvc", "_AuthntcnData", "_Bnfts", "_Card", "_Cntxt", "_ConvsDtTm", "_Crdhldr", "_Cstmr", "_CstmrDvc", "_DpstDtls", "_Dstn", "_FndsSvcs", "_Hdr", "_ICCRltdData", "_Instlmt", "_Issr", "_Jursdctn", "_NtlData", "_OrgnlDataElmts", "_Orgtr", "_POICmpnt", "_PrcgRslt", "_Prgrmm", "_Prmtn", "_PrtctdData", "_PrvtData", "_Pyee", "_Pyer", "_Rcncltn", "_RcrngPmt", "_Rcvr", "_Rsk", "_SctyTrlr", "_Sndr", "_SpclPrgrmmQlfctn", "_StrngCstmrAuthntcn", "_SttlmSvc", "_Tax", "_Termnl", "_Tkn", "_TxAmts", "_TxChrtcs", "_TxId", "_TxSpcfcData", "_Txtr", "_Vrfctn", "_Wllt", "_XchgRate"]
	@property
	def Accptr(self):
		return self._Accptr
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='Txtr', type=TransactorData1, min=0, max=None, mutex_group=None, array=True),
