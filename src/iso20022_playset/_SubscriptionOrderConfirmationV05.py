...
from . import SubscriptionMultipleExecution6
...
class SubscriptionOrderConfirmationV05(base_types._BaseFieldType):
	...
	def MltplExctnDtls(self, value):
		self._MltplExctnDtls = value if value is not None else base_types.UninitialisedField(self, 'MltplExctnDtls', SubscriptionMultipleExecution6, False)

	@MltplExctnDtls.deleter
	def MltplExctnDtls(self):
		del self._MltplExctnDtls
		self._MltplExctnDtls = base_types.UninitialisedField(self, 'MltplExctnDtls', SubscriptionMultipleExecution6, False)
