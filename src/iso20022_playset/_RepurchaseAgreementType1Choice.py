...
from . import GeneralCollateral2
...
class RepurchaseAgreementType1Choice(base_types._BaseFieldType):
	...
	def GnlColl(self, value):
		self._GnlColl = value if value is not None else base_types.UninitialisedField(self, 'GnlColl', GeneralCollateral2, False)

	@GnlColl.deleter
	def GnlColl(self):
		del self._GnlColl
		self._GnlColl = base_types.UninitialisedField(self, 'GnlColl', GeneralCollateral2, False)
