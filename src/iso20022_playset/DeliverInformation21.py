...
class DeliverInformation21(base_types._BaseFieldType):
	...
	__slots__ = ["_Fees", "_PhysTrf", "_PhysTrfDtls", "_BnfcryCertfctnCmpltn", "_ClntRef", "_TrfrRegdAcct", "_FXDtls", "_SctiesForm", "_SttlmAmt", "_ReqdSttlmDt", "_NetAmt", "_StmpDty", "_IncmPref", "_Trfr", "_IndvTax", "_SttlmPtiesDtls", "_DmtrlsdInd", "_ReqdTradDt", "_IntrmyInf"]
	@property
	def Fees(self):
		return self._Fees
