...
class DeliverInformation21(base_types._BaseFieldType):
	...
	__slots__ = ["_SctiesForm", "_PhysTrfDtls", "_FXDtls", "_IntrmyInf", "_ClntRef", "_TrfrRegdAcct", "_DmtrlsdInd", "_NetAmt", "_ReqdTradDt", "_SttlmPtiesDtls", "_Trfr", "_PhysTrf", "_BnfcryCertfctnCmpltn", "_IncmPref", "_SttlmAmt", "_Fees", "_StmpDty", "_ReqdSttlmDt", "_IndvTax"]
	@property
	def SctiesForm(self):
