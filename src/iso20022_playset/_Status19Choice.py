...
class Status19Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_InstrPrcgSts", "_RegnPrcgSts", "_MtchgSts", "_RplcmntPrcgSts", "_CorpActnEvtPrcgSts", "_AffirmSts", "_AllcnSts", "_IfrrdMtchgSts", "_RspnSts", "_CorpActnEvtStag", "_SttlmCondModSts", "_CxlPrcgSts", "_RepoCallReqSts", "_SttlmSts"]
	@property
