...
class InvoiceLineItem3(base_types._BaseFieldType):
	...
	__slots__ = ["_Dt", "_Desc", "_ShipToIndstryCd", "_ShppgDt", "_TpOfSpply", "_PdctCd", "_CtrctNb", "_OthrUnitOfMeasr", "_AdjstmntAmt", "_Rbllg", "_ZeroCostToCstmr", "_MdclSvcs", "_PdctQlfr", "_TtlAmt", "_UnitOfMeasr", "_PdctQty", "_Tax", "_InsrncAmt", "_Insrnc", "_AdjstmntRsn", "_VATInvcRef", "_AddtlData", "_AdjstmntCdtDbt", "_UnitPric", "_OrdrDt", "_CdtDbt"]
	@property
	def Dt(self):
		return self._Dt
