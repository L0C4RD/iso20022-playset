...
class InvoiceLineItem3(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrctNb", "_ZeroCostToCstmr", "_MdclSvcs", "_Rbllg", "_UnitPric", "_PdctCd", "_AdjstmntCdtDbt", "_AdjstmntRsn", "_ShipToIndstryCd", "_Tax", "_AdjstmntAmt", "_Desc", "_PdctQty", "_TpOfSpply", "_UnitOfMeasr", "_Insrnc", "_OthrUnitOfMeasr", "_CdtDbt", "_OrdrDt", "_TtlAmt", "_ShppgDt", "_InsrncAmt", "_VATInvcRef", "_Dt", "_AddtlData", "_PdctQlfr"]
	@property
	def CtrctNb(self):
