...
class CorporateActionRate119(base_types._BaseFieldType):
	...
	__slots__ = ["_NetDstrbtnRate", "_PrratnRate", "_MaxAllwdOvrsbcptRate", "_TaxblIncmPerDvddShr", "_GrssDstrbtnRate", "_TaxOnIncm", "_ScndLvlTax", "_GrssIntrstRateUsdForPmt", "_AddtlTax", "_WhldgTaxRate"]
	@property
