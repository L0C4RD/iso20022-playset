...
from . import PartyIdentification256Choice
from . import PartyTextInformation1

class PartyIdentificationAndAccount230(base_types._BaseFieldType):

	__slots__ = ["_AddtlInf", "_AltrnId", "_Id", "_PrcgId", "_SfkpgAcct"]
	@property
	def AddtlInf(self):
	...
	@Id.setter
	def Id(self, value):
		self._Id = value if value is not None else base_types.UninitialisedField(self, 'Id', PartyIdentification256Choice, False)

	@Id.deleter
	def Id(self):
		del self._Id
		self._Id = base_types.UninitialisedField(self, 'Id', PartyIdentification256Choice, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='Id', type=PartyIdentification256Choice, min=1, max=1, mutex_group=None, array=False),
