...
import AggregateBalancePerSafekeepingPlace4
...
class AggregateBalanceInformation3(base_types._BaseFieldType):
	...
	__slots__ = ["_AggtQty", "_AcrdIntrstAmt", "_BalBrkdwnDtls", "_HldgVal", "_BookVal", "_PrvsHldgVal", "_SfkpgPlc", "_PricDtls", "_AddtlBalBrkdwnDtls", "_DaysAcrd", "_FXDtls", "_AcrdIntrstAmtSgn", "_FinInstrmDtls", "_BalAtSfkpgPlc"]
	@property
	def AggtQty(self):
