...
class AggregateBalanceInformation3(base_types._BaseFieldType):
	...
	__slots__ = ["_FXDtls", "_DaysAcrd", "_BookVal", "_HldgVal", "_PrvsHldgVal", "_SfkpgPlc", "_FinInstrmDtls", "_AggtQty", "_BalBrkdwnDtls", "_AcrdIntrstAmt", "_AddtlBalBrkdwnDtls", "_AcrdIntrstAmtSgn", "_BalAtSfkpgPlc", "_PricDtls"]
	@property
	def FXDtls(self):
		return self._FXDtls
