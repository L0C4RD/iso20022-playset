...
class SettlementDetails210(base_types._BaseFieldType):
	...
	__slots__ = ["_SctiesTxTp", "_HldInd", "_LglRstrctns", "_BnfclOwnrsh", "_RpTp", "_MktClntSd", "_SttlgCpcty", "_PrtlSttlmInd", "_Regn", "_CshClrSys", "_SctiesRTGS", "_NetgElgblty", "_SttlmTxCond", "_CCPElgblty", "_BlckTrad", "_SttlmSysMtd", "_XpsrTp", "_StmpDtyTaxBsis", "_LttrOfGrnt", "_ElgblForColl", "_TaxCpcty"]
	@property
	def SctiesTxTp(self):
