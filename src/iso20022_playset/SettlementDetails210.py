...
class SettlementDetails210(base_types._BaseFieldType):
	...
	__slots__ = ["_XpsrTp", "_TaxCpcty", "_StmpDtyTaxBsis", "_SttlmTxCond", "_SttlmSysMtd", "_ElgblForColl", "_BlckTrad", "_MktClntSd", "_SctiesTxTp", "_RpTp", "_BnfclOwnrsh", "_LttrOfGrnt", "_SctiesRTGS", "_Regn", "_NetgElgblty", "_PrtlSttlmInd", "_CshClrSys", "_LglRstrctns", "_CCPElgblty", "_SttlgCpcty", "_HldInd"]
	@property
	def XpsrTp(self):
		return self._XpsrTp
