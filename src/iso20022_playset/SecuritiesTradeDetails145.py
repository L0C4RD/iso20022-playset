...
class SecuritiesTradeDetails145(base_types._BaseFieldType):
	...
	__slots__ = ["_CcyToBuyOrSell", "_TpOfPric", "_LateDlvryDt", "_Rptg", "_MtchdStsTmStmp", "_DealPric", "_PlcOfTrad", "_AffirmSts", "_MtchgSts", "_AckdStsTmStmp", "_OpngClsg", "_PlcOfClr", "_SttlmDt", "_TradTxCond", "_NbOfDaysAcrd", "_TradDt", "_UnqTxIdr", "_FxAddtlDtls", "_TradId", "_CollTxId", "_TradOrgtrRole", "_InvstrCpcty", "_SttlmInstrPrcgAddtlDtls"]
	@property
