...
class SecuritiesTradeDetails145(base_types._BaseFieldType):
	...
	__slots__ = ["_PlcOfTrad", "_TradId", "_UnqTxIdr", "_DealPric", "_AffirmSts", "_CollTxId", "_MtchdStsTmStmp", "_AckdStsTmStmp", "_Rptg", "_SttlmDt", "_NbOfDaysAcrd", "_InvstrCpcty", "_LateDlvryDt", "_TradTxCond", "_FxAddtlDtls", "_OpngClsg", "_PlcOfClr", "_TradOrgtrRole", "_MtchgSts", "_TradDt", "_CcyToBuyOrSell", "_TpOfPric", "_SttlmInstrPrcgAddtlDtls"]
	@property
	def PlcOfTrad(self):
