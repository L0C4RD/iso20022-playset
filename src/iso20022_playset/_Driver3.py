...
class Driver3(base_types._BaseFieldType):
	...
	__slots__ = ["_LicIssncDt", "_DeptNb", "_LicForm", "_Id", "_LicCtrySubDvsnMjr", "_LicAssgnr", "_DtOfBirth", "_LicCtry", "_LicId", "_LicOthrAuthrty", "_LicCtrySubDvsnMnr", "_AddtlId", "_MplyeeId", "_LicXprtnDt", "_LicTp", "_AddtlData", "_Nm", "_Mplyr"]
	@property
	def LicIssncDt(self):
