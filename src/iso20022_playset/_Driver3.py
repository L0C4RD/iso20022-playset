...
class Driver3(base_types._BaseFieldType):
	...
	__slots__ = ["_LicForm", "_AddtlData", "_LicCtry", "_AddtlId", "_Nm", "_LicXprtnDt", "_LicCtrySubDvsnMnr", "_LicId", "_MplyeeId", "_LicTp", "_Id", "_DtOfBirth", "_Mplyr", "_DeptNb", "_LicAssgnr", "_LicCtrySubDvsnMjr", "_LicOthrAuthrty", "_LicIssncDt"]
	@property
	def LicForm(self):
