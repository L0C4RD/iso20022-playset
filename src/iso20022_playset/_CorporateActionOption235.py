...
class CorporateActionOption235(base_types._BaseFieldType):
	...
	__slots__ = ["_PrdDtls", "_TaxCtgy", "_SctiesMvmntDtls", "_CertfctnBrkdwnTp", "_OptnAvlbtySts", "_SctiesQty", "_CcyOptn", "_OvrsbcptChrgInd", "_FinInstrmId", "_AddtlInf", "_DtDtls", "_OptnFeatrs", "_PrratnRndgInd", "_PrratnFrctn", "_PrtctChrgInd", "_WdrwlAllwdInd", "_SplmtryOptnFeatrs", "_CshMvmntDtls", "_StepUpChrgInd", "_PricDtls", "_SbcptChrgInd", "_OfferTp", "_DfltOptnInd", "_OptnNb", "_OptnTp", "_CertfctnBrkdwnInd", "_PrratnRtrMinQtyTrtmnt", "_FrctnDspstn", "_AccptncPrtyLvl", "_PrratnBlwMinQty", "_RateAndAmtDtls"]
	@property
	def PrdDtls(self):
