...
from . import ProcessingStatus83Choice
from . import RepoCallRequestStatus7Choice
from . import SecuritiesFinancingTransactionDetails57
...
class SecuritiesFinancingStatusAdviceV10(base_types._BaseFieldType):
	...
	def PrcgSts(self, value):
		self._PrcgSts = value if value is not None else base_types.UninitialisedField(self, 'PrcgSts', ProcessingStatus83Choice, False)

	@PrcgSts.deleter
	def PrcgSts(self):
		del self._PrcgSts
		self._PrcgSts = base_types.UninitialisedField(self, 'PrcgSts', ProcessingStatus83Choice, False)
	...
	def TxDtls(self, value):
		self._TxDtls = value if value is not None else base_types.UninitialisedField(self, 'TxDtls', SecuritiesFinancingTransactionDetails57, False)

	@TxDtls.deleter
	def TxDtls(self):
		del self._TxDtls
		self._TxDtls = base_types.UninitialisedField(self, 'TxDtls', SecuritiesFinancingTransactionDetails57, False)
