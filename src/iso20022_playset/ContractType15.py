...
class ContractType15(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrctTp", "_UndrlygAsstPricSrc", "_PlcOfSttlm", "_UndrlygInstrm", "_PdctClssfctn", "_AsstClss", "_PdctId", "_SttlmCcy", "_SttlmCcyScndLeg", "_UndrlygAsstTradgPltfmIdr", "_DerivBasedOnCrptAsst"]
	@property
	def CtrctTp(self):
