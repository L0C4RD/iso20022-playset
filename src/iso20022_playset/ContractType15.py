...
class ContractType15(base_types._BaseFieldType):
	...
	__slots__ = ["_DerivBasedOnCrptAsst", "_CtrctTp", "_PdctClssfctn", "_SttlmCcyScndLeg", "_UndrlygAsstTradgPltfmIdr", "_SttlmCcy", "_UndrlygInstrm", "_AsstClss", "_UndrlygAsstPricSrc", "_PdctId", "_PlcOfSttlm"]
	@property
