...
class Transaction163(base_types._BaseFieldType):
	...
	__slots__ = ["_ClntTrptyCollTxId", "_CtrPtyMktInfrstrctrTxId", "_AcctOwnrTxId", "_PoolId", "_AcctSvcrTxId", "_CmonId", "_StsAndRsn", "_PrcrTxId", "_TxDtls", "_UnqTxIdr", "_CorpActnEvtId", "_TradId", "_TrptyAgtSvcPrvdrCollInstrId", "_MktInfrstrctrTxId", "_TrptyAgtSvcPrvdrCollTxId", "_ClntCollInstrId"]
	@property
