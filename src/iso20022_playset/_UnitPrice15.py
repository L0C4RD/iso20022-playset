...
class UnitPrice15(base_types._BaseFieldType):
	...
	__slots__ = ["_ForExctnInd", "_TaxblIncmPerDvdd", "_EstmtdPricInd", "_XtndedTaxblIncmPerShrClctd", "_TaxblIncmPerShrClctd", "_TaxRfndDtls", "_EUDvddSts", "_CumDvddInd", "_ChrgDtls", "_XtndedEUDvddSts", "_ValInAltrntvCcy", "_XtndedTp", "_Tp", "_NbOfDaysAcrd", "_TaxLbltyDtls", "_TaxblIncmPerShr", "_ClctnBsis", "_PricMtd", "_ValInInvstmtCcy"]
	@property
