...
from . import NonFinancialRequestContentComponent5
...
class NonFinancialRequestComponent5(base_types._BaseFieldType):
	...
	def NonFinReqCntt(self, value):
		self._NonFinReqCntt = value if value is not None else base_types.UninitialisedField(self, 'NonFinReqCntt', NonFinancialRequestContentComponent5, False)

	@NonFinReqCntt.deleter
	def NonFinReqCntt(self):
		del self._NonFinReqCntt
		self._NonFinReqCntt = base_types.UninitialisedField(self, 'NonFinReqCntt', NonFinancialRequestContentComponent5, False)
