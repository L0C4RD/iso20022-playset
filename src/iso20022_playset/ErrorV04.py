...
class ErrorV04(base_types._BaseFieldType):
	...
	__slots__ = ["_Jursdctn", "_SplmtryData", "_AddtlData", "_Orgtr", "_Hdr", "_SttlmSvc", "_ErrDtl", "_SysTracAudtNb", "_RtrvlRefNb", "_Sndr", "_TrnsmssnDtTm", "_Dstn", "_Rcncltn", "_Rcvr", "_SctyTrlr", "_PrtctdData", "_OrgnlMsg", "_LifeCyclId", "_AddtlFee"]
	@property
	def Jursdctn(self):
