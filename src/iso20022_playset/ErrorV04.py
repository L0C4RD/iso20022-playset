...
class ErrorV04(base_types._BaseFieldType):
	...
	__slots__ = ["_SctyTrlr", "_TrnsmssnDtTm", "_Orgtr", "_ErrDtl", "_AddtlData", "_LifeCyclId", "_AddtlFee", "_Jursdctn", "_Dstn", "_SplmtryData", "_OrgnlMsg", "_Hdr", "_PrtctdData", "_SysTracAudtNb", "_RtrvlRefNb", "_SttlmSvc", "_Sndr", "_Rcvr", "_Rcncltn"]
	@property
	def SctyTrlr(self):
