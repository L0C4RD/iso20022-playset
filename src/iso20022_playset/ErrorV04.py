...
class ErrorV04(base_types._BaseFieldType):
	...
	__slots__ = ["_Sndr", "_ErrDtl", "_Hdr", "_AddtlData", "_Rcncltn", "_Dstn", "_PrtctdData", "_RtrvlRefNb", "_OrgnlMsg", "_LifeCyclId", "_TrnsmssnDtTm", "_Rcvr", "_Jursdctn", "_SplmtryData", "_Orgtr", "_SctyTrlr", "_SttlmSvc", "_AddtlFee", "_SysTracAudtNb"]
	@property
	def Sndr(self):
		return self._Sndr
