...
class FundSettlementParameters24(base_types._BaseFieldType):
	...
	def DlvrgSdDtls(self, value):
		self._DlvrgSdDtls = value if value is not None else base_types.UninitialisedField(self, 'DlvrgSdDtls', SettlementParties131, False)

	@DlvrgSdDtls.deleter
	def DlvrgSdDtls(self):
		del self._DlvrgSdDtls
		self._DlvrgSdDtls = base_types.UninitialisedField(self, 'DlvrgSdDtls', SettlementParties131, False)
