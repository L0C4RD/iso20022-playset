...
from .AccountIdentificationAndName6 import AccountIdentificationAndName6
from .FinancialInstitutionIdentification16 import FinancialInstitutionIdentification16
from .PartyIdentification132 import PartyIdentification132

class CreditTransfer11(base_types._BaseFieldType):

	__slots__ = ["_CdtrAcct", "_DbtrAcct", "_IntrmyAgt1Acct", "_CdtrAgtAcct", "_DbtrAgt", "_Cdtr", "_IntrmyAgt2Acct", "_DbtrAgtAcct", "_IntrmyAgt1", "_Dbtr", "_IntrmyAgt2", "_CdtrAgt"]
	@property
	def CdtrAcct(self):
