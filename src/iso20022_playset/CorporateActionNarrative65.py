...
class CorporateActionNarrative65(base_types._BaseFieldType):
	...
	__slots__ = ["_TaxtnConds", "_PtyCtctNrrtv", "_RegnDtls", "_PrcgTxtForNxtIntrmy", "_AddtlTxt", "_Dsclmr", "_BsktOrIndxInf", "_URLAdr", "_NrrtvVrsn", "_InfConds", "_CertfctnBrkdwn", "_InfToCmplyWth"]
	@property
	def TaxtnConds(self):
