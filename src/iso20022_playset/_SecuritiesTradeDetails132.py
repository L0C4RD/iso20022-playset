...
class SecuritiesTradeDetails132(base_types._BaseFieldType):
	...
	__slots__ = ["_AffirmSts", "_CcyToBuyOrSell", "_CollTxId", "_DealPric", "_FxAddtlDtls", "_InvstrCpcty", "_LateDlvryDt", "_MtchgSts", "_NbOfDaysAcrd", "_OpngClsg", "_PlcOfClr", "_PlcOfTrad", "_Rptg", "_SttlmInstrPrcgAddtlDtls", "_TpOfPric", "_TradDt", "_TradId", "_TradOrgtrRole", "_TradTxCond"]
	@property
	def AffirmSts(self):
