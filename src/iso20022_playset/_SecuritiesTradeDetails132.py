...
class SecuritiesTradeDetails132(base_types._BaseFieldType):

	__slots__ = ["_PlcOfTrad", "_NbOfDaysAcrd", "_AffirmSts", "_MtchgSts", "_SttlmInstrPrcgAddtlDtls", "_DealPric", "_TradDt", "_PlcOfClr", "_CcyToBuyOrSell", "_Rptg", "_OpngClsg", "_TradTxCond", "_TpOfPric", "_CollTxId", "_InvstrCpcty", "_LateDlvryDt", "_TradOrgtrRole", "_TradId", "_FxAddtlDtls"]
	@property
	def PlcOfTrad(self):
