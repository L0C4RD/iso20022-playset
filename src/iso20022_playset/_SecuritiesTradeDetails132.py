...
class SecuritiesTradeDetails132(base_types._BaseFieldType):
	...
	__slots__ = ["_TradId", "_FxAddtlDtls", "_MtchgSts", "_TpOfPric", "_LateDlvryDt", "_TradTxCond", "_NbOfDaysAcrd", "_TradDt", "_CollTxId", "_OpngClsg", "_DealPric", "_SttlmInstrPrcgAddtlDtls", "_Rptg", "_PlcOfTrad", "_CcyToBuyOrSell", "_TradOrgtrRole", "_PlcOfClr", "_InvstrCpcty", "_AffirmSts"]
	@property
	def AffirmSts(self):
