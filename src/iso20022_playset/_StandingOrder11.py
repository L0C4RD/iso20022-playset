...
class StandingOrder11(base_types._BaseFieldType):
	...
	__slots__ = ["_RspnsblPty", "_VldtyPrd", "_Amt", "_Tp", "_Ref", "_ZeroSweepInd", "_AssoctdPoolAcct", "_Ccy", "_LkSetId", "_ExctnTp", "_LkSetOrdrId", "_SysMmb", "_Frqcy", "_Dbtr", "_CdtrAcct", "_CdtDbtInd", "_Cdtr", "_TtlsPerStgOrdr", "_LkSetOrdrSeq", "_DbtrAcct"]
	@property
	def RspnsblPty(self):
