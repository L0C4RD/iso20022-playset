...
class PaymentTransaction152(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlIntrBkSttlmAmt", "_OrgnlTxRef", "_CxlStsRsnInf", "_OrgnlIntrBkSttlmDt", "_RsltnRltdInf", "_Assgnr", "_TxCxlSts", "_CxlStsId", "_RslvdCase", "_OrgnlUETR", "_OrgnlEndToEndId", "_OrgnlGrpInf", "_OrgnlTxId", "_OrgnlClrSysRef", "_OrgnlInstrId", "_Assgne"]
	@property
