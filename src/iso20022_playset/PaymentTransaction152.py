...
class PaymentTransaction152(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlIntrBkSttlmDt", "_RslvdCase", "_Assgne", "_OrgnlUETR", "_OrgnlGrpInf", "_CxlStsRsnInf", "_OrgnlClrSysRef", "_OrgnlEndToEndId", "_OrgnlIntrBkSttlmAmt", "_OrgnlInstrId", "_TxCxlSts", "_Assgnr", "_CxlStsId", "_OrgnlTxRef", "_OrgnlTxId", "_RsltnRltdInf"]
	@property
