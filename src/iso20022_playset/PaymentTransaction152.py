...
class PaymentTransaction152(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlInstrId", "_OrgnlEndToEndId", "_OrgnlGrpInf", "_OrgnlIntrBkSttlmAmt", "_OrgnlClrSysRef", "_OrgnlIntrBkSttlmDt", "_OrgnlTxRef", "_RslvdCase", "_OrgnlTxId", "_CxlStsRsnInf", "_Assgnr", "_OrgnlUETR", "_CxlStsId", "_TxCxlSts", "_RsltnRltdInf", "_Assgne"]
	@property
