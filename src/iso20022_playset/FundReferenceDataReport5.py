...
class FundReferenceDataReport5(base_types._BaseFieldType):
	...
	__slots__ = ["_Vrsn", "_TrgtMktInd", "_LclMktAnx", "_SbcptPrcgChrtcs", "_FndPties", "_ValtnDealgChrtcs", "_CshSttlmDtls", "_Xtnsn", "_ExPstInd", "_CostsAndChrgs", "_ValForMny", "_FndDtls", "_AuthrsdPrxy", "_TrgtMkt", "_GnlRefDt", "_RedPrcgChrtcs", "_DstrbtnStrtgy", "_AddtlInfUKMkt", "_PmtInstrm", "_SctyId", "_SwtchPrcgChrtcs", "_Id", "_InvstmtRstrctns", "_ExAnteInd", "_FndMgmtCpny", "_MainFndOrdrDsk", "_PlanChrtcs"]
	@property
	def Vrsn(self):
		return self._Vrsn
