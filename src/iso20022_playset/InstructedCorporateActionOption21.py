...
class InstructedCorporateActionOption21(base_types._BaseFieldType):
	...
	__slots__ = ["_OptnAccptdInstdBal", "_OptnRjctdInstrBal", "_OptnNb", "_OptnRtrdInstdBal", "_EvtDdlns", "_DfltActn", "_InstdBal", "_OptnTp", "_OptnCancInstrBal", "_OptnPdgInstrBal", "_OptnPrtctInstrBal", "_OptnInstrDtls"]
	@property
