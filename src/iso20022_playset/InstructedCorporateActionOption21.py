...
class InstructedCorporateActionOption21(base_types._BaseFieldType):
	...
	__slots__ = ["_OptnInstrDtls", "_OptnNb", "_OptnPrtctInstrBal", "_InstdBal", "_OptnAccptdInstdBal", "_OptnRtrdInstdBal", "_OptnTp", "_OptnPdgInstrBal", "_OptnCancInstrBal", "_EvtDdlns", "_OptnRjctdInstrBal", "_DfltActn"]
	@property
