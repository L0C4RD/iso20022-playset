...
class CorporateActionRate2(base_types._BaseFieldType):
	...
	__slots__ = ["_WhldgOfLclTax", "_Chrgs", "_XchgRate", "_WhldgTax", "_NewToOd", "_GrmnLclTax1", "_FullyFrnkd", "_AddtlQtyForSbcbdRsltntScties", "_MaxAllwdOvrsbcpt", "_SlctnFee", "_NewSctiesToUndrlygScties", "_NetDvdd", "_GrmnLclTax2", "_GrssDvdd", "_FnlDvdd", "_WhldgOfFrgnTax", "_IndxFctr", "_AddtlTax", "_AddtlQtyForExstgScties", "_GrmnLclTax3", "_TaxRclm", "_RltdTax", "_IntrstForUsdPmt", "_FsclStmp", "_OrgnlAmt", "_TaxOnPrft", "_CshIncntiv", "_NonResdtRate", "_PrvsnlDvdd", "_Prratn", "_AplblRate", "_GrmnLclTax4", "_TaxOnIncm"]
	@property
