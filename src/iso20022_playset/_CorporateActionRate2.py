...
class CorporateActionRate2(base_types._BaseFieldType):
	...
	__slots__ = ["_WhldgOfFrgnTax", "_MaxAllwdOvrsbcpt", "_AddtlTax", "_FsclStmp", "_GrssDvdd", "_NonResdtRate", "_GrmnLclTax1", "_FullyFrnkd", "_TaxRclm", "_Prratn", "_PrvsnlDvdd", "_WhldgOfLclTax", "_NewToOd", "_CshIncntiv", "_AddtlQtyForExstgScties", "_NewSctiesToUndrlygScties", "_GrmnLclTax2", "_FnlDvdd", "_AplblRate", "_TaxOnIncm", "_IndxFctr", "_Chrgs", "_XchgRate", "_WhldgTax", "_GrmnLclTax4", "_RltdTax", "_NetDvdd", "_AddtlQtyForSbcbdRsltntScties", "_GrmnLclTax3", "_OrgnlAmt", "_IntrstForUsdPmt", "_SlctnFee", "_TaxOnPrft"]
	@property
