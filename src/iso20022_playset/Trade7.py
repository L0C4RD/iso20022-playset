...
class Trade7(base_types._BaseFieldType):
	...
	__slots__ = ["_DtConfd", "_ContraCcy", "_FXDtls", "_TradgMtd", "_Symb", "_DealTcktId", "_TradId", "_TradgMd", "_SttlmCcy", "_TrgtCcyOrAmt", "_Optn", "_BaseCcyOrAmt", "_DtAndTm", "_TradgCcy", "_ClrMtd", "_TxTm", "_CmbntnDealTcktId", "_ExctnTp", "_PdctId", "_SwpLeg", "_PlcOfConf", "_FXTradPdct"]
	@property
	def DtConfd(self):
