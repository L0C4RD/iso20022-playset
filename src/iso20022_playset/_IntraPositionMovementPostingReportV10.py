...
from . import FinancialInstrumentDetails47
from . import Pagination1
from . import PartyIdentification127Choice
from . import SecuritiesAccount19
from . import Statement80
...
class IntraPositionMovementPostingReportV10(base_types._BaseFieldType):
	...
	def FinInstrm(self, value):
		self._FinInstrm = value if value is not None else base_types.UninitialisedField(self, 'FinInstrm', FinancialInstrumentDetails47, True)

	@FinInstrm.deleter
	def FinInstrm(self):
		del self._FinInstrm
		self._FinInstrm = base_types.UninitialisedField(self, 'FinInstrm', FinancialInstrumentDetails47, True)
	...
	def StmtGnlDtls(self, value):
		self._StmtGnlDtls = value if value is not None else base_types.UninitialisedField(self, 'StmtGnlDtls', Statement80, False)

	@StmtGnlDtls.deleter
	def StmtGnlDtls(self):
		del self._StmtGnlDtls
		self._StmtGnlDtls = base_types.UninitialisedField(self, 'StmtGnlDtls', Statement80, False)
