...
from . import NotificationRejectionReason2
...
class NotificationAdviceStatus2Choice(base_types._BaseFieldType):
	...
	def RjctdSts(self, value):
		self._RjctdSts = value if value is not None else base_types.UninitialisedField(self, 'RjctdSts', NotificationRejectionReason2, False)

	@RjctdSts.deleter
	def RjctdSts(self):
		del self._RjctdSts
		self._RjctdSts = base_types.UninitialisedField(self, 'RjctdSts', NotificationRejectionReason2, False)
