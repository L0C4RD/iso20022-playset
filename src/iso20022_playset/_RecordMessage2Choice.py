...
class RecordMessage2Choice(base_types._BaseFieldType):
	...
	def NqryVrfctnInitn(self, value):
		self._NqryVrfctnInitn = value if value is not None else base_types.UninitialisedField(self, 'NqryVrfctnInitn', Max2MBBinary, False)

	@NqryVrfctnInitn.deleter
	def NqryVrfctnInitn(self):
		del self._NqryVrfctnInitn
		self._NqryVrfctnInitn = base_types.UninitialisedField(self, 'NqryVrfctnInitn', Max2MBBinary, False)
	...
	def NqryVrfctnRspn(self, value):
		self._NqryVrfctnRspn = value if value is not None else base_types.UninitialisedField(self, 'NqryVrfctnRspn', Max2MBBinary, False)

	@NqryVrfctnRspn.deleter
	def NqryVrfctnRspn(self):
		del self._NqryVrfctnRspn
		self._NqryVrfctnRspn = base_types.UninitialisedField(self, 'NqryVrfctnRspn', Max2MBBinary, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='NqryVrfctnInitn', type=Max2MBBinary, min=0, max=1, mutex_group=1, array=False),
		base_types.FieldEntry(name='NqryVrfctnRspn', type=Max2MBBinary, min=0, max=1, mutex_group=1, array=False),
