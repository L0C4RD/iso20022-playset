...
class BuyerProtectionInstructionCancellationRequestV01(base_types._BaseFieldType):

	__slots__ = ["_AcctId", "_BuyrPrtcnInstrId", "_CorpActnElctn", "_CorpActnGnlInf", "_RltdSttlmInstr", "_SplmtryData"]
	@property
	def AcctId(self):
		return self._AcctId
