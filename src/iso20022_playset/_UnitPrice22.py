...
class UnitPrice22(base_types._BaseFieldType):
	...
	def PricDiffRsn(self, value):
		self._PricDiffRsn = value if value is not None else base_types.UninitialisedField(self, 'PricDiffRsn', Max350Text, False)

	@PricDiffRsn.deleter
	def PricDiffRsn(self):
		del self._PricDiffRsn
		self._PricDiffRsn = base_types.UninitialisedField(self, 'PricDiffRsn', Max350Text, False)
