...
from . import FeeCollectionResponseV04
...
class CAFC_002_001_04():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def FeeColltnRspn(self, value):
			self._FeeColltnRspn = value if value is not None else base_types.UninitialisedField(self, 'FeeColltnRspn', FeeCollectionResponseV04, False)

		@FeeColltnRspn.deleter
		def FeeColltnRspn(self):
			del self._FeeColltnRspn
			self._FeeColltnRspn = base_types.UninitialisedField(self, 'FeeColltnRspn', FeeCollectionResponseV04, False)
