...
from . import SecuritiesCertificate3
...
class RegistrationParameters3(base_types._BaseFieldType):
	...
	def CertNb(self, value):
		self._CertNb = value if value is not None else base_types.UninitialisedField(self, 'CertNb', SecuritiesCertificate3, True)

	@CertNb.deleter
	def CertNb(self):
		del self._CertNb
		self._CertNb = base_types.UninitialisedField(self, 'CertNb', SecuritiesCertificate3, True)
	...
	def CertfctnDtTm(self, value):
		self._CertfctnDtTm = value if value is not None else base_types.UninitialisedField(self, 'CertfctnDtTm', DateAndDateTime1Choice, False)

	@CertfctnDtTm.deleter
	def CertfctnDtTm(self):
		del self._CertfctnDtTm
		self._CertfctnDtTm = base_types.UninitialisedField(self, 'CertfctnDtTm', DateAndDateTime1Choice, False)
