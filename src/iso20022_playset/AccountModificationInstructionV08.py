...
class AccountModificationInstructionV08(base_types._BaseFieldType):
	...
	__slots__ = ["_ModfdAddtlInf", "_ModfdPlcmnt", "_MsgId", "_ModfdSvcLvlAgrmt", "_Xtnsn", "_ModfdAcctPties", "_ModfdIsseAllcn", "_InstrDtls", "_ModfdCshSttlm", "_InvstmtAcctSelctn", "_ModfdWdrwlInvstmtPlan", "_MktPrctcVrsn", "_ModfdInvstmtAcct", "_ModfdIntrmies", "_PrvsRef", "_ModfdSvgsInvstmtPlan"]
	@property
