...
class SubscriptionBulkOrder5(base_types._BaseFieldType):
	...
	__slots__ = ["_OrdrDtTm", "_PlcOfTrad", "_XpryDtTm", "_TtlSttlmAmt", "_ReqdNAVCcy", "_IndvOrdrDtls", "_BlkCshSttlmDtls", "_CxlRght", "_MstrRef", "_FinInstrmDtls", "_ReqdSttlmCcy", "_ReqdFutrTradDt"]
	@property
	def OrdrDtTm(self):
