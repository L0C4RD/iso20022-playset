...
class TaxEfficientProduct7(base_types._BaseFieldType):
	...
	__slots__ = ["_CshCmpntInd", "_CurYr", "_PrvsYrSbcptAmt", "_InvstrTaxRef", "_InvstmtsToFllwVal", "_WdrwlForResdtlPurchsPrgrs", "_TaxEffcntPdctTp", "_UusdTaxDdctn", "_LwstInvstdAmtCurYr", "_DtOfFrstSbcpt", "_DtFrstQlfygAddtn", "_EstmtdVal", "_BnsOrWdrwl", "_CurYrSbcptDtls", "_PrvsYrs", "_PrvsYrsSbcptAmt", "_TrfrAltrnId", "_AddtlInf", "_TtlSbcptAmt", "_TaxClctnBase", "_OthrAmt", "_CurInvstmtAmt", "_InnvtvFinc"]
	@property
