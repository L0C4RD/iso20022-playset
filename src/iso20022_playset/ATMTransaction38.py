...
class ATMTransaction38(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctTo", "_AcctFr", "_TxId", "_DtldReqdAmt", "_ReqdExctnDt", "_ReqdRct", "_PmtRef", "_DbtrLabl", "_RcrngTrf", "_PrtctdAcctTo", "_InstntTrfPrgm", "_CdtrLabl", "_PrtctdAcctFr", "_ICCRltdData", "_TtlReqdAmt", "_RcncltnId"]
	@property
	def AcctTo(self):
		return self._AcctTo
