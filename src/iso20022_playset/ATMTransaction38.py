...
class ATMTransaction38(base_types._BaseFieldType):
	...
	__slots__ = ["_TxId", "_PrtctdAcctFr", "_ReqdRct", "_TtlReqdAmt", "_PmtRef", "_CdtrLabl", "_AcctFr", "_ReqdExctnDt", "_DbtrLabl", "_RcrngTrf", "_ICCRltdData", "_DtldReqdAmt", "_InstntTrfPrgm", "_AcctTo", "_PrtctdAcctTo", "_RcncltnId"]
	@property
	def TxId(self):
		return self._TxId
