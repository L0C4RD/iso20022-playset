...
from . import ProcessedStatus3FormatChoice

class CorporateActionStandingInstructionProcessingStatus1(base_types._BaseFieldType):
	...
	@Sts.setter
	def Sts(self, value):
		self._Sts = value if value is not None else base_types.UninitialisedField(self, 'Sts', ProcessedStatus3FormatChoice, False)

	@Sts.deleter
	def Sts(self):
		del self._Sts
		self._Sts = base_types.UninitialisedField(self, 'Sts', ProcessedStatus3FormatChoice, False)
