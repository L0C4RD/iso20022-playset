...
from . import CorporateActionMovementConfirmationV16
...
class SEEV_036_001_16():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def CorpActnMvmntConf(self, value):
			self._CorpActnMvmntConf = value if value is not None else base_types.UninitialisedField(self, 'CorpActnMvmntConf', CorporateActionMovementConfirmationV16, False)

		@CorpActnMvmntConf.deleter
		def CorpActnMvmntConf(self):
			del self._CorpActnMvmntConf
			self._CorpActnMvmntConf = base_types.UninitialisedField(self, 'CorpActnMvmntConf', CorporateActionMovementConfirmationV16, False)
