...
class Transaction127(base_types._BaseFieldType):
	...
	__slots__ = ["_PrcrTxId", "_TrptyAgtSvcPrvdrCollTxId", "_TrptyAgtSvcPrvdrCollInstrId", "_CorpActnEvtId", "_AcctOwnrTxId", "_TradId", "_ClntCollInstrId", "_CtrPtyMktInfrstrctrTxId", "_CmonId", "_PoolId", "_MktInfrstrctrTxId", "_TxDtls", "_AcctSvcrTxId", "_ClntTrptyCollTxId"]
	@property
	def PrcrTxId(self):
