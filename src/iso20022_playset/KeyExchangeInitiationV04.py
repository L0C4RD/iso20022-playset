...
class KeyExchangeInitiationV04(base_types._BaseFieldType):
	...
	__slots__ = ["_Jursdctn", "_OthrKeyXchgTp", "_SplmtryData", "_AddtlData", "_Hdr", "_SttlmSvc", "_SysTracAudtNb", "_KeyXchgFctn", "_RtrvlRefNb", "_Prgrmm", "_TrnsmssnDtTm", "_KeyXchgTp", "_KeyXchgData", "_AltrnMsgRsn", "_Rcncltn", "_PrcgRslt", "_SctyTrlr", "_MsgRsn", "_PrtctdData", "_LifeCyclId", "_AddtlFee", "_OthrKeyXchgFctn"]
	@property
	def Jursdctn(self):
