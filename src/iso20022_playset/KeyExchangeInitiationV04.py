...
class KeyExchangeInitiationV04(base_types._BaseFieldType):
	...
	__slots__ = ["_Hdr", "_AddtlData", "_AltrnMsgRsn", "_Rcncltn", "_PrtctdData", "_RtrvlRefNb", "_Prgrmm", "_PrcgRslt", "_OthrKeyXchgFctn", "_LifeCyclId", "_KeyXchgFctn", "_TrnsmssnDtTm", "_KeyXchgData", "_OthrKeyXchgTp", "_MsgRsn", "_Jursdctn", "_SplmtryData", "_KeyXchgTp", "_SctyTrlr", "_SttlmSvc", "_AddtlFee", "_SysTracAudtNb"]
	@property
	def Hdr(self):
		return self._Hdr
