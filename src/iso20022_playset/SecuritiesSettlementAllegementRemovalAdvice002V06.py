...
class SecuritiesSettlementAllegementRemovalAdvice002V06(base_types._BaseFieldType):
	...
	__slots__ = ["_BlckChainAdrOrWllt", "_AcctOwnr", "_SplmtryData", "_AcctSvcrTxId", "_MktInfrstrctrTxId", "_CtrPtyMktInfrstrctrTxId", "_TxDtls", "_SfkpgAcct"]
	@property
