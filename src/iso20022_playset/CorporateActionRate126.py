...
class CorporateActionRate126(base_types._BaseFieldType):
	...
	__slots__ = ["_TaxOnIncm", "_AddtlTax", "_PrratnRate", "_TaxblIncmPerDvddShr", "_IssrDclrdXchgRate", "_GrssDstrbtnRate", "_NetDstrbtnRate", "_ScndLvlTax", "_BidIntrvl", "_MaxAllwdOvrsbcptRate", "_WhldgTaxRate", "_GrssIntrstRateUsdForPmt"]
	@property
	def TaxOnIncm(self):
