...
class CorporateActionRate126(base_types._BaseFieldType):
	...
	__slots__ = ["_GrssIntrstRateUsdForPmt", "_MaxAllwdOvrsbcptRate", "_NetDstrbtnRate", "_TaxOnIncm", "_GrssDstrbtnRate", "_IssrDclrdXchgRate", "_AddtlTax", "_BidIntrvl", "_PrratnRate", "_TaxblIncmPerDvddShr", "_WhldgTaxRate", "_ScndLvlTax"]
	@property
