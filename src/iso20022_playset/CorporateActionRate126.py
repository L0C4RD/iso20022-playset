...
import GrossDividendRateFormat36Choice

class CorporateActionRate126(base_types._BaseFieldType):

	__slots__ = ["_AddtlTax", "_TaxOnIncm", "_BidIntrvl", "_MaxAllwdOvrsbcptRate", "_IssrDclrdXchgRate", "_ScndLvlTax", "_GrssDstrbtnRate", "_GrssIntrstRateUsdForPmt", "_PrratnRate", "_WhldgTaxRate", "_NetDstrbtnRate", "_TaxblIncmPerDvddShr"]
	@property
	def AddtlTax(self):
