...
class CorporateActionRate126(base_types._BaseFieldType):
	...
	__slots__ = ["_TaxblIncmPerDvddShr", "_AddtlTax", "_GrssIntrstRateUsdForPmt", "_GrssDstrbtnRate", "_IssrDclrdXchgRate", "_MaxAllwdOvrsbcptRate", "_TaxOnIncm", "_PrratnRate", "_NetDstrbtnRate", "_BidIntrvl", "_ScndLvlTax", "_WhldgTaxRate"]
	@property
