...
from . import GenericDocumentIdentification5
...
class References59Choice(base_types._BaseFieldType):
	...
	def OthrTxId(self, value):
		self._OthrTxId = value if value is not None else base_types.UninitialisedField(self, 'OthrTxId', GenericDocumentIdentification5, False)

	@OthrTxId.deleter
	def OthrTxId(self):
		del self._OthrTxId
		self._OthrTxId = base_types.UninitialisedField(self, 'OthrTxId', GenericDocumentIdentification5, False)
