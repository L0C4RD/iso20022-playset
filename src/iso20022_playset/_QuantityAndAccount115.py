...
class QuantityAndAccount115(base_types._BaseFieldType):
	...
	__slots__ = ["_PrevslySttldQty", "_DnmtnChc", "_SfkpgPlc", "_QtyBrkdwn", "_SfkpgAcct", "_RmngToBeSttldQty", "_CshAcct", "_RmngToBeSttldAmt", "_AcctOwnr", "_SttldQty", "_BlckChainAdrOrWllt", "_PrevslySttldAmt"]
	@property
