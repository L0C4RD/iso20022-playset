...
from ._AccountSubLevel17 import AccountSubLevel17

class AccountSubLevel16(base_types._BaseFieldType):

	__slots__ = ["_BalDtls", "_AcctId", "_AcctSubLvl7", "_AcctOwnr", "_BnfclOwnr", "_AcctSubLvl7Diff", "_SplmtryData", "_AcctSvcr"]
	@property
	def AcctId(self):
		return self._AcctId
	...
	def AcctSubLvl7(self, value):
		self._AcctSubLvl7 = value if type(value) != base_types.auto else self.make_default("AcctSubLvl7")
	...
	def AcctSubLvl7Diff(self, value):
		self._AcctSubLvl7Diff = value if type(value) != base_types.auto else self.make_default("AcctSubLvl7Diff")
