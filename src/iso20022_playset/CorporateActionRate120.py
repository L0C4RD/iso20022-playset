...
import GrossDividendRateFormat35Choice
import RateAndAmountFormat55Choice
import NetDividendRateFormat37Choice

class CorporateActionRate120(base_types._BaseFieldType):

	__slots__ = ["_ScndLvlTax", "_MaxAllwdOvrsbcptRate", "_AddtlTax", "_NetDstrbtnRate", "_PrratnRate", "_GrssIntrstRateUsdForPmt", "_WhldgTaxRate", "_GrssDstrbtnRate", "_TaxblIncmPerDvddShr"]
	@property
	def ScndLvlTax(self):
