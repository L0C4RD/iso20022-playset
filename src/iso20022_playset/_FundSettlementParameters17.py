...
from . import SettlementParties94
...
class FundSettlementParameters17(base_types._BaseFieldType):
	...
	def DlvrgSdDtls(self, value):
		self._DlvrgSdDtls = value if value is not None else base_types.UninitialisedField(self, 'DlvrgSdDtls', SettlementParties94, False)

	@DlvrgSdDtls.deleter
	def DlvrgSdDtls(self):
		del self._DlvrgSdDtls
		self._DlvrgSdDtls = base_types.UninitialisedField(self, 'DlvrgSdDtls', SettlementParties94, False)
	...
	def RcvgSdDtls(self, value):
		self._RcvgSdDtls = value if value is not None else base_types.UninitialisedField(self, 'RcvgSdDtls', SettlementParties94, False)

	@RcvgSdDtls.deleter
	def RcvgSdDtls(self):
		del self._RcvgSdDtls
		self._RcvgSdDtls = base_types.UninitialisedField(self, 'RcvgSdDtls', SettlementParties94, False)
