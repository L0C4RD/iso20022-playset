...
import AdditionalReference12
import TransactionDetails165

class Transaction126(base_types._BaseFieldType):

	__slots__ = ["_PoolId", "_ClntTrptyCollTxId", "_PrcrTxId", "_TrptyAgtSvcPrvdrCollTxId", "_MktInfrstrctrTxId", "_AcctSvcrLegId", "_TradId", "_AcctSvcrTxId", "_MstrRef", "_AcctOwnrTxId", "_TxDtls", "_AcctOwnrLegId", "_ClntCollInstrId", "_SplmtryData", "_CtrPtyMktInfrstrctrTxId", "_CorpActnEvtId", "_TrptyAgtSvcPrvdrCollInstrId", "_CmonId", "_ClntRef"]
	@property
	def PoolId(self):
		return self._PoolId
