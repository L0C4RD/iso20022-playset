...
class Transaction126(base_types._BaseFieldType):
	...
	__slots__ = ["_TxDtls", "_AcctSvcrTxId", "_ClntTrptyCollTxId", "_AcctSvcrLegId", "_CtrPtyMktInfrstrctrTxId", "_MktInfrstrctrTxId", "_AcctOwnrLegId", "_CmonId", "_AcctOwnrTxId", "_PrcrTxId", "_SplmtryData", "_TradId", "_MstrRef", "_ClntRef", "_TrptyAgtSvcPrvdrCollInstrId", "_CorpActnEvtId", "_PoolId", "_TrptyAgtSvcPrvdrCollTxId", "_ClntCollInstrId"]
	@property
	def TxDtls(self):
		return self._TxDtls
