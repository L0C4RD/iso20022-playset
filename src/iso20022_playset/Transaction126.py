...
class Transaction126(base_types._BaseFieldType):
	...
	__slots__ = ["_CmonId", "_PrcrTxId", "_TrptyAgtSvcPrvdrCollInstrId", "_ClntTrptyCollTxId", "_CorpActnEvtId", "_PoolId", "_CtrPtyMktInfrstrctrTxId", "_ClntRef", "_ClntCollInstrId", "_MktInfrstrctrTxId", "_TrptyAgtSvcPrvdrCollTxId", "_AcctSvcrLegId", "_AcctSvcrTxId", "_SplmtryData", "_AcctOwnrLegId", "_AcctOwnrTxId", "_TradId", "_TxDtls", "_MstrRef"]
	@property
	def CmonId(self):
		return self._CmonId
