...
class SecuritiesSettlementTransactionGenerationNotificationV12(base_types._BaseFieldType):
	...
	__slots__ = ["_DgtlNtwkFee", "_OthrAmts", "_GnrtdRsn", "_RcvgSttlmPties", "_DlvrgSttlmPties", "_FinInstrmId", "_StsAndRsn", "_AddtlPhysOrRegnDtls", "_Lnkgs", "_SttlmParams", "_TxIdDtls", "_NbCounts", "_OthrBizPties", "_SplmtryData", "_QtyAndAcctDtls", "_FinInstrmAttrbts", "_TradDtls", "_CshPties", "_SttlmAmt"]
	@property
