...
class SecuritiesSettlementTransactionGenerationNotificationV12(base_types._BaseFieldType):
	...
	__slots__ = ["_RcvgSttlmPties", "_SttlmParams", "_StsAndRsn", "_OthrBizPties", "_QtyAndAcctDtls", "_OthrAmts", "_SttlmAmt", "_DgtlNtwkFee", "_TxIdDtls", "_Lnkgs", "_GnrtdRsn", "_AddtlPhysOrRegnDtls", "_CshPties", "_TradDtls", "_FinInstrmId", "_SplmtryData", "_DlvrgSttlmPties", "_FinInstrmAttrbts", "_NbCounts"]
	@property
