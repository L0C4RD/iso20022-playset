...
class SecuritiesSettlementTransactionGenerationNotificationV12(base_types._BaseFieldType):
	...
	__slots__ = ["_TradDtls", "_FinInstrmId", "_SttlmAmt", "_DgtlNtwkFee", "_DlvrgSttlmPties", "_QtyAndAcctDtls", "_CshPties", "_OthrAmts", "_NbCounts", "_Lnkgs", "_RcvgSttlmPties", "_SttlmParams", "_TxIdDtls", "_StsAndRsn", "_AddtlPhysOrRegnDtls", "_OthrBizPties", "_FinInstrmAttrbts", "_SplmtryData", "_GnrtdRsn"]
	@property
	def TradDtls(self):
