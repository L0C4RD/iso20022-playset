...
class SecuritiesSettlementTransactionGenerationNotificationV12(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmAmt", "_SplmtryData", "_QtyAndAcctDtls", "_TradDtls", "_CshPties", "_DgtlNtwkFee", "_FinInstrmId", "_GnrtdRsn", "_RcvgSttlmPties", "_NbCounts", "_TxIdDtls", "_SttlmParams", "_OthrAmts", "_FinInstrmAttrbts", "_AddtlPhysOrRegnDtls", "_Lnkgs", "_DlvrgSttlmPties", "_OthrBizPties", "_StsAndRsn"]
	@property
	def SttlmAmt(self):
