...
from . import SettlementTransactionCondition44Choice
...
class SettlementDetails225(base_types._BaseFieldType):
	...
	def SttlmTxCond(self, value):
		self._SttlmTxCond = value if value is not None else base_types.UninitialisedField(self, 'SttlmTxCond', SettlementTransactionCondition44Choice, True)

	@SttlmTxCond.deleter
	def SttlmTxCond(self):
		del self._SttlmTxCond
		self._SttlmTxCond = base_types.UninitialisedField(self, 'SttlmTxCond', SettlementTransactionCondition44Choice, True)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='SttlmTxCond', type=SettlementTransactionCondition44Choice, min=0, max=None, mutex_group=None, array=True),
