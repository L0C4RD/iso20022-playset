...
class InvestmentAccount75(base_types._BaseFieldType):
	...
	__slots__ = ["_TaxRptg", "_RndgDtls", "_TaxXmptn", "_AcctUsgTp", "_IncmPref", "_Lang", "_TaxWhldgMtd", "_StmtFrqcy", "_BlckdSts", "_FrgnStsCertfctn", "_Nm", "_RefCcy", "_LttrInttDtls", "_InvstmtAcctCtgy", "_Dsgnt", "_ReqrdSgntriesNb", "_Pldgg", "_ModfdInvstrPrfl", "_AcmltnRghtRef", "_Coll", "_ClsgDt", "_Tp", "_ModfdFinInstrmDtls", "_TxChanlTp", "_FsclYr", "_AcctStsUpdInstr", "_NegInd", "_AcctSgntrDtTm", "_AcctgSts", "_AcctSvcr", "_FndFmlyNm", "_PwrOfAttnyLvlOfCtrl", "_ThrdPtyRghts", "_Lblty", "_RinvstmtDtls", "_OwnrshTp", "_PrcgOrdr", "_OpngDt"]
	@property
	def TaxRptg(self):
