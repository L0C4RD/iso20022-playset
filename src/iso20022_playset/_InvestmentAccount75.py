...
class InvestmentAccount75(base_types._BaseFieldType):
	...
	__slots__ = ["_BlckdSts", "_FndFmlyNm", "_ThrdPtyRghts", "_PrcgOrdr", "_NegInd", "_TaxXmptn", "_StmtFrqcy", "_ModfdFinInstrmDtls", "_RinvstmtDtls", "_FsclYr", "_LttrInttDtls", "_FrgnStsCertfctn", "_InvstmtAcctCtgy", "_RndgDtls", "_TxChanlTp", "_AcctStsUpdInstr", "_Tp", "_AcmltnRghtRef", "_AcctUsgTp", "_AcctSgntrDtTm", "_ReqrdSgntriesNb", "_Dsgnt", "_ClsgDt", "_OwnrshTp", "_RefCcy", "_Coll", "_Lang", "_IncmPref", "_AcctSvcr", "_PwrOfAttnyLvlOfCtrl", "_Nm", "_Pldgg", "_Lblty", "_AcctgSts", "_OpngDt", "_TaxWhldgMtd", "_ModfdInvstrPrfl", "_TaxRptg"]
	@property
	def BlckdSts(self):
