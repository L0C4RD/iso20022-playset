...
from .PortfolioTransfer13 import PortfolioTransfer13
...
from .PartyIdentification309 import PartyIdentification309
from .InvestmentAccount69 import InvestmentAccount69

class PortfolioTransferCompletionV01(base_types._BaseFieldType):

	__slots__ = ["_Xtnsn", "_ScndryCorpInvstr", "_PmryIndvInvstr", "_RltdRef", "_OthrCorpInvstr", "_RegdHldr", "_MsgRef", "_PrvsRef", "_MktPrctcVrsn", "_PmryCorpInvstr", "_ScndryIndvInvstr", "_PoolRef", "_TrfrAcct", "_Trfee", "_OthrIndvInvstr", "_PdctTrf", "_NmneeAcct"]
	@property
	def Xtnsn(self):
		return self._Xtnsn
