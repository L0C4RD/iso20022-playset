import base_types
import PartyIdentification309
import MarketPracticeVersion1
import PortfolioTransfer13
...
class PortfolioTransferCompletionV01(base_types._BaseFieldType):
	...
	__slots__ = ["_PdctTrf", "_MsgRef", "_RegdHldr", "_TrfrAcct", "_Xtnsn", "_RltdRef", "_NmneeAcct", "_PoolRef", "_PmryIndvInvstr", "_Trfee", "_PrvsRef", "_OthrCorpInvstr", "_ScndryIndvInvstr", "_MktPrctcVrsn", "_PmryCorpInvstr", "_ScndryCorpInvstr", "_OthrIndvInvstr"]
	@property
	def PdctTrf(self):
