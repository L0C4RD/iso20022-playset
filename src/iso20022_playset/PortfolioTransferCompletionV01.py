...
class PortfolioTransferCompletionV01(base_types._BaseFieldType):
	...
	__slots__ = ["_PmryCorpInvstr", "_Xtnsn", "_OthrCorpInvstr", "_RegdHldr", "_TrfrAcct", "_MsgRef", "_PoolRef", "_ScndryCorpInvstr", "_MktPrctcVrsn", "_PmryIndvInvstr", "_PdctTrf", "_RltdRef", "_Trfee", "_OthrIndvInvstr", "_NmneeAcct", "_PrvsRef", "_ScndryIndvInvstr"]
	@property
