...
class PortfolioTransferCompletionV01(base_types._BaseFieldType):
	...
	__slots__ = ["_PdctTrf", "_Trfee", "_OthrCorpInvstr", "_PmryCorpInvstr", "_MktPrctcVrsn", "_RegdHldr", "_PoolRef", "_RltdRef", "_PmryIndvInvstr", "_TrfrAcct", "_MsgRef", "_OthrIndvInvstr", "_PrvsRef", "_ScndryIndvInvstr", "_NmneeAcct", "_ScndryCorpInvstr", "_Xtnsn"]
	@property
	def PdctTrf(self):
