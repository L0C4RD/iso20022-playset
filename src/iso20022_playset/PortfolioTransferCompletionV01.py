...
class PortfolioTransferCompletionV01(base_types._BaseFieldType):
	...
	__slots__ = ["_PmryCorpInvstr", "_Trfee", "_PmryIndvInvstr", "_RegdHldr", "_Xtnsn", "_PrvsRef", "_TrfrAcct", "_ScndryIndvInvstr", "_RltdRef", "_PoolRef", "_NmneeAcct", "_ScndryCorpInvstr", "_MsgRef", "_OthrCorpInvstr", "_PdctTrf", "_MktPrctcVrsn", "_OthrIndvInvstr"]
	@property
