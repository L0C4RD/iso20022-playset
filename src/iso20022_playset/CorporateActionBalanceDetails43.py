...
from .TotalEligibleBalanceFormat10 import TotalEligibleBalanceFormat10
from .BalanceFormat12Choice import BalanceFormat12Choice

class CorporateActionBalanceDetails43(base_types._BaseFieldType):

	__slots__ = ["_TradDtPosBal", "_RegdBal", "_OnLnBal", "_SttlmPosBal", "_UafctdBal", "_OutForRegnBal", "_InstdBal", "_TtlElgblBal", "_UinstdBal", "_StrtPosBal", "_BrrwdBal", "_OblgtdBal", "_CollOutBal", "_PdgRctBal", "_InTrnsShipmntBal", "_BlckdBal", "_CollInBal", "_AfctdBal", "_PdgDlvryBal"]
	@property
