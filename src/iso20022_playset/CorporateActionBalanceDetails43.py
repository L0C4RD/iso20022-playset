...
class CorporateActionBalanceDetails43(base_types._BaseFieldType):
	...
	__slots__ = ["_CollOutBal", "_OutForRegnBal", "_AfctdBal", "_StrtPosBal", "_UinstdBal", "_CollInBal", "_PdgRctBal", "_SttlmPosBal", "_RegdBal", "_OnLnBal", "_InstdBal", "_BlckdBal", "_TtlElgblBal", "_UafctdBal", "_OblgtdBal", "_PdgDlvryBal", "_BrrwdBal", "_InTrnsShipmntBal", "_TradDtPosBal"]
	@property
	def CollOutBal(self):
