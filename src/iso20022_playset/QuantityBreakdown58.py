...
from .BalanceAmounts2 import BalanceAmounts2
from .Balance16 import Balance16
...
class QuantityBreakdown58(base_types._BaseFieldType):
	...
	__slots__ = ["_LotQty", "_LotPric", "_TpOfPric", "_LotDtTm", "_LotNb", "_InstrmCcyAmts", "_AcctBaseCcyAmts", "_AltrnRptgCcyAmts"]
	@property
	def LotQty(self):
		return self._LotQty
