...
class FraudDispositionResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_Acqrr", "_SctyTrlr", "_OrgnlRspnCd", "_Hdr", "_AddtlData", "_Rcvr", "_Sndr", "_Dstn", "_Crdhldr", "_Issr", "_Card", "_FrdTxId", "_Rcncltn", "_AddtlFee", "_Tkn", "_Jursdctn", "_PrcgRslt", "_Orgtr", "_Prgrmm", "_SttlmSvc", "_PrtctdData"]
	@property
