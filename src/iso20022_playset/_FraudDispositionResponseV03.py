...
class FraudDispositionResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Issr", "_Orgtr", "_Prgrmm", "_Tkn", "_Crdhldr", "_Hdr", "_OrgnlRspnCd", "_PrcgRslt", "_Jursdctn", "_Acqrr", "_AddtlFee", "_Rcvr", "_SttlmSvc", "_PrtctdData", "_SctyTrlr", "_Dstn", "_Sndr", "_Card", "_Rcncltn", "_AddtlData", "_FrdTxId", "_SplmtryData"]
	@property
	def Issr(self):
		return self._Issr
