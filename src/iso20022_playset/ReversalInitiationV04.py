...
class ReversalInitiationV04(base_types._BaseFieldType):
	...
	__slots__ = ["_ICCRltdData", "_SctyTrlr", "_Hdr", "_Cntxt", "_Orgtr", "_Acqrr", "_PrcgRslt", "_Jursdctn", "_Rcvr", "_Pyee", "_Accptr", "_Dstn", "_AddtlAmt", "_Rcncltn", "_TxChrtcs", "_Issr", "_DpstDtls", "_SplmtryData", "_FndsSvcs", "_Pyer", "_AddtlData", "_Sndr", "_TxId", "_Termnl", "_AddtlSvc", "_AcctFr", "_Wllt", "_AcctTo", "_OrgnlDataElmts", "_Card", "_SpclPrgrmmQlfctn", "_TxAmts", "_Prgrmm", "_AddtlFee", "_SttlmSvc", "_PrtctdData", "_ConvsDtTm", "_Tkn", "_AcctBal"]
	@property
