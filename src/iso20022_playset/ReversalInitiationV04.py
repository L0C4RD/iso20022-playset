...
class ReversalInitiationV04(base_types._BaseFieldType):
	...
	__slots__ = ["_Card", "_PrcgRslt", "_DpstDtls", "_AddtlData", "_Accptr", "_Issr", "_TxId", "_Acqrr", "_Dstn", "_Termnl", "_SplmtryData", "_Hdr", "_Pyer", "_Prgrmm", "_AcctFr", "_AddtlSvc", "_Rcvr", "_AddtlAmt", "_Rcncltn", "_ConvsDtTm", "_TxAmts", "_Tkn", "_SttlmSvc", "_Wllt", "_SctyTrlr", "_Orgtr", "_AddtlFee", "_Pyee", "_Jursdctn", "_TxChrtcs", "_AcctTo", "_OrgnlDataElmts", "_PrtctdData", "_FndsSvcs", "_ICCRltdData", "_AcctBal", "_Cntxt", "_Sndr", "_SpclPrgrmmQlfctn"]
	@property
	def Card(self):
		return self._Card
