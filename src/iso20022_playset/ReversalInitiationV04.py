...
class ReversalInitiationV04(base_types._BaseFieldType):
	...
	__slots__ = ["_TxAmts", "_AcctTo", "_Prgrmm", "_Tkn", "_Dstn", "_PrtctdData", "_DpstDtls", "_PrcgRslt", "_AcctBal", "_Rcvr", "_FndsSvcs", "_Jursdctn", "_Wllt", "_Orgtr", "_SctyTrlr", "_Termnl", "_Hdr", "_Pyee", "_Accptr", "_AddtlFee", "_Sndr", "_ICCRltdData", "_OrgnlDataElmts", "_AddtlData", "_Rcncltn", "_SpclPrgrmmQlfctn", "_SttlmSvc", "_AcctFr", "_Issr", "_TxId", "_Pyer", "_AddtlAmt", "_Cntxt", "_SplmtryData", "_TxChrtcs", "_Acqrr", "_Card", "_ConvsDtTm", "_AddtlSvc"]
	@property
	def TxAmts(self):
		return self._TxAmts
