...
class ReversalInitiationV04(base_types._BaseFieldType):
	...
	__slots__ = ["_FndsSvcs", "_PrtctdData", "_AddtlSvc", "_Prgrmm", "_ConvsDtTm", "_Termnl", "_ICCRltdData", "_SpclPrgrmmQlfctn", "_Rcncltn", "_Accptr", "_AddtlData", "_Card", "_Issr", "_OrgnlDataElmts", "_AcctBal", "_Wllt", "_TxAmts", "_Acqrr", "_Hdr", "_Dstn", "_PrcgRslt", "_Rcvr", "_Jursdctn", "_Cntxt", "_Pyee", "_SttlmSvc", "_Sndr", "_Pyer", "_DpstDtls", "_AddtlFee", "_TxId", "_SplmtryData", "_AcctFr", "_Tkn", "_TxChrtcs", "_Orgtr", "_AddtlAmt", "_AcctTo", "_SctyTrlr"]
	@property
	def FndsSvcs(self):
