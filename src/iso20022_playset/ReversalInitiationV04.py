...
class ReversalInitiationV04(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_TxAmts", "_Accptr", "_AcctTo", "_Pyee", "_AddtlSvc", "_ICCRltdData", "_Dstn", "_AddtlData", "_PrcgRslt", "_Termnl", "_Acqrr", "_Hdr", "_SctyTrlr", "_AddtlAmt", "_AddtlFee", "_Card", "_Issr", "_OrgnlDataElmts", "_Orgtr", "_Sndr", "_SpclPrgrmmQlfctn", "_AcctFr", "_AcctBal", "_Pyer", "_Cntxt", "_Wllt", "_TxId", "_Rcvr", "_DpstDtls", "_ConvsDtTm", "_FndsSvcs", "_Rcncltn", "_Jursdctn", "_Tkn", "_PrtctdData", "_SttlmSvc", "_Prgrmm", "_TxChrtcs"]
	@property
