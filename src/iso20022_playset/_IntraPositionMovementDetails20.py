...
class IntraPositionMovementDetails20(base_types._BaseFieldType):
	...
	__slots__ = ["_CollMntrAmt", "_PrevslySttldQty", "_AckdStsTmStmp", "_CorpActnEvtTp", "_SttldQty", "_Id", "_BalTo", "_SctiesSubBalId", "_SttlmDt", "_AvlblDt", "_RmngToBeSttldQty", "_SplmtryData", "_InstrPrcgAddtlDtls"]
	@property
