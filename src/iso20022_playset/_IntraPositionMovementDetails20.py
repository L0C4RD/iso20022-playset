...
class IntraPositionMovementDetails20(base_types._BaseFieldType):
	...
	__slots__ = ["_AckdStsTmStmp", "_SctiesSubBalId", "_CorpActnEvtTp", "_SplmtryData", "_Id", "_AvlblDt", "_PrevslySttldQty", "_SttlmDt", "_RmngToBeSttldQty", "_SttldQty", "_CollMntrAmt", "_InstrPrcgAddtlDtls", "_BalTo"]
	@property
