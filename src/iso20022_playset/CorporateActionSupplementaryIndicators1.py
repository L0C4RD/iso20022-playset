...
class CorporateActionSupplementaryIndicators1(base_types._BaseFieldType):
	...
	__slots__ = ["_CondlPmtAplblInd", "_RghtsRndUpPrvlgInd", "_RghtsOvrsbcptInd", "_SlctnDealrFeeInd", "_RghtsTrfblInd", "_SrrndrShrsToAgtInd", "_EscrwToMtrtyInd", "_StepUpPrvlgInd"]
	@property
