...
class Pension5(base_types._BaseFieldType):
	...
	__slots__ = ["_BlckTrf", "_BlckTrfRef", "_LftmAllwncPrtcn", "_NonSfgrddGrntedBnfts", "_TrfScp", "_TaxRef", "_LumpSumTp", "_BnftCrstllstnEvtOcrd", "_NbOfDrwdwnTrnchs", "_TaxFreeCshPrtcn", "_Id", "_DrwdwnSts", "_DrwdwnTrchId", "_DrwdwnTp", "_NonWrpprTrf", "_ValOfPnsnPlcyOrPlanOrSchme", "_EstmtdVal", "_TaxFreeCshAmt", "_ClntLftmAllwncPrtcn", "_MnyPurchsAnlAllwnc", "_PnsnOrdr", "_SfgrdBnft", "_RtrmntAgePrtcn", "_RingFncdDrwdwnAssts", "_AddtlInf", "_Shrg", "_RtrmntAge", "_Tp"]
	@property
	def BlckTrf(self):
