...
class SaleContext4(base_types._BaseFieldType):
	...
	__slots__ = ["_ShftNb", "_AddtlSaleData", "_AllwdNtryMd", "_CshrLang", "_SaleRefNb", "_CshrId", "_InvcNb", "_SaleRcncltnId", "_SaleTknScp", "_PurchsOrdrNb", "_ForceOnlnFlg", "_RmngAmt", "_CstmrOrdrReqFlg", "_DlvryNoteNb", "_SaleId", "_SpltPmt", "_SpnsrdMrchnt", "_ReuseCardDataFlg"]
	@property
	def ShftNb(self):
		return self._ShftNb
