...
class SaleContext4(base_types._BaseFieldType):
	...
	__slots__ = ["_SaleRefNb", "_AllwdNtryMd", "_SaleRcncltnId", "_CstmrOrdrReqFlg", "_ForceOnlnFlg", "_SpnsrdMrchnt", "_CshrLang", "_InvcNb", "_SaleId", "_ShftNb", "_RmngAmt", "_PurchsOrdrNb", "_ReuseCardDataFlg", "_DlvryNoteNb", "_SaleTknScp", "_AddtlSaleData", "_CshrId", "_SpltPmt"]
	@property
	def SaleRefNb(self):
