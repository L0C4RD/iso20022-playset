...
class SaleContext4(base_types._BaseFieldType):
	...
	__slots__ = ["_SpnsrdMrchnt", "_InvcNb", "_AllwdNtryMd", "_AddtlSaleData", "_SaleRcncltnId", "_PurchsOrdrNb", "_CstmrOrdrReqFlg", "_SaleTknScp", "_CshrLang", "_SpltPmt", "_SaleRefNb", "_ShftNb", "_ForceOnlnFlg", "_DlvryNoteNb", "_SaleId", "_ReuseCardDataFlg", "_CshrId", "_RmngAmt"]
	@property
