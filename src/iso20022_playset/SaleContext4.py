...
class SaleContext4(base_types._BaseFieldType):
	...
	__slots__ = ["_ForceOnlnFlg", "_CstmrOrdrReqFlg", "_AddtlSaleData", "_SaleRefNb", "_DlvryNoteNb", "_SaleId", "_CshrLang", "_CshrId", "_AllwdNtryMd", "_ShftNb", "_SpnsrdMrchnt", "_ReuseCardDataFlg", "_InvcNb", "_SaleTknScp", "_RmngAmt", "_SaleRcncltnId", "_PurchsOrdrNb", "_SpltPmt"]
	@property
