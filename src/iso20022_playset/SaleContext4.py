...
class SaleContext4(base_types._BaseFieldType):
	...
	__slots__ = ["_CshrId", "_ShftNb", "_AddtlSaleData", "_SaleRefNb", "_DlvryNoteNb", "_ReuseCardDataFlg", "_SpltPmt", "_PurchsOrdrNb", "_CstmrOrdrReqFlg", "_SaleRcncltnId", "_SaleTknScp", "_AllwdNtryMd", "_SpnsrdMrchnt", "_ForceOnlnFlg", "_InvcNb", "_RmngAmt", "_SaleId", "_CshrLang"]
	@property
	def CshrId(self):
		return self._CshrId
