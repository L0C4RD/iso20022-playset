...
class PartyTextInformation3(base_types._BaseFieldType):
	...
	def RegnDtls(self, value):
		self._RegnDtls = value if value is not None else base_types.UninitialisedField(self, 'RegnDtls', RestrictedFINXMax350Text, False)

	@RegnDtls.deleter
	def RegnDtls(self):
		del self._RegnDtls
		self._RegnDtls = base_types.UninitialisedField(self, 'RegnDtls', RestrictedFINXMax350Text, False)
