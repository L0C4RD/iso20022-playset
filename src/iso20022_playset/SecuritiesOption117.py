...
from .SafekeepingPlaceFormat56Choice import SafekeepingPlaceFormat56Choice
from .NewSecuritiesIssuanceType5Code import NewSecuritiesIssuanceType5Code
from .SecurityDate24 import SecurityDate24
...
from .CorporateActionRate137 import CorporateActionRate137
from .FinancialInstrumentAttributes137 import FinancialInstrumentAttributes137
from .CorporateActionPrice98 import CorporateActionPrice98
...
class SecuritiesOption117(base_types._BaseFieldType):
	...
	__slots__ = ["_XmptnTp", "_IncmTp", "_CcyOptn", "_NonElgblPrcdsInd", "_OthrIncmTp", "_SctyDtls", "_CtryOfIncmSrc", "_EntitldQty", "_TradgPrd", "_PricDtls", "_DtDtls", "_SfkpgPlc", "_IssrOfferrTaxbltyInd", "_RateDtls", "_TempFinInstrmInd", "_FrctnDspstn", "_AmtDtls", "_CdtDbtInd", "_NewSctiesIssncInd"]
	@property
	def XmptnTp(self):
