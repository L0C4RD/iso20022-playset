...
class SecuritiesOption117(base_types._BaseFieldType):
	...
	__slots__ = ["_FrctnDspstn", "_IssrOfferrTaxbltyInd", "_NewSctiesIssncInd", "_CcyOptn", "_PricDtls", "_SfkpgPlc", "_TempFinInstrmInd", "_CtryOfIncmSrc", "_NonElgblPrcdsInd", "_IncmTp", "_DtDtls", "_EntitldQty", "_RateDtls", "_CdtDbtInd", "_SctyDtls", "_XmptnTp", "_AmtDtls", "_TradgPrd", "_OthrIncmTp"]
	@property
