...
class SecuritiesOption117(base_types._BaseFieldType):
	...
	__slots__ = ["_NewSctiesIssncInd", "_SfkpgPlc", "_CdtDbtInd", "_XmptnTp", "_TradgPrd", "_IncmTp", "_PricDtls", "_DtDtls", "_CcyOptn", "_TempFinInstrmInd", "_FrctnDspstn", "_NonElgblPrcdsInd", "_RateDtls", "_SctyDtls", "_EntitldQty", "_CtryOfIncmSrc", "_IssrOfferrTaxbltyInd", "_AmtDtls", "_OthrIncmTp"]
	@property
