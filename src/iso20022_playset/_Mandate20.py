...
class Mandate20(base_types._BaseFieldType):
	...
	__slots__ = ["_Rsn", "_MndtId", "_ColltnAmt", "_Dbtr", "_Tp", "_Cdtr", "_MndtRef", "_FrstColltnAmt", "_UltmtCdtr", "_Ocrncs", "_CdtrSchmeId", "_DbtrAgt", "_RfrdDoc", "_MndtReqId", "_UltmtDbtr", "_Adjstmnt", "_TrckgInd", "_CdtrAcct", "_MaxAmt", "_DbtrAcct", "_CdtrAgt", "_Authntcn"]
	@property
	def Adjstmnt(self):
