...
class SubscriptionExecution12(base_types._BaseFieldType):
	...
	__slots__ = ["_BestExctn", "_SttlmMtd", "_AcmltnRghtRef", "_OrdrRef", "_PhysDlvryInd", "_CshSttlmDtls", "_CstmrCndctClssfctn", "_IntrmPrftAmt", "_UnitsNb", "_GrssAmt", "_ClntRef", "_OrdrWvrDtls", "_LateRpt", "_InvstmtAcctDtls", "_RltdPtyDtls", "_TxChanlTp", "_SgntrTp", "_PrtlyExctdInd", "_CumDvddInd", "_NetAmt", "_Rfnd", "_Rndg", "_DealRef", "_DealgPricDtls", "_InftvTaxDtls", "_PhysDlvryDtls", "_StffClntBrkdwn", "_NgtdTrad", "_PrtlSttlmOfUnits", "_SttlmAndCtdyDtls", "_OrdrTp", "_PrtlSttlmOfCsh", "_TxOvrhd", "_InftvPricDtls", "_FinAdvc", "_SrcOfCsh", "_FXDtls", "_SttlmAmt", "_SbcptIntrst", "_BnfcryDtls", "_LttrInttRef", "_NonStdSttlmInf", "_CshSttlmDt", "_Equlstn", "_IncmPref", "_TradDtTm"]
	@property
	def BestExctn(self):
