...
from .OnBoardDiagnostics1 import OnBoardDiagnostics1
...
class Vehicle6(base_types._BaseFieldType):
	...
	__slots__ = ["_Hbmtr", "_OnBrdDgnstcs", "_Nb", "_TagNtryMd", "_TrlrNb", "_UnitNb", "_Tag", "_MntncId", "_IdNb", "_Rplcmnt", "_Odmtr", "_AddtlData", "_SubFleetNb", "_FleetNb"]
	@property
	def Hbmtr(self):
		return self._Hbmtr
