...
class Amendment1(base_types._BaseFieldType):
	...
	__slots__ = ["_NewXpryDtls", "_ScndAdvsgPty", "_SeqNb", "_AdvsgPty", "_DtOfIssnc", "_AddtlInf", "_BnfcryCnsntReqInd", "_TermntnDtls", "_UdrtkgAmtAdjstmnt", "_NewUdrtkgTermsAndConds", "_LclUdrtkg", "_NclsdFile", "_NewBnfcry", "_DlvryChanl", "_UdrtkgId"]
	@property
