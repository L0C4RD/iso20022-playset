...
class Amendment1(base_types._BaseFieldType):
	...
	__slots__ = ["_LclUdrtkg", "_NclsdFile", "_TermntnDtls", "_BnfcryCnsntReqInd", "_UdrtkgId", "_SeqNb", "_UdrtkgAmtAdjstmnt", "_NewXpryDtls", "_NewBnfcry", "_AddtlInf", "_NewUdrtkgTermsAndConds", "_ScndAdvsgPty", "_DlvryChanl", "_DtOfIssnc", "_AdvsgPty"]
	@property
	def LclUdrtkg(self):
