...
class CorporateActionNarrative60(base_types._BaseFieldType):
	...
	__slots__ = ["_CertfctnBrkdwn", "_NrrtvVrsn", "_InfConds", "_AddtlTxt", "_Dsclmr", "_InfToCmplyWth", "_PtyCtctNrrtv", "_RegnDtls", "_URLAdr", "_PrcgTxtForNxtIntrmy", "_TaxtnConds", "_BsktOrIndxInf"]
	@property
