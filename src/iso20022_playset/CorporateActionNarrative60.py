...
import UpdatedAdditionalInformation20

class CorporateActionNarrative60(base_types._BaseFieldType):

	__slots__ = ["_TaxtnConds", "_BsktOrIndxInf", "_InfConds", "_AddtlTxt", "_CertfctnBrkdwn", "_PrcgTxtForNxtIntrmy", "_NrrtvVrsn", "_Dsclmr", "_URLAdr", "_PtyCtctNrrtv", "_RegnDtls", "_InfToCmplyWth"]
	@property
	def TaxtnConds(self):
