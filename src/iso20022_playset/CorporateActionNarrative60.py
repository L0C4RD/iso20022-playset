...
class CorporateActionNarrative60(base_types._BaseFieldType):
	...
	__slots__ = ["_PrcgTxtForNxtIntrmy", "_Dsclmr", "_PtyCtctNrrtv", "_InfToCmplyWth", "_NrrtvVrsn", "_InfConds", "_RegnDtls", "_BsktOrIndxInf", "_CertfctnBrkdwn", "_AddtlTxt", "_URLAdr", "_TaxtnConds"]
	@property
