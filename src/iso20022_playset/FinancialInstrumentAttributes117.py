...
import FractionDispositionType32Choice
import AmountPrice4
...
class FinancialInstrumentAttributes117(base_types._BaseFieldType):
	...
	__slots__ = ["_XpryDt", "_RnncblEntitlmntStsTp", "_SctyId", "_FrctnDspstn", "_PstngDt", "_IntrmdtSctiesToUndrlygRatio", "_MktPric", "_UinstdBal", "_InstdBal", "_Qty", "_TradgPrd"]
	@property
	def XpryDt(self):
		return self._XpryDt
