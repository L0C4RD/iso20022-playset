...
class CorporateActionOption232(base_types._BaseFieldType):
	...
	__slots__ = ["_ChngAllwdInd", "_FrctnDspstn", "_PrdDtls", "_OptnTp", "_SctyId", "_AccptncPrtyLvl", "_VldDmclCtry", "_OptnNb", "_CcyOptn", "_NonDmclCtry", "_ApldOptnInd", "_SctiesMvmntDtls", "_PricDtls", "_DtDtls", "_CshMvmntDtls", "_DfltPrcgOrStgInstr", "_AddtlInf", "_OptnAvlbtySts", "_OfferTp", "_RateAndAmtDtls", "_SctiesQty", "_CertfctnBrkdwnTp", "_CertfctnBrkdwnInd", "_WdrwlAllwdInd", "_ChrgsApldInd", "_OptnFeatrs"]
	@property
