...
from . import ReconciliationResponse10
...
class SaleToPOIReconciliationResponseV07(base_types._BaseFieldType):
	...
	def RcncltnRspn(self, value):
		self._RcncltnRspn = value if value is not None else base_types.UninitialisedField(self, 'RcncltnRspn', ReconciliationResponse10, False)

	@RcncltnRspn.deleter
	def RcncltnRspn(self):
		del self._RcncltnRspn
		self._RcncltnRspn = base_types.UninitialisedField(self, 'RcncltnRspn', ReconciliationResponse10, False)
