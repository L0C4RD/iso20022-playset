...
class SecuritiesFinancingModificationInstructionV09(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_SttlmParams", "_FinInstrmId", "_DlvrgSttlmPties", "_SctiesFincgAddtlDtls", "_RcvgSttlmPties", "_TxTpAndModAddtlParams", "_TradDtls", "_OpngSttlmAmt", "_QtyAndAcctDtls"]
	@property
