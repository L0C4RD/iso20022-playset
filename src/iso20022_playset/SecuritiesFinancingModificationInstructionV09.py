...
class SecuritiesFinancingModificationInstructionV09(base_types._BaseFieldType):
	...
	__slots__ = ["_RcvgSttlmPties", "_QtyAndAcctDtls", "_SplmtryData", "_OpngSttlmAmt", "_FinInstrmId", "_TxTpAndModAddtlParams", "_DlvrgSttlmPties", "_SttlmParams", "_TradDtls", "_SctiesFincgAddtlDtls"]
	@property
