...
class SecuritiesFinancingModificationInstructionV09(base_types._BaseFieldType):
	...
	__slots__ = ["_DlvrgSttlmPties", "_TxTpAndModAddtlParams", "_QtyAndAcctDtls", "_RcvgSttlmPties", "_SttlmParams", "_SplmtryData", "_FinInstrmId", "_TradDtls", "_SctiesFincgAddtlDtls", "_OpngSttlmAmt"]
	@property
