...
class SecuritiesFinancingModificationInstructionV09(base_types._BaseFieldType):
	...
	__slots__ = ["_QtyAndAcctDtls", "_TradDtls", "_SctiesFincgAddtlDtls", "_DlvrgSttlmPties", "_FinInstrmId", "_TxTpAndModAddtlParams", "_RcvgSttlmPties", "_OpngSttlmAmt", "_SttlmParams", "_SplmtryData"]
	@property
