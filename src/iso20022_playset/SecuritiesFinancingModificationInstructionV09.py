...
class SecuritiesFinancingModificationInstructionV09(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_SttlmParams", "_RcvgSttlmPties", "_DlvrgSttlmPties", "_QtyAndAcctDtls", "_FinInstrmId", "_OpngSttlmAmt", "_TxTpAndModAddtlParams", "_TradDtls", "_SctiesFincgAddtlDtls"]
	@property
