...
from . import SwitchRedemptionLegOrder6
from . import SwitchSubscriptionLegOrder6
...
class SwitchOrder7(base_types._BaseFieldType):
	...
	def RedLegDtls(self, value):
		self._RedLegDtls = value if value is not None else base_types.UninitialisedField(self, 'RedLegDtls', SwitchRedemptionLegOrder6, True)

	@RedLegDtls.deleter
	def RedLegDtls(self):
		del self._RedLegDtls
		self._RedLegDtls = base_types.UninitialisedField(self, 'RedLegDtls', SwitchRedemptionLegOrder6, True)
	...
	def SbcptLegDtls(self, value):
		self._SbcptLegDtls = value if value is not None else base_types.UninitialisedField(self, 'SbcptLegDtls', SwitchSubscriptionLegOrder6, True)

	@SbcptLegDtls.deleter
	def SbcptLegDtls(self):
		del self._SbcptLegDtls
		self._SbcptLegDtls = base_types.UninitialisedField(self, 'SbcptLegDtls', SwitchSubscriptionLegOrder6, True)
