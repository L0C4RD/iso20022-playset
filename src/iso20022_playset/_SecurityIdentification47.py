...
class SecurityIdentification47(base_types._BaseFieldType):
	...
	__slots__ = ["_ClssTp", "_RegdDstrbtnCtry", "_Id", "_LvrgdOrCntngntLblty", "_NtnlOrUnitBased", "_CtryOfDmcl", "_Nm", "_ShrtNm", "_PdctCtgy", "_ExPstCostClctnBsis", "_ClssfctnTp", "_BaseCcy", "_Issr", "_UmbrllNm", "_IssrPdctGovncPrc", "_AddtlInf", "_NewUmbrll", "_PdctTp", "_PdctCtgyDE", "_QtnTp", "_NoRtrcssnInd"]
	@property
	def ClssTp(self):
		return self._ClssTp
