...
class FraudDispositionInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Sndr", "_AddtlInf", "_Hdr", "_AddtlData", "_Tkn", "_Rcncltn", "_Dstn", "_PrtctdData", "_Prgrmm", "_RptdFrd", "_Crdhldr", "_Issr", "_Card", "_FrdDspstnSts", "_Rcvr", "_Jursdctn", "_SplmtryData", "_Orgtr", "_Acqrr", "_SctyTrlr", "_SttlmSvc", "_AddtlFee", "_FrdTxId"]
	@property
	def Sndr(self):
		return self._Sndr
