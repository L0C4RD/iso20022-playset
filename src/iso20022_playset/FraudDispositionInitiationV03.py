...
class FraudDispositionInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Acqrr", "_Hdr", "_Dstn", "_PrtctdData", "_RptdFrd", "_FrdDspstnSts", "_Rcvr", "_Jursdctn", "_Crdhldr", "_Sndr", "_Prgrmm", "_FrdTxId", "_AddtlFee", "_Rcncltn", "_SplmtryData", "_AddtlData", "_Card", "_SttlmSvc", "_Tkn", "_Issr", "_Orgtr", "_SctyTrlr", "_AddtlInf"]
	@property
	def Acqrr(self):
		return self._Acqrr
