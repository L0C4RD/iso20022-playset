...
class FraudDispositionInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Jursdctn", "_SplmtryData", "_AddtlData", "_Orgtr", "_Hdr", "_SttlmSvc", "_Card", "_Sndr", "_Prgrmm", "_Tkn", "_Dstn", "_AddtlInf", "_Rcncltn", "_Rcvr", "_SctyTrlr", "_Issr", "_FrdDspstnSts", "_PrtctdData", "_Crdhldr", "_Acqrr", "_RptdFrd", "_AddtlFee", "_FrdTxId"]
	@property
	def Jursdctn(self):
