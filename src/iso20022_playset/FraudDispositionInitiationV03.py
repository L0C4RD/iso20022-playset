...
class FraudDispositionInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlData", "_SctyTrlr", "_FrdDspstnSts", "_Hdr", "_Sndr", "_Orgtr", "_Acqrr", "_FrdTxId", "_Jursdctn", "_Rcvr", "_Prgrmm", "_RptdFrd", "_AddtlFee", "_Dstn", "_SttlmSvc", "_PrtctdData", "_Rcncltn", "_Issr", "_AddtlInf", "_SplmtryData", "_Tkn", "_Card", "_Crdhldr"]
	@property
	def AddtlData(self):
	...
	def FrdDspstnSts(self, value):
		self._FrdDspstnSts = value if type(value) != auto else self.make_default("FrdDspstnSts")
