...
import ReportedFraud5
import ContentInformationType41
import FraudDispositionStatus2
import AdditionalInformation30
import AdditionalData2

class FraudDispositionInitiationV03(base_types._BaseFieldType):

	__slots__ = ["_Sndr", "_Card", "_SttlmSvc", "_FrdTxId", "_AddtlInf", "_RptdFrd", "_Rcvr", "_Prgrmm", "_Rcncltn", "_Dstn", "_AddtlData", "_Jursdctn", "_Tkn", "_Acqrr", "_Hdr", "_SctyTrlr", "_Crdhldr", "_FrdDspstnSts", "_AddtlFee", "_PrtctdData", "_Issr", "_SplmtryData", "_Orgtr"]
	@property
	def Sndr(self):
		return self._Sndr
