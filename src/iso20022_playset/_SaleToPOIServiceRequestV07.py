...
class SaleToPOIServiceRequestV07(base_types._BaseFieldType):
	...
	def SvcReq(self, value):
		self._SvcReq = value if value is not None else base_types.UninitialisedField(self, 'SvcReq', ServiceRequest8, False)

	@SvcReq.deleter
	def SvcReq(self):
		del self._SvcReq
		self._SvcReq = base_types.UninitialisedField(self, 'SvcReq', ServiceRequest8, False)
