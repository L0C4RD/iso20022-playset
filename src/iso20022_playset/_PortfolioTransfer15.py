...
from . import FinancialInstrument109
from . import FundPortfolio7Choice
from . import ISODate
from . import Max35Text
from . import PaymentInstrument22
from . import ResidualCash2

class PortfolioTransfer15(base_types._BaseFieldType):
	...
	def FinInstrmAsstForTrf(self, value):
		self._FinInstrmAsstForTrf = value if value is not None else base_types.UninitialisedField(self, 'FinInstrmAsstForTrf', FinancialInstrument109, True)

	@FinInstrmAsstForTrf.deleter
	def FinInstrmAsstForTrf(self):
		del self._FinInstrmAsstForTrf
		self._FinInstrmAsstForTrf = base_types.UninitialisedField(self, 'FinInstrmAsstForTrf', FinancialInstrument109, True)
	...
	def PmtDtls(self, value):
		self._PmtDtls = value if value is not None else base_types.UninitialisedField(self, 'PmtDtls', PaymentInstrument22, False)

	@PmtDtls.deleter
	def PmtDtls(self):
		del self._PmtDtls
		self._PmtDtls = base_types.UninitialisedField(self, 'PmtDtls', PaymentInstrument22, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='FinInstrmAsstForTrf', type=FinancialInstrument109, min=0, max=None, mutex_group=None, array=True),
		base_types.FieldEntry(name='MstrRef', type=Max35Text, min=0, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='PmtDtls', type=PaymentInstrument22, min=0, max=1, mutex_group=None, array=False),
