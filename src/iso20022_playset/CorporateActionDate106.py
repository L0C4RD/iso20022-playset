...
class CorporateActionDate106(base_types._BaseFieldType):
	...
	__slots__ = ["_MktDdln", "_StockLndgDdln", "_DcmnttnDdln", "_DpstryCoverXprtnDt", "_EarlyRspnDdln", "_SbcptCostDbtDt", "_PrtctDdln", "_XpryDt", "_CoverXprtnDdln", "_RspnDdln", "_BrrwrStockLndgDdln"]
	@property
	def MktDdln(self):
