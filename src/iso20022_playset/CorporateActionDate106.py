...
class CorporateActionDate106(base_types._BaseFieldType):
	...
	__slots__ = ["_BrrwrStockLndgDdln", "_EarlyRspnDdln", "_CoverXprtnDdln", "_RspnDdln", "_MktDdln", "_StockLndgDdln", "_SbcptCostDbtDt", "_PrtctDdln", "_XpryDt", "_DpstryCoverXprtnDt", "_DcmnttnDdln"]
	@property
