...
class CorporateActionDate106(base_types._BaseFieldType):
	...
	__slots__ = ["_XpryDt", "_EarlyRspnDdln", "_RspnDdln", "_DcmnttnDdln", "_PrtctDdln", "_SbcptCostDbtDt", "_MktDdln", "_BrrwrStockLndgDdln", "_DpstryCoverXprtnDt", "_StockLndgDdln", "_CoverXprtnDdln"]
	@property
	def XpryDt(self):
		return self._XpryDt
