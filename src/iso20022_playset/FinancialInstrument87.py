...
class FinancialInstrument87(base_types._BaseFieldType):
	...
	__slots__ = ["_ClssTp", "_PdctGrp", "_Id", "_ShrtNm", "_OprlSts", "_ThrdPtyRghts", "_SctiesForm", "_Nm", "_SplmtryId", "_DstrbtnPlcy", "_BlckdHldgDtls", "_Pldgg", "_FndOwnrsh", "_FndIntntn", "_Coll"]
	@property
	def ClssTp(self):
		return self._ClssTp
	...
	def OprlSts(self, value):
		self._OprlSts = value if type(value) != base_types.auto else self.make_default("OprlSts")
	...
	def BlckdHldgDtls(self, value):
		self._BlckdHldgDtls = value if type(value) != base_types.auto else self.make_default("BlckdHldgDtls")
	...
	def FndOwnrsh(self, value):
		self._FndOwnrsh = value if type(value) != base_types.auto else self.make_default("FndOwnrsh")
	...
	def FndIntntn(self, value):
		self._FndIntntn = value if type(value) != base_types.auto else self.make_default("FndIntntn")
