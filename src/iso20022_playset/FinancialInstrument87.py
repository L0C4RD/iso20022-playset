...
class FinancialInstrument87(base_types._BaseFieldType):
	...
	__slots__ = ["_OprlSts", "_DstrbtnPlcy", "_ClssTp", "_ThrdPtyRghts", "_Pldgg", "_SplmtryId", "_ShrtNm", "_Id", "_FndIntntn", "_Nm", "_SctiesForm", "_Coll", "_BlckdHldgDtls", "_PdctGrp", "_FndOwnrsh"]
	@property
	def OprlSts(self):
