...
class FinancialInstrument87(base_types._BaseFieldType):
	...
	__slots__ = ["_SctiesForm", "_FndOwnrsh", "_SplmtryId", "_ThrdPtyRghts", "_ShrtNm", "_BlckdHldgDtls", "_Coll", "_Id", "_ClssTp", "_PdctGrp", "_Pldgg", "_Nm", "_OprlSts", "_DstrbtnPlcy", "_FndIntntn"]
	@property
	def SctiesForm(self):
