...
class AdministrativeInitiationV02(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_Rsk", "_Accptr", "_Pyee", "_LclData", "_Card", "_AddtlSvc", "_ICCRltdData", "_Termnl", "_Dstn", "_AddtlData", "_PrcgRslt", "_Acqrr", "_Hdr", "_SctyTrlr", "_TxId", "_AddtlFee", "_OthrAdmstvTp", "_Issr", "_Orgtr", "_Sndr", "_SpclPrgrmmQlfctn", "_TxtMsg", "_Instlmt", "_Pyer", "_AltrnMsgRsn", "_AdmstvTp", "_Wllt", "_Rcvr", "_Cstmr", "_Vrfctn", "_XchgRate", "_ConvsDtTm", "_Rcncltn", "_Jursdctn", "_Tkn", "_CstmrDvc", "_TxDesc", "_MsgRsn", "_POICmpnt", "_Cntxt", "_Crdhldr", "_PrtctdData", "_SttlmSvc", "_Prgrmm", "_OrgnlTx"]
	@property
