...
class AdministrativeInitiationV02(base_types._BaseFieldType):
	...
	__slots__ = ["_AdmstvTp", "_SplmtryData", "_Pyer", "_CstmrDvc", "_TxtMsg", "_Prgrmm", "_OrgnlTx", "_ICCRltdData", "_Termnl", "_AltrnMsgRsn", "_SpclPrgrmmQlfctn", "_Rcvr", "_Rcncltn", "_SctyTrlr", "_MsgRsn", "_PrtctdData", "_Crdhldr", "_Vrfctn", "_Acqrr", "_Card", "_AddtlFee", "_LclData", "_OthrAdmstvTp", "_Jursdctn", "_AddtlData", "_Instlmt", "_ConvsDtTm", "_Orgtr", "_Hdr", "_Rsk", "_TxId", "_Sndr", "_Wllt", "_Tkn", "_POICmpnt", "_PrcgRslt", "_Dstn", "_SttlmSvc", "_Pyee", "_TxDesc", "_Issr", "_AddtlSvc", "_Cntxt", "_XchgRate", "_Accptr", "_Cstmr"]
	@property
	def AdmstvTp(self):
