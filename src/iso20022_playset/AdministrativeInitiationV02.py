...
from .LocalData17 import LocalData17
...
class AdministrativeInitiationV02(base_types._BaseFieldType):
	...
	__slots__ = ["_ICCRltdData", "_SctyTrlr", "_Hdr", "_Orgtr", "_Acqrr", "_PrcgRslt", "_OrgnlTx", "_TxId", "_Rcvr", "_Pyee", "_Jursdctn", "_Termnl", "_Accptr", "_LclData", "_Cntxt", "_CstmrDvc", "_Dstn", "_Rcncltn", "_Issr", "_TxDesc", "_SplmtryData", "_TxtMsg", "_Pyer", "_MsgRsn", "_XchgRate", "_Instlmt", "_AddtlData", "_Sndr", "_AddtlSvc", "_Wllt", "_AdmstvTp", "_POICmpnt", "_SpclPrgrmmQlfctn", "_Cstmr", "_Prgrmm", "_AddtlFee", "_OthrAdmstvTp", "_SttlmSvc", "_Vrfctn", "_PrtctdData", "_Rsk", "_AltrnMsgRsn", "_ConvsDtTm", "_Card", "_Tkn", "_Crdhldr"]
	@property
