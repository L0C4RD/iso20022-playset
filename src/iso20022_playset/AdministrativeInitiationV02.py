...
class AdministrativeInitiationV02(base_types._BaseFieldType):
	...
	__slots__ = ["_PrcgRslt", "_SpclPrgrmmQlfctn", "_AddtlData", "_Accptr", "_Issr", "_AltrnMsgRsn", "_Vrfctn", "_TxId", "_XchgRate", "_Acqrr", "_Dstn", "_Cntxt", "_SplmtryData", "_Hdr", "_Pyer", "_OrgnlTx", "_Card", "_Prgrmm", "_AddtlSvc", "_Rcvr", "_Rcncltn", "_ConvsDtTm", "_OthrAdmstvTp", "_MsgRsn", "_TxtMsg", "_Tkn", "_SttlmSvc", "_Wllt", "_SctyTrlr", "_Orgtr", "_AdmstvTp", "_AddtlFee", "_TxDesc", "_Pyee", "_Jursdctn", "_Cstmr", "_LclData", "_CstmrDvc", "_PrtctdData", "_Instlmt", "_ICCRltdData", "_Crdhldr", "_POICmpnt", "_Sndr", "_Rsk", "_Termnl"]
	@property
	def PrcgRslt(self):
