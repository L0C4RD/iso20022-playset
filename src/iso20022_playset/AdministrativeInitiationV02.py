...
class AdministrativeInitiationV02(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrAdmstvTp", "_POICmpnt", "_Prgrmm", "_Tkn", "_Dstn", "_TxId", "_PrtctdData", "_Crdhldr", "_PrcgRslt", "_Cstmr", "_Rcvr", "_Card", "_Jursdctn", "_Wllt", "_Orgtr", "_SctyTrlr", "_CstmrDvc", "_Hdr", "_TxtMsg", "_Pyee", "_Accptr", "_Rsk", "_Sndr", "_AddtlFee", "_ICCRltdData", "_Termnl", "_AddtlData", "_AltrnMsgRsn", "_Cntxt", "_Rcncltn", "_TxDesc", "_SpclPrgrmmQlfctn", "_SttlmSvc", "_AdmstvTp", "_Instlmt", "_Issr", "_MsgRsn", "_Pyer", "_Vrfctn", "_LclData", "_OrgnlTx", "_SplmtryData", "_Acqrr", "_XchgRate", "_ConvsDtTm", "_AddtlSvc"]
	@property
