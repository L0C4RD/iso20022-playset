...
class TradeLeg13(base_types._BaseFieldType):
	...
	__slots__ = ["_TradId", "_TradgCpcty", "_SfkpgAcct", "_OrdrId", "_TradRegnOrgn", "_AllcnId", "_TradgPtyAcct", "_SttlmDt", "_TradDt", "_TradExctnId", "_PlcOfListg", "_TradPstngCd", "_TradgPty", "_DealPric", "_GrssAmt", "_UnqTxIdr", "_Brkr", "_DerivRltdTrad", "_TradLegId", "_TxDtAndTm", "_SfkpgPlc", "_BuySellInd", "_TradTp", "_TradQty", "_PlcOfTrad", "_TradgCcy"]
	@property
	def TradId(self):
		return self._TradId
