...
from .SettlementDetails170 import SettlementDetails170
from .Rate2 import Rate2
from .Quantity51Choice import Quantity51Choice
from .SettlementParties127 import SettlementParties127
...
class SecuritiesFinancingTransactionDetails57(base_types._BaseFieldType):

	__slots__ = ["_ClntTrptyCollTxId", "_RateChngDt", "_RateTp", "_RpRate", "_Pmt", "_SttlmQty", "_SfkpgPlc", "_TradDt", "_XpctdSttlmDt", "_BlckChainAdrOrWllt", "_PricgRate", "_RcvgSttlmPties", "_TermntnDt", "_LateDlvryDt", "_OpngSttlmDt", "_SctiesMvmntTp", "_ClsgLegId", "_VarblRateSpprt", "_TrptyAgtSvcPrvdrCollTxId", "_XpctdValDt", "_SfkpgAcct", "_PlcOfTrad", "_TermntnTxAmt", "_SctiesFincgTradId", "_SttlmParams", "_Invstr", "_SctiesFincgTxTp", "_DlvrgSttlmPties", "_OpngSttlmAmt", "_PoolId", "_FinInstrmId", "_SttlmInstrPrcgAddtlDtls", "_AcctOwnr", "_Sprd", "_StockLnMrgn", "_SctiesFincgUnqTxIdr", "_CorpActnEvtId", "_SctiesHrcut"]
	@property
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='SttlmParams', type=SettlementDetails170, min=0, max=1, mutex_group=None, array=False),
