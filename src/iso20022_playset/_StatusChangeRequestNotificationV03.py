...
class StatusChangeRequestNotificationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_PropsdStsChng", "_TxSts", "_ReqRsn", "_ReqForActn", "_UsrTxRef", "_TxId", "_NtfctnId", "_EstblishdBaselnId", "_Initr"]
	@property
	...
	def PropsdStsChng(self, value):
		self._PropsdStsChng = value if type(value) != base_types.auto else self.make_default("PropsdStsChng")
