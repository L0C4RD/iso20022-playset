...
class StatusChangeRequestNotificationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_EstblishdBaselnId", "_Initr", "_NtfctnId", "_PropsdStsChng", "_ReqForActn", "_ReqRsn", "_TxId", "_TxSts", "_UsrTxRef"]
	@property
	...
	def PropsdStsChng(self, value):
		self._PropsdStsChng = value if value is not None else base_types.UninitialisedField(self, 'PropsdStsChng', TransactionStatus3, False)

	@PropsdStsChng.deleter
	def PropsdStsChng(self):
		del self._PropsdStsChng
		self._PropsdStsChng = base_types.UninitialisedField(self, 'PropsdStsChng', TransactionStatus3, False)
