...
class AdministrativeInitiationV02(base_types._BaseFieldType):
	...
	__slots__ = ["_Orgtr", "_ConvsDtTm", "_PrcgRslt", "_Tkn", "_Crdhldr", "_POICmpnt", "_OrgnlTx", "_Prgrmm", "_AddtlSvc", "_Jursdctn", "_OthrAdmstvTp", "_Rcvr", "_PrtctdData", "_XchgRate", "_MsgRsn", "_AdmstvTp", "_LclData", "_SttlmSvc", "_ICCRltdData", "_SctyTrlr", "_Cstmr", "_Cntxt", "_Accptr", "_Instlmt", "_SpclPrgrmmQlfctn", "_SplmtryData", "_Issr", "_Acqrr", "_TxDesc", "_Pyer", "_Hdr", "_CstmrDvc", "_Wllt", "_AltrnMsgRsn", "_AddtlFee", "_Termnl", "_Rsk", "_TxId", "_Pyee", "_TxtMsg", "_Sndr", "_Rcncltn", "_Card", "_AddtlData", "_Dstn", "_Vrfctn"]
	@property
	def Orgtr(self):
		return self._Orgtr
