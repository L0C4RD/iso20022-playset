...
class AdministrativeInitiationV02(base_types._BaseFieldType):
	...
	__slots__ = ["_XchgRate", "_ICCRltdData", "_TxDesc", "_AltrnMsgRsn", "_PrcgRslt", "_SctyTrlr", "_Pyee", "_OrgnlTx", "_LclData", "_Hdr", "_CstmrDvc", "_ConvsDtTm", "_Crdhldr", "_Issr", "_SttlmSvc", "_AdmstvTp", "_TxtMsg", "_Rcncltn", "_Tkn", "_Orgtr", "_OthrAdmstvTp", "_Wllt", "_MsgRsn", "_PrtctdData", "_Instlmt", "_SplmtryData", "_Cstmr", "_Termnl", "_Pyer", "_Prgrmm", "_Card", "_Acqrr", "_TxId", "_Vrfctn", "_AddtlData", "_Rcvr", "_Sndr", "_SpclPrgrmmQlfctn", "_Dstn", "_Accptr", "_POICmpnt", "_AddtlSvc", "_Jursdctn", "_Rsk", "_Cntxt", "_AddtlFee"]
	@property
	def XchgRate(self):
