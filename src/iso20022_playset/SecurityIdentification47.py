...
class SecurityIdentification47(base_types._BaseFieldType):
	...
	__slots__ = ["_NoRtrcssnInd", "_Nm", "_PdctCtgyDE", "_AddtlInf", "_RegdDstrbtnCtry", "_ClssTp", "_PdctCtgy", "_NtnlOrUnitBased", "_ShrtNm", "_QtnTp", "_Issr", "_UmbrllNm", "_ExPstCostClctnBsis", "_LvrgdOrCntngntLblty", "_NewUmbrll", "_CtryOfDmcl", "_PdctTp", "_ClssfctnTp", "_IssrPdctGovncPrc", "_BaseCcy", "_Id"]
	@property
