...
class SecurityIdentification47(base_types._BaseFieldType):
	...
	__slots__ = ["_ClssTp", "_PdctTp", "_RegdDstrbtnCtry", "_LvrgdOrCntngntLblty", "_ClssfctnTp", "_BaseCcy", "_NtnlOrUnitBased", "_AddtlInf", "_UmbrllNm", "_CtryOfDmcl", "_IssrPdctGovncPrc", "_PdctCtgyDE", "_Nm", "_ShrtNm", "_ExPstCostClctnBsis", "_Id", "_QtnTp", "_NewUmbrll", "_Issr", "_PdctCtgy", "_NoRtrcssnInd"]
	@property
	def ClssTp(self):
		return self._ClssTp
