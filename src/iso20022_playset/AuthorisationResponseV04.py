...
class AuthorisationResponseV04(base_types._BaseFieldType):
	...
	__slots__ = ["_Prgrmm", "_StrngCstmrAuthntcn", "_SpclPrgrmmQlfctn", "_AddtlData", "_Card", "_Issr", "_TxId", "_Acqrr", "_Dstn", "_Accptr", "_Termnl", "_SplmtryData", "_Hdr", "_AcctFr", "_AddtlSvc", "_SttlmSvc", "_Rcvr", "_AddtlAmt", "_Rcncltn", "_ConvsDtTm", "_TxAmts", "_Tkn", "_Wllt", "_SctyTrlr", "_Orgtr", "_AddtlFee", "_PrcgRslt", "_Jursdctn", "_TxChrtcs", "_AcctTo", "_OrgnlDataElmts", "_Instlmt", "_PrtctdData", "_Vrfctn", "_ICCRltdData", "_AdddmData", "_Crdhldr", "_Cntxt", "_AcctBal", "_Sndr", "_Rsk"]
	@property
	def Prgrmm(self):
		return self._Prgrmm
