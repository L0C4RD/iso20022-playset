...
class AuthorisationResponseV04(base_types._BaseFieldType):
	...
	__slots__ = ["_ICCRltdData", "_SctyTrlr", "_Hdr", "_Orgtr", "_Acqrr", "_Accptr", "_Vrfctn", "_Jursdctn", "_Rcvr", "_Prgrmm", "_AdddmData", "_PrcgRslt", "_Dstn", "_AddtlAmt", "_SttlmSvc", "_Rcncltn", "_TxChrtcs", "_Issr", "_SplmtryData", "_StrngCstmrAuthntcn", "_Card", "_Instlmt", "_AddtlData", "_Sndr", "_TxId", "_Termnl", "_AddtlSvc", "_AcctFr", "_Wllt", "_AcctTo", "_Cntxt", "_OrgnlDataElmts", "_SpclPrgrmmQlfctn", "_TxAmts", "_AddtlFee", "_PrtctdData", "_Rsk", "_ConvsDtTm", "_Tkn", "_AcctBal", "_Crdhldr"]
	@property
