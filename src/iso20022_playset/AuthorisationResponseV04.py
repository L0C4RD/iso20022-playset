...
import AddendumData7

class AuthorisationResponseV04(base_types._BaseFieldType):

	__slots__ = ["_AdddmData", "_TxAmts", "_AcctTo", "_Tkn", "_Dstn", "_PrtctdData", "_Prgrmm", "_Crdhldr", "_Card", "_Vrfctn", "_AcctBal", "_Rcvr", "_Jursdctn", "_Wllt", "_Orgtr", "_SctyTrlr", "_Termnl", "_Hdr", "_Rsk", "_SttlmSvc", "_AddtlFee", "_Sndr", "_ICCRltdData", "_OrgnlDataElmts", "_AddtlData", "_Rcncltn", "_SpclPrgrmmQlfctn", "_Accptr", "_StrngCstmrAuthntcn", "_Instlmt", "_AcctFr", "_Issr", "_TxId", "_PrcgRslt", "_AddtlAmt", "_SplmtryData", "_TxChrtcs", "_Acqrr", "_Cntxt", "_ConvsDtTm", "_AddtlSvc"]
	@property
	def AdddmData(self):
