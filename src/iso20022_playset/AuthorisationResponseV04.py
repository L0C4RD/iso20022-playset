...
class AuthorisationResponseV04(base_types._BaseFieldType):
	...
	__slots__ = ["_Instlmt", "_PrtctdData", "_AddtlSvc", "_Crdhldr", "_Vrfctn", "_ConvsDtTm", "_Termnl", "_Prgrmm", "_ICCRltdData", "_SpclPrgrmmQlfctn", "_Rcncltn", "_AddtlData", "_Accptr", "_SttlmSvc", "_Issr", "_OrgnlDataElmts", "_AcctBal", "_Wllt", "_TxAmts", "_Acqrr", "_Hdr", "_Dstn", "_AdddmData", "_Rcvr", "_Cntxt", "_Card", "_Jursdctn", "_Sndr", "_Rsk", "_AddtlFee", "_TxId", "_SplmtryData", "_AcctFr", "_PrcgRslt", "_Tkn", "_TxChrtcs", "_Orgtr", "_AddtlAmt", "_AcctTo", "_SctyTrlr", "_StrngCstmrAuthntcn"]
	@property
	def Instlmt(self):
