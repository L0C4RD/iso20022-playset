...
from . import CreditTransferTransaction82
from . import DateAndDateTime2Choice
from . import ISODate
from . import MandateRelatedData5Choice
...
class OriginalTransactionReference45(base_types._BaseFieldType):
	...
	def MndtRltdInf(self, value):
		self._MndtRltdInf = value if value is not None else base_types.UninitialisedField(self, 'MndtRltdInf', MandateRelatedData5Choice, False)

	@MndtRltdInf.deleter
	def MndtRltdInf(self):
		del self._MndtRltdInf
		self._MndtRltdInf = base_types.UninitialisedField(self, 'MndtRltdInf', MandateRelatedData5Choice, False)
	...
	def UndrlygFICdtTrf(self, value):
		self._UndrlygFICdtTrf = value if value is not None else base_types.UninitialisedField(self, 'UndrlygFICdtTrf', CreditTransferTransaction82, False)

	@UndrlygFICdtTrf.deleter
	def UndrlygFICdtTrf(self):
		del self._UndrlygFICdtTrf
		self._UndrlygFICdtTrf = base_types.UninitialisedField(self, 'UndrlygFICdtTrf', CreditTransferTransaction82, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='MndtRltdInf', type=MandateRelatedData5Choice, min=0, max=1, mutex_group=None, array=False),
