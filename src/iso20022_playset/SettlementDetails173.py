...
class SettlementDetails173(base_types._BaseFieldType):
	...
	__slots__ = ["_CshClrSys", "_SctiesRTGS", "_NetgElgblty", "_BlckTrad", "_SttlmSysMtd", "_CCPElgblty", "_MktClntSd", "_StmpDtyTaxBsis", "_HldInd", "_LglRstrctns", "_PrtlSttlmInd", "_ElgblForColl", "_SttlmTxCond", "_BnfclOwnrsh", "_SttlgCpcty", "_TaxCpcty"]
	@property
	def CshClrSys(self):
