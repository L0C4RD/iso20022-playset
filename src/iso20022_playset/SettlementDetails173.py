...
class SettlementDetails173(base_types._BaseFieldType):
	...
	__slots__ = ["_LglRstrctns", "_BnfclOwnrsh", "_MktClntSd", "_SttlgCpcty", "_PrtlSttlmInd", "_CshClrSys", "_SctiesRTGS", "_NetgElgblty", "_SttlmTxCond", "_CCPElgblty", "_BlckTrad", "_HldInd", "_SttlmSysMtd", "_StmpDtyTaxBsis", "_ElgblForColl", "_TaxCpcty"]
	@property
