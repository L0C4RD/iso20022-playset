...
class SettlementDetails173(base_types._BaseFieldType):
	...
	__slots__ = ["_TaxCpcty", "_StmpDtyTaxBsis", "_SttlmSysMtd", "_ElgblForColl", "_MktClntSd", "_BlckTrad", "_HldInd", "_BnfclOwnrsh", "_SttlmTxCond", "_SctiesRTGS", "_NetgElgblty", "_PrtlSttlmInd", "_CshClrSys", "_LglRstrctns", "_CCPElgblty", "_SttlgCpcty"]
	@property
	def TaxCpcty(self):
