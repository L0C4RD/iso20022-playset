...
class LoanData141(base_types._BaseFieldType):
	...
	__slots__ = ["_RbtRate", "_MstrAgrmt", "_ValDt", "_TermntnDt", "_CollDlvryMtd", "_UnqTradIdr", "_LnVal", "_LndgFee", "_GnlColl", "_AsstTp", "_DlvryByVal", "_ClrSts", "_ExctnDtTm", "_Term", "_TradgVn", "_EvtDt"]
	@property
	def AsstTp(self):
		return self._AsstTp
