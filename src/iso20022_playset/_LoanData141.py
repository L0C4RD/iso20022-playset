...
class LoanData141(base_types._BaseFieldType):
	...
	__slots__ = ["_EvtDt", "_RbtRate", "_UnqTradIdr", "_TermntnDt", "_GnlColl", "_DlvryByVal", "_LnVal", "_CollDlvryMtd", "_ValDt", "_TradgVn", "_ExctnDtTm", "_LndgFee", "_ClrSts", "_Term", "_MstrAgrmt", "_AsstTp"]
	@property
	def EvtDt(self):
		return self._EvtDt
