...
class LoanData141(base_types._BaseFieldType):
	...
	__slots__ = ["_EvtDt", "_TradgVn", "_ValDt", "_AsstTp", "_ClrSts", "_UnqTradIdr", "_TermntnDt", "_DlvryByVal", "_LndgFee", "_Term", "_RbtRate", "_ExctnDtTm", "_MstrAgrmt", "_CollDlvryMtd", "_GnlColl", "_LnVal"]
	@property
	def EvtDt(self):
		return self._EvtDt
