...
from . import SettlementDateCode9Choice
...
class SettlementDate20Choice(base_types._BaseFieldType):
	...
	@DtCd.setter
	def DtCd(self, value):
		self._DtCd = value if value is not None else base_types.UninitialisedField(self, 'DtCd', SettlementDateCode9Choice, False)

	@DtCd.deleter
	def DtCd(self):
		del self._DtCd
		self._DtCd = base_types.UninitialisedField(self, 'DtCd', SettlementDateCode9Choice, False)
