...
class PostalAddress21(base_types._BaseFieldType):
	...
	__slots__ = ["_PstBx", "_MlngInd", "_SuiteId", "_PstCd", "_BldgNb", "_Ctry", "_CareOf", "_AdrTp", "_Vllg", "_DstrctNm", "_AdrLine", "_TwnNm", "_Flr", "_Stat", "_StrtNm", "_RegnAdrInd", "_SdInBldg", "_BldgNm"]
	@property
	def PstBx(self):
		return self._PstBx
