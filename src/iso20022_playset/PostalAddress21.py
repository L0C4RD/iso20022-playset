...
class PostalAddress21(base_types._BaseFieldType):
	...
	__slots__ = ["_RegnAdrInd", "_BldgNm", "_TwnNm", "_MlngInd", "_PstCd", "_Ctry", "_CareOf", "_SdInBldg", "_SuiteId", "_Flr", "_StrtNm", "_PstBx", "_BldgNb", "_AdrLine", "_Vllg", "_AdrTp", "_DstrctNm", "_Stat"]
	@property
	def RegnAdrInd(self):
