...
class PostalAddress21(base_types._BaseFieldType):
	...
	__slots__ = ["_TwnNm", "_PstBx", "_CareOf", "_AdrTp", "_Ctry", "_Flr", "_AdrLine", "_BldgNb", "_RegnAdrInd", "_StrtNm", "_BldgNm", "_PstCd", "_MlngInd", "_Stat", "_DstrctNm", "_Vllg", "_SuiteId", "_SdInBldg"]
	@property
	def TwnNm(self):
		return self._TwnNm
