...
from . import SecuritiesTransactionStatusQuery002V06
...
class SESE_021_002_06():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def SctiesTxStsQry(self, value):
			self._SctiesTxStsQry = value if value is not None else base_types.UninitialisedField(self, 'SctiesTxStsQry', SecuritiesTransactionStatusQuery002V06, False)

		@SctiesTxStsQry.deleter
		def SctiesTxStsQry(self):
			del self._SctiesTxStsQry
			self._SctiesTxStsQry = base_types.UninitialisedField(self, 'SctiesTxStsQry', SecuritiesTransactionStatusQuery002V06, False)
