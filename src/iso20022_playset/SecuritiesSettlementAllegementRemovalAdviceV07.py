...
class SecuritiesSettlementAllegementRemovalAdviceV07(base_types._BaseFieldType):
	...
	__slots__ = ["_SfkpgAcct", "_SplmtryData", "_BlckChainAdrOrWllt", "_AcctOwnr", "_MktInfrstrctrTxId", "_CtrPtyMktInfrstrctrTxId", "_TxDtls", "_AcctSvcrTxId"]
	@property
	def SfkpgAcct(self):
