...
from . import RedemptionExecution19
from . import YesNoIndicator

class RedemptionMultipleExecution07(base_types._BaseFieldType):
	...
	def BlkCshSttlmDtls(self, value):
		self._BlkCshSttlmDtls = value if value is not None else base_types.UninitialisedField(self, 'BlkCshSttlmDtls', PaymentTransaction167, False)

	@BlkCshSttlmDtls.deleter
	def BlkCshSttlmDtls(self):
		del self._BlkCshSttlmDtls
		self._BlkCshSttlmDtls = base_types.UninitialisedField(self, 'BlkCshSttlmDtls', PaymentTransaction167, False)
	...
	def IndvExctnDtls(self, value):
		self._IndvExctnDtls = value if value is not None else base_types.UninitialisedField(self, 'IndvExctnDtls', RedemptionExecution19, True)

	@IndvExctnDtls.deleter
	def IndvExctnDtls(self):
		del self._IndvExctnDtls
		self._IndvExctnDtls = base_types.UninitialisedField(self, 'IndvExctnDtls', RedemptionExecution19, True)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='BlkCshSttlmDtls', type=PaymentTransaction167, min=0, max=1, mutex_group=None, array=False),
		...
		base_types.FieldEntry(name='IndvExctnDtls', type=RedemptionExecution19, min=1, max=None, mutex_group=None, array=True),
