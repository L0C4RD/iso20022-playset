...
class SettlementDetails214(base_types._BaseFieldType):
	...
	__slots__ = ["_CshSubBalTp", "_AutomtcBrrwg", "_SttlmTxCond", "_ElgblForColl", "_MktClntSd", "_SttlmSysMtd", "_RpTp", "_BnfclOwnrsh", "_StmpDtyTaxBsis", "_Prty", "_NetgElgblty", "_PrtlSttlmInd", "_SctiesSubBalTp", "_SctiesTxTp", "_SctiesRTGS", "_CCPElgblty", "_CshClrSys", "_Regn", "_LttrOfGrnt", "_TaxCpcty", "_SttlgCpcty", "_LglRstrctns", "_BlckTrad", "_XpsrTp"]
	@property
