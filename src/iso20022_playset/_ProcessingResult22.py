...
class ProcessingResult22(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlInf", "_RspnSrcAssgnr", "_RspnSrcTp", "_Actn", "_RspnSrcCtry", "_ApprvlCd", "_RspnCd", "_RspnSrcId", "_TempScrCardDataReusePrtd", "_ErrDtl", "_RspnSrcOthrTp", "_ActnReqrd", "_RspnSrcShrtNm"]
	@property
	def AddtlInf(self):
