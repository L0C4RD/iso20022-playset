...
class ProcessingResult22(base_types._BaseFieldType):
	...
	__slots__ = ["_RspnSrcAssgnr", "_ApprvlCd", "_Actn", "_ErrDtl", "_RspnSrcTp", "_RspnSrcShrtNm", "_RspnCd", "_ActnReqrd", "_RspnSrcId", "_AddtlInf", "_RspnSrcOthrTp", "_TempScrCardDataReusePrtd", "_RspnSrcCtry"]
	@property
