...
class QuantityAndAccount117(base_types._BaseFieldType):

	__slots__ = ["_DnmtnChc", "_SfkpgAcct", "_SttlmQty", "_SfkpgPlc", "_BlckChainAdrOrWllt", "_AcctOwnr", "_QtyBrkdwn", "_CshAcct"]
	@property
	def DnmtnChc(self):
