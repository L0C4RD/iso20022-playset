...
class CorporateActionRate136(base_types._BaseFieldType):
	...
	__slots__ = ["_TaxblIncmPerDvddShr", "_MaxAllwdOvrsbcptRate", "_GrssDstrbtnRate", "_NetDstrbtnRate", "_ScndLvlTax", "_AddtlTax", "_IssrDclrdXchgRate", "_BidIntrvl", "_GrssIntrstRateUsdForPmt", "_PrratnRate", "_WhldgTaxRate", "_TaxOnIncm"]
	@property
