...
class Instalment5(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlNbOfPmts", "_PlanId", "_SeqNb", "_Chrgs", "_LastAmt", "_FrstPmtDt", "_InstlmtPrd", "_DtldChrgs", "_TtlAmt", "_InstlmtPlan", "_SbsqntAmt", "_IntrstRate", "_GracePrd", "_PrdUnit", "_PlanOwnr", "_PlanNtce", "_FrstAmt"]
	@property
	...
	def InstlmtPlan(self, value):
		self._InstlmtPlan = value if type(value) != base_types.auto else self.make_default("InstlmtPlan")
