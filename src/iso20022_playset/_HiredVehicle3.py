...
class HiredVehicle3(base_types._BaseFieldType):
	...
	def DstnAdr(self, value):
		self._DstnAdr = value if value is not None else base_types.UninitialisedField(self, 'DstnAdr', Address2, False)

	@DstnAdr.deleter
	def DstnAdr(self):
		del self._DstnAdr
		self._DstnAdr = base_types.UninitialisedField(self, 'DstnAdr', Address2, False)
