...
from . import TradeStateReport16
...
class TradeStateReport5Choice(base_types._BaseFieldType):
	...
	@Stat.setter
	def Stat(self, value):
		self._Stat = value if value is not None else base_types.UninitialisedField(self, 'Stat', TradeStateReport16, True)

	@Stat.deleter
	def Stat(self):
		del self._Stat
		self._Stat = base_types.UninitialisedField(self, 'Stat', TradeStateReport16, True)
