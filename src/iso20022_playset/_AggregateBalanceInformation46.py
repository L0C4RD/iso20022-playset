...
from . import AggregateBalancePerSafekeepingPlace43
...
class AggregateBalanceInformation46(base_types._BaseFieldType):
	...
	def BalAtSfkpgPlc(self, value):
		self._BalAtSfkpgPlc = value if value is not None else base_types.UninitialisedField(self, 'BalAtSfkpgPlc', AggregateBalancePerSafekeepingPlace43, True)

	@BalAtSfkpgPlc.deleter
	def BalAtSfkpgPlc(self):
		del self._BalAtSfkpgPlc
		self._BalAtSfkpgPlc = base_types.UninitialisedField(self, 'BalAtSfkpgPlc', AggregateBalancePerSafekeepingPlace43, True)
