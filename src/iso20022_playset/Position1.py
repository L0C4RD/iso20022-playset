...
from .Fraction5DecimalNumber import Fraction5DecimalNumber
from .Max256Text import Max256Text
from .ActiveCurrencyAnd24Amount import ActiveCurrencyAnd24Amount
from .ActiveCurrencyAndAmount import ActiveCurrencyAndAmount
from .EndOfDayRequirement1 import EndOfDayRequirement1
from .NonNegativeFraction5DecimalNumber import NonNegativeFraction5DecimalNumber

class Position1(base_types._BaseFieldType):

	__slots__ = ["_GrssNtnl", "_GrssDltaEqvtVal", "_GrssMktVal", "_RskRqrmnt", "_NetDltaEqvtVal", "_NetNtnl", "_GrssDltaEqvtQty", "_PdctId", "_NetDltaEqvtQty"]
	@property
	def GrssNtnl(self):
	...
	def GrssNtnl(self, value):
		self._GrssNtnl = value if type(value) != auto else self.make_default("GrssNtnl")
	...
	def GrssMktVal(self, value):
		self._GrssMktVal = value if type(value) != auto else self.make_default("GrssMktVal")
