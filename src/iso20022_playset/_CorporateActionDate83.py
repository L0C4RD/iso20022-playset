...
class CorporateActionDate83(base_types._BaseFieldType):
	...
	def AnncmntDt(self, value):
		self._AnncmntDt = value if value is not None else base_types.UninitialisedField(self, 'AnncmntDt', DateFormat43Choice, False)

	@AnncmntDt.deleter
	def AnncmntDt(self):
		del self._AnncmntDt
		self._AnncmntDt = base_types.UninitialisedField(self, 'AnncmntDt', DateFormat43Choice, False)
	...
	def CertfctnDdln(self, value):
		self._CertfctnDdln = value if value is not None else base_types.UninitialisedField(self, 'CertfctnDdln', DateFormat43Choice, False)

	@CertfctnDdln.deleter
	def CertfctnDdln(self):
		del self._CertfctnDdln
		self._CertfctnDdln = base_types.UninitialisedField(self, 'CertfctnDdln', DateFormat43Choice, False)
	...
	def CrtApprvlDt(self, value):
		self._CrtApprvlDt = value if value is not None else base_types.UninitialisedField(self, 'CrtApprvlDt', DateFormat30Choice, False)

	@CrtApprvlDt.deleter
	def CrtApprvlDt(self):
		del self._CrtApprvlDt
		self._CrtApprvlDt = base_types.UninitialisedField(self, 'CrtApprvlDt', DateFormat30Choice, False)
	...
	def DdlnForTaxBrkdwnInstr(self, value):
		self._DdlnForTaxBrkdwnInstr = value if value is not None else base_types.UninitialisedField(self, 'DdlnForTaxBrkdwnInstr', DateFormat43Choice, False)

	@DdlnForTaxBrkdwnInstr.deleter
	def DdlnForTaxBrkdwnInstr(self):
		del self._DdlnForTaxBrkdwnInstr
		self._DdlnForTaxBrkdwnInstr = base_types.UninitialisedField(self, 'DdlnForTaxBrkdwnInstr', DateFormat43Choice, False)
	...
	def DdlnToSplt(self, value):
		self._DdlnToSplt = value if value is not None else base_types.UninitialisedField(self, 'DdlnToSplt', DateFormat43Choice, False)

	@DdlnToSplt.deleter
	def DdlnToSplt(self):
		del self._DdlnToSplt
		self._DdlnToSplt = base_types.UninitialisedField(self, 'DdlnToSplt', DateFormat43Choice, False)
	...
	def EarlyClsgDt(self, value):
		self._EarlyClsgDt = value if value is not None else base_types.UninitialisedField(self, 'EarlyClsgDt', DateFormat43Choice, False)

	@EarlyClsgDt.deleter
	def EarlyClsgDt(self):
		del self._EarlyClsgDt
		self._EarlyClsgDt = base_types.UninitialisedField(self, 'EarlyClsgDt', DateFormat43Choice, False)
	...
	def EarlyThrdPtyDdln(self, value):
		self._EarlyThrdPtyDdln = value if value is not None else base_types.UninitialisedField(self, 'EarlyThrdPtyDdln', DateFormat43Choice, False)

	@EarlyThrdPtyDdln.deleter
	def EarlyThrdPtyDdln(self):
		del self._EarlyThrdPtyDdln
		self._EarlyThrdPtyDdln = base_types.UninitialisedField(self, 'EarlyThrdPtyDdln', DateFormat43Choice, False)
	...
	def ElctnToCtrPtyMktDdln(self, value):
		self._ElctnToCtrPtyMktDdln = value if value is not None else base_types.UninitialisedField(self, 'ElctnToCtrPtyMktDdln', DateFormat43Choice, False)

	@ElctnToCtrPtyMktDdln.deleter
	def ElctnToCtrPtyMktDdln(self):
		del self._ElctnToCtrPtyMktDdln
		self._ElctnToCtrPtyMktDdln = base_types.UninitialisedField(self, 'ElctnToCtrPtyMktDdln', DateFormat43Choice, False)
	...
	def ElctnToCtrPtyRspnDdln(self, value):
		self._ElctnToCtrPtyRspnDdln = value if value is not None else base_types.UninitialisedField(self, 'ElctnToCtrPtyRspnDdln', DateFormat43Choice, False)

	@ElctnToCtrPtyRspnDdln.deleter
	def ElctnToCtrPtyRspnDdln(self):
		del self._ElctnToCtrPtyRspnDdln
		self._ElctnToCtrPtyRspnDdln = base_types.UninitialisedField(self, 'ElctnToCtrPtyRspnDdln', DateFormat43Choice, False)
	...
	def EqulstnDt(self, value):
		self._EqulstnDt = value if value is not None else base_types.UninitialisedField(self, 'EqulstnDt', DateFormat30Choice, False)

	@EqulstnDt.deleter
	def EqulstnDt(self):
		del self._EqulstnDt
		self._EqulstnDt = base_types.UninitialisedField(self, 'EqulstnDt', DateFormat30Choice, False)
	...
	def FctvDt(self, value):
		self._FctvDt = value if value is not None else base_types.UninitialisedField(self, 'FctvDt', DateFormat30Choice, False)

	@FctvDt.deleter
	def FctvDt(self):
		del self._FctvDt
		self._FctvDt = base_types.UninitialisedField(self, 'FctvDt', DateFormat30Choice, False)
	...
	def FilgDt(self, value):
		self._FilgDt = value if value is not None else base_types.UninitialisedField(self, 'FilgDt', DateFormat30Choice, False)

	@FilgDt.deleter
	def FilgDt(self):
		del self._FilgDt
		self._FilgDt = base_types.UninitialisedField(self, 'FilgDt', DateFormat30Choice, False)
	...
	def FrthrDtldAnncmntDt(self, value):
		self._FrthrDtldAnncmntDt = value if value is not None else base_types.UninitialisedField(self, 'FrthrDtldAnncmntDt', DateFormat43Choice, False)

	@FrthrDtldAnncmntDt.deleter
	def FrthrDtldAnncmntDt(self):
		del self._FrthrDtldAnncmntDt
		self._FrthrDtldAnncmntDt = base_types.UninitialisedField(self, 'FrthrDtldAnncmntDt', DateFormat43Choice, False)
	...
	def FxgDt(self, value):
		self._FxgDt = value if value is not None else base_types.UninitialisedField(self, 'FxgDt', DateFormat43Choice, False)

	@FxgDt.deleter
	def FxgDt(self):
		del self._FxgDt
		self._FxgDt = base_types.UninitialisedField(self, 'FxgDt', DateFormat43Choice, False)
	...
	def GrntedPrtcptnDt(self, value):
		self._GrntedPrtcptnDt = value if value is not None else base_types.UninitialisedField(self, 'GrntedPrtcptnDt', DateFormat30Choice, False)

	@GrntedPrtcptnDt.deleter
	def GrntedPrtcptnDt(self):
		del self._GrntedPrtcptnDt
		self._GrntedPrtcptnDt = base_types.UninitialisedField(self, 'GrntedPrtcptnDt', DateFormat30Choice, False)
	...
	def HrgDt(self, value):
		self._HrgDt = value if value is not None else base_types.UninitialisedField(self, 'HrgDt', DateFormat30Choice, False)

	@HrgDt.deleter
	def HrgDt(self):
		del self._HrgDt
		self._HrgDt = base_types.UninitialisedField(self, 'HrgDt', DateFormat30Choice, False)
	...
	def LeadPlntffDdln(self, value):
		self._LeadPlntffDdln = value if value is not None else base_types.UninitialisedField(self, 'LeadPlntffDdln', DateFormat43Choice, False)

	@LeadPlntffDdln.deleter
	def LeadPlntffDdln(self):
		del self._LeadPlntffDdln
		self._LeadPlntffDdln = base_types.UninitialisedField(self, 'LeadPlntffDdln', DateFormat43Choice, False)
	...
	def LpsdDt(self, value):
		self._LpsdDt = value if value is not None else base_types.UninitialisedField(self, 'LpsdDt', DateFormat30Choice, False)

	@LpsdDt.deleter
	def LpsdDt(self):
		del self._LpsdDt
		self._LpsdDt = base_types.UninitialisedField(self, 'LpsdDt', DateFormat30Choice, False)
	...
	def MktClmTrckgEndDt(self, value):
		self._MktClmTrckgEndDt = value if value is not None else base_types.UninitialisedField(self, 'MktClmTrckgEndDt', DateFormat30Choice, False)

	@MktClmTrckgEndDt.deleter
	def MktClmTrckgEndDt(self):
		del self._MktClmTrckgEndDt
		self._MktClmTrckgEndDt = base_types.UninitialisedField(self, 'MktClmTrckgEndDt', DateFormat30Choice, False)
	...
	def MrgnFxgDt(self, value):
		self._MrgnFxgDt = value if value is not None else base_types.UninitialisedField(self, 'MrgnFxgDt', DateFormat30Choice, False)

	@MrgnFxgDt.deleter
	def MrgnFxgDt(self):
		del self._MrgnFxgDt
		self._MrgnFxgDt = base_types.UninitialisedField(self, 'MrgnFxgDt', DateFormat30Choice, False)
	...
	def MtgDt(self, value):
		self._MtgDt = value if value is not None else base_types.UninitialisedField(self, 'MtgDt', DateFormat43Choice, False)

	@MtgDt.deleter
	def MtgDt(self):
		del self._MtgDt
		self._MtgDt = base_types.UninitialisedField(self, 'MtgDt', DateFormat43Choice, False)
	...
	def NewMtrtyDt(self, value):
		self._NewMtrtyDt = value if value is not None else base_types.UninitialisedField(self, 'NewMtrtyDt', DateFormat30Choice, False)

	@NewMtrtyDt.deleter
	def NewMtrtyDt(self):
		del self._NewMtrtyDt
		self._NewMtrtyDt = base_types.UninitialisedField(self, 'NewMtrtyDt', DateFormat30Choice, False)
	...
	def OffclAnncmntPblctnDt(self, value):
		self._OffclAnncmntPblctnDt = value if value is not None else base_types.UninitialisedField(self, 'OffclAnncmntPblctnDt', DateFormat43Choice, False)

	@OffclAnncmntPblctnDt.deleter
	def OffclAnncmntPblctnDt(self):
		del self._OffclAnncmntPblctnDt
		self._OffclAnncmntPblctnDt = base_types.UninitialisedField(self, 'OffclAnncmntPblctnDt', DateFormat43Choice, False)
	...
	def PrratnDt(self, value):
		self._PrratnDt = value if value is not None else base_types.UninitialisedField(self, 'PrratnDt', DateFormat30Choice, False)

	@PrratnDt.deleter
	def PrratnDt(self):
		del self._PrratnDt
		self._PrratnDt = base_types.UninitialisedField(self, 'PrratnDt', DateFormat30Choice, False)
	...
	def RegnDdln(self, value):
		self._RegnDdln = value if value is not None else base_types.UninitialisedField(self, 'RegnDdln', DateFormat43Choice, False)

	@RegnDdln.deleter
	def RegnDdln(self):
		del self._RegnDdln
		self._RegnDdln = base_types.UninitialisedField(self, 'RegnDdln', DateFormat43Choice, False)
	...
	def RsltsPblctnDt(self, value):
		self._RsltsPblctnDt = value if value is not None else base_types.UninitialisedField(self, 'RsltsPblctnDt', DateFormat43Choice, False)

	@RsltsPblctnDt.deleter
	def RsltsPblctnDt(self):
		del self._RsltsPblctnDt
		self._RsltsPblctnDt = base_types.UninitialisedField(self, 'RsltsPblctnDt', DateFormat43Choice, False)
	...
	def SpclExDt(self, value):
		self._SpclExDt = value if value is not None else base_types.UninitialisedField(self, 'SpclExDt', DateFormat30Choice, False)

	@SpclExDt.deleter
	def SpclExDt(self):
		del self._SpclExDt
		self._SpclExDt = base_types.UninitialisedField(self, 'SpclExDt', DateFormat30Choice, False)
	...
	def ThrdPtyDdln(self, value):
		self._ThrdPtyDdln = value if value is not None else base_types.UninitialisedField(self, 'ThrdPtyDdln', DateFormat43Choice, False)

	@ThrdPtyDdln.deleter
	def ThrdPtyDdln(self):
		del self._ThrdPtyDdln
		self._ThrdPtyDdln = base_types.UninitialisedField(self, 'ThrdPtyDdln', DateFormat43Choice, False)
	...
	def TradgSspdDt(self, value):
		self._TradgSspdDt = value if value is not None else base_types.UninitialisedField(self, 'TradgSspdDt', DateFormat43Choice, False)

	@TradgSspdDt.deleter
	def TradgSspdDt(self):
		del self._TradgSspdDt
		self._TradgSspdDt = base_types.UninitialisedField(self, 'TradgSspdDt', DateFormat43Choice, False)
	...
	def UcondlDt(self, value):
		self._UcondlDt = value if value is not None else base_types.UninitialisedField(self, 'UcondlDt', DateFormat30Choice, False)

	@UcondlDt.deleter
	def UcondlDt(self):
		del self._UcondlDt
		self._UcondlDt = base_types.UninitialisedField(self, 'UcondlDt', DateFormat30Choice, False)
	...
	def WhlyUcondlDt(self, value):
		self._WhlyUcondlDt = value if value is not None else base_types.UninitialisedField(self, 'WhlyUcondlDt', DateFormat30Choice, False)

	@WhlyUcondlDt.deleter
	def WhlyUcondlDt(self):
		del self._WhlyUcondlDt
		self._WhlyUcondlDt = base_types.UninitialisedField(self, 'WhlyUcondlDt', DateFormat30Choice, False)
