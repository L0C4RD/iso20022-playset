...
from .PartyIdentification28 import PartyIdentification28
from .TransactionStatus4 import TransactionStatus4
from .BICIdentification1 import BICIdentification1
from .PendingActivity1 import PendingActivity1

class ReportSpecification4(base_types._BaseFieldType):

	__slots__ = ["_SubmitgBk", "_CrspdtCtry", "_SubmitrTxRef", "_SellrCtry", "_TxId", "_BuyrCtry", "_Crspdt", "_OblgrBk", "_TxSts", "_Buyr", "_PdgReqForActn", "_Sellr", "_NttiesToBeRptd"]
	@property
	def SubmitgBk(self):
