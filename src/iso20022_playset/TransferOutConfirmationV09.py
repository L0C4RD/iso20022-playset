...
from .ReceiveInformation20 import ReceiveInformation20
...
class TransferOutConfirmationV09(base_types._BaseFieldType):
	...
	__slots__ = ["_TrfDtls", "_Xtnsn", "_MsgId", "_PrvsRef", "_AcctDtls", "_SttlmDtls", "_MktPrctcVrsn", "_MstrRef", "_CpyDtls", "_RltdRef", "_PoolRef"]
	@property
	def TrfDtls(self):
