...
class FeeCollectionResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Sndr", "_TxAmts", "_OrgnlDataElmts", "_Card", "_AddtlData", "_Tkn", "_Rcncltn", "_Dstn", "_SpclPrgrmmQlfctn", "_FeeColltnRef", "_Prgrmm", "_PrtctdData", "_Accptr", "_Issr", "_TxId", "_TxChrtcs", "_SttlmSvc", "_Rcvr", "_AddtlAmt", "_Jursdctn", "_SplmtryData", "_Orgtr", "_Acqrr", "_PrcgRslt", "_SctyTrlr", "_ConvsDtTm", "_Hdr", "_AddtlFee", "_Cntxt"]
	@property
	def Sndr(self):
		return self._Sndr
