...
class SecuredMarketTransaction4(base_types._BaseFieldType):
	...
	__slots__ = ["_TradDt", "_UnqTxIdr", "_RltdPrtryTxId", "_TxTp", "_NvtnSts", "_BrkrdDeal", "_BrnchId", "_RptdTxSts", "_PrtryTxId", "_RateTp", "_SttlmDt", "_Coll", "_FltgRateRpAgrmt", "_DealRate", "_CtrPtyId", "_SplmtryData", "_CtrPtyPrtryTxId", "_TxNmnlAmt", "_MtrtyDt", "_TrptyAgtId"]
	@property
	def TradDt(self):
		return self._TradDt
