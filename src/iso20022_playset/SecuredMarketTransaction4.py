...
class SecuredMarketTransaction4(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_TradDt", "_PrtryTxId", "_RptdTxSts", "_NvtnSts", "_SttlmDt", "_TxNmnlAmt", "_MtrtyDt", "_TrptyAgtId", "_RltdPrtryTxId", "_RateTp", "_CtrPtyId", "_Coll", "_BrnchId", "_BrkrdDeal", "_DealRate", "_CtrPtyPrtryTxId", "_UnqTxIdr", "_TxTp", "_FltgRateRpAgrmt"]
	@property
