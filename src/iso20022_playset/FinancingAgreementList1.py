...
from .FinancingAgreementItem1 import FinancingAgreementItem1
from .xs:IDREF import xs:IDREF

class FinancingAgreementList1(base_types._BaseFieldType):

	__slots__ = ["_Idr", "_Dt", "_VldtnStsInf", "_RltdDoc", "_Itm", "_CtrlSum", "_GrntApplcnt", "_ItmCnt", "_GrntNbfcry", "_AgrmtRqstr", "_NtfctnInf", "_AgrmtRspndr", "_AddtlInf", "_GrntIssr"]
	@property
	def Idr(self):
		return self._Idr
