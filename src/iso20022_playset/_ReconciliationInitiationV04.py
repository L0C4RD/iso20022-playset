...
class ReconciliationInitiationV04(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrRcncltnTp", "_RcncltnTp", "_Sndr", "_PrcgRslt", "_ReqdCcy", "_RcncltnFctn", "_AddtlData", "_Jursdctn", "_AddtlFee", "_LifeCyclId", "_Hdr", "_RcncltnTtls", "_RcncltnActvtyTp", "_RtrvlRefNb", "_Rcncltn", "_Prgrmm", "_SctyTrlr", "_Rcvr", "_SysTracAudtNb", "_SttlmSvc", "_OthrRcncltnActvtyTp", "_PrtctdData", "_TrnsmssnDtTm", "_Orgtr", "_SplmtryData", "_Dstn"]
	@property
	def AddtlData(self):
