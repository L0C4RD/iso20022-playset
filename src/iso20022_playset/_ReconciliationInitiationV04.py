...
from . import CardServiceType4Code
...
from . import ReconciliationActivityType1Code
from . import ReconciliationFunction1Code
from . import SettlementService6
from . import SupplementaryData1
from . import TransactionTotals14

class ReconciliationInitiationV04(base_types._BaseFieldType):

	__slots__ = ["_AddtlData", "_AddtlFee", "_Dstn", "_Hdr", "_Jursdctn", "_LifeCyclId", "_Orgtr", "_OthrRcncltnActvtyTp", "_OthrRcncltnTp", "_PrcgRslt", "_Prgrmm", "_PrtctdData", "_Rcncltn", "_RcncltnActvtyTp", "_RcncltnFctn", "_RcncltnTp", "_RcncltnTtls", "_Rcvr", "_ReqdCcy", "_RtrvlRefNb", "_SctyTrlr", "_Sndr", "_SplmtryData", "_SttlmSvc", "_SysTracAudtNb", "_TrnsmssnDtTm"]
	@property
	def AddtlData(self):
	...
	def OthrRcncltnActvtyTp(self, value):
		self._OthrRcncltnActvtyTp = value if value is not None else base_types.UninitialisedField(self, 'OthrRcncltnActvtyTp', Max35Text, False)

	@OthrRcncltnActvtyTp.deleter
	def OthrRcncltnActvtyTp(self):
		del self._OthrRcncltnActvtyTp
		self._OthrRcncltnActvtyTp = base_types.UninitialisedField(self, 'OthrRcncltnActvtyTp', Max35Text, False)
	...
	def OthrRcncltnTp(self, value):
		self._OthrRcncltnTp = value if value is not None else base_types.UninitialisedField(self, 'OthrRcncltnTp', Max35Text, False)

	@OthrRcncltnTp.deleter
	def OthrRcncltnTp(self):
		del self._OthrRcncltnTp
		self._OthrRcncltnTp = base_types.UninitialisedField(self, 'OthrRcncltnTp', Max35Text, False)
	...
	def RcncltnActvtyTp(self, value):
		self._RcncltnActvtyTp = value if value is not None else base_types.UninitialisedField(self, 'RcncltnActvtyTp', ReconciliationActivityType1Code, False)

	@RcncltnActvtyTp.deleter
	def RcncltnActvtyTp(self):
		del self._RcncltnActvtyTp
		self._RcncltnActvtyTp = base_types.UninitialisedField(self, 'RcncltnActvtyTp', ReconciliationActivityType1Code, False)
	...
	def RcncltnFctn(self, value):
		self._RcncltnFctn = value if value is not None else base_types.UninitialisedField(self, 'RcncltnFctn', ReconciliationFunction1Code, False)

	@RcncltnFctn.deleter
	def RcncltnFctn(self):
		del self._RcncltnFctn
		self._RcncltnFctn = base_types.UninitialisedField(self, 'RcncltnFctn', ReconciliationFunction1Code, False)
	...
	def RcncltnTp(self, value):
		self._RcncltnTp = value if value is not None else base_types.UninitialisedField(self, 'RcncltnTp', CardServiceType4Code, False)

	@RcncltnTp.deleter
	def RcncltnTp(self):
		del self._RcncltnTp
		self._RcncltnTp = base_types.UninitialisedField(self, 'RcncltnTp', CardServiceType4Code, False)
	...
	def RcncltnTtls(self, value):
		self._RcncltnTtls = value if value is not None else base_types.UninitialisedField(self, 'RcncltnTtls', TransactionTotals14, True)

	@RcncltnTtls.deleter
	def RcncltnTtls(self):
		del self._RcncltnTtls
		self._RcncltnTtls = base_types.UninitialisedField(self, 'RcncltnTtls', TransactionTotals14, True)
	...
	def ReqdCcy(self, value):
		self._ReqdCcy = value if value is not None else base_types.UninitialisedField(self, 'ReqdCcy', Exact3NumericText, True)

	@ReqdCcy.deleter
	def ReqdCcy(self):
		del self._ReqdCcy
		self._ReqdCcy = base_types.UninitialisedField(self, 'ReqdCcy', Exact3NumericText, True)
