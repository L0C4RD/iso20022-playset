...
class FinancingItemList1(base_types._BaseFieldType):
	...
	__slots__ = ["_VldtnStsInf", "_TtlReqAmt", "_ItmCnt", "_Assgne", "_IsseDt", "_FincgInstlmt", "_AgrdRate", "_Assgnr", "_AmtCutOffDt", "_NtfctnInf", "_CtrlSum", "_Idr", "_FincgSts", "_AddtlInf", "_FinItm", "_RltdDoc", "_TtlReqFincg"]
	@property
