...
class FinancingItemList1(base_types._BaseFieldType):
	...
	__slots__ = ["_Idr", "_Assgnr", "_FincgSts", "_VldtnStsInf", "_RltdDoc", "_AgrdRate", "_Assgne", "_TtlReqFincg", "_TtlReqAmt", "_IsseDt", "_AddtlInf", "_NtfctnInf", "_AmtCutOffDt", "_FincgInstlmt", "_CtrlSum", "_FinItm", "_ItmCnt"]
	@property
	def Idr(self):
		return self._Idr
