...
class FinancialInstrumentAttributes131(base_types._BaseFieldType):
	...
	__slots__ = ["_IsseDt", "_ClssfctnTp", "_ConvsDt", "_NxtCllblDt", "_MinNmnlQty", "_IssePric", "_FltgRateFxgDt", "_FinInstrmId", "_DayCntBsis", "_MtrtyDt", "_PutblDt", "_DtdDt", "_NxtCpnDt", "_OptnStyle", "_IntrstRate", "_NxtIntrstRate", "_CtrctSz", "_PrvsFctr", "_NxtFctr", "_MinQtyToInst", "_MinMltplQtyToInst", "_PlcOfListg", "_DnmtnCcy"]
	@property
	def IsseDt(self):
		return self._IsseDt
