...
class FinancialInstrumentAttributes131(base_types._BaseFieldType):
	...
	__slots__ = ["_MtrtyDt", "_PrvsFctr", "_NxtIntrstRate", "_DtdDt", "_PlcOfListg", "_IsseDt", "_FltgRateFxgDt", "_MinMltplQtyToInst", "_OptnStyle", "_CtrctSz", "_DnmtnCcy", "_ClssfctnTp", "_IssePric", "_NxtCpnDt", "_NxtCllblDt", "_FinInstrmId", "_IntrstRate", "_MinNmnlQty", "_MinQtyToInst", "_DayCntBsis", "_ConvsDt", "_NxtFctr", "_PutblDt"]
	@property
	def MtrtyDt(self):
