...
class FinancialInstrumentAttributes131(base_types._BaseFieldType):
	...
	__slots__ = ["_IsseDt", "_NxtCllblDt", "_PrvsFctr", "_PlcOfListg", "_FinInstrmId", "_ConvsDt", "_IssePric", "_ClssfctnTp", "_IntrstRate", "_NxtIntrstRate", "_PutblDt", "_DayCntBsis", "_MinMltplQtyToInst", "_MtrtyDt", "_NxtFctr", "_NxtCpnDt", "_MinQtyToInst", "_CtrctSz", "_DtdDt", "_OptnStyle", "_FltgRateFxgDt", "_DnmtnCcy", "_MinNmnlQty"]
	@property
	def IsseDt(self):
		return self._IsseDt
