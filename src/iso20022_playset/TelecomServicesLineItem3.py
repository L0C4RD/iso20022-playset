...
class TelecomServicesLineItem3(base_types._BaseFieldType):
	...
	__slots__ = ["_CallFrCtrySubDvsnMjr", "_TtlAmt", "_CallToTp", "_TmPrd", "_Drtn", "_CallFrCity", "_Chrg", "_AddtlData", "_Tax", "_CallFrPhne", "_CallFrOthrTp", "_CallToCity", "_CallFrCtrySubDvsnMnr", "_CallToPhne", "_Desc", "_CallToCtrySubDvsnMnr", "_CallFrTp", "_StartDtTm", "_CallToCtry", "_CallToOthrTp", "_CallFrCtry", "_CallToCtrySubDvsnMjr"]
	@property
