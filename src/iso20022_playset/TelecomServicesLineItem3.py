...
class TelecomServicesLineItem3(base_types._BaseFieldType):
	...
	__slots__ = ["_CallFrTp", "_CallToCity", "_Drtn", "_Desc", "_CallToOthrTp", "_CallFrPhne", "_Chrg", "_CallFrCity", "_TmPrd", "_CallFrOthrTp", "_StartDtTm", "_CallFrCtrySubDvsnMnr", "_CallToCtrySubDvsnMnr", "_TtlAmt", "_CallToTp", "_CallToCtry", "_Tax", "_CallToPhne", "_CallFrCtry", "_CallToCtrySubDvsnMjr", "_CallFrCtrySubDvsnMjr", "_AddtlData"]
	@property
	def CallFrTp(self):
