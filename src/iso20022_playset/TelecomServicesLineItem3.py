...
class TelecomServicesLineItem3(base_types._BaseFieldType):
	...
	__slots__ = ["_CallFrCtrySubDvsnMnr", "_Drtn", "_TmPrd", "_CallToTp", "_CallFrCtrySubDvsnMjr", "_CallToCtrySubDvsnMjr", "_Tax", "_Desc", "_CallToCtry", "_CallFrCity", "_CallToOthrTp", "_CallFrPhne", "_StartDtTm", "_CallToPhne", "_CallToCity", "_TtlAmt", "_CallToCtrySubDvsnMnr", "_CallFrOthrTp", "_CallFrTp", "_Chrg", "_AddtlData", "_CallFrCtry"]
	@property
