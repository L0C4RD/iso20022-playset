...
class TelecomServicesLineItem3(base_types._BaseFieldType):
	...
	__slots__ = ["_CallFrOthrTp", "_TmPrd", "_CallToCtrySubDvsnMnr", "_TtlAmt", "_CallFrCtry", "_CallToPhne", "_CallFrCity", "_AddtlData", "_Desc", "_CallToCtry", "_CallToCtrySubDvsnMjr", "_Tax", "_CallFrTp", "_CallToOthrTp", "_CallToCity", "_CallFrCtrySubDvsnMnr", "_StartDtTm", "_Drtn", "_Chrg", "_CallFrCtrySubDvsnMjr", "_CallToTp", "_CallFrPhne"]
	@property
