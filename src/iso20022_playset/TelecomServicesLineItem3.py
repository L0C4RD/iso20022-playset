...
class TelecomServicesLineItem3(base_types._BaseFieldType):
	...
	__slots__ = ["_CallToOthrTp", "_Tax", "_CallToCity", "_CallToCtrySubDvsnMjr", "_CallFrCtrySubDvsnMjr", "_CallFrCity", "_Chrg", "_TtlAmt", "_CallFrPhne", "_Desc", "_CallFrCtry", "_Drtn", "_TmPrd", "_StartDtTm", "_CallToCtry", "_CallToPhne", "_CallToCtrySubDvsnMnr", "_AddtlData", "_CallFrTp", "_CallToTp", "_CallFrCtrySubDvsnMnr", "_CallFrOthrTp"]
	@property
