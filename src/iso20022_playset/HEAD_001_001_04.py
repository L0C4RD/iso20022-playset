...
import BusinessApplicationHeader8
...
class HEAD_001_001_04():
	...
	class BusinessApplicationHeaderV04(base_types._BaseFieldType):
		...
		__slots__ = ["_MktPrctc", "_Sgntr", "_CreDt", "_To", "_BizMsgIdr", "_Fr", "_CpyDplct", "_MsgDefIdr", "_PssblDplct", "_BizSvc", "_Prty", "_Rltd", "_BizPrcgDt", "_CharSet"]
		@property
		def MktPrctc(self):
