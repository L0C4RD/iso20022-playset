...
from .IndicativeOrMarketPrice14Choice import IndicativeOrMarketPrice14Choice

class CorporateActionPrice89(base_types._BaseFieldType):

	__slots__ = ["_CshInLieuOfShrPric", "_IndctvOrMktPric", "_GncCshPricRcvdPerPdct", "_CshValForTax", "_GncCshPricPdPerPdct"]
	@property
