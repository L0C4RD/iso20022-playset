...
class SettlementTypeAndAdditionalParameters23(base_types._BaseFieldType):
	...
	__slots__ = ["_CmonId", "_ClntTrptyCollTxId", "_CorpActnEvtId", "_Pmt", "_NonceId", "_TrptyAgtSvcPrvdrCollInstrId", "_TrptyAgtSvcPrvdrCollTxId", "_ClntCollInstrId", "_RcncltnInd", "_SctiesMvmntTp"]
	@property
	def CmonId(self):
		return self._CmonId
