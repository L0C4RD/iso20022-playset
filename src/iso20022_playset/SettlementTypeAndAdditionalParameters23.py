...
class SettlementTypeAndAdditionalParameters23(base_types._BaseFieldType):
	...
	__slots__ = ["_RcncltnInd", "_CmonId", "_TrptyAgtSvcPrvdrCollTxId", "_NonceId", "_SctiesMvmntTp", "_CorpActnEvtId", "_Pmt", "_ClntCollInstrId", "_TrptyAgtSvcPrvdrCollInstrId", "_ClntTrptyCollTxId"]
	@property
	def RcncltnInd(self):
