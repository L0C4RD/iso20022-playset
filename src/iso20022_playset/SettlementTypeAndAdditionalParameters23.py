...
class SettlementTypeAndAdditionalParameters23(base_types._BaseFieldType):
	...
	__slots__ = ["_ClntCollInstrId", "_ClntTrptyCollTxId", "_Pmt", "_CorpActnEvtId", "_SctiesMvmntTp", "_TrptyAgtSvcPrvdrCollTxId", "_CmonId", "_TrptyAgtSvcPrvdrCollInstrId", "_RcncltnInd", "_NonceId"]
	@property
