...
class SettlementTypeAndAdditionalParameters23(base_types._BaseFieldType):
	...
	__slots__ = ["_ClntTrptyCollTxId", "_TrptyAgtSvcPrvdrCollTxId", "_RcncltnInd", "_NonceId", "_CorpActnEvtId", "_SctiesMvmntTp", "_ClntCollInstrId", "_TrptyAgtSvcPrvdrCollInstrId", "_CmonId", "_Pmt"]
	@property
