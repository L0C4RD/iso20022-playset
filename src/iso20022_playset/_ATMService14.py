...
from . import ATMServiceType7Code
from . import Max35Text

class ATMService14(base_types._BaseFieldType):
	...
	def SvcTp(self, value):
		self._SvcTp = value if value is not None else base_types.UninitialisedField(self, 'SvcTp', ATMServiceType7Code, False)

	@SvcTp.deleter
	def SvcTp(self):
		del self._SvcTp
		self._SvcTp = base_types.UninitialisedField(self, 'SvcTp', ATMServiceType7Code, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='SvcTp', type=ATMServiceType7Code, min=1, max=1, mutex_group=None, array=False),
