...
from ._SecuritiesFinancingInstructionV13 import SecuritiesFinancingInstructionV13
...
class SESE_033_001_13():
	...
	class Document(base_types._BaseFieldType):
		...
		attrib = {
			"xmlns" : base_types._BaseDataType_String(None, data="urn:iso:std:iso:20022:tech:xsd:sese.033.001.13"),
		}
