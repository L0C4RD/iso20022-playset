...
from . import FinancialInstrumentQuantity27Choice
...
class SubscriptionOrder15(base_types._BaseFieldType):
	...
	def AmtOrUnits(self, value):
		self._AmtOrUnits = value if value is not None else base_types.UninitialisedField(self, 'AmtOrUnits', FinancialInstrumentQuantity27Choice, False)

	@AmtOrUnits.deleter
	def AmtOrUnits(self):
		del self._AmtOrUnits
		self._AmtOrUnits = base_types.UninitialisedField(self, 'AmtOrUnits', FinancialInstrumentQuantity27Choice, False)
