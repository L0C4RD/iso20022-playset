...
class SubscriptionOrder15(base_types._BaseFieldType):
	...
	__slots__ = ["_FinAdvc", "_LttrInttRef", "_CshSttlmDtls", "_SgntrTp", "_SttlmAndCtdyDtls", "_OrdrTp", "_FXDtls", "_SttlmMtd", "_NgtdTrad", "_TxOvrhd", "_IncmPref", "_Rndg", "_PhysDlvryDtls", "_PhysDlvryInd", "_Equlstn", "_SrcOfCsh", "_StffClntBrkdwn", "_BnfcryDtls", "_RltdPtyDtls", "_CshSttlmDt", "_OrdrRef", "_TxChanlTp", "_InvstmtAcctDtls", "_AcmltnRghtRef", "_CstmrCndctClssfctn", "_NonStdSttlmInf", "_SttlmAmt", "_OrdrWvrDtls", "_AmtOrUnits", "_ClntRef"]
	@property
	def FinAdvc(self):
