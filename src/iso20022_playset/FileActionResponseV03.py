...
class FileActionResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_SysTracAudtNb", "_Pyee", "_DataRcrd", "_Termnl", "_Crrctn", "_Dstn", "_AddtlData", "_RspnCd", "_LifeCyclId", "_SctyTrlr", "_Hdr", "_AddtlFee", "_Issr", "_FileSctyCd", "_Orgtr", "_Sndr", "_SttlmSvc", "_Pyer", "_Frmt", "_Wllt", "_Rcvr", "_ActnDt", "_Prgrmm", "_Accptr", "_Rcncltn", "_Jursdctn", "_RtrvlRefNb", "_TrnsmssnDtTm", "_Tkn", "_CstmrDvc", "_POICmpnt", "_Crdhldr", "_Card", "_FileNm", "_PrtctdData", "_Acqrr", "_SplmtryData"]
	@property
