...
class FileActionResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Prgrmm", "_DataRcrd", "_Acqrr", "_RspnCd", "_Accptr", "_TrnsmssnDtTm", "_AddtlData", "_Issr", "_Crrctn", "_Dstn", "_SplmtryData", "_Hdr", "_Pyer", "_SysTracAudtNb", "_ActnDt", "_SttlmSvc", "_Rcvr", "_Rcncltn", "_Frmt", "_Card", "_Tkn", "_FileNm", "_Wllt", "_SctyTrlr", "_Orgtr", "_LifeCyclId", "_AddtlFee", "_Pyee", "_Jursdctn", "_CstmrDvc", "_PrtctdData", "_RtrvlRefNb", "_FileSctyCd", "_Crdhldr", "_POICmpnt", "_Sndr", "_Termnl"]
	@property
	def Prgrmm(self):
		return self._Prgrmm
