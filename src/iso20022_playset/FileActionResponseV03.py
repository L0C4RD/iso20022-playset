...
class FileActionResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_POICmpnt", "_Frmt", "_RspnCd", "_Card", "_Tkn", "_Dstn", "_PrtctdData", "_RtrvlRefNb", "_Prgrmm", "_Crdhldr", "_Acqrr", "_Accptr", "_Rcvr", "_Jursdctn", "_Wllt", "_Orgtr", "_FileSctyCd", "_SctyTrlr", "_CstmrDvc", "_Hdr", "_Pyee", "_SttlmSvc", "_AddtlFee", "_Sndr", "_Termnl", "_AddtlData", "_Rcncltn", "_Crrctn", "_LifeCyclId", "_TrnsmssnDtTm", "_Issr", "_Pyer", "_FileNm", "_DataRcrd", "_SplmtryData", "_ActnDt", "_SysTracAudtNb"]
	@property
	def POICmpnt(self):
