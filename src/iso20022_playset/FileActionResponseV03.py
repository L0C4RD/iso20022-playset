...
class FileActionResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Frmt", "_ActnDt", "_FileNm", "_SplmtryData", "_Pyer", "_SttlmSvc", "_CstmrDvc", "_RtrvlRefNb", "_Prgrmm", "_Accptr", "_Termnl", "_Rcncltn", "_Rcvr", "_SctyTrlr", "_PrtctdData", "_Crdhldr", "_LifeCyclId", "_AddtlFee", "_RspnCd", "_FileSctyCd", "_Jursdctn", "_AddtlData", "_Orgtr", "_Hdr", "_SysTracAudtNb", "_Acqrr", "_Wllt", "_Sndr", "_Tkn", "_TrnsmssnDtTm", "_POICmpnt", "_Dstn", "_Pyee", "_Crrctn", "_Issr", "_DataRcrd", "_Card"]
	@property
	def Frmt(self):
		return self._Frmt
