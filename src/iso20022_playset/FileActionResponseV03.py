...
class FileActionResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_RtrvlRefNb", "_SctyTrlr", "_Hdr", "_Orgtr", "_Jursdctn", "_Rcvr", "_Prgrmm", "_Crrctn", "_Pyee", "_Card", "_Termnl", "_CstmrDvc", "_Dstn", "_SttlmSvc", "_Rcncltn", "_Issr", "_SplmtryData", "_FileSctyCd", "_Tkn", "_Pyer", "_AddtlData", "_FileNm", "_Sndr", "_Wllt", "_DataRcrd", "_POICmpnt", "_Accptr", "_SysTracAudtNb", "_TrnsmssnDtTm", "_Acqrr", "_AddtlFee", "_Frmt", "_PrtctdData", "_RspnCd", "_ActnDt", "_LifeCyclId", "_Crdhldr"]
	@property
	def RtrvlRefNb(self):
