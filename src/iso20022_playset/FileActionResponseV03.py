...
class FileActionResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_CstmrDvc", "_PrtctdData", "_SysTracAudtNb", "_Acqrr", "_Crdhldr", "_RspnCd", "_Frmt", "_RtrvlRefNb", "_Prgrmm", "_FileSctyCd", "_TrnsmssnDtTm", "_Rcncltn", "_FileNm", "_AddtlData", "_SttlmSvc", "_Issr", "_Wllt", "_Hdr", "_ActnDt", "_Dstn", "_Accptr", "_Termnl", "_Rcvr", "_Crrctn", "_Jursdctn", "_Pyee", "_Sndr", "_Pyer", "_Card", "_POICmpnt", "_AddtlFee", "_SplmtryData", "_LifeCyclId", "_Tkn", "_Orgtr", "_SctyTrlr", "_DataRcrd"]
	@property
	def CstmrDvc(self):
