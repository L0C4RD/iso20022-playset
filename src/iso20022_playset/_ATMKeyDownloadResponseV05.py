...
from . import ATMKeyDownloadResponse6
...
class ATMKeyDownloadResponseV05(base_types._BaseFieldType):
	...
	def ATMKeyDwnldRspn(self, value):
		self._ATMKeyDwnldRspn = value if value is not None else base_types.UninitialisedField(self, 'ATMKeyDwnldRspn', ATMKeyDownloadResponse6, False)

	@ATMKeyDwnldRspn.deleter
	def ATMKeyDwnldRspn(self):
		del self._ATMKeyDwnldRspn
		self._ATMKeyDwnldRspn = base_types.UninitialisedField(self, 'ATMKeyDwnldRspn', ATMKeyDownloadResponse6, False)
