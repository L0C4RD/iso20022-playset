...
class FinancialInstrumentAttributes137(base_types._BaseFieldType):
	...
	__slots__ = ["_OptnStyle", "_PrvsFctr", "_PlcOfListg", "_ConvsDt", "_MinMltplQtyToInst", "_DnmtnCcy", "_NxtCllblDt", "_CtrctSz", "_IntrstRate", "_FltgRateFxgDt", "_MinQtyToInst", "_IssePric", "_DtdDt", "_MtrtyDt", "_IsseDt", "_NxtIntrstRate", "_DayCntBsis", "_NxtCpnDt", "_PutblDt", "_ClssfctnTp", "_MinNmnlQty", "_NxtFctr", "_FinInstrmId"]
	@property
	def OptnStyle(self):
