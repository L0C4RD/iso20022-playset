...
class FinancialInstrumentAttributes137(base_types._BaseFieldType):
	...
	__slots__ = ["_DayCntBsis", "_MinMltplQtyToInst", "_IsseDt", "_OptnStyle", "_MtrtyDt", "_IntrstRate", "_FltgRateFxgDt", "_IssePric", "_NxtFctr", "_DnmtnCcy", "_NxtCpnDt", "_ClssfctnTp", "_DtdDt", "_PrvsFctr", "_PutblDt", "_CtrctSz", "_NxtIntrstRate", "_MinNmnlQty", "_FinInstrmId", "_NxtCllblDt", "_PlcOfListg", "_MinQtyToInst", "_ConvsDt"]
	@property
	def DayCntBsis(self):
