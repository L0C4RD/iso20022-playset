...
class KeyExchangeInitiationV04(base_types._BaseFieldType):
	...
	__slots__ = ["_KeyXchgData", "_TrnsmssnDtTm", "_SplmtryData", "_SttlmSvc", "_KeyXchgFctn", "_SctyTrlr", "_AltrnMsgRsn", "_RtrvlRefNb", "_PrcgRslt", "_LifeCyclId", "_PrtctdData", "_OthrKeyXchgFctn", "_Hdr", "_AddtlData", "_KeyXchgTp", "_SysTracAudtNb", "_OthrKeyXchgTp", "_Rcncltn", "_Jursdctn", "_Prgrmm", "_AddtlFee", "_MsgRsn"]
	@property
