...
from . import InvestigationRequest51
from . import SupplementaryData1

class InvestigationRequestV02(base_types._BaseFieldType):
	...
	def InvstgtnReq(self, value):
		self._InvstgtnReq = value if value is not None else base_types.UninitialisedField(self, 'InvstgtnReq', InvestigationRequest51, False)

	@InvstgtnReq.deleter
	def InvstgtnReq(self):
		del self._InvstgtnReq
		self._InvstgtnReq = base_types.UninitialisedField(self, 'InvstgtnReq', InvestigationRequest51, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='InvstgtnReq', type=InvestigationRequest51, min=1, max=1, mutex_group=None, array=False),
