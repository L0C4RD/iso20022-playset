...
from ._CorporateActionBalanceDetails43 import CorporateActionBalanceDetails43
from ._Max140Text import Max140Text

class AccountAndBalance60(base_types._BaseFieldType):

	__slots__ = ["_SfkpgAcct", "_AcctOwnr", "_BlckChainAdrOrWllt", "_SfkpgPlc", "_Bal"]
	@property
	def AcctOwnr(self):
