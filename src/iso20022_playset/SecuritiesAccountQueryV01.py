...
from .SecuritiesAccountReturnCriteria1 import SecuritiesAccountReturnCriteria1
from .SecuritiesAccountSearchCriteria2 import SecuritiesAccountSearchCriteria2
from .MessageHeader2 import MessageHeader2

class SecuritiesAccountQueryV01(base_types._BaseFieldType):

	__slots__ = ["_SplmtryData", "_RtrCrit", "_MsgHdr", "_SchCrit"]
	@property
