...
from .QuantityAndAccount118 import QuantityAndAccount118
from .SettlementTypeAndAdditionalParameters13 import SettlementTypeAndAdditionalParameters13
...
from .SecuritiesTradeDetails146 import SecuritiesTradeDetails146
from .SettlementParties98 import SettlementParties98
from .RegistrationParameters6 import RegistrationParameters6
from .Linkages63 import Linkages63

class SecuritiesSettlementTransactionDetails56(base_types._BaseFieldType):

	__slots__ = ["_TradDtls", "_Lnkgs", "_SplmtryData", "_SttlmParams", "_OthrAmts", "_QtyAndAcctDtls", "_OthrBizPties", "_CshPties", "_RcvgSttlmPties", "_SttlmAmt", "_AddtlPhysOrRegnDtls", "_SttlmTpAndAddtlParams", "_DlvrgSttlmPties", "_FinInstrmAttrbts", "_StgSttlmInstrDtls"]
	@property
	def TradDtls(self):
