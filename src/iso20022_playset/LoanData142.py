...
from .InterestRate6 import InterestRate6
from .Max52Text import Max52Text

class LoanData142(base_types._BaseFieldType):

	__slots__ = ["_OutsdngMrgnLnAmt", "_UnqTradIdr", "_MrgnLnAttr", "_EvtDt", "_ExctnDtTm", "_ShrtMktValAmt", "_TradgVn", "_TermntnDt", "_CollDlvryMtd"]
	@property
