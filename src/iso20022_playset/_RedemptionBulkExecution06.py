...
from . import RedemptionExecution18
from . import YesNoIndicator

class RedemptionBulkExecution06(base_types._BaseFieldType):
	...
	def IndvExctnDtls(self, value):
		self._IndvExctnDtls = value if value is not None else base_types.UninitialisedField(self, 'IndvExctnDtls', RedemptionExecution18, True)

	@IndvExctnDtls.deleter
	def IndvExctnDtls(self):
		del self._IndvExctnDtls
		self._IndvExctnDtls = base_types.UninitialisedField(self, 'IndvExctnDtls', RedemptionExecution18, True)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='IndvExctnDtls', type=RedemptionExecution18, min=1, max=None, mutex_group=None, array=True),
