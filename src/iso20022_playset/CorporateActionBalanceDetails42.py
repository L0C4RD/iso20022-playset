...
class CorporateActionBalanceDetails42(base_types._BaseFieldType):
	...
	__slots__ = ["_OutForRegnBal", "_TtlElgblBal", "_OnLnBal", "_StrtPosBal", "_PdgRctBal", "_RegdBal", "_BlckdBal", "_PdgDlvryBal", "_InTrnsShipmntBal", "_CollOutBal", "_TradDtPosBal", "_CollInBal", "_BrrwdBal", "_SttlmPosBal"]
	@property
