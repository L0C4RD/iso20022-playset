...
class CorporateActionBalanceDetails42(base_types._BaseFieldType):
	...
	__slots__ = ["_PdgDlvryBal", "_StrtPosBal", "_PdgRctBal", "_SttlmPosBal", "_BrrwdBal", "_CollOutBal", "_InTrnsShipmntBal", "_TradDtPosBal", "_RegdBal", "_OnLnBal", "_OutForRegnBal", "_BlckdBal", "_CollInBal", "_TtlElgblBal"]
	@property
