...
class CorporateActionBalanceDetails42(base_types._BaseFieldType):
	...
	__slots__ = ["_CollOutBal", "_BlckdBal", "_StrtPosBal", "_CollInBal", "_TradDtPosBal", "_BrrwdBal", "_PdgRctBal", "_TtlElgblBal", "_PdgDlvryBal", "_OutForRegnBal", "_InTrnsShipmntBal", "_SttlmPosBal", "_RegdBal", "_OnLnBal"]
	@property
	def CollOutBal(self):
