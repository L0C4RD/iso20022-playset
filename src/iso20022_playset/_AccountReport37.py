...
class AccountReport37(base_types._BaseFieldType):
	...
	__slots__ = ["_Bal", "_FrToDt", "_TxsSummry", "_Id", "_Intrst", "_CreDtTm", "_Ntry", "_RptgSeq", "_AddtlRptInf", "_RltdAcct", "_RptgSrc", "_LglSeqNb", "_RptPgntn", "_CpyDplctInd", "_Acct", "_ElctrncSeqNb"]
	@property
	def Bal(self):
		return self._Bal
