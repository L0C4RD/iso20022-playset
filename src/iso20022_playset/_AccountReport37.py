...
class AccountReport37(base_types._BaseFieldType):
	...
	__slots__ = ["_RptgSrc", "_Intrst", "_AddtlRptInf", "_RptPgntn", "_CreDtTm", "_RptgSeq", "_RltdAcct", "_ElctrncSeqNb", "_LglSeqNb", "_TxsSummry", "_Bal", "_CpyDplctInd", "_FrToDt", "_Id", "_Acct", "_Ntry"]
	@property
	def RptgSrc(self):
