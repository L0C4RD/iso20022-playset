...
class SecuritiesTradeDetails130(base_types._BaseFieldType):
	...
	__slots__ = ["_CcyToBuyOrSell", "_LateDlvryDt", "_MtchdStsTmStmp", "_TradDt", "_DealPric", "_InvstrCpcty", "_SttlmDt", "_TpOfPric", "_PlcOfTrad", "_SttlmInstrPrcgAddtlDtls", "_FxAddtlDtls", "_AckdStsTmStmp", "_CollTxId", "_PlcOfClr", "_NbOfDaysAcrd", "_TradId", "_TradOrgtrRole", "_OpngClsg", "_TradTxCond", "_AffirmSts", "_MtchgSts", "_Rptg"]
	@property
