...
class SecuritiesTradeDetails130(base_types._BaseFieldType):
	...
	__slots__ = ["_DealPric", "_TradTxCond", "_AffirmSts", "_SttlmDt", "_MtchdStsTmStmp", "_AckdStsTmStmp", "_MtchgSts", "_NbOfDaysAcrd", "_LateDlvryDt", "_SttlmInstrPrcgAddtlDtls", "_Rptg", "_TradDt", "_PlcOfTrad", "_OpngClsg", "_PlcOfClr", "_CollTxId", "_TradOrgtrRole", "_FxAddtlDtls", "_CcyToBuyOrSell", "_TpOfPric", "_TradId", "_InvstrCpcty"]
	@property
	def DealPric(self):
