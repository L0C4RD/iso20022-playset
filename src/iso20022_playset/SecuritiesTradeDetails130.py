...
class SecuritiesTradeDetails130(base_types._BaseFieldType):
	...
	__slots__ = ["_OpngClsg", "_MtchdStsTmStmp", "_InvstrCpcty", "_TpOfPric", "_TradId", "_SttlmDt", "_FxAddtlDtls", "_CcyToBuyOrSell", "_DealPric", "_NbOfDaysAcrd", "_LateDlvryDt", "_AffirmSts", "_Rptg", "_PlcOfTrad", "_PlcOfClr", "_TradOrgtrRole", "_TradTxCond", "_CollTxId", "_SttlmInstrPrcgAddtlDtls", "_MtchgSts", "_AckdStsTmStmp", "_TradDt"]
	@property
	def OpngClsg(self):
