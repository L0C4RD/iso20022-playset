...
from .ActionType14Code import ActionType14Code
from .PartyType34Code import PartyType34Code
from .ContactPersonal1 import ContactPersonal1
from .ActionDestination1Code import ActionDestination1Code
...
class Action16(base_types._BaseFieldType):
	...
	__slots__ = ["_Lang", "_Dstn", "_CertId", "_Tp", "_Frmt", "_DstnTp", "_Sgntr", "_OthrTp", "_Ctct", "_Cntt", "_OthrFrmt", "_OthrDstn", "_OthrDstnTp", "_DstnAdr"]
	@property
	def Lang(self):
		return self._Lang
