...
class ProcessingCharacteristics12(base_types._BaseFieldType):
	...
	__slots__ = ["_AddtlInf", "_AmtInd", "_DealConfTm", "_DealConfTmFrame", "_DealgCcyAccptd", "_DealgCutOffTm", "_DealgCutOffTmFrame", "_DealgFrqcy", "_DealgFrqcyDesc", "_LtdPrd", "_MainFndOrdrDskLctn", "_PctgInd", "_RedAuthstn", "_Rndg", "_SttlmCycl", "_UnitsInd"]
	@property
	def AddtlInf(self):
	...
	def DealConfTmFrame(self, value):
		self._DealConfTmFrame = value if value is not None else base_types.UninitialisedField(self, 'DealConfTmFrame', TimeFrame10, False)

	@DealConfTmFrame.deleter
	def DealConfTmFrame(self):
		del self._DealConfTmFrame
		self._DealConfTmFrame = base_types.UninitialisedField(self, 'DealConfTmFrame', TimeFrame10, False)
	...
	def PctgInd(self, value):
		self._PctgInd = value if value is not None else base_types.UninitialisedField(self, 'PctgInd', YesNoIndicator, False)

	@PctgInd.deleter
	def PctgInd(self):
		del self._PctgInd
		self._PctgInd = base_types.UninitialisedField(self, 'PctgInd', YesNoIndicator, False)
	...
	@RedAuthstn.setter
	def RedAuthstn(self, value):
		self._RedAuthstn = value if value is not None else base_types.UninitialisedField(self, 'RedAuthstn', Forms1, False)

	@RedAuthstn.deleter
	def RedAuthstn(self):
		del self._RedAuthstn
		self._RedAuthstn = base_types.UninitialisedField(self, 'RedAuthstn', Forms1, False)
