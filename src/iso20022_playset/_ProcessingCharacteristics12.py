...
class ProcessingCharacteristics12(base_types._BaseFieldType):
	...
	__slots__ = ["_LtdPrd", "_MainFndOrdrDskLctn", "_DealConfTm", "_DealConfTmFrame", "_RedAuthstn", "_DealgCutOffTm", "_PctgInd", "_AmtInd", "_DealgCutOffTmFrame", "_UnitsInd", "_DealgCcyAccptd", "_AddtlInf", "_Rndg", "_DealgFrqcyDesc", "_DealgFrqcy", "_SttlmCycl"]
	@property
	def AddtlInf(self):
