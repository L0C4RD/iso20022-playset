...
class AccountParties17(base_types._BaseFieldType):
	...
	__slots__ = ["_Bnfcry", "_CtdnForMnr", "_Prtctr", "_PrncplAcctPty", "_ScndryOwnr", "_PwrOfAttny", "_OthrPty", "_Grntr", "_Admstr", "_SnrMggOffcl", "_RegdShrhldrNm", "_Sttlr", "_SucssrOnDth", "_LglGuardn"]
	@property
	def Bnfcry(self):
		return self._Bnfcry
