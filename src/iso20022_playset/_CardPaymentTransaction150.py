...
class CardPaymentTransaction150(base_types._BaseFieldType):
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='OrgnlTx', type=CardPaymentTransaction149, min=1, max=1, mutex_group=None, array=False),
