...
class ClearingBatchData3(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlsCcy", "_TtlsAmt", "_AgtFeeCcy", "_IntrchngFeeCcy", "_AgtFeeCdtDbt", "_Prty", "_OthrMtd", "_Dt", "_TtlsCdtDbt", "_AgtFeeAmt", "_IntrchngFeeAmt", "_Mtd", "_TtlsCnt", "_IntrchngFeeCdtDbt"]
	@property
	def TtlsCcy(self):
