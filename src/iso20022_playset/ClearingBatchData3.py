...
class ClearingBatchData3(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrMtd", "_IntrchngFeeAmt", "_IntrchngFeeCcy", "_TtlsCdtDbt", "_AgtFeeAmt", "_TtlsCnt", "_AgtFeeCdtDbt", "_AgtFeeCcy", "_IntrchngFeeCdtDbt", "_Dt", "_Prty", "_Mtd", "_TtlsAmt", "_TtlsCcy"]
	@property
	def OthrMtd(self):
