...
class Mandate20(base_types._BaseFieldType):
	...
	__slots__ = ["_RfrdDoc", "_ColltnAmt", "_Authntcn", "_DbtrAcct", "_CdtrAcct", "_DbtrAgt", "_Cdtr", "_UltmtCdtr", "_CdtrSchmeId", "_Rsn", "_Tp", "_CdtrAgt", "_Dbtr", "_MndtReqId", "_FrstColltnAmt", "_UltmtDbtr", "_MndtId", "_TrckgInd", "_MndtRef", "_MaxAmt", "_Ocrncs", "_Adjstmnt"]
	@property
	def RfrdDoc(self):
