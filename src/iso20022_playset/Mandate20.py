...
class Mandate20(base_types._BaseFieldType):
	...
	__slots__ = ["_MndtReqId", "_Authntcn", "_Tp", "_DbtrAgt", "_Dbtr", "_MaxAmt", "_UltmtCdtr", "_Ocrncs", "_Adjstmnt", "_DbtrAcct", "_CdtrAgt", "_MndtRef", "_Rsn", "_CdtrAcct", "_FrstColltnAmt", "_CdtrSchmeId", "_TrckgInd", "_ColltnAmt", "_MndtId", "_UltmtDbtr", "_RfrdDoc", "_Cdtr"]
	@property
	def MndtReqId(self):
