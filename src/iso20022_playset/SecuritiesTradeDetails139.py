...
class SecuritiesTradeDetails139(base_types._BaseFieldType):
	...
	__slots__ = ["_QtyDtls", "_OthrBizPties", "_TradDt", "_Pmt", "_Sts", "_SttlmDt", "_CmonId", "_OthrAmts", "_SctiesMvmntTp", "_NtfctnRcvrTxId", "_FinInstrmAttrbts", "_SplmtryData", "_RcvgSttlmPties", "_NbOfDaysAcrd", "_SttlmParams", "_NtfctnSndrTxId", "_Rptg", "_SttlmAmt", "_DlvrgSttlmPties", "_FinInstrmId"]
	@property
	def QtyDtls(self):
