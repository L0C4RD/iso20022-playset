...
from .SettlementParties104 import SettlementParties104
from .SettlementDetails103 import SettlementDetails103
from .ReceiveDelivery1Code import ReceiveDelivery1Code
from .Reporting8Choice import Reporting8Choice
from .SettlementDate20Choice import SettlementDate20Choice
from .RestrictedFINXMax16Text import RestrictedFINXMax16Text
from .Quantity49 import Quantity49
...
from .OtherAmounts33 import OtherAmounts33
from .FinancialInstrumentAttributes122 import FinancialInstrumentAttributes122
from .OtherParties42 import OtherParties42

class SecuritiesTradeDetails139(base_types._BaseFieldType):

	__slots__ = ["_OthrBizPties", "_CmonId", "_NtfctnRcvrTxId", "_FinInstrmAttrbts", "_NtfctnSndrTxId", "_SttlmDt", "_RcvgSttlmPties", "_SttlmParams", "_FinInstrmId", "_SctiesMvmntTp", "_SttlmAmt", "_NbOfDaysAcrd", "_OthrAmts", "_QtyDtls", "_Sts", "_DlvrgSttlmPties", "_TradDt", "_SplmtryData", "_Pmt", "_Rptg"]
	@property
