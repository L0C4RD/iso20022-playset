...
class PersonIdentification15(base_types._BaseFieldType):
	...
	__slots__ = ["_IdntyCardNb", "_Dept", "_EmailAdr", "_AlnRegnNb", "_MplyrIdNb", "_DrvrId", "_DtAndPlcOfBirth", "_DrvrLicNm", "_TaxIdNb", "_JobNb", "_PsptNb", "_Othr", "_MplyeeIdNb", "_DrvrLicLctn", "_CstmrNb", "_SclSctyNb", "_DrvrLicNb"]
	@property
