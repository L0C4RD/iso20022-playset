...
class PersonIdentification15(base_types._BaseFieldType):
	...
	__slots__ = ["_PsptNb", "_CstmrNb", "_DrvrId", "_SclSctyNb", "_EmailAdr", "_JobNb", "_DrvrLicNb", "_Othr", "_Dept", "_MplyeeIdNb", "_DtAndPlcOfBirth", "_DrvrLicLctn", "_TaxIdNb", "_MplyrIdNb", "_AlnRegnNb", "_IdntyCardNb", "_DrvrLicNm"]
	@property
	def PsptNb(self):
		return self._PsptNb
