...
class AccountSubLevel11(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctId", "_AcctOwnr", "_AcctSubLvl2", "_AcctSubLvl2Diff", "_AcctSvcr", "_BalDtls", "_BnfclOwnr", "_SplmtryData"]
	@property
	def AcctId(self):
		return self._AcctId
	...
	def AcctSubLvl2(self, value):
		self._AcctSubLvl2 = value if value is not None else base_types.UninitialisedField(self, 'AcctSubLvl2', AccountSubLevel12, True)

	@AcctSubLvl2.deleter
	def AcctSubLvl2(self):
		del self._AcctSubLvl2
		self._AcctSubLvl2 = base_types.UninitialisedField(self, 'AcctSubLvl2', AccountSubLevel12, True)
	...
	def AcctSubLvl2Diff(self, value):
		self._AcctSubLvl2Diff = value if value is not None else base_types.UninitialisedField(self, 'AcctSubLvl2Diff', AggregateHoldingBalance2, True)

	@AcctSubLvl2Diff.deleter
	def AcctSubLvl2Diff(self):
		del self._AcctSubLvl2Diff
		self._AcctSubLvl2Diff = base_types.UninitialisedField(self, 'AcctSubLvl2Diff', AggregateHoldingBalance2, True)
