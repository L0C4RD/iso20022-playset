...
from . import AcknowledgementDetails1Choice
...
class PayInEventAcknowledgementV02(base_types._BaseFieldType):
	...
	def AckDtls(self, value):
		self._AckDtls = value if value is not None else base_types.UninitialisedField(self, 'AckDtls', AcknowledgementDetails1Choice, False)

	@AckDtls.deleter
	def AckDtls(self):
		del self._AckDtls
		self._AckDtls = base_types.UninitialisedField(self, 'AckDtls', AcknowledgementDetails1Choice, False)
