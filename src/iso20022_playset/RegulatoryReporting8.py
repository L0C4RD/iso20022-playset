...
class RegulatoryReporting8(base_types._BaseFieldType):
	...
	__slots__ = ["_LkSwpId", "_ComssnsAndFees", "_ClrThrshldInd", "_ConfDtAndTmstmp", "_ClrBrkr", "_ExctnTmstmp", "_CollPrtflInd", "_ClrTmstmp", "_ClrBrkrId", "_CtrPtySdTxRptg", "_ClrXcptnPty", "_CollPrtflCd", "_AllcnInd", "_CorpSctrInd", "_NonStdFlg", "_PrtflCmprssnInd", "_TradgSdTxRptg", "_ExctnVn", "_CollstnInd", "_FinInstrmId", "_ClrdPdctId", "_FinNtrOfTheCtrPtyInd", "_TradWthNonEEACtrPtyInd", "_AddtlRptgInf", "_NtrgrpTradInd", "_CntrlCtrPtyClrHs", "_PdctIdr", "_ComrclOrTrsrFincgInd"]
	@property
	def LkSwpId(self):
