...
class RegulatoryReporting8(base_types._BaseFieldType):
	...
	__slots__ = ["_AllcnInd", "_AddtlRptgInf", "_ClrThrshldInd", "_LkSwpId", "_ExctnVn", "_NtrgrpTradInd", "_CtrPtySdTxRptg", "_ClrXcptnPty", "_ComrclOrTrsrFincgInd", "_NonStdFlg", "_TradWthNonEEACtrPtyInd", "_ClrdPdctId", "_ConfDtAndTmstmp", "_CollPrtflInd", "_CntrlCtrPtyClrHs", "_ExctnTmstmp", "_PdctIdr", "_ComssnsAndFees", "_ClrBrkrId", "_CollPrtflCd", "_CorpSctrInd", "_FinNtrOfTheCtrPtyInd", "_FinInstrmId", "_TradgSdTxRptg", "_PrtflCmprssnInd", "_ClrBrkr", "_CollstnInd", "_ClrTmstmp"]
	@property
	def AllcnInd(self):
