...
from . import CreditTransferTransaction76
...
class PaymentInstruction51(base_types._BaseFieldType):
	...
	def CdtTrfTxInf(self, value):
		self._CdtTrfTxInf = value if value is not None else base_types.UninitialisedField(self, 'CdtTrfTxInf', CreditTransferTransaction76, True)

	@CdtTrfTxInf.deleter
	def CdtTrfTxInf(self):
		del self._CdtTrfTxInf
		self._CdtTrfTxInf = base_types.UninitialisedField(self, 'CdtTrfTxInf', CreditTransferTransaction76, True)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='CdtTrfTxInf', type=CreditTransferTransaction76, min=1, max=None, mutex_group=None, array=True),
