...
class OnBoardDiagnostics1(base_types._BaseFieldType):
	...
	__slots__ = ["_FuelTankLvlStart", "_NgnIdleTm", "_ChckNgnWrngSts", "_NgnOilLifeRmng", "_NgnRPM", "_FuelEcnmy", "_NgnHrs", "_RfrgrtnTmprtr", "_RfrgrtnHrs", "_NgnTtlTm", "_HardAcclrtn", "_CoolntTmprtr", "_NgnOilTmprtr", "_FuelGaugeLvl", "_HardBrakg", "_BttryVltg", "_NgnOilPrssr", "_NgnTtlIdleTm", "_NgnLd"]
	@property
