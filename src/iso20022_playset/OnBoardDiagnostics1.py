...
class OnBoardDiagnostics1(base_types._BaseFieldType):
	...
	__slots__ = ["_NgnOilLifeRmng", "_NgnIdleTm", "_NgnTtlIdleTm", "_ChckNgnWrngSts", "_BttryVltg", "_NgnLd", "_FuelGaugeLvl", "_NgnOilTmprtr", "_NgnOilPrssr", "_NgnRPM", "_RfrgrtnHrs", "_NgnTtlTm", "_CoolntTmprtr", "_HardBrakg", "_HardAcclrtn", "_RfrgrtnTmprtr", "_FuelEcnmy", "_NgnHrs", "_FuelTankLvlStart"]
	@property
