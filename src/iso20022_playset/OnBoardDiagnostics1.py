...
class OnBoardDiagnostics1(base_types._BaseFieldType):
	...
	__slots__ = ["_NgnRPM", "_ChckNgnWrngSts", "_RfrgrtnTmprtr", "_BttryVltg", "_RfrgrtnHrs", "_FuelEcnmy", "_NgnHrs", "_HardAcclrtn", "_NgnTtlTm", "_NgnLd", "_NgnOilTmprtr", "_NgnTtlIdleTm", "_FuelGaugeLvl", "_CoolntTmprtr", "_HardBrakg", "_NgnOilPrssr", "_NgnOilLifeRmng", "_FuelTankLvlStart", "_NgnIdleTm"]
	@property
	def NgnRPM(self):
		return self._NgnRPM
