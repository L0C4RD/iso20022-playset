...
class OnBoardDiagnostics1(base_types._BaseFieldType):
	...
	__slots__ = ["_NgnLd", "_NgnOilTmprtr", "_NgnTtlTm", "_RfrgrtnTmprtr", "_NgnHrs", "_ChckNgnWrngSts", "_FuelTankLvlStart", "_FuelGaugeLvl", "_NgnRPM", "_NgnOilLifeRmng", "_NgnIdleTm", "_NgnTtlIdleTm", "_HardBrakg", "_CoolntTmprtr", "_RfrgrtnHrs", "_NgnOilPrssr", "_HardAcclrtn", "_BttryVltg", "_FuelEcnmy"]
	@property
	def NgnLd(self):
		return self._NgnLd
