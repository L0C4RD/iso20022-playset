...
class SecuritiesTradeDetails148(base_types._BaseFieldType):
	...
	__slots__ = ["_OthrAmts", "_SttlmParams", "_Pmt", "_NtfctnRcvrTxId", "_Sts", "_SctiesMvmntTp", "_CmonId", "_SttlmDt", "_NtfctnSndrTxId", "_SplmtryData", "_NbOfDaysAcrd", "_TradDt", "_Rptg", "_QtyDtls", "_FinInstrmId", "_FinInstrmAttrbts", "_DlvrgSttlmPties", "_SttlmAmt", "_OthrBizPties", "_RcvgSttlmPties"]
	@property
	def OthrAmts(self):
