...
class SecuritiesTradeDetails148(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_SttlmAmt", "_DlvrgSttlmPties", "_OthrBizPties", "_FinInstrmId", "_QtyDtls", "_CmonId", "_Sts", "_SctiesMvmntTp", "_NtfctnRcvrTxId", "_RcvgSttlmPties", "_NtfctnSndrTxId", "_FinInstrmAttrbts", "_Pmt", "_NbOfDaysAcrd", "_SttlmParams", "_TradDt", "_Rptg", "_OthrAmts", "_SttlmDt"]
	@property
