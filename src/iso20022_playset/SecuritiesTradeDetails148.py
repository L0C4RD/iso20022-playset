...
class SecuritiesTradeDetails148(base_types._BaseFieldType):
	...
	__slots__ = ["_NtfctnRcvrTxId", "_SttlmDt", "_NbOfDaysAcrd", "_SttlmAmt", "_SctiesMvmntTp", "_Pmt", "_RcvgSttlmPties", "_NtfctnSndrTxId", "_SttlmParams", "_Rptg", "_DlvrgSttlmPties", "_CmonId", "_OthrAmts", "_Sts", "_QtyDtls", "_FinInstrmId", "_SplmtryData", "_TradDt", "_OthrBizPties", "_FinInstrmAttrbts"]
	@property
