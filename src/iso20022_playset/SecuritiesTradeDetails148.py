...
import AmountAndDirection52
import OtherAmounts29
import Max3Number
...
import PortfolioTransferStatus2Choice
import SettlementDetails100
import TradeDate8Choice
import Reporting7Choice
import OtherParties39
import Max35Text
import SettlementParties128

class SecuritiesTradeDetails148(base_types._BaseFieldType):

	__slots__ = ["_SplmtryData", "_Pmt", "_NtfctnRcvrTxId", "_SttlmDt", "_SctiesMvmntTp", "_QtyDtls", "_CmonId", "_FinInstrmId", "_Rptg", "_NtfctnSndrTxId", "_OthrAmts", "_TradDt", "_Sts", "_FinInstrmAttrbts", "_OthrBizPties", "_NbOfDaysAcrd", "_RcvgSttlmPties", "_DlvrgSttlmPties", "_SttlmAmt", "_SttlmParams"]
	@property
