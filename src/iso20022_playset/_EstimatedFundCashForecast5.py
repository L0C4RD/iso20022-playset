...
class EstimatedFundCashForecast5(base_types._BaseFieldType):
	...
	__slots__ = ["_InvstmtCcy", "_PrvsTtlNAV", "_FXRate", "_XcptnlNetCshFlowInd", "_BrkdwnByCtry", "_FinInstrmDtls", "_EstmtdNetCshFcstDtls", "_EstmtdTtlUnitsNb", "_EstmtdTtlNAVChngRate", "_Id", "_BrkdwnByCcy", "_EstmtdTtlNAV", "_TradDtTm", "_PrvsTradDtTm", "_PrvsTtlUnitsNb", "_Pric", "_EstmtdPctgOfShrClssTtlNAV", "_BrkdwnByUsrDfndParam", "_BrkdwnByPty", "_CcySts"]
	@property
	def InvstmtCcy(self):
