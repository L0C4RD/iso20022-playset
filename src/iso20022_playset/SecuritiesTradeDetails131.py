...
class SecuritiesTradeDetails131(base_types._BaseFieldType):
	...
	__slots__ = ["_CcyToBuyOrSell", "_LateDlvryDt", "_TradDt", "_DealPric", "_InvstrCpcty", "_Rptg", "_SttlmDt", "_TpOfPric", "_PlcOfTrad", "_SttlmInstrPrcgAddtlDtls", "_CollTxId", "_PlcOfClr", "_NbOfDaysAcrd", "_TradId", "_TradOrgtrRole", "_OpngClsg", "_TradTxCond", "_AffirmSts", "_MtchgSts", "_FxAddtlDtls"]
	@property
