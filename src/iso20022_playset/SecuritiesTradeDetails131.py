...
class SecuritiesTradeDetails131(base_types._BaseFieldType):
	...
	__slots__ = ["_InvstrCpcty", "_AffirmSts", "_Rptg", "_DealPric", "_TradOrgtrRole", "_PlcOfTrad", "_TpOfPric", "_SttlmDt", "_TradId", "_CcyToBuyOrSell", "_MtchgSts", "_LateDlvryDt", "_PlcOfClr", "_TradTxCond", "_CollTxId", "_NbOfDaysAcrd", "_OpngClsg", "_FxAddtlDtls", "_TradDt", "_SttlmInstrPrcgAddtlDtls"]
	@property
