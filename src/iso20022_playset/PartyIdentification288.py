...
class PartyIdentification288(base_types._BaseFieldType):
	...
	__slots__ = ["_GeogcLctn", "_CorpTaxId", "_Email", "_Assgnr", "_OwnrEthnctyTp", "_Adr", "_AddtlCtct", "_CstmrSvc", "_CorpTaxIdTp", "_LglCorpNm", "_ShrtNm", "_SpnsrdMrchnt", "_URL", "_AddtlAdr", "_OwnrEthnctyTpPrvddBy", "_OwnrTpPrvddBy", "_LclData", "_OwnrTp", "_Phne", "_CertfctnTp", "_Id", "_TaxRegnId", "_AddtlId", "_CertfctnTpPrvddBy", "_NmAndLctn", "_BizTpPrvddBy", "_AddtlTxRefNb", "_BizTp", "_AddtlData"]
	@property
	def GeogcLctn(self):
