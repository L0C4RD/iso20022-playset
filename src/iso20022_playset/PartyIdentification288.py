...
class PartyIdentification288(base_types._BaseFieldType):
	...
	__slots__ = ["_OwnrTp", "_AddtlAdr", "_LglCorpNm", "_Phne", "_LclData", "_Email", "_AddtlData", "_AddtlTxRefNb", "_CorpTaxIdTp", "_NmAndLctn", "_BizTpPrvddBy", "_CstmrSvc", "_CorpTaxId", "_URL", "_GeogcLctn", "_AddtlCtct", "_Adr", "_BizTp", "_SpnsrdMrchnt", "_OwnrEthnctyTpPrvddBy", "_OwnrEthnctyTp", "_CertfctnTp", "_Assgnr", "_TaxRegnId", "_OwnrTpPrvddBy", "_Id", "_ShrtNm", "_AddtlId", "_CertfctnTpPrvddBy"]
	@property
	def OwnrTp(self):
		return self._OwnrTp
