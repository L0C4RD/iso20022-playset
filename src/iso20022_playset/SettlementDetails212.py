...
class SettlementDetails212(base_types._BaseFieldType):
	...
	__slots__ = ["_SctiesTxTp", "_HldInd", "_LglRstrctns", "_BnfclOwnrsh", "_AutomtcBrrwg", "_SttlmTxCond", "_MktClntSd", "_SttlgCpcty", "_PrtlSttlmInd", "_CshSubBalTp", "_Regn", "_CshClrSys", "_Prty", "_ModCxlAllwd", "_SctiesSubBalTp", "_SctiesRTGS", "_NetgElgblty", "_DlvryRtrRsn", "_RpTp", "_CCPElgblty", "_BlckTrad", "_SttlmSysMtd", "_XpsrTp", "_FxStgInstr", "_Trckg", "_StmpDtyTaxBsis", "_LttrOfGrnt", "_ElgblForColl", "_TaxCpcty", "_RtrLeg"]
	@property
	def SctiesTxTp(self):
