...
class SettlementDetails212(base_types._BaseFieldType):
	...
	__slots__ = ["_SctiesTxTp", "_Prty", "_StmpDtyTaxBsis", "_ElgblForColl", "_SctiesSubBalTp", "_TaxCpcty", "_BnfclOwnrsh", "_SttlmTxCond", "_LttrOfGrnt", "_SttlgCpcty", "_FxStgInstr", "_RtrLeg", "_NetgElgblty", "_RpTp", "_AutomtcBrrwg", "_MktClntSd", "_HldInd", "_DlvryRtrRsn", "_SctiesRTGS", "_SttlmSysMtd", "_CshSubBalTp", "_PrtlSttlmInd", "_CshClrSys", "_LglRstrctns", "_CCPElgblty", "_Regn", "_ModCxlAllwd", "_XpsrTp", "_BlckTrad", "_Trckg"]
	@property
	def SctiesTxTp(self):
