...
class SettlementDetails212(base_types._BaseFieldType):
	...
	__slots__ = ["_XpsrTp", "_TaxCpcty", "_StmpDtyTaxBsis", "_SttlmSysMtd", "_ElgblForColl", "_CshSubBalTp", "_BlckTrad", "_MktClntSd", "_SctiesTxTp", "_DlvryRtrRsn", "_RtrLeg", "_SttlmTxCond", "_BnfclOwnrsh", "_ModCxlAllwd", "_LttrOfGrnt", "_SctiesRTGS", "_Regn", "_NetgElgblty", "_PrtlSttlmInd", "_CshClrSys", "_LglRstrctns", "_Prty", "_CCPElgblty", "_Trckg", "_SctiesSubBalTp", "_SttlgCpcty", "_AutomtcBrrwg", "_FxStgInstr", "_RpTp", "_HldInd"]
	@property
	def XpsrTp(self):
		return self._XpsrTp
