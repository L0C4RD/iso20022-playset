...
class SecuritiesTradeDetails139(base_types._BaseFieldType):
	...
	__slots__ = ["_NbOfDaysAcrd", "_SplmtryData", "_OthrBizPties", "_SttlmParams", "_DlvrgSttlmPties", "_Pmt", "_TradDt", "_NtfctnRcvrTxId", "_NtfctnSndrTxId", "_QtyDtls", "_SttlmAmt", "_FinInstrmAttrbts", "_OthrAmts", "_Sts", "_CmonId", "_Rptg", "_SttlmDt", "_SctiesMvmntTp", "_RcvgSttlmPties", "_FinInstrmId"]
	@property
