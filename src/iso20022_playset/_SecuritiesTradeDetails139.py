...
class SecuritiesTradeDetails139(base_types._BaseFieldType):
	...
	def DlvrgSttlmPties(self, value):
		self._DlvrgSttlmPties = value if value is not None else base_types.UninitialisedField(self, 'DlvrgSttlmPties', SettlementParties104, False)

	@DlvrgSttlmPties.deleter
	def DlvrgSttlmPties(self):
		del self._DlvrgSttlmPties
		self._DlvrgSttlmPties = base_types.UninitialisedField(self, 'DlvrgSttlmPties', SettlementParties104, False)
	...
	def NtfctnRcvrTxId(self, value):
		self._NtfctnRcvrTxId = value if value is not None else base_types.UninitialisedField(self, 'NtfctnRcvrTxId', RestrictedFINXMax16Text, False)

	@NtfctnRcvrTxId.deleter
	def NtfctnRcvrTxId(self):
		del self._NtfctnRcvrTxId
		self._NtfctnRcvrTxId = base_types.UninitialisedField(self, 'NtfctnRcvrTxId', RestrictedFINXMax16Text, False)
	...
	def NtfctnSndrTxId(self, value):
		self._NtfctnSndrTxId = value if value is not None else base_types.UninitialisedField(self, 'NtfctnSndrTxId', RestrictedFINXMax16Text, False)

	@NtfctnSndrTxId.deleter
	def NtfctnSndrTxId(self):
		del self._NtfctnSndrTxId
		self._NtfctnSndrTxId = base_types.UninitialisedField(self, 'NtfctnSndrTxId', RestrictedFINXMax16Text, False)
	...
	def OthrAmts(self, value):
		self._OthrAmts = value if value is not None else base_types.UninitialisedField(self, 'OthrAmts', OtherAmounts33, False)

	@OthrAmts.deleter
	def OthrAmts(self):
		del self._OthrAmts
		self._OthrAmts = base_types.UninitialisedField(self, 'OthrAmts', OtherAmounts33, False)
	...
	def OthrBizPties(self, value):
		self._OthrBizPties = value if value is not None else base_types.UninitialisedField(self, 'OthrBizPties', OtherParties42, False)

	@OthrBizPties.deleter
	def OthrBizPties(self):
		del self._OthrBizPties
		self._OthrBizPties = base_types.UninitialisedField(self, 'OthrBizPties', OtherParties42, False)
	...
	def QtyDtls(self, value):
		self._QtyDtls = value if value is not None else base_types.UninitialisedField(self, 'QtyDtls', Quantity49, False)

	@QtyDtls.deleter
	def QtyDtls(self):
		del self._QtyDtls
		self._QtyDtls = base_types.UninitialisedField(self, 'QtyDtls', Quantity49, False)
	...
	def RcvgSttlmPties(self, value):
		self._RcvgSttlmPties = value if value is not None else base_types.UninitialisedField(self, 'RcvgSttlmPties', SettlementParties104, False)

	@RcvgSttlmPties.deleter
	def RcvgSttlmPties(self):
		del self._RcvgSttlmPties
		self._RcvgSttlmPties = base_types.UninitialisedField(self, 'RcvgSttlmPties', SettlementParties104, False)
	...
	@Rptg.setter
	def Rptg(self, value):
		self._Rptg = value if value is not None else base_types.UninitialisedField(self, 'Rptg', Reporting8Choice, True)

	@Rptg.deleter
	def Rptg(self):
		del self._Rptg
		self._Rptg = base_types.UninitialisedField(self, 'Rptg', Reporting8Choice, True)
	...
	def SttlmAmt(self, value):
		self._SttlmAmt = value if value is not None else base_types.UninitialisedField(self, 'SttlmAmt', AmountAndDirection57, False)

	@SttlmAmt.deleter
	def SttlmAmt(self):
		del self._SttlmAmt
		self._SttlmAmt = base_types.UninitialisedField(self, 'SttlmAmt', AmountAndDirection57, False)
	...
	def SttlmParams(self, value):
		self._SttlmParams = value if value is not None else base_types.UninitialisedField(self, 'SttlmParams', SettlementDetails103, False)

	@SttlmParams.deleter
	def SttlmParams(self):
		del self._SttlmParams
		self._SttlmParams = base_types.UninitialisedField(self, 'SttlmParams', SettlementDetails103, False)
