...
class FundCashForecast6(base_types._BaseFieldType):
	...
	__slots__ = ["_FinInstrmDtls", "_TtlNAV", "_BrkdwnByCcy", "_XcptnlNetCshFlowInd", "_InvstmtCcy", "_TtlNAVChngRate", "_Pric", "_FXRate", "_CcySts", "_NetCshFcstDtls", "_BrkdwnByCtry", "_PrvsTradDtTm", "_PrvsTtlUnitsNb", "_TtlUnitsNb", "_BrkdwnByUsrDfndParam", "_Id", "_TradDtTm", "_PrvsTtlNAV", "_BrkdwnByPty", "_PctgOfShrClssTtlNAV"]
	@property
