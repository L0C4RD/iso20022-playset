...
from . import MessageStatusResponse9
...
class SaleToPOIMessageStatusResponseV07(base_types._BaseFieldType):
	...
	def StsRspn(self, value):
		self._StsRspn = value if value is not None else base_types.UninitialisedField(self, 'StsRspn', MessageStatusResponse9, False)

	@StsRspn.deleter
	def StsRspn(self):
		del self._StsRspn
		self._StsRspn = base_types.UninitialisedField(self, 'StsRspn', MessageStatusResponse9, False)
