...
import References75Choice

class IntraPositionMovementDetails20(base_types._BaseFieldType):

	__slots__ = ["_AvlblDt", "_RmngToBeSttldQty", "_PrevslySttldQty", "_SctiesSubBalId", "_BalTo", "_SttldQty", "_CollMntrAmt", "_Id", "_CorpActnEvtTp", "_AckdStsTmStmp", "_InstrPrcgAddtlDtls", "_SttlmDt", "_SplmtryData"]
	@property
	def AvlblDt(self):
