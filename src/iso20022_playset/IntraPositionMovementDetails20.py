...
class IntraPositionMovementDetails20(base_types._BaseFieldType):
	...
	__slots__ = ["_Id", "_InstrPrcgAddtlDtls", "_AvlblDt", "_SctiesSubBalId", "_SttlmDt", "_AckdStsTmStmp", "_SplmtryData", "_CollMntrAmt", "_BalTo", "_SttldQty", "_RmngToBeSttldQty", "_CorpActnEvtTp", "_PrevslySttldQty"]
	@property
	def Id(self):
		return self._Id
