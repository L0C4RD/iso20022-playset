...
class IntraPositionMovementDetails20(base_types._BaseFieldType):
	...
	__slots__ = ["_SctiesSubBalId", "_SplmtryData", "_AvlblDt", "_CorpActnEvtTp", "_InstrPrcgAddtlDtls", "_RmngToBeSttldQty", "_Id", "_CollMntrAmt", "_PrevslySttldQty", "_SttlmDt", "_BalTo", "_AckdStsTmStmp", "_SttldQty"]
	@property
