...
from .References75Choice import References75Choice

class IntraPositionMovementDetails20(base_types._BaseFieldType):

	__slots__ = ["_AckdStsTmStmp", "_CorpActnEvtTp", "_SplmtryData", "_CollMntrAmt", "_SttldQty", "_PrevslySttldQty", "_SctiesSubBalId", "_SttlmDt", "_Id", "_BalTo", "_RmngToBeSttldQty", "_AvlblDt", "_InstrPrcgAddtlDtls"]
	@property
