...
class IntraPositionMovementDetails20(base_types._BaseFieldType):
	...
	__slots__ = ["_InstrPrcgAddtlDtls", "_RmngToBeSttldQty", "_PrevslySttldQty", "_AvlblDt", "_SttlmDt", "_CorpActnEvtTp", "_BalTo", "_AckdStsTmStmp", "_CollMntrAmt", "_SctiesSubBalId", "_SplmtryData", "_SttldQty", "_Id"]
	@property
