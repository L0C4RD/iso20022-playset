...
class IntraPositionMovementDetails20(base_types._BaseFieldType):
	...
	__slots__ = ["_Id", "_CorpActnEvtTp", "_CollMntrAmt", "_AvlblDt", "_SplmtryData", "_AckdStsTmStmp", "_SttldQty", "_SttlmDt", "_PrevslySttldQty", "_InstrPrcgAddtlDtls", "_BalTo", "_RmngToBeSttldQty", "_SctiesSubBalId"]
	@property
	def Id(self):
		return self._Id
