...
class AccountDetailsConfirmationV08(base_types._BaseFieldType):
	...
	__slots__ = ["_MsgId", "_RltdRef", "_Xtnsn", "_NewIsseAllcn", "_ConfDtls", "_AddtlInf", "_WdrwlInvstmtPlan", "_OrdrRef", "_SvgsInvstmtPlan", "_InvstmtAcct", "_Intrmies", "_Plcmnt", "_AcctPties", "_CshSttlm", "_MktPrctcVrsn", "_SvcLvlAgrmt"]
	@property
	def MsgId(self):
		return self._MsgId
