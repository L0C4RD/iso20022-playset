...
class AccountDetailsConfirmationV08(base_types._BaseFieldType):
	...
	__slots__ = ["_InvstmtAcct", "_WdrwlInvstmtPlan", "_CshSttlm", "_Plcmnt", "_AcctPties", "_ConfDtls", "_AddtlInf", "_Xtnsn", "_MsgId", "_OrdrRef", "_NewIsseAllcn", "_RltdRef", "_SvgsInvstmtPlan", "_SvcLvlAgrmt", "_MktPrctcVrsn", "_Intrmies"]
	@property
