...
class Terminal10(base_types._BaseFieldType):
	...
	def NcrptnMtd(self, value):
		self._NcrptnMtd = value if value is not None else base_types.UninitialisedField(self, 'NcrptnMtd', Max35Text, False)

	@NcrptnMtd.deleter
	def NcrptnMtd(self):
		del self._NcrptnMtd
		self._NcrptnMtd = base_types.UninitialisedField(self, 'NcrptnMtd', Max35Text, False)
	...
	def PINNtryCpblty(self, value):
		self._PINNtryCpblty = value if value is not None else base_types.UninitialisedField(self, 'PINNtryCpblty', ISO8583PINEntryCapabilityCode, False)

	@PINNtryCpblty.deleter
	def PINNtryCpblty(self):
		del self._PINNtryCpblty
		self._PINNtryCpblty = base_types.UninitialisedField(self, 'PINNtryCpblty', ISO8583PINEntryCapabilityCode, False)
	...
	def SnglTap(self, value):
		self._SnglTap = value if value is not None else base_types.UninitialisedField(self, 'SnglTap', TrueFalseIndicator, False)

	@SnglTap.deleter
	def SnglTap(self):
		del self._SnglTap
		self._SnglTap = base_types.UninitialisedField(self, 'SnglTap', TrueFalseIndicator, False)
	...
	def TermnlLineNcrptnCertfd(self, value):
		self._TermnlLineNcrptnCertfd = value if value is not None else base_types.UninitialisedField(self, 'TermnlLineNcrptnCertfd', TrueFalseIndicator, False)

	@TermnlLineNcrptnCertfd.deleter
	def TermnlLineNcrptnCertfd(self):
		del self._TermnlLineNcrptnCertfd
		self._TermnlLineNcrptnCertfd = base_types.UninitialisedField(self, 'TermnlLineNcrptnCertfd', TrueFalseIndicator, False)
	...
	def UnqKeyPerTermnlCertfd(self, value):
		self._UnqKeyPerTermnlCertfd = value if value is not None else base_types.UninitialisedField(self, 'UnqKeyPerTermnlCertfd', TrueFalseIndicator, False)

	@UnqKeyPerTermnlCertfd.deleter
	def UnqKeyPerTermnlCertfd(self):
		del self._UnqKeyPerTermnlCertfd
		self._UnqKeyPerTermnlCertfd = base_types.UninitialisedField(self, 'UnqKeyPerTermnlCertfd', TrueFalseIndicator, False)
