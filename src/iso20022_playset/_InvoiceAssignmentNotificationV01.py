...
class InvoiceAssignmentNotificationV01(base_types._BaseFieldType):
	...
	def NtfctnList(self, value):
		self._NtfctnList = value if value is not None else base_types.UninitialisedField(self, 'NtfctnList', FinancingItemList1, True)

	@NtfctnList.deleter
	def NtfctnList(self):
		del self._NtfctnList
		self._NtfctnList = base_types.UninitialisedField(self, 'NtfctnList', FinancingItemList1, True)
