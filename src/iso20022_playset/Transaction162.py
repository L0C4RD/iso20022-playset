...
class Transaction162(base_types._BaseFieldType):
	...
	__slots__ = ["_ClntTrptyCollTxId", "_TrptyAgtSvcPrvdrCollTxId", "_TradId", "_PrcrTxId", "_AcctSvcrTxId", "_UnqTxIdr", "_PoolId", "_CorpActnEvtId", "_ClntCollInstrId", "_TxDtls", "_TrptyAgtSvcPrvdrCollInstrId", "_CtrPtyMktInfrstrctrTxId", "_CmonId", "_AcctOwnrTxId", "_MktInfrstrctrTxId"]
	@property
