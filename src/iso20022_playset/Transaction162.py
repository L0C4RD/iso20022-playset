...
class Transaction162(base_types._BaseFieldType):
	...
	__slots__ = ["_TxDtls", "_AcctSvcrTxId", "_TrptyAgtSvcPrvdrCollTxId", "_ClntTrptyCollTxId", "_AcctOwnrTxId", "_CmonId", "_UnqTxIdr", "_TrptyAgtSvcPrvdrCollInstrId", "_PoolId", "_CtrPtyMktInfrstrctrTxId", "_TradId", "_PrcrTxId", "_CorpActnEvtId", "_MktInfrstrctrTxId", "_ClntCollInstrId"]
	@property
	def TxDtls(self):
		return self._TxDtls
