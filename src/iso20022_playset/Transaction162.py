...
class Transaction162(base_types._BaseFieldType):
	...
	__slots__ = ["_CmonId", "_PrcrTxId", "_ClntTrptyCollTxId", "_TxDtls", "_CtrPtyMktInfrstrctrTxId", "_UnqTxIdr", "_CorpActnEvtId", "_TradId", "_TrptyAgtSvcPrvdrCollInstrId", "_AcctOwnrTxId", "_MktInfrstrctrTxId", "_TrptyAgtSvcPrvdrCollTxId", "_PoolId", "_AcctSvcrTxId", "_ClntCollInstrId"]
	@property
	def CmonId(self):
		return self._CmonId
