...
class Transaction162(base_types._BaseFieldType):
	...
	__slots__ = ["_PoolId", "_TrptyAgtSvcPrvdrCollInstrId", "_TxDtls", "_PrcrTxId", "_MktInfrstrctrTxId", "_TradId", "_CmonId", "_AcctOwnrTxId", "_UnqTxIdr", "_ClntTrptyCollTxId", "_AcctSvcrTxId", "_ClntCollInstrId", "_TrptyAgtSvcPrvdrCollTxId", "_CorpActnEvtId", "_CtrPtyMktInfrstrctrTxId"]
	@property
	def PoolId(self):
		return self._PoolId
