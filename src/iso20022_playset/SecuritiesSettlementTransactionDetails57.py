...
class SecuritiesSettlementTransactionDetails57(base_types._BaseFieldType):
	...
	__slots__ = ["_TradDtls", "_AddtlPhysOrRegnDtls", "_Lnkgs", "_FinInstrmId", "_RcvgSttlmPties", "_FinInstrmAttrbts", "_SttlmTpAndAddtlParams", "_OthrAmts", "_DlvrgSttlmPties", "_QtyAndAcctDtls", "_SplmtryData", "_OthrBizPties", "_SttlmParams", "_SttlmAmt", "_CshPties", "_StgSttlmInstrDtls"]
	@property
	def TradDtls(self):
