...
class Identification29(base_types._BaseFieldType):
	...
	__slots__ = ["_AcctSvcrTxId", "_PrcrTxId", "_IndxId", "_CtrPtyMktInfrstrctrTxId", "_MktInfrstrctrTxId", "_ListId", "_PoolId", "_CorpActnEvtId", "_PrgmId", "_CmonId", "_TradId", "_MstrId", "_BsktId", "_AcctOwnrTxId"]
	@property
