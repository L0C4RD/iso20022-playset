...
class Identification29(base_types._BaseFieldType):
	...
	__slots__ = ["_PrgmId", "_CmonId", "_AcctSvcrTxId", "_BsktId", "_AcctOwnrTxId", "_PoolId", "_CorpActnEvtId", "_CtrPtyMktInfrstrctrTxId", "_IndxId", "_ListId", "_TradId", "_PrcrTxId", "_MktInfrstrctrTxId", "_MstrId"]
	@property
	def PrgmId(self):
		return self._PrgmId
