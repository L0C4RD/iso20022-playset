...
from . import SecuritiesSettlementTransactionQueryV01
...
class SEMT_026_001_01():
	...
	class Document(base_types._BaseFieldType_Document):
		...
		def SctiesSttlmTxQry(self, value):
			self._SctiesSttlmTxQry = value if value is not None else base_types.UninitialisedField(self, 'SctiesSttlmTxQry', SecuritiesSettlementTransactionQueryV01, False)

		@SctiesSttlmTxQry.deleter
		def SctiesSttlmTxQry(self):
			del self._SctiesSttlmTxQry
			self._SctiesSttlmTxQry = base_types.UninitialisedField(self, 'SctiesSttlmTxQry', SecuritiesSettlementTransactionQueryV01, False)
