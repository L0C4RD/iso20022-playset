...
class TradeLeg11(base_types._BaseFieldType):
	...
	__slots__ = ["_TradId", "_TradgCpcty", "_SfkpgAcct", "_OrdrId", "_TradRegnOrgn", "_TradDt", "_AllcnId", "_TradgPtyAcct", "_Sts", "_FinInstrmId", "_AcrdIntrstAmt", "_TradExctnId", "_PlcOfListg", "_TradPstngCd", "_TradgPty", "_DealPric", "_GrssAmt", "_TxDtTm", "_UnqTxIdr", "_Brkr", "_DerivRltdTrad", "_TradLegId", "_SfkpgPlc", "_SttlmDt", "_BuySellInd", "_TradTp", "_TradQty", "_PlcOfTrad", "_TradgCcy"]
	@property
	def TradId(self):
		return self._TradId
