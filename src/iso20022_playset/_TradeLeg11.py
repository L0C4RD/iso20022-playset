...
class TradeLeg11(base_types._BaseFieldType):
	...
	__slots__ = ["_SfkpgAcct", "_FinInstrmId", "_DealPric", "_TradDt", "_AllcnId", "_TradgCpcty", "_OrdrId", "_PlcOfTrad", "_PlcOfListg", "_GrssAmt", "_TradRegnOrgn", "_AcrdIntrstAmt", "_TradTp", "_TradgPty", "_Brkr", "_TradPstngCd", "_TradgPtyAcct", "_TradgCcy", "_TxDtTm", "_Sts", "_TradExctnId", "_BuySellInd", "_SfkpgPlc", "_DerivRltdTrad", "_UnqTxIdr", "_TradId", "_TradQty", "_TradLegId", "_SttlmDt"]
	@property
	def SfkpgAcct(self):
