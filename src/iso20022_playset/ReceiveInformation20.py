...
class ReceiveInformation20(base_types._BaseFieldType):
	...
	__slots__ = ["_ClntRef", "_SttlmPtiesDtls", "_Trfee", "_BnfcryCertfctnCmpltn", "_SttlmAmt", "_IntrmyInf", "_PhysTrfDtls", "_StmpDty", "_TrfeeRegdAcct", "_FctvSttlmDt", "_Fees", "_PhysTrf", "_SctiesForm", "_ReqdTradDt", "_ReqdSttlmDt", "_IndvTax", "_FXDtls", "_IncmPref", "_NetAmt", "_DmtrlsdInd"]
	@property
	def ClntRef(self):
