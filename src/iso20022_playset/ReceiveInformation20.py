...
class ReceiveInformation20(base_types._BaseFieldType):
	...
	__slots__ = ["_SctiesForm", "_PhysTrfDtls", "_FXDtls", "_Trfee", "_IntrmyInf", "_FctvSttlmDt", "_ClntRef", "_DmtrlsdInd", "_NetAmt", "_ReqdTradDt", "_TrfeeRegdAcct", "_PhysTrf", "_BnfcryCertfctnCmpltn", "_IncmPref", "_SttlmAmt", "_Fees", "_StmpDty", "_ReqdSttlmDt", "_IndvTax", "_SttlmPtiesDtls"]
	@property
	def SctiesForm(self):
