...
from .FundSettlementParameters16 import FundSettlementParameters16
...
class ReceiveInformation20(base_types._BaseFieldType):
	...
	__slots__ = ["_StmpDty", "_NetAmt", "_Trfee", "_ClntRef", "_IncmPref", "_FXDtls", "_DmtrlsdInd", "_IntrmyInf", "_SttlmAmt", "_TrfeeRegdAcct", "_IndvTax", "_SttlmPtiesDtls", "_SctiesForm", "_BnfcryCertfctnCmpltn", "_ReqdTradDt", "_Fees", "_PhysTrf", "_ReqdSttlmDt", "_FctvSttlmDt", "_PhysTrfDtls"]
	@property
	def StmpDty(self):
