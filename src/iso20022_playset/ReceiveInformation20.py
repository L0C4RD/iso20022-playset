...
class ReceiveInformation20(base_types._BaseFieldType):
	...
	__slots__ = ["_Trfee", "_FctvSttlmDt", "_DmtrlsdInd", "_PhysTrf", "_FXDtls", "_ReqdSttlmDt", "_SttlmPtiesDtls", "_SctiesForm", "_SttlmAmt", "_IncmPref", "_Fees", "_StmpDty", "_IndvTax", "_IntrmyInf", "_NetAmt", "_TrfeeRegdAcct", "_PhysTrfDtls", "_ClntRef", "_ReqdTradDt", "_BnfcryCertfctnCmpltn"]
	@property
	def Trfee(self):
		return self._Trfee
