...
class CorporateActionDate107(base_types._BaseFieldType):
	...
	__slots__ = ["_BrrwrStockLndgDdln", "_XpryDt", "_RspnDdln", "_SbcptCostDbtDt", "_StockLndgDdln", "_DcmnttnDdln", "_CoverXprtnDdln", "_MktDdln", "_PrtctDdln", "_EarlyRspnDdln", "_DpstryCoverXprtnDt"]
	@property
