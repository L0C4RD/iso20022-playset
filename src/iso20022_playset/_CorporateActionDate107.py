...
class CorporateActionDate107(base_types._BaseFieldType):
	...
	__slots__ = ["_DpstryCoverXprtnDt", "_PrtctDdln", "_StockLndgDdln", "_BrrwrStockLndgDdln", "_MktDdln", "_EarlyRspnDdln", "_CoverXprtnDdln", "_RspnDdln", "_XpryDt", "_DcmnttnDdln", "_SbcptCostDbtDt"]
	@property
