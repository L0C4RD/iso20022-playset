...
from .ProprietaryVote2 import ProprietaryVote2
from .FinancialInstrumentQuantity18Choice import FinancialInstrumentQuantity18Choice
from .ResolutionSubStatus1Code import ResolutionSubStatus1Code
from .ResolutionStatus2Code import ResolutionStatus2Code
from .Max35Text import Max35Text

class Vote20(base_types._BaseFieldType):

	__slots__ = ["_For", "_Blnk", "_Prtry", "_Abstn", "_Agnst", "_WthMgmt", "_OneYr", "_SubSts", "_Wthhld", "_TwoYrs", "_NoActn", "_RsltnSts", "_ThreeYrs", "_Desc", "_AgnstMgmt", "_Dscrtnry", "_IssrLabl"]
	@property
	def For(self):
		return self._For
	...
	def RsltnSts(self, value):
		self._RsltnSts = value if type(value) != base_types.auto else self.make_default("RsltnSts")
