...
class CorporateActionMovementConfirmation002V16(base_types._BaseFieldType):
	...
	__slots__ = ["_MvmntConfId", "_MvmntPrlimryAdvcId", "_InstrId", "_IssrAgt", "_CorpActnDtls", "_CorpActnConfDtls", "_AddtlInf", "_EvtsLkg", "_OthrDocId", "_TxId", "_SplmtryData", "_SubPngAgt", "_CorpActnGnlInf", "_Pgntn", "_PngAgt", "_NtfctnId", "_AcctDtls"]
	@property
