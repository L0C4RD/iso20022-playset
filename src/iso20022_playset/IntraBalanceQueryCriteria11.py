...
class IntraBalanceQueryCriteria11(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmAmt", "_CshAcctSvcr", "_CshSubBalId", "_SttlmCcy", "_Refs", "_Sts", "_FctvSttlmDt", "_CshAcct", "_Prty", "_SttldAmt", "_CshAcctOwnr", "_BalTp", "_MsgOrgtr", "_CreDtTm", "_IntnddSttlmDt"]
	@property
	def SttlmAmt(self):
