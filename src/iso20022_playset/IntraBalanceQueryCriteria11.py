...
class IntraBalanceQueryCriteria11(base_types._BaseFieldType):
	...
	__slots__ = ["_CshAcctSvcr", "_CshSubBalId", "_SttlmCcy", "_CshAcctOwnr", "_CreDtTm", "_SttldAmt", "_Prty", "_MsgOrgtr", "_FctvSttlmDt", "_SttlmAmt", "_CshAcct", "_Refs", "_BalTp", "_Sts", "_IntnddSttlmDt"]
	@property
