...
class IntraBalanceQueryCriteria11(base_types._BaseFieldType):
	...
	__slots__ = ["_Sts", "_Refs", "_FctvSttlmDt", "_CshAcctOwnr", "_CshSubBalId", "_Prty", "_SttldAmt", "_CshAcct", "_SttlmAmt", "_CreDtTm", "_MsgOrgtr", "_IntnddSttlmDt", "_CshAcctSvcr", "_SttlmCcy", "_BalTp"]
	@property
	def Sts(self):
		return self._Sts
