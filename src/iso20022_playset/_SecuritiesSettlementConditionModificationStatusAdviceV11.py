...
from . import ProcessingStatus106Choice
from . import RequestDetails31
from . import SecuritiesAccount19
from . import SupplementaryData1

class SecuritiesSettlementConditionModificationStatusAdviceV11(base_types._BaseFieldType):
	...
	def PrcgSts(self, value):
		self._PrcgSts = value if value is not None else base_types.UninitialisedField(self, 'PrcgSts', ProcessingStatus106Choice, False)

	@PrcgSts.deleter
	def PrcgSts(self):
		del self._PrcgSts
		self._PrcgSts = base_types.UninitialisedField(self, 'PrcgSts', ProcessingStatus106Choice, False)
	...
	def ReqDtls(self, value):
		self._ReqDtls = value if value is not None else base_types.UninitialisedField(self, 'ReqDtls', RequestDetails31, False)

	@ReqDtls.deleter
	def ReqDtls(self):
		del self._ReqDtls
		self._ReqDtls = base_types.UninitialisedField(self, 'ReqDtls', RequestDetails31, False)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='PrcgSts', type=ProcessingStatus106Choice, min=1, max=1, mutex_group=None, array=False),
		base_types.FieldEntry(name='ReqDtls', type=RequestDetails31, min=0, max=1, mutex_group=None, array=False),
