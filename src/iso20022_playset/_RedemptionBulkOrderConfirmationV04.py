...
from . import RedemptionBulkExecution5
...
class RedemptionBulkOrderConfirmationV04(base_types._BaseFieldType):
	...
	def BlkExctnDtls(self, value):
		self._BlkExctnDtls = value if value is not None else base_types.UninitialisedField(self, 'BlkExctnDtls', RedemptionBulkExecution5, False)

	@BlkExctnDtls.deleter
	def BlkExctnDtls(self):
		del self._BlkExctnDtls
		self._BlkExctnDtls = base_types.UninitialisedField(self, 'BlkExctnDtls', RedemptionBulkExecution5, False)
