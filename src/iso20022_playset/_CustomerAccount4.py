...
class CustomerAccount4(base_types._BaseFieldType):
	...
	__slots__ = ["_Rstrctn", "_Ccy", "_Sts", "_MnthlyTxNb", "_FlrNtfctnAmt", "_AvrgBal", "_Tp", "_StmtFrqcyAndFrmt", "_AcctPurp", "_Id", "_ClngNtfctnAmt", "_ClsgDt", "_Nm", "_MnthlyPmtVal", "_MnthlyRcvdVal"]
	@property
	def AcctPurp(self):
