...
class CustomerAccount4(base_types._BaseFieldType):
	...
	__slots__ = ["_FlrNtfctnAmt", "_AvrgBal", "_Sts", "_Tp", "_MnthlyRcvdVal", "_Id", "_Ccy", "_MnthlyPmtVal", "_MnthlyTxNb", "_Rstrctn", "_ClsgDt", "_ClngNtfctnAmt", "_AcctPurp", "_Nm", "_StmtFrqcyAndFrmt"]
	@property
