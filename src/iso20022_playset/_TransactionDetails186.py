...
from ._SettlementDetails231 import SettlementDetails231
...
class TransactionDetails186(base_types._BaseFieldType):

	__slots__ = ["_AckdStsTmStmp", "_AcrdIntrstAmt", "_DgtlPmtSttlm", "_DlvrgSttlmPties", "_FctvSttlmDt", "_MtchdStsTmStmp", "_NbOfDaysAcrd", "_PlcOfClr", "_PlcOfTrad", "_Pmt", "_PstngAmt", "_PstngQty", "_RcvgSttlmPties", "_RvslInd", "_SctiesMvmntTp", "_SfkpgPlc", "_SttlmDt", "_SttlmParams", "_SttlmTxOrCorpActnEvtTp", "_TradDt", "_TxActvty", "_TxAddtlDtls", "_ValDt"]
	@property
