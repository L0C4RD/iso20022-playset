...
class SettlementDetails151(base_types._BaseFieldType):
	...
	__slots__ = ["_NetgElgblty", "_ElgblForColl", "_SctiesRTGS", "_CshClrSys", "_BnfclOwnrsh", "_LglRstrctns", "_MktClntSd", "_SttlmTxCond", "_TaxCpcty", "_SttlmSysMtd", "_PrtlSttlmInd", "_SttlgCpcty", "_BlckTrad", "_CCPElgblty", "_StmpDtyTaxBsis", "_AutomtcBrrwg", "_Prty"]
	@property
