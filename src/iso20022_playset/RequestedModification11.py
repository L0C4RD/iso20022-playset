...
class RequestedModification11(base_types._BaseFieldType):
	...
	__slots__ = ["_Amt", "_Dbtr", "_DbtrAgtAcct", "_UltmtCdtr", "_DbtrAcct", "_ReqdColltnDt", "_InstrForNxtAgt", "_CdtrAgtAcct", "_CdtrAcct", "_SttlmInf", "_IntrBkSttlmDt", "_Purp", "_InstrForDbtrAgt", "_ChrgBr", "_UltmtDbtr", "_RltdRmtInf", "_SttlmTmIndctn", "_EndToEndId", "_InstrId", "_ReqdExctnDt", "_TxId", "_Cdtr", "_InstrForCdtrAgt", "_RmtInf", "_PmtTpInf", "_IntrBkSttlmAmt"]
	@property
	def Amt(self):
		return self._Amt
