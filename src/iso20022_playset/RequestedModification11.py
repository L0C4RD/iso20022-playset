...
class RequestedModification11(base_types._BaseFieldType):
	...
	__slots__ = ["_Purp", "_DbtrAcct", "_CdtrAcct", "_PmtTpInf", "_ReqdExctnDt", "_InstrForDbtrAgt", "_RltdRmtInf", "_EndToEndId", "_UltmtCdtr", "_InstrId", "_SttlmInf", "_IntrBkSttlmAmt", "_RmtInf", "_InstrForCdtrAgt", "_Cdtr", "_SttlmTmIndctn", "_UltmtDbtr", "_IntrBkSttlmDt", "_ChrgBr", "_Dbtr", "_CdtrAgtAcct", "_Amt", "_InstrForNxtAgt", "_TxId", "_ReqdColltnDt", "_DbtrAgtAcct"]
	@property
	def Purp(self):
		return self._Purp
