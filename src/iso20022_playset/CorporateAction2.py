...
class CorporateAction2(base_types._BaseFieldType):
	...
	__slots__ = ["_FrntEndOddLotSctiesQty", "_OfferTp", "_CorpActnAddtlInf", "_EvtStag", "_MinExrcblSctiesQty", "_ElctnTp", "_IntrstAcrdNbOfDays", "_DvddTp", "_RedChrgsApldInd", "_ChngTp", "_PricDtls", "_LtryTp", "_DstrbtnTp", "_TaxblIncmPerShrClctd", "_IncmTp", "_BckEndOddLotSctiesQty", "_PrtlElctnInd", "_DfltOptnNb", "_CpnNb", "_CertfctnTp", "_BaseDnmtn", "_NewPlcOfIncorprtn", "_RateAndAmtDtls", "_ConvsTp", "_IncrmtlDnmtn", "_PrdDtls", "_ClctnMtd", "_CptlGn", "_MinExrcblMltplSctiesQty", "_NewDnmtnSctiesQty", "_SctiesQtySght", "_DfltOptnTp", "_DtDtls", "_RnncblEntitlmntStsTp", "_IntrmdtSctiesDstrbtnTp", "_CertfctnReqrdInd", "_NewBrdLotSctiesQty", "_RstrctnInd", "_NewDnmtnCcy"]
	@property
