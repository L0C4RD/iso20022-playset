...
class TransferStatusAndReason8(base_types._BaseFieldType):
	...
	__slots__ = ["_StsRcpt", "_BnftCrstllstnEvt", "_QryRspn", "_TtlTrfVal", "_CxlRef", "_Convs", "_TrfRef", "_StsIssr", "_OthrDrwdwnInf", "_InvstmtAcctDtls", "_MstrRef", "_AvrgPric", "_TtlUnitsNb", "_SttlmDt", "_DrwdwnTrch", "_CshSttlmDt", "_UnitsDtls", "_TrfEvtTp", "_ClntRef", "_Instrm", "_PmtDtls", "_AddtlInf", "_IntrmyInf", "_StsInitr", "_TradDt", "_TrfSts", "_SndOutDt"]
	@property
	def StsRcpt(self):
