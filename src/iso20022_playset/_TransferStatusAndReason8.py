...
from . import Conversion2
from . import DecimalNumber
from . import Drawdown2
...
from . import PaymentInstrument18
...
class TransferStatusAndReason8(base_types._BaseFieldType):
	...
	def Convs(self, value):
		self._Convs = value if value is not None else base_types.UninitialisedField(self, 'Convs', Conversion2, False)

	@Convs.deleter
	def Convs(self):
		del self._Convs
		self._Convs = base_types.UninitialisedField(self, 'Convs', Conversion2, False)
	...
	def DrwdwnTrch(self, value):
		self._DrwdwnTrch = value if value is not None else base_types.UninitialisedField(self, 'DrwdwnTrch', Drawdown2, True)

	@DrwdwnTrch.deleter
	def DrwdwnTrch(self):
		del self._DrwdwnTrch
		self._DrwdwnTrch = base_types.UninitialisedField(self, 'DrwdwnTrch', Drawdown2, True)
	...
	def PmtDtls(self, value):
		self._PmtDtls = value if value is not None else base_types.UninitialisedField(self, 'PmtDtls', PaymentInstrument18, True)

	@PmtDtls.deleter
	def PmtDtls(self):
		del self._PmtDtls
		self._PmtDtls = base_types.UninitialisedField(self, 'PmtDtls', PaymentInstrument18, True)
