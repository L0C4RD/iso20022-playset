...
class TransferStatusAndReason8(base_types._BaseFieldType):
	...
	__slots__ = ["_Instrm", "_SttlmDt", "_QryRspn", "_TrfEvtTp", "_MstrRef", "_TradDt", "_ClntRef", "_TtlTrfVal", "_Convs", "_TtlUnitsNb", "_CshSttlmDt", "_StsIssr", "_CxlRef", "_StsInitr", "_SndOutDt", "_BnftCrstllstnEvt", "_IntrmyInf", "_StsRcpt", "_InvstmtAcctDtls", "_TrfRef", "_AvrgPric", "_TrfSts", "_UnitsDtls", "_AddtlInf", "_PmtDtls", "_DrwdwnTrch", "_OthrDrwdwnInf"]
	@property
	def Instrm(self):
		return self._Instrm
