...
from . import AcceptorCancellationRequest14
...
class AcceptorCancellationRequestV14(base_types._BaseFieldType):
	...
	def CxlReq(self, value):
		self._CxlReq = value if value is not None else base_types.UninitialisedField(self, 'CxlReq', AcceptorCancellationRequest14, False)

	@CxlReq.deleter
	def CxlReq(self):
		del self._CxlReq
		self._CxlReq = base_types.UninitialisedField(self, 'CxlReq', AcceptorCancellationRequest14, False)
