...
class Identification30(base_types._BaseFieldType):
	...
	__slots__ = ["_PrgmId", "_MstrId", "_CtrPtyMktInfrstrctrTxId", "_TradId", "_AcctSvcrTxId", "_UnqTxIdr", "_CmonId", "_BsktId", "_AcctOwnrTxId", "_MktInfrstrctrTxId", "_ListId", "_PrcrTxId", "_CorpActnEvtId", "_IndxId", "_PoolId"]
	@property
	def PrgmId(self):
		return self._PrgmId
