...
from . import DetailedAmount24
from . import ISO3NumericCurrencyCode
from . import ImpliedCurrencyAndAmount
from . import TypeOfAmount22Code

class TransactionAmounts6(base_types._BaseFieldType):
	...
	def DtldAmt(self, value):
		self._DtldAmt = value if value is not None else base_types.UninitialisedField(self, 'DtldAmt', DetailedAmount24, True)

	@DtldAmt.deleter
	def DtldAmt(self):
		del self._DtldAmt
		self._DtldAmt = base_types.UninitialisedField(self, 'DtldAmt', DetailedAmount24, True)
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='DtldAmt', type=DetailedAmount24, min=0, max=None, mutex_group=None, array=True),
