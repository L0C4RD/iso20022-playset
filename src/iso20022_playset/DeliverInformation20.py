...
class DeliverInformation20(base_types._BaseFieldType):
	...
	__slots__ = ["_DmtrlsdInd", "_PhysTrfDtls", "_TrfrRegdAcct", "_SctiesForm", "_BnfcryCertfctnCmpltn", "_IndvTax", "_StmpDty", "_FctvSttlmDt", "_Fees", "_ClntRef", "_IntrmyInf", "_Trfr", "_SttlmPtiesDtls", "_IncmPref", "_FXDtls", "_PhysTrf", "_ReqdSttlmDt", "_NetAmt", "_SttlmAmt", "_ReqdTradDt"]
	@property
	def DmtrlsdInd(self):
