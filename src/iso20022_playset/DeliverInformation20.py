...
class DeliverInformation20(base_types._BaseFieldType):
	...
	__slots__ = ["_ClntRef", "_BnfcryCertfctnCmpltn", "_SttlmAmt", "_IntrmyInf", "_PhysTrfDtls", "_StmpDty", "_SttlmPtiesDtls", "_FctvSttlmDt", "_Fees", "_PhysTrf", "_SctiesForm", "_ReqdTradDt", "_ReqdSttlmDt", "_IndvTax", "_Trfr", "_FXDtls", "_TrfrRegdAcct", "_IncmPref", "_NetAmt", "_DmtrlsdInd"]
	@property
	def ClntRef(self):
