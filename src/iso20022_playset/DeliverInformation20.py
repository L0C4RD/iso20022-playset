...
class DeliverInformation20(base_types._BaseFieldType):
	...
	__slots__ = ["_StmpDty", "_TrfrRegdAcct", "_NetAmt", "_ClntRef", "_IncmPref", "_FXDtls", "_DmtrlsdInd", "_IntrmyInf", "_SttlmAmt", "_Trfr", "_IndvTax", "_SctiesForm", "_BnfcryCertfctnCmpltn", "_ReqdTradDt", "_SttlmPtiesDtls", "_Fees", "_PhysTrf", "_ReqdSttlmDt", "_FctvSttlmDt", "_PhysTrfDtls"]
	@property
	def StmpDty(self):
