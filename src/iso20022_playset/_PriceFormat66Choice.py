...
from . import PercentagePrice1
from . import PriceValueType9Code

class PriceFormat66Choice(base_types._BaseFieldType):
	...
	def PctgPric(self, value):
		self._PctgPric = value if value is not None else base_types.UninitialisedField(self, 'PctgPric', PercentagePrice1, False)

	@PctgPric.deleter
	def PctgPric(self):
		del self._PctgPric
		self._PctgPric = base_types.UninitialisedField(self, 'PctgPric', PercentagePrice1, False)
