...
class MarginCallRequestV05(base_types._BaseFieldType):
	...
	__slots__ = ["_TxId", "_Agrmt", "_XpctdCollDueToA", "_RqrmntDtlsDueToB", "_MrgnCallDtls", "_MrgnDtlsDueToB", "_SplmtryData", "_MrgnDtlsDueToA", "_MrgnCallRslt", "_XpctdCollDueToB", "_RqrmntDtlsDueToA", "_Oblgtn"]
	@property
	def TxId(self):
		return self._TxId
