...
from ._BatchManagementType3Code import BatchManagementType3Code
...
class BatchManagementResponseV04(base_types._BaseFieldType):

	__slots__ = ["_AddtlFee", "_BtchChcksm", "_BtchId", "_BtchIdList", "_BtchMgmtTp", "_ChckptId", "_ColltnChcksm", "_ColltnId", "_ColltnIdList", "_ColltnSz", "_Conttn", "_Crrctn", "_Dstn", "_Hdr", "_Jursdctn", "_LifeCyclId", "_MsgSeqNb", "_MsgsBfrAck", "_NbOfBtchsInColltn", "_NbOfMsgs", "_NtlData", "_OrgnlBtchId", "_OrgnlColltnId", "_OrgnlRspnCd", "_Orgtr", "_PostvAck", "_PrcgRslt", "_Prgrmm", "_PrtctdData", "_PrvtData", "_Rcncltn", "_Rcvr", "_ReqAck", "_RmngMsgsInColltn", "_RtrvlRefNb", "_SctyTrlr", "_Sndr", "_SttlmSvc", "_SysTracAudtNb", "_TrnsmssnDtTm"]
	@property
	def AddtlFee(self):
