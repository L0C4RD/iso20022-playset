...
from .Context21 import Context21
...
class ChargeBackInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_OrgnlTx", "_SctyTrlr", "_Hdr", "_Cntxt", "_Orgtr", "_Acqrr", "_Accptr", "_OrgnlTxAmts", "_Jursdctn", "_Rcvr", "_Pyee", "_Dstn", "_Rcncltn", "_Issr", "_SplmtryData", "_TxId", "_Pyer", "_AddtlData", "_Sndr", "_Termnl", "_DsptData", "_Dcmnttn", "_Wllt", "_Card", "_TxChrtcs", "_TxAmts", "_Prgrmm", "_AddtlFee", "_SttlmSvc", "_PrtctdData", "_PrcgRslt", "_ConvsDtTm", "_Tkn"]
	@property
	def OrgnlTx(self):
	...
	def OrgnlTxAmts(self, value):
		self._OrgnlTxAmts = value if type(value) != auto else self.make_default("OrgnlTxAmts")
