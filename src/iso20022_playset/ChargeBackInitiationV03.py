...
class ChargeBackInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_Card", "_TxChrtcs", "_OrgnlTx", "_AddtlData", "_Issr", "_DsptData", "_Acqrr", "_Dstn", "_Accptr", "_Termnl", "_OrgnlTxAmts", "_PrcgRslt", "_Hdr", "_SplmtryData", "_Pyer", "_Prgrmm", "_Dcmnttn", "_Rcvr", "_Rcncltn", "_ConvsDtTm", "_TxAmts", "_Tkn", "_SttlmSvc", "_Wllt", "_SctyTrlr", "_Orgtr", "_AddtlFee", "_Pyee", "_Jursdctn", "_TxId", "_PrtctdData", "_Cntxt", "_Sndr"]
	@property
	def Card(self):
		return self._Card
