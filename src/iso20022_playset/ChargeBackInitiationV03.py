...
class ChargeBackInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_PrtctdData", "_Prgrmm", "_ConvsDtTm", "_Termnl", "_Rcncltn", "_AddtlData", "_Accptr", "_Card", "_Issr", "_OrgnlTx", "_Wllt", "_TxAmts", "_Acqrr", "_Hdr", "_TxId", "_Dstn", "_Rcvr", "_Jursdctn", "_Cntxt", "_Pyee", "_SttlmSvc", "_Dcmnttn", "_Sndr", "_Pyer", "_TxChrtcs", "_DsptData", "_AddtlFee", "_SplmtryData", "_OrgnlTxAmts", "_PrcgRslt", "_Tkn", "_Orgtr", "_SctyTrlr"]
	@property
	def PrtctdData(self):
