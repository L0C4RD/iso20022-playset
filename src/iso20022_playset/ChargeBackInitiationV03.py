...
class ChargeBackInitiationV03(base_types._BaseFieldType):
	...
	__slots__ = ["_TxAmts", "_Pyee", "_TxId", "_Dstn", "_AddtlData", "_Termnl", "_Acqrr", "_Hdr", "_SctyTrlr", "_AddtlFee", "_Card", "_Issr", "_Accptr", "_Orgtr", "_Sndr", "_PrcgRslt", "_Pyer", "_Cntxt", "_Wllt", "_Rcvr", "_DsptData", "_ConvsDtTm", "_Rcncltn", "_Jursdctn", "_OrgnlTxAmts", "_Tkn", "_OrgnlTx", "_Dcmnttn", "_PrtctdData", "_TxChrtcs", "_SttlmSvc", "_Prgrmm", "_SplmtryData"]
	@property
	def TxAmts(self):
		return self._TxAmts
