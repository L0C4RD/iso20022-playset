...
class SettlementDetails208(base_types._BaseFieldType):
	...
	__slots__ = ["_XpsrTp", "_TaxCpcty", "_StmpDtyTaxBsis", "_ElgblForColl", "_CshSubBalTp", "_MktClntSd", "_SctiesTxTp", "_DlvryRtrRsn", "_RtrLeg", "_BnfclOwnrsh", "_ModCxlAllwd", "_LttrOfGrnt", "_SttlmTxCond", "_Regn", "_NetgElgblty", "_CshClrSys", "_LglRstrctns", "_CCPElgblty", "_Trckg", "_SctiesSubBalTp", "_SttlgCpcty", "_FxStgInstr"]
	@property
	def XpsrTp(self):
		return self._XpsrTp
