...
import SettlementTransactionCondition28Choice
...
import SecuritiesTransactionType60Choice
import BeneficialOwnership5Choice
import CashSettlementSystem5Choice

class SettlementDetails208(base_types._BaseFieldType):

	__slots__ = ["_SttlmTxCond", "_LglRstrctns", "_SctiesTxTp", "_BnfclOwnrsh", "_MktClntSd", "_SttlgCpcty", "_CshSubBalTp", "_Regn", "_CshClrSys", "_ModCxlAllwd", "_SctiesSubBalTp", "_NetgElgblty", "_DlvryRtrRsn", "_CCPElgblty", "_XpsrTp", "_FxStgInstr", "_Trckg", "_StmpDtyTaxBsis", "_LttrOfGrnt", "_ElgblForColl", "_TaxCpcty", "_RtrLeg"]
	@property
