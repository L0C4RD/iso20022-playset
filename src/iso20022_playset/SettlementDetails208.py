...
class SettlementDetails208(base_types._BaseFieldType):
	...
	__slots__ = ["_RtrLeg", "_SctiesTxTp", "_ModCxlAllwd", "_SctiesSubBalTp", "_CshClrSys", "_SttlmTxCond", "_NetgElgblty", "_XpsrTp", "_FxStgInstr", "_Regn", "_CCPElgblty", "_LttrOfGrnt", "_Trckg", "_StmpDtyTaxBsis", "_MktClntSd", "_DlvryRtrRsn", "_LglRstrctns", "_CshSubBalTp", "_ElgblForColl", "_BnfclOwnrsh", "_SttlgCpcty", "_TaxCpcty"]
	@property
	def RtrLeg(self):
		return self._RtrLeg
