...
class FinancialInstrumentAttributes124(base_types._BaseFieldType):
	...
	__slots__ = ["_OddCpnInd", "_FinInstrmAttrAddtlDtls", "_DtdDt", "_DayCntBsis", "_YldVar", "_VarblRateInd", "_FaceAmt", "_MtrtyDt", "_IsseDt", "_DnmtnCcy", "_MinExrcblMltplQty", "_EndFctr", "_TaxblIncmPerShr", "_ClssfctnTp", "_Ratg", "_MinNmnlQty", "_NxtFctrDt", "_CertNb", "_PmtFrqcy", "_NxtIntrstRate", "_OptnTp", "_ConvtblInd", "_FltgRateFxgDt", "_MinExrcblQty", "_PutblInd", "_PlcOfListg", "_CtrctSz", "_SbcptPric", "_PrvsFctr", "_CpnAttchdNb", "_OptnStyle", "_CvrdInd", "_WarrtAttchdOnDlvry", "_IntrstRate", "_NxtFctr", "_IndxRateBsis", "_CllblInd", "_PoolNb", "_FrstPmtDt", "_CpnDt", "_RedYldImpct", "_PutblDt", "_XpryDt", "_RegnForm", "_ConvsPric", "_PctgOfDebtClms", "_VrsnNb", "_NxtCllblDt", "_ConvsDt", "_ExrcPric", "_VarblRateChngFrqcy", "_CurFctr"]
	@property
	def OddCpnInd(self):
