...
class OtherAmounts29(base_types._BaseFieldType):
	...
	__slots__ = ["_LclTax", "_TxTax", "_CtryNtlFdrlTax", "_RgltryAmt", "_ChrgsFees", "_Othr", "_StmpDty", "_CsmptnTax", "_StockXchgTax", "_ValAddedTax", "_ShppgAmt", "_WhldgTax", "_AcrdCptlstnAmt", "_TrfTax", "_AcrdIntrstAmt", "_PmtLevyTax"]
	@property
	def LclTax(self):
		return self._LclTax
