...
class SettlementDetails216(base_types._BaseFieldType):
	...
	__slots__ = ["_CshClrSys", "_ElgblForColl", "_CCPElgblty", "_StmpDtyTaxBsis", "_MktClntSd", "_SttlmTxCond", "_BlckTrad", "_Regn", "_NetgElgblty", "_TaxCpcty", "_SctiesTxTp", "_LglRstrctns", "_SttlgCpcty", "_HldInd", "_XpsrTp", "_SctiesRTGS", "_BnfclOwnrsh", "_SttlmSysMtd", "_LttrOfGrnt", "_PrtlSttlmInd", "_RpTp"]
	@property
	def CshClrSys(self):
