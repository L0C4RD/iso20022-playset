...
class SettlementDetails216(base_types._BaseFieldType):
	...
	__slots__ = ["_TaxCpcty", "_NetgElgblty", "_MktClntSd", "_Regn", "_CshClrSys", "_CCPElgblty", "_SttlmTxCond", "_LttrOfGrnt", "_BlckTrad", "_SttlgCpcty", "_PrtlSttlmInd", "_BnfclOwnrsh", "_SttlmSysMtd", "_HldInd", "_XpsrTp", "_StmpDtyTaxBsis", "_RpTp", "_SctiesRTGS", "_ElgblForColl", "_SctiesTxTp", "_LglRstrctns"]
	@property
	def TaxCpcty(self):
