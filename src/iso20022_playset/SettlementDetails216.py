...
class SettlementDetails216(base_types._BaseFieldType):
	...
	__slots__ = ["_HldInd", "_ElgblForColl", "_RpTp", "_NetgElgblty", "_SttlmTxCond", "_TaxCpcty", "_CshClrSys", "_Regn", "_MktClntSd", "_StmpDtyTaxBsis", "_LttrOfGrnt", "_SctiesRTGS", "_CCPElgblty", "_LglRstrctns", "_SttlmSysMtd", "_PrtlSttlmInd", "_BnfclOwnrsh", "_XpsrTp", "_SttlgCpcty", "_SctiesTxTp", "_BlckTrad"]
	@property
	def HldInd(self):
		return self._HldInd
