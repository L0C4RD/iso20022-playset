...
class SettlementDetails216(base_types._BaseFieldType):
	...
	__slots__ = ["_CshClrSys", "_CCPElgblty", "_SttlmTxCond", "_SctiesRTGS", "_SttlgCpcty", "_BlckTrad", "_NetgElgblty", "_TaxCpcty", "_SttlmSysMtd", "_LglRstrctns", "_LttrOfGrnt", "_PrtlSttlmInd", "_StmpDtyTaxBsis", "_ElgblForColl", "_XpsrTp", "_SctiesTxTp", "_MktClntSd", "_Regn", "_RpTp", "_BnfclOwnrsh", "_HldInd"]
	@property
	def CshClrSys(self):
