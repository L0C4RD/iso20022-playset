...
from . import TrackerData7
from . import UUIDv4Identifier

class PaymentTransaction178(base_types._BaseFieldType):

	__slots__ = ["_AccptncDtTm", "_AcctSvcrRef", "_ChrgsInf", "_ClrSysRef", "_OrgnlEndToEndId", "_OrgnlInstrId", "_OrgnlTxRef", "_OrgnlUETR", "_SplmtryData", "_StsId", "_StsRsnInf", "_TrckrData", "_TxSts"]
	@property
	...
	def TrckrData(self, value):
		self._TrckrData = value if value is not None else base_types.UninitialisedField(self, 'TrckrData', TrackerData7, False)

	@TrckrData.deleter
	def TrckrData(self):
		del self._TrckrData
		self._TrckrData = base_types.UninitialisedField(self, 'TrckrData', TrackerData7, False)
