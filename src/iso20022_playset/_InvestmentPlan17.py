...
class InvestmentPlan17(base_types._BaseFieldType):
	...
	__slots__ = ["_CshSttlm", "_CtrctRef", "_EndDt", "_Frqcy", "_GrssAmtInd", "_IncmPref", "_InitlAmt", "_InsrncCover", "_InstlmtMgrRole", "_PdctId", "_PlanSts", "_Qty", "_RltdCtrctRef", "_RndgDrctn", "_SLAChrgAndComssnRef", "_SctyDtls", "_StartDt", "_TtlNbOfInstlmts"]
	@property
	def CshSttlm(self):
