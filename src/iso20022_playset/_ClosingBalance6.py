...
from . import ClosingBalance7Choice
...
class ClosingBalance6(base_types._BaseFieldType):
	...
	def ClsgBal(self, value):
		self._ClsgBal = value if value is not None else base_types.UninitialisedField(self, 'ClsgBal', ClosingBalance7Choice, False)

	@ClsgBal.deleter
	def ClsgBal(self):
		del self._ClsgBal
		self._ClsgBal = base_types.UninitialisedField(self, 'ClsgBal', ClosingBalance7Choice, False)
