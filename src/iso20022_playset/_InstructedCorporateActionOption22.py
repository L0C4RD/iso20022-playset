...
class InstructedCorporateActionOption22(base_types._BaseFieldType):
	...
	__slots__ = ["_OptnRtrdInstdBal", "_InstdBal", "_OptnInstrDtls", "_OptnPrtctInstrBal", "_EvtDdlns", "_OptnTp", "_OptnRjctdInstrBal", "_OptnNb", "_OptnPdgInstrBal", "_DfltActn", "_OptnCancInstrBal", "_OptnAccptdInstdBal"]
	@property
