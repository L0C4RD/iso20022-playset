...
class InstructedCorporateActionOption22(base_types._BaseFieldType):
	...
	__slots__ = ["_OptnCancInstrBal", "_DfltActn", "_OptnPdgInstrBal", "_OptnRjctdInstrBal", "_OptnAccptdInstdBal", "_OptnTp", "_InstdBal", "_OptnNb", "_OptnPrtctInstrBal", "_OptnRtrdInstdBal", "_EvtDdlns", "_OptnInstrDtls"]
	@property
