...
class SwitchOrder7(base_types._BaseFieldType):
	...
	__slots__ = ["_CstmrCndctClssfctn", "_SttlmAmt", "_TxChanlTp", "_RltdPtyDtls", "_MstrRef", "_CshSttlmDt", "_CxlRght", "_ClntRef", "_OrdrRef", "_FinAdvc", "_OrdrDtTm", "_InvstmtAcctDtls", "_NgtdTrad", "_SgntrTp", "_RedLegDtls", "_XpryDtTm", "_CshSttlmDtls", "_OrdrWvrDtls", "_SbcptLegDtls", "_ReqdFutrTradDt", "_PlcOfTrad", "_AddtlAmt", "_FXDtls", "_SttlmMtd"]
	@property
