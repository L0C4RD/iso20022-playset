...
import OrderWaiver1
import SwitchSubscriptionLegOrder6
...
import SwitchRedemptionLegOrder6
...
class SwitchOrder7(base_types._BaseFieldType):
	...
	__slots__ = ["_RedLegDtls", "_MstrRef", "_FinAdvc", "_PlcOfTrad", "_OrdrDtTm", "_ReqdFutrTradDt", "_InvstmtAcctDtls", "_TxChanlTp", "_CstmrCndctClssfctn", "_CxlRght", "_OrdrWvrDtls", "_SttlmAmt", "_CshSttlmDt", "_FXDtls", "_XpryDtTm", "_AddtlAmt", "_ClntRef", "_OrdrRef", "_SttlmMtd", "_RltdPtyDtls", "_SgntrTp", "_NgtdTrad", "_SbcptLegDtls", "_CshSttlmDtls"]
	@property
	def RedLegDtls(self):
