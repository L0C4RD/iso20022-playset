...
class SwitchRedemptionLegExecution4(base_types._BaseFieldType):
	...
	__slots__ = ["_GrssAmt", "_GtgOrHldBckDtls", "_PhysDlvryInd", "_TxOvrhd", "_NetAmt", "_ReqdSttlmCcy", "_LegId", "_CumDvddInd", "_Equlstn", "_HldgsRedRate", "_InftvPricDtls", "_PricDtls", "_SttlmAndCtdyDtls", "_IntrmPrftAmt", "_TradDtTm", "_LegExctnId", "_InvstmtAcctDtls", "_FinInstrmDtls", "_NonStdSttlmInf", "_Grp1Or2Units", "_InftvTaxDtls", "_ReqdNAVCcy", "_UnitsNb", "_IncmPref", "_PhysDlvryDtls"]
	@property
	def GrssAmt(self):
