...
class SwitchRedemptionLegExecution4(base_types._BaseFieldType):
	...
	__slots__ = ["_UnitsNb", "_IncmPref", "_GtgOrHldBckDtls", "_InftvPricDtls", "_InvstmtAcctDtls", "_IntrmPrftAmt", "_PhysDlvryDtls", "_PricDtls", "_NonStdSttlmInf", "_LegId", "_NetAmt", "_PhysDlvryInd", "_Grp1Or2Units", "_SttlmAndCtdyDtls", "_LegExctnId", "_HldgsRedRate", "_FinInstrmDtls", "_Equlstn", "_TradDtTm", "_InftvTaxDtls", "_ReqdNAVCcy", "_ReqdSttlmCcy", "_TxOvrhd", "_GrssAmt", "_CumDvddInd"]
	@property
	def UnitsNb(self):
