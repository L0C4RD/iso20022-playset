...
class SwitchRedemptionLegExecution4(base_types._BaseFieldType):
	...
	__slots__ = ["_TradDtTm", "_PricDtls", "_IntrmPrftAmt", "_ReqdNAVCcy", "_PhysDlvryDtls", "_GrssAmt", "_CumDvddInd", "_NonStdSttlmInf", "_Equlstn", "_GtgOrHldBckDtls", "_FinInstrmDtls", "_TxOvrhd", "_Grp1Or2Units", "_PhysDlvryInd", "_HldgsRedRate", "_SttlmAndCtdyDtls", "_UnitsNb", "_NetAmt", "_InvstmtAcctDtls", "_LegExctnId", "_ReqdSttlmCcy", "_IncmPref", "_InftvPricDtls", "_LegId", "_InftvTaxDtls"]
	@property
	def TradDtTm(self):
