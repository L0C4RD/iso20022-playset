...
class ForeignExchangeSwapTransaction3(base_types._BaseFieldType):
	...
	__slots__ = ["_TradDt", "_UnqTxIdr", "_CtrPtyId", "_TxTp", "_RltdPrtryTxId", "_NvtnSts", "_FX", "_BrnchId", "_SplmtryData", "_CtrPtyPrtryTxId", "_TxNmnlAmt", "_RptdTxSts", "_MtrtyDt", "_PrtryTxId", "_SpotValDt"]
	@property
	def TradDt(self):
		return self._TradDt
