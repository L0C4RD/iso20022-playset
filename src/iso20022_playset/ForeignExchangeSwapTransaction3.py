...
class ForeignExchangeSwapTransaction3(base_types._BaseFieldType):
	...
	__slots__ = ["_UnqTxIdr", "_SpotValDt", "_RltdPrtryTxId", "_SplmtryData", "_PrtryTxId", "_TxNmnlAmt", "_BrnchId", "_FX", "_CtrPtyId", "_MtrtyDt", "_NvtnSts", "_TradDt", "_TxTp", "_CtrPtyPrtryTxId", "_RptdTxSts"]
	@property
	def UnqTxIdr(self):
