...
class ForeignExchangeSwapTransaction3(base_types._BaseFieldType):
	...
	__slots__ = ["_TradDt", "_SpotValDt", "_TxTp", "_RptdTxSts", "_PrtryTxId", "_FX", "_CtrPtyId", "_MtrtyDt", "_TxNmnlAmt", "_CtrPtyPrtryTxId", "_SplmtryData", "_NvtnSts", "_BrnchId", "_RltdPrtryTxId", "_UnqTxIdr"]
	@property
	def TradDt(self):
		return self._TradDt
	...
	def SpotValDt(self, value):
		self._SpotValDt = value if type(value) != auto else self.make_default("SpotValDt")
