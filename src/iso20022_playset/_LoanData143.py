...
class LoanData143(base_types._BaseFieldType):
	...
	__slots__ = ["_EvtDt", "_TradgVn", "_DlvryByVal", "_TermntnDt", "_CollDlvryMtd", "_GnlColl", "_ValDt", "_ClrSts", "_ExctnDtTm", "_Term", "_IntrstRate", "_UnitPric", "_MstrAgrmt", "_PrncplAmt", "_UnqTradIdr"]
	@property
	def EvtDt(self):
		return self._EvtDt
