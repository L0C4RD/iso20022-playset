...
class LoanData143(base_types._BaseFieldType):
	...
	__slots__ = ["_PrncplAmt", "_ExctnDtTm", "_ClrSts", "_MstrAgrmt", "_TermntnDt", "_UnitPric", "_TradgVn", "_ValDt", "_Term", "_DlvryByVal", "_EvtDt", "_CollDlvryMtd", "_GnlColl", "_IntrstRate", "_UnqTradIdr"]
	@property
	def ClrSts(self):
		return self._ClrSts
