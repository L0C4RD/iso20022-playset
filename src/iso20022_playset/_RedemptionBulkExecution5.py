...
from . import RedemptionExecution16
...
class RedemptionBulkExecution5(base_types._BaseFieldType):
	...
	def IndvExctnDtls(self, value):
		self._IndvExctnDtls = value if value is not None else base_types.UninitialisedField(self, 'IndvExctnDtls', RedemptionExecution16, True)

	@IndvExctnDtls.deleter
	def IndvExctnDtls(self):
		del self._IndvExctnDtls
		self._IndvExctnDtls = base_types.UninitialisedField(self, 'IndvExctnDtls', RedemptionExecution16, True)
