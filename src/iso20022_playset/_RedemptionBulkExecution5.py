...
class RedemptionBulkExecution5(base_types._BaseFieldType):
	...
	__slots__ = ["_PlcOfTrad", "_RcvdDtTm", "_FinInstrmDtls", "_AmdmntInd", "_ReqdSttlmCcy", "_OrdrDtTm", "_MstrRef", "_CxlRght", "_ReqdNAVCcy", "_TtlSttlmAmt", "_IndvExctnDtls", "_BlkCshSttlmDtls", "_ReqdFutrTradDt"]
	@property
	def PlcOfTrad(self):
