...
class RedemptionBulkExecution5(base_types._BaseFieldType):
	...
	__slots__ = ["_OrdrDtTm", "_PlcOfTrad", "_IndvExctnDtls", "_TtlSttlmAmt", "_ReqdNAVCcy", "_RcvdDtTm", "_AmdmntInd", "_BlkCshSttlmDtls", "_CxlRght", "_MstrRef", "_FinInstrmDtls", "_ReqdSttlmCcy", "_ReqdFutrTradDt"]
	@property
	def OrdrDtTm(self):
