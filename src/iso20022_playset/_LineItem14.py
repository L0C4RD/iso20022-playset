...
from .LineItemDetails12 import LineItemDetails12

class LineItem14(base_types._BaseFieldType):

	__slots__ = ["_OrdrdLineItmsTtlAmt", "_LineItmDtls", "_PdgLineItmsTtlAmt", "_OrdrdTtlNetAmt", "_AccptdLineItmsTtlAmt", "_AccptdTtlNetAmt", "_OutsdngLineItmsTtlAmt", "_OutsdngTtlNetAmt", "_PdgTtlNetAmt"]
	@property
