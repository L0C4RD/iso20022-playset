...
class LineItem14(base_types._BaseFieldType):
	...
	__slots__ = ["_OutsdngLineItmsTtlAmt", "_AccptdLineItmsTtlAmt", "_OutsdngTtlNetAmt", "_PdgTtlNetAmt", "_OrdrdTtlNetAmt", "_PdgLineItmsTtlAmt", "_LineItmDtls", "_AccptdTtlNetAmt", "_OrdrdLineItmsTtlAmt"]
	@property
