...
class PassengerTransport3(base_types._BaseFieldType):
	...
	__slots__ = ["_TrvlAuthstnCd", "_RsvatnSys", "_Pssngr", "_TripLeg", "_OrgnlRsvatnSys", "_LltyPrgrmm", "_TtlAmt", "_RsvatnNb", "_AddtlData", "_Insrnc", "_Dprture", "_DocNb", "_OpnTckt", "_SummryCmmdtyId", "_AncllryPurchs", "_TcktIssr", "_Drtn", "_OrgnlRsvatnNb", "_HirdVhclDtls", "_CstmrRef"]
	@property
