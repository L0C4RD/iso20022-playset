...
class InvestmentFundTransaction4(base_types._BaseFieldType):
	...
	__slots__ = ["_EvtTp", "_CdtDbt", "_SttldTxInd", "_LegId", "_CumDvddInd", "_PrtlyExctdInd", "_PricDtls", "_OrdrRef", "_ClntRef", "_SttlmAmt", "_UnitsQty", "_TradDtTm", "_SttlmDt", "_LegExctnId", "_RegdTxInd", "_DealRef", "_MstrRef", "_OrdrDtTm", "_BookgSts", "_Rvsl"]
	@property
	def EvtTp(self):
		return self._EvtTp
