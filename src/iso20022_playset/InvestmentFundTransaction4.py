...
class InvestmentFundTransaction4(base_types._BaseFieldType):
	...
	__slots__ = ["_LegExctnId", "_MstrRef", "_RegdTxInd", "_PrtlyExctdInd", "_TradDtTm", "_EvtTp", "_SttlmDt", "_OrdrDtTm", "_OrdrRef", "_CumDvddInd", "_SttlmAmt", "_UnitsQty", "_PricDtls", "_Rvsl", "_BookgSts", "_DealRef", "_ClntRef", "_CdtDbt", "_SttldTxInd", "_LegId"]
	@property
	def LegExctnId(self):
