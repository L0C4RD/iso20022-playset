...
class InvestmentFundTransaction4(base_types._BaseFieldType):
	...
	__slots__ = ["_RegdTxInd", "_PricDtls", "_UnitsQty", "_DealRef", "_SttlmAmt", "_BookgSts", "_ClntRef", "_MstrRef", "_LegId", "_CdtDbt", "_OrdrDtTm", "_OrdrRef", "_SttldTxInd", "_LegExctnId", "_EvtTp", "_PrtlyExctdInd", "_SttlmDt", "_CumDvddInd", "_Rvsl", "_TradDtTm"]
	@property
	def RegdTxInd(self):
