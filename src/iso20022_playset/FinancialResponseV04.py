...
class FinancialResponseV04(base_types._BaseFieldType):
	...
	__slots__ = ["_Instlmt", "_PrcgRslt", "_PrtctdData", "_AddtlSvc", "_Crdhldr", "_Vrfctn", "_ConvsDtTm", "_Termnl", "_ICCRltdData", "_SpclPrgrmmQlfctn", "_Rcncltn", "_AddtlData", "_Accptr", "_SttlmSvc", "_Prgrmm", "_Issr", "_OrgnlDataElmts", "_AcctBal", "_Wllt", "_TxAmts", "_DsptData", "_Acqrr", "_Hdr", "_Dstn", "_AdddmData", "_Rcvr", "_Cntxt", "_Card", "_Jursdctn", "_Dcmnttn", "_Sndr", "_Rsk", "_AddtlFee", "_TxId", "_SplmtryData", "_AcctFr", "_Tkn", "_TxChrtcs", "_Orgtr", "_AddtlAmt", "_AcctTo", "_SctyTrlr", "_StrngCstmrAuthntcn"]
	@property
	def Instlmt(self):
