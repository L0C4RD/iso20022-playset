...
class FinancialResponseV04(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_AdddmData", "_SttlmSvc", "_Vrfctn", "_ICCRltdData", "_PrcgRslt", "_DsptData", "_TxId", "_Rcvr", "_Cntxt", "_SpclPrgrmmQlfctn", "_Rcncltn", "_Prgrmm", "_Dcmnttn", "_PrtctdData", "_Crdhldr", "_SctyTrlr", "_Acqrr", "_AddtlFee", "_TxChrtcs", "_Jursdctn", "_TxAmts", "_Accptr", "_Instlmt", "_AddtlData", "_ConvsDtTm", "_Orgtr", "_Hdr", "_AcctTo", "_Rsk", "_Wllt", "_OrgnlDataElmts", "_Sndr", "_Tkn", "_Dstn", "_Termnl", "_Issr", "_AddtlAmt", "_AddtlSvc", "_StrngCstmrAuthntcn", "_AcctBal", "_AcctFr", "_Card"]
	@property
