...
class FinancialResponseV04(base_types._BaseFieldType):
	...
	__slots__ = ["_StrngCstmrAuthntcn", "_SpclPrgrmmQlfctn", "_AddtlData", "_Card", "_Issr", "_TxId", "_Acqrr", "_Dstn", "_Accptr", "_Termnl", "_PrcgRslt", "_SplmtryData", "_Hdr", "_AcctFr", "_AddtlSvc", "_SttlmSvc", "_Dcmnttn", "_Rcvr", "_AddtlAmt", "_Rcncltn", "_ConvsDtTm", "_Rsk", "_TxAmts", "_Tkn", "_Wllt", "_SctyTrlr", "_Orgtr", "_AddtlFee", "_Jursdctn", "_TxChrtcs", "_AcctTo", "_OrgnlDataElmts", "_Instlmt", "_DsptData", "_Vrfctn", "_PrtctdData", "_ICCRltdData", "_AdddmData", "_Crdhldr", "_Cntxt", "_AcctBal", "_Sndr", "_Prgrmm"]
	@property
