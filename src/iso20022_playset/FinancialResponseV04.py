...
class FinancialResponseV04(base_types._BaseFieldType):
	...
	__slots__ = ["_SplmtryData", "_TxAmts", "_Rsk", "_AcctTo", "_AddtlSvc", "_ICCRltdData", "_PrcgRslt", "_StrngCstmrAuthntcn", "_Dstn", "_AddtlData", "_Termnl", "_DsptData", "_Acqrr", "_Hdr", "_SctyTrlr", "_AddtlAmt", "_AddtlFee", "_Issr", "_OrgnlDataElmts", "_Accptr", "_Orgtr", "_Sndr", "_Prgrmm", "_SpclPrgrmmQlfctn", "_AcctFr", "_SttlmSvc", "_AcctBal", "_Instlmt", "_AdddmData", "_Wllt", "_TxId", "_Rcvr", "_Vrfctn", "_ConvsDtTm", "_Rcncltn", "_Jursdctn", "_Tkn", "_Cntxt", "_Crdhldr", "_Dcmnttn", "_PrtctdData", "_Card", "_TxChrtcs"]
	@property
