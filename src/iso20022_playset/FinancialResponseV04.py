...
from .AddendumData7 import AddendumData7

class FinancialResponseV04(base_types._BaseFieldType):

	__slots__ = ["_ICCRltdData", "_SctyTrlr", "_Hdr", "_Orgtr", "_Acqrr", "_Accptr", "_Vrfctn", "_Jursdctn", "_Rcvr", "_AdddmData", "_Prgrmm", "_Dstn", "_AddtlAmt", "_SttlmSvc", "_Rcncltn", "_TxChrtcs", "_Issr", "_SplmtryData", "_StrngCstmrAuthntcn", "_Card", "_Instlmt", "_AddtlData", "_Sndr", "_TxId", "_Termnl", "_Dcmnttn", "_PrcgRslt", "_AddtlSvc", "_AcctFr", "_Wllt", "_AcctTo", "_Cntxt", "_DsptData", "_OrgnlDataElmts", "_SpclPrgrmmQlfctn", "_TxAmts", "_AddtlFee", "_PrtctdData", "_Rsk", "_ConvsDtTm", "_Tkn", "_AcctBal", "_Crdhldr"]
	@property
