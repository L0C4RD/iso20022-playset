...
class SettlementDetails190(base_types._BaseFieldType):
	...
	__slots__ = ["_RpTp", "_SttlmTxCond", "_TaxCpcty", "_NetgElgblty", "_CshClrSys", "_Regn", "_MktClntSd", "_StmpDtyTaxBsis", "_LttrOfGrnt", "_CCPElgblty", "_SctiesRTGS", "_LglRstrctns", "_SttlmSysMtd", "_PrtlSttlmInd", "_BnfclOwnrsh", "_SttlgCpcty", "_BlckTrad"]
	@property
	def RpTp(self):
		return self._RpTp
