...
class SettlementDetails190(base_types._BaseFieldType):
	...
	__slots__ = ["_CshClrSys", "_CCPElgblty", "_SttlmTxCond", "_SctiesRTGS", "_SttlgCpcty", "_BlckTrad", "_NetgElgblty", "_TaxCpcty", "_SttlmSysMtd", "_LglRstrctns", "_LttrOfGrnt", "_PrtlSttlmInd", "_StmpDtyTaxBsis", "_MktClntSd", "_Regn", "_RpTp", "_BnfclOwnrsh"]
	@property
	def CshClrSys(self):
