...
class SettlementDetails190(base_types._BaseFieldType):
	...
	__slots__ = ["_CshClrSys", "_StmpDtyTaxBsis", "_MktClntSd", "_SttlmTxCond", "_BlckTrad", "_CCPElgblty", "_Regn", "_NetgElgblty", "_TaxCpcty", "_LglRstrctns", "_SttlgCpcty", "_SctiesRTGS", "_BnfclOwnrsh", "_SttlmSysMtd", "_LttrOfGrnt", "_PrtlSttlmInd", "_RpTp"]
	@property
	def CshClrSys(self):
