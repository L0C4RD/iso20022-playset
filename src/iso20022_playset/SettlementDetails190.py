...
class SettlementDetails190(base_types._BaseFieldType):
	...
	__slots__ = ["_TaxCpcty", "_NetgElgblty", "_MktClntSd", "_Regn", "_CshClrSys", "_CCPElgblty", "_SttlmTxCond", "_LttrOfGrnt", "_SttlmSysMtd", "_BlckTrad", "_PrtlSttlmInd", "_BnfclOwnrsh", "_SttlgCpcty", "_StmpDtyTaxBsis", "_RpTp", "_SctiesRTGS", "_LglRstrctns"]
	@property
	def TaxCpcty(self):
