...
class SettlementDetails152(base_types._BaseFieldType):
	...
	__slots__ = ["_AutomtcBrrwg", "_CshClrSys", "_SctiesRTGS", "_NetgElgblty", "_BlckTrad", "_SttlmSysMtd", "_FxStgInstr", "_Prty", "_CCPElgblty", "_Trckg", "_MktClntSd", "_StmpDtyTaxBsis", "_HldInd", "_LglRstrctns", "_PrtlSttlmInd", "_ElgblForColl", "_BnfclOwnrsh", "_SttlmTxCond", "_SttlgCpcty", "_TaxCpcty"]
	@property
