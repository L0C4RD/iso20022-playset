...
from .SettlementTransactionCondition22Choice import SettlementTransactionCondition22Choice
...
class SettlementDetails152(base_types._BaseFieldType):

	__slots__ = ["_ElgblForColl", "_AutomtcBrrwg", "_SttlgCpcty", "_LglRstrctns", "_HldInd", "_SttlmSysMtd", "_NetgElgblty", "_CCPElgblty", "_FxStgInstr", "_BlckTrad", "_SctiesRTGS", "_Trckg", "_TaxCpcty", "_SttlmTxCond", "_MktClntSd", "_BnfclOwnrsh", "_StmpDtyTaxBsis", "_Prty", "_PrtlSttlmInd", "_CshClrSys"]
	@property
