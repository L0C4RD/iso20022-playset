...
import SettlementTransactionCondition22Choice
...
class SettlementDetails152(base_types._BaseFieldType):
	...
	__slots__ = ["_TaxCpcty", "_StmpDtyTaxBsis", "_SttlmSysMtd", "_ElgblForColl", "_BlckTrad", "_MktClntSd", "_HldInd", "_BnfclOwnrsh", "_SttlmTxCond", "_SctiesRTGS", "_NetgElgblty", "_PrtlSttlmInd", "_CshClrSys", "_LglRstrctns", "_Prty", "_CCPElgblty", "_Trckg", "_SttlgCpcty", "_AutomtcBrrwg", "_FxStgInstr"]
	@property
	def TaxCpcty(self):
