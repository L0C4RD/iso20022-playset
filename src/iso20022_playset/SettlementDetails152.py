...
class SettlementDetails152(base_types._BaseFieldType):
	...
	__slots__ = ["_FxStgInstr", "_Prty", "_SttlmSysMtd", "_StmpDtyTaxBsis", "_HldInd", "_NetgElgblty", "_SttlmTxCond", "_BnfclOwnrsh", "_CshClrSys", "_SctiesRTGS", "_TaxCpcty", "_PrtlSttlmInd", "_BlckTrad", "_AutomtcBrrwg", "_MktClntSd", "_LglRstrctns", "_ElgblForColl", "_Trckg", "_SttlgCpcty", "_CCPElgblty"]
	@property
	def FxStgInstr(self):
