...
from ._SettlementDetails222 import SettlementDetails222
...
class TransactionDetails177(base_types._BaseFieldType):

	__slots__ = ["_AcctOwnr", "_AckdStsTmStmp", "_BlckChainAdrOrWllt", "_ClntCollInstrId", "_ClntTrptyCollTxId", "_CorpActnEvtId", "_DgtlPmtSttlm", "_DlvrgSttlmPties", "_FinInstrmId", "_Invstr", "_LateDlvryDt", "_MtchdStsTmStmp", "_NonceId", "_PlcOfClr", "_PlcOfTrad", "_Pmt", "_PoolId", "_PrtlyRlsdQty", "_QlfdFrgnIntrmy", "_RcvgSttlmPties", "_SctiesMvmntTp", "_SfkpgAcct", "_SfkpgPlc", "_SttlmAmt", "_SttlmDt", "_SttlmInstrPrcgAddtlDtls", "_SttlmParams", "_SttlmQty", "_TradDt", "_TradId", "_TrptyAgtSvcPrvdrCollInstrId", "_TrptyAgtSvcPrvdrCollTxId", "_UnqTxIdr", "_XpctdSttlmDt", "_XpctdValDt"]
	@property
	def AcctOwnr(self):
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='SttlmParams', type=SettlementDetails222, min=1, max=1, mutex_group=None, array=False),
