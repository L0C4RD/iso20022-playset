...
from . import MessageStatusResponseData9
...
class MessageStatusResponse9(base_types._BaseFieldType):
	...
	def MsgStsRspnData(self, value):
		self._MsgStsRspnData = value if value is not None else base_types.UninitialisedField(self, 'MsgStsRspnData', MessageStatusResponseData9, False)

	@MsgStsRspnData.deleter
	def MsgStsRspnData(self):
		del self._MsgStsRspnData
		self._MsgStsRspnData = base_types.UninitialisedField(self, 'MsgStsRspnData', MessageStatusResponseData9, False)
