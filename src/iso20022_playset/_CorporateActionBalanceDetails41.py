...
class CorporateActionBalanceDetails41(base_types._BaseFieldType):
	...
	__slots__ = ["_RegdBal", "_TtlElgblBal", "_ConfdBal", "_SttlmPosBal", "_InTrnsShipmntBal", "_PdgRctBal", "_StrtPosBal", "_OnLnBal", "_CollOutBal", "_UafctdBal", "_TradDtPosBal", "_AfctdBal", "_BrrwdBal", "_CollInBal", "_PdgDlvryBal", "_BlckdBal", "_OutForRegnBal"]
	@property
	def RegdBal(self):
