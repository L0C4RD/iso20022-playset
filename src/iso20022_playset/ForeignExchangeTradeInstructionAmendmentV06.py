...
class ForeignExchangeTradeInstructionAmendmentV06(base_types._BaseFieldType):
	...
	__slots__ = ["_AgrdRate", "_TradgSdSttlmInstrs", "_PstTradEvt", "_TradInf", "_SplmtryData", "_NDFConds", "_CtrPtySdId", "_TradAmts", "_RgltryRptg", "_OptnlGnlInf", "_CtrPtySdSttlmInstrs", "_TradgSdId"]
	@property
	def AgrdRate(self):
