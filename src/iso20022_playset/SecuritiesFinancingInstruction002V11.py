...
class SecuritiesFinancingInstruction002V11(base_types._BaseFieldType):
	...
	__slots__ = ["_Lnkgs", "_SctiesFincgDtls", "_OpngSttlmAmt", "_OthrAmts", "_FinInstrmAttrbts", "_QtyAndAcctDtls", "_OthrBizPties", "_DlvrgSttlmPties", "_CshPties", "_RcvgSttlmPties", "_SttlmParams", "_TradDtls", "_TxId", "_FinInstrmId", "_TxTpAndAddtlParams", "_StgSttlmInstrDtls", "_SplmtryData", "_NbCounts"]
	@property
	def Lnkgs(self):
		return self._Lnkgs
