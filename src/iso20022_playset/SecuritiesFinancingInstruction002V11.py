...
class SecuritiesFinancingInstruction002V11(base_types._BaseFieldType):
	...
	__slots__ = ["_SttlmParams", "_OthrBizPties", "_SplmtryData", "_OpngSttlmAmt", "_TxTpAndAddtlParams", "_Lnkgs", "_TradDtls", "_RcvgSttlmPties", "_SctiesFincgDtls", "_TxId", "_FinInstrmId", "_NbCounts", "_FinInstrmAttrbts", "_DlvrgSttlmPties", "_QtyAndAcctDtls", "_StgSttlmInstrDtls", "_OthrAmts", "_CshPties"]
	@property
