...
class PartyProfileInformation5(base_types._BaseFieldType):
	...
	__slots__ = ["_KnowYourCstmrChckTp", "_CertTp", "_VldtngPty", "_RspnsblPty", "_SlryRg", "_SrcOfWlth", "_ChckngDt", "_NxtRvsnDt", "_ChckngPty", "_ChckngFrqcy", "_CstmrCndctClssfctn", "_RskLvl", "_CertfctnInd", "_KnowYourCstmrDBChck"]
	@property
