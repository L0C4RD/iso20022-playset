...
class QuantityAndAccount108(base_types._BaseFieldType):
	...
	__slots__ = ["_RmngToBeSttldQty", "_PrevslySttldQty", "_SttldQty", "_QtyBrkdwn", "_DnmtnChc", "_CshAcct", "_BlckChainAdrOrWllt", "_PrevslySttldAmt", "_AcctOwnr", "_SfkpgPlc", "_SfkpgAcct", "_RmngToBeSttldAmt"]
	@property
