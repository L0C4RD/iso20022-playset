...
class QuantityAndAccount108(base_types._BaseFieldType):
	...
	__slots__ = ["_RmngToBeSttldAmt", "_BlckChainAdrOrWllt", "_DnmtnChc", "_QtyBrkdwn", "_AcctOwnr", "_SfkpgPlc", "_CshAcct", "_PrevslySttldAmt", "_PrevslySttldQty", "_SttldQty", "_RmngToBeSttldQty", "_SfkpgAcct"]
	@property
