...
class QuantityAndAccount108(base_types._BaseFieldType):
	...
	__slots__ = ["_DnmtnChc", "_SfkpgPlc", "_SttldQty", "_BlckChainAdrOrWllt", "_PrevslySttldAmt", "_QtyBrkdwn", "_CshAcct", "_RmngToBeSttldAmt", "_SfkpgAcct", "_RmngToBeSttldQty", "_AcctOwnr", "_PrevslySttldQty"]
	@property
	def DnmtnChc(self):
