...
class QuantityAndAccount108(base_types._BaseFieldType):
	...
	__slots__ = ["_QtyBrkdwn", "_RmngToBeSttldAmt", "_SttldQty", "_SfkpgAcct", "_PrevslySttldAmt", "_CshAcct", "_AcctOwnr", "_RmngToBeSttldQty", "_DnmtnChc", "_BlckChainAdrOrWllt", "_PrevslySttldQty", "_SfkpgPlc"]
	@property
	def QtyBrkdwn(self):
