...
class QuantityAndAccount108(base_types._BaseFieldType):
	...
	__slots__ = ["_RmngToBeSttldQty", "_SttldQty", "_QtyBrkdwn", "_AcctOwnr", "_CshAcct", "_PrevslySttldQty", "_BlckChainAdrOrWllt", "_SfkpgPlc", "_DnmtnChc", "_SfkpgAcct", "_PrevslySttldAmt", "_RmngToBeSttldAmt"]
	@property
