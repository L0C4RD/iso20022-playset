...
from .InstalmentAmountDetails3 import InstalmentAmountDetails3
from .ISODate import ISODate
from .ISO3NumericCurrencyCode import ISO3NumericCurrencyCode
from .AdditionalData1 import AdditionalData1
from .GracePeriodUnitType1Code import GracePeriodUnitType1Code
from .Max70Text import Max70Text
from .InterestRateDetails2 import InterestRateDetails2
from .TrueFalseIndicator import TrueFalseIndicator
from .Number import Number
from .Max3NumericText import Max3NumericText
from .Max256Text import Max256Text
from .Frequency18Code import Frequency18Code
from .PlanOwner1Code import PlanOwner1Code

class Plan3(base_types._BaseFieldType):

	__slots__ = ["_NbOfPrds", "_GracePrdUnitTp", "_PrdUnit", "_FrstAmt", "_PmtTp", "_Ownr", "_Ccy", "_DfrrdPrds", "_OthrOwnr", "_GrdTtlAmt", "_IntrstRate", "_TtlNbOfPmts", "_Dfrrd", "_AmtDtls", "_OthrGracePrdUnitTp", "_NbOfGracePrdUnits", "_Id", "_NrmlPmtAmt", "_RegnSysId", "_FrstPmtDt", "_AddtlData", "_OwnrNm", "_CstmrSelctdGracePrd"]
	@property
	def NbOfPrds(self):
	...
	def GracePrdUnitTp(self, value):
		self._GracePrdUnitTp = value if type(value) != auto else self.make_default("GracePrdUnitTp")
	...
	def GrdTtlAmt(self, value):
		self._GrdTtlAmt = value if type(value) != auto else self.make_default("GrdTtlAmt")
	...
	def OthrGracePrdUnitTp(self, value):
		self._OthrGracePrdUnitTp = value if type(value) != auto else self.make_default("OthrGracePrdUnitTp")
	...
	def NrmlPmtAmt(self, value):
		self._NrmlPmtAmt = value if type(value) != auto else self.make_default("NrmlPmtAmt")
