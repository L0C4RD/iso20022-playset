...
class Plan3(base_types._BaseFieldType):
	...
	__slots__ = ["_TtlNbOfPmts", "_OthrGracePrdUnitTp", "_IntrstRate", "_RegnSysId", "_GrdTtlAmt", "_FrstPmtDt", "_Ccy", "_CstmrSelctdGracePrd", "_PrdUnit", "_Ownr", "_NbOfGracePrdUnits", "_PmtTp", "_NrmlPmtAmt", "_Dfrrd", "_NbOfPrds", "_GracePrdUnitTp", "_OwnrNm", "_AmtDtls", "_FrstAmt", "_OthrOwnr", "_Id", "_DfrrdPrds", "_AddtlData"]
	@property
