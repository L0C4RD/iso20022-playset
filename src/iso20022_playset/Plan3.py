...
class Plan3(base_types._BaseFieldType):
	...
	__slots__ = ["_OwnrNm", "_Id", "_NbOfGracePrdUnits", "_RegnSysId", "_PmtTp", "_TtlNbOfPmts", "_OthrOwnr", "_FrstPmtDt", "_OthrGracePrdUnitTp", "_AddtlData", "_GrdTtlAmt", "_NrmlPmtAmt", "_AmtDtls", "_Ccy", "_FrstAmt", "_NbOfPrds", "_CstmrSelctdGracePrd", "_Dfrrd", "_DfrrdPrds", "_IntrstRate", "_Ownr", "_PrdUnit", "_GracePrdUnitTp"]
	@property
	def OwnrNm(self):
		return self._OwnrNm
