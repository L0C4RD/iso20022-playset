...
class BatchTransferResponseV03(base_types._BaseFieldType):
	...
	__slots__ = ["_BtchChcksm", "_Orgtr", "_OrgnlBtchId", "_Hdr", "_NbOfMsgs", "_OrgnlRspnCd", "_RtrvlRefNb", "_PrcgRslt", "_Jursdctn", "_ClrBtchData", "_SttlmSvc", "_PrtctdData", "_LifeCyclId", "_SysTracAudtNb", "_BtchId", "_SctyTrlr", "_TrnsmssnDtTm", "_Prgrmm", "_ClrCtrlTtls", "_Rcncltn", "_AddtlData", "_ReqAck", "_Dstn", "_AgtData", "_SplmtryData", "_Rcrd"]
	@property
	def BtchChcksm(self):
