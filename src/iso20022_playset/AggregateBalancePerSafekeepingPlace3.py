...
import SafekeepingPlaceFormatChoice
import ForeignExchangeTerms6
import Number
import SubBalanceInformation2
import PriceInformation2
import BalanceQuantity1Choice
import ActiveOrHistoricCurrencyAndAmount

class AggregateBalancePerSafekeepingPlace3(base_types._BaseFieldType):

	__slots__ = ["_FXDtls", "_PricDtls", "_BookVal", "_AggtQty", "_PrvsHldgVal", "_DaysAcrd", "_AcrdIntrstAmt", "_BalBrkdwnDtls", "_NotAvlblQty", "_AcrdIntrstAmtSgn", "_AvlblQty", "_SfkpgPlc", "_HldgVal", "_AddtlBalBrkdwnDtls"]
	@property
	def FXDtls(self):
		return self._FXDtls
	...
	def NotAvlblQty(self, value):
		self._NotAvlblQty = value if type(value) != auto else self.make_default("NotAvlblQty")
	...
	def AvlblQty(self, value):
		self._AvlblQty = value if type(value) != auto else self.make_default("AvlblQty")
