...
class AggregateBalancePerSafekeepingPlace3(base_types._BaseFieldType):
	...
	__slots__ = ["_PricDtls", "_AggtQty", "_AcrdIntrstAmt", "_BalBrkdwnDtls", "_NotAvlblQty", "_BookVal", "_HldgVal", "_SfkpgPlc", "_PrvsHldgVal", "_AddtlBalBrkdwnDtls", "_AvlblQty", "_DaysAcrd", "_FXDtls", "_AcrdIntrstAmtSgn"]
	@property
	def PricDtls(self):
