...
from . import ModificationStatus6Choice
from . import PendingProcessingStatus23Choice
...
class ModificationProcessingStatus12Choice(base_types._BaseFieldType):
	...
	def Modfd(self, value):
		self._Modfd = value if value is not None else base_types.UninitialisedField(self, 'Modfd', ModificationStatus6Choice, False)

	@Modfd.deleter
	def Modfd(self):
		del self._Modfd
		self._Modfd = base_types.UninitialisedField(self, 'Modfd', ModificationStatus6Choice, False)
	...
	def PdgPrcg(self, value):
		self._PdgPrcg = value if value is not None else base_types.UninitialisedField(self, 'PdgPrcg', PendingProcessingStatus23Choice, False)

	@PdgPrcg.deleter
	def PdgPrcg(self):
		del self._PdgPrcg
		self._PdgPrcg = base_types.UninitialisedField(self, 'PdgPrcg', PendingProcessingStatus23Choice, False)
