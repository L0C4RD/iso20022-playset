...
class InstructionProcessingStatus62Choice(base_types._BaseFieldType):
	...
	_field_defs = frozenset((
		...
		base_types.FieldEntry(name='Pdg', type=PendingStatus85Choice, min=0, max=1, mutex_group=1, array=False),
		base_types.FieldEntry(name='PdgCxl', type=PendingCancellationStatus21Choice, min=0, max=1, mutex_group=1, array=False),
