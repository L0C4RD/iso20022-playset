...
class SecuritiesTradeConfirmationV05(base_types._BaseFieldType):
	...
	__slots__ = ["_UndrlygFinInstrm", "_ConfPties", "_FinInstrmAttrbts", "_RgltryStiptns", "_Id", "_OthrBizPties", "_NbCnt", "_DlvrgSttlmPties", "_RcvgSttlmPties", "_SplmtryData", "_TwoLegTxDtls", "_ClrDtls", "_TradDtls", "_OthrPrics", "_Refs", "_Stiptns", "_FinInstrmId", "_OthrAmts", "_StgSttlmInstr", "_SttlmAmt", "_CshPties", "_SttlmParams"]
	@property
