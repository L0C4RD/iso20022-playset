...
class SecuritiesTradeConfirmationV05(base_types._BaseFieldType):
	...
	__slots__ = ["_UndrlygFinInstrm", "_OthrBizPties", "_TwoLegTxDtls", "_OthrAmts", "_FinInstrmId", "_CshPties", "_ClrDtls", "_FinInstrmAttrbts", "_OthrPrics", "_SttlmParams", "_Refs", "_Stiptns", "_RcvgSttlmPties", "_RgltryStiptns", "_Id", "_StgSttlmInstr", "_SttlmAmt", "_NbCnt", "_SplmtryData", "_ConfPties", "_DlvrgSttlmPties", "_TradDtls"]
	@property
