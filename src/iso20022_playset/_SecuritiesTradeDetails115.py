...
class SecuritiesTradeDetails115(base_types._BaseFieldType):
	...
	__slots__ = ["_NbOfDaysAcrd", "_FxAddtlDtls", "_FctvSttlmDt", "_PlcOfTrad", "_TradTxCond", "_TradOrgtrRole", "_SttlmDt", "_Rptg", "_InvstrCpcty", "_DealPric", "_TradDt", "_PlcOfClr", "_SttlmInstrPrcgAddtlDtls"]
	@property
