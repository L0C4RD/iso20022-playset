...
class SecuritiesTradeDetails115(base_types._BaseFieldType):
	...
	__slots__ = ["_Rptg", "_NbOfDaysAcrd", "_SttlmDt", "_InvstrCpcty", "_FctvSttlmDt", "_TradOrgtrRole", "_SttlmInstrPrcgAddtlDtls", "_DealPric", "_FxAddtlDtls", "_PlcOfClr", "_TradTxCond", "_PlcOfTrad", "_TradDt"]
	@property
	def Rptg(self):
		return self._Rptg
