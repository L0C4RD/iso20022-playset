...
class FinancialInstrumentAttributes136(base_types._BaseFieldType):
	...
	__slots__ = ["_IsseDt", "_MinNmnlQty", "_CtrctSz", "_ConvsDt", "_NxtCllblDt", "_FinInstrmId", "_FltgRateFxgDt", "_PlcOfListg", "_MtrtyDt", "_PutblDt", "_DtdDt", "_DayCntBsis", "_OptnStyle", "_NxtCpnDt", "_ClssfctnTp", "_WarrtParity", "_IntrstRate", "_XpryDt", "_NxtIntrstRate", "_PrvsFctr", "_PctgOfDebtClm", "_NxtFctr", "_DnmtnCcy"]
	@property
	def IsseDt(self):
		return self._IsseDt
