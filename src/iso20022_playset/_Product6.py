...
class Product6(base_types._BaseFieldType):
	...
	__slots__ = ["_UnitOfMeasr", "_ValAddedTax", "_SaleChanl", "_ItmId", "_DlvryLctn", "_PdctQty", "_PdctDesc", "_AddtlPdctDesc", "_UnitPricSgn", "_AddtlPdctCd", "_PdctAmtSgn", "_PdctAmt", "_PdctCd", "_UnitPric", "_DlvrySvc", "_TaxTp"]
	@property
