...
class Product6(base_types._BaseFieldType):
	...
	__slots__ = ["_PdctCd", "_TaxTp", "_SaleChanl", "_UnitOfMeasr", "_ItmId", "_PdctQty", "_PdctDesc", "_AddtlPdctCd", "_DlvrySvc", "_PdctAmtSgn", "_AddtlPdctDesc", "_ValAddedTax", "_UnitPric", "_PdctAmt", "_DlvryLctn", "_UnitPricSgn"]
	@property
	def PdctCd(self):
		return self._PdctCd
