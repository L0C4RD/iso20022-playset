...
class ClearingSystemMemberIdentification2Choice(base_types._BaseFieldType):
	...
	__slots__ = ["_PTNCC", "_PLKNR", "_GRHEBIC", "_GBSC", "_ITNCC", "_HKNCC", "_ESNCC", "_CHSIC", "_NZNCC", "_USCH", "_OthrClrCdId", "_RUCB", "_IENSC", "_CACPA", "_USCHU", "_CHBC", "_AUBSBx", "_DEBLZ", "_INIFSC", "_ZANCC", "_ATBLZ", "_USFW", "_AUBSBs"]
	@property
	def PTNCC(self):
		return self._PTNCC
