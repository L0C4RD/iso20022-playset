...
class CompareInterestRate1(base_types._BaseFieldType):
	...
	__slots__ = ["_FltgIntrstRateRstFrqcyVal", "_FltgIntrstRateRstFrqcyUnit", "_FltgIntrstRefRate", "_DayCntBsis", "_FltgIntrstRatePmtFrqcyVal", "_FltgIntrstRateTermVal", "_BsisPtSprd", "_FxdIntrstRate", "_FltgIntrstRateTermUnit", "_MrgnLnAmt", "_FltgIntrstRatePmtFrqcyUnit"]
	@property
