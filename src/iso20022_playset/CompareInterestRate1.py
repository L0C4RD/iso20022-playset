...
class CompareInterestRate1(base_types._BaseFieldType):
	...
	__slots__ = ["_DayCntBsis", "_FltgIntrstRefRate", "_FltgIntrstRateTermUnit", "_FltgIntrstRateRstFrqcyUnit", "_FxdIntrstRate", "_MrgnLnAmt", "_BsisPtSprd", "_FltgIntrstRateTermVal", "_FltgIntrstRatePmtFrqcyVal", "_FltgIntrstRateRstFrqcyVal", "_FltgIntrstRatePmtFrqcyUnit"]
	@property
	def DayCntBsis(self):
