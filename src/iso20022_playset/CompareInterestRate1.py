...
class CompareInterestRate1(base_types._BaseFieldType):
	...
	__slots__ = ["_FxdIntrstRate", "_FltgIntrstRateTermUnit", "_FltgIntrstRatePmtFrqcyVal", "_FltgIntrstRateTermVal", "_DayCntBsis", "_FltgIntrstRatePmtFrqcyUnit", "_FltgIntrstRateRstFrqcyVal", "_BsisPtSprd", "_FltgIntrstRefRate", "_MrgnLnAmt", "_FltgIntrstRateRstFrqcyUnit"]
	@property
