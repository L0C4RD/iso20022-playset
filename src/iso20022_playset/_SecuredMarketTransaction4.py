...
class SecuredMarketTransaction4(base_types._BaseFieldType):
	...
	__slots__ = ["_CtrPtyPrtryTxId", "_SplmtryData", "_CtrPtyId", "_Coll", "_SttlmDt", "_MtrtyDt", "_PrtryTxId", "_BrkrdDeal", "_RptdTxSts", "_TxTp", "_UnqTxIdr", "_TradDt", "_NvtnSts", "_TxNmnlAmt", "_RateTp", "_TrptyAgtId", "_DealRate", "_BrnchId", "_RltdPrtryTxId", "_FltgRateRpAgrmt"]
	@property
