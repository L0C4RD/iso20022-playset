...
class SecuredMarketTransaction4(base_types._BaseFieldType):
	...
	__slots__ = ["_Coll", "_RltdPrtryTxId", "_TxTp", "_TxNmnlAmt", "_CtrPtyId", "_RateTp", "_TradDt", "_UnqTxIdr", "_DealRate", "_TrptyAgtId", "_SplmtryData", "_PrtryTxId", "_NvtnSts", "_RptdTxSts", "_SttlmDt", "_CtrPtyPrtryTxId", "_MtrtyDt", "_BrkrdDeal", "_FltgRateRpAgrmt", "_BrnchId"]
	@property
	def Coll(self):
		return self._Coll
